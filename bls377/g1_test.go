...
func TestG1AffineIsOnCurve(t *testing.T) {
	...
	genFuzz1 := GenFp()
	properties.Property("[BLS377] g1Gen (affine) should be on the curve", prop.ForAll(
	...
	properties.Property("[BLS377] g1Gen (Jacobian) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
...
func TestG1AffineOps(t *testing.T) {
	...
	properties.Property("[BLS377] [Jacobian Extended] add (-G) should equal sub(G)", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG1Affine(&g1Gen, a)
