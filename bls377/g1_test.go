...
func TestG1IsOnCurve(t *testing.T) {
	...
	properties.Property("[BLS377] g1Gen (projective) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
...
func TestG1MultiExp(t *testing.T) {
	...
	if !testing.Short() {
		...
		properties.Property("[BLS377] Multi exponentation (c=17) should be consistant with sum of square", prop.ForAll(
			func(mixer fr.Element) bool {
	...
	if !testing.Short() {
		...
		properties.Property("[BLS377] Multi exponentation (c=18) should be consistant with sum of square", prop.ForAll(
			func(mixer fr.Element) bool {
	...
	if !testing.Short() {
		...
		properties.Property("[BLS377] Multi exponentation (c=19) should be consistant with sum of square", prop.ForAll(
			func(mixer fr.Element) bool {
