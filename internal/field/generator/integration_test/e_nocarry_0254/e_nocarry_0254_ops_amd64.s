...
// modulus q
DATA q<>+0(SB)/8, $0x54e0f145b7f0eecf
DATA q<>+8(SB)/8, $0xb66514d310239bde
DATA q<>+16(SB)/8, $0x019028785c299070
DATA q<>+24(SB)/8, $0x3195e4bf66c30c73
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0e7beba2503ca7d1
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x54e0f145b7f0eecf, R12
	MOVQ    $0xb66514d310239bde, R13
	MOVQ    $0x019028785c299070, R14
	MOVQ    $0x3195e4bf66c30c73, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
