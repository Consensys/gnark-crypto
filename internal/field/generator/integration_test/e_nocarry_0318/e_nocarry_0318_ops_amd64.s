...
// modulus q
DATA q<>+0(SB)/8, $0x6892dece0c83829f
DATA q<>+8(SB)/8, $0x131a1ad7e8181d3c
DATA q<>+16(SB)/8, $0x71b10d9b252a695d
DATA q<>+24(SB)/8, $0xbe3ba6edcf05be8d
DATA q<>+32(SB)/8, $0x3aa7dd64da5d8598
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xb10861ca3010e6a1
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x6892dece0c83829f, CX
	MOVQ    $0x131a1ad7e8181d3c, BX
	MOVQ    $0x71b10d9b252a695d, SI
	MOVQ    $0xbe3ba6edcf05be8d, DI
	MOVQ    $0x3aa7dd64da5d8598, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
