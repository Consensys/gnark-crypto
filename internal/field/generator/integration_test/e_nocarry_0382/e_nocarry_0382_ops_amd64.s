...
// modulus q
DATA q<>+0(SB)/8, $0x3cf331a00f96d341
DATA q<>+8(SB)/8, $0x9531777c18e18cd1
DATA q<>+16(SB)/8, $0xbd4adb37830da84d
DATA q<>+24(SB)/8, $0x94a284e51d9a4b54
DATA q<>+32(SB)/8, $0x0d7df27d5ff446b9
DATA q<>+40(SB)/8, $0x30a094cbc42354d4
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x8771f623c298433f
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x3cf331a00f96d341, CX
	MOVQ    $0x9531777c18e18cd1, BX
	MOVQ    $0xbd4adb37830da84d, SI
	MOVQ    $0x94a284e51d9a4b54, DI
	MOVQ    $0x0d7df27d5ff446b9, R8
	MOVQ    $0x30a094cbc42354d4, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
