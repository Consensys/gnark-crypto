...
// modulus q
DATA q<>+0(SB)/8, $0x519a4d537b19b7ef
DATA q<>+8(SB)/8, $0x28b2d42f26b8aaf3
DATA q<>+16(SB)/8, $0xc242d320ae8e33b7
DATA q<>+24(SB)/8, $0xe5d9962c0b7acf83
DATA q<>+32(SB)/8, $0x474515b0429e02e2
DATA q<>+40(SB)/8, $0xe982b41edddc7962
DATA q<>+48(SB)/8, $0x1de326578eab137b
GLOBL q<>(SB), (RODATA+NOPTR), $56

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x06f5e5e2a83ba8f1
...
TEXT ·Butterfly(SB), $8-16
	...
	SBBQ 48(AX), R9
	JCC  l1
	MOVQ $0x519a4d537b19b7ef, AX
	ADDQ AX, DX
	MOVQ $0x28b2d42f26b8aaf3, AX
	ADCQ AX, CX
	MOVQ $0xc242d320ae8e33b7, AX
	ADCQ AX, BX
	MOVQ $0xe5d9962c0b7acf83, AX
	ADCQ AX, SI
	MOVQ $0x474515b0429e02e2, AX
	ADCQ AX, DI
	MOVQ $0xe982b41edddc7962, AX
	ADCQ AX, R8
	MOVQ $0x1de326578eab137b, AX
	ADCQ AX, R9
