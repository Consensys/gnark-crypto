...
// modulus q
DATA q<>+0(SB)/8, $0x0091592e88ccb417
DATA q<>+8(SB)/8, $0x0c7e380ae7957a89
DATA q<>+16(SB)/8, $0xfe58cef4fc3f31b5
DATA q<>+24(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0c57c69742603c59
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x0091592e88ccb417, R12
	MOVQ    $0x0c7e380ae7957a89, R13
	MOVQ    $0xfe58cef4fc3f31b5, R14
	MOVQ    $1, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
