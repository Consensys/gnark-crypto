...
// modulus q
DATA q<>+0(SB)/8, $0xf30696da811fa2f9
DATA q<>+8(SB)/8, $0x3e4bf494d45c8ae1
GLOBL q<>(SB), (RODATA+NOPTR), $16

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x89b18b8d3b9680b7
...
TEXT ·mul(SB), $24-24
	...
	// the algorithm is described in the e_nocarry_0126.Mul declaration (.go)
