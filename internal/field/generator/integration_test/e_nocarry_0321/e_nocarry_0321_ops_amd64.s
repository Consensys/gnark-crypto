...
// modulus q
DATA q<>+0(SB)/8, $0x776040da6cd3f391
DATA q<>+8(SB)/8, $0x6001b98edb119ada
DATA q<>+16(SB)/8, $0x50b5de1789910abe
DATA q<>+24(SB)/8, $0xae0d681c738bdf0f
DATA q<>+32(SB)/8, $0xaed1c44849f526dc
DATA q<>+40(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x8bb4e80af7eed28f
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x776040da6cd3f391, CX
	MOVQ    $0x6001b98edb119ada, BX
	MOVQ    $0x50b5de1789910abe, SI
	MOVQ    $0xae0d681c738bdf0f, DI
	MOVQ    $0xaed1c44849f526dc, R8
	MOVQ    $1, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
