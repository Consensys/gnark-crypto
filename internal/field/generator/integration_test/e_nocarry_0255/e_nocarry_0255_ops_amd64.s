...
// modulus q
DATA q<>+0(SB)/8, $0x143f9b90cbd04afd
DATA q<>+8(SB)/8, $0x83e84c16cc1bc820
DATA q<>+16(SB)/8, $0xc07b17842e550913
DATA q<>+24(SB)/8, $0x77177314231e5993
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xd0a0947665205dab
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x143f9b90cbd04afd, R12
	MOVQ    $0x83e84c16cc1bc820, R13
	MOVQ    $0xc07b17842e550913, R14
	MOVQ    $0x77177314231e5993, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
