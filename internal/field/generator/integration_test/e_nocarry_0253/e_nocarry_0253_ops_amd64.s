...
// modulus q
DATA q<>+0(SB)/8, $0xa09b925a44961d07
DATA q<>+8(SB)/8, $0x37714ab00dfbc57d
DATA q<>+16(SB)/8, $0x326434bcbb75a4d5
DATA q<>+24(SB)/8, $0x18cb26e5b0035779
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xa4e5f7e0494b3f49
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xa09b925a44961d07, R12
	MOVQ    $0x37714ab00dfbc57d, R13
	MOVQ    $0x326434bcbb75a4d5, R14
	MOVQ    $0x18cb26e5b0035779, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
