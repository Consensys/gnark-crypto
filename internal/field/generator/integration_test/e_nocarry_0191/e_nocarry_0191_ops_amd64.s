...
// modulus q
DATA q<>+0(SB)/8, $0xc0e6d3037e68a1fd
DATA q<>+8(SB)/8, $0xa89c7f2492792f5c
DATA q<>+16(SB)/8, $0x711c5d663853916d
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x52cd2cd16b9ebcab
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xc0e6d3037e68a1fd, R10
	MOVQ    $0xa89c7f2492792f5c, R11
	MOVQ    $0x711c5d663853916d, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
