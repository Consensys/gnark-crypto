...
// modulus q
DATA q<>+0(SB)/8, $0x412ec4f81b3bd80f
DATA q<>+8(SB)/8, $0x7ab1fff35f234188
DATA q<>+16(SB)/8, $0xa26ef3acfb3962e5
DATA q<>+24(SB)/8, $0xc91b216563a41625
DATA q<>+32(SB)/8, $0x179aa3ebc800ad32
DATA q<>+40(SB)/8, $0x0d0fed35932a6fe2
DATA q<>+48(SB)/8, $0x61198f79ca656578
GLOBL q<>(SB), (RODATA+NOPTR), $56

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x20e8e08f678fe911
...
TEXT ·Butterfly(SB), $8-16
	...
	SBBQ 48(AX), R9
	JCC  l1
	MOVQ $0x412ec4f81b3bd80f, AX
	ADDQ AX, DX
	MOVQ $0x7ab1fff35f234188, AX
	ADCQ AX, CX
	MOVQ $0xa26ef3acfb3962e5, AX
	ADCQ AX, BX
	MOVQ $0xc91b216563a41625, AX
	ADCQ AX, SI
	MOVQ $0x179aa3ebc800ad32, AX
	ADCQ AX, DI
	MOVQ $0x0d0fed35932a6fe2, AX
	ADCQ AX, R8
	MOVQ $0x61198f79ca656578, AX
	ADCQ AX, R9
