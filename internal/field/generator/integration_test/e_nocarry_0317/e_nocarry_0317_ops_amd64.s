...
// modulus q
DATA q<>+0(SB)/8, $0x358f0773704bc5e1
DATA q<>+8(SB)/8, $0x6bfc96cfdf67d37b
DATA q<>+16(SB)/8, $0xda432ab4e0a1486f
DATA q<>+24(SB)/8, $0xa3fe43c696eaac05
DATA q<>+32(SB)/8, $0x18f4ecd2253cffce
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xe2c8505227d0c1df
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x358f0773704bc5e1, CX
	MOVQ    $0x6bfc96cfdf67d37b, BX
	MOVQ    $0xda432ab4e0a1486f, SI
	MOVQ    $0xa3fe43c696eaac05, DI
	MOVQ    $0x18f4ecd2253cffce, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
