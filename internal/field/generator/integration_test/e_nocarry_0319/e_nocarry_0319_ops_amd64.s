...
// modulus q
DATA q<>+0(SB)/8, $0x857d9d14a1a94eb1
DATA q<>+8(SB)/8, $0x427b4e4ddc153da3
DATA q<>+16(SB)/8, $0xb80708a5005d639e
DATA q<>+24(SB)/8, $0xc9d4bda7eefc6d3f
DATA q<>+32(SB)/8, $0x7ef61b6b1c03dfcb
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x029344275e45c5af
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x857d9d14a1a94eb1, CX
	MOVQ    $0x427b4e4ddc153da3, BX
	MOVQ    $0xb80708a5005d639e, SI
	MOVQ    $0xc9d4bda7eefc6d3f, DI
	MOVQ    $0x7ef61b6b1c03dfcb, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
