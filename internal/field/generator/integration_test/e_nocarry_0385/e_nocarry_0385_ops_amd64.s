...
// modulus q
DATA q<>+0(SB)/8, $0x32da32558b777417
DATA q<>+8(SB)/8, $0x8bb62606be36397c
DATA q<>+16(SB)/8, $0x3302552a7355c927
DATA q<>+24(SB)/8, $0xe702be13fcee4885
DATA q<>+32(SB)/8, $0x4128b67eb6efa50b
DATA q<>+40(SB)/8, $0xf8b91eb3ae2e3113
DATA q<>+48(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $56

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x7119af1c519efc59
...
TEXT ·Butterfly(SB), $8-16
	...
	SBBQ 48(AX), R9
	JCC  l1
	MOVQ $0x32da32558b777417, AX
	ADDQ AX, DX
	MOVQ $0x8bb62606be36397c, AX
	ADCQ AX, CX
	MOVQ $0x3302552a7355c927, AX
	ADCQ AX, BX
	MOVQ $0xe702be13fcee4885, AX
	ADCQ AX, SI
	MOVQ $0x4128b67eb6efa50b, AX
	ADCQ AX, DI
	MOVQ $0xf8b91eb3ae2e3113, AX
	ADCQ AX, R8
	MOVQ $1, AX
	ADCQ AX, R9
