...
// modulus q
DATA q<>+0(SB)/8, $0x0d20fb5bb81a89a5
DATA q<>+8(SB)/8, $0xe96ebedfa470f4b5
DATA q<>+16(SB)/8, $0xc9a48f30cfcbc001
DATA q<>+24(SB)/8, $0xa5dd7cb04cc30a1f
DATA q<>+32(SB)/8, $0x4d8ae409b4d8c641
DATA q<>+40(SB)/8, $0x1ebc9ddcdae2ff71
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x726a25adf276c9d3
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x0d20fb5bb81a89a5, CX
	MOVQ    $0xe96ebedfa470f4b5, BX
	MOVQ    $0xc9a48f30cfcbc001, SI
	MOVQ    $0xa5dd7cb04cc30a1f, DI
	MOVQ    $0x4d8ae409b4d8c641, R8
	MOVQ    $0x1ebc9ddcdae2ff71, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
