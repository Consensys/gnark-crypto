...
// modulus q
DATA q<>+0(SB)/8, $0xdf1fc45754c2db43
DATA q<>+8(SB)/8, $0xe67897c653fda2eb
DATA q<>+16(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xcc0e144c1c4cf695
...
TEXT ·mul(SB), $24-24
	...
	// the algorithm is described in the e_nocarry_0129.Mul declaration (.go)
