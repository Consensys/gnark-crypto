...
// modulus q
DATA q<>+0(SB)/8, $0x3da2a89eca29294d
DATA q<>+8(SB)/8, $0xd27b853964b8f2a4
DATA q<>+16(SB)/8, $0xae9997fb4bd48881
DATA q<>+24(SB)/8, $0xb458e85ed5515998
DATA q<>+32(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xaed80a782b49c87b
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x3da2a89eca29294d, CX
	MOVQ    $0xd27b853964b8f2a4, BX
	MOVQ    $0xae9997fb4bd48881, SI
	MOVQ    $0xb458e85ed5515998, DI
	MOVQ    $1, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
