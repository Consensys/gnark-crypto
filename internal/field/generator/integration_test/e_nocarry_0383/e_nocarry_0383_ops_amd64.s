...
// modulus q
DATA q<>+0(SB)/8, $0xf7b5ad661f7f63c7
DATA q<>+8(SB)/8, $0x4f0b766102a042e5
DATA q<>+16(SB)/8, $0x33fd5285d8f6e63d
DATA q<>+24(SB)/8, $0x58658165d1b07d10
DATA q<>+32(SB)/8, $0xf0d14949c1e69d78
DATA q<>+40(SB)/8, $0x74511f8dd5571849
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x5f8e457bb9729209
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xf7b5ad661f7f63c7, CX
	MOVQ    $0x4f0b766102a042e5, BX
	MOVQ    $0x33fd5285d8f6e63d, SI
	MOVQ    $0x58658165d1b07d10, DI
	MOVQ    $0xf0d14949c1e69d78, R8
	MOVQ    $0x74511f8dd5571849, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
