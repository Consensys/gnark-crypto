...
// modulus q
DATA q<>+0(SB)/8, $0xec89bc42ee02b3e7
DATA q<>+8(SB)/8, $0x7bf4d82a0a06c2be
DATA q<>+16(SB)/8, $0x381579b98b12b707
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x794560acb0bf5029
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xec89bc42ee02b3e7, R10
	MOVQ    $0x7bf4d82a0a06c2be, R11
	MOVQ    $0x381579b98b12b707, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
