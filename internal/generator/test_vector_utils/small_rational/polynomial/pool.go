...
type largeArr = [maxNForLargePool]small_rational.SmallRational
type smallArr = [maxNForSmallPool]small_rational.SmallRational
...
func Make(n int) []small_rational.SmallRational {
...
func Dump(arrs ...[]small_rational.SmallRational) int {
	cnt := 0
...
func ptr(m []small_rational.SmallRational) unsafe.Pointer {
