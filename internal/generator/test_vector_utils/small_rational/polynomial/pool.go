...
type enormousArray = [1 << 32]small_rational.SmallRational // semantic necessity
...
func (p *Pool) Dump(slices ...[]small_rational.SmallRational) {
...
func getDataPointer(slice []small_rational.SmallRational) unsafe.Pointer {
