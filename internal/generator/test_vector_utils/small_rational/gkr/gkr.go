...
func collateExtrapolate(s []polynomial.MultiLin, D int, w *utils.WorkerPool, p *polynomial.Pool) [][]small_rational.SmallRational {
	res := make([][]small_rational.SmallRational, D)
...
type computeGjResult struct {
	sum small_rational.SmallRational
	d   int
}
...
type safeStack struct {
	...
	slice     []small_rational.SmallRational
}

func (s *safeStack) push(x small_rational.SmallRational) {
	s.writeLock.Lock()
