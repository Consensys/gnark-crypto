...
type LazyClaims interface {
	...
	VerifyFinalEval(r []small_rational.SmallRational, combinationCoeff small_rational.SmallRational, purportedValue small_rational.SmallRational, proof interface{}) bool
}
...
type ArithmeticTranscript interface {
	Update(...interface{})
	Next(...interface{}) small_rational.SmallRational
	NextN(int, ...interface{}) []small_rational.SmallRational
}
...
func (m *MessageCounter) Next(i ...interface{}) (challenge small_rational.SmallRational) {
...
func (m *MessageCounter) NextN(N int, i ...interface{}) (challenges []small_rational.SmallRational) {
	challenges = make([]small_rational.SmallRational, N)
	for n := 0; n < N; n++ {
