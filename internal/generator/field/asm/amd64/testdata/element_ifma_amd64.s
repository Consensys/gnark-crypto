...
loop_1:
	...
	MOVQ         $0x36d9, AX // Barrett mu constant
	...
	VPMULUDQ Z25, Z5, Z6  // Z6 = k * q[0]
	VPMULUDQ Z26, Z5, Z7  // Z7 = k * q[1]
	VPMULUDQ Z27, Z5, Z8  // Z8 = k * q[2]
	VPMULUDQ Z28, Z5, Z9  // Z9 = k * q[3]
	VPMULUDQ Z29, Z5, Z10 // Z10 = k * q[4]

	// Subtract k*q with carry propagation
	VPSRLQ $52, Z6, Z15  // Z15 = carry from k*q[0]
	VPANDQ Z31, Z6, Z6   // Z6 = k*q[0] & mask52
	VPSUBQ Z6, Z0, Z0    // Z0 -= k*q[0]_low
	VPADDQ Z15, Z7, Z7   // Z7 = k*q[1] + carry
	VPSRLQ $52, Z7, Z15
	VPANDQ Z31, Z7, Z7
	VPSUBQ Z7, Z1, Z1
	VPADDQ Z15, Z8, Z8
