...
type G2CoordType = fp.Element

// G2Jac is a point with G2CoordType coordinates
type G2Jac struct {
	X, Y, Z G2CoordType
}
...
func (p *g2JacExtended) mAdd(a *G2Affine) *g2JacExtended {
	...
	var U2, S2, P, R, PP, PPP, Q, Q2, RR, X3, Y3 G2CoordType
