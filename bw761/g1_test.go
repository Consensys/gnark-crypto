...
func TestG1Serialization(t *testing.T) {
	...
	properties.Property("[BW761] Affine SetBytes(Bytes(compressed = false)) should stay the same", prop.ForAll(
	...
	properties.Property("[BW761] Affine SetBytes(Bytes(compressed = true)) should stay the same", prop.ForAll(
		func(a fp.Element) bool {
			var start, end G1Affine
			var ab big.Int
