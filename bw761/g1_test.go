...
func TestG1AffineIsOnCurve(t *testing.T) {
	...
	genFuzz1 := GenFp()
	properties.Property("[BW761] g1Gen (affine) should be on the curve", prop.ForAll(
	...
	properties.Property("[BW761] g1Gen (Jacobian) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
...
func TestG1AffineSerialization(t *testing.T) {
	...
	properties.Property("[BW761] Affine SetBytes(RawBytes) should stay the same", prop.ForAll(
	...
	properties.Property("[BW761] Affine SetBytes(Bytes()) should stay the same", prop.ForAll(
		func(a fp.Element) bool {
			var start, end G1Affine
			var ab big.Int
