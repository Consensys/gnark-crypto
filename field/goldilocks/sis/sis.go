...
type RSis struct {
	...
	smallFFT      func([]goldilocks.Element)
	twiddlesCoset []goldilocks.Element // used in conjunction with the smallFFT;
}
...
func NewRSis(seed int64, logTwoDegree, logTwoBound, maxNbElementsToHash int) (*RSis, error) {
	...
	r.smallFFT = func(p []goldilocks.Element) {
	...
	if r.Domain.Cardinality == 64 {
		...
		r.smallFFT = func(a []goldilocks.Element) {
