...
// fft64 unrolls an FFT with domain.Cardinality == 64
...
func fft64(a []goldilocks.Element, twiddlesCoset []goldilocks.Element) {
	...
	goldilocks.Butterfly(&a[0], &a[32])
	goldilocks.Butterfly(&a[1], &a[33])
	goldilocks.Butterfly(&a[2], &a[34])
	goldilocks.Butterfly(&a[3], &a[35])
	goldilocks.Butterfly(&a[4], &a[36])
	goldilocks.Butterfly(&a[5], &a[37])
	goldilocks.Butterfly(&a[6], &a[38])
	goldilocks.Butterfly(&a[7], &a[39])
	goldilocks.Butterfly(&a[8], &a[40])
	goldilocks.Butterfly(&a[9], &a[41])
	goldilocks.Butterfly(&a[10], &a[42])
	goldilocks.Butterfly(&a[11], &a[43])
	goldilocks.Butterfly(&a[12], &a[44])
	goldilocks.Butterfly(&a[13], &a[45])
	goldilocks.Butterfly(&a[14], &a[46])
	goldilocks.Butterfly(&a[15], &a[47])
	goldilocks.Butterfly(&a[16], &a[48])
	goldilocks.Butterfly(&a[17], &a[49])
	goldilocks.Butterfly(&a[18], &a[50])
	goldilocks.Butterfly(&a[19], &a[51])
	goldilocks.Butterfly(&a[20], &a[52])
	goldilocks.Butterfly(&a[21], &a[53])
	goldilocks.Butterfly(&a[22], &a[54])
	goldilocks.Butterfly(&a[23], &a[55])
	goldilocks.Butterfly(&a[24], &a[56])
	goldilocks.Butterfly(&a[25], &a[57])
	goldilocks.Butterfly(&a[26], &a[58])
	goldilocks.Butterfly(&a[27], &a[59])
	goldilocks.Butterfly(&a[28], &a[60])
	goldilocks.Butterfly(&a[29], &a[61])
	goldilocks.Butterfly(&a[30], &a[62])
	goldilocks.Butterfly(&a[31], &a[63])
	...
	goldilocks.Butterfly(&a[0], &a[16])
	goldilocks.Butterfly(&a[1], &a[17])
	goldilocks.Butterfly(&a[2], &a[18])
	goldilocks.Butterfly(&a[3], &a[19])
	goldilocks.Butterfly(&a[4], &a[20])
	goldilocks.Butterfly(&a[5], &a[21])
	goldilocks.Butterfly(&a[6], &a[22])
	goldilocks.Butterfly(&a[7], &a[23])
	goldilocks.Butterfly(&a[8], &a[24])
	goldilocks.Butterfly(&a[9], &a[25])
	goldilocks.Butterfly(&a[10], &a[26])
	goldilocks.Butterfly(&a[11], &a[27])
	goldilocks.Butterfly(&a[12], &a[28])
	goldilocks.Butterfly(&a[13], &a[29])
	goldilocks.Butterfly(&a[14], &a[30])
	goldilocks.Butterfly(&a[15], &a[31])
	goldilocks.Butterfly(&a[32], &a[48])
	goldilocks.Butterfly(&a[33], &a[49])
	goldilocks.Butterfly(&a[34], &a[50])
	goldilocks.Butterfly(&a[35], &a[51])
	goldilocks.Butterfly(&a[36], &a[52])
	goldilocks.Butterfly(&a[37], &a[53])
	goldilocks.Butterfly(&a[38], &a[54])
	goldilocks.Butterfly(&a[39], &a[55])
	goldilocks.Butterfly(&a[40], &a[56])
	goldilocks.Butterfly(&a[41], &a[57])
	goldilocks.Butterfly(&a[42], &a[58])
	goldilocks.Butterfly(&a[43], &a[59])
	goldilocks.Butterfly(&a[44], &a[60])
	goldilocks.Butterfly(&a[45], &a[61])
	goldilocks.Butterfly(&a[46], &a[62])
	goldilocks.Butterfly(&a[47], &a[63])
	...
	goldilocks.Butterfly(&a[0], &a[8])
	goldilocks.Butterfly(&a[1], &a[9])
	goldilocks.Butterfly(&a[2], &a[10])
	goldilocks.Butterfly(&a[3], &a[11])
	goldilocks.Butterfly(&a[4], &a[12])
	goldilocks.Butterfly(&a[5], &a[13])
	goldilocks.Butterfly(&a[6], &a[14])
	goldilocks.Butterfly(&a[7], &a[15])
	goldilocks.Butterfly(&a[16], &a[24])
	goldilocks.Butterfly(&a[17], &a[25])
	goldilocks.Butterfly(&a[18], &a[26])
	goldilocks.Butterfly(&a[19], &a[27])
	goldilocks.Butterfly(&a[20], &a[28])
	goldilocks.Butterfly(&a[21], &a[29])
	goldilocks.Butterfly(&a[22], &a[30])
	goldilocks.Butterfly(&a[23], &a[31])
	goldilocks.Butterfly(&a[32], &a[40])
	goldilocks.Butterfly(&a[33], &a[41])
	goldilocks.Butterfly(&a[34], &a[42])
	goldilocks.Butterfly(&a[35], &a[43])
	goldilocks.Butterfly(&a[36], &a[44])
	goldilocks.Butterfly(&a[37], &a[45])
	goldilocks.Butterfly(&a[38], &a[46])
	goldilocks.Butterfly(&a[39], &a[47])
	goldilocks.Butterfly(&a[48], &a[56])
	goldilocks.Butterfly(&a[49], &a[57])
	goldilocks.Butterfly(&a[50], &a[58])
	goldilocks.Butterfly(&a[51], &a[59])
	goldilocks.Butterfly(&a[52], &a[60])
	goldilocks.Butterfly(&a[53], &a[61])
	goldilocks.Butterfly(&a[54], &a[62])
	goldilocks.Butterfly(&a[55], &a[63])
	...
	goldilocks.Butterfly(&a[0], &a[4])
	goldilocks.Butterfly(&a[1], &a[5])
	goldilocks.Butterfly(&a[2], &a[6])
	goldilocks.Butterfly(&a[3], &a[7])
	goldilocks.Butterfly(&a[8], &a[12])
	goldilocks.Butterfly(&a[9], &a[13])
	goldilocks.Butterfly(&a[10], &a[14])
	goldilocks.Butterfly(&a[11], &a[15])
	goldilocks.Butterfly(&a[16], &a[20])
	goldilocks.Butterfly(&a[17], &a[21])
	goldilocks.Butterfly(&a[18], &a[22])
	goldilocks.Butterfly(&a[19], &a[23])
	goldilocks.Butterfly(&a[24], &a[28])
	goldilocks.Butterfly(&a[25], &a[29])
	goldilocks.Butterfly(&a[26], &a[30])
	goldilocks.Butterfly(&a[27], &a[31])
	goldilocks.Butterfly(&a[32], &a[36])
	goldilocks.Butterfly(&a[33], &a[37])
	goldilocks.Butterfly(&a[34], &a[38])
	goldilocks.Butterfly(&a[35], &a[39])
	goldilocks.Butterfly(&a[40], &a[44])
	goldilocks.Butterfly(&a[41], &a[45])
	goldilocks.Butterfly(&a[42], &a[46])
	goldilocks.Butterfly(&a[43], &a[47])
	goldilocks.Butterfly(&a[48], &a[52])
	goldilocks.Butterfly(&a[49], &a[53])
	goldilocks.Butterfly(&a[50], &a[54])
	goldilocks.Butterfly(&a[51], &a[55])
	goldilocks.Butterfly(&a[56], &a[60])
	goldilocks.Butterfly(&a[57], &a[61])
	goldilocks.Butterfly(&a[58], &a[62])
	goldilocks.Butterfly(&a[59], &a[63])
	...
	goldilocks.Butterfly(&a[0], &a[2])
	goldilocks.Butterfly(&a[1], &a[3])
	goldilocks.Butterfly(&a[4], &a[6])
	goldilocks.Butterfly(&a[5], &a[7])
	goldilocks.Butterfly(&a[8], &a[10])
	goldilocks.Butterfly(&a[9], &a[11])
	goldilocks.Butterfly(&a[12], &a[14])
	goldilocks.Butterfly(&a[13], &a[15])
	goldilocks.Butterfly(&a[16], &a[18])
	goldilocks.Butterfly(&a[17], &a[19])
	goldilocks.Butterfly(&a[20], &a[22])
	goldilocks.Butterfly(&a[21], &a[23])
	goldilocks.Butterfly(&a[24], &a[26])
	goldilocks.Butterfly(&a[25], &a[27])
	goldilocks.Butterfly(&a[28], &a[30])
	goldilocks.Butterfly(&a[29], &a[31])
	goldilocks.Butterfly(&a[32], &a[34])
	goldilocks.Butterfly(&a[33], &a[35])
	goldilocks.Butterfly(&a[36], &a[38])
	goldilocks.Butterfly(&a[37], &a[39])
	goldilocks.Butterfly(&a[40], &a[42])
	goldilocks.Butterfly(&a[41], &a[43])
	goldilocks.Butterfly(&a[44], &a[46])
	goldilocks.Butterfly(&a[45], &a[47])
	goldilocks.Butterfly(&a[48], &a[50])
	goldilocks.Butterfly(&a[49], &a[51])
	goldilocks.Butterfly(&a[52], &a[54])
	goldilocks.Butterfly(&a[53], &a[55])
	goldilocks.Butterfly(&a[56], &a[58])
	goldilocks.Butterfly(&a[57], &a[59])
	goldilocks.Butterfly(&a[60], &a[62])
	goldilocks.Butterfly(&a[61], &a[63])
	...
	goldilocks.Butterfly(&a[0], &a[1])
	goldilocks.Butterfly(&a[2], &a[3])
	goldilocks.Butterfly(&a[4], &a[5])
	goldilocks.Butterfly(&a[6], &a[7])
	goldilocks.Butterfly(&a[8], &a[9])
	goldilocks.Butterfly(&a[10], &a[11])
	goldilocks.Butterfly(&a[12], &a[13])
	goldilocks.Butterfly(&a[14], &a[15])
	goldilocks.Butterfly(&a[16], &a[17])
	goldilocks.Butterfly(&a[18], &a[19])
	goldilocks.Butterfly(&a[20], &a[21])
	goldilocks.Butterfly(&a[22], &a[23])
	goldilocks.Butterfly(&a[24], &a[25])
	goldilocks.Butterfly(&a[26], &a[27])
	goldilocks.Butterfly(&a[28], &a[29])
	goldilocks.Butterfly(&a[30], &a[31])
	goldilocks.Butterfly(&a[32], &a[33])
	goldilocks.Butterfly(&a[34], &a[35])
	goldilocks.Butterfly(&a[36], &a[37])
	goldilocks.Butterfly(&a[38], &a[39])
	goldilocks.Butterfly(&a[40], &a[41])
	goldilocks.Butterfly(&a[42], &a[43])
	goldilocks.Butterfly(&a[44], &a[45])
	goldilocks.Butterfly(&a[46], &a[47])
	goldilocks.Butterfly(&a[48], &a[49])
	goldilocks.Butterfly(&a[50], &a[51])
	goldilocks.Butterfly(&a[52], &a[53])
	goldilocks.Butterfly(&a[54], &a[55])
	goldilocks.Butterfly(&a[56], &a[57])
	goldilocks.Butterfly(&a[58], &a[59])
	goldilocks.Butterfly(&a[60], &a[61])
	goldilocks.Butterfly(&a[62], &a[63])
}
...
func precomputeTwiddlesCoset(generator, shifter goldilocks.Element) []goldilocks.Element {
	toReturn := make([]goldilocks.Element, 63)
	var r, s goldilocks.Element
	e := new(big.Int)
