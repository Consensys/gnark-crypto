...
func DivideByXMinusOne(a *Polynomial, domains [2]*fft.Domain) (*Polynomial, error) {
	...
	coeffs := make([]goldilocks.Element, a.coefficients.Len())
...
func evaluateXnMinusOneDomainBigCoset(domains [2]*fft.Domain) []goldilocks.Element {

	ratio := domains[1].Cardinality / domains[0].Cardinality

	res := make([]goldilocks.Element, ratio)
	...
	res = goldilocks.BatchInvert(res)
