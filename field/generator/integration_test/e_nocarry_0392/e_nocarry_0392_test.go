...
var benchRese_nocarry_0392 e_nocarry_0392

func BenchmarkE_nocarry_0392SetBytes(b *testing.B) {
	var x e_nocarry_0392
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0392MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0392.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0392)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0392)
		}
	})
}

func BenchmarkE_nocarry_0392Inverse(b *testing.B) {
	var x e_nocarry_0392
	x.SetRandom()
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0392Butterfly(b *testing.B) {
	var x e_nocarry_0392
	x.SetRandom()
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0392)
	}
}

func BenchmarkE_nocarry_0392Exp(b *testing.B) {
	var x e_nocarry_0392
	x.SetRandom()
	benchRese_nocarry_0392.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0392Double(b *testing.B) {
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Double(&benchRese_nocarry_0392)
	}
}

func BenchmarkE_nocarry_0392Add(b *testing.B) {
	var x e_nocarry_0392
	x.SetRandom()
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Add(&x, &benchRese_nocarry_0392)
	}
}

func BenchmarkE_nocarry_0392Sub(b *testing.B) {
	var x e_nocarry_0392
	x.SetRandom()
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Sub(&x, &benchRese_nocarry_0392)
	}
}

func BenchmarkE_nocarry_0392Neg(b *testing.B) {
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Neg(&benchRese_nocarry_0392)
	}
}

func BenchmarkE_nocarry_0392Div(b *testing.B) {
	var x e_nocarry_0392
	x.SetRandom()
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Div(&x, &benchRese_nocarry_0392)
	}
}

func BenchmarkE_nocarry_0392FromMont(b *testing.B) {
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.FromMont()
	}
}

func BenchmarkE_nocarry_0392ToMont(b *testing.B) {
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.ToMont()
	}
}
func BenchmarkE_nocarry_0392Square(b *testing.B) {
	benchRese_nocarry_0392.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Square(&benchRese_nocarry_0392)
	}
}

func BenchmarkE_nocarry_0392Sqrt(b *testing.B) {
	var a e_nocarry_0392
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0392Mul(b *testing.B) {
	x := e_nocarry_0392{
		4910846774276381896,
		1991144233448476198,
	...
	benchRese_nocarry_0392.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Mul(&benchRese_nocarry_0392, &x)
	}
}

func BenchmarkE_nocarry_0392Cmp(b *testing.B) {
	x := e_nocarry_0392{
		4910846774276381896,
		1991144233448476198,
		13508136688007922915,
	...
	benchRese_nocarry_0392 = x
	benchRese_nocarry_0392[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0392.Cmp(&x)
	}
}

func TestE_nocarry_0392Cmp(t *testing.T) {
	var x, y e_nocarry_0392
...
func TestE_nocarry_0392IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0392
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0392

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0392{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0392
	one.SetOne()
	e.Sub(&qe_nocarry_0392, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0392{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0392{0, uint64(i)})
	}
...
func TestE_nocarry_0392NegZero(t *testing.T) {
	var a, b e_nocarry_0392
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0392Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0392, len(staticTestValues))
...
func TestE_nocarry_0392Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0392) bool {
			var b e_nocarry_0392
...
func TestE_nocarry_0392InverseExp(t *testing.T) {
...
func TestE_nocarry_0392MulByConstants(t *testing.T) {
...
func TestE_nocarry_0392Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0392) bool {
...
func TestE_nocarry_0392LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0392Halve(t *testing.T) {
...
func TestE_nocarry_0392FromMont(t *testing.T) {
...
type testPaire_nocarry_0392 struct {
	element e_nocarry_0392
	bigint  big.Int
}

func (z *e_nocarry_0392) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0392[6] {
		return true
	}
	if z[6] < qe_nocarry_0392[6] {
		return false
	...
	return z[0] >= qe_nocarry_0392[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0392

		g.element = e_nocarry_0392{
		...
		if qe_nocarry_0392[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0392[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0392 {
			var g e_nocarry_0392
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0392[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0392[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0392[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0392[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0392[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0392[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0392[6], carry)
...
func Benchmarke_nocarry_0392InverseNew(b *testing.B) {
	var x e_nocarry_0392
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0392
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0392
		var xInv e_nocarry_0392
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0392
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0392
...
func testLinearComb(t *testing.T, x *e_nocarry_0392, xC int64, y *e_nocarry_0392, yC int64) {
	...
	var z e_nocarry_0392
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0392, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0392
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0392, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0392
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0392, xHi uint64) {
	var res e_nocarry_0392
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0392) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0392) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0392, c int64, result *e_nocarry_0392, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0392) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0392) uint64 {
