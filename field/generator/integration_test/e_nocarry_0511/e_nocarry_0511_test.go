...
var benchRese_nocarry_0511 e_nocarry_0511

func BenchmarkE_nocarry_0511SetBytes(b *testing.B) {
	var x e_nocarry_0511
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0511MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0511.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0511)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0511)
		}
	})
}

func BenchmarkE_nocarry_0511Inverse(b *testing.B) {
	var x e_nocarry_0511
	x.SetRandom()
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0511Butterfly(b *testing.B) {
	var x e_nocarry_0511
	x.SetRandom()
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0511)
	}
}

func BenchmarkE_nocarry_0511Exp(b *testing.B) {
	var x e_nocarry_0511
	x.SetRandom()
	benchRese_nocarry_0511.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0511Double(b *testing.B) {
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Double(&benchRese_nocarry_0511)
	}
}

func BenchmarkE_nocarry_0511Add(b *testing.B) {
	var x e_nocarry_0511
	x.SetRandom()
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Add(&x, &benchRese_nocarry_0511)
	}
}

func BenchmarkE_nocarry_0511Sub(b *testing.B) {
	var x e_nocarry_0511
	x.SetRandom()
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Sub(&x, &benchRese_nocarry_0511)
	}
}

func BenchmarkE_nocarry_0511Neg(b *testing.B) {
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Neg(&benchRese_nocarry_0511)
	}
}

func BenchmarkE_nocarry_0511Div(b *testing.B) {
	var x e_nocarry_0511
	x.SetRandom()
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Div(&x, &benchRese_nocarry_0511)
	}
}

func BenchmarkE_nocarry_0511FromMont(b *testing.B) {
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.FromMont()
	}
}

func BenchmarkE_nocarry_0511ToMont(b *testing.B) {
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.ToMont()
	}
}
func BenchmarkE_nocarry_0511Square(b *testing.B) {
	benchRese_nocarry_0511.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Square(&benchRese_nocarry_0511)
	}
}

func BenchmarkE_nocarry_0511Sqrt(b *testing.B) {
	var a e_nocarry_0511
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0511Mul(b *testing.B) {
	x := e_nocarry_0511{
	...
	benchRese_nocarry_0511.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Mul(&benchRese_nocarry_0511, &x)
	}
}

func BenchmarkE_nocarry_0511Cmp(b *testing.B) {
	x := e_nocarry_0511{
		14278598335961970820,
		6391734855617854929,
		10010869198272896055,
	...
	benchRese_nocarry_0511 = x
	benchRese_nocarry_0511[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0511.Cmp(&x)
	}
}

func TestE_nocarry_0511Cmp(t *testing.T) {
	var x, y e_nocarry_0511
...
func TestE_nocarry_0511IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0511
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0511

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0511{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0511
	one.SetOne()
	e.Sub(&qe_nocarry_0511, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0511{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0511{0, uint64(i)})
	}
...
func TestE_nocarry_0511NegZero(t *testing.T) {
	var a, b e_nocarry_0511
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0511Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0511, len(staticTestValues))
...
func TestE_nocarry_0511Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0511) bool {
			var b e_nocarry_0511
...
func TestE_nocarry_0511InverseExp(t *testing.T) {
...
func TestE_nocarry_0511MulByConstants(t *testing.T) {
...
func TestE_nocarry_0511Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0511) bool {
...
func TestE_nocarry_0511LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0511Halve(t *testing.T) {
...
func TestE_nocarry_0511FromMont(t *testing.T) {
...
type testPaire_nocarry_0511 struct {
	element e_nocarry_0511
	bigint  big.Int
}

func (z *e_nocarry_0511) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0511[7] {
		return true
	}
	if z[7] < qe_nocarry_0511[7] {
		return false
	...
	return z[0] >= qe_nocarry_0511[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0511

		g.element = e_nocarry_0511{
		...
		if qe_nocarry_0511[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0511[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0511 {
			var g e_nocarry_0511
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0511[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0511[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0511[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0511[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0511[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0511[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0511[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0511[7], carry)
...
func Benchmarke_nocarry_0511InverseNew(b *testing.B) {
	var x e_nocarry_0511
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0511
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0511
		var xInv e_nocarry_0511
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0511
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0511
...
func testLinearComb(t *testing.T, x *e_nocarry_0511, xC int64, y *e_nocarry_0511, yC int64) {
	...
	var z e_nocarry_0511
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0511, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0511
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0511, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0511
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0511, xHi uint64) {
	var res e_nocarry_0511
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0511) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0511) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0511, c int64, result *e_nocarry_0511, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0511) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0511) uint64 {
