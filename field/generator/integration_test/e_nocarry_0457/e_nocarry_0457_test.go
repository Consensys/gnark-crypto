...
var benchRese_nocarry_0457 e_nocarry_0457

func BenchmarkE_nocarry_0457SetBytes(b *testing.B) {
	var x e_nocarry_0457
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0457MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0457.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0457)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0457)
		}
	})
}

func BenchmarkE_nocarry_0457Inverse(b *testing.B) {
	var x e_nocarry_0457
	x.SetRandom()
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0457Butterfly(b *testing.B) {
	var x e_nocarry_0457
	x.SetRandom()
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0457)
	}
}

func BenchmarkE_nocarry_0457Exp(b *testing.B) {
	var x e_nocarry_0457
	x.SetRandom()
	benchRese_nocarry_0457.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0457Double(b *testing.B) {
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Double(&benchRese_nocarry_0457)
	}
}

func BenchmarkE_nocarry_0457Add(b *testing.B) {
	var x e_nocarry_0457
	x.SetRandom()
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Add(&x, &benchRese_nocarry_0457)
	}
}

func BenchmarkE_nocarry_0457Sub(b *testing.B) {
	var x e_nocarry_0457
	x.SetRandom()
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Sub(&x, &benchRese_nocarry_0457)
	}
}

func BenchmarkE_nocarry_0457Neg(b *testing.B) {
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Neg(&benchRese_nocarry_0457)
	}
}

func BenchmarkE_nocarry_0457Div(b *testing.B) {
	var x e_nocarry_0457
	x.SetRandom()
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Div(&x, &benchRese_nocarry_0457)
	}
}

func BenchmarkE_nocarry_0457FromMont(b *testing.B) {
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.FromMont()
	}
}

func BenchmarkE_nocarry_0457ToMont(b *testing.B) {
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.ToMont()
	}
}
func BenchmarkE_nocarry_0457Square(b *testing.B) {
	benchRese_nocarry_0457.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Square(&benchRese_nocarry_0457)
	}
}

func BenchmarkE_nocarry_0457Sqrt(b *testing.B) {
	var a e_nocarry_0457
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0457Mul(b *testing.B) {
	x := e_nocarry_0457{
	...
	benchRese_nocarry_0457.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Mul(&benchRese_nocarry_0457, &x)
	}
}

func BenchmarkE_nocarry_0457Cmp(b *testing.B) {
	x := e_nocarry_0457{
		17855686353974333021,
		3800287242324919410,
		8842134777267794832,
	...
	benchRese_nocarry_0457 = x
	benchRese_nocarry_0457[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0457.Cmp(&x)
	}
}

func TestE_nocarry_0457Cmp(t *testing.T) {
	var x, y e_nocarry_0457
...
func TestE_nocarry_0457IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0457
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0457

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0457{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0457
	one.SetOne()
	e.Sub(&qe_nocarry_0457, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0457{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0457{0, uint64(i)})
	}
...
func TestE_nocarry_0457NegZero(t *testing.T) {
	var a, b e_nocarry_0457
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0457Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0457, len(staticTestValues))
...
func TestE_nocarry_0457Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0457) bool {
			var b e_nocarry_0457
...
func TestE_nocarry_0457InverseExp(t *testing.T) {
...
func TestE_nocarry_0457MulByConstants(t *testing.T) {
...
func TestE_nocarry_0457Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0457) bool {
...
func TestE_nocarry_0457LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0457Halve(t *testing.T) {
...
func TestE_nocarry_0457FromMont(t *testing.T) {
...
type testPaire_nocarry_0457 struct {
	element e_nocarry_0457
	bigint  big.Int
}

func (z *e_nocarry_0457) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0457[7] {
		return true
	}
	if z[7] < qe_nocarry_0457[7] {
		return false
	...
	return z[0] >= qe_nocarry_0457[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0457

		g.element = e_nocarry_0457{
		...
		if qe_nocarry_0457[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0457[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0457 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0457[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0457[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0457[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0457[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0457[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0457[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0457[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0457[7], carry)
...
func Benchmarke_nocarry_0457InverseNew(b *testing.B) {
	var x e_nocarry_0457
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0457
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0457
		var xInv e_nocarry_0457
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0457
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0457
...
func testLinearComb(t *testing.T, x *e_nocarry_0457, xC int64, y *e_nocarry_0457, yC int64) {
	...
	var z e_nocarry_0457
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0457, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0457
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0457, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0457
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0457, xHi uint64) {
	var res e_nocarry_0457
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0457) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0457) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0457, c int64, result *e_nocarry_0457, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0457) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0457) uint64 {
