...
var benchRese_nocarry_0496 e_nocarry_0496

func BenchmarkE_nocarry_0496SetBytes(b *testing.B) {
	var x e_nocarry_0496
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0496MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0496.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0496)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0496)
		}
	})
}

func BenchmarkE_nocarry_0496Inverse(b *testing.B) {
	var x e_nocarry_0496
	x.SetRandom()
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0496Butterfly(b *testing.B) {
	var x e_nocarry_0496
	x.SetRandom()
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0496)
	}
}

func BenchmarkE_nocarry_0496Exp(b *testing.B) {
	var x e_nocarry_0496
	x.SetRandom()
	benchRese_nocarry_0496.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0496Double(b *testing.B) {
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Double(&benchRese_nocarry_0496)
	}
}

func BenchmarkE_nocarry_0496Add(b *testing.B) {
	var x e_nocarry_0496
	x.SetRandom()
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Add(&x, &benchRese_nocarry_0496)
	}
}

func BenchmarkE_nocarry_0496Sub(b *testing.B) {
	var x e_nocarry_0496
	x.SetRandom()
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Sub(&x, &benchRese_nocarry_0496)
	}
}

func BenchmarkE_nocarry_0496Neg(b *testing.B) {
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Neg(&benchRese_nocarry_0496)
	}
}

func BenchmarkE_nocarry_0496Div(b *testing.B) {
	var x e_nocarry_0496
	x.SetRandom()
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Div(&x, &benchRese_nocarry_0496)
	}
}

func BenchmarkE_nocarry_0496FromMont(b *testing.B) {
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.FromMont()
	}
}

func BenchmarkE_nocarry_0496ToMont(b *testing.B) {
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.ToMont()
	}
}
func BenchmarkE_nocarry_0496Square(b *testing.B) {
	benchRese_nocarry_0496.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Square(&benchRese_nocarry_0496)
	}
}

func BenchmarkE_nocarry_0496Sqrt(b *testing.B) {
	var a e_nocarry_0496
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0496Mul(b *testing.B) {
	x := e_nocarry_0496{
	...
	benchRese_nocarry_0496.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Mul(&benchRese_nocarry_0496, &x)
	}
}

func BenchmarkE_nocarry_0496Cmp(b *testing.B) {
	x := e_nocarry_0496{
		13837485961024031641,
		16953410501710324511,
		979321605461449779,
	...
	benchRese_nocarry_0496 = x
	benchRese_nocarry_0496[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0496.Cmp(&x)
	}
}

func TestE_nocarry_0496Cmp(t *testing.T) {
	var x, y e_nocarry_0496
...
func TestE_nocarry_0496IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0496
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0496

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0496{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0496
	one.SetOne()
	e.Sub(&qe_nocarry_0496, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0496{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0496{0, uint64(i)})
	}
...
func TestE_nocarry_0496NegZero(t *testing.T) {
	var a, b e_nocarry_0496
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0496Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0496, len(staticTestValues))
...
func TestE_nocarry_0496Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0496) bool {
			var b e_nocarry_0496
...
func TestE_nocarry_0496InverseExp(t *testing.T) {
...
func TestE_nocarry_0496MulByConstants(t *testing.T) {
...
func TestE_nocarry_0496Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0496) bool {
...
func TestE_nocarry_0496LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0496Halve(t *testing.T) {
...
func TestE_nocarry_0496FromMont(t *testing.T) {
...
type testPaire_nocarry_0496 struct {
	element e_nocarry_0496
	bigint  big.Int
}

func (z *e_nocarry_0496) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0496[7] {
		return true
	}
	if z[7] < qe_nocarry_0496[7] {
		return false
	...
	return z[0] >= qe_nocarry_0496[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0496

		g.element = e_nocarry_0496{
		...
		if qe_nocarry_0496[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0496[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0496 {
			var g e_nocarry_0496
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0496[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0496[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0496[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0496[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0496[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0496[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0496[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0496[7], carry)
...
func Benchmarke_nocarry_0496InverseNew(b *testing.B) {
	var x e_nocarry_0496
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0496
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0496
		var xInv e_nocarry_0496
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0496
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0496
...
func testLinearComb(t *testing.T, x *e_nocarry_0496, xC int64, y *e_nocarry_0496, yC int64) {
	...
	var z e_nocarry_0496
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0496, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0496
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0496, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0496
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0496, xHi uint64) {
	var res e_nocarry_0496
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0496) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0496) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0496, c int64, result *e_nocarry_0496, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0496) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0496) uint64 {
