...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x400cdf09c8edaaab, R14
	ADDQ R14, AX
	MOVQ $0x61d00d7f557a53a2, R14
	ADCQ R14, DX
	MOVQ $0xc104244527ee6cb7, R14
	ADCQ R14, CX
	MOVQ $0xc70344fdc6507296, R14
	ADCQ R14, BX
	MOVQ $0x2129ded686b19631, R14
	ADCQ R14, SI
	MOVQ $0x74a61f4fb716264b, R14
	ADCQ R14, DI
	MOVQ $0xcebfb77b0b4825f4, R14
	ADCQ R14, R8
	MOVQ $0x0d058a474c061c15, R14
	ADCQ R14, R9
	MOVQ $0xe3022293a57ef239, R14
	ADCQ R14, R10
	MOVQ $0xfdb5bda5c064026a, R14
	ADCQ R14, R11
	MOVQ $0x0000000d1c548807, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x400cdf09c8edaaab, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x61d00d7f557a53a2, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xc104244527ee6cb7, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xc70344fdc6507296, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x2129ded686b19631, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x74a61f4fb716264b, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xcebfb77b0b4825f4, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x0d058a474c061c15, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xe3022293a57ef239, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xfdb5bda5c064026a, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000d1c548807, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x400cdf09c8edaaab, AX
	ADDQ AX, DX
	MOVQ $0x61d00d7f557a53a2, AX
	ADCQ AX, CX
	MOVQ $0xc104244527ee6cb7, AX
	ADCQ AX, BX
	MOVQ $0xc70344fdc6507296, AX
	ADCQ AX, SI
	MOVQ $0x2129ded686b19631, AX
	ADCQ AX, DI
	MOVQ $0x74a61f4fb716264b, AX
	ADCQ AX, R8
	MOVQ $0xcebfb77b0b4825f4, AX
	ADCQ AX, R9
	MOVQ $0x0d058a474c061c15, AX
	ADCQ AX, R10
	MOVQ $0xe3022293a57ef239, AX
	ADCQ AX, R11
	MOVQ $0xfdb5bda5c064026a, AX
	ADCQ AX, R12
	MOVQ $0x0000000d1c548807, AX
	ADCQ AX, R13
