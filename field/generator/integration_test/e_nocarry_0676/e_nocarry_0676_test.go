...
var benchRese_nocarry_0676 e_nocarry_0676

func BenchmarkE_nocarry_0676SetBytes(b *testing.B) {
	var x e_nocarry_0676
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0676MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0676.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0676)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0676)
		}
	})
}

func BenchmarkE_nocarry_0676Inverse(b *testing.B) {
	var x e_nocarry_0676
	x.SetRandom()
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0676Butterfly(b *testing.B) {
	var x e_nocarry_0676
	x.SetRandom()
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0676)
	}
}

func BenchmarkE_nocarry_0676Exp(b *testing.B) {
	var x e_nocarry_0676
	x.SetRandom()
	benchRese_nocarry_0676.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0676Double(b *testing.B) {
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Double(&benchRese_nocarry_0676)
	}
}

func BenchmarkE_nocarry_0676Add(b *testing.B) {
	var x e_nocarry_0676
	x.SetRandom()
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Add(&x, &benchRese_nocarry_0676)
	}
}

func BenchmarkE_nocarry_0676Sub(b *testing.B) {
	var x e_nocarry_0676
	x.SetRandom()
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Sub(&x, &benchRese_nocarry_0676)
	}
}

func BenchmarkE_nocarry_0676Neg(b *testing.B) {
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Neg(&benchRese_nocarry_0676)
	}
}

func BenchmarkE_nocarry_0676Div(b *testing.B) {
	var x e_nocarry_0676
	x.SetRandom()
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Div(&x, &benchRese_nocarry_0676)
	}
}

func BenchmarkE_nocarry_0676FromMont(b *testing.B) {
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.FromMont()
	}
}

func BenchmarkE_nocarry_0676ToMont(b *testing.B) {
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.ToMont()
	}
}
func BenchmarkE_nocarry_0676Square(b *testing.B) {
	benchRese_nocarry_0676.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Square(&benchRese_nocarry_0676)
	}
}

func BenchmarkE_nocarry_0676Sqrt(b *testing.B) {
	var a e_nocarry_0676
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0676Mul(b *testing.B) {
	x := e_nocarry_0676{
		4123843163159641197,
	...
	benchRese_nocarry_0676.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Mul(&benchRese_nocarry_0676, &x)
	}
}

func BenchmarkE_nocarry_0676Cmp(b *testing.B) {
	x := e_nocarry_0676{
		4123843163159641197,
		14884144220853737797,
		6925244063394883305,
	...
	benchRese_nocarry_0676 = x
	benchRese_nocarry_0676[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0676.Cmp(&x)
	}
}

func TestE_nocarry_0676Cmp(t *testing.T) {
	var x, y e_nocarry_0676
...
func TestE_nocarry_0676IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0676
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0676

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0676{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0676
	one.SetOne()
	e.Sub(&qe_nocarry_0676, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0676{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0676{0, uint64(i)})
	}
...
func TestE_nocarry_0676NegZero(t *testing.T) {
	var a, b e_nocarry_0676
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0676Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0676, len(staticTestValues))
...
func TestE_nocarry_0676Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0676) bool {
			var b e_nocarry_0676
...
func TestE_nocarry_0676InverseExp(t *testing.T) {
...
func TestE_nocarry_0676MulByConstants(t *testing.T) {
...
func TestE_nocarry_0676Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0676) bool {
...
func TestE_nocarry_0676LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0676Halve(t *testing.T) {
...
func TestE_nocarry_0676FromMont(t *testing.T) {
...
type testPaire_nocarry_0676 struct {
	element e_nocarry_0676
	bigint  big.Int
}

func (z *e_nocarry_0676) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0676[10] {
		return true
	}
	if z[10] < qe_nocarry_0676[10] {
		return false
	...
	return z[0] >= qe_nocarry_0676[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0676

		g.element = e_nocarry_0676{
		...
		if qe_nocarry_0676[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0676[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0676 {
			var g e_nocarry_0676
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0676[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0676[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0676[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0676[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0676[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0676[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0676[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0676[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0676[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0676[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0676[10], carry)
...
func Benchmarke_nocarry_0676InverseNew(b *testing.B) {
	var x e_nocarry_0676
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0676
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0676
		var xInv e_nocarry_0676
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0676
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0676
...
func testLinearComb(t *testing.T, x *e_nocarry_0676, xC int64, y *e_nocarry_0676, yC int64) {
	...
	var z e_nocarry_0676
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0676, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0676
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0676, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0676
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0676, xHi uint64) {
	var res e_nocarry_0676
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0676) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0676) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0676, c int64, result *e_nocarry_0676, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0676) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0676) uint64 {
