...
// modulus q
DATA q<>+0(SB)/8, $0xdee9416987df88af
DATA q<>+8(SB)/8, $0x9c898913497d6483
DATA q<>+16(SB)/8, $0x1825ee52af422c27
DATA q<>+24(SB)/8, $0x65652e7ac6854804
DATA q<>+32(SB)/8, $0x000001ee3eb09d9a
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xc89993371f8731b1
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xdee9416987df88af, R9
	MOVQ    $0x9c898913497d6483, R10
	MOVQ    $0x1825ee52af422c27, R11
	MOVQ    $0x65652e7ac6854804, R12
	MOVQ    $0x000001ee3eb09d9a, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x9c898913497d6483, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x1825ee52af422c27, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x65652e7ac6854804, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000001ee3eb09d9a, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xdee9416987df88af, CX
	MOVQ    $0x9c898913497d6483, BX
	MOVQ    $0x1825ee52af422c27, SI
	MOVQ    $0x65652e7ac6854804, DI
	MOVQ    $0x000001ee3eb09d9a, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
