...
var benchRese_nocarry_0297 e_nocarry_0297

func BenchmarkE_nocarry_0297SetBytes(b *testing.B) {
	var x e_nocarry_0297
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0297MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0297.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0297)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0297)
		}
	})
}

func BenchmarkE_nocarry_0297Inverse(b *testing.B) {
	var x e_nocarry_0297
	x.SetRandom()
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0297Butterfly(b *testing.B) {
	var x e_nocarry_0297
	x.SetRandom()
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0297)
	}
}

func BenchmarkE_nocarry_0297Exp(b *testing.B) {
	var x e_nocarry_0297
	x.SetRandom()
	benchRese_nocarry_0297.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0297Double(b *testing.B) {
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Double(&benchRese_nocarry_0297)
	}
}

func BenchmarkE_nocarry_0297Add(b *testing.B) {
	var x e_nocarry_0297
	x.SetRandom()
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Add(&x, &benchRese_nocarry_0297)
	}
}

func BenchmarkE_nocarry_0297Sub(b *testing.B) {
	var x e_nocarry_0297
	x.SetRandom()
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Sub(&x, &benchRese_nocarry_0297)
	}
}

func BenchmarkE_nocarry_0297Neg(b *testing.B) {
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Neg(&benchRese_nocarry_0297)
	}
}

func BenchmarkE_nocarry_0297Div(b *testing.B) {
	var x e_nocarry_0297
	x.SetRandom()
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Div(&x, &benchRese_nocarry_0297)
	}
}

func BenchmarkE_nocarry_0297FromMont(b *testing.B) {
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.FromMont()
	}
}

func BenchmarkE_nocarry_0297ToMont(b *testing.B) {
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.ToMont()
	}
}
func BenchmarkE_nocarry_0297Square(b *testing.B) {
	benchRese_nocarry_0297.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Square(&benchRese_nocarry_0297)
	}
}

func BenchmarkE_nocarry_0297Sqrt(b *testing.B) {
	var a e_nocarry_0297
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0297Mul(b *testing.B) {
	x := e_nocarry_0297{
		8738376898093025964,
		3034568837023154773,
		2681571297315101977,
	...
	benchRese_nocarry_0297.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Mul(&benchRese_nocarry_0297, &x)
	}
}

func BenchmarkE_nocarry_0297Cmp(b *testing.B) {
	x := e_nocarry_0297{
		8738376898093025964,
		3034568837023154773,
		2681571297315101977,
	...
	benchRese_nocarry_0297 = x
	benchRese_nocarry_0297[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0297.Cmp(&x)
	}
}

func TestE_nocarry_0297Cmp(t *testing.T) {
	var x, y e_nocarry_0297
...
func TestE_nocarry_0297IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0297
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0297

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0297{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0297
	one.SetOne()
	e.Sub(&qe_nocarry_0297, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0297{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0297{0, uint64(i)})
	}
...
func TestE_nocarry_0297NegZero(t *testing.T) {
	var a, b e_nocarry_0297
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0297Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0297, len(staticTestValues))
...
func TestE_nocarry_0297Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0297) bool {
			var b e_nocarry_0297
...
func TestE_nocarry_0297InverseExp(t *testing.T) {
...
func TestE_nocarry_0297MulByConstants(t *testing.T) {
...
func TestE_nocarry_0297Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0297) bool {
...
func TestE_nocarry_0297LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0297Halve(t *testing.T) {
...
func TestE_nocarry_0297FromMont(t *testing.T) {
...
type testPaire_nocarry_0297 struct {
	element e_nocarry_0297
	bigint  big.Int
}

func (z *e_nocarry_0297) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0297[4] {
		return true
	}
	if z[4] < qe_nocarry_0297[4] {
		return false
	...
	return z[0] >= qe_nocarry_0297[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0297

		g.element = e_nocarry_0297{
		...
		if qe_nocarry_0297[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0297[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0297 {
			var g e_nocarry_0297
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0297[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0297[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0297[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0297[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0297[4], carry)
...
func Benchmarke_nocarry_0297InverseNew(b *testing.B) {
	var x e_nocarry_0297
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0297
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0297
		var xInv e_nocarry_0297
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0297
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0297
...
func testLinearComb(t *testing.T, x *e_nocarry_0297, xC int64, y *e_nocarry_0297, yC int64) {
	...
	var z e_nocarry_0297
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0297, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0297
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0297, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0297
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0297, xHi uint64) {
	var res e_nocarry_0297
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0297) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0297) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0297, c int64, result *e_nocarry_0297, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0297) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0297) uint64 {
