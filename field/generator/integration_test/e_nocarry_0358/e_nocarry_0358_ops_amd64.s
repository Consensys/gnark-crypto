...
// modulus q
DATA q<>+0(SB)/8, $0xd40c30aee593d0d9
DATA q<>+8(SB)/8, $0xdfae8a9c2808abf7
DATA q<>+16(SB)/8, $0x8cdc9155fce878ea
DATA q<>+24(SB)/8, $0xeee4c4a0614a750d
DATA q<>+32(SB)/8, $0xb77ac9b31ccac12d
DATA q<>+40(SB)/8, $0x0000003481338062
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xaa2f2420f16c5097
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xd40c30aee593d0d9, R10
	MOVQ    $0xdfae8a9c2808abf7, R11
	MOVQ    $0x8cdc9155fce878ea, R12
	MOVQ    $0xeee4c4a0614a750d, R13
	MOVQ    $0xb77ac9b31ccac12d, R14
	MOVQ    $0x0000003481338062, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xdfae8a9c2808abf7, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x8cdc9155fce878ea, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xeee4c4a0614a750d, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xb77ac9b31ccac12d, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000003481338062, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xd40c30aee593d0d9, CX
	MOVQ    $0xdfae8a9c2808abf7, BX
	MOVQ    $0x8cdc9155fce878ea, SI
	MOVQ    $0xeee4c4a0614a750d, DI
	MOVQ    $0xb77ac9b31ccac12d, R8
	MOVQ    $0x0000003481338062, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
