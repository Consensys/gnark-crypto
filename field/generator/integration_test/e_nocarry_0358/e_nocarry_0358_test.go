...
var benchRese_nocarry_0358 e_nocarry_0358

func BenchmarkE_nocarry_0358SetBytes(b *testing.B) {
	var x e_nocarry_0358
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0358MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0358.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0358)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0358)
		}
	})
}

func BenchmarkE_nocarry_0358Inverse(b *testing.B) {
	var x e_nocarry_0358
	x.SetRandom()
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0358Butterfly(b *testing.B) {
	var x e_nocarry_0358
	x.SetRandom()
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0358)
	}
}

func BenchmarkE_nocarry_0358Exp(b *testing.B) {
	var x e_nocarry_0358
	x.SetRandom()
	benchRese_nocarry_0358.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0358Double(b *testing.B) {
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Double(&benchRese_nocarry_0358)
	}
}

func BenchmarkE_nocarry_0358Add(b *testing.B) {
	var x e_nocarry_0358
	x.SetRandom()
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Add(&x, &benchRese_nocarry_0358)
	}
}

func BenchmarkE_nocarry_0358Sub(b *testing.B) {
	var x e_nocarry_0358
	x.SetRandom()
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Sub(&x, &benchRese_nocarry_0358)
	}
}

func BenchmarkE_nocarry_0358Neg(b *testing.B) {
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Neg(&benchRese_nocarry_0358)
	}
}

func BenchmarkE_nocarry_0358Div(b *testing.B) {
	var x e_nocarry_0358
	x.SetRandom()
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Div(&x, &benchRese_nocarry_0358)
	}
}

func BenchmarkE_nocarry_0358FromMont(b *testing.B) {
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.FromMont()
	}
}

func BenchmarkE_nocarry_0358ToMont(b *testing.B) {
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.ToMont()
	}
}
func BenchmarkE_nocarry_0358Square(b *testing.B) {
	benchRese_nocarry_0358.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Square(&benchRese_nocarry_0358)
	}
}

func BenchmarkE_nocarry_0358Sqrt(b *testing.B) {
	var a e_nocarry_0358
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0358Mul(b *testing.B) {
	x := e_nocarry_0358{
		8343309054324044542,
	...
	benchRese_nocarry_0358.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Mul(&benchRese_nocarry_0358, &x)
	}
}

func BenchmarkE_nocarry_0358Cmp(b *testing.B) {
	x := e_nocarry_0358{
		8343309054324044542,
		13807225233479351875,
		9765484348801788289,
	...
	benchRese_nocarry_0358 = x
	benchRese_nocarry_0358[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0358.Cmp(&x)
	}
}

func TestE_nocarry_0358Cmp(t *testing.T) {
	var x, y e_nocarry_0358
...
func TestE_nocarry_0358IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0358
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0358

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0358{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0358
	one.SetOne()
	e.Sub(&qe_nocarry_0358, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0358{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0358{0, uint64(i)})
	}
...
func TestE_nocarry_0358NegZero(t *testing.T) {
	var a, b e_nocarry_0358
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0358Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0358, len(staticTestValues))
...
func TestE_nocarry_0358Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0358) bool {
			var b e_nocarry_0358
...
func TestE_nocarry_0358InverseExp(t *testing.T) {
...
func TestE_nocarry_0358MulByConstants(t *testing.T) {
...
func TestE_nocarry_0358Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0358) bool {
...
func TestE_nocarry_0358LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0358Halve(t *testing.T) {
...
func TestE_nocarry_0358FromMont(t *testing.T) {
...
type testPaire_nocarry_0358 struct {
	element e_nocarry_0358
	bigint  big.Int
}

func (z *e_nocarry_0358) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0358[5] {
		return true
	}
	if z[5] < qe_nocarry_0358[5] {
		return false
	...
	return z[0] >= qe_nocarry_0358[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0358

		g.element = e_nocarry_0358{
		...
		if qe_nocarry_0358[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0358[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0358 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0358[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0358[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0358[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0358[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0358[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0358[5], carry)
...
func Benchmarke_nocarry_0358InverseNew(b *testing.B) {
	var x e_nocarry_0358
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0358
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0358
		var xInv e_nocarry_0358
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0358
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0358
...
func testLinearComb(t *testing.T, x *e_nocarry_0358, xC int64, y *e_nocarry_0358, yC int64) {
	...
	var z e_nocarry_0358
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0358, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0358
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0358, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0358
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0358, xHi uint64) {
	var res e_nocarry_0358
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0358) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0358) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0358, c int64, result *e_nocarry_0358, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0358) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0358) uint64 {
