...
// modulus q
DATA q<>+0(SB)/8, $0x3ea0682574ef5d83
DATA q<>+8(SB)/8, $0xd519651334a3af7f
DATA q<>+16(SB)/8, $0xbc644a48c4980483
DATA q<>+24(SB)/8, $0x62e0e02f2052885b
DATA q<>+32(SB)/8, $0x435af672ff1128f8
DATA q<>+40(SB)/8, $0x000000000fba2942
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x16e051f66d0766d5
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x3ea0682574ef5d83, R10
	MOVQ    $0xd519651334a3af7f, R11
	MOVQ    $0xbc644a48c4980483, R12
	MOVQ    $0x62e0e02f2052885b, R13
	MOVQ    $0x435af672ff1128f8, R14
	MOVQ    $0x000000000fba2942, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xd519651334a3af7f, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xbc644a48c4980483, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x62e0e02f2052885b, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x435af672ff1128f8, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000000fba2942, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x3ea0682574ef5d83, CX
	MOVQ    $0xd519651334a3af7f, BX
	MOVQ    $0xbc644a48c4980483, SI
	MOVQ    $0x62e0e02f2052885b, DI
	MOVQ    $0x435af672ff1128f8, R8
	MOVQ    $0x000000000fba2942, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
