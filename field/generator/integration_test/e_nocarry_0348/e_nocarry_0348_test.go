...
var benchRese_nocarry_0348 e_nocarry_0348

func BenchmarkE_nocarry_0348SetBytes(b *testing.B) {
	var x e_nocarry_0348
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0348MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0348.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0348)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0348)
		}
	})
}

func BenchmarkE_nocarry_0348Inverse(b *testing.B) {
	var x e_nocarry_0348
	x.SetRandom()
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0348Butterfly(b *testing.B) {
	var x e_nocarry_0348
	x.SetRandom()
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0348)
	}
}

func BenchmarkE_nocarry_0348Exp(b *testing.B) {
	var x e_nocarry_0348
	x.SetRandom()
	benchRese_nocarry_0348.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0348Double(b *testing.B) {
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Double(&benchRese_nocarry_0348)
	}
}

func BenchmarkE_nocarry_0348Add(b *testing.B) {
	var x e_nocarry_0348
	x.SetRandom()
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Add(&x, &benchRese_nocarry_0348)
	}
}

func BenchmarkE_nocarry_0348Sub(b *testing.B) {
	var x e_nocarry_0348
	x.SetRandom()
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Sub(&x, &benchRese_nocarry_0348)
	}
}

func BenchmarkE_nocarry_0348Neg(b *testing.B) {
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Neg(&benchRese_nocarry_0348)
	}
}

func BenchmarkE_nocarry_0348Div(b *testing.B) {
	var x e_nocarry_0348
	x.SetRandom()
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Div(&x, &benchRese_nocarry_0348)
	}
}

func BenchmarkE_nocarry_0348FromMont(b *testing.B) {
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.FromMont()
	}
}

func BenchmarkE_nocarry_0348ToMont(b *testing.B) {
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.ToMont()
	}
}
func BenchmarkE_nocarry_0348Square(b *testing.B) {
	benchRese_nocarry_0348.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Square(&benchRese_nocarry_0348)
	}
}

func BenchmarkE_nocarry_0348Sqrt(b *testing.B) {
	var a e_nocarry_0348
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0348Mul(b *testing.B) {
	x := e_nocarry_0348{
	...
	benchRese_nocarry_0348.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Mul(&benchRese_nocarry_0348, &x)
	}
}

func BenchmarkE_nocarry_0348Cmp(b *testing.B) {
	x := e_nocarry_0348{
		14293540613055502837,
		8109572212386686380,
		3969241364612476352,
	...
	benchRese_nocarry_0348 = x
	benchRese_nocarry_0348[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0348.Cmp(&x)
	}
}

func TestE_nocarry_0348Cmp(t *testing.T) {
	var x, y e_nocarry_0348
...
func TestE_nocarry_0348IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0348
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0348

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0348{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0348
	one.SetOne()
	e.Sub(&qe_nocarry_0348, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0348{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0348{0, uint64(i)})
	}
...
func TestE_nocarry_0348NegZero(t *testing.T) {
	var a, b e_nocarry_0348
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0348Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0348, len(staticTestValues))
...
func TestE_nocarry_0348Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0348) bool {
			var b e_nocarry_0348
...
func TestE_nocarry_0348InverseExp(t *testing.T) {
...
func TestE_nocarry_0348MulByConstants(t *testing.T) {
...
func TestE_nocarry_0348Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0348) bool {
...
func TestE_nocarry_0348LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0348Halve(t *testing.T) {
...
func TestE_nocarry_0348FromMont(t *testing.T) {
...
type testPaire_nocarry_0348 struct {
	element e_nocarry_0348
	bigint  big.Int
}

func (z *e_nocarry_0348) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0348[5] {
		return true
	}
	if z[5] < qe_nocarry_0348[5] {
		return false
	...
	return z[0] >= qe_nocarry_0348[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0348

		g.element = e_nocarry_0348{
		...
		if qe_nocarry_0348[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0348[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0348 {
			var g e_nocarry_0348
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0348[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0348[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0348[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0348[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0348[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0348[5], carry)
...
func Benchmarke_nocarry_0348InverseNew(b *testing.B) {
	var x e_nocarry_0348
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0348
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0348
		var xInv e_nocarry_0348
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0348
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0348
...
func testLinearComb(t *testing.T, x *e_nocarry_0348, xC int64, y *e_nocarry_0348, yC int64) {
	...
	var z e_nocarry_0348
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0348, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0348
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0348, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0348
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0348, xHi uint64) {
	var res e_nocarry_0348
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0348) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0348) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0348, c int64, result *e_nocarry_0348, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0348) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0348) uint64 {
