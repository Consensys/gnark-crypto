...
var benchRese_nocarry_0347 e_nocarry_0347

func BenchmarkE_nocarry_0347SetBytes(b *testing.B) {
	var x e_nocarry_0347
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0347MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0347.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0347)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0347)
		}
	})
}

func BenchmarkE_nocarry_0347Inverse(b *testing.B) {
	var x e_nocarry_0347
	x.SetRandom()
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0347Butterfly(b *testing.B) {
	var x e_nocarry_0347
	x.SetRandom()
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0347)
	}
}

func BenchmarkE_nocarry_0347Exp(b *testing.B) {
	var x e_nocarry_0347
	x.SetRandom()
	benchRese_nocarry_0347.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0347Double(b *testing.B) {
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Double(&benchRese_nocarry_0347)
	}
}

func BenchmarkE_nocarry_0347Add(b *testing.B) {
	var x e_nocarry_0347
	x.SetRandom()
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Add(&x, &benchRese_nocarry_0347)
	}
}

func BenchmarkE_nocarry_0347Sub(b *testing.B) {
	var x e_nocarry_0347
	x.SetRandom()
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Sub(&x, &benchRese_nocarry_0347)
	}
}

func BenchmarkE_nocarry_0347Neg(b *testing.B) {
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Neg(&benchRese_nocarry_0347)
	}
}

func BenchmarkE_nocarry_0347Div(b *testing.B) {
	var x e_nocarry_0347
	x.SetRandom()
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Div(&x, &benchRese_nocarry_0347)
	}
}

func BenchmarkE_nocarry_0347FromMont(b *testing.B) {
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.FromMont()
	}
}

func BenchmarkE_nocarry_0347ToMont(b *testing.B) {
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.ToMont()
	}
}
func BenchmarkE_nocarry_0347Square(b *testing.B) {
	benchRese_nocarry_0347.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Square(&benchRese_nocarry_0347)
	}
}

func BenchmarkE_nocarry_0347Sqrt(b *testing.B) {
	var a e_nocarry_0347
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0347Mul(b *testing.B) {
	x := e_nocarry_0347{
	...
	benchRese_nocarry_0347.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Mul(&benchRese_nocarry_0347, &x)
	}
}

func BenchmarkE_nocarry_0347Cmp(b *testing.B) {
	x := e_nocarry_0347{
		17502463242839342943,
		3824303015052784501,
		4044958653386215465,
	...
	benchRese_nocarry_0347 = x
	benchRese_nocarry_0347[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0347.Cmp(&x)
	}
}

func TestE_nocarry_0347Cmp(t *testing.T) {
	var x, y e_nocarry_0347
...
func TestE_nocarry_0347IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0347
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0347

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0347{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0347
	one.SetOne()
	e.Sub(&qe_nocarry_0347, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0347{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0347{0, uint64(i)})
	}
...
func TestE_nocarry_0347NegZero(t *testing.T) {
	var a, b e_nocarry_0347
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0347Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0347, len(staticTestValues))
...
func TestE_nocarry_0347Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0347) bool {
			var b e_nocarry_0347
...
func TestE_nocarry_0347InverseExp(t *testing.T) {
...
func TestE_nocarry_0347MulByConstants(t *testing.T) {
...
func TestE_nocarry_0347Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0347) bool {
...
func TestE_nocarry_0347LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0347Halve(t *testing.T) {
...
func TestE_nocarry_0347FromMont(t *testing.T) {
...
type testPaire_nocarry_0347 struct {
	element e_nocarry_0347
	bigint  big.Int
}

func (z *e_nocarry_0347) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0347[5] {
		return true
	}
	if z[5] < qe_nocarry_0347[5] {
		return false
	...
	return z[0] >= qe_nocarry_0347[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0347

		g.element = e_nocarry_0347{
		...
		if qe_nocarry_0347[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0347[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0347 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0347[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0347[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0347[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0347[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0347[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0347[5], carry)
...
func Benchmarke_nocarry_0347InverseNew(b *testing.B) {
	var x e_nocarry_0347
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0347
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0347
		var xInv e_nocarry_0347
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0347
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0347
...
func testLinearComb(t *testing.T, x *e_nocarry_0347, xC int64, y *e_nocarry_0347, yC int64) {
	...
	var z e_nocarry_0347
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0347, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0347
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0347, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0347
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0347, xHi uint64) {
	var res e_nocarry_0347
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0347) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0347) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0347, c int64, result *e_nocarry_0347, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0347) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0347) uint64 {
