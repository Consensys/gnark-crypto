...
// modulus q
DATA q<>+0(SB)/8, $0xe37ad9c4a961ed89
DATA q<>+8(SB)/8, $0x3f66dde1c271fc7f
DATA q<>+16(SB)/8, $0x74bf9a71e17f5f6f
DATA q<>+24(SB)/8, $0x5be47f2ca4a1c717
DATA q<>+32(SB)/8, $0x67fda6da6041596d
DATA q<>+40(SB)/8, $0x00000000076f6e65
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x4a2fa38c10dd6747
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xe37ad9c4a961ed89, R10
	MOVQ    $0x3f66dde1c271fc7f, R11
	MOVQ    $0x74bf9a71e17f5f6f, R12
	MOVQ    $0x5be47f2ca4a1c717, R13
	MOVQ    $0x67fda6da6041596d, R14
	MOVQ    $0x00000000076f6e65, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x3f66dde1c271fc7f, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x74bf9a71e17f5f6f, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x5be47f2ca4a1c717, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x67fda6da6041596d, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000000076f6e65, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xe37ad9c4a961ed89, CX
	MOVQ    $0x3f66dde1c271fc7f, BX
	MOVQ    $0x74bf9a71e17f5f6f, SI
	MOVQ    $0x5be47f2ca4a1c717, DI
	MOVQ    $0x67fda6da6041596d, R8
	MOVQ    $0x00000000076f6e65, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
