...
var benchRese_nocarry_0582 e_nocarry_0582

func BenchmarkE_nocarry_0582SetBytes(b *testing.B) {
	var x e_nocarry_0582
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0582MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0582.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0582)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0582)
		}
	})
}

func BenchmarkE_nocarry_0582Inverse(b *testing.B) {
	var x e_nocarry_0582
	x.SetRandom()
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0582Butterfly(b *testing.B) {
	var x e_nocarry_0582
	x.SetRandom()
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0582)
	}
}

func BenchmarkE_nocarry_0582Exp(b *testing.B) {
	var x e_nocarry_0582
	x.SetRandom()
	benchRese_nocarry_0582.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0582Double(b *testing.B) {
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Double(&benchRese_nocarry_0582)
	}
}

func BenchmarkE_nocarry_0582Add(b *testing.B) {
	var x e_nocarry_0582
	x.SetRandom()
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Add(&x, &benchRese_nocarry_0582)
	}
}

func BenchmarkE_nocarry_0582Sub(b *testing.B) {
	var x e_nocarry_0582
	x.SetRandom()
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Sub(&x, &benchRese_nocarry_0582)
	}
}

func BenchmarkE_nocarry_0582Neg(b *testing.B) {
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Neg(&benchRese_nocarry_0582)
	}
}

func BenchmarkE_nocarry_0582Div(b *testing.B) {
	var x e_nocarry_0582
	x.SetRandom()
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Div(&x, &benchRese_nocarry_0582)
	}
}

func BenchmarkE_nocarry_0582FromMont(b *testing.B) {
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.FromMont()
	}
}

func BenchmarkE_nocarry_0582ToMont(b *testing.B) {
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.ToMont()
	}
}
func BenchmarkE_nocarry_0582Square(b *testing.B) {
	benchRese_nocarry_0582.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Square(&benchRese_nocarry_0582)
	}
}

func BenchmarkE_nocarry_0582Sqrt(b *testing.B) {
	var a e_nocarry_0582
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0582Mul(b *testing.B) {
	x := e_nocarry_0582{
	...
	benchRese_nocarry_0582.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Mul(&benchRese_nocarry_0582, &x)
	}
}

func BenchmarkE_nocarry_0582Cmp(b *testing.B) {
	x := e_nocarry_0582{
		13173147574297614443,
		18293442587312252716,
		5561899525523757002,
	...
	benchRese_nocarry_0582 = x
	benchRese_nocarry_0582[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0582.Cmp(&x)
	}
}

func TestE_nocarry_0582Cmp(t *testing.T) {
	var x, y e_nocarry_0582
...
func TestE_nocarry_0582IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0582
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0582

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0582{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0582
	one.SetOne()
	e.Sub(&qe_nocarry_0582, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0582{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0582{0, uint64(i)})
	}
...
func TestE_nocarry_0582NegZero(t *testing.T) {
	var a, b e_nocarry_0582
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0582Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0582, len(staticTestValues))
...
func TestE_nocarry_0582Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0582) bool {
			var b e_nocarry_0582
...
func TestE_nocarry_0582InverseExp(t *testing.T) {
...
func TestE_nocarry_0582MulByConstants(t *testing.T) {
...
func TestE_nocarry_0582Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0582) bool {
...
func TestE_nocarry_0582LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0582Halve(t *testing.T) {
...
func TestE_nocarry_0582FromMont(t *testing.T) {
...
type testPaire_nocarry_0582 struct {
	element e_nocarry_0582
	bigint  big.Int
}

func (z *e_nocarry_0582) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0582[9] {
		return true
	}
	if z[9] < qe_nocarry_0582[9] {
		return false
	...
	return z[0] >= qe_nocarry_0582[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0582

		g.element = e_nocarry_0582{
		...
		if qe_nocarry_0582[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0582[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0582 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0582[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0582[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0582[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0582[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0582[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0582[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0582[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0582[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0582[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0582[9], carry)
...
func Benchmarke_nocarry_0582InverseNew(b *testing.B) {
	var x e_nocarry_0582
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0582
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0582
		var xInv e_nocarry_0582
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0582
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0582
...
func testLinearComb(t *testing.T, x *e_nocarry_0582, xC int64, y *e_nocarry_0582, yC int64) {
	...
	var z e_nocarry_0582
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0582, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0582
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0582, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0582
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0582, xHi uint64) {
	var res e_nocarry_0582
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0582) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0582) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0582, c int64, result *e_nocarry_0582, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0582) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0582) uint64 {
