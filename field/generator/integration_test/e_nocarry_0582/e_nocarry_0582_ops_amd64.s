...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x9efdf3308b968409, R13
	ADDQ R13, AX
	MOVQ $0x6d6b4eaa40186d10, R13
	ADCQ R13, DX
	MOVQ $0x0f093dd3b6a180df, R13
	ADCQ R13, CX
	MOVQ $0xab463ad31911e73f, R13
	ADCQ R13, BX
	MOVQ $0x5da52425b0a9f62a, R13
	ADCQ R13, SI
	MOVQ $0x901b6724f9034465, R13
	ADCQ R13, DI
	MOVQ $0xbffefc620b8251b1, R13
	ADCQ R13, R8
	MOVQ $0xc31c49f42c6f9659, R13
	ADCQ R13, R9
	MOVQ $0x04851bb1b6dc4645, R13
	ADCQ R13, R10
	MOVQ $0x0000000000000039, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x9efdf3308b968409, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x6d6b4eaa40186d10, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x0f093dd3b6a180df, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xab463ad31911e73f, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x5da52425b0a9f62a, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x901b6724f9034465, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xbffefc620b8251b1, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xc31c49f42c6f9659, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x04851bb1b6dc4645, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000000000039, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x9efdf3308b968409, AX
	ADDQ AX, DX
	MOVQ $0x6d6b4eaa40186d10, AX
	ADCQ AX, CX
	MOVQ $0x0f093dd3b6a180df, AX
	ADCQ AX, BX
	MOVQ $0xab463ad31911e73f, AX
	ADCQ AX, SI
	MOVQ $0x5da52425b0a9f62a, AX
	ADCQ AX, DI
	MOVQ $0x901b6724f9034465, AX
	ADCQ AX, R8
	MOVQ $0xbffefc620b8251b1, AX
	ADCQ AX, R9
	MOVQ $0xc31c49f42c6f9659, AX
	ADCQ AX, R10
	MOVQ $0x04851bb1b6dc4645, AX
	ADCQ AX, R11
	MOVQ $0x0000000000000039, AX
	ADCQ AX, R12
