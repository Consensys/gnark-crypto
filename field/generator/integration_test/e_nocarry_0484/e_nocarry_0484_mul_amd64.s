...
// modulus q
DATA q<>+0(SB)/8, $0x5ce27ed6f324a815
DATA q<>+8(SB)/8, $0xfbbfc642c3304ae9
DATA q<>+16(SB)/8, $0xa9696f968e053bb3
DATA q<>+24(SB)/8, $0xe247a917f522b7fe
DATA q<>+32(SB)/8, $0x065eeda8c72da507
DATA q<>+40(SB)/8, $0xc2896e3e59b2b2f9
DATA q<>+48(SB)/8, $0x5b713401cd742f29
DATA q<>+56(SB)/8, $0x0000000daa858c19
GLOBL q<>(SB), (RODATA+NOPTR), $64

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x6bd197cbc08a18c3
