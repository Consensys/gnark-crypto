...
var benchRese_nocarry_0484 e_nocarry_0484

func BenchmarkE_nocarry_0484SetBytes(b *testing.B) {
	var x e_nocarry_0484
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0484MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0484.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0484)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0484)
		}
	})
}

func BenchmarkE_nocarry_0484Inverse(b *testing.B) {
	var x e_nocarry_0484
	x.SetRandom()
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0484Butterfly(b *testing.B) {
	var x e_nocarry_0484
	x.SetRandom()
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0484)
	}
}

func BenchmarkE_nocarry_0484Exp(b *testing.B) {
	var x e_nocarry_0484
	x.SetRandom()
	benchRese_nocarry_0484.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0484Double(b *testing.B) {
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Double(&benchRese_nocarry_0484)
	}
}

func BenchmarkE_nocarry_0484Add(b *testing.B) {
	var x e_nocarry_0484
	x.SetRandom()
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Add(&x, &benchRese_nocarry_0484)
	}
}

func BenchmarkE_nocarry_0484Sub(b *testing.B) {
	var x e_nocarry_0484
	x.SetRandom()
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Sub(&x, &benchRese_nocarry_0484)
	}
}

func BenchmarkE_nocarry_0484Neg(b *testing.B) {
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Neg(&benchRese_nocarry_0484)
	}
}

func BenchmarkE_nocarry_0484Div(b *testing.B) {
	var x e_nocarry_0484
	x.SetRandom()
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Div(&x, &benchRese_nocarry_0484)
	}
}

func BenchmarkE_nocarry_0484FromMont(b *testing.B) {
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.FromMont()
	}
}

func BenchmarkE_nocarry_0484ToMont(b *testing.B) {
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.ToMont()
	}
}
func BenchmarkE_nocarry_0484Square(b *testing.B) {
	benchRese_nocarry_0484.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Square(&benchRese_nocarry_0484)
	}
}

func BenchmarkE_nocarry_0484Sqrt(b *testing.B) {
	var a e_nocarry_0484
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0484Mul(b *testing.B) {
	x := e_nocarry_0484{
	...
	benchRese_nocarry_0484.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Mul(&benchRese_nocarry_0484, &x)
	}
}

func BenchmarkE_nocarry_0484Cmp(b *testing.B) {
	x := e_nocarry_0484{
		16674305390243082755,
		2706848930242244517,
		6045384172338770488,
	...
	benchRese_nocarry_0484 = x
	benchRese_nocarry_0484[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0484.Cmp(&x)
	}
}

func TestE_nocarry_0484Cmp(t *testing.T) {
	var x, y e_nocarry_0484
...
func TestE_nocarry_0484IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0484
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0484

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0484{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0484
	one.SetOne()
	e.Sub(&qe_nocarry_0484, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0484{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0484{0, uint64(i)})
	}
...
func TestE_nocarry_0484NegZero(t *testing.T) {
	var a, b e_nocarry_0484
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0484Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0484, len(staticTestValues))
...
func TestE_nocarry_0484Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0484) bool {
			var b e_nocarry_0484
...
func TestE_nocarry_0484InverseExp(t *testing.T) {
...
func TestE_nocarry_0484MulByConstants(t *testing.T) {
...
func TestE_nocarry_0484Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0484) bool {
...
func TestE_nocarry_0484LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0484Halve(t *testing.T) {
...
func TestE_nocarry_0484FromMont(t *testing.T) {
...
type testPaire_nocarry_0484 struct {
	element e_nocarry_0484
	bigint  big.Int
}

func (z *e_nocarry_0484) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0484[7] {
		return true
	}
	if z[7] < qe_nocarry_0484[7] {
		return false
	...
	return z[0] >= qe_nocarry_0484[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0484

		g.element = e_nocarry_0484{
		...
		if qe_nocarry_0484[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0484[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0484 {
			var g e_nocarry_0484
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0484[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0484[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0484[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0484[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0484[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0484[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0484[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0484[7], carry)
...
func Benchmarke_nocarry_0484InverseNew(b *testing.B) {
	var x e_nocarry_0484
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0484
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0484
		var xInv e_nocarry_0484
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0484
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0484
...
func testLinearComb(t *testing.T, x *e_nocarry_0484, xC int64, y *e_nocarry_0484, yC int64) {
	...
	var z e_nocarry_0484
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0484, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0484
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0484, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0484
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0484, xHi uint64) {
	var res e_nocarry_0484
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0484) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0484) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0484, c int64, result *e_nocarry_0484, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0484) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0484) uint64 {
