...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x6be6398ec4e01ad9, R13
	ADDQ R13, AX
	MOVQ $0x174b7b541d4f00e2, R13
	ADCQ R13, DX
	MOVQ $0xd90f8b0f735871d1, R13
	ADCQ R13, CX
	MOVQ $0xe928cfea5a955e14, R13
	ADCQ R13, BX
	MOVQ $0x6af27c5139259fc1, R13
	ADCQ R13, SI
	MOVQ $0x9a92e3fcaff1b60b, R13
	ADCQ R13, DI
	MOVQ $0xbacc99eb4094c653, R13
	ADCQ R13, R8
	MOVQ $0x66b098a90878c671, R13
	ADCQ R13, R9
	MOVQ $0xcb26fa8f38f7bb7d, R13
	ADCQ R13, R10
	MOVQ $0x000000000001dac9, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x6be6398ec4e01ad9, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x174b7b541d4f00e2, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xd90f8b0f735871d1, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xe928cfea5a955e14, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x6af27c5139259fc1, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x9a92e3fcaff1b60b, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xbacc99eb4094c653, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x66b098a90878c671, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xcb26fa8f38f7bb7d, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000000001dac9, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x6be6398ec4e01ad9, AX
	ADDQ AX, DX
	MOVQ $0x174b7b541d4f00e2, AX
	ADCQ AX, CX
	MOVQ $0xd90f8b0f735871d1, AX
	ADCQ AX, BX
	MOVQ $0xe928cfea5a955e14, AX
	ADCQ AX, SI
	MOVQ $0x6af27c5139259fc1, AX
	ADCQ AX, DI
	MOVQ $0x9a92e3fcaff1b60b, AX
	ADCQ AX, R8
	MOVQ $0xbacc99eb4094c653, AX
	ADCQ AX, R9
	MOVQ $0x66b098a90878c671, AX
	ADCQ AX, R10
	MOVQ $0xcb26fa8f38f7bb7d, AX
	ADCQ AX, R11
	MOVQ $0x000000000001dac9, AX
	ADCQ AX, R12
