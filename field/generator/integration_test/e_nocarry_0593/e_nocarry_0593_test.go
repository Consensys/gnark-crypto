...
var benchRese_nocarry_0593 e_nocarry_0593

func BenchmarkE_nocarry_0593SetBytes(b *testing.B) {
	var x e_nocarry_0593
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0593MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0593.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0593)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0593)
		}
	})
}

func BenchmarkE_nocarry_0593Inverse(b *testing.B) {
	var x e_nocarry_0593
	x.SetRandom()
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0593Butterfly(b *testing.B) {
	var x e_nocarry_0593
	x.SetRandom()
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0593)
	}
}

func BenchmarkE_nocarry_0593Exp(b *testing.B) {
	var x e_nocarry_0593
	x.SetRandom()
	benchRese_nocarry_0593.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0593Double(b *testing.B) {
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Double(&benchRese_nocarry_0593)
	}
}

func BenchmarkE_nocarry_0593Add(b *testing.B) {
	var x e_nocarry_0593
	x.SetRandom()
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Add(&x, &benchRese_nocarry_0593)
	}
}

func BenchmarkE_nocarry_0593Sub(b *testing.B) {
	var x e_nocarry_0593
	x.SetRandom()
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Sub(&x, &benchRese_nocarry_0593)
	}
}

func BenchmarkE_nocarry_0593Neg(b *testing.B) {
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Neg(&benchRese_nocarry_0593)
	}
}

func BenchmarkE_nocarry_0593Div(b *testing.B) {
	var x e_nocarry_0593
	x.SetRandom()
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Div(&x, &benchRese_nocarry_0593)
	}
}

func BenchmarkE_nocarry_0593FromMont(b *testing.B) {
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.FromMont()
	}
}

func BenchmarkE_nocarry_0593ToMont(b *testing.B) {
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.ToMont()
	}
}
func BenchmarkE_nocarry_0593Square(b *testing.B) {
	benchRese_nocarry_0593.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Square(&benchRese_nocarry_0593)
	}
}

func BenchmarkE_nocarry_0593Sqrt(b *testing.B) {
	var a e_nocarry_0593
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0593Mul(b *testing.B) {
	x := e_nocarry_0593{
	...
	benchRese_nocarry_0593.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Mul(&benchRese_nocarry_0593, &x)
	}
}

func BenchmarkE_nocarry_0593Cmp(b *testing.B) {
	x := e_nocarry_0593{
		15911848662258120436,
		7940595922366884620,
		15325336672049210592,
	...
	benchRese_nocarry_0593 = x
	benchRese_nocarry_0593[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0593.Cmp(&x)
	}
}

func TestE_nocarry_0593Cmp(t *testing.T) {
	var x, y e_nocarry_0593
...
func TestE_nocarry_0593IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0593
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0593

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0593{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0593
	one.SetOne()
	e.Sub(&qe_nocarry_0593, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0593{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0593{0, uint64(i)})
	}
...
func TestE_nocarry_0593NegZero(t *testing.T) {
	var a, b e_nocarry_0593
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0593Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0593, len(staticTestValues))
...
func TestE_nocarry_0593Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0593) bool {
			var b e_nocarry_0593
...
func TestE_nocarry_0593InverseExp(t *testing.T) {
...
func TestE_nocarry_0593MulByConstants(t *testing.T) {
...
func TestE_nocarry_0593Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0593) bool {
...
func TestE_nocarry_0593LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0593Halve(t *testing.T) {
...
func TestE_nocarry_0593FromMont(t *testing.T) {
...
type testPaire_nocarry_0593 struct {
	element e_nocarry_0593
	bigint  big.Int
}

func (z *e_nocarry_0593) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0593[9] {
		return true
	}
	if z[9] < qe_nocarry_0593[9] {
		return false
	...
	return z[0] >= qe_nocarry_0593[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0593

		g.element = e_nocarry_0593{
		...
		if qe_nocarry_0593[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0593[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0593 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0593[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0593[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0593[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0593[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0593[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0593[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0593[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0593[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0593[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0593[9], carry)
...
func Benchmarke_nocarry_0593InverseNew(b *testing.B) {
	var x e_nocarry_0593
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0593
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0593
		var xInv e_nocarry_0593
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0593
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0593
...
func testLinearComb(t *testing.T, x *e_nocarry_0593, xC int64, y *e_nocarry_0593, yC int64) {
	...
	var z e_nocarry_0593
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0593, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0593
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0593, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0593
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0593, xHi uint64) {
	var res e_nocarry_0593
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0593) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0593) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0593, c int64, result *e_nocarry_0593, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0593) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0593) uint64 {
