...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x2b58fdbdb92a85e7, R12
	ADDQ R12, AX
	MOVQ $0x5a93a29adad0962a, R12
	ADCQ R12, DX
	MOVQ $0xda6644f3a4db006b, R12
	ADCQ R12, CX
	MOVQ $0xa0d7816909cc865f, R12
	ADCQ R12, BX
	MOVQ $0xaf4b560a6d6539df, R12
	ADCQ R12, SI
	MOVQ $0x9610000697009e4e, R12
	ADCQ R12, DI
	MOVQ $0xcc88717692e92725, R12
	ADCQ R12, R8
	MOVQ $0x6bb4d88bf81cfe9a, R12
	ADCQ R12, R9
	MOVQ $0x0000000d874932ba, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x2b58fdbdb92a85e7, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x5a93a29adad0962a, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xda6644f3a4db006b, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xa0d7816909cc865f, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xaf4b560a6d6539df, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x9610000697009e4e, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xcc88717692e92725, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x6bb4d88bf81cfe9a, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000d874932ba, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x2b58fdbdb92a85e7, AX
	ADDQ AX, DX
	MOVQ $0x5a93a29adad0962a, AX
	ADCQ AX, CX
	MOVQ $0xda6644f3a4db006b, AX
	ADCQ AX, BX
	MOVQ $0xa0d7816909cc865f, AX
	ADCQ AX, SI
	MOVQ $0xaf4b560a6d6539df, AX
	ADCQ AX, DI
	MOVQ $0x9610000697009e4e, AX
	ADCQ AX, R8
	MOVQ $0xcc88717692e92725, AX
	ADCQ AX, R9
	MOVQ $0x6bb4d88bf81cfe9a, AX
	ADCQ AX, R10
	MOVQ $0x0000000d874932ba, AX
	ADCQ AX, R11
