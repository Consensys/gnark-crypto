...
var benchRese_nocarry_0548 e_nocarry_0548

func BenchmarkE_nocarry_0548SetBytes(b *testing.B) {
	var x e_nocarry_0548
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0548MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0548.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0548)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0548)
		}
	})
}

func BenchmarkE_nocarry_0548Inverse(b *testing.B) {
	var x e_nocarry_0548
	x.SetRandom()
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0548Butterfly(b *testing.B) {
	var x e_nocarry_0548
	x.SetRandom()
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0548)
	}
}

func BenchmarkE_nocarry_0548Exp(b *testing.B) {
	var x e_nocarry_0548
	x.SetRandom()
	benchRese_nocarry_0548.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0548Double(b *testing.B) {
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Double(&benchRese_nocarry_0548)
	}
}

func BenchmarkE_nocarry_0548Add(b *testing.B) {
	var x e_nocarry_0548
	x.SetRandom()
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Add(&x, &benchRese_nocarry_0548)
	}
}

func BenchmarkE_nocarry_0548Sub(b *testing.B) {
	var x e_nocarry_0548
	x.SetRandom()
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Sub(&x, &benchRese_nocarry_0548)
	}
}

func BenchmarkE_nocarry_0548Neg(b *testing.B) {
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Neg(&benchRese_nocarry_0548)
	}
}

func BenchmarkE_nocarry_0548Div(b *testing.B) {
	var x e_nocarry_0548
	x.SetRandom()
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Div(&x, &benchRese_nocarry_0548)
	}
}

func BenchmarkE_nocarry_0548FromMont(b *testing.B) {
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.FromMont()
	}
}

func BenchmarkE_nocarry_0548ToMont(b *testing.B) {
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.ToMont()
	}
}
func BenchmarkE_nocarry_0548Square(b *testing.B) {
	benchRese_nocarry_0548.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Square(&benchRese_nocarry_0548)
	}
}

func BenchmarkE_nocarry_0548Sqrt(b *testing.B) {
	var a e_nocarry_0548
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0548Mul(b *testing.B) {
	x := e_nocarry_0548{
		2976030402125685578,
	...
	benchRese_nocarry_0548.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Mul(&benchRese_nocarry_0548, &x)
	}
}

func BenchmarkE_nocarry_0548Cmp(b *testing.B) {
	x := e_nocarry_0548{
		2976030402125685578,
		17626418638376060534,
		3145026253178954908,
	...
	benchRese_nocarry_0548 = x
	benchRese_nocarry_0548[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0548.Cmp(&x)
	}
}

func TestE_nocarry_0548Cmp(t *testing.T) {
	var x, y e_nocarry_0548
...
func TestE_nocarry_0548IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0548
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0548

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0548{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0548
	one.SetOne()
	e.Sub(&qe_nocarry_0548, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0548{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0548{0, uint64(i)})
	}
...
func TestE_nocarry_0548NegZero(t *testing.T) {
	var a, b e_nocarry_0548
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0548Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0548, len(staticTestValues))
...
func TestE_nocarry_0548Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0548) bool {
			var b e_nocarry_0548
...
func TestE_nocarry_0548InverseExp(t *testing.T) {
...
func TestE_nocarry_0548MulByConstants(t *testing.T) {
...
func TestE_nocarry_0548Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0548) bool {
...
func TestE_nocarry_0548LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0548Halve(t *testing.T) {
...
func TestE_nocarry_0548FromMont(t *testing.T) {
...
type testPaire_nocarry_0548 struct {
	element e_nocarry_0548
	bigint  big.Int
}

func (z *e_nocarry_0548) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0548[8] {
		return true
	}
	if z[8] < qe_nocarry_0548[8] {
		return false
	...
	return z[0] >= qe_nocarry_0548[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0548

		g.element = e_nocarry_0548{
		...
		if qe_nocarry_0548[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0548[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0548 {
			var g e_nocarry_0548
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0548[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0548[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0548[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0548[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0548[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0548[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0548[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0548[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0548[8], carry)
...
func Benchmarke_nocarry_0548InverseNew(b *testing.B) {
	var x e_nocarry_0548
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0548
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0548
		var xInv e_nocarry_0548
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0548
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0548
...
func testLinearComb(t *testing.T, x *e_nocarry_0548, xC int64, y *e_nocarry_0548, yC int64) {
	...
	var z e_nocarry_0548
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0548, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0548
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0548, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0548
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0548, xHi uint64) {
	var res e_nocarry_0548
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0548) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0548) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0548, c int64, result *e_nocarry_0548, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0548) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0548) uint64 {
