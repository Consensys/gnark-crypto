...
var benchRese_nocarry_0535 e_nocarry_0535

func BenchmarkE_nocarry_0535SetBytes(b *testing.B) {
	var x e_nocarry_0535
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0535MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0535.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0535)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0535)
		}
	})
}

func BenchmarkE_nocarry_0535Inverse(b *testing.B) {
	var x e_nocarry_0535
	x.SetRandom()
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0535Butterfly(b *testing.B) {
	var x e_nocarry_0535
	x.SetRandom()
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0535)
	}
}

func BenchmarkE_nocarry_0535Exp(b *testing.B) {
	var x e_nocarry_0535
	x.SetRandom()
	benchRese_nocarry_0535.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0535Double(b *testing.B) {
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Double(&benchRese_nocarry_0535)
	}
}

func BenchmarkE_nocarry_0535Add(b *testing.B) {
	var x e_nocarry_0535
	x.SetRandom()
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Add(&x, &benchRese_nocarry_0535)
	}
}

func BenchmarkE_nocarry_0535Sub(b *testing.B) {
	var x e_nocarry_0535
	x.SetRandom()
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Sub(&x, &benchRese_nocarry_0535)
	}
}

func BenchmarkE_nocarry_0535Neg(b *testing.B) {
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Neg(&benchRese_nocarry_0535)
	}
}

func BenchmarkE_nocarry_0535Div(b *testing.B) {
	var x e_nocarry_0535
	x.SetRandom()
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Div(&x, &benchRese_nocarry_0535)
	}
}

func BenchmarkE_nocarry_0535FromMont(b *testing.B) {
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.FromMont()
	}
}

func BenchmarkE_nocarry_0535ToMont(b *testing.B) {
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.ToMont()
	}
}
func BenchmarkE_nocarry_0535Square(b *testing.B) {
	benchRese_nocarry_0535.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Square(&benchRese_nocarry_0535)
	}
}

func BenchmarkE_nocarry_0535Sqrt(b *testing.B) {
	var a e_nocarry_0535
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0535Mul(b *testing.B) {
	x := e_nocarry_0535{
		3602509566553452801,
		8822424765014202447,
	...
	benchRese_nocarry_0535.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Mul(&benchRese_nocarry_0535, &x)
	}
}

func BenchmarkE_nocarry_0535Cmp(b *testing.B) {
	x := e_nocarry_0535{
		3602509566553452801,
		8822424765014202447,
		15597416341468285903,
	...
	benchRese_nocarry_0535 = x
	benchRese_nocarry_0535[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0535.Cmp(&x)
	}
}

func TestE_nocarry_0535Cmp(t *testing.T) {
	var x, y e_nocarry_0535
...
func TestE_nocarry_0535IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0535
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0535

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0535{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0535
	one.SetOne()
	e.Sub(&qe_nocarry_0535, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0535{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0535{0, uint64(i)})
	}
...
func TestE_nocarry_0535NegZero(t *testing.T) {
	var a, b e_nocarry_0535
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0535Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0535, len(staticTestValues))
...
func TestE_nocarry_0535Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0535) bool {
			var b e_nocarry_0535
...
func TestE_nocarry_0535InverseExp(t *testing.T) {
...
func TestE_nocarry_0535MulByConstants(t *testing.T) {
...
func TestE_nocarry_0535Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0535) bool {
...
func TestE_nocarry_0535LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0535Halve(t *testing.T) {
...
func TestE_nocarry_0535FromMont(t *testing.T) {
...
type testPaire_nocarry_0535 struct {
	element e_nocarry_0535
	bigint  big.Int
}

func (z *e_nocarry_0535) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0535[8] {
		return true
	}
	if z[8] < qe_nocarry_0535[8] {
		return false
	...
	return z[0] >= qe_nocarry_0535[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0535

		g.element = e_nocarry_0535{
		...
		if qe_nocarry_0535[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0535[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0535 {
			var g e_nocarry_0535
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0535[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0535[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0535[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0535[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0535[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0535[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0535[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0535[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0535[8], carry)
...
func Benchmarke_nocarry_0535InverseNew(b *testing.B) {
	var x e_nocarry_0535
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0535
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0535
		var xInv e_nocarry_0535
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0535
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0535
...
func testLinearComb(t *testing.T, x *e_nocarry_0535, xC int64, y *e_nocarry_0535, yC int64) {
	...
	var z e_nocarry_0535
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0535, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0535
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0535, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0535
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0535, xHi uint64) {
	var res e_nocarry_0535
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0535) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0535) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0535, c int64, result *e_nocarry_0535, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0535) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0535) uint64 {
