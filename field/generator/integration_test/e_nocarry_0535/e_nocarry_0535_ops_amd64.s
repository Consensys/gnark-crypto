...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xfa9597eae2537055, R12
	ADDQ R12, AX
	MOVQ $0xdfd365e233d056c2, R12
	ADCQ R12, DX
	MOVQ $0x3e148bb820637359, R12
	ADCQ R12, CX
	MOVQ $0x12056fc9e6d6a664, R12
	ADCQ R12, BX
	MOVQ $0x04058ceded6715db, R12
	ADCQ R12, SI
	MOVQ $0x662e6cd73788d394, R12
	ADCQ R12, DI
	MOVQ $0x6c96a07dc434f9c4, R12
	ADCQ R12, R8
	MOVQ $0xb2b29b2a96ea4c81, R12
	ADCQ R12, R9
	MOVQ $0x000000000073f558, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xfa9597eae2537055, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xdfd365e233d056c2, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x3e148bb820637359, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x12056fc9e6d6a664, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x04058ceded6715db, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x662e6cd73788d394, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x6c96a07dc434f9c4, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xb2b29b2a96ea4c81, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000000073f558, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xfa9597eae2537055, AX
	ADDQ AX, DX
	MOVQ $0xdfd365e233d056c2, AX
	ADCQ AX, CX
	MOVQ $0x3e148bb820637359, AX
	ADCQ AX, BX
	MOVQ $0x12056fc9e6d6a664, AX
	ADCQ AX, SI
	MOVQ $0x04058ceded6715db, AX
	ADCQ AX, DI
	MOVQ $0x662e6cd73788d394, AX
	ADCQ AX, R8
	MOVQ $0x6c96a07dc434f9c4, AX
	ADCQ AX, R9
	MOVQ $0xb2b29b2a96ea4c81, AX
	ADCQ AX, R10
	MOVQ $0x000000000073f558, AX
	ADCQ AX, R11
