...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xfd2cc4b6245221ed, R13
	ADDQ R13, AX
	MOVQ $0x26391faaf2846921, R13
	ADCQ R13, DX
	MOVQ $0x68c8b6b1de6a737a, R13
	ADCQ R13, CX
	MOVQ $0x683f7e0ba11321f4, R13
	ADCQ R13, BX
	MOVQ $0xabbc7f35ad34b08c, R13
	ADCQ R13, SI
	MOVQ $0xd936417f29886b4c, R13
	ADCQ R13, DI
	MOVQ $0x1e3f96341fdab85b, R13
	ADCQ R13, R8
	MOVQ $0xe31fdc8fe91e7265, R13
	ADCQ R13, R9
	MOVQ $0xe32a1ab1340ded73, R13
	ADCQ R13, R10
	MOVQ $0x000000000000007e, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xfd2cc4b6245221ed, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x26391faaf2846921, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x68c8b6b1de6a737a, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x683f7e0ba11321f4, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xabbc7f35ad34b08c, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xd936417f29886b4c, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x1e3f96341fdab85b, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xe31fdc8fe91e7265, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xe32a1ab1340ded73, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000000000007e, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xfd2cc4b6245221ed, AX
	ADDQ AX, DX
	MOVQ $0x26391faaf2846921, AX
	ADCQ AX, CX
	MOVQ $0x68c8b6b1de6a737a, AX
	ADCQ AX, BX
	MOVQ $0x683f7e0ba11321f4, AX
	ADCQ AX, SI
	MOVQ $0xabbc7f35ad34b08c, AX
	ADCQ AX, DI
	MOVQ $0xd936417f29886b4c, AX
	ADCQ AX, R8
	MOVQ $0x1e3f96341fdab85b, AX
	ADCQ AX, R9
	MOVQ $0xe31fdc8fe91e7265, AX
	ADCQ AX, R10
	MOVQ $0xe32a1ab1340ded73, AX
	ADCQ AX, R11
	MOVQ $0x000000000000007e, AX
	ADCQ AX, R12
