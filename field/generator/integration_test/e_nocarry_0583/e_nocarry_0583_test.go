...
var benchRese_nocarry_0583 e_nocarry_0583

func BenchmarkE_nocarry_0583SetBytes(b *testing.B) {
	var x e_nocarry_0583
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0583MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0583.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0583)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0583)
		}
	})
}

func BenchmarkE_nocarry_0583Inverse(b *testing.B) {
	var x e_nocarry_0583
	x.SetRandom()
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0583Butterfly(b *testing.B) {
	var x e_nocarry_0583
	x.SetRandom()
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0583)
	}
}

func BenchmarkE_nocarry_0583Exp(b *testing.B) {
	var x e_nocarry_0583
	x.SetRandom()
	benchRese_nocarry_0583.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0583Double(b *testing.B) {
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Double(&benchRese_nocarry_0583)
	}
}

func BenchmarkE_nocarry_0583Add(b *testing.B) {
	var x e_nocarry_0583
	x.SetRandom()
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Add(&x, &benchRese_nocarry_0583)
	}
}

func BenchmarkE_nocarry_0583Sub(b *testing.B) {
	var x e_nocarry_0583
	x.SetRandom()
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Sub(&x, &benchRese_nocarry_0583)
	}
}

func BenchmarkE_nocarry_0583Neg(b *testing.B) {
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Neg(&benchRese_nocarry_0583)
	}
}

func BenchmarkE_nocarry_0583Div(b *testing.B) {
	var x e_nocarry_0583
	x.SetRandom()
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Div(&x, &benchRese_nocarry_0583)
	}
}

func BenchmarkE_nocarry_0583FromMont(b *testing.B) {
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.FromMont()
	}
}

func BenchmarkE_nocarry_0583ToMont(b *testing.B) {
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.ToMont()
	}
}
func BenchmarkE_nocarry_0583Square(b *testing.B) {
	benchRese_nocarry_0583.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Square(&benchRese_nocarry_0583)
	}
}

func BenchmarkE_nocarry_0583Sqrt(b *testing.B) {
	var a e_nocarry_0583
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0583Mul(b *testing.B) {
	x := e_nocarry_0583{
		7800053871292856567,
	...
	benchRese_nocarry_0583.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Mul(&benchRese_nocarry_0583, &x)
	}
}

func BenchmarkE_nocarry_0583Cmp(b *testing.B) {
	x := e_nocarry_0583{
		7800053871292856567,
		10328218043002696912,
		14289549825935140380,
	...
	benchRese_nocarry_0583 = x
	benchRese_nocarry_0583[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0583.Cmp(&x)
	}
}

func TestE_nocarry_0583Cmp(t *testing.T) {
	var x, y e_nocarry_0583
...
func TestE_nocarry_0583IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0583
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0583

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0583{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0583
	one.SetOne()
	e.Sub(&qe_nocarry_0583, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0583{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0583{0, uint64(i)})
	}
...
func TestE_nocarry_0583NegZero(t *testing.T) {
	var a, b e_nocarry_0583
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0583Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0583, len(staticTestValues))
...
func TestE_nocarry_0583Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0583) bool {
			var b e_nocarry_0583
...
func TestE_nocarry_0583InverseExp(t *testing.T) {
...
func TestE_nocarry_0583MulByConstants(t *testing.T) {
...
func TestE_nocarry_0583Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0583) bool {
...
func TestE_nocarry_0583LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0583Halve(t *testing.T) {
...
func TestE_nocarry_0583FromMont(t *testing.T) {
...
type testPaire_nocarry_0583 struct {
	element e_nocarry_0583
	bigint  big.Int
}

func (z *e_nocarry_0583) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0583[9] {
		return true
	}
	if z[9] < qe_nocarry_0583[9] {
		return false
	...
	return z[0] >= qe_nocarry_0583[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0583

		g.element = e_nocarry_0583{
		...
		if qe_nocarry_0583[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0583[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0583 {
			var g e_nocarry_0583
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0583[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0583[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0583[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0583[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0583[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0583[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0583[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0583[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0583[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0583[9], carry)
...
func Benchmarke_nocarry_0583InverseNew(b *testing.B) {
	var x e_nocarry_0583
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0583
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0583
		var xInv e_nocarry_0583
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0583
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0583
...
func testLinearComb(t *testing.T, x *e_nocarry_0583, xC int64, y *e_nocarry_0583, yC int64) {
	...
	var z e_nocarry_0583
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0583, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0583
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0583, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0583
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0583, xHi uint64) {
	var res e_nocarry_0583
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0583) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0583) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0583, c int64, result *e_nocarry_0583, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0583) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0583) uint64 {
