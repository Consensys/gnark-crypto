...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0447{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0447{0, uint64(i)})
	}
...
func (z *e_nocarry_0447) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0447[6] {
		return true
	}
	if z[6] < qe_nocarry_0447[6] {
		return false
...
func Benchmarke_nocarry_0447InverseNew(b *testing.B) {
	var x e_nocarry_0447
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0447, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0447, xHi uint64) {
