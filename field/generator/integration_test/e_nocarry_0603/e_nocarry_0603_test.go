...
var benchRese_nocarry_0603 e_nocarry_0603

func BenchmarkE_nocarry_0603SetBytes(b *testing.B) {
	var x e_nocarry_0603
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0603MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0603.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0603)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0603)
		}
	})
}

func BenchmarkE_nocarry_0603Inverse(b *testing.B) {
	var x e_nocarry_0603
	x.SetRandom()
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0603Butterfly(b *testing.B) {
	var x e_nocarry_0603
	x.SetRandom()
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0603)
	}
}

func BenchmarkE_nocarry_0603Exp(b *testing.B) {
	var x e_nocarry_0603
	x.SetRandom()
	benchRese_nocarry_0603.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0603Double(b *testing.B) {
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Double(&benchRese_nocarry_0603)
	}
}

func BenchmarkE_nocarry_0603Add(b *testing.B) {
	var x e_nocarry_0603
	x.SetRandom()
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Add(&x, &benchRese_nocarry_0603)
	}
}

func BenchmarkE_nocarry_0603Sub(b *testing.B) {
	var x e_nocarry_0603
	x.SetRandom()
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Sub(&x, &benchRese_nocarry_0603)
	}
}

func BenchmarkE_nocarry_0603Neg(b *testing.B) {
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Neg(&benchRese_nocarry_0603)
	}
}

func BenchmarkE_nocarry_0603Div(b *testing.B) {
	var x e_nocarry_0603
	x.SetRandom()
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Div(&x, &benchRese_nocarry_0603)
	}
}

func BenchmarkE_nocarry_0603FromMont(b *testing.B) {
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.FromMont()
	}
}

func BenchmarkE_nocarry_0603ToMont(b *testing.B) {
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.ToMont()
	}
}
func BenchmarkE_nocarry_0603Square(b *testing.B) {
	benchRese_nocarry_0603.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Square(&benchRese_nocarry_0603)
	}
}

func BenchmarkE_nocarry_0603Sqrt(b *testing.B) {
	var a e_nocarry_0603
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0603Mul(b *testing.B) {
	x := e_nocarry_0603{
	...
	benchRese_nocarry_0603.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Mul(&benchRese_nocarry_0603, &x)
	}
}

func BenchmarkE_nocarry_0603Cmp(b *testing.B) {
	x := e_nocarry_0603{
		10952992240491129345,
		1386327026135675286,
		790440188375907079,
	...
	benchRese_nocarry_0603 = x
	benchRese_nocarry_0603[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0603.Cmp(&x)
	}
}

func TestE_nocarry_0603Cmp(t *testing.T) {
	var x, y e_nocarry_0603
...
func TestE_nocarry_0603IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0603
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0603

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0603{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0603
	one.SetOne()
	e.Sub(&qe_nocarry_0603, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0603{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0603{0, uint64(i)})
	}
...
func TestE_nocarry_0603NegZero(t *testing.T) {
	var a, b e_nocarry_0603
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0603Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0603, len(staticTestValues))
...
func TestE_nocarry_0603Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0603) bool {
			var b e_nocarry_0603
...
func TestE_nocarry_0603InverseExp(t *testing.T) {
...
func TestE_nocarry_0603MulByConstants(t *testing.T) {
...
func TestE_nocarry_0603Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0603) bool {
...
func TestE_nocarry_0603LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0603Halve(t *testing.T) {
...
func TestE_nocarry_0603FromMont(t *testing.T) {
...
type testPaire_nocarry_0603 struct {
	element e_nocarry_0603
	bigint  big.Int
}

func (z *e_nocarry_0603) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0603[9] {
		return true
	}
	if z[9] < qe_nocarry_0603[9] {
		return false
	...
	return z[0] >= qe_nocarry_0603[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0603

		g.element = e_nocarry_0603{
		...
		if qe_nocarry_0603[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0603[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0603 {
			var g e_nocarry_0603
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0603[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0603[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0603[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0603[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0603[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0603[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0603[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0603[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0603[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0603[9], carry)
...
func Benchmarke_nocarry_0603InverseNew(b *testing.B) {
	var x e_nocarry_0603
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0603
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0603
		var xInv e_nocarry_0603
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0603
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0603
...
func testLinearComb(t *testing.T, x *e_nocarry_0603, xC int64, y *e_nocarry_0603, yC int64) {
	...
	var z e_nocarry_0603
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0603, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0603
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0603, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0603
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0603, xHi uint64) {
	var res e_nocarry_0603
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0603) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0603) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0603, c int64, result *e_nocarry_0603, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0603) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0603) uint64 {
