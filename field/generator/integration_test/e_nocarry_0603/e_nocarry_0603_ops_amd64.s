...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xa5d1a9b595f21525, R13
	ADDQ R13, AX
	MOVQ $0x9a3dae32d4223a43, R13
	ADCQ R13, DX
	MOVQ $0x69f48ff388f0cad1, R13
	ADCQ R13, CX
	MOVQ $0x2f7afdb5adaed705, R13
	ADCQ R13, BX
	MOVQ $0x78a17209eaf6af59, R13
	ADCQ R13, SI
	MOVQ $0x0708f2a1eae76c16, R13
	ADCQ R13, DI
	MOVQ $0x89be3f44fac083ca, R13
	ADCQ R13, R8
	MOVQ $0x9cd6fd1a0c56163a, R13
	ADCQ R13, R9
	MOVQ $0xabdcc958006aa431, R13
	ADCQ R13, R10
	MOVQ $0x000000000656d6c1, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xa5d1a9b595f21525, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x9a3dae32d4223a43, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x69f48ff388f0cad1, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x2f7afdb5adaed705, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x78a17209eaf6af59, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x0708f2a1eae76c16, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x89be3f44fac083ca, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x9cd6fd1a0c56163a, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xabdcc958006aa431, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000000656d6c1, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xa5d1a9b595f21525, AX
	ADDQ AX, DX
	MOVQ $0x9a3dae32d4223a43, AX
	ADCQ AX, CX
	MOVQ $0x69f48ff388f0cad1, AX
	ADCQ AX, BX
	MOVQ $0x2f7afdb5adaed705, AX
	ADCQ AX, SI
	MOVQ $0x78a17209eaf6af59, AX
	ADCQ AX, DI
	MOVQ $0x0708f2a1eae76c16, AX
	ADCQ AX, R8
	MOVQ $0x89be3f44fac083ca, AX
	ADCQ AX, R9
	MOVQ $0x9cd6fd1a0c56163a, AX
	ADCQ AX, R10
	MOVQ $0xabdcc958006aa431, AX
	ADCQ AX, R11
	MOVQ $0x000000000656d6c1, AX
	ADCQ AX, R12
