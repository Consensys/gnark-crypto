...
var benchRese_nocarry_0417 e_nocarry_0417

func BenchmarkE_nocarry_0417SetBytes(b *testing.B) {
	var x e_nocarry_0417
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0417MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0417.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0417)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0417)
		}
	})
}

func BenchmarkE_nocarry_0417Inverse(b *testing.B) {
	var x e_nocarry_0417
	x.SetRandom()
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0417Butterfly(b *testing.B) {
	var x e_nocarry_0417
	x.SetRandom()
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0417)
	}
}

func BenchmarkE_nocarry_0417Exp(b *testing.B) {
	var x e_nocarry_0417
	x.SetRandom()
	benchRese_nocarry_0417.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0417Double(b *testing.B) {
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Double(&benchRese_nocarry_0417)
	}
}

func BenchmarkE_nocarry_0417Add(b *testing.B) {
	var x e_nocarry_0417
	x.SetRandom()
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Add(&x, &benchRese_nocarry_0417)
	}
}

func BenchmarkE_nocarry_0417Sub(b *testing.B) {
	var x e_nocarry_0417
	x.SetRandom()
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Sub(&x, &benchRese_nocarry_0417)
	}
}

func BenchmarkE_nocarry_0417Neg(b *testing.B) {
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Neg(&benchRese_nocarry_0417)
	}
}

func BenchmarkE_nocarry_0417Div(b *testing.B) {
	var x e_nocarry_0417
	x.SetRandom()
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Div(&x, &benchRese_nocarry_0417)
	}
}

func BenchmarkE_nocarry_0417FromMont(b *testing.B) {
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.FromMont()
	}
}

func BenchmarkE_nocarry_0417ToMont(b *testing.B) {
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.ToMont()
	}
}
func BenchmarkE_nocarry_0417Square(b *testing.B) {
	benchRese_nocarry_0417.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Square(&benchRese_nocarry_0417)
	}
}

func BenchmarkE_nocarry_0417Sqrt(b *testing.B) {
	var a e_nocarry_0417
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0417Mul(b *testing.B) {
	x := e_nocarry_0417{
		8401817508701539083,
	...
	benchRese_nocarry_0417.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Mul(&benchRese_nocarry_0417, &x)
	}
}

func BenchmarkE_nocarry_0417Cmp(b *testing.B) {
	x := e_nocarry_0417{
		8401817508701539083,
		15752851124777849061,
		7534743753137142145,
	...
	benchRese_nocarry_0417 = x
	benchRese_nocarry_0417[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0417.Cmp(&x)
	}
}

func TestE_nocarry_0417Cmp(t *testing.T) {
	var x, y e_nocarry_0417
...
func TestE_nocarry_0417IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0417
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0417

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0417{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0417
	one.SetOne()
	e.Sub(&qe_nocarry_0417, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0417{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0417{0, uint64(i)})
	}
...
func TestE_nocarry_0417NegZero(t *testing.T) {
	var a, b e_nocarry_0417
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0417Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0417, len(staticTestValues))
...
func TestE_nocarry_0417Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0417) bool {
			var b e_nocarry_0417
...
func TestE_nocarry_0417InverseExp(t *testing.T) {
...
func TestE_nocarry_0417MulByConstants(t *testing.T) {
...
func TestE_nocarry_0417Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0417) bool {
...
func TestE_nocarry_0417LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0417Halve(t *testing.T) {
...
func TestE_nocarry_0417FromMont(t *testing.T) {
...
type testPaire_nocarry_0417 struct {
	element e_nocarry_0417
	bigint  big.Int
}

func (z *e_nocarry_0417) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0417[6] {
		return true
	}
	if z[6] < qe_nocarry_0417[6] {
		return false
	...
	return z[0] >= qe_nocarry_0417[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0417

		g.element = e_nocarry_0417{
		...
		if qe_nocarry_0417[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0417[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0417 {
			var g e_nocarry_0417
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0417[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0417[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0417[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0417[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0417[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0417[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0417[6], carry)
...
func Benchmarke_nocarry_0417InverseNew(b *testing.B) {
	var x e_nocarry_0417
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0417
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0417
		var xInv e_nocarry_0417
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0417
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0417
...
func testLinearComb(t *testing.T, x *e_nocarry_0417, xC int64, y *e_nocarry_0417, yC int64) {
	...
	var z e_nocarry_0417
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0417, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0417
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0417, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0417
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0417, xHi uint64) {
	var res e_nocarry_0417
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0417) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0417) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0417, c int64, result *e_nocarry_0417, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0417) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0417) uint64 {
