...
var benchRese_nocarry_0145 e_nocarry_0145

func BenchmarkE_nocarry_0145SetBytes(b *testing.B) {
	var x e_nocarry_0145
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0145MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0145.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0145)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0145)
		}
	})
}

func BenchmarkE_nocarry_0145Inverse(b *testing.B) {
	var x e_nocarry_0145
	x.SetRandom()
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0145Butterfly(b *testing.B) {
	var x e_nocarry_0145
	x.SetRandom()
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0145)
	}
}

func BenchmarkE_nocarry_0145Exp(b *testing.B) {
	var x e_nocarry_0145
	x.SetRandom()
	benchRese_nocarry_0145.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0145Double(b *testing.B) {
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Double(&benchRese_nocarry_0145)
	}
}

func BenchmarkE_nocarry_0145Add(b *testing.B) {
	var x e_nocarry_0145
	x.SetRandom()
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Add(&x, &benchRese_nocarry_0145)
	}
}

func BenchmarkE_nocarry_0145Sub(b *testing.B) {
	var x e_nocarry_0145
	x.SetRandom()
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Sub(&x, &benchRese_nocarry_0145)
	}
}

func BenchmarkE_nocarry_0145Neg(b *testing.B) {
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Neg(&benchRese_nocarry_0145)
	}
}

func BenchmarkE_nocarry_0145Div(b *testing.B) {
	var x e_nocarry_0145
	x.SetRandom()
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Div(&x, &benchRese_nocarry_0145)
	}
}

func BenchmarkE_nocarry_0145FromMont(b *testing.B) {
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.FromMont()
	}
}

func BenchmarkE_nocarry_0145ToMont(b *testing.B) {
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.ToMont()
	}
}
func BenchmarkE_nocarry_0145Square(b *testing.B) {
	benchRese_nocarry_0145.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Square(&benchRese_nocarry_0145)
	}
}

func BenchmarkE_nocarry_0145Sqrt(b *testing.B) {
	var a e_nocarry_0145
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0145Mul(b *testing.B) {
	x := e_nocarry_0145{
		9303103934610729655,
		8007402030191628478,
		57273,
	}
	benchRese_nocarry_0145.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Mul(&benchRese_nocarry_0145, &x)
	}
}

func BenchmarkE_nocarry_0145Cmp(b *testing.B) {
	x := e_nocarry_0145{
		9303103934610729655,
		8007402030191628478,
		57273,
	}
	benchRese_nocarry_0145 = x
	benchRese_nocarry_0145[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0145.Cmp(&x)
	}
}

func TestE_nocarry_0145Cmp(t *testing.T) {
	var x, y e_nocarry_0145
...
func TestE_nocarry_0145IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0145
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0145

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0145{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0145
	one.SetOne()
	e.Sub(&qe_nocarry_0145, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0145{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0145{0, uint64(i)})
	}
...
func TestE_nocarry_0145NegZero(t *testing.T) {
	var a, b e_nocarry_0145
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0145Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0145, len(staticTestValues))
...
func TestE_nocarry_0145Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0145) bool {
			var b e_nocarry_0145
...
func TestE_nocarry_0145InverseExp(t *testing.T) {
...
func TestE_nocarry_0145MulByConstants(t *testing.T) {
...
func TestE_nocarry_0145Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0145) bool {
...
func TestE_nocarry_0145LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0145Halve(t *testing.T) {
...
func TestE_nocarry_0145FromMont(t *testing.T) {
...
type testPaire_nocarry_0145 struct {
	element e_nocarry_0145
	bigint  big.Int
}

func (z *e_nocarry_0145) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0145[2] {
		return true
	}
	if z[2] < qe_nocarry_0145[2] {
		return false
	...
	return z[0] >= qe_nocarry_0145[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0145

		g.element = e_nocarry_0145{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0145[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0145[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0145 {
			var g e_nocarry_0145
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0145[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0145[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0145[2], carry)
...
func Benchmarke_nocarry_0145InverseNew(b *testing.B) {
	var x e_nocarry_0145
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0145
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0145
		var xInv e_nocarry_0145
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0145
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0145
...
func testLinearComb(t *testing.T, x *e_nocarry_0145, xC int64, y *e_nocarry_0145, yC int64) {
	...
	var z e_nocarry_0145
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0145, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0145
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0145, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0145
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0145, xHi uint64) {
	var res e_nocarry_0145
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0145) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0145) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0145, c int64, result *e_nocarry_0145, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0145) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0145) uint64 {
