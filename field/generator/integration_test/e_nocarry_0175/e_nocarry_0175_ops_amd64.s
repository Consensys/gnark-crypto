...
// modulus q
DATA q<>+0(SB)/8, $0xb2121851b882439d
DATA q<>+8(SB)/8, $0xed24719e43017ca8
DATA q<>+16(SB)/8, $0x000061013a404861
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x42820d558eaaa54b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xb2121851b882439d, DI
	MOVQ    $0xed24719e43017ca8, R8
	MOVQ    $0x000061013a404861, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xed24719e43017ca8, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x000061013a404861, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xb2121851b882439d, R10
	MOVQ    $0xed24719e43017ca8, R11
	MOVQ    $0x000061013a404861, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
