...
// modulus q
DATA q<>+0(SB)/8, $0x1f3cc58e47ddabe3
DATA q<>+8(SB)/8, $0x4e658f7e9c46f5a1
DATA q<>+16(SB)/8, $0xa9062a2e09d11c52
DATA q<>+24(SB)/8, $0xf22dd0b8d88dfb09
DATA q<>+32(SB)/8, $0xb69324afbded02c9
DATA q<>+40(SB)/8, $0x00d65364b89595e3
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x66e8af1029870e35
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x1f3cc58e47ddabe3, R10
	MOVQ    $0x4e658f7e9c46f5a1, R11
	MOVQ    $0xa9062a2e09d11c52, R12
	MOVQ    $0xf22dd0b8d88dfb09, R13
	MOVQ    $0xb69324afbded02c9, R14
	MOVQ    $0x00d65364b89595e3, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x4e658f7e9c46f5a1, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xa9062a2e09d11c52, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xf22dd0b8d88dfb09, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xb69324afbded02c9, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00d65364b89595e3, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x1f3cc58e47ddabe3, CX
	MOVQ    $0x4e658f7e9c46f5a1, BX
	MOVQ    $0xa9062a2e09d11c52, SI
	MOVQ    $0xf22dd0b8d88dfb09, DI
	MOVQ    $0xb69324afbded02c9, R8
	MOVQ    $0x00d65364b89595e3, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
