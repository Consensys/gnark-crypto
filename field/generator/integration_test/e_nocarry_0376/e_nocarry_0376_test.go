...
var benchRese_nocarry_0376 e_nocarry_0376

func BenchmarkE_nocarry_0376SetBytes(b *testing.B) {
	var x e_nocarry_0376
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0376MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0376.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0376)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0376)
		}
	})
}

func BenchmarkE_nocarry_0376Inverse(b *testing.B) {
	var x e_nocarry_0376
	x.SetRandom()
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0376Butterfly(b *testing.B) {
	var x e_nocarry_0376
	x.SetRandom()
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0376)
	}
}

func BenchmarkE_nocarry_0376Exp(b *testing.B) {
	var x e_nocarry_0376
	x.SetRandom()
	benchRese_nocarry_0376.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0376Double(b *testing.B) {
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Double(&benchRese_nocarry_0376)
	}
}

func BenchmarkE_nocarry_0376Add(b *testing.B) {
	var x e_nocarry_0376
	x.SetRandom()
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Add(&x, &benchRese_nocarry_0376)
	}
}

func BenchmarkE_nocarry_0376Sub(b *testing.B) {
	var x e_nocarry_0376
	x.SetRandom()
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Sub(&x, &benchRese_nocarry_0376)
	}
}

func BenchmarkE_nocarry_0376Neg(b *testing.B) {
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Neg(&benchRese_nocarry_0376)
	}
}

func BenchmarkE_nocarry_0376Div(b *testing.B) {
	var x e_nocarry_0376
	x.SetRandom()
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Div(&x, &benchRese_nocarry_0376)
	}
}

func BenchmarkE_nocarry_0376FromMont(b *testing.B) {
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.FromMont()
	}
}

func BenchmarkE_nocarry_0376ToMont(b *testing.B) {
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.ToMont()
	}
}
func BenchmarkE_nocarry_0376Square(b *testing.B) {
	benchRese_nocarry_0376.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Square(&benchRese_nocarry_0376)
	}
}

func BenchmarkE_nocarry_0376Sqrt(b *testing.B) {
	var a e_nocarry_0376
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0376Mul(b *testing.B) {
	x := e_nocarry_0376{
		694380524660900979,
		502388704252344868,
	...
	benchRese_nocarry_0376.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Mul(&benchRese_nocarry_0376, &x)
	}
}

func BenchmarkE_nocarry_0376Cmp(b *testing.B) {
	x := e_nocarry_0376{
		694380524660900979,
		502388704252344868,
		12423515687311073486,
	...
	benchRese_nocarry_0376 = x
	benchRese_nocarry_0376[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0376.Cmp(&x)
	}
}

func TestE_nocarry_0376Cmp(t *testing.T) {
	var x, y e_nocarry_0376
...
func TestE_nocarry_0376IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0376
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0376

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0376{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0376
	one.SetOne()
	e.Sub(&qe_nocarry_0376, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0376{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0376{0, uint64(i)})
	}
...
func TestE_nocarry_0376NegZero(t *testing.T) {
	var a, b e_nocarry_0376
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0376Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0376, len(staticTestValues))
...
func TestE_nocarry_0376Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0376) bool {
			var b e_nocarry_0376
...
func TestE_nocarry_0376InverseExp(t *testing.T) {
...
func TestE_nocarry_0376MulByConstants(t *testing.T) {
...
func TestE_nocarry_0376Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0376) bool {
...
func TestE_nocarry_0376LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0376Halve(t *testing.T) {
...
func TestE_nocarry_0376FromMont(t *testing.T) {
...
type testPaire_nocarry_0376 struct {
	element e_nocarry_0376
	bigint  big.Int
}

func (z *e_nocarry_0376) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0376[5] {
		return true
	}
	if z[5] < qe_nocarry_0376[5] {
		return false
	...
	return z[0] >= qe_nocarry_0376[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0376

		g.element = e_nocarry_0376{
		...
		if qe_nocarry_0376[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0376[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0376 {
			var g e_nocarry_0376
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0376[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0376[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0376[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0376[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0376[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0376[5], carry)
...
func Benchmarke_nocarry_0376InverseNew(b *testing.B) {
	var x e_nocarry_0376
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0376
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0376
		var xInv e_nocarry_0376
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0376
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0376
...
func testLinearComb(t *testing.T, x *e_nocarry_0376, xC int64, y *e_nocarry_0376, yC int64) {
	...
	var z e_nocarry_0376
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0376, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0376
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0376, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0376
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0376, xHi uint64) {
	var res e_nocarry_0376
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0376) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0376) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0376, c int64, result *e_nocarry_0376, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0376) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0376) uint64 {
