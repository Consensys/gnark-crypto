...
var benchRese_nocarry_0605 e_nocarry_0605

func BenchmarkE_nocarry_0605SetBytes(b *testing.B) {
	var x e_nocarry_0605
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0605MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0605.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0605)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0605)
		}
	})
}

func BenchmarkE_nocarry_0605Inverse(b *testing.B) {
	var x e_nocarry_0605
	x.SetRandom()
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0605Butterfly(b *testing.B) {
	var x e_nocarry_0605
	x.SetRandom()
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0605)
	}
}

func BenchmarkE_nocarry_0605Exp(b *testing.B) {
	var x e_nocarry_0605
	x.SetRandom()
	benchRese_nocarry_0605.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0605Double(b *testing.B) {
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Double(&benchRese_nocarry_0605)
	}
}

func BenchmarkE_nocarry_0605Add(b *testing.B) {
	var x e_nocarry_0605
	x.SetRandom()
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Add(&x, &benchRese_nocarry_0605)
	}
}

func BenchmarkE_nocarry_0605Sub(b *testing.B) {
	var x e_nocarry_0605
	x.SetRandom()
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Sub(&x, &benchRese_nocarry_0605)
	}
}

func BenchmarkE_nocarry_0605Neg(b *testing.B) {
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Neg(&benchRese_nocarry_0605)
	}
}

func BenchmarkE_nocarry_0605Div(b *testing.B) {
	var x e_nocarry_0605
	x.SetRandom()
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Div(&x, &benchRese_nocarry_0605)
	}
}

func BenchmarkE_nocarry_0605FromMont(b *testing.B) {
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.FromMont()
	}
}

func BenchmarkE_nocarry_0605ToMont(b *testing.B) {
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.ToMont()
	}
}
func BenchmarkE_nocarry_0605Square(b *testing.B) {
	benchRese_nocarry_0605.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Square(&benchRese_nocarry_0605)
	}
}

func BenchmarkE_nocarry_0605Sqrt(b *testing.B) {
	var a e_nocarry_0605
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0605Mul(b *testing.B) {
	x := e_nocarry_0605{
		8626921755606677059,
		495647083190366896,
	...
	benchRese_nocarry_0605.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Mul(&benchRese_nocarry_0605, &x)
	}
}

func BenchmarkE_nocarry_0605Cmp(b *testing.B) {
	x := e_nocarry_0605{
		8626921755606677059,
		495647083190366896,
		18016496334227165173,
	...
	benchRese_nocarry_0605 = x
	benchRese_nocarry_0605[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0605.Cmp(&x)
	}
}

func TestE_nocarry_0605Cmp(t *testing.T) {
	var x, y e_nocarry_0605
...
func TestE_nocarry_0605IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0605
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0605

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0605{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0605
	one.SetOne()
	e.Sub(&qe_nocarry_0605, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0605{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0605{0, uint64(i)})
	}
...
func TestE_nocarry_0605NegZero(t *testing.T) {
	var a, b e_nocarry_0605
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0605Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0605, len(staticTestValues))
...
func TestE_nocarry_0605Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0605) bool {
			var b e_nocarry_0605
...
func TestE_nocarry_0605InverseExp(t *testing.T) {
...
func TestE_nocarry_0605MulByConstants(t *testing.T) {
...
func TestE_nocarry_0605Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0605) bool {
...
func TestE_nocarry_0605LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0605Halve(t *testing.T) {
...
func TestE_nocarry_0605FromMont(t *testing.T) {
...
type testPaire_nocarry_0605 struct {
	element e_nocarry_0605
	bigint  big.Int
}

func (z *e_nocarry_0605) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0605[9] {
		return true
	}
	if z[9] < qe_nocarry_0605[9] {
		return false
	...
	return z[0] >= qe_nocarry_0605[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0605

		g.element = e_nocarry_0605{
		...
		if qe_nocarry_0605[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0605[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0605 {
			var g e_nocarry_0605
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0605[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0605[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0605[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0605[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0605[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0605[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0605[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0605[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0605[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0605[9], carry)
...
func Benchmarke_nocarry_0605InverseNew(b *testing.B) {
	var x e_nocarry_0605
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0605
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0605
		var xInv e_nocarry_0605
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0605
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0605
...
func testLinearComb(t *testing.T, x *e_nocarry_0605, xC int64, y *e_nocarry_0605, yC int64) {
	...
	var z e_nocarry_0605
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0605, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0605
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0605, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0605
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0605, xHi uint64) {
	var res e_nocarry_0605
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0605) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0605) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0605, c int64, result *e_nocarry_0605, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0605) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0605) uint64 {
