...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x7b407b9456942a53, R13
	ADDQ R13, AX
	MOVQ $0x74ebe836d31e0e3f, R13
	ADCQ R13, DX
	MOVQ $0x7105a4a5f8225366, R13
	ADCQ R13, CX
	MOVQ $0x5be683f6b2bf4b46, R13
	ADCQ R13, BX
	MOVQ $0x261cea18e36842fe, R13
	ADCQ R13, SI
	MOVQ $0x3cf87e1ea6289207, R13
	ADCQ R13, DI
	MOVQ $0x50abc666d152ccf0, R13
	ADCQ R13, R8
	MOVQ $0x7023e732f0498659, R13
	ADCQ R13, R9
	MOVQ $0xe49a5a8b22931da2, R13
	ADCQ R13, R10
	MOVQ $0x000000001c1f06fa, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x7b407b9456942a53, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x74ebe836d31e0e3f, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x7105a4a5f8225366, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x5be683f6b2bf4b46, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x261cea18e36842fe, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x3cf87e1ea6289207, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x50abc666d152ccf0, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x7023e732f0498659, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xe49a5a8b22931da2, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000001c1f06fa, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x7b407b9456942a53, AX
	ADDQ AX, DX
	MOVQ $0x74ebe836d31e0e3f, AX
	ADCQ AX, CX
	MOVQ $0x7105a4a5f8225366, AX
	ADCQ AX, BX
	MOVQ $0x5be683f6b2bf4b46, AX
	ADCQ AX, SI
	MOVQ $0x261cea18e36842fe, AX
	ADCQ AX, DI
	MOVQ $0x3cf87e1ea6289207, AX
	ADCQ AX, R8
	MOVQ $0x50abc666d152ccf0, AX
	ADCQ AX, R9
	MOVQ $0x7023e732f0498659, AX
	ADCQ AX, R10
	MOVQ $0xe49a5a8b22931da2, AX
	ADCQ AX, R11
	MOVQ $0x000000001c1f06fa, AX
	ADCQ AX, R12
