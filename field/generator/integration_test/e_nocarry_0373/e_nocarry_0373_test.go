...
var benchRese_nocarry_0373 e_nocarry_0373

func BenchmarkE_nocarry_0373SetBytes(b *testing.B) {
	var x e_nocarry_0373
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0373MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0373.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0373)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0373)
		}
	})
}

func BenchmarkE_nocarry_0373Inverse(b *testing.B) {
	var x e_nocarry_0373
	x.SetRandom()
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0373Butterfly(b *testing.B) {
	var x e_nocarry_0373
	x.SetRandom()
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0373)
	}
}

func BenchmarkE_nocarry_0373Exp(b *testing.B) {
	var x e_nocarry_0373
	x.SetRandom()
	benchRese_nocarry_0373.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0373Double(b *testing.B) {
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Double(&benchRese_nocarry_0373)
	}
}

func BenchmarkE_nocarry_0373Add(b *testing.B) {
	var x e_nocarry_0373
	x.SetRandom()
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Add(&x, &benchRese_nocarry_0373)
	}
}

func BenchmarkE_nocarry_0373Sub(b *testing.B) {
	var x e_nocarry_0373
	x.SetRandom()
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Sub(&x, &benchRese_nocarry_0373)
	}
}

func BenchmarkE_nocarry_0373Neg(b *testing.B) {
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Neg(&benchRese_nocarry_0373)
	}
}

func BenchmarkE_nocarry_0373Div(b *testing.B) {
	var x e_nocarry_0373
	x.SetRandom()
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Div(&x, &benchRese_nocarry_0373)
	}
}

func BenchmarkE_nocarry_0373FromMont(b *testing.B) {
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.FromMont()
	}
}

func BenchmarkE_nocarry_0373ToMont(b *testing.B) {
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.ToMont()
	}
}
func BenchmarkE_nocarry_0373Square(b *testing.B) {
	benchRese_nocarry_0373.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Square(&benchRese_nocarry_0373)
	}
}

func BenchmarkE_nocarry_0373Sqrt(b *testing.B) {
	var a e_nocarry_0373
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0373Mul(b *testing.B) {
	x := e_nocarry_0373{
		7954927495885096308,
	...
	benchRese_nocarry_0373.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Mul(&benchRese_nocarry_0373, &x)
	}
}

func BenchmarkE_nocarry_0373Cmp(b *testing.B) {
	x := e_nocarry_0373{
		7954927495885096308,
		14767687008343183133,
		10977784582270394745,
	...
	benchRese_nocarry_0373 = x
	benchRese_nocarry_0373[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0373.Cmp(&x)
	}
}

func TestE_nocarry_0373Cmp(t *testing.T) {
	var x, y e_nocarry_0373
...
func TestE_nocarry_0373IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0373
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0373

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0373{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0373
	one.SetOne()
	e.Sub(&qe_nocarry_0373, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0373{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0373{0, uint64(i)})
	}
...
func TestE_nocarry_0373NegZero(t *testing.T) {
	var a, b e_nocarry_0373
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0373Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0373, len(staticTestValues))
...
func TestE_nocarry_0373Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0373) bool {
			var b e_nocarry_0373
...
func TestE_nocarry_0373InverseExp(t *testing.T) {
...
func TestE_nocarry_0373MulByConstants(t *testing.T) {
...
func TestE_nocarry_0373Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0373) bool {
...
func TestE_nocarry_0373LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0373Halve(t *testing.T) {
...
func TestE_nocarry_0373FromMont(t *testing.T) {
...
type testPaire_nocarry_0373 struct {
	element e_nocarry_0373
	bigint  big.Int
}

func (z *e_nocarry_0373) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0373[5] {
		return true
	}
	if z[5] < qe_nocarry_0373[5] {
		return false
	...
	return z[0] >= qe_nocarry_0373[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0373

		g.element = e_nocarry_0373{
		...
		if qe_nocarry_0373[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0373[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0373 {
			var g e_nocarry_0373
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0373[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0373[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0373[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0373[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0373[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0373[5], carry)
...
func Benchmarke_nocarry_0373InverseNew(b *testing.B) {
	var x e_nocarry_0373
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0373
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0373
		var xInv e_nocarry_0373
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0373
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0373
...
func testLinearComb(t *testing.T, x *e_nocarry_0373, xC int64, y *e_nocarry_0373, yC int64) {
	...
	var z e_nocarry_0373
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0373, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0373
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0373, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0373
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0373, xHi uint64) {
	var res e_nocarry_0373
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0373) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0373) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0373, c int64, result *e_nocarry_0373, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0373) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0373) uint64 {
