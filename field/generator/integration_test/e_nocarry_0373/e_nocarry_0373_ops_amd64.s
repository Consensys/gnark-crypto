...
// modulus q
DATA q<>+0(SB)/8, $0x21933f88951ef357
DATA q<>+8(SB)/8, $0x98d2a0c5520ce1c5
DATA q<>+16(SB)/8, $0xd9251963d3fafd36
DATA q<>+24(SB)/8, $0xdd9eadfd8ab3abed
DATA q<>+32(SB)/8, $0x8b08270dcebfe9f3
DATA q<>+40(SB)/8, $0x0019bc60810d1e51
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x263415f11fe25799
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x21933f88951ef357, R10
	MOVQ    $0x98d2a0c5520ce1c5, R11
	MOVQ    $0xd9251963d3fafd36, R12
	MOVQ    $0xdd9eadfd8ab3abed, R13
	MOVQ    $0x8b08270dcebfe9f3, R14
	MOVQ    $0x0019bc60810d1e51, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x98d2a0c5520ce1c5, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xd9251963d3fafd36, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xdd9eadfd8ab3abed, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x8b08270dcebfe9f3, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0019bc60810d1e51, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x21933f88951ef357, CX
	MOVQ    $0x98d2a0c5520ce1c5, BX
	MOVQ    $0xd9251963d3fafd36, SI
	MOVQ    $0xdd9eadfd8ab3abed, DI
	MOVQ    $0x8b08270dcebfe9f3, R8
	MOVQ    $0x0019bc60810d1e51, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
