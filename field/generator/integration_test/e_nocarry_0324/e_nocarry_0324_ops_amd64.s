...
// modulus q
DATA q<>+0(SB)/8, $0x72ae7e3ac69deecd
DATA q<>+8(SB)/8, $0x8d85638ab00a9c72
DATA q<>+16(SB)/8, $0x6db41ab58402aefe
DATA q<>+24(SB)/8, $0x2e0354bc8164fb88
DATA q<>+32(SB)/8, $0xed5835457268cbd9
DATA q<>+40(SB)/8, $0x000000000000000c
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x84ea387fc4f851fb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x72ae7e3ac69deecd, R10
	MOVQ    $0x8d85638ab00a9c72, R11
	MOVQ    $0x6db41ab58402aefe, R12
	MOVQ    $0x2e0354bc8164fb88, R13
	MOVQ    $0xed5835457268cbd9, R14
	MOVQ    $0x000000000000000c, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x8d85638ab00a9c72, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x6db41ab58402aefe, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x2e0354bc8164fb88, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xed5835457268cbd9, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000000000000c, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x72ae7e3ac69deecd, CX
	MOVQ    $0x8d85638ab00a9c72, BX
	MOVQ    $0x6db41ab58402aefe, SI
	MOVQ    $0x2e0354bc8164fb88, DI
	MOVQ    $0xed5835457268cbd9, R8
	MOVQ    $0x000000000000000c, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
