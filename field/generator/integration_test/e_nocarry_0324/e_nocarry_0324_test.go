...
var benchRese_nocarry_0324 e_nocarry_0324

func BenchmarkE_nocarry_0324SetBytes(b *testing.B) {
	var x e_nocarry_0324
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0324MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0324.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0324)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0324)
		}
	})
}

func BenchmarkE_nocarry_0324Inverse(b *testing.B) {
	var x e_nocarry_0324
	x.SetRandom()
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0324Butterfly(b *testing.B) {
	var x e_nocarry_0324
	x.SetRandom()
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0324)
	}
}

func BenchmarkE_nocarry_0324Exp(b *testing.B) {
	var x e_nocarry_0324
	x.SetRandom()
	benchRese_nocarry_0324.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0324Double(b *testing.B) {
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Double(&benchRese_nocarry_0324)
	}
}

func BenchmarkE_nocarry_0324Add(b *testing.B) {
	var x e_nocarry_0324
	x.SetRandom()
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Add(&x, &benchRese_nocarry_0324)
	}
}

func BenchmarkE_nocarry_0324Sub(b *testing.B) {
	var x e_nocarry_0324
	x.SetRandom()
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Sub(&x, &benchRese_nocarry_0324)
	}
}

func BenchmarkE_nocarry_0324Neg(b *testing.B) {
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Neg(&benchRese_nocarry_0324)
	}
}

func BenchmarkE_nocarry_0324Div(b *testing.B) {
	var x e_nocarry_0324
	x.SetRandom()
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Div(&x, &benchRese_nocarry_0324)
	}
}

func BenchmarkE_nocarry_0324FromMont(b *testing.B) {
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.FromMont()
	}
}

func BenchmarkE_nocarry_0324ToMont(b *testing.B) {
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.ToMont()
	}
}
func BenchmarkE_nocarry_0324Square(b *testing.B) {
	benchRese_nocarry_0324.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Square(&benchRese_nocarry_0324)
	}
}

func BenchmarkE_nocarry_0324Sqrt(b *testing.B) {
	var a e_nocarry_0324
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0324Mul(b *testing.B) {
	x := e_nocarry_0324{
		9794867061107554192,
		2790488757860907031,
		1697833593212832049,
	...
	benchRese_nocarry_0324.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Mul(&benchRese_nocarry_0324, &x)
	}
}

func BenchmarkE_nocarry_0324Cmp(b *testing.B) {
	x := e_nocarry_0324{
		9794867061107554192,
		2790488757860907031,
		1697833593212832049,
	...
	benchRese_nocarry_0324 = x
	benchRese_nocarry_0324[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0324.Cmp(&x)
	}
}

func TestE_nocarry_0324Cmp(t *testing.T) {
	var x, y e_nocarry_0324
...
func TestE_nocarry_0324IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0324
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0324

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0324{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0324
	one.SetOne()
	e.Sub(&qe_nocarry_0324, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0324{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0324{0, uint64(i)})
	}
...
func TestE_nocarry_0324NegZero(t *testing.T) {
	var a, b e_nocarry_0324
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0324Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0324, len(staticTestValues))
...
func TestE_nocarry_0324Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0324) bool {
			var b e_nocarry_0324
...
func TestE_nocarry_0324InverseExp(t *testing.T) {
...
func TestE_nocarry_0324MulByConstants(t *testing.T) {
...
func TestE_nocarry_0324Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0324) bool {
...
func TestE_nocarry_0324LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0324Halve(t *testing.T) {
...
func TestE_nocarry_0324FromMont(t *testing.T) {
...
type testPaire_nocarry_0324 struct {
	element e_nocarry_0324
	bigint  big.Int
}

func (z *e_nocarry_0324) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0324[5] {
		return true
	}
	if z[5] < qe_nocarry_0324[5] {
		return false
	...
	return z[0] >= qe_nocarry_0324[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0324

		g.element = e_nocarry_0324{
		...
		if qe_nocarry_0324[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0324[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0324 {
			var g e_nocarry_0324
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0324[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0324[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0324[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0324[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0324[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0324[5], carry)
...
func Benchmarke_nocarry_0324InverseNew(b *testing.B) {
	var x e_nocarry_0324
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0324
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0324
		var xInv e_nocarry_0324
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0324
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0324
...
func testLinearComb(t *testing.T, x *e_nocarry_0324, xC int64, y *e_nocarry_0324, yC int64) {
	...
	var z e_nocarry_0324
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0324, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0324
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0324, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0324
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0324, xHi uint64) {
	var res e_nocarry_0324
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0324) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0324) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0324, c int64, result *e_nocarry_0324, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0324) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0324) uint64 {
