...
var benchRese_nocarry_0241 e_nocarry_0241

func BenchmarkE_nocarry_0241SetBytes(b *testing.B) {
	var x e_nocarry_0241
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0241MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0241.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0241)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0241)
		}
	})
}

func BenchmarkE_nocarry_0241Inverse(b *testing.B) {
	var x e_nocarry_0241
	x.SetRandom()
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0241Butterfly(b *testing.B) {
	var x e_nocarry_0241
	x.SetRandom()
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0241)
	}
}

func BenchmarkE_nocarry_0241Exp(b *testing.B) {
	var x e_nocarry_0241
	x.SetRandom()
	benchRese_nocarry_0241.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0241Double(b *testing.B) {
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Double(&benchRese_nocarry_0241)
	}
}

func BenchmarkE_nocarry_0241Add(b *testing.B) {
	var x e_nocarry_0241
	x.SetRandom()
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Add(&x, &benchRese_nocarry_0241)
	}
}

func BenchmarkE_nocarry_0241Sub(b *testing.B) {
	var x e_nocarry_0241
	x.SetRandom()
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Sub(&x, &benchRese_nocarry_0241)
	}
}

func BenchmarkE_nocarry_0241Neg(b *testing.B) {
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Neg(&benchRese_nocarry_0241)
	}
}

func BenchmarkE_nocarry_0241Div(b *testing.B) {
	var x e_nocarry_0241
	x.SetRandom()
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Div(&x, &benchRese_nocarry_0241)
	}
}

func BenchmarkE_nocarry_0241FromMont(b *testing.B) {
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.FromMont()
	}
}

func BenchmarkE_nocarry_0241ToMont(b *testing.B) {
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.ToMont()
	}
}
func BenchmarkE_nocarry_0241Square(b *testing.B) {
	benchRese_nocarry_0241.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Square(&benchRese_nocarry_0241)
	}
}

func BenchmarkE_nocarry_0241Sqrt(b *testing.B) {
	var a e_nocarry_0241
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0241Mul(b *testing.B) {
	x := e_nocarry_0241{
		1688977711404789535,
		5241174841292787229,
		2257452445792749020,
	...
	benchRese_nocarry_0241.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Mul(&benchRese_nocarry_0241, &x)
	}
}

func BenchmarkE_nocarry_0241Cmp(b *testing.B) {
	x := e_nocarry_0241{
		1688977711404789535,
		5241174841292787229,
		2257452445792749020,
	...
	benchRese_nocarry_0241 = x
	benchRese_nocarry_0241[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0241.Cmp(&x)
	}
}

func TestE_nocarry_0241Cmp(t *testing.T) {
	var x, y e_nocarry_0241
...
func TestE_nocarry_0241IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0241
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0241

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0241{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0241
	one.SetOne()
	e.Sub(&qe_nocarry_0241, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0241{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0241{0, uint64(i)})
	}
...
func TestE_nocarry_0241NegZero(t *testing.T) {
	var a, b e_nocarry_0241
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0241Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0241, len(staticTestValues))
...
func TestE_nocarry_0241Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0241) bool {
			var b e_nocarry_0241
...
func TestE_nocarry_0241InverseExp(t *testing.T) {
...
func TestE_nocarry_0241MulByConstants(t *testing.T) {
...
func TestE_nocarry_0241Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0241) bool {
...
func TestE_nocarry_0241LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0241Halve(t *testing.T) {
...
func TestE_nocarry_0241FromMont(t *testing.T) {
...
type testPaire_nocarry_0241 struct {
	element e_nocarry_0241
	bigint  big.Int
}

func (z *e_nocarry_0241) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0241[3] {
		return true
	}
	if z[3] < qe_nocarry_0241[3] {
		return false
	...
	return z[0] >= qe_nocarry_0241[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0241

		g.element = e_nocarry_0241{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0241[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0241[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0241 {
			var g e_nocarry_0241
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0241[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0241[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0241[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0241[3], carry)
...
func Benchmarke_nocarry_0241InverseNew(b *testing.B) {
	var x e_nocarry_0241
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0241
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0241
		var xInv e_nocarry_0241
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0241
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0241
...
func testLinearComb(t *testing.T, x *e_nocarry_0241, xC int64, y *e_nocarry_0241, yC int64) {
	...
	var z e_nocarry_0241
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0241, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0241
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0241, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0241
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0241, xHi uint64) {
	var res e_nocarry_0241
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0241) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0241) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0241, c int64, result *e_nocarry_0241, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0241) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0241) uint64 {
