...
// modulus q
DATA q<>+0(SB)/8, $0x519aeddffdc38e1f
DATA q<>+8(SB)/8, $0xea0c14b69e8e9dcc
DATA q<>+16(SB)/8, $0x921db6ca7dfe8025
DATA q<>+24(SB)/8, $0x0001e21daaecc5d3
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x7a2cf35a1ba39221
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x519aeddffdc38e1f, R8
	MOVQ    $0xea0c14b69e8e9dcc, R9
	MOVQ    $0x921db6ca7dfe8025, R10
	MOVQ    $0x0001e21daaecc5d3, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xea0c14b69e8e9dcc, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x921db6ca7dfe8025, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0001e21daaecc5d3, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x519aeddffdc38e1f, R12
	MOVQ    $0xea0c14b69e8e9dcc, R13
	MOVQ    $0x921db6ca7dfe8025, R14
	MOVQ    $0x0001e21daaecc5d3, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
