...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x708e25f65fdf068d, R12
	ADDQ R12, AX
	MOVQ $0x4d8384de00f61498, R12
	ADCQ R12, DX
	MOVQ $0x9166be28a6c11c70, R12
	ADCQ R12, CX
	MOVQ $0x19009a9faaad69a9, R12
	ADCQ R12, BX
	MOVQ $0x608d021438445605, R12
	ADCQ R12, SI
	MOVQ $0x329ed706fa2ab04c, R12
	ADCQ R12, DI
	MOVQ $0xc252d972d71bedf0, R12
	ADCQ R12, R8
	MOVQ $0xb356f420838a6cd7, R12
	ADCQ R12, R9
	MOVQ $0x00d9639c95121c3e, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x708e25f65fdf068d, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x4d8384de00f61498, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x9166be28a6c11c70, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x19009a9faaad69a9, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x608d021438445605, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x329ed706fa2ab04c, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xc252d972d71bedf0, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xb356f420838a6cd7, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00d9639c95121c3e, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x708e25f65fdf068d, AX
	ADDQ AX, DX
	MOVQ $0x4d8384de00f61498, AX
	ADCQ AX, CX
	MOVQ $0x9166be28a6c11c70, AX
	ADCQ AX, BX
	MOVQ $0x19009a9faaad69a9, AX
	ADCQ AX, SI
	MOVQ $0x608d021438445605, AX
	ADCQ AX, DI
	MOVQ $0x329ed706fa2ab04c, AX
	ADCQ AX, R8
	MOVQ $0xc252d972d71bedf0, AX
	ADCQ AX, R9
	MOVQ $0xb356f420838a6cd7, AX
	ADCQ AX, R10
	MOVQ $0x00d9639c95121c3e, AX
	ADCQ AX, R11
