...
var benchRese_nocarry_0568 e_nocarry_0568

func BenchmarkE_nocarry_0568SetBytes(b *testing.B) {
	var x e_nocarry_0568
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0568MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0568.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0568)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0568)
		}
	})
}

func BenchmarkE_nocarry_0568Inverse(b *testing.B) {
	var x e_nocarry_0568
	x.SetRandom()
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0568Butterfly(b *testing.B) {
	var x e_nocarry_0568
	x.SetRandom()
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0568)
	}
}

func BenchmarkE_nocarry_0568Exp(b *testing.B) {
	var x e_nocarry_0568
	x.SetRandom()
	benchRese_nocarry_0568.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0568Double(b *testing.B) {
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Double(&benchRese_nocarry_0568)
	}
}

func BenchmarkE_nocarry_0568Add(b *testing.B) {
	var x e_nocarry_0568
	x.SetRandom()
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Add(&x, &benchRese_nocarry_0568)
	}
}

func BenchmarkE_nocarry_0568Sub(b *testing.B) {
	var x e_nocarry_0568
	x.SetRandom()
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Sub(&x, &benchRese_nocarry_0568)
	}
}

func BenchmarkE_nocarry_0568Neg(b *testing.B) {
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Neg(&benchRese_nocarry_0568)
	}
}

func BenchmarkE_nocarry_0568Div(b *testing.B) {
	var x e_nocarry_0568
	x.SetRandom()
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Div(&x, &benchRese_nocarry_0568)
	}
}

func BenchmarkE_nocarry_0568FromMont(b *testing.B) {
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.FromMont()
	}
}

func BenchmarkE_nocarry_0568ToMont(b *testing.B) {
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.ToMont()
	}
}
func BenchmarkE_nocarry_0568Square(b *testing.B) {
	benchRese_nocarry_0568.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Square(&benchRese_nocarry_0568)
	}
}

func BenchmarkE_nocarry_0568Sqrt(b *testing.B) {
	var a e_nocarry_0568
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0568Mul(b *testing.B) {
	x := e_nocarry_0568{
		8524005297998714249,
	...
	benchRese_nocarry_0568.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Mul(&benchRese_nocarry_0568, &x)
	}
}

func BenchmarkE_nocarry_0568Cmp(b *testing.B) {
	x := e_nocarry_0568{
		8524005297998714249,
		17401240046675793021,
		17242970047443930506,
	...
	benchRese_nocarry_0568 = x
	benchRese_nocarry_0568[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0568.Cmp(&x)
	}
}

func TestE_nocarry_0568Cmp(t *testing.T) {
	var x, y e_nocarry_0568
...
func TestE_nocarry_0568IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0568
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0568

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0568{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0568
	one.SetOne()
	e.Sub(&qe_nocarry_0568, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0568{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0568{0, uint64(i)})
	}
...
func TestE_nocarry_0568NegZero(t *testing.T) {
	var a, b e_nocarry_0568
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0568Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0568, len(staticTestValues))
...
func TestE_nocarry_0568Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0568) bool {
			var b e_nocarry_0568
...
func TestE_nocarry_0568InverseExp(t *testing.T) {
...
func TestE_nocarry_0568MulByConstants(t *testing.T) {
...
func TestE_nocarry_0568Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0568) bool {
...
func TestE_nocarry_0568LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0568Halve(t *testing.T) {
...
func TestE_nocarry_0568FromMont(t *testing.T) {
...
type testPaire_nocarry_0568 struct {
	element e_nocarry_0568
	bigint  big.Int
}

func (z *e_nocarry_0568) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0568[8] {
		return true
	}
	if z[8] < qe_nocarry_0568[8] {
		return false
	...
	return z[0] >= qe_nocarry_0568[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0568

		g.element = e_nocarry_0568{
		...
		if qe_nocarry_0568[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0568[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0568 {
			var g e_nocarry_0568
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0568[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0568[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0568[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0568[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0568[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0568[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0568[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0568[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0568[8], carry)
...
func Benchmarke_nocarry_0568InverseNew(b *testing.B) {
	var x e_nocarry_0568
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0568
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0568
		var xInv e_nocarry_0568
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0568
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0568
...
func testLinearComb(t *testing.T, x *e_nocarry_0568, xC int64, y *e_nocarry_0568, yC int64) {
	...
	var z e_nocarry_0568
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0568, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0568
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0568, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0568
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0568, xHi uint64) {
	var res e_nocarry_0568
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0568) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0568) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0568, c int64, result *e_nocarry_0568, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0568) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0568) uint64 {
