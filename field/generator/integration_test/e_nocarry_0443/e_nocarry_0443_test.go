...
var benchRese_nocarry_0443 e_nocarry_0443

func BenchmarkE_nocarry_0443SetBytes(b *testing.B) {
	var x e_nocarry_0443
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0443MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0443.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0443)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0443)
		}
	})
}

func BenchmarkE_nocarry_0443Inverse(b *testing.B) {
	var x e_nocarry_0443
	x.SetRandom()
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0443Butterfly(b *testing.B) {
	var x e_nocarry_0443
	x.SetRandom()
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0443)
	}
}

func BenchmarkE_nocarry_0443Exp(b *testing.B) {
	var x e_nocarry_0443
	x.SetRandom()
	benchRese_nocarry_0443.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0443Double(b *testing.B) {
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Double(&benchRese_nocarry_0443)
	}
}

func BenchmarkE_nocarry_0443Add(b *testing.B) {
	var x e_nocarry_0443
	x.SetRandom()
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Add(&x, &benchRese_nocarry_0443)
	}
}

func BenchmarkE_nocarry_0443Sub(b *testing.B) {
	var x e_nocarry_0443
	x.SetRandom()
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Sub(&x, &benchRese_nocarry_0443)
	}
}

func BenchmarkE_nocarry_0443Neg(b *testing.B) {
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Neg(&benchRese_nocarry_0443)
	}
}

func BenchmarkE_nocarry_0443Div(b *testing.B) {
	var x e_nocarry_0443
	x.SetRandom()
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Div(&x, &benchRese_nocarry_0443)
	}
}

func BenchmarkE_nocarry_0443FromMont(b *testing.B) {
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.FromMont()
	}
}

func BenchmarkE_nocarry_0443ToMont(b *testing.B) {
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.ToMont()
	}
}
func BenchmarkE_nocarry_0443Square(b *testing.B) {
	benchRese_nocarry_0443.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Square(&benchRese_nocarry_0443)
	}
}

func BenchmarkE_nocarry_0443Sqrt(b *testing.B) {
	var a e_nocarry_0443
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0443Mul(b *testing.B) {
	x := e_nocarry_0443{
		8933191471728191475,
		6427954403077342634,
		1481757634408060299,
	...
	benchRese_nocarry_0443.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Mul(&benchRese_nocarry_0443, &x)
	}
}

func BenchmarkE_nocarry_0443Cmp(b *testing.B) {
	x := e_nocarry_0443{
		8933191471728191475,
		6427954403077342634,
		1481757634408060299,
	...
	benchRese_nocarry_0443 = x
	benchRese_nocarry_0443[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0443.Cmp(&x)
	}
}

func TestE_nocarry_0443Cmp(t *testing.T) {
	var x, y e_nocarry_0443
...
func TestE_nocarry_0443IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0443
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0443

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0443{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0443
	one.SetOne()
	e.Sub(&qe_nocarry_0443, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0443{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0443{0, uint64(i)})
	}
...
func TestE_nocarry_0443NegZero(t *testing.T) {
	var a, b e_nocarry_0443
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0443Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0443, len(staticTestValues))
...
func TestE_nocarry_0443Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0443) bool {
			var b e_nocarry_0443
...
func TestE_nocarry_0443InverseExp(t *testing.T) {
...
func TestE_nocarry_0443MulByConstants(t *testing.T) {
...
func TestE_nocarry_0443Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0443) bool {
...
func TestE_nocarry_0443LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0443Halve(t *testing.T) {
...
func TestE_nocarry_0443FromMont(t *testing.T) {
...
type testPaire_nocarry_0443 struct {
	element e_nocarry_0443
	bigint  big.Int
}

func (z *e_nocarry_0443) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0443[6] {
		return true
	}
	if z[6] < qe_nocarry_0443[6] {
		return false
	...
	return z[0] >= qe_nocarry_0443[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0443

		g.element = e_nocarry_0443{
		...
		if qe_nocarry_0443[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0443[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0443 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0443[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0443[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0443[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0443[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0443[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0443[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0443[6], carry)
...
func Benchmarke_nocarry_0443InverseNew(b *testing.B) {
	var x e_nocarry_0443
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0443
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0443
		var xInv e_nocarry_0443
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0443
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0443
...
func testLinearComb(t *testing.T, x *e_nocarry_0443, xC int64, y *e_nocarry_0443, yC int64) {
	...
	var z e_nocarry_0443
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0443, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0443
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0443, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0443
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0443, xHi uint64) {
	var res e_nocarry_0443
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0443) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0443) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0443, c int64, result *e_nocarry_0443, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0443) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0443) uint64 {
