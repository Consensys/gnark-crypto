...
// modulus q
DATA q<>+0(SB)/8, $0xb1ce15056487055d
DATA q<>+8(SB)/8, $0xef1feb6c31ea82d4
DATA q<>+16(SB)/8, $0x8b9b3ac95395b93b
DATA q<>+24(SB)/8, $0x9cb3db0f787a4619
DATA q<>+32(SB)/8, $0x74910f9886214024
DATA q<>+40(SB)/8, $0x0000000000000003
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x25a19b8a6464890b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xb1ce15056487055d, R10
	MOVQ    $0xef1feb6c31ea82d4, R11
	MOVQ    $0x8b9b3ac95395b93b, R12
	MOVQ    $0x9cb3db0f787a4619, R13
	MOVQ    $0x74910f9886214024, R14
	MOVQ    $0x0000000000000003, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xef1feb6c31ea82d4, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x8b9b3ac95395b93b, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x9cb3db0f787a4619, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x74910f9886214024, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xb1ce15056487055d, CX
	MOVQ    $0xef1feb6c31ea82d4, BX
	MOVQ    $0x8b9b3ac95395b93b, SI
	MOVQ    $0x9cb3db0f787a4619, DI
	MOVQ    $0x74910f9886214024, R8
