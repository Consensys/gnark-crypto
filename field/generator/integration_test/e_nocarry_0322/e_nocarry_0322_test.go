...
var benchRese_nocarry_0322 e_nocarry_0322

func BenchmarkE_nocarry_0322SetBytes(b *testing.B) {
	var x e_nocarry_0322
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0322MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0322.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0322)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0322)
		}
	})
}

func BenchmarkE_nocarry_0322Inverse(b *testing.B) {
	var x e_nocarry_0322
	x.SetRandom()
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0322Butterfly(b *testing.B) {
	var x e_nocarry_0322
	x.SetRandom()
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0322)
	}
}

func BenchmarkE_nocarry_0322Exp(b *testing.B) {
	var x e_nocarry_0322
	x.SetRandom()
	benchRese_nocarry_0322.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0322Double(b *testing.B) {
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Double(&benchRese_nocarry_0322)
	}
}

func BenchmarkE_nocarry_0322Add(b *testing.B) {
	var x e_nocarry_0322
	x.SetRandom()
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Add(&x, &benchRese_nocarry_0322)
	}
}

func BenchmarkE_nocarry_0322Sub(b *testing.B) {
	var x e_nocarry_0322
	x.SetRandom()
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Sub(&x, &benchRese_nocarry_0322)
	}
}

func BenchmarkE_nocarry_0322Neg(b *testing.B) {
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Neg(&benchRese_nocarry_0322)
	}
}

func BenchmarkE_nocarry_0322Div(b *testing.B) {
	var x e_nocarry_0322
	x.SetRandom()
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Div(&x, &benchRese_nocarry_0322)
	}
}

func BenchmarkE_nocarry_0322FromMont(b *testing.B) {
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.FromMont()
	}
}

func BenchmarkE_nocarry_0322ToMont(b *testing.B) {
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.ToMont()
	}
}
func BenchmarkE_nocarry_0322Square(b *testing.B) {
	benchRese_nocarry_0322.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Square(&benchRese_nocarry_0322)
	}
}

func BenchmarkE_nocarry_0322Sqrt(b *testing.B) {
	var a e_nocarry_0322
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0322Mul(b *testing.B) {
	x := e_nocarry_0322{
	...
	benchRese_nocarry_0322.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Mul(&benchRese_nocarry_0322, &x)
	}
}

func BenchmarkE_nocarry_0322Cmp(b *testing.B) {
	x := e_nocarry_0322{
		12569253601766158266,
		10417568474472946080,
		14655824986304381176,
	...
	benchRese_nocarry_0322 = x
	benchRese_nocarry_0322[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0322.Cmp(&x)
	}
}

func TestE_nocarry_0322Cmp(t *testing.T) {
	var x, y e_nocarry_0322
...
func TestE_nocarry_0322IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0322
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0322

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0322{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0322
	one.SetOne()
	e.Sub(&qe_nocarry_0322, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0322{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0322{0, uint64(i)})
	}
...
func TestE_nocarry_0322NegZero(t *testing.T) {
	var a, b e_nocarry_0322
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0322Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0322, len(staticTestValues))
...
func TestE_nocarry_0322Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0322) bool {
			var b e_nocarry_0322
...
func TestE_nocarry_0322InverseExp(t *testing.T) {
...
func TestE_nocarry_0322MulByConstants(t *testing.T) {
...
func TestE_nocarry_0322Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0322) bool {
...
func TestE_nocarry_0322LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0322Halve(t *testing.T) {
...
func TestE_nocarry_0322FromMont(t *testing.T) {
...
type testPaire_nocarry_0322 struct {
	element e_nocarry_0322
	bigint  big.Int
}

func (z *e_nocarry_0322) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0322[5] {
		return true
	}
	if z[5] < qe_nocarry_0322[5] {
		return false
	...
	return z[0] >= qe_nocarry_0322[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0322

		g.element = e_nocarry_0322{
		...
		if qe_nocarry_0322[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0322[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0322 {
			var g e_nocarry_0322
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0322[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0322[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0322[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0322[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0322[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0322[5], carry)
...
func Benchmarke_nocarry_0322InverseNew(b *testing.B) {
	var x e_nocarry_0322
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0322
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0322
		var xInv e_nocarry_0322
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0322
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0322
...
func testLinearComb(t *testing.T, x *e_nocarry_0322, xC int64, y *e_nocarry_0322, yC int64) {
	...
	var z e_nocarry_0322
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0322, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0322
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0322, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0322
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0322, xHi uint64) {
	var res e_nocarry_0322
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0322) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0322) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0322, c int64, result *e_nocarry_0322, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0322) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0322) uint64 {
