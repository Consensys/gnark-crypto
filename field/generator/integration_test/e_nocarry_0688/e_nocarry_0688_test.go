...
var benchRese_nocarry_0688 e_nocarry_0688

func BenchmarkE_nocarry_0688SetBytes(b *testing.B) {
	var x e_nocarry_0688
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0688MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0688.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0688)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0688)
		}
	})
}

func BenchmarkE_nocarry_0688Inverse(b *testing.B) {
	var x e_nocarry_0688
	x.SetRandom()
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0688Butterfly(b *testing.B) {
	var x e_nocarry_0688
	x.SetRandom()
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0688)
	}
}

func BenchmarkE_nocarry_0688Exp(b *testing.B) {
	var x e_nocarry_0688
	x.SetRandom()
	benchRese_nocarry_0688.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0688Double(b *testing.B) {
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Double(&benchRese_nocarry_0688)
	}
}

func BenchmarkE_nocarry_0688Add(b *testing.B) {
	var x e_nocarry_0688
	x.SetRandom()
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Add(&x, &benchRese_nocarry_0688)
	}
}

func BenchmarkE_nocarry_0688Sub(b *testing.B) {
	var x e_nocarry_0688
	x.SetRandom()
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Sub(&x, &benchRese_nocarry_0688)
	}
}

func BenchmarkE_nocarry_0688Neg(b *testing.B) {
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Neg(&benchRese_nocarry_0688)
	}
}

func BenchmarkE_nocarry_0688Div(b *testing.B) {
	var x e_nocarry_0688
	x.SetRandom()
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Div(&x, &benchRese_nocarry_0688)
	}
}

func BenchmarkE_nocarry_0688FromMont(b *testing.B) {
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.FromMont()
	}
}

func BenchmarkE_nocarry_0688ToMont(b *testing.B) {
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.ToMont()
	}
}
func BenchmarkE_nocarry_0688Square(b *testing.B) {
	benchRese_nocarry_0688.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Square(&benchRese_nocarry_0688)
	}
}

func BenchmarkE_nocarry_0688Sqrt(b *testing.B) {
	var a e_nocarry_0688
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0688Mul(b *testing.B) {
	x := e_nocarry_0688{
		5411354658497953315,
	...
	benchRese_nocarry_0688.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Mul(&benchRese_nocarry_0688, &x)
	}
}

func BenchmarkE_nocarry_0688Cmp(b *testing.B) {
	x := e_nocarry_0688{
		5411354658497953315,
		14654810189118709293,
		11551192876465845635,
	...
	benchRese_nocarry_0688 = x
	benchRese_nocarry_0688[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0688.Cmp(&x)
	}
}

func TestE_nocarry_0688Cmp(t *testing.T) {
	var x, y e_nocarry_0688
...
func TestE_nocarry_0688IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0688
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0688

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0688{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0688
	one.SetOne()
	e.Sub(&qe_nocarry_0688, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0688{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0688{0, uint64(i)})
	}
...
func TestE_nocarry_0688NegZero(t *testing.T) {
	var a, b e_nocarry_0688
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0688Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0688, len(staticTestValues))
...
func TestE_nocarry_0688Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0688) bool {
			var b e_nocarry_0688
...
func TestE_nocarry_0688InverseExp(t *testing.T) {
...
func TestE_nocarry_0688MulByConstants(t *testing.T) {
...
func TestE_nocarry_0688Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0688) bool {
...
func TestE_nocarry_0688LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0688Halve(t *testing.T) {
...
func TestE_nocarry_0688FromMont(t *testing.T) {
...
type testPaire_nocarry_0688 struct {
	element e_nocarry_0688
	bigint  big.Int
}

func (z *e_nocarry_0688) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0688[10] {
		return true
	}
	if z[10] < qe_nocarry_0688[10] {
		return false
	...
	return z[0] >= qe_nocarry_0688[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0688

		g.element = e_nocarry_0688{
		...
		if qe_nocarry_0688[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0688[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0688 {
			var g e_nocarry_0688
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0688[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0688[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0688[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0688[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0688[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0688[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0688[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0688[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0688[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0688[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0688[10], carry)
...
func Benchmarke_nocarry_0688InverseNew(b *testing.B) {
	var x e_nocarry_0688
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0688
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0688
		var xInv e_nocarry_0688
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0688
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0688
...
func testLinearComb(t *testing.T, x *e_nocarry_0688, xC int64, y *e_nocarry_0688, yC int64) {
	...
	var z e_nocarry_0688
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0688, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0688
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0688, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0688
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0688, xHi uint64) {
	var res e_nocarry_0688
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0688) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0688) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0688, c int64, result *e_nocarry_0688, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0688) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0688) uint64 {
