...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xe83710ac55579b0f, R14
	ADDQ R14, AX
	MOVQ $0x548492516105af35, R14
	ADCQ R14, DX
	MOVQ $0xc3f54fdadb332d09, R14
	ADCQ R14, CX
	MOVQ $0x2b8c7dd4ccf2ed2b, R14
	ADCQ R14, BX
	MOVQ $0xec30111cf3aa4b11, R14
	ADCQ R14, SI
	MOVQ $0xc2cdfa0d3c955fa6, R14
	ADCQ R14, DI
	MOVQ $0x783be5a6b0bbb433, R14
	ADCQ R14, R8
	MOVQ $0x6d7c9c96c39eaf78, R14
	ADCQ R14, R9
	MOVQ $0x1a49dfb07d272f7b, R14
	ADCQ R14, R10
	MOVQ $0xc1bbb9ccaa8d4197, R14
	ADCQ R14, R11
	MOVQ $0x0000eb5400a9d31b, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xe83710ac55579b0f, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x548492516105af35, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xc3f54fdadb332d09, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x2b8c7dd4ccf2ed2b, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xec30111cf3aa4b11, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xc2cdfa0d3c955fa6, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x783be5a6b0bbb433, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x6d7c9c96c39eaf78, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x1a49dfb07d272f7b, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xc1bbb9ccaa8d4197, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000eb5400a9d31b, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xe83710ac55579b0f, AX
	ADDQ AX, DX
	MOVQ $0x548492516105af35, AX
	ADCQ AX, CX
	MOVQ $0xc3f54fdadb332d09, AX
	ADCQ AX, BX
	MOVQ $0x2b8c7dd4ccf2ed2b, AX
	ADCQ AX, SI
	MOVQ $0xec30111cf3aa4b11, AX
	ADCQ AX, DI
	MOVQ $0xc2cdfa0d3c955fa6, AX
	ADCQ AX, R8
	MOVQ $0x783be5a6b0bbb433, AX
	ADCQ AX, R9
	MOVQ $0x6d7c9c96c39eaf78, AX
	ADCQ AX, R10
	MOVQ $0x1a49dfb07d272f7b, AX
	ADCQ AX, R11
	MOVQ $0xc1bbb9ccaa8d4197, AX
	ADCQ AX, R12
	MOVQ $0x0000eb5400a9d31b, AX
	ADCQ AX, R13
