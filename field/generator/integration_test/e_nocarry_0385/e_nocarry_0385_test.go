...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0385{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0385{0, uint64(i)})
	}
...
func (z *e_nocarry_0385) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0385[6] {
		return true
	}
	if z[6] < qe_nocarry_0385[6] {
		return false
...
func Benchmarke_nocarry_0385InverseNew(b *testing.B) {
	var x e_nocarry_0385
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0385, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0385, xHi uint64) {
