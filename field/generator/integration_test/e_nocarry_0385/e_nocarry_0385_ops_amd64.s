...
// modulus q
DATA q<>+0(SB)/8, $0x3ab07226e27eb3ad
DATA q<>+8(SB)/8, $0xd71a7f8e7e20ab09
DATA q<>+16(SB)/8, $0x592c7efaf239a478
DATA q<>+24(SB)/8, $0x0e8939d185578d9a
DATA q<>+32(SB)/8, $0xd6f89e57aba91c19
DATA q<>+40(SB)/8, $0xbef04ace69218f5f
DATA q<>+48(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $56

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xc9d1c4202e4ed7db
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 48(R9), R8
	JCC  l1
	MOVQ $0x3ab07226e27eb3ad, R10
	ADDQ R10, AX
	MOVQ $0xd71a7f8e7e20ab09, R10
	ADCQ R10, DX
	MOVQ $0x592c7efaf239a478, R10
	ADCQ R10, CX
	MOVQ $0x0e8939d185578d9a, R10
	ADCQ R10, BX
	MOVQ $0xd6f89e57aba91c19, R10
	ADCQ R10, SI
	MOVQ $0xbef04ace69218f5f, R10
	ADCQ R10, DI
	MOVQ $1, R10
	ADCQ R10, R8
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x3ab07226e27eb3ad, R11
	SUBQ  DX, R11
	MOVQ  R11, 0(R10)
	MOVQ  $0xd71a7f8e7e20ab09, R11
	SBBQ  CX, R11
	MOVQ  R11, 8(R10)
	MOVQ  $0x592c7efaf239a478, R11
	SBBQ  BX, R11
	MOVQ  R11, 16(R10)
	MOVQ  $0x0e8939d185578d9a, R11
	SBBQ  SI, R11
	MOVQ  R11, 24(R10)
	MOVQ  $0xd6f89e57aba91c19, R11
	SBBQ  DI, R11
	MOVQ  R11, 32(R10)
	MOVQ  $0xbef04ace69218f5f, R11
	SBBQ  R8, R11
	MOVQ  R11, 40(R10)
	MOVQ  $1, R11
	SBBQ  R9, R11
...
TEXT ·Butterfly(SB), $8-16
	...
	SBBQ 48(AX), R9
	JCC  l3
	MOVQ $0x3ab07226e27eb3ad, AX
	ADDQ AX, DX
	MOVQ $0xd71a7f8e7e20ab09, AX
	ADCQ AX, CX
	MOVQ $0x592c7efaf239a478, AX
	ADCQ AX, BX
	MOVQ $0x0e8939d185578d9a, AX
	ADCQ AX, SI
	MOVQ $0xd6f89e57aba91c19, AX
	ADCQ AX, DI
	MOVQ $0xbef04ace69218f5f, AX
	ADCQ AX, R8
	MOVQ $1, AX
	ADCQ AX, R9
