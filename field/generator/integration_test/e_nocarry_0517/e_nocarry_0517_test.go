...
var benchRese_nocarry_0517 e_nocarry_0517

func BenchmarkE_nocarry_0517SetBytes(b *testing.B) {
	var x e_nocarry_0517
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0517MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0517.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0517)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0517)
		}
	})
}

func BenchmarkE_nocarry_0517Inverse(b *testing.B) {
	var x e_nocarry_0517
	x.SetRandom()
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0517Butterfly(b *testing.B) {
	var x e_nocarry_0517
	x.SetRandom()
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0517)
	}
}

func BenchmarkE_nocarry_0517Exp(b *testing.B) {
	var x e_nocarry_0517
	x.SetRandom()
	benchRese_nocarry_0517.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0517Double(b *testing.B) {
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Double(&benchRese_nocarry_0517)
	}
}

func BenchmarkE_nocarry_0517Add(b *testing.B) {
	var x e_nocarry_0517
	x.SetRandom()
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Add(&x, &benchRese_nocarry_0517)
	}
}

func BenchmarkE_nocarry_0517Sub(b *testing.B) {
	var x e_nocarry_0517
	x.SetRandom()
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Sub(&x, &benchRese_nocarry_0517)
	}
}

func BenchmarkE_nocarry_0517Neg(b *testing.B) {
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Neg(&benchRese_nocarry_0517)
	}
}

func BenchmarkE_nocarry_0517Div(b *testing.B) {
	var x e_nocarry_0517
	x.SetRandom()
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Div(&x, &benchRese_nocarry_0517)
	}
}

func BenchmarkE_nocarry_0517FromMont(b *testing.B) {
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.FromMont()
	}
}

func BenchmarkE_nocarry_0517ToMont(b *testing.B) {
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.ToMont()
	}
}
func BenchmarkE_nocarry_0517Square(b *testing.B) {
	benchRese_nocarry_0517.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Square(&benchRese_nocarry_0517)
	}
}

func BenchmarkE_nocarry_0517Sqrt(b *testing.B) {
	var a e_nocarry_0517
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0517Mul(b *testing.B) {
	x := e_nocarry_0517{
		459672253402733934,
		5547649834556499169,
	...
	benchRese_nocarry_0517.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Mul(&benchRese_nocarry_0517, &x)
	}
}

func BenchmarkE_nocarry_0517Cmp(b *testing.B) {
	x := e_nocarry_0517{
		459672253402733934,
		5547649834556499169,
		18310644151107047650,
	...
	benchRese_nocarry_0517 = x
	benchRese_nocarry_0517[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0517.Cmp(&x)
	}
}

func TestE_nocarry_0517Cmp(t *testing.T) {
	var x, y e_nocarry_0517
...
func TestE_nocarry_0517IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0517
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0517

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0517{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0517
	one.SetOne()
	e.Sub(&qe_nocarry_0517, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0517{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0517{0, uint64(i)})
	}
...
func TestE_nocarry_0517NegZero(t *testing.T) {
	var a, b e_nocarry_0517
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0517Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0517, len(staticTestValues))
...
func TestE_nocarry_0517Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0517) bool {
			var b e_nocarry_0517
...
func TestE_nocarry_0517InverseExp(t *testing.T) {
...
func TestE_nocarry_0517MulByConstants(t *testing.T) {
...
func TestE_nocarry_0517Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0517) bool {
...
func TestE_nocarry_0517LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0517Halve(t *testing.T) {
...
func TestE_nocarry_0517FromMont(t *testing.T) {
...
type testPaire_nocarry_0517 struct {
	element e_nocarry_0517
	bigint  big.Int
}

func (z *e_nocarry_0517) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0517[8] {
		return true
	}
	if z[8] < qe_nocarry_0517[8] {
		return false
	...
	return z[0] >= qe_nocarry_0517[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0517

		g.element = e_nocarry_0517{
		...
		if qe_nocarry_0517[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0517[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0517 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0517[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0517[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0517[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0517[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0517[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0517[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0517[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0517[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0517[8], carry)
...
func Benchmarke_nocarry_0517InverseNew(b *testing.B) {
	var x e_nocarry_0517
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0517
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0517
		var xInv e_nocarry_0517
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0517
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0517
...
func testLinearComb(t *testing.T, x *e_nocarry_0517, xC int64, y *e_nocarry_0517, yC int64) {
	...
	var z e_nocarry_0517
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0517, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0517
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0517, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0517
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0517, xHi uint64) {
	var res e_nocarry_0517
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0517) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0517) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0517, c int64, result *e_nocarry_0517, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0517) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0517) uint64 {
