...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x9429bcfaf50cc599, R12
	ADDQ R12, AX
	MOVQ $0x51a77d056a63a17d, R12
	ADCQ R12, DX
	MOVQ $0xc3deb61e28d9f3e1, R12
	ADCQ R12, CX
	MOVQ $0x7e97b7b0d0d00915, R12
	ADCQ R12, BX
	MOVQ $0xc391c2534a0d6fa6, R12
	ADCQ R12, SI
	MOVQ $0x1e7292a669badd1c, R12
	ADCQ R12, DI
	MOVQ $0x69203636147f326f, R12
	ADCQ R12, R8
	MOVQ $0xb57a5bcf0001eac4, R12
	ADCQ R12, R9
	MOVQ $0x000000000000001b, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x9429bcfaf50cc599, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x51a77d056a63a17d, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xc3deb61e28d9f3e1, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x7e97b7b0d0d00915, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xc391c2534a0d6fa6, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x1e7292a669badd1c, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x69203636147f326f, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xb57a5bcf0001eac4, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000000000001b, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x9429bcfaf50cc599, AX
	ADDQ AX, DX
	MOVQ $0x51a77d056a63a17d, AX
	ADCQ AX, CX
	MOVQ $0xc3deb61e28d9f3e1, AX
	ADCQ AX, BX
	MOVQ $0x7e97b7b0d0d00915, AX
	ADCQ AX, SI
	MOVQ $0xc391c2534a0d6fa6, AX
	ADCQ AX, DI
	MOVQ $0x1e7292a669badd1c, AX
	ADCQ AX, R8
	MOVQ $0x69203636147f326f, AX
	ADCQ AX, R9
	MOVQ $0xb57a5bcf0001eac4, AX
	ADCQ AX, R10
	MOVQ $0x000000000000001b, AX
	ADCQ AX, R11
