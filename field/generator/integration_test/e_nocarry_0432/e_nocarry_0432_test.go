...
var benchRese_nocarry_0432 e_nocarry_0432

func BenchmarkE_nocarry_0432SetBytes(b *testing.B) {
	var x e_nocarry_0432
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0432MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0432.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0432)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0432)
		}
	})
}

func BenchmarkE_nocarry_0432Inverse(b *testing.B) {
	var x e_nocarry_0432
	x.SetRandom()
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0432Butterfly(b *testing.B) {
	var x e_nocarry_0432
	x.SetRandom()
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0432)
	}
}

func BenchmarkE_nocarry_0432Exp(b *testing.B) {
	var x e_nocarry_0432
	x.SetRandom()
	benchRese_nocarry_0432.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0432Double(b *testing.B) {
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Double(&benchRese_nocarry_0432)
	}
}

func BenchmarkE_nocarry_0432Add(b *testing.B) {
	var x e_nocarry_0432
	x.SetRandom()
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Add(&x, &benchRese_nocarry_0432)
	}
}

func BenchmarkE_nocarry_0432Sub(b *testing.B) {
	var x e_nocarry_0432
	x.SetRandom()
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Sub(&x, &benchRese_nocarry_0432)
	}
}

func BenchmarkE_nocarry_0432Neg(b *testing.B) {
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Neg(&benchRese_nocarry_0432)
	}
}

func BenchmarkE_nocarry_0432Div(b *testing.B) {
	var x e_nocarry_0432
	x.SetRandom()
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Div(&x, &benchRese_nocarry_0432)
	}
}

func BenchmarkE_nocarry_0432FromMont(b *testing.B) {
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.FromMont()
	}
}

func BenchmarkE_nocarry_0432ToMont(b *testing.B) {
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.ToMont()
	}
}
func BenchmarkE_nocarry_0432Square(b *testing.B) {
	benchRese_nocarry_0432.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Square(&benchRese_nocarry_0432)
	}
}

func BenchmarkE_nocarry_0432Sqrt(b *testing.B) {
	var a e_nocarry_0432
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0432Mul(b *testing.B) {
	x := e_nocarry_0432{
		5772955089674735580,
		5499720398927849558,
		7663831704700485692,
	...
	benchRese_nocarry_0432.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Mul(&benchRese_nocarry_0432, &x)
	}
}

func BenchmarkE_nocarry_0432Cmp(b *testing.B) {
	x := e_nocarry_0432{
		5772955089674735580,
		5499720398927849558,
		7663831704700485692,
	...
	benchRese_nocarry_0432 = x
	benchRese_nocarry_0432[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0432.Cmp(&x)
	}
}

func TestE_nocarry_0432Cmp(t *testing.T) {
	var x, y e_nocarry_0432
...
func TestE_nocarry_0432IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0432
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0432

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0432{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0432
	one.SetOne()
	e.Sub(&qe_nocarry_0432, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0432{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0432{0, uint64(i)})
	}
...
func TestE_nocarry_0432NegZero(t *testing.T) {
	var a, b e_nocarry_0432
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0432Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0432, len(staticTestValues))
...
func TestE_nocarry_0432Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0432) bool {
			var b e_nocarry_0432
...
func TestE_nocarry_0432InverseExp(t *testing.T) {
...
func TestE_nocarry_0432MulByConstants(t *testing.T) {
...
func TestE_nocarry_0432Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0432) bool {
...
func TestE_nocarry_0432LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0432Halve(t *testing.T) {
...
func TestE_nocarry_0432FromMont(t *testing.T) {
...
type testPaire_nocarry_0432 struct {
	element e_nocarry_0432
	bigint  big.Int
}

func (z *e_nocarry_0432) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0432[6] {
		return true
	}
	if z[6] < qe_nocarry_0432[6] {
		return false
	...
	return z[0] >= qe_nocarry_0432[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0432

		g.element = e_nocarry_0432{
		...
		if qe_nocarry_0432[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0432[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0432 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0432[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0432[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0432[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0432[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0432[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0432[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0432[6], carry)
...
func Benchmarke_nocarry_0432InverseNew(b *testing.B) {
	var x e_nocarry_0432
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0432
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0432
		var xInv e_nocarry_0432
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0432
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0432
...
func testLinearComb(t *testing.T, x *e_nocarry_0432, xC int64, y *e_nocarry_0432, yC int64) {
	...
	var z e_nocarry_0432
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0432, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0432
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0432, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0432
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0432, xHi uint64) {
	var res e_nocarry_0432
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0432) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0432) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0432, c int64, result *e_nocarry_0432, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0432) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0432) uint64 {
