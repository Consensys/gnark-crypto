...
var benchRese_nocarry_0459 e_nocarry_0459

func BenchmarkE_nocarry_0459SetBytes(b *testing.B) {
	var x e_nocarry_0459
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0459MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0459.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0459)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0459)
		}
	})
}

func BenchmarkE_nocarry_0459Inverse(b *testing.B) {
	var x e_nocarry_0459
	x.SetRandom()
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0459Butterfly(b *testing.B) {
	var x e_nocarry_0459
	x.SetRandom()
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0459)
	}
}

func BenchmarkE_nocarry_0459Exp(b *testing.B) {
	var x e_nocarry_0459
	x.SetRandom()
	benchRese_nocarry_0459.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0459Double(b *testing.B) {
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Double(&benchRese_nocarry_0459)
	}
}

func BenchmarkE_nocarry_0459Add(b *testing.B) {
	var x e_nocarry_0459
	x.SetRandom()
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Add(&x, &benchRese_nocarry_0459)
	}
}

func BenchmarkE_nocarry_0459Sub(b *testing.B) {
	var x e_nocarry_0459
	x.SetRandom()
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Sub(&x, &benchRese_nocarry_0459)
	}
}

func BenchmarkE_nocarry_0459Neg(b *testing.B) {
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Neg(&benchRese_nocarry_0459)
	}
}

func BenchmarkE_nocarry_0459Div(b *testing.B) {
	var x e_nocarry_0459
	x.SetRandom()
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Div(&x, &benchRese_nocarry_0459)
	}
}

func BenchmarkE_nocarry_0459FromMont(b *testing.B) {
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.FromMont()
	}
}

func BenchmarkE_nocarry_0459ToMont(b *testing.B) {
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.ToMont()
	}
}
func BenchmarkE_nocarry_0459Square(b *testing.B) {
	benchRese_nocarry_0459.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Square(&benchRese_nocarry_0459)
	}
}

func BenchmarkE_nocarry_0459Sqrt(b *testing.B) {
	var a e_nocarry_0459
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0459Mul(b *testing.B) {
	x := e_nocarry_0459{
		9657631916705709169,
	...
	benchRese_nocarry_0459.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Mul(&benchRese_nocarry_0459, &x)
	}
}

func BenchmarkE_nocarry_0459Cmp(b *testing.B) {
	x := e_nocarry_0459{
		9657631916705709169,
		17169595735742353411,
		5932536833637520298,
	...
	benchRese_nocarry_0459 = x
	benchRese_nocarry_0459[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0459.Cmp(&x)
	}
}

func TestE_nocarry_0459Cmp(t *testing.T) {
	var x, y e_nocarry_0459
...
func TestE_nocarry_0459IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0459
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0459

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0459{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0459
	one.SetOne()
	e.Sub(&qe_nocarry_0459, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0459{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0459{0, uint64(i)})
	}
...
func TestE_nocarry_0459NegZero(t *testing.T) {
	var a, b e_nocarry_0459
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0459Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0459, len(staticTestValues))
...
func TestE_nocarry_0459Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0459) bool {
			var b e_nocarry_0459
...
func TestE_nocarry_0459InverseExp(t *testing.T) {
...
func TestE_nocarry_0459MulByConstants(t *testing.T) {
...
func TestE_nocarry_0459Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0459) bool {
...
func TestE_nocarry_0459LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0459Halve(t *testing.T) {
...
func TestE_nocarry_0459FromMont(t *testing.T) {
...
type testPaire_nocarry_0459 struct {
	element e_nocarry_0459
	bigint  big.Int
}

func (z *e_nocarry_0459) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0459[7] {
		return true
	}
	if z[7] < qe_nocarry_0459[7] {
		return false
	...
	return z[0] >= qe_nocarry_0459[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0459

		g.element = e_nocarry_0459{
		...
		if qe_nocarry_0459[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0459[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0459 {
			var g e_nocarry_0459
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0459[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0459[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0459[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0459[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0459[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0459[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0459[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0459[7], carry)
...
func Benchmarke_nocarry_0459InverseNew(b *testing.B) {
	var x e_nocarry_0459
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0459
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0459
		var xInv e_nocarry_0459
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0459
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0459
...
func testLinearComb(t *testing.T, x *e_nocarry_0459, xC int64, y *e_nocarry_0459, yC int64) {
	...
	var z e_nocarry_0459
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0459, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0459
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0459, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0459
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0459, xHi uint64) {
	var res e_nocarry_0459
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0459) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0459) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0459, c int64, result *e_nocarry_0459, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0459) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0459) uint64 {
