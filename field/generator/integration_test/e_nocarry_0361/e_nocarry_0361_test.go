...
var benchRese_nocarry_0361 e_nocarry_0361

func BenchmarkE_nocarry_0361SetBytes(b *testing.B) {
	var x e_nocarry_0361
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0361MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0361.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0361)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0361)
		}
	})
}

func BenchmarkE_nocarry_0361Inverse(b *testing.B) {
	var x e_nocarry_0361
	x.SetRandom()
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0361Butterfly(b *testing.B) {
	var x e_nocarry_0361
	x.SetRandom()
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0361)
	}
}

func BenchmarkE_nocarry_0361Exp(b *testing.B) {
	var x e_nocarry_0361
	x.SetRandom()
	benchRese_nocarry_0361.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0361Double(b *testing.B) {
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Double(&benchRese_nocarry_0361)
	}
}

func BenchmarkE_nocarry_0361Add(b *testing.B) {
	var x e_nocarry_0361
	x.SetRandom()
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Add(&x, &benchRese_nocarry_0361)
	}
}

func BenchmarkE_nocarry_0361Sub(b *testing.B) {
	var x e_nocarry_0361
	x.SetRandom()
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Sub(&x, &benchRese_nocarry_0361)
	}
}

func BenchmarkE_nocarry_0361Neg(b *testing.B) {
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Neg(&benchRese_nocarry_0361)
	}
}

func BenchmarkE_nocarry_0361Div(b *testing.B) {
	var x e_nocarry_0361
	x.SetRandom()
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Div(&x, &benchRese_nocarry_0361)
	}
}

func BenchmarkE_nocarry_0361FromMont(b *testing.B) {
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.FromMont()
	}
}

func BenchmarkE_nocarry_0361ToMont(b *testing.B) {
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.ToMont()
	}
}
func BenchmarkE_nocarry_0361Square(b *testing.B) {
	benchRese_nocarry_0361.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Square(&benchRese_nocarry_0361)
	}
}

func BenchmarkE_nocarry_0361Sqrt(b *testing.B) {
	var a e_nocarry_0361
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0361Mul(b *testing.B) {
	x := e_nocarry_0361{
	...
	benchRese_nocarry_0361.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Mul(&benchRese_nocarry_0361, &x)
	}
}

func BenchmarkE_nocarry_0361Cmp(b *testing.B) {
	x := e_nocarry_0361{
		17292286913614203417,
		5552096166101733899,
		4375914597307236722,
	...
	benchRese_nocarry_0361 = x
	benchRese_nocarry_0361[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0361.Cmp(&x)
	}
}

func TestE_nocarry_0361Cmp(t *testing.T) {
	var x, y e_nocarry_0361
...
func TestE_nocarry_0361IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0361
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0361

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0361{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0361
	one.SetOne()
	e.Sub(&qe_nocarry_0361, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0361{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0361{0, uint64(i)})
	}
...
func TestE_nocarry_0361NegZero(t *testing.T) {
	var a, b e_nocarry_0361
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0361Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0361, len(staticTestValues))
...
func TestE_nocarry_0361Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0361) bool {
			var b e_nocarry_0361
...
func TestE_nocarry_0361InverseExp(t *testing.T) {
...
func TestE_nocarry_0361MulByConstants(t *testing.T) {
...
func TestE_nocarry_0361Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0361) bool {
...
func TestE_nocarry_0361LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0361Halve(t *testing.T) {
...
func TestE_nocarry_0361FromMont(t *testing.T) {
...
type testPaire_nocarry_0361 struct {
	element e_nocarry_0361
	bigint  big.Int
}

func (z *e_nocarry_0361) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0361[5] {
		return true
	}
	if z[5] < qe_nocarry_0361[5] {
		return false
	...
	return z[0] >= qe_nocarry_0361[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0361

		g.element = e_nocarry_0361{
		...
		if qe_nocarry_0361[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0361[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0361 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0361[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0361[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0361[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0361[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0361[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0361[5], carry)
...
func Benchmarke_nocarry_0361InverseNew(b *testing.B) {
	var x e_nocarry_0361
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0361
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0361
		var xInv e_nocarry_0361
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0361
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0361
...
func testLinearComb(t *testing.T, x *e_nocarry_0361, xC int64, y *e_nocarry_0361, yC int64) {
	...
	var z e_nocarry_0361
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0361, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0361
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0361, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0361
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0361, xHi uint64) {
	var res e_nocarry_0361
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0361) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0361) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0361, c int64, result *e_nocarry_0361, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0361) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0361) uint64 {
