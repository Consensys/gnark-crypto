...
// modulus q
DATA q<>+0(SB)/8, $0x7d46e121908e6ff1
DATA q<>+8(SB)/8, $0xdadbe37c9e717275
DATA q<>+16(SB)/8, $0x60b0fb9e21fa424f
DATA q<>+24(SB)/8, $0x76d4bb0f5613e629
DATA q<>+32(SB)/8, $0xcf831f8c22d6f33e
DATA q<>+40(SB)/8, $0x000001e161e12e6b
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x187a4c2e679b5eef
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x7d46e121908e6ff1, R10
	MOVQ    $0xdadbe37c9e717275, R11
	MOVQ    $0x60b0fb9e21fa424f, R12
	MOVQ    $0x76d4bb0f5613e629, R13
	MOVQ    $0xcf831f8c22d6f33e, R14
	MOVQ    $0x000001e161e12e6b, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xdadbe37c9e717275, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x60b0fb9e21fa424f, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x76d4bb0f5613e629, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xcf831f8c22d6f33e, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000001e161e12e6b, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x7d46e121908e6ff1, CX
	MOVQ    $0xdadbe37c9e717275, BX
	MOVQ    $0x60b0fb9e21fa424f, SI
	MOVQ    $0x76d4bb0f5613e629, DI
	MOVQ    $0xcf831f8c22d6f33e, R8
	MOVQ    $0x000001e161e12e6b, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
