...
var benchRese_nocarry_0204 e_nocarry_0204

func BenchmarkE_nocarry_0204SetBytes(b *testing.B) {
	var x e_nocarry_0204
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0204MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0204.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0204)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0204)
		}
	})
}

func BenchmarkE_nocarry_0204Inverse(b *testing.B) {
	var x e_nocarry_0204
	x.SetRandom()
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0204Butterfly(b *testing.B) {
	var x e_nocarry_0204
	x.SetRandom()
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0204)
	}
}

func BenchmarkE_nocarry_0204Exp(b *testing.B) {
	var x e_nocarry_0204
	x.SetRandom()
	benchRese_nocarry_0204.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0204Double(b *testing.B) {
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Double(&benchRese_nocarry_0204)
	}
}

func BenchmarkE_nocarry_0204Add(b *testing.B) {
	var x e_nocarry_0204
	x.SetRandom()
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Add(&x, &benchRese_nocarry_0204)
	}
}

func BenchmarkE_nocarry_0204Sub(b *testing.B) {
	var x e_nocarry_0204
	x.SetRandom()
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Sub(&x, &benchRese_nocarry_0204)
	}
}

func BenchmarkE_nocarry_0204Neg(b *testing.B) {
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Neg(&benchRese_nocarry_0204)
	}
}

func BenchmarkE_nocarry_0204Div(b *testing.B) {
	var x e_nocarry_0204
	x.SetRandom()
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Div(&x, &benchRese_nocarry_0204)
	}
}

func BenchmarkE_nocarry_0204FromMont(b *testing.B) {
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.FromMont()
	}
}

func BenchmarkE_nocarry_0204ToMont(b *testing.B) {
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.ToMont()
	}
}
func BenchmarkE_nocarry_0204Square(b *testing.B) {
	benchRese_nocarry_0204.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Square(&benchRese_nocarry_0204)
	}
}

func BenchmarkE_nocarry_0204Sqrt(b *testing.B) {
	var a e_nocarry_0204
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0204Mul(b *testing.B) {
	x := e_nocarry_0204{
		2576397195390766723,
		9989086692767025709,
	...
	benchRese_nocarry_0204.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Mul(&benchRese_nocarry_0204, &x)
	}
}

func BenchmarkE_nocarry_0204Cmp(b *testing.B) {
	x := e_nocarry_0204{
		2576397195390766723,
		9989086692767025709,
		11710819425767883130,
	...
	benchRese_nocarry_0204 = x
	benchRese_nocarry_0204[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0204.Cmp(&x)
	}
}

func TestE_nocarry_0204Cmp(t *testing.T) {
	var x, y e_nocarry_0204
...
func TestE_nocarry_0204IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0204
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0204

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0204{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0204
	one.SetOne()
	e.Sub(&qe_nocarry_0204, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0204{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0204{0, uint64(i)})
	}
...
func TestE_nocarry_0204NegZero(t *testing.T) {
	var a, b e_nocarry_0204
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0204Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0204, len(staticTestValues))
...
func TestE_nocarry_0204Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0204) bool {
			var b e_nocarry_0204
...
func TestE_nocarry_0204InverseExp(t *testing.T) {
...
func TestE_nocarry_0204MulByConstants(t *testing.T) {
...
func TestE_nocarry_0204Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0204) bool {
...
func TestE_nocarry_0204LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0204Halve(t *testing.T) {
...
func TestE_nocarry_0204FromMont(t *testing.T) {
...
type testPaire_nocarry_0204 struct {
	element e_nocarry_0204
	bigint  big.Int
}

func (z *e_nocarry_0204) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0204[3] {
		return true
	}
	if z[3] < qe_nocarry_0204[3] {
		return false
	...
	return z[0] >= qe_nocarry_0204[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0204

		g.element = e_nocarry_0204{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0204[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0204[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0204 {
			var g e_nocarry_0204
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0204[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0204[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0204[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0204[3], carry)
...
func Benchmarke_nocarry_0204InverseNew(b *testing.B) {
	var x e_nocarry_0204
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0204
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0204
		var xInv e_nocarry_0204
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0204
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0204
...
func testLinearComb(t *testing.T, x *e_nocarry_0204, xC int64, y *e_nocarry_0204, yC int64) {
	...
	var z e_nocarry_0204
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0204, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0204
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0204, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0204
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0204, xHi uint64) {
	var res e_nocarry_0204
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0204) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0204) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0204, c int64, result *e_nocarry_0204, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0204) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0204) uint64 {
