...
var benchRese_nocarry_0142 e_nocarry_0142

func BenchmarkE_nocarry_0142SetBytes(b *testing.B) {
	var x e_nocarry_0142
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0142MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0142.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0142)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0142)
		}
	})
}

func BenchmarkE_nocarry_0142Inverse(b *testing.B) {
	var x e_nocarry_0142
	x.SetRandom()
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0142Butterfly(b *testing.B) {
	var x e_nocarry_0142
	x.SetRandom()
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0142)
	}
}

func BenchmarkE_nocarry_0142Exp(b *testing.B) {
	var x e_nocarry_0142
	x.SetRandom()
	benchRese_nocarry_0142.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0142Double(b *testing.B) {
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Double(&benchRese_nocarry_0142)
	}
}

func BenchmarkE_nocarry_0142Add(b *testing.B) {
	var x e_nocarry_0142
	x.SetRandom()
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Add(&x, &benchRese_nocarry_0142)
	}
}

func BenchmarkE_nocarry_0142Sub(b *testing.B) {
	var x e_nocarry_0142
	x.SetRandom()
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Sub(&x, &benchRese_nocarry_0142)
	}
}

func BenchmarkE_nocarry_0142Neg(b *testing.B) {
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Neg(&benchRese_nocarry_0142)
	}
}

func BenchmarkE_nocarry_0142Div(b *testing.B) {
	var x e_nocarry_0142
	x.SetRandom()
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Div(&x, &benchRese_nocarry_0142)
	}
}

func BenchmarkE_nocarry_0142FromMont(b *testing.B) {
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.FromMont()
	}
}

func BenchmarkE_nocarry_0142ToMont(b *testing.B) {
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.ToMont()
	}
}
func BenchmarkE_nocarry_0142Square(b *testing.B) {
	benchRese_nocarry_0142.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Square(&benchRese_nocarry_0142)
	}
}

func BenchmarkE_nocarry_0142Sqrt(b *testing.B) {
	var a e_nocarry_0142
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0142Mul(b *testing.B) {
	x := e_nocarry_0142{
		16082399245568035382,
		3939457605259595279,
		10383,
	}
	benchRese_nocarry_0142.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Mul(&benchRese_nocarry_0142, &x)
	}
}

func BenchmarkE_nocarry_0142Cmp(b *testing.B) {
	x := e_nocarry_0142{
		16082399245568035382,
		3939457605259595279,
		10383,
	}
	benchRese_nocarry_0142 = x
	benchRese_nocarry_0142[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0142.Cmp(&x)
	}
}

func TestE_nocarry_0142Cmp(t *testing.T) {
	var x, y e_nocarry_0142
...
func TestE_nocarry_0142IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0142
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0142

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0142{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0142
	one.SetOne()
	e.Sub(&qe_nocarry_0142, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0142{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0142{0, uint64(i)})
	}
...
func TestE_nocarry_0142NegZero(t *testing.T) {
	var a, b e_nocarry_0142
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0142Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0142, len(staticTestValues))
...
func TestE_nocarry_0142Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0142) bool {
			var b e_nocarry_0142
...
func TestE_nocarry_0142InverseExp(t *testing.T) {
...
func TestE_nocarry_0142MulByConstants(t *testing.T) {
...
func TestE_nocarry_0142Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0142) bool {
...
func TestE_nocarry_0142LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0142Halve(t *testing.T) {
...
func TestE_nocarry_0142FromMont(t *testing.T) {
...
type testPaire_nocarry_0142 struct {
	element e_nocarry_0142
	bigint  big.Int
}

func (z *e_nocarry_0142) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0142[2] {
		return true
	}
	if z[2] < qe_nocarry_0142[2] {
		return false
	...
	return z[0] >= qe_nocarry_0142[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0142

		g.element = e_nocarry_0142{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0142[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0142[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0142 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0142[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0142[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0142[2], carry)
...
func Benchmarke_nocarry_0142InverseNew(b *testing.B) {
	var x e_nocarry_0142
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0142
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0142
		var xInv e_nocarry_0142
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0142
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0142
...
func testLinearComb(t *testing.T, x *e_nocarry_0142, xC int64, y *e_nocarry_0142, yC int64) {
	...
	var z e_nocarry_0142
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0142, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0142
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0142, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0142
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0142, xHi uint64) {
	var res e_nocarry_0142
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0142) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0142) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0142, c int64, result *e_nocarry_0142, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0142) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0142) uint64 {
