...
var benchRese_nocarry_0316 e_nocarry_0316

func BenchmarkE_nocarry_0316SetBytes(b *testing.B) {
	var x e_nocarry_0316
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0316MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0316.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0316)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0316)
		}
	})
}

func BenchmarkE_nocarry_0316Inverse(b *testing.B) {
	var x e_nocarry_0316
	x.SetRandom()
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0316Butterfly(b *testing.B) {
	var x e_nocarry_0316
	x.SetRandom()
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0316)
	}
}

func BenchmarkE_nocarry_0316Exp(b *testing.B) {
	var x e_nocarry_0316
	x.SetRandom()
	benchRese_nocarry_0316.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0316Double(b *testing.B) {
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Double(&benchRese_nocarry_0316)
	}
}

func BenchmarkE_nocarry_0316Add(b *testing.B) {
	var x e_nocarry_0316
	x.SetRandom()
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Add(&x, &benchRese_nocarry_0316)
	}
}

func BenchmarkE_nocarry_0316Sub(b *testing.B) {
	var x e_nocarry_0316
	x.SetRandom()
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Sub(&x, &benchRese_nocarry_0316)
	}
}

func BenchmarkE_nocarry_0316Neg(b *testing.B) {
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Neg(&benchRese_nocarry_0316)
	}
}

func BenchmarkE_nocarry_0316Div(b *testing.B) {
	var x e_nocarry_0316
	x.SetRandom()
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Div(&x, &benchRese_nocarry_0316)
	}
}

func BenchmarkE_nocarry_0316FromMont(b *testing.B) {
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.FromMont()
	}
}

func BenchmarkE_nocarry_0316ToMont(b *testing.B) {
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.ToMont()
	}
}
func BenchmarkE_nocarry_0316Square(b *testing.B) {
	benchRese_nocarry_0316.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Square(&benchRese_nocarry_0316)
	}
}

func BenchmarkE_nocarry_0316Sqrt(b *testing.B) {
	var a e_nocarry_0316
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0316Mul(b *testing.B) {
	x := e_nocarry_0316{
	...
	benchRese_nocarry_0316.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Mul(&benchRese_nocarry_0316, &x)
	}
}

func BenchmarkE_nocarry_0316Cmp(b *testing.B) {
	x := e_nocarry_0316{
		13173653664100205598,
		12214164607721094635,
		11021774252551575383,
	...
	benchRese_nocarry_0316 = x
	benchRese_nocarry_0316[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0316.Cmp(&x)
	}
}

func TestE_nocarry_0316Cmp(t *testing.T) {
	var x, y e_nocarry_0316
...
func TestE_nocarry_0316IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0316
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0316

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0316{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0316
	one.SetOne()
	e.Sub(&qe_nocarry_0316, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0316{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0316{0, uint64(i)})
	}
...
func TestE_nocarry_0316NegZero(t *testing.T) {
	var a, b e_nocarry_0316
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0316Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0316, len(staticTestValues))
...
func TestE_nocarry_0316Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0316) bool {
			var b e_nocarry_0316
...
func TestE_nocarry_0316InverseExp(t *testing.T) {
...
func TestE_nocarry_0316MulByConstants(t *testing.T) {
...
func TestE_nocarry_0316Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0316) bool {
...
func TestE_nocarry_0316LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0316Halve(t *testing.T) {
...
func TestE_nocarry_0316FromMont(t *testing.T) {
...
type testPaire_nocarry_0316 struct {
	element e_nocarry_0316
	bigint  big.Int
}

func (z *e_nocarry_0316) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0316[4] {
		return true
	}
	if z[4] < qe_nocarry_0316[4] {
		return false
	...
	return z[0] >= qe_nocarry_0316[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0316

		g.element = e_nocarry_0316{
		...
		if qe_nocarry_0316[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0316[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0316 {
			var g e_nocarry_0316
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0316[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0316[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0316[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0316[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0316[4], carry)
...
func Benchmarke_nocarry_0316InverseNew(b *testing.B) {
	var x e_nocarry_0316
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0316
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0316
		var xInv e_nocarry_0316
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0316
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0316
...
func testLinearComb(t *testing.T, x *e_nocarry_0316, xC int64, y *e_nocarry_0316, yC int64) {
	...
	var z e_nocarry_0316
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0316, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0316
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0316, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0316
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0316, xHi uint64) {
	var res e_nocarry_0316
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0316) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0316) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0316, c int64, result *e_nocarry_0316, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0316) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0316) uint64 {
