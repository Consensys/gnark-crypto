...
// modulus q
DATA q<>+0(SB)/8, $0xe8089f1cc709f43b
DATA q<>+8(SB)/8, $0x00d963071277de79
DATA q<>+16(SB)/8, $0x9400dc129f56ffce
DATA q<>+24(SB)/8, $0x618ecd65439e4a4a
DATA q<>+32(SB)/8, $0x0cb0fe540e44dea7
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0b9374ac014f3b0d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xe8089f1cc709f43b, R9
	MOVQ    $0x00d963071277de79, R10
	MOVQ    $0x9400dc129f56ffce, R11
	MOVQ    $0x618ecd65439e4a4a, R12
	MOVQ    $0x0cb0fe540e44dea7, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x00d963071277de79, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x9400dc129f56ffce, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x618ecd65439e4a4a, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0cb0fe540e44dea7, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xe8089f1cc709f43b, CX
	MOVQ    $0x00d963071277de79, BX
	MOVQ    $0x9400dc129f56ffce, SI
	MOVQ    $0x618ecd65439e4a4a, DI
	MOVQ    $0x0cb0fe540e44dea7, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
