...
var benchRese_nocarry_0465 e_nocarry_0465

func BenchmarkE_nocarry_0465SetBytes(b *testing.B) {
	var x e_nocarry_0465
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0465MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0465.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0465)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0465)
		}
	})
}

func BenchmarkE_nocarry_0465Inverse(b *testing.B) {
	var x e_nocarry_0465
	x.SetRandom()
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0465Butterfly(b *testing.B) {
	var x e_nocarry_0465
	x.SetRandom()
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0465)
	}
}

func BenchmarkE_nocarry_0465Exp(b *testing.B) {
	var x e_nocarry_0465
	x.SetRandom()
	benchRese_nocarry_0465.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0465Double(b *testing.B) {
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Double(&benchRese_nocarry_0465)
	}
}

func BenchmarkE_nocarry_0465Add(b *testing.B) {
	var x e_nocarry_0465
	x.SetRandom()
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Add(&x, &benchRese_nocarry_0465)
	}
}

func BenchmarkE_nocarry_0465Sub(b *testing.B) {
	var x e_nocarry_0465
	x.SetRandom()
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Sub(&x, &benchRese_nocarry_0465)
	}
}

func BenchmarkE_nocarry_0465Neg(b *testing.B) {
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Neg(&benchRese_nocarry_0465)
	}
}

func BenchmarkE_nocarry_0465Div(b *testing.B) {
	var x e_nocarry_0465
	x.SetRandom()
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Div(&x, &benchRese_nocarry_0465)
	}
}

func BenchmarkE_nocarry_0465FromMont(b *testing.B) {
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.FromMont()
	}
}

func BenchmarkE_nocarry_0465ToMont(b *testing.B) {
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.ToMont()
	}
}
func BenchmarkE_nocarry_0465Square(b *testing.B) {
	benchRese_nocarry_0465.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Square(&benchRese_nocarry_0465)
	}
}

func BenchmarkE_nocarry_0465Sqrt(b *testing.B) {
	var a e_nocarry_0465
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0465Mul(b *testing.B) {
	x := e_nocarry_0465{
		3342953601731337046,
		3979550899678885586,
	...
	benchRese_nocarry_0465.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Mul(&benchRese_nocarry_0465, &x)
	}
}

func BenchmarkE_nocarry_0465Cmp(b *testing.B) {
	x := e_nocarry_0465{
		3342953601731337046,
		3979550899678885586,
		15394640682545258029,
	...
	benchRese_nocarry_0465 = x
	benchRese_nocarry_0465[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0465.Cmp(&x)
	}
}

func TestE_nocarry_0465Cmp(t *testing.T) {
	var x, y e_nocarry_0465
...
func TestE_nocarry_0465IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0465
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0465

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0465{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0465
	one.SetOne()
	e.Sub(&qe_nocarry_0465, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0465{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0465{0, uint64(i)})
	}
...
func TestE_nocarry_0465NegZero(t *testing.T) {
	var a, b e_nocarry_0465
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0465Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0465, len(staticTestValues))
...
func TestE_nocarry_0465Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0465) bool {
			var b e_nocarry_0465
...
func TestE_nocarry_0465InverseExp(t *testing.T) {
...
func TestE_nocarry_0465MulByConstants(t *testing.T) {
...
func TestE_nocarry_0465Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0465) bool {
...
func TestE_nocarry_0465LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0465Halve(t *testing.T) {
...
func TestE_nocarry_0465FromMont(t *testing.T) {
...
type testPaire_nocarry_0465 struct {
	element e_nocarry_0465
	bigint  big.Int
}

func (z *e_nocarry_0465) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0465[7] {
		return true
	}
	if z[7] < qe_nocarry_0465[7] {
		return false
	...
	return z[0] >= qe_nocarry_0465[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0465

		g.element = e_nocarry_0465{
		...
		if qe_nocarry_0465[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0465[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0465 {
			var g e_nocarry_0465
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0465[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0465[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0465[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0465[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0465[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0465[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0465[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0465[7], carry)
...
func Benchmarke_nocarry_0465InverseNew(b *testing.B) {
	var x e_nocarry_0465
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0465
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0465
		var xInv e_nocarry_0465
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0465
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0465
...
func testLinearComb(t *testing.T, x *e_nocarry_0465, xC int64, y *e_nocarry_0465, yC int64) {
	...
	var z e_nocarry_0465
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0465, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0465
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0465, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0465
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0465, xHi uint64) {
	var res e_nocarry_0465
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0465) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0465) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0465, c int64, result *e_nocarry_0465, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0465) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0465) uint64 {
