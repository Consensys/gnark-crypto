...
var benchRese_nocarry_0294 e_nocarry_0294

func BenchmarkE_nocarry_0294SetBytes(b *testing.B) {
	var x e_nocarry_0294
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0294MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0294.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0294)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0294)
		}
	})
}

func BenchmarkE_nocarry_0294Inverse(b *testing.B) {
	var x e_nocarry_0294
	x.SetRandom()
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0294Butterfly(b *testing.B) {
	var x e_nocarry_0294
	x.SetRandom()
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0294)
	}
}

func BenchmarkE_nocarry_0294Exp(b *testing.B) {
	var x e_nocarry_0294
	x.SetRandom()
	benchRese_nocarry_0294.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0294Double(b *testing.B) {
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Double(&benchRese_nocarry_0294)
	}
}

func BenchmarkE_nocarry_0294Add(b *testing.B) {
	var x e_nocarry_0294
	x.SetRandom()
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Add(&x, &benchRese_nocarry_0294)
	}
}

func BenchmarkE_nocarry_0294Sub(b *testing.B) {
	var x e_nocarry_0294
	x.SetRandom()
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Sub(&x, &benchRese_nocarry_0294)
	}
}

func BenchmarkE_nocarry_0294Neg(b *testing.B) {
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Neg(&benchRese_nocarry_0294)
	}
}

func BenchmarkE_nocarry_0294Div(b *testing.B) {
	var x e_nocarry_0294
	x.SetRandom()
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Div(&x, &benchRese_nocarry_0294)
	}
}

func BenchmarkE_nocarry_0294FromMont(b *testing.B) {
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.FromMont()
	}
}

func BenchmarkE_nocarry_0294ToMont(b *testing.B) {
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.ToMont()
	}
}
func BenchmarkE_nocarry_0294Square(b *testing.B) {
	benchRese_nocarry_0294.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Square(&benchRese_nocarry_0294)
	}
}

func BenchmarkE_nocarry_0294Sqrt(b *testing.B) {
	var a e_nocarry_0294
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0294Mul(b *testing.B) {
	x := e_nocarry_0294{
		5411083014969751412,
		1796453167022773403,
		1992039281458791048,
	...
	benchRese_nocarry_0294.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Mul(&benchRese_nocarry_0294, &x)
	}
}

func BenchmarkE_nocarry_0294Cmp(b *testing.B) {
	x := e_nocarry_0294{
		5411083014969751412,
		1796453167022773403,
		1992039281458791048,
	...
	benchRese_nocarry_0294 = x
	benchRese_nocarry_0294[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0294.Cmp(&x)
	}
}

func TestE_nocarry_0294Cmp(t *testing.T) {
	var x, y e_nocarry_0294
...
func TestE_nocarry_0294IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0294
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0294

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0294{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0294
	one.SetOne()
	e.Sub(&qe_nocarry_0294, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0294{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0294{0, uint64(i)})
	}
...
func TestE_nocarry_0294NegZero(t *testing.T) {
	var a, b e_nocarry_0294
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0294Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0294, len(staticTestValues))
...
func TestE_nocarry_0294Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0294) bool {
			var b e_nocarry_0294
...
func TestE_nocarry_0294InverseExp(t *testing.T) {
...
func TestE_nocarry_0294MulByConstants(t *testing.T) {
...
func TestE_nocarry_0294Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0294) bool {
...
func TestE_nocarry_0294LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0294Halve(t *testing.T) {
...
func TestE_nocarry_0294FromMont(t *testing.T) {
...
type testPaire_nocarry_0294 struct {
	element e_nocarry_0294
	bigint  big.Int
}

func (z *e_nocarry_0294) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0294[4] {
		return true
	}
	if z[4] < qe_nocarry_0294[4] {
		return false
	...
	return z[0] >= qe_nocarry_0294[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0294

		g.element = e_nocarry_0294{
		...
		if qe_nocarry_0294[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0294[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0294 {
			var g e_nocarry_0294
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0294[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0294[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0294[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0294[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0294[4], carry)
...
func Benchmarke_nocarry_0294InverseNew(b *testing.B) {
	var x e_nocarry_0294
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0294
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0294
		var xInv e_nocarry_0294
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0294
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0294
...
func testLinearComb(t *testing.T, x *e_nocarry_0294, xC int64, y *e_nocarry_0294, yC int64) {
	...
	var z e_nocarry_0294
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0294, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0294
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0294, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0294
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0294, xHi uint64) {
	var res e_nocarry_0294
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0294) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0294) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0294, c int64, result *e_nocarry_0294, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0294) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0294) uint64 {
