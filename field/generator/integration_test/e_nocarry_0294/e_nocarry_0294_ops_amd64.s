...
// modulus q
DATA q<>+0(SB)/8, $0x99299fb984f64115
DATA q<>+8(SB)/8, $0xd3ea4b447cebe106
DATA q<>+16(SB)/8, $0x508bdbceb71d969c
DATA q<>+24(SB)/8, $0xe5f6c0eb4574d05f
DATA q<>+32(SB)/8, $0x000000369f4e80da
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xac73460ee863f9c3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x99299fb984f64115, R9
	MOVQ    $0xd3ea4b447cebe106, R10
	MOVQ    $0x508bdbceb71d969c, R11
	MOVQ    $0xe5f6c0eb4574d05f, R12
	MOVQ    $0x000000369f4e80da, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xd3ea4b447cebe106, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x508bdbceb71d969c, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xe5f6c0eb4574d05f, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000369f4e80da, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x99299fb984f64115, CX
	MOVQ    $0xd3ea4b447cebe106, BX
	MOVQ    $0x508bdbceb71d969c, SI
	MOVQ    $0xe5f6c0eb4574d05f, DI
	MOVQ    $0x000000369f4e80da, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
