...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x03387584f8254043, R12
	ADDQ R12, AX
	MOVQ $0x426ef9812ab4037c, R12
	ADCQ R12, DX
	MOVQ $0xe6f0cb0763e0edf9, R12
	ADCQ R12, CX
	MOVQ $0xa1ac7ccc20c72c9c, R12
	ADCQ R12, BX
	MOVQ $0xf34e8cec33c63156, R12
	ADCQ R12, SI
	MOVQ $0x6bac210741a33204, R12
	ADCQ R12, DI
	MOVQ $0x587cd3a7d8e7db54, R12
	ADCQ R12, R8
	MOVQ $0x6afd3a5d783ecd13, R12
	ADCQ R12, R9
	MOVQ $0x00000033b342c671, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x03387584f8254043, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x426ef9812ab4037c, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xe6f0cb0763e0edf9, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xa1ac7ccc20c72c9c, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xf34e8cec33c63156, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x6bac210741a33204, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x587cd3a7d8e7db54, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x6afd3a5d783ecd13, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000033b342c671, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x03387584f8254043, AX
	ADDQ AX, DX
	MOVQ $0x426ef9812ab4037c, AX
	ADCQ AX, CX
	MOVQ $0xe6f0cb0763e0edf9, AX
	ADCQ AX, BX
	MOVQ $0xa1ac7ccc20c72c9c, AX
	ADCQ AX, SI
	MOVQ $0xf34e8cec33c63156, AX
	ADCQ AX, DI
	MOVQ $0x6bac210741a33204, AX
	ADCQ AX, R8
	MOVQ $0x587cd3a7d8e7db54, AX
	ADCQ AX, R9
	MOVQ $0x6afd3a5d783ecd13, AX
	ADCQ AX, R10
	MOVQ $0x00000033b342c671, AX
	ADCQ AX, R11
