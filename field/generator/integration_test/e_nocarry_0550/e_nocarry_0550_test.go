...
var benchRese_nocarry_0550 e_nocarry_0550

func BenchmarkE_nocarry_0550SetBytes(b *testing.B) {
	var x e_nocarry_0550
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0550MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0550.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0550)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0550)
		}
	})
}

func BenchmarkE_nocarry_0550Inverse(b *testing.B) {
	var x e_nocarry_0550
	x.SetRandom()
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0550Butterfly(b *testing.B) {
	var x e_nocarry_0550
	x.SetRandom()
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0550)
	}
}

func BenchmarkE_nocarry_0550Exp(b *testing.B) {
	var x e_nocarry_0550
	x.SetRandom()
	benchRese_nocarry_0550.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0550Double(b *testing.B) {
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Double(&benchRese_nocarry_0550)
	}
}

func BenchmarkE_nocarry_0550Add(b *testing.B) {
	var x e_nocarry_0550
	x.SetRandom()
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Add(&x, &benchRese_nocarry_0550)
	}
}

func BenchmarkE_nocarry_0550Sub(b *testing.B) {
	var x e_nocarry_0550
	x.SetRandom()
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Sub(&x, &benchRese_nocarry_0550)
	}
}

func BenchmarkE_nocarry_0550Neg(b *testing.B) {
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Neg(&benchRese_nocarry_0550)
	}
}

func BenchmarkE_nocarry_0550Div(b *testing.B) {
	var x e_nocarry_0550
	x.SetRandom()
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Div(&x, &benchRese_nocarry_0550)
	}
}

func BenchmarkE_nocarry_0550FromMont(b *testing.B) {
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.FromMont()
	}
}

func BenchmarkE_nocarry_0550ToMont(b *testing.B) {
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.ToMont()
	}
}
func BenchmarkE_nocarry_0550Square(b *testing.B) {
	benchRese_nocarry_0550.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Square(&benchRese_nocarry_0550)
	}
}

func BenchmarkE_nocarry_0550Sqrt(b *testing.B) {
	var a e_nocarry_0550
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0550Mul(b *testing.B) {
	x := e_nocarry_0550{
		920173539964516315,
	...
	benchRese_nocarry_0550.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Mul(&benchRese_nocarry_0550, &x)
	}
}

func BenchmarkE_nocarry_0550Cmp(b *testing.B) {
	x := e_nocarry_0550{
		920173539964516315,
		15261973241952853338,
		9440940373106816817,
	...
	benchRese_nocarry_0550 = x
	benchRese_nocarry_0550[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0550.Cmp(&x)
	}
}

func TestE_nocarry_0550Cmp(t *testing.T) {
	var x, y e_nocarry_0550
...
func TestE_nocarry_0550IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0550
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0550

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0550{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0550
	one.SetOne()
	e.Sub(&qe_nocarry_0550, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0550{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0550{0, uint64(i)})
	}
...
func TestE_nocarry_0550NegZero(t *testing.T) {
	var a, b e_nocarry_0550
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0550Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0550, len(staticTestValues))
...
func TestE_nocarry_0550Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0550) bool {
			var b e_nocarry_0550
...
func TestE_nocarry_0550InverseExp(t *testing.T) {
...
func TestE_nocarry_0550MulByConstants(t *testing.T) {
...
func TestE_nocarry_0550Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0550) bool {
...
func TestE_nocarry_0550LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0550Halve(t *testing.T) {
...
func TestE_nocarry_0550FromMont(t *testing.T) {
...
type testPaire_nocarry_0550 struct {
	element e_nocarry_0550
	bigint  big.Int
}

func (z *e_nocarry_0550) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0550[8] {
		return true
	}
	if z[8] < qe_nocarry_0550[8] {
		return false
	...
	return z[0] >= qe_nocarry_0550[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0550

		g.element = e_nocarry_0550{
		...
		if qe_nocarry_0550[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0550[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0550 {
			var g e_nocarry_0550
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0550[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0550[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0550[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0550[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0550[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0550[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0550[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0550[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0550[8], carry)
...
func Benchmarke_nocarry_0550InverseNew(b *testing.B) {
	var x e_nocarry_0550
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0550
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0550
		var xInv e_nocarry_0550
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0550
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0550
...
func testLinearComb(t *testing.T, x *e_nocarry_0550, xC int64, y *e_nocarry_0550, yC int64) {
	...
	var z e_nocarry_0550
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0550, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0550
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0550, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0550
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0550, xHi uint64) {
	var res e_nocarry_0550
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0550) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0550) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0550, c int64, result *e_nocarry_0550, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0550) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0550) uint64 {
