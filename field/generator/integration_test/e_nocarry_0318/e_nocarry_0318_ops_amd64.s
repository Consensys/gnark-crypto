...
// modulus q
DATA q<>+0(SB)/8, $0x622f0bdfab4e1fb9
DATA q<>+8(SB)/8, $0x49e7860f621f550a
DATA q<>+16(SB)/8, $0xcf26f06d60b35a1c
DATA q<>+24(SB)/8, $0x84c7e66b2bc430c1
DATA q<>+32(SB)/8, $0x3054341ab2dea123
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x69c9f067237fc977
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x622f0bdfab4e1fb9, R9
	MOVQ    $0x49e7860f621f550a, R10
	MOVQ    $0xcf26f06d60b35a1c, R11
	MOVQ    $0x84c7e66b2bc430c1, R12
	MOVQ    $0x3054341ab2dea123, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x49e7860f621f550a, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xcf26f06d60b35a1c, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x84c7e66b2bc430c1, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x3054341ab2dea123, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x622f0bdfab4e1fb9, CX
	MOVQ    $0x49e7860f621f550a, BX
	MOVQ    $0xcf26f06d60b35a1c, SI
	MOVQ    $0x84c7e66b2bc430c1, DI
	MOVQ    $0x3054341ab2dea123, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
