...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xc14dedfbc868e39d, R14
	ADDQ R14, AX
	MOVQ $0x5926766a5ec48be0, R14
	ADCQ R14, DX
	MOVQ $0xe00a7d5bc3ea153e, R14
	ADCQ R14, CX
	MOVQ $0xb991471c932aca46, R14
	ADCQ R14, BX
	MOVQ $0xeacea984d6475640, R14
	ADCQ R14, SI
	MOVQ $0x355349ed3ccc6987, R14
	ADCQ R14, DI
	MOVQ $0x27aff0973cc47258, R14
	ADCQ R14, R8
	MOVQ $0x30f241ba94011085, R14
	ADCQ R14, R9
	MOVQ $0xd0ca1437f6eca952, R14
	ADCQ R14, R10
	MOVQ $0x13944fcf046d2f9b, R14
	ADCQ R14, R11
	MOVQ $0x00635fcaf7ba1700, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xc14dedfbc868e39d, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x5926766a5ec48be0, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xe00a7d5bc3ea153e, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xb991471c932aca46, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xeacea984d6475640, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x355349ed3ccc6987, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x27aff0973cc47258, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x30f241ba94011085, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xd0ca1437f6eca952, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x13944fcf046d2f9b, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00635fcaf7ba1700, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xc14dedfbc868e39d, AX
	ADDQ AX, DX
	MOVQ $0x5926766a5ec48be0, AX
	ADCQ AX, CX
	MOVQ $0xe00a7d5bc3ea153e, AX
	ADCQ AX, BX
	MOVQ $0xb991471c932aca46, AX
	ADCQ AX, SI
	MOVQ $0xeacea984d6475640, AX
	ADCQ AX, DI
	MOVQ $0x355349ed3ccc6987, AX
	ADCQ AX, R8
	MOVQ $0x27aff0973cc47258, AX
	ADCQ AX, R9
	MOVQ $0x30f241ba94011085, AX
	ADCQ AX, R10
	MOVQ $0xd0ca1437f6eca952, AX
	ADCQ AX, R11
	MOVQ $0x13944fcf046d2f9b, AX
	ADCQ AX, R12
	MOVQ $0x00635fcaf7ba1700, AX
	ADCQ AX, R13
