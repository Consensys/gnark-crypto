...
var benchRese_nocarry_0695 e_nocarry_0695

func BenchmarkE_nocarry_0695SetBytes(b *testing.B) {
	var x e_nocarry_0695
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0695MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0695.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0695)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0695)
		}
	})
}

func BenchmarkE_nocarry_0695Inverse(b *testing.B) {
	var x e_nocarry_0695
	x.SetRandom()
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0695Butterfly(b *testing.B) {
	var x e_nocarry_0695
	x.SetRandom()
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0695)
	}
}

func BenchmarkE_nocarry_0695Exp(b *testing.B) {
	var x e_nocarry_0695
	x.SetRandom()
	benchRese_nocarry_0695.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0695Double(b *testing.B) {
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Double(&benchRese_nocarry_0695)
	}
}

func BenchmarkE_nocarry_0695Add(b *testing.B) {
	var x e_nocarry_0695
	x.SetRandom()
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Add(&x, &benchRese_nocarry_0695)
	}
}

func BenchmarkE_nocarry_0695Sub(b *testing.B) {
	var x e_nocarry_0695
	x.SetRandom()
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Sub(&x, &benchRese_nocarry_0695)
	}
}

func BenchmarkE_nocarry_0695Neg(b *testing.B) {
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Neg(&benchRese_nocarry_0695)
	}
}

func BenchmarkE_nocarry_0695Div(b *testing.B) {
	var x e_nocarry_0695
	x.SetRandom()
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Div(&x, &benchRese_nocarry_0695)
	}
}

func BenchmarkE_nocarry_0695FromMont(b *testing.B) {
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.FromMont()
	}
}

func BenchmarkE_nocarry_0695ToMont(b *testing.B) {
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.ToMont()
	}
}
func BenchmarkE_nocarry_0695Square(b *testing.B) {
	benchRese_nocarry_0695.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Square(&benchRese_nocarry_0695)
	}
}

func BenchmarkE_nocarry_0695Sqrt(b *testing.B) {
	var a e_nocarry_0695
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0695Mul(b *testing.B) {
	x := e_nocarry_0695{
		9884215130573365435,
	...
	benchRese_nocarry_0695.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Mul(&benchRese_nocarry_0695, &x)
	}
}

func BenchmarkE_nocarry_0695Cmp(b *testing.B) {
	x := e_nocarry_0695{
		9884215130573365435,
		12599215389428146590,
		18157686559802753924,
	...
	benchRese_nocarry_0695 = x
	benchRese_nocarry_0695[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0695.Cmp(&x)
	}
}

func TestE_nocarry_0695Cmp(t *testing.T) {
	var x, y e_nocarry_0695
...
func TestE_nocarry_0695IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0695
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0695

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0695{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0695
	one.SetOne()
	e.Sub(&qe_nocarry_0695, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0695{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0695{0, uint64(i)})
	}
...
func TestE_nocarry_0695NegZero(t *testing.T) {
	var a, b e_nocarry_0695
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0695Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0695, len(staticTestValues))
...
func TestE_nocarry_0695Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0695) bool {
			var b e_nocarry_0695
...
func TestE_nocarry_0695InverseExp(t *testing.T) {
...
func TestE_nocarry_0695MulByConstants(t *testing.T) {
...
func TestE_nocarry_0695Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0695) bool {
...
func TestE_nocarry_0695LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0695Halve(t *testing.T) {
...
func TestE_nocarry_0695FromMont(t *testing.T) {
...
type testPaire_nocarry_0695 struct {
	element e_nocarry_0695
	bigint  big.Int
}

func (z *e_nocarry_0695) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0695[10] {
		return true
	}
	if z[10] < qe_nocarry_0695[10] {
		return false
	...
	return z[0] >= qe_nocarry_0695[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0695

		g.element = e_nocarry_0695{
		...
		if qe_nocarry_0695[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0695[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0695 {
			var g e_nocarry_0695
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0695[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0695[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0695[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0695[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0695[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0695[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0695[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0695[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0695[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0695[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0695[10], carry)
...
func Benchmarke_nocarry_0695InverseNew(b *testing.B) {
	var x e_nocarry_0695
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0695
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0695
		var xInv e_nocarry_0695
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0695
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0695
...
func testLinearComb(t *testing.T, x *e_nocarry_0695, xC int64, y *e_nocarry_0695, yC int64) {
	...
	var z e_nocarry_0695
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0695, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0695
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0695, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0695
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0695, xHi uint64) {
	var res e_nocarry_0695
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0695) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0695) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0695, c int64, result *e_nocarry_0695, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0695) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0695) uint64 {
