...
var benchRese_nocarry_0503 e_nocarry_0503

func BenchmarkE_nocarry_0503SetBytes(b *testing.B) {
	var x e_nocarry_0503
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0503MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0503.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0503)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0503)
		}
	})
}

func BenchmarkE_nocarry_0503Inverse(b *testing.B) {
	var x e_nocarry_0503
	x.SetRandom()
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0503Butterfly(b *testing.B) {
	var x e_nocarry_0503
	x.SetRandom()
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0503)
	}
}

func BenchmarkE_nocarry_0503Exp(b *testing.B) {
	var x e_nocarry_0503
	x.SetRandom()
	benchRese_nocarry_0503.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0503Double(b *testing.B) {
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Double(&benchRese_nocarry_0503)
	}
}

func BenchmarkE_nocarry_0503Add(b *testing.B) {
	var x e_nocarry_0503
	x.SetRandom()
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Add(&x, &benchRese_nocarry_0503)
	}
}

func BenchmarkE_nocarry_0503Sub(b *testing.B) {
	var x e_nocarry_0503
	x.SetRandom()
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Sub(&x, &benchRese_nocarry_0503)
	}
}

func BenchmarkE_nocarry_0503Neg(b *testing.B) {
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Neg(&benchRese_nocarry_0503)
	}
}

func BenchmarkE_nocarry_0503Div(b *testing.B) {
	var x e_nocarry_0503
	x.SetRandom()
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Div(&x, &benchRese_nocarry_0503)
	}
}

func BenchmarkE_nocarry_0503FromMont(b *testing.B) {
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.FromMont()
	}
}

func BenchmarkE_nocarry_0503ToMont(b *testing.B) {
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.ToMont()
	}
}
func BenchmarkE_nocarry_0503Square(b *testing.B) {
	benchRese_nocarry_0503.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Square(&benchRese_nocarry_0503)
	}
}

func BenchmarkE_nocarry_0503Sqrt(b *testing.B) {
	var a e_nocarry_0503
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0503Mul(b *testing.B) {
	x := e_nocarry_0503{
		1489494700212722002,
		337596296581499176,
	...
	benchRese_nocarry_0503.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Mul(&benchRese_nocarry_0503, &x)
	}
}

func BenchmarkE_nocarry_0503Cmp(b *testing.B) {
	x := e_nocarry_0503{
		1489494700212722002,
		337596296581499176,
		12418285251210090235,
	...
	benchRese_nocarry_0503 = x
	benchRese_nocarry_0503[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0503.Cmp(&x)
	}
}

func TestE_nocarry_0503Cmp(t *testing.T) {
	var x, y e_nocarry_0503
...
func TestE_nocarry_0503IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0503
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0503

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0503{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0503
	one.SetOne()
	e.Sub(&qe_nocarry_0503, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0503{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0503{0, uint64(i)})
	}
...
func TestE_nocarry_0503NegZero(t *testing.T) {
	var a, b e_nocarry_0503
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0503Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0503, len(staticTestValues))
...
func TestE_nocarry_0503Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0503) bool {
			var b e_nocarry_0503
...
func TestE_nocarry_0503InverseExp(t *testing.T) {
...
func TestE_nocarry_0503MulByConstants(t *testing.T) {
...
func TestE_nocarry_0503Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0503) bool {
...
func TestE_nocarry_0503LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0503Halve(t *testing.T) {
...
func TestE_nocarry_0503FromMont(t *testing.T) {
...
type testPaire_nocarry_0503 struct {
	element e_nocarry_0503
	bigint  big.Int
}

func (z *e_nocarry_0503) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0503[7] {
		return true
	}
	if z[7] < qe_nocarry_0503[7] {
		return false
	...
	return z[0] >= qe_nocarry_0503[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0503

		g.element = e_nocarry_0503{
		...
		if qe_nocarry_0503[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0503[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0503 {
			var g e_nocarry_0503
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0503[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0503[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0503[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0503[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0503[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0503[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0503[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0503[7], carry)
...
func Benchmarke_nocarry_0503InverseNew(b *testing.B) {
	var x e_nocarry_0503
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0503
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0503
		var xInv e_nocarry_0503
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0503
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0503
...
func testLinearComb(t *testing.T, x *e_nocarry_0503, xC int64, y *e_nocarry_0503, yC int64) {
	...
	var z e_nocarry_0503
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0503, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0503
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0503, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0503
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0503, xHi uint64) {
	var res e_nocarry_0503
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0503) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0503) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0503, c int64, result *e_nocarry_0503, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0503) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0503) uint64 {
