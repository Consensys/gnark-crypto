...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x18189511050cebf3, R13
	ADDQ R13, AX
	MOVQ $0x746f50521c464117, R13
	ADCQ R13, DX
	MOVQ $0x69cab265f5e7ea71, R13
	ADCQ R13, CX
	MOVQ $0xfcb9c62266a37af8, R13
	ADCQ R13, BX
	MOVQ $0xc202f71181a4182b, R13
	ADCQ R13, SI
	MOVQ $0x302c9b8f9724982f, R13
	ADCQ R13, DI
	MOVQ $0x0b2d52dbbdde3f92, R13
	ADCQ R13, R8
	MOVQ $0x536f07a525b97669, R13
	ADCQ R13, R9
	MOVQ $0x23f01390cbda0684, R13
	ADCQ R13, R10
	MOVQ $0x00000000000000d2, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x18189511050cebf3, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x746f50521c464117, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x69cab265f5e7ea71, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xfcb9c62266a37af8, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xc202f71181a4182b, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x302c9b8f9724982f, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x0b2d52dbbdde3f92, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x536f07a525b97669, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x23f01390cbda0684, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000000000d2, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x18189511050cebf3, AX
	ADDQ AX, DX
	MOVQ $0x746f50521c464117, AX
	ADCQ AX, CX
	MOVQ $0x69cab265f5e7ea71, AX
	ADCQ AX, BX
	MOVQ $0xfcb9c62266a37af8, AX
	ADCQ AX, SI
	MOVQ $0xc202f71181a4182b, AX
	ADCQ AX, DI
	MOVQ $0x302c9b8f9724982f, AX
	ADCQ AX, R8
	MOVQ $0x0b2d52dbbdde3f92, AX
	ADCQ AX, R9
	MOVQ $0x536f07a525b97669, AX
	ADCQ AX, R10
	MOVQ $0x23f01390cbda0684, AX
	ADCQ AX, R11
	MOVQ $0x00000000000000d2, AX
	ADCQ AX, R12
