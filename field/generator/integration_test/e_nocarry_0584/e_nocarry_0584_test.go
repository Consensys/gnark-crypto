...
var benchRese_nocarry_0584 e_nocarry_0584

func BenchmarkE_nocarry_0584SetBytes(b *testing.B) {
	var x e_nocarry_0584
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0584MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0584.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0584)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0584)
		}
	})
}

func BenchmarkE_nocarry_0584Inverse(b *testing.B) {
	var x e_nocarry_0584
	x.SetRandom()
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0584Butterfly(b *testing.B) {
	var x e_nocarry_0584
	x.SetRandom()
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0584)
	}
}

func BenchmarkE_nocarry_0584Exp(b *testing.B) {
	var x e_nocarry_0584
	x.SetRandom()
	benchRese_nocarry_0584.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0584Double(b *testing.B) {
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Double(&benchRese_nocarry_0584)
	}
}

func BenchmarkE_nocarry_0584Add(b *testing.B) {
	var x e_nocarry_0584
	x.SetRandom()
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Add(&x, &benchRese_nocarry_0584)
	}
}

func BenchmarkE_nocarry_0584Sub(b *testing.B) {
	var x e_nocarry_0584
	x.SetRandom()
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Sub(&x, &benchRese_nocarry_0584)
	}
}

func BenchmarkE_nocarry_0584Neg(b *testing.B) {
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Neg(&benchRese_nocarry_0584)
	}
}

func BenchmarkE_nocarry_0584Div(b *testing.B) {
	var x e_nocarry_0584
	x.SetRandom()
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Div(&x, &benchRese_nocarry_0584)
	}
}

func BenchmarkE_nocarry_0584FromMont(b *testing.B) {
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.FromMont()
	}
}

func BenchmarkE_nocarry_0584ToMont(b *testing.B) {
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.ToMont()
	}
}
func BenchmarkE_nocarry_0584Square(b *testing.B) {
	benchRese_nocarry_0584.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Square(&benchRese_nocarry_0584)
	}
}

func BenchmarkE_nocarry_0584Sqrt(b *testing.B) {
	var a e_nocarry_0584
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0584Mul(b *testing.B) {
	x := e_nocarry_0584{
	...
	benchRese_nocarry_0584.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Mul(&benchRese_nocarry_0584, &x)
	}
}

func BenchmarkE_nocarry_0584Cmp(b *testing.B) {
	x := e_nocarry_0584{
		11272679781282814590,
		9868270534640845658,
		16884708718708094739,
	...
	benchRese_nocarry_0584 = x
	benchRese_nocarry_0584[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0584.Cmp(&x)
	}
}

func TestE_nocarry_0584Cmp(t *testing.T) {
	var x, y e_nocarry_0584
...
func TestE_nocarry_0584IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0584
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0584

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0584{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0584
	one.SetOne()
	e.Sub(&qe_nocarry_0584, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0584{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0584{0, uint64(i)})
	}
...
func TestE_nocarry_0584NegZero(t *testing.T) {
	var a, b e_nocarry_0584
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0584Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0584, len(staticTestValues))
...
func TestE_nocarry_0584Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0584) bool {
			var b e_nocarry_0584
...
func TestE_nocarry_0584InverseExp(t *testing.T) {
...
func TestE_nocarry_0584MulByConstants(t *testing.T) {
...
func TestE_nocarry_0584Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0584) bool {
...
func TestE_nocarry_0584LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0584Halve(t *testing.T) {
...
func TestE_nocarry_0584FromMont(t *testing.T) {
...
type testPaire_nocarry_0584 struct {
	element e_nocarry_0584
	bigint  big.Int
}

func (z *e_nocarry_0584) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0584[9] {
		return true
	}
	if z[9] < qe_nocarry_0584[9] {
		return false
	...
	return z[0] >= qe_nocarry_0584[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0584

		g.element = e_nocarry_0584{
		...
		if qe_nocarry_0584[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0584[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0584 {
			var g e_nocarry_0584
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0584[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0584[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0584[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0584[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0584[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0584[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0584[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0584[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0584[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0584[9], carry)
...
func Benchmarke_nocarry_0584InverseNew(b *testing.B) {
	var x e_nocarry_0584
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0584
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0584
		var xInv e_nocarry_0584
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0584
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0584
...
func testLinearComb(t *testing.T, x *e_nocarry_0584, xC int64, y *e_nocarry_0584, yC int64) {
	...
	var z e_nocarry_0584
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0584, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0584
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0584, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0584
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0584, xHi uint64) {
	var res e_nocarry_0584
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0584) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0584) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0584, c int64, result *e_nocarry_0584, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0584) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0584) uint64 {
