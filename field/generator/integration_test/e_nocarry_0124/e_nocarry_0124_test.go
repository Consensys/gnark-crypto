...
var benchRese_nocarry_0124 e_nocarry_0124

func BenchmarkE_nocarry_0124SetBytes(b *testing.B) {
	var x e_nocarry_0124
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0124MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0124.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0124)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0124)
		}
	})
}

func BenchmarkE_nocarry_0124Inverse(b *testing.B) {
	var x e_nocarry_0124
	x.SetRandom()
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0124Butterfly(b *testing.B) {
	var x e_nocarry_0124
	x.SetRandom()
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0124)
	}
}

func BenchmarkE_nocarry_0124Exp(b *testing.B) {
	var x e_nocarry_0124
	x.SetRandom()
	benchRese_nocarry_0124.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0124Double(b *testing.B) {
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Double(&benchRese_nocarry_0124)
	}
}

func BenchmarkE_nocarry_0124Add(b *testing.B) {
	var x e_nocarry_0124
	x.SetRandom()
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Add(&x, &benchRese_nocarry_0124)
	}
}

func BenchmarkE_nocarry_0124Sub(b *testing.B) {
	var x e_nocarry_0124
	x.SetRandom()
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Sub(&x, &benchRese_nocarry_0124)
	}
}

func BenchmarkE_nocarry_0124Neg(b *testing.B) {
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Neg(&benchRese_nocarry_0124)
	}
}

func BenchmarkE_nocarry_0124Div(b *testing.B) {
	var x e_nocarry_0124
	x.SetRandom()
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Div(&x, &benchRese_nocarry_0124)
	}
}

func BenchmarkE_nocarry_0124FromMont(b *testing.B) {
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.FromMont()
	}
}

func BenchmarkE_nocarry_0124ToMont(b *testing.B) {
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.ToMont()
	}
}
func BenchmarkE_nocarry_0124Square(b *testing.B) {
	benchRese_nocarry_0124.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Square(&benchRese_nocarry_0124)
	}
}

func BenchmarkE_nocarry_0124Sqrt(b *testing.B) {
	var a e_nocarry_0124
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0124Mul(b *testing.B) {
	x := e_nocarry_0124{
		1672561119813522066,
		476519238613287490,
	}
	benchRese_nocarry_0124.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Mul(&benchRese_nocarry_0124, &x)
	}
}

func BenchmarkE_nocarry_0124Cmp(b *testing.B) {
	x := e_nocarry_0124{
		1672561119813522066,
		476519238613287490,
	}
	benchRese_nocarry_0124 = x
	benchRese_nocarry_0124[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0124.Cmp(&x)
	}
}

func TestE_nocarry_0124Cmp(t *testing.T) {
	var x, y e_nocarry_0124
...
func TestE_nocarry_0124IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0124
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0124

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0124{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0124
	one.SetOne()
	e.Sub(&qe_nocarry_0124, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0124{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0124{0, uint64(i)})
	}
...
func TestE_nocarry_0124NegZero(t *testing.T) {
	var a, b e_nocarry_0124
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0124Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0124, len(staticTestValues))
...
func TestE_nocarry_0124Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0124) bool {
			var b e_nocarry_0124
...
func TestE_nocarry_0124InverseExp(t *testing.T) {
...
func TestE_nocarry_0124MulByConstants(t *testing.T) {
...
func TestE_nocarry_0124Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0124) bool {
...
func TestE_nocarry_0124LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0124Halve(t *testing.T) {
...
func TestE_nocarry_0124FromMont(t *testing.T) {
...
type testPaire_nocarry_0124 struct {
	element e_nocarry_0124
	bigint  big.Int
}

func (z *e_nocarry_0124) biggerOrEqualModulus() bool {
	if z[1] > qe_nocarry_0124[1] {
		return true
	}
	if z[1] < qe_nocarry_0124[1] {
		return false
	...
	return z[0] >= qe_nocarry_0124[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0124

		g.element = e_nocarry_0124{
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0124[1] != ^uint64(0) {
			g.element[1] %= (qe_nocarry_0124[1] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0124 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0124[0], carry)
		a[1], _ = bits.Add64(a[1], qe_nocarry_0124[1], carry)
...
func Benchmarke_nocarry_0124InverseNew(b *testing.B) {
	var x e_nocarry_0124
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0124
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0124
		var xInv e_nocarry_0124
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0124
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0124
...
func testLinearComb(t *testing.T, x *e_nocarry_0124, xC int64, y *e_nocarry_0124, yC int64) {
	...
	var z e_nocarry_0124
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0124, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0124
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0124, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0124
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0124, xHi uint64) {
	var res e_nocarry_0124
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0124) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0124) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0124, c int64, result *e_nocarry_0124, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0124) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0124) uint64 {
