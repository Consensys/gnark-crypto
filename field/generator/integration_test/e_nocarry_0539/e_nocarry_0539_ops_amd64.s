...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x53acc2dfee1b6a37, R12
	ADDQ R12, AX
	MOVQ $0x0bbc32b80184cbea, R12
	ADCQ R12, DX
	MOVQ $0x3503b61c501a997f, R12
	ADCQ R12, CX
	MOVQ $0x77a559013f4bde84, R12
	ADCQ R12, BX
	MOVQ $0x561f732727114442, R12
	ADCQ R12, SI
	MOVQ $0x64428801b19743df, R12
	ADCQ R12, DI
	MOVQ $0x6f47d4cbaea4760c, R12
	ADCQ R12, R8
	MOVQ $0x6dc5c6c22cd82dea, R12
	ADCQ R12, R9
	MOVQ $0x000000000654bf77, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x53acc2dfee1b6a37, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x0bbc32b80184cbea, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x3503b61c501a997f, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x77a559013f4bde84, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x561f732727114442, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x64428801b19743df, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x6f47d4cbaea4760c, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x6dc5c6c22cd82dea, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000000654bf77, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x53acc2dfee1b6a37, AX
	ADDQ AX, DX
	MOVQ $0x0bbc32b80184cbea, AX
	ADCQ AX, CX
	MOVQ $0x3503b61c501a997f, AX
	ADCQ AX, BX
	MOVQ $0x77a559013f4bde84, AX
	ADCQ AX, SI
	MOVQ $0x561f732727114442, AX
	ADCQ AX, DI
	MOVQ $0x64428801b19743df, AX
	ADCQ AX, R8
	MOVQ $0x6f47d4cbaea4760c, AX
	ADCQ AX, R9
	MOVQ $0x6dc5c6c22cd82dea, AX
	ADCQ AX, R10
	MOVQ $0x000000000654bf77, AX
	ADCQ AX, R11
