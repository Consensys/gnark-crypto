...
var benchRese_nocarry_0539 e_nocarry_0539

func BenchmarkE_nocarry_0539SetBytes(b *testing.B) {
	var x e_nocarry_0539
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0539MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0539.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0539)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0539)
		}
	})
}

func BenchmarkE_nocarry_0539Inverse(b *testing.B) {
	var x e_nocarry_0539
	x.SetRandom()
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0539Butterfly(b *testing.B) {
	var x e_nocarry_0539
	x.SetRandom()
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0539)
	}
}

func BenchmarkE_nocarry_0539Exp(b *testing.B) {
	var x e_nocarry_0539
	x.SetRandom()
	benchRese_nocarry_0539.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0539Double(b *testing.B) {
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Double(&benchRese_nocarry_0539)
	}
}

func BenchmarkE_nocarry_0539Add(b *testing.B) {
	var x e_nocarry_0539
	x.SetRandom()
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Add(&x, &benchRese_nocarry_0539)
	}
}

func BenchmarkE_nocarry_0539Sub(b *testing.B) {
	var x e_nocarry_0539
	x.SetRandom()
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Sub(&x, &benchRese_nocarry_0539)
	}
}

func BenchmarkE_nocarry_0539Neg(b *testing.B) {
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Neg(&benchRese_nocarry_0539)
	}
}

func BenchmarkE_nocarry_0539Div(b *testing.B) {
	var x e_nocarry_0539
	x.SetRandom()
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Div(&x, &benchRese_nocarry_0539)
	}
}

func BenchmarkE_nocarry_0539FromMont(b *testing.B) {
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.FromMont()
	}
}

func BenchmarkE_nocarry_0539ToMont(b *testing.B) {
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.ToMont()
	}
}
func BenchmarkE_nocarry_0539Square(b *testing.B) {
	benchRese_nocarry_0539.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Square(&benchRese_nocarry_0539)
	}
}

func BenchmarkE_nocarry_0539Sqrt(b *testing.B) {
	var a e_nocarry_0539
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0539Mul(b *testing.B) {
	x := e_nocarry_0539{
		2202525357298166386,
		7154643647144384609,
		2808501798465858787,
	...
	benchRese_nocarry_0539.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Mul(&benchRese_nocarry_0539, &x)
	}
}

func BenchmarkE_nocarry_0539Cmp(b *testing.B) {
	x := e_nocarry_0539{
		2202525357298166386,
		7154643647144384609,
		2808501798465858787,
	...
	benchRese_nocarry_0539 = x
	benchRese_nocarry_0539[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0539.Cmp(&x)
	}
}

func TestE_nocarry_0539Cmp(t *testing.T) {
	var x, y e_nocarry_0539
...
func TestE_nocarry_0539IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0539
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0539

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0539{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0539
	one.SetOne()
	e.Sub(&qe_nocarry_0539, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0539{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0539{0, uint64(i)})
	}
...
func TestE_nocarry_0539NegZero(t *testing.T) {
	var a, b e_nocarry_0539
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0539Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0539, len(staticTestValues))
...
func TestE_nocarry_0539Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0539) bool {
			var b e_nocarry_0539
...
func TestE_nocarry_0539InverseExp(t *testing.T) {
...
func TestE_nocarry_0539MulByConstants(t *testing.T) {
...
func TestE_nocarry_0539Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0539) bool {
...
func TestE_nocarry_0539LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0539Halve(t *testing.T) {
...
func TestE_nocarry_0539FromMont(t *testing.T) {
...
type testPaire_nocarry_0539 struct {
	element e_nocarry_0539
	bigint  big.Int
}

func (z *e_nocarry_0539) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0539[8] {
		return true
	}
	if z[8] < qe_nocarry_0539[8] {
		return false
	...
	return z[0] >= qe_nocarry_0539[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0539

		g.element = e_nocarry_0539{
		...
		if qe_nocarry_0539[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0539[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0539 {
			var g e_nocarry_0539
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0539[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0539[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0539[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0539[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0539[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0539[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0539[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0539[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0539[8], carry)
...
func Benchmarke_nocarry_0539InverseNew(b *testing.B) {
	var x e_nocarry_0539
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0539
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0539
		var xInv e_nocarry_0539
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0539
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0539
...
func testLinearComb(t *testing.T, x *e_nocarry_0539, xC int64, y *e_nocarry_0539, yC int64) {
	...
	var z e_nocarry_0539
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0539, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0539
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0539, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0539
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0539, xHi uint64) {
	var res e_nocarry_0539
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0539) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0539) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0539, c int64, result *e_nocarry_0539, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0539) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0539) uint64 {
