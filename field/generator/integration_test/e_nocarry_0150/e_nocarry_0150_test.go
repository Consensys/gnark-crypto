...
var benchRese_nocarry_0150 e_nocarry_0150

func BenchmarkE_nocarry_0150SetBytes(b *testing.B) {
	var x e_nocarry_0150
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0150MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0150.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0150)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0150)
		}
	})
}

func BenchmarkE_nocarry_0150Inverse(b *testing.B) {
	var x e_nocarry_0150
	x.SetRandom()
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0150Butterfly(b *testing.B) {
	var x e_nocarry_0150
	x.SetRandom()
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0150)
	}
}

func BenchmarkE_nocarry_0150Exp(b *testing.B) {
	var x e_nocarry_0150
	x.SetRandom()
	benchRese_nocarry_0150.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0150Double(b *testing.B) {
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Double(&benchRese_nocarry_0150)
	}
}

func BenchmarkE_nocarry_0150Add(b *testing.B) {
	var x e_nocarry_0150
	x.SetRandom()
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Add(&x, &benchRese_nocarry_0150)
	}
}

func BenchmarkE_nocarry_0150Sub(b *testing.B) {
	var x e_nocarry_0150
	x.SetRandom()
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Sub(&x, &benchRese_nocarry_0150)
	}
}

func BenchmarkE_nocarry_0150Neg(b *testing.B) {
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Neg(&benchRese_nocarry_0150)
	}
}

func BenchmarkE_nocarry_0150Div(b *testing.B) {
	var x e_nocarry_0150
	x.SetRandom()
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Div(&x, &benchRese_nocarry_0150)
	}
}

func BenchmarkE_nocarry_0150FromMont(b *testing.B) {
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.FromMont()
	}
}

func BenchmarkE_nocarry_0150ToMont(b *testing.B) {
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.ToMont()
	}
}
func BenchmarkE_nocarry_0150Square(b *testing.B) {
	benchRese_nocarry_0150.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Square(&benchRese_nocarry_0150)
	}
}

func BenchmarkE_nocarry_0150Sqrt(b *testing.B) {
	var a e_nocarry_0150
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0150Mul(b *testing.B) {
	x := e_nocarry_0150{
		956494455185071210,
		6854514793720870926,
		4082096,
	}
	benchRese_nocarry_0150.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Mul(&benchRese_nocarry_0150, &x)
	}
}

func BenchmarkE_nocarry_0150Cmp(b *testing.B) {
	x := e_nocarry_0150{
		956494455185071210,
		6854514793720870926,
		4082096,
	}
	benchRese_nocarry_0150 = x
	benchRese_nocarry_0150[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0150.Cmp(&x)
	}
}

func TestE_nocarry_0150Cmp(t *testing.T) {
	var x, y e_nocarry_0150
...
func TestE_nocarry_0150IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0150
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0150

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0150{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0150
	one.SetOne()
	e.Sub(&qe_nocarry_0150, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0150{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0150{0, uint64(i)})
	}
...
func TestE_nocarry_0150NegZero(t *testing.T) {
	var a, b e_nocarry_0150
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0150Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0150, len(staticTestValues))
...
func TestE_nocarry_0150Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0150) bool {
			var b e_nocarry_0150
...
func TestE_nocarry_0150InverseExp(t *testing.T) {
...
func TestE_nocarry_0150MulByConstants(t *testing.T) {
...
func TestE_nocarry_0150Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0150) bool {
...
func TestE_nocarry_0150LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0150Halve(t *testing.T) {
...
func TestE_nocarry_0150FromMont(t *testing.T) {
...
type testPaire_nocarry_0150 struct {
	element e_nocarry_0150
	bigint  big.Int
}

func (z *e_nocarry_0150) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0150[2] {
		return true
	}
	if z[2] < qe_nocarry_0150[2] {
		return false
	...
	return z[0] >= qe_nocarry_0150[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0150

		g.element = e_nocarry_0150{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0150[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0150[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0150 {
			var g e_nocarry_0150
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0150[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0150[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0150[2], carry)
...
func Benchmarke_nocarry_0150InverseNew(b *testing.B) {
	var x e_nocarry_0150
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0150
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0150
		var xInv e_nocarry_0150
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0150
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0150
...
func testLinearComb(t *testing.T, x *e_nocarry_0150, xC int64, y *e_nocarry_0150, yC int64) {
	...
	var z e_nocarry_0150
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0150, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0150
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0150, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0150
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0150, xHi uint64) {
	var res e_nocarry_0150
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0150) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0150) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0150, c int64, result *e_nocarry_0150, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0150) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0150) uint64 {
