...
var benchRese_nocarry_0226 e_nocarry_0226

func BenchmarkE_nocarry_0226SetBytes(b *testing.B) {
	var x e_nocarry_0226
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0226MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0226.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0226)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0226)
		}
	})
}

func BenchmarkE_nocarry_0226Inverse(b *testing.B) {
	var x e_nocarry_0226
	x.SetRandom()
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0226Butterfly(b *testing.B) {
	var x e_nocarry_0226
	x.SetRandom()
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0226)
	}
}

func BenchmarkE_nocarry_0226Exp(b *testing.B) {
	var x e_nocarry_0226
	x.SetRandom()
	benchRese_nocarry_0226.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0226Double(b *testing.B) {
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Double(&benchRese_nocarry_0226)
	}
}

func BenchmarkE_nocarry_0226Add(b *testing.B) {
	var x e_nocarry_0226
	x.SetRandom()
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Add(&x, &benchRese_nocarry_0226)
	}
}

func BenchmarkE_nocarry_0226Sub(b *testing.B) {
	var x e_nocarry_0226
	x.SetRandom()
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Sub(&x, &benchRese_nocarry_0226)
	}
}

func BenchmarkE_nocarry_0226Neg(b *testing.B) {
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Neg(&benchRese_nocarry_0226)
	}
}

func BenchmarkE_nocarry_0226Div(b *testing.B) {
	var x e_nocarry_0226
	x.SetRandom()
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Div(&x, &benchRese_nocarry_0226)
	}
}

func BenchmarkE_nocarry_0226FromMont(b *testing.B) {
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.FromMont()
	}
}

func BenchmarkE_nocarry_0226ToMont(b *testing.B) {
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.ToMont()
	}
}
func BenchmarkE_nocarry_0226Square(b *testing.B) {
	benchRese_nocarry_0226.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Square(&benchRese_nocarry_0226)
	}
}

func BenchmarkE_nocarry_0226Sqrt(b *testing.B) {
	var a e_nocarry_0226
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0226Mul(b *testing.B) {
	x := e_nocarry_0226{
	...
	benchRese_nocarry_0226.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Mul(&benchRese_nocarry_0226, &x)
	}
}

func BenchmarkE_nocarry_0226Cmp(b *testing.B) {
	x := e_nocarry_0226{
		11451885894473924098,
		5512886101791958418,
		12858541111872736143,
	...
	benchRese_nocarry_0226 = x
	benchRese_nocarry_0226[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0226.Cmp(&x)
	}
}

func TestE_nocarry_0226Cmp(t *testing.T) {
	var x, y e_nocarry_0226
...
func TestE_nocarry_0226IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0226
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0226

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0226{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0226
	one.SetOne()
	e.Sub(&qe_nocarry_0226, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0226{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0226{0, uint64(i)})
	}
...
func TestE_nocarry_0226NegZero(t *testing.T) {
	var a, b e_nocarry_0226
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0226Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0226, len(staticTestValues))
...
func TestE_nocarry_0226Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0226) bool {
			var b e_nocarry_0226
...
func TestE_nocarry_0226InverseExp(t *testing.T) {
...
func TestE_nocarry_0226MulByConstants(t *testing.T) {
...
func TestE_nocarry_0226Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0226) bool {
...
func TestE_nocarry_0226LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0226Halve(t *testing.T) {
...
func TestE_nocarry_0226FromMont(t *testing.T) {
...
type testPaire_nocarry_0226 struct {
	element e_nocarry_0226
	bigint  big.Int
}

func (z *e_nocarry_0226) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0226[3] {
		return true
	}
	if z[3] < qe_nocarry_0226[3] {
		return false
	...
	return z[0] >= qe_nocarry_0226[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0226

		g.element = e_nocarry_0226{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0226[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0226[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0226 {
			var g e_nocarry_0226
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0226[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0226[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0226[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0226[3], carry)
...
func Benchmarke_nocarry_0226InverseNew(b *testing.B) {
	var x e_nocarry_0226
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0226
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0226
		var xInv e_nocarry_0226
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0226
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0226
...
func testLinearComb(t *testing.T, x *e_nocarry_0226, xC int64, y *e_nocarry_0226, yC int64) {
	...
	var z e_nocarry_0226
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0226, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0226
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0226, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0226
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0226, xHi uint64) {
	var res e_nocarry_0226
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0226) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0226) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0226, c int64, result *e_nocarry_0226, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0226) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0226) uint64 {
