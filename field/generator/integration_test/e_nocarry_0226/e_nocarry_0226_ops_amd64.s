...
// modulus q
DATA q<>+0(SB)/8, $0x901bcbe2f33c4e3f
DATA q<>+8(SB)/8, $0xa1b898b9c75e5ecc
DATA q<>+16(SB)/8, $0x12905ce2327a5eac
DATA q<>+24(SB)/8, $0x000000035f8d12c2
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x66699378b3cb5e41
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x901bcbe2f33c4e3f, R8
	MOVQ    $0xa1b898b9c75e5ecc, R9
	MOVQ    $0x12905ce2327a5eac, R10
	MOVQ    $0x000000035f8d12c2, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xa1b898b9c75e5ecc, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x12905ce2327a5eac, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x000000035f8d12c2, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x901bcbe2f33c4e3f, R12
	MOVQ    $0xa1b898b9c75e5ecc, R13
	MOVQ    $0x12905ce2327a5eac, R14
	MOVQ    $0x000000035f8d12c2, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
