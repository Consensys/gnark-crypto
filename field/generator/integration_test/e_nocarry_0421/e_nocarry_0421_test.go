...
var benchRese_nocarry_0421 e_nocarry_0421

func BenchmarkE_nocarry_0421SetBytes(b *testing.B) {
	var x e_nocarry_0421
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0421MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0421.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0421)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0421)
		}
	})
}

func BenchmarkE_nocarry_0421Inverse(b *testing.B) {
	var x e_nocarry_0421
	x.SetRandom()
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0421Butterfly(b *testing.B) {
	var x e_nocarry_0421
	x.SetRandom()
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0421)
	}
}

func BenchmarkE_nocarry_0421Exp(b *testing.B) {
	var x e_nocarry_0421
	x.SetRandom()
	benchRese_nocarry_0421.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0421Double(b *testing.B) {
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Double(&benchRese_nocarry_0421)
	}
}

func BenchmarkE_nocarry_0421Add(b *testing.B) {
	var x e_nocarry_0421
	x.SetRandom()
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Add(&x, &benchRese_nocarry_0421)
	}
}

func BenchmarkE_nocarry_0421Sub(b *testing.B) {
	var x e_nocarry_0421
	x.SetRandom()
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Sub(&x, &benchRese_nocarry_0421)
	}
}

func BenchmarkE_nocarry_0421Neg(b *testing.B) {
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Neg(&benchRese_nocarry_0421)
	}
}

func BenchmarkE_nocarry_0421Div(b *testing.B) {
	var x e_nocarry_0421
	x.SetRandom()
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Div(&x, &benchRese_nocarry_0421)
	}
}

func BenchmarkE_nocarry_0421FromMont(b *testing.B) {
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.FromMont()
	}
}

func BenchmarkE_nocarry_0421ToMont(b *testing.B) {
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.ToMont()
	}
}
func BenchmarkE_nocarry_0421Square(b *testing.B) {
	benchRese_nocarry_0421.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Square(&benchRese_nocarry_0421)
	}
}

func BenchmarkE_nocarry_0421Sqrt(b *testing.B) {
	var a e_nocarry_0421
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0421Mul(b *testing.B) {
	x := e_nocarry_0421{
		312301987741352423,
	...
	benchRese_nocarry_0421.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Mul(&benchRese_nocarry_0421, &x)
	}
}

func BenchmarkE_nocarry_0421Cmp(b *testing.B) {
	x := e_nocarry_0421{
		312301987741352423,
		10484473850334419067,
		6687033895340019780,
	...
	benchRese_nocarry_0421 = x
	benchRese_nocarry_0421[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0421.Cmp(&x)
	}
}

func TestE_nocarry_0421Cmp(t *testing.T) {
	var x, y e_nocarry_0421
...
func TestE_nocarry_0421IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0421
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0421

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0421{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0421
	one.SetOne()
	e.Sub(&qe_nocarry_0421, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0421{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0421{0, uint64(i)})
	}
...
func TestE_nocarry_0421NegZero(t *testing.T) {
	var a, b e_nocarry_0421
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0421Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0421, len(staticTestValues))
...
func TestE_nocarry_0421Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0421) bool {
			var b e_nocarry_0421
...
func TestE_nocarry_0421InverseExp(t *testing.T) {
...
func TestE_nocarry_0421MulByConstants(t *testing.T) {
...
func TestE_nocarry_0421Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0421) bool {
...
func TestE_nocarry_0421LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0421Halve(t *testing.T) {
...
func TestE_nocarry_0421FromMont(t *testing.T) {
...
type testPaire_nocarry_0421 struct {
	element e_nocarry_0421
	bigint  big.Int
}

func (z *e_nocarry_0421) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0421[6] {
		return true
	}
	if z[6] < qe_nocarry_0421[6] {
		return false
	...
	return z[0] >= qe_nocarry_0421[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0421

		g.element = e_nocarry_0421{
		...
		if qe_nocarry_0421[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0421[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0421 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0421[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0421[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0421[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0421[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0421[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0421[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0421[6], carry)
...
func Benchmarke_nocarry_0421InverseNew(b *testing.B) {
	var x e_nocarry_0421
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0421
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0421
		var xInv e_nocarry_0421
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0421
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0421
...
func testLinearComb(t *testing.T, x *e_nocarry_0421, xC int64, y *e_nocarry_0421, yC int64) {
	...
	var z e_nocarry_0421
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0421, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0421
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0421, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0421
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0421, xHi uint64) {
	var res e_nocarry_0421
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0421) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0421) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0421, c int64, result *e_nocarry_0421, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0421) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0421) uint64 {
