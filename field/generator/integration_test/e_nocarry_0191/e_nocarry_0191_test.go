...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0191{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0191{0, uint64(i)})
	}
...
func (z *e_nocarry_0191) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0191[2] {
		return true
	}
	if z[2] < qe_nocarry_0191[2] {
		return false
...
func Benchmarke_nocarry_0191InverseNew(b *testing.B) {
	var x e_nocarry_0191
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0191, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0191, xHi uint64) {
