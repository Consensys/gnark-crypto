...
var benchRese_nocarry_0596 e_nocarry_0596

func BenchmarkE_nocarry_0596SetBytes(b *testing.B) {
	var x e_nocarry_0596
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0596MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0596.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0596)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0596)
		}
	})
}

func BenchmarkE_nocarry_0596Inverse(b *testing.B) {
	var x e_nocarry_0596
	x.SetRandom()
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0596Butterfly(b *testing.B) {
	var x e_nocarry_0596
	x.SetRandom()
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0596)
	}
}

func BenchmarkE_nocarry_0596Exp(b *testing.B) {
	var x e_nocarry_0596
	x.SetRandom()
	benchRese_nocarry_0596.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0596Double(b *testing.B) {
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Double(&benchRese_nocarry_0596)
	}
}

func BenchmarkE_nocarry_0596Add(b *testing.B) {
	var x e_nocarry_0596
	x.SetRandom()
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Add(&x, &benchRese_nocarry_0596)
	}
}

func BenchmarkE_nocarry_0596Sub(b *testing.B) {
	var x e_nocarry_0596
	x.SetRandom()
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Sub(&x, &benchRese_nocarry_0596)
	}
}

func BenchmarkE_nocarry_0596Neg(b *testing.B) {
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Neg(&benchRese_nocarry_0596)
	}
}

func BenchmarkE_nocarry_0596Div(b *testing.B) {
	var x e_nocarry_0596
	x.SetRandom()
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Div(&x, &benchRese_nocarry_0596)
	}
}

func BenchmarkE_nocarry_0596FromMont(b *testing.B) {
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.FromMont()
	}
}

func BenchmarkE_nocarry_0596ToMont(b *testing.B) {
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.ToMont()
	}
}
func BenchmarkE_nocarry_0596Square(b *testing.B) {
	benchRese_nocarry_0596.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Square(&benchRese_nocarry_0596)
	}
}

func BenchmarkE_nocarry_0596Sqrt(b *testing.B) {
	var a e_nocarry_0596
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0596Mul(b *testing.B) {
	x := e_nocarry_0596{
	...
	benchRese_nocarry_0596.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Mul(&benchRese_nocarry_0596, &x)
	}
}

func BenchmarkE_nocarry_0596Cmp(b *testing.B) {
	x := e_nocarry_0596{
		18053151636412859946,
		16718489655128742140,
		888031227085196127,
	...
	benchRese_nocarry_0596 = x
	benchRese_nocarry_0596[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0596.Cmp(&x)
	}
}

func TestE_nocarry_0596Cmp(t *testing.T) {
	var x, y e_nocarry_0596
...
func TestE_nocarry_0596IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0596
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0596

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0596{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0596
	one.SetOne()
	e.Sub(&qe_nocarry_0596, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0596{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0596{0, uint64(i)})
	}
...
func TestE_nocarry_0596NegZero(t *testing.T) {
	var a, b e_nocarry_0596
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0596Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0596, len(staticTestValues))
...
func TestE_nocarry_0596Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0596) bool {
			var b e_nocarry_0596
...
func TestE_nocarry_0596InverseExp(t *testing.T) {
...
func TestE_nocarry_0596MulByConstants(t *testing.T) {
...
func TestE_nocarry_0596Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0596) bool {
...
func TestE_nocarry_0596LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0596Halve(t *testing.T) {
...
func TestE_nocarry_0596FromMont(t *testing.T) {
...
type testPaire_nocarry_0596 struct {
	element e_nocarry_0596
	bigint  big.Int
}

func (z *e_nocarry_0596) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0596[9] {
		return true
	}
	if z[9] < qe_nocarry_0596[9] {
		return false
	...
	return z[0] >= qe_nocarry_0596[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0596

		g.element = e_nocarry_0596{
		...
		if qe_nocarry_0596[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0596[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0596 {
			var g e_nocarry_0596
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0596[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0596[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0596[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0596[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0596[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0596[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0596[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0596[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0596[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0596[9], carry)
...
func Benchmarke_nocarry_0596InverseNew(b *testing.B) {
	var x e_nocarry_0596
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0596
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0596
		var xInv e_nocarry_0596
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0596
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0596
...
func testLinearComb(t *testing.T, x *e_nocarry_0596, xC int64, y *e_nocarry_0596, yC int64) {
	...
	var z e_nocarry_0596
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0596, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0596
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0596, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0596
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0596, xHi uint64) {
	var res e_nocarry_0596
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0596) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0596) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0596, c int64, result *e_nocarry_0596, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0596) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0596) uint64 {
