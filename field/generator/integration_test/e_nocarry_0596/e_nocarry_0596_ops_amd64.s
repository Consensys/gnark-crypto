...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xd8194413f5affc3b, R13
	ADDQ R13, AX
	MOVQ $0xcff9ca941e26d3d7, R13
	ADCQ R13, DX
	MOVQ $0xb63d73f6117f5082, R13
	ADCQ R13, CX
	MOVQ $0x852177d37ee4f9e4, R13
	ADCQ R13, BX
	MOVQ $0xa8a75ea20c1130c1, R13
	ADCQ R13, SI
	MOVQ $0x6d860a10313e60c5, R13
	ADCQ R13, DI
	MOVQ $0xa8ee5999b9500afb, R13
	ADCQ R13, R8
	MOVQ $0x7b685a945077c27c, R13
	ADCQ R13, R9
	MOVQ $0x88cef386a5233255, R13
	ADCQ R13, R10
	MOVQ $0x00000000000c23bc, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xd8194413f5affc3b, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xcff9ca941e26d3d7, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xb63d73f6117f5082, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x852177d37ee4f9e4, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xa8a75ea20c1130c1, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x6d860a10313e60c5, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xa8ee5999b9500afb, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x7b685a945077c27c, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x88cef386a5233255, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000000c23bc, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xd8194413f5affc3b, AX
	ADDQ AX, DX
	MOVQ $0xcff9ca941e26d3d7, AX
	ADCQ AX, CX
	MOVQ $0xb63d73f6117f5082, AX
	ADCQ AX, BX
	MOVQ $0x852177d37ee4f9e4, AX
	ADCQ AX, SI
	MOVQ $0xa8a75ea20c1130c1, AX
	ADCQ AX, DI
	MOVQ $0x6d860a10313e60c5, AX
	ADCQ AX, R8
	MOVQ $0xa8ee5999b9500afb, AX
	ADCQ AX, R9
	MOVQ $0x7b685a945077c27c, AX
	ADCQ AX, R10
	MOVQ $0x88cef386a5233255, AX
	ADCQ AX, R11
	MOVQ $0x00000000000c23bc, AX
	ADCQ AX, R12
