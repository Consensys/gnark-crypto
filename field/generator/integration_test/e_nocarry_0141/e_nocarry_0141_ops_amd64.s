...
// modulus q
DATA q<>+0(SB)/8, $0xa5a06909dae8329b
DATA q<>+8(SB)/8, $0xb35261c0286f23eb
DATA q<>+16(SB)/8, $0x0000000000001f5a
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xbf09df6933a49c6d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xa5a06909dae8329b, DI
	MOVQ    $0xb35261c0286f23eb, R8
	MOVQ    $0x0000000000001f5a, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xb35261c0286f23eb, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x0000000000001f5a, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xa5a06909dae8329b, R10
	MOVQ    $0xb35261c0286f23eb, R11
	MOVQ    $0x0000000000001f5a, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
