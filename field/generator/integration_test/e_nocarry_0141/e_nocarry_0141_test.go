...
var benchRese_nocarry_0141 e_nocarry_0141

func BenchmarkE_nocarry_0141SetBytes(b *testing.B) {
	var x e_nocarry_0141
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0141MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0141.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0141)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0141)
		}
	})
}

func BenchmarkE_nocarry_0141Inverse(b *testing.B) {
	var x e_nocarry_0141
	x.SetRandom()
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0141Butterfly(b *testing.B) {
	var x e_nocarry_0141
	x.SetRandom()
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0141)
	}
}

func BenchmarkE_nocarry_0141Exp(b *testing.B) {
	var x e_nocarry_0141
	x.SetRandom()
	benchRese_nocarry_0141.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0141Double(b *testing.B) {
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Double(&benchRese_nocarry_0141)
	}
}

func BenchmarkE_nocarry_0141Add(b *testing.B) {
	var x e_nocarry_0141
	x.SetRandom()
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Add(&x, &benchRese_nocarry_0141)
	}
}

func BenchmarkE_nocarry_0141Sub(b *testing.B) {
	var x e_nocarry_0141
	x.SetRandom()
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Sub(&x, &benchRese_nocarry_0141)
	}
}

func BenchmarkE_nocarry_0141Neg(b *testing.B) {
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Neg(&benchRese_nocarry_0141)
	}
}

func BenchmarkE_nocarry_0141Div(b *testing.B) {
	var x e_nocarry_0141
	x.SetRandom()
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Div(&x, &benchRese_nocarry_0141)
	}
}

func BenchmarkE_nocarry_0141FromMont(b *testing.B) {
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.FromMont()
	}
}

func BenchmarkE_nocarry_0141ToMont(b *testing.B) {
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.ToMont()
	}
}
func BenchmarkE_nocarry_0141Square(b *testing.B) {
	benchRese_nocarry_0141.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Square(&benchRese_nocarry_0141)
	}
}

func BenchmarkE_nocarry_0141Sqrt(b *testing.B) {
	var a e_nocarry_0141
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0141Mul(b *testing.B) {
	x := e_nocarry_0141{
		5320041903834558104,
		7398226237180981506,
		618,
	}
	benchRese_nocarry_0141.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Mul(&benchRese_nocarry_0141, &x)
	}
}

func BenchmarkE_nocarry_0141Cmp(b *testing.B) {
	x := e_nocarry_0141{
		5320041903834558104,
		7398226237180981506,
		618,
	}
	benchRese_nocarry_0141 = x
	benchRese_nocarry_0141[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0141.Cmp(&x)
	}
}

func TestE_nocarry_0141Cmp(t *testing.T) {
	var x, y e_nocarry_0141
...
func TestE_nocarry_0141IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0141
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0141

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0141{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0141
	one.SetOne()
	e.Sub(&qe_nocarry_0141, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0141{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0141{0, uint64(i)})
	}
...
func TestE_nocarry_0141NegZero(t *testing.T) {
	var a, b e_nocarry_0141
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0141Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0141, len(staticTestValues))
...
func TestE_nocarry_0141Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0141) bool {
			var b e_nocarry_0141
...
func TestE_nocarry_0141InverseExp(t *testing.T) {
...
func TestE_nocarry_0141MulByConstants(t *testing.T) {
...
func TestE_nocarry_0141Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0141) bool {
...
func TestE_nocarry_0141LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0141Halve(t *testing.T) {
...
func TestE_nocarry_0141FromMont(t *testing.T) {
...
type testPaire_nocarry_0141 struct {
	element e_nocarry_0141
	bigint  big.Int
}

func (z *e_nocarry_0141) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0141[2] {
		return true
	}
	if z[2] < qe_nocarry_0141[2] {
		return false
	...
	return z[0] >= qe_nocarry_0141[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0141

		g.element = e_nocarry_0141{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0141[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0141[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0141 {
			var g e_nocarry_0141
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0141[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0141[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0141[2], carry)
...
func Benchmarke_nocarry_0141InverseNew(b *testing.B) {
	var x e_nocarry_0141
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0141
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0141
		var xInv e_nocarry_0141
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0141
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0141
...
func testLinearComb(t *testing.T, x *e_nocarry_0141, xC int64, y *e_nocarry_0141, yC int64) {
	...
	var z e_nocarry_0141
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0141, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0141
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0141, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0141
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0141, xHi uint64) {
	var res e_nocarry_0141
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0141) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0141) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0141, c int64, result *e_nocarry_0141, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0141) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0141) uint64 {
