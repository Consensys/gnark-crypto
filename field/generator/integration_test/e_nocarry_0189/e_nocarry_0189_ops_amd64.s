...
// modulus q
DATA q<>+0(SB)/8, $0x30de6bd237493f59
DATA q<>+8(SB)/8, $0xe1cfd53830bdbb3f
DATA q<>+16(SB)/8, $0x1881b565fb9bab84
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x35bcb65bdc12e717
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x30de6bd237493f59, DI
	MOVQ    $0xe1cfd53830bdbb3f, R8
	MOVQ    $0x1881b565fb9bab84, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xe1cfd53830bdbb3f, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x1881b565fb9bab84, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x30de6bd237493f59, R10
	MOVQ    $0xe1cfd53830bdbb3f, R11
	MOVQ    $0x1881b565fb9bab84, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
