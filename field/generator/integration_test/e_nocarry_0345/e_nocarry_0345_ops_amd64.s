...
// modulus q
DATA q<>+0(SB)/8, $0x9bc9a40889d938d5
DATA q<>+8(SB)/8, $0x7de4e13be3937752
DATA q<>+16(SB)/8, $0xd03f9714cd69e38c
DATA q<>+24(SB)/8, $0xaae3ca0eb936bd2c
DATA q<>+32(SB)/8, $0x4cbffdc60f06e87c
DATA q<>+40(SB)/8, $0x0000000001828d5e
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xce1843a74b2dbf83
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x9bc9a40889d938d5, R10
	MOVQ    $0x7de4e13be3937752, R11
	MOVQ    $0xd03f9714cd69e38c, R12
	MOVQ    $0xaae3ca0eb936bd2c, R13
	MOVQ    $0x4cbffdc60f06e87c, R14
	MOVQ    $0x0000000001828d5e, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x7de4e13be3937752, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xd03f9714cd69e38c, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xaae3ca0eb936bd2c, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x4cbffdc60f06e87c, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000001828d5e, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x9bc9a40889d938d5, CX
	MOVQ    $0x7de4e13be3937752, BX
	MOVQ    $0xd03f9714cd69e38c, SI
	MOVQ    $0xaae3ca0eb936bd2c, DI
	MOVQ    $0x4cbffdc60f06e87c, R8
	MOVQ    $0x0000000001828d5e, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
