...
var benchRese_nocarry_0345 e_nocarry_0345

func BenchmarkE_nocarry_0345SetBytes(b *testing.B) {
	var x e_nocarry_0345
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0345MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0345.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0345)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0345)
		}
	})
}

func BenchmarkE_nocarry_0345Inverse(b *testing.B) {
	var x e_nocarry_0345
	x.SetRandom()
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0345Butterfly(b *testing.B) {
	var x e_nocarry_0345
	x.SetRandom()
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0345)
	}
}

func BenchmarkE_nocarry_0345Exp(b *testing.B) {
	var x e_nocarry_0345
	x.SetRandom()
	benchRese_nocarry_0345.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0345Double(b *testing.B) {
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Double(&benchRese_nocarry_0345)
	}
}

func BenchmarkE_nocarry_0345Add(b *testing.B) {
	var x e_nocarry_0345
	x.SetRandom()
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Add(&x, &benchRese_nocarry_0345)
	}
}

func BenchmarkE_nocarry_0345Sub(b *testing.B) {
	var x e_nocarry_0345
	x.SetRandom()
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Sub(&x, &benchRese_nocarry_0345)
	}
}

func BenchmarkE_nocarry_0345Neg(b *testing.B) {
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Neg(&benchRese_nocarry_0345)
	}
}

func BenchmarkE_nocarry_0345Div(b *testing.B) {
	var x e_nocarry_0345
	x.SetRandom()
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Div(&x, &benchRese_nocarry_0345)
	}
}

func BenchmarkE_nocarry_0345FromMont(b *testing.B) {
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.FromMont()
	}
}

func BenchmarkE_nocarry_0345ToMont(b *testing.B) {
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.ToMont()
	}
}
func BenchmarkE_nocarry_0345Square(b *testing.B) {
	benchRese_nocarry_0345.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Square(&benchRese_nocarry_0345)
	}
}

func BenchmarkE_nocarry_0345Sqrt(b *testing.B) {
	var a e_nocarry_0345
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0345Mul(b *testing.B) {
	x := e_nocarry_0345{
	...
	benchRese_nocarry_0345.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Mul(&benchRese_nocarry_0345, &x)
	}
}

func BenchmarkE_nocarry_0345Cmp(b *testing.B) {
	x := e_nocarry_0345{
		10975541183320830242,
		3297492558395099556,
		8870311371857964371,
	...
	benchRese_nocarry_0345 = x
	benchRese_nocarry_0345[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0345.Cmp(&x)
	}
}

func TestE_nocarry_0345Cmp(t *testing.T) {
	var x, y e_nocarry_0345
...
func TestE_nocarry_0345IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0345
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0345

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0345{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0345
	one.SetOne()
	e.Sub(&qe_nocarry_0345, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0345{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0345{0, uint64(i)})
	}
...
func TestE_nocarry_0345NegZero(t *testing.T) {
	var a, b e_nocarry_0345
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0345Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0345, len(staticTestValues))
...
func TestE_nocarry_0345Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0345) bool {
			var b e_nocarry_0345
...
func TestE_nocarry_0345InverseExp(t *testing.T) {
...
func TestE_nocarry_0345MulByConstants(t *testing.T) {
...
func TestE_nocarry_0345Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0345) bool {
...
func TestE_nocarry_0345LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0345Halve(t *testing.T) {
...
func TestE_nocarry_0345FromMont(t *testing.T) {
...
type testPaire_nocarry_0345 struct {
	element e_nocarry_0345
	bigint  big.Int
}

func (z *e_nocarry_0345) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0345[5] {
		return true
	}
	if z[5] < qe_nocarry_0345[5] {
		return false
	...
	return z[0] >= qe_nocarry_0345[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0345

		g.element = e_nocarry_0345{
		...
		if qe_nocarry_0345[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0345[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0345 {
			var g e_nocarry_0345
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0345[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0345[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0345[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0345[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0345[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0345[5], carry)
...
func Benchmarke_nocarry_0345InverseNew(b *testing.B) {
	var x e_nocarry_0345
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0345
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0345
		var xInv e_nocarry_0345
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0345
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0345
...
func testLinearComb(t *testing.T, x *e_nocarry_0345, xC int64, y *e_nocarry_0345, yC int64) {
	...
	var z e_nocarry_0345
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0345, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0345
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0345, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0345
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0345, xHi uint64) {
	var res e_nocarry_0345
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0345) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0345) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0345, c int64, result *e_nocarry_0345, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0345) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0345) uint64 {
