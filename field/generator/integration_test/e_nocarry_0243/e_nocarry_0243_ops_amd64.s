...
// modulus q
DATA q<>+0(SB)/8, $0x339ba88fb623aff3
DATA q<>+8(SB)/8, $0x7138250a3b1d168e
DATA q<>+16(SB)/8, $0x1546cba7a2f6e98d
DATA q<>+24(SB)/8, $0x00072602b87103bb
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x2ca3d14f0e507ec5
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x339ba88fb623aff3, R8
	MOVQ    $0x7138250a3b1d168e, R9
	MOVQ    $0x1546cba7a2f6e98d, R10
	MOVQ    $0x00072602b87103bb, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x7138250a3b1d168e, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x1546cba7a2f6e98d, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00072602b87103bb, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x339ba88fb623aff3, R12
	MOVQ    $0x7138250a3b1d168e, R13
	MOVQ    $0x1546cba7a2f6e98d, R14
	MOVQ    $0x00072602b87103bb, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
