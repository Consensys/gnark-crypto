...
var benchRese_nocarry_0243 e_nocarry_0243

func BenchmarkE_nocarry_0243SetBytes(b *testing.B) {
	var x e_nocarry_0243
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0243MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0243.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0243)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0243)
		}
	})
}

func BenchmarkE_nocarry_0243Inverse(b *testing.B) {
	var x e_nocarry_0243
	x.SetRandom()
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0243Butterfly(b *testing.B) {
	var x e_nocarry_0243
	x.SetRandom()
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0243)
	}
}

func BenchmarkE_nocarry_0243Exp(b *testing.B) {
	var x e_nocarry_0243
	x.SetRandom()
	benchRese_nocarry_0243.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0243Double(b *testing.B) {
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Double(&benchRese_nocarry_0243)
	}
}

func BenchmarkE_nocarry_0243Add(b *testing.B) {
	var x e_nocarry_0243
	x.SetRandom()
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Add(&x, &benchRese_nocarry_0243)
	}
}

func BenchmarkE_nocarry_0243Sub(b *testing.B) {
	var x e_nocarry_0243
	x.SetRandom()
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Sub(&x, &benchRese_nocarry_0243)
	}
}

func BenchmarkE_nocarry_0243Neg(b *testing.B) {
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Neg(&benchRese_nocarry_0243)
	}
}

func BenchmarkE_nocarry_0243Div(b *testing.B) {
	var x e_nocarry_0243
	x.SetRandom()
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Div(&x, &benchRese_nocarry_0243)
	}
}

func BenchmarkE_nocarry_0243FromMont(b *testing.B) {
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.FromMont()
	}
}

func BenchmarkE_nocarry_0243ToMont(b *testing.B) {
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.ToMont()
	}
}
func BenchmarkE_nocarry_0243Square(b *testing.B) {
	benchRese_nocarry_0243.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Square(&benchRese_nocarry_0243)
	}
}

func BenchmarkE_nocarry_0243Sqrt(b *testing.B) {
	var a e_nocarry_0243
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0243Mul(b *testing.B) {
	x := e_nocarry_0243{
	...
	benchRese_nocarry_0243.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Mul(&benchRese_nocarry_0243, &x)
	}
}

func BenchmarkE_nocarry_0243Cmp(b *testing.B) {
	x := e_nocarry_0243{
		10418630980406692095,
		17648940847476021844,
		14680716194456396992,
	...
	benchRese_nocarry_0243 = x
	benchRese_nocarry_0243[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0243.Cmp(&x)
	}
}

func TestE_nocarry_0243Cmp(t *testing.T) {
	var x, y e_nocarry_0243
...
func TestE_nocarry_0243IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0243
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0243

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0243{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0243
	one.SetOne()
	e.Sub(&qe_nocarry_0243, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0243{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0243{0, uint64(i)})
	}
...
func TestE_nocarry_0243NegZero(t *testing.T) {
	var a, b e_nocarry_0243
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0243Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0243, len(staticTestValues))
...
func TestE_nocarry_0243Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0243) bool {
			var b e_nocarry_0243
...
func TestE_nocarry_0243InverseExp(t *testing.T) {
...
func TestE_nocarry_0243MulByConstants(t *testing.T) {
...
func TestE_nocarry_0243Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0243) bool {
...
func TestE_nocarry_0243LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0243Halve(t *testing.T) {
...
func TestE_nocarry_0243FromMont(t *testing.T) {
...
type testPaire_nocarry_0243 struct {
	element e_nocarry_0243
	bigint  big.Int
}

func (z *e_nocarry_0243) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0243[3] {
		return true
	}
	if z[3] < qe_nocarry_0243[3] {
		return false
	...
	return z[0] >= qe_nocarry_0243[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0243

		g.element = e_nocarry_0243{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0243[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0243[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0243 {
			var g e_nocarry_0243
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0243[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0243[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0243[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0243[3], carry)
...
func Benchmarke_nocarry_0243InverseNew(b *testing.B) {
	var x e_nocarry_0243
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0243
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0243
		var xInv e_nocarry_0243
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0243
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0243
...
func testLinearComb(t *testing.T, x *e_nocarry_0243, xC int64, y *e_nocarry_0243, yC int64) {
	...
	var z e_nocarry_0243
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0243, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0243
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0243, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0243
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0243, xHi uint64) {
	var res e_nocarry_0243
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0243) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0243) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0243, c int64, result *e_nocarry_0243, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0243) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0243) uint64 {
