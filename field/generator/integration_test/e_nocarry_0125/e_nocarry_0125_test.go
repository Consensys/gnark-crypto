...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0125{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0125{0, uint64(i)})
	}
...
func (z *e_nocarry_0125) biggerOrEqualModulus() bool {
	if z[1] > qe_nocarry_0125[1] {
		return true
	}
	if z[1] < qe_nocarry_0125[1] {
		return false
...
func Benchmarke_nocarry_0125InverseNew(b *testing.B) {
	var x e_nocarry_0125
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0125, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0125, xHi uint64) {
