...
var benchRese_nocarry_0477 e_nocarry_0477

func BenchmarkE_nocarry_0477SetBytes(b *testing.B) {
	var x e_nocarry_0477
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0477MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0477.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0477)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0477)
		}
	})
}

func BenchmarkE_nocarry_0477Inverse(b *testing.B) {
	var x e_nocarry_0477
	x.SetRandom()
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0477Butterfly(b *testing.B) {
	var x e_nocarry_0477
	x.SetRandom()
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0477)
	}
}

func BenchmarkE_nocarry_0477Exp(b *testing.B) {
	var x e_nocarry_0477
	x.SetRandom()
	benchRese_nocarry_0477.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0477Double(b *testing.B) {
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Double(&benchRese_nocarry_0477)
	}
}

func BenchmarkE_nocarry_0477Add(b *testing.B) {
	var x e_nocarry_0477
	x.SetRandom()
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Add(&x, &benchRese_nocarry_0477)
	}
}

func BenchmarkE_nocarry_0477Sub(b *testing.B) {
	var x e_nocarry_0477
	x.SetRandom()
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Sub(&x, &benchRese_nocarry_0477)
	}
}

func BenchmarkE_nocarry_0477Neg(b *testing.B) {
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Neg(&benchRese_nocarry_0477)
	}
}

func BenchmarkE_nocarry_0477Div(b *testing.B) {
	var x e_nocarry_0477
	x.SetRandom()
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Div(&x, &benchRese_nocarry_0477)
	}
}

func BenchmarkE_nocarry_0477FromMont(b *testing.B) {
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.FromMont()
	}
}

func BenchmarkE_nocarry_0477ToMont(b *testing.B) {
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.ToMont()
	}
}
func BenchmarkE_nocarry_0477Square(b *testing.B) {
	benchRese_nocarry_0477.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Square(&benchRese_nocarry_0477)
	}
}

func BenchmarkE_nocarry_0477Sqrt(b *testing.B) {
	var a e_nocarry_0477
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0477Mul(b *testing.B) {
	x := e_nocarry_0477{
	...
	benchRese_nocarry_0477.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Mul(&benchRese_nocarry_0477, &x)
	}
}

func BenchmarkE_nocarry_0477Cmp(b *testing.B) {
	x := e_nocarry_0477{
		10205207936418715566,
		10974642568517549592,
		1954199141182275481,
	...
	benchRese_nocarry_0477 = x
	benchRese_nocarry_0477[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0477.Cmp(&x)
	}
}

func TestE_nocarry_0477Cmp(t *testing.T) {
	var x, y e_nocarry_0477
...
func TestE_nocarry_0477IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0477
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0477

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0477{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0477
	one.SetOne()
	e.Sub(&qe_nocarry_0477, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0477{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0477{0, uint64(i)})
	}
...
func TestE_nocarry_0477NegZero(t *testing.T) {
	var a, b e_nocarry_0477
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0477Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0477, len(staticTestValues))
...
func TestE_nocarry_0477Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0477) bool {
			var b e_nocarry_0477
...
func TestE_nocarry_0477InverseExp(t *testing.T) {
...
func TestE_nocarry_0477MulByConstants(t *testing.T) {
...
func TestE_nocarry_0477Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0477) bool {
...
func TestE_nocarry_0477LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0477Halve(t *testing.T) {
...
func TestE_nocarry_0477FromMont(t *testing.T) {
...
type testPaire_nocarry_0477 struct {
	element e_nocarry_0477
	bigint  big.Int
}

func (z *e_nocarry_0477) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0477[7] {
		return true
	}
	if z[7] < qe_nocarry_0477[7] {
		return false
	...
	return z[0] >= qe_nocarry_0477[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0477

		g.element = e_nocarry_0477{
		...
		if qe_nocarry_0477[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0477[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0477 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0477[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0477[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0477[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0477[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0477[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0477[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0477[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0477[7], carry)
...
func Benchmarke_nocarry_0477InverseNew(b *testing.B) {
	var x e_nocarry_0477
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0477
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0477
		var xInv e_nocarry_0477
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0477
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0477
...
func testLinearComb(t *testing.T, x *e_nocarry_0477, xC int64, y *e_nocarry_0477, yC int64) {
	...
	var z e_nocarry_0477
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0477, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0477
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0477, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0477
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0477, xHi uint64) {
	var res e_nocarry_0477
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0477) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0477) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0477, c int64, result *e_nocarry_0477, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0477) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0477) uint64 {
