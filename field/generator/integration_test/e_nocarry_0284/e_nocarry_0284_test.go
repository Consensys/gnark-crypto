...
var benchRese_nocarry_0284 e_nocarry_0284

func BenchmarkE_nocarry_0284SetBytes(b *testing.B) {
	var x e_nocarry_0284
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0284MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0284.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0284)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0284)
		}
	})
}

func BenchmarkE_nocarry_0284Inverse(b *testing.B) {
	var x e_nocarry_0284
	x.SetRandom()
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0284Butterfly(b *testing.B) {
	var x e_nocarry_0284
	x.SetRandom()
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0284)
	}
}

func BenchmarkE_nocarry_0284Exp(b *testing.B) {
	var x e_nocarry_0284
	x.SetRandom()
	benchRese_nocarry_0284.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0284Double(b *testing.B) {
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Double(&benchRese_nocarry_0284)
	}
}

func BenchmarkE_nocarry_0284Add(b *testing.B) {
	var x e_nocarry_0284
	x.SetRandom()
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Add(&x, &benchRese_nocarry_0284)
	}
}

func BenchmarkE_nocarry_0284Sub(b *testing.B) {
	var x e_nocarry_0284
	x.SetRandom()
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Sub(&x, &benchRese_nocarry_0284)
	}
}

func BenchmarkE_nocarry_0284Neg(b *testing.B) {
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Neg(&benchRese_nocarry_0284)
	}
}

func BenchmarkE_nocarry_0284Div(b *testing.B) {
	var x e_nocarry_0284
	x.SetRandom()
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Div(&x, &benchRese_nocarry_0284)
	}
}

func BenchmarkE_nocarry_0284FromMont(b *testing.B) {
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.FromMont()
	}
}

func BenchmarkE_nocarry_0284ToMont(b *testing.B) {
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.ToMont()
	}
}
func BenchmarkE_nocarry_0284Square(b *testing.B) {
	benchRese_nocarry_0284.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Square(&benchRese_nocarry_0284)
	}
}

func BenchmarkE_nocarry_0284Sqrt(b *testing.B) {
	var a e_nocarry_0284
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0284Mul(b *testing.B) {
	x := e_nocarry_0284{
		1321858332222022097,
	...
	benchRese_nocarry_0284.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Mul(&benchRese_nocarry_0284, &x)
	}
}

func BenchmarkE_nocarry_0284Cmp(b *testing.B) {
	x := e_nocarry_0284{
		1321858332222022097,
		12646279465522888240,
		8759421334108109860,
	...
	benchRese_nocarry_0284 = x
	benchRese_nocarry_0284[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0284.Cmp(&x)
	}
}

func TestE_nocarry_0284Cmp(t *testing.T) {
	var x, y e_nocarry_0284
...
func TestE_nocarry_0284IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0284
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0284

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0284{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0284
	one.SetOne()
	e.Sub(&qe_nocarry_0284, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0284{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0284{0, uint64(i)})
	}
...
func TestE_nocarry_0284NegZero(t *testing.T) {
	var a, b e_nocarry_0284
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0284Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0284, len(staticTestValues))
...
func TestE_nocarry_0284Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0284) bool {
			var b e_nocarry_0284
...
func TestE_nocarry_0284InverseExp(t *testing.T) {
...
func TestE_nocarry_0284MulByConstants(t *testing.T) {
...
func TestE_nocarry_0284Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0284) bool {
...
func TestE_nocarry_0284LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0284Halve(t *testing.T) {
...
func TestE_nocarry_0284FromMont(t *testing.T) {
...
type testPaire_nocarry_0284 struct {
	element e_nocarry_0284
	bigint  big.Int
}

func (z *e_nocarry_0284) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0284[4] {
		return true
	}
	if z[4] < qe_nocarry_0284[4] {
		return false
	...
	return z[0] >= qe_nocarry_0284[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0284

		g.element = e_nocarry_0284{
		...
		if qe_nocarry_0284[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0284[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0284 {
			var g e_nocarry_0284
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0284[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0284[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0284[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0284[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0284[4], carry)
...
func Benchmarke_nocarry_0284InverseNew(b *testing.B) {
	var x e_nocarry_0284
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0284
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0284
		var xInv e_nocarry_0284
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0284
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0284
...
func testLinearComb(t *testing.T, x *e_nocarry_0284, xC int64, y *e_nocarry_0284, yC int64) {
	...
	var z e_nocarry_0284
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0284, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0284
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0284, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0284
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0284, xHi uint64) {
	var res e_nocarry_0284
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0284) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0284) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0284, c int64, result *e_nocarry_0284, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0284) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0284) uint64 {
