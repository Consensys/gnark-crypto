...
// modulus q
DATA q<>+0(SB)/8, $0x965d6dc0168a5d3f
DATA q<>+8(SB)/8, $0xbf35dd4513435ffc
DATA q<>+16(SB)/8, $0xd7819e8b5d81d78b
DATA q<>+24(SB)/8, $0x77567a395f31e29c
DATA q<>+32(SB)/8, $0x000000000d800377
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x17e0273a7fb5ed41
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x965d6dc0168a5d3f, R9
	MOVQ    $0xbf35dd4513435ffc, R10
	MOVQ    $0xd7819e8b5d81d78b, R11
	MOVQ    $0x77567a395f31e29c, R12
	MOVQ    $0x000000000d800377, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xbf35dd4513435ffc, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xd7819e8b5d81d78b, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x77567a395f31e29c, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000000d800377, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x965d6dc0168a5d3f, CX
	MOVQ    $0xbf35dd4513435ffc, BX
	MOVQ    $0xd7819e8b5d81d78b, SI
	MOVQ    $0x77567a395f31e29c, DI
	MOVQ    $0x000000000d800377, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
