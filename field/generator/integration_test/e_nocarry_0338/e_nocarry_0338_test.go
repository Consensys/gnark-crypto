...
var benchRese_nocarry_0338 e_nocarry_0338

func BenchmarkE_nocarry_0338SetBytes(b *testing.B) {
	var x e_nocarry_0338
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0338MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0338.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0338)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0338)
		}
	})
}

func BenchmarkE_nocarry_0338Inverse(b *testing.B) {
	var x e_nocarry_0338
	x.SetRandom()
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0338Butterfly(b *testing.B) {
	var x e_nocarry_0338
	x.SetRandom()
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0338)
	}
}

func BenchmarkE_nocarry_0338Exp(b *testing.B) {
	var x e_nocarry_0338
	x.SetRandom()
	benchRese_nocarry_0338.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0338Double(b *testing.B) {
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Double(&benchRese_nocarry_0338)
	}
}

func BenchmarkE_nocarry_0338Add(b *testing.B) {
	var x e_nocarry_0338
	x.SetRandom()
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Add(&x, &benchRese_nocarry_0338)
	}
}

func BenchmarkE_nocarry_0338Sub(b *testing.B) {
	var x e_nocarry_0338
	x.SetRandom()
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Sub(&x, &benchRese_nocarry_0338)
	}
}

func BenchmarkE_nocarry_0338Neg(b *testing.B) {
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Neg(&benchRese_nocarry_0338)
	}
}

func BenchmarkE_nocarry_0338Div(b *testing.B) {
	var x e_nocarry_0338
	x.SetRandom()
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Div(&x, &benchRese_nocarry_0338)
	}
}

func BenchmarkE_nocarry_0338FromMont(b *testing.B) {
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.FromMont()
	}
}

func BenchmarkE_nocarry_0338ToMont(b *testing.B) {
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.ToMont()
	}
}
func BenchmarkE_nocarry_0338Square(b *testing.B) {
	benchRese_nocarry_0338.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Square(&benchRese_nocarry_0338)
	}
}

func BenchmarkE_nocarry_0338Sqrt(b *testing.B) {
	var a e_nocarry_0338
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0338Mul(b *testing.B) {
	x := e_nocarry_0338{
	...
	benchRese_nocarry_0338.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Mul(&benchRese_nocarry_0338, &x)
	}
}

func BenchmarkE_nocarry_0338Cmp(b *testing.B) {
	x := e_nocarry_0338{
		10666720906201336874,
		5821382060722144388,
		10151721793126329419,
	...
	benchRese_nocarry_0338 = x
	benchRese_nocarry_0338[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0338.Cmp(&x)
	}
}

func TestE_nocarry_0338Cmp(t *testing.T) {
	var x, y e_nocarry_0338
...
func TestE_nocarry_0338IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0338
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0338

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0338{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0338
	one.SetOne()
	e.Sub(&qe_nocarry_0338, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0338{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0338{0, uint64(i)})
	}
...
func TestE_nocarry_0338NegZero(t *testing.T) {
	var a, b e_nocarry_0338
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0338Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0338, len(staticTestValues))
...
func TestE_nocarry_0338Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0338) bool {
			var b e_nocarry_0338
...
func TestE_nocarry_0338InverseExp(t *testing.T) {
...
func TestE_nocarry_0338MulByConstants(t *testing.T) {
...
func TestE_nocarry_0338Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0338) bool {
...
func TestE_nocarry_0338LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0338Halve(t *testing.T) {
...
func TestE_nocarry_0338FromMont(t *testing.T) {
...
type testPaire_nocarry_0338 struct {
	element e_nocarry_0338
	bigint  big.Int
}

func (z *e_nocarry_0338) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0338[5] {
		return true
	}
	if z[5] < qe_nocarry_0338[5] {
		return false
	...
	return z[0] >= qe_nocarry_0338[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0338

		g.element = e_nocarry_0338{
		...
		if qe_nocarry_0338[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0338[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0338 {
			var g e_nocarry_0338
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0338[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0338[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0338[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0338[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0338[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0338[5], carry)
...
func Benchmarke_nocarry_0338InverseNew(b *testing.B) {
	var x e_nocarry_0338
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0338
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0338
		var xInv e_nocarry_0338
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0338
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0338
...
func testLinearComb(t *testing.T, x *e_nocarry_0338, xC int64, y *e_nocarry_0338, yC int64) {
	...
	var z e_nocarry_0338
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0338, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0338
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0338, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0338
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0338, xHi uint64) {
	var res e_nocarry_0338
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0338) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0338) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0338, c int64, result *e_nocarry_0338, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0338) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0338) uint64 {
