...
// modulus q
DATA q<>+0(SB)/8, $0xe942ca7f8c644eeb
DATA q<>+8(SB)/8, $0xe7cd353727d2b9f4
DATA q<>+16(SB)/8, $0xb4d28cf90e68cc69
DATA q<>+24(SB)/8, $0x5764c9e7e3f08463
DATA q<>+32(SB)/8, $0xf36022c9fcc069fd
DATA q<>+40(SB)/8, $0x000000000003443a
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xab168cdd7db3163d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xe942ca7f8c644eeb, R10
	MOVQ    $0xe7cd353727d2b9f4, R11
	MOVQ    $0xb4d28cf90e68cc69, R12
	MOVQ    $0x5764c9e7e3f08463, R13
	MOVQ    $0xf36022c9fcc069fd, R14
	MOVQ    $0x000000000003443a, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xe7cd353727d2b9f4, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xb4d28cf90e68cc69, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x5764c9e7e3f08463, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xf36022c9fcc069fd, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000000003443a, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xe942ca7f8c644eeb, CX
	MOVQ    $0xe7cd353727d2b9f4, BX
	MOVQ    $0xb4d28cf90e68cc69, SI
	MOVQ    $0x5764c9e7e3f08463, DI
	MOVQ    $0xf36022c9fcc069fd, R8
	MOVQ    $0x000000000003443a, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
