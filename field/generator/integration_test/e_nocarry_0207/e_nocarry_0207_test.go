...
var benchRese_nocarry_0207 e_nocarry_0207

func BenchmarkE_nocarry_0207SetBytes(b *testing.B) {
	var x e_nocarry_0207
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0207MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0207.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0207)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0207)
		}
	})
}

func BenchmarkE_nocarry_0207Inverse(b *testing.B) {
	var x e_nocarry_0207
	x.SetRandom()
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0207Butterfly(b *testing.B) {
	var x e_nocarry_0207
	x.SetRandom()
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0207)
	}
}

func BenchmarkE_nocarry_0207Exp(b *testing.B) {
	var x e_nocarry_0207
	x.SetRandom()
	benchRese_nocarry_0207.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0207Double(b *testing.B) {
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Double(&benchRese_nocarry_0207)
	}
}

func BenchmarkE_nocarry_0207Add(b *testing.B) {
	var x e_nocarry_0207
	x.SetRandom()
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Add(&x, &benchRese_nocarry_0207)
	}
}

func BenchmarkE_nocarry_0207Sub(b *testing.B) {
	var x e_nocarry_0207
	x.SetRandom()
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Sub(&x, &benchRese_nocarry_0207)
	}
}

func BenchmarkE_nocarry_0207Neg(b *testing.B) {
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Neg(&benchRese_nocarry_0207)
	}
}

func BenchmarkE_nocarry_0207Div(b *testing.B) {
	var x e_nocarry_0207
	x.SetRandom()
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Div(&x, &benchRese_nocarry_0207)
	}
}

func BenchmarkE_nocarry_0207FromMont(b *testing.B) {
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.FromMont()
	}
}

func BenchmarkE_nocarry_0207ToMont(b *testing.B) {
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.ToMont()
	}
}
func BenchmarkE_nocarry_0207Square(b *testing.B) {
	benchRese_nocarry_0207.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Square(&benchRese_nocarry_0207)
	}
}

func BenchmarkE_nocarry_0207Sqrt(b *testing.B) {
	var a e_nocarry_0207
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0207Mul(b *testing.B) {
	x := e_nocarry_0207{
		559234851511873249,
		9834232311500836272,
	...
	benchRese_nocarry_0207.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Mul(&benchRese_nocarry_0207, &x)
	}
}

func BenchmarkE_nocarry_0207Cmp(b *testing.B) {
	x := e_nocarry_0207{
		559234851511873249,
		9834232311500836272,
		12492147347448555492,
	...
	benchRese_nocarry_0207 = x
	benchRese_nocarry_0207[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0207.Cmp(&x)
	}
}

func TestE_nocarry_0207Cmp(t *testing.T) {
	var x, y e_nocarry_0207
...
func TestE_nocarry_0207IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0207
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0207

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0207{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0207
	one.SetOne()
	e.Sub(&qe_nocarry_0207, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0207{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0207{0, uint64(i)})
	}
...
func TestE_nocarry_0207NegZero(t *testing.T) {
	var a, b e_nocarry_0207
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0207Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0207, len(staticTestValues))
...
func TestE_nocarry_0207Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0207) bool {
			var b e_nocarry_0207
...
func TestE_nocarry_0207InverseExp(t *testing.T) {
...
func TestE_nocarry_0207MulByConstants(t *testing.T) {
...
func TestE_nocarry_0207Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0207) bool {
...
func TestE_nocarry_0207LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0207Halve(t *testing.T) {
...
func TestE_nocarry_0207FromMont(t *testing.T) {
...
type testPaire_nocarry_0207 struct {
	element e_nocarry_0207
	bigint  big.Int
}

func (z *e_nocarry_0207) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0207[3] {
		return true
	}
	if z[3] < qe_nocarry_0207[3] {
		return false
	...
	return z[0] >= qe_nocarry_0207[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0207

		g.element = e_nocarry_0207{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0207[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0207[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0207 {
			var g e_nocarry_0207
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0207[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0207[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0207[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0207[3], carry)
...
func Benchmarke_nocarry_0207InverseNew(b *testing.B) {
	var x e_nocarry_0207
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0207
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0207
		var xInv e_nocarry_0207
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0207
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0207
...
func testLinearComb(t *testing.T, x *e_nocarry_0207, xC int64, y *e_nocarry_0207, yC int64) {
	...
	var z e_nocarry_0207
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0207, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0207
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0207, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0207
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0207, xHi uint64) {
	var res e_nocarry_0207
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0207) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0207) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0207, c int64, result *e_nocarry_0207, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0207) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0207) uint64 {
