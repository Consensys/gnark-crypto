...
// modulus q
DATA q<>+0(SB)/8, $0xc124125da2c2c82b
DATA q<>+8(SB)/8, $0xde093b9563ead4c7
DATA q<>+16(SB)/8, $0x625eb26fed1a49ba
DATA q<>+24(SB)/8, $0x0000000000006cc3
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x997627cdbb70497d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xc124125da2c2c82b, R8
	MOVQ    $0xde093b9563ead4c7, R9
	MOVQ    $0x625eb26fed1a49ba, R10
	MOVQ    $0x0000000000006cc3, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xde093b9563ead4c7, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x625eb26fed1a49ba, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000000000006cc3, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xc124125da2c2c82b, R12
	MOVQ    $0xde093b9563ead4c7, R13
	MOVQ    $0x625eb26fed1a49ba, R14
	MOVQ    $0x0000000000006cc3, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
