...
var benchRese_nocarry_0430 e_nocarry_0430

func BenchmarkE_nocarry_0430SetBytes(b *testing.B) {
	var x e_nocarry_0430
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0430MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0430.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0430)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0430)
		}
	})
}

func BenchmarkE_nocarry_0430Inverse(b *testing.B) {
	var x e_nocarry_0430
	x.SetRandom()
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0430Butterfly(b *testing.B) {
	var x e_nocarry_0430
	x.SetRandom()
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0430)
	}
}

func BenchmarkE_nocarry_0430Exp(b *testing.B) {
	var x e_nocarry_0430
	x.SetRandom()
	benchRese_nocarry_0430.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0430Double(b *testing.B) {
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Double(&benchRese_nocarry_0430)
	}
}

func BenchmarkE_nocarry_0430Add(b *testing.B) {
	var x e_nocarry_0430
	x.SetRandom()
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Add(&x, &benchRese_nocarry_0430)
	}
}

func BenchmarkE_nocarry_0430Sub(b *testing.B) {
	var x e_nocarry_0430
	x.SetRandom()
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Sub(&x, &benchRese_nocarry_0430)
	}
}

func BenchmarkE_nocarry_0430Neg(b *testing.B) {
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Neg(&benchRese_nocarry_0430)
	}
}

func BenchmarkE_nocarry_0430Div(b *testing.B) {
	var x e_nocarry_0430
	x.SetRandom()
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Div(&x, &benchRese_nocarry_0430)
	}
}

func BenchmarkE_nocarry_0430FromMont(b *testing.B) {
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.FromMont()
	}
}

func BenchmarkE_nocarry_0430ToMont(b *testing.B) {
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.ToMont()
	}
}
func BenchmarkE_nocarry_0430Square(b *testing.B) {
	benchRese_nocarry_0430.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Square(&benchRese_nocarry_0430)
	}
}

func BenchmarkE_nocarry_0430Sqrt(b *testing.B) {
	var a e_nocarry_0430
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0430Mul(b *testing.B) {
	x := e_nocarry_0430{
		6600433240946060652,
	...
	benchRese_nocarry_0430.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Mul(&benchRese_nocarry_0430, &x)
	}
}

func BenchmarkE_nocarry_0430Cmp(b *testing.B) {
	x := e_nocarry_0430{
		6600433240946060652,
		11144232163570482161,
		15790931387654932607,
	...
	benchRese_nocarry_0430 = x
	benchRese_nocarry_0430[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0430.Cmp(&x)
	}
}

func TestE_nocarry_0430Cmp(t *testing.T) {
	var x, y e_nocarry_0430
...
func TestE_nocarry_0430IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0430
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0430

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0430{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0430
	one.SetOne()
	e.Sub(&qe_nocarry_0430, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0430{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0430{0, uint64(i)})
	}
...
func TestE_nocarry_0430NegZero(t *testing.T) {
	var a, b e_nocarry_0430
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0430Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0430, len(staticTestValues))
...
func TestE_nocarry_0430Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0430) bool {
			var b e_nocarry_0430
...
func TestE_nocarry_0430InverseExp(t *testing.T) {
...
func TestE_nocarry_0430MulByConstants(t *testing.T) {
...
func TestE_nocarry_0430Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0430) bool {
...
func TestE_nocarry_0430LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0430Halve(t *testing.T) {
...
func TestE_nocarry_0430FromMont(t *testing.T) {
...
type testPaire_nocarry_0430 struct {
	element e_nocarry_0430
	bigint  big.Int
}

func (z *e_nocarry_0430) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0430[6] {
		return true
	}
	if z[6] < qe_nocarry_0430[6] {
		return false
	...
	return z[0] >= qe_nocarry_0430[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0430

		g.element = e_nocarry_0430{
		...
		if qe_nocarry_0430[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0430[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0430 {
			var g e_nocarry_0430
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0430[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0430[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0430[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0430[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0430[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0430[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0430[6], carry)
...
func Benchmarke_nocarry_0430InverseNew(b *testing.B) {
	var x e_nocarry_0430
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0430
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0430
		var xInv e_nocarry_0430
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0430
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0430
...
func testLinearComb(t *testing.T, x *e_nocarry_0430, xC int64, y *e_nocarry_0430, yC int64) {
	...
	var z e_nocarry_0430
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0430, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0430
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0430, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0430
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0430, xHi uint64) {
	var res e_nocarry_0430
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0430) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0430) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0430, c int64, result *e_nocarry_0430, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0430) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0430) uint64 {
