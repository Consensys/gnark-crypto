...
var benchRese_nocarry_0518 e_nocarry_0518

func BenchmarkE_nocarry_0518SetBytes(b *testing.B) {
	var x e_nocarry_0518
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0518MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0518.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0518)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0518)
		}
	})
}

func BenchmarkE_nocarry_0518Inverse(b *testing.B) {
	var x e_nocarry_0518
	x.SetRandom()
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0518Butterfly(b *testing.B) {
	var x e_nocarry_0518
	x.SetRandom()
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0518)
	}
}

func BenchmarkE_nocarry_0518Exp(b *testing.B) {
	var x e_nocarry_0518
	x.SetRandom()
	benchRese_nocarry_0518.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0518Double(b *testing.B) {
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Double(&benchRese_nocarry_0518)
	}
}

func BenchmarkE_nocarry_0518Add(b *testing.B) {
	var x e_nocarry_0518
	x.SetRandom()
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Add(&x, &benchRese_nocarry_0518)
	}
}

func BenchmarkE_nocarry_0518Sub(b *testing.B) {
	var x e_nocarry_0518
	x.SetRandom()
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Sub(&x, &benchRese_nocarry_0518)
	}
}

func BenchmarkE_nocarry_0518Neg(b *testing.B) {
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Neg(&benchRese_nocarry_0518)
	}
}

func BenchmarkE_nocarry_0518Div(b *testing.B) {
	var x e_nocarry_0518
	x.SetRandom()
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Div(&x, &benchRese_nocarry_0518)
	}
}

func BenchmarkE_nocarry_0518FromMont(b *testing.B) {
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.FromMont()
	}
}

func BenchmarkE_nocarry_0518ToMont(b *testing.B) {
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.ToMont()
	}
}
func BenchmarkE_nocarry_0518Square(b *testing.B) {
	benchRese_nocarry_0518.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Square(&benchRese_nocarry_0518)
	}
}

func BenchmarkE_nocarry_0518Sqrt(b *testing.B) {
	var a e_nocarry_0518
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0518Mul(b *testing.B) {
	x := e_nocarry_0518{
	...
	benchRese_nocarry_0518.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Mul(&benchRese_nocarry_0518, &x)
	}
}

func BenchmarkE_nocarry_0518Cmp(b *testing.B) {
	x := e_nocarry_0518{
		13620633492009649652,
		17848507295638711192,
		4851165667431496554,
	...
	benchRese_nocarry_0518 = x
	benchRese_nocarry_0518[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0518.Cmp(&x)
	}
}

func TestE_nocarry_0518Cmp(t *testing.T) {
	var x, y e_nocarry_0518
...
func TestE_nocarry_0518IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0518
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0518

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0518{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0518
	one.SetOne()
	e.Sub(&qe_nocarry_0518, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0518{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0518{0, uint64(i)})
	}
...
func TestE_nocarry_0518NegZero(t *testing.T) {
	var a, b e_nocarry_0518
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0518Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0518, len(staticTestValues))
...
func TestE_nocarry_0518Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0518) bool {
			var b e_nocarry_0518
...
func TestE_nocarry_0518InverseExp(t *testing.T) {
...
func TestE_nocarry_0518MulByConstants(t *testing.T) {
...
func TestE_nocarry_0518Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0518) bool {
...
func TestE_nocarry_0518LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0518Halve(t *testing.T) {
...
func TestE_nocarry_0518FromMont(t *testing.T) {
...
type testPaire_nocarry_0518 struct {
	element e_nocarry_0518
	bigint  big.Int
}

func (z *e_nocarry_0518) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0518[8] {
		return true
	}
	if z[8] < qe_nocarry_0518[8] {
		return false
	...
	return z[0] >= qe_nocarry_0518[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0518

		g.element = e_nocarry_0518{
		...
		if qe_nocarry_0518[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0518[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0518 {
			var g e_nocarry_0518
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0518[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0518[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0518[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0518[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0518[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0518[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0518[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0518[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0518[8], carry)
...
func Benchmarke_nocarry_0518InverseNew(b *testing.B) {
	var x e_nocarry_0518
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0518
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0518
		var xInv e_nocarry_0518
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0518
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0518
...
func testLinearComb(t *testing.T, x *e_nocarry_0518, xC int64, y *e_nocarry_0518, yC int64) {
	...
	var z e_nocarry_0518
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0518, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0518
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0518, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0518
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0518, xHi uint64) {
	var res e_nocarry_0518
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0518) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0518) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0518, c int64, result *e_nocarry_0518, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0518) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0518) uint64 {
