...
var benchRese_nocarry_0340 e_nocarry_0340

func BenchmarkE_nocarry_0340SetBytes(b *testing.B) {
	var x e_nocarry_0340
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0340MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0340.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0340)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0340)
		}
	})
}

func BenchmarkE_nocarry_0340Inverse(b *testing.B) {
	var x e_nocarry_0340
	x.SetRandom()
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0340Butterfly(b *testing.B) {
	var x e_nocarry_0340
	x.SetRandom()
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0340)
	}
}

func BenchmarkE_nocarry_0340Exp(b *testing.B) {
	var x e_nocarry_0340
	x.SetRandom()
	benchRese_nocarry_0340.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0340Double(b *testing.B) {
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Double(&benchRese_nocarry_0340)
	}
}

func BenchmarkE_nocarry_0340Add(b *testing.B) {
	var x e_nocarry_0340
	x.SetRandom()
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Add(&x, &benchRese_nocarry_0340)
	}
}

func BenchmarkE_nocarry_0340Sub(b *testing.B) {
	var x e_nocarry_0340
	x.SetRandom()
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Sub(&x, &benchRese_nocarry_0340)
	}
}

func BenchmarkE_nocarry_0340Neg(b *testing.B) {
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Neg(&benchRese_nocarry_0340)
	}
}

func BenchmarkE_nocarry_0340Div(b *testing.B) {
	var x e_nocarry_0340
	x.SetRandom()
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Div(&x, &benchRese_nocarry_0340)
	}
}

func BenchmarkE_nocarry_0340FromMont(b *testing.B) {
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.FromMont()
	}
}

func BenchmarkE_nocarry_0340ToMont(b *testing.B) {
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.ToMont()
	}
}
func BenchmarkE_nocarry_0340Square(b *testing.B) {
	benchRese_nocarry_0340.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Square(&benchRese_nocarry_0340)
	}
}

func BenchmarkE_nocarry_0340Sqrt(b *testing.B) {
	var a e_nocarry_0340
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0340Mul(b *testing.B) {
	x := e_nocarry_0340{
	...
	benchRese_nocarry_0340.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Mul(&benchRese_nocarry_0340, &x)
	}
}

func BenchmarkE_nocarry_0340Cmp(b *testing.B) {
	x := e_nocarry_0340{
		13550486274816596264,
		16419645467062639114,
		13209704609932342896,
	...
	benchRese_nocarry_0340 = x
	benchRese_nocarry_0340[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0340.Cmp(&x)
	}
}

func TestE_nocarry_0340Cmp(t *testing.T) {
	var x, y e_nocarry_0340
...
func TestE_nocarry_0340IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0340
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0340

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0340{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0340
	one.SetOne()
	e.Sub(&qe_nocarry_0340, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0340{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0340{0, uint64(i)})
	}
...
func TestE_nocarry_0340NegZero(t *testing.T) {
	var a, b e_nocarry_0340
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0340Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0340, len(staticTestValues))
...
func TestE_nocarry_0340Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0340) bool {
			var b e_nocarry_0340
...
func TestE_nocarry_0340InverseExp(t *testing.T) {
...
func TestE_nocarry_0340MulByConstants(t *testing.T) {
...
func TestE_nocarry_0340Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0340) bool {
...
func TestE_nocarry_0340LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0340Halve(t *testing.T) {
...
func TestE_nocarry_0340FromMont(t *testing.T) {
...
type testPaire_nocarry_0340 struct {
	element e_nocarry_0340
	bigint  big.Int
}

func (z *e_nocarry_0340) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0340[5] {
		return true
	}
	if z[5] < qe_nocarry_0340[5] {
		return false
	...
	return z[0] >= qe_nocarry_0340[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0340

		g.element = e_nocarry_0340{
		...
		if qe_nocarry_0340[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0340[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0340 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0340[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0340[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0340[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0340[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0340[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0340[5], carry)
...
func Benchmarke_nocarry_0340InverseNew(b *testing.B) {
	var x e_nocarry_0340
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0340
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0340
		var xInv e_nocarry_0340
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0340
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0340
...
func testLinearComb(t *testing.T, x *e_nocarry_0340, xC int64, y *e_nocarry_0340, yC int64) {
	...
	var z e_nocarry_0340
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0340, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0340
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0340, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0340
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0340, xHi uint64) {
	var res e_nocarry_0340
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0340) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0340) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0340, c int64, result *e_nocarry_0340, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0340) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0340) uint64 {
