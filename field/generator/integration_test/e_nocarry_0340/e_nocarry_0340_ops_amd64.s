...
// modulus q
DATA q<>+0(SB)/8, $0x8d81f1f3192d7719
DATA q<>+8(SB)/8, $0x3cdb556f41e60e68
DATA q<>+16(SB)/8, $0xad0fd7cfae0ab5fd
DATA q<>+24(SB)/8, $0xb53a7a04e5c4f87b
DATA q<>+32(SB)/8, $0xea2726587fa8b1c1
DATA q<>+40(SB)/8, $0x00000000000f7c86
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xabebba8b6cba0ad7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x8d81f1f3192d7719, R10
	MOVQ    $0x3cdb556f41e60e68, R11
	MOVQ    $0xad0fd7cfae0ab5fd, R12
	MOVQ    $0xb53a7a04e5c4f87b, R13
	MOVQ    $0xea2726587fa8b1c1, R14
	MOVQ    $0x00000000000f7c86, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x3cdb556f41e60e68, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xad0fd7cfae0ab5fd, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xb53a7a04e5c4f87b, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xea2726587fa8b1c1, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000000000f7c86, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x8d81f1f3192d7719, CX
	MOVQ    $0x3cdb556f41e60e68, BX
	MOVQ    $0xad0fd7cfae0ab5fd, SI
	MOVQ    $0xb53a7a04e5c4f87b, DI
	MOVQ    $0xea2726587fa8b1c1, R8
	MOVQ    $0x00000000000f7c86, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
