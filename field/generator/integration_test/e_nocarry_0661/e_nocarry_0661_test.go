...
var benchRese_nocarry_0661 e_nocarry_0661

func BenchmarkE_nocarry_0661SetBytes(b *testing.B) {
	var x e_nocarry_0661
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0661MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0661.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0661)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0661)
		}
	})
}

func BenchmarkE_nocarry_0661Inverse(b *testing.B) {
	var x e_nocarry_0661
	x.SetRandom()
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0661Butterfly(b *testing.B) {
	var x e_nocarry_0661
	x.SetRandom()
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0661)
	}
}

func BenchmarkE_nocarry_0661Exp(b *testing.B) {
	var x e_nocarry_0661
	x.SetRandom()
	benchRese_nocarry_0661.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0661Double(b *testing.B) {
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Double(&benchRese_nocarry_0661)
	}
}

func BenchmarkE_nocarry_0661Add(b *testing.B) {
	var x e_nocarry_0661
	x.SetRandom()
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Add(&x, &benchRese_nocarry_0661)
	}
}

func BenchmarkE_nocarry_0661Sub(b *testing.B) {
	var x e_nocarry_0661
	x.SetRandom()
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Sub(&x, &benchRese_nocarry_0661)
	}
}

func BenchmarkE_nocarry_0661Neg(b *testing.B) {
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Neg(&benchRese_nocarry_0661)
	}
}

func BenchmarkE_nocarry_0661Div(b *testing.B) {
	var x e_nocarry_0661
	x.SetRandom()
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Div(&x, &benchRese_nocarry_0661)
	}
}

func BenchmarkE_nocarry_0661FromMont(b *testing.B) {
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.FromMont()
	}
}

func BenchmarkE_nocarry_0661ToMont(b *testing.B) {
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.ToMont()
	}
}
func BenchmarkE_nocarry_0661Square(b *testing.B) {
	benchRese_nocarry_0661.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Square(&benchRese_nocarry_0661)
	}
}

func BenchmarkE_nocarry_0661Sqrt(b *testing.B) {
	var a e_nocarry_0661
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0661Mul(b *testing.B) {
	x := e_nocarry_0661{
	...
	benchRese_nocarry_0661.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Mul(&benchRese_nocarry_0661, &x)
	}
}

func BenchmarkE_nocarry_0661Cmp(b *testing.B) {
	x := e_nocarry_0661{
		15802530703200871685,
		17223421888643669230,
		10062808983724282716,
	...
	benchRese_nocarry_0661 = x
	benchRese_nocarry_0661[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0661.Cmp(&x)
	}
}

func TestE_nocarry_0661Cmp(t *testing.T) {
	var x, y e_nocarry_0661
...
func TestE_nocarry_0661IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0661
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0661

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0661{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0661
	one.SetOne()
	e.Sub(&qe_nocarry_0661, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0661{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0661{0, uint64(i)})
	}
...
func TestE_nocarry_0661NegZero(t *testing.T) {
	var a, b e_nocarry_0661
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0661Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0661, len(staticTestValues))
...
func TestE_nocarry_0661Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0661) bool {
			var b e_nocarry_0661
...
func TestE_nocarry_0661InverseExp(t *testing.T) {
...
func TestE_nocarry_0661MulByConstants(t *testing.T) {
...
func TestE_nocarry_0661Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0661) bool {
...
func TestE_nocarry_0661LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0661Halve(t *testing.T) {
...
func TestE_nocarry_0661FromMont(t *testing.T) {
...
type testPaire_nocarry_0661 struct {
	element e_nocarry_0661
	bigint  big.Int
}

func (z *e_nocarry_0661) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0661[10] {
		return true
	}
	if z[10] < qe_nocarry_0661[10] {
		return false
	...
	return z[0] >= qe_nocarry_0661[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0661

		g.element = e_nocarry_0661{
		...
		if qe_nocarry_0661[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0661[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0661 {
			var g e_nocarry_0661
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0661[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0661[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0661[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0661[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0661[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0661[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0661[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0661[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0661[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0661[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0661[10], carry)
...
func Benchmarke_nocarry_0661InverseNew(b *testing.B) {
	var x e_nocarry_0661
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0661
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0661
		var xInv e_nocarry_0661
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0661
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0661
...
func testLinearComb(t *testing.T, x *e_nocarry_0661, xC int64, y *e_nocarry_0661, yC int64) {
	...
	var z e_nocarry_0661
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0661, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0661
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0661, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0661
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0661, xHi uint64) {
	var res e_nocarry_0661
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0661) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0661) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0661, c int64, result *e_nocarry_0661, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0661) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0661) uint64 {
