...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x35712e0e61147a85, R14
	ADDQ R14, AX
	MOVQ $0x81b9e1d6c7adf9f0, R14
	ADCQ R14, DX
	MOVQ $0xa3d1159bdc59e4b4, R14
	ADCQ R14, CX
	MOVQ $0x2d45674584f3da92, R14
	ADCQ R14, BX
	MOVQ $0x0331e894abe311fc, R14
	ADCQ R14, SI
	MOVQ $0x8ea3f48d13ff762b, R14
	ADCQ R14, DI
	MOVQ $0x407c0cc11b2596c4, R14
	ADCQ R14, R8
	MOVQ $0x2e091b88e8bde4df, R14
	ADCQ R14, R9
	MOVQ $0x2d167abac671682f, R14
	ADCQ R14, R10
	MOVQ $0x50c8e0bf600d2fed, R14
	ADCQ R14, R11
	MOVQ $0x00000000001ff9fa, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x35712e0e61147a85, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x81b9e1d6c7adf9f0, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xa3d1159bdc59e4b4, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x2d45674584f3da92, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x0331e894abe311fc, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x8ea3f48d13ff762b, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x407c0cc11b2596c4, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x2e091b88e8bde4df, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x2d167abac671682f, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x50c8e0bf600d2fed, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000001ff9fa, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x35712e0e61147a85, AX
	ADDQ AX, DX
	MOVQ $0x81b9e1d6c7adf9f0, AX
	ADCQ AX, CX
	MOVQ $0xa3d1159bdc59e4b4, AX
	ADCQ AX, BX
	MOVQ $0x2d45674584f3da92, AX
	ADCQ AX, SI
	MOVQ $0x0331e894abe311fc, AX
	ADCQ AX, DI
	MOVQ $0x8ea3f48d13ff762b, AX
	ADCQ AX, R8
	MOVQ $0x407c0cc11b2596c4, AX
	ADCQ AX, R9
	MOVQ $0x2e091b88e8bde4df, AX
	ADCQ AX, R10
	MOVQ $0x2d167abac671682f, AX
	ADCQ AX, R11
	MOVQ $0x50c8e0bf600d2fed, AX
	ADCQ AX, R12
	MOVQ $0x00000000001ff9fa, AX
	ADCQ AX, R13
