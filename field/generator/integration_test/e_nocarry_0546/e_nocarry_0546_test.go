...
var benchRese_nocarry_0546 e_nocarry_0546

func BenchmarkE_nocarry_0546SetBytes(b *testing.B) {
	var x e_nocarry_0546
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0546MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0546.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0546)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0546)
		}
	})
}

func BenchmarkE_nocarry_0546Inverse(b *testing.B) {
	var x e_nocarry_0546
	x.SetRandom()
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0546Butterfly(b *testing.B) {
	var x e_nocarry_0546
	x.SetRandom()
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0546)
	}
}

func BenchmarkE_nocarry_0546Exp(b *testing.B) {
	var x e_nocarry_0546
	x.SetRandom()
	benchRese_nocarry_0546.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0546Double(b *testing.B) {
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Double(&benchRese_nocarry_0546)
	}
}

func BenchmarkE_nocarry_0546Add(b *testing.B) {
	var x e_nocarry_0546
	x.SetRandom()
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Add(&x, &benchRese_nocarry_0546)
	}
}

func BenchmarkE_nocarry_0546Sub(b *testing.B) {
	var x e_nocarry_0546
	x.SetRandom()
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Sub(&x, &benchRese_nocarry_0546)
	}
}

func BenchmarkE_nocarry_0546Neg(b *testing.B) {
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Neg(&benchRese_nocarry_0546)
	}
}

func BenchmarkE_nocarry_0546Div(b *testing.B) {
	var x e_nocarry_0546
	x.SetRandom()
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Div(&x, &benchRese_nocarry_0546)
	}
}

func BenchmarkE_nocarry_0546FromMont(b *testing.B) {
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.FromMont()
	}
}

func BenchmarkE_nocarry_0546ToMont(b *testing.B) {
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.ToMont()
	}
}
func BenchmarkE_nocarry_0546Square(b *testing.B) {
	benchRese_nocarry_0546.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Square(&benchRese_nocarry_0546)
	}
}

func BenchmarkE_nocarry_0546Sqrt(b *testing.B) {
	var a e_nocarry_0546
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0546Mul(b *testing.B) {
	x := e_nocarry_0546{
		3592021485853590939,
	...
	benchRese_nocarry_0546.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Mul(&benchRese_nocarry_0546, &x)
	}
}

func BenchmarkE_nocarry_0546Cmp(b *testing.B) {
	x := e_nocarry_0546{
		3592021485853590939,
		14392569896134838857,
		8056737812248391573,
	...
	benchRese_nocarry_0546 = x
	benchRese_nocarry_0546[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0546.Cmp(&x)
	}
}

func TestE_nocarry_0546Cmp(t *testing.T) {
	var x, y e_nocarry_0546
...
func TestE_nocarry_0546IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0546
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0546

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0546{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0546
	one.SetOne()
	e.Sub(&qe_nocarry_0546, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0546{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0546{0, uint64(i)})
	}
...
func TestE_nocarry_0546NegZero(t *testing.T) {
	var a, b e_nocarry_0546
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0546Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0546, len(staticTestValues))
...
func TestE_nocarry_0546Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0546) bool {
			var b e_nocarry_0546
...
func TestE_nocarry_0546InverseExp(t *testing.T) {
...
func TestE_nocarry_0546MulByConstants(t *testing.T) {
...
func TestE_nocarry_0546Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0546) bool {
...
func TestE_nocarry_0546LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0546Halve(t *testing.T) {
...
func TestE_nocarry_0546FromMont(t *testing.T) {
...
type testPaire_nocarry_0546 struct {
	element e_nocarry_0546
	bigint  big.Int
}

func (z *e_nocarry_0546) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0546[8] {
		return true
	}
	if z[8] < qe_nocarry_0546[8] {
		return false
	...
	return z[0] >= qe_nocarry_0546[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0546

		g.element = e_nocarry_0546{
		...
		if qe_nocarry_0546[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0546[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0546 {
			var g e_nocarry_0546
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0546[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0546[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0546[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0546[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0546[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0546[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0546[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0546[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0546[8], carry)
...
func Benchmarke_nocarry_0546InverseNew(b *testing.B) {
	var x e_nocarry_0546
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0546
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0546
		var xInv e_nocarry_0546
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0546
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0546
...
func testLinearComb(t *testing.T, x *e_nocarry_0546, xC int64, y *e_nocarry_0546, yC int64) {
	...
	var z e_nocarry_0546
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0546, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0546
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0546, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0546
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0546, xHi uint64) {
	var res e_nocarry_0546
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0546) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0546) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0546, c int64, result *e_nocarry_0546, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0546) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0546) uint64 {
