...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x8962a09a3c2e1a47, R12
	ADDQ R12, AX
	MOVQ $0xfb9bac71c8da001a, R12
	ADCQ R12, DX
	MOVQ $0x9e5ce501acccaec8, R12
	ADCQ R12, CX
	MOVQ $0xa258afba3fc0cc94, R12
	ADCQ R12, BX
	MOVQ $0xa5b7f9df9fb3d840, R12
	ADCQ R12, SI
	MOVQ $0x801a35a6e8351196, R12
	ADCQ R12, DI
	MOVQ $0x49f2d2f7be13bc3e, R12
	ADCQ R12, R8
	MOVQ $0x327a436bb970c40e, R12
	ADCQ R12, R9
	MOVQ $0x00000003384095b7, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x8962a09a3c2e1a47, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xfb9bac71c8da001a, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x9e5ce501acccaec8, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xa258afba3fc0cc94, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xa5b7f9df9fb3d840, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x801a35a6e8351196, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x49f2d2f7be13bc3e, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x327a436bb970c40e, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000003384095b7, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x8962a09a3c2e1a47, AX
	ADDQ AX, DX
	MOVQ $0xfb9bac71c8da001a, AX
	ADCQ AX, CX
	MOVQ $0x9e5ce501acccaec8, AX
	ADCQ AX, BX
	MOVQ $0xa258afba3fc0cc94, AX
	ADCQ AX, SI
	MOVQ $0xa5b7f9df9fb3d840, AX
	ADCQ AX, DI
	MOVQ $0x801a35a6e8351196, AX
	ADCQ AX, R8
	MOVQ $0x49f2d2f7be13bc3e, AX
	ADCQ AX, R9
	MOVQ $0x327a436bb970c40e, AX
	ADCQ AX, R10
	MOVQ $0x00000003384095b7, AX
	ADCQ AX, R11
