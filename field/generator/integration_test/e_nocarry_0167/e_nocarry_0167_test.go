...
var benchRese_nocarry_0167 e_nocarry_0167

func BenchmarkE_nocarry_0167SetBytes(b *testing.B) {
	var x e_nocarry_0167
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0167MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0167.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0167)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0167)
		}
	})
}

func BenchmarkE_nocarry_0167Inverse(b *testing.B) {
	var x e_nocarry_0167
	x.SetRandom()
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0167Butterfly(b *testing.B) {
	var x e_nocarry_0167
	x.SetRandom()
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0167)
	}
}

func BenchmarkE_nocarry_0167Exp(b *testing.B) {
	var x e_nocarry_0167
	x.SetRandom()
	benchRese_nocarry_0167.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0167Double(b *testing.B) {
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Double(&benchRese_nocarry_0167)
	}
}

func BenchmarkE_nocarry_0167Add(b *testing.B) {
	var x e_nocarry_0167
	x.SetRandom()
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Add(&x, &benchRese_nocarry_0167)
	}
}

func BenchmarkE_nocarry_0167Sub(b *testing.B) {
	var x e_nocarry_0167
	x.SetRandom()
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Sub(&x, &benchRese_nocarry_0167)
	}
}

func BenchmarkE_nocarry_0167Neg(b *testing.B) {
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Neg(&benchRese_nocarry_0167)
	}
}

func BenchmarkE_nocarry_0167Div(b *testing.B) {
	var x e_nocarry_0167
	x.SetRandom()
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Div(&x, &benchRese_nocarry_0167)
	}
}

func BenchmarkE_nocarry_0167FromMont(b *testing.B) {
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.FromMont()
	}
}

func BenchmarkE_nocarry_0167ToMont(b *testing.B) {
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.ToMont()
	}
}
func BenchmarkE_nocarry_0167Square(b *testing.B) {
	benchRese_nocarry_0167.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Square(&benchRese_nocarry_0167)
	}
}

func BenchmarkE_nocarry_0167Sqrt(b *testing.B) {
	var a e_nocarry_0167
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0167Mul(b *testing.B) {
	x := e_nocarry_0167{
		13319507568160684789,
		13185661049360317194,
		218329173548,
	}
	benchRese_nocarry_0167.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Mul(&benchRese_nocarry_0167, &x)
	}
}

func BenchmarkE_nocarry_0167Cmp(b *testing.B) {
	x := e_nocarry_0167{
		13319507568160684789,
		13185661049360317194,
		218329173548,
	}
	benchRese_nocarry_0167 = x
	benchRese_nocarry_0167[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0167.Cmp(&x)
	}
}

func TestE_nocarry_0167Cmp(t *testing.T) {
	var x, y e_nocarry_0167
...
func TestE_nocarry_0167IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0167
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0167

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0167{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0167
	one.SetOne()
	e.Sub(&qe_nocarry_0167, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0167{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0167{0, uint64(i)})
	}
...
func TestE_nocarry_0167NegZero(t *testing.T) {
	var a, b e_nocarry_0167
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0167Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0167, len(staticTestValues))
...
func TestE_nocarry_0167Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0167) bool {
			var b e_nocarry_0167
...
func TestE_nocarry_0167InverseExp(t *testing.T) {
...
func TestE_nocarry_0167MulByConstants(t *testing.T) {
...
func TestE_nocarry_0167Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0167) bool {
...
func TestE_nocarry_0167LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0167Halve(t *testing.T) {
...
func TestE_nocarry_0167FromMont(t *testing.T) {
...
type testPaire_nocarry_0167 struct {
	element e_nocarry_0167
	bigint  big.Int
}

func (z *e_nocarry_0167) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0167[2] {
		return true
	}
	if z[2] < qe_nocarry_0167[2] {
		return false
	...
	return z[0] >= qe_nocarry_0167[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0167

		g.element = e_nocarry_0167{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0167[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0167[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0167 {
			var g e_nocarry_0167
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0167[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0167[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0167[2], carry)
...
func Benchmarke_nocarry_0167InverseNew(b *testing.B) {
	var x e_nocarry_0167
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0167
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0167
		var xInv e_nocarry_0167
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0167
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0167
...
func testLinearComb(t *testing.T, x *e_nocarry_0167, xC int64, y *e_nocarry_0167, yC int64) {
	...
	var z e_nocarry_0167
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0167, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0167
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0167, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0167
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0167, xHi uint64) {
	var res e_nocarry_0167
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0167) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0167) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0167, c int64, result *e_nocarry_0167, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0167) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0167) uint64 {
