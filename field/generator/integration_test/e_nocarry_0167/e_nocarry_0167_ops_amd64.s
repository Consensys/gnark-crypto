...
// modulus q
DATA q<>+0(SB)/8, $0xa7651ae5bb896ffd
DATA q<>+8(SB)/8, $0x59d617ed350a894f
DATA q<>+16(SB)/8, $0x00000064d2254447
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x1f1572ec3b649aab
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xa7651ae5bb896ffd, DI
	MOVQ    $0x59d617ed350a894f, R8
	MOVQ    $0x00000064d2254447, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x59d617ed350a894f, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x00000064d2254447, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xa7651ae5bb896ffd, R10
	MOVQ    $0x59d617ed350a894f, R11
	MOVQ    $0x00000064d2254447, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
