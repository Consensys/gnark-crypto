...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_cios_0192{uint64(i)})
		staticTestValues = append(staticTestValues, e_cios_0192{0, uint64(i)})
	}
...
func (z *e_cios_0192) biggerOrEqualModulus() bool {
	if z[2] > qe_cios_0192[2] {
		return true
	}
	if z[2] < qe_cios_0192[2] {
		return false
