...
var benchRese_nocarry_0461 e_nocarry_0461

func BenchmarkE_nocarry_0461SetBytes(b *testing.B) {
	var x e_nocarry_0461
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0461MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0461.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0461)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0461)
		}
	})
}

func BenchmarkE_nocarry_0461Inverse(b *testing.B) {
	var x e_nocarry_0461
	x.SetRandom()
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0461Butterfly(b *testing.B) {
	var x e_nocarry_0461
	x.SetRandom()
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0461)
	}
}

func BenchmarkE_nocarry_0461Exp(b *testing.B) {
	var x e_nocarry_0461
	x.SetRandom()
	benchRese_nocarry_0461.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0461Double(b *testing.B) {
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Double(&benchRese_nocarry_0461)
	}
}

func BenchmarkE_nocarry_0461Add(b *testing.B) {
	var x e_nocarry_0461
	x.SetRandom()
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Add(&x, &benchRese_nocarry_0461)
	}
}

func BenchmarkE_nocarry_0461Sub(b *testing.B) {
	var x e_nocarry_0461
	x.SetRandom()
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Sub(&x, &benchRese_nocarry_0461)
	}
}

func BenchmarkE_nocarry_0461Neg(b *testing.B) {
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Neg(&benchRese_nocarry_0461)
	}
}

func BenchmarkE_nocarry_0461Div(b *testing.B) {
	var x e_nocarry_0461
	x.SetRandom()
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Div(&x, &benchRese_nocarry_0461)
	}
}

func BenchmarkE_nocarry_0461FromMont(b *testing.B) {
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.FromMont()
	}
}

func BenchmarkE_nocarry_0461ToMont(b *testing.B) {
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.ToMont()
	}
}
func BenchmarkE_nocarry_0461Square(b *testing.B) {
	benchRese_nocarry_0461.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Square(&benchRese_nocarry_0461)
	}
}

func BenchmarkE_nocarry_0461Sqrt(b *testing.B) {
	var a e_nocarry_0461
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0461Mul(b *testing.B) {
	x := e_nocarry_0461{
		784235196092030242,
		4410217428262581680,
	...
	benchRese_nocarry_0461.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Mul(&benchRese_nocarry_0461, &x)
	}
}

func BenchmarkE_nocarry_0461Cmp(b *testing.B) {
	x := e_nocarry_0461{
		784235196092030242,
		4410217428262581680,
		17083562017292686662,
	...
	benchRese_nocarry_0461 = x
	benchRese_nocarry_0461[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0461.Cmp(&x)
	}
}

func TestE_nocarry_0461Cmp(t *testing.T) {
	var x, y e_nocarry_0461
...
func TestE_nocarry_0461IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0461
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0461

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0461{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0461
	one.SetOne()
	e.Sub(&qe_nocarry_0461, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0461{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0461{0, uint64(i)})
	}
...
func TestE_nocarry_0461NegZero(t *testing.T) {
	var a, b e_nocarry_0461
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0461Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0461, len(staticTestValues))
...
func TestE_nocarry_0461Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0461) bool {
			var b e_nocarry_0461
...
func TestE_nocarry_0461InverseExp(t *testing.T) {
...
func TestE_nocarry_0461MulByConstants(t *testing.T) {
...
func TestE_nocarry_0461Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0461) bool {
...
func TestE_nocarry_0461LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0461Halve(t *testing.T) {
...
func TestE_nocarry_0461FromMont(t *testing.T) {
...
type testPaire_nocarry_0461 struct {
	element e_nocarry_0461
	bigint  big.Int
}

func (z *e_nocarry_0461) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0461[7] {
		return true
	}
	if z[7] < qe_nocarry_0461[7] {
		return false
	...
	return z[0] >= qe_nocarry_0461[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0461

		g.element = e_nocarry_0461{
		...
		if qe_nocarry_0461[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0461[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0461 {
			var g e_nocarry_0461
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0461[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0461[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0461[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0461[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0461[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0461[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0461[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0461[7], carry)
...
func Benchmarke_nocarry_0461InverseNew(b *testing.B) {
	var x e_nocarry_0461
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0461
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0461
		var xInv e_nocarry_0461
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0461
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0461
...
func testLinearComb(t *testing.T, x *e_nocarry_0461, xC int64, y *e_nocarry_0461, yC int64) {
	...
	var z e_nocarry_0461
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0461, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0461
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0461, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0461
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0461, xHi uint64) {
	var res e_nocarry_0461
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0461) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0461) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0461, c int64, result *e_nocarry_0461, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0461) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0461) uint64 {
