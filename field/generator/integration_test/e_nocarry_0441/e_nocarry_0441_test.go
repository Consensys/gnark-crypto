...
var benchRese_nocarry_0441 e_nocarry_0441

func BenchmarkE_nocarry_0441SetBytes(b *testing.B) {
	var x e_nocarry_0441
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0441MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0441.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0441)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0441)
		}
	})
}

func BenchmarkE_nocarry_0441Inverse(b *testing.B) {
	var x e_nocarry_0441
	x.SetRandom()
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0441Butterfly(b *testing.B) {
	var x e_nocarry_0441
	x.SetRandom()
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0441)
	}
}

func BenchmarkE_nocarry_0441Exp(b *testing.B) {
	var x e_nocarry_0441
	x.SetRandom()
	benchRese_nocarry_0441.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0441Double(b *testing.B) {
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Double(&benchRese_nocarry_0441)
	}
}

func BenchmarkE_nocarry_0441Add(b *testing.B) {
	var x e_nocarry_0441
	x.SetRandom()
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Add(&x, &benchRese_nocarry_0441)
	}
}

func BenchmarkE_nocarry_0441Sub(b *testing.B) {
	var x e_nocarry_0441
	x.SetRandom()
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Sub(&x, &benchRese_nocarry_0441)
	}
}

func BenchmarkE_nocarry_0441Neg(b *testing.B) {
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Neg(&benchRese_nocarry_0441)
	}
}

func BenchmarkE_nocarry_0441Div(b *testing.B) {
	var x e_nocarry_0441
	x.SetRandom()
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Div(&x, &benchRese_nocarry_0441)
	}
}

func BenchmarkE_nocarry_0441FromMont(b *testing.B) {
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.FromMont()
	}
}

func BenchmarkE_nocarry_0441ToMont(b *testing.B) {
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.ToMont()
	}
}
func BenchmarkE_nocarry_0441Square(b *testing.B) {
	benchRese_nocarry_0441.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Square(&benchRese_nocarry_0441)
	}
}

func BenchmarkE_nocarry_0441Sqrt(b *testing.B) {
	var a e_nocarry_0441
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0441Mul(b *testing.B) {
	x := e_nocarry_0441{
	...
	benchRese_nocarry_0441.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Mul(&benchRese_nocarry_0441, &x)
	}
}

func BenchmarkE_nocarry_0441Cmp(b *testing.B) {
	x := e_nocarry_0441{
		16947362453632760598,
		12839385384840526762,
		921874035953427578,
	...
	benchRese_nocarry_0441 = x
	benchRese_nocarry_0441[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0441.Cmp(&x)
	}
}

func TestE_nocarry_0441Cmp(t *testing.T) {
	var x, y e_nocarry_0441
...
func TestE_nocarry_0441IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0441
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0441

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0441{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0441
	one.SetOne()
	e.Sub(&qe_nocarry_0441, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0441{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0441{0, uint64(i)})
	}
...
func TestE_nocarry_0441NegZero(t *testing.T) {
	var a, b e_nocarry_0441
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0441Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0441, len(staticTestValues))
...
func TestE_nocarry_0441Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0441) bool {
			var b e_nocarry_0441
...
func TestE_nocarry_0441InverseExp(t *testing.T) {
...
func TestE_nocarry_0441MulByConstants(t *testing.T) {
...
func TestE_nocarry_0441Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0441) bool {
...
func TestE_nocarry_0441LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0441Halve(t *testing.T) {
...
func TestE_nocarry_0441FromMont(t *testing.T) {
...
type testPaire_nocarry_0441 struct {
	element e_nocarry_0441
	bigint  big.Int
}

func (z *e_nocarry_0441) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0441[6] {
		return true
	}
	if z[6] < qe_nocarry_0441[6] {
		return false
	...
	return z[0] >= qe_nocarry_0441[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0441

		g.element = e_nocarry_0441{
		...
		if qe_nocarry_0441[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0441[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0441 {
			var g e_nocarry_0441
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0441[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0441[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0441[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0441[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0441[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0441[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0441[6], carry)
...
func Benchmarke_nocarry_0441InverseNew(b *testing.B) {
	var x e_nocarry_0441
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0441
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0441
		var xInv e_nocarry_0441
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0441
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0441
...
func testLinearComb(t *testing.T, x *e_nocarry_0441, xC int64, y *e_nocarry_0441, yC int64) {
	...
	var z e_nocarry_0441
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0441, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0441
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0441, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0441
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0441, xHi uint64) {
	var res e_nocarry_0441
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0441) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0441) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0441, c int64, result *e_nocarry_0441, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0441) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0441) uint64 {
