...
var benchRese_nocarry_0647 e_nocarry_0647

func BenchmarkE_nocarry_0647SetBytes(b *testing.B) {
	var x e_nocarry_0647
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0647MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0647.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0647)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0647)
		}
	})
}

func BenchmarkE_nocarry_0647Inverse(b *testing.B) {
	var x e_nocarry_0647
	x.SetRandom()
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0647Butterfly(b *testing.B) {
	var x e_nocarry_0647
	x.SetRandom()
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0647)
	}
}

func BenchmarkE_nocarry_0647Exp(b *testing.B) {
	var x e_nocarry_0647
	x.SetRandom()
	benchRese_nocarry_0647.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0647Double(b *testing.B) {
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Double(&benchRese_nocarry_0647)
	}
}

func BenchmarkE_nocarry_0647Add(b *testing.B) {
	var x e_nocarry_0647
	x.SetRandom()
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Add(&x, &benchRese_nocarry_0647)
	}
}

func BenchmarkE_nocarry_0647Sub(b *testing.B) {
	var x e_nocarry_0647
	x.SetRandom()
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Sub(&x, &benchRese_nocarry_0647)
	}
}

func BenchmarkE_nocarry_0647Neg(b *testing.B) {
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Neg(&benchRese_nocarry_0647)
	}
}

func BenchmarkE_nocarry_0647Div(b *testing.B) {
	var x e_nocarry_0647
	x.SetRandom()
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Div(&x, &benchRese_nocarry_0647)
	}
}

func BenchmarkE_nocarry_0647FromMont(b *testing.B) {
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.FromMont()
	}
}

func BenchmarkE_nocarry_0647ToMont(b *testing.B) {
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.ToMont()
	}
}
func BenchmarkE_nocarry_0647Square(b *testing.B) {
	benchRese_nocarry_0647.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Square(&benchRese_nocarry_0647)
	}
}

func BenchmarkE_nocarry_0647Sqrt(b *testing.B) {
	var a e_nocarry_0647
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0647Mul(b *testing.B) {
	x := e_nocarry_0647{
	...
	benchRese_nocarry_0647.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Mul(&benchRese_nocarry_0647, &x)
	}
}

func BenchmarkE_nocarry_0647Cmp(b *testing.B) {
	x := e_nocarry_0647{
		10708125690772578027,
		1191968799868018464,
		3154163425282332139,
	...
	benchRese_nocarry_0647 = x
	benchRese_nocarry_0647[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0647.Cmp(&x)
	}
}

func TestE_nocarry_0647Cmp(t *testing.T) {
	var x, y e_nocarry_0647
...
func TestE_nocarry_0647IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0647
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0647

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0647{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0647
	one.SetOne()
	e.Sub(&qe_nocarry_0647, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0647{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0647{0, uint64(i)})
	}
...
func TestE_nocarry_0647NegZero(t *testing.T) {
	var a, b e_nocarry_0647
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0647Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0647, len(staticTestValues))
...
func TestE_nocarry_0647Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0647) bool {
			var b e_nocarry_0647
...
func TestE_nocarry_0647InverseExp(t *testing.T) {
...
func TestE_nocarry_0647MulByConstants(t *testing.T) {
...
func TestE_nocarry_0647Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0647) bool {
...
func TestE_nocarry_0647LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0647Halve(t *testing.T) {
...
func TestE_nocarry_0647FromMont(t *testing.T) {
...
type testPaire_nocarry_0647 struct {
	element e_nocarry_0647
	bigint  big.Int
}

func (z *e_nocarry_0647) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0647[10] {
		return true
	}
	if z[10] < qe_nocarry_0647[10] {
		return false
	...
	return z[0] >= qe_nocarry_0647[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0647

		g.element = e_nocarry_0647{
		...
		if qe_nocarry_0647[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0647[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0647 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0647[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0647[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0647[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0647[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0647[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0647[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0647[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0647[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0647[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0647[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0647[10], carry)
...
func Benchmarke_nocarry_0647InverseNew(b *testing.B) {
	var x e_nocarry_0647
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0647
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0647
		var xInv e_nocarry_0647
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0647
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0647
...
func testLinearComb(t *testing.T, x *e_nocarry_0647, xC int64, y *e_nocarry_0647, yC int64) {
	...
	var z e_nocarry_0647
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0647, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0647
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0647, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0647
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0647, xHi uint64) {
	var res e_nocarry_0647
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0647) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0647) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0647, c int64, result *e_nocarry_0647, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0647) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0647) uint64 {
