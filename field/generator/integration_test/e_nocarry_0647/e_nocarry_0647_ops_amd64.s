...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xd67e64f0ab4c61f1, R14
	ADDQ R14, AX
	MOVQ $0x719f3d9086660171, R14
	ADCQ R14, DX
	MOVQ $0x9c11c528ca107cb8, R14
	ADCQ R14, CX
	MOVQ $0x2b69b1a5b57751f6, R14
	ADCQ R14, BX
	MOVQ $0xf45805d04cdaa8ac, R14
	ADCQ R14, SI
	MOVQ $0x36302094991e7070, R14
	ADCQ R14, DI
	MOVQ $0xf44953040b9945e0, R14
	ADCQ R14, R8
	MOVQ $0x3e5fb47950659370, R14
	ADCQ R14, R9
	MOVQ $0x23774a0c99099663, R14
	ADCQ R14, R10
	MOVQ $0x69705e1f0a111346, R14
	ADCQ R14, R11
	MOVQ $0x0000000000000078, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xd67e64f0ab4c61f1, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x719f3d9086660171, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x9c11c528ca107cb8, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x2b69b1a5b57751f6, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xf45805d04cdaa8ac, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x36302094991e7070, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xf44953040b9945e0, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x3e5fb47950659370, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x23774a0c99099663, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x69705e1f0a111346, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000000000078, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xd67e64f0ab4c61f1, AX
	ADDQ AX, DX
	MOVQ $0x719f3d9086660171, AX
	ADCQ AX, CX
	MOVQ $0x9c11c528ca107cb8, AX
	ADCQ AX, BX
	MOVQ $0x2b69b1a5b57751f6, AX
	ADCQ AX, SI
	MOVQ $0xf45805d04cdaa8ac, AX
	ADCQ AX, DI
	MOVQ $0x36302094991e7070, AX
	ADCQ AX, R8
	MOVQ $0xf44953040b9945e0, AX
	ADCQ AX, R9
	MOVQ $0x3e5fb47950659370, AX
	ADCQ AX, R10
	MOVQ $0x23774a0c99099663, AX
	ADCQ AX, R11
	MOVQ $0x69705e1f0a111346, AX
	ADCQ AX, R12
	MOVQ $0x0000000000000078, AX
	ADCQ AX, R13
