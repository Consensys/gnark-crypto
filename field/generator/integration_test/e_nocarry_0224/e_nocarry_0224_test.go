...
var benchRese_nocarry_0224 e_nocarry_0224

func BenchmarkE_nocarry_0224SetBytes(b *testing.B) {
	var x e_nocarry_0224
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0224MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0224.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0224)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0224)
		}
	})
}

func BenchmarkE_nocarry_0224Inverse(b *testing.B) {
	var x e_nocarry_0224
	x.SetRandom()
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0224Butterfly(b *testing.B) {
	var x e_nocarry_0224
	x.SetRandom()
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0224)
	}
}

func BenchmarkE_nocarry_0224Exp(b *testing.B) {
	var x e_nocarry_0224
	x.SetRandom()
	benchRese_nocarry_0224.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0224Double(b *testing.B) {
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Double(&benchRese_nocarry_0224)
	}
}

func BenchmarkE_nocarry_0224Add(b *testing.B) {
	var x e_nocarry_0224
	x.SetRandom()
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Add(&x, &benchRese_nocarry_0224)
	}
}

func BenchmarkE_nocarry_0224Sub(b *testing.B) {
	var x e_nocarry_0224
	x.SetRandom()
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Sub(&x, &benchRese_nocarry_0224)
	}
}

func BenchmarkE_nocarry_0224Neg(b *testing.B) {
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Neg(&benchRese_nocarry_0224)
	}
}

func BenchmarkE_nocarry_0224Div(b *testing.B) {
	var x e_nocarry_0224
	x.SetRandom()
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Div(&x, &benchRese_nocarry_0224)
	}
}

func BenchmarkE_nocarry_0224FromMont(b *testing.B) {
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.FromMont()
	}
}

func BenchmarkE_nocarry_0224ToMont(b *testing.B) {
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.ToMont()
	}
}
func BenchmarkE_nocarry_0224Square(b *testing.B) {
	benchRese_nocarry_0224.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Square(&benchRese_nocarry_0224)
	}
}

func BenchmarkE_nocarry_0224Sqrt(b *testing.B) {
	var a e_nocarry_0224
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0224Mul(b *testing.B) {
	x := e_nocarry_0224{
		8546624552584946967,
		6003258818101960325,
	...
	benchRese_nocarry_0224.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Mul(&benchRese_nocarry_0224, &x)
	}
}

func BenchmarkE_nocarry_0224Cmp(b *testing.B) {
	x := e_nocarry_0224{
		8546624552584946967,
		6003258818101960325,
		10956101099902828536,
	...
	benchRese_nocarry_0224 = x
	benchRese_nocarry_0224[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0224.Cmp(&x)
	}
}

func TestE_nocarry_0224Cmp(t *testing.T) {
	var x, y e_nocarry_0224
...
func TestE_nocarry_0224IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0224
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0224

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0224{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0224
	one.SetOne()
	e.Sub(&qe_nocarry_0224, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0224{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0224{0, uint64(i)})
	}
...
func TestE_nocarry_0224NegZero(t *testing.T) {
	var a, b e_nocarry_0224
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0224Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0224, len(staticTestValues))
...
func TestE_nocarry_0224Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0224) bool {
			var b e_nocarry_0224
...
func TestE_nocarry_0224InverseExp(t *testing.T) {
...
func TestE_nocarry_0224MulByConstants(t *testing.T) {
...
func TestE_nocarry_0224Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0224) bool {
...
func TestE_nocarry_0224LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0224Halve(t *testing.T) {
...
func TestE_nocarry_0224FromMont(t *testing.T) {
...
type testPaire_nocarry_0224 struct {
	element e_nocarry_0224
	bigint  big.Int
}

func (z *e_nocarry_0224) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0224[3] {
		return true
	}
	if z[3] < qe_nocarry_0224[3] {
		return false
	...
	return z[0] >= qe_nocarry_0224[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0224

		g.element = e_nocarry_0224{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0224[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0224[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0224 {
			var g e_nocarry_0224
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0224[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0224[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0224[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0224[3], carry)
...
func Benchmarke_nocarry_0224InverseNew(b *testing.B) {
	var x e_nocarry_0224
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0224
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0224
		var xInv e_nocarry_0224
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0224
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0224
...
func testLinearComb(t *testing.T, x *e_nocarry_0224, xC int64, y *e_nocarry_0224, yC int64) {
	...
	var z e_nocarry_0224
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0224, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0224
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0224, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0224
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0224, xHi uint64) {
	var res e_nocarry_0224
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0224) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0224) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0224, c int64, result *e_nocarry_0224, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0224) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0224) uint64 {
