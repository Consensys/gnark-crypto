...
// modulus q
DATA q<>+0(SB)/8, $0x1a4c41453ce8816f
DATA q<>+8(SB)/8, $0xad63398e341cb964
DATA q<>+16(SB)/8, $0x3b6c2948a9a52ff7
DATA q<>+24(SB)/8, $0xa40f28b87ebee569
DATA q<>+32(SB)/8, $0x00000001ebef2889
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x672429bf93640271
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x1a4c41453ce8816f, R9
	MOVQ    $0xad63398e341cb964, R10
	MOVQ    $0x3b6c2948a9a52ff7, R11
	MOVQ    $0xa40f28b87ebee569, R12
	MOVQ    $0x00000001ebef2889, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xad63398e341cb964, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x3b6c2948a9a52ff7, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xa40f28b87ebee569, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00000001ebef2889, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x1a4c41453ce8816f, CX
	MOVQ    $0xad63398e341cb964, BX
	MOVQ    $0x3b6c2948a9a52ff7, SI
	MOVQ    $0xa40f28b87ebee569, DI
	MOVQ    $0x00000001ebef2889, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
