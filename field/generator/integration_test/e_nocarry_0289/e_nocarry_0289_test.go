...
var benchRese_nocarry_0289 e_nocarry_0289

func BenchmarkE_nocarry_0289SetBytes(b *testing.B) {
	var x e_nocarry_0289
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0289MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0289.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0289)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0289)
		}
	})
}

func BenchmarkE_nocarry_0289Inverse(b *testing.B) {
	var x e_nocarry_0289
	x.SetRandom()
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0289Butterfly(b *testing.B) {
	var x e_nocarry_0289
	x.SetRandom()
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0289)
	}
}

func BenchmarkE_nocarry_0289Exp(b *testing.B) {
	var x e_nocarry_0289
	x.SetRandom()
	benchRese_nocarry_0289.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0289Double(b *testing.B) {
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Double(&benchRese_nocarry_0289)
	}
}

func BenchmarkE_nocarry_0289Add(b *testing.B) {
	var x e_nocarry_0289
	x.SetRandom()
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Add(&x, &benchRese_nocarry_0289)
	}
}

func BenchmarkE_nocarry_0289Sub(b *testing.B) {
	var x e_nocarry_0289
	x.SetRandom()
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Sub(&x, &benchRese_nocarry_0289)
	}
}

func BenchmarkE_nocarry_0289Neg(b *testing.B) {
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Neg(&benchRese_nocarry_0289)
	}
}

func BenchmarkE_nocarry_0289Div(b *testing.B) {
	var x e_nocarry_0289
	x.SetRandom()
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Div(&x, &benchRese_nocarry_0289)
	}
}

func BenchmarkE_nocarry_0289FromMont(b *testing.B) {
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.FromMont()
	}
}

func BenchmarkE_nocarry_0289ToMont(b *testing.B) {
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.ToMont()
	}
}
func BenchmarkE_nocarry_0289Square(b *testing.B) {
	benchRese_nocarry_0289.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Square(&benchRese_nocarry_0289)
	}
}

func BenchmarkE_nocarry_0289Sqrt(b *testing.B) {
	var a e_nocarry_0289
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0289Mul(b *testing.B) {
	x := e_nocarry_0289{
		6076647676195910020,
		7750164384804103021,
	...
	benchRese_nocarry_0289.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Mul(&benchRese_nocarry_0289, &x)
	}
}

func BenchmarkE_nocarry_0289Cmp(b *testing.B) {
	x := e_nocarry_0289{
		6076647676195910020,
		7750164384804103021,
		12866401926692830400,
	...
	benchRese_nocarry_0289 = x
	benchRese_nocarry_0289[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0289.Cmp(&x)
	}
}

func TestE_nocarry_0289Cmp(t *testing.T) {
	var x, y e_nocarry_0289
...
func TestE_nocarry_0289IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0289
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0289

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0289{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0289
	one.SetOne()
	e.Sub(&qe_nocarry_0289, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0289{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0289{0, uint64(i)})
	}
...
func TestE_nocarry_0289NegZero(t *testing.T) {
	var a, b e_nocarry_0289
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0289Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0289, len(staticTestValues))
...
func TestE_nocarry_0289Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0289) bool {
			var b e_nocarry_0289
...
func TestE_nocarry_0289InverseExp(t *testing.T) {
...
func TestE_nocarry_0289MulByConstants(t *testing.T) {
...
func TestE_nocarry_0289Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0289) bool {
...
func TestE_nocarry_0289LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0289Halve(t *testing.T) {
...
func TestE_nocarry_0289FromMont(t *testing.T) {
...
type testPaire_nocarry_0289 struct {
	element e_nocarry_0289
	bigint  big.Int
}

func (z *e_nocarry_0289) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0289[4] {
		return true
	}
	if z[4] < qe_nocarry_0289[4] {
		return false
	...
	return z[0] >= qe_nocarry_0289[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0289

		g.element = e_nocarry_0289{
		...
		if qe_nocarry_0289[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0289[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0289 {
			var g e_nocarry_0289
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0289[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0289[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0289[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0289[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0289[4], carry)
...
func Benchmarke_nocarry_0289InverseNew(b *testing.B) {
	var x e_nocarry_0289
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0289
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0289
		var xInv e_nocarry_0289
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0289
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0289
...
func testLinearComb(t *testing.T, x *e_nocarry_0289, xC int64, y *e_nocarry_0289, yC int64) {
	...
	var z e_nocarry_0289
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0289, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0289
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0289, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0289
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0289, xHi uint64) {
	var res e_nocarry_0289
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0289) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0289) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0289, c int64, result *e_nocarry_0289, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0289) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0289) uint64 {
