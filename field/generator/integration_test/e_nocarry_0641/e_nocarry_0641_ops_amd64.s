...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xf8413f6a6eb826af, R14
	ADDQ R14, AX
	MOVQ $0x06027d52def8b616, R14
	ADCQ R14, DX
	MOVQ $0x484678a7a17025d2, R14
	ADCQ R14, CX
	MOVQ $0x282df802b14a4de8, R14
	ADCQ R14, BX
	MOVQ $0xe821fad8a2a86fc3, R14
	ADCQ R14, SI
	MOVQ $0x3044f5c1e147de50, R14
	ADCQ R14, DI
	MOVQ $0x6830b12b5bdadc0e, R14
	ADCQ R14, R8
	MOVQ $0x611d7fddf4e1b9bb, R14
	ADCQ R14, R9
	MOVQ $0x98712d8a31895514, R14
	ADCQ R14, R10
	MOVQ $0x8759767196ac8dea, R14
	ADCQ R14, R11
	MOVQ $1, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf8413f6a6eb826af, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x06027d52def8b616, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x484678a7a17025d2, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x282df802b14a4de8, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xe821fad8a2a86fc3, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x3044f5c1e147de50, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x6830b12b5bdadc0e, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x611d7fddf4e1b9bb, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x98712d8a31895514, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x8759767196ac8dea, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $1, R15
	SBBQ  R13, R15
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xf8413f6a6eb826af, AX
	ADDQ AX, DX
	MOVQ $0x06027d52def8b616, AX
	ADCQ AX, CX
	MOVQ $0x484678a7a17025d2, AX
	ADCQ AX, BX
	MOVQ $0x282df802b14a4de8, AX
	ADCQ AX, SI
	MOVQ $0xe821fad8a2a86fc3, AX
	ADCQ AX, DI
	MOVQ $0x3044f5c1e147de50, AX
	ADCQ AX, R8
	MOVQ $0x6830b12b5bdadc0e, AX
	ADCQ AX, R9
	MOVQ $0x611d7fddf4e1b9bb, AX
	ADCQ AX, R10
	MOVQ $0x98712d8a31895514, AX
	ADCQ AX, R11
	MOVQ $0x8759767196ac8dea, AX
	ADCQ AX, R12
	MOVQ $1, AX
	ADCQ AX, R13
