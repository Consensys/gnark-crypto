...
// modulus q
DATA q<>+0(SB)/8, $0xf8413f6a6eb826af
DATA q<>+8(SB)/8, $0x06027d52def8b616
DATA q<>+16(SB)/8, $0x484678a7a17025d2
DATA q<>+24(SB)/8, $0x282df802b14a4de8
DATA q<>+32(SB)/8, $0xe821fad8a2a86fc3
DATA q<>+40(SB)/8, $0x3044f5c1e147de50
DATA q<>+48(SB)/8, $0x6830b12b5bdadc0e
DATA q<>+56(SB)/8, $0x611d7fddf4e1b9bb
DATA q<>+64(SB)/8, $0x98712d8a31895514
DATA q<>+72(SB)/8, $0x8759767196ac8dea
DATA q<>+80(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xd82a4a4268670fb1
