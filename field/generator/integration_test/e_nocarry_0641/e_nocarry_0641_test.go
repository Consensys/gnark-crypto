...
var benchRese_nocarry_0641 e_nocarry_0641

func BenchmarkE_nocarry_0641SetBytes(b *testing.B) {
	var x e_nocarry_0641
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0641MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0641.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0641)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0641)
		}
	})
}

func BenchmarkE_nocarry_0641Inverse(b *testing.B) {
	var x e_nocarry_0641
	x.SetRandom()
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0641Butterfly(b *testing.B) {
	var x e_nocarry_0641
	x.SetRandom()
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0641)
	}
}

func BenchmarkE_nocarry_0641Exp(b *testing.B) {
	var x e_nocarry_0641
	x.SetRandom()
	benchRese_nocarry_0641.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0641Double(b *testing.B) {
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Double(&benchRese_nocarry_0641)
	}
}

func BenchmarkE_nocarry_0641Add(b *testing.B) {
	var x e_nocarry_0641
	x.SetRandom()
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Add(&x, &benchRese_nocarry_0641)
	}
}

func BenchmarkE_nocarry_0641Sub(b *testing.B) {
	var x e_nocarry_0641
	x.SetRandom()
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Sub(&x, &benchRese_nocarry_0641)
	}
}

func BenchmarkE_nocarry_0641Neg(b *testing.B) {
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Neg(&benchRese_nocarry_0641)
	}
}

func BenchmarkE_nocarry_0641Div(b *testing.B) {
	var x e_nocarry_0641
	x.SetRandom()
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Div(&x, &benchRese_nocarry_0641)
	}
}

func BenchmarkE_nocarry_0641FromMont(b *testing.B) {
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.FromMont()
	}
}

func BenchmarkE_nocarry_0641ToMont(b *testing.B) {
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.ToMont()
	}
}
func BenchmarkE_nocarry_0641Square(b *testing.B) {
	benchRese_nocarry_0641.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Square(&benchRese_nocarry_0641)
	}
}

func BenchmarkE_nocarry_0641Sqrt(b *testing.B) {
	var a e_nocarry_0641
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0641Mul(b *testing.B) {
	x := e_nocarry_0641{
		8963071071313559465,
	...
	benchRese_nocarry_0641.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Mul(&benchRese_nocarry_0641, &x)
	}
}

func BenchmarkE_nocarry_0641Cmp(b *testing.B) {
	x := e_nocarry_0641{
		8963071071313559465,
		15774596732821324473,
		5921281765636991020,
	...
	benchRese_nocarry_0641 = x
	benchRese_nocarry_0641[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0641.Cmp(&x)
	}
}

func TestE_nocarry_0641Cmp(t *testing.T) {
	var x, y e_nocarry_0641
...
func TestE_nocarry_0641IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0641
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0641

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0641{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0641
	one.SetOne()
	e.Sub(&qe_nocarry_0641, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0641{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0641{0, uint64(i)})
	}
...
func TestE_nocarry_0641NegZero(t *testing.T) {
	var a, b e_nocarry_0641
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0641Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0641, len(staticTestValues))
...
func TestE_nocarry_0641Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0641) bool {
			var b e_nocarry_0641
...
func TestE_nocarry_0641InverseExp(t *testing.T) {
...
func TestE_nocarry_0641MulByConstants(t *testing.T) {
...
func TestE_nocarry_0641Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0641) bool {
...
func TestE_nocarry_0641LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0641Halve(t *testing.T) {
...
func TestE_nocarry_0641FromMont(t *testing.T) {
...
type testPaire_nocarry_0641 struct {
	element e_nocarry_0641
	bigint  big.Int
}

func (z *e_nocarry_0641) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0641[10] {
		return true
	}
	if z[10] < qe_nocarry_0641[10] {
		return false
	...
	return z[0] >= qe_nocarry_0641[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0641

		g.element = e_nocarry_0641{
		...
		if qe_nocarry_0641[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0641[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0641 {
			var g e_nocarry_0641
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0641[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0641[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0641[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0641[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0641[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0641[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0641[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0641[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0641[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0641[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0641[10], carry)
...
func Benchmarke_nocarry_0641InverseNew(b *testing.B) {
	var x e_nocarry_0641
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0641
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0641
		var xInv e_nocarry_0641
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0641
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0641
...
func testLinearComb(t *testing.T, x *e_nocarry_0641, xC int64, y *e_nocarry_0641, yC int64) {
	...
	var z e_nocarry_0641
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0641, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0641
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0641, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0641
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0641, xHi uint64) {
	var res e_nocarry_0641
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0641) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0641) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0641, c int64, result *e_nocarry_0641, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0641) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0641) uint64 {
