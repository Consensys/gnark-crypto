...
var benchRese_nocarry_0648 e_nocarry_0648

func BenchmarkE_nocarry_0648SetBytes(b *testing.B) {
	var x e_nocarry_0648
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0648MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0648.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0648)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0648)
		}
	})
}

func BenchmarkE_nocarry_0648Inverse(b *testing.B) {
	var x e_nocarry_0648
	x.SetRandom()
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0648Butterfly(b *testing.B) {
	var x e_nocarry_0648
	x.SetRandom()
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0648)
	}
}

func BenchmarkE_nocarry_0648Exp(b *testing.B) {
	var x e_nocarry_0648
	x.SetRandom()
	benchRese_nocarry_0648.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0648Double(b *testing.B) {
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Double(&benchRese_nocarry_0648)
	}
}

func BenchmarkE_nocarry_0648Add(b *testing.B) {
	var x e_nocarry_0648
	x.SetRandom()
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Add(&x, &benchRese_nocarry_0648)
	}
}

func BenchmarkE_nocarry_0648Sub(b *testing.B) {
	var x e_nocarry_0648
	x.SetRandom()
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Sub(&x, &benchRese_nocarry_0648)
	}
}

func BenchmarkE_nocarry_0648Neg(b *testing.B) {
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Neg(&benchRese_nocarry_0648)
	}
}

func BenchmarkE_nocarry_0648Div(b *testing.B) {
	var x e_nocarry_0648
	x.SetRandom()
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Div(&x, &benchRese_nocarry_0648)
	}
}

func BenchmarkE_nocarry_0648FromMont(b *testing.B) {
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.FromMont()
	}
}

func BenchmarkE_nocarry_0648ToMont(b *testing.B) {
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.ToMont()
	}
}
func BenchmarkE_nocarry_0648Square(b *testing.B) {
	benchRese_nocarry_0648.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Square(&benchRese_nocarry_0648)
	}
}

func BenchmarkE_nocarry_0648Sqrt(b *testing.B) {
	var a e_nocarry_0648
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0648Mul(b *testing.B) {
	x := e_nocarry_0648{
		6187623617203330549,
		1776212903594484505,
		8858189860533620077,
	...
	benchRese_nocarry_0648.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Mul(&benchRese_nocarry_0648, &x)
	}
}

func BenchmarkE_nocarry_0648Cmp(b *testing.B) {
	x := e_nocarry_0648{
		6187623617203330549,
		1776212903594484505,
		8858189860533620077,
	...
	benchRese_nocarry_0648 = x
	benchRese_nocarry_0648[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0648.Cmp(&x)
	}
}

func TestE_nocarry_0648Cmp(t *testing.T) {
	var x, y e_nocarry_0648
...
func TestE_nocarry_0648IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0648
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0648

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0648{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0648
	one.SetOne()
	e.Sub(&qe_nocarry_0648, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0648{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0648{0, uint64(i)})
	}
...
func TestE_nocarry_0648NegZero(t *testing.T) {
	var a, b e_nocarry_0648
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0648Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0648, len(staticTestValues))
...
func TestE_nocarry_0648Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0648) bool {
			var b e_nocarry_0648
...
func TestE_nocarry_0648InverseExp(t *testing.T) {
...
func TestE_nocarry_0648MulByConstants(t *testing.T) {
...
func TestE_nocarry_0648Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0648) bool {
...
func TestE_nocarry_0648LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0648Halve(t *testing.T) {
...
func TestE_nocarry_0648FromMont(t *testing.T) {
...
type testPaire_nocarry_0648 struct {
	element e_nocarry_0648
	bigint  big.Int
}

func (z *e_nocarry_0648) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0648[10] {
		return true
	}
	if z[10] < qe_nocarry_0648[10] {
		return false
	...
	return z[0] >= qe_nocarry_0648[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0648

		g.element = e_nocarry_0648{
		...
		if qe_nocarry_0648[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0648[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0648 {
			var g e_nocarry_0648
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0648[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0648[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0648[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0648[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0648[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0648[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0648[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0648[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0648[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0648[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0648[10], carry)
...
func Benchmarke_nocarry_0648InverseNew(b *testing.B) {
	var x e_nocarry_0648
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0648
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0648
		var xInv e_nocarry_0648
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0648
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0648
...
func testLinearComb(t *testing.T, x *e_nocarry_0648, xC int64, y *e_nocarry_0648, yC int64) {
	...
	var z e_nocarry_0648
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0648, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0648
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0648, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0648
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0648, xHi uint64) {
	var res e_nocarry_0648
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0648) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0648) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0648, c int64, result *e_nocarry_0648, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0648) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0648) uint64 {
