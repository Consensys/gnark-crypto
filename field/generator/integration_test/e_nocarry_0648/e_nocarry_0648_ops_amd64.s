...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xb2cde8ac4fe49c7d, R14
	ADDQ R14, AX
	MOVQ $0xb99b4abfecd589c8, R14
	ADCQ R14, DX
	MOVQ $0xdcbfe7816eb55138, R14
	ADCQ R14, CX
	MOVQ $0x73adaa7ba74e88dc, R14
	ADCQ R14, BX
	MOVQ $0x14cd02898798fdc4, R14
	ADCQ R14, SI
	MOVQ $0xb99fb8449061d841, R14
	ADCQ R14, DI
	MOVQ $0xf0671cd530d81749, R14
	ADCQ R14, R8
	MOVQ $0x27c227f809f87dc3, R14
	ADCQ R14, R9
	MOVQ $0x62fc6dca00c475aa, R14
	ADCQ R14, R10
	MOVQ $0x71ccd57f7c4a66df, R14
	ADCQ R14, R11
	MOVQ $0x00000000000000fd, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xb2cde8ac4fe49c7d, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xb99b4abfecd589c8, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xdcbfe7816eb55138, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x73adaa7ba74e88dc, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x14cd02898798fdc4, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xb99fb8449061d841, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xf0671cd530d81749, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x27c227f809f87dc3, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x62fc6dca00c475aa, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x71ccd57f7c4a66df, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000000000fd, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xb2cde8ac4fe49c7d, AX
	ADDQ AX, DX
	MOVQ $0xb99b4abfecd589c8, AX
	ADCQ AX, CX
	MOVQ $0xdcbfe7816eb55138, AX
	ADCQ AX, BX
	MOVQ $0x73adaa7ba74e88dc, AX
	ADCQ AX, SI
	MOVQ $0x14cd02898798fdc4, AX
	ADCQ AX, DI
	MOVQ $0xb99fb8449061d841, AX
	ADCQ AX, R8
	MOVQ $0xf0671cd530d81749, AX
	ADCQ AX, R9
	MOVQ $0x27c227f809f87dc3, AX
	ADCQ AX, R10
	MOVQ $0x62fc6dca00c475aa, AX
	ADCQ AX, R11
	MOVQ $0x71ccd57f7c4a66df, AX
	ADCQ AX, R12
	MOVQ $0x00000000000000fd, AX
	ADCQ AX, R13
