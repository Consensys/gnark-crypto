...
var benchRese_nocarry_0607 e_nocarry_0607

func BenchmarkE_nocarry_0607SetBytes(b *testing.B) {
	var x e_nocarry_0607
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0607MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0607.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0607)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0607)
		}
	})
}

func BenchmarkE_nocarry_0607Inverse(b *testing.B) {
	var x e_nocarry_0607
	x.SetRandom()
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0607Butterfly(b *testing.B) {
	var x e_nocarry_0607
	x.SetRandom()
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0607)
	}
}

func BenchmarkE_nocarry_0607Exp(b *testing.B) {
	var x e_nocarry_0607
	x.SetRandom()
	benchRese_nocarry_0607.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0607Double(b *testing.B) {
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Double(&benchRese_nocarry_0607)
	}
}

func BenchmarkE_nocarry_0607Add(b *testing.B) {
	var x e_nocarry_0607
	x.SetRandom()
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Add(&x, &benchRese_nocarry_0607)
	}
}

func BenchmarkE_nocarry_0607Sub(b *testing.B) {
	var x e_nocarry_0607
	x.SetRandom()
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Sub(&x, &benchRese_nocarry_0607)
	}
}

func BenchmarkE_nocarry_0607Neg(b *testing.B) {
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Neg(&benchRese_nocarry_0607)
	}
}

func BenchmarkE_nocarry_0607Div(b *testing.B) {
	var x e_nocarry_0607
	x.SetRandom()
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Div(&x, &benchRese_nocarry_0607)
	}
}

func BenchmarkE_nocarry_0607FromMont(b *testing.B) {
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.FromMont()
	}
}

func BenchmarkE_nocarry_0607ToMont(b *testing.B) {
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.ToMont()
	}
}
func BenchmarkE_nocarry_0607Square(b *testing.B) {
	benchRese_nocarry_0607.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Square(&benchRese_nocarry_0607)
	}
}

func BenchmarkE_nocarry_0607Sqrt(b *testing.B) {
	var a e_nocarry_0607
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0607Mul(b *testing.B) {
	x := e_nocarry_0607{
		826315536305558778,
		578734316270910561,
	...
	benchRese_nocarry_0607.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Mul(&benchRese_nocarry_0607, &x)
	}
}

func BenchmarkE_nocarry_0607Cmp(b *testing.B) {
	x := e_nocarry_0607{
		826315536305558778,
		578734316270910561,
		11233695296615024961,
	...
	benchRese_nocarry_0607 = x
	benchRese_nocarry_0607[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0607.Cmp(&x)
	}
}

func TestE_nocarry_0607Cmp(t *testing.T) {
	var x, y e_nocarry_0607
...
func TestE_nocarry_0607IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0607
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0607

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0607{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0607
	one.SetOne()
	e.Sub(&qe_nocarry_0607, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0607{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0607{0, uint64(i)})
	}
...
func TestE_nocarry_0607NegZero(t *testing.T) {
	var a, b e_nocarry_0607
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0607Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0607, len(staticTestValues))
...
func TestE_nocarry_0607Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0607) bool {
			var b e_nocarry_0607
...
func TestE_nocarry_0607InverseExp(t *testing.T) {
...
func TestE_nocarry_0607MulByConstants(t *testing.T) {
...
func TestE_nocarry_0607Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0607) bool {
...
func TestE_nocarry_0607LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0607Halve(t *testing.T) {
...
func TestE_nocarry_0607FromMont(t *testing.T) {
...
type testPaire_nocarry_0607 struct {
	element e_nocarry_0607
	bigint  big.Int
}

func (z *e_nocarry_0607) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0607[9] {
		return true
	}
	if z[9] < qe_nocarry_0607[9] {
		return false
	...
	return z[0] >= qe_nocarry_0607[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0607

		g.element = e_nocarry_0607{
		...
		if qe_nocarry_0607[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0607[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0607 {
			var g e_nocarry_0607
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0607[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0607[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0607[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0607[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0607[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0607[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0607[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0607[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0607[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0607[9], carry)
...
func Benchmarke_nocarry_0607InverseNew(b *testing.B) {
	var x e_nocarry_0607
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0607
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0607
		var xInv e_nocarry_0607
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0607
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0607
...
func testLinearComb(t *testing.T, x *e_nocarry_0607, xC int64, y *e_nocarry_0607, yC int64) {
	...
	var z e_nocarry_0607
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0607, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0607
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0607, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0607
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0607, xHi uint64) {
	var res e_nocarry_0607
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0607) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0607) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0607, c int64, result *e_nocarry_0607, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0607) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0607) uint64 {
