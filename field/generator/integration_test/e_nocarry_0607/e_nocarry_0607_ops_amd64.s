...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x10d6bb764b04bdaf, R13
	ADDQ R13, AX
	MOVQ $0x94068b81eb40bdff, R13
	ADCQ R13, DX
	MOVQ $0x716792702b31333f, R13
	ADCQ R13, CX
	MOVQ $0xc8425549556ac761, R13
	ADCQ R13, BX
	MOVQ $0x48ce28c8c454fad0, R13
	ADCQ R13, SI
	MOVQ $0x5e8f8b676ca1d46b, R13
	ADCQ R13, DI
	MOVQ $0xc44271e59d32a145, R13
	ADCQ R13, R8
	MOVQ $0xc6c50967e8bd8db1, R13
	ADCQ R13, R9
	MOVQ $0x540a710d27ac0742, R13
	ADCQ R13, R10
	MOVQ $0x0000000077163bcb, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x10d6bb764b04bdaf, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x94068b81eb40bdff, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x716792702b31333f, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xc8425549556ac761, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x48ce28c8c454fad0, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x5e8f8b676ca1d46b, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xc44271e59d32a145, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xc6c50967e8bd8db1, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x540a710d27ac0742, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000077163bcb, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x10d6bb764b04bdaf, AX
	ADDQ AX, DX
	MOVQ $0x94068b81eb40bdff, AX
	ADCQ AX, CX
	MOVQ $0x716792702b31333f, AX
	ADCQ AX, BX
	MOVQ $0xc8425549556ac761, AX
	ADCQ AX, SI
	MOVQ $0x48ce28c8c454fad0, AX
	ADCQ AX, DI
	MOVQ $0x5e8f8b676ca1d46b, AX
	ADCQ AX, R8
	MOVQ $0xc44271e59d32a145, AX
	ADCQ AX, R9
	MOVQ $0xc6c50967e8bd8db1, AX
	ADCQ AX, R10
	MOVQ $0x540a710d27ac0742, AX
	ADCQ AX, R11
	MOVQ $0x0000000077163bcb, AX
	ADCQ AX, R12
