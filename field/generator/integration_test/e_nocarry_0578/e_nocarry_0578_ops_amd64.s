...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xf5326687c23afd95, R13
	ADDQ R13, AX
	MOVQ $0x4f26daf287ae48e2, R13
	ADCQ R13, DX
	MOVQ $0xbea0792c48178b54, R13
	ADCQ R13, CX
	MOVQ $0x98f5ede4c425bfde, R13
	ADCQ R13, BX
	MOVQ $0x866bb3783e55525d, R13
	ADCQ R13, SI
	MOVQ $0xcba667b29e87c262, R13
	ADCQ R13, DI
	MOVQ $0xeb3d7cb8a8147c17, R13
	ADCQ R13, R8
	MOVQ $0x347fd457d48d54d7, R13
	ADCQ R13, R9
	MOVQ $0xfec5c5be5db2031e, R13
	ADCQ R13, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf5326687c23afd95, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x4f26daf287ae48e2, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xbea0792c48178b54, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x98f5ede4c425bfde, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x866bb3783e55525d, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xcba667b29e87c262, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xeb3d7cb8a8147c17, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x347fd457d48d54d7, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xfec5c5be5db2031e, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xf5326687c23afd95, AX
	ADDQ AX, DX
	MOVQ $0x4f26daf287ae48e2, AX
	ADCQ AX, CX
	MOVQ $0xbea0792c48178b54, AX
	ADCQ AX, BX
	MOVQ $0x98f5ede4c425bfde, AX
	ADCQ AX, SI
	MOVQ $0x866bb3783e55525d, AX
	ADCQ AX, DI
	MOVQ $0xcba667b29e87c262, AX
	ADCQ AX, R8
	MOVQ $0xeb3d7cb8a8147c17, AX
	ADCQ AX, R9
	MOVQ $0x347fd457d48d54d7, AX
	ADCQ AX, R10
	MOVQ $0xfec5c5be5db2031e, AX
	ADCQ AX, R11
