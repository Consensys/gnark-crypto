...
var benchRese_nocarry_0578 e_nocarry_0578

func BenchmarkE_nocarry_0578SetBytes(b *testing.B) {
	var x e_nocarry_0578
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0578MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0578.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0578)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0578)
		}
	})
}

func BenchmarkE_nocarry_0578Inverse(b *testing.B) {
	var x e_nocarry_0578
	x.SetRandom()
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0578Butterfly(b *testing.B) {
	var x e_nocarry_0578
	x.SetRandom()
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0578)
	}
}

func BenchmarkE_nocarry_0578Exp(b *testing.B) {
	var x e_nocarry_0578
	x.SetRandom()
	benchRese_nocarry_0578.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0578Double(b *testing.B) {
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Double(&benchRese_nocarry_0578)
	}
}

func BenchmarkE_nocarry_0578Add(b *testing.B) {
	var x e_nocarry_0578
	x.SetRandom()
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Add(&x, &benchRese_nocarry_0578)
	}
}

func BenchmarkE_nocarry_0578Sub(b *testing.B) {
	var x e_nocarry_0578
	x.SetRandom()
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Sub(&x, &benchRese_nocarry_0578)
	}
}

func BenchmarkE_nocarry_0578Neg(b *testing.B) {
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Neg(&benchRese_nocarry_0578)
	}
}

func BenchmarkE_nocarry_0578Div(b *testing.B) {
	var x e_nocarry_0578
	x.SetRandom()
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Div(&x, &benchRese_nocarry_0578)
	}
}

func BenchmarkE_nocarry_0578FromMont(b *testing.B) {
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.FromMont()
	}
}

func BenchmarkE_nocarry_0578ToMont(b *testing.B) {
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.ToMont()
	}
}
func BenchmarkE_nocarry_0578Square(b *testing.B) {
	benchRese_nocarry_0578.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Square(&benchRese_nocarry_0578)
	}
}

func BenchmarkE_nocarry_0578Sqrt(b *testing.B) {
	var a e_nocarry_0578
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0578Mul(b *testing.B) {
	x := e_nocarry_0578{
	...
	benchRese_nocarry_0578.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Mul(&benchRese_nocarry_0578, &x)
	}
}

func BenchmarkE_nocarry_0578Cmp(b *testing.B) {
	x := e_nocarry_0578{
		14029086145273395259,
		13591518371223582168,
		17625094197834409120,
	...
	benchRese_nocarry_0578 = x
	benchRese_nocarry_0578[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0578.Cmp(&x)
	}
}

func TestE_nocarry_0578Cmp(t *testing.T) {
	var x, y e_nocarry_0578
...
func TestE_nocarry_0578IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0578
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0578

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0578{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0578
	one.SetOne()
	e.Sub(&qe_nocarry_0578, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0578{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0578{0, uint64(i)})
	}
...
func TestE_nocarry_0578NegZero(t *testing.T) {
	var a, b e_nocarry_0578
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0578Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0578, len(staticTestValues))
...
func TestE_nocarry_0578Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0578) bool {
			var b e_nocarry_0578
...
func TestE_nocarry_0578InverseExp(t *testing.T) {
...
func TestE_nocarry_0578MulByConstants(t *testing.T) {
...
func TestE_nocarry_0578Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0578) bool {
...
func TestE_nocarry_0578LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0578Halve(t *testing.T) {
...
func TestE_nocarry_0578FromMont(t *testing.T) {
...
type testPaire_nocarry_0578 struct {
	element e_nocarry_0578
	bigint  big.Int
}

func (z *e_nocarry_0578) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0578[9] {
		return true
	}
	if z[9] < qe_nocarry_0578[9] {
		return false
	...
	return z[0] >= qe_nocarry_0578[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0578

		g.element = e_nocarry_0578{
		...
		if qe_nocarry_0578[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0578[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0578 {
			var g e_nocarry_0578
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0578[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0578[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0578[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0578[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0578[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0578[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0578[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0578[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0578[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0578[9], carry)
...
func Benchmarke_nocarry_0578InverseNew(b *testing.B) {
	var x e_nocarry_0578
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0578
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0578
		var xInv e_nocarry_0578
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0578
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0578
...
func testLinearComb(t *testing.T, x *e_nocarry_0578, xC int64, y *e_nocarry_0578, yC int64) {
	...
	var z e_nocarry_0578
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0578, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0578
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0578, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0578
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0578, xHi uint64) {
	var res e_nocarry_0578
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0578) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0578) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0578, c int64, result *e_nocarry_0578, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0578) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0578) uint64 {
