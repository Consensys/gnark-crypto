...
var benchRese_nocarry_0458 e_nocarry_0458

func BenchmarkE_nocarry_0458SetBytes(b *testing.B) {
	var x e_nocarry_0458
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0458MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0458.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0458)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0458)
		}
	})
}

func BenchmarkE_nocarry_0458Inverse(b *testing.B) {
	var x e_nocarry_0458
	x.SetRandom()
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0458Butterfly(b *testing.B) {
	var x e_nocarry_0458
	x.SetRandom()
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0458)
	}
}

func BenchmarkE_nocarry_0458Exp(b *testing.B) {
	var x e_nocarry_0458
	x.SetRandom()
	benchRese_nocarry_0458.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0458Double(b *testing.B) {
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Double(&benchRese_nocarry_0458)
	}
}

func BenchmarkE_nocarry_0458Add(b *testing.B) {
	var x e_nocarry_0458
	x.SetRandom()
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Add(&x, &benchRese_nocarry_0458)
	}
}

func BenchmarkE_nocarry_0458Sub(b *testing.B) {
	var x e_nocarry_0458
	x.SetRandom()
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Sub(&x, &benchRese_nocarry_0458)
	}
}

func BenchmarkE_nocarry_0458Neg(b *testing.B) {
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Neg(&benchRese_nocarry_0458)
	}
}

func BenchmarkE_nocarry_0458Div(b *testing.B) {
	var x e_nocarry_0458
	x.SetRandom()
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Div(&x, &benchRese_nocarry_0458)
	}
}

func BenchmarkE_nocarry_0458FromMont(b *testing.B) {
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.FromMont()
	}
}

func BenchmarkE_nocarry_0458ToMont(b *testing.B) {
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.ToMont()
	}
}
func BenchmarkE_nocarry_0458Square(b *testing.B) {
	benchRese_nocarry_0458.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Square(&benchRese_nocarry_0458)
	}
}

func BenchmarkE_nocarry_0458Sqrt(b *testing.B) {
	var a e_nocarry_0458
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0458Mul(b *testing.B) {
	x := e_nocarry_0458{
		5349483498299135824,
		1873040421466137618,
		6435843496992423758,
	...
	benchRese_nocarry_0458.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Mul(&benchRese_nocarry_0458, &x)
	}
}

func BenchmarkE_nocarry_0458Cmp(b *testing.B) {
	x := e_nocarry_0458{
		5349483498299135824,
		1873040421466137618,
		6435843496992423758,
	...
	benchRese_nocarry_0458 = x
	benchRese_nocarry_0458[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0458.Cmp(&x)
	}
}

func TestE_nocarry_0458Cmp(t *testing.T) {
	var x, y e_nocarry_0458
...
func TestE_nocarry_0458IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0458
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0458

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0458{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0458
	one.SetOne()
	e.Sub(&qe_nocarry_0458, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0458{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0458{0, uint64(i)})
	}
...
func TestE_nocarry_0458NegZero(t *testing.T) {
	var a, b e_nocarry_0458
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0458Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0458, len(staticTestValues))
...
func TestE_nocarry_0458Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0458) bool {
			var b e_nocarry_0458
...
func TestE_nocarry_0458InverseExp(t *testing.T) {
...
func TestE_nocarry_0458MulByConstants(t *testing.T) {
...
func TestE_nocarry_0458Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0458) bool {
...
func TestE_nocarry_0458LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0458Halve(t *testing.T) {
...
func TestE_nocarry_0458FromMont(t *testing.T) {
...
type testPaire_nocarry_0458 struct {
	element e_nocarry_0458
	bigint  big.Int
}

func (z *e_nocarry_0458) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0458[7] {
		return true
	}
	if z[7] < qe_nocarry_0458[7] {
		return false
	...
	return z[0] >= qe_nocarry_0458[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0458

		g.element = e_nocarry_0458{
		...
		if qe_nocarry_0458[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0458[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0458 {
			var g e_nocarry_0458
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0458[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0458[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0458[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0458[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0458[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0458[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0458[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0458[7], carry)
...
func Benchmarke_nocarry_0458InverseNew(b *testing.B) {
	var x e_nocarry_0458
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0458
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0458
		var xInv e_nocarry_0458
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0458
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0458
...
func testLinearComb(t *testing.T, x *e_nocarry_0458, xC int64, y *e_nocarry_0458, yC int64) {
	...
	var z e_nocarry_0458
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0458, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0458
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0458, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0458
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0458, xHi uint64) {
	var res e_nocarry_0458
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0458) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0458) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0458, c int64, result *e_nocarry_0458, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0458) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0458) uint64 {
