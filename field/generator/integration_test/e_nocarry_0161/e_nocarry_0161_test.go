...
var benchRese_nocarry_0161 e_nocarry_0161

func BenchmarkE_nocarry_0161SetBytes(b *testing.B) {
	var x e_nocarry_0161
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0161MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0161.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0161)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0161)
		}
	})
}

func BenchmarkE_nocarry_0161Inverse(b *testing.B) {
	var x e_nocarry_0161
	x.SetRandom()
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0161Butterfly(b *testing.B) {
	var x e_nocarry_0161
	x.SetRandom()
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0161)
	}
}

func BenchmarkE_nocarry_0161Exp(b *testing.B) {
	var x e_nocarry_0161
	x.SetRandom()
	benchRese_nocarry_0161.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0161Double(b *testing.B) {
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Double(&benchRese_nocarry_0161)
	}
}

func BenchmarkE_nocarry_0161Add(b *testing.B) {
	var x e_nocarry_0161
	x.SetRandom()
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Add(&x, &benchRese_nocarry_0161)
	}
}

func BenchmarkE_nocarry_0161Sub(b *testing.B) {
	var x e_nocarry_0161
	x.SetRandom()
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Sub(&x, &benchRese_nocarry_0161)
	}
}

func BenchmarkE_nocarry_0161Neg(b *testing.B) {
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Neg(&benchRese_nocarry_0161)
	}
}

func BenchmarkE_nocarry_0161Div(b *testing.B) {
	var x e_nocarry_0161
	x.SetRandom()
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Div(&x, &benchRese_nocarry_0161)
	}
}

func BenchmarkE_nocarry_0161FromMont(b *testing.B) {
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.FromMont()
	}
}

func BenchmarkE_nocarry_0161ToMont(b *testing.B) {
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.ToMont()
	}
}
func BenchmarkE_nocarry_0161Square(b *testing.B) {
	benchRese_nocarry_0161.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Square(&benchRese_nocarry_0161)
	}
}

func BenchmarkE_nocarry_0161Sqrt(b *testing.B) {
	var a e_nocarry_0161
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0161Mul(b *testing.B) {
	x := e_nocarry_0161{
		4205583108537576808,
		2714380001167781019,
		4618534648,
	}
	benchRese_nocarry_0161.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Mul(&benchRese_nocarry_0161, &x)
	}
}

func BenchmarkE_nocarry_0161Cmp(b *testing.B) {
	x := e_nocarry_0161{
		4205583108537576808,
		2714380001167781019,
		4618534648,
	}
	benchRese_nocarry_0161 = x
	benchRese_nocarry_0161[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0161.Cmp(&x)
	}
}

func TestE_nocarry_0161Cmp(t *testing.T) {
	var x, y e_nocarry_0161
...
func TestE_nocarry_0161IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0161
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0161

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0161{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0161
	one.SetOne()
	e.Sub(&qe_nocarry_0161, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0161{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0161{0, uint64(i)})
	}
...
func TestE_nocarry_0161NegZero(t *testing.T) {
	var a, b e_nocarry_0161
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0161Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0161, len(staticTestValues))
...
func TestE_nocarry_0161Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0161) bool {
			var b e_nocarry_0161
...
func TestE_nocarry_0161InverseExp(t *testing.T) {
...
func TestE_nocarry_0161MulByConstants(t *testing.T) {
...
func TestE_nocarry_0161Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0161) bool {
...
func TestE_nocarry_0161LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0161Halve(t *testing.T) {
...
func TestE_nocarry_0161FromMont(t *testing.T) {
...
type testPaire_nocarry_0161 struct {
	element e_nocarry_0161
	bigint  big.Int
}

func (z *e_nocarry_0161) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0161[2] {
		return true
	}
	if z[2] < qe_nocarry_0161[2] {
		return false
	...
	return z[0] >= qe_nocarry_0161[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0161

		g.element = e_nocarry_0161{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0161[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0161[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0161 {
			var g e_nocarry_0161
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0161[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0161[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0161[2], carry)
...
func Benchmarke_nocarry_0161InverseNew(b *testing.B) {
	var x e_nocarry_0161
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0161
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0161
		var xInv e_nocarry_0161
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0161
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0161
...
func testLinearComb(t *testing.T, x *e_nocarry_0161, xC int64, y *e_nocarry_0161, yC int64) {
	...
	var z e_nocarry_0161
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0161, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0161
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0161, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0161
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0161, xHi uint64) {
	var res e_nocarry_0161
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0161) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0161) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0161, c int64, result *e_nocarry_0161, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0161) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0161) uint64 {
