...
var benchRese_nocarry_0261 e_nocarry_0261

func BenchmarkE_nocarry_0261SetBytes(b *testing.B) {
	var x e_nocarry_0261
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0261MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0261.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0261)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0261)
		}
	})
}

func BenchmarkE_nocarry_0261Inverse(b *testing.B) {
	var x e_nocarry_0261
	x.SetRandom()
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0261Butterfly(b *testing.B) {
	var x e_nocarry_0261
	x.SetRandom()
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0261)
	}
}

func BenchmarkE_nocarry_0261Exp(b *testing.B) {
	var x e_nocarry_0261
	x.SetRandom()
	benchRese_nocarry_0261.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0261Double(b *testing.B) {
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Double(&benchRese_nocarry_0261)
	}
}

func BenchmarkE_nocarry_0261Add(b *testing.B) {
	var x e_nocarry_0261
	x.SetRandom()
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Add(&x, &benchRese_nocarry_0261)
	}
}

func BenchmarkE_nocarry_0261Sub(b *testing.B) {
	var x e_nocarry_0261
	x.SetRandom()
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Sub(&x, &benchRese_nocarry_0261)
	}
}

func BenchmarkE_nocarry_0261Neg(b *testing.B) {
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Neg(&benchRese_nocarry_0261)
	}
}

func BenchmarkE_nocarry_0261Div(b *testing.B) {
	var x e_nocarry_0261
	x.SetRandom()
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Div(&x, &benchRese_nocarry_0261)
	}
}

func BenchmarkE_nocarry_0261FromMont(b *testing.B) {
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.FromMont()
	}
}

func BenchmarkE_nocarry_0261ToMont(b *testing.B) {
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.ToMont()
	}
}
func BenchmarkE_nocarry_0261Square(b *testing.B) {
	benchRese_nocarry_0261.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Square(&benchRese_nocarry_0261)
	}
}

func BenchmarkE_nocarry_0261Sqrt(b *testing.B) {
	var a e_nocarry_0261
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0261Mul(b *testing.B) {
	x := e_nocarry_0261{
		3771983693975468420,
	...
	benchRese_nocarry_0261.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Mul(&benchRese_nocarry_0261, &x)
	}
}

func BenchmarkE_nocarry_0261Cmp(b *testing.B) {
	x := e_nocarry_0261{
		3771983693975468420,
		10524889266252846235,
		16266758008831368748,
	...
	benchRese_nocarry_0261 = x
	benchRese_nocarry_0261[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0261.Cmp(&x)
	}
}

func TestE_nocarry_0261Cmp(t *testing.T) {
	var x, y e_nocarry_0261
...
func TestE_nocarry_0261IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0261
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0261

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0261{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0261
	one.SetOne()
	e.Sub(&qe_nocarry_0261, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0261{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0261{0, uint64(i)})
	}
...
func TestE_nocarry_0261NegZero(t *testing.T) {
	var a, b e_nocarry_0261
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0261Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0261, len(staticTestValues))
...
func TestE_nocarry_0261Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0261) bool {
			var b e_nocarry_0261
...
func TestE_nocarry_0261InverseExp(t *testing.T) {
...
func TestE_nocarry_0261MulByConstants(t *testing.T) {
...
func TestE_nocarry_0261Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0261) bool {
...
func TestE_nocarry_0261LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0261Halve(t *testing.T) {
...
func TestE_nocarry_0261FromMont(t *testing.T) {
...
type testPaire_nocarry_0261 struct {
	element e_nocarry_0261
	bigint  big.Int
}

func (z *e_nocarry_0261) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0261[4] {
		return true
	}
	if z[4] < qe_nocarry_0261[4] {
		return false
	...
	return z[0] >= qe_nocarry_0261[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0261

		g.element = e_nocarry_0261{
		...
		if qe_nocarry_0261[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0261[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0261 {
			var g e_nocarry_0261
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0261[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0261[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0261[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0261[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0261[4], carry)
...
func Benchmarke_nocarry_0261InverseNew(b *testing.B) {
	var x e_nocarry_0261
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0261
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0261
		var xInv e_nocarry_0261
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0261
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0261
...
func testLinearComb(t *testing.T, x *e_nocarry_0261, xC int64, y *e_nocarry_0261, yC int64) {
	...
	var z e_nocarry_0261
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0261, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0261
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0261, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0261
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0261, xHi uint64) {
	var res e_nocarry_0261
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0261) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0261) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0261, c int64, result *e_nocarry_0261, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0261) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0261) uint64 {
