...
// modulus q
DATA q<>+0(SB)/8, $0x4b27d44b83d3656f
DATA q<>+8(SB)/8, $0xcfac9fa724458db3
DATA q<>+16(SB)/8, $0xfe5fdf4538dd63e8
DATA q<>+24(SB)/8, $0xe9fd4e4d3a194483
DATA q<>+32(SB)/8, $0x0000000000000019
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xae26ef44381a6671
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x4b27d44b83d3656f, R9
	MOVQ    $0xcfac9fa724458db3, R10
	MOVQ    $0xfe5fdf4538dd63e8, R11
	MOVQ    $0xe9fd4e4d3a194483, R12
	MOVQ    $0x0000000000000019, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xcfac9fa724458db3, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xfe5fdf4538dd63e8, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xe9fd4e4d3a194483, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000000019, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x4b27d44b83d3656f, CX
	MOVQ    $0xcfac9fa724458db3, BX
	MOVQ    $0xfe5fdf4538dd63e8, SI
	MOVQ    $0xe9fd4e4d3a194483, DI
	MOVQ    $0x0000000000000019, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
