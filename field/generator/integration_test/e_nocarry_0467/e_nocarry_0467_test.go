...
var benchRese_nocarry_0467 e_nocarry_0467

func BenchmarkE_nocarry_0467SetBytes(b *testing.B) {
	var x e_nocarry_0467
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0467MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0467.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0467)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0467)
		}
	})
}

func BenchmarkE_nocarry_0467Inverse(b *testing.B) {
	var x e_nocarry_0467
	x.SetRandom()
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0467Butterfly(b *testing.B) {
	var x e_nocarry_0467
	x.SetRandom()
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0467)
	}
}

func BenchmarkE_nocarry_0467Exp(b *testing.B) {
	var x e_nocarry_0467
	x.SetRandom()
	benchRese_nocarry_0467.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0467Double(b *testing.B) {
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Double(&benchRese_nocarry_0467)
	}
}

func BenchmarkE_nocarry_0467Add(b *testing.B) {
	var x e_nocarry_0467
	x.SetRandom()
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Add(&x, &benchRese_nocarry_0467)
	}
}

func BenchmarkE_nocarry_0467Sub(b *testing.B) {
	var x e_nocarry_0467
	x.SetRandom()
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Sub(&x, &benchRese_nocarry_0467)
	}
}

func BenchmarkE_nocarry_0467Neg(b *testing.B) {
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Neg(&benchRese_nocarry_0467)
	}
}

func BenchmarkE_nocarry_0467Div(b *testing.B) {
	var x e_nocarry_0467
	x.SetRandom()
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Div(&x, &benchRese_nocarry_0467)
	}
}

func BenchmarkE_nocarry_0467FromMont(b *testing.B) {
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.FromMont()
	}
}

func BenchmarkE_nocarry_0467ToMont(b *testing.B) {
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.ToMont()
	}
}
func BenchmarkE_nocarry_0467Square(b *testing.B) {
	benchRese_nocarry_0467.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Square(&benchRese_nocarry_0467)
	}
}

func BenchmarkE_nocarry_0467Sqrt(b *testing.B) {
	var a e_nocarry_0467
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0467Mul(b *testing.B) {
	x := e_nocarry_0467{
	...
	benchRese_nocarry_0467.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Mul(&benchRese_nocarry_0467, &x)
	}
}

func BenchmarkE_nocarry_0467Cmp(b *testing.B) {
	x := e_nocarry_0467{
		16480305457117968220,
		12069069484883263054,
		12023408818813274291,
	...
	benchRese_nocarry_0467 = x
	benchRese_nocarry_0467[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0467.Cmp(&x)
	}
}

func TestE_nocarry_0467Cmp(t *testing.T) {
	var x, y e_nocarry_0467
...
func TestE_nocarry_0467IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0467
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0467

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0467{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0467
	one.SetOne()
	e.Sub(&qe_nocarry_0467, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0467{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0467{0, uint64(i)})
	}
...
func TestE_nocarry_0467NegZero(t *testing.T) {
	var a, b e_nocarry_0467
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0467Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0467, len(staticTestValues))
...
func TestE_nocarry_0467Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0467) bool {
			var b e_nocarry_0467
...
func TestE_nocarry_0467InverseExp(t *testing.T) {
...
func TestE_nocarry_0467MulByConstants(t *testing.T) {
...
func TestE_nocarry_0467Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0467) bool {
...
func TestE_nocarry_0467LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0467Halve(t *testing.T) {
...
func TestE_nocarry_0467FromMont(t *testing.T) {
...
type testPaire_nocarry_0467 struct {
	element e_nocarry_0467
	bigint  big.Int
}

func (z *e_nocarry_0467) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0467[7] {
		return true
	}
	if z[7] < qe_nocarry_0467[7] {
		return false
	...
	return z[0] >= qe_nocarry_0467[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0467

		g.element = e_nocarry_0467{
		...
		if qe_nocarry_0467[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0467[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0467 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0467[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0467[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0467[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0467[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0467[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0467[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0467[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0467[7], carry)
...
func Benchmarke_nocarry_0467InverseNew(b *testing.B) {
	var x e_nocarry_0467
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0467
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0467
		var xInv e_nocarry_0467
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0467
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0467
...
func testLinearComb(t *testing.T, x *e_nocarry_0467, xC int64, y *e_nocarry_0467, yC int64) {
	...
	var z e_nocarry_0467
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0467, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0467
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0467, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0467
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0467, xHi uint64) {
	var res e_nocarry_0467
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0467) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0467) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0467, c int64, result *e_nocarry_0467, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0467) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0467) uint64 {
