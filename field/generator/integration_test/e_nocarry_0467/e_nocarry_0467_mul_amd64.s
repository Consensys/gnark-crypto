...
// modulus q
DATA q<>+0(SB)/8, $0xb66c85d703a2be19
DATA q<>+8(SB)/8, $0x849d4227de5490d3
DATA q<>+16(SB)/8, $0xeff3f000c774e83d
DATA q<>+24(SB)/8, $0x87542d5550a73c2d
DATA q<>+32(SB)/8, $0x4dcc78f3bb83839a
DATA q<>+40(SB)/8, $0xe201952915ae6175
DATA q<>+48(SB)/8, $0x409ea7413f5d76e0
DATA q<>+56(SB)/8, $0x0000000000077ca1
GLOBL q<>(SB), (RODATA+NOPTR), $64

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x121815c9063e41d7
