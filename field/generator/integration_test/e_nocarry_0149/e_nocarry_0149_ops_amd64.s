...
// modulus q
DATA q<>+0(SB)/8, $0x99fcf34625c10fab
DATA q<>+8(SB)/8, $0x7775840a5e41de81
DATA q<>+16(SB)/8, $0x00000000001ae96c
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x8960b75118e68cfd
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x99fcf34625c10fab, DI
	MOVQ    $0x7775840a5e41de81, R8
	MOVQ    $0x00000000001ae96c, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x7775840a5e41de81, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x00000000001ae96c, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x99fcf34625c10fab, R10
	MOVQ    $0x7775840a5e41de81, R11
	MOVQ    $0x00000000001ae96c, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
