...
var benchRese_nocarry_0149 e_nocarry_0149

func BenchmarkE_nocarry_0149SetBytes(b *testing.B) {
	var x e_nocarry_0149
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0149MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0149.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0149)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0149)
		}
	})
}

func BenchmarkE_nocarry_0149Inverse(b *testing.B) {
	var x e_nocarry_0149
	x.SetRandom()
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0149Butterfly(b *testing.B) {
	var x e_nocarry_0149
	x.SetRandom()
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0149)
	}
}

func BenchmarkE_nocarry_0149Exp(b *testing.B) {
	var x e_nocarry_0149
	x.SetRandom()
	benchRese_nocarry_0149.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0149Double(b *testing.B) {
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Double(&benchRese_nocarry_0149)
	}
}

func BenchmarkE_nocarry_0149Add(b *testing.B) {
	var x e_nocarry_0149
	x.SetRandom()
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Add(&x, &benchRese_nocarry_0149)
	}
}

func BenchmarkE_nocarry_0149Sub(b *testing.B) {
	var x e_nocarry_0149
	x.SetRandom()
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Sub(&x, &benchRese_nocarry_0149)
	}
}

func BenchmarkE_nocarry_0149Neg(b *testing.B) {
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Neg(&benchRese_nocarry_0149)
	}
}

func BenchmarkE_nocarry_0149Div(b *testing.B) {
	var x e_nocarry_0149
	x.SetRandom()
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Div(&x, &benchRese_nocarry_0149)
	}
}

func BenchmarkE_nocarry_0149FromMont(b *testing.B) {
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.FromMont()
	}
}

func BenchmarkE_nocarry_0149ToMont(b *testing.B) {
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.ToMont()
	}
}
func BenchmarkE_nocarry_0149Square(b *testing.B) {
	benchRese_nocarry_0149.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Square(&benchRese_nocarry_0149)
	}
}

func BenchmarkE_nocarry_0149Sqrt(b *testing.B) {
	var a e_nocarry_0149
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0149Mul(b *testing.B) {
	x := e_nocarry_0149{
		881152551750901404,
		527473579918095287,
		1763025,
	}
	benchRese_nocarry_0149.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Mul(&benchRese_nocarry_0149, &x)
	}
}

func BenchmarkE_nocarry_0149Cmp(b *testing.B) {
	x := e_nocarry_0149{
		881152551750901404,
		527473579918095287,
		1763025,
	}
	benchRese_nocarry_0149 = x
	benchRese_nocarry_0149[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0149.Cmp(&x)
	}
}

func TestE_nocarry_0149Cmp(t *testing.T) {
	var x, y e_nocarry_0149
...
func TestE_nocarry_0149IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0149
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0149

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0149{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0149
	one.SetOne()
	e.Sub(&qe_nocarry_0149, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0149{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0149{0, uint64(i)})
	}
...
func TestE_nocarry_0149NegZero(t *testing.T) {
	var a, b e_nocarry_0149
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0149Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0149, len(staticTestValues))
...
func TestE_nocarry_0149Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0149) bool {
			var b e_nocarry_0149
...
func TestE_nocarry_0149InverseExp(t *testing.T) {
...
func TestE_nocarry_0149MulByConstants(t *testing.T) {
...
func TestE_nocarry_0149Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0149) bool {
...
func TestE_nocarry_0149LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0149Halve(t *testing.T) {
...
func TestE_nocarry_0149FromMont(t *testing.T) {
...
type testPaire_nocarry_0149 struct {
	element e_nocarry_0149
	bigint  big.Int
}

func (z *e_nocarry_0149) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0149[2] {
		return true
	}
	if z[2] < qe_nocarry_0149[2] {
		return false
	...
	return z[0] >= qe_nocarry_0149[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0149

		g.element = e_nocarry_0149{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0149[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0149[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0149 {
			var g e_nocarry_0149
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0149[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0149[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0149[2], carry)
...
func Benchmarke_nocarry_0149InverseNew(b *testing.B) {
	var x e_nocarry_0149
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0149
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0149
		var xInv e_nocarry_0149
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0149
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0149
...
func testLinearComb(t *testing.T, x *e_nocarry_0149, xC int64, y *e_nocarry_0149, yC int64) {
	...
	var z e_nocarry_0149
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0149, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0149
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0149, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0149
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0149, xHi uint64) {
	var res e_nocarry_0149
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0149) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0149) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0149, c int64, result *e_nocarry_0149, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0149) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0149) uint64 {
