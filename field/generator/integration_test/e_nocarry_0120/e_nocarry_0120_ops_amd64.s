...
// modulus q
DATA q<>+0(SB)/8, $0x28e143d35fc52553
DATA q<>+8(SB)/8, $0x00e481cd64a90b01
GLOBL q<>(SB), (RODATA+NOPTR), $16

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xb56f782734a19925
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SUBQ    0(CX), AX
	SBBQ    8(CX), DX
	MOVQ    $0x28e143d35fc52553, SI
	MOVQ    $0x00e481cd64a90b01, DI
	CMOVQCC BX, SI
	CMOVQCC BX, DI
	ADDQ    SI, AX
	ADCQ    DI, DX
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SUBQ    0(DX), SI
	SBBQ    8(DX), DI
	MOVQ    $0x28e143d35fc52553, R8
	MOVQ    $0x00e481cd64a90b01, R9
	CMOVQCC AX, R8
	CMOVQCC AX, R9
	ADDQ    R8, SI
	ADCQ    R9, DI
