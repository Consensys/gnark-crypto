...
var benchRese_nocarry_0120 e_nocarry_0120

func BenchmarkE_nocarry_0120SetBytes(b *testing.B) {
	var x e_nocarry_0120
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0120MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0120.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0120)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0120)
		}
	})
}

func BenchmarkE_nocarry_0120Inverse(b *testing.B) {
	var x e_nocarry_0120
	x.SetRandom()
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0120Butterfly(b *testing.B) {
	var x e_nocarry_0120
	x.SetRandom()
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0120)
	}
}

func BenchmarkE_nocarry_0120Exp(b *testing.B) {
	var x e_nocarry_0120
	x.SetRandom()
	benchRese_nocarry_0120.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0120Double(b *testing.B) {
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Double(&benchRese_nocarry_0120)
	}
}

func BenchmarkE_nocarry_0120Add(b *testing.B) {
	var x e_nocarry_0120
	x.SetRandom()
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Add(&x, &benchRese_nocarry_0120)
	}
}

func BenchmarkE_nocarry_0120Sub(b *testing.B) {
	var x e_nocarry_0120
	x.SetRandom()
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Sub(&x, &benchRese_nocarry_0120)
	}
}

func BenchmarkE_nocarry_0120Neg(b *testing.B) {
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Neg(&benchRese_nocarry_0120)
	}
}

func BenchmarkE_nocarry_0120Div(b *testing.B) {
	var x e_nocarry_0120
	x.SetRandom()
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Div(&x, &benchRese_nocarry_0120)
	}
}

func BenchmarkE_nocarry_0120FromMont(b *testing.B) {
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.FromMont()
	}
}

func BenchmarkE_nocarry_0120ToMont(b *testing.B) {
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.ToMont()
	}
}
func BenchmarkE_nocarry_0120Square(b *testing.B) {
	benchRese_nocarry_0120.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Square(&benchRese_nocarry_0120)
	}
}

func BenchmarkE_nocarry_0120Sqrt(b *testing.B) {
	var a e_nocarry_0120
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0120Mul(b *testing.B) {
	x := e_nocarry_0120{
		15467829366069508677,
		48593472195567039,
	}
	benchRese_nocarry_0120.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Mul(&benchRese_nocarry_0120, &x)
	}
}

func BenchmarkE_nocarry_0120Cmp(b *testing.B) {
	x := e_nocarry_0120{
		15467829366069508677,
		48593472195567039,
	}
	benchRese_nocarry_0120 = x
	benchRese_nocarry_0120[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0120.Cmp(&x)
	}
}

func TestE_nocarry_0120Cmp(t *testing.T) {
	var x, y e_nocarry_0120
...
func TestE_nocarry_0120IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0120
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0120

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0120{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0120
	one.SetOne()
	e.Sub(&qe_nocarry_0120, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0120{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0120{0, uint64(i)})
	}
...
func TestE_nocarry_0120NegZero(t *testing.T) {
	var a, b e_nocarry_0120
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0120Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0120, len(staticTestValues))
...
func TestE_nocarry_0120Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0120) bool {
			var b e_nocarry_0120
...
func TestE_nocarry_0120InverseExp(t *testing.T) {
...
func TestE_nocarry_0120MulByConstants(t *testing.T) {
...
func TestE_nocarry_0120Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0120) bool {
...
func TestE_nocarry_0120LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0120Halve(t *testing.T) {
...
func TestE_nocarry_0120FromMont(t *testing.T) {
...
type testPaire_nocarry_0120 struct {
	element e_nocarry_0120
	bigint  big.Int
}

func (z *e_nocarry_0120) biggerOrEqualModulus() bool {
	if z[1] > qe_nocarry_0120[1] {
		return true
	}
	if z[1] < qe_nocarry_0120[1] {
		return false
	...
	return z[0] >= qe_nocarry_0120[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0120

		g.element = e_nocarry_0120{
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0120[1] != ^uint64(0) {
			g.element[1] %= (qe_nocarry_0120[1] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0120 {
			var g e_nocarry_0120
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0120[0], carry)
		a[1], _ = bits.Add64(a[1], qe_nocarry_0120[1], carry)
...
func Benchmarke_nocarry_0120InverseNew(b *testing.B) {
	var x e_nocarry_0120
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0120
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0120
		var xInv e_nocarry_0120
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0120
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0120
...
func testLinearComb(t *testing.T, x *e_nocarry_0120, xC int64, y *e_nocarry_0120, yC int64) {
	...
	var z e_nocarry_0120
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0120, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0120
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0120, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0120
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0120, xHi uint64) {
	var res e_nocarry_0120
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0120) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0120) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0120, c int64, result *e_nocarry_0120, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0120) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0120) uint64 {
