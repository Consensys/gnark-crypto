...
var benchRese_nocarry_0386 e_nocarry_0386

func BenchmarkE_nocarry_0386SetBytes(b *testing.B) {
	var x e_nocarry_0386
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0386MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0386.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0386)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0386)
		}
	})
}

func BenchmarkE_nocarry_0386Inverse(b *testing.B) {
	var x e_nocarry_0386
	x.SetRandom()
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0386Butterfly(b *testing.B) {
	var x e_nocarry_0386
	x.SetRandom()
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0386)
	}
}

func BenchmarkE_nocarry_0386Exp(b *testing.B) {
	var x e_nocarry_0386
	x.SetRandom()
	benchRese_nocarry_0386.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0386Double(b *testing.B) {
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Double(&benchRese_nocarry_0386)
	}
}

func BenchmarkE_nocarry_0386Add(b *testing.B) {
	var x e_nocarry_0386
	x.SetRandom()
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Add(&x, &benchRese_nocarry_0386)
	}
}

func BenchmarkE_nocarry_0386Sub(b *testing.B) {
	var x e_nocarry_0386
	x.SetRandom()
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Sub(&x, &benchRese_nocarry_0386)
	}
}

func BenchmarkE_nocarry_0386Neg(b *testing.B) {
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Neg(&benchRese_nocarry_0386)
	}
}

func BenchmarkE_nocarry_0386Div(b *testing.B) {
	var x e_nocarry_0386
	x.SetRandom()
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Div(&x, &benchRese_nocarry_0386)
	}
}

func BenchmarkE_nocarry_0386FromMont(b *testing.B) {
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.FromMont()
	}
}

func BenchmarkE_nocarry_0386ToMont(b *testing.B) {
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.ToMont()
	}
}
func BenchmarkE_nocarry_0386Square(b *testing.B) {
	benchRese_nocarry_0386.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Square(&benchRese_nocarry_0386)
	}
}

func BenchmarkE_nocarry_0386Sqrt(b *testing.B) {
	var a e_nocarry_0386
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0386Mul(b *testing.B) {
	x := e_nocarry_0386{
	...
	benchRese_nocarry_0386.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Mul(&benchRese_nocarry_0386, &x)
	}
}

func BenchmarkE_nocarry_0386Cmp(b *testing.B) {
	x := e_nocarry_0386{
		14644833734917656820,
		7161948908683422762,
		8784252368152653206,
	...
	benchRese_nocarry_0386 = x
	benchRese_nocarry_0386[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0386.Cmp(&x)
	}
}

func TestE_nocarry_0386Cmp(t *testing.T) {
	var x, y e_nocarry_0386
...
func TestE_nocarry_0386IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0386
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0386

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0386{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0386
	one.SetOne()
	e.Sub(&qe_nocarry_0386, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0386{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0386{0, uint64(i)})
	}
...
func TestE_nocarry_0386NegZero(t *testing.T) {
	var a, b e_nocarry_0386
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0386Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0386, len(staticTestValues))
...
func TestE_nocarry_0386Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0386) bool {
			var b e_nocarry_0386
...
func TestE_nocarry_0386InverseExp(t *testing.T) {
...
func TestE_nocarry_0386MulByConstants(t *testing.T) {
...
func TestE_nocarry_0386Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0386) bool {
...
func TestE_nocarry_0386LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0386Halve(t *testing.T) {
...
func TestE_nocarry_0386FromMont(t *testing.T) {
...
type testPaire_nocarry_0386 struct {
	element e_nocarry_0386
	bigint  big.Int
}

func (z *e_nocarry_0386) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0386[6] {
		return true
	}
	if z[6] < qe_nocarry_0386[6] {
		return false
	...
	return z[0] >= qe_nocarry_0386[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0386

		g.element = e_nocarry_0386{
		...
		if qe_nocarry_0386[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0386[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0386 {
			var g e_nocarry_0386
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0386[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0386[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0386[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0386[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0386[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0386[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0386[6], carry)
...
func Benchmarke_nocarry_0386InverseNew(b *testing.B) {
	var x e_nocarry_0386
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0386
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0386
		var xInv e_nocarry_0386
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0386
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0386
...
func testLinearComb(t *testing.T, x *e_nocarry_0386, xC int64, y *e_nocarry_0386, yC int64) {
	...
	var z e_nocarry_0386
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0386, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0386
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0386, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0386
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0386, xHi uint64) {
	var res e_nocarry_0386
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0386) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0386) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0386, c int64, result *e_nocarry_0386, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0386) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0386) uint64 {
