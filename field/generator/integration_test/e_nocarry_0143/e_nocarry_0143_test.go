...
var benchRese_nocarry_0143 e_nocarry_0143

func BenchmarkE_nocarry_0143SetBytes(b *testing.B) {
	var x e_nocarry_0143
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0143MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0143.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0143)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0143)
		}
	})
}

func BenchmarkE_nocarry_0143Inverse(b *testing.B) {
	var x e_nocarry_0143
	x.SetRandom()
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0143Butterfly(b *testing.B) {
	var x e_nocarry_0143
	x.SetRandom()
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0143)
	}
}

func BenchmarkE_nocarry_0143Exp(b *testing.B) {
	var x e_nocarry_0143
	x.SetRandom()
	benchRese_nocarry_0143.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0143Double(b *testing.B) {
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Double(&benchRese_nocarry_0143)
	}
}

func BenchmarkE_nocarry_0143Add(b *testing.B) {
	var x e_nocarry_0143
	x.SetRandom()
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Add(&x, &benchRese_nocarry_0143)
	}
}

func BenchmarkE_nocarry_0143Sub(b *testing.B) {
	var x e_nocarry_0143
	x.SetRandom()
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Sub(&x, &benchRese_nocarry_0143)
	}
}

func BenchmarkE_nocarry_0143Neg(b *testing.B) {
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Neg(&benchRese_nocarry_0143)
	}
}

func BenchmarkE_nocarry_0143Div(b *testing.B) {
	var x e_nocarry_0143
	x.SetRandom()
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Div(&x, &benchRese_nocarry_0143)
	}
}

func BenchmarkE_nocarry_0143FromMont(b *testing.B) {
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.FromMont()
	}
}

func BenchmarkE_nocarry_0143ToMont(b *testing.B) {
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.ToMont()
	}
}
func BenchmarkE_nocarry_0143Square(b *testing.B) {
	benchRese_nocarry_0143.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Square(&benchRese_nocarry_0143)
	}
}

func BenchmarkE_nocarry_0143Sqrt(b *testing.B) {
	var a e_nocarry_0143
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0143Mul(b *testing.B) {
	x := e_nocarry_0143{
		8728959989547789789,
		4908205064349207121,
		7061,
	}
	benchRese_nocarry_0143.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Mul(&benchRese_nocarry_0143, &x)
	}
}

func BenchmarkE_nocarry_0143Cmp(b *testing.B) {
	x := e_nocarry_0143{
		8728959989547789789,
		4908205064349207121,
		7061,
	}
	benchRese_nocarry_0143 = x
	benchRese_nocarry_0143[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0143.Cmp(&x)
	}
}

func TestE_nocarry_0143Cmp(t *testing.T) {
	var x, y e_nocarry_0143
...
func TestE_nocarry_0143IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0143
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0143

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0143{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0143
	one.SetOne()
	e.Sub(&qe_nocarry_0143, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0143{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0143{0, uint64(i)})
	}
...
func TestE_nocarry_0143NegZero(t *testing.T) {
	var a, b e_nocarry_0143
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0143Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0143, len(staticTestValues))
...
func TestE_nocarry_0143Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0143) bool {
			var b e_nocarry_0143
...
func TestE_nocarry_0143InverseExp(t *testing.T) {
...
func TestE_nocarry_0143MulByConstants(t *testing.T) {
...
func TestE_nocarry_0143Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0143) bool {
...
func TestE_nocarry_0143LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0143Halve(t *testing.T) {
...
func TestE_nocarry_0143FromMont(t *testing.T) {
...
type testPaire_nocarry_0143 struct {
	element e_nocarry_0143
	bigint  big.Int
}

func (z *e_nocarry_0143) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0143[2] {
		return true
	}
	if z[2] < qe_nocarry_0143[2] {
		return false
	...
	return z[0] >= qe_nocarry_0143[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0143

		g.element = e_nocarry_0143{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0143[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0143[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0143 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0143[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0143[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0143[2], carry)
...
func Benchmarke_nocarry_0143InverseNew(b *testing.B) {
	var x e_nocarry_0143
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0143
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0143
		var xInv e_nocarry_0143
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0143
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0143
...
func testLinearComb(t *testing.T, x *e_nocarry_0143, xC int64, y *e_nocarry_0143, yC int64) {
	...
	var z e_nocarry_0143
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0143, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0143
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0143, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0143
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0143, xHi uint64) {
	var res e_nocarry_0143
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0143) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0143) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0143, c int64, result *e_nocarry_0143, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0143) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0143) uint64 {
