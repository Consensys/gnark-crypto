...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x3d8c8297a97f5d2f, R13
	ADDQ R13, AX
	MOVQ $0x3377fcb9ac02bae5, R13
	ADCQ R13, DX
	MOVQ $0x001bf8d78a9e6e09, R13
	ADCQ R13, CX
	MOVQ $0x02ebada53765d357, R13
	ADCQ R13, BX
	MOVQ $0xdea13df9e4f55110, R13
	ADCQ R13, SI
	MOVQ $0xda281fdb39725277, R13
	ADCQ R13, DI
	MOVQ $0xd70f91ed0e83f854, R13
	ADCQ R13, R8
	MOVQ $0x3ef6722aeab729b1, R13
	ADCQ R13, R9
	MOVQ $0x5c25cc19f0c2a792, R13
	ADCQ R13, R10
	MOVQ $0x000000f988525246, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x3d8c8297a97f5d2f, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x3377fcb9ac02bae5, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x001bf8d78a9e6e09, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x02ebada53765d357, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xdea13df9e4f55110, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xda281fdb39725277, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xd70f91ed0e83f854, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x3ef6722aeab729b1, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x5c25cc19f0c2a792, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000f988525246, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x3d8c8297a97f5d2f, AX
	ADDQ AX, DX
	MOVQ $0x3377fcb9ac02bae5, AX
	ADCQ AX, CX
	MOVQ $0x001bf8d78a9e6e09, AX
	ADCQ AX, BX
	MOVQ $0x02ebada53765d357, AX
	ADCQ AX, SI
	MOVQ $0xdea13df9e4f55110, AX
	ADCQ AX, DI
	MOVQ $0xda281fdb39725277, AX
	ADCQ AX, R8
	MOVQ $0xd70f91ed0e83f854, AX
	ADCQ AX, R9
	MOVQ $0x3ef6722aeab729b1, AX
	ADCQ AX, R10
	MOVQ $0x5c25cc19f0c2a792, AX
	ADCQ AX, R11
	MOVQ $0x000000f988525246, AX
	ADCQ AX, R12
