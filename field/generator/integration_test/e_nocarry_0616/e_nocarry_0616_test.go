...
var benchRese_nocarry_0616 e_nocarry_0616

func BenchmarkE_nocarry_0616SetBytes(b *testing.B) {
	var x e_nocarry_0616
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0616MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0616.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0616)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0616)
		}
	})
}

func BenchmarkE_nocarry_0616Inverse(b *testing.B) {
	var x e_nocarry_0616
	x.SetRandom()
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0616Butterfly(b *testing.B) {
	var x e_nocarry_0616
	x.SetRandom()
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0616)
	}
}

func BenchmarkE_nocarry_0616Exp(b *testing.B) {
	var x e_nocarry_0616
	x.SetRandom()
	benchRese_nocarry_0616.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0616Double(b *testing.B) {
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Double(&benchRese_nocarry_0616)
	}
}

func BenchmarkE_nocarry_0616Add(b *testing.B) {
	var x e_nocarry_0616
	x.SetRandom()
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Add(&x, &benchRese_nocarry_0616)
	}
}

func BenchmarkE_nocarry_0616Sub(b *testing.B) {
	var x e_nocarry_0616
	x.SetRandom()
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Sub(&x, &benchRese_nocarry_0616)
	}
}

func BenchmarkE_nocarry_0616Neg(b *testing.B) {
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Neg(&benchRese_nocarry_0616)
	}
}

func BenchmarkE_nocarry_0616Div(b *testing.B) {
	var x e_nocarry_0616
	x.SetRandom()
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Div(&x, &benchRese_nocarry_0616)
	}
}

func BenchmarkE_nocarry_0616FromMont(b *testing.B) {
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.FromMont()
	}
}

func BenchmarkE_nocarry_0616ToMont(b *testing.B) {
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.ToMont()
	}
}
func BenchmarkE_nocarry_0616Square(b *testing.B) {
	benchRese_nocarry_0616.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Square(&benchRese_nocarry_0616)
	}
}

func BenchmarkE_nocarry_0616Sqrt(b *testing.B) {
	var a e_nocarry_0616
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0616Mul(b *testing.B) {
	x := e_nocarry_0616{
	...
	benchRese_nocarry_0616.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Mul(&benchRese_nocarry_0616, &x)
	}
}

func BenchmarkE_nocarry_0616Cmp(b *testing.B) {
	x := e_nocarry_0616{
		18439881499406435318,
		9661597479037636416,
		10443029793129650267,
	...
	benchRese_nocarry_0616 = x
	benchRese_nocarry_0616[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0616.Cmp(&x)
	}
}

func TestE_nocarry_0616Cmp(t *testing.T) {
	var x, y e_nocarry_0616
...
func TestE_nocarry_0616IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0616
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0616

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0616{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0616
	one.SetOne()
	e.Sub(&qe_nocarry_0616, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0616{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0616{0, uint64(i)})
	}
...
func TestE_nocarry_0616NegZero(t *testing.T) {
	var a, b e_nocarry_0616
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0616Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0616, len(staticTestValues))
...
func TestE_nocarry_0616Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0616) bool {
			var b e_nocarry_0616
...
func TestE_nocarry_0616InverseExp(t *testing.T) {
...
func TestE_nocarry_0616MulByConstants(t *testing.T) {
...
func TestE_nocarry_0616Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0616) bool {
...
func TestE_nocarry_0616LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0616Halve(t *testing.T) {
...
func TestE_nocarry_0616FromMont(t *testing.T) {
...
type testPaire_nocarry_0616 struct {
	element e_nocarry_0616
	bigint  big.Int
}

func (z *e_nocarry_0616) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0616[9] {
		return true
	}
	if z[9] < qe_nocarry_0616[9] {
		return false
	...
	return z[0] >= qe_nocarry_0616[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0616

		g.element = e_nocarry_0616{
		...
		if qe_nocarry_0616[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0616[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0616 {
			var g e_nocarry_0616
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0616[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0616[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0616[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0616[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0616[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0616[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0616[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0616[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0616[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0616[9], carry)
...
func Benchmarke_nocarry_0616InverseNew(b *testing.B) {
	var x e_nocarry_0616
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0616
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0616
		var xInv e_nocarry_0616
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0616
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0616
...
func testLinearComb(t *testing.T, x *e_nocarry_0616, xC int64, y *e_nocarry_0616, yC int64) {
	...
	var z e_nocarry_0616
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0616, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0616
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0616, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0616
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0616, xHi uint64) {
	var res e_nocarry_0616
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0616) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0616) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0616, c int64, result *e_nocarry_0616, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0616) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0616) uint64 {
