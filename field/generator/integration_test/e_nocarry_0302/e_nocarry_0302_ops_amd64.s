...
// modulus q
DATA q<>+0(SB)/8, $0xc1743e759fab2d85
DATA q<>+8(SB)/8, $0xb8e725d9755bebb9
DATA q<>+16(SB)/8, $0xf2231d387b06949c
DATA q<>+24(SB)/8, $0x39a0babfbbdd03fc
DATA q<>+32(SB)/8, $0x0000324d615a39dd
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x5cc1fa6029543cb3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xc1743e759fab2d85, R9
	MOVQ    $0xb8e725d9755bebb9, R10
	MOVQ    $0xf2231d387b06949c, R11
	MOVQ    $0x39a0babfbbdd03fc, R12
	MOVQ    $0x0000324d615a39dd, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xb8e725d9755bebb9, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xf2231d387b06949c, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x39a0babfbbdd03fc, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000324d615a39dd, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xc1743e759fab2d85, CX
	MOVQ    $0xb8e725d9755bebb9, BX
	MOVQ    $0xf2231d387b06949c, SI
	MOVQ    $0x39a0babfbbdd03fc, DI
	MOVQ    $0x0000324d615a39dd, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
