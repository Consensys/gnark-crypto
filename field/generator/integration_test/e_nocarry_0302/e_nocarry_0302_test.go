...
var benchRese_nocarry_0302 e_nocarry_0302

func BenchmarkE_nocarry_0302SetBytes(b *testing.B) {
	var x e_nocarry_0302
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0302MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0302.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0302)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0302)
		}
	})
}

func BenchmarkE_nocarry_0302Inverse(b *testing.B) {
	var x e_nocarry_0302
	x.SetRandom()
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0302Butterfly(b *testing.B) {
	var x e_nocarry_0302
	x.SetRandom()
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0302)
	}
}

func BenchmarkE_nocarry_0302Exp(b *testing.B) {
	var x e_nocarry_0302
	x.SetRandom()
	benchRese_nocarry_0302.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0302Double(b *testing.B) {
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Double(&benchRese_nocarry_0302)
	}
}

func BenchmarkE_nocarry_0302Add(b *testing.B) {
	var x e_nocarry_0302
	x.SetRandom()
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Add(&x, &benchRese_nocarry_0302)
	}
}

func BenchmarkE_nocarry_0302Sub(b *testing.B) {
	var x e_nocarry_0302
	x.SetRandom()
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Sub(&x, &benchRese_nocarry_0302)
	}
}

func BenchmarkE_nocarry_0302Neg(b *testing.B) {
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Neg(&benchRese_nocarry_0302)
	}
}

func BenchmarkE_nocarry_0302Div(b *testing.B) {
	var x e_nocarry_0302
	x.SetRandom()
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Div(&x, &benchRese_nocarry_0302)
	}
}

func BenchmarkE_nocarry_0302FromMont(b *testing.B) {
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.FromMont()
	}
}

func BenchmarkE_nocarry_0302ToMont(b *testing.B) {
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.ToMont()
	}
}
func BenchmarkE_nocarry_0302Square(b *testing.B) {
	benchRese_nocarry_0302.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Square(&benchRese_nocarry_0302)
	}
}

func BenchmarkE_nocarry_0302Sqrt(b *testing.B) {
	var a e_nocarry_0302
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0302Mul(b *testing.B) {
	x := e_nocarry_0302{
	...
	benchRese_nocarry_0302.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Mul(&benchRese_nocarry_0302, &x)
	}
}

func BenchmarkE_nocarry_0302Cmp(b *testing.B) {
	x := e_nocarry_0302{
		16273197589338048123,
		14905963053931844959,
		486713135472191956,
	...
	benchRese_nocarry_0302 = x
	benchRese_nocarry_0302[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0302.Cmp(&x)
	}
}

func TestE_nocarry_0302Cmp(t *testing.T) {
	var x, y e_nocarry_0302
...
func TestE_nocarry_0302IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0302
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0302

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0302{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0302
	one.SetOne()
	e.Sub(&qe_nocarry_0302, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0302{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0302{0, uint64(i)})
	}
...
func TestE_nocarry_0302NegZero(t *testing.T) {
	var a, b e_nocarry_0302
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0302Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0302, len(staticTestValues))
...
func TestE_nocarry_0302Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0302) bool {
			var b e_nocarry_0302
...
func TestE_nocarry_0302InverseExp(t *testing.T) {
...
func TestE_nocarry_0302MulByConstants(t *testing.T) {
...
func TestE_nocarry_0302Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0302) bool {
...
func TestE_nocarry_0302LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0302Halve(t *testing.T) {
...
func TestE_nocarry_0302FromMont(t *testing.T) {
...
type testPaire_nocarry_0302 struct {
	element e_nocarry_0302
	bigint  big.Int
}

func (z *e_nocarry_0302) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0302[4] {
		return true
	}
	if z[4] < qe_nocarry_0302[4] {
		return false
	...
	return z[0] >= qe_nocarry_0302[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0302

		g.element = e_nocarry_0302{
		...
		if qe_nocarry_0302[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0302[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0302 {
			var g e_nocarry_0302
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0302[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0302[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0302[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0302[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0302[4], carry)
...
func Benchmarke_nocarry_0302InverseNew(b *testing.B) {
	var x e_nocarry_0302
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0302
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0302
		var xInv e_nocarry_0302
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0302
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0302
...
func testLinearComb(t *testing.T, x *e_nocarry_0302, xC int64, y *e_nocarry_0302, yC int64) {
	...
	var z e_nocarry_0302
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0302, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0302
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0302, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0302
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0302, xHi uint64) {
	var res e_nocarry_0302
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0302) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0302) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0302, c int64, result *e_nocarry_0302, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0302) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0302) uint64 {
