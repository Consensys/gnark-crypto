...
// modulus q
DATA q<>+0(SB)/8, $0x2d0a433b6b0a4449
DATA q<>+8(SB)/8, $0xeb640cf510d97ade
DATA q<>+16(SB)/8, $0x000f4562ce2908e3
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x7dc986cb04931207
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x2d0a433b6b0a4449, DI
	MOVQ    $0xeb640cf510d97ade, R8
	MOVQ    $0x000f4562ce2908e3, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xeb640cf510d97ade, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x000f4562ce2908e3, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x2d0a433b6b0a4449, R10
	MOVQ    $0xeb640cf510d97ade, R11
	MOVQ    $0x000f4562ce2908e3, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
