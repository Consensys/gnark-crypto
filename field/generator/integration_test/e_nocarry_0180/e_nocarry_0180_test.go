...
var benchRese_nocarry_0180 e_nocarry_0180

func BenchmarkE_nocarry_0180SetBytes(b *testing.B) {
	var x e_nocarry_0180
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0180MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0180.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0180)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0180)
		}
	})
}

func BenchmarkE_nocarry_0180Inverse(b *testing.B) {
	var x e_nocarry_0180
	x.SetRandom()
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0180Butterfly(b *testing.B) {
	var x e_nocarry_0180
	x.SetRandom()
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0180)
	}
}

func BenchmarkE_nocarry_0180Exp(b *testing.B) {
	var x e_nocarry_0180
	x.SetRandom()
	benchRese_nocarry_0180.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0180Double(b *testing.B) {
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Double(&benchRese_nocarry_0180)
	}
}

func BenchmarkE_nocarry_0180Add(b *testing.B) {
	var x e_nocarry_0180
	x.SetRandom()
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Add(&x, &benchRese_nocarry_0180)
	}
}

func BenchmarkE_nocarry_0180Sub(b *testing.B) {
	var x e_nocarry_0180
	x.SetRandom()
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Sub(&x, &benchRese_nocarry_0180)
	}
}

func BenchmarkE_nocarry_0180Neg(b *testing.B) {
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Neg(&benchRese_nocarry_0180)
	}
}

func BenchmarkE_nocarry_0180Div(b *testing.B) {
	var x e_nocarry_0180
	x.SetRandom()
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Div(&x, &benchRese_nocarry_0180)
	}
}

func BenchmarkE_nocarry_0180FromMont(b *testing.B) {
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.FromMont()
	}
}

func BenchmarkE_nocarry_0180ToMont(b *testing.B) {
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.ToMont()
	}
}
func BenchmarkE_nocarry_0180Square(b *testing.B) {
	benchRese_nocarry_0180.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Square(&benchRese_nocarry_0180)
	}
}

func BenchmarkE_nocarry_0180Sqrt(b *testing.B) {
	var a e_nocarry_0180
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0180Mul(b *testing.B) {
	x := e_nocarry_0180{
		12200044220325175209,
		10277752478159040875,
		2657760972659524,
	}
	benchRese_nocarry_0180.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Mul(&benchRese_nocarry_0180, &x)
	}
}

func BenchmarkE_nocarry_0180Cmp(b *testing.B) {
	x := e_nocarry_0180{
		12200044220325175209,
		10277752478159040875,
		2657760972659524,
	}
	benchRese_nocarry_0180 = x
	benchRese_nocarry_0180[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0180.Cmp(&x)
	}
}

func TestE_nocarry_0180Cmp(t *testing.T) {
	var x, y e_nocarry_0180
...
func TestE_nocarry_0180IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0180
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0180

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0180{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0180
	one.SetOne()
	e.Sub(&qe_nocarry_0180, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0180{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0180{0, uint64(i)})
	}
...
func TestE_nocarry_0180NegZero(t *testing.T) {
	var a, b e_nocarry_0180
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0180Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0180, len(staticTestValues))
...
func TestE_nocarry_0180Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0180) bool {
			var b e_nocarry_0180
...
func TestE_nocarry_0180InverseExp(t *testing.T) {
...
func TestE_nocarry_0180MulByConstants(t *testing.T) {
...
func TestE_nocarry_0180Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0180) bool {
...
func TestE_nocarry_0180LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0180Halve(t *testing.T) {
...
func TestE_nocarry_0180FromMont(t *testing.T) {
...
type testPaire_nocarry_0180 struct {
	element e_nocarry_0180
	bigint  big.Int
}

func (z *e_nocarry_0180) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0180[2] {
		return true
	}
	if z[2] < qe_nocarry_0180[2] {
		return false
	...
	return z[0] >= qe_nocarry_0180[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0180

		g.element = e_nocarry_0180{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0180[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0180[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0180 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0180[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0180[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0180[2], carry)
...
func Benchmarke_nocarry_0180InverseNew(b *testing.B) {
	var x e_nocarry_0180
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0180
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0180
		var xInv e_nocarry_0180
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0180
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0180
...
func testLinearComb(t *testing.T, x *e_nocarry_0180, xC int64, y *e_nocarry_0180, yC int64) {
	...
	var z e_nocarry_0180
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0180, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0180
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0180, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0180
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0180, xHi uint64) {
	var res e_nocarry_0180
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0180) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0180) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0180, c int64, result *e_nocarry_0180, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0180) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0180) uint64 {
