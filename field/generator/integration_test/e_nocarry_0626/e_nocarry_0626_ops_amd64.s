...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x01bca130f8137f71, R13
	ADDQ R13, AX
	MOVQ $0x8955f017a4f5d12a, R13
	ADCQ R13, DX
	MOVQ $0x4fdc3981be731704, R13
	ADCQ R13, CX
	MOVQ $0xbcf66751d8f5dc7a, R13
	ADCQ R13, BX
	MOVQ $0x4f0089ab788bcf98, R13
	ADCQ R13, SI
	MOVQ $0x24c7dca123dd804e, R13
	ADCQ R13, DI
	MOVQ $0xfbe0b88564995ed2, R13
	ADCQ R13, R8
	MOVQ $0x9dac29bf4b756e5e, R13
	ADCQ R13, R9
	MOVQ $0x7d036a31d04883ab, R13
	ADCQ R13, R10
	MOVQ $0x0003476442668d68, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x01bca130f8137f71, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x8955f017a4f5d12a, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x4fdc3981be731704, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xbcf66751d8f5dc7a, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x4f0089ab788bcf98, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x24c7dca123dd804e, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xfbe0b88564995ed2, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x9dac29bf4b756e5e, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x7d036a31d04883ab, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0003476442668d68, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x01bca130f8137f71, AX
	ADDQ AX, DX
	MOVQ $0x8955f017a4f5d12a, AX
	ADCQ AX, CX
	MOVQ $0x4fdc3981be731704, AX
	ADCQ AX, BX
	MOVQ $0xbcf66751d8f5dc7a, AX
	ADCQ AX, SI
	MOVQ $0x4f0089ab788bcf98, AX
	ADCQ AX, DI
	MOVQ $0x24c7dca123dd804e, AX
	ADCQ AX, R8
	MOVQ $0xfbe0b88564995ed2, AX
	ADCQ AX, R9
	MOVQ $0x9dac29bf4b756e5e, AX
	ADCQ AX, R10
	MOVQ $0x7d036a31d04883ab, AX
	ADCQ AX, R11
	MOVQ $0x0003476442668d68, AX
	ADCQ AX, R12
