...
var benchRese_nocarry_0626 e_nocarry_0626

func BenchmarkE_nocarry_0626SetBytes(b *testing.B) {
	var x e_nocarry_0626
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0626MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0626.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0626)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0626)
		}
	})
}

func BenchmarkE_nocarry_0626Inverse(b *testing.B) {
	var x e_nocarry_0626
	x.SetRandom()
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0626Butterfly(b *testing.B) {
	var x e_nocarry_0626
	x.SetRandom()
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0626)
	}
}

func BenchmarkE_nocarry_0626Exp(b *testing.B) {
	var x e_nocarry_0626
	x.SetRandom()
	benchRese_nocarry_0626.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0626Double(b *testing.B) {
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Double(&benchRese_nocarry_0626)
	}
}

func BenchmarkE_nocarry_0626Add(b *testing.B) {
	var x e_nocarry_0626
	x.SetRandom()
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Add(&x, &benchRese_nocarry_0626)
	}
}

func BenchmarkE_nocarry_0626Sub(b *testing.B) {
	var x e_nocarry_0626
	x.SetRandom()
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Sub(&x, &benchRese_nocarry_0626)
	}
}

func BenchmarkE_nocarry_0626Neg(b *testing.B) {
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Neg(&benchRese_nocarry_0626)
	}
}

func BenchmarkE_nocarry_0626Div(b *testing.B) {
	var x e_nocarry_0626
	x.SetRandom()
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Div(&x, &benchRese_nocarry_0626)
	}
}

func BenchmarkE_nocarry_0626FromMont(b *testing.B) {
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.FromMont()
	}
}

func BenchmarkE_nocarry_0626ToMont(b *testing.B) {
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.ToMont()
	}
}
func BenchmarkE_nocarry_0626Square(b *testing.B) {
	benchRese_nocarry_0626.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Square(&benchRese_nocarry_0626)
	}
}

func BenchmarkE_nocarry_0626Sqrt(b *testing.B) {
	var a e_nocarry_0626
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0626Mul(b *testing.B) {
	x := e_nocarry_0626{
		9838512983852222997,
		393323809531879332,
	...
	benchRese_nocarry_0626.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Mul(&benchRese_nocarry_0626, &x)
	}
}

func BenchmarkE_nocarry_0626Cmp(b *testing.B) {
	x := e_nocarry_0626{
		9838512983852222997,
		393323809531879332,
		11632746181036252460,
	...
	benchRese_nocarry_0626 = x
	benchRese_nocarry_0626[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0626.Cmp(&x)
	}
}

func TestE_nocarry_0626Cmp(t *testing.T) {
	var x, y e_nocarry_0626
...
func TestE_nocarry_0626IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0626
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0626

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0626{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0626
	one.SetOne()
	e.Sub(&qe_nocarry_0626, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0626{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0626{0, uint64(i)})
	}
...
func TestE_nocarry_0626NegZero(t *testing.T) {
	var a, b e_nocarry_0626
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0626Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0626, len(staticTestValues))
...
func TestE_nocarry_0626Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0626) bool {
			var b e_nocarry_0626
...
func TestE_nocarry_0626InverseExp(t *testing.T) {
...
func TestE_nocarry_0626MulByConstants(t *testing.T) {
...
func TestE_nocarry_0626Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0626) bool {
...
func TestE_nocarry_0626LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0626Halve(t *testing.T) {
...
func TestE_nocarry_0626FromMont(t *testing.T) {
...
type testPaire_nocarry_0626 struct {
	element e_nocarry_0626
	bigint  big.Int
}

func (z *e_nocarry_0626) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0626[9] {
		return true
	}
	if z[9] < qe_nocarry_0626[9] {
		return false
	...
	return z[0] >= qe_nocarry_0626[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0626

		g.element = e_nocarry_0626{
		...
		if qe_nocarry_0626[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0626[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0626 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0626[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0626[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0626[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0626[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0626[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0626[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0626[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0626[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0626[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0626[9], carry)
...
func Benchmarke_nocarry_0626InverseNew(b *testing.B) {
	var x e_nocarry_0626
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0626
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0626
		var xInv e_nocarry_0626
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0626
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0626
...
func testLinearComb(t *testing.T, x *e_nocarry_0626, xC int64, y *e_nocarry_0626, yC int64) {
	...
	var z e_nocarry_0626
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0626, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0626
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0626, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0626
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0626, xHi uint64) {
	var res e_nocarry_0626
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0626) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0626) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0626, c int64, result *e_nocarry_0626, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0626) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0626) uint64 {
