...
// modulus q
DATA q<>+0(SB)/8, $0x0fc699dd7aa16e7b
DATA q<>+8(SB)/8, $0x158f922e6e6dd79d
DATA q<>+16(SB)/8, $0xae8a6406f1e7b450
DATA q<>+24(SB)/8, $0x4ef4cdee4337f6dd
DATA q<>+32(SB)/8, $0xa35b7694944f7eda
DATA q<>+40(SB)/8, $0x00000078c8c27d54
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x71b14dfe46ccbf4d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x0fc699dd7aa16e7b, R10
	MOVQ    $0x158f922e6e6dd79d, R11
	MOVQ    $0xae8a6406f1e7b450, R12
	MOVQ    $0x4ef4cdee4337f6dd, R13
	MOVQ    $0xa35b7694944f7eda, R14
	MOVQ    $0x00000078c8c27d54, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x158f922e6e6dd79d, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xae8a6406f1e7b450, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x4ef4cdee4337f6dd, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xa35b7694944f7eda, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000078c8c27d54, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x0fc699dd7aa16e7b, CX
	MOVQ    $0x158f922e6e6dd79d, BX
	MOVQ    $0xae8a6406f1e7b450, SI
	MOVQ    $0x4ef4cdee4337f6dd, DI
	MOVQ    $0xa35b7694944f7eda, R8
	MOVQ    $0x00000078c8c27d54, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
