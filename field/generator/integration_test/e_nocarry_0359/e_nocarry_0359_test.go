...
var benchRese_nocarry_0359 e_nocarry_0359

func BenchmarkE_nocarry_0359SetBytes(b *testing.B) {
	var x e_nocarry_0359
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0359MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0359.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0359)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0359)
		}
	})
}

func BenchmarkE_nocarry_0359Inverse(b *testing.B) {
	var x e_nocarry_0359
	x.SetRandom()
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0359Butterfly(b *testing.B) {
	var x e_nocarry_0359
	x.SetRandom()
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0359)
	}
}

func BenchmarkE_nocarry_0359Exp(b *testing.B) {
	var x e_nocarry_0359
	x.SetRandom()
	benchRese_nocarry_0359.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0359Double(b *testing.B) {
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Double(&benchRese_nocarry_0359)
	}
}

func BenchmarkE_nocarry_0359Add(b *testing.B) {
	var x e_nocarry_0359
	x.SetRandom()
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Add(&x, &benchRese_nocarry_0359)
	}
}

func BenchmarkE_nocarry_0359Sub(b *testing.B) {
	var x e_nocarry_0359
	x.SetRandom()
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Sub(&x, &benchRese_nocarry_0359)
	}
}

func BenchmarkE_nocarry_0359Neg(b *testing.B) {
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Neg(&benchRese_nocarry_0359)
	}
}

func BenchmarkE_nocarry_0359Div(b *testing.B) {
	var x e_nocarry_0359
	x.SetRandom()
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Div(&x, &benchRese_nocarry_0359)
	}
}

func BenchmarkE_nocarry_0359FromMont(b *testing.B) {
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.FromMont()
	}
}

func BenchmarkE_nocarry_0359ToMont(b *testing.B) {
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.ToMont()
	}
}
func BenchmarkE_nocarry_0359Square(b *testing.B) {
	benchRese_nocarry_0359.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Square(&benchRese_nocarry_0359)
	}
}

func BenchmarkE_nocarry_0359Sqrt(b *testing.B) {
	var a e_nocarry_0359
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0359Mul(b *testing.B) {
	x := e_nocarry_0359{
		9405065922768722033,
		7350658559876381737,
	...
	benchRese_nocarry_0359.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Mul(&benchRese_nocarry_0359, &x)
	}
}

func BenchmarkE_nocarry_0359Cmp(b *testing.B) {
	x := e_nocarry_0359{
		9405065922768722033,
		7350658559876381737,
		17527676439829789741,
	...
	benchRese_nocarry_0359 = x
	benchRese_nocarry_0359[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0359.Cmp(&x)
	}
}

func TestE_nocarry_0359Cmp(t *testing.T) {
	var x, y e_nocarry_0359
...
func TestE_nocarry_0359IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0359
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0359

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0359{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0359
	one.SetOne()
	e.Sub(&qe_nocarry_0359, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0359{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0359{0, uint64(i)})
	}
...
func TestE_nocarry_0359NegZero(t *testing.T) {
	var a, b e_nocarry_0359
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0359Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0359, len(staticTestValues))
...
func TestE_nocarry_0359Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0359) bool {
			var b e_nocarry_0359
...
func TestE_nocarry_0359InverseExp(t *testing.T) {
...
func TestE_nocarry_0359MulByConstants(t *testing.T) {
...
func TestE_nocarry_0359Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0359) bool {
...
func TestE_nocarry_0359LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0359Halve(t *testing.T) {
...
func TestE_nocarry_0359FromMont(t *testing.T) {
...
type testPaire_nocarry_0359 struct {
	element e_nocarry_0359
	bigint  big.Int
}

func (z *e_nocarry_0359) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0359[5] {
		return true
	}
	if z[5] < qe_nocarry_0359[5] {
		return false
	...
	return z[0] >= qe_nocarry_0359[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0359

		g.element = e_nocarry_0359{
		...
		if qe_nocarry_0359[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0359[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0359 {
			var g e_nocarry_0359
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0359[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0359[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0359[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0359[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0359[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0359[5], carry)
...
func Benchmarke_nocarry_0359InverseNew(b *testing.B) {
	var x e_nocarry_0359
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0359
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0359
		var xInv e_nocarry_0359
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0359
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0359
...
func testLinearComb(t *testing.T, x *e_nocarry_0359, xC int64, y *e_nocarry_0359, yC int64) {
	...
	var z e_nocarry_0359
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0359, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0359
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0359, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0359
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0359, xHi uint64) {
	var res e_nocarry_0359
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0359) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0359) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0359, c int64, result *e_nocarry_0359, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0359) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0359) uint64 {
