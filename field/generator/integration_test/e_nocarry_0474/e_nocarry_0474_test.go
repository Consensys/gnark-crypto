...
var benchRese_nocarry_0474 e_nocarry_0474

func BenchmarkE_nocarry_0474SetBytes(b *testing.B) {
	var x e_nocarry_0474
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0474MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0474.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0474)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0474)
		}
	})
}

func BenchmarkE_nocarry_0474Inverse(b *testing.B) {
	var x e_nocarry_0474
	x.SetRandom()
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0474Butterfly(b *testing.B) {
	var x e_nocarry_0474
	x.SetRandom()
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0474)
	}
}

func BenchmarkE_nocarry_0474Exp(b *testing.B) {
	var x e_nocarry_0474
	x.SetRandom()
	benchRese_nocarry_0474.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0474Double(b *testing.B) {
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Double(&benchRese_nocarry_0474)
	}
}

func BenchmarkE_nocarry_0474Add(b *testing.B) {
	var x e_nocarry_0474
	x.SetRandom()
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Add(&x, &benchRese_nocarry_0474)
	}
}

func BenchmarkE_nocarry_0474Sub(b *testing.B) {
	var x e_nocarry_0474
	x.SetRandom()
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Sub(&x, &benchRese_nocarry_0474)
	}
}

func BenchmarkE_nocarry_0474Neg(b *testing.B) {
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Neg(&benchRese_nocarry_0474)
	}
}

func BenchmarkE_nocarry_0474Div(b *testing.B) {
	var x e_nocarry_0474
	x.SetRandom()
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Div(&x, &benchRese_nocarry_0474)
	}
}

func BenchmarkE_nocarry_0474FromMont(b *testing.B) {
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.FromMont()
	}
}

func BenchmarkE_nocarry_0474ToMont(b *testing.B) {
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.ToMont()
	}
}
func BenchmarkE_nocarry_0474Square(b *testing.B) {
	benchRese_nocarry_0474.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Square(&benchRese_nocarry_0474)
	}
}

func BenchmarkE_nocarry_0474Sqrt(b *testing.B) {
	var a e_nocarry_0474
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0474Mul(b *testing.B) {
	x := e_nocarry_0474{
		574577301690696209,
		8330025073087665888,
		4600541489898090975,
	...
	benchRese_nocarry_0474.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Mul(&benchRese_nocarry_0474, &x)
	}
}

func BenchmarkE_nocarry_0474Cmp(b *testing.B) {
	x := e_nocarry_0474{
		574577301690696209,
		8330025073087665888,
		4600541489898090975,
	...
	benchRese_nocarry_0474 = x
	benchRese_nocarry_0474[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0474.Cmp(&x)
	}
}

func TestE_nocarry_0474Cmp(t *testing.T) {
	var x, y e_nocarry_0474
...
func TestE_nocarry_0474IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0474
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0474

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0474{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0474
	one.SetOne()
	e.Sub(&qe_nocarry_0474, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0474{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0474{0, uint64(i)})
	}
...
func TestE_nocarry_0474NegZero(t *testing.T) {
	var a, b e_nocarry_0474
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0474Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0474, len(staticTestValues))
...
func TestE_nocarry_0474Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0474) bool {
			var b e_nocarry_0474
...
func TestE_nocarry_0474InverseExp(t *testing.T) {
...
func TestE_nocarry_0474MulByConstants(t *testing.T) {
...
func TestE_nocarry_0474Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0474) bool {
...
func TestE_nocarry_0474LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0474Halve(t *testing.T) {
...
func TestE_nocarry_0474FromMont(t *testing.T) {
...
type testPaire_nocarry_0474 struct {
	element e_nocarry_0474
	bigint  big.Int
}

func (z *e_nocarry_0474) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0474[7] {
		return true
	}
	if z[7] < qe_nocarry_0474[7] {
		return false
	...
	return z[0] >= qe_nocarry_0474[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0474

		g.element = e_nocarry_0474{
		...
		if qe_nocarry_0474[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0474[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0474 {
			var g e_nocarry_0474
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0474[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0474[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0474[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0474[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0474[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0474[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0474[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0474[7], carry)
...
func Benchmarke_nocarry_0474InverseNew(b *testing.B) {
	var x e_nocarry_0474
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0474
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0474
		var xInv e_nocarry_0474
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0474
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0474
...
func testLinearComb(t *testing.T, x *e_nocarry_0474, xC int64, y *e_nocarry_0474, yC int64) {
	...
	var z e_nocarry_0474
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0474, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0474
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0474, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0474
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0474, xHi uint64) {
	var res e_nocarry_0474
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0474) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0474) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0474, c int64, result *e_nocarry_0474, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0474) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0474) uint64 {
