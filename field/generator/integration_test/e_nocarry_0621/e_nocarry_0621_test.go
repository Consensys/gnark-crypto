...
var benchRese_nocarry_0621 e_nocarry_0621

func BenchmarkE_nocarry_0621SetBytes(b *testing.B) {
	var x e_nocarry_0621
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0621MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0621.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0621)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0621)
		}
	})
}

func BenchmarkE_nocarry_0621Inverse(b *testing.B) {
	var x e_nocarry_0621
	x.SetRandom()
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0621Butterfly(b *testing.B) {
	var x e_nocarry_0621
	x.SetRandom()
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0621)
	}
}

func BenchmarkE_nocarry_0621Exp(b *testing.B) {
	var x e_nocarry_0621
	x.SetRandom()
	benchRese_nocarry_0621.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0621Double(b *testing.B) {
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Double(&benchRese_nocarry_0621)
	}
}

func BenchmarkE_nocarry_0621Add(b *testing.B) {
	var x e_nocarry_0621
	x.SetRandom()
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Add(&x, &benchRese_nocarry_0621)
	}
}

func BenchmarkE_nocarry_0621Sub(b *testing.B) {
	var x e_nocarry_0621
	x.SetRandom()
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Sub(&x, &benchRese_nocarry_0621)
	}
}

func BenchmarkE_nocarry_0621Neg(b *testing.B) {
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Neg(&benchRese_nocarry_0621)
	}
}

func BenchmarkE_nocarry_0621Div(b *testing.B) {
	var x e_nocarry_0621
	x.SetRandom()
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Div(&x, &benchRese_nocarry_0621)
	}
}

func BenchmarkE_nocarry_0621FromMont(b *testing.B) {
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.FromMont()
	}
}

func BenchmarkE_nocarry_0621ToMont(b *testing.B) {
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.ToMont()
	}
}
func BenchmarkE_nocarry_0621Square(b *testing.B) {
	benchRese_nocarry_0621.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Square(&benchRese_nocarry_0621)
	}
}

func BenchmarkE_nocarry_0621Sqrt(b *testing.B) {
	var a e_nocarry_0621
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0621Mul(b *testing.B) {
	x := e_nocarry_0621{
	...
	benchRese_nocarry_0621.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Mul(&benchRese_nocarry_0621, &x)
	}
}

func BenchmarkE_nocarry_0621Cmp(b *testing.B) {
	x := e_nocarry_0621{
		10593057604436559662,
		14824109583584850308,
		2634815510266665326,
	...
	benchRese_nocarry_0621 = x
	benchRese_nocarry_0621[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0621.Cmp(&x)
	}
}

func TestE_nocarry_0621Cmp(t *testing.T) {
	var x, y e_nocarry_0621
...
func TestE_nocarry_0621IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0621
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0621

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0621{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0621
	one.SetOne()
	e.Sub(&qe_nocarry_0621, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0621{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0621{0, uint64(i)})
	}
...
func TestE_nocarry_0621NegZero(t *testing.T) {
	var a, b e_nocarry_0621
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0621Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0621, len(staticTestValues))
...
func TestE_nocarry_0621Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0621) bool {
			var b e_nocarry_0621
...
func TestE_nocarry_0621InverseExp(t *testing.T) {
...
func TestE_nocarry_0621MulByConstants(t *testing.T) {
...
func TestE_nocarry_0621Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0621) bool {
...
func TestE_nocarry_0621LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0621Halve(t *testing.T) {
...
func TestE_nocarry_0621FromMont(t *testing.T) {
...
type testPaire_nocarry_0621 struct {
	element e_nocarry_0621
	bigint  big.Int
}

func (z *e_nocarry_0621) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0621[9] {
		return true
	}
	if z[9] < qe_nocarry_0621[9] {
		return false
	...
	return z[0] >= qe_nocarry_0621[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0621

		g.element = e_nocarry_0621{
		...
		if qe_nocarry_0621[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0621[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0621 {
			var g e_nocarry_0621
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0621[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0621[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0621[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0621[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0621[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0621[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0621[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0621[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0621[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0621[9], carry)
...
func Benchmarke_nocarry_0621InverseNew(b *testing.B) {
	var x e_nocarry_0621
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0621
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0621
		var xInv e_nocarry_0621
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0621
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0621
...
func testLinearComb(t *testing.T, x *e_nocarry_0621, xC int64, y *e_nocarry_0621, yC int64) {
	...
	var z e_nocarry_0621
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0621, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0621
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0621, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0621
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0621, xHi uint64) {
	var res e_nocarry_0621
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0621) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0621) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0621, c int64, result *e_nocarry_0621, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0621) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0621) uint64 {
