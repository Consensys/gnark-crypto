...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x04ae05337094000f, R13
	ADDQ R13, AX
	MOVQ $0xb29fd0951ac73430, R13
	ADCQ R13, DX
	MOVQ $0x909bd826822f29ab, R13
	ADCQ R13, CX
	MOVQ $0x791d3f5c8f6a54ab, R13
	ADCQ R13, BX
	MOVQ $0xbdf26ba9742392aa, R13
	ADCQ R13, SI
	MOVQ $0x1c3d84fe2c611f41, R13
	ADCQ R13, DI
	MOVQ $0x8fa6fdfae11433ab, R13
	ADCQ R13, R8
	MOVQ $0x5877dea146aa6ff8, R13
	ADCQ R13, R9
	MOVQ $0x07a01ea7ba8cba79, R13
	ADCQ R13, R10
	MOVQ $0x00001dd1371b92e9, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x04ae05337094000f, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xb29fd0951ac73430, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x909bd826822f29ab, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x791d3f5c8f6a54ab, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xbdf26ba9742392aa, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x1c3d84fe2c611f41, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x8fa6fdfae11433ab, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x5877dea146aa6ff8, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x07a01ea7ba8cba79, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00001dd1371b92e9, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x04ae05337094000f, AX
	ADDQ AX, DX
	MOVQ $0xb29fd0951ac73430, AX
	ADCQ AX, CX
	MOVQ $0x909bd826822f29ab, AX
	ADCQ AX, BX
	MOVQ $0x791d3f5c8f6a54ab, AX
	ADCQ AX, SI
	MOVQ $0xbdf26ba9742392aa, AX
	ADCQ AX, DI
	MOVQ $0x1c3d84fe2c611f41, AX
	ADCQ AX, R8
	MOVQ $0x8fa6fdfae11433ab, AX
	ADCQ AX, R9
	MOVQ $0x5877dea146aa6ff8, AX
	ADCQ AX, R10
	MOVQ $0x07a01ea7ba8cba79, AX
	ADCQ AX, R11
	MOVQ $0x00001dd1371b92e9, AX
	ADCQ AX, R12
