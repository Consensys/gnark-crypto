...
var benchRese_nocarry_0506 e_nocarry_0506

func BenchmarkE_nocarry_0506SetBytes(b *testing.B) {
	var x e_nocarry_0506
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0506MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0506.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0506)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0506)
		}
	})
}

func BenchmarkE_nocarry_0506Inverse(b *testing.B) {
	var x e_nocarry_0506
	x.SetRandom()
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0506Butterfly(b *testing.B) {
	var x e_nocarry_0506
	x.SetRandom()
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0506)
	}
}

func BenchmarkE_nocarry_0506Exp(b *testing.B) {
	var x e_nocarry_0506
	x.SetRandom()
	benchRese_nocarry_0506.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0506Double(b *testing.B) {
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Double(&benchRese_nocarry_0506)
	}
}

func BenchmarkE_nocarry_0506Add(b *testing.B) {
	var x e_nocarry_0506
	x.SetRandom()
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Add(&x, &benchRese_nocarry_0506)
	}
}

func BenchmarkE_nocarry_0506Sub(b *testing.B) {
	var x e_nocarry_0506
	x.SetRandom()
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Sub(&x, &benchRese_nocarry_0506)
	}
}

func BenchmarkE_nocarry_0506Neg(b *testing.B) {
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Neg(&benchRese_nocarry_0506)
	}
}

func BenchmarkE_nocarry_0506Div(b *testing.B) {
	var x e_nocarry_0506
	x.SetRandom()
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Div(&x, &benchRese_nocarry_0506)
	}
}

func BenchmarkE_nocarry_0506FromMont(b *testing.B) {
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.FromMont()
	}
}

func BenchmarkE_nocarry_0506ToMont(b *testing.B) {
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.ToMont()
	}
}
func BenchmarkE_nocarry_0506Square(b *testing.B) {
	benchRese_nocarry_0506.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Square(&benchRese_nocarry_0506)
	}
}

func BenchmarkE_nocarry_0506Sqrt(b *testing.B) {
	var a e_nocarry_0506
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0506Mul(b *testing.B) {
	x := e_nocarry_0506{
		7069601877963617736,
		6964406283591884043,
		1192712274815188678,
	...
	benchRese_nocarry_0506.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Mul(&benchRese_nocarry_0506, &x)
	}
}

func BenchmarkE_nocarry_0506Cmp(b *testing.B) {
	x := e_nocarry_0506{
		7069601877963617736,
		6964406283591884043,
		1192712274815188678,
	...
	benchRese_nocarry_0506 = x
	benchRese_nocarry_0506[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0506.Cmp(&x)
	}
}

func TestE_nocarry_0506Cmp(t *testing.T) {
	var x, y e_nocarry_0506
...
func TestE_nocarry_0506IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0506
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0506

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0506{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0506
	one.SetOne()
	e.Sub(&qe_nocarry_0506, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0506{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0506{0, uint64(i)})
	}
...
func TestE_nocarry_0506NegZero(t *testing.T) {
	var a, b e_nocarry_0506
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0506Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0506, len(staticTestValues))
...
func TestE_nocarry_0506Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0506) bool {
			var b e_nocarry_0506
...
func TestE_nocarry_0506InverseExp(t *testing.T) {
...
func TestE_nocarry_0506MulByConstants(t *testing.T) {
...
func TestE_nocarry_0506Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0506) bool {
...
func TestE_nocarry_0506LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0506Halve(t *testing.T) {
...
func TestE_nocarry_0506FromMont(t *testing.T) {
...
type testPaire_nocarry_0506 struct {
	element e_nocarry_0506
	bigint  big.Int
}

func (z *e_nocarry_0506) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0506[7] {
		return true
	}
	if z[7] < qe_nocarry_0506[7] {
		return false
	...
	return z[0] >= qe_nocarry_0506[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0506

		g.element = e_nocarry_0506{
		...
		if qe_nocarry_0506[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0506[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0506 {
			var g e_nocarry_0506
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0506[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0506[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0506[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0506[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0506[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0506[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0506[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0506[7], carry)
...
func Benchmarke_nocarry_0506InverseNew(b *testing.B) {
	var x e_nocarry_0506
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0506
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0506
		var xInv e_nocarry_0506
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0506
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0506
...
func testLinearComb(t *testing.T, x *e_nocarry_0506, xC int64, y *e_nocarry_0506, yC int64) {
	...
	var z e_nocarry_0506
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0506, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0506
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0506, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0506
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0506, xHi uint64) {
	var res e_nocarry_0506
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0506) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0506) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0506, c int64, result *e_nocarry_0506, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0506) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0506) uint64 {
