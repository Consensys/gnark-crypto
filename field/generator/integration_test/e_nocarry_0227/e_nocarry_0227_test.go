...
var benchRese_nocarry_0227 e_nocarry_0227

func BenchmarkE_nocarry_0227SetBytes(b *testing.B) {
	var x e_nocarry_0227
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0227MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0227.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0227)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0227)
		}
	})
}

func BenchmarkE_nocarry_0227Inverse(b *testing.B) {
	var x e_nocarry_0227
	x.SetRandom()
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0227Butterfly(b *testing.B) {
	var x e_nocarry_0227
	x.SetRandom()
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0227)
	}
}

func BenchmarkE_nocarry_0227Exp(b *testing.B) {
	var x e_nocarry_0227
	x.SetRandom()
	benchRese_nocarry_0227.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0227Double(b *testing.B) {
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Double(&benchRese_nocarry_0227)
	}
}

func BenchmarkE_nocarry_0227Add(b *testing.B) {
	var x e_nocarry_0227
	x.SetRandom()
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Add(&x, &benchRese_nocarry_0227)
	}
}

func BenchmarkE_nocarry_0227Sub(b *testing.B) {
	var x e_nocarry_0227
	x.SetRandom()
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Sub(&x, &benchRese_nocarry_0227)
	}
}

func BenchmarkE_nocarry_0227Neg(b *testing.B) {
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Neg(&benchRese_nocarry_0227)
	}
}

func BenchmarkE_nocarry_0227Div(b *testing.B) {
	var x e_nocarry_0227
	x.SetRandom()
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Div(&x, &benchRese_nocarry_0227)
	}
}

func BenchmarkE_nocarry_0227FromMont(b *testing.B) {
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.FromMont()
	}
}

func BenchmarkE_nocarry_0227ToMont(b *testing.B) {
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.ToMont()
	}
}
func BenchmarkE_nocarry_0227Square(b *testing.B) {
	benchRese_nocarry_0227.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Square(&benchRese_nocarry_0227)
	}
}

func BenchmarkE_nocarry_0227Sqrt(b *testing.B) {
	var a e_nocarry_0227
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0227Mul(b *testing.B) {
	x := e_nocarry_0227{
		2109491057094108064,
	...
	benchRese_nocarry_0227.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Mul(&benchRese_nocarry_0227, &x)
	}
}

func BenchmarkE_nocarry_0227Cmp(b *testing.B) {
	x := e_nocarry_0227{
		2109491057094108064,
		16497856994301776028,
		16574890175086471746,
	...
	benchRese_nocarry_0227 = x
	benchRese_nocarry_0227[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0227.Cmp(&x)
	}
}

func TestE_nocarry_0227Cmp(t *testing.T) {
	var x, y e_nocarry_0227
...
func TestE_nocarry_0227IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0227
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0227

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0227{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0227
	one.SetOne()
	e.Sub(&qe_nocarry_0227, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0227{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0227{0, uint64(i)})
	}
...
func TestE_nocarry_0227NegZero(t *testing.T) {
	var a, b e_nocarry_0227
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0227Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0227, len(staticTestValues))
...
func TestE_nocarry_0227Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0227) bool {
			var b e_nocarry_0227
...
func TestE_nocarry_0227InverseExp(t *testing.T) {
...
func TestE_nocarry_0227MulByConstants(t *testing.T) {
...
func TestE_nocarry_0227Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0227) bool {
...
func TestE_nocarry_0227LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0227Halve(t *testing.T) {
...
func TestE_nocarry_0227FromMont(t *testing.T) {
...
type testPaire_nocarry_0227 struct {
	element e_nocarry_0227
	bigint  big.Int
}

func (z *e_nocarry_0227) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0227[3] {
		return true
	}
	if z[3] < qe_nocarry_0227[3] {
		return false
	...
	return z[0] >= qe_nocarry_0227[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0227

		g.element = e_nocarry_0227{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0227[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0227[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0227 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0227[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0227[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0227[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0227[3], carry)
...
func Benchmarke_nocarry_0227InverseNew(b *testing.B) {
	var x e_nocarry_0227
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0227
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0227
		var xInv e_nocarry_0227
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0227
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0227
...
func testLinearComb(t *testing.T, x *e_nocarry_0227, xC int64, y *e_nocarry_0227, yC int64) {
	...
	var z e_nocarry_0227
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0227, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0227
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0227, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0227
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0227, xHi uint64) {
	var res e_nocarry_0227
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0227) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0227) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0227, c int64, result *e_nocarry_0227, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0227) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0227) uint64 {
