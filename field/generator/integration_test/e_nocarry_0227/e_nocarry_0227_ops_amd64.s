...
// modulus q
DATA q<>+0(SB)/8, $0x470ff1aa2e5fc041
DATA q<>+8(SB)/8, $0x7b27bc93197f7884
DATA q<>+16(SB)/8, $0xfe624d26f8f28c63
DATA q<>+24(SB)/8, $0x0000000660288dad
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x9e51e7352183b03f
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x470ff1aa2e5fc041, R8
	MOVQ    $0x7b27bc93197f7884, R9
	MOVQ    $0xfe624d26f8f28c63, R10
	MOVQ    $0x0000000660288dad, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x7b27bc93197f7884, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xfe624d26f8f28c63, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000000660288dad, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x470ff1aa2e5fc041, R12
	MOVQ    $0x7b27bc93197f7884, R13
	MOVQ    $0xfe624d26f8f28c63, R14
	MOVQ    $0x0000000660288dad, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
