...
var benchRese_nocarry_0307 e_nocarry_0307

func BenchmarkE_nocarry_0307SetBytes(b *testing.B) {
	var x e_nocarry_0307
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0307MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0307.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0307)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0307)
		}
	})
}

func BenchmarkE_nocarry_0307Inverse(b *testing.B) {
	var x e_nocarry_0307
	x.SetRandom()
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0307Butterfly(b *testing.B) {
	var x e_nocarry_0307
	x.SetRandom()
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0307)
	}
}

func BenchmarkE_nocarry_0307Exp(b *testing.B) {
	var x e_nocarry_0307
	x.SetRandom()
	benchRese_nocarry_0307.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0307Double(b *testing.B) {
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Double(&benchRese_nocarry_0307)
	}
}

func BenchmarkE_nocarry_0307Add(b *testing.B) {
	var x e_nocarry_0307
	x.SetRandom()
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Add(&x, &benchRese_nocarry_0307)
	}
}

func BenchmarkE_nocarry_0307Sub(b *testing.B) {
	var x e_nocarry_0307
	x.SetRandom()
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Sub(&x, &benchRese_nocarry_0307)
	}
}

func BenchmarkE_nocarry_0307Neg(b *testing.B) {
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Neg(&benchRese_nocarry_0307)
	}
}

func BenchmarkE_nocarry_0307Div(b *testing.B) {
	var x e_nocarry_0307
	x.SetRandom()
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Div(&x, &benchRese_nocarry_0307)
	}
}

func BenchmarkE_nocarry_0307FromMont(b *testing.B) {
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.FromMont()
	}
}

func BenchmarkE_nocarry_0307ToMont(b *testing.B) {
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.ToMont()
	}
}
func BenchmarkE_nocarry_0307Square(b *testing.B) {
	benchRese_nocarry_0307.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Square(&benchRese_nocarry_0307)
	}
}

func BenchmarkE_nocarry_0307Sqrt(b *testing.B) {
	var a e_nocarry_0307
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0307Mul(b *testing.B) {
	x := e_nocarry_0307{
		5143604693463425145,
	...
	benchRese_nocarry_0307.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Mul(&benchRese_nocarry_0307, &x)
	}
}

func BenchmarkE_nocarry_0307Cmp(b *testing.B) {
	x := e_nocarry_0307{
		5143604693463425145,
		18247082428158293547,
		13406689924209354148,
	...
	benchRese_nocarry_0307 = x
	benchRese_nocarry_0307[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0307.Cmp(&x)
	}
}

func TestE_nocarry_0307Cmp(t *testing.T) {
	var x, y e_nocarry_0307
...
func TestE_nocarry_0307IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0307
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0307

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0307{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0307
	one.SetOne()
	e.Sub(&qe_nocarry_0307, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0307{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0307{0, uint64(i)})
	}
...
func TestE_nocarry_0307NegZero(t *testing.T) {
	var a, b e_nocarry_0307
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0307Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0307, len(staticTestValues))
...
func TestE_nocarry_0307Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0307) bool {
			var b e_nocarry_0307
...
func TestE_nocarry_0307InverseExp(t *testing.T) {
...
func TestE_nocarry_0307MulByConstants(t *testing.T) {
...
func TestE_nocarry_0307Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0307) bool {
...
func TestE_nocarry_0307LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0307Halve(t *testing.T) {
...
func TestE_nocarry_0307FromMont(t *testing.T) {
...
type testPaire_nocarry_0307 struct {
	element e_nocarry_0307
	bigint  big.Int
}

func (z *e_nocarry_0307) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0307[4] {
		return true
	}
	if z[4] < qe_nocarry_0307[4] {
		return false
	...
	return z[0] >= qe_nocarry_0307[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0307

		g.element = e_nocarry_0307{
		...
		if qe_nocarry_0307[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0307[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0307 {
			var g e_nocarry_0307
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0307[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0307[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0307[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0307[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0307[4], carry)
...
func Benchmarke_nocarry_0307InverseNew(b *testing.B) {
	var x e_nocarry_0307
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0307
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0307
		var xInv e_nocarry_0307
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0307
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0307
...
func testLinearComb(t *testing.T, x *e_nocarry_0307, xC int64, y *e_nocarry_0307, yC int64) {
	...
	var z e_nocarry_0307
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0307, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0307
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0307, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0307
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0307, xHi uint64) {
	var res e_nocarry_0307
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0307) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0307) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0307, c int64, result *e_nocarry_0307, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0307) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0307) uint64 {
