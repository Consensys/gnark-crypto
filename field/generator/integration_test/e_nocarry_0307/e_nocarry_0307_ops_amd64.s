...
// modulus q
DATA q<>+0(SB)/8, $0x6b18139138c3347f
DATA q<>+8(SB)/8, $0xe286fd3632dfa5da
DATA q<>+16(SB)/8, $0x2f6abd7eac413cff
DATA q<>+24(SB)/8, $0x0fd3c72da21328b8
DATA q<>+32(SB)/8, $0x0006f4901c898f97
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x1e8a51c7cda77481
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x6b18139138c3347f, R9
	MOVQ    $0xe286fd3632dfa5da, R10
	MOVQ    $0x2f6abd7eac413cff, R11
	MOVQ    $0x0fd3c72da21328b8, R12
	MOVQ    $0x0006f4901c898f97, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xe286fd3632dfa5da, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x2f6abd7eac413cff, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x0fd3c72da21328b8, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0006f4901c898f97, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x6b18139138c3347f, CX
	MOVQ    $0xe286fd3632dfa5da, BX
	MOVQ    $0x2f6abd7eac413cff, SI
	MOVQ    $0x0fd3c72da21328b8, DI
	MOVQ    $0x0006f4901c898f97, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
