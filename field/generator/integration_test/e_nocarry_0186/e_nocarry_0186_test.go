...
var benchRese_nocarry_0186 e_nocarry_0186

func BenchmarkE_nocarry_0186SetBytes(b *testing.B) {
	var x e_nocarry_0186
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0186MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0186.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0186)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0186)
		}
	})
}

func BenchmarkE_nocarry_0186Inverse(b *testing.B) {
	var x e_nocarry_0186
	x.SetRandom()
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0186Butterfly(b *testing.B) {
	var x e_nocarry_0186
	x.SetRandom()
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0186)
	}
}

func BenchmarkE_nocarry_0186Exp(b *testing.B) {
	var x e_nocarry_0186
	x.SetRandom()
	benchRese_nocarry_0186.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0186Double(b *testing.B) {
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Double(&benchRese_nocarry_0186)
	}
}

func BenchmarkE_nocarry_0186Add(b *testing.B) {
	var x e_nocarry_0186
	x.SetRandom()
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Add(&x, &benchRese_nocarry_0186)
	}
}

func BenchmarkE_nocarry_0186Sub(b *testing.B) {
	var x e_nocarry_0186
	x.SetRandom()
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Sub(&x, &benchRese_nocarry_0186)
	}
}

func BenchmarkE_nocarry_0186Neg(b *testing.B) {
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Neg(&benchRese_nocarry_0186)
	}
}

func BenchmarkE_nocarry_0186Div(b *testing.B) {
	var x e_nocarry_0186
	x.SetRandom()
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Div(&x, &benchRese_nocarry_0186)
	}
}

func BenchmarkE_nocarry_0186FromMont(b *testing.B) {
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.FromMont()
	}
}

func BenchmarkE_nocarry_0186ToMont(b *testing.B) {
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.ToMont()
	}
}
func BenchmarkE_nocarry_0186Square(b *testing.B) {
	benchRese_nocarry_0186.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Square(&benchRese_nocarry_0186)
	}
}

func BenchmarkE_nocarry_0186Sqrt(b *testing.B) {
	var a e_nocarry_0186
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0186Mul(b *testing.B) {
	x := e_nocarry_0186{
		15381341531626724584,
		14471834829397069937,
		105602511631031018,
	}
	benchRese_nocarry_0186.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Mul(&benchRese_nocarry_0186, &x)
	}
}

func BenchmarkE_nocarry_0186Cmp(b *testing.B) {
	x := e_nocarry_0186{
		15381341531626724584,
		14471834829397069937,
		105602511631031018,
	}
	benchRese_nocarry_0186 = x
	benchRese_nocarry_0186[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0186.Cmp(&x)
	}
}

func TestE_nocarry_0186Cmp(t *testing.T) {
	var x, y e_nocarry_0186
...
func TestE_nocarry_0186IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0186
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0186

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0186{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0186
	one.SetOne()
	e.Sub(&qe_nocarry_0186, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0186{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0186{0, uint64(i)})
	}
...
func TestE_nocarry_0186NegZero(t *testing.T) {
	var a, b e_nocarry_0186
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0186Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0186, len(staticTestValues))
...
func TestE_nocarry_0186Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0186) bool {
			var b e_nocarry_0186
...
func TestE_nocarry_0186InverseExp(t *testing.T) {
...
func TestE_nocarry_0186MulByConstants(t *testing.T) {
...
func TestE_nocarry_0186Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0186) bool {
...
func TestE_nocarry_0186LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0186Halve(t *testing.T) {
...
func TestE_nocarry_0186FromMont(t *testing.T) {
...
type testPaire_nocarry_0186 struct {
	element e_nocarry_0186
	bigint  big.Int
}

func (z *e_nocarry_0186) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0186[2] {
		return true
	}
	if z[2] < qe_nocarry_0186[2] {
		return false
	...
	return z[0] >= qe_nocarry_0186[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0186

		g.element = e_nocarry_0186{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0186[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0186[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0186 {
			var g e_nocarry_0186
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0186[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0186[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0186[2], carry)
...
func Benchmarke_nocarry_0186InverseNew(b *testing.B) {
	var x e_nocarry_0186
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0186
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0186
		var xInv e_nocarry_0186
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0186
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0186
...
func testLinearComb(t *testing.T, x *e_nocarry_0186, xC int64, y *e_nocarry_0186, yC int64) {
	...
	var z e_nocarry_0186
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0186, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0186
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0186, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0186
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0186, xHi uint64) {
	var res e_nocarry_0186
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0186) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0186) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0186, c int64, result *e_nocarry_0186, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0186) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0186) uint64 {
