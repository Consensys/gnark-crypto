...
// modulus q
DATA q<>+0(SB)/8, $0x61dc883075cc7ffd
DATA q<>+8(SB)/8, $0x41cc6c44e885e225
DATA q<>+16(SB)/8, $0xe47f6f3183d468cc
DATA q<>+24(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x4a9f347a94332aab
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x61dc883075cc7ffd, R8
	MOVQ    $0x41cc6c44e885e225, R9
	MOVQ    $0xe47f6f3183d468cc, R10
	MOVQ    $1, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x41cc6c44e885e225, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xe47f6f3183d468cc, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $1, R8
	SBBQ  SI, R8
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x61dc883075cc7ffd, R12
	MOVQ    $0x41cc6c44e885e225, R13
	MOVQ    $0xe47f6f3183d468cc, R14
	MOVQ    $1, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
