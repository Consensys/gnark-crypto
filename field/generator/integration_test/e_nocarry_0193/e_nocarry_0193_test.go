...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0193{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0193{0, uint64(i)})
	}
...
func (z *e_nocarry_0193) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0193[3] {
		return true
	}
	if z[3] < qe_nocarry_0193[3] {
		return false
...
func Benchmarke_nocarry_0193InverseNew(b *testing.B) {
	var x e_nocarry_0193
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0193, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0193, xHi uint64) {
