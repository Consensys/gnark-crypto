...
// modulus q
DATA q<>+0(SB)/8, $0x03f1e6f4d29ef877
DATA q<>+8(SB)/8, $0xcfaa1442132971d6
DATA q<>+16(SB)/8, $0x00000000000f2583
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x2185f5a6d6a39eb9
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x03f1e6f4d29ef877, DI
	MOVQ    $0xcfaa1442132971d6, R8
	MOVQ    $0x00000000000f2583, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xcfaa1442132971d6, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x00000000000f2583, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x03f1e6f4d29ef877, R10
	MOVQ    $0xcfaa1442132971d6, R11
	MOVQ    $0x00000000000f2583, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
