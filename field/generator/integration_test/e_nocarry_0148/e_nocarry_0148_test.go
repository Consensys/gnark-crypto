...
var benchRese_nocarry_0148 e_nocarry_0148

func BenchmarkE_nocarry_0148SetBytes(b *testing.B) {
	var x e_nocarry_0148
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0148MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0148.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0148)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0148)
		}
	})
}

func BenchmarkE_nocarry_0148Inverse(b *testing.B) {
	var x e_nocarry_0148
	x.SetRandom()
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0148Butterfly(b *testing.B) {
	var x e_nocarry_0148
	x.SetRandom()
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0148)
	}
}

func BenchmarkE_nocarry_0148Exp(b *testing.B) {
	var x e_nocarry_0148
	x.SetRandom()
	benchRese_nocarry_0148.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0148Double(b *testing.B) {
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Double(&benchRese_nocarry_0148)
	}
}

func BenchmarkE_nocarry_0148Add(b *testing.B) {
	var x e_nocarry_0148
	x.SetRandom()
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Add(&x, &benchRese_nocarry_0148)
	}
}

func BenchmarkE_nocarry_0148Sub(b *testing.B) {
	var x e_nocarry_0148
	x.SetRandom()
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Sub(&x, &benchRese_nocarry_0148)
	}
}

func BenchmarkE_nocarry_0148Neg(b *testing.B) {
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Neg(&benchRese_nocarry_0148)
	}
}

func BenchmarkE_nocarry_0148Div(b *testing.B) {
	var x e_nocarry_0148
	x.SetRandom()
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Div(&x, &benchRese_nocarry_0148)
	}
}

func BenchmarkE_nocarry_0148FromMont(b *testing.B) {
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.FromMont()
	}
}

func BenchmarkE_nocarry_0148ToMont(b *testing.B) {
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.ToMont()
	}
}
func BenchmarkE_nocarry_0148Square(b *testing.B) {
	benchRese_nocarry_0148.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Square(&benchRese_nocarry_0148)
	}
}

func BenchmarkE_nocarry_0148Sqrt(b *testing.B) {
	var a e_nocarry_0148
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0148Mul(b *testing.B) {
	x := e_nocarry_0148{
		14712116820273154783,
		5602257205895223541,
		762422,
	}
	benchRese_nocarry_0148.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Mul(&benchRese_nocarry_0148, &x)
	}
}

func BenchmarkE_nocarry_0148Cmp(b *testing.B) {
	x := e_nocarry_0148{
		14712116820273154783,
		5602257205895223541,
		762422,
	}
	benchRese_nocarry_0148 = x
	benchRese_nocarry_0148[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0148.Cmp(&x)
	}
}

func TestE_nocarry_0148Cmp(t *testing.T) {
	var x, y e_nocarry_0148
...
func TestE_nocarry_0148IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0148
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0148

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0148{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0148
	one.SetOne()
	e.Sub(&qe_nocarry_0148, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0148{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0148{0, uint64(i)})
	}
...
func TestE_nocarry_0148NegZero(t *testing.T) {
	var a, b e_nocarry_0148
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0148Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0148, len(staticTestValues))
...
func TestE_nocarry_0148Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0148) bool {
			var b e_nocarry_0148
...
func TestE_nocarry_0148InverseExp(t *testing.T) {
...
func TestE_nocarry_0148MulByConstants(t *testing.T) {
...
func TestE_nocarry_0148Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0148) bool {
...
func TestE_nocarry_0148LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0148Halve(t *testing.T) {
...
func TestE_nocarry_0148FromMont(t *testing.T) {
...
type testPaire_nocarry_0148 struct {
	element e_nocarry_0148
	bigint  big.Int
}

func (z *e_nocarry_0148) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0148[2] {
		return true
	}
	if z[2] < qe_nocarry_0148[2] {
		return false
	...
	return z[0] >= qe_nocarry_0148[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0148

		g.element = e_nocarry_0148{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0148[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0148[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0148 {
			var g e_nocarry_0148
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0148[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0148[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0148[2], carry)
...
func Benchmarke_nocarry_0148InverseNew(b *testing.B) {
	var x e_nocarry_0148
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0148
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0148
		var xInv e_nocarry_0148
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0148
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0148
...
func testLinearComb(t *testing.T, x *e_nocarry_0148, xC int64, y *e_nocarry_0148, yC int64) {
	...
	var z e_nocarry_0148
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0148, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0148
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0148, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0148
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0148, xHi uint64) {
	var res e_nocarry_0148
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0148) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0148) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0148, c int64, result *e_nocarry_0148, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0148) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0148) uint64 {
