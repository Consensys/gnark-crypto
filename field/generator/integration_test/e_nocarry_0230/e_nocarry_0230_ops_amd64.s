...
// modulus q
DATA q<>+0(SB)/8, $0xf2bd466002bd5455
DATA q<>+8(SB)/8, $0x1d013536a2607e3f
DATA q<>+16(SB)/8, $0xcb0efcb918714213
DATA q<>+24(SB)/8, $0x00000031cc2ae816
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xbd5aff36d7c2f703
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xf2bd466002bd5455, R8
	MOVQ    $0x1d013536a2607e3f, R9
	MOVQ    $0xcb0efcb918714213, R10
	MOVQ    $0x00000031cc2ae816, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x1d013536a2607e3f, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xcb0efcb918714213, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000031cc2ae816, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xf2bd466002bd5455, R12
	MOVQ    $0x1d013536a2607e3f, R13
	MOVQ    $0xcb0efcb918714213, R14
	MOVQ    $0x00000031cc2ae816, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
