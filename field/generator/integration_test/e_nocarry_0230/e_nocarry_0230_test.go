...
var benchRese_nocarry_0230 e_nocarry_0230

func BenchmarkE_nocarry_0230SetBytes(b *testing.B) {
	var x e_nocarry_0230
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0230MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0230.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0230)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0230)
		}
	})
}

func BenchmarkE_nocarry_0230Inverse(b *testing.B) {
	var x e_nocarry_0230
	x.SetRandom()
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0230Butterfly(b *testing.B) {
	var x e_nocarry_0230
	x.SetRandom()
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0230)
	}
}

func BenchmarkE_nocarry_0230Exp(b *testing.B) {
	var x e_nocarry_0230
	x.SetRandom()
	benchRese_nocarry_0230.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0230Double(b *testing.B) {
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Double(&benchRese_nocarry_0230)
	}
}

func BenchmarkE_nocarry_0230Add(b *testing.B) {
	var x e_nocarry_0230
	x.SetRandom()
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Add(&x, &benchRese_nocarry_0230)
	}
}

func BenchmarkE_nocarry_0230Sub(b *testing.B) {
	var x e_nocarry_0230
	x.SetRandom()
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Sub(&x, &benchRese_nocarry_0230)
	}
}

func BenchmarkE_nocarry_0230Neg(b *testing.B) {
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Neg(&benchRese_nocarry_0230)
	}
}

func BenchmarkE_nocarry_0230Div(b *testing.B) {
	var x e_nocarry_0230
	x.SetRandom()
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Div(&x, &benchRese_nocarry_0230)
	}
}

func BenchmarkE_nocarry_0230FromMont(b *testing.B) {
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.FromMont()
	}
}

func BenchmarkE_nocarry_0230ToMont(b *testing.B) {
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.ToMont()
	}
}
func BenchmarkE_nocarry_0230Square(b *testing.B) {
	benchRese_nocarry_0230.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Square(&benchRese_nocarry_0230)
	}
}

func BenchmarkE_nocarry_0230Sqrt(b *testing.B) {
	var a e_nocarry_0230
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0230Mul(b *testing.B) {
	x := e_nocarry_0230{
		7620522220322642460,
	...
	benchRese_nocarry_0230.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Mul(&benchRese_nocarry_0230, &x)
	}
}

func BenchmarkE_nocarry_0230Cmp(b *testing.B) {
	x := e_nocarry_0230{
		7620522220322642460,
		15453108447328680026,
		1808778623605497587,
	...
	benchRese_nocarry_0230 = x
	benchRese_nocarry_0230[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0230.Cmp(&x)
	}
}

func TestE_nocarry_0230Cmp(t *testing.T) {
	var x, y e_nocarry_0230
...
func TestE_nocarry_0230IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0230
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0230

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0230{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0230
	one.SetOne()
	e.Sub(&qe_nocarry_0230, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0230{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0230{0, uint64(i)})
	}
...
func TestE_nocarry_0230NegZero(t *testing.T) {
	var a, b e_nocarry_0230
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0230Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0230, len(staticTestValues))
...
func TestE_nocarry_0230Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0230) bool {
			var b e_nocarry_0230
...
func TestE_nocarry_0230InverseExp(t *testing.T) {
...
func TestE_nocarry_0230MulByConstants(t *testing.T) {
...
func TestE_nocarry_0230Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0230) bool {
...
func TestE_nocarry_0230LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0230Halve(t *testing.T) {
...
func TestE_nocarry_0230FromMont(t *testing.T) {
...
type testPaire_nocarry_0230 struct {
	element e_nocarry_0230
	bigint  big.Int
}

func (z *e_nocarry_0230) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0230[3] {
		return true
	}
	if z[3] < qe_nocarry_0230[3] {
		return false
	...
	return z[0] >= qe_nocarry_0230[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0230

		g.element = e_nocarry_0230{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0230[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0230[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0230 {
			var g e_nocarry_0230
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0230[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0230[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0230[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0230[3], carry)
...
func Benchmarke_nocarry_0230InverseNew(b *testing.B) {
	var x e_nocarry_0230
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0230
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0230
		var xInv e_nocarry_0230
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0230
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0230
...
func testLinearComb(t *testing.T, x *e_nocarry_0230, xC int64, y *e_nocarry_0230, yC int64) {
	...
	var z e_nocarry_0230
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0230, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0230
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0230, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0230
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0230, xHi uint64) {
	var res e_nocarry_0230
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0230) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0230) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0230, c int64, result *e_nocarry_0230, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0230) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0230) uint64 {
