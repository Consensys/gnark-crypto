...
var benchRese_nocarry_0485 e_nocarry_0485

func BenchmarkE_nocarry_0485SetBytes(b *testing.B) {
	var x e_nocarry_0485
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0485MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0485.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0485)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0485)
		}
	})
}

func BenchmarkE_nocarry_0485Inverse(b *testing.B) {
	var x e_nocarry_0485
	x.SetRandom()
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0485Butterfly(b *testing.B) {
	var x e_nocarry_0485
	x.SetRandom()
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0485)
	}
}

func BenchmarkE_nocarry_0485Exp(b *testing.B) {
	var x e_nocarry_0485
	x.SetRandom()
	benchRese_nocarry_0485.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0485Double(b *testing.B) {
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Double(&benchRese_nocarry_0485)
	}
}

func BenchmarkE_nocarry_0485Add(b *testing.B) {
	var x e_nocarry_0485
	x.SetRandom()
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Add(&x, &benchRese_nocarry_0485)
	}
}

func BenchmarkE_nocarry_0485Sub(b *testing.B) {
	var x e_nocarry_0485
	x.SetRandom()
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Sub(&x, &benchRese_nocarry_0485)
	}
}

func BenchmarkE_nocarry_0485Neg(b *testing.B) {
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Neg(&benchRese_nocarry_0485)
	}
}

func BenchmarkE_nocarry_0485Div(b *testing.B) {
	var x e_nocarry_0485
	x.SetRandom()
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Div(&x, &benchRese_nocarry_0485)
	}
}

func BenchmarkE_nocarry_0485FromMont(b *testing.B) {
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.FromMont()
	}
}

func BenchmarkE_nocarry_0485ToMont(b *testing.B) {
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.ToMont()
	}
}
func BenchmarkE_nocarry_0485Square(b *testing.B) {
	benchRese_nocarry_0485.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Square(&benchRese_nocarry_0485)
	}
}

func BenchmarkE_nocarry_0485Sqrt(b *testing.B) {
	var a e_nocarry_0485
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0485Mul(b *testing.B) {
	x := e_nocarry_0485{
	...
	benchRese_nocarry_0485.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Mul(&benchRese_nocarry_0485, &x)
	}
}

func BenchmarkE_nocarry_0485Cmp(b *testing.B) {
	x := e_nocarry_0485{
		16935964364952491469,
		11548441397809709578,
		420852649862505396,
	...
	benchRese_nocarry_0485 = x
	benchRese_nocarry_0485[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0485.Cmp(&x)
	}
}

func TestE_nocarry_0485Cmp(t *testing.T) {
	var x, y e_nocarry_0485
...
func TestE_nocarry_0485IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0485
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0485

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0485{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0485
	one.SetOne()
	e.Sub(&qe_nocarry_0485, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0485{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0485{0, uint64(i)})
	}
...
func TestE_nocarry_0485NegZero(t *testing.T) {
	var a, b e_nocarry_0485
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0485Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0485, len(staticTestValues))
...
func TestE_nocarry_0485Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0485) bool {
			var b e_nocarry_0485
...
func TestE_nocarry_0485InverseExp(t *testing.T) {
...
func TestE_nocarry_0485MulByConstants(t *testing.T) {
...
func TestE_nocarry_0485Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0485) bool {
...
func TestE_nocarry_0485LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0485Halve(t *testing.T) {
...
func TestE_nocarry_0485FromMont(t *testing.T) {
...
type testPaire_nocarry_0485 struct {
	element e_nocarry_0485
	bigint  big.Int
}

func (z *e_nocarry_0485) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0485[7] {
		return true
	}
	if z[7] < qe_nocarry_0485[7] {
		return false
	...
	return z[0] >= qe_nocarry_0485[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0485

		g.element = e_nocarry_0485{
		...
		if qe_nocarry_0485[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0485[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0485 {
			var g e_nocarry_0485
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0485[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0485[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0485[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0485[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0485[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0485[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0485[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0485[7], carry)
...
func Benchmarke_nocarry_0485InverseNew(b *testing.B) {
	var x e_nocarry_0485
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0485
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0485
		var xInv e_nocarry_0485
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0485
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0485
...
func testLinearComb(t *testing.T, x *e_nocarry_0485, xC int64, y *e_nocarry_0485, yC int64) {
	...
	var z e_nocarry_0485
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0485, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0485
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0485, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0485
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0485, xHi uint64) {
	var res e_nocarry_0485
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0485) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0485) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0485, c int64, result *e_nocarry_0485, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0485) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0485) uint64 {
