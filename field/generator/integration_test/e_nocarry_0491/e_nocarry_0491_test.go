...
var benchRese_nocarry_0491 e_nocarry_0491

func BenchmarkE_nocarry_0491SetBytes(b *testing.B) {
	var x e_nocarry_0491
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0491MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0491.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0491)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0491)
		}
	})
}

func BenchmarkE_nocarry_0491Inverse(b *testing.B) {
	var x e_nocarry_0491
	x.SetRandom()
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0491Butterfly(b *testing.B) {
	var x e_nocarry_0491
	x.SetRandom()
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0491)
	}
}

func BenchmarkE_nocarry_0491Exp(b *testing.B) {
	var x e_nocarry_0491
	x.SetRandom()
	benchRese_nocarry_0491.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0491Double(b *testing.B) {
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Double(&benchRese_nocarry_0491)
	}
}

func BenchmarkE_nocarry_0491Add(b *testing.B) {
	var x e_nocarry_0491
	x.SetRandom()
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Add(&x, &benchRese_nocarry_0491)
	}
}

func BenchmarkE_nocarry_0491Sub(b *testing.B) {
	var x e_nocarry_0491
	x.SetRandom()
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Sub(&x, &benchRese_nocarry_0491)
	}
}

func BenchmarkE_nocarry_0491Neg(b *testing.B) {
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Neg(&benchRese_nocarry_0491)
	}
}

func BenchmarkE_nocarry_0491Div(b *testing.B) {
	var x e_nocarry_0491
	x.SetRandom()
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Div(&x, &benchRese_nocarry_0491)
	}
}

func BenchmarkE_nocarry_0491FromMont(b *testing.B) {
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.FromMont()
	}
}

func BenchmarkE_nocarry_0491ToMont(b *testing.B) {
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.ToMont()
	}
}
func BenchmarkE_nocarry_0491Square(b *testing.B) {
	benchRese_nocarry_0491.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Square(&benchRese_nocarry_0491)
	}
}

func BenchmarkE_nocarry_0491Sqrt(b *testing.B) {
	var a e_nocarry_0491
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0491Mul(b *testing.B) {
	x := e_nocarry_0491{
		3781521705113864506,
	...
	benchRese_nocarry_0491.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Mul(&benchRese_nocarry_0491, &x)
	}
}

func BenchmarkE_nocarry_0491Cmp(b *testing.B) {
	x := e_nocarry_0491{
		3781521705113864506,
		16702141961192039101,
		3855930293110602984,
	...
	benchRese_nocarry_0491 = x
	benchRese_nocarry_0491[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0491.Cmp(&x)
	}
}

func TestE_nocarry_0491Cmp(t *testing.T) {
	var x, y e_nocarry_0491
...
func TestE_nocarry_0491IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0491
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0491

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0491{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0491
	one.SetOne()
	e.Sub(&qe_nocarry_0491, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0491{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0491{0, uint64(i)})
	}
...
func TestE_nocarry_0491NegZero(t *testing.T) {
	var a, b e_nocarry_0491
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0491Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0491, len(staticTestValues))
...
func TestE_nocarry_0491Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0491) bool {
			var b e_nocarry_0491
...
func TestE_nocarry_0491InverseExp(t *testing.T) {
...
func TestE_nocarry_0491MulByConstants(t *testing.T) {
...
func TestE_nocarry_0491Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0491) bool {
...
func TestE_nocarry_0491LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0491Halve(t *testing.T) {
...
func TestE_nocarry_0491FromMont(t *testing.T) {
...
type testPaire_nocarry_0491 struct {
	element e_nocarry_0491
	bigint  big.Int
}

func (z *e_nocarry_0491) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0491[7] {
		return true
	}
	if z[7] < qe_nocarry_0491[7] {
		return false
	...
	return z[0] >= qe_nocarry_0491[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0491

		g.element = e_nocarry_0491{
		...
		if qe_nocarry_0491[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0491[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0491 {
			var g e_nocarry_0491
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0491[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0491[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0491[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0491[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0491[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0491[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0491[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0491[7], carry)
...
func Benchmarke_nocarry_0491InverseNew(b *testing.B) {
	var x e_nocarry_0491
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0491
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0491
		var xInv e_nocarry_0491
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0491
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0491
...
func testLinearComb(t *testing.T, x *e_nocarry_0491, xC int64, y *e_nocarry_0491, yC int64) {
	...
	var z e_nocarry_0491
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0491, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0491
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0491, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0491
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0491, xHi uint64) {
	var res e_nocarry_0491
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0491) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0491) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0491, c int64, result *e_nocarry_0491, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0491) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0491) uint64 {
