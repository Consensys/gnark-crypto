...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x87b275126c5df29b, R14
	ADDQ R14, AX
	MOVQ $0xdf7ea0513a8824c1, R14
	ADCQ R14, DX
	MOVQ $0xa6fa2a5e81acc069, R14
	ADCQ R14, CX
	MOVQ $0xb8e57646a15ea3e5, R14
	ADCQ R14, BX
	MOVQ $0x8598db2983874e83, R14
	ADCQ R14, SI
	MOVQ $0x791a6f2b08e4666e, R14
	ADCQ R14, DI
	MOVQ $0x5070b1224683b551, R14
	ADCQ R14, R8
	MOVQ $0x3aefb82835b5725a, R14
	ADCQ R14, R9
	MOVQ $0x308916ecdfb18931, R14
	ADCQ R14, R10
	MOVQ $0x0f458a8aafb016b0, R14
	ADCQ R14, R11
	MOVQ $0x000000000ca5ac62, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x87b275126c5df29b, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xdf7ea0513a8824c1, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xa6fa2a5e81acc069, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xb8e57646a15ea3e5, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x8598db2983874e83, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x791a6f2b08e4666e, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x5070b1224683b551, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x3aefb82835b5725a, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x308916ecdfb18931, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x0f458a8aafb016b0, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000000ca5ac62, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x87b275126c5df29b, AX
	ADDQ AX, DX
	MOVQ $0xdf7ea0513a8824c1, AX
	ADCQ AX, CX
	MOVQ $0xa6fa2a5e81acc069, AX
	ADCQ AX, BX
	MOVQ $0xb8e57646a15ea3e5, AX
	ADCQ AX, SI
	MOVQ $0x8598db2983874e83, AX
	ADCQ AX, DI
	MOVQ $0x791a6f2b08e4666e, AX
	ADCQ AX, R8
	MOVQ $0x5070b1224683b551, AX
	ADCQ AX, R9
	MOVQ $0x3aefb82835b5725a, AX
	ADCQ AX, R10
	MOVQ $0x308916ecdfb18931, AX
	ADCQ AX, R11
	MOVQ $0x0f458a8aafb016b0, AX
	ADCQ AX, R12
	MOVQ $0x000000000ca5ac62, AX
	ADCQ AX, R13
