...
// modulus q
DATA q<>+0(SB)/8, $0x87b275126c5df29b
DATA q<>+8(SB)/8, $0xdf7ea0513a8824c1
DATA q<>+16(SB)/8, $0xa6fa2a5e81acc069
DATA q<>+24(SB)/8, $0xb8e57646a15ea3e5
DATA q<>+32(SB)/8, $0x8598db2983874e83
DATA q<>+40(SB)/8, $0x791a6f2b08e4666e
DATA q<>+48(SB)/8, $0x5070b1224683b551
DATA q<>+56(SB)/8, $0x3aefb82835b5725a
DATA q<>+64(SB)/8, $0x308916ecdfb18931
DATA q<>+72(SB)/8, $0x0f458a8aafb016b0
DATA q<>+80(SB)/8, $0x000000000ca5ac62
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xa1d4850caf705c6d
