...
var benchRese_nocarry_0668 e_nocarry_0668

func BenchmarkE_nocarry_0668SetBytes(b *testing.B) {
	var x e_nocarry_0668
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0668MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0668.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0668)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0668)
		}
	})
}

func BenchmarkE_nocarry_0668Inverse(b *testing.B) {
	var x e_nocarry_0668
	x.SetRandom()
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0668Butterfly(b *testing.B) {
	var x e_nocarry_0668
	x.SetRandom()
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0668)
	}
}

func BenchmarkE_nocarry_0668Exp(b *testing.B) {
	var x e_nocarry_0668
	x.SetRandom()
	benchRese_nocarry_0668.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0668Double(b *testing.B) {
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Double(&benchRese_nocarry_0668)
	}
}

func BenchmarkE_nocarry_0668Add(b *testing.B) {
	var x e_nocarry_0668
	x.SetRandom()
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Add(&x, &benchRese_nocarry_0668)
	}
}

func BenchmarkE_nocarry_0668Sub(b *testing.B) {
	var x e_nocarry_0668
	x.SetRandom()
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Sub(&x, &benchRese_nocarry_0668)
	}
}

func BenchmarkE_nocarry_0668Neg(b *testing.B) {
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Neg(&benchRese_nocarry_0668)
	}
}

func BenchmarkE_nocarry_0668Div(b *testing.B) {
	var x e_nocarry_0668
	x.SetRandom()
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Div(&x, &benchRese_nocarry_0668)
	}
}

func BenchmarkE_nocarry_0668FromMont(b *testing.B) {
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.FromMont()
	}
}

func BenchmarkE_nocarry_0668ToMont(b *testing.B) {
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.ToMont()
	}
}
func BenchmarkE_nocarry_0668Square(b *testing.B) {
	benchRese_nocarry_0668.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Square(&benchRese_nocarry_0668)
	}
}

func BenchmarkE_nocarry_0668Sqrt(b *testing.B) {
	var a e_nocarry_0668
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0668Mul(b *testing.B) {
	x := e_nocarry_0668{
	...
	benchRese_nocarry_0668.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Mul(&benchRese_nocarry_0668, &x)
	}
}

func BenchmarkE_nocarry_0668Cmp(b *testing.B) {
	x := e_nocarry_0668{
		15866575747037874232,
		8479482831976578398,
		18378249779876361711,
	...
	benchRese_nocarry_0668 = x
	benchRese_nocarry_0668[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0668.Cmp(&x)
	}
}

func TestE_nocarry_0668Cmp(t *testing.T) {
	var x, y e_nocarry_0668
...
func TestE_nocarry_0668IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0668
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0668

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0668{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0668
	one.SetOne()
	e.Sub(&qe_nocarry_0668, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0668{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0668{0, uint64(i)})
	}
...
func TestE_nocarry_0668NegZero(t *testing.T) {
	var a, b e_nocarry_0668
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0668Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0668, len(staticTestValues))
...
func TestE_nocarry_0668Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0668) bool {
			var b e_nocarry_0668
...
func TestE_nocarry_0668InverseExp(t *testing.T) {
...
func TestE_nocarry_0668MulByConstants(t *testing.T) {
...
func TestE_nocarry_0668Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0668) bool {
...
func TestE_nocarry_0668LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0668Halve(t *testing.T) {
...
func TestE_nocarry_0668FromMont(t *testing.T) {
...
type testPaire_nocarry_0668 struct {
	element e_nocarry_0668
	bigint  big.Int
}

func (z *e_nocarry_0668) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0668[10] {
		return true
	}
	if z[10] < qe_nocarry_0668[10] {
		return false
	...
	return z[0] >= qe_nocarry_0668[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0668

		g.element = e_nocarry_0668{
		...
		if qe_nocarry_0668[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0668[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0668 {
			var g e_nocarry_0668
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0668[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0668[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0668[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0668[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0668[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0668[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0668[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0668[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0668[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0668[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0668[10], carry)
...
func Benchmarke_nocarry_0668InverseNew(b *testing.B) {
	var x e_nocarry_0668
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0668
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0668
		var xInv e_nocarry_0668
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0668
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0668
...
func testLinearComb(t *testing.T, x *e_nocarry_0668, xC int64, y *e_nocarry_0668, yC int64) {
	...
	var z e_nocarry_0668
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0668, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0668
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0668, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0668
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0668, xHi uint64) {
	var res e_nocarry_0668
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0668) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0668) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0668, c int64, result *e_nocarry_0668, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0668) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0668) uint64 {
