...
var benchRese_nocarry_0504 e_nocarry_0504

func BenchmarkE_nocarry_0504SetBytes(b *testing.B) {
	var x e_nocarry_0504
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0504MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0504.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0504)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0504)
		}
	})
}

func BenchmarkE_nocarry_0504Inverse(b *testing.B) {
	var x e_nocarry_0504
	x.SetRandom()
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0504Butterfly(b *testing.B) {
	var x e_nocarry_0504
	x.SetRandom()
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0504)
	}
}

func BenchmarkE_nocarry_0504Exp(b *testing.B) {
	var x e_nocarry_0504
	x.SetRandom()
	benchRese_nocarry_0504.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0504Double(b *testing.B) {
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Double(&benchRese_nocarry_0504)
	}
}

func BenchmarkE_nocarry_0504Add(b *testing.B) {
	var x e_nocarry_0504
	x.SetRandom()
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Add(&x, &benchRese_nocarry_0504)
	}
}

func BenchmarkE_nocarry_0504Sub(b *testing.B) {
	var x e_nocarry_0504
	x.SetRandom()
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Sub(&x, &benchRese_nocarry_0504)
	}
}

func BenchmarkE_nocarry_0504Neg(b *testing.B) {
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Neg(&benchRese_nocarry_0504)
	}
}

func BenchmarkE_nocarry_0504Div(b *testing.B) {
	var x e_nocarry_0504
	x.SetRandom()
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Div(&x, &benchRese_nocarry_0504)
	}
}

func BenchmarkE_nocarry_0504FromMont(b *testing.B) {
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.FromMont()
	}
}

func BenchmarkE_nocarry_0504ToMont(b *testing.B) {
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.ToMont()
	}
}
func BenchmarkE_nocarry_0504Square(b *testing.B) {
	benchRese_nocarry_0504.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Square(&benchRese_nocarry_0504)
	}
}

func BenchmarkE_nocarry_0504Sqrt(b *testing.B) {
	var a e_nocarry_0504
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0504Mul(b *testing.B) {
	x := e_nocarry_0504{
		5570274379054850755,
		9146180400996665748,
		134285521841021700,
	...
	benchRese_nocarry_0504.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Mul(&benchRese_nocarry_0504, &x)
	}
}

func BenchmarkE_nocarry_0504Cmp(b *testing.B) {
	x := e_nocarry_0504{
		5570274379054850755,
		9146180400996665748,
		134285521841021700,
	...
	benchRese_nocarry_0504 = x
	benchRese_nocarry_0504[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0504.Cmp(&x)
	}
}

func TestE_nocarry_0504Cmp(t *testing.T) {
	var x, y e_nocarry_0504
...
func TestE_nocarry_0504IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0504
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0504

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0504{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0504
	one.SetOne()
	e.Sub(&qe_nocarry_0504, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0504{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0504{0, uint64(i)})
	}
...
func TestE_nocarry_0504NegZero(t *testing.T) {
	var a, b e_nocarry_0504
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0504Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0504, len(staticTestValues))
...
func TestE_nocarry_0504Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0504) bool {
			var b e_nocarry_0504
...
func TestE_nocarry_0504InverseExp(t *testing.T) {
...
func TestE_nocarry_0504MulByConstants(t *testing.T) {
...
func TestE_nocarry_0504Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0504) bool {
...
func TestE_nocarry_0504LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0504Halve(t *testing.T) {
...
func TestE_nocarry_0504FromMont(t *testing.T) {
...
type testPaire_nocarry_0504 struct {
	element e_nocarry_0504
	bigint  big.Int
}

func (z *e_nocarry_0504) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0504[7] {
		return true
	}
	if z[7] < qe_nocarry_0504[7] {
		return false
	...
	return z[0] >= qe_nocarry_0504[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0504

		g.element = e_nocarry_0504{
		...
		if qe_nocarry_0504[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0504[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0504 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0504[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0504[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0504[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0504[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0504[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0504[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0504[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0504[7], carry)
...
func Benchmarke_nocarry_0504InverseNew(b *testing.B) {
	var x e_nocarry_0504
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0504
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0504
		var xInv e_nocarry_0504
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0504
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0504
...
func testLinearComb(t *testing.T, x *e_nocarry_0504, xC int64, y *e_nocarry_0504, yC int64) {
	...
	var z e_nocarry_0504
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0504, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0504
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0504, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0504
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0504, xHi uint64) {
	var res e_nocarry_0504
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0504) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0504) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0504, c int64, result *e_nocarry_0504, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0504) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0504) uint64 {
