...
// modulus q
DATA q<>+0(SB)/8, $0xd9f0339b4d17083b
DATA q<>+8(SB)/8, $0xf21cd8e7dd8fd521
DATA q<>+16(SB)/8, $0xd79c8d4b7d6630b1
DATA q<>+24(SB)/8, $0x1ef0d218f330ee5d
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x72e1830faa996f0d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xd9f0339b4d17083b, R8
	MOVQ    $0xf21cd8e7dd8fd521, R9
	MOVQ    $0xd79c8d4b7d6630b1, R10
	MOVQ    $0x1ef0d218f330ee5d, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xf21cd8e7dd8fd521, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xd79c8d4b7d6630b1, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x1ef0d218f330ee5d, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xd9f0339b4d17083b, R12
	MOVQ    $0xf21cd8e7dd8fd521, R13
	MOVQ    $0xd79c8d4b7d6630b1, R14
	MOVQ    $0x1ef0d218f330ee5d, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
