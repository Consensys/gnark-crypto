...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0253{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0253{0, uint64(i)})
	}
...
func (z *e_nocarry_0253) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0253[3] {
		return true
	}
	if z[3] < qe_nocarry_0253[3] {
		return false
...
func Benchmarke_nocarry_0253InverseNew(b *testing.B) {
	var x e_nocarry_0253
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0253, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0253, xHi uint64) {
