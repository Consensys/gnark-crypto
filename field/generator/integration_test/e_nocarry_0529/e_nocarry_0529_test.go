...
var benchRese_nocarry_0529 e_nocarry_0529

func BenchmarkE_nocarry_0529SetBytes(b *testing.B) {
	var x e_nocarry_0529
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0529MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0529.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0529)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0529)
		}
	})
}

func BenchmarkE_nocarry_0529Inverse(b *testing.B) {
	var x e_nocarry_0529
	x.SetRandom()
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0529Butterfly(b *testing.B) {
	var x e_nocarry_0529
	x.SetRandom()
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0529)
	}
}

func BenchmarkE_nocarry_0529Exp(b *testing.B) {
	var x e_nocarry_0529
	x.SetRandom()
	benchRese_nocarry_0529.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0529Double(b *testing.B) {
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Double(&benchRese_nocarry_0529)
	}
}

func BenchmarkE_nocarry_0529Add(b *testing.B) {
	var x e_nocarry_0529
	x.SetRandom()
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Add(&x, &benchRese_nocarry_0529)
	}
}

func BenchmarkE_nocarry_0529Sub(b *testing.B) {
	var x e_nocarry_0529
	x.SetRandom()
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Sub(&x, &benchRese_nocarry_0529)
	}
}

func BenchmarkE_nocarry_0529Neg(b *testing.B) {
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Neg(&benchRese_nocarry_0529)
	}
}

func BenchmarkE_nocarry_0529Div(b *testing.B) {
	var x e_nocarry_0529
	x.SetRandom()
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Div(&x, &benchRese_nocarry_0529)
	}
}

func BenchmarkE_nocarry_0529FromMont(b *testing.B) {
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.FromMont()
	}
}

func BenchmarkE_nocarry_0529ToMont(b *testing.B) {
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.ToMont()
	}
}
func BenchmarkE_nocarry_0529Square(b *testing.B) {
	benchRese_nocarry_0529.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Square(&benchRese_nocarry_0529)
	}
}

func BenchmarkE_nocarry_0529Sqrt(b *testing.B) {
	var a e_nocarry_0529
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0529Mul(b *testing.B) {
	x := e_nocarry_0529{
		3629442697185655852,
	...
	benchRese_nocarry_0529.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Mul(&benchRese_nocarry_0529, &x)
	}
}

func BenchmarkE_nocarry_0529Cmp(b *testing.B) {
	x := e_nocarry_0529{
		3629442697185655852,
		17333137196897127870,
		2183313451710711106,
	...
	benchRese_nocarry_0529 = x
	benchRese_nocarry_0529[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0529.Cmp(&x)
	}
}

func TestE_nocarry_0529Cmp(t *testing.T) {
	var x, y e_nocarry_0529
...
func TestE_nocarry_0529IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0529
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0529

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0529{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0529
	one.SetOne()
	e.Sub(&qe_nocarry_0529, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0529{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0529{0, uint64(i)})
	}
...
func TestE_nocarry_0529NegZero(t *testing.T) {
	var a, b e_nocarry_0529
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0529Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0529, len(staticTestValues))
...
func TestE_nocarry_0529Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0529) bool {
			var b e_nocarry_0529
...
func TestE_nocarry_0529InverseExp(t *testing.T) {
...
func TestE_nocarry_0529MulByConstants(t *testing.T) {
...
func TestE_nocarry_0529Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0529) bool {
...
func TestE_nocarry_0529LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0529Halve(t *testing.T) {
...
func TestE_nocarry_0529FromMont(t *testing.T) {
...
type testPaire_nocarry_0529 struct {
	element e_nocarry_0529
	bigint  big.Int
}

func (z *e_nocarry_0529) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0529[8] {
		return true
	}
	if z[8] < qe_nocarry_0529[8] {
		return false
	...
	return z[0] >= qe_nocarry_0529[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0529

		g.element = e_nocarry_0529{
		...
		if qe_nocarry_0529[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0529[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0529 {
			var g e_nocarry_0529
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0529[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0529[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0529[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0529[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0529[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0529[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0529[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0529[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0529[8], carry)
...
func Benchmarke_nocarry_0529InverseNew(b *testing.B) {
	var x e_nocarry_0529
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0529
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0529
		var xInv e_nocarry_0529
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0529
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0529
...
func testLinearComb(t *testing.T, x *e_nocarry_0529, xC int64, y *e_nocarry_0529, yC int64) {
	...
	var z e_nocarry_0529
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0529, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0529
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0529, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0529
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0529, xHi uint64) {
	var res e_nocarry_0529
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0529) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0529) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0529, c int64, result *e_nocarry_0529, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0529) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0529) uint64 {
