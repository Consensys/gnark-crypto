...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x2ff7c805a94ab3a3, R12
	ADDQ R12, AX
	MOVQ $0x47b230df900d97f1, R12
	ADCQ R12, DX
	MOVQ $0xa0ffb9bbd90ee375, R12
	ADCQ R12, CX
	MOVQ $0xfcfafe39bac56525, R12
	ADCQ R12, BX
	MOVQ $0xe1915e4834b9853a, R12
	ADCQ R12, SI
	MOVQ $0xaa698561c5780117, R12
	ADCQ R12, DI
	MOVQ $0x9ebd4b114f4e5935, R12
	ADCQ R12, R8
	MOVQ $0x7e097c395f7dabce, R12
	ADCQ R12, R9
	MOVQ $0x000000000001b5ae, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x2ff7c805a94ab3a3, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x47b230df900d97f1, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xa0ffb9bbd90ee375, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xfcfafe39bac56525, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xe1915e4834b9853a, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xaa698561c5780117, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x9ebd4b114f4e5935, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x7e097c395f7dabce, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000000001b5ae, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x2ff7c805a94ab3a3, AX
	ADDQ AX, DX
	MOVQ $0x47b230df900d97f1, AX
	ADCQ AX, CX
	MOVQ $0xa0ffb9bbd90ee375, AX
	ADCQ AX, BX
	MOVQ $0xfcfafe39bac56525, AX
	ADCQ AX, SI
	MOVQ $0xe1915e4834b9853a, AX
	ADCQ AX, DI
	MOVQ $0xaa698561c5780117, AX
	ADCQ AX, R8
	MOVQ $0x9ebd4b114f4e5935, AX
	ADCQ AX, R9
	MOVQ $0x7e097c395f7dabce, AX
	ADCQ AX, R10
	MOVQ $0x000000000001b5ae, AX
	ADCQ AX, R11
