...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xf93cccddf433d187, R14
	ADDQ R14, AX
	MOVQ $0x9c4e55a381d233c3, R14
	ADCQ R14, DX
	MOVQ $0xb08364ba408968f4, R14
	ADCQ R14, CX
	MOVQ $0xa54d11ccaee8dba7, R14
	ADCQ R14, BX
	MOVQ $0x277a5d273d731db4, R14
	ADCQ R14, SI
	MOVQ $0x07fed7e62c04de1b, R14
	ADCQ R14, DI
	MOVQ $0x3aa647bb7febf14e, R14
	ADCQ R14, R8
	MOVQ $0x3d491e93eea111ff, R14
	ADCQ R14, R9
	MOVQ $0x68265cef0cbe1584, R14
	ADCQ R14, R10
	MOVQ $0x80588ca3114943c1, R14
	ADCQ R14, R11
	MOVQ $0x000000000000000d, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf93cccddf433d187, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x9c4e55a381d233c3, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xb08364ba408968f4, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xa54d11ccaee8dba7, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x277a5d273d731db4, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x07fed7e62c04de1b, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x3aa647bb7febf14e, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x3d491e93eea111ff, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x68265cef0cbe1584, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x80588ca3114943c1, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000000000000d, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xf93cccddf433d187, AX
	ADDQ AX, DX
	MOVQ $0x9c4e55a381d233c3, AX
	ADCQ AX, CX
	MOVQ $0xb08364ba408968f4, AX
	ADCQ AX, BX
	MOVQ $0xa54d11ccaee8dba7, AX
	ADCQ AX, SI
	MOVQ $0x277a5d273d731db4, AX
	ADCQ AX, DI
	MOVQ $0x07fed7e62c04de1b, AX
	ADCQ AX, R8
	MOVQ $0x3aa647bb7febf14e, AX
	ADCQ AX, R9
	MOVQ $0x3d491e93eea111ff, AX
	ADCQ AX, R10
	MOVQ $0x68265cef0cbe1584, AX
	ADCQ AX, R11
	MOVQ $0x80588ca3114943c1, AX
	ADCQ AX, R12
	MOVQ $0x000000000000000d, AX
	ADCQ AX, R13
