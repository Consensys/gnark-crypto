...
var benchRese_nocarry_0644 e_nocarry_0644

func BenchmarkE_nocarry_0644SetBytes(b *testing.B) {
	var x e_nocarry_0644
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0644MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0644.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0644)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0644)
		}
	})
}

func BenchmarkE_nocarry_0644Inverse(b *testing.B) {
	var x e_nocarry_0644
	x.SetRandom()
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0644Butterfly(b *testing.B) {
	var x e_nocarry_0644
	x.SetRandom()
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0644)
	}
}

func BenchmarkE_nocarry_0644Exp(b *testing.B) {
	var x e_nocarry_0644
	x.SetRandom()
	benchRese_nocarry_0644.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0644Double(b *testing.B) {
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Double(&benchRese_nocarry_0644)
	}
}

func BenchmarkE_nocarry_0644Add(b *testing.B) {
	var x e_nocarry_0644
	x.SetRandom()
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Add(&x, &benchRese_nocarry_0644)
	}
}

func BenchmarkE_nocarry_0644Sub(b *testing.B) {
	var x e_nocarry_0644
	x.SetRandom()
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Sub(&x, &benchRese_nocarry_0644)
	}
}

func BenchmarkE_nocarry_0644Neg(b *testing.B) {
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Neg(&benchRese_nocarry_0644)
	}
}

func BenchmarkE_nocarry_0644Div(b *testing.B) {
	var x e_nocarry_0644
	x.SetRandom()
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Div(&x, &benchRese_nocarry_0644)
	}
}

func BenchmarkE_nocarry_0644FromMont(b *testing.B) {
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.FromMont()
	}
}

func BenchmarkE_nocarry_0644ToMont(b *testing.B) {
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.ToMont()
	}
}
func BenchmarkE_nocarry_0644Square(b *testing.B) {
	benchRese_nocarry_0644.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Square(&benchRese_nocarry_0644)
	}
}

func BenchmarkE_nocarry_0644Sqrt(b *testing.B) {
	var a e_nocarry_0644
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0644Mul(b *testing.B) {
	x := e_nocarry_0644{
		8834578418998275846,
	...
	benchRese_nocarry_0644.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Mul(&benchRese_nocarry_0644, &x)
	}
}

func BenchmarkE_nocarry_0644Cmp(b *testing.B) {
	x := e_nocarry_0644{
		8834578418998275846,
		10444149893399937195,
		15795455197695804831,
	...
	benchRese_nocarry_0644 = x
	benchRese_nocarry_0644[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0644.Cmp(&x)
	}
}

func TestE_nocarry_0644Cmp(t *testing.T) {
	var x, y e_nocarry_0644
...
func TestE_nocarry_0644IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0644
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0644

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0644{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0644
	one.SetOne()
	e.Sub(&qe_nocarry_0644, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0644{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0644{0, uint64(i)})
	}
...
func TestE_nocarry_0644NegZero(t *testing.T) {
	var a, b e_nocarry_0644
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0644Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0644, len(staticTestValues))
...
func TestE_nocarry_0644Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0644) bool {
			var b e_nocarry_0644
...
func TestE_nocarry_0644InverseExp(t *testing.T) {
...
func TestE_nocarry_0644MulByConstants(t *testing.T) {
...
func TestE_nocarry_0644Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0644) bool {
...
func TestE_nocarry_0644LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0644Halve(t *testing.T) {
...
func TestE_nocarry_0644FromMont(t *testing.T) {
...
type testPaire_nocarry_0644 struct {
	element e_nocarry_0644
	bigint  big.Int
}

func (z *e_nocarry_0644) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0644[10] {
		return true
	}
	if z[10] < qe_nocarry_0644[10] {
		return false
	...
	return z[0] >= qe_nocarry_0644[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0644

		g.element = e_nocarry_0644{
		...
		if qe_nocarry_0644[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0644[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0644 {
			var g e_nocarry_0644
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0644[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0644[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0644[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0644[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0644[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0644[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0644[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0644[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0644[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0644[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0644[10], carry)
...
func Benchmarke_nocarry_0644InverseNew(b *testing.B) {
	var x e_nocarry_0644
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0644
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0644
		var xInv e_nocarry_0644
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0644
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0644
...
func testLinearComb(t *testing.T, x *e_nocarry_0644, xC int64, y *e_nocarry_0644, yC int64) {
	...
	var z e_nocarry_0644
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0644, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0644
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0644, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0644
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0644, xHi uint64) {
	var res e_nocarry_0644
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0644) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0644) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0644, c int64, result *e_nocarry_0644, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0644) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0644) uint64 {
