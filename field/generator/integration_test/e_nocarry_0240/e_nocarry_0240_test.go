...
var benchRese_nocarry_0240 e_nocarry_0240

func BenchmarkE_nocarry_0240SetBytes(b *testing.B) {
	var x e_nocarry_0240
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0240MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0240.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0240)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0240)
		}
	})
}

func BenchmarkE_nocarry_0240Inverse(b *testing.B) {
	var x e_nocarry_0240
	x.SetRandom()
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0240Butterfly(b *testing.B) {
	var x e_nocarry_0240
	x.SetRandom()
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0240)
	}
}

func BenchmarkE_nocarry_0240Exp(b *testing.B) {
	var x e_nocarry_0240
	x.SetRandom()
	benchRese_nocarry_0240.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0240Double(b *testing.B) {
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Double(&benchRese_nocarry_0240)
	}
}

func BenchmarkE_nocarry_0240Add(b *testing.B) {
	var x e_nocarry_0240
	x.SetRandom()
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Add(&x, &benchRese_nocarry_0240)
	}
}

func BenchmarkE_nocarry_0240Sub(b *testing.B) {
	var x e_nocarry_0240
	x.SetRandom()
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Sub(&x, &benchRese_nocarry_0240)
	}
}

func BenchmarkE_nocarry_0240Neg(b *testing.B) {
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Neg(&benchRese_nocarry_0240)
	}
}

func BenchmarkE_nocarry_0240Div(b *testing.B) {
	var x e_nocarry_0240
	x.SetRandom()
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Div(&x, &benchRese_nocarry_0240)
	}
}

func BenchmarkE_nocarry_0240FromMont(b *testing.B) {
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.FromMont()
	}
}

func BenchmarkE_nocarry_0240ToMont(b *testing.B) {
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.ToMont()
	}
}
func BenchmarkE_nocarry_0240Square(b *testing.B) {
	benchRese_nocarry_0240.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Square(&benchRese_nocarry_0240)
	}
}

func BenchmarkE_nocarry_0240Sqrt(b *testing.B) {
	var a e_nocarry_0240
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0240Mul(b *testing.B) {
	x := e_nocarry_0240{
	...
	benchRese_nocarry_0240.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Mul(&benchRese_nocarry_0240, &x)
	}
}

func BenchmarkE_nocarry_0240Cmp(b *testing.B) {
	x := e_nocarry_0240{
		10679715859394139774,
		17819338768726885242,
		12851774171918375074,
	...
	benchRese_nocarry_0240 = x
	benchRese_nocarry_0240[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0240.Cmp(&x)
	}
}

func TestE_nocarry_0240Cmp(t *testing.T) {
	var x, y e_nocarry_0240
...
func TestE_nocarry_0240IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0240
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0240

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0240{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0240
	one.SetOne()
	e.Sub(&qe_nocarry_0240, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0240{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0240{0, uint64(i)})
	}
...
func TestE_nocarry_0240NegZero(t *testing.T) {
	var a, b e_nocarry_0240
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0240Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0240, len(staticTestValues))
...
func TestE_nocarry_0240Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0240) bool {
			var b e_nocarry_0240
...
func TestE_nocarry_0240InverseExp(t *testing.T) {
...
func TestE_nocarry_0240MulByConstants(t *testing.T) {
...
func TestE_nocarry_0240Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0240) bool {
...
func TestE_nocarry_0240LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0240Halve(t *testing.T) {
...
func TestE_nocarry_0240FromMont(t *testing.T) {
...
type testPaire_nocarry_0240 struct {
	element e_nocarry_0240
	bigint  big.Int
}

func (z *e_nocarry_0240) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0240[3] {
		return true
	}
	if z[3] < qe_nocarry_0240[3] {
		return false
	...
	return z[0] >= qe_nocarry_0240[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0240

		g.element = e_nocarry_0240{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0240[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0240[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0240 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0240[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0240[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0240[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0240[3], carry)
...
func Benchmarke_nocarry_0240InverseNew(b *testing.B) {
	var x e_nocarry_0240
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0240
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0240
		var xInv e_nocarry_0240
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0240
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0240
...
func testLinearComb(t *testing.T, x *e_nocarry_0240, xC int64, y *e_nocarry_0240, yC int64) {
	...
	var z e_nocarry_0240
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0240, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0240
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0240, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0240
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0240, xHi uint64) {
	var res e_nocarry_0240
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0240) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0240) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0240, c int64, result *e_nocarry_0240, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0240) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0240) uint64 {
