...
var benchRese_nocarry_0653 e_nocarry_0653

func BenchmarkE_nocarry_0653SetBytes(b *testing.B) {
	var x e_nocarry_0653
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0653MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0653.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0653)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0653)
		}
	})
}

func BenchmarkE_nocarry_0653Inverse(b *testing.B) {
	var x e_nocarry_0653
	x.SetRandom()
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0653Butterfly(b *testing.B) {
	var x e_nocarry_0653
	x.SetRandom()
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0653)
	}
}

func BenchmarkE_nocarry_0653Exp(b *testing.B) {
	var x e_nocarry_0653
	x.SetRandom()
	benchRese_nocarry_0653.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0653Double(b *testing.B) {
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Double(&benchRese_nocarry_0653)
	}
}

func BenchmarkE_nocarry_0653Add(b *testing.B) {
	var x e_nocarry_0653
	x.SetRandom()
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Add(&x, &benchRese_nocarry_0653)
	}
}

func BenchmarkE_nocarry_0653Sub(b *testing.B) {
	var x e_nocarry_0653
	x.SetRandom()
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Sub(&x, &benchRese_nocarry_0653)
	}
}

func BenchmarkE_nocarry_0653Neg(b *testing.B) {
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Neg(&benchRese_nocarry_0653)
	}
}

func BenchmarkE_nocarry_0653Div(b *testing.B) {
	var x e_nocarry_0653
	x.SetRandom()
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Div(&x, &benchRese_nocarry_0653)
	}
}

func BenchmarkE_nocarry_0653FromMont(b *testing.B) {
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.FromMont()
	}
}

func BenchmarkE_nocarry_0653ToMont(b *testing.B) {
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.ToMont()
	}
}
func BenchmarkE_nocarry_0653Square(b *testing.B) {
	benchRese_nocarry_0653.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Square(&benchRese_nocarry_0653)
	}
}

func BenchmarkE_nocarry_0653Sqrt(b *testing.B) {
	var a e_nocarry_0653
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0653Mul(b *testing.B) {
	x := e_nocarry_0653{
		2788744933976040069,
		4489451845683639848,
	...
	benchRese_nocarry_0653.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Mul(&benchRese_nocarry_0653, &x)
	}
}

func BenchmarkE_nocarry_0653Cmp(b *testing.B) {
	x := e_nocarry_0653{
		2788744933976040069,
		4489451845683639848,
		14223779678740767502,
	...
	benchRese_nocarry_0653 = x
	benchRese_nocarry_0653[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0653.Cmp(&x)
	}
}

func TestE_nocarry_0653Cmp(t *testing.T) {
	var x, y e_nocarry_0653
...
func TestE_nocarry_0653IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0653
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0653

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0653{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0653
	one.SetOne()
	e.Sub(&qe_nocarry_0653, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0653{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0653{0, uint64(i)})
	}
...
func TestE_nocarry_0653NegZero(t *testing.T) {
	var a, b e_nocarry_0653
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0653Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0653, len(staticTestValues))
...
func TestE_nocarry_0653Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0653) bool {
			var b e_nocarry_0653
...
func TestE_nocarry_0653InverseExp(t *testing.T) {
...
func TestE_nocarry_0653MulByConstants(t *testing.T) {
...
func TestE_nocarry_0653Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0653) bool {
...
func TestE_nocarry_0653LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0653Halve(t *testing.T) {
...
func TestE_nocarry_0653FromMont(t *testing.T) {
...
type testPaire_nocarry_0653 struct {
	element e_nocarry_0653
	bigint  big.Int
}

func (z *e_nocarry_0653) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0653[10] {
		return true
	}
	if z[10] < qe_nocarry_0653[10] {
		return false
	...
	return z[0] >= qe_nocarry_0653[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0653

		g.element = e_nocarry_0653{
		...
		if qe_nocarry_0653[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0653[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0653 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0653[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0653[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0653[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0653[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0653[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0653[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0653[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0653[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0653[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0653[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0653[10], carry)
...
func Benchmarke_nocarry_0653InverseNew(b *testing.B) {
	var x e_nocarry_0653
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0653
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0653
		var xInv e_nocarry_0653
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0653
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0653
...
func testLinearComb(t *testing.T, x *e_nocarry_0653, xC int64, y *e_nocarry_0653, yC int64) {
	...
	var z e_nocarry_0653
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0653, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0653
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0653, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0653
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0653, xHi uint64) {
	var res e_nocarry_0653
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0653) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0653) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0653, c int64, result *e_nocarry_0653, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0653) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0653) uint64 {
