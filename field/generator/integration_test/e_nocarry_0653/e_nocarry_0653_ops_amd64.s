...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xaa87d51ed86ef519, R14
	ADDQ R14, AX
	MOVQ $0x0783c11f821eafb0, R14
	ADCQ R14, DX
	MOVQ $0xbfb584def146c689, R14
	ADCQ R14, CX
	MOVQ $0x0dcf595824b44360, R14
	ADCQ R14, BX
	MOVQ $0xfcd6cd31915f02cc, R14
	ADCQ R14, SI
	MOVQ $0x2dbee841bb13be65, R14
	ADCQ R14, DI
	MOVQ $0x4ce9560e0d6ec4fb, R14
	ADCQ R14, R8
	MOVQ $0x33e09a88da48f2a2, R14
	ADCQ R14, R9
	MOVQ $0x1d05993c2c1cc402, R14
	ADCQ R14, R10
	MOVQ $0xfa3083eac1be3e81, R14
	ADCQ R14, R11
	MOVQ $0x0000000000001a1c, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xaa87d51ed86ef519, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x0783c11f821eafb0, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xbfb584def146c689, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x0dcf595824b44360, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xfcd6cd31915f02cc, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x2dbee841bb13be65, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x4ce9560e0d6ec4fb, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x33e09a88da48f2a2, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x1d05993c2c1cc402, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xfa3083eac1be3e81, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000000001a1c, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xaa87d51ed86ef519, AX
	ADDQ AX, DX
	MOVQ $0x0783c11f821eafb0, AX
	ADCQ AX, CX
	MOVQ $0xbfb584def146c689, AX
	ADCQ AX, BX
	MOVQ $0x0dcf595824b44360, AX
	ADCQ AX, SI
	MOVQ $0xfcd6cd31915f02cc, AX
	ADCQ AX, DI
	MOVQ $0x2dbee841bb13be65, AX
	ADCQ AX, R8
	MOVQ $0x4ce9560e0d6ec4fb, AX
	ADCQ AX, R9
	MOVQ $0x33e09a88da48f2a2, AX
	ADCQ AX, R10
	MOVQ $0x1d05993c2c1cc402, AX
	ADCQ AX, R11
	MOVQ $0xfa3083eac1be3e81, AX
	ADCQ AX, R12
	MOVQ $0x0000000000001a1c, AX
	ADCQ AX, R13
