...
var benchRese_nocarry_0666 e_nocarry_0666

func BenchmarkE_nocarry_0666SetBytes(b *testing.B) {
	var x e_nocarry_0666
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0666MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0666.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0666)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0666)
		}
	})
}

func BenchmarkE_nocarry_0666Inverse(b *testing.B) {
	var x e_nocarry_0666
	x.SetRandom()
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0666Butterfly(b *testing.B) {
	var x e_nocarry_0666
	x.SetRandom()
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0666)
	}
}

func BenchmarkE_nocarry_0666Exp(b *testing.B) {
	var x e_nocarry_0666
	x.SetRandom()
	benchRese_nocarry_0666.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0666Double(b *testing.B) {
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Double(&benchRese_nocarry_0666)
	}
}

func BenchmarkE_nocarry_0666Add(b *testing.B) {
	var x e_nocarry_0666
	x.SetRandom()
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Add(&x, &benchRese_nocarry_0666)
	}
}

func BenchmarkE_nocarry_0666Sub(b *testing.B) {
	var x e_nocarry_0666
	x.SetRandom()
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Sub(&x, &benchRese_nocarry_0666)
	}
}

func BenchmarkE_nocarry_0666Neg(b *testing.B) {
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Neg(&benchRese_nocarry_0666)
	}
}

func BenchmarkE_nocarry_0666Div(b *testing.B) {
	var x e_nocarry_0666
	x.SetRandom()
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Div(&x, &benchRese_nocarry_0666)
	}
}

func BenchmarkE_nocarry_0666FromMont(b *testing.B) {
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.FromMont()
	}
}

func BenchmarkE_nocarry_0666ToMont(b *testing.B) {
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.ToMont()
	}
}
func BenchmarkE_nocarry_0666Square(b *testing.B) {
	benchRese_nocarry_0666.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Square(&benchRese_nocarry_0666)
	}
}

func BenchmarkE_nocarry_0666Sqrt(b *testing.B) {
	var a e_nocarry_0666
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0666Mul(b *testing.B) {
	x := e_nocarry_0666{
	...
	benchRese_nocarry_0666.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Mul(&benchRese_nocarry_0666, &x)
	}
}

func BenchmarkE_nocarry_0666Cmp(b *testing.B) {
	x := e_nocarry_0666{
		17186112845893168911,
		8919215489017635978,
		17157645928597881719,
	...
	benchRese_nocarry_0666 = x
	benchRese_nocarry_0666[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0666.Cmp(&x)
	}
}

func TestE_nocarry_0666Cmp(t *testing.T) {
	var x, y e_nocarry_0666
...
func TestE_nocarry_0666IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0666
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0666

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0666{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0666
	one.SetOne()
	e.Sub(&qe_nocarry_0666, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0666{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0666{0, uint64(i)})
	}
...
func TestE_nocarry_0666NegZero(t *testing.T) {
	var a, b e_nocarry_0666
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0666Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0666, len(staticTestValues))
...
func TestE_nocarry_0666Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0666) bool {
			var b e_nocarry_0666
...
func TestE_nocarry_0666InverseExp(t *testing.T) {
...
func TestE_nocarry_0666MulByConstants(t *testing.T) {
...
func TestE_nocarry_0666Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0666) bool {
...
func TestE_nocarry_0666LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0666Halve(t *testing.T) {
...
func TestE_nocarry_0666FromMont(t *testing.T) {
...
type testPaire_nocarry_0666 struct {
	element e_nocarry_0666
	bigint  big.Int
}

func (z *e_nocarry_0666) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0666[10] {
		return true
	}
	if z[10] < qe_nocarry_0666[10] {
		return false
	...
	return z[0] >= qe_nocarry_0666[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0666

		g.element = e_nocarry_0666{
		...
		if qe_nocarry_0666[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0666[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0666 {
			var g e_nocarry_0666
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0666[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0666[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0666[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0666[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0666[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0666[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0666[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0666[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0666[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0666[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0666[10], carry)
...
func Benchmarke_nocarry_0666InverseNew(b *testing.B) {
	var x e_nocarry_0666
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0666
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0666
		var xInv e_nocarry_0666
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0666
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0666
...
func testLinearComb(t *testing.T, x *e_nocarry_0666, xC int64, y *e_nocarry_0666, yC int64) {
	...
	var z e_nocarry_0666
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0666, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0666
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0666, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0666
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0666, xHi uint64) {
	var res e_nocarry_0666
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0666) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0666) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0666, c int64, result *e_nocarry_0666, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0666) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0666) uint64 {
