...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xe01e8d43894ca80d, R14
	ADDQ R14, AX
	MOVQ $0x1e49a1562225fd12, R14
	ADCQ R14, DX
	MOVQ $0xe75486e925f0242e, R14
	ADCQ R14, CX
	MOVQ $0x20ff45209fdd681c, R14
	ADCQ R14, BX
	MOVQ $0xbdd6a48ebd66ede2, R14
	ADCQ R14, SI
	MOVQ $0xa904065c3e5f0e12, R14
	ADCQ R14, DI
	MOVQ $0xfbaa1e4a9737d0af, R14
	ADCQ R14, R8
	MOVQ $0x74f48994dd23c009, R14
	ADCQ R14, R9
	MOVQ $0xc162586ba94298f7, R14
	ADCQ R14, R10
	MOVQ $0x5d9062955aeeeaa0, R14
	ADCQ R14, R11
	MOVQ $0x0000000003aecc1c, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xe01e8d43894ca80d, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x1e49a1562225fd12, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xe75486e925f0242e, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x20ff45209fdd681c, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xbdd6a48ebd66ede2, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xa904065c3e5f0e12, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xfbaa1e4a9737d0af, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x74f48994dd23c009, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xc162586ba94298f7, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x5d9062955aeeeaa0, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000003aecc1c, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xe01e8d43894ca80d, AX
	ADDQ AX, DX
	MOVQ $0x1e49a1562225fd12, AX
	ADCQ AX, CX
	MOVQ $0xe75486e925f0242e, AX
	ADCQ AX, BX
	MOVQ $0x20ff45209fdd681c, AX
	ADCQ AX, SI
	MOVQ $0xbdd6a48ebd66ede2, AX
	ADCQ AX, DI
	MOVQ $0xa904065c3e5f0e12, AX
	ADCQ AX, R8
	MOVQ $0xfbaa1e4a9737d0af, AX
	ADCQ AX, R9
	MOVQ $0x74f48994dd23c009, AX
	ADCQ AX, R10
	MOVQ $0xc162586ba94298f7, AX
	ADCQ AX, R11
	MOVQ $0x5d9062955aeeeaa0, AX
	ADCQ AX, R12
	MOVQ $0x0000000003aecc1c, AX
	ADCQ AX, R13
