...
var benchRese_nocarry_0437 e_nocarry_0437

func BenchmarkE_nocarry_0437SetBytes(b *testing.B) {
	var x e_nocarry_0437
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0437MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0437.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0437)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0437)
		}
	})
}

func BenchmarkE_nocarry_0437Inverse(b *testing.B) {
	var x e_nocarry_0437
	x.SetRandom()
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0437Butterfly(b *testing.B) {
	var x e_nocarry_0437
	x.SetRandom()
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0437)
	}
}

func BenchmarkE_nocarry_0437Exp(b *testing.B) {
	var x e_nocarry_0437
	x.SetRandom()
	benchRese_nocarry_0437.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0437Double(b *testing.B) {
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Double(&benchRese_nocarry_0437)
	}
}

func BenchmarkE_nocarry_0437Add(b *testing.B) {
	var x e_nocarry_0437
	x.SetRandom()
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Add(&x, &benchRese_nocarry_0437)
	}
}

func BenchmarkE_nocarry_0437Sub(b *testing.B) {
	var x e_nocarry_0437
	x.SetRandom()
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Sub(&x, &benchRese_nocarry_0437)
	}
}

func BenchmarkE_nocarry_0437Neg(b *testing.B) {
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Neg(&benchRese_nocarry_0437)
	}
}

func BenchmarkE_nocarry_0437Div(b *testing.B) {
	var x e_nocarry_0437
	x.SetRandom()
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Div(&x, &benchRese_nocarry_0437)
	}
}

func BenchmarkE_nocarry_0437FromMont(b *testing.B) {
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.FromMont()
	}
}

func BenchmarkE_nocarry_0437ToMont(b *testing.B) {
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.ToMont()
	}
}
func BenchmarkE_nocarry_0437Square(b *testing.B) {
	benchRese_nocarry_0437.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Square(&benchRese_nocarry_0437)
	}
}

func BenchmarkE_nocarry_0437Sqrt(b *testing.B) {
	var a e_nocarry_0437
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0437Mul(b *testing.B) {
	x := e_nocarry_0437{
		3932546175917482746,
	...
	benchRese_nocarry_0437.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Mul(&benchRese_nocarry_0437, &x)
	}
}

func BenchmarkE_nocarry_0437Cmp(b *testing.B) {
	x := e_nocarry_0437{
		3932546175917482746,
		14791882452524795500,
		15659169498796368714,
	...
	benchRese_nocarry_0437 = x
	benchRese_nocarry_0437[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0437.Cmp(&x)
	}
}

func TestE_nocarry_0437Cmp(t *testing.T) {
	var x, y e_nocarry_0437
...
func TestE_nocarry_0437IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0437
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0437

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0437{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0437
	one.SetOne()
	e.Sub(&qe_nocarry_0437, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0437{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0437{0, uint64(i)})
	}
...
func TestE_nocarry_0437NegZero(t *testing.T) {
	var a, b e_nocarry_0437
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0437Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0437, len(staticTestValues))
...
func TestE_nocarry_0437Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0437) bool {
			var b e_nocarry_0437
...
func TestE_nocarry_0437InverseExp(t *testing.T) {
...
func TestE_nocarry_0437MulByConstants(t *testing.T) {
...
func TestE_nocarry_0437Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0437) bool {
...
func TestE_nocarry_0437LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0437Halve(t *testing.T) {
...
func TestE_nocarry_0437FromMont(t *testing.T) {
...
type testPaire_nocarry_0437 struct {
	element e_nocarry_0437
	bigint  big.Int
}

func (z *e_nocarry_0437) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0437[6] {
		return true
	}
	if z[6] < qe_nocarry_0437[6] {
		return false
	...
	return z[0] >= qe_nocarry_0437[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0437

		g.element = e_nocarry_0437{
		...
		if qe_nocarry_0437[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0437[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0437 {
			var g e_nocarry_0437
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0437[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0437[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0437[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0437[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0437[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0437[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0437[6], carry)
...
func Benchmarke_nocarry_0437InverseNew(b *testing.B) {
	var x e_nocarry_0437
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0437
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0437
		var xInv e_nocarry_0437
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0437
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0437
...
func testLinearComb(t *testing.T, x *e_nocarry_0437, xC int64, y *e_nocarry_0437, yC int64) {
	...
	var z e_nocarry_0437
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0437, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0437
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0437, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0437
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0437, xHi uint64) {
	var res e_nocarry_0437
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0437) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0437) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0437, c int64, result *e_nocarry_0437, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0437) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0437) uint64 {
