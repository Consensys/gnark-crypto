...
var benchRese_nocarry_0497 e_nocarry_0497

func BenchmarkE_nocarry_0497SetBytes(b *testing.B) {
	var x e_nocarry_0497
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0497MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0497.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0497)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0497)
		}
	})
}

func BenchmarkE_nocarry_0497Inverse(b *testing.B) {
	var x e_nocarry_0497
	x.SetRandom()
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0497Butterfly(b *testing.B) {
	var x e_nocarry_0497
	x.SetRandom()
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0497)
	}
}

func BenchmarkE_nocarry_0497Exp(b *testing.B) {
	var x e_nocarry_0497
	x.SetRandom()
	benchRese_nocarry_0497.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0497Double(b *testing.B) {
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Double(&benchRese_nocarry_0497)
	}
}

func BenchmarkE_nocarry_0497Add(b *testing.B) {
	var x e_nocarry_0497
	x.SetRandom()
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Add(&x, &benchRese_nocarry_0497)
	}
}

func BenchmarkE_nocarry_0497Sub(b *testing.B) {
	var x e_nocarry_0497
	x.SetRandom()
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Sub(&x, &benchRese_nocarry_0497)
	}
}

func BenchmarkE_nocarry_0497Neg(b *testing.B) {
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Neg(&benchRese_nocarry_0497)
	}
}

func BenchmarkE_nocarry_0497Div(b *testing.B) {
	var x e_nocarry_0497
	x.SetRandom()
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Div(&x, &benchRese_nocarry_0497)
	}
}

func BenchmarkE_nocarry_0497FromMont(b *testing.B) {
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.FromMont()
	}
}

func BenchmarkE_nocarry_0497ToMont(b *testing.B) {
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.ToMont()
	}
}
func BenchmarkE_nocarry_0497Square(b *testing.B) {
	benchRese_nocarry_0497.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Square(&benchRese_nocarry_0497)
	}
}

func BenchmarkE_nocarry_0497Sqrt(b *testing.B) {
	var a e_nocarry_0497
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0497Mul(b *testing.B) {
	x := e_nocarry_0497{
	...
	benchRese_nocarry_0497.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Mul(&benchRese_nocarry_0497, &x)
	}
}

func BenchmarkE_nocarry_0497Cmp(b *testing.B) {
	x := e_nocarry_0497{
		13991895633086823711,
		18159303915535916622,
		11093503610329296524,
	...
	benchRese_nocarry_0497 = x
	benchRese_nocarry_0497[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0497.Cmp(&x)
	}
}

func TestE_nocarry_0497Cmp(t *testing.T) {
	var x, y e_nocarry_0497
...
func TestE_nocarry_0497IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0497
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0497

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0497{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0497
	one.SetOne()
	e.Sub(&qe_nocarry_0497, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0497{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0497{0, uint64(i)})
	}
...
func TestE_nocarry_0497NegZero(t *testing.T) {
	var a, b e_nocarry_0497
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0497Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0497, len(staticTestValues))
...
func TestE_nocarry_0497Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0497) bool {
			var b e_nocarry_0497
...
func TestE_nocarry_0497InverseExp(t *testing.T) {
...
func TestE_nocarry_0497MulByConstants(t *testing.T) {
...
func TestE_nocarry_0497Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0497) bool {
...
func TestE_nocarry_0497LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0497Halve(t *testing.T) {
...
func TestE_nocarry_0497FromMont(t *testing.T) {
...
type testPaire_nocarry_0497 struct {
	element e_nocarry_0497
	bigint  big.Int
}

func (z *e_nocarry_0497) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0497[7] {
		return true
	}
	if z[7] < qe_nocarry_0497[7] {
		return false
	...
	return z[0] >= qe_nocarry_0497[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0497

		g.element = e_nocarry_0497{
		...
		if qe_nocarry_0497[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0497[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0497 {
			var g e_nocarry_0497
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0497[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0497[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0497[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0497[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0497[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0497[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0497[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0497[7], carry)
...
func Benchmarke_nocarry_0497InverseNew(b *testing.B) {
	var x e_nocarry_0497
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0497
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0497
		var xInv e_nocarry_0497
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0497
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0497
...
func testLinearComb(t *testing.T, x *e_nocarry_0497, xC int64, y *e_nocarry_0497, yC int64) {
	...
	var z e_nocarry_0497
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0497, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0497
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0497, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0497
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0497, xHi uint64) {
	var res e_nocarry_0497
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0497) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0497) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0497, c int64, result *e_nocarry_0497, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0497) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0497) uint64 {
