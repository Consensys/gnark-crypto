...
var benchRese_nocarry_0163 e_nocarry_0163

func BenchmarkE_nocarry_0163SetBytes(b *testing.B) {
	var x e_nocarry_0163
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0163MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0163.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0163)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0163)
		}
	})
}

func BenchmarkE_nocarry_0163Inverse(b *testing.B) {
	var x e_nocarry_0163
	x.SetRandom()
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0163Butterfly(b *testing.B) {
	var x e_nocarry_0163
	x.SetRandom()
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0163)
	}
}

func BenchmarkE_nocarry_0163Exp(b *testing.B) {
	var x e_nocarry_0163
	x.SetRandom()
	benchRese_nocarry_0163.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0163Double(b *testing.B) {
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Double(&benchRese_nocarry_0163)
	}
}

func BenchmarkE_nocarry_0163Add(b *testing.B) {
	var x e_nocarry_0163
	x.SetRandom()
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Add(&x, &benchRese_nocarry_0163)
	}
}

func BenchmarkE_nocarry_0163Sub(b *testing.B) {
	var x e_nocarry_0163
	x.SetRandom()
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Sub(&x, &benchRese_nocarry_0163)
	}
}

func BenchmarkE_nocarry_0163Neg(b *testing.B) {
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Neg(&benchRese_nocarry_0163)
	}
}

func BenchmarkE_nocarry_0163Div(b *testing.B) {
	var x e_nocarry_0163
	x.SetRandom()
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Div(&x, &benchRese_nocarry_0163)
	}
}

func BenchmarkE_nocarry_0163FromMont(b *testing.B) {
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.FromMont()
	}
}

func BenchmarkE_nocarry_0163ToMont(b *testing.B) {
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.ToMont()
	}
}
func BenchmarkE_nocarry_0163Square(b *testing.B) {
	benchRese_nocarry_0163.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Square(&benchRese_nocarry_0163)
	}
}

func BenchmarkE_nocarry_0163Sqrt(b *testing.B) {
	var a e_nocarry_0163
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0163Mul(b *testing.B) {
	x := e_nocarry_0163{
		4838502911042134398,
		381823213563857241,
		13288902295,
	}
	benchRese_nocarry_0163.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Mul(&benchRese_nocarry_0163, &x)
	}
}

func BenchmarkE_nocarry_0163Cmp(b *testing.B) {
	x := e_nocarry_0163{
		4838502911042134398,
		381823213563857241,
		13288902295,
	}
	benchRese_nocarry_0163 = x
	benchRese_nocarry_0163[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0163.Cmp(&x)
	}
}

func TestE_nocarry_0163Cmp(t *testing.T) {
	var x, y e_nocarry_0163
...
func TestE_nocarry_0163IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0163
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0163

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0163{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0163
	one.SetOne()
	e.Sub(&qe_nocarry_0163, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0163{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0163{0, uint64(i)})
	}
...
func TestE_nocarry_0163NegZero(t *testing.T) {
	var a, b e_nocarry_0163
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0163Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0163, len(staticTestValues))
...
func TestE_nocarry_0163Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0163) bool {
			var b e_nocarry_0163
...
func TestE_nocarry_0163InverseExp(t *testing.T) {
...
func TestE_nocarry_0163MulByConstants(t *testing.T) {
...
func TestE_nocarry_0163Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0163) bool {
...
func TestE_nocarry_0163LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0163Halve(t *testing.T) {
...
func TestE_nocarry_0163FromMont(t *testing.T) {
...
type testPaire_nocarry_0163 struct {
	element e_nocarry_0163
	bigint  big.Int
}

func (z *e_nocarry_0163) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0163[2] {
		return true
	}
	if z[2] < qe_nocarry_0163[2] {
		return false
	...
	return z[0] >= qe_nocarry_0163[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0163

		g.element = e_nocarry_0163{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0163[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0163[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0163 {
			var g e_nocarry_0163
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0163[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0163[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0163[2], carry)
...
func Benchmarke_nocarry_0163InverseNew(b *testing.B) {
	var x e_nocarry_0163
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0163
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0163
		var xInv e_nocarry_0163
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0163
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0163
...
func testLinearComb(t *testing.T, x *e_nocarry_0163, xC int64, y *e_nocarry_0163, yC int64) {
	...
	var z e_nocarry_0163
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0163, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0163
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0163, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0163
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0163, xHi uint64) {
	var res e_nocarry_0163
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0163) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0163) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0163, c int64, result *e_nocarry_0163, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0163) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0163) uint64 {
