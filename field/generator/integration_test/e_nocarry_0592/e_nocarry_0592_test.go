...
var benchRese_nocarry_0592 e_nocarry_0592

func BenchmarkE_nocarry_0592SetBytes(b *testing.B) {
	var x e_nocarry_0592
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0592MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0592.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0592)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0592)
		}
	})
}

func BenchmarkE_nocarry_0592Inverse(b *testing.B) {
	var x e_nocarry_0592
	x.SetRandom()
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0592Butterfly(b *testing.B) {
	var x e_nocarry_0592
	x.SetRandom()
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0592)
	}
}

func BenchmarkE_nocarry_0592Exp(b *testing.B) {
	var x e_nocarry_0592
	x.SetRandom()
	benchRese_nocarry_0592.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0592Double(b *testing.B) {
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Double(&benchRese_nocarry_0592)
	}
}

func BenchmarkE_nocarry_0592Add(b *testing.B) {
	var x e_nocarry_0592
	x.SetRandom()
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Add(&x, &benchRese_nocarry_0592)
	}
}

func BenchmarkE_nocarry_0592Sub(b *testing.B) {
	var x e_nocarry_0592
	x.SetRandom()
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Sub(&x, &benchRese_nocarry_0592)
	}
}

func BenchmarkE_nocarry_0592Neg(b *testing.B) {
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Neg(&benchRese_nocarry_0592)
	}
}

func BenchmarkE_nocarry_0592Div(b *testing.B) {
	var x e_nocarry_0592
	x.SetRandom()
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Div(&x, &benchRese_nocarry_0592)
	}
}

func BenchmarkE_nocarry_0592FromMont(b *testing.B) {
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.FromMont()
	}
}

func BenchmarkE_nocarry_0592ToMont(b *testing.B) {
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.ToMont()
	}
}
func BenchmarkE_nocarry_0592Square(b *testing.B) {
	benchRese_nocarry_0592.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Square(&benchRese_nocarry_0592)
	}
}

func BenchmarkE_nocarry_0592Sqrt(b *testing.B) {
	var a e_nocarry_0592
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0592Mul(b *testing.B) {
	x := e_nocarry_0592{
		541946252619949601,
	...
	benchRese_nocarry_0592.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Mul(&benchRese_nocarry_0592, &x)
	}
}

func BenchmarkE_nocarry_0592Cmp(b *testing.B) {
	x := e_nocarry_0592{
		541946252619949601,
		10045921186164509817,
		8948839035655965809,
	...
	benchRese_nocarry_0592 = x
	benchRese_nocarry_0592[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0592.Cmp(&x)
	}
}

func TestE_nocarry_0592Cmp(t *testing.T) {
	var x, y e_nocarry_0592
...
func TestE_nocarry_0592IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0592
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0592

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0592{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0592
	one.SetOne()
	e.Sub(&qe_nocarry_0592, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0592{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0592{0, uint64(i)})
	}
...
func TestE_nocarry_0592NegZero(t *testing.T) {
	var a, b e_nocarry_0592
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0592Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0592, len(staticTestValues))
...
func TestE_nocarry_0592Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0592) bool {
			var b e_nocarry_0592
...
func TestE_nocarry_0592InverseExp(t *testing.T) {
...
func TestE_nocarry_0592MulByConstants(t *testing.T) {
...
func TestE_nocarry_0592Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0592) bool {
...
func TestE_nocarry_0592LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0592Halve(t *testing.T) {
...
func TestE_nocarry_0592FromMont(t *testing.T) {
...
type testPaire_nocarry_0592 struct {
	element e_nocarry_0592
	bigint  big.Int
}

func (z *e_nocarry_0592) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0592[9] {
		return true
	}
	if z[9] < qe_nocarry_0592[9] {
		return false
	...
	return z[0] >= qe_nocarry_0592[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0592

		g.element = e_nocarry_0592{
		...
		if qe_nocarry_0592[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0592[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0592 {
			var g e_nocarry_0592
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0592[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0592[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0592[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0592[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0592[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0592[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0592[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0592[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0592[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0592[9], carry)
...
func Benchmarke_nocarry_0592InverseNew(b *testing.B) {
	var x e_nocarry_0592
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0592
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0592
		var xInv e_nocarry_0592
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0592
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0592
...
func testLinearComb(t *testing.T, x *e_nocarry_0592, xC int64, y *e_nocarry_0592, yC int64) {
	...
	var z e_nocarry_0592
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0592, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0592
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0592, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0592
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0592, xHi uint64) {
	var res e_nocarry_0592
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0592) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0592) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0592, c int64, result *e_nocarry_0592, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0592) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0592) uint64 {
