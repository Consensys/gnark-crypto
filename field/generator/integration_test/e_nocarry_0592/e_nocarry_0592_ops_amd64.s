...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xe4b25c2a1b55695b, R13
	ADDQ R13, AX
	MOVQ $0xa33e026e979e9d3c, R13
	ADCQ R13, DX
	MOVQ $0xafb36cf7c1bd6099, R13
	ADCQ R13, CX
	MOVQ $0x0246a2f866e3c6a8, R13
	ADCQ R13, BX
	MOVQ $0x5b9187e6ed65c3b4, R13
	ADCQ R13, SI
	MOVQ $0x885f26c40ea1df2f, R13
	ADCQ R13, DI
	MOVQ $0xed17546d29194f0d, R13
	ADCQ R13, R8
	MOVQ $0x122533993fdf6111, R13
	ADCQ R13, R9
	MOVQ $0x46289bf84e0e38a9, R13
	ADCQ R13, R10
	MOVQ $0x000000000000edb6, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xe4b25c2a1b55695b, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xa33e026e979e9d3c, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xafb36cf7c1bd6099, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x0246a2f866e3c6a8, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x5b9187e6ed65c3b4, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x885f26c40ea1df2f, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xed17546d29194f0d, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x122533993fdf6111, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x46289bf84e0e38a9, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000000000edb6, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xe4b25c2a1b55695b, AX
	ADDQ AX, DX
	MOVQ $0xa33e026e979e9d3c, AX
	ADCQ AX, CX
	MOVQ $0xafb36cf7c1bd6099, AX
	ADCQ AX, BX
	MOVQ $0x0246a2f866e3c6a8, AX
	ADCQ AX, SI
	MOVQ $0x5b9187e6ed65c3b4, AX
	ADCQ AX, DI
	MOVQ $0x885f26c40ea1df2f, AX
	ADCQ AX, R8
	MOVQ $0xed17546d29194f0d, AX
	ADCQ AX, R9
	MOVQ $0x122533993fdf6111, AX
	ADCQ AX, R10
	MOVQ $0x46289bf84e0e38a9, AX
	ADCQ AX, R11
	MOVQ $0x000000000000edb6, AX
	ADCQ AX, R12
