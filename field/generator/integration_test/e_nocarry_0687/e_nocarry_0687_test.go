...
var benchRese_nocarry_0687 e_nocarry_0687

func BenchmarkE_nocarry_0687SetBytes(b *testing.B) {
	var x e_nocarry_0687
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0687MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0687.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0687)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0687)
		}
	})
}

func BenchmarkE_nocarry_0687Inverse(b *testing.B) {
	var x e_nocarry_0687
	x.SetRandom()
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0687Butterfly(b *testing.B) {
	var x e_nocarry_0687
	x.SetRandom()
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0687)
	}
}

func BenchmarkE_nocarry_0687Exp(b *testing.B) {
	var x e_nocarry_0687
	x.SetRandom()
	benchRese_nocarry_0687.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0687Double(b *testing.B) {
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Double(&benchRese_nocarry_0687)
	}
}

func BenchmarkE_nocarry_0687Add(b *testing.B) {
	var x e_nocarry_0687
	x.SetRandom()
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Add(&x, &benchRese_nocarry_0687)
	}
}

func BenchmarkE_nocarry_0687Sub(b *testing.B) {
	var x e_nocarry_0687
	x.SetRandom()
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Sub(&x, &benchRese_nocarry_0687)
	}
}

func BenchmarkE_nocarry_0687Neg(b *testing.B) {
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Neg(&benchRese_nocarry_0687)
	}
}

func BenchmarkE_nocarry_0687Div(b *testing.B) {
	var x e_nocarry_0687
	x.SetRandom()
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Div(&x, &benchRese_nocarry_0687)
	}
}

func BenchmarkE_nocarry_0687FromMont(b *testing.B) {
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.FromMont()
	}
}

func BenchmarkE_nocarry_0687ToMont(b *testing.B) {
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.ToMont()
	}
}
func BenchmarkE_nocarry_0687Square(b *testing.B) {
	benchRese_nocarry_0687.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Square(&benchRese_nocarry_0687)
	}
}

func BenchmarkE_nocarry_0687Sqrt(b *testing.B) {
	var a e_nocarry_0687
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0687Mul(b *testing.B) {
	x := e_nocarry_0687{
	...
	benchRese_nocarry_0687.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Mul(&benchRese_nocarry_0687, &x)
	}
}

func BenchmarkE_nocarry_0687Cmp(b *testing.B) {
	x := e_nocarry_0687{
		12434478260822935597,
		15113134478606580477,
		876319664156049423,
	...
	benchRese_nocarry_0687 = x
	benchRese_nocarry_0687[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0687.Cmp(&x)
	}
}

func TestE_nocarry_0687Cmp(t *testing.T) {
	var x, y e_nocarry_0687
...
func TestE_nocarry_0687IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0687
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0687

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0687{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0687
	one.SetOne()
	e.Sub(&qe_nocarry_0687, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0687{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0687{0, uint64(i)})
	}
...
func TestE_nocarry_0687NegZero(t *testing.T) {
	var a, b e_nocarry_0687
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0687Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0687, len(staticTestValues))
...
func TestE_nocarry_0687Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0687) bool {
			var b e_nocarry_0687
...
func TestE_nocarry_0687InverseExp(t *testing.T) {
...
func TestE_nocarry_0687MulByConstants(t *testing.T) {
...
func TestE_nocarry_0687Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0687) bool {
...
func TestE_nocarry_0687LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0687Halve(t *testing.T) {
...
func TestE_nocarry_0687FromMont(t *testing.T) {
...
type testPaire_nocarry_0687 struct {
	element e_nocarry_0687
	bigint  big.Int
}

func (z *e_nocarry_0687) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0687[10] {
		return true
	}
	if z[10] < qe_nocarry_0687[10] {
		return false
	...
	return z[0] >= qe_nocarry_0687[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0687

		g.element = e_nocarry_0687{
		...
		if qe_nocarry_0687[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0687[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0687 {
			var g e_nocarry_0687
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0687[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0687[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0687[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0687[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0687[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0687[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0687[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0687[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0687[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0687[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0687[10], carry)
...
func Benchmarke_nocarry_0687InverseNew(b *testing.B) {
	var x e_nocarry_0687
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0687
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0687
		var xInv e_nocarry_0687
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0687
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0687
...
func testLinearComb(t *testing.T, x *e_nocarry_0687, xC int64, y *e_nocarry_0687, yC int64) {
	...
	var z e_nocarry_0687
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0687, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0687
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0687, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0687
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0687, xHi uint64) {
	var res e_nocarry_0687
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0687) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0687) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0687, c int64, result *e_nocarry_0687, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0687) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0687) uint64 {
