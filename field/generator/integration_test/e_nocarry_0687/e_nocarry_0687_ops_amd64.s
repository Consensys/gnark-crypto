...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x43545544d10bde03, R14
	ADDQ R14, AX
	MOVQ $0xa51d4a0e5b298285, R14
	ADCQ R14, DX
	MOVQ $0x668a6709080ce823, R14
	ADCQ R14, CX
	MOVQ $0xe61bc4cb8c5ec6b3, R14
	ADCQ R14, BX
	MOVQ $0x65bcda4c2850e394, R14
	ADCQ R14, SI
	MOVQ $0x6c3b7f86a1d785ac, R14
	ADCQ R14, DI
	MOVQ $0x59da9d60d8d4d1d0, R14
	ADCQ R14, R8
	MOVQ $0x4c7ad3237d94cee3, R14
	ADCQ R14, R9
	MOVQ $0xd2f09ad825726bcc, R14
	ADCQ R14, R10
	MOVQ $0xfc18940d07d10c83, R14
	ADCQ R14, R11
	MOVQ $0x0000777997abb86c, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x43545544d10bde03, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xa51d4a0e5b298285, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x668a6709080ce823, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xe61bc4cb8c5ec6b3, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x65bcda4c2850e394, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x6c3b7f86a1d785ac, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x59da9d60d8d4d1d0, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x4c7ad3237d94cee3, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xd2f09ad825726bcc, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xfc18940d07d10c83, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000777997abb86c, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x43545544d10bde03, AX
	ADDQ AX, DX
	MOVQ $0xa51d4a0e5b298285, AX
	ADCQ AX, CX
	MOVQ $0x668a6709080ce823, AX
	ADCQ AX, BX
	MOVQ $0xe61bc4cb8c5ec6b3, AX
	ADCQ AX, SI
	MOVQ $0x65bcda4c2850e394, AX
	ADCQ AX, DI
	MOVQ $0x6c3b7f86a1d785ac, AX
	ADCQ AX, R8
	MOVQ $0x59da9d60d8d4d1d0, AX
	ADCQ AX, R9
	MOVQ $0x4c7ad3237d94cee3, AX
	ADCQ AX, R10
	MOVQ $0xd2f09ad825726bcc, AX
	ADCQ AX, R11
	MOVQ $0xfc18940d07d10c83, AX
	ADCQ AX, R12
	MOVQ $0x0000777997abb86c, AX
	ADCQ AX, R13
