...
var benchRese_nocarry_0160 e_nocarry_0160

func BenchmarkE_nocarry_0160SetBytes(b *testing.B) {
	var x e_nocarry_0160
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0160MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0160.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0160)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0160)
		}
	})
}

func BenchmarkE_nocarry_0160Inverse(b *testing.B) {
	var x e_nocarry_0160
	x.SetRandom()
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0160Butterfly(b *testing.B) {
	var x e_nocarry_0160
	x.SetRandom()
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0160)
	}
}

func BenchmarkE_nocarry_0160Exp(b *testing.B) {
	var x e_nocarry_0160
	x.SetRandom()
	benchRese_nocarry_0160.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0160Double(b *testing.B) {
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Double(&benchRese_nocarry_0160)
	}
}

func BenchmarkE_nocarry_0160Add(b *testing.B) {
	var x e_nocarry_0160
	x.SetRandom()
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Add(&x, &benchRese_nocarry_0160)
	}
}

func BenchmarkE_nocarry_0160Sub(b *testing.B) {
	var x e_nocarry_0160
	x.SetRandom()
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Sub(&x, &benchRese_nocarry_0160)
	}
}

func BenchmarkE_nocarry_0160Neg(b *testing.B) {
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Neg(&benchRese_nocarry_0160)
	}
}

func BenchmarkE_nocarry_0160Div(b *testing.B) {
	var x e_nocarry_0160
	x.SetRandom()
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Div(&x, &benchRese_nocarry_0160)
	}
}

func BenchmarkE_nocarry_0160FromMont(b *testing.B) {
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.FromMont()
	}
}

func BenchmarkE_nocarry_0160ToMont(b *testing.B) {
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.ToMont()
	}
}
func BenchmarkE_nocarry_0160Square(b *testing.B) {
	benchRese_nocarry_0160.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Square(&benchRese_nocarry_0160)
	}
}

func BenchmarkE_nocarry_0160Sqrt(b *testing.B) {
	var a e_nocarry_0160
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0160Mul(b *testing.B) {
	x := e_nocarry_0160{
		9047997936792951218,
		18115700415682355417,
		3148915744,
	}
	benchRese_nocarry_0160.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Mul(&benchRese_nocarry_0160, &x)
	}
}

func BenchmarkE_nocarry_0160Cmp(b *testing.B) {
	x := e_nocarry_0160{
		9047997936792951218,
		18115700415682355417,
		3148915744,
	}
	benchRese_nocarry_0160 = x
	benchRese_nocarry_0160[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0160.Cmp(&x)
	}
}

func TestE_nocarry_0160Cmp(t *testing.T) {
	var x, y e_nocarry_0160
...
func TestE_nocarry_0160IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0160
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0160

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0160{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0160
	one.SetOne()
	e.Sub(&qe_nocarry_0160, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0160{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0160{0, uint64(i)})
	}
...
func TestE_nocarry_0160NegZero(t *testing.T) {
	var a, b e_nocarry_0160
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0160Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0160, len(staticTestValues))
...
func TestE_nocarry_0160Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0160) bool {
			var b e_nocarry_0160
...
func TestE_nocarry_0160InverseExp(t *testing.T) {
...
func TestE_nocarry_0160MulByConstants(t *testing.T) {
...
func TestE_nocarry_0160Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0160) bool {
...
func TestE_nocarry_0160LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0160Halve(t *testing.T) {
...
func TestE_nocarry_0160FromMont(t *testing.T) {
...
type testPaire_nocarry_0160 struct {
	element e_nocarry_0160
	bigint  big.Int
}

func (z *e_nocarry_0160) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0160[2] {
		return true
	}
	if z[2] < qe_nocarry_0160[2] {
		return false
	...
	return z[0] >= qe_nocarry_0160[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0160

		g.element = e_nocarry_0160{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0160[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0160[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0160 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0160[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0160[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0160[2], carry)
...
func Benchmarke_nocarry_0160InverseNew(b *testing.B) {
	var x e_nocarry_0160
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0160
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0160
		var xInv e_nocarry_0160
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0160
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0160
...
func testLinearComb(t *testing.T, x *e_nocarry_0160, xC int64, y *e_nocarry_0160, yC int64) {
	...
	var z e_nocarry_0160
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0160, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0160
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0160, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0160
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0160, xHi uint64) {
	var res e_nocarry_0160
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0160) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0160) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0160, c int64, result *e_nocarry_0160, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0160) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0160) uint64 {
