...
// modulus q
DATA q<>+0(SB)/8, $0xe34ab82cf52ddc51
DATA q<>+8(SB)/8, $0xe6a6223544e75686
DATA q<>+16(SB)/8, $0x00000000e948a76e
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xdde4f31baacf134f
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xe34ab82cf52ddc51, DI
	MOVQ    $0xe6a6223544e75686, R8
	MOVQ    $0x00000000e948a76e, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xe6a6223544e75686, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x00000000e948a76e, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xe34ab82cf52ddc51, R10
	MOVQ    $0xe6a6223544e75686, R11
	MOVQ    $0x00000000e948a76e, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
