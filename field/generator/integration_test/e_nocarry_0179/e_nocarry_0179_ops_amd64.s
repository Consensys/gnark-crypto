...
// modulus q
DATA q<>+0(SB)/8, $0x29338ef0dac48be1
DATA q<>+8(SB)/8, $0xde2539c947aa7f3f
DATA q<>+16(SB)/8, $0x000792890342650c
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xc8c0480f35d707df
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x29338ef0dac48be1, DI
	MOVQ    $0xde2539c947aa7f3f, R8
	MOVQ    $0x000792890342650c, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xde2539c947aa7f3f, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x000792890342650c, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x29338ef0dac48be1, R10
	MOVQ    $0xde2539c947aa7f3f, R11
	MOVQ    $0x000792890342650c, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
