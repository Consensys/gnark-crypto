...
var benchRese_nocarry_0179 e_nocarry_0179

func BenchmarkE_nocarry_0179SetBytes(b *testing.B) {
	var x e_nocarry_0179
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0179MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0179.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0179)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0179)
		}
	})
}

func BenchmarkE_nocarry_0179Inverse(b *testing.B) {
	var x e_nocarry_0179
	x.SetRandom()
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0179Butterfly(b *testing.B) {
	var x e_nocarry_0179
	x.SetRandom()
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0179)
	}
}

func BenchmarkE_nocarry_0179Exp(b *testing.B) {
	var x e_nocarry_0179
	x.SetRandom()
	benchRese_nocarry_0179.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0179Double(b *testing.B) {
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Double(&benchRese_nocarry_0179)
	}
}

func BenchmarkE_nocarry_0179Add(b *testing.B) {
	var x e_nocarry_0179
	x.SetRandom()
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Add(&x, &benchRese_nocarry_0179)
	}
}

func BenchmarkE_nocarry_0179Sub(b *testing.B) {
	var x e_nocarry_0179
	x.SetRandom()
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Sub(&x, &benchRese_nocarry_0179)
	}
}

func BenchmarkE_nocarry_0179Neg(b *testing.B) {
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Neg(&benchRese_nocarry_0179)
	}
}

func BenchmarkE_nocarry_0179Div(b *testing.B) {
	var x e_nocarry_0179
	x.SetRandom()
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Div(&x, &benchRese_nocarry_0179)
	}
}

func BenchmarkE_nocarry_0179FromMont(b *testing.B) {
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.FromMont()
	}
}

func BenchmarkE_nocarry_0179ToMont(b *testing.B) {
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.ToMont()
	}
}
func BenchmarkE_nocarry_0179Square(b *testing.B) {
	benchRese_nocarry_0179.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Square(&benchRese_nocarry_0179)
	}
}

func BenchmarkE_nocarry_0179Sqrt(b *testing.B) {
	var a e_nocarry_0179
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0179Mul(b *testing.B) {
	x := e_nocarry_0179{
		8843768633133264683,
		7687742137876096537,
		61013691546995,
	}
	benchRese_nocarry_0179.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Mul(&benchRese_nocarry_0179, &x)
	}
}

func BenchmarkE_nocarry_0179Cmp(b *testing.B) {
	x := e_nocarry_0179{
		8843768633133264683,
		7687742137876096537,
		61013691546995,
	}
	benchRese_nocarry_0179 = x
	benchRese_nocarry_0179[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0179.Cmp(&x)
	}
}

func TestE_nocarry_0179Cmp(t *testing.T) {
	var x, y e_nocarry_0179
...
func TestE_nocarry_0179IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0179
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0179

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0179{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0179
	one.SetOne()
	e.Sub(&qe_nocarry_0179, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0179{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0179{0, uint64(i)})
	}
...
func TestE_nocarry_0179NegZero(t *testing.T) {
	var a, b e_nocarry_0179
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0179Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0179, len(staticTestValues))
...
func TestE_nocarry_0179Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0179) bool {
			var b e_nocarry_0179
...
func TestE_nocarry_0179InverseExp(t *testing.T) {
...
func TestE_nocarry_0179MulByConstants(t *testing.T) {
...
func TestE_nocarry_0179Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0179) bool {
...
func TestE_nocarry_0179LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0179Halve(t *testing.T) {
...
func TestE_nocarry_0179FromMont(t *testing.T) {
...
type testPaire_nocarry_0179 struct {
	element e_nocarry_0179
	bigint  big.Int
}

func (z *e_nocarry_0179) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0179[2] {
		return true
	}
	if z[2] < qe_nocarry_0179[2] {
		return false
	...
	return z[0] >= qe_nocarry_0179[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0179

		g.element = e_nocarry_0179{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0179[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0179[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0179 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0179[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0179[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0179[2], carry)
...
func Benchmarke_nocarry_0179InverseNew(b *testing.B) {
	var x e_nocarry_0179
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0179
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0179
		var xInv e_nocarry_0179
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0179
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0179
...
func testLinearComb(t *testing.T, x *e_nocarry_0179, xC int64, y *e_nocarry_0179, yC int64) {
	...
	var z e_nocarry_0179
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0179, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0179
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0179, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0179
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0179, xHi uint64) {
	var res e_nocarry_0179
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0179) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0179) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0179, c int64, result *e_nocarry_0179, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0179) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0179) uint64 {
