...
var benchRese_nocarry_0291 e_nocarry_0291

func BenchmarkE_nocarry_0291SetBytes(b *testing.B) {
	var x e_nocarry_0291
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0291MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0291.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0291)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0291)
		}
	})
}

func BenchmarkE_nocarry_0291Inverse(b *testing.B) {
	var x e_nocarry_0291
	x.SetRandom()
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0291Butterfly(b *testing.B) {
	var x e_nocarry_0291
	x.SetRandom()
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0291)
	}
}

func BenchmarkE_nocarry_0291Exp(b *testing.B) {
	var x e_nocarry_0291
	x.SetRandom()
	benchRese_nocarry_0291.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0291Double(b *testing.B) {
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Double(&benchRese_nocarry_0291)
	}
}

func BenchmarkE_nocarry_0291Add(b *testing.B) {
	var x e_nocarry_0291
	x.SetRandom()
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Add(&x, &benchRese_nocarry_0291)
	}
}

func BenchmarkE_nocarry_0291Sub(b *testing.B) {
	var x e_nocarry_0291
	x.SetRandom()
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Sub(&x, &benchRese_nocarry_0291)
	}
}

func BenchmarkE_nocarry_0291Neg(b *testing.B) {
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Neg(&benchRese_nocarry_0291)
	}
}

func BenchmarkE_nocarry_0291Div(b *testing.B) {
	var x e_nocarry_0291
	x.SetRandom()
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Div(&x, &benchRese_nocarry_0291)
	}
}

func BenchmarkE_nocarry_0291FromMont(b *testing.B) {
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.FromMont()
	}
}

func BenchmarkE_nocarry_0291ToMont(b *testing.B) {
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.ToMont()
	}
}
func BenchmarkE_nocarry_0291Square(b *testing.B) {
	benchRese_nocarry_0291.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Square(&benchRese_nocarry_0291)
	}
}

func BenchmarkE_nocarry_0291Sqrt(b *testing.B) {
	var a e_nocarry_0291
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0291Mul(b *testing.B) {
	x := e_nocarry_0291{
	...
	benchRese_nocarry_0291.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Mul(&benchRese_nocarry_0291, &x)
	}
}

func BenchmarkE_nocarry_0291Cmp(b *testing.B) {
	x := e_nocarry_0291{
		14449259054392542403,
		1978255749529760818,
		10803539724032329023,
	...
	benchRese_nocarry_0291 = x
	benchRese_nocarry_0291[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0291.Cmp(&x)
	}
}

func TestE_nocarry_0291Cmp(t *testing.T) {
	var x, y e_nocarry_0291
...
func TestE_nocarry_0291IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0291
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0291

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0291{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0291
	one.SetOne()
	e.Sub(&qe_nocarry_0291, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0291{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0291{0, uint64(i)})
	}
...
func TestE_nocarry_0291NegZero(t *testing.T) {
	var a, b e_nocarry_0291
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0291Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0291, len(staticTestValues))
...
func TestE_nocarry_0291Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0291) bool {
			var b e_nocarry_0291
...
func TestE_nocarry_0291InverseExp(t *testing.T) {
...
func TestE_nocarry_0291MulByConstants(t *testing.T) {
...
func TestE_nocarry_0291Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0291) bool {
...
func TestE_nocarry_0291LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0291Halve(t *testing.T) {
...
func TestE_nocarry_0291FromMont(t *testing.T) {
...
type testPaire_nocarry_0291 struct {
	element e_nocarry_0291
	bigint  big.Int
}

func (z *e_nocarry_0291) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0291[4] {
		return true
	}
	if z[4] < qe_nocarry_0291[4] {
		return false
	...
	return z[0] >= qe_nocarry_0291[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0291

		g.element = e_nocarry_0291{
		...
		if qe_nocarry_0291[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0291[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0291 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0291[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0291[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0291[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0291[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0291[4], carry)
...
func Benchmarke_nocarry_0291InverseNew(b *testing.B) {
	var x e_nocarry_0291
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0291
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0291
		var xInv e_nocarry_0291
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0291
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0291
...
func testLinearComb(t *testing.T, x *e_nocarry_0291, xC int64, y *e_nocarry_0291, yC int64) {
	...
	var z e_nocarry_0291
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0291, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0291
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0291, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0291
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0291, xHi uint64) {
	var res e_nocarry_0291
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0291) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0291) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0291, c int64, result *e_nocarry_0291, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0291) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0291) uint64 {
