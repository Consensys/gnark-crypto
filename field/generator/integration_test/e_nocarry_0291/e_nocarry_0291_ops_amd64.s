...
// modulus q
DATA q<>+0(SB)/8, $0xdfb0b91a14ab0e99
DATA q<>+8(SB)/8, $0xff842f2aef2e7569
DATA q<>+16(SB)/8, $0x4fb890570e980aad
DATA q<>+24(SB)/8, $0xe0589dea36c75c4d
DATA q<>+32(SB)/8, $0x0000000753ad5c4a
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xa1e856ce47869a57
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xdfb0b91a14ab0e99, R9
	MOVQ    $0xff842f2aef2e7569, R10
	MOVQ    $0x4fb890570e980aad, R11
	MOVQ    $0xe0589dea36c75c4d, R12
	MOVQ    $0x0000000753ad5c4a, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xff842f2aef2e7569, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x4fb890570e980aad, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xe0589dea36c75c4d, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000753ad5c4a, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xdfb0b91a14ab0e99, CX
	MOVQ    $0xff842f2aef2e7569, BX
	MOVQ    $0x4fb890570e980aad, SI
	MOVQ    $0xe0589dea36c75c4d, DI
	MOVQ    $0x0000000753ad5c4a, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
