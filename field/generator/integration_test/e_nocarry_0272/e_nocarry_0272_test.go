...
var benchRese_nocarry_0272 e_nocarry_0272

func BenchmarkE_nocarry_0272SetBytes(b *testing.B) {
	var x e_nocarry_0272
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0272MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0272.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0272)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0272)
		}
	})
}

func BenchmarkE_nocarry_0272Inverse(b *testing.B) {
	var x e_nocarry_0272
	x.SetRandom()
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0272Butterfly(b *testing.B) {
	var x e_nocarry_0272
	x.SetRandom()
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0272)
	}
}

func BenchmarkE_nocarry_0272Exp(b *testing.B) {
	var x e_nocarry_0272
	x.SetRandom()
	benchRese_nocarry_0272.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0272Double(b *testing.B) {
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Double(&benchRese_nocarry_0272)
	}
}

func BenchmarkE_nocarry_0272Add(b *testing.B) {
	var x e_nocarry_0272
	x.SetRandom()
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Add(&x, &benchRese_nocarry_0272)
	}
}

func BenchmarkE_nocarry_0272Sub(b *testing.B) {
	var x e_nocarry_0272
	x.SetRandom()
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Sub(&x, &benchRese_nocarry_0272)
	}
}

func BenchmarkE_nocarry_0272Neg(b *testing.B) {
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Neg(&benchRese_nocarry_0272)
	}
}

func BenchmarkE_nocarry_0272Div(b *testing.B) {
	var x e_nocarry_0272
	x.SetRandom()
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Div(&x, &benchRese_nocarry_0272)
	}
}

func BenchmarkE_nocarry_0272FromMont(b *testing.B) {
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.FromMont()
	}
}

func BenchmarkE_nocarry_0272ToMont(b *testing.B) {
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.ToMont()
	}
}
func BenchmarkE_nocarry_0272Square(b *testing.B) {
	benchRese_nocarry_0272.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Square(&benchRese_nocarry_0272)
	}
}

func BenchmarkE_nocarry_0272Sqrt(b *testing.B) {
	var a e_nocarry_0272
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0272Mul(b *testing.B) {
	x := e_nocarry_0272{
		1702327314704758972,
		778093715210772171,
		8744628393756187274,
	...
	benchRese_nocarry_0272.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Mul(&benchRese_nocarry_0272, &x)
	}
}

func BenchmarkE_nocarry_0272Cmp(b *testing.B) {
	x := e_nocarry_0272{
		1702327314704758972,
		778093715210772171,
		8744628393756187274,
	...
	benchRese_nocarry_0272 = x
	benchRese_nocarry_0272[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0272.Cmp(&x)
	}
}

func TestE_nocarry_0272Cmp(t *testing.T) {
	var x, y e_nocarry_0272
...
func TestE_nocarry_0272IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0272
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0272

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0272{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0272
	one.SetOne()
	e.Sub(&qe_nocarry_0272, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0272{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0272{0, uint64(i)})
	}
...
func TestE_nocarry_0272NegZero(t *testing.T) {
	var a, b e_nocarry_0272
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0272Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0272, len(staticTestValues))
...
func TestE_nocarry_0272Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0272) bool {
			var b e_nocarry_0272
...
func TestE_nocarry_0272InverseExp(t *testing.T) {
...
func TestE_nocarry_0272MulByConstants(t *testing.T) {
...
func TestE_nocarry_0272Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0272) bool {
...
func TestE_nocarry_0272LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0272Halve(t *testing.T) {
...
func TestE_nocarry_0272FromMont(t *testing.T) {
...
type testPaire_nocarry_0272 struct {
	element e_nocarry_0272
	bigint  big.Int
}

func (z *e_nocarry_0272) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0272[4] {
		return true
	}
	if z[4] < qe_nocarry_0272[4] {
		return false
	...
	return z[0] >= qe_nocarry_0272[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0272

		g.element = e_nocarry_0272{
		...
		if qe_nocarry_0272[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0272[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0272 {
			var g e_nocarry_0272
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0272[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0272[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0272[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0272[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0272[4], carry)
...
func Benchmarke_nocarry_0272InverseNew(b *testing.B) {
	var x e_nocarry_0272
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0272
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0272
		var xInv e_nocarry_0272
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0272
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0272
...
func testLinearComb(t *testing.T, x *e_nocarry_0272, xC int64, y *e_nocarry_0272, yC int64) {
	...
	var z e_nocarry_0272
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0272, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0272
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0272, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0272
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0272, xHi uint64) {
	var res e_nocarry_0272
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0272) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0272) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0272, c int64, result *e_nocarry_0272, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0272) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0272) uint64 {
