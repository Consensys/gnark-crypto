...
// modulus q
DATA q<>+0(SB)/8, $0xd08f42c21c0f1b4d
DATA q<>+8(SB)/8, $0x4a8f5ad9546cc3c1
DATA q<>+16(SB)/8, $0x9f7c5cfd3ebf717a
DATA q<>+24(SB)/8, $0x6518d7633664c911
DATA q<>+32(SB)/8, $0x000000000000cba4
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x6c4b158939306a7b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xd08f42c21c0f1b4d, R9
	MOVQ    $0x4a8f5ad9546cc3c1, R10
	MOVQ    $0x9f7c5cfd3ebf717a, R11
	MOVQ    $0x6518d7633664c911, R12
	MOVQ    $0x000000000000cba4, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x4a8f5ad9546cc3c1, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x9f7c5cfd3ebf717a, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x6518d7633664c911, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000000000cba4, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xd08f42c21c0f1b4d, CX
	MOVQ    $0x4a8f5ad9546cc3c1, BX
	MOVQ    $0x9f7c5cfd3ebf717a, SI
	MOVQ    $0x6518d7633664c911, DI
	MOVQ    $0x000000000000cba4, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
