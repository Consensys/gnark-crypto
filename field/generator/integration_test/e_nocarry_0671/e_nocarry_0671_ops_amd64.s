...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xe1a008c145ee1977, R14
	ADDQ R14, AX
	MOVQ $0xa3f20d12b8e63bb4, R14
	ADCQ R14, DX
	MOVQ $0x286c121cf6cdd1a3, R14
	ADCQ R14, CX
	MOVQ $0xaa31b2f2cc037fd0, R14
	ADCQ R14, BX
	MOVQ $0xe80411e60ea89cc8, R14
	ADCQ R14, SI
	MOVQ $0x9f7fffbc193dc0a7, R14
	ADCQ R14, DI
	MOVQ $0x46f889b5dc43cdc0, R14
	ADCQ R14, R8
	MOVQ $0xf828605f2bd41566, R14
	ADCQ R14, R9
	MOVQ $0xb29c97edbbeb1ace, R14
	ADCQ R14, R10
	MOVQ $0xb40735e14d8d32b5, R14
	ADCQ R14, R11
	MOVQ $0x000000007d0373f5, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xe1a008c145ee1977, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xa3f20d12b8e63bb4, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x286c121cf6cdd1a3, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xaa31b2f2cc037fd0, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xe80411e60ea89cc8, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x9f7fffbc193dc0a7, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x46f889b5dc43cdc0, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xf828605f2bd41566, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xb29c97edbbeb1ace, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xb40735e14d8d32b5, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000007d0373f5, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xe1a008c145ee1977, AX
	ADDQ AX, DX
	MOVQ $0xa3f20d12b8e63bb4, AX
	ADCQ AX, CX
	MOVQ $0x286c121cf6cdd1a3, AX
	ADCQ AX, BX
	MOVQ $0xaa31b2f2cc037fd0, AX
	ADCQ AX, SI
	MOVQ $0xe80411e60ea89cc8, AX
	ADCQ AX, DI
	MOVQ $0x9f7fffbc193dc0a7, AX
	ADCQ AX, R8
	MOVQ $0x46f889b5dc43cdc0, AX
	ADCQ AX, R9
	MOVQ $0xf828605f2bd41566, AX
	ADCQ AX, R10
	MOVQ $0xb29c97edbbeb1ace, AX
	ADCQ AX, R11
	MOVQ $0xb40735e14d8d32b5, AX
	ADCQ AX, R12
	MOVQ $0x000000007d0373f5, AX
	ADCQ AX, R13
