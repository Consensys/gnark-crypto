...
var benchRese_nocarry_0671 e_nocarry_0671

func BenchmarkE_nocarry_0671SetBytes(b *testing.B) {
	var x e_nocarry_0671
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0671MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0671.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0671)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0671)
		}
	})
}

func BenchmarkE_nocarry_0671Inverse(b *testing.B) {
	var x e_nocarry_0671
	x.SetRandom()
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0671Butterfly(b *testing.B) {
	var x e_nocarry_0671
	x.SetRandom()
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0671)
	}
}

func BenchmarkE_nocarry_0671Exp(b *testing.B) {
	var x e_nocarry_0671
	x.SetRandom()
	benchRese_nocarry_0671.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0671Double(b *testing.B) {
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Double(&benchRese_nocarry_0671)
	}
}

func BenchmarkE_nocarry_0671Add(b *testing.B) {
	var x e_nocarry_0671
	x.SetRandom()
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Add(&x, &benchRese_nocarry_0671)
	}
}

func BenchmarkE_nocarry_0671Sub(b *testing.B) {
	var x e_nocarry_0671
	x.SetRandom()
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Sub(&x, &benchRese_nocarry_0671)
	}
}

func BenchmarkE_nocarry_0671Neg(b *testing.B) {
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Neg(&benchRese_nocarry_0671)
	}
}

func BenchmarkE_nocarry_0671Div(b *testing.B) {
	var x e_nocarry_0671
	x.SetRandom()
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Div(&x, &benchRese_nocarry_0671)
	}
}

func BenchmarkE_nocarry_0671FromMont(b *testing.B) {
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.FromMont()
	}
}

func BenchmarkE_nocarry_0671ToMont(b *testing.B) {
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.ToMont()
	}
}
func BenchmarkE_nocarry_0671Square(b *testing.B) {
	benchRese_nocarry_0671.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Square(&benchRese_nocarry_0671)
	}
}

func BenchmarkE_nocarry_0671Sqrt(b *testing.B) {
	var a e_nocarry_0671
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0671Mul(b *testing.B) {
	x := e_nocarry_0671{
		3962544616081458060,
	...
	benchRese_nocarry_0671.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Mul(&benchRese_nocarry_0671, &x)
	}
}

func BenchmarkE_nocarry_0671Cmp(b *testing.B) {
	x := e_nocarry_0671{
		3962544616081458060,
		13788685038852554324,
		17436997528189787010,
	...
	benchRese_nocarry_0671 = x
	benchRese_nocarry_0671[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0671.Cmp(&x)
	}
}

func TestE_nocarry_0671Cmp(t *testing.T) {
	var x, y e_nocarry_0671
...
func TestE_nocarry_0671IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0671
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0671

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0671{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0671
	one.SetOne()
	e.Sub(&qe_nocarry_0671, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0671{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0671{0, uint64(i)})
	}
...
func TestE_nocarry_0671NegZero(t *testing.T) {
	var a, b e_nocarry_0671
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0671Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0671, len(staticTestValues))
...
func TestE_nocarry_0671Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0671) bool {
			var b e_nocarry_0671
...
func TestE_nocarry_0671InverseExp(t *testing.T) {
...
func TestE_nocarry_0671MulByConstants(t *testing.T) {
...
func TestE_nocarry_0671Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0671) bool {
...
func TestE_nocarry_0671LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0671Halve(t *testing.T) {
...
func TestE_nocarry_0671FromMont(t *testing.T) {
...
type testPaire_nocarry_0671 struct {
	element e_nocarry_0671
	bigint  big.Int
}

func (z *e_nocarry_0671) biggerOrEqualModulus() bool {
...
func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0671

		g.element = e_nocarry_0671{
		...
		if qe_nocarry_0671[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0671[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0671 {
			var g e_nocarry_0671
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0671[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0671[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0671[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0671[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0671[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0671[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0671[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0671[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0671[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0671[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0671[10], carry)
...
func Benchmarke_nocarry_0671InverseNew(b *testing.B) {
	var x e_nocarry_0671
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0671
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0671
		var xInv e_nocarry_0671
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0671
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0671
...
func testLinearComb(t *testing.T, x *e_nocarry_0671, xC int64, y *e_nocarry_0671, yC int64) {
	...
	var z e_nocarry_0671
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0671, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0671
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0671, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0671
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0671, xHi uint64) {
	var res e_nocarry_0671
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0671) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0671) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0671, c int64, result *e_nocarry_0671, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0671) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0671) uint64 {
