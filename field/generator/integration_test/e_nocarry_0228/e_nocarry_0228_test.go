...
var benchRese_nocarry_0228 e_nocarry_0228

func BenchmarkE_nocarry_0228SetBytes(b *testing.B) {
	var x e_nocarry_0228
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0228MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0228.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0228)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0228)
		}
	})
}

func BenchmarkE_nocarry_0228Inverse(b *testing.B) {
	var x e_nocarry_0228
	x.SetRandom()
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0228Butterfly(b *testing.B) {
	var x e_nocarry_0228
	x.SetRandom()
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0228)
	}
}

func BenchmarkE_nocarry_0228Exp(b *testing.B) {
	var x e_nocarry_0228
	x.SetRandom()
	benchRese_nocarry_0228.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0228Double(b *testing.B) {
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Double(&benchRese_nocarry_0228)
	}
}

func BenchmarkE_nocarry_0228Add(b *testing.B) {
	var x e_nocarry_0228
	x.SetRandom()
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Add(&x, &benchRese_nocarry_0228)
	}
}

func BenchmarkE_nocarry_0228Sub(b *testing.B) {
	var x e_nocarry_0228
	x.SetRandom()
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Sub(&x, &benchRese_nocarry_0228)
	}
}

func BenchmarkE_nocarry_0228Neg(b *testing.B) {
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Neg(&benchRese_nocarry_0228)
	}
}

func BenchmarkE_nocarry_0228Div(b *testing.B) {
	var x e_nocarry_0228
	x.SetRandom()
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Div(&x, &benchRese_nocarry_0228)
	}
}

func BenchmarkE_nocarry_0228FromMont(b *testing.B) {
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.FromMont()
	}
}

func BenchmarkE_nocarry_0228ToMont(b *testing.B) {
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.ToMont()
	}
}
func BenchmarkE_nocarry_0228Square(b *testing.B) {
	benchRese_nocarry_0228.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Square(&benchRese_nocarry_0228)
	}
}

func BenchmarkE_nocarry_0228Sqrt(b *testing.B) {
	var a e_nocarry_0228
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0228Mul(b *testing.B) {
	x := e_nocarry_0228{
	...
	benchRese_nocarry_0228.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Mul(&benchRese_nocarry_0228, &x)
	}
}

func BenchmarkE_nocarry_0228Cmp(b *testing.B) {
	x := e_nocarry_0228{
		14784407414888409949,
		7534648467953603369,
		16414034134727589100,
	...
	benchRese_nocarry_0228 = x
	benchRese_nocarry_0228[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0228.Cmp(&x)
	}
}

func TestE_nocarry_0228Cmp(t *testing.T) {
	var x, y e_nocarry_0228
...
func TestE_nocarry_0228IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0228
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0228

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0228{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0228
	one.SetOne()
	e.Sub(&qe_nocarry_0228, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0228{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0228{0, uint64(i)})
	}
...
func TestE_nocarry_0228NegZero(t *testing.T) {
	var a, b e_nocarry_0228
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0228Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0228, len(staticTestValues))
...
func TestE_nocarry_0228Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0228) bool {
			var b e_nocarry_0228
...
func TestE_nocarry_0228InverseExp(t *testing.T) {
...
func TestE_nocarry_0228MulByConstants(t *testing.T) {
...
func TestE_nocarry_0228Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0228) bool {
...
func TestE_nocarry_0228LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0228Halve(t *testing.T) {
...
func TestE_nocarry_0228FromMont(t *testing.T) {
...
type testPaire_nocarry_0228 struct {
	element e_nocarry_0228
	bigint  big.Int
}

func (z *e_nocarry_0228) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0228[3] {
		return true
	}
	if z[3] < qe_nocarry_0228[3] {
		return false
	...
	return z[0] >= qe_nocarry_0228[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0228

		g.element = e_nocarry_0228{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0228[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0228[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0228 {
			var g e_nocarry_0228
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0228[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0228[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0228[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0228[3], carry)
...
func Benchmarke_nocarry_0228InverseNew(b *testing.B) {
	var x e_nocarry_0228
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0228
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0228
		var xInv e_nocarry_0228
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0228
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0228
...
func testLinearComb(t *testing.T, x *e_nocarry_0228, xC int64, y *e_nocarry_0228, yC int64) {
	...
	var z e_nocarry_0228
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0228, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0228
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0228, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0228
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0228, xHi uint64) {
	var res e_nocarry_0228
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0228) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0228) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0228, c int64, result *e_nocarry_0228, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0228) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0228) uint64 {
