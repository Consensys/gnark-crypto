...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xc5832bc22f20096f, R12
	ADDQ R12, AX
	MOVQ $0xd51fab8aec88bac5, R12
	ADCQ R12, DX
	MOVQ $0xedf9a648f4d7d7d6, R12
	ADCQ R12, CX
	MOVQ $0x92d1b5e3c8021ac8, R12
	ADCQ R12, BX
	MOVQ $0x4189d876458228df, R12
	ADCQ R12, SI
	MOVQ $0xe20d4e42a47b1b78, R12
	ADCQ R12, DI
	MOVQ $0x80c492bb71194e8e, R12
	ADCQ R12, R8
	MOVQ $0xc118115d5416ef9d, R12
	ADCQ R12, R9
	MOVQ $0x001969c75a5a6e8f, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xc5832bc22f20096f, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xd51fab8aec88bac5, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xedf9a648f4d7d7d6, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x92d1b5e3c8021ac8, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x4189d876458228df, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xe20d4e42a47b1b78, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x80c492bb71194e8e, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xc118115d5416ef9d, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x001969c75a5a6e8f, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xc5832bc22f20096f, AX
	ADDQ AX, DX
	MOVQ $0xd51fab8aec88bac5, AX
	ADCQ AX, CX
	MOVQ $0xedf9a648f4d7d7d6, AX
	ADCQ AX, BX
	MOVQ $0x92d1b5e3c8021ac8, AX
	ADCQ AX, SI
	MOVQ $0x4189d876458228df, AX
	ADCQ AX, DI
	MOVQ $0xe20d4e42a47b1b78, AX
	ADCQ AX, R8
	MOVQ $0x80c492bb71194e8e, AX
	ADCQ AX, R9
	MOVQ $0xc118115d5416ef9d, AX
	ADCQ AX, R10
	MOVQ $0x001969c75a5a6e8f, AX
	ADCQ AX, R11
