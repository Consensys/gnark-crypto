...
// modulus q
DATA q<>+0(SB)/8, $0xe11c9fb19904f95b
DATA q<>+8(SB)/8, $0xcade66c1c357ba7b
DATA q<>+16(SB)/8, $0x38b50b1fd10bae59
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xf1a1e669965d712d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xe11c9fb19904f95b, DI
	MOVQ    $0xcade66c1c357ba7b, R8
	MOVQ    $0x38b50b1fd10bae59, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xcade66c1c357ba7b, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x38b50b1fd10bae59, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xe11c9fb19904f95b, R10
	MOVQ    $0xcade66c1c357ba7b, R11
	MOVQ    $0x38b50b1fd10bae59, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
