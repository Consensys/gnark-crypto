...
var benchRese_nocarry_0314 e_nocarry_0314

func BenchmarkE_nocarry_0314SetBytes(b *testing.B) {
	var x e_nocarry_0314
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0314MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0314.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0314)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0314)
		}
	})
}

func BenchmarkE_nocarry_0314Inverse(b *testing.B) {
	var x e_nocarry_0314
	x.SetRandom()
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0314Butterfly(b *testing.B) {
	var x e_nocarry_0314
	x.SetRandom()
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0314)
	}
}

func BenchmarkE_nocarry_0314Exp(b *testing.B) {
	var x e_nocarry_0314
	x.SetRandom()
	benchRese_nocarry_0314.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0314Double(b *testing.B) {
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Double(&benchRese_nocarry_0314)
	}
}

func BenchmarkE_nocarry_0314Add(b *testing.B) {
	var x e_nocarry_0314
	x.SetRandom()
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Add(&x, &benchRese_nocarry_0314)
	}
}

func BenchmarkE_nocarry_0314Sub(b *testing.B) {
	var x e_nocarry_0314
	x.SetRandom()
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Sub(&x, &benchRese_nocarry_0314)
	}
}

func BenchmarkE_nocarry_0314Neg(b *testing.B) {
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Neg(&benchRese_nocarry_0314)
	}
}

func BenchmarkE_nocarry_0314Div(b *testing.B) {
	var x e_nocarry_0314
	x.SetRandom()
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Div(&x, &benchRese_nocarry_0314)
	}
}

func BenchmarkE_nocarry_0314FromMont(b *testing.B) {
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.FromMont()
	}
}

func BenchmarkE_nocarry_0314ToMont(b *testing.B) {
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.ToMont()
	}
}
func BenchmarkE_nocarry_0314Square(b *testing.B) {
	benchRese_nocarry_0314.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Square(&benchRese_nocarry_0314)
	}
}

func BenchmarkE_nocarry_0314Sqrt(b *testing.B) {
	var a e_nocarry_0314
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0314Mul(b *testing.B) {
	x := e_nocarry_0314{
	...
	benchRese_nocarry_0314.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Mul(&benchRese_nocarry_0314, &x)
	}
}

func BenchmarkE_nocarry_0314Cmp(b *testing.B) {
	x := e_nocarry_0314{
		11900085214856199286,
		15732690861937001532,
		3490269319314197090,
	...
	benchRese_nocarry_0314 = x
	benchRese_nocarry_0314[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0314.Cmp(&x)
	}
}

func TestE_nocarry_0314Cmp(t *testing.T) {
	var x, y e_nocarry_0314
...
func TestE_nocarry_0314IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0314
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0314

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0314{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0314
	one.SetOne()
	e.Sub(&qe_nocarry_0314, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0314{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0314{0, uint64(i)})
	}
...
func TestE_nocarry_0314NegZero(t *testing.T) {
	var a, b e_nocarry_0314
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0314Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0314, len(staticTestValues))
...
func TestE_nocarry_0314Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0314) bool {
			var b e_nocarry_0314
...
func TestE_nocarry_0314InverseExp(t *testing.T) {
...
func TestE_nocarry_0314MulByConstants(t *testing.T) {
...
func TestE_nocarry_0314Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0314) bool {
...
func TestE_nocarry_0314LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0314Halve(t *testing.T) {
...
func TestE_nocarry_0314FromMont(t *testing.T) {
...
type testPaire_nocarry_0314 struct {
	element e_nocarry_0314
	bigint  big.Int
}

func (z *e_nocarry_0314) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0314[4] {
		return true
	}
	if z[4] < qe_nocarry_0314[4] {
		return false
	...
	return z[0] >= qe_nocarry_0314[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0314

		g.element = e_nocarry_0314{
		...
		if qe_nocarry_0314[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0314[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0314 {
			var g e_nocarry_0314
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0314[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0314[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0314[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0314[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0314[4], carry)
...
func Benchmarke_nocarry_0314InverseNew(b *testing.B) {
	var x e_nocarry_0314
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0314
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0314
		var xInv e_nocarry_0314
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0314
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0314
...
func testLinearComb(t *testing.T, x *e_nocarry_0314, xC int64, y *e_nocarry_0314, yC int64) {
	...
	var z e_nocarry_0314
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0314, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0314
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0314, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0314
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0314, xHi uint64) {
	var res e_nocarry_0314
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0314) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0314) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0314, c int64, result *e_nocarry_0314, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0314) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0314) uint64 {
