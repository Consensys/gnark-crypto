...
// modulus q
DATA q<>+0(SB)/8, $0x81076e4f5d32b86b
DATA q<>+8(SB)/8, $0x6e27060b2cb98362
DATA q<>+16(SB)/8, $0x5f3e996e9787d84d
DATA q<>+24(SB)/8, $0x5571749b32fbe89c
DATA q<>+32(SB)/8, $0x03ce6bd661f232a2
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xeca19bf1b433cbbd
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x81076e4f5d32b86b, R9
	MOVQ    $0x6e27060b2cb98362, R10
	MOVQ    $0x5f3e996e9787d84d, R11
	MOVQ    $0x5571749b32fbe89c, R12
	MOVQ    $0x03ce6bd661f232a2, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x6e27060b2cb98362, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x5f3e996e9787d84d, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x5571749b32fbe89c, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x03ce6bd661f232a2, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x81076e4f5d32b86b, CX
	MOVQ    $0x6e27060b2cb98362, BX
	MOVQ    $0x5f3e996e9787d84d, SI
	MOVQ    $0x5571749b32fbe89c, DI
	MOVQ    $0x03ce6bd661f232a2, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
