...
var benchRese_nocarry_0456 e_nocarry_0456

func BenchmarkE_nocarry_0456SetBytes(b *testing.B) {
	var x e_nocarry_0456
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0456MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0456.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0456)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0456)
		}
	})
}

func BenchmarkE_nocarry_0456Inverse(b *testing.B) {
	var x e_nocarry_0456
	x.SetRandom()
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0456Butterfly(b *testing.B) {
	var x e_nocarry_0456
	x.SetRandom()
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0456)
	}
}

func BenchmarkE_nocarry_0456Exp(b *testing.B) {
	var x e_nocarry_0456
	x.SetRandom()
	benchRese_nocarry_0456.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0456Double(b *testing.B) {
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Double(&benchRese_nocarry_0456)
	}
}

func BenchmarkE_nocarry_0456Add(b *testing.B) {
	var x e_nocarry_0456
	x.SetRandom()
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Add(&x, &benchRese_nocarry_0456)
	}
}

func BenchmarkE_nocarry_0456Sub(b *testing.B) {
	var x e_nocarry_0456
	x.SetRandom()
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Sub(&x, &benchRese_nocarry_0456)
	}
}

func BenchmarkE_nocarry_0456Neg(b *testing.B) {
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Neg(&benchRese_nocarry_0456)
	}
}

func BenchmarkE_nocarry_0456Div(b *testing.B) {
	var x e_nocarry_0456
	x.SetRandom()
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Div(&x, &benchRese_nocarry_0456)
	}
}

func BenchmarkE_nocarry_0456FromMont(b *testing.B) {
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.FromMont()
	}
}

func BenchmarkE_nocarry_0456ToMont(b *testing.B) {
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.ToMont()
	}
}
func BenchmarkE_nocarry_0456Square(b *testing.B) {
	benchRese_nocarry_0456.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Square(&benchRese_nocarry_0456)
	}
}

func BenchmarkE_nocarry_0456Sqrt(b *testing.B) {
	var a e_nocarry_0456
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0456Mul(b *testing.B) {
	x := e_nocarry_0456{
	...
	benchRese_nocarry_0456.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Mul(&benchRese_nocarry_0456, &x)
	}
}

func BenchmarkE_nocarry_0456Cmp(b *testing.B) {
	x := e_nocarry_0456{
		10251032866537272713,
		8904595995419095946,
		2082483313742848631,
	...
	benchRese_nocarry_0456 = x
	benchRese_nocarry_0456[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0456.Cmp(&x)
	}
}

func TestE_nocarry_0456Cmp(t *testing.T) {
	var x, y e_nocarry_0456
...
func TestE_nocarry_0456IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0456
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0456

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0456{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0456
	one.SetOne()
	e.Sub(&qe_nocarry_0456, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0456{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0456{0, uint64(i)})
	}
...
func TestE_nocarry_0456NegZero(t *testing.T) {
	var a, b e_nocarry_0456
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0456Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0456, len(staticTestValues))
...
func TestE_nocarry_0456Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0456) bool {
			var b e_nocarry_0456
...
func TestE_nocarry_0456InverseExp(t *testing.T) {
...
func TestE_nocarry_0456MulByConstants(t *testing.T) {
...
func TestE_nocarry_0456Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0456) bool {
...
func TestE_nocarry_0456LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0456Halve(t *testing.T) {
...
func TestE_nocarry_0456FromMont(t *testing.T) {
...
type testPaire_nocarry_0456 struct {
	element e_nocarry_0456
	bigint  big.Int
}

func (z *e_nocarry_0456) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0456[7] {
		return true
	}
	if z[7] < qe_nocarry_0456[7] {
		return false
	...
	return z[0] >= qe_nocarry_0456[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0456

		g.element = e_nocarry_0456{
		...
		if qe_nocarry_0456[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0456[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0456 {
			var g e_nocarry_0456
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0456[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0456[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0456[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0456[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0456[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0456[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0456[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0456[7], carry)
...
func Benchmarke_nocarry_0456InverseNew(b *testing.B) {
	var x e_nocarry_0456
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0456
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0456
		var xInv e_nocarry_0456
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0456
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0456
...
func testLinearComb(t *testing.T, x *e_nocarry_0456, xC int64, y *e_nocarry_0456, yC int64) {
	...
	var z e_nocarry_0456
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0456, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0456
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0456, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0456
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0456, xHi uint64) {
	var res e_nocarry_0456
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0456) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0456) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0456, c int64, result *e_nocarry_0456, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0456) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0456) uint64 {
