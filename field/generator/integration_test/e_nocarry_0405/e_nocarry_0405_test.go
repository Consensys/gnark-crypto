...
var benchRese_nocarry_0405 e_nocarry_0405

func BenchmarkE_nocarry_0405SetBytes(b *testing.B) {
	var x e_nocarry_0405
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0405MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0405.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0405)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0405)
		}
	})
}

func BenchmarkE_nocarry_0405Inverse(b *testing.B) {
	var x e_nocarry_0405
	x.SetRandom()
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0405Butterfly(b *testing.B) {
	var x e_nocarry_0405
	x.SetRandom()
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0405)
	}
}

func BenchmarkE_nocarry_0405Exp(b *testing.B) {
	var x e_nocarry_0405
	x.SetRandom()
	benchRese_nocarry_0405.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0405Double(b *testing.B) {
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Double(&benchRese_nocarry_0405)
	}
}

func BenchmarkE_nocarry_0405Add(b *testing.B) {
	var x e_nocarry_0405
	x.SetRandom()
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Add(&x, &benchRese_nocarry_0405)
	}
}

func BenchmarkE_nocarry_0405Sub(b *testing.B) {
	var x e_nocarry_0405
	x.SetRandom()
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Sub(&x, &benchRese_nocarry_0405)
	}
}

func BenchmarkE_nocarry_0405Neg(b *testing.B) {
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Neg(&benchRese_nocarry_0405)
	}
}

func BenchmarkE_nocarry_0405Div(b *testing.B) {
	var x e_nocarry_0405
	x.SetRandom()
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Div(&x, &benchRese_nocarry_0405)
	}
}

func BenchmarkE_nocarry_0405FromMont(b *testing.B) {
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.FromMont()
	}
}

func BenchmarkE_nocarry_0405ToMont(b *testing.B) {
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.ToMont()
	}
}
func BenchmarkE_nocarry_0405Square(b *testing.B) {
	benchRese_nocarry_0405.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Square(&benchRese_nocarry_0405)
	}
}

func BenchmarkE_nocarry_0405Sqrt(b *testing.B) {
	var a e_nocarry_0405
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0405Mul(b *testing.B) {
	x := e_nocarry_0405{
	...
	benchRese_nocarry_0405.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Mul(&benchRese_nocarry_0405, &x)
	}
}

func BenchmarkE_nocarry_0405Cmp(b *testing.B) {
	x := e_nocarry_0405{
		14702415971153030528,
		7006597762190903836,
		7056030379194126975,
	...
	benchRese_nocarry_0405 = x
	benchRese_nocarry_0405[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0405.Cmp(&x)
	}
}

func TestE_nocarry_0405Cmp(t *testing.T) {
	var x, y e_nocarry_0405
...
func TestE_nocarry_0405IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0405
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0405

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0405{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0405
	one.SetOne()
	e.Sub(&qe_nocarry_0405, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0405{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0405{0, uint64(i)})
	}
...
func TestE_nocarry_0405NegZero(t *testing.T) {
	var a, b e_nocarry_0405
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0405Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0405, len(staticTestValues))
...
func TestE_nocarry_0405Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0405) bool {
			var b e_nocarry_0405
...
func TestE_nocarry_0405InverseExp(t *testing.T) {
...
func TestE_nocarry_0405MulByConstants(t *testing.T) {
...
func TestE_nocarry_0405Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0405) bool {
...
func TestE_nocarry_0405LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0405Halve(t *testing.T) {
...
func TestE_nocarry_0405FromMont(t *testing.T) {
...
type testPaire_nocarry_0405 struct {
	element e_nocarry_0405
	bigint  big.Int
}

func (z *e_nocarry_0405) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0405[6] {
		return true
	}
	if z[6] < qe_nocarry_0405[6] {
		return false
	...
	return z[0] >= qe_nocarry_0405[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0405

		g.element = e_nocarry_0405{
		...
		if qe_nocarry_0405[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0405[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0405 {
			var g e_nocarry_0405
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0405[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0405[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0405[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0405[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0405[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0405[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0405[6], carry)
...
func Benchmarke_nocarry_0405InverseNew(b *testing.B) {
	var x e_nocarry_0405
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0405
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0405
		var xInv e_nocarry_0405
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0405
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0405
...
func testLinearComb(t *testing.T, x *e_nocarry_0405, xC int64, y *e_nocarry_0405, yC int64) {
	...
	var z e_nocarry_0405
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0405, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0405
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0405, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0405
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0405, xHi uint64) {
	var res e_nocarry_0405
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0405) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0405) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0405, c int64, result *e_nocarry_0405, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0405) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0405) uint64 {
