...
// modulus q
DATA q<>+0(SB)/8, $0x7cd6861b424b71e9
DATA q<>+8(SB)/8, $0x1c7af231faed6eff
DATA q<>+16(SB)/8, $0x3e1f63888a341741
DATA q<>+24(SB)/8, $0x5ba395c99c8de4fc
DATA q<>+32(SB)/8, $0x0000000000746d9e
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x14ff74a3eb5b89a7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x7cd6861b424b71e9, R9
	MOVQ    $0x1c7af231faed6eff, R10
	MOVQ    $0x3e1f63888a341741, R11
	MOVQ    $0x5ba395c99c8de4fc, R12
	MOVQ    $0x0000000000746d9e, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x1c7af231faed6eff, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x3e1f63888a341741, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x5ba395c99c8de4fc, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000746d9e, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x7cd6861b424b71e9, CX
	MOVQ    $0x1c7af231faed6eff, BX
	MOVQ    $0x3e1f63888a341741, SI
	MOVQ    $0x5ba395c99c8de4fc, DI
	MOVQ    $0x0000000000746d9e, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
