...
var benchRese_nocarry_0279 e_nocarry_0279

func BenchmarkE_nocarry_0279SetBytes(b *testing.B) {
	var x e_nocarry_0279
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0279MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0279.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0279)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0279)
		}
	})
}

func BenchmarkE_nocarry_0279Inverse(b *testing.B) {
	var x e_nocarry_0279
	x.SetRandom()
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0279Butterfly(b *testing.B) {
	var x e_nocarry_0279
	x.SetRandom()
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0279)
	}
}

func BenchmarkE_nocarry_0279Exp(b *testing.B) {
	var x e_nocarry_0279
	x.SetRandom()
	benchRese_nocarry_0279.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0279Double(b *testing.B) {
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Double(&benchRese_nocarry_0279)
	}
}

func BenchmarkE_nocarry_0279Add(b *testing.B) {
	var x e_nocarry_0279
	x.SetRandom()
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Add(&x, &benchRese_nocarry_0279)
	}
}

func BenchmarkE_nocarry_0279Sub(b *testing.B) {
	var x e_nocarry_0279
	x.SetRandom()
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Sub(&x, &benchRese_nocarry_0279)
	}
}

func BenchmarkE_nocarry_0279Neg(b *testing.B) {
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Neg(&benchRese_nocarry_0279)
	}
}

func BenchmarkE_nocarry_0279Div(b *testing.B) {
	var x e_nocarry_0279
	x.SetRandom()
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Div(&x, &benchRese_nocarry_0279)
	}
}

func BenchmarkE_nocarry_0279FromMont(b *testing.B) {
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.FromMont()
	}
}

func BenchmarkE_nocarry_0279ToMont(b *testing.B) {
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.ToMont()
	}
}
func BenchmarkE_nocarry_0279Square(b *testing.B) {
	benchRese_nocarry_0279.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Square(&benchRese_nocarry_0279)
	}
}

func BenchmarkE_nocarry_0279Sqrt(b *testing.B) {
	var a e_nocarry_0279
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0279Mul(b *testing.B) {
	x := e_nocarry_0279{
	...
	benchRese_nocarry_0279.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Mul(&benchRese_nocarry_0279, &x)
	}
}

func BenchmarkE_nocarry_0279Cmp(b *testing.B) {
	x := e_nocarry_0279{
		15424184003163756393,
		10156402008733311686,
		5709722148636683052,
	...
	benchRese_nocarry_0279 = x
	benchRese_nocarry_0279[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0279.Cmp(&x)
	}
}

func TestE_nocarry_0279Cmp(t *testing.T) {
	var x, y e_nocarry_0279
...
func TestE_nocarry_0279IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0279
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0279

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0279{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0279
	one.SetOne()
	e.Sub(&qe_nocarry_0279, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0279{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0279{0, uint64(i)})
	}
...
func TestE_nocarry_0279NegZero(t *testing.T) {
	var a, b e_nocarry_0279
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0279Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0279, len(staticTestValues))
...
func TestE_nocarry_0279Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0279) bool {
			var b e_nocarry_0279
...
func TestE_nocarry_0279InverseExp(t *testing.T) {
...
func TestE_nocarry_0279MulByConstants(t *testing.T) {
...
func TestE_nocarry_0279Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0279) bool {
...
func TestE_nocarry_0279LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0279Halve(t *testing.T) {
...
func TestE_nocarry_0279FromMont(t *testing.T) {
...
type testPaire_nocarry_0279 struct {
	element e_nocarry_0279
	bigint  big.Int
}

func (z *e_nocarry_0279) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0279[4] {
		return true
	}
	if z[4] < qe_nocarry_0279[4] {
		return false
	...
	return z[0] >= qe_nocarry_0279[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0279

		g.element = e_nocarry_0279{
		...
		if qe_nocarry_0279[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0279[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0279 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0279[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0279[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0279[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0279[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0279[4], carry)
...
func Benchmarke_nocarry_0279InverseNew(b *testing.B) {
	var x e_nocarry_0279
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0279
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0279
		var xInv e_nocarry_0279
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0279
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0279
...
func testLinearComb(t *testing.T, x *e_nocarry_0279, xC int64, y *e_nocarry_0279, yC int64) {
	...
	var z e_nocarry_0279
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0279, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0279
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0279, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0279
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0279, xHi uint64) {
	var res e_nocarry_0279
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0279) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0279) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0279, c int64, result *e_nocarry_0279, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0279) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0279) uint64 {
