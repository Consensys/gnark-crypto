...
var benchRese_nocarry_0229 e_nocarry_0229

func BenchmarkE_nocarry_0229SetBytes(b *testing.B) {
	var x e_nocarry_0229
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0229MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0229.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0229)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0229)
		}
	})
}

func BenchmarkE_nocarry_0229Inverse(b *testing.B) {
	var x e_nocarry_0229
	x.SetRandom()
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0229Butterfly(b *testing.B) {
	var x e_nocarry_0229
	x.SetRandom()
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0229)
	}
}

func BenchmarkE_nocarry_0229Exp(b *testing.B) {
	var x e_nocarry_0229
	x.SetRandom()
	benchRese_nocarry_0229.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0229Double(b *testing.B) {
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Double(&benchRese_nocarry_0229)
	}
}

func BenchmarkE_nocarry_0229Add(b *testing.B) {
	var x e_nocarry_0229
	x.SetRandom()
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Add(&x, &benchRese_nocarry_0229)
	}
}

func BenchmarkE_nocarry_0229Sub(b *testing.B) {
	var x e_nocarry_0229
	x.SetRandom()
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Sub(&x, &benchRese_nocarry_0229)
	}
}

func BenchmarkE_nocarry_0229Neg(b *testing.B) {
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Neg(&benchRese_nocarry_0229)
	}
}

func BenchmarkE_nocarry_0229Div(b *testing.B) {
	var x e_nocarry_0229
	x.SetRandom()
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Div(&x, &benchRese_nocarry_0229)
	}
}

func BenchmarkE_nocarry_0229FromMont(b *testing.B) {
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.FromMont()
	}
}

func BenchmarkE_nocarry_0229ToMont(b *testing.B) {
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.ToMont()
	}
}
func BenchmarkE_nocarry_0229Square(b *testing.B) {
	benchRese_nocarry_0229.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Square(&benchRese_nocarry_0229)
	}
}

func BenchmarkE_nocarry_0229Sqrt(b *testing.B) {
	var a e_nocarry_0229
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0229Mul(b *testing.B) {
	x := e_nocarry_0229{
	...
	benchRese_nocarry_0229.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Mul(&benchRese_nocarry_0229, &x)
	}
}

func BenchmarkE_nocarry_0229Cmp(b *testing.B) {
	x := e_nocarry_0229{
		12327615251993586214,
		725034414210380236,
		1804318842981160336,
	...
	benchRese_nocarry_0229 = x
	benchRese_nocarry_0229[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0229.Cmp(&x)
	}
}

func TestE_nocarry_0229Cmp(t *testing.T) {
	var x, y e_nocarry_0229
...
func TestE_nocarry_0229IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0229
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0229

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0229{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0229
	one.SetOne()
	e.Sub(&qe_nocarry_0229, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0229{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0229{0, uint64(i)})
	}
...
func TestE_nocarry_0229NegZero(t *testing.T) {
	var a, b e_nocarry_0229
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0229Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0229, len(staticTestValues))
...
func TestE_nocarry_0229Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0229) bool {
			var b e_nocarry_0229
...
func TestE_nocarry_0229InverseExp(t *testing.T) {
...
func TestE_nocarry_0229MulByConstants(t *testing.T) {
...
func TestE_nocarry_0229Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0229) bool {
...
func TestE_nocarry_0229LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0229Halve(t *testing.T) {
...
func TestE_nocarry_0229FromMont(t *testing.T) {
...
type testPaire_nocarry_0229 struct {
	element e_nocarry_0229
	bigint  big.Int
}

func (z *e_nocarry_0229) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0229[3] {
		return true
	}
	if z[3] < qe_nocarry_0229[3] {
		return false
	...
	return z[0] >= qe_nocarry_0229[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0229

		g.element = e_nocarry_0229{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0229[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0229[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0229 {
			var g e_nocarry_0229
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0229[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0229[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0229[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0229[3], carry)
...
func Benchmarke_nocarry_0229InverseNew(b *testing.B) {
	var x e_nocarry_0229
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0229
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0229
		var xInv e_nocarry_0229
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0229
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0229
...
func testLinearComb(t *testing.T, x *e_nocarry_0229, xC int64, y *e_nocarry_0229, yC int64) {
	...
	var z e_nocarry_0229
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0229, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0229
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0229, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0229
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0229, xHi uint64) {
	var res e_nocarry_0229
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0229) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0229) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0229, c int64, result *e_nocarry_0229, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0229) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0229) uint64 {
