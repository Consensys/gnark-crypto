...
// modulus q
DATA q<>+0(SB)/8, $0x3a6c08ae6896d85b
DATA q<>+8(SB)/8, $0x51f02e800af5358b
DATA q<>+16(SB)/8, $0x6b9635ec21298046
DATA q<>+24(SB)/8, $0x0000001e97d3265f
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x22913ed69c75682d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x3a6c08ae6896d85b, R8
	MOVQ    $0x51f02e800af5358b, R9
	MOVQ    $0x6b9635ec21298046, R10
	MOVQ    $0x0000001e97d3265f, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x51f02e800af5358b, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x6b9635ec21298046, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000001e97d3265f, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x3a6c08ae6896d85b, R12
	MOVQ    $0x51f02e800af5358b, R13
	MOVQ    $0x6b9635ec21298046, R14
	MOVQ    $0x0000001e97d3265f, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
