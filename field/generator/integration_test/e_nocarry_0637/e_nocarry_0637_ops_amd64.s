...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x4ffff809e2367537, R13
	ADDQ R13, AX
	MOVQ $0xbe7de6dc54327d0c, R13
	ADCQ R13, DX
	MOVQ $0x1cf970fdaf7f652d, R13
	ADCQ R13, CX
	MOVQ $0xba27934940afc70b, R13
	ADCQ R13, BX
	MOVQ $0xf3b6fc64929c1141, R13
	ADCQ R13, SI
	MOVQ $0x9631717ec5ed5f8b, R13
	ADCQ R13, DI
	MOVQ $0x8dcd3c414cfd0b34, R13
	ADCQ R13, R8
	MOVQ $0xd7af22d3a7b6fec2, R13
	ADCQ R13, R9
	MOVQ $0xdbee86c97d3cbddb, R13
	ADCQ R13, R10
	MOVQ $0x19367581e1c82e64, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x4ffff809e2367537, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xbe7de6dc54327d0c, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x1cf970fdaf7f652d, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xba27934940afc70b, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xf3b6fc64929c1141, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x9631717ec5ed5f8b, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x8dcd3c414cfd0b34, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xd7af22d3a7b6fec2, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xdbee86c97d3cbddb, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x19367581e1c82e64, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x4ffff809e2367537, AX
	ADDQ AX, DX
	MOVQ $0xbe7de6dc54327d0c, AX
	ADCQ AX, CX
	MOVQ $0x1cf970fdaf7f652d, AX
	ADCQ AX, BX
	MOVQ $0xba27934940afc70b, AX
	ADCQ AX, SI
	MOVQ $0xf3b6fc64929c1141, AX
	ADCQ AX, DI
	MOVQ $0x9631717ec5ed5f8b, AX
	ADCQ AX, R8
	MOVQ $0x8dcd3c414cfd0b34, AX
	ADCQ AX, R9
	MOVQ $0xd7af22d3a7b6fec2, AX
	ADCQ AX, R10
	MOVQ $0xdbee86c97d3cbddb, AX
	ADCQ AX, R11
	MOVQ $0x19367581e1c82e64, AX
	ADCQ AX, R12
