...
var benchRese_nocarry_0637 e_nocarry_0637

func BenchmarkE_nocarry_0637SetBytes(b *testing.B) {
	var x e_nocarry_0637
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0637MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0637.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0637)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0637)
		}
	})
}

func BenchmarkE_nocarry_0637Inverse(b *testing.B) {
	var x e_nocarry_0637
	x.SetRandom()
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0637Butterfly(b *testing.B) {
	var x e_nocarry_0637
	x.SetRandom()
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0637)
	}
}

func BenchmarkE_nocarry_0637Exp(b *testing.B) {
	var x e_nocarry_0637
	x.SetRandom()
	benchRese_nocarry_0637.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0637Double(b *testing.B) {
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Double(&benchRese_nocarry_0637)
	}
}

func BenchmarkE_nocarry_0637Add(b *testing.B) {
	var x e_nocarry_0637
	x.SetRandom()
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Add(&x, &benchRese_nocarry_0637)
	}
}

func BenchmarkE_nocarry_0637Sub(b *testing.B) {
	var x e_nocarry_0637
	x.SetRandom()
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Sub(&x, &benchRese_nocarry_0637)
	}
}

func BenchmarkE_nocarry_0637Neg(b *testing.B) {
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Neg(&benchRese_nocarry_0637)
	}
}

func BenchmarkE_nocarry_0637Div(b *testing.B) {
	var x e_nocarry_0637
	x.SetRandom()
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Div(&x, &benchRese_nocarry_0637)
	}
}

func BenchmarkE_nocarry_0637FromMont(b *testing.B) {
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.FromMont()
	}
}

func BenchmarkE_nocarry_0637ToMont(b *testing.B) {
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.ToMont()
	}
}
func BenchmarkE_nocarry_0637Square(b *testing.B) {
	benchRese_nocarry_0637.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Square(&benchRese_nocarry_0637)
	}
}

func BenchmarkE_nocarry_0637Sqrt(b *testing.B) {
	var a e_nocarry_0637
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0637Mul(b *testing.B) {
	x := e_nocarry_0637{
		7418114812159609681,
		5969060724992326638,
		4872916216884504810,
	...
	benchRese_nocarry_0637.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Mul(&benchRese_nocarry_0637, &x)
	}
}

func BenchmarkE_nocarry_0637Cmp(b *testing.B) {
	x := e_nocarry_0637{
		7418114812159609681,
		5969060724992326638,
		4872916216884504810,
	...
	benchRese_nocarry_0637 = x
	benchRese_nocarry_0637[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0637.Cmp(&x)
	}
}

func TestE_nocarry_0637Cmp(t *testing.T) {
	var x, y e_nocarry_0637
...
func TestE_nocarry_0637IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0637
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0637

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0637{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0637
	one.SetOne()
	e.Sub(&qe_nocarry_0637, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0637{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0637{0, uint64(i)})
	}
...
func TestE_nocarry_0637NegZero(t *testing.T) {
	var a, b e_nocarry_0637
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0637Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0637, len(staticTestValues))
...
func TestE_nocarry_0637Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0637) bool {
			var b e_nocarry_0637
...
func TestE_nocarry_0637InverseExp(t *testing.T) {
...
func TestE_nocarry_0637MulByConstants(t *testing.T) {
...
func TestE_nocarry_0637Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0637) bool {
...
func TestE_nocarry_0637LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0637Halve(t *testing.T) {
...
func TestE_nocarry_0637FromMont(t *testing.T) {
...
type testPaire_nocarry_0637 struct {
	element e_nocarry_0637
	bigint  big.Int
}

func (z *e_nocarry_0637) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0637[9] {
		return true
	}
	if z[9] < qe_nocarry_0637[9] {
		return false
	...
	return z[0] >= qe_nocarry_0637[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0637

		g.element = e_nocarry_0637{
		...
		if qe_nocarry_0637[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0637[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0637 {
			var g e_nocarry_0637
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0637[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0637[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0637[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0637[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0637[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0637[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0637[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0637[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0637[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0637[9], carry)
...
func Benchmarke_nocarry_0637InverseNew(b *testing.B) {
	var x e_nocarry_0637
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0637
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0637
		var xInv e_nocarry_0637
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0637
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0637
...
func testLinearComb(t *testing.T, x *e_nocarry_0637, xC int64, y *e_nocarry_0637, yC int64) {
	...
	var z e_nocarry_0637
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0637, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0637
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0637, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0637
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0637, xHi uint64) {
	var res e_nocarry_0637
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0637) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0637) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0637, c int64, result *e_nocarry_0637, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0637) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0637) uint64 {
