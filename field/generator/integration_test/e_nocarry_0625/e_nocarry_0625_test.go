...
var benchRese_nocarry_0625 e_nocarry_0625

func BenchmarkE_nocarry_0625SetBytes(b *testing.B) {
	var x e_nocarry_0625
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0625MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0625.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0625)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0625)
		}
	})
}

func BenchmarkE_nocarry_0625Inverse(b *testing.B) {
	var x e_nocarry_0625
	x.SetRandom()
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0625Butterfly(b *testing.B) {
	var x e_nocarry_0625
	x.SetRandom()
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0625)
	}
}

func BenchmarkE_nocarry_0625Exp(b *testing.B) {
	var x e_nocarry_0625
	x.SetRandom()
	benchRese_nocarry_0625.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0625Double(b *testing.B) {
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Double(&benchRese_nocarry_0625)
	}
}

func BenchmarkE_nocarry_0625Add(b *testing.B) {
	var x e_nocarry_0625
	x.SetRandom()
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Add(&x, &benchRese_nocarry_0625)
	}
}

func BenchmarkE_nocarry_0625Sub(b *testing.B) {
	var x e_nocarry_0625
	x.SetRandom()
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Sub(&x, &benchRese_nocarry_0625)
	}
}

func BenchmarkE_nocarry_0625Neg(b *testing.B) {
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Neg(&benchRese_nocarry_0625)
	}
}

func BenchmarkE_nocarry_0625Div(b *testing.B) {
	var x e_nocarry_0625
	x.SetRandom()
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Div(&x, &benchRese_nocarry_0625)
	}
}

func BenchmarkE_nocarry_0625FromMont(b *testing.B) {
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.FromMont()
	}
}

func BenchmarkE_nocarry_0625ToMont(b *testing.B) {
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.ToMont()
	}
}
func BenchmarkE_nocarry_0625Square(b *testing.B) {
	benchRese_nocarry_0625.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Square(&benchRese_nocarry_0625)
	}
}

func BenchmarkE_nocarry_0625Sqrt(b *testing.B) {
	var a e_nocarry_0625
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0625Mul(b *testing.B) {
	x := e_nocarry_0625{
		4494601141790886823,
	...
	benchRese_nocarry_0625.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Mul(&benchRese_nocarry_0625, &x)
	}
}

func BenchmarkE_nocarry_0625Cmp(b *testing.B) {
	x := e_nocarry_0625{
		4494601141790886823,
		10391119465101776091,
		2492952674209789398,
	...
	benchRese_nocarry_0625 = x
	benchRese_nocarry_0625[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0625.Cmp(&x)
	}
}

func TestE_nocarry_0625Cmp(t *testing.T) {
	var x, y e_nocarry_0625
...
func TestE_nocarry_0625IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0625
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0625

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0625{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0625
	one.SetOne()
	e.Sub(&qe_nocarry_0625, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0625{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0625{0, uint64(i)})
	}
...
func TestE_nocarry_0625NegZero(t *testing.T) {
	var a, b e_nocarry_0625
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0625Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0625, len(staticTestValues))
...
func TestE_nocarry_0625Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0625) bool {
			var b e_nocarry_0625
...
func TestE_nocarry_0625InverseExp(t *testing.T) {
...
func TestE_nocarry_0625MulByConstants(t *testing.T) {
...
func TestE_nocarry_0625Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0625) bool {
...
func TestE_nocarry_0625LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0625Halve(t *testing.T) {
...
func TestE_nocarry_0625FromMont(t *testing.T) {
...
type testPaire_nocarry_0625 struct {
	element e_nocarry_0625
	bigint  big.Int
}

func (z *e_nocarry_0625) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0625[9] {
		return true
	}
	if z[9] < qe_nocarry_0625[9] {
		return false
	...
	return z[0] >= qe_nocarry_0625[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0625

		g.element = e_nocarry_0625{
		...
		if qe_nocarry_0625[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0625[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0625 {
			var g e_nocarry_0625
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0625[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0625[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0625[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0625[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0625[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0625[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0625[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0625[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0625[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0625[9], carry)
...
func Benchmarke_nocarry_0625InverseNew(b *testing.B) {
	var x e_nocarry_0625
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0625
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0625
		var xInv e_nocarry_0625
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0625
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0625
...
func testLinearComb(t *testing.T, x *e_nocarry_0625, xC int64, y *e_nocarry_0625, yC int64) {
	...
	var z e_nocarry_0625
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0625, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0625
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0625, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0625
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0625, xHi uint64) {
	var res e_nocarry_0625
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0625) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0625) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0625, c int64, result *e_nocarry_0625, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0625) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0625) uint64 {
