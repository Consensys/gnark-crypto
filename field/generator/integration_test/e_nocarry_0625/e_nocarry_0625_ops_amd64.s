...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xa69100e2295284a5, R13
	ADDQ R13, AX
	MOVQ $0xb14e80135597edc5, R13
	ADCQ R13, DX
	MOVQ $0x5cc6d772465d0903, R13
	ADCQ R13, CX
	MOVQ $0x338ef9108f1c3d1d, R13
	ADCQ R13, BX
	MOVQ $0x42ce24cf1b174249, R13
	ADCQ R13, SI
	MOVQ $0x3e5e9e24d09f2381, R13
	ADCQ R13, DI
	MOVQ $0xe4112a0b04521a36, R13
	ADCQ R13, R8
	MOVQ $0x3ccd7043b12aecd9, R13
	ADCQ R13, R9
	MOVQ $0xb1cf43691a0074a8, R13
	ADCQ R13, R10
	MOVQ $0x0001de37c62b0dcc, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xa69100e2295284a5, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xb14e80135597edc5, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x5cc6d772465d0903, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x338ef9108f1c3d1d, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x42ce24cf1b174249, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x3e5e9e24d09f2381, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xe4112a0b04521a36, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x3ccd7043b12aecd9, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xb1cf43691a0074a8, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0001de37c62b0dcc, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xa69100e2295284a5, AX
	ADDQ AX, DX
	MOVQ $0xb14e80135597edc5, AX
	ADCQ AX, CX
	MOVQ $0x5cc6d772465d0903, AX
	ADCQ AX, BX
	MOVQ $0x338ef9108f1c3d1d, AX
	ADCQ AX, SI
	MOVQ $0x42ce24cf1b174249, AX
	ADCQ AX, DI
	MOVQ $0x3e5e9e24d09f2381, AX
	ADCQ AX, R8
	MOVQ $0xe4112a0b04521a36, AX
	ADCQ AX, R9
	MOVQ $0x3ccd7043b12aecd9, AX
	ADCQ AX, R10
	MOVQ $0xb1cf43691a0074a8, AX
	ADCQ AX, R11
	MOVQ $0x0001de37c62b0dcc, AX
	ADCQ AX, R12
