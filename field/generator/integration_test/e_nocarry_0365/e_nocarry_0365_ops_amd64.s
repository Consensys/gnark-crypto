...
// modulus q
DATA q<>+0(SB)/8, $0xebb99381dbdead33
DATA q<>+8(SB)/8, $0x45af5de979571406
DATA q<>+16(SB)/8, $0x6f4a234a05cd8c6d
DATA q<>+24(SB)/8, $0x58572f67ae1ca0ea
DATA q<>+32(SB)/8, $0x5bc19d94d8cf1b64
DATA q<>+40(SB)/8, $0x00001fb417aa801b
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x1e948e4f9052ea05
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xebb99381dbdead33, R10
	MOVQ    $0x45af5de979571406, R11
	MOVQ    $0x6f4a234a05cd8c6d, R12
	MOVQ    $0x58572f67ae1ca0ea, R13
	MOVQ    $0x5bc19d94d8cf1b64, R14
	MOVQ    $0x00001fb417aa801b, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x45af5de979571406, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x6f4a234a05cd8c6d, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x58572f67ae1ca0ea, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x5bc19d94d8cf1b64, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00001fb417aa801b, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xebb99381dbdead33, CX
	MOVQ    $0x45af5de979571406, BX
	MOVQ    $0x6f4a234a05cd8c6d, SI
	MOVQ    $0x58572f67ae1ca0ea, DI
	MOVQ    $0x5bc19d94d8cf1b64, R8
	MOVQ    $0x00001fb417aa801b, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
