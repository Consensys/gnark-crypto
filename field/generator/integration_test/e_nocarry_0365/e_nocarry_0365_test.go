...
var benchRese_nocarry_0365 e_nocarry_0365

func BenchmarkE_nocarry_0365SetBytes(b *testing.B) {
	var x e_nocarry_0365
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0365MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0365.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0365)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0365)
		}
	})
}

func BenchmarkE_nocarry_0365Inverse(b *testing.B) {
	var x e_nocarry_0365
	x.SetRandom()
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0365Butterfly(b *testing.B) {
	var x e_nocarry_0365
	x.SetRandom()
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0365)
	}
}

func BenchmarkE_nocarry_0365Exp(b *testing.B) {
	var x e_nocarry_0365
	x.SetRandom()
	benchRese_nocarry_0365.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0365Double(b *testing.B) {
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Double(&benchRese_nocarry_0365)
	}
}

func BenchmarkE_nocarry_0365Add(b *testing.B) {
	var x e_nocarry_0365
	x.SetRandom()
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Add(&x, &benchRese_nocarry_0365)
	}
}

func BenchmarkE_nocarry_0365Sub(b *testing.B) {
	var x e_nocarry_0365
	x.SetRandom()
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Sub(&x, &benchRese_nocarry_0365)
	}
}

func BenchmarkE_nocarry_0365Neg(b *testing.B) {
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Neg(&benchRese_nocarry_0365)
	}
}

func BenchmarkE_nocarry_0365Div(b *testing.B) {
	var x e_nocarry_0365
	x.SetRandom()
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Div(&x, &benchRese_nocarry_0365)
	}
}

func BenchmarkE_nocarry_0365FromMont(b *testing.B) {
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.FromMont()
	}
}

func BenchmarkE_nocarry_0365ToMont(b *testing.B) {
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.ToMont()
	}
}
func BenchmarkE_nocarry_0365Square(b *testing.B) {
	benchRese_nocarry_0365.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Square(&benchRese_nocarry_0365)
	}
}

func BenchmarkE_nocarry_0365Sqrt(b *testing.B) {
	var a e_nocarry_0365
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0365Mul(b *testing.B) {
	x := e_nocarry_0365{
		8664782835202354459,
	...
	benchRese_nocarry_0365.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Mul(&benchRese_nocarry_0365, &x)
	}
}

func BenchmarkE_nocarry_0365Cmp(b *testing.B) {
	x := e_nocarry_0365{
		8664782835202354459,
		12508757529535043712,
		3465653725879437543,
	...
	benchRese_nocarry_0365 = x
	benchRese_nocarry_0365[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0365.Cmp(&x)
	}
}

func TestE_nocarry_0365Cmp(t *testing.T) {
	var x, y e_nocarry_0365
...
func TestE_nocarry_0365IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0365
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0365

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0365{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0365
	one.SetOne()
	e.Sub(&qe_nocarry_0365, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0365{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0365{0, uint64(i)})
	}
...
func TestE_nocarry_0365NegZero(t *testing.T) {
	var a, b e_nocarry_0365
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0365Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0365, len(staticTestValues))
...
func TestE_nocarry_0365Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0365) bool {
			var b e_nocarry_0365
...
func TestE_nocarry_0365InverseExp(t *testing.T) {
...
func TestE_nocarry_0365MulByConstants(t *testing.T) {
...
func TestE_nocarry_0365Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0365) bool {
...
func TestE_nocarry_0365LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0365Halve(t *testing.T) {
...
func TestE_nocarry_0365FromMont(t *testing.T) {
...
type testPaire_nocarry_0365 struct {
	element e_nocarry_0365
	bigint  big.Int
}

func (z *e_nocarry_0365) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0365[5] {
		return true
	}
	if z[5] < qe_nocarry_0365[5] {
		return false
	...
	return z[0] >= qe_nocarry_0365[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0365

		g.element = e_nocarry_0365{
		...
		if qe_nocarry_0365[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0365[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0365 {
			var g e_nocarry_0365
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0365[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0365[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0365[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0365[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0365[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0365[5], carry)
...
func Benchmarke_nocarry_0365InverseNew(b *testing.B) {
	var x e_nocarry_0365
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0365
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0365
		var xInv e_nocarry_0365
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0365
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0365
...
func testLinearComb(t *testing.T, x *e_nocarry_0365, xC int64, y *e_nocarry_0365, yC int64) {
	...
	var z e_nocarry_0365
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0365, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0365
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0365, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0365
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0365, xHi uint64) {
	var res e_nocarry_0365
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0365) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0365) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0365, c int64, result *e_nocarry_0365, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0365) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0365) uint64 {
