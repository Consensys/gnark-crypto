...
var benchRese_nocarry_0375 e_nocarry_0375

func BenchmarkE_nocarry_0375SetBytes(b *testing.B) {
	var x e_nocarry_0375
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0375MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0375.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0375)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0375)
		}
	})
}

func BenchmarkE_nocarry_0375Inverse(b *testing.B) {
	var x e_nocarry_0375
	x.SetRandom()
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0375Butterfly(b *testing.B) {
	var x e_nocarry_0375
	x.SetRandom()
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0375)
	}
}

func BenchmarkE_nocarry_0375Exp(b *testing.B) {
	var x e_nocarry_0375
	x.SetRandom()
	benchRese_nocarry_0375.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0375Double(b *testing.B) {
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Double(&benchRese_nocarry_0375)
	}
}

func BenchmarkE_nocarry_0375Add(b *testing.B) {
	var x e_nocarry_0375
	x.SetRandom()
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Add(&x, &benchRese_nocarry_0375)
	}
}

func BenchmarkE_nocarry_0375Sub(b *testing.B) {
	var x e_nocarry_0375
	x.SetRandom()
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Sub(&x, &benchRese_nocarry_0375)
	}
}

func BenchmarkE_nocarry_0375Neg(b *testing.B) {
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Neg(&benchRese_nocarry_0375)
	}
}

func BenchmarkE_nocarry_0375Div(b *testing.B) {
	var x e_nocarry_0375
	x.SetRandom()
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Div(&x, &benchRese_nocarry_0375)
	}
}

func BenchmarkE_nocarry_0375FromMont(b *testing.B) {
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.FromMont()
	}
}

func BenchmarkE_nocarry_0375ToMont(b *testing.B) {
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.ToMont()
	}
}
func BenchmarkE_nocarry_0375Square(b *testing.B) {
	benchRese_nocarry_0375.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Square(&benchRese_nocarry_0375)
	}
}

func BenchmarkE_nocarry_0375Sqrt(b *testing.B) {
	var a e_nocarry_0375
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0375Mul(b *testing.B) {
	x := e_nocarry_0375{
		8287876477985481622,
		5980974395222809306,
		4267277123716273614,
	...
	benchRese_nocarry_0375.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Mul(&benchRese_nocarry_0375, &x)
	}
}

func BenchmarkE_nocarry_0375Cmp(b *testing.B) {
	x := e_nocarry_0375{
		8287876477985481622,
		5980974395222809306,
		4267277123716273614,
	...
	benchRese_nocarry_0375 = x
	benchRese_nocarry_0375[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0375.Cmp(&x)
	}
}

func TestE_nocarry_0375Cmp(t *testing.T) {
	var x, y e_nocarry_0375
...
func TestE_nocarry_0375IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0375
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0375

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0375{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0375
	one.SetOne()
	e.Sub(&qe_nocarry_0375, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0375{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0375{0, uint64(i)})
	}
...
func TestE_nocarry_0375NegZero(t *testing.T) {
	var a, b e_nocarry_0375
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0375Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0375, len(staticTestValues))
...
func TestE_nocarry_0375Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0375) bool {
			var b e_nocarry_0375
...
func TestE_nocarry_0375InverseExp(t *testing.T) {
...
func TestE_nocarry_0375MulByConstants(t *testing.T) {
...
func TestE_nocarry_0375Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0375) bool {
...
func TestE_nocarry_0375LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0375Halve(t *testing.T) {
...
func TestE_nocarry_0375FromMont(t *testing.T) {
...
type testPaire_nocarry_0375 struct {
	element e_nocarry_0375
	bigint  big.Int
}

func (z *e_nocarry_0375) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0375[5] {
		return true
	}
	if z[5] < qe_nocarry_0375[5] {
		return false
	...
	return z[0] >= qe_nocarry_0375[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0375

		g.element = e_nocarry_0375{
		...
		if qe_nocarry_0375[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0375[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0375 {
			var g e_nocarry_0375
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0375[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0375[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0375[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0375[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0375[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0375[5], carry)
...
func Benchmarke_nocarry_0375InverseNew(b *testing.B) {
	var x e_nocarry_0375
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0375
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0375
		var xInv e_nocarry_0375
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0375
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0375
...
func testLinearComb(t *testing.T, x *e_nocarry_0375, xC int64, y *e_nocarry_0375, yC int64) {
	...
	var z e_nocarry_0375
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0375, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0375
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0375, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0375
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0375, xHi uint64) {
	var res e_nocarry_0375
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0375) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0375) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0375, c int64, result *e_nocarry_0375, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0375) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0375) uint64 {
