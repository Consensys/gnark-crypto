...
// modulus q
DATA q<>+0(SB)/8, $0x2cfeac6f2e973b8d
DATA q<>+8(SB)/8, $0xed1626ecf9d39f34
DATA q<>+16(SB)/8, $0xe3d3643ace2c7bbd
DATA q<>+24(SB)/8, $0x455fec7a277cde05
DATA q<>+32(SB)/8, $0xca38e31d8bff29b8
DATA q<>+40(SB)/8, $0x006a787cfe869073
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xad8c45c9f00580bb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x2cfeac6f2e973b8d, R10
	MOVQ    $0xed1626ecf9d39f34, R11
	MOVQ    $0xe3d3643ace2c7bbd, R12
	MOVQ    $0x455fec7a277cde05, R13
	MOVQ    $0xca38e31d8bff29b8, R14
	MOVQ    $0x006a787cfe869073, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xed1626ecf9d39f34, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xe3d3643ace2c7bbd, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x455fec7a277cde05, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xca38e31d8bff29b8, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x006a787cfe869073, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x2cfeac6f2e973b8d, CX
	MOVQ    $0xed1626ecf9d39f34, BX
	MOVQ    $0xe3d3643ace2c7bbd, SI
	MOVQ    $0x455fec7a277cde05, DI
	MOVQ    $0xca38e31d8bff29b8, R8
	MOVQ    $0x006a787cfe869073, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
