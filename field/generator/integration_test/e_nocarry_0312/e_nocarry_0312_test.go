...
var benchRese_nocarry_0312 e_nocarry_0312

func BenchmarkE_nocarry_0312SetBytes(b *testing.B) {
	var x e_nocarry_0312
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0312MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0312.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0312)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0312)
		}
	})
}

func BenchmarkE_nocarry_0312Inverse(b *testing.B) {
	var x e_nocarry_0312
	x.SetRandom()
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0312Butterfly(b *testing.B) {
	var x e_nocarry_0312
	x.SetRandom()
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0312)
	}
}

func BenchmarkE_nocarry_0312Exp(b *testing.B) {
	var x e_nocarry_0312
	x.SetRandom()
	benchRese_nocarry_0312.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0312Double(b *testing.B) {
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Double(&benchRese_nocarry_0312)
	}
}

func BenchmarkE_nocarry_0312Add(b *testing.B) {
	var x e_nocarry_0312
	x.SetRandom()
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Add(&x, &benchRese_nocarry_0312)
	}
}

func BenchmarkE_nocarry_0312Sub(b *testing.B) {
	var x e_nocarry_0312
	x.SetRandom()
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Sub(&x, &benchRese_nocarry_0312)
	}
}

func BenchmarkE_nocarry_0312Neg(b *testing.B) {
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Neg(&benchRese_nocarry_0312)
	}
}

func BenchmarkE_nocarry_0312Div(b *testing.B) {
	var x e_nocarry_0312
	x.SetRandom()
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Div(&x, &benchRese_nocarry_0312)
	}
}

func BenchmarkE_nocarry_0312FromMont(b *testing.B) {
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.FromMont()
	}
}

func BenchmarkE_nocarry_0312ToMont(b *testing.B) {
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.ToMont()
	}
}
func BenchmarkE_nocarry_0312Square(b *testing.B) {
	benchRese_nocarry_0312.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Square(&benchRese_nocarry_0312)
	}
}

func BenchmarkE_nocarry_0312Sqrt(b *testing.B) {
	var a e_nocarry_0312
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0312Mul(b *testing.B) {
	x := e_nocarry_0312{
		5101448041624384782,
		7088297506613899706,
	...
	benchRese_nocarry_0312.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Mul(&benchRese_nocarry_0312, &x)
	}
}

func BenchmarkE_nocarry_0312Cmp(b *testing.B) {
	x := e_nocarry_0312{
		5101448041624384782,
		7088297506613899706,
		10550208626788339134,
	...
	benchRese_nocarry_0312 = x
	benchRese_nocarry_0312[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0312.Cmp(&x)
	}
}

func TestE_nocarry_0312Cmp(t *testing.T) {
	var x, y e_nocarry_0312
...
func TestE_nocarry_0312IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0312
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0312

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0312{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0312
	one.SetOne()
	e.Sub(&qe_nocarry_0312, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0312{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0312{0, uint64(i)})
	}
...
func TestE_nocarry_0312NegZero(t *testing.T) {
	var a, b e_nocarry_0312
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0312Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0312, len(staticTestValues))
...
func TestE_nocarry_0312Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0312) bool {
			var b e_nocarry_0312
...
func TestE_nocarry_0312InverseExp(t *testing.T) {
...
func TestE_nocarry_0312MulByConstants(t *testing.T) {
...
func TestE_nocarry_0312Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0312) bool {
...
func TestE_nocarry_0312LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0312Halve(t *testing.T) {
...
func TestE_nocarry_0312FromMont(t *testing.T) {
...
type testPaire_nocarry_0312 struct {
	element e_nocarry_0312
	bigint  big.Int
}

func (z *e_nocarry_0312) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0312[4] {
		return true
	}
	if z[4] < qe_nocarry_0312[4] {
		return false
	...
	return z[0] >= qe_nocarry_0312[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0312

		g.element = e_nocarry_0312{
		...
		if qe_nocarry_0312[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0312[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0312 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0312[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0312[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0312[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0312[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0312[4], carry)
...
func Benchmarke_nocarry_0312InverseNew(b *testing.B) {
	var x e_nocarry_0312
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0312
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0312
		var xInv e_nocarry_0312
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0312
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0312
...
func testLinearComb(t *testing.T, x *e_nocarry_0312, xC int64, y *e_nocarry_0312, yC int64) {
	...
	var z e_nocarry_0312
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0312, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0312
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0312, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0312
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0312, xHi uint64) {
	var res e_nocarry_0312
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0312) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0312) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0312, c int64, result *e_nocarry_0312, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0312) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0312) uint64 {
