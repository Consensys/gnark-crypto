...
// modulus q
DATA q<>+0(SB)/8, $0x01d9470f0080d721
DATA q<>+8(SB)/8, $0xf5aba1bf13606539
DATA q<>+16(SB)/8, $0x7789e747d69e7266
DATA q<>+24(SB)/8, $0x0c62611bf0bb6215
DATA q<>+32(SB)/8, $0x00f4411ab528b02f
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x03ab3ea6df1e931f
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x01d9470f0080d721, R9
	MOVQ    $0xf5aba1bf13606539, R10
	MOVQ    $0x7789e747d69e7266, R11
	MOVQ    $0x0c62611bf0bb6215, R12
	MOVQ    $0x00f4411ab528b02f, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xf5aba1bf13606539, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x7789e747d69e7266, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x0c62611bf0bb6215, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00f4411ab528b02f, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x01d9470f0080d721, CX
	MOVQ    $0xf5aba1bf13606539, BX
	MOVQ    $0x7789e747d69e7266, SI
	MOVQ    $0x0c62611bf0bb6215, DI
	MOVQ    $0x00f4411ab528b02f, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
