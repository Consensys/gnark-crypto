...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xdb18d0262a4267c3, R13
	ADDQ R13, AX
	MOVQ $0xf3c7909b715dc0ad, R13
	ADCQ R13, DX
	MOVQ $0x1940c453797ebd17, R13
	ADCQ R13, CX
	MOVQ $0x3c6bdfc904019522, R13
	ADCQ R13, BX
	MOVQ $0x59ee605729f3d916, R13
	ADCQ R13, SI
	MOVQ $0x25863b7c43e277f1, R13
	ADCQ R13, DI
	MOVQ $0xae3396ab0f99a3be, R13
	ADCQ R13, R8
	MOVQ $0x19242bae42adc803, R13
	ADCQ R13, R9
	MOVQ $0xdb6b372b871ff35a, R13
	ADCQ R13, R10
	MOVQ $0x00075317d898f5a5, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xdb18d0262a4267c3, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xf3c7909b715dc0ad, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x1940c453797ebd17, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x3c6bdfc904019522, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x59ee605729f3d916, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x25863b7c43e277f1, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xae3396ab0f99a3be, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x19242bae42adc803, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xdb6b372b871ff35a, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00075317d898f5a5, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xdb18d0262a4267c3, AX
	ADDQ AX, DX
	MOVQ $0xf3c7909b715dc0ad, AX
	ADCQ AX, CX
	MOVQ $0x1940c453797ebd17, AX
	ADCQ AX, BX
	MOVQ $0x3c6bdfc904019522, AX
	ADCQ AX, SI
	MOVQ $0x59ee605729f3d916, AX
	ADCQ AX, DI
	MOVQ $0x25863b7c43e277f1, AX
	ADCQ AX, R8
	MOVQ $0xae3396ab0f99a3be, AX
	ADCQ AX, R9
	MOVQ $0x19242bae42adc803, AX
	ADCQ AX, R10
	MOVQ $0xdb6b372b871ff35a, AX
	ADCQ AX, R11
	MOVQ $0x00075317d898f5a5, AX
	ADCQ AX, R12
