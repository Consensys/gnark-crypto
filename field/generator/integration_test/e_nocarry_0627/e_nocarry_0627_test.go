...
var benchRese_nocarry_0627 e_nocarry_0627

func BenchmarkE_nocarry_0627SetBytes(b *testing.B) {
	var x e_nocarry_0627
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0627MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0627.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0627)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0627)
		}
	})
}

func BenchmarkE_nocarry_0627Inverse(b *testing.B) {
	var x e_nocarry_0627
	x.SetRandom()
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0627Butterfly(b *testing.B) {
	var x e_nocarry_0627
	x.SetRandom()
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0627)
	}
}

func BenchmarkE_nocarry_0627Exp(b *testing.B) {
	var x e_nocarry_0627
	x.SetRandom()
	benchRese_nocarry_0627.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0627Double(b *testing.B) {
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Double(&benchRese_nocarry_0627)
	}
}

func BenchmarkE_nocarry_0627Add(b *testing.B) {
	var x e_nocarry_0627
	x.SetRandom()
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Add(&x, &benchRese_nocarry_0627)
	}
}

func BenchmarkE_nocarry_0627Sub(b *testing.B) {
	var x e_nocarry_0627
	x.SetRandom()
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Sub(&x, &benchRese_nocarry_0627)
	}
}

func BenchmarkE_nocarry_0627Neg(b *testing.B) {
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Neg(&benchRese_nocarry_0627)
	}
}

func BenchmarkE_nocarry_0627Div(b *testing.B) {
	var x e_nocarry_0627
	x.SetRandom()
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Div(&x, &benchRese_nocarry_0627)
	}
}

func BenchmarkE_nocarry_0627FromMont(b *testing.B) {
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.FromMont()
	}
}

func BenchmarkE_nocarry_0627ToMont(b *testing.B) {
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.ToMont()
	}
}
func BenchmarkE_nocarry_0627Square(b *testing.B) {
	benchRese_nocarry_0627.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Square(&benchRese_nocarry_0627)
	}
}

func BenchmarkE_nocarry_0627Sqrt(b *testing.B) {
	var a e_nocarry_0627
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0627Mul(b *testing.B) {
	x := e_nocarry_0627{
	...
	benchRese_nocarry_0627.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Mul(&benchRese_nocarry_0627, &x)
	}
}

func BenchmarkE_nocarry_0627Cmp(b *testing.B) {
	x := e_nocarry_0627{
		15485367342892222034,
		10793446077146886614,
		16271268906938070887,
	...
	benchRese_nocarry_0627 = x
	benchRese_nocarry_0627[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0627.Cmp(&x)
	}
}

func TestE_nocarry_0627Cmp(t *testing.T) {
	var x, y e_nocarry_0627
...
func TestE_nocarry_0627IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0627
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0627

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0627{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0627
	one.SetOne()
	e.Sub(&qe_nocarry_0627, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0627{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0627{0, uint64(i)})
	}
...
func TestE_nocarry_0627NegZero(t *testing.T) {
	var a, b e_nocarry_0627
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0627Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0627, len(staticTestValues))
...
func TestE_nocarry_0627Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0627) bool {
			var b e_nocarry_0627
...
func TestE_nocarry_0627InverseExp(t *testing.T) {
...
func TestE_nocarry_0627MulByConstants(t *testing.T) {
...
func TestE_nocarry_0627Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0627) bool {
...
func TestE_nocarry_0627LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0627Halve(t *testing.T) {
...
func TestE_nocarry_0627FromMont(t *testing.T) {
...
type testPaire_nocarry_0627 struct {
	element e_nocarry_0627
	bigint  big.Int
}

func (z *e_nocarry_0627) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0627[9] {
		return true
	}
	if z[9] < qe_nocarry_0627[9] {
		return false
	...
	return z[0] >= qe_nocarry_0627[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0627

		g.element = e_nocarry_0627{
		...
		if qe_nocarry_0627[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0627[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0627 {
			var g e_nocarry_0627
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0627[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0627[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0627[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0627[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0627[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0627[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0627[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0627[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0627[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0627[9], carry)
...
func Benchmarke_nocarry_0627InverseNew(b *testing.B) {
	var x e_nocarry_0627
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0627
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0627
		var xInv e_nocarry_0627
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0627
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0627
...
func testLinearComb(t *testing.T, x *e_nocarry_0627, xC int64, y *e_nocarry_0627, yC int64) {
	...
	var z e_nocarry_0627
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0627, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0627
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0627, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0627
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0627, xHi uint64) {
	var res e_nocarry_0627
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0627) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0627) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0627, c int64, result *e_nocarry_0627, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0627) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0627) uint64 {
