...
var benchRese_nocarry_0172 e_nocarry_0172

func BenchmarkE_nocarry_0172SetBytes(b *testing.B) {
	var x e_nocarry_0172
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0172MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0172.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0172)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0172)
		}
	})
}

func BenchmarkE_nocarry_0172Inverse(b *testing.B) {
	var x e_nocarry_0172
	x.SetRandom()
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0172Butterfly(b *testing.B) {
	var x e_nocarry_0172
	x.SetRandom()
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0172)
	}
}

func BenchmarkE_nocarry_0172Exp(b *testing.B) {
	var x e_nocarry_0172
	x.SetRandom()
	benchRese_nocarry_0172.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0172Double(b *testing.B) {
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Double(&benchRese_nocarry_0172)
	}
}

func BenchmarkE_nocarry_0172Add(b *testing.B) {
	var x e_nocarry_0172
	x.SetRandom()
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Add(&x, &benchRese_nocarry_0172)
	}
}

func BenchmarkE_nocarry_0172Sub(b *testing.B) {
	var x e_nocarry_0172
	x.SetRandom()
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Sub(&x, &benchRese_nocarry_0172)
	}
}

func BenchmarkE_nocarry_0172Neg(b *testing.B) {
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Neg(&benchRese_nocarry_0172)
	}
}

func BenchmarkE_nocarry_0172Div(b *testing.B) {
	var x e_nocarry_0172
	x.SetRandom()
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Div(&x, &benchRese_nocarry_0172)
	}
}

func BenchmarkE_nocarry_0172FromMont(b *testing.B) {
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.FromMont()
	}
}

func BenchmarkE_nocarry_0172ToMont(b *testing.B) {
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.ToMont()
	}
}
func BenchmarkE_nocarry_0172Square(b *testing.B) {
	benchRese_nocarry_0172.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Square(&benchRese_nocarry_0172)
	}
}

func BenchmarkE_nocarry_0172Sqrt(b *testing.B) {
	var a e_nocarry_0172
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0172Mul(b *testing.B) {
	x := e_nocarry_0172{
		2439057707196043377,
		8736311207108971067,
		12062005357389,
	}
	benchRese_nocarry_0172.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Mul(&benchRese_nocarry_0172, &x)
	}
}

func BenchmarkE_nocarry_0172Cmp(b *testing.B) {
	x := e_nocarry_0172{
		2439057707196043377,
		8736311207108971067,
		12062005357389,
	}
	benchRese_nocarry_0172 = x
	benchRese_nocarry_0172[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0172.Cmp(&x)
	}
}

func TestE_nocarry_0172Cmp(t *testing.T) {
	var x, y e_nocarry_0172
...
func TestE_nocarry_0172IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0172
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0172

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0172{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0172
	one.SetOne()
	e.Sub(&qe_nocarry_0172, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0172{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0172{0, uint64(i)})
	}
...
func TestE_nocarry_0172NegZero(t *testing.T) {
	var a, b e_nocarry_0172
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0172Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0172, len(staticTestValues))
...
func TestE_nocarry_0172Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0172) bool {
			var b e_nocarry_0172
...
func TestE_nocarry_0172InverseExp(t *testing.T) {
...
func TestE_nocarry_0172MulByConstants(t *testing.T) {
...
func TestE_nocarry_0172Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0172) bool {
...
func TestE_nocarry_0172LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0172Halve(t *testing.T) {
...
func TestE_nocarry_0172FromMont(t *testing.T) {
...
type testPaire_nocarry_0172 struct {
	element e_nocarry_0172
	bigint  big.Int
}

func (z *e_nocarry_0172) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0172[2] {
		return true
	}
	if z[2] < qe_nocarry_0172[2] {
		return false
	...
	return z[0] >= qe_nocarry_0172[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0172

		g.element = e_nocarry_0172{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0172[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0172[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0172 {
			var g e_nocarry_0172
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0172[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0172[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0172[2], carry)
...
func Benchmarke_nocarry_0172InverseNew(b *testing.B) {
	var x e_nocarry_0172
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0172
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0172
		var xInv e_nocarry_0172
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0172
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0172
...
func testLinearComb(t *testing.T, x *e_nocarry_0172, xC int64, y *e_nocarry_0172, yC int64) {
	...
	var z e_nocarry_0172
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0172, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0172
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0172, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0172
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0172, xHi uint64) {
	var res e_nocarry_0172
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0172) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0172) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0172, c int64, result *e_nocarry_0172, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0172) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0172) uint64 {
