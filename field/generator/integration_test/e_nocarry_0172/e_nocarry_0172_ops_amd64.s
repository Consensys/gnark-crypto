...
// modulus q
DATA q<>+0(SB)/8, $0x7f344b58dbba0bdf
DATA q<>+8(SB)/8, $0xac4f4da76057f60f
DATA q<>+16(SB)/8, $0x00000c6181281563
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x1d591c7e06668fe1
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x7f344b58dbba0bdf, DI
	MOVQ    $0xac4f4da76057f60f, R8
	MOVQ    $0x00000c6181281563, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xac4f4da76057f60f, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x00000c6181281563, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x7f344b58dbba0bdf, R10
	MOVQ    $0xac4f4da76057f60f, R11
	MOVQ    $0x00000c6181281563, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
