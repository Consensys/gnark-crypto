...
var benchRese_nocarry_0643 e_nocarry_0643

func BenchmarkE_nocarry_0643SetBytes(b *testing.B) {
	var x e_nocarry_0643
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0643MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0643.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0643)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0643)
		}
	})
}

func BenchmarkE_nocarry_0643Inverse(b *testing.B) {
	var x e_nocarry_0643
	x.SetRandom()
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0643Butterfly(b *testing.B) {
	var x e_nocarry_0643
	x.SetRandom()
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0643)
	}
}

func BenchmarkE_nocarry_0643Exp(b *testing.B) {
	var x e_nocarry_0643
	x.SetRandom()
	benchRese_nocarry_0643.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0643Double(b *testing.B) {
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Double(&benchRese_nocarry_0643)
	}
}

func BenchmarkE_nocarry_0643Add(b *testing.B) {
	var x e_nocarry_0643
	x.SetRandom()
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Add(&x, &benchRese_nocarry_0643)
	}
}

func BenchmarkE_nocarry_0643Sub(b *testing.B) {
	var x e_nocarry_0643
	x.SetRandom()
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Sub(&x, &benchRese_nocarry_0643)
	}
}

func BenchmarkE_nocarry_0643Neg(b *testing.B) {
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Neg(&benchRese_nocarry_0643)
	}
}

func BenchmarkE_nocarry_0643Div(b *testing.B) {
	var x e_nocarry_0643
	x.SetRandom()
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Div(&x, &benchRese_nocarry_0643)
	}
}

func BenchmarkE_nocarry_0643FromMont(b *testing.B) {
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.FromMont()
	}
}

func BenchmarkE_nocarry_0643ToMont(b *testing.B) {
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.ToMont()
	}
}
func BenchmarkE_nocarry_0643Square(b *testing.B) {
	benchRese_nocarry_0643.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Square(&benchRese_nocarry_0643)
	}
}

func BenchmarkE_nocarry_0643Sqrt(b *testing.B) {
	var a e_nocarry_0643
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0643Mul(b *testing.B) {
	x := e_nocarry_0643{
	...
	benchRese_nocarry_0643.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Mul(&benchRese_nocarry_0643, &x)
	}
}

func BenchmarkE_nocarry_0643Cmp(b *testing.B) {
	x := e_nocarry_0643{
		11241929743531580643,
		11689929077141453751,
		15733850807006092178,
	...
	benchRese_nocarry_0643 = x
	benchRese_nocarry_0643[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0643.Cmp(&x)
	}
}

func TestE_nocarry_0643Cmp(t *testing.T) {
	var x, y e_nocarry_0643
...
func TestE_nocarry_0643IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0643
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0643

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0643{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0643
	one.SetOne()
	e.Sub(&qe_nocarry_0643, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0643{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0643{0, uint64(i)})
	}
...
func TestE_nocarry_0643NegZero(t *testing.T) {
	var a, b e_nocarry_0643
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0643Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0643, len(staticTestValues))
...
func TestE_nocarry_0643Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0643) bool {
			var b e_nocarry_0643
...
func TestE_nocarry_0643InverseExp(t *testing.T) {
...
func TestE_nocarry_0643MulByConstants(t *testing.T) {
...
func TestE_nocarry_0643Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0643) bool {
...
func TestE_nocarry_0643LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0643Halve(t *testing.T) {
...
func TestE_nocarry_0643FromMont(t *testing.T) {
...
type testPaire_nocarry_0643 struct {
	element e_nocarry_0643
	bigint  big.Int
}

func (z *e_nocarry_0643) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0643[10] {
		return true
	}
	if z[10] < qe_nocarry_0643[10] {
		return false
	...
	return z[0] >= qe_nocarry_0643[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0643

		g.element = e_nocarry_0643{
		...
		if qe_nocarry_0643[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0643[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0643 {
			var g e_nocarry_0643
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0643[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0643[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0643[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0643[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0643[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0643[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0643[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0643[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0643[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0643[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0643[10], carry)
...
func Benchmarke_nocarry_0643InverseNew(b *testing.B) {
	var x e_nocarry_0643
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0643
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0643
		var xInv e_nocarry_0643
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0643
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0643
...
func testLinearComb(t *testing.T, x *e_nocarry_0643, xC int64, y *e_nocarry_0643, yC int64) {
	...
	var z e_nocarry_0643
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0643, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0643
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0643, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0643
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0643, xHi uint64) {
	var res e_nocarry_0643
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0643) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0643) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0643, c int64, result *e_nocarry_0643, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0643) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0643) uint64 {
