...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xd1888b9d8cc40475, R14
	ADDQ R14, AX
	MOVQ $0xb2a3806f152878b5, R14
	ADCQ R14, DX
	MOVQ $0xfc099ce2f9df36ea, R14
	ADCQ R14, CX
	MOVQ $0x3b66848b0a8bb27a, R14
	ADCQ R14, BX
	MOVQ $0x81053239de7a3757, R14
	ADCQ R14, SI
	MOVQ $0xa55b859e381283ac, R14
	ADCQ R14, DI
	MOVQ $0x57dee21c9143bc5c, R14
	ADCQ R14, R8
	MOVQ $0xdfce27f6a9ce1c19, R14
	ADCQ R14, R9
	MOVQ $0xa49d198ae5e58031, R14
	ADCQ R14, R10
	MOVQ $0xf97c4db206a76319, R14
	ADCQ R14, R11
	MOVQ $0x0000000000000007, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xd1888b9d8cc40475, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xb2a3806f152878b5, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xfc099ce2f9df36ea, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x3b66848b0a8bb27a, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x81053239de7a3757, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xa55b859e381283ac, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x57dee21c9143bc5c, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xdfce27f6a9ce1c19, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xa49d198ae5e58031, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xf97c4db206a76319, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xd1888b9d8cc40475, AX
	ADDQ AX, DX
	MOVQ $0xb2a3806f152878b5, AX
	ADCQ AX, CX
	MOVQ $0xfc099ce2f9df36ea, AX
	ADCQ AX, BX
	MOVQ $0x3b66848b0a8bb27a, AX
	ADCQ AX, SI
	MOVQ $0x81053239de7a3757, AX
	ADCQ AX, DI
	MOVQ $0xa55b859e381283ac, AX
	ADCQ AX, R8
	MOVQ $0x57dee21c9143bc5c, AX
	ADCQ AX, R9
	MOVQ $0xdfce27f6a9ce1c19, AX
	ADCQ AX, R10
	MOVQ $0xa49d198ae5e58031, AX
	ADCQ AX, R11
	MOVQ $0xf97c4db206a76319, AX
	ADCQ AX, R12
	MOVQ $0x0000000000000007, AX
	ADCQ AX, R13
