...
// modulus q
DATA q<>+0(SB)/8, $0x2c5987990c86b727
DATA q<>+8(SB)/8, $0xdbc343a3831a6c9a
DATA q<>+16(SB)/8, $0x0b0c932db7c0bfc4
DATA q<>+24(SB)/8, $0x2163c6782cc35220
DATA q<>+32(SB)/8, $0x0000000000fdca1f
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xc857df8ce4deb769
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x2c5987990c86b727, R9
	MOVQ    $0xdbc343a3831a6c9a, R10
	MOVQ    $0x0b0c932db7c0bfc4, R11
	MOVQ    $0x2163c6782cc35220, R12
	MOVQ    $0x0000000000fdca1f, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xdbc343a3831a6c9a, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x0b0c932db7c0bfc4, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x2163c6782cc35220, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000fdca1f, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x2c5987990c86b727, CX
	MOVQ    $0xdbc343a3831a6c9a, BX
	MOVQ    $0x0b0c932db7c0bfc4, SI
	MOVQ    $0x2163c6782cc35220, DI
	MOVQ    $0x0000000000fdca1f, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
