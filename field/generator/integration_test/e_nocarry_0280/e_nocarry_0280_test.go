...
var benchRese_nocarry_0280 e_nocarry_0280

func BenchmarkE_nocarry_0280SetBytes(b *testing.B) {
	var x e_nocarry_0280
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0280MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0280.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0280)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0280)
		}
	})
}

func BenchmarkE_nocarry_0280Inverse(b *testing.B) {
	var x e_nocarry_0280
	x.SetRandom()
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0280Butterfly(b *testing.B) {
	var x e_nocarry_0280
	x.SetRandom()
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0280)
	}
}

func BenchmarkE_nocarry_0280Exp(b *testing.B) {
	var x e_nocarry_0280
	x.SetRandom()
	benchRese_nocarry_0280.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0280Double(b *testing.B) {
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Double(&benchRese_nocarry_0280)
	}
}

func BenchmarkE_nocarry_0280Add(b *testing.B) {
	var x e_nocarry_0280
	x.SetRandom()
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Add(&x, &benchRese_nocarry_0280)
	}
}

func BenchmarkE_nocarry_0280Sub(b *testing.B) {
	var x e_nocarry_0280
	x.SetRandom()
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Sub(&x, &benchRese_nocarry_0280)
	}
}

func BenchmarkE_nocarry_0280Neg(b *testing.B) {
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Neg(&benchRese_nocarry_0280)
	}
}

func BenchmarkE_nocarry_0280Div(b *testing.B) {
	var x e_nocarry_0280
	x.SetRandom()
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Div(&x, &benchRese_nocarry_0280)
	}
}

func BenchmarkE_nocarry_0280FromMont(b *testing.B) {
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.FromMont()
	}
}

func BenchmarkE_nocarry_0280ToMont(b *testing.B) {
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.ToMont()
	}
}
func BenchmarkE_nocarry_0280Square(b *testing.B) {
	benchRese_nocarry_0280.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Square(&benchRese_nocarry_0280)
	}
}

func BenchmarkE_nocarry_0280Sqrt(b *testing.B) {
	var a e_nocarry_0280
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0280Mul(b *testing.B) {
	x := e_nocarry_0280{
		4821998485047491789,
	...
	benchRese_nocarry_0280.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Mul(&benchRese_nocarry_0280, &x)
	}
}

func BenchmarkE_nocarry_0280Cmp(b *testing.B) {
	x := e_nocarry_0280{
		4821998485047491789,
		14019282903865795517,
		4483424138054791776,
	...
	benchRese_nocarry_0280 = x
	benchRese_nocarry_0280[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0280.Cmp(&x)
	}
}

func TestE_nocarry_0280Cmp(t *testing.T) {
	var x, y e_nocarry_0280
...
func TestE_nocarry_0280IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0280
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0280

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0280{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0280
	one.SetOne()
	e.Sub(&qe_nocarry_0280, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0280{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0280{0, uint64(i)})
	}
...
func TestE_nocarry_0280NegZero(t *testing.T) {
	var a, b e_nocarry_0280
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0280Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0280, len(staticTestValues))
...
func TestE_nocarry_0280Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0280) bool {
			var b e_nocarry_0280
...
func TestE_nocarry_0280InverseExp(t *testing.T) {
...
func TestE_nocarry_0280MulByConstants(t *testing.T) {
...
func TestE_nocarry_0280Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0280) bool {
...
func TestE_nocarry_0280LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0280Halve(t *testing.T) {
...
func TestE_nocarry_0280FromMont(t *testing.T) {
...
type testPaire_nocarry_0280 struct {
	element e_nocarry_0280
	bigint  big.Int
}

func (z *e_nocarry_0280) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0280[4] {
		return true
	}
	if z[4] < qe_nocarry_0280[4] {
		return false
	...
	return z[0] >= qe_nocarry_0280[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0280

		g.element = e_nocarry_0280{
		...
		if qe_nocarry_0280[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0280[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0280 {
			var g e_nocarry_0280
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0280[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0280[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0280[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0280[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0280[4], carry)
...
func Benchmarke_nocarry_0280InverseNew(b *testing.B) {
	var x e_nocarry_0280
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0280
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0280
		var xInv e_nocarry_0280
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0280
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0280
...
func testLinearComb(t *testing.T, x *e_nocarry_0280, xC int64, y *e_nocarry_0280, yC int64) {
	...
	var z e_nocarry_0280
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0280, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0280
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0280, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0280
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0280, xHi uint64) {
	var res e_nocarry_0280
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0280) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0280) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0280, c int64, result *e_nocarry_0280, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0280) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0280) uint64 {
