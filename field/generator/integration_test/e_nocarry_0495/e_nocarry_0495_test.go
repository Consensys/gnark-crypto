...
var benchRese_nocarry_0495 e_nocarry_0495

func BenchmarkE_nocarry_0495SetBytes(b *testing.B) {
	var x e_nocarry_0495
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0495MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0495.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0495)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0495)
		}
	})
}

func BenchmarkE_nocarry_0495Inverse(b *testing.B) {
	var x e_nocarry_0495
	x.SetRandom()
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0495Butterfly(b *testing.B) {
	var x e_nocarry_0495
	x.SetRandom()
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0495)
	}
}

func BenchmarkE_nocarry_0495Exp(b *testing.B) {
	var x e_nocarry_0495
	x.SetRandom()
	benchRese_nocarry_0495.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0495Double(b *testing.B) {
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Double(&benchRese_nocarry_0495)
	}
}

func BenchmarkE_nocarry_0495Add(b *testing.B) {
	var x e_nocarry_0495
	x.SetRandom()
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Add(&x, &benchRese_nocarry_0495)
	}
}

func BenchmarkE_nocarry_0495Sub(b *testing.B) {
	var x e_nocarry_0495
	x.SetRandom()
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Sub(&x, &benchRese_nocarry_0495)
	}
}

func BenchmarkE_nocarry_0495Neg(b *testing.B) {
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Neg(&benchRese_nocarry_0495)
	}
}

func BenchmarkE_nocarry_0495Div(b *testing.B) {
	var x e_nocarry_0495
	x.SetRandom()
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Div(&x, &benchRese_nocarry_0495)
	}
}

func BenchmarkE_nocarry_0495FromMont(b *testing.B) {
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.FromMont()
	}
}

func BenchmarkE_nocarry_0495ToMont(b *testing.B) {
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.ToMont()
	}
}
func BenchmarkE_nocarry_0495Square(b *testing.B) {
	benchRese_nocarry_0495.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Square(&benchRese_nocarry_0495)
	}
}

func BenchmarkE_nocarry_0495Sqrt(b *testing.B) {
	var a e_nocarry_0495
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0495Mul(b *testing.B) {
	x := e_nocarry_0495{
	...
	benchRese_nocarry_0495.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Mul(&benchRese_nocarry_0495, &x)
	}
}

func BenchmarkE_nocarry_0495Cmp(b *testing.B) {
	x := e_nocarry_0495{
		12149442167762016363,
		4792564687845313980,
		16170034134484068003,
	...
	benchRese_nocarry_0495 = x
	benchRese_nocarry_0495[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0495.Cmp(&x)
	}
}

func TestE_nocarry_0495Cmp(t *testing.T) {
	var x, y e_nocarry_0495
...
func TestE_nocarry_0495IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0495
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0495

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0495{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0495
	one.SetOne()
	e.Sub(&qe_nocarry_0495, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0495{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0495{0, uint64(i)})
	}
...
func TestE_nocarry_0495NegZero(t *testing.T) {
	var a, b e_nocarry_0495
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0495Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0495, len(staticTestValues))
...
func TestE_nocarry_0495Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0495) bool {
			var b e_nocarry_0495
...
func TestE_nocarry_0495InverseExp(t *testing.T) {
...
func TestE_nocarry_0495MulByConstants(t *testing.T) {
...
func TestE_nocarry_0495Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0495) bool {
...
func TestE_nocarry_0495LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0495Halve(t *testing.T) {
...
func TestE_nocarry_0495FromMont(t *testing.T) {
...
type testPaire_nocarry_0495 struct {
	element e_nocarry_0495
	bigint  big.Int
}

func (z *e_nocarry_0495) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0495[7] {
		return true
	}
	if z[7] < qe_nocarry_0495[7] {
		return false
	...
	return z[0] >= qe_nocarry_0495[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0495

		g.element = e_nocarry_0495{
		...
		if qe_nocarry_0495[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0495[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0495 {
			var g e_nocarry_0495
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0495[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0495[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0495[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0495[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0495[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0495[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0495[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0495[7], carry)
...
func Benchmarke_nocarry_0495InverseNew(b *testing.B) {
	var x e_nocarry_0495
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0495
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0495
		var xInv e_nocarry_0495
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0495
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0495
...
func testLinearComb(t *testing.T, x *e_nocarry_0495, xC int64, y *e_nocarry_0495, yC int64) {
	...
	var z e_nocarry_0495
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0495, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0495
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0495, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0495
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0495, xHi uint64) {
	var res e_nocarry_0495
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0495) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0495) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0495, c int64, result *e_nocarry_0495, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0495) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0495) uint64 {
