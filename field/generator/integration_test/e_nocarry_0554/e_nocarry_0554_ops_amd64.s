...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x304f0ce8bde66ab7, R12
	ADDQ R12, AX
	MOVQ $0x1d8ac3e6305d76c4, R12
	ADCQ R12, DX
	MOVQ $0x71e1b36b98e9c7b2, R12
	ADCQ R12, CX
	MOVQ $0x5a25c6986267dae5, R12
	ADCQ R12, BX
	MOVQ $0x74286a144a5bc37c, R12
	ADCQ R12, SI
	MOVQ $0xe9499097717911f7, R12
	ADCQ R12, DI
	MOVQ $0x428dec04217fb8c8, R12
	ADCQ R12, R8
	MOVQ $0x1b3fd9e79358967f, R12
	ADCQ R12, R9
	MOVQ $0x0000038e15e3a5b0, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x304f0ce8bde66ab7, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x1d8ac3e6305d76c4, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x71e1b36b98e9c7b2, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x5a25c6986267dae5, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x74286a144a5bc37c, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xe9499097717911f7, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x428dec04217fb8c8, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x1b3fd9e79358967f, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000038e15e3a5b0, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x304f0ce8bde66ab7, AX
	ADDQ AX, DX
	MOVQ $0x1d8ac3e6305d76c4, AX
	ADCQ AX, CX
	MOVQ $0x71e1b36b98e9c7b2, AX
	ADCQ AX, BX
	MOVQ $0x5a25c6986267dae5, AX
	ADCQ AX, SI
	MOVQ $0x74286a144a5bc37c, AX
	ADCQ AX, DI
	MOVQ $0xe9499097717911f7, AX
	ADCQ AX, R8
	MOVQ $0x428dec04217fb8c8, AX
	ADCQ AX, R9
	MOVQ $0x1b3fd9e79358967f, AX
	ADCQ AX, R10
	MOVQ $0x0000038e15e3a5b0, AX
	ADCQ AX, R11
