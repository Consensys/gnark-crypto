...
var benchRese_nocarry_0554 e_nocarry_0554

func BenchmarkE_nocarry_0554SetBytes(b *testing.B) {
	var x e_nocarry_0554
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0554MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0554.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0554)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0554)
		}
	})
}

func BenchmarkE_nocarry_0554Inverse(b *testing.B) {
	var x e_nocarry_0554
	x.SetRandom()
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0554Butterfly(b *testing.B) {
	var x e_nocarry_0554
	x.SetRandom()
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0554)
	}
}

func BenchmarkE_nocarry_0554Exp(b *testing.B) {
	var x e_nocarry_0554
	x.SetRandom()
	benchRese_nocarry_0554.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0554Double(b *testing.B) {
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Double(&benchRese_nocarry_0554)
	}
}

func BenchmarkE_nocarry_0554Add(b *testing.B) {
	var x e_nocarry_0554
	x.SetRandom()
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Add(&x, &benchRese_nocarry_0554)
	}
}

func BenchmarkE_nocarry_0554Sub(b *testing.B) {
	var x e_nocarry_0554
	x.SetRandom()
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Sub(&x, &benchRese_nocarry_0554)
	}
}

func BenchmarkE_nocarry_0554Neg(b *testing.B) {
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Neg(&benchRese_nocarry_0554)
	}
}

func BenchmarkE_nocarry_0554Div(b *testing.B) {
	var x e_nocarry_0554
	x.SetRandom()
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Div(&x, &benchRese_nocarry_0554)
	}
}

func BenchmarkE_nocarry_0554FromMont(b *testing.B) {
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.FromMont()
	}
}

func BenchmarkE_nocarry_0554ToMont(b *testing.B) {
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.ToMont()
	}
}
func BenchmarkE_nocarry_0554Square(b *testing.B) {
	benchRese_nocarry_0554.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Square(&benchRese_nocarry_0554)
	}
}

func BenchmarkE_nocarry_0554Sqrt(b *testing.B) {
	var a e_nocarry_0554
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0554Mul(b *testing.B) {
	x := e_nocarry_0554{
		8675312920275740875,
	...
	benchRese_nocarry_0554.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Mul(&benchRese_nocarry_0554, &x)
	}
}

func BenchmarkE_nocarry_0554Cmp(b *testing.B) {
	x := e_nocarry_0554{
		8675312920275740875,
		11350456201253645981,
		4911443344937982412,
	...
	benchRese_nocarry_0554 = x
	benchRese_nocarry_0554[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0554.Cmp(&x)
	}
}

func TestE_nocarry_0554Cmp(t *testing.T) {
	var x, y e_nocarry_0554
...
func TestE_nocarry_0554IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0554
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0554

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0554{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0554
	one.SetOne()
	e.Sub(&qe_nocarry_0554, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0554{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0554{0, uint64(i)})
	}
...
func TestE_nocarry_0554NegZero(t *testing.T) {
	var a, b e_nocarry_0554
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0554Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0554, len(staticTestValues))
...
func TestE_nocarry_0554Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0554) bool {
			var b e_nocarry_0554
...
func TestE_nocarry_0554InverseExp(t *testing.T) {
...
func TestE_nocarry_0554MulByConstants(t *testing.T) {
...
func TestE_nocarry_0554Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0554) bool {
...
func TestE_nocarry_0554LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0554Halve(t *testing.T) {
...
func TestE_nocarry_0554FromMont(t *testing.T) {
...
type testPaire_nocarry_0554 struct {
	element e_nocarry_0554
	bigint  big.Int
}

func (z *e_nocarry_0554) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0554[8] {
		return true
	}
	if z[8] < qe_nocarry_0554[8] {
		return false
	...
	return z[0] >= qe_nocarry_0554[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0554

		g.element = e_nocarry_0554{
		...
		if qe_nocarry_0554[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0554[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0554 {
			var g e_nocarry_0554
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0554[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0554[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0554[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0554[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0554[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0554[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0554[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0554[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0554[8], carry)
...
func Benchmarke_nocarry_0554InverseNew(b *testing.B) {
	var x e_nocarry_0554
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0554
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0554
		var xInv e_nocarry_0554
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0554
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0554
...
func testLinearComb(t *testing.T, x *e_nocarry_0554, xC int64, y *e_nocarry_0554, yC int64) {
	...
	var z e_nocarry_0554
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0554, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0554
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0554, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0554
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0554, xHi uint64) {
	var res e_nocarry_0554
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0554) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0554) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0554, c int64, result *e_nocarry_0554, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0554) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0554) uint64 {
