...
var benchRese_nocarry_0268 e_nocarry_0268

func BenchmarkE_nocarry_0268SetBytes(b *testing.B) {
	var x e_nocarry_0268
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0268MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0268.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0268)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0268)
		}
	})
}

func BenchmarkE_nocarry_0268Inverse(b *testing.B) {
	var x e_nocarry_0268
	x.SetRandom()
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0268Butterfly(b *testing.B) {
	var x e_nocarry_0268
	x.SetRandom()
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0268)
	}
}

func BenchmarkE_nocarry_0268Exp(b *testing.B) {
	var x e_nocarry_0268
	x.SetRandom()
	benchRese_nocarry_0268.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0268Double(b *testing.B) {
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Double(&benchRese_nocarry_0268)
	}
}

func BenchmarkE_nocarry_0268Add(b *testing.B) {
	var x e_nocarry_0268
	x.SetRandom()
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Add(&x, &benchRese_nocarry_0268)
	}
}

func BenchmarkE_nocarry_0268Sub(b *testing.B) {
	var x e_nocarry_0268
	x.SetRandom()
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Sub(&x, &benchRese_nocarry_0268)
	}
}

func BenchmarkE_nocarry_0268Neg(b *testing.B) {
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Neg(&benchRese_nocarry_0268)
	}
}

func BenchmarkE_nocarry_0268Div(b *testing.B) {
	var x e_nocarry_0268
	x.SetRandom()
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Div(&x, &benchRese_nocarry_0268)
	}
}

func BenchmarkE_nocarry_0268FromMont(b *testing.B) {
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.FromMont()
	}
}

func BenchmarkE_nocarry_0268ToMont(b *testing.B) {
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.ToMont()
	}
}
func BenchmarkE_nocarry_0268Square(b *testing.B) {
	benchRese_nocarry_0268.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Square(&benchRese_nocarry_0268)
	}
}

func BenchmarkE_nocarry_0268Sqrt(b *testing.B) {
	var a e_nocarry_0268
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0268Mul(b *testing.B) {
	x := e_nocarry_0268{
	...
	benchRese_nocarry_0268.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Mul(&benchRese_nocarry_0268, &x)
	}
}

func BenchmarkE_nocarry_0268Cmp(b *testing.B) {
	x := e_nocarry_0268{
		16135339858805713631,
		1016119711350347537,
		14340583322659480886,
	...
	benchRese_nocarry_0268 = x
	benchRese_nocarry_0268[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0268.Cmp(&x)
	}
}

func TestE_nocarry_0268Cmp(t *testing.T) {
	var x, y e_nocarry_0268
...
func TestE_nocarry_0268IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0268
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0268

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0268{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0268
	one.SetOne()
	e.Sub(&qe_nocarry_0268, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0268{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0268{0, uint64(i)})
	}
...
func TestE_nocarry_0268NegZero(t *testing.T) {
	var a, b e_nocarry_0268
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0268Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0268, len(staticTestValues))
...
func TestE_nocarry_0268Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0268) bool {
			var b e_nocarry_0268
...
func TestE_nocarry_0268InverseExp(t *testing.T) {
...
func TestE_nocarry_0268MulByConstants(t *testing.T) {
...
func TestE_nocarry_0268Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0268) bool {
...
func TestE_nocarry_0268LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0268Halve(t *testing.T) {
...
func TestE_nocarry_0268FromMont(t *testing.T) {
...
type testPaire_nocarry_0268 struct {
	element e_nocarry_0268
	bigint  big.Int
}

func (z *e_nocarry_0268) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0268[4] {
		return true
	}
	if z[4] < qe_nocarry_0268[4] {
		return false
	...
	return z[0] >= qe_nocarry_0268[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0268

		g.element = e_nocarry_0268{
		...
		if qe_nocarry_0268[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0268[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0268 {
			var g e_nocarry_0268
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0268[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0268[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0268[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0268[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0268[4], carry)
...
func Benchmarke_nocarry_0268InverseNew(b *testing.B) {
	var x e_nocarry_0268
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0268
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0268
		var xInv e_nocarry_0268
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0268
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0268
...
func testLinearComb(t *testing.T, x *e_nocarry_0268, xC int64, y *e_nocarry_0268, yC int64) {
	...
	var z e_nocarry_0268
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0268, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0268
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0268, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0268
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0268, xHi uint64) {
	var res e_nocarry_0268
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0268) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0268) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0268, c int64, result *e_nocarry_0268, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0268) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0268) uint64 {
