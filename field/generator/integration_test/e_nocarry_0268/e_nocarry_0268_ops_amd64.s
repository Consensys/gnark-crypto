...
// modulus q
DATA q<>+0(SB)/8, $0xf6fc35628755fd43
DATA q<>+8(SB)/8, $0xb8eb90f9c4da92f3
DATA q<>+16(SB)/8, $0xcf35aa302d7a35e4
DATA q<>+24(SB)/8, $0x299244a5bdcdd53d
DATA q<>+32(SB)/8, $0x0000000000000e1b
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x7a015b0207788895
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xf6fc35628755fd43, R9
	MOVQ    $0xb8eb90f9c4da92f3, R10
	MOVQ    $0xcf35aa302d7a35e4, R11
	MOVQ    $0x299244a5bdcdd53d, R12
	MOVQ    $0x0000000000000e1b, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xb8eb90f9c4da92f3, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xcf35aa302d7a35e4, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x299244a5bdcdd53d, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000000e1b, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xf6fc35628755fd43, CX
	MOVQ    $0xb8eb90f9c4da92f3, BX
	MOVQ    $0xcf35aa302d7a35e4, SI
	MOVQ    $0x299244a5bdcdd53d, DI
	MOVQ    $0x0000000000000e1b, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
