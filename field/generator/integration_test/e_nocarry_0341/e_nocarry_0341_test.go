...
var benchRese_nocarry_0341 e_nocarry_0341

func BenchmarkE_nocarry_0341SetBytes(b *testing.B) {
	var x e_nocarry_0341
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0341MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0341.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0341)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0341)
		}
	})
}

func BenchmarkE_nocarry_0341Inverse(b *testing.B) {
	var x e_nocarry_0341
	x.SetRandom()
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0341Butterfly(b *testing.B) {
	var x e_nocarry_0341
	x.SetRandom()
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0341)
	}
}

func BenchmarkE_nocarry_0341Exp(b *testing.B) {
	var x e_nocarry_0341
	x.SetRandom()
	benchRese_nocarry_0341.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0341Double(b *testing.B) {
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Double(&benchRese_nocarry_0341)
	}
}

func BenchmarkE_nocarry_0341Add(b *testing.B) {
	var x e_nocarry_0341
	x.SetRandom()
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Add(&x, &benchRese_nocarry_0341)
	}
}

func BenchmarkE_nocarry_0341Sub(b *testing.B) {
	var x e_nocarry_0341
	x.SetRandom()
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Sub(&x, &benchRese_nocarry_0341)
	}
}

func BenchmarkE_nocarry_0341Neg(b *testing.B) {
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Neg(&benchRese_nocarry_0341)
	}
}

func BenchmarkE_nocarry_0341Div(b *testing.B) {
	var x e_nocarry_0341
	x.SetRandom()
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Div(&x, &benchRese_nocarry_0341)
	}
}

func BenchmarkE_nocarry_0341FromMont(b *testing.B) {
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.FromMont()
	}
}

func BenchmarkE_nocarry_0341ToMont(b *testing.B) {
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.ToMont()
	}
}
func BenchmarkE_nocarry_0341Square(b *testing.B) {
	benchRese_nocarry_0341.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Square(&benchRese_nocarry_0341)
	}
}

func BenchmarkE_nocarry_0341Sqrt(b *testing.B) {
	var a e_nocarry_0341
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0341Mul(b *testing.B) {
	x := e_nocarry_0341{
		7512189702089056574,
	...
	benchRese_nocarry_0341.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Mul(&benchRese_nocarry_0341, &x)
	}
}

func BenchmarkE_nocarry_0341Cmp(b *testing.B) {
	x := e_nocarry_0341{
		7512189702089056574,
		13072070275535450624,
		1278683877098643811,
	...
	benchRese_nocarry_0341 = x
	benchRese_nocarry_0341[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0341.Cmp(&x)
	}
}

func TestE_nocarry_0341Cmp(t *testing.T) {
	var x, y e_nocarry_0341
...
func TestE_nocarry_0341IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0341
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0341

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0341{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0341
	one.SetOne()
	e.Sub(&qe_nocarry_0341, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0341{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0341{0, uint64(i)})
	}
...
func TestE_nocarry_0341NegZero(t *testing.T) {
	var a, b e_nocarry_0341
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0341Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0341, len(staticTestValues))
...
func TestE_nocarry_0341Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0341) bool {
			var b e_nocarry_0341
...
func TestE_nocarry_0341InverseExp(t *testing.T) {
...
func TestE_nocarry_0341MulByConstants(t *testing.T) {
...
func TestE_nocarry_0341Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0341) bool {
...
func TestE_nocarry_0341LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0341Halve(t *testing.T) {
...
func TestE_nocarry_0341FromMont(t *testing.T) {
...
type testPaire_nocarry_0341 struct {
	element e_nocarry_0341
	bigint  big.Int
}

func (z *e_nocarry_0341) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0341[5] {
		return true
	}
	if z[5] < qe_nocarry_0341[5] {
		return false
	...
	return z[0] >= qe_nocarry_0341[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0341

		g.element = e_nocarry_0341{
		...
		if qe_nocarry_0341[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0341[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0341 {
			var g e_nocarry_0341
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0341[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0341[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0341[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0341[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0341[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0341[5], carry)
...
func Benchmarke_nocarry_0341InverseNew(b *testing.B) {
	var x e_nocarry_0341
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0341
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0341
		var xInv e_nocarry_0341
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0341
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0341
...
func testLinearComb(t *testing.T, x *e_nocarry_0341, xC int64, y *e_nocarry_0341, yC int64) {
	...
	var z e_nocarry_0341
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0341, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0341
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0341, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0341
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0341, xHi uint64) {
	var res e_nocarry_0341
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0341) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0341) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0341, c int64, result *e_nocarry_0341, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0341) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0341) uint64 {
