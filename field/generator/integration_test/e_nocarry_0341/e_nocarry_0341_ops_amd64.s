...
// modulus q
DATA q<>+0(SB)/8, $0xcf22e61c09299def
DATA q<>+8(SB)/8, $0x0ef391901d09484f
DATA q<>+16(SB)/8, $0xc54589137841d289
DATA q<>+24(SB)/8, $0xdce7d02d8756febb
DATA q<>+32(SB)/8, $0x3f30073489853df0
DATA q<>+40(SB)/8, $0x0000000000191401
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xad35903c4504cef1
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xcf22e61c09299def, R10
	MOVQ    $0x0ef391901d09484f, R11
	MOVQ    $0xc54589137841d289, R12
	MOVQ    $0xdce7d02d8756febb, R13
	MOVQ    $0x3f30073489853df0, R14
	MOVQ    $0x0000000000191401, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x0ef391901d09484f, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xc54589137841d289, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xdce7d02d8756febb, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x3f30073489853df0, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000000191401, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xcf22e61c09299def, CX
	MOVQ    $0x0ef391901d09484f, BX
	MOVQ    $0xc54589137841d289, SI
	MOVQ    $0xdce7d02d8756febb, DI
	MOVQ    $0x3f30073489853df0, R8
	MOVQ    $0x0000000000191401, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
