...
// modulus q
DATA q<>+0(SB)/8, $0x7af9d3c4db1aed17
DATA q<>+8(SB)/8, $0x7020612e7bde30fb
DATA q<>+16(SB)/8, $0xffe78494a8a33cfa
DATA q<>+24(SB)/8, $0x38dbd86605d4f802
DATA q<>+32(SB)/8, $0x0000000f73e08832
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xc171ce4213a2e559
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x7af9d3c4db1aed17, R9
	MOVQ    $0x7020612e7bde30fb, R10
	MOVQ    $0xffe78494a8a33cfa, R11
	MOVQ    $0x38dbd86605d4f802, R12
	MOVQ    $0x0000000f73e08832, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x7020612e7bde30fb, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xffe78494a8a33cfa, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x38dbd86605d4f802, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000f73e08832, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x7af9d3c4db1aed17, CX
	MOVQ    $0x7020612e7bde30fb, BX
	MOVQ    $0xffe78494a8a33cfa, SI
	MOVQ    $0x38dbd86605d4f802, DI
	MOVQ    $0x0000000f73e08832, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
