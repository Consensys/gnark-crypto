...
var benchRese_nocarry_0292 e_nocarry_0292

func BenchmarkE_nocarry_0292SetBytes(b *testing.B) {
	var x e_nocarry_0292
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0292MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0292.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0292)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0292)
		}
	})
}

func BenchmarkE_nocarry_0292Inverse(b *testing.B) {
	var x e_nocarry_0292
	x.SetRandom()
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0292Butterfly(b *testing.B) {
	var x e_nocarry_0292
	x.SetRandom()
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0292)
	}
}

func BenchmarkE_nocarry_0292Exp(b *testing.B) {
	var x e_nocarry_0292
	x.SetRandom()
	benchRese_nocarry_0292.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0292Double(b *testing.B) {
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Double(&benchRese_nocarry_0292)
	}
}

func BenchmarkE_nocarry_0292Add(b *testing.B) {
	var x e_nocarry_0292
	x.SetRandom()
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Add(&x, &benchRese_nocarry_0292)
	}
}

func BenchmarkE_nocarry_0292Sub(b *testing.B) {
	var x e_nocarry_0292
	x.SetRandom()
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Sub(&x, &benchRese_nocarry_0292)
	}
}

func BenchmarkE_nocarry_0292Neg(b *testing.B) {
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Neg(&benchRese_nocarry_0292)
	}
}

func BenchmarkE_nocarry_0292Div(b *testing.B) {
	var x e_nocarry_0292
	x.SetRandom()
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Div(&x, &benchRese_nocarry_0292)
	}
}

func BenchmarkE_nocarry_0292FromMont(b *testing.B) {
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.FromMont()
	}
}

func BenchmarkE_nocarry_0292ToMont(b *testing.B) {
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.ToMont()
	}
}
func BenchmarkE_nocarry_0292Square(b *testing.B) {
	benchRese_nocarry_0292.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Square(&benchRese_nocarry_0292)
	}
}

func BenchmarkE_nocarry_0292Sqrt(b *testing.B) {
	var a e_nocarry_0292
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0292Mul(b *testing.B) {
	x := e_nocarry_0292{
	...
	benchRese_nocarry_0292.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Mul(&benchRese_nocarry_0292, &x)
	}
}

func BenchmarkE_nocarry_0292Cmp(b *testing.B) {
	x := e_nocarry_0292{
		12951036176300805935,
		8703510296503478933,
		8832513204726479570,
	...
	benchRese_nocarry_0292 = x
	benchRese_nocarry_0292[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0292.Cmp(&x)
	}
}

func TestE_nocarry_0292Cmp(t *testing.T) {
	var x, y e_nocarry_0292
...
func TestE_nocarry_0292IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0292
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0292

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0292{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0292
	one.SetOne()
	e.Sub(&qe_nocarry_0292, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0292{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0292{0, uint64(i)})
	}
...
func TestE_nocarry_0292NegZero(t *testing.T) {
	var a, b e_nocarry_0292
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0292Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0292, len(staticTestValues))
...
func TestE_nocarry_0292Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0292) bool {
			var b e_nocarry_0292
...
func TestE_nocarry_0292InverseExp(t *testing.T) {
...
func TestE_nocarry_0292MulByConstants(t *testing.T) {
...
func TestE_nocarry_0292Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0292) bool {
...
func TestE_nocarry_0292LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0292Halve(t *testing.T) {
...
func TestE_nocarry_0292FromMont(t *testing.T) {
...
type testPaire_nocarry_0292 struct {
	element e_nocarry_0292
	bigint  big.Int
}

func (z *e_nocarry_0292) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0292[4] {
		return true
	}
	if z[4] < qe_nocarry_0292[4] {
		return false
	...
	return z[0] >= qe_nocarry_0292[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0292

		g.element = e_nocarry_0292{
		...
		if qe_nocarry_0292[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0292[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0292 {
			var g e_nocarry_0292
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0292[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0292[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0292[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0292[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0292[4], carry)
...
func Benchmarke_nocarry_0292InverseNew(b *testing.B) {
	var x e_nocarry_0292
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0292
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0292
		var xInv e_nocarry_0292
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0292
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0292
...
func testLinearComb(t *testing.T, x *e_nocarry_0292, xC int64, y *e_nocarry_0292, yC int64) {
	...
	var z e_nocarry_0292
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0292, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0292
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0292, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0292
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0292, xHi uint64) {
	var res e_nocarry_0292
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0292) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0292) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0292, c int64, result *e_nocarry_0292, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0292) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0292) uint64 {
