...
var benchRese_nocarry_0165 e_nocarry_0165

func BenchmarkE_nocarry_0165SetBytes(b *testing.B) {
	var x e_nocarry_0165
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0165MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0165.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0165)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0165)
		}
	})
}

func BenchmarkE_nocarry_0165Inverse(b *testing.B) {
	var x e_nocarry_0165
	x.SetRandom()
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0165Butterfly(b *testing.B) {
	var x e_nocarry_0165
	x.SetRandom()
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0165)
	}
}

func BenchmarkE_nocarry_0165Exp(b *testing.B) {
	var x e_nocarry_0165
	x.SetRandom()
	benchRese_nocarry_0165.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0165Double(b *testing.B) {
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Double(&benchRese_nocarry_0165)
	}
}

func BenchmarkE_nocarry_0165Add(b *testing.B) {
	var x e_nocarry_0165
	x.SetRandom()
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Add(&x, &benchRese_nocarry_0165)
	}
}

func BenchmarkE_nocarry_0165Sub(b *testing.B) {
	var x e_nocarry_0165
	x.SetRandom()
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Sub(&x, &benchRese_nocarry_0165)
	}
}

func BenchmarkE_nocarry_0165Neg(b *testing.B) {
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Neg(&benchRese_nocarry_0165)
	}
}

func BenchmarkE_nocarry_0165Div(b *testing.B) {
	var x e_nocarry_0165
	x.SetRandom()
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Div(&x, &benchRese_nocarry_0165)
	}
}

func BenchmarkE_nocarry_0165FromMont(b *testing.B) {
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.FromMont()
	}
}

func BenchmarkE_nocarry_0165ToMont(b *testing.B) {
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.ToMont()
	}
}
func BenchmarkE_nocarry_0165Square(b *testing.B) {
	benchRese_nocarry_0165.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Square(&benchRese_nocarry_0165)
	}
}

func BenchmarkE_nocarry_0165Sqrt(b *testing.B) {
	var a e_nocarry_0165
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0165Mul(b *testing.B) {
	x := e_nocarry_0165{
		4373549245068946464,
		8820187403954588340,
		84044268468,
	}
	benchRese_nocarry_0165.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Mul(&benchRese_nocarry_0165, &x)
	}
}

func BenchmarkE_nocarry_0165Cmp(b *testing.B) {
	x := e_nocarry_0165{
		4373549245068946464,
		8820187403954588340,
		84044268468,
	}
	benchRese_nocarry_0165 = x
	benchRese_nocarry_0165[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0165.Cmp(&x)
	}
}

func TestE_nocarry_0165Cmp(t *testing.T) {
	var x, y e_nocarry_0165
...
func TestE_nocarry_0165IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0165
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0165

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0165{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0165
	one.SetOne()
	e.Sub(&qe_nocarry_0165, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0165{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0165{0, uint64(i)})
	}
...
func TestE_nocarry_0165NegZero(t *testing.T) {
	var a, b e_nocarry_0165
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0165Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0165, len(staticTestValues))
...
func TestE_nocarry_0165Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0165) bool {
			var b e_nocarry_0165
...
func TestE_nocarry_0165InverseExp(t *testing.T) {
...
func TestE_nocarry_0165MulByConstants(t *testing.T) {
...
func TestE_nocarry_0165Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0165) bool {
...
func TestE_nocarry_0165LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0165Halve(t *testing.T) {
...
func TestE_nocarry_0165FromMont(t *testing.T) {
...
type testPaire_nocarry_0165 struct {
	element e_nocarry_0165
	bigint  big.Int
}

func (z *e_nocarry_0165) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0165[2] {
		return true
	}
	if z[2] < qe_nocarry_0165[2] {
		return false
	...
	return z[0] >= qe_nocarry_0165[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0165

		g.element = e_nocarry_0165{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0165[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0165[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0165 {
			var g e_nocarry_0165
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0165[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0165[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0165[2], carry)
...
func Benchmarke_nocarry_0165InverseNew(b *testing.B) {
	var x e_nocarry_0165
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0165
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0165
		var xInv e_nocarry_0165
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0165
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0165
...
func testLinearComb(t *testing.T, x *e_nocarry_0165, xC int64, y *e_nocarry_0165, yC int64) {
	...
	var z e_nocarry_0165
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0165, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0165
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0165, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0165
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0165, xHi uint64) {
	var res e_nocarry_0165
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0165) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0165) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0165, c int64, result *e_nocarry_0165, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0165) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0165) uint64 {
