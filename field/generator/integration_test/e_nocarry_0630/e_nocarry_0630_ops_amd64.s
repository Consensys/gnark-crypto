...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xdb4159aefccdb3c7, R13
	ADDQ R13, AX
	MOVQ $0x507afeb81bb72182, R13
	ADCQ R13, DX
	MOVQ $0x7e39af4d0ce51103, R13
	ADCQ R13, CX
	MOVQ $0x61fa9074d3b7a8a8, R13
	ADCQ R13, BX
	MOVQ $0xeb5eeb2922eb3bcc, R13
	ADCQ R13, SI
	MOVQ $0x9adb792955586504, R13
	ADCQ R13, DI
	MOVQ $0xbb49d45f667cfb73, R13
	ADCQ R13, R8
	MOVQ $0x13f6f31778677a2a, R13
	ADCQ R13, R9
	MOVQ $0x943737b1e735cf0b, R13
	ADCQ R13, R10
	MOVQ $0x003cd08fa585828e, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xdb4159aefccdb3c7, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x507afeb81bb72182, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x7e39af4d0ce51103, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x61fa9074d3b7a8a8, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xeb5eeb2922eb3bcc, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x9adb792955586504, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xbb49d45f667cfb73, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x13f6f31778677a2a, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x943737b1e735cf0b, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x003cd08fa585828e, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xdb4159aefccdb3c7, AX
	ADDQ AX, DX
	MOVQ $0x507afeb81bb72182, AX
	ADCQ AX, CX
	MOVQ $0x7e39af4d0ce51103, AX
	ADCQ AX, BX
	MOVQ $0x61fa9074d3b7a8a8, AX
	ADCQ AX, SI
	MOVQ $0xeb5eeb2922eb3bcc, AX
	ADCQ AX, DI
	MOVQ $0x9adb792955586504, AX
	ADCQ AX, R8
	MOVQ $0xbb49d45f667cfb73, AX
	ADCQ AX, R9
	MOVQ $0x13f6f31778677a2a, AX
	ADCQ AX, R10
	MOVQ $0x943737b1e735cf0b, AX
	ADCQ AX, R11
	MOVQ $0x003cd08fa585828e, AX
	ADCQ AX, R12
