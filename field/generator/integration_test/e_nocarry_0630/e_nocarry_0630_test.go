...
var benchRese_nocarry_0630 e_nocarry_0630

func BenchmarkE_nocarry_0630SetBytes(b *testing.B) {
	var x e_nocarry_0630
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0630MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0630.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0630)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0630)
		}
	})
}

func BenchmarkE_nocarry_0630Inverse(b *testing.B) {
	var x e_nocarry_0630
	x.SetRandom()
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0630Butterfly(b *testing.B) {
	var x e_nocarry_0630
	x.SetRandom()
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0630)
	}
}

func BenchmarkE_nocarry_0630Exp(b *testing.B) {
	var x e_nocarry_0630
	x.SetRandom()
	benchRese_nocarry_0630.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0630Double(b *testing.B) {
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Double(&benchRese_nocarry_0630)
	}
}

func BenchmarkE_nocarry_0630Add(b *testing.B) {
	var x e_nocarry_0630
	x.SetRandom()
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Add(&x, &benchRese_nocarry_0630)
	}
}

func BenchmarkE_nocarry_0630Sub(b *testing.B) {
	var x e_nocarry_0630
	x.SetRandom()
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Sub(&x, &benchRese_nocarry_0630)
	}
}

func BenchmarkE_nocarry_0630Neg(b *testing.B) {
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Neg(&benchRese_nocarry_0630)
	}
}

func BenchmarkE_nocarry_0630Div(b *testing.B) {
	var x e_nocarry_0630
	x.SetRandom()
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Div(&x, &benchRese_nocarry_0630)
	}
}

func BenchmarkE_nocarry_0630FromMont(b *testing.B) {
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.FromMont()
	}
}

func BenchmarkE_nocarry_0630ToMont(b *testing.B) {
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.ToMont()
	}
}
func BenchmarkE_nocarry_0630Square(b *testing.B) {
	benchRese_nocarry_0630.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Square(&benchRese_nocarry_0630)
	}
}

func BenchmarkE_nocarry_0630Sqrt(b *testing.B) {
	var a e_nocarry_0630
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0630Mul(b *testing.B) {
	x := e_nocarry_0630{
		1815775390887782724,
		3475709867702934941,
	...
	benchRese_nocarry_0630.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Mul(&benchRese_nocarry_0630, &x)
	}
}

func BenchmarkE_nocarry_0630Cmp(b *testing.B) {
	x := e_nocarry_0630{
		1815775390887782724,
		3475709867702934941,
		16089204657270107383,
	...
	benchRese_nocarry_0630 = x
	benchRese_nocarry_0630[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0630.Cmp(&x)
	}
}

func TestE_nocarry_0630Cmp(t *testing.T) {
	var x, y e_nocarry_0630
...
func TestE_nocarry_0630IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0630
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0630

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0630{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0630
	one.SetOne()
	e.Sub(&qe_nocarry_0630, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0630{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0630{0, uint64(i)})
	}
...
func TestE_nocarry_0630NegZero(t *testing.T) {
	var a, b e_nocarry_0630
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0630Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0630, len(staticTestValues))
...
func TestE_nocarry_0630Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0630) bool {
			var b e_nocarry_0630
...
func TestE_nocarry_0630InverseExp(t *testing.T) {
...
func TestE_nocarry_0630MulByConstants(t *testing.T) {
...
func TestE_nocarry_0630Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0630) bool {
...
func TestE_nocarry_0630LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0630Halve(t *testing.T) {
...
func TestE_nocarry_0630FromMont(t *testing.T) {
...
type testPaire_nocarry_0630 struct {
	element e_nocarry_0630
	bigint  big.Int
}

func (z *e_nocarry_0630) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0630[9] {
		return true
	}
	if z[9] < qe_nocarry_0630[9] {
		return false
	...
	return z[0] >= qe_nocarry_0630[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0630

		g.element = e_nocarry_0630{
		...
		if qe_nocarry_0630[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0630[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0630 {
			var g e_nocarry_0630
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0630[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0630[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0630[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0630[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0630[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0630[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0630[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0630[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0630[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0630[9], carry)
...
func Benchmarke_nocarry_0630InverseNew(b *testing.B) {
	var x e_nocarry_0630
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0630
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0630
		var xInv e_nocarry_0630
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0630
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0630
...
func testLinearComb(t *testing.T, x *e_nocarry_0630, xC int64, y *e_nocarry_0630, yC int64) {
	...
	var z e_nocarry_0630
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0630, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0630
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0630, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0630
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0630, xHi uint64) {
	var res e_nocarry_0630
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0630) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0630) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0630, c int64, result *e_nocarry_0630, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0630) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0630) uint64 {
