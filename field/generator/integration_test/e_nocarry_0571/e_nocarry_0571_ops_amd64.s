...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x262482c9cb8dacc7, R12
	ADDQ R12, AX
	MOVQ $0x4617f8eafe5fe75e, R12
	ADCQ R12, DX
	MOVQ $0x524c1c132c010ba7, R12
	ADCQ R12, CX
	MOVQ $0x8494e62c59de55cd, R12
	ADCQ R12, BX
	MOVQ $0x9fb34b9b631c96ab, R12
	ADCQ R12, SI
	MOVQ $0xa52962fa5be9a428, R12
	ADCQ R12, DI
	MOVQ $0x259d53db38da82b0, R12
	ADCQ R12, R8
	MOVQ $0xf1408539b0ce4e79, R12
	ADCQ R12, R9
	MOVQ $0x0612d2741fb5f160, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x262482c9cb8dacc7, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x4617f8eafe5fe75e, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x524c1c132c010ba7, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x8494e62c59de55cd, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x9fb34b9b631c96ab, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xa52962fa5be9a428, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x259d53db38da82b0, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xf1408539b0ce4e79, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0612d2741fb5f160, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x262482c9cb8dacc7, AX
	ADDQ AX, DX
	MOVQ $0x4617f8eafe5fe75e, AX
	ADCQ AX, CX
	MOVQ $0x524c1c132c010ba7, AX
	ADCQ AX, BX
	MOVQ $0x8494e62c59de55cd, AX
	ADCQ AX, SI
	MOVQ $0x9fb34b9b631c96ab, AX
	ADCQ AX, DI
	MOVQ $0xa52962fa5be9a428, AX
	ADCQ AX, R8
	MOVQ $0x259d53db38da82b0, AX
	ADCQ AX, R9
	MOVQ $0xf1408539b0ce4e79, AX
	ADCQ AX, R10
	MOVQ $0x0612d2741fb5f160, AX
	ADCQ AX, R11
