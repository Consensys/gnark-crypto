...
var benchRese_nocarry_0571 e_nocarry_0571

func BenchmarkE_nocarry_0571SetBytes(b *testing.B) {
	var x e_nocarry_0571
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0571MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0571.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0571)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0571)
		}
	})
}

func BenchmarkE_nocarry_0571Inverse(b *testing.B) {
	var x e_nocarry_0571
	x.SetRandom()
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0571Butterfly(b *testing.B) {
	var x e_nocarry_0571
	x.SetRandom()
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0571)
	}
}

func BenchmarkE_nocarry_0571Exp(b *testing.B) {
	var x e_nocarry_0571
	x.SetRandom()
	benchRese_nocarry_0571.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0571Double(b *testing.B) {
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Double(&benchRese_nocarry_0571)
	}
}

func BenchmarkE_nocarry_0571Add(b *testing.B) {
	var x e_nocarry_0571
	x.SetRandom()
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Add(&x, &benchRese_nocarry_0571)
	}
}

func BenchmarkE_nocarry_0571Sub(b *testing.B) {
	var x e_nocarry_0571
	x.SetRandom()
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Sub(&x, &benchRese_nocarry_0571)
	}
}

func BenchmarkE_nocarry_0571Neg(b *testing.B) {
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Neg(&benchRese_nocarry_0571)
	}
}

func BenchmarkE_nocarry_0571Div(b *testing.B) {
	var x e_nocarry_0571
	x.SetRandom()
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Div(&x, &benchRese_nocarry_0571)
	}
}

func BenchmarkE_nocarry_0571FromMont(b *testing.B) {
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.FromMont()
	}
}

func BenchmarkE_nocarry_0571ToMont(b *testing.B) {
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.ToMont()
	}
}
func BenchmarkE_nocarry_0571Square(b *testing.B) {
	benchRese_nocarry_0571.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Square(&benchRese_nocarry_0571)
	}
}

func BenchmarkE_nocarry_0571Sqrt(b *testing.B) {
	var a e_nocarry_0571
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0571Mul(b *testing.B) {
	x := e_nocarry_0571{
		9345359306555675436,
		3979119958498745812,
	...
	benchRese_nocarry_0571.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Mul(&benchRese_nocarry_0571, &x)
	}
}

func BenchmarkE_nocarry_0571Cmp(b *testing.B) {
	x := e_nocarry_0571{
		9345359306555675436,
		3979119958498745812,
		11278798557328919527,
	...
	benchRese_nocarry_0571 = x
	benchRese_nocarry_0571[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0571.Cmp(&x)
	}
}

func TestE_nocarry_0571Cmp(t *testing.T) {
	var x, y e_nocarry_0571
...
func TestE_nocarry_0571IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0571
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0571

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0571{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0571
	one.SetOne()
	e.Sub(&qe_nocarry_0571, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0571{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0571{0, uint64(i)})
	}
...
func TestE_nocarry_0571NegZero(t *testing.T) {
	var a, b e_nocarry_0571
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0571Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0571, len(staticTestValues))
...
func TestE_nocarry_0571Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0571) bool {
			var b e_nocarry_0571
...
func TestE_nocarry_0571InverseExp(t *testing.T) {
...
func TestE_nocarry_0571MulByConstants(t *testing.T) {
...
func TestE_nocarry_0571Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0571) bool {
...
func TestE_nocarry_0571LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0571Halve(t *testing.T) {
...
func TestE_nocarry_0571FromMont(t *testing.T) {
...
type testPaire_nocarry_0571 struct {
	element e_nocarry_0571
	bigint  big.Int
}

func (z *e_nocarry_0571) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0571[8] {
		return true
	}
	if z[8] < qe_nocarry_0571[8] {
		return false
	...
	return z[0] >= qe_nocarry_0571[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0571

		g.element = e_nocarry_0571{
		...
		if qe_nocarry_0571[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0571[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0571 {
			var g e_nocarry_0571
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0571[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0571[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0571[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0571[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0571[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0571[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0571[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0571[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0571[8], carry)
...
func Benchmarke_nocarry_0571InverseNew(b *testing.B) {
	var x e_nocarry_0571
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0571
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0571
		var xInv e_nocarry_0571
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0571
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0571
...
func testLinearComb(t *testing.T, x *e_nocarry_0571, xC int64, y *e_nocarry_0571, yC int64) {
	...
	var z e_nocarry_0571
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0571, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0571
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0571, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0571
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0571, xHi uint64) {
	var res e_nocarry_0571
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0571) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0571) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0571, c int64, result *e_nocarry_0571, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0571) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0571) uint64 {
