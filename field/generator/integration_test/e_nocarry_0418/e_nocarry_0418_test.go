...
var benchRese_nocarry_0418 e_nocarry_0418

func BenchmarkE_nocarry_0418SetBytes(b *testing.B) {
	var x e_nocarry_0418
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0418MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0418.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0418)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0418)
		}
	})
}

func BenchmarkE_nocarry_0418Inverse(b *testing.B) {
	var x e_nocarry_0418
	x.SetRandom()
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0418Butterfly(b *testing.B) {
	var x e_nocarry_0418
	x.SetRandom()
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0418)
	}
}

func BenchmarkE_nocarry_0418Exp(b *testing.B) {
	var x e_nocarry_0418
	x.SetRandom()
	benchRese_nocarry_0418.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0418Double(b *testing.B) {
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Double(&benchRese_nocarry_0418)
	}
}

func BenchmarkE_nocarry_0418Add(b *testing.B) {
	var x e_nocarry_0418
	x.SetRandom()
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Add(&x, &benchRese_nocarry_0418)
	}
}

func BenchmarkE_nocarry_0418Sub(b *testing.B) {
	var x e_nocarry_0418
	x.SetRandom()
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Sub(&x, &benchRese_nocarry_0418)
	}
}

func BenchmarkE_nocarry_0418Neg(b *testing.B) {
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Neg(&benchRese_nocarry_0418)
	}
}

func BenchmarkE_nocarry_0418Div(b *testing.B) {
	var x e_nocarry_0418
	x.SetRandom()
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Div(&x, &benchRese_nocarry_0418)
	}
}

func BenchmarkE_nocarry_0418FromMont(b *testing.B) {
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.FromMont()
	}
}

func BenchmarkE_nocarry_0418ToMont(b *testing.B) {
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.ToMont()
	}
}
func BenchmarkE_nocarry_0418Square(b *testing.B) {
	benchRese_nocarry_0418.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Square(&benchRese_nocarry_0418)
	}
}

func BenchmarkE_nocarry_0418Sqrt(b *testing.B) {
	var a e_nocarry_0418
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0418Mul(b *testing.B) {
	x := e_nocarry_0418{
	...
	benchRese_nocarry_0418.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Mul(&benchRese_nocarry_0418, &x)
	}
}

func BenchmarkE_nocarry_0418Cmp(b *testing.B) {
	x := e_nocarry_0418{
		18428320088635814933,
		9319493864988264877,
		10415011172682176452,
	...
	benchRese_nocarry_0418 = x
	benchRese_nocarry_0418[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0418.Cmp(&x)
	}
}

func TestE_nocarry_0418Cmp(t *testing.T) {
	var x, y e_nocarry_0418
...
func TestE_nocarry_0418IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0418
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0418

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0418{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0418
	one.SetOne()
	e.Sub(&qe_nocarry_0418, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0418{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0418{0, uint64(i)})
	}
...
func TestE_nocarry_0418NegZero(t *testing.T) {
	var a, b e_nocarry_0418
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0418Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0418, len(staticTestValues))
...
func TestE_nocarry_0418Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0418) bool {
			var b e_nocarry_0418
...
func TestE_nocarry_0418InverseExp(t *testing.T) {
...
func TestE_nocarry_0418MulByConstants(t *testing.T) {
...
func TestE_nocarry_0418Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0418) bool {
...
func TestE_nocarry_0418LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0418Halve(t *testing.T) {
...
func TestE_nocarry_0418FromMont(t *testing.T) {
...
type testPaire_nocarry_0418 struct {
	element e_nocarry_0418
	bigint  big.Int
}

func (z *e_nocarry_0418) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0418[6] {
		return true
	}
	if z[6] < qe_nocarry_0418[6] {
		return false
	...
	return z[0] >= qe_nocarry_0418[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0418

		g.element = e_nocarry_0418{
		...
		if qe_nocarry_0418[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0418[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0418 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0418[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0418[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0418[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0418[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0418[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0418[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0418[6], carry)
...
func Benchmarke_nocarry_0418InverseNew(b *testing.B) {
	var x e_nocarry_0418
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0418
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0418
		var xInv e_nocarry_0418
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0418
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0418
...
func testLinearComb(t *testing.T, x *e_nocarry_0418, xC int64, y *e_nocarry_0418, yC int64) {
	...
	var z e_nocarry_0418
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0418, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0418
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0418, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0418
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0418, xHi uint64) {
	var res e_nocarry_0418
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0418) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0418) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0418, c int64, result *e_nocarry_0418, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0418) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0418) uint64 {
