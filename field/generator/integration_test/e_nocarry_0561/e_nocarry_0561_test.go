...
var benchRese_nocarry_0561 e_nocarry_0561

func BenchmarkE_nocarry_0561SetBytes(b *testing.B) {
	var x e_nocarry_0561
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0561MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0561.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0561)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0561)
		}
	})
}

func BenchmarkE_nocarry_0561Inverse(b *testing.B) {
	var x e_nocarry_0561
	x.SetRandom()
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0561Butterfly(b *testing.B) {
	var x e_nocarry_0561
	x.SetRandom()
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0561)
	}
}

func BenchmarkE_nocarry_0561Exp(b *testing.B) {
	var x e_nocarry_0561
	x.SetRandom()
	benchRese_nocarry_0561.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0561Double(b *testing.B) {
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Double(&benchRese_nocarry_0561)
	}
}

func BenchmarkE_nocarry_0561Add(b *testing.B) {
	var x e_nocarry_0561
	x.SetRandom()
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Add(&x, &benchRese_nocarry_0561)
	}
}

func BenchmarkE_nocarry_0561Sub(b *testing.B) {
	var x e_nocarry_0561
	x.SetRandom()
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Sub(&x, &benchRese_nocarry_0561)
	}
}

func BenchmarkE_nocarry_0561Neg(b *testing.B) {
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Neg(&benchRese_nocarry_0561)
	}
}

func BenchmarkE_nocarry_0561Div(b *testing.B) {
	var x e_nocarry_0561
	x.SetRandom()
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Div(&x, &benchRese_nocarry_0561)
	}
}

func BenchmarkE_nocarry_0561FromMont(b *testing.B) {
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.FromMont()
	}
}

func BenchmarkE_nocarry_0561ToMont(b *testing.B) {
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.ToMont()
	}
}
func BenchmarkE_nocarry_0561Square(b *testing.B) {
	benchRese_nocarry_0561.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Square(&benchRese_nocarry_0561)
	}
}

func BenchmarkE_nocarry_0561Sqrt(b *testing.B) {
	var a e_nocarry_0561
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0561Mul(b *testing.B) {
	x := e_nocarry_0561{
		5244013846794471905,
	...
	benchRese_nocarry_0561.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Mul(&benchRese_nocarry_0561, &x)
	}
}

func BenchmarkE_nocarry_0561Cmp(b *testing.B) {
	x := e_nocarry_0561{
		5244013846794471905,
		12817811809490522377,
		9633005021906654020,
	...
	benchRese_nocarry_0561 = x
	benchRese_nocarry_0561[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0561.Cmp(&x)
	}
}

func TestE_nocarry_0561Cmp(t *testing.T) {
	var x, y e_nocarry_0561
...
func TestE_nocarry_0561IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0561
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0561

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0561{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0561
	one.SetOne()
	e.Sub(&qe_nocarry_0561, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0561{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0561{0, uint64(i)})
	}
...
func TestE_nocarry_0561NegZero(t *testing.T) {
	var a, b e_nocarry_0561
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0561Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0561, len(staticTestValues))
...
func TestE_nocarry_0561Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0561) bool {
			var b e_nocarry_0561
...
func TestE_nocarry_0561InverseExp(t *testing.T) {
...
func TestE_nocarry_0561MulByConstants(t *testing.T) {
...
func TestE_nocarry_0561Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0561) bool {
...
func TestE_nocarry_0561LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0561Halve(t *testing.T) {
...
func TestE_nocarry_0561FromMont(t *testing.T) {
...
type testPaire_nocarry_0561 struct {
	element e_nocarry_0561
	bigint  big.Int
}

func (z *e_nocarry_0561) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0561[8] {
		return true
	}
	if z[8] < qe_nocarry_0561[8] {
		return false
	...
	return z[0] >= qe_nocarry_0561[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0561

		g.element = e_nocarry_0561{
		...
		if qe_nocarry_0561[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0561[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0561 {
			var g e_nocarry_0561
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0561[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0561[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0561[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0561[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0561[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0561[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0561[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0561[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0561[8], carry)
...
func Benchmarke_nocarry_0561InverseNew(b *testing.B) {
	var x e_nocarry_0561
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0561
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0561
		var xInv e_nocarry_0561
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0561
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0561
...
func testLinearComb(t *testing.T, x *e_nocarry_0561, xC int64, y *e_nocarry_0561, yC int64) {
	...
	var z e_nocarry_0561
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0561, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0561
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0561, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0561
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0561, xHi uint64) {
	var res e_nocarry_0561
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0561) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0561) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0561, c int64, result *e_nocarry_0561, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0561) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0561) uint64 {
