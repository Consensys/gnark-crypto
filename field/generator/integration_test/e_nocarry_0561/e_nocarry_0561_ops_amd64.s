...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xba040bc61892a9a7, R12
	ADDQ R12, AX
	MOVQ $0x116a60ca0a8164b7, R12
	ADCQ R12, DX
	MOVQ $0xdfcae6c87abb9603, R12
	ADCQ R12, CX
	MOVQ $0x1117c1f7da7ef6d7, R12
	ADCQ R12, BX
	MOVQ $0x3a368214f37250ea, R12
	ADCQ R12, SI
	MOVQ $0x61cef6f5b4216126, R12
	ADCQ R12, DI
	MOVQ $0x2248584b1940080b, R12
	ADCQ R12, R8
	MOVQ $0xb7c7e827a7085dc7, R12
	ADCQ R12, R9
	MOVQ $0x0001ec7707be0b0b, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xba040bc61892a9a7, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x116a60ca0a8164b7, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xdfcae6c87abb9603, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x1117c1f7da7ef6d7, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x3a368214f37250ea, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x61cef6f5b4216126, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x2248584b1940080b, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xb7c7e827a7085dc7, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0001ec7707be0b0b, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xba040bc61892a9a7, AX
	ADDQ AX, DX
	MOVQ $0x116a60ca0a8164b7, AX
	ADCQ AX, CX
	MOVQ $0xdfcae6c87abb9603, AX
	ADCQ AX, BX
	MOVQ $0x1117c1f7da7ef6d7, AX
	ADCQ AX, SI
	MOVQ $0x3a368214f37250ea, AX
	ADCQ AX, DI
	MOVQ $0x61cef6f5b4216126, AX
	ADCQ AX, R8
	MOVQ $0x2248584b1940080b, AX
	ADCQ AX, R9
	MOVQ $0xb7c7e827a7085dc7, AX
	ADCQ AX, R10
	MOVQ $0x0001ec7707be0b0b, AX
	ADCQ AX, R11
