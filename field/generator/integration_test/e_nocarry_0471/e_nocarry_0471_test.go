...
var benchRese_nocarry_0471 e_nocarry_0471

func BenchmarkE_nocarry_0471SetBytes(b *testing.B) {
	var x e_nocarry_0471
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0471MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0471.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0471)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0471)
		}
	})
}

func BenchmarkE_nocarry_0471Inverse(b *testing.B) {
	var x e_nocarry_0471
	x.SetRandom()
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0471Butterfly(b *testing.B) {
	var x e_nocarry_0471
	x.SetRandom()
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0471)
	}
}

func BenchmarkE_nocarry_0471Exp(b *testing.B) {
	var x e_nocarry_0471
	x.SetRandom()
	benchRese_nocarry_0471.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0471Double(b *testing.B) {
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Double(&benchRese_nocarry_0471)
	}
}

func BenchmarkE_nocarry_0471Add(b *testing.B) {
	var x e_nocarry_0471
	x.SetRandom()
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Add(&x, &benchRese_nocarry_0471)
	}
}

func BenchmarkE_nocarry_0471Sub(b *testing.B) {
	var x e_nocarry_0471
	x.SetRandom()
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Sub(&x, &benchRese_nocarry_0471)
	}
}

func BenchmarkE_nocarry_0471Neg(b *testing.B) {
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Neg(&benchRese_nocarry_0471)
	}
}

func BenchmarkE_nocarry_0471Div(b *testing.B) {
	var x e_nocarry_0471
	x.SetRandom()
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Div(&x, &benchRese_nocarry_0471)
	}
}

func BenchmarkE_nocarry_0471FromMont(b *testing.B) {
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.FromMont()
	}
}

func BenchmarkE_nocarry_0471ToMont(b *testing.B) {
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.ToMont()
	}
}
func BenchmarkE_nocarry_0471Square(b *testing.B) {
	benchRese_nocarry_0471.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Square(&benchRese_nocarry_0471)
	}
}

func BenchmarkE_nocarry_0471Sqrt(b *testing.B) {
	var a e_nocarry_0471
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0471Mul(b *testing.B) {
	x := e_nocarry_0471{
		3482838531173326805,
		5673564310680727218,
		5479023169785660676,
	...
	benchRese_nocarry_0471.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Mul(&benchRese_nocarry_0471, &x)
	}
}

func BenchmarkE_nocarry_0471Cmp(b *testing.B) {
	x := e_nocarry_0471{
		3482838531173326805,
		5673564310680727218,
		5479023169785660676,
	...
	benchRese_nocarry_0471 = x
	benchRese_nocarry_0471[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0471.Cmp(&x)
	}
}

func TestE_nocarry_0471Cmp(t *testing.T) {
	var x, y e_nocarry_0471
...
func TestE_nocarry_0471IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0471
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0471

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0471{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0471
	one.SetOne()
	e.Sub(&qe_nocarry_0471, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0471{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0471{0, uint64(i)})
	}
...
func TestE_nocarry_0471NegZero(t *testing.T) {
	var a, b e_nocarry_0471
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0471Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0471, len(staticTestValues))
...
func TestE_nocarry_0471Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0471) bool {
			var b e_nocarry_0471
...
func TestE_nocarry_0471InverseExp(t *testing.T) {
...
func TestE_nocarry_0471MulByConstants(t *testing.T) {
...
func TestE_nocarry_0471Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0471) bool {
...
func TestE_nocarry_0471LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0471Halve(t *testing.T) {
...
func TestE_nocarry_0471FromMont(t *testing.T) {
...
type testPaire_nocarry_0471 struct {
	element e_nocarry_0471
	bigint  big.Int
}

func (z *e_nocarry_0471) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0471[7] {
		return true
	}
	if z[7] < qe_nocarry_0471[7] {
		return false
	...
	return z[0] >= qe_nocarry_0471[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0471

		g.element = e_nocarry_0471{
		...
		if qe_nocarry_0471[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0471[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0471 {
			var g e_nocarry_0471
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0471[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0471[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0471[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0471[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0471[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0471[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0471[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0471[7], carry)
...
func Benchmarke_nocarry_0471InverseNew(b *testing.B) {
	var x e_nocarry_0471
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0471
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0471
		var xInv e_nocarry_0471
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0471
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0471
...
func testLinearComb(t *testing.T, x *e_nocarry_0471, xC int64, y *e_nocarry_0471, yC int64) {
	...
	var z e_nocarry_0471
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0471, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0471
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0471, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0471
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0471, xHi uint64) {
	var res e_nocarry_0471
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0471) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0471) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0471, c int64, result *e_nocarry_0471, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0471) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0471) uint64 {
