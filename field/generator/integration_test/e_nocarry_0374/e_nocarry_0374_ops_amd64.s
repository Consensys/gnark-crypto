...
// modulus q
DATA q<>+0(SB)/8, $0x25761aecad225e29
DATA q<>+8(SB)/8, $0x9cbf03f988b07793
DATA q<>+16(SB)/8, $0x6e89f2b213f30352
DATA q<>+24(SB)/8, $0x0225eaf5a5604d8a
DATA q<>+32(SB)/8, $0x1d68be7b45fbc43c
DATA q<>+40(SB)/8, $0x003b0c4d6cdc89de
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xa69e868b18c3e1e7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x25761aecad225e29, R10
	MOVQ    $0x9cbf03f988b07793, R11
	MOVQ    $0x6e89f2b213f30352, R12
	MOVQ    $0x0225eaf5a5604d8a, R13
	MOVQ    $0x1d68be7b45fbc43c, R14
	MOVQ    $0x003b0c4d6cdc89de, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x9cbf03f988b07793, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x6e89f2b213f30352, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x0225eaf5a5604d8a, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x1d68be7b45fbc43c, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x003b0c4d6cdc89de, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x25761aecad225e29, CX
	MOVQ    $0x9cbf03f988b07793, BX
	MOVQ    $0x6e89f2b213f30352, SI
	MOVQ    $0x0225eaf5a5604d8a, DI
	MOVQ    $0x1d68be7b45fbc43c, R8
	MOVQ    $0x003b0c4d6cdc89de, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
