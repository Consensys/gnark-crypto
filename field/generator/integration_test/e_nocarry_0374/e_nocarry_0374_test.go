...
var benchRese_nocarry_0374 e_nocarry_0374

func BenchmarkE_nocarry_0374SetBytes(b *testing.B) {
	var x e_nocarry_0374
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0374MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0374.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0374)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0374)
		}
	})
}

func BenchmarkE_nocarry_0374Inverse(b *testing.B) {
	var x e_nocarry_0374
	x.SetRandom()
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0374Butterfly(b *testing.B) {
	var x e_nocarry_0374
	x.SetRandom()
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0374)
	}
}

func BenchmarkE_nocarry_0374Exp(b *testing.B) {
	var x e_nocarry_0374
	x.SetRandom()
	benchRese_nocarry_0374.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0374Double(b *testing.B) {
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Double(&benchRese_nocarry_0374)
	}
}

func BenchmarkE_nocarry_0374Add(b *testing.B) {
	var x e_nocarry_0374
	x.SetRandom()
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Add(&x, &benchRese_nocarry_0374)
	}
}

func BenchmarkE_nocarry_0374Sub(b *testing.B) {
	var x e_nocarry_0374
	x.SetRandom()
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Sub(&x, &benchRese_nocarry_0374)
	}
}

func BenchmarkE_nocarry_0374Neg(b *testing.B) {
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Neg(&benchRese_nocarry_0374)
	}
}

func BenchmarkE_nocarry_0374Div(b *testing.B) {
	var x e_nocarry_0374
	x.SetRandom()
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Div(&x, &benchRese_nocarry_0374)
	}
}

func BenchmarkE_nocarry_0374FromMont(b *testing.B) {
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.FromMont()
	}
}

func BenchmarkE_nocarry_0374ToMont(b *testing.B) {
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.ToMont()
	}
}
func BenchmarkE_nocarry_0374Square(b *testing.B) {
	benchRese_nocarry_0374.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Square(&benchRese_nocarry_0374)
	}
}

func BenchmarkE_nocarry_0374Sqrt(b *testing.B) {
	var a e_nocarry_0374
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0374Mul(b *testing.B) {
	x := e_nocarry_0374{
	...
	benchRese_nocarry_0374.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Mul(&benchRese_nocarry_0374, &x)
	}
}

func BenchmarkE_nocarry_0374Cmp(b *testing.B) {
	x := e_nocarry_0374{
		11381278369343264833,
		11692530899046670202,
		7738082445552489914,
	...
	benchRese_nocarry_0374 = x
	benchRese_nocarry_0374[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0374.Cmp(&x)
	}
}

func TestE_nocarry_0374Cmp(t *testing.T) {
	var x, y e_nocarry_0374
...
func TestE_nocarry_0374IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0374
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0374

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0374{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0374
	one.SetOne()
	e.Sub(&qe_nocarry_0374, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0374{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0374{0, uint64(i)})
	}
...
func TestE_nocarry_0374NegZero(t *testing.T) {
	var a, b e_nocarry_0374
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0374Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0374, len(staticTestValues))
...
func TestE_nocarry_0374Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0374) bool {
			var b e_nocarry_0374
...
func TestE_nocarry_0374InverseExp(t *testing.T) {
...
func TestE_nocarry_0374MulByConstants(t *testing.T) {
...
func TestE_nocarry_0374Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0374) bool {
...
func TestE_nocarry_0374LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0374Halve(t *testing.T) {
...
func TestE_nocarry_0374FromMont(t *testing.T) {
...
type testPaire_nocarry_0374 struct {
	element e_nocarry_0374
	bigint  big.Int
}

func (z *e_nocarry_0374) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0374[5] {
		return true
	}
	if z[5] < qe_nocarry_0374[5] {
		return false
	...
	return z[0] >= qe_nocarry_0374[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0374

		g.element = e_nocarry_0374{
		...
		if qe_nocarry_0374[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0374[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0374 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0374[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0374[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0374[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0374[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0374[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0374[5], carry)
...
func Benchmarke_nocarry_0374InverseNew(b *testing.B) {
	var x e_nocarry_0374
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0374
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0374
		var xInv e_nocarry_0374
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0374
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0374
...
func testLinearComb(t *testing.T, x *e_nocarry_0374, xC int64, y *e_nocarry_0374, yC int64) {
	...
	var z e_nocarry_0374
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0374, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0374
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0374, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0374
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0374, xHi uint64) {
	var res e_nocarry_0374
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0374) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0374) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0374, c int64, result *e_nocarry_0374, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0374) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0374) uint64 {
