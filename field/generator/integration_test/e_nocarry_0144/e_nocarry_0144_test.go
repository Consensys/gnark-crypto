...
var benchRese_nocarry_0144 e_nocarry_0144

func BenchmarkE_nocarry_0144SetBytes(b *testing.B) {
	var x e_nocarry_0144
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0144MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0144.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0144)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0144)
		}
	})
}

func BenchmarkE_nocarry_0144Inverse(b *testing.B) {
	var x e_nocarry_0144
	x.SetRandom()
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0144Butterfly(b *testing.B) {
	var x e_nocarry_0144
	x.SetRandom()
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0144)
	}
}

func BenchmarkE_nocarry_0144Exp(b *testing.B) {
	var x e_nocarry_0144
	x.SetRandom()
	benchRese_nocarry_0144.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0144Double(b *testing.B) {
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Double(&benchRese_nocarry_0144)
	}
}

func BenchmarkE_nocarry_0144Add(b *testing.B) {
	var x e_nocarry_0144
	x.SetRandom()
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Add(&x, &benchRese_nocarry_0144)
	}
}

func BenchmarkE_nocarry_0144Sub(b *testing.B) {
	var x e_nocarry_0144
	x.SetRandom()
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Sub(&x, &benchRese_nocarry_0144)
	}
}

func BenchmarkE_nocarry_0144Neg(b *testing.B) {
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Neg(&benchRese_nocarry_0144)
	}
}

func BenchmarkE_nocarry_0144Div(b *testing.B) {
	var x e_nocarry_0144
	x.SetRandom()
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Div(&x, &benchRese_nocarry_0144)
	}
}

func BenchmarkE_nocarry_0144FromMont(b *testing.B) {
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.FromMont()
	}
}

func BenchmarkE_nocarry_0144ToMont(b *testing.B) {
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.ToMont()
	}
}
func BenchmarkE_nocarry_0144Square(b *testing.B) {
	benchRese_nocarry_0144.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Square(&benchRese_nocarry_0144)
	}
}

func BenchmarkE_nocarry_0144Sqrt(b *testing.B) {
	var a e_nocarry_0144
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0144Mul(b *testing.B) {
	x := e_nocarry_0144{
		6572686648312592390,
		8037586963940569558,
		34644,
	}
	benchRese_nocarry_0144.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Mul(&benchRese_nocarry_0144, &x)
	}
}

func BenchmarkE_nocarry_0144Cmp(b *testing.B) {
	x := e_nocarry_0144{
		6572686648312592390,
		8037586963940569558,
		34644,
	}
	benchRese_nocarry_0144 = x
	benchRese_nocarry_0144[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0144.Cmp(&x)
	}
}

func TestE_nocarry_0144Cmp(t *testing.T) {
	var x, y e_nocarry_0144
...
func TestE_nocarry_0144IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0144
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0144

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0144{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0144
	one.SetOne()
	e.Sub(&qe_nocarry_0144, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0144{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0144{0, uint64(i)})
	}
...
func TestE_nocarry_0144NegZero(t *testing.T) {
	var a, b e_nocarry_0144
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0144Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0144, len(staticTestValues))
...
func TestE_nocarry_0144Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0144) bool {
			var b e_nocarry_0144
...
func TestE_nocarry_0144InverseExp(t *testing.T) {
...
func TestE_nocarry_0144MulByConstants(t *testing.T) {
...
func TestE_nocarry_0144Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0144) bool {
...
func TestE_nocarry_0144LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0144Halve(t *testing.T) {
...
func TestE_nocarry_0144FromMont(t *testing.T) {
...
type testPaire_nocarry_0144 struct {
	element e_nocarry_0144
	bigint  big.Int
}

func (z *e_nocarry_0144) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0144[2] {
		return true
	}
	if z[2] < qe_nocarry_0144[2] {
		return false
	...
	return z[0] >= qe_nocarry_0144[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0144

		g.element = e_nocarry_0144{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0144[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0144[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0144 {
			var g e_nocarry_0144
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0144[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0144[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0144[2], carry)
...
func Benchmarke_nocarry_0144InverseNew(b *testing.B) {
	var x e_nocarry_0144
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0144
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0144
		var xInv e_nocarry_0144
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0144
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0144
...
func testLinearComb(t *testing.T, x *e_nocarry_0144, xC int64, y *e_nocarry_0144, yC int64) {
	...
	var z e_nocarry_0144
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0144, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0144
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0144, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0144
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0144, xHi uint64) {
	var res e_nocarry_0144
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0144) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0144) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0144, c int64, result *e_nocarry_0144, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0144) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0144) uint64 {
