...
var benchRese_nocarry_0490 e_nocarry_0490

func BenchmarkE_nocarry_0490SetBytes(b *testing.B) {
	var x e_nocarry_0490
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0490MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0490.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0490)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0490)
		}
	})
}

func BenchmarkE_nocarry_0490Inverse(b *testing.B) {
	var x e_nocarry_0490
	x.SetRandom()
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0490Butterfly(b *testing.B) {
	var x e_nocarry_0490
	x.SetRandom()
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0490)
	}
}

func BenchmarkE_nocarry_0490Exp(b *testing.B) {
	var x e_nocarry_0490
	x.SetRandom()
	benchRese_nocarry_0490.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0490Double(b *testing.B) {
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Double(&benchRese_nocarry_0490)
	}
}

func BenchmarkE_nocarry_0490Add(b *testing.B) {
	var x e_nocarry_0490
	x.SetRandom()
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Add(&x, &benchRese_nocarry_0490)
	}
}

func BenchmarkE_nocarry_0490Sub(b *testing.B) {
	var x e_nocarry_0490
	x.SetRandom()
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Sub(&x, &benchRese_nocarry_0490)
	}
}

func BenchmarkE_nocarry_0490Neg(b *testing.B) {
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Neg(&benchRese_nocarry_0490)
	}
}

func BenchmarkE_nocarry_0490Div(b *testing.B) {
	var x e_nocarry_0490
	x.SetRandom()
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Div(&x, &benchRese_nocarry_0490)
	}
}

func BenchmarkE_nocarry_0490FromMont(b *testing.B) {
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.FromMont()
	}
}

func BenchmarkE_nocarry_0490ToMont(b *testing.B) {
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.ToMont()
	}
}
func BenchmarkE_nocarry_0490Square(b *testing.B) {
	benchRese_nocarry_0490.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Square(&benchRese_nocarry_0490)
	}
}

func BenchmarkE_nocarry_0490Sqrt(b *testing.B) {
	var a e_nocarry_0490
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0490Mul(b *testing.B) {
	x := e_nocarry_0490{
	...
	benchRese_nocarry_0490.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Mul(&benchRese_nocarry_0490, &x)
	}
}

func BenchmarkE_nocarry_0490Cmp(b *testing.B) {
	x := e_nocarry_0490{
		17599165436224287652,
		17483888697991122307,
		8087183193956019090,
	...
	benchRese_nocarry_0490 = x
	benchRese_nocarry_0490[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0490.Cmp(&x)
	}
}

func TestE_nocarry_0490Cmp(t *testing.T) {
	var x, y e_nocarry_0490
...
func TestE_nocarry_0490IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0490
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0490

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0490{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0490
	one.SetOne()
	e.Sub(&qe_nocarry_0490, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0490{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0490{0, uint64(i)})
	}
...
func TestE_nocarry_0490NegZero(t *testing.T) {
	var a, b e_nocarry_0490
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0490Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0490, len(staticTestValues))
...
func TestE_nocarry_0490Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0490) bool {
			var b e_nocarry_0490
...
func TestE_nocarry_0490InverseExp(t *testing.T) {
...
func TestE_nocarry_0490MulByConstants(t *testing.T) {
...
func TestE_nocarry_0490Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0490) bool {
...
func TestE_nocarry_0490LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0490Halve(t *testing.T) {
...
func TestE_nocarry_0490FromMont(t *testing.T) {
...
type testPaire_nocarry_0490 struct {
	element e_nocarry_0490
	bigint  big.Int
}

func (z *e_nocarry_0490) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0490[7] {
		return true
	}
	if z[7] < qe_nocarry_0490[7] {
		return false
	...
	return z[0] >= qe_nocarry_0490[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0490

		g.element = e_nocarry_0490{
		...
		if qe_nocarry_0490[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0490[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0490 {
			var g e_nocarry_0490
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0490[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0490[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0490[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0490[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0490[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0490[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0490[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0490[7], carry)
...
func Benchmarke_nocarry_0490InverseNew(b *testing.B) {
	var x e_nocarry_0490
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0490
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0490
		var xInv e_nocarry_0490
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0490
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0490
...
func testLinearComb(t *testing.T, x *e_nocarry_0490, xC int64, y *e_nocarry_0490, yC int64) {
	...
	var z e_nocarry_0490
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0490, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0490
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0490, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0490
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0490, xHi uint64) {
	var res e_nocarry_0490
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0490) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0490) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0490, c int64, result *e_nocarry_0490, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0490) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0490) uint64 {
