...
var benchRese_nocarry_0645 e_nocarry_0645

func BenchmarkE_nocarry_0645SetBytes(b *testing.B) {
	var x e_nocarry_0645
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0645MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0645.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0645)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0645)
		}
	})
}

func BenchmarkE_nocarry_0645Inverse(b *testing.B) {
	var x e_nocarry_0645
	x.SetRandom()
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0645Butterfly(b *testing.B) {
	var x e_nocarry_0645
	x.SetRandom()
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0645)
	}
}

func BenchmarkE_nocarry_0645Exp(b *testing.B) {
	var x e_nocarry_0645
	x.SetRandom()
	benchRese_nocarry_0645.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0645Double(b *testing.B) {
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Double(&benchRese_nocarry_0645)
	}
}

func BenchmarkE_nocarry_0645Add(b *testing.B) {
	var x e_nocarry_0645
	x.SetRandom()
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Add(&x, &benchRese_nocarry_0645)
	}
}

func BenchmarkE_nocarry_0645Sub(b *testing.B) {
	var x e_nocarry_0645
	x.SetRandom()
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Sub(&x, &benchRese_nocarry_0645)
	}
}

func BenchmarkE_nocarry_0645Neg(b *testing.B) {
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Neg(&benchRese_nocarry_0645)
	}
}

func BenchmarkE_nocarry_0645Div(b *testing.B) {
	var x e_nocarry_0645
	x.SetRandom()
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Div(&x, &benchRese_nocarry_0645)
	}
}

func BenchmarkE_nocarry_0645FromMont(b *testing.B) {
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.FromMont()
	}
}

func BenchmarkE_nocarry_0645ToMont(b *testing.B) {
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.ToMont()
	}
}
func BenchmarkE_nocarry_0645Square(b *testing.B) {
	benchRese_nocarry_0645.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Square(&benchRese_nocarry_0645)
	}
}

func BenchmarkE_nocarry_0645Sqrt(b *testing.B) {
	var a e_nocarry_0645
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0645Mul(b *testing.B) {
	x := e_nocarry_0645{
	...
	benchRese_nocarry_0645.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Mul(&benchRese_nocarry_0645, &x)
	}
}

func BenchmarkE_nocarry_0645Cmp(b *testing.B) {
	x := e_nocarry_0645{
		11976108119414071897,
		14353127883064916044,
		14581148939305090495,
	...
	benchRese_nocarry_0645 = x
	benchRese_nocarry_0645[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0645.Cmp(&x)
	}
}

func TestE_nocarry_0645Cmp(t *testing.T) {
	var x, y e_nocarry_0645
...
func TestE_nocarry_0645IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0645
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0645

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0645{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0645
	one.SetOne()
	e.Sub(&qe_nocarry_0645, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0645{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0645{0, uint64(i)})
	}
...
func TestE_nocarry_0645NegZero(t *testing.T) {
	var a, b e_nocarry_0645
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0645Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0645, len(staticTestValues))
...
func TestE_nocarry_0645Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0645) bool {
			var b e_nocarry_0645
...
func TestE_nocarry_0645InverseExp(t *testing.T) {
...
func TestE_nocarry_0645MulByConstants(t *testing.T) {
...
func TestE_nocarry_0645Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0645) bool {
...
func TestE_nocarry_0645LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0645Halve(t *testing.T) {
...
func TestE_nocarry_0645FromMont(t *testing.T) {
...
type testPaire_nocarry_0645 struct {
	element e_nocarry_0645
	bigint  big.Int
}

func (z *e_nocarry_0645) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0645[10] {
		return true
	}
	if z[10] < qe_nocarry_0645[10] {
		return false
	...
	return z[0] >= qe_nocarry_0645[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0645

		g.element = e_nocarry_0645{
		...
		if qe_nocarry_0645[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0645[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0645 {
			var g e_nocarry_0645
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0645[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0645[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0645[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0645[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0645[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0645[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0645[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0645[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0645[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0645[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0645[10], carry)
...
func Benchmarke_nocarry_0645InverseNew(b *testing.B) {
	var x e_nocarry_0645
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0645
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0645
		var xInv e_nocarry_0645
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0645
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0645
...
func testLinearComb(t *testing.T, x *e_nocarry_0645, xC int64, y *e_nocarry_0645, yC int64) {
	...
	var z e_nocarry_0645
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0645, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0645
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0645, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0645
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0645, xHi uint64) {
	var res e_nocarry_0645
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0645) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0645) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0645, c int64, result *e_nocarry_0645, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0645) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0645) uint64 {
