...
// modulus q
DATA q<>+0(SB)/8, $0xffad87be2934564b
DATA q<>+8(SB)/8, $0xd43f06b035d97a82
DATA q<>+16(SB)/8, $0xf0adf8e002076458
DATA q<>+24(SB)/8, $0x32be19b9355dfc0c
DATA q<>+32(SB)/8, $0x2e95047f5a189797
DATA q<>+40(SB)/8, $0x4012158bcd1a9ad1
DATA q<>+48(SB)/8, $0x27b59094ff4c32e7
DATA q<>+56(SB)/8, $0xa6eb7af65cf3d1db
DATA q<>+64(SB)/8, $0x814918d7b3a35a2b
DATA q<>+72(SB)/8, $0xa8013f043d1897ce
DATA q<>+80(SB)/8, $0x0000000000000019
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xce5cfb33cd98bc9d
