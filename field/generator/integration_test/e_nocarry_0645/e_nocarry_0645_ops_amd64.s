...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xffad87be2934564b, R14
	ADDQ R14, AX
	MOVQ $0xd43f06b035d97a82, R14
	ADCQ R14, DX
	MOVQ $0xf0adf8e002076458, R14
	ADCQ R14, CX
	MOVQ $0x32be19b9355dfc0c, R14
	ADCQ R14, BX
	MOVQ $0x2e95047f5a189797, R14
	ADCQ R14, SI
	MOVQ $0x4012158bcd1a9ad1, R14
	ADCQ R14, DI
	MOVQ $0x27b59094ff4c32e7, R14
	ADCQ R14, R8
	MOVQ $0xa6eb7af65cf3d1db, R14
	ADCQ R14, R9
	MOVQ $0x814918d7b3a35a2b, R14
	ADCQ R14, R10
	MOVQ $0xa8013f043d1897ce, R14
	ADCQ R14, R11
	MOVQ $0x0000000000000019, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xffad87be2934564b, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xd43f06b035d97a82, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xf0adf8e002076458, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x32be19b9355dfc0c, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x2e95047f5a189797, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x4012158bcd1a9ad1, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x27b59094ff4c32e7, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xa6eb7af65cf3d1db, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x814918d7b3a35a2b, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xa8013f043d1897ce, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000000000019, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xffad87be2934564b, AX
	ADDQ AX, DX
	MOVQ $0xd43f06b035d97a82, AX
	ADCQ AX, CX
	MOVQ $0xf0adf8e002076458, AX
	ADCQ AX, BX
	MOVQ $0x32be19b9355dfc0c, AX
	ADCQ AX, SI
	MOVQ $0x2e95047f5a189797, AX
	ADCQ AX, DI
	MOVQ $0x4012158bcd1a9ad1, AX
	ADCQ AX, R8
	MOVQ $0x27b59094ff4c32e7, AX
	ADCQ AX, R9
	MOVQ $0xa6eb7af65cf3d1db, AX
	ADCQ AX, R10
	MOVQ $0x814918d7b3a35a2b, AX
	ADCQ AX, R11
	MOVQ $0xa8013f043d1897ce, AX
	ADCQ AX, R12
	MOVQ $0x0000000000000019, AX
	ADCQ AX, R13
