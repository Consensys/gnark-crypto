...
var benchRese_nocarry_0275 e_nocarry_0275

func BenchmarkE_nocarry_0275SetBytes(b *testing.B) {
	var x e_nocarry_0275
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0275MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0275.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0275)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0275)
		}
	})
}

func BenchmarkE_nocarry_0275Inverse(b *testing.B) {
	var x e_nocarry_0275
	x.SetRandom()
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0275Butterfly(b *testing.B) {
	var x e_nocarry_0275
	x.SetRandom()
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0275)
	}
}

func BenchmarkE_nocarry_0275Exp(b *testing.B) {
	var x e_nocarry_0275
	x.SetRandom()
	benchRese_nocarry_0275.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0275Double(b *testing.B) {
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Double(&benchRese_nocarry_0275)
	}
}

func BenchmarkE_nocarry_0275Add(b *testing.B) {
	var x e_nocarry_0275
	x.SetRandom()
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Add(&x, &benchRese_nocarry_0275)
	}
}

func BenchmarkE_nocarry_0275Sub(b *testing.B) {
	var x e_nocarry_0275
	x.SetRandom()
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Sub(&x, &benchRese_nocarry_0275)
	}
}

func BenchmarkE_nocarry_0275Neg(b *testing.B) {
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Neg(&benchRese_nocarry_0275)
	}
}

func BenchmarkE_nocarry_0275Div(b *testing.B) {
	var x e_nocarry_0275
	x.SetRandom()
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Div(&x, &benchRese_nocarry_0275)
	}
}

func BenchmarkE_nocarry_0275FromMont(b *testing.B) {
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.FromMont()
	}
}

func BenchmarkE_nocarry_0275ToMont(b *testing.B) {
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.ToMont()
	}
}
func BenchmarkE_nocarry_0275Square(b *testing.B) {
	benchRese_nocarry_0275.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Square(&benchRese_nocarry_0275)
	}
}

func BenchmarkE_nocarry_0275Sqrt(b *testing.B) {
	var a e_nocarry_0275
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0275Mul(b *testing.B) {
	x := e_nocarry_0275{
		7742586788516608818,
		3777598379747465152,
		2326354597414329442,
	...
	benchRese_nocarry_0275.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Mul(&benchRese_nocarry_0275, &x)
	}
}

func BenchmarkE_nocarry_0275Cmp(b *testing.B) {
	x := e_nocarry_0275{
		7742586788516608818,
		3777598379747465152,
		2326354597414329442,
	...
	benchRese_nocarry_0275 = x
	benchRese_nocarry_0275[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0275.Cmp(&x)
	}
}

func TestE_nocarry_0275Cmp(t *testing.T) {
	var x, y e_nocarry_0275
...
func TestE_nocarry_0275IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0275
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0275

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0275{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0275
	one.SetOne()
	e.Sub(&qe_nocarry_0275, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0275{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0275{0, uint64(i)})
	}
...
func TestE_nocarry_0275NegZero(t *testing.T) {
	var a, b e_nocarry_0275
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0275Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0275, len(staticTestValues))
...
func TestE_nocarry_0275Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0275) bool {
			var b e_nocarry_0275
...
func TestE_nocarry_0275InverseExp(t *testing.T) {
...
func TestE_nocarry_0275MulByConstants(t *testing.T) {
...
func TestE_nocarry_0275Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0275) bool {
...
func TestE_nocarry_0275LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0275Halve(t *testing.T) {
...
func TestE_nocarry_0275FromMont(t *testing.T) {
...
type testPaire_nocarry_0275 struct {
	element e_nocarry_0275
	bigint  big.Int
}

func (z *e_nocarry_0275) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0275[4] {
		return true
	}
	if z[4] < qe_nocarry_0275[4] {
		return false
	...
	return z[0] >= qe_nocarry_0275[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0275

		g.element = e_nocarry_0275{
		...
		if qe_nocarry_0275[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0275[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0275 {
			var g e_nocarry_0275
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0275[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0275[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0275[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0275[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0275[4], carry)
...
func Benchmarke_nocarry_0275InverseNew(b *testing.B) {
	var x e_nocarry_0275
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0275
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0275
		var xInv e_nocarry_0275
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0275
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0275
...
func testLinearComb(t *testing.T, x *e_nocarry_0275, xC int64, y *e_nocarry_0275, yC int64) {
	...
	var z e_nocarry_0275
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0275, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0275
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0275, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0275
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0275, xHi uint64) {
	var res e_nocarry_0275
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0275) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0275) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0275, c int64, result *e_nocarry_0275, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0275) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0275) uint64 {
