...
// modulus q
DATA q<>+0(SB)/8, $0x8b194065ab5608eb
DATA q<>+8(SB)/8, $0x9f7bd4ad1dcee527
DATA q<>+16(SB)/8, $0x3d733e46e2c76f20
DATA q<>+24(SB)/8, $0x7d65dcd92dcb8110
DATA q<>+32(SB)/8, $0x000000000007f3ed
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x7de83da85987a03d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x8b194065ab5608eb, R9
	MOVQ    $0x9f7bd4ad1dcee527, R10
	MOVQ    $0x3d733e46e2c76f20, R11
	MOVQ    $0x7d65dcd92dcb8110, R12
	MOVQ    $0x000000000007f3ed, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x9f7bd4ad1dcee527, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x3d733e46e2c76f20, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x7d65dcd92dcb8110, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000000007f3ed, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x8b194065ab5608eb, CX
	MOVQ    $0x9f7bd4ad1dcee527, BX
	MOVQ    $0x3d733e46e2c76f20, SI
	MOVQ    $0x7d65dcd92dcb8110, DI
	MOVQ    $0x000000000007f3ed, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
