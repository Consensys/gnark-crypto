...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x144ccd83da25f871, R13
	ADDQ R13, AX
	MOVQ $0xa6212ba50f5bb0fb, R13
	ADCQ R13, DX
	MOVQ $0x9ba4557129e0015f, R13
	ADCQ R13, CX
	MOVQ $0x12b57740786c728a, R13
	ADCQ R13, BX
	MOVQ $0x1f3dc05cbb57f38f, R13
	ADCQ R13, SI
	MOVQ $0x8e708596e863bc5c, R13
	ADCQ R13, DI
	MOVQ $0x94b8835dbab022df, R13
	ADCQ R13, R8
	MOVQ $0x3b67c98c6d2b24fb, R13
	ADCQ R13, R9
	MOVQ $0x0f814a9c36309412, R13
	ADCQ R13, R10
	MOVQ $0x0000000e76f16c0e, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x144ccd83da25f871, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xa6212ba50f5bb0fb, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x9ba4557129e0015f, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x12b57740786c728a, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x1f3dc05cbb57f38f, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x8e708596e863bc5c, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x94b8835dbab022df, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x3b67c98c6d2b24fb, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x0f814a9c36309412, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000e76f16c0e, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x144ccd83da25f871, AX
	ADDQ AX, DX
	MOVQ $0xa6212ba50f5bb0fb, AX
	ADCQ AX, CX
	MOVQ $0x9ba4557129e0015f, AX
	ADCQ AX, BX
	MOVQ $0x12b57740786c728a, AX
	ADCQ AX, SI
	MOVQ $0x1f3dc05cbb57f38f, AX
	ADCQ AX, DI
	MOVQ $0x8e708596e863bc5c, AX
	ADCQ AX, R8
	MOVQ $0x94b8835dbab022df, AX
	ADCQ AX, R9
	MOVQ $0x3b67c98c6d2b24fb, AX
	ADCQ AX, R10
	MOVQ $0x0f814a9c36309412, AX
	ADCQ AX, R11
	MOVQ $0x0000000e76f16c0e, AX
	ADCQ AX, R12
