...
var benchRese_nocarry_0612 e_nocarry_0612

func BenchmarkE_nocarry_0612SetBytes(b *testing.B) {
	var x e_nocarry_0612
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0612MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0612.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0612)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0612)
		}
	})
}

func BenchmarkE_nocarry_0612Inverse(b *testing.B) {
	var x e_nocarry_0612
	x.SetRandom()
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0612Butterfly(b *testing.B) {
	var x e_nocarry_0612
	x.SetRandom()
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0612)
	}
}

func BenchmarkE_nocarry_0612Exp(b *testing.B) {
	var x e_nocarry_0612
	x.SetRandom()
	benchRese_nocarry_0612.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0612Double(b *testing.B) {
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Double(&benchRese_nocarry_0612)
	}
}

func BenchmarkE_nocarry_0612Add(b *testing.B) {
	var x e_nocarry_0612
	x.SetRandom()
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Add(&x, &benchRese_nocarry_0612)
	}
}

func BenchmarkE_nocarry_0612Sub(b *testing.B) {
	var x e_nocarry_0612
	x.SetRandom()
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Sub(&x, &benchRese_nocarry_0612)
	}
}

func BenchmarkE_nocarry_0612Neg(b *testing.B) {
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Neg(&benchRese_nocarry_0612)
	}
}

func BenchmarkE_nocarry_0612Div(b *testing.B) {
	var x e_nocarry_0612
	x.SetRandom()
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Div(&x, &benchRese_nocarry_0612)
	}
}

func BenchmarkE_nocarry_0612FromMont(b *testing.B) {
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.FromMont()
	}
}

func BenchmarkE_nocarry_0612ToMont(b *testing.B) {
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.ToMont()
	}
}
func BenchmarkE_nocarry_0612Square(b *testing.B) {
	benchRese_nocarry_0612.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Square(&benchRese_nocarry_0612)
	}
}

func BenchmarkE_nocarry_0612Sqrt(b *testing.B) {
	var a e_nocarry_0612
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0612Mul(b *testing.B) {
	x := e_nocarry_0612{
		9604203658116682895,
		1293066273840866493,
	...
	benchRese_nocarry_0612.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Mul(&benchRese_nocarry_0612, &x)
	}
}

func BenchmarkE_nocarry_0612Cmp(b *testing.B) {
	x := e_nocarry_0612{
		9604203658116682895,
		1293066273840866493,
		11154584604119437328,
	...
	benchRese_nocarry_0612 = x
	benchRese_nocarry_0612[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0612.Cmp(&x)
	}
}

func TestE_nocarry_0612Cmp(t *testing.T) {
	var x, y e_nocarry_0612
...
func TestE_nocarry_0612IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0612
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0612

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0612{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0612
	one.SetOne()
	e.Sub(&qe_nocarry_0612, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0612{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0612{0, uint64(i)})
	}
...
func TestE_nocarry_0612NegZero(t *testing.T) {
	var a, b e_nocarry_0612
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0612Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0612, len(staticTestValues))
...
func TestE_nocarry_0612Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0612) bool {
			var b e_nocarry_0612
...
func TestE_nocarry_0612InverseExp(t *testing.T) {
...
func TestE_nocarry_0612MulByConstants(t *testing.T) {
...
func TestE_nocarry_0612Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0612) bool {
...
func TestE_nocarry_0612LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0612Halve(t *testing.T) {
...
func TestE_nocarry_0612FromMont(t *testing.T) {
...
type testPaire_nocarry_0612 struct {
	element e_nocarry_0612
	bigint  big.Int
}

func (z *e_nocarry_0612) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0612[9] {
		return true
	}
	if z[9] < qe_nocarry_0612[9] {
		return false
	...
	return z[0] >= qe_nocarry_0612[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0612

		g.element = e_nocarry_0612{
		...
		if qe_nocarry_0612[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0612[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0612 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0612[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0612[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0612[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0612[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0612[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0612[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0612[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0612[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0612[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0612[9], carry)
...
func Benchmarke_nocarry_0612InverseNew(b *testing.B) {
	var x e_nocarry_0612
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0612
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0612
		var xInv e_nocarry_0612
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0612
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0612
...
func testLinearComb(t *testing.T, x *e_nocarry_0612, xC int64, y *e_nocarry_0612, yC int64) {
	...
	var z e_nocarry_0612
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0612, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0612
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0612, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0612
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0612, xHi uint64) {
	var res e_nocarry_0612
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0612) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0612) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0612, c int64, result *e_nocarry_0612, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0612) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0612) uint64 {
