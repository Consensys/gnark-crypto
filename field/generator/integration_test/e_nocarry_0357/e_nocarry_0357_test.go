...
var benchRese_nocarry_0357 e_nocarry_0357

func BenchmarkE_nocarry_0357SetBytes(b *testing.B) {
	var x e_nocarry_0357
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0357MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0357.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0357)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0357)
		}
	})
}

func BenchmarkE_nocarry_0357Inverse(b *testing.B) {
	var x e_nocarry_0357
	x.SetRandom()
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0357Butterfly(b *testing.B) {
	var x e_nocarry_0357
	x.SetRandom()
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0357)
	}
}

func BenchmarkE_nocarry_0357Exp(b *testing.B) {
	var x e_nocarry_0357
	x.SetRandom()
	benchRese_nocarry_0357.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0357Double(b *testing.B) {
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Double(&benchRese_nocarry_0357)
	}
}

func BenchmarkE_nocarry_0357Add(b *testing.B) {
	var x e_nocarry_0357
	x.SetRandom()
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Add(&x, &benchRese_nocarry_0357)
	}
}

func BenchmarkE_nocarry_0357Sub(b *testing.B) {
	var x e_nocarry_0357
	x.SetRandom()
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Sub(&x, &benchRese_nocarry_0357)
	}
}

func BenchmarkE_nocarry_0357Neg(b *testing.B) {
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Neg(&benchRese_nocarry_0357)
	}
}

func BenchmarkE_nocarry_0357Div(b *testing.B) {
	var x e_nocarry_0357
	x.SetRandom()
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Div(&x, &benchRese_nocarry_0357)
	}
}

func BenchmarkE_nocarry_0357FromMont(b *testing.B) {
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.FromMont()
	}
}

func BenchmarkE_nocarry_0357ToMont(b *testing.B) {
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.ToMont()
	}
}
func BenchmarkE_nocarry_0357Square(b *testing.B) {
	benchRese_nocarry_0357.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Square(&benchRese_nocarry_0357)
	}
}

func BenchmarkE_nocarry_0357Sqrt(b *testing.B) {
	var a e_nocarry_0357
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0357Mul(b *testing.B) {
	x := e_nocarry_0357{
		8455267458208650355,
	...
	benchRese_nocarry_0357.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Mul(&benchRese_nocarry_0357, &x)
	}
}

func BenchmarkE_nocarry_0357Cmp(b *testing.B) {
	x := e_nocarry_0357{
		8455267458208650355,
		12609562031073720710,
		17514015990374714469,
	...
	benchRese_nocarry_0357 = x
	benchRese_nocarry_0357[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0357.Cmp(&x)
	}
}

func TestE_nocarry_0357Cmp(t *testing.T) {
	var x, y e_nocarry_0357
...
func TestE_nocarry_0357IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0357
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0357

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0357{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0357
	one.SetOne()
	e.Sub(&qe_nocarry_0357, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0357{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0357{0, uint64(i)})
	}
...
func TestE_nocarry_0357NegZero(t *testing.T) {
	var a, b e_nocarry_0357
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0357Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0357, len(staticTestValues))
...
func TestE_nocarry_0357Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0357) bool {
			var b e_nocarry_0357
...
func TestE_nocarry_0357InverseExp(t *testing.T) {
...
func TestE_nocarry_0357MulByConstants(t *testing.T) {
...
func TestE_nocarry_0357Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0357) bool {
...
func TestE_nocarry_0357LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0357Halve(t *testing.T) {
...
func TestE_nocarry_0357FromMont(t *testing.T) {
...
type testPaire_nocarry_0357 struct {
	element e_nocarry_0357
	bigint  big.Int
}

func (z *e_nocarry_0357) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0357[5] {
		return true
	}
	if z[5] < qe_nocarry_0357[5] {
		return false
	...
	return z[0] >= qe_nocarry_0357[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0357

		g.element = e_nocarry_0357{
		...
		if qe_nocarry_0357[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0357[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0357 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0357[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0357[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0357[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0357[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0357[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0357[5], carry)
...
func Benchmarke_nocarry_0357InverseNew(b *testing.B) {
	var x e_nocarry_0357
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0357
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0357
		var xInv e_nocarry_0357
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0357
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0357
...
func testLinearComb(t *testing.T, x *e_nocarry_0357, xC int64, y *e_nocarry_0357, yC int64) {
	...
	var z e_nocarry_0357
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0357, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0357
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0357, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0357
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0357, xHi uint64) {
	var res e_nocarry_0357
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0357) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0357) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0357, c int64, result *e_nocarry_0357, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0357) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0357) uint64 {
