...
// modulus q
DATA q<>+0(SB)/8, $0xc2d953dcf7fed359
DATA q<>+8(SB)/8, $0x9a64b3699a9c4156
DATA q<>+16(SB)/8, $0x006327c057d1db34
DATA q<>+24(SB)/8, $0x8b70f60331a376cd
DATA q<>+32(SB)/8, $0xc6d06e87bd549893
DATA q<>+40(SB)/8, $0x0000001e22a1551c
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x27d5b01f9761bb17
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xc2d953dcf7fed359, R10
	MOVQ    $0x9a64b3699a9c4156, R11
	MOVQ    $0x006327c057d1db34, R12
	MOVQ    $0x8b70f60331a376cd, R13
	MOVQ    $0xc6d06e87bd549893, R14
	MOVQ    $0x0000001e22a1551c, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x9a64b3699a9c4156, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x006327c057d1db34, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x8b70f60331a376cd, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xc6d06e87bd549893, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000001e22a1551c, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xc2d953dcf7fed359, CX
	MOVQ    $0x9a64b3699a9c4156, BX
	MOVQ    $0x006327c057d1db34, SI
	MOVQ    $0x8b70f60331a376cd, DI
	MOVQ    $0xc6d06e87bd549893, R8
	MOVQ    $0x0000001e22a1551c, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
