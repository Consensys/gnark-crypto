...
var benchRese_nocarry_0579 e_nocarry_0579

func BenchmarkE_nocarry_0579SetBytes(b *testing.B) {
	var x e_nocarry_0579
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0579MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0579.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0579)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0579)
		}
	})
}

func BenchmarkE_nocarry_0579Inverse(b *testing.B) {
	var x e_nocarry_0579
	x.SetRandom()
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0579Butterfly(b *testing.B) {
	var x e_nocarry_0579
	x.SetRandom()
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0579)
	}
}

func BenchmarkE_nocarry_0579Exp(b *testing.B) {
	var x e_nocarry_0579
	x.SetRandom()
	benchRese_nocarry_0579.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0579Double(b *testing.B) {
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Double(&benchRese_nocarry_0579)
	}
}

func BenchmarkE_nocarry_0579Add(b *testing.B) {
	var x e_nocarry_0579
	x.SetRandom()
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Add(&x, &benchRese_nocarry_0579)
	}
}

func BenchmarkE_nocarry_0579Sub(b *testing.B) {
	var x e_nocarry_0579
	x.SetRandom()
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Sub(&x, &benchRese_nocarry_0579)
	}
}

func BenchmarkE_nocarry_0579Neg(b *testing.B) {
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Neg(&benchRese_nocarry_0579)
	}
}

func BenchmarkE_nocarry_0579Div(b *testing.B) {
	var x e_nocarry_0579
	x.SetRandom()
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Div(&x, &benchRese_nocarry_0579)
	}
}

func BenchmarkE_nocarry_0579FromMont(b *testing.B) {
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.FromMont()
	}
}

func BenchmarkE_nocarry_0579ToMont(b *testing.B) {
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.ToMont()
	}
}
func BenchmarkE_nocarry_0579Square(b *testing.B) {
	benchRese_nocarry_0579.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Square(&benchRese_nocarry_0579)
	}
}

func BenchmarkE_nocarry_0579Sqrt(b *testing.B) {
	var a e_nocarry_0579
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0579Mul(b *testing.B) {
	x := e_nocarry_0579{
		1388763936567542728,
	...
	benchRese_nocarry_0579.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Mul(&benchRese_nocarry_0579, &x)
	}
}

func BenchmarkE_nocarry_0579Cmp(b *testing.B) {
	x := e_nocarry_0579{
		1388763936567542728,
		12231574002455978141,
		17081663559213697969,
	...
	benchRese_nocarry_0579 = x
	benchRese_nocarry_0579[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0579.Cmp(&x)
	}
}

func TestE_nocarry_0579Cmp(t *testing.T) {
	var x, y e_nocarry_0579
...
func TestE_nocarry_0579IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0579
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0579

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0579{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0579
	one.SetOne()
	e.Sub(&qe_nocarry_0579, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0579{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0579{0, uint64(i)})
	}
...
func TestE_nocarry_0579NegZero(t *testing.T) {
	var a, b e_nocarry_0579
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0579Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0579, len(staticTestValues))
...
func TestE_nocarry_0579Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0579) bool {
			var b e_nocarry_0579
...
func TestE_nocarry_0579InverseExp(t *testing.T) {
...
func TestE_nocarry_0579MulByConstants(t *testing.T) {
...
func TestE_nocarry_0579Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0579) bool {
...
func TestE_nocarry_0579LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0579Halve(t *testing.T) {
...
func TestE_nocarry_0579FromMont(t *testing.T) {
...
type testPaire_nocarry_0579 struct {
	element e_nocarry_0579
	bigint  big.Int
}

func (z *e_nocarry_0579) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0579[9] {
		return true
	}
	if z[9] < qe_nocarry_0579[9] {
		return false
	...
	return z[0] >= qe_nocarry_0579[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0579

		g.element = e_nocarry_0579{
		...
		if qe_nocarry_0579[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0579[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0579 {
			var g e_nocarry_0579
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0579[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0579[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0579[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0579[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0579[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0579[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0579[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0579[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0579[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0579[9], carry)
...
func Benchmarke_nocarry_0579InverseNew(b *testing.B) {
	var x e_nocarry_0579
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0579
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0579
		var xInv e_nocarry_0579
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0579
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0579
...
func testLinearComb(t *testing.T, x *e_nocarry_0579, xC int64, y *e_nocarry_0579, yC int64) {
	...
	var z e_nocarry_0579
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0579, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0579
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0579, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0579
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0579, xHi uint64) {
	var res e_nocarry_0579
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0579) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0579) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0579, c int64, result *e_nocarry_0579, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0579) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0579) uint64 {
