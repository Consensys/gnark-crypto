...
// modulus q
DATA q<>+0(SB)/8, $0x24392d43fe374b55
DATA q<>+8(SB)/8, $0xfcafb57cb98b1d1d
DATA q<>+16(SB)/8, $0x8025971067da7061
DATA q<>+24(SB)/8, $0x5fe036871081c71c
DATA q<>+32(SB)/8, $0xaf04a82ca7aae498
DATA q<>+40(SB)/8, $0xaf73a7e92436f832
DATA q<>+48(SB)/8, $0x7296eb78f10174c1
DATA q<>+56(SB)/8, $0xdd990e82e4ed3bd6
DATA q<>+64(SB)/8, $0x6a0a9d70e0e93f4a
DATA q<>+72(SB)/8, $0x0000000000000006
GLOBL q<>(SB), (RODATA+NOPTR), $80

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x865e7d5eda7da603
