...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x24392d43fe374b55, R13
	ADDQ R13, AX
	MOVQ $0xfcafb57cb98b1d1d, R13
	ADCQ R13, DX
	MOVQ $0x8025971067da7061, R13
	ADCQ R13, CX
	MOVQ $0x5fe036871081c71c, R13
	ADCQ R13, BX
	MOVQ $0xaf04a82ca7aae498, R13
	ADCQ R13, SI
	MOVQ $0xaf73a7e92436f832, R13
	ADCQ R13, DI
	MOVQ $0x7296eb78f10174c1, R13
	ADCQ R13, R8
	MOVQ $0xdd990e82e4ed3bd6, R13
	ADCQ R13, R9
	MOVQ $0x6a0a9d70e0e93f4a, R13
	ADCQ R13, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x24392d43fe374b55, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xfcafb57cb98b1d1d, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x8025971067da7061, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x5fe036871081c71c, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xaf04a82ca7aae498, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xaf73a7e92436f832, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x7296eb78f10174c1, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xdd990e82e4ed3bd6, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x6a0a9d70e0e93f4a, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000000000006, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x24392d43fe374b55, AX
	ADDQ AX, DX
	MOVQ $0xfcafb57cb98b1d1d, AX
	ADCQ AX, CX
	MOVQ $0x8025971067da7061, AX
	ADCQ AX, BX
	MOVQ $0x5fe036871081c71c, AX
	ADCQ AX, SI
	MOVQ $0xaf04a82ca7aae498, AX
	ADCQ AX, DI
	MOVQ $0xaf73a7e92436f832, AX
	ADCQ AX, R8
	MOVQ $0x7296eb78f10174c1, AX
	ADCQ AX, R9
	MOVQ $0xdd990e82e4ed3bd6, AX
	ADCQ AX, R10
	MOVQ $0x6a0a9d70e0e93f4a, AX
	ADCQ AX, R11
