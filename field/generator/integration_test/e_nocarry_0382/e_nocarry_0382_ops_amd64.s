...
// modulus q
DATA q<>+0(SB)/8, $0x36c82f81a7acff37
DATA q<>+8(SB)/8, $0xa54f5ca91e7ea071
DATA q<>+16(SB)/8, $0xe9c9d7acdb406a74
DATA q<>+24(SB)/8, $0x70e5143fdc795796
DATA q<>+32(SB)/8, $0xc833843c67412ae3
DATA q<>+40(SB)/8, $0x3c4a8218af9432b0
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x4d859b0119a91979
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x36c82f81a7acff37, R10
	MOVQ    $0xa54f5ca91e7ea071, R11
	MOVQ    $0xe9c9d7acdb406a74, R12
	MOVQ    $0x70e5143fdc795796, R13
	MOVQ    $0xc833843c67412ae3, R14
	MOVQ    $0x3c4a8218af9432b0, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xa54f5ca91e7ea071, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xe9c9d7acdb406a74, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x70e5143fdc795796, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xc833843c67412ae3, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x3c4a8218af9432b0, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x36c82f81a7acff37, CX
	MOVQ    $0xa54f5ca91e7ea071, BX
	MOVQ    $0xe9c9d7acdb406a74, SI
	MOVQ    $0x70e5143fdc795796, DI
	MOVQ    $0xc833843c67412ae3, R8
	MOVQ    $0x3c4a8218af9432b0, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
