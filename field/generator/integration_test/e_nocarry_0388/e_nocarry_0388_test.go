...
var benchRese_nocarry_0388 e_nocarry_0388

func BenchmarkE_nocarry_0388SetBytes(b *testing.B) {
	var x e_nocarry_0388
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0388MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0388.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0388)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0388)
		}
	})
}

func BenchmarkE_nocarry_0388Inverse(b *testing.B) {
	var x e_nocarry_0388
	x.SetRandom()
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0388Butterfly(b *testing.B) {
	var x e_nocarry_0388
	x.SetRandom()
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0388)
	}
}

func BenchmarkE_nocarry_0388Exp(b *testing.B) {
	var x e_nocarry_0388
	x.SetRandom()
	benchRese_nocarry_0388.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0388Double(b *testing.B) {
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Double(&benchRese_nocarry_0388)
	}
}

func BenchmarkE_nocarry_0388Add(b *testing.B) {
	var x e_nocarry_0388
	x.SetRandom()
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Add(&x, &benchRese_nocarry_0388)
	}
}

func BenchmarkE_nocarry_0388Sub(b *testing.B) {
	var x e_nocarry_0388
	x.SetRandom()
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Sub(&x, &benchRese_nocarry_0388)
	}
}

func BenchmarkE_nocarry_0388Neg(b *testing.B) {
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Neg(&benchRese_nocarry_0388)
	}
}

func BenchmarkE_nocarry_0388Div(b *testing.B) {
	var x e_nocarry_0388
	x.SetRandom()
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Div(&x, &benchRese_nocarry_0388)
	}
}

func BenchmarkE_nocarry_0388FromMont(b *testing.B) {
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.FromMont()
	}
}

func BenchmarkE_nocarry_0388ToMont(b *testing.B) {
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.ToMont()
	}
}
func BenchmarkE_nocarry_0388Square(b *testing.B) {
	benchRese_nocarry_0388.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Square(&benchRese_nocarry_0388)
	}
}

func BenchmarkE_nocarry_0388Sqrt(b *testing.B) {
	var a e_nocarry_0388
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0388Mul(b *testing.B) {
	x := e_nocarry_0388{
		8572495147367977713,
		5495396755651971328,
		3738386176503498676,
	...
	benchRese_nocarry_0388.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Mul(&benchRese_nocarry_0388, &x)
	}
}

func BenchmarkE_nocarry_0388Cmp(b *testing.B) {
	x := e_nocarry_0388{
		8572495147367977713,
		5495396755651971328,
		3738386176503498676,
	...
	benchRese_nocarry_0388 = x
	benchRese_nocarry_0388[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0388.Cmp(&x)
	}
}

func TestE_nocarry_0388Cmp(t *testing.T) {
	var x, y e_nocarry_0388
...
func TestE_nocarry_0388IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0388
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0388

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0388{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0388
	one.SetOne()
	e.Sub(&qe_nocarry_0388, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0388{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0388{0, uint64(i)})
	}
...
func TestE_nocarry_0388NegZero(t *testing.T) {
	var a, b e_nocarry_0388
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0388Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0388, len(staticTestValues))
...
func TestE_nocarry_0388Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0388) bool {
			var b e_nocarry_0388
...
func TestE_nocarry_0388InverseExp(t *testing.T) {
...
func TestE_nocarry_0388MulByConstants(t *testing.T) {
...
func TestE_nocarry_0388Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0388) bool {
...
func TestE_nocarry_0388LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0388Halve(t *testing.T) {
...
func TestE_nocarry_0388FromMont(t *testing.T) {
...
type testPaire_nocarry_0388 struct {
	element e_nocarry_0388
	bigint  big.Int
}

func (z *e_nocarry_0388) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0388[6] {
		return true
	}
	if z[6] < qe_nocarry_0388[6] {
		return false
	...
	return z[0] >= qe_nocarry_0388[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0388

		g.element = e_nocarry_0388{
		...
		if qe_nocarry_0388[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0388[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0388 {
			var g e_nocarry_0388
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0388[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0388[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0388[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0388[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0388[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0388[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0388[6], carry)
...
func Benchmarke_nocarry_0388InverseNew(b *testing.B) {
	var x e_nocarry_0388
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0388
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0388
		var xInv e_nocarry_0388
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0388
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0388
...
func testLinearComb(t *testing.T, x *e_nocarry_0388, xC int64, y *e_nocarry_0388, yC int64) {
	...
	var z e_nocarry_0388
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0388, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0388
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0388, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0388
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0388, xHi uint64) {
	var res e_nocarry_0388
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0388) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0388) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0388, c int64, result *e_nocarry_0388, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0388) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0388) uint64 {
