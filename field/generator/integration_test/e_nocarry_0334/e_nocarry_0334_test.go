...
var benchRese_nocarry_0334 e_nocarry_0334

func BenchmarkE_nocarry_0334SetBytes(b *testing.B) {
	var x e_nocarry_0334
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0334MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0334.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0334)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0334)
		}
	})
}

func BenchmarkE_nocarry_0334Inverse(b *testing.B) {
	var x e_nocarry_0334
	x.SetRandom()
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0334Butterfly(b *testing.B) {
	var x e_nocarry_0334
	x.SetRandom()
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0334)
	}
}

func BenchmarkE_nocarry_0334Exp(b *testing.B) {
	var x e_nocarry_0334
	x.SetRandom()
	benchRese_nocarry_0334.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0334Double(b *testing.B) {
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Double(&benchRese_nocarry_0334)
	}
}

func BenchmarkE_nocarry_0334Add(b *testing.B) {
	var x e_nocarry_0334
	x.SetRandom()
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Add(&x, &benchRese_nocarry_0334)
	}
}

func BenchmarkE_nocarry_0334Sub(b *testing.B) {
	var x e_nocarry_0334
	x.SetRandom()
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Sub(&x, &benchRese_nocarry_0334)
	}
}

func BenchmarkE_nocarry_0334Neg(b *testing.B) {
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Neg(&benchRese_nocarry_0334)
	}
}

func BenchmarkE_nocarry_0334Div(b *testing.B) {
	var x e_nocarry_0334
	x.SetRandom()
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Div(&x, &benchRese_nocarry_0334)
	}
}

func BenchmarkE_nocarry_0334FromMont(b *testing.B) {
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.FromMont()
	}
}

func BenchmarkE_nocarry_0334ToMont(b *testing.B) {
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.ToMont()
	}
}
func BenchmarkE_nocarry_0334Square(b *testing.B) {
	benchRese_nocarry_0334.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Square(&benchRese_nocarry_0334)
	}
}

func BenchmarkE_nocarry_0334Sqrt(b *testing.B) {
	var a e_nocarry_0334
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0334Mul(b *testing.B) {
	x := e_nocarry_0334{
	...
	benchRese_nocarry_0334.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Mul(&benchRese_nocarry_0334, &x)
	}
}

func BenchmarkE_nocarry_0334Cmp(b *testing.B) {
	x := e_nocarry_0334{
		12241369628291041657,
		4233655303097155358,
		17097818606681660623,
	...
	benchRese_nocarry_0334 = x
	benchRese_nocarry_0334[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0334.Cmp(&x)
	}
}

func TestE_nocarry_0334Cmp(t *testing.T) {
	var x, y e_nocarry_0334
...
func TestE_nocarry_0334IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0334
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0334

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0334{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0334
	one.SetOne()
	e.Sub(&qe_nocarry_0334, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0334{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0334{0, uint64(i)})
	}
...
func TestE_nocarry_0334NegZero(t *testing.T) {
	var a, b e_nocarry_0334
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0334Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0334, len(staticTestValues))
...
func TestE_nocarry_0334Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0334) bool {
			var b e_nocarry_0334
...
func TestE_nocarry_0334InverseExp(t *testing.T) {
...
func TestE_nocarry_0334MulByConstants(t *testing.T) {
...
func TestE_nocarry_0334Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0334) bool {
...
func TestE_nocarry_0334LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0334Halve(t *testing.T) {
...
func TestE_nocarry_0334FromMont(t *testing.T) {
...
type testPaire_nocarry_0334 struct {
	element e_nocarry_0334
	bigint  big.Int
}

func (z *e_nocarry_0334) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0334[5] {
		return true
	}
	if z[5] < qe_nocarry_0334[5] {
		return false
	...
	return z[0] >= qe_nocarry_0334[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0334

		g.element = e_nocarry_0334{
		...
		if qe_nocarry_0334[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0334[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0334 {
			var g e_nocarry_0334
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0334[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0334[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0334[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0334[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0334[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0334[5], carry)
...
func Benchmarke_nocarry_0334InverseNew(b *testing.B) {
	var x e_nocarry_0334
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0334
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0334
		var xInv e_nocarry_0334
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0334
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0334
...
func testLinearComb(t *testing.T, x *e_nocarry_0334, xC int64, y *e_nocarry_0334, yC int64) {
	...
	var z e_nocarry_0334
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0334, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0334
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0334, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0334
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0334, xHi uint64) {
	var res e_nocarry_0334
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0334) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0334) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0334, c int64, result *e_nocarry_0334, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0334) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0334) uint64 {
