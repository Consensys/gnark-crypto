...
// modulus q
DATA q<>+0(SB)/8, $0xd87cd72e356e7943
DATA q<>+8(SB)/8, $0xccc178192cfa5b12
DATA q<>+16(SB)/8, $0x50e27d7e3005904a
DATA q<>+24(SB)/8, $0xaf400b4319c0c931
DATA q<>+32(SB)/8, $0x75bd63f53a15a03b
DATA q<>+40(SB)/8, $0x0000000000003978
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0485772f26622495
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xd87cd72e356e7943, R10
	MOVQ    $0xccc178192cfa5b12, R11
	MOVQ    $0x50e27d7e3005904a, R12
	MOVQ    $0xaf400b4319c0c931, R13
	MOVQ    $0x75bd63f53a15a03b, R14
	MOVQ    $0x0000000000003978, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xccc178192cfa5b12, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x50e27d7e3005904a, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xaf400b4319c0c931, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x75bd63f53a15a03b, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000000003978, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xd87cd72e356e7943, CX
	MOVQ    $0xccc178192cfa5b12, BX
	MOVQ    $0x50e27d7e3005904a, SI
	MOVQ    $0xaf400b4319c0c931, DI
	MOVQ    $0x75bd63f53a15a03b, R8
	MOVQ    $0x0000000000003978, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
