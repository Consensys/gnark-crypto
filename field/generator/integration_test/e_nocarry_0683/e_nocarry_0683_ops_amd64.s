...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x1f1abb4bff936387, R14
	ADDQ R14, AX
	MOVQ $0xe2a94f75e72628c8, R14
	ADCQ R14, DX
	MOVQ $0x0c8ef8fde9542db4, R14
	ADCQ R14, CX
	MOVQ $0xec6f490fe63217de, R14
	ADCQ R14, BX
	MOVQ $0x233ef3411cbdfcb8, R14
	ADCQ R14, SI
	MOVQ $0x13e2bbd47b9c74f9, R14
	ADCQ R14, DI
	MOVQ $0xed4bbca16e9578af, R14
	ADCQ R14, R8
	MOVQ $0x4a9caf12de838802, R14
	ADCQ R14, R9
	MOVQ $0xc6a64f7a991e5416, R14
	ADCQ R14, R10
	MOVQ $0x015342fe158af4fc, R14
	ADCQ R14, R11
	MOVQ $0x0000061bcb6b5ccf, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x1f1abb4bff936387, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xe2a94f75e72628c8, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x0c8ef8fde9542db4, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xec6f490fe63217de, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x233ef3411cbdfcb8, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x13e2bbd47b9c74f9, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xed4bbca16e9578af, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x4a9caf12de838802, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xc6a64f7a991e5416, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x015342fe158af4fc, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000061bcb6b5ccf, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x1f1abb4bff936387, AX
	ADDQ AX, DX
	MOVQ $0xe2a94f75e72628c8, AX
	ADCQ AX, CX
	MOVQ $0x0c8ef8fde9542db4, AX
	ADCQ AX, BX
	MOVQ $0xec6f490fe63217de, AX
	ADCQ AX, SI
	MOVQ $0x233ef3411cbdfcb8, AX
	ADCQ AX, DI
	MOVQ $0x13e2bbd47b9c74f9, AX
	ADCQ AX, R8
	MOVQ $0xed4bbca16e9578af, AX
	ADCQ AX, R9
	MOVQ $0x4a9caf12de838802, AX
	ADCQ AX, R10
	MOVQ $0xc6a64f7a991e5416, AX
	ADCQ AX, R11
	MOVQ $0x015342fe158af4fc, AX
	ADCQ AX, R12
	MOVQ $0x0000061bcb6b5ccf, AX
	ADCQ AX, R13
