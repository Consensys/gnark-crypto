...
var benchRese_nocarry_0683 e_nocarry_0683

func BenchmarkE_nocarry_0683SetBytes(b *testing.B) {
	var x e_nocarry_0683
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0683MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0683.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0683)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0683)
		}
	})
}

func BenchmarkE_nocarry_0683Inverse(b *testing.B) {
	var x e_nocarry_0683
	x.SetRandom()
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0683Butterfly(b *testing.B) {
	var x e_nocarry_0683
	x.SetRandom()
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0683)
	}
}

func BenchmarkE_nocarry_0683Exp(b *testing.B) {
	var x e_nocarry_0683
	x.SetRandom()
	benchRese_nocarry_0683.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0683Double(b *testing.B) {
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Double(&benchRese_nocarry_0683)
	}
}

func BenchmarkE_nocarry_0683Add(b *testing.B) {
	var x e_nocarry_0683
	x.SetRandom()
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Add(&x, &benchRese_nocarry_0683)
	}
}

func BenchmarkE_nocarry_0683Sub(b *testing.B) {
	var x e_nocarry_0683
	x.SetRandom()
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Sub(&x, &benchRese_nocarry_0683)
	}
}

func BenchmarkE_nocarry_0683Neg(b *testing.B) {
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Neg(&benchRese_nocarry_0683)
	}
}

func BenchmarkE_nocarry_0683Div(b *testing.B) {
	var x e_nocarry_0683
	x.SetRandom()
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Div(&x, &benchRese_nocarry_0683)
	}
}

func BenchmarkE_nocarry_0683FromMont(b *testing.B) {
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.FromMont()
	}
}

func BenchmarkE_nocarry_0683ToMont(b *testing.B) {
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.ToMont()
	}
}
func BenchmarkE_nocarry_0683Square(b *testing.B) {
	benchRese_nocarry_0683.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Square(&benchRese_nocarry_0683)
	}
}

func BenchmarkE_nocarry_0683Sqrt(b *testing.B) {
	var a e_nocarry_0683
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0683Mul(b *testing.B) {
	x := e_nocarry_0683{
		845566540673486467,
		1245456394879086062,
	...
	benchRese_nocarry_0683.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Mul(&benchRese_nocarry_0683, &x)
	}
}

func BenchmarkE_nocarry_0683Cmp(b *testing.B) {
	x := e_nocarry_0683{
		845566540673486467,
		1245456394879086062,
		12760022885565773271,
	...
	benchRese_nocarry_0683 = x
	benchRese_nocarry_0683[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0683.Cmp(&x)
	}
}

func TestE_nocarry_0683Cmp(t *testing.T) {
	var x, y e_nocarry_0683
...
func TestE_nocarry_0683IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0683
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0683

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0683{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0683
	one.SetOne()
	e.Sub(&qe_nocarry_0683, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0683{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0683{0, uint64(i)})
	}
...
func TestE_nocarry_0683NegZero(t *testing.T) {
	var a, b e_nocarry_0683
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0683Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0683, len(staticTestValues))
...
func TestE_nocarry_0683Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0683) bool {
			var b e_nocarry_0683
...
func TestE_nocarry_0683InverseExp(t *testing.T) {
...
func TestE_nocarry_0683MulByConstants(t *testing.T) {
...
func TestE_nocarry_0683Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0683) bool {
...
func TestE_nocarry_0683LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0683Halve(t *testing.T) {
...
func TestE_nocarry_0683FromMont(t *testing.T) {
...
type testPaire_nocarry_0683 struct {
	element e_nocarry_0683
	bigint  big.Int
}

func (z *e_nocarry_0683) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0683[10] {
		return true
	}
	if z[10] < qe_nocarry_0683[10] {
		return false
	...
	return z[0] >= qe_nocarry_0683[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0683

		g.element = e_nocarry_0683{
		...
		if qe_nocarry_0683[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0683[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0683 {
			var g e_nocarry_0683
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0683[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0683[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0683[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0683[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0683[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0683[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0683[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0683[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0683[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0683[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0683[10], carry)
...
func Benchmarke_nocarry_0683InverseNew(b *testing.B) {
	var x e_nocarry_0683
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0683
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0683
		var xInv e_nocarry_0683
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0683
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0683
...
func testLinearComb(t *testing.T, x *e_nocarry_0683, xC int64, y *e_nocarry_0683, yC int64) {
	...
	var z e_nocarry_0683
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0683, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0683
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0683, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0683
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0683, xHi uint64) {
	var res e_nocarry_0683
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0683) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0683) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0683, c int64, result *e_nocarry_0683, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0683) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0683) uint64 {
