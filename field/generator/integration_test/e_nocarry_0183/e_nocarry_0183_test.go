...
var benchRese_nocarry_0183 e_nocarry_0183

func BenchmarkE_nocarry_0183SetBytes(b *testing.B) {
	var x e_nocarry_0183
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0183MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0183.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0183)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0183)
		}
	})
}

func BenchmarkE_nocarry_0183Inverse(b *testing.B) {
	var x e_nocarry_0183
	x.SetRandom()
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0183Butterfly(b *testing.B) {
	var x e_nocarry_0183
	x.SetRandom()
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0183)
	}
}

func BenchmarkE_nocarry_0183Exp(b *testing.B) {
	var x e_nocarry_0183
	x.SetRandom()
	benchRese_nocarry_0183.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0183Double(b *testing.B) {
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Double(&benchRese_nocarry_0183)
	}
}

func BenchmarkE_nocarry_0183Add(b *testing.B) {
	var x e_nocarry_0183
	x.SetRandom()
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Add(&x, &benchRese_nocarry_0183)
	}
}

func BenchmarkE_nocarry_0183Sub(b *testing.B) {
	var x e_nocarry_0183
	x.SetRandom()
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Sub(&x, &benchRese_nocarry_0183)
	}
}

func BenchmarkE_nocarry_0183Neg(b *testing.B) {
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Neg(&benchRese_nocarry_0183)
	}
}

func BenchmarkE_nocarry_0183Div(b *testing.B) {
	var x e_nocarry_0183
	x.SetRandom()
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Div(&x, &benchRese_nocarry_0183)
	}
}

func BenchmarkE_nocarry_0183FromMont(b *testing.B) {
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.FromMont()
	}
}

func BenchmarkE_nocarry_0183ToMont(b *testing.B) {
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.ToMont()
	}
}
func BenchmarkE_nocarry_0183Square(b *testing.B) {
	benchRese_nocarry_0183.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Square(&benchRese_nocarry_0183)
	}
}

func BenchmarkE_nocarry_0183Sqrt(b *testing.B) {
	var a e_nocarry_0183
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0183Mul(b *testing.B) {
	x := e_nocarry_0183{
		17722265556000184308,
		12461154484880017319,
		30945281356930925,
	}
	benchRese_nocarry_0183.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Mul(&benchRese_nocarry_0183, &x)
	}
}

func BenchmarkE_nocarry_0183Cmp(b *testing.B) {
	x := e_nocarry_0183{
		17722265556000184308,
		12461154484880017319,
		30945281356930925,
	}
	benchRese_nocarry_0183 = x
	benchRese_nocarry_0183[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0183.Cmp(&x)
	}
}

func TestE_nocarry_0183Cmp(t *testing.T) {
	var x, y e_nocarry_0183
...
func TestE_nocarry_0183IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0183
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0183

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0183{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0183
	one.SetOne()
	e.Sub(&qe_nocarry_0183, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0183{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0183{0, uint64(i)})
	}
...
func TestE_nocarry_0183NegZero(t *testing.T) {
	var a, b e_nocarry_0183
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0183Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0183, len(staticTestValues))
...
func TestE_nocarry_0183Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0183) bool {
			var b e_nocarry_0183
...
func TestE_nocarry_0183InverseExp(t *testing.T) {
...
func TestE_nocarry_0183MulByConstants(t *testing.T) {
...
func TestE_nocarry_0183Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0183) bool {
...
func TestE_nocarry_0183LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0183Halve(t *testing.T) {
...
func TestE_nocarry_0183FromMont(t *testing.T) {
...
type testPaire_nocarry_0183 struct {
	element e_nocarry_0183
	bigint  big.Int
}

func (z *e_nocarry_0183) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0183[2] {
		return true
	}
	if z[2] < qe_nocarry_0183[2] {
		return false
	...
	return z[0] >= qe_nocarry_0183[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0183

		g.element = e_nocarry_0183{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0183[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0183[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0183 {
			var g e_nocarry_0183
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0183[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0183[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0183[2], carry)
...
func Benchmarke_nocarry_0183InverseNew(b *testing.B) {
	var x e_nocarry_0183
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0183
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0183
		var xInv e_nocarry_0183
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0183
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0183
...
func testLinearComb(t *testing.T, x *e_nocarry_0183, xC int64, y *e_nocarry_0183, yC int64) {
	...
	var z e_nocarry_0183
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0183, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0183
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0183, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0183
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0183, xHi uint64) {
	var res e_nocarry_0183
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0183) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0183) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0183, c int64, result *e_nocarry_0183, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0183) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0183) uint64 {
