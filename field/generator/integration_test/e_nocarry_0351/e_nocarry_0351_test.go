...
var benchRese_nocarry_0351 e_nocarry_0351

func BenchmarkE_nocarry_0351SetBytes(b *testing.B) {
	var x e_nocarry_0351
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0351MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0351.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0351)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0351)
		}
	})
}

func BenchmarkE_nocarry_0351Inverse(b *testing.B) {
	var x e_nocarry_0351
	x.SetRandom()
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0351Butterfly(b *testing.B) {
	var x e_nocarry_0351
	x.SetRandom()
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0351)
	}
}

func BenchmarkE_nocarry_0351Exp(b *testing.B) {
	var x e_nocarry_0351
	x.SetRandom()
	benchRese_nocarry_0351.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0351Double(b *testing.B) {
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Double(&benchRese_nocarry_0351)
	}
}

func BenchmarkE_nocarry_0351Add(b *testing.B) {
	var x e_nocarry_0351
	x.SetRandom()
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Add(&x, &benchRese_nocarry_0351)
	}
}

func BenchmarkE_nocarry_0351Sub(b *testing.B) {
	var x e_nocarry_0351
	x.SetRandom()
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Sub(&x, &benchRese_nocarry_0351)
	}
}

func BenchmarkE_nocarry_0351Neg(b *testing.B) {
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Neg(&benchRese_nocarry_0351)
	}
}

func BenchmarkE_nocarry_0351Div(b *testing.B) {
	var x e_nocarry_0351
	x.SetRandom()
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Div(&x, &benchRese_nocarry_0351)
	}
}

func BenchmarkE_nocarry_0351FromMont(b *testing.B) {
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.FromMont()
	}
}

func BenchmarkE_nocarry_0351ToMont(b *testing.B) {
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.ToMont()
	}
}
func BenchmarkE_nocarry_0351Square(b *testing.B) {
	benchRese_nocarry_0351.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Square(&benchRese_nocarry_0351)
	}
}

func BenchmarkE_nocarry_0351Sqrt(b *testing.B) {
	var a e_nocarry_0351
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0351Mul(b *testing.B) {
	x := e_nocarry_0351{
		8594118172250033454,
	...
	benchRese_nocarry_0351.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Mul(&benchRese_nocarry_0351, &x)
	}
}

func BenchmarkE_nocarry_0351Cmp(b *testing.B) {
	x := e_nocarry_0351{
		8594118172250033454,
		17067261987036682070,
		13901925105474960967,
	...
	benchRese_nocarry_0351 = x
	benchRese_nocarry_0351[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0351.Cmp(&x)
	}
}

func TestE_nocarry_0351Cmp(t *testing.T) {
	var x, y e_nocarry_0351
...
func TestE_nocarry_0351IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0351
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0351

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0351{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0351
	one.SetOne()
	e.Sub(&qe_nocarry_0351, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0351{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0351{0, uint64(i)})
	}
...
func TestE_nocarry_0351NegZero(t *testing.T) {
	var a, b e_nocarry_0351
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0351Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0351, len(staticTestValues))
...
func TestE_nocarry_0351Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0351) bool {
			var b e_nocarry_0351
...
func TestE_nocarry_0351InverseExp(t *testing.T) {
...
func TestE_nocarry_0351MulByConstants(t *testing.T) {
...
func TestE_nocarry_0351Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0351) bool {
...
func TestE_nocarry_0351LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0351Halve(t *testing.T) {
...
func TestE_nocarry_0351FromMont(t *testing.T) {
...
type testPaire_nocarry_0351 struct {
	element e_nocarry_0351
	bigint  big.Int
}

func (z *e_nocarry_0351) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0351[5] {
		return true
	}
	if z[5] < qe_nocarry_0351[5] {
		return false
	...
	return z[0] >= qe_nocarry_0351[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0351

		g.element = e_nocarry_0351{
		...
		if qe_nocarry_0351[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0351[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0351 {
			var g e_nocarry_0351
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0351[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0351[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0351[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0351[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0351[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0351[5], carry)
...
func Benchmarke_nocarry_0351InverseNew(b *testing.B) {
	var x e_nocarry_0351
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0351
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0351
		var xInv e_nocarry_0351
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0351
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0351
...
func testLinearComb(t *testing.T, x *e_nocarry_0351, xC int64, y *e_nocarry_0351, yC int64) {
	...
	var z e_nocarry_0351
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0351, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0351
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0351, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0351
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0351, xHi uint64) {
	var res e_nocarry_0351
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0351) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0351) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0351, c int64, result *e_nocarry_0351, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0351) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0351) uint64 {
