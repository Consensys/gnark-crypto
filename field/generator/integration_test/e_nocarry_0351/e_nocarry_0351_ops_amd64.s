...
// modulus q
DATA q<>+0(SB)/8, $0x2f35f69a0a8802cd
DATA q<>+8(SB)/8, $0x78c3cd23966ca8d4
DATA q<>+16(SB)/8, $0x9d618a49c200922c
DATA q<>+24(SB)/8, $0x63a659fb5300b7bd
DATA q<>+32(SB)/8, $0xd332031a6b284b49
DATA q<>+40(SB)/8, $0x000000006f38ee33
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x3d0c2444bb7445fb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x2f35f69a0a8802cd, R10
	MOVQ    $0x78c3cd23966ca8d4, R11
	MOVQ    $0x9d618a49c200922c, R12
	MOVQ    $0x63a659fb5300b7bd, R13
	MOVQ    $0xd332031a6b284b49, R14
	MOVQ    $0x000000006f38ee33, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x78c3cd23966ca8d4, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x9d618a49c200922c, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x63a659fb5300b7bd, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xd332031a6b284b49, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000006f38ee33, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x2f35f69a0a8802cd, CX
	MOVQ    $0x78c3cd23966ca8d4, BX
	MOVQ    $0x9d618a49c200922c, SI
	MOVQ    $0x63a659fb5300b7bd, DI
	MOVQ    $0xd332031a6b284b49, R8
	MOVQ    $0x000000006f38ee33, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
