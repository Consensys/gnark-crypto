...
var benchRese_nocarry_0209 e_nocarry_0209

func BenchmarkE_nocarry_0209SetBytes(b *testing.B) {
	var x e_nocarry_0209
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0209MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0209.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0209)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0209)
		}
	})
}

func BenchmarkE_nocarry_0209Inverse(b *testing.B) {
	var x e_nocarry_0209
	x.SetRandom()
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0209Butterfly(b *testing.B) {
	var x e_nocarry_0209
	x.SetRandom()
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0209)
	}
}

func BenchmarkE_nocarry_0209Exp(b *testing.B) {
	var x e_nocarry_0209
	x.SetRandom()
	benchRese_nocarry_0209.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0209Double(b *testing.B) {
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Double(&benchRese_nocarry_0209)
	}
}

func BenchmarkE_nocarry_0209Add(b *testing.B) {
	var x e_nocarry_0209
	x.SetRandom()
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Add(&x, &benchRese_nocarry_0209)
	}
}

func BenchmarkE_nocarry_0209Sub(b *testing.B) {
	var x e_nocarry_0209
	x.SetRandom()
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Sub(&x, &benchRese_nocarry_0209)
	}
}

func BenchmarkE_nocarry_0209Neg(b *testing.B) {
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Neg(&benchRese_nocarry_0209)
	}
}

func BenchmarkE_nocarry_0209Div(b *testing.B) {
	var x e_nocarry_0209
	x.SetRandom()
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Div(&x, &benchRese_nocarry_0209)
	}
}

func BenchmarkE_nocarry_0209FromMont(b *testing.B) {
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.FromMont()
	}
}

func BenchmarkE_nocarry_0209ToMont(b *testing.B) {
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.ToMont()
	}
}
func BenchmarkE_nocarry_0209Square(b *testing.B) {
	benchRese_nocarry_0209.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Square(&benchRese_nocarry_0209)
	}
}

func BenchmarkE_nocarry_0209Sqrt(b *testing.B) {
	var a e_nocarry_0209
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0209Mul(b *testing.B) {
	x := e_nocarry_0209{
	...
	benchRese_nocarry_0209.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Mul(&benchRese_nocarry_0209, &x)
	}
}

func BenchmarkE_nocarry_0209Cmp(b *testing.B) {
	x := e_nocarry_0209{
		10374834296118319725,
		9556210024731912432,
		9421786653853786766,
	...
	benchRese_nocarry_0209 = x
	benchRese_nocarry_0209[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0209.Cmp(&x)
	}
}

func TestE_nocarry_0209Cmp(t *testing.T) {
	var x, y e_nocarry_0209
...
func TestE_nocarry_0209IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0209
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0209

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0209{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0209
	one.SetOne()
	e.Sub(&qe_nocarry_0209, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0209{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0209{0, uint64(i)})
	}
...
func TestE_nocarry_0209NegZero(t *testing.T) {
	var a, b e_nocarry_0209
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0209Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0209, len(staticTestValues))
...
func TestE_nocarry_0209Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0209) bool {
			var b e_nocarry_0209
...
func TestE_nocarry_0209InverseExp(t *testing.T) {
...
func TestE_nocarry_0209MulByConstants(t *testing.T) {
...
func TestE_nocarry_0209Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0209) bool {
...
func TestE_nocarry_0209LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0209Halve(t *testing.T) {
...
func TestE_nocarry_0209FromMont(t *testing.T) {
...
type testPaire_nocarry_0209 struct {
	element e_nocarry_0209
	bigint  big.Int
}

func (z *e_nocarry_0209) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0209[3] {
		return true
	}
	if z[3] < qe_nocarry_0209[3] {
		return false
	...
	return z[0] >= qe_nocarry_0209[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0209

		g.element = e_nocarry_0209{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0209[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0209[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0209 {
			var g e_nocarry_0209
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0209[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0209[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0209[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0209[3], carry)
...
func Benchmarke_nocarry_0209InverseNew(b *testing.B) {
	var x e_nocarry_0209
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0209
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0209
		var xInv e_nocarry_0209
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0209
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0209
...
func testLinearComb(t *testing.T, x *e_nocarry_0209, xC int64, y *e_nocarry_0209, yC int64) {
	...
	var z e_nocarry_0209
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0209, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0209
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0209, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0209
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0209, xHi uint64) {
	var res e_nocarry_0209
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0209) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0209) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0209, c int64, result *e_nocarry_0209, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0209) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0209) uint64 {
