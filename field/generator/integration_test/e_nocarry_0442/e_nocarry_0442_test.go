...
var benchRese_nocarry_0442 e_nocarry_0442

func BenchmarkE_nocarry_0442SetBytes(b *testing.B) {
	var x e_nocarry_0442
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0442MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0442.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0442)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0442)
		}
	})
}

func BenchmarkE_nocarry_0442Inverse(b *testing.B) {
	var x e_nocarry_0442
	x.SetRandom()
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0442Butterfly(b *testing.B) {
	var x e_nocarry_0442
	x.SetRandom()
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0442)
	}
}

func BenchmarkE_nocarry_0442Exp(b *testing.B) {
	var x e_nocarry_0442
	x.SetRandom()
	benchRese_nocarry_0442.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0442Double(b *testing.B) {
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Double(&benchRese_nocarry_0442)
	}
}

func BenchmarkE_nocarry_0442Add(b *testing.B) {
	var x e_nocarry_0442
	x.SetRandom()
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Add(&x, &benchRese_nocarry_0442)
	}
}

func BenchmarkE_nocarry_0442Sub(b *testing.B) {
	var x e_nocarry_0442
	x.SetRandom()
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Sub(&x, &benchRese_nocarry_0442)
	}
}

func BenchmarkE_nocarry_0442Neg(b *testing.B) {
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Neg(&benchRese_nocarry_0442)
	}
}

func BenchmarkE_nocarry_0442Div(b *testing.B) {
	var x e_nocarry_0442
	x.SetRandom()
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Div(&x, &benchRese_nocarry_0442)
	}
}

func BenchmarkE_nocarry_0442FromMont(b *testing.B) {
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.FromMont()
	}
}

func BenchmarkE_nocarry_0442ToMont(b *testing.B) {
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.ToMont()
	}
}
func BenchmarkE_nocarry_0442Square(b *testing.B) {
	benchRese_nocarry_0442.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Square(&benchRese_nocarry_0442)
	}
}

func BenchmarkE_nocarry_0442Sqrt(b *testing.B) {
	var a e_nocarry_0442
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0442Mul(b *testing.B) {
	x := e_nocarry_0442{
		2623717854335539497,
	...
	benchRese_nocarry_0442.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Mul(&benchRese_nocarry_0442, &x)
	}
}

func BenchmarkE_nocarry_0442Cmp(b *testing.B) {
	x := e_nocarry_0442{
		2623717854335539497,
		14562076349379852374,
		8893104400205679812,
	...
	benchRese_nocarry_0442 = x
	benchRese_nocarry_0442[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0442.Cmp(&x)
	}
}

func TestE_nocarry_0442Cmp(t *testing.T) {
	var x, y e_nocarry_0442
...
func TestE_nocarry_0442IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0442
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0442

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0442{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0442
	one.SetOne()
	e.Sub(&qe_nocarry_0442, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0442{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0442{0, uint64(i)})
	}
...
func TestE_nocarry_0442NegZero(t *testing.T) {
	var a, b e_nocarry_0442
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0442Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0442, len(staticTestValues))
...
func TestE_nocarry_0442Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0442) bool {
			var b e_nocarry_0442
...
func TestE_nocarry_0442InverseExp(t *testing.T) {
...
func TestE_nocarry_0442MulByConstants(t *testing.T) {
...
func TestE_nocarry_0442Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0442) bool {
...
func TestE_nocarry_0442LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0442Halve(t *testing.T) {
...
func TestE_nocarry_0442FromMont(t *testing.T) {
...
type testPaire_nocarry_0442 struct {
	element e_nocarry_0442
	bigint  big.Int
}

func (z *e_nocarry_0442) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0442[6] {
		return true
	}
	if z[6] < qe_nocarry_0442[6] {
		return false
	...
	return z[0] >= qe_nocarry_0442[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0442

		g.element = e_nocarry_0442{
		...
		if qe_nocarry_0442[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0442[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0442 {
			var g e_nocarry_0442
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0442[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0442[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0442[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0442[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0442[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0442[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0442[6], carry)
...
func Benchmarke_nocarry_0442InverseNew(b *testing.B) {
	var x e_nocarry_0442
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0442
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0442
		var xInv e_nocarry_0442
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0442
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0442
...
func testLinearComb(t *testing.T, x *e_nocarry_0442, xC int64, y *e_nocarry_0442, yC int64) {
	...
	var z e_nocarry_0442
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0442, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0442
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0442, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0442
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0442, xHi uint64) {
	var res e_nocarry_0442
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0442) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0442) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0442, c int64, result *e_nocarry_0442, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0442) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0442) uint64 {
