...
var benchRese_nocarry_0260 e_nocarry_0260

func BenchmarkE_nocarry_0260SetBytes(b *testing.B) {
	var x e_nocarry_0260
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0260MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0260.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0260)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0260)
		}
	})
}

func BenchmarkE_nocarry_0260Inverse(b *testing.B) {
	var x e_nocarry_0260
	x.SetRandom()
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0260Butterfly(b *testing.B) {
	var x e_nocarry_0260
	x.SetRandom()
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0260)
	}
}

func BenchmarkE_nocarry_0260Exp(b *testing.B) {
	var x e_nocarry_0260
	x.SetRandom()
	benchRese_nocarry_0260.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0260Double(b *testing.B) {
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Double(&benchRese_nocarry_0260)
	}
}

func BenchmarkE_nocarry_0260Add(b *testing.B) {
	var x e_nocarry_0260
	x.SetRandom()
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Add(&x, &benchRese_nocarry_0260)
	}
}

func BenchmarkE_nocarry_0260Sub(b *testing.B) {
	var x e_nocarry_0260
	x.SetRandom()
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Sub(&x, &benchRese_nocarry_0260)
	}
}

func BenchmarkE_nocarry_0260Neg(b *testing.B) {
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Neg(&benchRese_nocarry_0260)
	}
}

func BenchmarkE_nocarry_0260Div(b *testing.B) {
	var x e_nocarry_0260
	x.SetRandom()
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Div(&x, &benchRese_nocarry_0260)
	}
}

func BenchmarkE_nocarry_0260FromMont(b *testing.B) {
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.FromMont()
	}
}

func BenchmarkE_nocarry_0260ToMont(b *testing.B) {
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.ToMont()
	}
}
func BenchmarkE_nocarry_0260Square(b *testing.B) {
	benchRese_nocarry_0260.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Square(&benchRese_nocarry_0260)
	}
}

func BenchmarkE_nocarry_0260Sqrt(b *testing.B) {
	var a e_nocarry_0260
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0260Mul(b *testing.B) {
	x := e_nocarry_0260{
		7728828257414723339,
		4134821163617312337,
		3496965936317883250,
	...
	benchRese_nocarry_0260.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Mul(&benchRese_nocarry_0260, &x)
	}
}

func BenchmarkE_nocarry_0260Cmp(b *testing.B) {
	x := e_nocarry_0260{
		7728828257414723339,
		4134821163617312337,
		3496965936317883250,
	...
	benchRese_nocarry_0260 = x
	benchRese_nocarry_0260[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0260.Cmp(&x)
	}
}

func TestE_nocarry_0260Cmp(t *testing.T) {
	var x, y e_nocarry_0260
...
func TestE_nocarry_0260IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0260
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0260

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0260{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0260
	one.SetOne()
	e.Sub(&qe_nocarry_0260, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0260{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0260{0, uint64(i)})
	}
...
func TestE_nocarry_0260NegZero(t *testing.T) {
	var a, b e_nocarry_0260
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0260Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0260, len(staticTestValues))
...
func TestE_nocarry_0260Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0260) bool {
			var b e_nocarry_0260
...
func TestE_nocarry_0260InverseExp(t *testing.T) {
...
func TestE_nocarry_0260MulByConstants(t *testing.T) {
...
func TestE_nocarry_0260Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0260) bool {
...
func TestE_nocarry_0260LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0260Halve(t *testing.T) {
...
func TestE_nocarry_0260FromMont(t *testing.T) {
...
type testPaire_nocarry_0260 struct {
	element e_nocarry_0260
	bigint  big.Int
}

func (z *e_nocarry_0260) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0260[4] {
		return true
	}
	if z[4] < qe_nocarry_0260[4] {
		return false
	...
	return z[0] >= qe_nocarry_0260[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0260

		g.element = e_nocarry_0260{
		...
		if qe_nocarry_0260[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0260[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0260 {
			var g e_nocarry_0260
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0260[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0260[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0260[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0260[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0260[4], carry)
...
func Benchmarke_nocarry_0260InverseNew(b *testing.B) {
	var x e_nocarry_0260
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0260
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0260
		var xInv e_nocarry_0260
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0260
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0260
...
func testLinearComb(t *testing.T, x *e_nocarry_0260, xC int64, y *e_nocarry_0260, yC int64) {
	...
	var z e_nocarry_0260
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0260, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0260
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0260, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0260
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0260, xHi uint64) {
	var res e_nocarry_0260
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0260) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0260) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0260, c int64, result *e_nocarry_0260, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0260) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0260) uint64 {
