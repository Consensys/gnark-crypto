...
// modulus q
DATA q<>+0(SB)/8, $0x798df9fc11a22787
DATA q<>+8(SB)/8, $0x4c58bad840d72112
DATA q<>+16(SB)/8, $0x257e1410aae82f70
DATA q<>+24(SB)/8, $0x8be4952b353ab144
DATA q<>+32(SB)/8, $0x000000000000000e
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x96cf300d3a3911c9
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x798df9fc11a22787, R9
	MOVQ    $0x4c58bad840d72112, R10
	MOVQ    $0x257e1410aae82f70, R11
	MOVQ    $0x8be4952b353ab144, R12
	MOVQ    $0x000000000000000e, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x4c58bad840d72112, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x257e1410aae82f70, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x8be4952b353ab144, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000000000000e, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x798df9fc11a22787, CX
	MOVQ    $0x4c58bad840d72112, BX
	MOVQ    $0x257e1410aae82f70, SI
	MOVQ    $0x8be4952b353ab144, DI
	MOVQ    $0x000000000000000e, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
