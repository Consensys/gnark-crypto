...
var benchRese_nocarry_0468 e_nocarry_0468

func BenchmarkE_nocarry_0468SetBytes(b *testing.B) {
	var x e_nocarry_0468
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0468MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0468.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0468)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0468)
		}
	})
}

func BenchmarkE_nocarry_0468Inverse(b *testing.B) {
	var x e_nocarry_0468
	x.SetRandom()
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0468Butterfly(b *testing.B) {
	var x e_nocarry_0468
	x.SetRandom()
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0468)
	}
}

func BenchmarkE_nocarry_0468Exp(b *testing.B) {
	var x e_nocarry_0468
	x.SetRandom()
	benchRese_nocarry_0468.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0468Double(b *testing.B) {
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Double(&benchRese_nocarry_0468)
	}
}

func BenchmarkE_nocarry_0468Add(b *testing.B) {
	var x e_nocarry_0468
	x.SetRandom()
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Add(&x, &benchRese_nocarry_0468)
	}
}

func BenchmarkE_nocarry_0468Sub(b *testing.B) {
	var x e_nocarry_0468
	x.SetRandom()
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Sub(&x, &benchRese_nocarry_0468)
	}
}

func BenchmarkE_nocarry_0468Neg(b *testing.B) {
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Neg(&benchRese_nocarry_0468)
	}
}

func BenchmarkE_nocarry_0468Div(b *testing.B) {
	var x e_nocarry_0468
	x.SetRandom()
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Div(&x, &benchRese_nocarry_0468)
	}
}

func BenchmarkE_nocarry_0468FromMont(b *testing.B) {
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.FromMont()
	}
}

func BenchmarkE_nocarry_0468ToMont(b *testing.B) {
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.ToMont()
	}
}
func BenchmarkE_nocarry_0468Square(b *testing.B) {
	benchRese_nocarry_0468.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Square(&benchRese_nocarry_0468)
	}
}

func BenchmarkE_nocarry_0468Sqrt(b *testing.B) {
	var a e_nocarry_0468
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0468Mul(b *testing.B) {
	x := e_nocarry_0468{
		2411850770373345338,
	...
	benchRese_nocarry_0468.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Mul(&benchRese_nocarry_0468, &x)
	}
}

func BenchmarkE_nocarry_0468Cmp(b *testing.B) {
	x := e_nocarry_0468{
		2411850770373345338,
		18329655432766660941,
		4385759761430376138,
	...
	benchRese_nocarry_0468 = x
	benchRese_nocarry_0468[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0468.Cmp(&x)
	}
}

func TestE_nocarry_0468Cmp(t *testing.T) {
	var x, y e_nocarry_0468
...
func TestE_nocarry_0468IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0468
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0468

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0468{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0468
	one.SetOne()
	e.Sub(&qe_nocarry_0468, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0468{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0468{0, uint64(i)})
	}
...
func TestE_nocarry_0468NegZero(t *testing.T) {
	var a, b e_nocarry_0468
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0468Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0468, len(staticTestValues))
...
func TestE_nocarry_0468Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0468) bool {
			var b e_nocarry_0468
...
func TestE_nocarry_0468InverseExp(t *testing.T) {
...
func TestE_nocarry_0468MulByConstants(t *testing.T) {
...
func TestE_nocarry_0468Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0468) bool {
...
func TestE_nocarry_0468LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0468Halve(t *testing.T) {
...
func TestE_nocarry_0468FromMont(t *testing.T) {
...
type testPaire_nocarry_0468 struct {
	element e_nocarry_0468
	bigint  big.Int
}

func (z *e_nocarry_0468) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0468[7] {
		return true
	}
	if z[7] < qe_nocarry_0468[7] {
		return false
	...
	return z[0] >= qe_nocarry_0468[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0468

		g.element = e_nocarry_0468{
		...
		if qe_nocarry_0468[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0468[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0468 {
			var g e_nocarry_0468
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0468[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0468[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0468[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0468[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0468[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0468[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0468[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0468[7], carry)
...
func Benchmarke_nocarry_0468InverseNew(b *testing.B) {
	var x e_nocarry_0468
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0468
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0468
		var xInv e_nocarry_0468
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0468
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0468
...
func testLinearComb(t *testing.T, x *e_nocarry_0468, xC int64, y *e_nocarry_0468, yC int64) {
	...
	var z e_nocarry_0468
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0468, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0468
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0468, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0468
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0468, xHi uint64) {
	var res e_nocarry_0468
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0468) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0468) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0468, c int64, result *e_nocarry_0468, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0468) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0468) uint64 {
