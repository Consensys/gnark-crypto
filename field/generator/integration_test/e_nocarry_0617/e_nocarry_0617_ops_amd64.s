...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xa940c2c1502cb2ef, R13
	ADDQ R13, AX
	MOVQ $0xdb8bdb30e358d471, R13
	ADCQ R13, DX
	MOVQ $0xe5f9005b5589e088, R13
	ADCQ R13, CX
	MOVQ $0xd3449f82cbbbc6fc, R13
	ADCQ R13, BX
	MOVQ $0xa75380d1e4b66a96, R13
	ADCQ R13, SI
	MOVQ $0xe4d88c286dc5594b, R13
	ADCQ R13, DI
	MOVQ $0x37489a9a102a9c13, R13
	ADCQ R13, R8
	MOVQ $0xdb207dfb239d6a4b, R13
	ADCQ R13, R9
	MOVQ $0xee3b60b4eee294ce, R13
	ADCQ R13, R10
	MOVQ $0x000001d153a8b0cb, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xa940c2c1502cb2ef, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xdb8bdb30e358d471, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xe5f9005b5589e088, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xd3449f82cbbbc6fc, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xa75380d1e4b66a96, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xe4d88c286dc5594b, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x37489a9a102a9c13, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xdb207dfb239d6a4b, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xee3b60b4eee294ce, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000001d153a8b0cb, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xa940c2c1502cb2ef, AX
	ADDQ AX, DX
	MOVQ $0xdb8bdb30e358d471, AX
	ADCQ AX, CX
	MOVQ $0xe5f9005b5589e088, AX
	ADCQ AX, BX
	MOVQ $0xd3449f82cbbbc6fc, AX
	ADCQ AX, SI
	MOVQ $0xa75380d1e4b66a96, AX
	ADCQ AX, DI
	MOVQ $0xe4d88c286dc5594b, AX
	ADCQ AX, R8
	MOVQ $0x37489a9a102a9c13, AX
	ADCQ AX, R9
	MOVQ $0xdb207dfb239d6a4b, AX
	ADCQ AX, R10
	MOVQ $0xee3b60b4eee294ce, AX
	ADCQ AX, R11
	MOVQ $0x000001d153a8b0cb, AX
	ADCQ AX, R12
