...
var benchRese_nocarry_0617 e_nocarry_0617

func BenchmarkE_nocarry_0617SetBytes(b *testing.B) {
	var x e_nocarry_0617
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0617MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0617.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0617)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0617)
		}
	})
}

func BenchmarkE_nocarry_0617Inverse(b *testing.B) {
	var x e_nocarry_0617
	x.SetRandom()
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0617Butterfly(b *testing.B) {
	var x e_nocarry_0617
	x.SetRandom()
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0617)
	}
}

func BenchmarkE_nocarry_0617Exp(b *testing.B) {
	var x e_nocarry_0617
	x.SetRandom()
	benchRese_nocarry_0617.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0617Double(b *testing.B) {
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Double(&benchRese_nocarry_0617)
	}
}

func BenchmarkE_nocarry_0617Add(b *testing.B) {
	var x e_nocarry_0617
	x.SetRandom()
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Add(&x, &benchRese_nocarry_0617)
	}
}

func BenchmarkE_nocarry_0617Sub(b *testing.B) {
	var x e_nocarry_0617
	x.SetRandom()
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Sub(&x, &benchRese_nocarry_0617)
	}
}

func BenchmarkE_nocarry_0617Neg(b *testing.B) {
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Neg(&benchRese_nocarry_0617)
	}
}

func BenchmarkE_nocarry_0617Div(b *testing.B) {
	var x e_nocarry_0617
	x.SetRandom()
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Div(&x, &benchRese_nocarry_0617)
	}
}

func BenchmarkE_nocarry_0617FromMont(b *testing.B) {
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.FromMont()
	}
}

func BenchmarkE_nocarry_0617ToMont(b *testing.B) {
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.ToMont()
	}
}
func BenchmarkE_nocarry_0617Square(b *testing.B) {
	benchRese_nocarry_0617.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Square(&benchRese_nocarry_0617)
	}
}

func BenchmarkE_nocarry_0617Sqrt(b *testing.B) {
	var a e_nocarry_0617
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0617Mul(b *testing.B) {
	x := e_nocarry_0617{
	...
	benchRese_nocarry_0617.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Mul(&benchRese_nocarry_0617, &x)
	}
}

func BenchmarkE_nocarry_0617Cmp(b *testing.B) {
	x := e_nocarry_0617{
		13916220969493523003,
		11314028090738202680,
		13608104148018988635,
	...
	benchRese_nocarry_0617 = x
	benchRese_nocarry_0617[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0617.Cmp(&x)
	}
}

func TestE_nocarry_0617Cmp(t *testing.T) {
	var x, y e_nocarry_0617
...
func TestE_nocarry_0617IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0617
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0617

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0617{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0617
	one.SetOne()
	e.Sub(&qe_nocarry_0617, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0617{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0617{0, uint64(i)})
	}
...
func TestE_nocarry_0617NegZero(t *testing.T) {
	var a, b e_nocarry_0617
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0617Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0617, len(staticTestValues))
...
func TestE_nocarry_0617Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0617) bool {
			var b e_nocarry_0617
...
func TestE_nocarry_0617InverseExp(t *testing.T) {
...
func TestE_nocarry_0617MulByConstants(t *testing.T) {
...
func TestE_nocarry_0617Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0617) bool {
...
func TestE_nocarry_0617LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0617Halve(t *testing.T) {
...
func TestE_nocarry_0617FromMont(t *testing.T) {
...
type testPaire_nocarry_0617 struct {
	element e_nocarry_0617
	bigint  big.Int
}

func (z *e_nocarry_0617) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0617[9] {
		return true
	}
	if z[9] < qe_nocarry_0617[9] {
		return false
	...
	return z[0] >= qe_nocarry_0617[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0617

		g.element = e_nocarry_0617{
		...
		if qe_nocarry_0617[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0617[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0617 {
			var g e_nocarry_0617
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0617[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0617[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0617[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0617[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0617[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0617[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0617[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0617[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0617[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0617[9], carry)
...
func Benchmarke_nocarry_0617InverseNew(b *testing.B) {
	var x e_nocarry_0617
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0617
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0617
		var xInv e_nocarry_0617
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0617
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0617
...
func testLinearComb(t *testing.T, x *e_nocarry_0617, xC int64, y *e_nocarry_0617, yC int64) {
	...
	var z e_nocarry_0617
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0617, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0617
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0617, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0617
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0617, xHi uint64) {
	var res e_nocarry_0617
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0617) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0617) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0617, c int64, result *e_nocarry_0617, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0617) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0617) uint64 {
