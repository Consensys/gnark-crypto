...
var benchRese_nocarry_0217 e_nocarry_0217

func BenchmarkE_nocarry_0217SetBytes(b *testing.B) {
	var x e_nocarry_0217
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0217MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0217.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0217)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0217)
		}
	})
}

func BenchmarkE_nocarry_0217Inverse(b *testing.B) {
	var x e_nocarry_0217
	x.SetRandom()
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0217Butterfly(b *testing.B) {
	var x e_nocarry_0217
	x.SetRandom()
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0217)
	}
}

func BenchmarkE_nocarry_0217Exp(b *testing.B) {
	var x e_nocarry_0217
	x.SetRandom()
	benchRese_nocarry_0217.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0217Double(b *testing.B) {
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Double(&benchRese_nocarry_0217)
	}
}

func BenchmarkE_nocarry_0217Add(b *testing.B) {
	var x e_nocarry_0217
	x.SetRandom()
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Add(&x, &benchRese_nocarry_0217)
	}
}

func BenchmarkE_nocarry_0217Sub(b *testing.B) {
	var x e_nocarry_0217
	x.SetRandom()
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Sub(&x, &benchRese_nocarry_0217)
	}
}

func BenchmarkE_nocarry_0217Neg(b *testing.B) {
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Neg(&benchRese_nocarry_0217)
	}
}

func BenchmarkE_nocarry_0217Div(b *testing.B) {
	var x e_nocarry_0217
	x.SetRandom()
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Div(&x, &benchRese_nocarry_0217)
	}
}

func BenchmarkE_nocarry_0217FromMont(b *testing.B) {
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.FromMont()
	}
}

func BenchmarkE_nocarry_0217ToMont(b *testing.B) {
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.ToMont()
	}
}
func BenchmarkE_nocarry_0217Square(b *testing.B) {
	benchRese_nocarry_0217.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Square(&benchRese_nocarry_0217)
	}
}

func BenchmarkE_nocarry_0217Sqrt(b *testing.B) {
	var a e_nocarry_0217
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0217Mul(b *testing.B) {
	x := e_nocarry_0217{
	...
	benchRese_nocarry_0217.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Mul(&benchRese_nocarry_0217, &x)
	}
}

func BenchmarkE_nocarry_0217Cmp(b *testing.B) {
	x := e_nocarry_0217{
		15618904215570937984,
		8081142417233326796,
		14208880877305129705,
	...
	benchRese_nocarry_0217 = x
	benchRese_nocarry_0217[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0217.Cmp(&x)
	}
}

func TestE_nocarry_0217Cmp(t *testing.T) {
	var x, y e_nocarry_0217
...
func TestE_nocarry_0217IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0217
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0217

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0217{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0217
	one.SetOne()
	e.Sub(&qe_nocarry_0217, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0217{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0217{0, uint64(i)})
	}
...
func TestE_nocarry_0217NegZero(t *testing.T) {
	var a, b e_nocarry_0217
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0217Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0217, len(staticTestValues))
...
func TestE_nocarry_0217Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0217) bool {
			var b e_nocarry_0217
...
func TestE_nocarry_0217InverseExp(t *testing.T) {
...
func TestE_nocarry_0217MulByConstants(t *testing.T) {
...
func TestE_nocarry_0217Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0217) bool {
...
func TestE_nocarry_0217LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0217Halve(t *testing.T) {
...
func TestE_nocarry_0217FromMont(t *testing.T) {
...
type testPaire_nocarry_0217 struct {
	element e_nocarry_0217
	bigint  big.Int
}

func (z *e_nocarry_0217) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0217[3] {
		return true
	}
	if z[3] < qe_nocarry_0217[3] {
		return false
	...
	return z[0] >= qe_nocarry_0217[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0217

		g.element = e_nocarry_0217{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0217[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0217[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0217 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0217[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0217[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0217[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0217[3], carry)
...
func Benchmarke_nocarry_0217InverseNew(b *testing.B) {
	var x e_nocarry_0217
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0217
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0217
		var xInv e_nocarry_0217
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0217
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0217
...
func testLinearComb(t *testing.T, x *e_nocarry_0217, xC int64, y *e_nocarry_0217, yC int64) {
	...
	var z e_nocarry_0217
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0217, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0217
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0217, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0217
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0217, xHi uint64) {
	var res e_nocarry_0217
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0217) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0217) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0217, c int64, result *e_nocarry_0217, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0217) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0217) uint64 {
