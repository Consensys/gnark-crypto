...
// modulus q
DATA q<>+0(SB)/8, $0x3c92f861f150a929
DATA q<>+8(SB)/8, $0x26ac085fc0c1ffca
DATA q<>+16(SB)/8, $0x642c58103f339940
DATA q<>+24(SB)/8, $0x0000000001a94836
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xc9dbafc95b7bfce7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x3c92f861f150a929, R8
	MOVQ    $0x26ac085fc0c1ffca, R9
	MOVQ    $0x642c58103f339940, R10
	MOVQ    $0x0000000001a94836, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x26ac085fc0c1ffca, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x642c58103f339940, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000000001a94836, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x3c92f861f150a929, R12
	MOVQ    $0x26ac085fc0c1ffca, R13
	MOVQ    $0x642c58103f339940, R14
	MOVQ    $0x0000000001a94836, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
