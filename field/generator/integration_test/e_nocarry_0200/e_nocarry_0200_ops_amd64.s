...
// modulus q
DATA q<>+0(SB)/8, $0x99f85ee698d54119
DATA q<>+8(SB)/8, $0x86509cae94c26c2e
DATA q<>+16(SB)/8, $0x9401ad1939ddbf97
DATA q<>+24(SB)/8, $0x00000000000000ea
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xcabc97b6787f74d7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x99f85ee698d54119, R8
	MOVQ    $0x86509cae94c26c2e, R9
	MOVQ    $0x9401ad1939ddbf97, R10
	MOVQ    $0x00000000000000ea, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x86509cae94c26c2e, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x9401ad1939ddbf97, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000000000000ea, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x99f85ee698d54119, R12
	MOVQ    $0x86509cae94c26c2e, R13
	MOVQ    $0x9401ad1939ddbf97, R14
	MOVQ    $0x00000000000000ea, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
