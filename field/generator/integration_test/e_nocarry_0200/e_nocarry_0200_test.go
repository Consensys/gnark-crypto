...
var benchRese_nocarry_0200 e_nocarry_0200

func BenchmarkE_nocarry_0200SetBytes(b *testing.B) {
	var x e_nocarry_0200
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0200MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0200.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0200)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0200)
		}
	})
}

func BenchmarkE_nocarry_0200Inverse(b *testing.B) {
	var x e_nocarry_0200
	x.SetRandom()
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0200Butterfly(b *testing.B) {
	var x e_nocarry_0200
	x.SetRandom()
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0200)
	}
}

func BenchmarkE_nocarry_0200Exp(b *testing.B) {
	var x e_nocarry_0200
	x.SetRandom()
	benchRese_nocarry_0200.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0200Double(b *testing.B) {
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Double(&benchRese_nocarry_0200)
	}
}

func BenchmarkE_nocarry_0200Add(b *testing.B) {
	var x e_nocarry_0200
	x.SetRandom()
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Add(&x, &benchRese_nocarry_0200)
	}
}

func BenchmarkE_nocarry_0200Sub(b *testing.B) {
	var x e_nocarry_0200
	x.SetRandom()
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Sub(&x, &benchRese_nocarry_0200)
	}
}

func BenchmarkE_nocarry_0200Neg(b *testing.B) {
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Neg(&benchRese_nocarry_0200)
	}
}

func BenchmarkE_nocarry_0200Div(b *testing.B) {
	var x e_nocarry_0200
	x.SetRandom()
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Div(&x, &benchRese_nocarry_0200)
	}
}

func BenchmarkE_nocarry_0200FromMont(b *testing.B) {
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.FromMont()
	}
}

func BenchmarkE_nocarry_0200ToMont(b *testing.B) {
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.ToMont()
	}
}
func BenchmarkE_nocarry_0200Square(b *testing.B) {
	benchRese_nocarry_0200.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Square(&benchRese_nocarry_0200)
	}
}

func BenchmarkE_nocarry_0200Sqrt(b *testing.B) {
	var a e_nocarry_0200
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0200Mul(b *testing.B) {
	x := e_nocarry_0200{
		6434367993626741000,
		5345707124096784239,
		8994431739649260798,
	...
	benchRese_nocarry_0200.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Mul(&benchRese_nocarry_0200, &x)
	}
}

func BenchmarkE_nocarry_0200Cmp(b *testing.B) {
	x := e_nocarry_0200{
		6434367993626741000,
		5345707124096784239,
		8994431739649260798,
	...
	benchRese_nocarry_0200 = x
	benchRese_nocarry_0200[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0200.Cmp(&x)
	}
}

func TestE_nocarry_0200Cmp(t *testing.T) {
	var x, y e_nocarry_0200
...
func TestE_nocarry_0200IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0200
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0200

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0200{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0200
	one.SetOne()
	e.Sub(&qe_nocarry_0200, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0200{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0200{0, uint64(i)})
	}
...
func TestE_nocarry_0200NegZero(t *testing.T) {
	var a, b e_nocarry_0200
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0200Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0200, len(staticTestValues))
...
func TestE_nocarry_0200Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0200) bool {
			var b e_nocarry_0200
...
func TestE_nocarry_0200InverseExp(t *testing.T) {
...
func TestE_nocarry_0200MulByConstants(t *testing.T) {
...
func TestE_nocarry_0200Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0200) bool {
...
func TestE_nocarry_0200LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0200Halve(t *testing.T) {
...
func TestE_nocarry_0200FromMont(t *testing.T) {
...
type testPaire_nocarry_0200 struct {
	element e_nocarry_0200
	bigint  big.Int
}

func (z *e_nocarry_0200) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0200[3] {
		return true
	}
	if z[3] < qe_nocarry_0200[3] {
		return false
	...
	return z[0] >= qe_nocarry_0200[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0200

		g.element = e_nocarry_0200{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0200[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0200[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0200 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0200[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0200[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0200[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0200[3], carry)
...
func Benchmarke_nocarry_0200InverseNew(b *testing.B) {
	var x e_nocarry_0200
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0200
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0200
		var xInv e_nocarry_0200
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0200
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0200
...
func testLinearComb(t *testing.T, x *e_nocarry_0200, xC int64, y *e_nocarry_0200, yC int64) {
	...
	var z e_nocarry_0200
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0200, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0200
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0200, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0200
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0200, xHi uint64) {
	var res e_nocarry_0200
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0200) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0200) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0200, c int64, result *e_nocarry_0200, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0200) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0200) uint64 {
