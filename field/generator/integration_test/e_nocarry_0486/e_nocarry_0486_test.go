...
var benchRese_nocarry_0486 e_nocarry_0486

func BenchmarkE_nocarry_0486SetBytes(b *testing.B) {
	var x e_nocarry_0486
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0486MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0486.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0486)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0486)
		}
	})
}

func BenchmarkE_nocarry_0486Inverse(b *testing.B) {
	var x e_nocarry_0486
	x.SetRandom()
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0486Butterfly(b *testing.B) {
	var x e_nocarry_0486
	x.SetRandom()
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0486)
	}
}

func BenchmarkE_nocarry_0486Exp(b *testing.B) {
	var x e_nocarry_0486
	x.SetRandom()
	benchRese_nocarry_0486.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0486Double(b *testing.B) {
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Double(&benchRese_nocarry_0486)
	}
}

func BenchmarkE_nocarry_0486Add(b *testing.B) {
	var x e_nocarry_0486
	x.SetRandom()
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Add(&x, &benchRese_nocarry_0486)
	}
}

func BenchmarkE_nocarry_0486Sub(b *testing.B) {
	var x e_nocarry_0486
	x.SetRandom()
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Sub(&x, &benchRese_nocarry_0486)
	}
}

func BenchmarkE_nocarry_0486Neg(b *testing.B) {
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Neg(&benchRese_nocarry_0486)
	}
}

func BenchmarkE_nocarry_0486Div(b *testing.B) {
	var x e_nocarry_0486
	x.SetRandom()
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Div(&x, &benchRese_nocarry_0486)
	}
}

func BenchmarkE_nocarry_0486FromMont(b *testing.B) {
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.FromMont()
	}
}

func BenchmarkE_nocarry_0486ToMont(b *testing.B) {
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.ToMont()
	}
}
func BenchmarkE_nocarry_0486Square(b *testing.B) {
	benchRese_nocarry_0486.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Square(&benchRese_nocarry_0486)
	}
}

func BenchmarkE_nocarry_0486Sqrt(b *testing.B) {
	var a e_nocarry_0486
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0486Mul(b *testing.B) {
	x := e_nocarry_0486{
		7435863231109292710,
	...
	benchRese_nocarry_0486.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Mul(&benchRese_nocarry_0486, &x)
	}
}

func BenchmarkE_nocarry_0486Cmp(b *testing.B) {
	x := e_nocarry_0486{
		7435863231109292710,
		15626784202702072138,
		13957169597599703537,
	...
	benchRese_nocarry_0486 = x
	benchRese_nocarry_0486[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0486.Cmp(&x)
	}
}

func TestE_nocarry_0486Cmp(t *testing.T) {
	var x, y e_nocarry_0486
...
func TestE_nocarry_0486IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0486
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0486

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0486{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0486
	one.SetOne()
	e.Sub(&qe_nocarry_0486, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0486{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0486{0, uint64(i)})
	}
...
func TestE_nocarry_0486NegZero(t *testing.T) {
	var a, b e_nocarry_0486
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0486Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0486, len(staticTestValues))
...
func TestE_nocarry_0486Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0486) bool {
			var b e_nocarry_0486
...
func TestE_nocarry_0486InverseExp(t *testing.T) {
...
func TestE_nocarry_0486MulByConstants(t *testing.T) {
...
func TestE_nocarry_0486Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0486) bool {
...
func TestE_nocarry_0486LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0486Halve(t *testing.T) {
...
func TestE_nocarry_0486FromMont(t *testing.T) {
...
type testPaire_nocarry_0486 struct {
	element e_nocarry_0486
	bigint  big.Int
}

func (z *e_nocarry_0486) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0486[7] {
		return true
	}
	if z[7] < qe_nocarry_0486[7] {
		return false
	...
	return z[0] >= qe_nocarry_0486[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0486

		g.element = e_nocarry_0486{
		...
		if qe_nocarry_0486[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0486[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0486 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0486[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0486[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0486[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0486[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0486[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0486[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0486[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0486[7], carry)
...
func Benchmarke_nocarry_0486InverseNew(b *testing.B) {
	var x e_nocarry_0486
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0486
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0486
		var xInv e_nocarry_0486
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0486
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0486
...
func testLinearComb(t *testing.T, x *e_nocarry_0486, xC int64, y *e_nocarry_0486, yC int64) {
	...
	var z e_nocarry_0486
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0486, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0486
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0486, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0486
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0486, xHi uint64) {
	var res e_nocarry_0486
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0486) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0486) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0486, c int64, result *e_nocarry_0486, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0486) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0486) uint64 {
