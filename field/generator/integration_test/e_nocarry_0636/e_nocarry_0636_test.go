...
var benchRese_nocarry_0636 e_nocarry_0636

func BenchmarkE_nocarry_0636SetBytes(b *testing.B) {
	var x e_nocarry_0636
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0636MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0636.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0636)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0636)
		}
	})
}

func BenchmarkE_nocarry_0636Inverse(b *testing.B) {
	var x e_nocarry_0636
	x.SetRandom()
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0636Butterfly(b *testing.B) {
	var x e_nocarry_0636
	x.SetRandom()
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0636)
	}
}

func BenchmarkE_nocarry_0636Exp(b *testing.B) {
	var x e_nocarry_0636
	x.SetRandom()
	benchRese_nocarry_0636.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0636Double(b *testing.B) {
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Double(&benchRese_nocarry_0636)
	}
}

func BenchmarkE_nocarry_0636Add(b *testing.B) {
	var x e_nocarry_0636
	x.SetRandom()
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Add(&x, &benchRese_nocarry_0636)
	}
}

func BenchmarkE_nocarry_0636Sub(b *testing.B) {
	var x e_nocarry_0636
	x.SetRandom()
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Sub(&x, &benchRese_nocarry_0636)
	}
}

func BenchmarkE_nocarry_0636Neg(b *testing.B) {
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Neg(&benchRese_nocarry_0636)
	}
}

func BenchmarkE_nocarry_0636Div(b *testing.B) {
	var x e_nocarry_0636
	x.SetRandom()
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Div(&x, &benchRese_nocarry_0636)
	}
}

func BenchmarkE_nocarry_0636FromMont(b *testing.B) {
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.FromMont()
	}
}

func BenchmarkE_nocarry_0636ToMont(b *testing.B) {
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.ToMont()
	}
}
func BenchmarkE_nocarry_0636Square(b *testing.B) {
	benchRese_nocarry_0636.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Square(&benchRese_nocarry_0636)
	}
}

func BenchmarkE_nocarry_0636Sqrt(b *testing.B) {
	var a e_nocarry_0636
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0636Mul(b *testing.B) {
	x := e_nocarry_0636{
	...
	benchRese_nocarry_0636.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Mul(&benchRese_nocarry_0636, &x)
	}
}

func BenchmarkE_nocarry_0636Cmp(b *testing.B) {
	x := e_nocarry_0636{
		13702945474130210574,
		18223147810064666788,
		4743334535123587217,
	...
	benchRese_nocarry_0636 = x
	benchRese_nocarry_0636[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0636.Cmp(&x)
	}
}

func TestE_nocarry_0636Cmp(t *testing.T) {
	var x, y e_nocarry_0636
...
func TestE_nocarry_0636IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0636
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0636

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0636{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0636
	one.SetOne()
	e.Sub(&qe_nocarry_0636, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0636{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0636{0, uint64(i)})
	}
...
func TestE_nocarry_0636NegZero(t *testing.T) {
	var a, b e_nocarry_0636
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0636Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0636, len(staticTestValues))
...
func TestE_nocarry_0636Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0636) bool {
			var b e_nocarry_0636
...
func TestE_nocarry_0636InverseExp(t *testing.T) {
...
func TestE_nocarry_0636MulByConstants(t *testing.T) {
...
func TestE_nocarry_0636Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0636) bool {
...
func TestE_nocarry_0636LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0636Halve(t *testing.T) {
...
func TestE_nocarry_0636FromMont(t *testing.T) {
...
type testPaire_nocarry_0636 struct {
	element e_nocarry_0636
	bigint  big.Int
}

func (z *e_nocarry_0636) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0636[9] {
		return true
	}
	if z[9] < qe_nocarry_0636[9] {
		return false
	...
	return z[0] >= qe_nocarry_0636[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0636

		g.element = e_nocarry_0636{
		...
		if qe_nocarry_0636[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0636[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0636 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0636[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0636[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0636[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0636[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0636[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0636[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0636[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0636[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0636[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0636[9], carry)
...
func Benchmarke_nocarry_0636InverseNew(b *testing.B) {
	var x e_nocarry_0636
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0636
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0636
		var xInv e_nocarry_0636
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0636
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0636
...
func testLinearComb(t *testing.T, x *e_nocarry_0636, xC int64, y *e_nocarry_0636, yC int64) {
	...
	var z e_nocarry_0636
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0636, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0636
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0636, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0636
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0636, xHi uint64) {
	var res e_nocarry_0636
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0636) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0636) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0636, c int64, result *e_nocarry_0636, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0636) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0636) uint64 {
