...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x042262ae5f9f5a29, R13
	ADDQ R13, AX
	MOVQ $0xb5ca004e4a3333d9, R13
	ADCQ R13, DX
	MOVQ $0x6f7951caae55c339, R13
	ADCQ R13, CX
	MOVQ $0x514fc4b123944b94, R13
	ADCQ R13, BX
	MOVQ $0xf4fae73e5ac11ab0, R13
	ADCQ R13, SI
	MOVQ $0x8389cee309583369, R13
	ADCQ R13, DI
	MOVQ $0xeba360fa99d1b3aa, R13
	ADCQ R13, R8
	MOVQ $0x06cc92a4f6ea96bf, R13
	ADCQ R13, R9
	MOVQ $0x6d623f750ca88053, R13
	ADCQ R13, R10
	MOVQ $0x0d66c7773b122514, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x042262ae5f9f5a29, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xb5ca004e4a3333d9, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x6f7951caae55c339, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x514fc4b123944b94, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xf4fae73e5ac11ab0, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x8389cee309583369, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xeba360fa99d1b3aa, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x06cc92a4f6ea96bf, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x6d623f750ca88053, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0d66c7773b122514, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x042262ae5f9f5a29, AX
	ADDQ AX, DX
	MOVQ $0xb5ca004e4a3333d9, AX
	ADCQ AX, CX
	MOVQ $0x6f7951caae55c339, AX
	ADCQ AX, BX
	MOVQ $0x514fc4b123944b94, AX
	ADCQ AX, SI
	MOVQ $0xf4fae73e5ac11ab0, AX
	ADCQ AX, DI
	MOVQ $0x8389cee309583369, AX
	ADCQ AX, R8
	MOVQ $0xeba360fa99d1b3aa, AX
	ADCQ AX, R9
	MOVQ $0x06cc92a4f6ea96bf, AX
	ADCQ AX, R10
	MOVQ $0x6d623f750ca88053, AX
	ADCQ AX, R11
	MOVQ $0x0d66c7773b122514, AX
	ADCQ AX, R12
