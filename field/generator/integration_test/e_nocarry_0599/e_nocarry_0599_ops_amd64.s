...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x7d12c814c7fca385, R13
	ADDQ R13, AX
	MOVQ $0xfb7fd740d554f1f7, R13
	ADCQ R13, DX
	MOVQ $0x4be3d1ac404cf0f1, R13
	ADCQ R13, CX
	MOVQ $0x5f81abcfd8180989, R13
	ADCQ R13, BX
	MOVQ $0xfbb40e5cd973445e, R13
	ADCQ R13, SI
	MOVQ $0x9b1c831dc817ca11, R13
	ADCQ R13, DI
	MOVQ $0x961b79943f76f735, R13
	ADCQ R13, R8
	MOVQ $0x44112b1d81b5e167, R13
	ADCQ R13, R9
	MOVQ $0x3a58332e4b9c0af4, R13
	ADCQ R13, R10
	MOVQ $0x00000000006b8f43, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x7d12c814c7fca385, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xfb7fd740d554f1f7, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x4be3d1ac404cf0f1, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x5f81abcfd8180989, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xfbb40e5cd973445e, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x9b1c831dc817ca11, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x961b79943f76f735, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x44112b1d81b5e167, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x3a58332e4b9c0af4, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000006b8f43, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x7d12c814c7fca385, AX
	ADDQ AX, DX
	MOVQ $0xfb7fd740d554f1f7, AX
	ADCQ AX, CX
	MOVQ $0x4be3d1ac404cf0f1, AX
	ADCQ AX, BX
	MOVQ $0x5f81abcfd8180989, AX
	ADCQ AX, SI
	MOVQ $0xfbb40e5cd973445e, AX
	ADCQ AX, DI
	MOVQ $0x9b1c831dc817ca11, AX
	ADCQ AX, R8
	MOVQ $0x961b79943f76f735, AX
	ADCQ AX, R9
	MOVQ $0x44112b1d81b5e167, AX
	ADCQ AX, R10
	MOVQ $0x3a58332e4b9c0af4, AX
	ADCQ AX, R11
	MOVQ $0x00000000006b8f43, AX
	ADCQ AX, R12
