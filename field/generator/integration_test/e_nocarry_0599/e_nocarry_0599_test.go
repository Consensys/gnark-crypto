...
var benchRese_nocarry_0599 e_nocarry_0599

func BenchmarkE_nocarry_0599SetBytes(b *testing.B) {
	var x e_nocarry_0599
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0599MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0599.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0599)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0599)
		}
	})
}

func BenchmarkE_nocarry_0599Inverse(b *testing.B) {
	var x e_nocarry_0599
	x.SetRandom()
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0599Butterfly(b *testing.B) {
	var x e_nocarry_0599
	x.SetRandom()
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0599)
	}
}

func BenchmarkE_nocarry_0599Exp(b *testing.B) {
	var x e_nocarry_0599
	x.SetRandom()
	benchRese_nocarry_0599.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0599Double(b *testing.B) {
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Double(&benchRese_nocarry_0599)
	}
}

func BenchmarkE_nocarry_0599Add(b *testing.B) {
	var x e_nocarry_0599
	x.SetRandom()
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Add(&x, &benchRese_nocarry_0599)
	}
}

func BenchmarkE_nocarry_0599Sub(b *testing.B) {
	var x e_nocarry_0599
	x.SetRandom()
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Sub(&x, &benchRese_nocarry_0599)
	}
}

func BenchmarkE_nocarry_0599Neg(b *testing.B) {
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Neg(&benchRese_nocarry_0599)
	}
}

func BenchmarkE_nocarry_0599Div(b *testing.B) {
	var x e_nocarry_0599
	x.SetRandom()
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Div(&x, &benchRese_nocarry_0599)
	}
}

func BenchmarkE_nocarry_0599FromMont(b *testing.B) {
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.FromMont()
	}
}

func BenchmarkE_nocarry_0599ToMont(b *testing.B) {
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.ToMont()
	}
}
func BenchmarkE_nocarry_0599Square(b *testing.B) {
	benchRese_nocarry_0599.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Square(&benchRese_nocarry_0599)
	}
}

func BenchmarkE_nocarry_0599Sqrt(b *testing.B) {
	var a e_nocarry_0599
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0599Mul(b *testing.B) {
	x := e_nocarry_0599{
		4208791745661913064,
		1237441403575334151,
	...
	benchRese_nocarry_0599.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Mul(&benchRese_nocarry_0599, &x)
	}
}

func BenchmarkE_nocarry_0599Cmp(b *testing.B) {
	x := e_nocarry_0599{
		4208791745661913064,
		1237441403575334151,
		15328447518805707764,
	...
	benchRese_nocarry_0599 = x
	benchRese_nocarry_0599[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0599.Cmp(&x)
	}
}

func TestE_nocarry_0599Cmp(t *testing.T) {
	var x, y e_nocarry_0599
...
func TestE_nocarry_0599IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0599
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0599

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0599{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0599
	one.SetOne()
	e.Sub(&qe_nocarry_0599, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0599{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0599{0, uint64(i)})
	}
...
func TestE_nocarry_0599NegZero(t *testing.T) {
	var a, b e_nocarry_0599
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0599Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0599, len(staticTestValues))
...
func TestE_nocarry_0599Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0599) bool {
			var b e_nocarry_0599
...
func TestE_nocarry_0599InverseExp(t *testing.T) {
...
func TestE_nocarry_0599MulByConstants(t *testing.T) {
...
func TestE_nocarry_0599Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0599) bool {
...
func TestE_nocarry_0599LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0599Halve(t *testing.T) {
...
func TestE_nocarry_0599FromMont(t *testing.T) {
...
type testPaire_nocarry_0599 struct {
	element e_nocarry_0599
	bigint  big.Int
}

func (z *e_nocarry_0599) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0599[9] {
		return true
	}
	if z[9] < qe_nocarry_0599[9] {
		return false
	...
	return z[0] >= qe_nocarry_0599[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0599

		g.element = e_nocarry_0599{
		...
		if qe_nocarry_0599[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0599[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0599 {
			var g e_nocarry_0599
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0599[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0599[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0599[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0599[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0599[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0599[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0599[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0599[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0599[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0599[9], carry)
...
func Benchmarke_nocarry_0599InverseNew(b *testing.B) {
	var x e_nocarry_0599
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0599
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0599
		var xInv e_nocarry_0599
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0599
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0599
...
func testLinearComb(t *testing.T, x *e_nocarry_0599, xC int64, y *e_nocarry_0599, yC int64) {
	...
	var z e_nocarry_0599
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0599, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0599
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0599, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0599
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0599, xHi uint64) {
	var res e_nocarry_0599
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0599) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0599) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0599, c int64, result *e_nocarry_0599, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0599) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0599) uint64 {
