...
var benchRese_nocarry_0674 e_nocarry_0674

func BenchmarkE_nocarry_0674SetBytes(b *testing.B) {
	var x e_nocarry_0674
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0674MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0674.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0674)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0674)
		}
	})
}

func BenchmarkE_nocarry_0674Inverse(b *testing.B) {
	var x e_nocarry_0674
	x.SetRandom()
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0674Butterfly(b *testing.B) {
	var x e_nocarry_0674
	x.SetRandom()
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0674)
	}
}

func BenchmarkE_nocarry_0674Exp(b *testing.B) {
	var x e_nocarry_0674
	x.SetRandom()
	benchRese_nocarry_0674.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0674Double(b *testing.B) {
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Double(&benchRese_nocarry_0674)
	}
}

func BenchmarkE_nocarry_0674Add(b *testing.B) {
	var x e_nocarry_0674
	x.SetRandom()
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Add(&x, &benchRese_nocarry_0674)
	}
}

func BenchmarkE_nocarry_0674Sub(b *testing.B) {
	var x e_nocarry_0674
	x.SetRandom()
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Sub(&x, &benchRese_nocarry_0674)
	}
}

func BenchmarkE_nocarry_0674Neg(b *testing.B) {
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Neg(&benchRese_nocarry_0674)
	}
}

func BenchmarkE_nocarry_0674Div(b *testing.B) {
	var x e_nocarry_0674
	x.SetRandom()
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Div(&x, &benchRese_nocarry_0674)
	}
}

func BenchmarkE_nocarry_0674FromMont(b *testing.B) {
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.FromMont()
	}
}

func BenchmarkE_nocarry_0674ToMont(b *testing.B) {
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.ToMont()
	}
}
func BenchmarkE_nocarry_0674Square(b *testing.B) {
	benchRese_nocarry_0674.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Square(&benchRese_nocarry_0674)
	}
}

func BenchmarkE_nocarry_0674Sqrt(b *testing.B) {
	var a e_nocarry_0674
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0674Mul(b *testing.B) {
	x := e_nocarry_0674{
	...
	benchRese_nocarry_0674.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Mul(&benchRese_nocarry_0674, &x)
	}
}

func BenchmarkE_nocarry_0674Cmp(b *testing.B) {
	x := e_nocarry_0674{
		16991127455207774575,
		2751531449162992141,
		8671243557316440868,
	...
	benchRese_nocarry_0674 = x
	benchRese_nocarry_0674[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0674.Cmp(&x)
	}
}

func TestE_nocarry_0674Cmp(t *testing.T) {
	var x, y e_nocarry_0674
...
func TestE_nocarry_0674IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0674
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0674

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0674{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0674
	one.SetOne()
	e.Sub(&qe_nocarry_0674, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0674{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0674{0, uint64(i)})
	}
...
func TestE_nocarry_0674NegZero(t *testing.T) {
	var a, b e_nocarry_0674
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0674Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0674, len(staticTestValues))
...
func TestE_nocarry_0674Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0674) bool {
			var b e_nocarry_0674
...
func TestE_nocarry_0674InverseExp(t *testing.T) {
...
func TestE_nocarry_0674MulByConstants(t *testing.T) {
...
func TestE_nocarry_0674Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0674) bool {
...
func TestE_nocarry_0674LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0674Halve(t *testing.T) {
...
func TestE_nocarry_0674FromMont(t *testing.T) {
...
type testPaire_nocarry_0674 struct {
	element e_nocarry_0674
	bigint  big.Int
}

func (z *e_nocarry_0674) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0674[10] {
		return true
	}
	if z[10] < qe_nocarry_0674[10] {
		return false
	...
	return z[0] >= qe_nocarry_0674[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0674

		g.element = e_nocarry_0674{
		...
		if qe_nocarry_0674[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0674[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0674 {
			var g e_nocarry_0674
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0674[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0674[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0674[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0674[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0674[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0674[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0674[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0674[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0674[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0674[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0674[10], carry)
...
func Benchmarke_nocarry_0674InverseNew(b *testing.B) {
	var x e_nocarry_0674
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0674
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0674
		var xInv e_nocarry_0674
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0674
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0674
...
func testLinearComb(t *testing.T, x *e_nocarry_0674, xC int64, y *e_nocarry_0674, yC int64) {
	...
	var z e_nocarry_0674
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0674, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0674
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0674, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0674
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0674, xHi uint64) {
	var res e_nocarry_0674
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0674) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0674) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0674, c int64, result *e_nocarry_0674, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0674) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0674) uint64 {
