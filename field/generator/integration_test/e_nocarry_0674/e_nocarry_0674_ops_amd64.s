...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xc547648faafaa303, R14
	ADDQ R14, AX
	MOVQ $0x99984a20cfa965a7, R14
	ADCQ R14, DX
	MOVQ $0x2d761fe5a77ac705, R14
	ADCQ R14, CX
	MOVQ $0x871476f26fe36403, R14
	ADCQ R14, BX
	MOVQ $0xa672d8310b559d50, R14
	ADCQ R14, SI
	MOVQ $0x512336ce598855d7, R14
	ADCQ R14, DI
	MOVQ $0xeeb77af863226477, R14
	ADCQ R14, R8
	MOVQ $0x2593d5015248574f, R14
	ADCQ R14, R9
	MOVQ $0xe2841c23aaffc502, R14
	ADCQ R14, R10
	MOVQ $0xd409f24ac146839f, R14
	ADCQ R14, R11
	MOVQ $0x00000003365a827e, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xc547648faafaa303, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x99984a20cfa965a7, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x2d761fe5a77ac705, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x871476f26fe36403, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xa672d8310b559d50, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x512336ce598855d7, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xeeb77af863226477, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x2593d5015248574f, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xe2841c23aaffc502, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xd409f24ac146839f, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000003365a827e, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xc547648faafaa303, AX
	ADDQ AX, DX
	MOVQ $0x99984a20cfa965a7, AX
	ADCQ AX, CX
	MOVQ $0x2d761fe5a77ac705, AX
	ADCQ AX, BX
	MOVQ $0x871476f26fe36403, AX
	ADCQ AX, SI
	MOVQ $0xa672d8310b559d50, AX
	ADCQ AX, DI
	MOVQ $0x512336ce598855d7, AX
	ADCQ AX, R8
	MOVQ $0xeeb77af863226477, AX
	ADCQ AX, R9
	MOVQ $0x2593d5015248574f, AX
	ADCQ AX, R10
	MOVQ $0xe2841c23aaffc502, AX
	ADCQ AX, R11
	MOVQ $0xd409f24ac146839f, AX
	ADCQ AX, R12
	MOVQ $0x00000003365a827e, AX
	ADCQ AX, R13
