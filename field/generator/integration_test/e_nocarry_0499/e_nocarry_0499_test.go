...
var benchRese_nocarry_0499 e_nocarry_0499

func BenchmarkE_nocarry_0499SetBytes(b *testing.B) {
	var x e_nocarry_0499
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0499MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0499.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0499)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0499)
		}
	})
}

func BenchmarkE_nocarry_0499Inverse(b *testing.B) {
	var x e_nocarry_0499
	x.SetRandom()
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0499Butterfly(b *testing.B) {
	var x e_nocarry_0499
	x.SetRandom()
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0499)
	}
}

func BenchmarkE_nocarry_0499Exp(b *testing.B) {
	var x e_nocarry_0499
	x.SetRandom()
	benchRese_nocarry_0499.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0499Double(b *testing.B) {
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Double(&benchRese_nocarry_0499)
	}
}

func BenchmarkE_nocarry_0499Add(b *testing.B) {
	var x e_nocarry_0499
	x.SetRandom()
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Add(&x, &benchRese_nocarry_0499)
	}
}

func BenchmarkE_nocarry_0499Sub(b *testing.B) {
	var x e_nocarry_0499
	x.SetRandom()
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Sub(&x, &benchRese_nocarry_0499)
	}
}

func BenchmarkE_nocarry_0499Neg(b *testing.B) {
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Neg(&benchRese_nocarry_0499)
	}
}

func BenchmarkE_nocarry_0499Div(b *testing.B) {
	var x e_nocarry_0499
	x.SetRandom()
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Div(&x, &benchRese_nocarry_0499)
	}
}

func BenchmarkE_nocarry_0499FromMont(b *testing.B) {
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.FromMont()
	}
}

func BenchmarkE_nocarry_0499ToMont(b *testing.B) {
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.ToMont()
	}
}
func BenchmarkE_nocarry_0499Square(b *testing.B) {
	benchRese_nocarry_0499.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Square(&benchRese_nocarry_0499)
	}
}

func BenchmarkE_nocarry_0499Sqrt(b *testing.B) {
	var a e_nocarry_0499
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0499Mul(b *testing.B) {
	x := e_nocarry_0499{
	...
	benchRese_nocarry_0499.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Mul(&benchRese_nocarry_0499, &x)
	}
}

func BenchmarkE_nocarry_0499Cmp(b *testing.B) {
	x := e_nocarry_0499{
		17957770989170830004,
		6840251491833901050,
		6356719854762330287,
	...
	benchRese_nocarry_0499 = x
	benchRese_nocarry_0499[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0499.Cmp(&x)
	}
}

func TestE_nocarry_0499Cmp(t *testing.T) {
	var x, y e_nocarry_0499
...
func TestE_nocarry_0499IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0499
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0499

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0499{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0499
	one.SetOne()
	e.Sub(&qe_nocarry_0499, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0499{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0499{0, uint64(i)})
	}
...
func TestE_nocarry_0499NegZero(t *testing.T) {
	var a, b e_nocarry_0499
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0499Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0499, len(staticTestValues))
...
func TestE_nocarry_0499Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0499) bool {
			var b e_nocarry_0499
...
func TestE_nocarry_0499InverseExp(t *testing.T) {
...
func TestE_nocarry_0499MulByConstants(t *testing.T) {
...
func TestE_nocarry_0499Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0499) bool {
...
func TestE_nocarry_0499LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0499Halve(t *testing.T) {
...
func TestE_nocarry_0499FromMont(t *testing.T) {
...
type testPaire_nocarry_0499 struct {
	element e_nocarry_0499
	bigint  big.Int
}

func (z *e_nocarry_0499) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0499[7] {
		return true
	}
	if z[7] < qe_nocarry_0499[7] {
		return false
	...
	return z[0] >= qe_nocarry_0499[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0499

		g.element = e_nocarry_0499{
		...
		if qe_nocarry_0499[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0499[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0499 {
			var g e_nocarry_0499
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0499[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0499[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0499[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0499[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0499[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0499[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0499[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0499[7], carry)
...
func Benchmarke_nocarry_0499InverseNew(b *testing.B) {
	var x e_nocarry_0499
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0499
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0499
		var xInv e_nocarry_0499
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0499
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0499
...
func testLinearComb(t *testing.T, x *e_nocarry_0499, xC int64, y *e_nocarry_0499, yC int64) {
	...
	var z e_nocarry_0499
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0499, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0499
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0499, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0499
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0499, xHi uint64) {
	var res e_nocarry_0499
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0499) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0499) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0499, c int64, result *e_nocarry_0499, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0499) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0499) uint64 {
