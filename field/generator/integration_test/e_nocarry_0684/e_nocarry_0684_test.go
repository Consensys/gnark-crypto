...
var benchRese_nocarry_0684 e_nocarry_0684

func BenchmarkE_nocarry_0684SetBytes(b *testing.B) {
	var x e_nocarry_0684
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0684MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0684.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0684)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0684)
		}
	})
}

func BenchmarkE_nocarry_0684Inverse(b *testing.B) {
	var x e_nocarry_0684
	x.SetRandom()
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0684Butterfly(b *testing.B) {
	var x e_nocarry_0684
	x.SetRandom()
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0684)
	}
}

func BenchmarkE_nocarry_0684Exp(b *testing.B) {
	var x e_nocarry_0684
	x.SetRandom()
	benchRese_nocarry_0684.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0684Double(b *testing.B) {
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Double(&benchRese_nocarry_0684)
	}
}

func BenchmarkE_nocarry_0684Add(b *testing.B) {
	var x e_nocarry_0684
	x.SetRandom()
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Add(&x, &benchRese_nocarry_0684)
	}
}

func BenchmarkE_nocarry_0684Sub(b *testing.B) {
	var x e_nocarry_0684
	x.SetRandom()
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Sub(&x, &benchRese_nocarry_0684)
	}
}

func BenchmarkE_nocarry_0684Neg(b *testing.B) {
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Neg(&benchRese_nocarry_0684)
	}
}

func BenchmarkE_nocarry_0684Div(b *testing.B) {
	var x e_nocarry_0684
	x.SetRandom()
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Div(&x, &benchRese_nocarry_0684)
	}
}

func BenchmarkE_nocarry_0684FromMont(b *testing.B) {
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.FromMont()
	}
}

func BenchmarkE_nocarry_0684ToMont(b *testing.B) {
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.ToMont()
	}
}
func BenchmarkE_nocarry_0684Square(b *testing.B) {
	benchRese_nocarry_0684.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Square(&benchRese_nocarry_0684)
	}
}

func BenchmarkE_nocarry_0684Sqrt(b *testing.B) {
	var a e_nocarry_0684
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0684Mul(b *testing.B) {
	x := e_nocarry_0684{
		1950928820848442644,
	...
	benchRese_nocarry_0684.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Mul(&benchRese_nocarry_0684, &x)
	}
}

func BenchmarkE_nocarry_0684Cmp(b *testing.B) {
	x := e_nocarry_0684{
		1950928820848442644,
		12231197560998989586,
		16606836156117952420,
	...
	benchRese_nocarry_0684 = x
	benchRese_nocarry_0684[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0684.Cmp(&x)
	}
}

func TestE_nocarry_0684Cmp(t *testing.T) {
	var x, y e_nocarry_0684
...
func TestE_nocarry_0684IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0684
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0684

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0684{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0684
	one.SetOne()
	e.Sub(&qe_nocarry_0684, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0684{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0684{0, uint64(i)})
	}
...
func TestE_nocarry_0684NegZero(t *testing.T) {
	var a, b e_nocarry_0684
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0684Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0684, len(staticTestValues))
...
func TestE_nocarry_0684Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0684) bool {
			var b e_nocarry_0684
...
func TestE_nocarry_0684InverseExp(t *testing.T) {
...
func TestE_nocarry_0684MulByConstants(t *testing.T) {
...
func TestE_nocarry_0684Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0684) bool {
...
func TestE_nocarry_0684LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0684Halve(t *testing.T) {
...
func TestE_nocarry_0684FromMont(t *testing.T) {
...
type testPaire_nocarry_0684 struct {
	element e_nocarry_0684
	bigint  big.Int
}

func (z *e_nocarry_0684) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0684[10] {
		return true
	}
	if z[10] < qe_nocarry_0684[10] {
		return false
	...
	return z[0] >= qe_nocarry_0684[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0684

		g.element = e_nocarry_0684{
		...
		if qe_nocarry_0684[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0684[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0684 {
			var g e_nocarry_0684
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0684[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0684[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0684[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0684[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0684[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0684[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0684[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0684[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0684[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0684[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0684[10], carry)
...
func Benchmarke_nocarry_0684InverseNew(b *testing.B) {
	var x e_nocarry_0684
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0684
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0684
		var xInv e_nocarry_0684
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0684
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0684
...
func testLinearComb(t *testing.T, x *e_nocarry_0684, xC int64, y *e_nocarry_0684, yC int64) {
	...
	var z e_nocarry_0684
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0684, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0684
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0684, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0684
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0684, xHi uint64) {
	var res e_nocarry_0684
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0684) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0684) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0684, c int64, result *e_nocarry_0684, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0684) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0684) uint64 {
