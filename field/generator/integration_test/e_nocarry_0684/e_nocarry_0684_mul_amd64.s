...
// modulus q
DATA q<>+0(SB)/8, $0xa137767843945d93
DATA q<>+8(SB)/8, $0x8b8d86954f2c2a02
DATA q<>+16(SB)/8, $0x645d897b8ed1e1c2
DATA q<>+24(SB)/8, $0x2944f427d3c494f8
DATA q<>+32(SB)/8, $0xd8a05ebfbe1e8b7f
DATA q<>+40(SB)/8, $0x926eaa2575816bc7
DATA q<>+48(SB)/8, $0x1098189cccb049c9
DATA q<>+56(SB)/8, $0x8d44b57c2147f99a
DATA q<>+64(SB)/8, $0xd013c15ecd052f05
DATA q<>+72(SB)/8, $0x79d3a5da821ad4d6
DATA q<>+80(SB)/8, $0x00000ca9a7ec4ece
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xf475feb0ae01b765
