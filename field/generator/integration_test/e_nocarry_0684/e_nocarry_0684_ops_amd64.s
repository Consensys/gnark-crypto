...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xa137767843945d93, R14
	ADDQ R14, AX
	MOVQ $0x8b8d86954f2c2a02, R14
	ADCQ R14, DX
	MOVQ $0x645d897b8ed1e1c2, R14
	ADCQ R14, CX
	MOVQ $0x2944f427d3c494f8, R14
	ADCQ R14, BX
	MOVQ $0xd8a05ebfbe1e8b7f, R14
	ADCQ R14, SI
	MOVQ $0x926eaa2575816bc7, R14
	ADCQ R14, DI
	MOVQ $0x1098189cccb049c9, R14
	ADCQ R14, R8
	MOVQ $0x8d44b57c2147f99a, R14
	ADCQ R14, R9
	MOVQ $0xd013c15ecd052f05, R14
	ADCQ R14, R10
	MOVQ $0x79d3a5da821ad4d6, R14
	ADCQ R14, R11
	MOVQ $0x00000ca9a7ec4ece, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xa137767843945d93, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x8b8d86954f2c2a02, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x645d897b8ed1e1c2, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x2944f427d3c494f8, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xd8a05ebfbe1e8b7f, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x926eaa2575816bc7, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x1098189cccb049c9, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x8d44b57c2147f99a, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xd013c15ecd052f05, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x79d3a5da821ad4d6, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000ca9a7ec4ece, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xa137767843945d93, AX
	ADDQ AX, DX
	MOVQ $0x8b8d86954f2c2a02, AX
	ADCQ AX, CX
	MOVQ $0x645d897b8ed1e1c2, AX
	ADCQ AX, BX
	MOVQ $0x2944f427d3c494f8, AX
	ADCQ AX, SI
	MOVQ $0xd8a05ebfbe1e8b7f, AX
	ADCQ AX, DI
	MOVQ $0x926eaa2575816bc7, AX
	ADCQ AX, R8
	MOVQ $0x1098189cccb049c9, AX
	ADCQ AX, R9
	MOVQ $0x8d44b57c2147f99a, AX
	ADCQ AX, R10
	MOVQ $0xd013c15ecd052f05, AX
	ADCQ AX, R11
	MOVQ $0x79d3a5da821ad4d6, AX
	ADCQ AX, R12
	MOVQ $0x00000ca9a7ec4ece, AX
	ADCQ AX, R13
