...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0317{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0317{0, uint64(i)})
	}
...
func (z *e_nocarry_0317) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0317[4] {
		return true
	}
	if z[4] < qe_nocarry_0317[4] {
		return false
...
func Benchmarke_nocarry_0317InverseNew(b *testing.B) {
	var x e_nocarry_0317
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0317, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0317, xHi uint64) {
