...
// modulus q
DATA q<>+0(SB)/8, $0xd54f8a46302af60f
DATA q<>+8(SB)/8, $0x76ba5f3f576b7506
DATA q<>+16(SB)/8, $0xfe43b9385ba9d02d
DATA q<>+24(SB)/8, $0xde0a06d822bf0aa2
DATA q<>+32(SB)/8, $0x1dbd2baf8c37568b
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xf7399004fa20c711
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xd54f8a46302af60f, R9
	MOVQ    $0x76ba5f3f576b7506, R10
	MOVQ    $0xfe43b9385ba9d02d, R11
	MOVQ    $0xde0a06d822bf0aa2, R12
	MOVQ    $0x1dbd2baf8c37568b, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x76ba5f3f576b7506, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xfe43b9385ba9d02d, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xde0a06d822bf0aa2, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x1dbd2baf8c37568b, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xd54f8a46302af60f, CX
	MOVQ    $0x76ba5f3f576b7506, BX
	MOVQ    $0xfe43b9385ba9d02d, SI
	MOVQ    $0xde0a06d822bf0aa2, DI
	MOVQ    $0x1dbd2baf8c37568b, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
