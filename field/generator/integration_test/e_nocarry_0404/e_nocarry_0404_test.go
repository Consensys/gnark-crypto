...
var benchRese_nocarry_0404 e_nocarry_0404

func BenchmarkE_nocarry_0404SetBytes(b *testing.B) {
	var x e_nocarry_0404
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0404MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0404.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0404)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0404)
		}
	})
}

func BenchmarkE_nocarry_0404Inverse(b *testing.B) {
	var x e_nocarry_0404
	x.SetRandom()
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0404Butterfly(b *testing.B) {
	var x e_nocarry_0404
	x.SetRandom()
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0404)
	}
}

func BenchmarkE_nocarry_0404Exp(b *testing.B) {
	var x e_nocarry_0404
	x.SetRandom()
	benchRese_nocarry_0404.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0404Double(b *testing.B) {
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Double(&benchRese_nocarry_0404)
	}
}

func BenchmarkE_nocarry_0404Add(b *testing.B) {
	var x e_nocarry_0404
	x.SetRandom()
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Add(&x, &benchRese_nocarry_0404)
	}
}

func BenchmarkE_nocarry_0404Sub(b *testing.B) {
	var x e_nocarry_0404
	x.SetRandom()
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Sub(&x, &benchRese_nocarry_0404)
	}
}

func BenchmarkE_nocarry_0404Neg(b *testing.B) {
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Neg(&benchRese_nocarry_0404)
	}
}

func BenchmarkE_nocarry_0404Div(b *testing.B) {
	var x e_nocarry_0404
	x.SetRandom()
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Div(&x, &benchRese_nocarry_0404)
	}
}

func BenchmarkE_nocarry_0404FromMont(b *testing.B) {
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.FromMont()
	}
}

func BenchmarkE_nocarry_0404ToMont(b *testing.B) {
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.ToMont()
	}
}
func BenchmarkE_nocarry_0404Square(b *testing.B) {
	benchRese_nocarry_0404.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Square(&benchRese_nocarry_0404)
	}
}

func BenchmarkE_nocarry_0404Sqrt(b *testing.B) {
	var a e_nocarry_0404
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0404Mul(b *testing.B) {
	x := e_nocarry_0404{
		3424971098860712880,
	...
	benchRese_nocarry_0404.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Mul(&benchRese_nocarry_0404, &x)
	}
}

func BenchmarkE_nocarry_0404Cmp(b *testing.B) {
	x := e_nocarry_0404{
		3424971098860712880,
		11347961165480070904,
		5686037849412035062,
	...
	benchRese_nocarry_0404 = x
	benchRese_nocarry_0404[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0404.Cmp(&x)
	}
}

func TestE_nocarry_0404Cmp(t *testing.T) {
	var x, y e_nocarry_0404
...
func TestE_nocarry_0404IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0404
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0404

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0404{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0404
	one.SetOne()
	e.Sub(&qe_nocarry_0404, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0404{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0404{0, uint64(i)})
	}
...
func TestE_nocarry_0404NegZero(t *testing.T) {
	var a, b e_nocarry_0404
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0404Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0404, len(staticTestValues))
...
func TestE_nocarry_0404Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0404) bool {
			var b e_nocarry_0404
...
func TestE_nocarry_0404InverseExp(t *testing.T) {
...
func TestE_nocarry_0404MulByConstants(t *testing.T) {
...
func TestE_nocarry_0404Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0404) bool {
...
func TestE_nocarry_0404LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0404Halve(t *testing.T) {
...
func TestE_nocarry_0404FromMont(t *testing.T) {
...
type testPaire_nocarry_0404 struct {
	element e_nocarry_0404
	bigint  big.Int
}

func (z *e_nocarry_0404) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0404[6] {
		return true
	}
	if z[6] < qe_nocarry_0404[6] {
		return false
	...
	return z[0] >= qe_nocarry_0404[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0404

		g.element = e_nocarry_0404{
		...
		if qe_nocarry_0404[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0404[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0404 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0404[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0404[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0404[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0404[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0404[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0404[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0404[6], carry)
...
func Benchmarke_nocarry_0404InverseNew(b *testing.B) {
	var x e_nocarry_0404
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0404
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0404
		var xInv e_nocarry_0404
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0404
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0404
...
func testLinearComb(t *testing.T, x *e_nocarry_0404, xC int64, y *e_nocarry_0404, yC int64) {
	...
	var z e_nocarry_0404
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0404, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0404
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0404, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0404
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0404, xHi uint64) {
	var res e_nocarry_0404
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0404) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0404) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0404, c int64, result *e_nocarry_0404, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0404) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0404) uint64 {
