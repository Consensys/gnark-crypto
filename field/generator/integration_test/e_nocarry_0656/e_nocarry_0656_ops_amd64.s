...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x6c20d8bc2937cd09, R14
	ADDQ R14, AX
	MOVQ $0x27c3d5d70300bbc1, R14
	ADCQ R14, DX
	MOVQ $0xa5c084680ac1d633, R14
	ADCQ R14, CX
	MOVQ $0x3954ec7d5e66fffa, R14
	ADCQ R14, BX
	MOVQ $0x174dd8ab0bd472cf, R14
	ADCQ R14, SI
	MOVQ $0x0ff34180725f81e9, R14
	ADCQ R14, DI
	MOVQ $0x817d422f48cde57b, R14
	ADCQ R14, R8
	MOVQ $0x4f1847773a2d8400, R14
	ADCQ R14, R9
	MOVQ $0x61cdfe165504b7af, R14
	ADCQ R14, R10
	MOVQ $0xe72c482eaec5e338, R14
	ADCQ R14, R11
	MOVQ $0x000000000000da4e, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x6c20d8bc2937cd09, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x27c3d5d70300bbc1, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xa5c084680ac1d633, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x3954ec7d5e66fffa, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x174dd8ab0bd472cf, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x0ff34180725f81e9, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x817d422f48cde57b, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x4f1847773a2d8400, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x61cdfe165504b7af, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xe72c482eaec5e338, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000000000da4e, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x6c20d8bc2937cd09, AX
	ADDQ AX, DX
	MOVQ $0x27c3d5d70300bbc1, AX
	ADCQ AX, CX
	MOVQ $0xa5c084680ac1d633, AX
	ADCQ AX, BX
	MOVQ $0x3954ec7d5e66fffa, AX
	ADCQ AX, SI
	MOVQ $0x174dd8ab0bd472cf, AX
	ADCQ AX, DI
	MOVQ $0x0ff34180725f81e9, AX
	ADCQ AX, R8
	MOVQ $0x817d422f48cde57b, AX
	ADCQ AX, R9
	MOVQ $0x4f1847773a2d8400, AX
	ADCQ AX, R10
	MOVQ $0x61cdfe165504b7af, AX
	ADCQ AX, R11
	MOVQ $0xe72c482eaec5e338, AX
	ADCQ AX, R12
	MOVQ $0x000000000000da4e, AX
	ADCQ AX, R13
