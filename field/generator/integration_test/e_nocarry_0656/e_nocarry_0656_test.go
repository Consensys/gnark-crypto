...
var benchRese_nocarry_0656 e_nocarry_0656

func BenchmarkE_nocarry_0656SetBytes(b *testing.B) {
	var x e_nocarry_0656
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0656MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0656.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0656)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0656)
		}
	})
}

func BenchmarkE_nocarry_0656Inverse(b *testing.B) {
	var x e_nocarry_0656
	x.SetRandom()
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0656Butterfly(b *testing.B) {
	var x e_nocarry_0656
	x.SetRandom()
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0656)
	}
}

func BenchmarkE_nocarry_0656Exp(b *testing.B) {
	var x e_nocarry_0656
	x.SetRandom()
	benchRese_nocarry_0656.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0656Double(b *testing.B) {
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Double(&benchRese_nocarry_0656)
	}
}

func BenchmarkE_nocarry_0656Add(b *testing.B) {
	var x e_nocarry_0656
	x.SetRandom()
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Add(&x, &benchRese_nocarry_0656)
	}
}

func BenchmarkE_nocarry_0656Sub(b *testing.B) {
	var x e_nocarry_0656
	x.SetRandom()
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Sub(&x, &benchRese_nocarry_0656)
	}
}

func BenchmarkE_nocarry_0656Neg(b *testing.B) {
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Neg(&benchRese_nocarry_0656)
	}
}

func BenchmarkE_nocarry_0656Div(b *testing.B) {
	var x e_nocarry_0656
	x.SetRandom()
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Div(&x, &benchRese_nocarry_0656)
	}
}

func BenchmarkE_nocarry_0656FromMont(b *testing.B) {
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.FromMont()
	}
}

func BenchmarkE_nocarry_0656ToMont(b *testing.B) {
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.ToMont()
	}
}
func BenchmarkE_nocarry_0656Square(b *testing.B) {
	benchRese_nocarry_0656.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Square(&benchRese_nocarry_0656)
	}
}

func BenchmarkE_nocarry_0656Sqrt(b *testing.B) {
	var a e_nocarry_0656
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0656Mul(b *testing.B) {
	x := e_nocarry_0656{
		9927625901375997600,
		1717695696388756094,
	...
	benchRese_nocarry_0656.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Mul(&benchRese_nocarry_0656, &x)
	}
}

func BenchmarkE_nocarry_0656Cmp(b *testing.B) {
	x := e_nocarry_0656{
		9927625901375997600,
		1717695696388756094,
		13520764578216591466,
	...
	benchRese_nocarry_0656 = x
	benchRese_nocarry_0656[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0656.Cmp(&x)
	}
}

func TestE_nocarry_0656Cmp(t *testing.T) {
	var x, y e_nocarry_0656
...
func TestE_nocarry_0656IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0656
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0656

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0656{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0656
	one.SetOne()
	e.Sub(&qe_nocarry_0656, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0656{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0656{0, uint64(i)})
	}
...
func TestE_nocarry_0656NegZero(t *testing.T) {
	var a, b e_nocarry_0656
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0656Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0656, len(staticTestValues))
...
func TestE_nocarry_0656Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0656) bool {
			var b e_nocarry_0656
...
func TestE_nocarry_0656InverseExp(t *testing.T) {
...
func TestE_nocarry_0656MulByConstants(t *testing.T) {
...
func TestE_nocarry_0656Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0656) bool {
...
func TestE_nocarry_0656LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0656Halve(t *testing.T) {
...
func TestE_nocarry_0656FromMont(t *testing.T) {
...
type testPaire_nocarry_0656 struct {
	element e_nocarry_0656
	bigint  big.Int
}

func (z *e_nocarry_0656) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0656[10] {
		return true
	}
	if z[10] < qe_nocarry_0656[10] {
		return false
	...
	return z[0] >= qe_nocarry_0656[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0656

		g.element = e_nocarry_0656{
		...
		if qe_nocarry_0656[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0656[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0656 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0656[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0656[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0656[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0656[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0656[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0656[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0656[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0656[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0656[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0656[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0656[10], carry)
...
func Benchmarke_nocarry_0656InverseNew(b *testing.B) {
	var x e_nocarry_0656
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0656
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0656
		var xInv e_nocarry_0656
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0656
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0656
...
func testLinearComb(t *testing.T, x *e_nocarry_0656, xC int64, y *e_nocarry_0656, yC int64) {
	...
	var z e_nocarry_0656
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0656, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0656
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0656, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0656
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0656, xHi uint64) {
	var res e_nocarry_0656
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0656) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0656) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0656, c int64, result *e_nocarry_0656, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0656) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0656) uint64 {
