...
// modulus q
DATA q<>+0(SB)/8, $0x71cac9c71aaa5b0b
DATA q<>+8(SB)/8, $0xf413655151fcadbd
DATA q<>+16(SB)/8, $0x28d120d762330646
DATA q<>+24(SB)/8, $0x000000000000ef77
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x2b9d1caed1a2e75d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x71cac9c71aaa5b0b, R8
	MOVQ    $0xf413655151fcadbd, R9
	MOVQ    $0x28d120d762330646, R10
	MOVQ    $0x000000000000ef77, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xf413655151fcadbd, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x28d120d762330646, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x000000000000ef77, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x71cac9c71aaa5b0b, R12
	MOVQ    $0xf413655151fcadbd, R13
	MOVQ    $0x28d120d762330646, R14
	MOVQ    $0x000000000000ef77, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
