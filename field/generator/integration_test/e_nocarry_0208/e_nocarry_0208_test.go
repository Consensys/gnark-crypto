...
var benchRese_nocarry_0208 e_nocarry_0208

func BenchmarkE_nocarry_0208SetBytes(b *testing.B) {
	var x e_nocarry_0208
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0208MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0208.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0208)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0208)
		}
	})
}

func BenchmarkE_nocarry_0208Inverse(b *testing.B) {
	var x e_nocarry_0208
	x.SetRandom()
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0208Butterfly(b *testing.B) {
	var x e_nocarry_0208
	x.SetRandom()
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0208)
	}
}

func BenchmarkE_nocarry_0208Exp(b *testing.B) {
	var x e_nocarry_0208
	x.SetRandom()
	benchRese_nocarry_0208.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0208Double(b *testing.B) {
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Double(&benchRese_nocarry_0208)
	}
}

func BenchmarkE_nocarry_0208Add(b *testing.B) {
	var x e_nocarry_0208
	x.SetRandom()
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Add(&x, &benchRese_nocarry_0208)
	}
}

func BenchmarkE_nocarry_0208Sub(b *testing.B) {
	var x e_nocarry_0208
	x.SetRandom()
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Sub(&x, &benchRese_nocarry_0208)
	}
}

func BenchmarkE_nocarry_0208Neg(b *testing.B) {
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Neg(&benchRese_nocarry_0208)
	}
}

func BenchmarkE_nocarry_0208Div(b *testing.B) {
	var x e_nocarry_0208
	x.SetRandom()
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Div(&x, &benchRese_nocarry_0208)
	}
}

func BenchmarkE_nocarry_0208FromMont(b *testing.B) {
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.FromMont()
	}
}

func BenchmarkE_nocarry_0208ToMont(b *testing.B) {
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.ToMont()
	}
}
func BenchmarkE_nocarry_0208Square(b *testing.B) {
	benchRese_nocarry_0208.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Square(&benchRese_nocarry_0208)
	}
}

func BenchmarkE_nocarry_0208Sqrt(b *testing.B) {
	var a e_nocarry_0208
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0208Mul(b *testing.B) {
	x := e_nocarry_0208{
		7588098092394675949,
	...
	benchRese_nocarry_0208.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Mul(&benchRese_nocarry_0208, &x)
	}
}

func BenchmarkE_nocarry_0208Cmp(b *testing.B) {
	x := e_nocarry_0208{
		7588098092394675949,
		13826010525794231863,
		14532109377296621112,
	...
	benchRese_nocarry_0208 = x
	benchRese_nocarry_0208[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0208.Cmp(&x)
	}
}

func TestE_nocarry_0208Cmp(t *testing.T) {
	var x, y e_nocarry_0208
...
func TestE_nocarry_0208IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0208
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0208

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0208{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0208
	one.SetOne()
	e.Sub(&qe_nocarry_0208, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0208{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0208{0, uint64(i)})
	}
...
func TestE_nocarry_0208NegZero(t *testing.T) {
	var a, b e_nocarry_0208
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0208Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0208, len(staticTestValues))
...
func TestE_nocarry_0208Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0208) bool {
			var b e_nocarry_0208
...
func TestE_nocarry_0208InverseExp(t *testing.T) {
...
func TestE_nocarry_0208MulByConstants(t *testing.T) {
...
func TestE_nocarry_0208Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0208) bool {
...
func TestE_nocarry_0208LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0208Halve(t *testing.T) {
...
func TestE_nocarry_0208FromMont(t *testing.T) {
...
type testPaire_nocarry_0208 struct {
	element e_nocarry_0208
	bigint  big.Int
}

func (z *e_nocarry_0208) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0208[3] {
		return true
	}
	if z[3] < qe_nocarry_0208[3] {
		return false
	...
	return z[0] >= qe_nocarry_0208[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0208

		g.element = e_nocarry_0208{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0208[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0208[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0208 {
			var g e_nocarry_0208
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0208[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0208[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0208[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0208[3], carry)
...
func Benchmarke_nocarry_0208InverseNew(b *testing.B) {
	var x e_nocarry_0208
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0208
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0208
		var xInv e_nocarry_0208
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0208
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0208
...
func testLinearComb(t *testing.T, x *e_nocarry_0208, xC int64, y *e_nocarry_0208, yC int64) {
	...
	var z e_nocarry_0208
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0208, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0208
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0208, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0208
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0208, xHi uint64) {
	var res e_nocarry_0208
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0208) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0208) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0208, c int64, result *e_nocarry_0208, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0208) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0208) uint64 {
