...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x65b5c4430c3d0b21, R13
	ADDQ R13, AX
	MOVQ $0x7e1e0d7dc4a8599c, R13
	ADCQ R13, DX
	MOVQ $0x71aa73bb7850ddf4, R13
	ADCQ R13, CX
	MOVQ $0x86f71aaaa08efd4d, R13
	ADCQ R13, BX
	MOVQ $0x195544480e66f44d, R13
	ADCQ R13, SI
	MOVQ $0xa398780f4c25e101, R13
	ADCQ R13, DI
	MOVQ $0xa38636a2e4fd643a, R13
	ADCQ R13, R8
	MOVQ $0x617e322661588c3b, R13
	ADCQ R13, R9
	MOVQ $0x063cdc8cd07f7776, R13
	ADCQ R13, R10
	MOVQ $0x00612ce0e0edfda3, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x65b5c4430c3d0b21, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x7e1e0d7dc4a8599c, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x71aa73bb7850ddf4, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x86f71aaaa08efd4d, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x195544480e66f44d, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xa398780f4c25e101, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xa38636a2e4fd643a, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x617e322661588c3b, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x063cdc8cd07f7776, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00612ce0e0edfda3, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x65b5c4430c3d0b21, AX
	ADDQ AX, DX
	MOVQ $0x7e1e0d7dc4a8599c, AX
	ADCQ AX, CX
	MOVQ $0x71aa73bb7850ddf4, AX
	ADCQ AX, BX
	MOVQ $0x86f71aaaa08efd4d, AX
	ADCQ AX, SI
	MOVQ $0x195544480e66f44d, AX
	ADCQ AX, DI
	MOVQ $0xa398780f4c25e101, AX
	ADCQ AX, R8
	MOVQ $0xa38636a2e4fd643a, AX
	ADCQ AX, R9
	MOVQ $0x617e322661588c3b, AX
	ADCQ AX, R10
	MOVQ $0x063cdc8cd07f7776, AX
	ADCQ AX, R11
	MOVQ $0x00612ce0e0edfda3, AX
	ADCQ AX, R12
