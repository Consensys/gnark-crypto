...
// modulus q
DATA q<>+0(SB)/8, $0x65b5c4430c3d0b21
DATA q<>+8(SB)/8, $0x7e1e0d7dc4a8599c
DATA q<>+16(SB)/8, $0x71aa73bb7850ddf4
DATA q<>+24(SB)/8, $0x86f71aaaa08efd4d
DATA q<>+32(SB)/8, $0x195544480e66f44d
DATA q<>+40(SB)/8, $0xa398780f4c25e101
DATA q<>+48(SB)/8, $0xa38636a2e4fd643a
DATA q<>+56(SB)/8, $0x617e322661588c3b
DATA q<>+64(SB)/8, $0x063cdc8cd07f7776
DATA q<>+72(SB)/8, $0x00612ce0e0edfda3
GLOBL q<>(SB), (RODATA+NOPTR), $80

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x082c26147f55c71f
