...
var benchRese_nocarry_0631 e_nocarry_0631

func BenchmarkE_nocarry_0631SetBytes(b *testing.B) {
	var x e_nocarry_0631
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0631MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0631.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0631)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0631)
		}
	})
}

func BenchmarkE_nocarry_0631Inverse(b *testing.B) {
	var x e_nocarry_0631
	x.SetRandom()
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0631Butterfly(b *testing.B) {
	var x e_nocarry_0631
	x.SetRandom()
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0631)
	}
}

func BenchmarkE_nocarry_0631Exp(b *testing.B) {
	var x e_nocarry_0631
	x.SetRandom()
	benchRese_nocarry_0631.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0631Double(b *testing.B) {
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Double(&benchRese_nocarry_0631)
	}
}

func BenchmarkE_nocarry_0631Add(b *testing.B) {
	var x e_nocarry_0631
	x.SetRandom()
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Add(&x, &benchRese_nocarry_0631)
	}
}

func BenchmarkE_nocarry_0631Sub(b *testing.B) {
	var x e_nocarry_0631
	x.SetRandom()
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Sub(&x, &benchRese_nocarry_0631)
	}
}

func BenchmarkE_nocarry_0631Neg(b *testing.B) {
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Neg(&benchRese_nocarry_0631)
	}
}

func BenchmarkE_nocarry_0631Div(b *testing.B) {
	var x e_nocarry_0631
	x.SetRandom()
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Div(&x, &benchRese_nocarry_0631)
	}
}

func BenchmarkE_nocarry_0631FromMont(b *testing.B) {
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.FromMont()
	}
}

func BenchmarkE_nocarry_0631ToMont(b *testing.B) {
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.ToMont()
	}
}
func BenchmarkE_nocarry_0631Square(b *testing.B) {
	benchRese_nocarry_0631.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Square(&benchRese_nocarry_0631)
	}
}

func BenchmarkE_nocarry_0631Sqrt(b *testing.B) {
	var a e_nocarry_0631
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0631Mul(b *testing.B) {
	x := e_nocarry_0631{
		5740664241534136631,
	...
	benchRese_nocarry_0631.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Mul(&benchRese_nocarry_0631, &x)
	}
}

func BenchmarkE_nocarry_0631Cmp(b *testing.B) {
	x := e_nocarry_0631{
		5740664241534136631,
		15187460177695144876,
		637516398849324461,
	...
	benchRese_nocarry_0631 = x
	benchRese_nocarry_0631[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0631.Cmp(&x)
	}
}

func TestE_nocarry_0631Cmp(t *testing.T) {
	var x, y e_nocarry_0631
...
func TestE_nocarry_0631IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0631
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0631

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0631{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0631
	one.SetOne()
	e.Sub(&qe_nocarry_0631, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0631{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0631{0, uint64(i)})
	}
...
func TestE_nocarry_0631NegZero(t *testing.T) {
	var a, b e_nocarry_0631
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0631Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0631, len(staticTestValues))
...
func TestE_nocarry_0631Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0631) bool {
			var b e_nocarry_0631
...
func TestE_nocarry_0631InverseExp(t *testing.T) {
...
func TestE_nocarry_0631MulByConstants(t *testing.T) {
...
func TestE_nocarry_0631Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0631) bool {
...
func TestE_nocarry_0631LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0631Halve(t *testing.T) {
...
func TestE_nocarry_0631FromMont(t *testing.T) {
...
type testPaire_nocarry_0631 struct {
	element e_nocarry_0631
	bigint  big.Int
}

func (z *e_nocarry_0631) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0631[9] {
		return true
	}
	if z[9] < qe_nocarry_0631[9] {
		return false
	...
	return z[0] >= qe_nocarry_0631[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0631

		g.element = e_nocarry_0631{
		...
		if qe_nocarry_0631[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0631[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0631 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0631[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0631[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0631[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0631[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0631[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0631[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0631[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0631[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0631[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0631[9], carry)
...
func Benchmarke_nocarry_0631InverseNew(b *testing.B) {
	var x e_nocarry_0631
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0631
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0631
		var xInv e_nocarry_0631
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0631
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0631
...
func testLinearComb(t *testing.T, x *e_nocarry_0631, xC int64, y *e_nocarry_0631, yC int64) {
	...
	var z e_nocarry_0631
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0631, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0631
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0631, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0631
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0631, xHi uint64) {
	var res e_nocarry_0631
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0631) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0631) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0631, c int64, result *e_nocarry_0631, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0631) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0631) uint64 {
