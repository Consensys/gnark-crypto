...
var benchRese_nocarry_0395 e_nocarry_0395

func BenchmarkE_nocarry_0395SetBytes(b *testing.B) {
	var x e_nocarry_0395
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0395MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0395.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0395)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0395)
		}
	})
}

func BenchmarkE_nocarry_0395Inverse(b *testing.B) {
	var x e_nocarry_0395
	x.SetRandom()
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0395Butterfly(b *testing.B) {
	var x e_nocarry_0395
	x.SetRandom()
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0395)
	}
}

func BenchmarkE_nocarry_0395Exp(b *testing.B) {
	var x e_nocarry_0395
	x.SetRandom()
	benchRese_nocarry_0395.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0395Double(b *testing.B) {
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Double(&benchRese_nocarry_0395)
	}
}

func BenchmarkE_nocarry_0395Add(b *testing.B) {
	var x e_nocarry_0395
	x.SetRandom()
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Add(&x, &benchRese_nocarry_0395)
	}
}

func BenchmarkE_nocarry_0395Sub(b *testing.B) {
	var x e_nocarry_0395
	x.SetRandom()
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Sub(&x, &benchRese_nocarry_0395)
	}
}

func BenchmarkE_nocarry_0395Neg(b *testing.B) {
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Neg(&benchRese_nocarry_0395)
	}
}

func BenchmarkE_nocarry_0395Div(b *testing.B) {
	var x e_nocarry_0395
	x.SetRandom()
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Div(&x, &benchRese_nocarry_0395)
	}
}

func BenchmarkE_nocarry_0395FromMont(b *testing.B) {
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.FromMont()
	}
}

func BenchmarkE_nocarry_0395ToMont(b *testing.B) {
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.ToMont()
	}
}
func BenchmarkE_nocarry_0395Square(b *testing.B) {
	benchRese_nocarry_0395.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Square(&benchRese_nocarry_0395)
	}
}

func BenchmarkE_nocarry_0395Sqrt(b *testing.B) {
	var a e_nocarry_0395
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0395Mul(b *testing.B) {
	x := e_nocarry_0395{
	...
	benchRese_nocarry_0395.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Mul(&benchRese_nocarry_0395, &x)
	}
}

func BenchmarkE_nocarry_0395Cmp(b *testing.B) {
	x := e_nocarry_0395{
		15055201898157255901,
		9938622467097523657,
		17794791813920586978,
	...
	benchRese_nocarry_0395 = x
	benchRese_nocarry_0395[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0395.Cmp(&x)
	}
}

func TestE_nocarry_0395Cmp(t *testing.T) {
	var x, y e_nocarry_0395
...
func TestE_nocarry_0395IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0395
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0395

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0395{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0395
	one.SetOne()
	e.Sub(&qe_nocarry_0395, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0395{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0395{0, uint64(i)})
	}
...
func TestE_nocarry_0395NegZero(t *testing.T) {
	var a, b e_nocarry_0395
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0395Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0395, len(staticTestValues))
...
func TestE_nocarry_0395Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0395) bool {
			var b e_nocarry_0395
...
func TestE_nocarry_0395InverseExp(t *testing.T) {
...
func TestE_nocarry_0395MulByConstants(t *testing.T) {
...
func TestE_nocarry_0395Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0395) bool {
...
func TestE_nocarry_0395LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0395Halve(t *testing.T) {
...
func TestE_nocarry_0395FromMont(t *testing.T) {
...
type testPaire_nocarry_0395 struct {
	element e_nocarry_0395
	bigint  big.Int
}

func (z *e_nocarry_0395) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0395[6] {
		return true
	}
	if z[6] < qe_nocarry_0395[6] {
		return false
	...
	return z[0] >= qe_nocarry_0395[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0395

		g.element = e_nocarry_0395{
		...
		if qe_nocarry_0395[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0395[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0395 {
			var g e_nocarry_0395
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0395[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0395[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0395[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0395[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0395[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0395[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0395[6], carry)
...
func Benchmarke_nocarry_0395InverseNew(b *testing.B) {
	var x e_nocarry_0395
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0395
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0395
		var xInv e_nocarry_0395
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0395
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0395
...
func testLinearComb(t *testing.T, x *e_nocarry_0395, xC int64, y *e_nocarry_0395, yC int64) {
	...
	var z e_nocarry_0395
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0395, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0395
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0395, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0395
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0395, xHi uint64) {
	var res e_nocarry_0395
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0395) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0395) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0395, c int64, result *e_nocarry_0395, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0395) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0395) uint64 {
