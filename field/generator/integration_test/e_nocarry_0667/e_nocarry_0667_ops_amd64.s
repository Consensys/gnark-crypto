...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x5fae6e42e084ee0d, R14
	ADDQ R14, AX
	MOVQ $0xe21a5964861f942d, R14
	ADCQ R14, DX
	MOVQ $0x65e0679cfa1cfba8, R14
	ADCQ R14, CX
	MOVQ $0x0d17db24c21d7896, R14
	ADCQ R14, BX
	MOVQ $0xbceb15a0b619d932, R14
	ADCQ R14, SI
	MOVQ $0x2c061c98600971ad, R14
	ADCQ R14, DI
	MOVQ $0xf1d14f2942716596, R14
	ADCQ R14, R8
	MOVQ $0xb2f750d2b3daa154, R14
	ADCQ R14, R9
	MOVQ $0x303e755f0f36615f, R14
	ADCQ R14, R10
	MOVQ $0xac7f3f5dd2952c0a, R14
	ADCQ R14, R11
	MOVQ $0x00000000079a10e8, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x5fae6e42e084ee0d, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xe21a5964861f942d, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x65e0679cfa1cfba8, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x0d17db24c21d7896, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xbceb15a0b619d932, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x2c061c98600971ad, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xf1d14f2942716596, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xb2f750d2b3daa154, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x303e755f0f36615f, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xac7f3f5dd2952c0a, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000079a10e8, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x5fae6e42e084ee0d, AX
	ADDQ AX, DX
	MOVQ $0xe21a5964861f942d, AX
	ADCQ AX, CX
	MOVQ $0x65e0679cfa1cfba8, AX
	ADCQ AX, BX
	MOVQ $0x0d17db24c21d7896, AX
	ADCQ AX, SI
	MOVQ $0xbceb15a0b619d932, AX
	ADCQ AX, DI
	MOVQ $0x2c061c98600971ad, AX
	ADCQ AX, R8
	MOVQ $0xf1d14f2942716596, AX
	ADCQ AX, R9
	MOVQ $0xb2f750d2b3daa154, AX
	ADCQ AX, R10
	MOVQ $0x303e755f0f36615f, AX
	ADCQ AX, R11
	MOVQ $0xac7f3f5dd2952c0a, AX
	ADCQ AX, R12
	MOVQ $0x00000000079a10e8, AX
	ADCQ AX, R13
