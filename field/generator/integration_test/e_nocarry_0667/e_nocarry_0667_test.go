...
var benchRese_nocarry_0667 e_nocarry_0667

func BenchmarkE_nocarry_0667SetBytes(b *testing.B) {
	var x e_nocarry_0667
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0667MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0667.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0667)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0667)
		}
	})
}

func BenchmarkE_nocarry_0667Inverse(b *testing.B) {
	var x e_nocarry_0667
	x.SetRandom()
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0667Butterfly(b *testing.B) {
	var x e_nocarry_0667
	x.SetRandom()
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0667)
	}
}

func BenchmarkE_nocarry_0667Exp(b *testing.B) {
	var x e_nocarry_0667
	x.SetRandom()
	benchRese_nocarry_0667.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0667Double(b *testing.B) {
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Double(&benchRese_nocarry_0667)
	}
}

func BenchmarkE_nocarry_0667Add(b *testing.B) {
	var x e_nocarry_0667
	x.SetRandom()
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Add(&x, &benchRese_nocarry_0667)
	}
}

func BenchmarkE_nocarry_0667Sub(b *testing.B) {
	var x e_nocarry_0667
	x.SetRandom()
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Sub(&x, &benchRese_nocarry_0667)
	}
}

func BenchmarkE_nocarry_0667Neg(b *testing.B) {
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Neg(&benchRese_nocarry_0667)
	}
}

func BenchmarkE_nocarry_0667Div(b *testing.B) {
	var x e_nocarry_0667
	x.SetRandom()
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Div(&x, &benchRese_nocarry_0667)
	}
}

func BenchmarkE_nocarry_0667FromMont(b *testing.B) {
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.FromMont()
	}
}

func BenchmarkE_nocarry_0667ToMont(b *testing.B) {
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.ToMont()
	}
}
func BenchmarkE_nocarry_0667Square(b *testing.B) {
	benchRese_nocarry_0667.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Square(&benchRese_nocarry_0667)
	}
}

func BenchmarkE_nocarry_0667Sqrt(b *testing.B) {
	var a e_nocarry_0667
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0667Mul(b *testing.B) {
	x := e_nocarry_0667{
	...
	benchRese_nocarry_0667.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Mul(&benchRese_nocarry_0667, &x)
	}
}

func BenchmarkE_nocarry_0667Cmp(b *testing.B) {
	x := e_nocarry_0667{
		12849613743407076077,
		6129510478032072680,
		6225155554588982941,
	...
	benchRese_nocarry_0667 = x
	benchRese_nocarry_0667[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0667.Cmp(&x)
	}
}

func TestE_nocarry_0667Cmp(t *testing.T) {
	var x, y e_nocarry_0667
...
func TestE_nocarry_0667IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0667
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0667

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0667{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0667
	one.SetOne()
	e.Sub(&qe_nocarry_0667, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0667{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0667{0, uint64(i)})
	}
...
func TestE_nocarry_0667NegZero(t *testing.T) {
	var a, b e_nocarry_0667
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0667Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0667, len(staticTestValues))
...
func TestE_nocarry_0667Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0667) bool {
			var b e_nocarry_0667
...
func TestE_nocarry_0667InverseExp(t *testing.T) {
...
func TestE_nocarry_0667MulByConstants(t *testing.T) {
...
func TestE_nocarry_0667Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0667) bool {
...
func TestE_nocarry_0667LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0667Halve(t *testing.T) {
...
func TestE_nocarry_0667FromMont(t *testing.T) {
...
type testPaire_nocarry_0667 struct {
	element e_nocarry_0667
	bigint  big.Int
}

func (z *e_nocarry_0667) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0667[10] {
		return true
	}
	if z[10] < qe_nocarry_0667[10] {
		return false
	...
	return z[0] >= qe_nocarry_0667[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0667

		g.element = e_nocarry_0667{
		...
		if qe_nocarry_0667[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0667[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0667 {
			var g e_nocarry_0667
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0667[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0667[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0667[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0667[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0667[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0667[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0667[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0667[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0667[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0667[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0667[10], carry)
...
func Benchmarke_nocarry_0667InverseNew(b *testing.B) {
	var x e_nocarry_0667
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0667
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0667
		var xInv e_nocarry_0667
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0667
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0667
...
func testLinearComb(t *testing.T, x *e_nocarry_0667, xC int64, y *e_nocarry_0667, yC int64) {
	...
	var z e_nocarry_0667
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0667, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0667
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0667, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0667
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0667, xHi uint64) {
	var res e_nocarry_0667
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0667) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0667) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0667, c int64, result *e_nocarry_0667, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0667) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0667) uint64 {
