...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xec567a4f289d8fd7, R14
	ADDQ R14, AX
	MOVQ $0x9ce9340b1ea1d3f2, R14
	ADCQ R14, DX
	MOVQ $0x8480c68e1579a0d3, R14
	ADCQ R14, CX
	MOVQ $0x316ac9bb5cb8eace, R14
	ADCQ R14, BX
	MOVQ $0x34e2efbd47fbc7b9, R14
	ADCQ R14, SI
	MOVQ $0x7110e60f7adfb69a, R14
	ADCQ R14, DI
	MOVQ $0xe010d5451976f9f6, R14
	ADCQ R14, R8
	MOVQ $0xab72757c78e04cd5, R14
	ADCQ R14, R9
	MOVQ $0x87e822f769817212, R14
	ADCQ R14, R10
	MOVQ $0xc1549a3030a5b4fc, R14
	ADCQ R14, R11
	MOVQ $0x00000000003166ec, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xec567a4f289d8fd7, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x9ce9340b1ea1d3f2, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x8480c68e1579a0d3, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x316ac9bb5cb8eace, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x34e2efbd47fbc7b9, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x7110e60f7adfb69a, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xe010d5451976f9f6, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xab72757c78e04cd5, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x87e822f769817212, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xc1549a3030a5b4fc, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000003166ec, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xec567a4f289d8fd7, AX
	ADDQ AX, DX
	MOVQ $0x9ce9340b1ea1d3f2, AX
	ADCQ AX, CX
	MOVQ $0x8480c68e1579a0d3, AX
	ADCQ AX, BX
	MOVQ $0x316ac9bb5cb8eace, AX
	ADCQ AX, SI
	MOVQ $0x34e2efbd47fbc7b9, AX
	ADCQ AX, DI
	MOVQ $0x7110e60f7adfb69a, AX
	ADCQ AX, R8
	MOVQ $0xe010d5451976f9f6, AX
	ADCQ AX, R9
	MOVQ $0xab72757c78e04cd5, AX
	ADCQ AX, R10
	MOVQ $0x87e822f769817212, AX
	ADCQ AX, R11
	MOVQ $0xc1549a3030a5b4fc, AX
	ADCQ AX, R12
	MOVQ $0x00000000003166ec, AX
	ADCQ AX, R13
