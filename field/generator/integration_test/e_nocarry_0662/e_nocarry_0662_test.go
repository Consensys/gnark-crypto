...
var benchRese_nocarry_0662 e_nocarry_0662

func BenchmarkE_nocarry_0662SetBytes(b *testing.B) {
	var x e_nocarry_0662
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0662MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0662.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0662)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0662)
		}
	})
}

func BenchmarkE_nocarry_0662Inverse(b *testing.B) {
	var x e_nocarry_0662
	x.SetRandom()
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0662Butterfly(b *testing.B) {
	var x e_nocarry_0662
	x.SetRandom()
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0662)
	}
}

func BenchmarkE_nocarry_0662Exp(b *testing.B) {
	var x e_nocarry_0662
	x.SetRandom()
	benchRese_nocarry_0662.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0662Double(b *testing.B) {
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Double(&benchRese_nocarry_0662)
	}
}

func BenchmarkE_nocarry_0662Add(b *testing.B) {
	var x e_nocarry_0662
	x.SetRandom()
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Add(&x, &benchRese_nocarry_0662)
	}
}

func BenchmarkE_nocarry_0662Sub(b *testing.B) {
	var x e_nocarry_0662
	x.SetRandom()
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Sub(&x, &benchRese_nocarry_0662)
	}
}

func BenchmarkE_nocarry_0662Neg(b *testing.B) {
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Neg(&benchRese_nocarry_0662)
	}
}

func BenchmarkE_nocarry_0662Div(b *testing.B) {
	var x e_nocarry_0662
	x.SetRandom()
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Div(&x, &benchRese_nocarry_0662)
	}
}

func BenchmarkE_nocarry_0662FromMont(b *testing.B) {
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.FromMont()
	}
}

func BenchmarkE_nocarry_0662ToMont(b *testing.B) {
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.ToMont()
	}
}
func BenchmarkE_nocarry_0662Square(b *testing.B) {
	benchRese_nocarry_0662.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Square(&benchRese_nocarry_0662)
	}
}

func BenchmarkE_nocarry_0662Sqrt(b *testing.B) {
	var a e_nocarry_0662
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0662Mul(b *testing.B) {
	x := e_nocarry_0662{
	...
	benchRese_nocarry_0662.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Mul(&benchRese_nocarry_0662, &x)
	}
}

func BenchmarkE_nocarry_0662Cmp(b *testing.B) {
	x := e_nocarry_0662{
		11097415274465103789,
		5121955671518114104,
		9212064237713928322,
	...
	benchRese_nocarry_0662 = x
	benchRese_nocarry_0662[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0662.Cmp(&x)
	}
}

func TestE_nocarry_0662Cmp(t *testing.T) {
	var x, y e_nocarry_0662
...
func TestE_nocarry_0662IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0662
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0662

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0662{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0662
	one.SetOne()
	e.Sub(&qe_nocarry_0662, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0662{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0662{0, uint64(i)})
	}
...
func TestE_nocarry_0662NegZero(t *testing.T) {
	var a, b e_nocarry_0662
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0662Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0662, len(staticTestValues))
...
func TestE_nocarry_0662Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0662) bool {
			var b e_nocarry_0662
...
func TestE_nocarry_0662InverseExp(t *testing.T) {
...
func TestE_nocarry_0662MulByConstants(t *testing.T) {
...
func TestE_nocarry_0662Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0662) bool {
...
func TestE_nocarry_0662LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0662Halve(t *testing.T) {
...
func TestE_nocarry_0662FromMont(t *testing.T) {
...
type testPaire_nocarry_0662 struct {
	element e_nocarry_0662
	bigint  big.Int
}

func (z *e_nocarry_0662) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0662[10] {
		return true
	}
	if z[10] < qe_nocarry_0662[10] {
		return false
	...
	return z[0] >= qe_nocarry_0662[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0662

		g.element = e_nocarry_0662{
		...
		if qe_nocarry_0662[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0662[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0662 {
			var g e_nocarry_0662
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0662[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0662[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0662[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0662[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0662[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0662[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0662[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0662[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0662[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0662[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0662[10], carry)
...
func Benchmarke_nocarry_0662InverseNew(b *testing.B) {
	var x e_nocarry_0662
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0662
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0662
		var xInv e_nocarry_0662
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0662
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0662
...
func testLinearComb(t *testing.T, x *e_nocarry_0662, xC int64, y *e_nocarry_0662, yC int64) {
	...
	var z e_nocarry_0662
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0662, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0662
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0662, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0662
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0662, xHi uint64) {
	var res e_nocarry_0662
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0662) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0662) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0662, c int64, result *e_nocarry_0662, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0662) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0662) uint64 {
