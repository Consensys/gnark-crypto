...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0321{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0321{0, uint64(i)})
	}
...
func (z *e_nocarry_0321) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0321[5] {
		return true
	}
	if z[5] < qe_nocarry_0321[5] {
		return false
...
func Benchmarke_nocarry_0321InverseNew(b *testing.B) {
	var x e_nocarry_0321
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0321, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0321, xHi uint64) {
