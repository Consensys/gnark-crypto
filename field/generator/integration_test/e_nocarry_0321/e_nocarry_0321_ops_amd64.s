...
// modulus q
DATA q<>+0(SB)/8, $0xc7aeb1f9d01e8659
DATA q<>+8(SB)/8, $0xf0e105e392e2c7ad
DATA q<>+16(SB)/8, $0x0253c02880add553
DATA q<>+24(SB)/8, $0x4010214e2c839f5b
DATA q<>+32(SB)/8, $0xbba5b65ee41f2203
DATA q<>+40(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x31c0d085ac2f9e17
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xc7aeb1f9d01e8659, R10
	MOVQ    $0xf0e105e392e2c7ad, R11
	MOVQ    $0x0253c02880add553, R12
	MOVQ    $0x4010214e2c839f5b, R13
	MOVQ    $0xbba5b65ee41f2203, R14
	MOVQ    $1, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xf0e105e392e2c7ad, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x0253c02880add553, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x4010214e2c839f5b, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xbba5b65ee41f2203, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $1, R10
	SBBQ  R8, R10
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xc7aeb1f9d01e8659, CX
	MOVQ    $0xf0e105e392e2c7ad, BX
	MOVQ    $0x0253c02880add553, SI
	MOVQ    $0x4010214e2c839f5b, DI
	MOVQ    $0xbba5b65ee41f2203, R8
	MOVQ    $1, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
