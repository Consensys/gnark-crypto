...
var benchRese_nocarry_0659 e_nocarry_0659

func BenchmarkE_nocarry_0659SetBytes(b *testing.B) {
	var x e_nocarry_0659
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0659MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0659.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0659)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0659)
		}
	})
}

func BenchmarkE_nocarry_0659Inverse(b *testing.B) {
	var x e_nocarry_0659
	x.SetRandom()
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0659Butterfly(b *testing.B) {
	var x e_nocarry_0659
	x.SetRandom()
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0659)
	}
}

func BenchmarkE_nocarry_0659Exp(b *testing.B) {
	var x e_nocarry_0659
	x.SetRandom()
	benchRese_nocarry_0659.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0659Double(b *testing.B) {
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Double(&benchRese_nocarry_0659)
	}
}

func BenchmarkE_nocarry_0659Add(b *testing.B) {
	var x e_nocarry_0659
	x.SetRandom()
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Add(&x, &benchRese_nocarry_0659)
	}
}

func BenchmarkE_nocarry_0659Sub(b *testing.B) {
	var x e_nocarry_0659
	x.SetRandom()
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Sub(&x, &benchRese_nocarry_0659)
	}
}

func BenchmarkE_nocarry_0659Neg(b *testing.B) {
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Neg(&benchRese_nocarry_0659)
	}
}

func BenchmarkE_nocarry_0659Div(b *testing.B) {
	var x e_nocarry_0659
	x.SetRandom()
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Div(&x, &benchRese_nocarry_0659)
	}
}

func BenchmarkE_nocarry_0659FromMont(b *testing.B) {
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.FromMont()
	}
}

func BenchmarkE_nocarry_0659ToMont(b *testing.B) {
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.ToMont()
	}
}
func BenchmarkE_nocarry_0659Square(b *testing.B) {
	benchRese_nocarry_0659.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Square(&benchRese_nocarry_0659)
	}
}

func BenchmarkE_nocarry_0659Sqrt(b *testing.B) {
	var a e_nocarry_0659
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0659Mul(b *testing.B) {
	x := e_nocarry_0659{
		8147352035283941720,
		409226593960084657,
		6426909508694393768,
	...
	benchRese_nocarry_0659.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Mul(&benchRese_nocarry_0659, &x)
	}
}

func BenchmarkE_nocarry_0659Cmp(b *testing.B) {
	x := e_nocarry_0659{
		8147352035283941720,
		409226593960084657,
		6426909508694393768,
	...
	benchRese_nocarry_0659 = x
	benchRese_nocarry_0659[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0659.Cmp(&x)
	}
}

func TestE_nocarry_0659Cmp(t *testing.T) {
	var x, y e_nocarry_0659
...
func TestE_nocarry_0659IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0659
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0659

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0659{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0659
	one.SetOne()
	e.Sub(&qe_nocarry_0659, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0659{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0659{0, uint64(i)})
	}
...
func TestE_nocarry_0659NegZero(t *testing.T) {
	var a, b e_nocarry_0659
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0659Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0659, len(staticTestValues))
...
func TestE_nocarry_0659Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0659) bool {
			var b e_nocarry_0659
...
func TestE_nocarry_0659InverseExp(t *testing.T) {
...
func TestE_nocarry_0659MulByConstants(t *testing.T) {
...
func TestE_nocarry_0659Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0659) bool {
...
func TestE_nocarry_0659LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0659Halve(t *testing.T) {
...
func TestE_nocarry_0659FromMont(t *testing.T) {
...
type testPaire_nocarry_0659 struct {
	element e_nocarry_0659
	bigint  big.Int
}

func (z *e_nocarry_0659) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0659[10] {
		return true
	}
	if z[10] < qe_nocarry_0659[10] {
		return false
	...
	return z[0] >= qe_nocarry_0659[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0659

		g.element = e_nocarry_0659{
		...
		if qe_nocarry_0659[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0659[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0659 {
			var g e_nocarry_0659
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0659[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0659[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0659[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0659[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0659[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0659[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0659[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0659[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0659[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0659[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0659[10], carry)
...
func Benchmarke_nocarry_0659InverseNew(b *testing.B) {
	var x e_nocarry_0659
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0659
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0659
		var xInv e_nocarry_0659
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0659
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0659
...
func testLinearComb(t *testing.T, x *e_nocarry_0659, xC int64, y *e_nocarry_0659, yC int64) {
	...
	var z e_nocarry_0659
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0659, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0659
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0659, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0659
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0659, xHi uint64) {
	var res e_nocarry_0659
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0659) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0659) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0659, c int64, result *e_nocarry_0659, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0659) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0659) uint64 {
