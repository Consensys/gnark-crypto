...
var benchRese_nocarry_0325 e_nocarry_0325

func BenchmarkE_nocarry_0325SetBytes(b *testing.B) {
	var x e_nocarry_0325
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0325MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0325.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0325)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0325)
		}
	})
}

func BenchmarkE_nocarry_0325Inverse(b *testing.B) {
	var x e_nocarry_0325
	x.SetRandom()
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0325Butterfly(b *testing.B) {
	var x e_nocarry_0325
	x.SetRandom()
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0325)
	}
}

func BenchmarkE_nocarry_0325Exp(b *testing.B) {
	var x e_nocarry_0325
	x.SetRandom()
	benchRese_nocarry_0325.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0325Double(b *testing.B) {
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Double(&benchRese_nocarry_0325)
	}
}

func BenchmarkE_nocarry_0325Add(b *testing.B) {
	var x e_nocarry_0325
	x.SetRandom()
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Add(&x, &benchRese_nocarry_0325)
	}
}

func BenchmarkE_nocarry_0325Sub(b *testing.B) {
	var x e_nocarry_0325
	x.SetRandom()
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Sub(&x, &benchRese_nocarry_0325)
	}
}

func BenchmarkE_nocarry_0325Neg(b *testing.B) {
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Neg(&benchRese_nocarry_0325)
	}
}

func BenchmarkE_nocarry_0325Div(b *testing.B) {
	var x e_nocarry_0325
	x.SetRandom()
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Div(&x, &benchRese_nocarry_0325)
	}
}

func BenchmarkE_nocarry_0325FromMont(b *testing.B) {
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.FromMont()
	}
}

func BenchmarkE_nocarry_0325ToMont(b *testing.B) {
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.ToMont()
	}
}
func BenchmarkE_nocarry_0325Square(b *testing.B) {
	benchRese_nocarry_0325.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Square(&benchRese_nocarry_0325)
	}
}

func BenchmarkE_nocarry_0325Sqrt(b *testing.B) {
	var a e_nocarry_0325
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0325Mul(b *testing.B) {
	x := e_nocarry_0325{
		708352378479071801,
		7134821638711814898,
		4456898019501475120,
	...
	benchRese_nocarry_0325.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Mul(&benchRese_nocarry_0325, &x)
	}
}

func BenchmarkE_nocarry_0325Cmp(b *testing.B) {
	x := e_nocarry_0325{
		708352378479071801,
		7134821638711814898,
		4456898019501475120,
	...
	benchRese_nocarry_0325 = x
	benchRese_nocarry_0325[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0325.Cmp(&x)
	}
}

func TestE_nocarry_0325Cmp(t *testing.T) {
	var x, y e_nocarry_0325
...
func TestE_nocarry_0325IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0325
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0325

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0325{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0325
	one.SetOne()
	e.Sub(&qe_nocarry_0325, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0325{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0325{0, uint64(i)})
	}
...
func TestE_nocarry_0325NegZero(t *testing.T) {
	var a, b e_nocarry_0325
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0325Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0325, len(staticTestValues))
...
func TestE_nocarry_0325Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0325) bool {
			var b e_nocarry_0325
...
func TestE_nocarry_0325InverseExp(t *testing.T) {
...
func TestE_nocarry_0325MulByConstants(t *testing.T) {
...
func TestE_nocarry_0325Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0325) bool {
...
func TestE_nocarry_0325LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0325Halve(t *testing.T) {
...
func TestE_nocarry_0325FromMont(t *testing.T) {
...
type testPaire_nocarry_0325 struct {
	element e_nocarry_0325
	bigint  big.Int
}

func (z *e_nocarry_0325) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0325[5] {
		return true
	}
	if z[5] < qe_nocarry_0325[5] {
		return false
	...
	return z[0] >= qe_nocarry_0325[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0325

		g.element = e_nocarry_0325{
		...
		if qe_nocarry_0325[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0325[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0325 {
			var g e_nocarry_0325
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0325[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0325[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0325[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0325[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0325[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0325[5], carry)
...
func Benchmarke_nocarry_0325InverseNew(b *testing.B) {
	var x e_nocarry_0325
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0325
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0325
		var xInv e_nocarry_0325
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0325
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0325
...
func testLinearComb(t *testing.T, x *e_nocarry_0325, xC int64, y *e_nocarry_0325, yC int64) {
	...
	var z e_nocarry_0325
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0325, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0325
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0325, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0325
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0325, xHi uint64) {
	var res e_nocarry_0325
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0325) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0325) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0325, c int64, result *e_nocarry_0325, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0325) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0325) uint64 {
