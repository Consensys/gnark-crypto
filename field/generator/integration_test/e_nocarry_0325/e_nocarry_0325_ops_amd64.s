...
// modulus q
DATA q<>+0(SB)/8, $0xf63105a28bb4330b
DATA q<>+8(SB)/8, $0x8052d9093cb863c0
DATA q<>+16(SB)/8, $0x080dce7540f14300
DATA q<>+24(SB)/8, $0xaaeabfd6164f4803
DATA q<>+32(SB)/8, $0x80479baeb2d6422b
DATA q<>+40(SB)/8, $0x000000000000001b
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x68ad61c871057f5d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xf63105a28bb4330b, R10
	MOVQ    $0x8052d9093cb863c0, R11
	MOVQ    $0x080dce7540f14300, R12
	MOVQ    $0xaaeabfd6164f4803, R13
	MOVQ    $0x80479baeb2d6422b, R14
	MOVQ    $0x000000000000001b, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x8052d9093cb863c0, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x080dce7540f14300, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xaaeabfd6164f4803, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x80479baeb2d6422b, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000000000001b, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xf63105a28bb4330b, CX
	MOVQ    $0x8052d9093cb863c0, BX
	MOVQ    $0x080dce7540f14300, SI
	MOVQ    $0xaaeabfd6164f4803, DI
	MOVQ    $0x80479baeb2d6422b, R8
	MOVQ    $0x000000000000001b, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
