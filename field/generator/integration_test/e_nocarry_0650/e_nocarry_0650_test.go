...
var benchRese_nocarry_0650 e_nocarry_0650

func BenchmarkE_nocarry_0650SetBytes(b *testing.B) {
	var x e_nocarry_0650
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0650MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0650.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0650)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0650)
		}
	})
}

func BenchmarkE_nocarry_0650Inverse(b *testing.B) {
	var x e_nocarry_0650
	x.SetRandom()
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0650Butterfly(b *testing.B) {
	var x e_nocarry_0650
	x.SetRandom()
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0650)
	}
}

func BenchmarkE_nocarry_0650Exp(b *testing.B) {
	var x e_nocarry_0650
	x.SetRandom()
	benchRese_nocarry_0650.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0650Double(b *testing.B) {
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Double(&benchRese_nocarry_0650)
	}
}

func BenchmarkE_nocarry_0650Add(b *testing.B) {
	var x e_nocarry_0650
	x.SetRandom()
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Add(&x, &benchRese_nocarry_0650)
	}
}

func BenchmarkE_nocarry_0650Sub(b *testing.B) {
	var x e_nocarry_0650
	x.SetRandom()
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Sub(&x, &benchRese_nocarry_0650)
	}
}

func BenchmarkE_nocarry_0650Neg(b *testing.B) {
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Neg(&benchRese_nocarry_0650)
	}
}

func BenchmarkE_nocarry_0650Div(b *testing.B) {
	var x e_nocarry_0650
	x.SetRandom()
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Div(&x, &benchRese_nocarry_0650)
	}
}

func BenchmarkE_nocarry_0650FromMont(b *testing.B) {
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.FromMont()
	}
}

func BenchmarkE_nocarry_0650ToMont(b *testing.B) {
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.ToMont()
	}
}
func BenchmarkE_nocarry_0650Square(b *testing.B) {
	benchRese_nocarry_0650.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Square(&benchRese_nocarry_0650)
	}
}

func BenchmarkE_nocarry_0650Sqrt(b *testing.B) {
	var a e_nocarry_0650
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0650Mul(b *testing.B) {
	x := e_nocarry_0650{
		2472808354274319583,
	...
	benchRese_nocarry_0650.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Mul(&benchRese_nocarry_0650, &x)
	}
}

func BenchmarkE_nocarry_0650Cmp(b *testing.B) {
	x := e_nocarry_0650{
		2472808354274319583,
		18407505301494732676,
		6151140794696359076,
	...
	benchRese_nocarry_0650 = x
	benchRese_nocarry_0650[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0650.Cmp(&x)
	}
}

func TestE_nocarry_0650Cmp(t *testing.T) {
	var x, y e_nocarry_0650
...
func TestE_nocarry_0650IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0650
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0650

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0650{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0650
	one.SetOne()
	e.Sub(&qe_nocarry_0650, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0650{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0650{0, uint64(i)})
	}
...
func TestE_nocarry_0650NegZero(t *testing.T) {
	var a, b e_nocarry_0650
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0650Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0650, len(staticTestValues))
...
func TestE_nocarry_0650Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0650) bool {
			var b e_nocarry_0650
...
func TestE_nocarry_0650InverseExp(t *testing.T) {
...
func TestE_nocarry_0650MulByConstants(t *testing.T) {
...
func TestE_nocarry_0650Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0650) bool {
...
func TestE_nocarry_0650LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0650Halve(t *testing.T) {
...
func TestE_nocarry_0650FromMont(t *testing.T) {
...
type testPaire_nocarry_0650 struct {
	element e_nocarry_0650
	bigint  big.Int
}

func (z *e_nocarry_0650) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0650[10] {
		return true
	}
	if z[10] < qe_nocarry_0650[10] {
		return false
	...
	return z[0] >= qe_nocarry_0650[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0650

		g.element = e_nocarry_0650{
		...
		if qe_nocarry_0650[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0650[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0650 {
			var g e_nocarry_0650
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0650[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0650[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0650[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0650[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0650[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0650[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0650[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0650[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0650[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0650[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0650[10], carry)
...
func Benchmarke_nocarry_0650InverseNew(b *testing.B) {
	var x e_nocarry_0650
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0650
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0650
		var xInv e_nocarry_0650
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0650
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0650
...
func testLinearComb(t *testing.T, x *e_nocarry_0650, xC int64, y *e_nocarry_0650, yC int64) {
	...
	var z e_nocarry_0650
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0650, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0650
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0650, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0650
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0650, xHi uint64) {
	var res e_nocarry_0650
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0650) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0650) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0650, c int64, result *e_nocarry_0650, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0650) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0650) uint64 {
