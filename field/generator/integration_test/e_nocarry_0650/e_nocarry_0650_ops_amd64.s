...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x0f5cad533fb97adb, R14
	ADDQ R14, AX
	MOVQ $0xf5f641edd73162aa, R14
	ADCQ R14, DX
	MOVQ $0xcc8374a80f703970, R14
	ADCQ R14, CX
	MOVQ $0xc42c9cd46427afac, R14
	ADCQ R14, BX
	MOVQ $0x118290de6d0ed76f, R14
	ADCQ R14, SI
	MOVQ $0x2c2be76eab857914, R14
	ADCQ R14, DI
	MOVQ $0xe0df53fea31811c9, R14
	ADCQ R14, R8
	MOVQ $0xb334a31b0660910f, R14
	ADCQ R14, R9
	MOVQ $0x5fe28eb18479e263, R14
	ADCQ R14, R10
	MOVQ $0xcf30d94b799ab8f8, R14
	ADCQ R14, R11
	MOVQ $0x0000000000000369, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x0f5cad533fb97adb, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xf5f641edd73162aa, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xcc8374a80f703970, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xc42c9cd46427afac, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x118290de6d0ed76f, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x2c2be76eab857914, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xe0df53fea31811c9, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xb334a31b0660910f, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x5fe28eb18479e263, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xcf30d94b799ab8f8, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000000000369, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x0f5cad533fb97adb, AX
	ADDQ AX, DX
	MOVQ $0xf5f641edd73162aa, AX
	ADCQ AX, CX
	MOVQ $0xcc8374a80f703970, AX
	ADCQ AX, BX
	MOVQ $0xc42c9cd46427afac, AX
	ADCQ AX, SI
	MOVQ $0x118290de6d0ed76f, AX
	ADCQ AX, DI
	MOVQ $0x2c2be76eab857914, AX
	ADCQ AX, R8
	MOVQ $0xe0df53fea31811c9, AX
	ADCQ AX, R9
	MOVQ $0xb334a31b0660910f, AX
	ADCQ AX, R10
	MOVQ $0x5fe28eb18479e263, AX
	ADCQ AX, R11
	MOVQ $0xcf30d94b799ab8f8, AX
	ADCQ AX, R12
	MOVQ $0x0000000000000369, AX
	ADCQ AX, R13
