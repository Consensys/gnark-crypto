...
var benchRese_nocarry_0169 e_nocarry_0169

func BenchmarkE_nocarry_0169SetBytes(b *testing.B) {
	var x e_nocarry_0169
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0169MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0169.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0169)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0169)
		}
	})
}

func BenchmarkE_nocarry_0169Inverse(b *testing.B) {
	var x e_nocarry_0169
	x.SetRandom()
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0169Butterfly(b *testing.B) {
	var x e_nocarry_0169
	x.SetRandom()
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0169)
	}
}

func BenchmarkE_nocarry_0169Exp(b *testing.B) {
	var x e_nocarry_0169
	x.SetRandom()
	benchRese_nocarry_0169.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0169Double(b *testing.B) {
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Double(&benchRese_nocarry_0169)
	}
}

func BenchmarkE_nocarry_0169Add(b *testing.B) {
	var x e_nocarry_0169
	x.SetRandom()
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Add(&x, &benchRese_nocarry_0169)
	}
}

func BenchmarkE_nocarry_0169Sub(b *testing.B) {
	var x e_nocarry_0169
	x.SetRandom()
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Sub(&x, &benchRese_nocarry_0169)
	}
}

func BenchmarkE_nocarry_0169Neg(b *testing.B) {
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Neg(&benchRese_nocarry_0169)
	}
}

func BenchmarkE_nocarry_0169Div(b *testing.B) {
	var x e_nocarry_0169
	x.SetRandom()
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Div(&x, &benchRese_nocarry_0169)
	}
}

func BenchmarkE_nocarry_0169FromMont(b *testing.B) {
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.FromMont()
	}
}

func BenchmarkE_nocarry_0169ToMont(b *testing.B) {
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.ToMont()
	}
}
func BenchmarkE_nocarry_0169Square(b *testing.B) {
	benchRese_nocarry_0169.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Square(&benchRese_nocarry_0169)
	}
}

func BenchmarkE_nocarry_0169Sqrt(b *testing.B) {
	var a e_nocarry_0169
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0169Mul(b *testing.B) {
	x := e_nocarry_0169{
		4218245523947310836,
		2303108550264721517,
		633342801387,
	}
	benchRese_nocarry_0169.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Mul(&benchRese_nocarry_0169, &x)
	}
}

func BenchmarkE_nocarry_0169Cmp(b *testing.B) {
	x := e_nocarry_0169{
		4218245523947310836,
		2303108550264721517,
		633342801387,
	}
	benchRese_nocarry_0169 = x
	benchRese_nocarry_0169[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0169.Cmp(&x)
	}
}

func TestE_nocarry_0169Cmp(t *testing.T) {
	var x, y e_nocarry_0169
...
func TestE_nocarry_0169IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0169
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0169

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0169{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0169
	one.SetOne()
	e.Sub(&qe_nocarry_0169, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0169{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0169{0, uint64(i)})
	}
...
func TestE_nocarry_0169NegZero(t *testing.T) {
	var a, b e_nocarry_0169
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0169Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0169, len(staticTestValues))
...
func TestE_nocarry_0169Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0169) bool {
			var b e_nocarry_0169
...
func TestE_nocarry_0169InverseExp(t *testing.T) {
...
func TestE_nocarry_0169MulByConstants(t *testing.T) {
...
func TestE_nocarry_0169Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0169) bool {
...
func TestE_nocarry_0169LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0169Halve(t *testing.T) {
...
func TestE_nocarry_0169FromMont(t *testing.T) {
...
type testPaire_nocarry_0169 struct {
	element e_nocarry_0169
	bigint  big.Int
}

func (z *e_nocarry_0169) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0169[2] {
		return true
	}
	if z[2] < qe_nocarry_0169[2] {
		return false
	...
	return z[0] >= qe_nocarry_0169[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0169

		g.element = e_nocarry_0169{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0169[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0169[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0169 {
			var g e_nocarry_0169
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0169[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0169[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0169[2], carry)
...
func Benchmarke_nocarry_0169InverseNew(b *testing.B) {
	var x e_nocarry_0169
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0169
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0169
		var xInv e_nocarry_0169
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0169
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0169
...
func testLinearComb(t *testing.T, x *e_nocarry_0169, xC int64, y *e_nocarry_0169, yC int64) {
	...
	var z e_nocarry_0169
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0169, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0169
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0169, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0169
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0169, xHi uint64) {
	var res e_nocarry_0169
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0169) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0169) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0169, c int64, result *e_nocarry_0169, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0169) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0169) uint64 {
