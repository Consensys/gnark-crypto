...
// modulus q
DATA q<>+0(SB)/8, $0x786c286b6d4cab9b
DATA q<>+8(SB)/8, $0x91bc2db65513dde6
DATA q<>+16(SB)/8, $0x678794bbfba7bcab
DATA q<>+24(SB)/8, $0xb9e1a6fb3ad04a89
DATA q<>+32(SB)/8, $0x00000000000000e4
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xabe1353395553d6d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x786c286b6d4cab9b, R9
	MOVQ    $0x91bc2db65513dde6, R10
	MOVQ    $0x678794bbfba7bcab, R11
	MOVQ    $0xb9e1a6fb3ad04a89, R12
	MOVQ    $0x00000000000000e4, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x91bc2db65513dde6, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x678794bbfba7bcab, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xb9e1a6fb3ad04a89, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00000000000000e4, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x786c286b6d4cab9b, CX
	MOVQ    $0x91bc2db65513dde6, BX
	MOVQ    $0x678794bbfba7bcab, SI
	MOVQ    $0xb9e1a6fb3ad04a89, DI
	MOVQ    $0x00000000000000e4, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
