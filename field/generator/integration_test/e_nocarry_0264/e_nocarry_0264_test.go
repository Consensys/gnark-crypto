...
var benchRese_nocarry_0264 e_nocarry_0264

func BenchmarkE_nocarry_0264SetBytes(b *testing.B) {
	var x e_nocarry_0264
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0264MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0264.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0264)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0264)
		}
	})
}

func BenchmarkE_nocarry_0264Inverse(b *testing.B) {
	var x e_nocarry_0264
	x.SetRandom()
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0264Butterfly(b *testing.B) {
	var x e_nocarry_0264
	x.SetRandom()
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0264)
	}
}

func BenchmarkE_nocarry_0264Exp(b *testing.B) {
	var x e_nocarry_0264
	x.SetRandom()
	benchRese_nocarry_0264.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0264Double(b *testing.B) {
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Double(&benchRese_nocarry_0264)
	}
}

func BenchmarkE_nocarry_0264Add(b *testing.B) {
	var x e_nocarry_0264
	x.SetRandom()
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Add(&x, &benchRese_nocarry_0264)
	}
}

func BenchmarkE_nocarry_0264Sub(b *testing.B) {
	var x e_nocarry_0264
	x.SetRandom()
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Sub(&x, &benchRese_nocarry_0264)
	}
}

func BenchmarkE_nocarry_0264Neg(b *testing.B) {
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Neg(&benchRese_nocarry_0264)
	}
}

func BenchmarkE_nocarry_0264Div(b *testing.B) {
	var x e_nocarry_0264
	x.SetRandom()
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Div(&x, &benchRese_nocarry_0264)
	}
}

func BenchmarkE_nocarry_0264FromMont(b *testing.B) {
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.FromMont()
	}
}

func BenchmarkE_nocarry_0264ToMont(b *testing.B) {
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.ToMont()
	}
}
func BenchmarkE_nocarry_0264Square(b *testing.B) {
	benchRese_nocarry_0264.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Square(&benchRese_nocarry_0264)
	}
}

func BenchmarkE_nocarry_0264Sqrt(b *testing.B) {
	var a e_nocarry_0264
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0264Mul(b *testing.B) {
	x := e_nocarry_0264{
	...
	benchRese_nocarry_0264.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Mul(&benchRese_nocarry_0264, &x)
	}
}

func BenchmarkE_nocarry_0264Cmp(b *testing.B) {
	x := e_nocarry_0264{
		17751564179018707376,
		13147923050248997901,
		11102406221152873726,
	...
	benchRese_nocarry_0264 = x
	benchRese_nocarry_0264[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0264.Cmp(&x)
	}
}

func TestE_nocarry_0264Cmp(t *testing.T) {
	var x, y e_nocarry_0264
...
func TestE_nocarry_0264IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0264
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0264

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0264{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0264
	one.SetOne()
	e.Sub(&qe_nocarry_0264, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0264{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0264{0, uint64(i)})
	}
...
func TestE_nocarry_0264NegZero(t *testing.T) {
	var a, b e_nocarry_0264
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0264Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0264, len(staticTestValues))
...
func TestE_nocarry_0264Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0264) bool {
			var b e_nocarry_0264
...
func TestE_nocarry_0264InverseExp(t *testing.T) {
...
func TestE_nocarry_0264MulByConstants(t *testing.T) {
...
func TestE_nocarry_0264Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0264) bool {
...
func TestE_nocarry_0264LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0264Halve(t *testing.T) {
...
func TestE_nocarry_0264FromMont(t *testing.T) {
...
type testPaire_nocarry_0264 struct {
	element e_nocarry_0264
	bigint  big.Int
}

func (z *e_nocarry_0264) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0264[4] {
		return true
	}
	if z[4] < qe_nocarry_0264[4] {
		return false
	...
	return z[0] >= qe_nocarry_0264[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0264

		g.element = e_nocarry_0264{
		...
		if qe_nocarry_0264[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0264[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0264 {
			var g e_nocarry_0264
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0264[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0264[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0264[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0264[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0264[4], carry)
...
func Benchmarke_nocarry_0264InverseNew(b *testing.B) {
	var x e_nocarry_0264
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0264
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0264
		var xInv e_nocarry_0264
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0264
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0264
...
func testLinearComb(t *testing.T, x *e_nocarry_0264, xC int64, y *e_nocarry_0264, yC int64) {
	...
	var z e_nocarry_0264
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0264, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0264
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0264, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0264
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0264, xHi uint64) {
	var res e_nocarry_0264
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0264) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0264) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0264, c int64, result *e_nocarry_0264, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0264) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0264) uint64 {
