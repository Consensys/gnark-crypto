...
// modulus q
DATA q<>+0(SB)/8, $0x275919389c0651df
DATA q<>+8(SB)/8, $0x4af8d82b85b764b5
DATA q<>+16(SB)/8, $0x0000000000ddc466
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x8bbb86cc611d55e1
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x275919389c0651df, DI
	MOVQ    $0x4af8d82b85b764b5, R8
	MOVQ    $0x0000000000ddc466, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x4af8d82b85b764b5, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x0000000000ddc466, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x275919389c0651df, R10
	MOVQ    $0x4af8d82b85b764b5, R11
	MOVQ    $0x0000000000ddc466, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
