...
var benchRese_nocarry_0152 e_nocarry_0152

func BenchmarkE_nocarry_0152SetBytes(b *testing.B) {
	var x e_nocarry_0152
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0152MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0152.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0152)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0152)
		}
	})
}

func BenchmarkE_nocarry_0152Inverse(b *testing.B) {
	var x e_nocarry_0152
	x.SetRandom()
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0152Butterfly(b *testing.B) {
	var x e_nocarry_0152
	x.SetRandom()
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0152)
	}
}

func BenchmarkE_nocarry_0152Exp(b *testing.B) {
	var x e_nocarry_0152
	x.SetRandom()
	benchRese_nocarry_0152.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0152Double(b *testing.B) {
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Double(&benchRese_nocarry_0152)
	}
}

func BenchmarkE_nocarry_0152Add(b *testing.B) {
	var x e_nocarry_0152
	x.SetRandom()
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Add(&x, &benchRese_nocarry_0152)
	}
}

func BenchmarkE_nocarry_0152Sub(b *testing.B) {
	var x e_nocarry_0152
	x.SetRandom()
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Sub(&x, &benchRese_nocarry_0152)
	}
}

func BenchmarkE_nocarry_0152Neg(b *testing.B) {
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Neg(&benchRese_nocarry_0152)
	}
}

func BenchmarkE_nocarry_0152Div(b *testing.B) {
	var x e_nocarry_0152
	x.SetRandom()
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Div(&x, &benchRese_nocarry_0152)
	}
}

func BenchmarkE_nocarry_0152FromMont(b *testing.B) {
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.FromMont()
	}
}

func BenchmarkE_nocarry_0152ToMont(b *testing.B) {
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.ToMont()
	}
}
func BenchmarkE_nocarry_0152Square(b *testing.B) {
	benchRese_nocarry_0152.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Square(&benchRese_nocarry_0152)
	}
}

func BenchmarkE_nocarry_0152Sqrt(b *testing.B) {
	var a e_nocarry_0152
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0152Mul(b *testing.B) {
	x := e_nocarry_0152{
		14918837561970360956,
		7466659113388651888,
		7983111,
	}
	benchRese_nocarry_0152.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Mul(&benchRese_nocarry_0152, &x)
	}
}

func BenchmarkE_nocarry_0152Cmp(b *testing.B) {
	x := e_nocarry_0152{
		14918837561970360956,
		7466659113388651888,
		7983111,
	}
	benchRese_nocarry_0152 = x
	benchRese_nocarry_0152[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0152.Cmp(&x)
	}
}

func TestE_nocarry_0152Cmp(t *testing.T) {
	var x, y e_nocarry_0152
...
func TestE_nocarry_0152IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0152
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0152

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0152{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0152
	one.SetOne()
	e.Sub(&qe_nocarry_0152, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0152{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0152{0, uint64(i)})
	}
...
func TestE_nocarry_0152NegZero(t *testing.T) {
	var a, b e_nocarry_0152
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0152Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0152, len(staticTestValues))
...
func TestE_nocarry_0152Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0152) bool {
			var b e_nocarry_0152
...
func TestE_nocarry_0152InverseExp(t *testing.T) {
...
func TestE_nocarry_0152MulByConstants(t *testing.T) {
...
func TestE_nocarry_0152Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0152) bool {
...
func TestE_nocarry_0152LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0152Halve(t *testing.T) {
...
func TestE_nocarry_0152FromMont(t *testing.T) {
...
type testPaire_nocarry_0152 struct {
	element e_nocarry_0152
	bigint  big.Int
}

func (z *e_nocarry_0152) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0152[2] {
		return true
	}
	if z[2] < qe_nocarry_0152[2] {
		return false
	...
	return z[0] >= qe_nocarry_0152[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0152

		g.element = e_nocarry_0152{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0152[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0152[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0152 {
			var g e_nocarry_0152
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0152[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0152[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0152[2], carry)
...
func Benchmarke_nocarry_0152InverseNew(b *testing.B) {
	var x e_nocarry_0152
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0152
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0152
		var xInv e_nocarry_0152
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0152
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0152
...
func testLinearComb(t *testing.T, x *e_nocarry_0152, xC int64, y *e_nocarry_0152, yC int64) {
	...
	var z e_nocarry_0152
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0152, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0152
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0152, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0152
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0152, xHi uint64) {
	var res e_nocarry_0152
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0152) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0152) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0152, c int64, result *e_nocarry_0152, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0152) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0152) uint64 {
