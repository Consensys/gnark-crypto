...
// modulus q
DATA q<>+0(SB)/8, $0xe8fcc85c6d28fe0d
DATA q<>+8(SB)/8, $0x79e915258446226d
DATA q<>+16(SB)/8, $0x2ab76704890dd205
DATA q<>+24(SB)/8, $0x4ee20be68b22917e
DATA q<>+32(SB)/8, $0xc66047be1bbdc371
DATA q<>+40(SB)/8, $0x000000000007ccc9
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xafe4245b2b597f3b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xe8fcc85c6d28fe0d, R10
	MOVQ    $0x79e915258446226d, R11
	MOVQ    $0x2ab76704890dd205, R12
	MOVQ    $0x4ee20be68b22917e, R13
	MOVQ    $0xc66047be1bbdc371, R14
	MOVQ    $0x000000000007ccc9, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x79e915258446226d, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x2ab76704890dd205, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x4ee20be68b22917e, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xc66047be1bbdc371, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000000007ccc9, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xe8fcc85c6d28fe0d, CX
	MOVQ    $0x79e915258446226d, BX
	MOVQ    $0x2ab76704890dd205, SI
	MOVQ    $0x4ee20be68b22917e, DI
	MOVQ    $0xc66047be1bbdc371, R8
	MOVQ    $0x000000000007ccc9, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
