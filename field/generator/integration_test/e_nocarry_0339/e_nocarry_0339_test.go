...
var benchRese_nocarry_0339 e_nocarry_0339

func BenchmarkE_nocarry_0339SetBytes(b *testing.B) {
	var x e_nocarry_0339
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0339MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0339.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0339)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0339)
		}
	})
}

func BenchmarkE_nocarry_0339Inverse(b *testing.B) {
	var x e_nocarry_0339
	x.SetRandom()
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0339Butterfly(b *testing.B) {
	var x e_nocarry_0339
	x.SetRandom()
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0339)
	}
}

func BenchmarkE_nocarry_0339Exp(b *testing.B) {
	var x e_nocarry_0339
	x.SetRandom()
	benchRese_nocarry_0339.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0339Double(b *testing.B) {
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Double(&benchRese_nocarry_0339)
	}
}

func BenchmarkE_nocarry_0339Add(b *testing.B) {
	var x e_nocarry_0339
	x.SetRandom()
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Add(&x, &benchRese_nocarry_0339)
	}
}

func BenchmarkE_nocarry_0339Sub(b *testing.B) {
	var x e_nocarry_0339
	x.SetRandom()
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Sub(&x, &benchRese_nocarry_0339)
	}
}

func BenchmarkE_nocarry_0339Neg(b *testing.B) {
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Neg(&benchRese_nocarry_0339)
	}
}

func BenchmarkE_nocarry_0339Div(b *testing.B) {
	var x e_nocarry_0339
	x.SetRandom()
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Div(&x, &benchRese_nocarry_0339)
	}
}

func BenchmarkE_nocarry_0339FromMont(b *testing.B) {
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.FromMont()
	}
}

func BenchmarkE_nocarry_0339ToMont(b *testing.B) {
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.ToMont()
	}
}
func BenchmarkE_nocarry_0339Square(b *testing.B) {
	benchRese_nocarry_0339.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Square(&benchRese_nocarry_0339)
	}
}

func BenchmarkE_nocarry_0339Sqrt(b *testing.B) {
	var a e_nocarry_0339
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0339Mul(b *testing.B) {
	x := e_nocarry_0339{
		6982472963059300244,
	...
	benchRese_nocarry_0339.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Mul(&benchRese_nocarry_0339, &x)
	}
}

func BenchmarkE_nocarry_0339Cmp(b *testing.B) {
	x := e_nocarry_0339{
		6982472963059300244,
		13260638409542242934,
		17542086545241815451,
	...
	benchRese_nocarry_0339 = x
	benchRese_nocarry_0339[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0339.Cmp(&x)
	}
}

func TestE_nocarry_0339Cmp(t *testing.T) {
	var x, y e_nocarry_0339
...
func TestE_nocarry_0339IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0339
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0339

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0339{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0339
	one.SetOne()
	e.Sub(&qe_nocarry_0339, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0339{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0339{0, uint64(i)})
	}
...
func TestE_nocarry_0339NegZero(t *testing.T) {
	var a, b e_nocarry_0339
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0339Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0339, len(staticTestValues))
...
func TestE_nocarry_0339Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0339) bool {
			var b e_nocarry_0339
...
func TestE_nocarry_0339InverseExp(t *testing.T) {
...
func TestE_nocarry_0339MulByConstants(t *testing.T) {
...
func TestE_nocarry_0339Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0339) bool {
...
func TestE_nocarry_0339LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0339Halve(t *testing.T) {
...
func TestE_nocarry_0339FromMont(t *testing.T) {
...
type testPaire_nocarry_0339 struct {
	element e_nocarry_0339
	bigint  big.Int
}

func (z *e_nocarry_0339) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0339[5] {
		return true
	}
	if z[5] < qe_nocarry_0339[5] {
		return false
	...
	return z[0] >= qe_nocarry_0339[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0339

		g.element = e_nocarry_0339{
		...
		if qe_nocarry_0339[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0339[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0339 {
			var g e_nocarry_0339
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0339[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0339[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0339[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0339[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0339[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0339[5], carry)
...
func Benchmarke_nocarry_0339InverseNew(b *testing.B) {
	var x e_nocarry_0339
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0339
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0339
		var xInv e_nocarry_0339
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0339
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0339
...
func testLinearComb(t *testing.T, x *e_nocarry_0339, xC int64, y *e_nocarry_0339, yC int64) {
	...
	var z e_nocarry_0339
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0339, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0339
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0339, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0339
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0339, xHi uint64) {
	var res e_nocarry_0339
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0339) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0339) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0339, c int64, result *e_nocarry_0339, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0339) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0339) uint64 {
