...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x348af8088a37b2dd, R13
	ADDQ R13, AX
	MOVQ $0x1025f5dbeb9d9b55, R13
	ADCQ R13, DX
	MOVQ $0x55dd19b657bde0ad, R13
	ADCQ R13, CX
	MOVQ $0x39db75170b9129b7, R13
	ADCQ R13, BX
	MOVQ $0x9df4f4dd7ac3466a, R13
	ADCQ R13, SI
	MOVQ $0x11c94a0404073577, R13
	ADCQ R13, DI
	MOVQ $0x86ff44bf61e5acc1, R13
	ADCQ R13, R8
	MOVQ $0x4cd6f6880fe58ab7, R13
	ADCQ R13, R9
	MOVQ $0x35663c8a78556635, R13
	ADCQ R13, R10
	MOVQ $0x644ecd79e92e8145, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x348af8088a37b2dd, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x1025f5dbeb9d9b55, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x55dd19b657bde0ad, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x39db75170b9129b7, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x9df4f4dd7ac3466a, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x11c94a0404073577, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x86ff44bf61e5acc1, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x4cd6f6880fe58ab7, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x35663c8a78556635, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x644ecd79e92e8145, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x348af8088a37b2dd, AX
	ADDQ AX, DX
	MOVQ $0x1025f5dbeb9d9b55, AX
	ADCQ AX, CX
	MOVQ $0x55dd19b657bde0ad, AX
	ADCQ AX, BX
	MOVQ $0x39db75170b9129b7, AX
	ADCQ AX, SI
	MOVQ $0x9df4f4dd7ac3466a, AX
	ADCQ AX, DI
	MOVQ $0x11c94a0404073577, AX
	ADCQ AX, R8
	MOVQ $0x86ff44bf61e5acc1, AX
	ADCQ AX, R9
	MOVQ $0x4cd6f6880fe58ab7, AX
	ADCQ AX, R10
	MOVQ $0x35663c8a78556635, AX
	ADCQ AX, R11
	MOVQ $0x644ecd79e92e8145, AX
	ADCQ AX, R12
