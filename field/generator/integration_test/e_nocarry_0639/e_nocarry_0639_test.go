...
var benchRese_nocarry_0639 e_nocarry_0639

func BenchmarkE_nocarry_0639SetBytes(b *testing.B) {
	var x e_nocarry_0639
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0639MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0639.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0639)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0639)
		}
	})
}

func BenchmarkE_nocarry_0639Inverse(b *testing.B) {
	var x e_nocarry_0639
	x.SetRandom()
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0639Butterfly(b *testing.B) {
	var x e_nocarry_0639
	x.SetRandom()
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0639)
	}
}

func BenchmarkE_nocarry_0639Exp(b *testing.B) {
	var x e_nocarry_0639
	x.SetRandom()
	benchRese_nocarry_0639.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0639Double(b *testing.B) {
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Double(&benchRese_nocarry_0639)
	}
}

func BenchmarkE_nocarry_0639Add(b *testing.B) {
	var x e_nocarry_0639
	x.SetRandom()
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Add(&x, &benchRese_nocarry_0639)
	}
}

func BenchmarkE_nocarry_0639Sub(b *testing.B) {
	var x e_nocarry_0639
	x.SetRandom()
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Sub(&x, &benchRese_nocarry_0639)
	}
}

func BenchmarkE_nocarry_0639Neg(b *testing.B) {
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Neg(&benchRese_nocarry_0639)
	}
}

func BenchmarkE_nocarry_0639Div(b *testing.B) {
	var x e_nocarry_0639
	x.SetRandom()
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Div(&x, &benchRese_nocarry_0639)
	}
}

func BenchmarkE_nocarry_0639FromMont(b *testing.B) {
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.FromMont()
	}
}

func BenchmarkE_nocarry_0639ToMont(b *testing.B) {
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.ToMont()
	}
}
func BenchmarkE_nocarry_0639Square(b *testing.B) {
	benchRese_nocarry_0639.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Square(&benchRese_nocarry_0639)
	}
}

func BenchmarkE_nocarry_0639Sqrt(b *testing.B) {
	var a e_nocarry_0639
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0639Mul(b *testing.B) {
	x := e_nocarry_0639{
		3820186183452200111,
		6432387258839858829,
	...
	benchRese_nocarry_0639.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Mul(&benchRese_nocarry_0639, &x)
	}
}

func BenchmarkE_nocarry_0639Cmp(b *testing.B) {
	x := e_nocarry_0639{
		3820186183452200111,
		6432387258839858829,
		10230316486096555805,
	...
	benchRese_nocarry_0639 = x
	benchRese_nocarry_0639[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0639.Cmp(&x)
	}
}

func TestE_nocarry_0639Cmp(t *testing.T) {
	var x, y e_nocarry_0639
...
func TestE_nocarry_0639IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0639
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0639

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0639{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0639
	one.SetOne()
	e.Sub(&qe_nocarry_0639, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0639{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0639{0, uint64(i)})
	}
...
func TestE_nocarry_0639NegZero(t *testing.T) {
	var a, b e_nocarry_0639
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0639Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0639, len(staticTestValues))
...
func TestE_nocarry_0639Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0639) bool {
			var b e_nocarry_0639
...
func TestE_nocarry_0639InverseExp(t *testing.T) {
...
func TestE_nocarry_0639MulByConstants(t *testing.T) {
...
func TestE_nocarry_0639Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0639) bool {
...
func TestE_nocarry_0639LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0639Halve(t *testing.T) {
...
func TestE_nocarry_0639FromMont(t *testing.T) {
...
type testPaire_nocarry_0639 struct {
	element e_nocarry_0639
	bigint  big.Int
}

func (z *e_nocarry_0639) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0639[9] {
		return true
	}
	if z[9] < qe_nocarry_0639[9] {
		return false
	...
	return z[0] >= qe_nocarry_0639[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0639

		g.element = e_nocarry_0639{
		...
		if qe_nocarry_0639[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0639[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0639 {
			var g e_nocarry_0639
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0639[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0639[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0639[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0639[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0639[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0639[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0639[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0639[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0639[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0639[9], carry)
...
func Benchmarke_nocarry_0639InverseNew(b *testing.B) {
	var x e_nocarry_0639
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0639
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0639
		var xInv e_nocarry_0639
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0639
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0639
...
func testLinearComb(t *testing.T, x *e_nocarry_0639, xC int64, y *e_nocarry_0639, yC int64) {
	...
	var z e_nocarry_0639
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0639, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0639
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0639, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0639
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0639, xHi uint64) {
	var res e_nocarry_0639
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0639) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0639) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0639, c int64, result *e_nocarry_0639, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0639) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0639) uint64 {
