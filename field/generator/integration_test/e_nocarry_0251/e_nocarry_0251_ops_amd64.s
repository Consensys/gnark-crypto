...
// modulus q
DATA q<>+0(SB)/8, $0x2254883a4f914a2d
DATA q<>+8(SB)/8, $0xe6aa7ec8a0bcfb86
DATA q<>+16(SB)/8, $0x79485f323255e2aa
DATA q<>+24(SB)/8, $0x0618fa33158b0caa
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x4ba777ec63b46a5b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x2254883a4f914a2d, R8
	MOVQ    $0xe6aa7ec8a0bcfb86, R9
	MOVQ    $0x79485f323255e2aa, R10
	MOVQ    $0x0618fa33158b0caa, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xe6aa7ec8a0bcfb86, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x79485f323255e2aa, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0618fa33158b0caa, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x2254883a4f914a2d, R12
	MOVQ    $0xe6aa7ec8a0bcfb86, R13
	MOVQ    $0x79485f323255e2aa, R14
	MOVQ    $0x0618fa33158b0caa, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
