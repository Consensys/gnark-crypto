...
var benchRese_nocarry_0251 e_nocarry_0251

func BenchmarkE_nocarry_0251SetBytes(b *testing.B) {
	var x e_nocarry_0251
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0251MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0251.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0251)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0251)
		}
	})
}

func BenchmarkE_nocarry_0251Inverse(b *testing.B) {
	var x e_nocarry_0251
	x.SetRandom()
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0251Butterfly(b *testing.B) {
	var x e_nocarry_0251
	x.SetRandom()
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0251)
	}
}

func BenchmarkE_nocarry_0251Exp(b *testing.B) {
	var x e_nocarry_0251
	x.SetRandom()
	benchRese_nocarry_0251.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0251Double(b *testing.B) {
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Double(&benchRese_nocarry_0251)
	}
}

func BenchmarkE_nocarry_0251Add(b *testing.B) {
	var x e_nocarry_0251
	x.SetRandom()
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Add(&x, &benchRese_nocarry_0251)
	}
}

func BenchmarkE_nocarry_0251Sub(b *testing.B) {
	var x e_nocarry_0251
	x.SetRandom()
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Sub(&x, &benchRese_nocarry_0251)
	}
}

func BenchmarkE_nocarry_0251Neg(b *testing.B) {
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Neg(&benchRese_nocarry_0251)
	}
}

func BenchmarkE_nocarry_0251Div(b *testing.B) {
	var x e_nocarry_0251
	x.SetRandom()
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Div(&x, &benchRese_nocarry_0251)
	}
}

func BenchmarkE_nocarry_0251FromMont(b *testing.B) {
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.FromMont()
	}
}

func BenchmarkE_nocarry_0251ToMont(b *testing.B) {
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.ToMont()
	}
}
func BenchmarkE_nocarry_0251Square(b *testing.B) {
	benchRese_nocarry_0251.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Square(&benchRese_nocarry_0251)
	}
}

func BenchmarkE_nocarry_0251Sqrt(b *testing.B) {
	var a e_nocarry_0251
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0251Mul(b *testing.B) {
	x := e_nocarry_0251{
	...
	benchRese_nocarry_0251.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Mul(&benchRese_nocarry_0251, &x)
	}
}

func BenchmarkE_nocarry_0251Cmp(b *testing.B) {
	x := e_nocarry_0251{
		10604689120619226010,
		2053312010391273221,
		15039954880434668592,
	...
	benchRese_nocarry_0251 = x
	benchRese_nocarry_0251[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0251.Cmp(&x)
	}
}

func TestE_nocarry_0251Cmp(t *testing.T) {
	var x, y e_nocarry_0251
...
func TestE_nocarry_0251IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0251
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0251

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0251{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0251
	one.SetOne()
	e.Sub(&qe_nocarry_0251, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0251{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0251{0, uint64(i)})
	}
...
func TestE_nocarry_0251NegZero(t *testing.T) {
	var a, b e_nocarry_0251
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0251Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0251, len(staticTestValues))
...
func TestE_nocarry_0251Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0251) bool {
			var b e_nocarry_0251
...
func TestE_nocarry_0251InverseExp(t *testing.T) {
...
func TestE_nocarry_0251MulByConstants(t *testing.T) {
...
func TestE_nocarry_0251Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0251) bool {
...
func TestE_nocarry_0251LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0251Halve(t *testing.T) {
...
func TestE_nocarry_0251FromMont(t *testing.T) {
...
type testPaire_nocarry_0251 struct {
	element e_nocarry_0251
	bigint  big.Int
}

func (z *e_nocarry_0251) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0251[3] {
		return true
	}
	if z[3] < qe_nocarry_0251[3] {
		return false
	...
	return z[0] >= qe_nocarry_0251[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0251

		g.element = e_nocarry_0251{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0251[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0251[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0251 {
			var g e_nocarry_0251
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0251[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0251[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0251[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0251[3], carry)
...
func Benchmarke_nocarry_0251InverseNew(b *testing.B) {
	var x e_nocarry_0251
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0251
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0251
		var xInv e_nocarry_0251
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0251
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0251
...
func testLinearComb(t *testing.T, x *e_nocarry_0251, xC int64, y *e_nocarry_0251, yC int64) {
	...
	var z e_nocarry_0251
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0251, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0251
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0251, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0251
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0251, xHi uint64) {
	var res e_nocarry_0251
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0251) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0251) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0251, c int64, result *e_nocarry_0251, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0251) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0251) uint64 {
