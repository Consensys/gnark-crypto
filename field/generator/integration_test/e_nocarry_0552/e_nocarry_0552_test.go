...
var benchRese_nocarry_0552 e_nocarry_0552

func BenchmarkE_nocarry_0552SetBytes(b *testing.B) {
	var x e_nocarry_0552
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0552MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0552.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0552)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0552)
		}
	})
}

func BenchmarkE_nocarry_0552Inverse(b *testing.B) {
	var x e_nocarry_0552
	x.SetRandom()
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0552Butterfly(b *testing.B) {
	var x e_nocarry_0552
	x.SetRandom()
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0552)
	}
}

func BenchmarkE_nocarry_0552Exp(b *testing.B) {
	var x e_nocarry_0552
	x.SetRandom()
	benchRese_nocarry_0552.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0552Double(b *testing.B) {
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Double(&benchRese_nocarry_0552)
	}
}

func BenchmarkE_nocarry_0552Add(b *testing.B) {
	var x e_nocarry_0552
	x.SetRandom()
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Add(&x, &benchRese_nocarry_0552)
	}
}

func BenchmarkE_nocarry_0552Sub(b *testing.B) {
	var x e_nocarry_0552
	x.SetRandom()
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Sub(&x, &benchRese_nocarry_0552)
	}
}

func BenchmarkE_nocarry_0552Neg(b *testing.B) {
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Neg(&benchRese_nocarry_0552)
	}
}

func BenchmarkE_nocarry_0552Div(b *testing.B) {
	var x e_nocarry_0552
	x.SetRandom()
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Div(&x, &benchRese_nocarry_0552)
	}
}

func BenchmarkE_nocarry_0552FromMont(b *testing.B) {
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.FromMont()
	}
}

func BenchmarkE_nocarry_0552ToMont(b *testing.B) {
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.ToMont()
	}
}
func BenchmarkE_nocarry_0552Square(b *testing.B) {
	benchRese_nocarry_0552.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Square(&benchRese_nocarry_0552)
	}
}

func BenchmarkE_nocarry_0552Sqrt(b *testing.B) {
	var a e_nocarry_0552
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0552Mul(b *testing.B) {
	x := e_nocarry_0552{
	...
	benchRese_nocarry_0552.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Mul(&benchRese_nocarry_0552, &x)
	}
}

func BenchmarkE_nocarry_0552Cmp(b *testing.B) {
	x := e_nocarry_0552{
		15157904542487729449,
		16784463080758251027,
		11343773915212798277,
	...
	benchRese_nocarry_0552 = x
	benchRese_nocarry_0552[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0552.Cmp(&x)
	}
}

func TestE_nocarry_0552Cmp(t *testing.T) {
	var x, y e_nocarry_0552
...
func TestE_nocarry_0552IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0552
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0552

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0552{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0552
	one.SetOne()
	e.Sub(&qe_nocarry_0552, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0552{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0552{0, uint64(i)})
	}
...
func TestE_nocarry_0552NegZero(t *testing.T) {
	var a, b e_nocarry_0552
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0552Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0552, len(staticTestValues))
...
func TestE_nocarry_0552Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0552) bool {
			var b e_nocarry_0552
...
func TestE_nocarry_0552InverseExp(t *testing.T) {
...
func TestE_nocarry_0552MulByConstants(t *testing.T) {
...
func TestE_nocarry_0552Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0552) bool {
...
func TestE_nocarry_0552LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0552Halve(t *testing.T) {
...
func TestE_nocarry_0552FromMont(t *testing.T) {
...
type testPaire_nocarry_0552 struct {
	element e_nocarry_0552
	bigint  big.Int
}

func (z *e_nocarry_0552) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0552[8] {
		return true
	}
	if z[8] < qe_nocarry_0552[8] {
		return false
	...
	return z[0] >= qe_nocarry_0552[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0552

		g.element = e_nocarry_0552{
		...
		if qe_nocarry_0552[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0552[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0552 {
			var g e_nocarry_0552
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0552[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0552[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0552[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0552[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0552[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0552[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0552[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0552[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0552[8], carry)
...
func Benchmarke_nocarry_0552InverseNew(b *testing.B) {
	var x e_nocarry_0552
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0552
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0552
		var xInv e_nocarry_0552
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0552
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0552
...
func testLinearComb(t *testing.T, x *e_nocarry_0552, xC int64, y *e_nocarry_0552, yC int64) {
	...
	var z e_nocarry_0552
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0552, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0552
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0552, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0552
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0552, xHi uint64) {
	var res e_nocarry_0552
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0552) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0552) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0552, c int64, result *e_nocarry_0552, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0552) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0552) uint64 {
