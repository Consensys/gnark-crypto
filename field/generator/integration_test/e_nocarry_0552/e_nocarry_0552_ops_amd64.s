...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x566e1ff56208affb, R12
	ADDQ R12, AX
	MOVQ $0x903f6b125b70807d, R12
	ADCQ R12, DX
	MOVQ $0xf3ba7ce7c53ff737, R12
	ADCQ R12, CX
	MOVQ $0xbc507cd0f281385a, R12
	ADCQ R12, BX
	MOVQ $0x3603d1ff69a0093e, R12
	ADCQ R12, SI
	MOVQ $0x03c90fbf629eeab9, R12
	ADCQ R12, DI
	MOVQ $0xa483540a6748aa5e, R12
	ADCQ R12, R8
	MOVQ $0x17985649eb41c9d3, R12
	ADCQ R12, R9
	MOVQ $0x000000efab194a31, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x566e1ff56208affb, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x903f6b125b70807d, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xf3ba7ce7c53ff737, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xbc507cd0f281385a, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x3603d1ff69a0093e, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x03c90fbf629eeab9, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xa483540a6748aa5e, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x17985649eb41c9d3, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000efab194a31, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x566e1ff56208affb, AX
	ADDQ AX, DX
	MOVQ $0x903f6b125b70807d, AX
	ADCQ AX, CX
	MOVQ $0xf3ba7ce7c53ff737, AX
	ADCQ AX, BX
	MOVQ $0xbc507cd0f281385a, AX
	ADCQ AX, SI
	MOVQ $0x3603d1ff69a0093e, AX
	ADCQ AX, DI
	MOVQ $0x03c90fbf629eeab9, AX
	ADCQ AX, R8
	MOVQ $0xa483540a6748aa5e, AX
	ADCQ AX, R9
	MOVQ $0x17985649eb41c9d3, AX
	ADCQ AX, R10
	MOVQ $0x000000efab194a31, AX
	ADCQ AX, R11
