...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x2716c9908659687f, R14
	ADDQ R14, AX
	MOVQ $0x50e46630700f9fac, R14
	ADCQ R14, DX
	MOVQ $0x8625d9c02807eaf1, R14
	ADCQ R14, CX
	MOVQ $0xbe4579e8680d6a12, R14
	ADCQ R14, BX
	MOVQ $0x03a5936970e334e9, R14
	ADCQ R14, SI
	MOVQ $0x345a9805c842fe13, R14
	ADCQ R14, DI
	MOVQ $0xce483f313997bfb7, R14
	ADCQ R14, R8
	MOVQ $0xa98e4b0c45493219, R14
	ADCQ R14, R9
	MOVQ $0xa724db992dcb4a96, R14
	ADCQ R14, R10
	MOVQ $0x9b9f40197d349872, R14
	ADCQ R14, R11
	MOVQ $0x078c5f16943297fd, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x2716c9908659687f, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x50e46630700f9fac, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x8625d9c02807eaf1, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xbe4579e8680d6a12, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x03a5936970e334e9, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x345a9805c842fe13, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xce483f313997bfb7, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xa98e4b0c45493219, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xa724db992dcb4a96, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x9b9f40197d349872, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x078c5f16943297fd, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x2716c9908659687f, AX
	ADDQ AX, DX
	MOVQ $0x50e46630700f9fac, AX
	ADCQ AX, CX
	MOVQ $0x8625d9c02807eaf1, AX
	ADCQ AX, BX
	MOVQ $0xbe4579e8680d6a12, AX
	ADCQ AX, SI
	MOVQ $0x03a5936970e334e9, AX
	ADCQ AX, DI
	MOVQ $0x345a9805c842fe13, AX
	ADCQ AX, R8
	MOVQ $0xce483f313997bfb7, AX
	ADCQ AX, R9
	MOVQ $0xa98e4b0c45493219, AX
	ADCQ AX, R10
	MOVQ $0xa724db992dcb4a96, AX
	ADCQ AX, R11
	MOVQ $0x9b9f40197d349872, AX
	ADCQ AX, R12
	MOVQ $0x078c5f16943297fd, AX
	ADCQ AX, R13
