...
// modulus q
DATA q<>+0(SB)/8, $0x2716c9908659687f
DATA q<>+8(SB)/8, $0x50e46630700f9fac
DATA q<>+16(SB)/8, $0x8625d9c02807eaf1
DATA q<>+24(SB)/8, $0xbe4579e8680d6a12
DATA q<>+32(SB)/8, $0x03a5936970e334e9
DATA q<>+40(SB)/8, $0x345a9805c842fe13
DATA q<>+48(SB)/8, $0xce483f313997bfb7
DATA q<>+56(SB)/8, $0xa98e4b0c45493219
DATA q<>+64(SB)/8, $0xa724db992dcb4a96
DATA q<>+72(SB)/8, $0x9b9f40197d349872
DATA q<>+80(SB)/8, $0x078c5f16943297fd
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x09b083b0d821a881
