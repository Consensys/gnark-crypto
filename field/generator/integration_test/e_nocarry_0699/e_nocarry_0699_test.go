...
var benchRese_nocarry_0699 e_nocarry_0699

func BenchmarkE_nocarry_0699SetBytes(b *testing.B) {
	var x e_nocarry_0699
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0699MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0699.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0699)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0699)
		}
	})
}

func BenchmarkE_nocarry_0699Inverse(b *testing.B) {
	var x e_nocarry_0699
	x.SetRandom()
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0699Butterfly(b *testing.B) {
	var x e_nocarry_0699
	x.SetRandom()
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0699)
	}
}

func BenchmarkE_nocarry_0699Exp(b *testing.B) {
	var x e_nocarry_0699
	x.SetRandom()
	benchRese_nocarry_0699.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0699Double(b *testing.B) {
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Double(&benchRese_nocarry_0699)
	}
}

func BenchmarkE_nocarry_0699Add(b *testing.B) {
	var x e_nocarry_0699
	x.SetRandom()
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Add(&x, &benchRese_nocarry_0699)
	}
}

func BenchmarkE_nocarry_0699Sub(b *testing.B) {
	var x e_nocarry_0699
	x.SetRandom()
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Sub(&x, &benchRese_nocarry_0699)
	}
}

func BenchmarkE_nocarry_0699Neg(b *testing.B) {
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Neg(&benchRese_nocarry_0699)
	}
}

func BenchmarkE_nocarry_0699Div(b *testing.B) {
	var x e_nocarry_0699
	x.SetRandom()
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Div(&x, &benchRese_nocarry_0699)
	}
}

func BenchmarkE_nocarry_0699FromMont(b *testing.B) {
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.FromMont()
	}
}

func BenchmarkE_nocarry_0699ToMont(b *testing.B) {
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.ToMont()
	}
}
func BenchmarkE_nocarry_0699Square(b *testing.B) {
	benchRese_nocarry_0699.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Square(&benchRese_nocarry_0699)
	}
}

func BenchmarkE_nocarry_0699Sqrt(b *testing.B) {
	var a e_nocarry_0699
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0699Mul(b *testing.B) {
	x := e_nocarry_0699{
	...
	benchRese_nocarry_0699.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Mul(&benchRese_nocarry_0699, &x)
	}
}

func BenchmarkE_nocarry_0699Cmp(b *testing.B) {
	x := e_nocarry_0699{
		16357811417392285874,
		18301360801806302261,
		1894351099895423600,
	...
	benchRese_nocarry_0699 = x
	benchRese_nocarry_0699[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0699.Cmp(&x)
	}
}

func TestE_nocarry_0699Cmp(t *testing.T) {
	var x, y e_nocarry_0699
...
func TestE_nocarry_0699IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0699
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0699

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0699{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0699
	one.SetOne()
	e.Sub(&qe_nocarry_0699, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0699{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0699{0, uint64(i)})
	}
...
func TestE_nocarry_0699NegZero(t *testing.T) {
	var a, b e_nocarry_0699
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0699Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0699, len(staticTestValues))
...
func TestE_nocarry_0699Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0699) bool {
			var b e_nocarry_0699
...
func TestE_nocarry_0699InverseExp(t *testing.T) {
...
func TestE_nocarry_0699MulByConstants(t *testing.T) {
...
func TestE_nocarry_0699Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0699) bool {
...
func TestE_nocarry_0699LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0699Halve(t *testing.T) {
...
func TestE_nocarry_0699FromMont(t *testing.T) {
...
type testPaire_nocarry_0699 struct {
	element e_nocarry_0699
	bigint  big.Int
}

func (z *e_nocarry_0699) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0699[10] {
		return true
	}
	if z[10] < qe_nocarry_0699[10] {
		return false
	...
	return z[0] >= qe_nocarry_0699[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0699

		g.element = e_nocarry_0699{
		...
		if qe_nocarry_0699[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0699[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0699 {
			var g e_nocarry_0699
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0699[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0699[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0699[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0699[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0699[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0699[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0699[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0699[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0699[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0699[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0699[10], carry)
...
func Benchmarke_nocarry_0699InverseNew(b *testing.B) {
	var x e_nocarry_0699
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0699
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0699
		var xInv e_nocarry_0699
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0699
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0699
...
func testLinearComb(t *testing.T, x *e_nocarry_0699, xC int64, y *e_nocarry_0699, yC int64) {
	...
	var z e_nocarry_0699
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0699, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0699
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0699, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0699
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0699, xHi uint64) {
	var res e_nocarry_0699
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0699) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0699) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0699, c int64, result *e_nocarry_0699, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0699) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0699) uint64 {
