...
var benchRese_nocarry_0544 e_nocarry_0544

func BenchmarkE_nocarry_0544SetBytes(b *testing.B) {
	var x e_nocarry_0544
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0544MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0544.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0544)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0544)
		}
	})
}

func BenchmarkE_nocarry_0544Inverse(b *testing.B) {
	var x e_nocarry_0544
	x.SetRandom()
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0544Butterfly(b *testing.B) {
	var x e_nocarry_0544
	x.SetRandom()
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0544)
	}
}

func BenchmarkE_nocarry_0544Exp(b *testing.B) {
	var x e_nocarry_0544
	x.SetRandom()
	benchRese_nocarry_0544.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0544Double(b *testing.B) {
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Double(&benchRese_nocarry_0544)
	}
}

func BenchmarkE_nocarry_0544Add(b *testing.B) {
	var x e_nocarry_0544
	x.SetRandom()
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Add(&x, &benchRese_nocarry_0544)
	}
}

func BenchmarkE_nocarry_0544Sub(b *testing.B) {
	var x e_nocarry_0544
	x.SetRandom()
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Sub(&x, &benchRese_nocarry_0544)
	}
}

func BenchmarkE_nocarry_0544Neg(b *testing.B) {
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Neg(&benchRese_nocarry_0544)
	}
}

func BenchmarkE_nocarry_0544Div(b *testing.B) {
	var x e_nocarry_0544
	x.SetRandom()
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Div(&x, &benchRese_nocarry_0544)
	}
}

func BenchmarkE_nocarry_0544FromMont(b *testing.B) {
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.FromMont()
	}
}

func BenchmarkE_nocarry_0544ToMont(b *testing.B) {
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.ToMont()
	}
}
func BenchmarkE_nocarry_0544Square(b *testing.B) {
	benchRese_nocarry_0544.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Square(&benchRese_nocarry_0544)
	}
}

func BenchmarkE_nocarry_0544Sqrt(b *testing.B) {
	var a e_nocarry_0544
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0544Mul(b *testing.B) {
	x := e_nocarry_0544{
	...
	benchRese_nocarry_0544.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Mul(&benchRese_nocarry_0544, &x)
	}
}

func BenchmarkE_nocarry_0544Cmp(b *testing.B) {
	x := e_nocarry_0544{
		11535903033382327875,
		579399279355034380,
		8639202919529317180,
	...
	benchRese_nocarry_0544 = x
	benchRese_nocarry_0544[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0544.Cmp(&x)
	}
}

func TestE_nocarry_0544Cmp(t *testing.T) {
	var x, y e_nocarry_0544
...
func TestE_nocarry_0544IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0544
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0544

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0544{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0544
	one.SetOne()
	e.Sub(&qe_nocarry_0544, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0544{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0544{0, uint64(i)})
	}
...
func TestE_nocarry_0544NegZero(t *testing.T) {
	var a, b e_nocarry_0544
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0544Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0544, len(staticTestValues))
...
func TestE_nocarry_0544Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0544) bool {
			var b e_nocarry_0544
...
func TestE_nocarry_0544InverseExp(t *testing.T) {
...
func TestE_nocarry_0544MulByConstants(t *testing.T) {
...
func TestE_nocarry_0544Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0544) bool {
...
func TestE_nocarry_0544LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0544Halve(t *testing.T) {
...
func TestE_nocarry_0544FromMont(t *testing.T) {
...
type testPaire_nocarry_0544 struct {
	element e_nocarry_0544
	bigint  big.Int
}

func (z *e_nocarry_0544) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0544[8] {
		return true
	}
	if z[8] < qe_nocarry_0544[8] {
		return false
	...
	return z[0] >= qe_nocarry_0544[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0544

		g.element = e_nocarry_0544{
		...
		if qe_nocarry_0544[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0544[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0544 {
			var g e_nocarry_0544
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0544[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0544[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0544[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0544[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0544[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0544[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0544[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0544[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0544[8], carry)
...
func Benchmarke_nocarry_0544InverseNew(b *testing.B) {
	var x e_nocarry_0544
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0544
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0544
		var xInv e_nocarry_0544
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0544
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0544
...
func testLinearComb(t *testing.T, x *e_nocarry_0544, xC int64, y *e_nocarry_0544, yC int64) {
	...
	var z e_nocarry_0544
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0544, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0544
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0544, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0544
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0544, xHi uint64) {
	var res e_nocarry_0544
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0544) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0544) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0544, c int64, result *e_nocarry_0544, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0544) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0544) uint64 {
