...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x8ebb413e86e953a3, R12
	ADDQ R12, AX
	MOVQ $0x87b39c357038556d, R12
	ADCQ R12, DX
	MOVQ $0xa7a70438e682321d, R12
	ADCQ R12, CX
	MOVQ $0x5e0a3baf4da47b9e, R12
	ADCQ R12, BX
	MOVQ $0x1b3de8da8dd6b770, R12
	ADCQ R12, SI
	MOVQ $0xb610c30676f4f824, R12
	ADCQ R12, DI
	MOVQ $0xc9450a29b9fa9c8a, R12
	ADCQ R12, R8
	MOVQ $0x6a33c4b6e9f0a883, R12
	ADCQ R12, R9
	MOVQ $0x00000000ec919abf, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x8ebb413e86e953a3, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x87b39c357038556d, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xa7a70438e682321d, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x5e0a3baf4da47b9e, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x1b3de8da8dd6b770, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xb610c30676f4f824, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xc9450a29b9fa9c8a, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x6a33c4b6e9f0a883, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000000ec919abf, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x8ebb413e86e953a3, AX
	ADDQ AX, DX
	MOVQ $0x87b39c357038556d, AX
	ADCQ AX, CX
	MOVQ $0xa7a70438e682321d, AX
	ADCQ AX, BX
	MOVQ $0x5e0a3baf4da47b9e, AX
	ADCQ AX, SI
	MOVQ $0x1b3de8da8dd6b770, AX
	ADCQ AX, DI
	MOVQ $0xb610c30676f4f824, AX
	ADCQ AX, R8
	MOVQ $0xc9450a29b9fa9c8a, AX
	ADCQ AX, R9
	MOVQ $0x6a33c4b6e9f0a883, AX
	ADCQ AX, R10
	MOVQ $0x00000000ec919abf, AX
	ADCQ AX, R11
