...
var benchRese_nocarry_0483 e_nocarry_0483

func BenchmarkE_nocarry_0483SetBytes(b *testing.B) {
	var x e_nocarry_0483
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0483MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0483.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0483)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0483)
		}
	})
}

func BenchmarkE_nocarry_0483Inverse(b *testing.B) {
	var x e_nocarry_0483
	x.SetRandom()
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0483Butterfly(b *testing.B) {
	var x e_nocarry_0483
	x.SetRandom()
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0483)
	}
}

func BenchmarkE_nocarry_0483Exp(b *testing.B) {
	var x e_nocarry_0483
	x.SetRandom()
	benchRese_nocarry_0483.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0483Double(b *testing.B) {
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Double(&benchRese_nocarry_0483)
	}
}

func BenchmarkE_nocarry_0483Add(b *testing.B) {
	var x e_nocarry_0483
	x.SetRandom()
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Add(&x, &benchRese_nocarry_0483)
	}
}

func BenchmarkE_nocarry_0483Sub(b *testing.B) {
	var x e_nocarry_0483
	x.SetRandom()
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Sub(&x, &benchRese_nocarry_0483)
	}
}

func BenchmarkE_nocarry_0483Neg(b *testing.B) {
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Neg(&benchRese_nocarry_0483)
	}
}

func BenchmarkE_nocarry_0483Div(b *testing.B) {
	var x e_nocarry_0483
	x.SetRandom()
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Div(&x, &benchRese_nocarry_0483)
	}
}

func BenchmarkE_nocarry_0483FromMont(b *testing.B) {
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.FromMont()
	}
}

func BenchmarkE_nocarry_0483ToMont(b *testing.B) {
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.ToMont()
	}
}
func BenchmarkE_nocarry_0483Square(b *testing.B) {
	benchRese_nocarry_0483.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Square(&benchRese_nocarry_0483)
	}
}

func BenchmarkE_nocarry_0483Sqrt(b *testing.B) {
	var a e_nocarry_0483
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0483Mul(b *testing.B) {
	x := e_nocarry_0483{
	...
	benchRese_nocarry_0483.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Mul(&benchRese_nocarry_0483, &x)
	}
}

func BenchmarkE_nocarry_0483Cmp(b *testing.B) {
	x := e_nocarry_0483{
		10459667438605479728,
		13019291007849096543,
		512089492523438804,
	...
	benchRese_nocarry_0483 = x
	benchRese_nocarry_0483[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0483.Cmp(&x)
	}
}

func TestE_nocarry_0483Cmp(t *testing.T) {
	var x, y e_nocarry_0483
...
func TestE_nocarry_0483IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0483
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0483

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0483{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0483
	one.SetOne()
	e.Sub(&qe_nocarry_0483, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0483{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0483{0, uint64(i)})
	}
...
func TestE_nocarry_0483NegZero(t *testing.T) {
	var a, b e_nocarry_0483
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0483Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0483, len(staticTestValues))
...
func TestE_nocarry_0483Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0483) bool {
			var b e_nocarry_0483
...
func TestE_nocarry_0483InverseExp(t *testing.T) {
...
func TestE_nocarry_0483MulByConstants(t *testing.T) {
...
func TestE_nocarry_0483Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0483) bool {
...
func TestE_nocarry_0483LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0483Halve(t *testing.T) {
...
func TestE_nocarry_0483FromMont(t *testing.T) {
...
type testPaire_nocarry_0483 struct {
	element e_nocarry_0483
	bigint  big.Int
}

func (z *e_nocarry_0483) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0483[7] {
		return true
	}
	if z[7] < qe_nocarry_0483[7] {
		return false
	...
	return z[0] >= qe_nocarry_0483[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0483

		g.element = e_nocarry_0483{
		...
		if qe_nocarry_0483[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0483[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0483 {
			var g e_nocarry_0483
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0483[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0483[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0483[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0483[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0483[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0483[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0483[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0483[7], carry)
...
func Benchmarke_nocarry_0483InverseNew(b *testing.B) {
	var x e_nocarry_0483
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0483
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0483
		var xInv e_nocarry_0483
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0483
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0483
...
func testLinearComb(t *testing.T, x *e_nocarry_0483, xC int64, y *e_nocarry_0483, yC int64) {
	...
	var z e_nocarry_0483
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0483, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0483
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0483, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0483
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0483, xHi uint64) {
	var res e_nocarry_0483
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0483) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0483) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0483, c int64, result *e_nocarry_0483, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0483) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0483) uint64 {
