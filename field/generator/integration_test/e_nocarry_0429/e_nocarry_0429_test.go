...
var benchRese_nocarry_0429 e_nocarry_0429

func BenchmarkE_nocarry_0429SetBytes(b *testing.B) {
	var x e_nocarry_0429
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0429MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0429.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0429)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0429)
		}
	})
}

func BenchmarkE_nocarry_0429Inverse(b *testing.B) {
	var x e_nocarry_0429
	x.SetRandom()
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0429Butterfly(b *testing.B) {
	var x e_nocarry_0429
	x.SetRandom()
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0429)
	}
}

func BenchmarkE_nocarry_0429Exp(b *testing.B) {
	var x e_nocarry_0429
	x.SetRandom()
	benchRese_nocarry_0429.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0429Double(b *testing.B) {
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Double(&benchRese_nocarry_0429)
	}
}

func BenchmarkE_nocarry_0429Add(b *testing.B) {
	var x e_nocarry_0429
	x.SetRandom()
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Add(&x, &benchRese_nocarry_0429)
	}
}

func BenchmarkE_nocarry_0429Sub(b *testing.B) {
	var x e_nocarry_0429
	x.SetRandom()
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Sub(&x, &benchRese_nocarry_0429)
	}
}

func BenchmarkE_nocarry_0429Neg(b *testing.B) {
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Neg(&benchRese_nocarry_0429)
	}
}

func BenchmarkE_nocarry_0429Div(b *testing.B) {
	var x e_nocarry_0429
	x.SetRandom()
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Div(&x, &benchRese_nocarry_0429)
	}
}

func BenchmarkE_nocarry_0429FromMont(b *testing.B) {
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.FromMont()
	}
}

func BenchmarkE_nocarry_0429ToMont(b *testing.B) {
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.ToMont()
	}
}
func BenchmarkE_nocarry_0429Square(b *testing.B) {
	benchRese_nocarry_0429.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Square(&benchRese_nocarry_0429)
	}
}

func BenchmarkE_nocarry_0429Sqrt(b *testing.B) {
	var a e_nocarry_0429
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0429Mul(b *testing.B) {
	x := e_nocarry_0429{
		4837275764502023748,
		2468551621963602844,
	...
	benchRese_nocarry_0429.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Mul(&benchRese_nocarry_0429, &x)
	}
}

func BenchmarkE_nocarry_0429Cmp(b *testing.B) {
	x := e_nocarry_0429{
		4837275764502023748,
		2468551621963602844,
		15340821934425351221,
	...
	benchRese_nocarry_0429 = x
	benchRese_nocarry_0429[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0429.Cmp(&x)
	}
}

func TestE_nocarry_0429Cmp(t *testing.T) {
	var x, y e_nocarry_0429
...
func TestE_nocarry_0429IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0429
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0429

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0429{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0429
	one.SetOne()
	e.Sub(&qe_nocarry_0429, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0429{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0429{0, uint64(i)})
	}
...
func TestE_nocarry_0429NegZero(t *testing.T) {
	var a, b e_nocarry_0429
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0429Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0429, len(staticTestValues))
...
func TestE_nocarry_0429Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0429) bool {
			var b e_nocarry_0429
...
func TestE_nocarry_0429InverseExp(t *testing.T) {
...
func TestE_nocarry_0429MulByConstants(t *testing.T) {
...
func TestE_nocarry_0429Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0429) bool {
...
func TestE_nocarry_0429LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0429Halve(t *testing.T) {
...
func TestE_nocarry_0429FromMont(t *testing.T) {
...
type testPaire_nocarry_0429 struct {
	element e_nocarry_0429
	bigint  big.Int
}

func (z *e_nocarry_0429) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0429[6] {
		return true
	}
	if z[6] < qe_nocarry_0429[6] {
		return false
	...
	return z[0] >= qe_nocarry_0429[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0429

		g.element = e_nocarry_0429{
		...
		if qe_nocarry_0429[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0429[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0429 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0429[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0429[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0429[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0429[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0429[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0429[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0429[6], carry)
...
func Benchmarke_nocarry_0429InverseNew(b *testing.B) {
	var x e_nocarry_0429
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0429
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0429
		var xInv e_nocarry_0429
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0429
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0429
...
func testLinearComb(t *testing.T, x *e_nocarry_0429, xC int64, y *e_nocarry_0429, yC int64) {
	...
	var z e_nocarry_0429
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0429, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0429
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0429, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0429
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0429, xHi uint64) {
	var res e_nocarry_0429
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0429) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0429) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0429, c int64, result *e_nocarry_0429, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0429) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0429) uint64 {
