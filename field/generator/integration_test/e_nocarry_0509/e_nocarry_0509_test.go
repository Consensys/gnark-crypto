...
var benchRese_nocarry_0509 e_nocarry_0509

func BenchmarkE_nocarry_0509SetBytes(b *testing.B) {
	var x e_nocarry_0509
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0509MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0509.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0509)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0509)
		}
	})
}

func BenchmarkE_nocarry_0509Inverse(b *testing.B) {
	var x e_nocarry_0509
	x.SetRandom()
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0509Butterfly(b *testing.B) {
	var x e_nocarry_0509
	x.SetRandom()
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0509)
	}
}

func BenchmarkE_nocarry_0509Exp(b *testing.B) {
	var x e_nocarry_0509
	x.SetRandom()
	benchRese_nocarry_0509.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0509Double(b *testing.B) {
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Double(&benchRese_nocarry_0509)
	}
}

func BenchmarkE_nocarry_0509Add(b *testing.B) {
	var x e_nocarry_0509
	x.SetRandom()
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Add(&x, &benchRese_nocarry_0509)
	}
}

func BenchmarkE_nocarry_0509Sub(b *testing.B) {
	var x e_nocarry_0509
	x.SetRandom()
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Sub(&x, &benchRese_nocarry_0509)
	}
}

func BenchmarkE_nocarry_0509Neg(b *testing.B) {
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Neg(&benchRese_nocarry_0509)
	}
}

func BenchmarkE_nocarry_0509Div(b *testing.B) {
	var x e_nocarry_0509
	x.SetRandom()
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Div(&x, &benchRese_nocarry_0509)
	}
}

func BenchmarkE_nocarry_0509FromMont(b *testing.B) {
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.FromMont()
	}
}

func BenchmarkE_nocarry_0509ToMont(b *testing.B) {
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.ToMont()
	}
}
func BenchmarkE_nocarry_0509Square(b *testing.B) {
	benchRese_nocarry_0509.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Square(&benchRese_nocarry_0509)
	}
}

func BenchmarkE_nocarry_0509Sqrt(b *testing.B) {
	var a e_nocarry_0509
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0509Mul(b *testing.B) {
	x := e_nocarry_0509{
	...
	benchRese_nocarry_0509.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Mul(&benchRese_nocarry_0509, &x)
	}
}

func BenchmarkE_nocarry_0509Cmp(b *testing.B) {
	x := e_nocarry_0509{
		12349174378180334184,
		6035175392649975673,
		8683654588215383558,
	...
	benchRese_nocarry_0509 = x
	benchRese_nocarry_0509[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0509.Cmp(&x)
	}
}

func TestE_nocarry_0509Cmp(t *testing.T) {
	var x, y e_nocarry_0509
...
func TestE_nocarry_0509IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0509
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0509

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0509{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0509
	one.SetOne()
	e.Sub(&qe_nocarry_0509, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0509{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0509{0, uint64(i)})
	}
...
func TestE_nocarry_0509NegZero(t *testing.T) {
	var a, b e_nocarry_0509
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0509Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0509, len(staticTestValues))
...
func TestE_nocarry_0509Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0509) bool {
			var b e_nocarry_0509
...
func TestE_nocarry_0509InverseExp(t *testing.T) {
...
func TestE_nocarry_0509MulByConstants(t *testing.T) {
...
func TestE_nocarry_0509Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0509) bool {
...
func TestE_nocarry_0509LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0509Halve(t *testing.T) {
...
func TestE_nocarry_0509FromMont(t *testing.T) {
...
type testPaire_nocarry_0509 struct {
	element e_nocarry_0509
	bigint  big.Int
}

func (z *e_nocarry_0509) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0509[7] {
		return true
	}
	if z[7] < qe_nocarry_0509[7] {
		return false
	...
	return z[0] >= qe_nocarry_0509[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0509

		g.element = e_nocarry_0509{
		...
		if qe_nocarry_0509[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0509[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0509 {
			var g e_nocarry_0509
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0509[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0509[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0509[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0509[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0509[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0509[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0509[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0509[7], carry)
...
func Benchmarke_nocarry_0509InverseNew(b *testing.B) {
	var x e_nocarry_0509
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0509
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0509
		var xInv e_nocarry_0509
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0509
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0509
...
func testLinearComb(t *testing.T, x *e_nocarry_0509, xC int64, y *e_nocarry_0509, yC int64) {
	...
	var z e_nocarry_0509
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0509, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0509
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0509, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0509
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0509, xHi uint64) {
	var res e_nocarry_0509
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0509) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0509) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0509, c int64, result *e_nocarry_0509, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0509) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0509) uint64 {
