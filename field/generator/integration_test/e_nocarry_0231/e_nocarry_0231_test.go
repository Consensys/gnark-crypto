...
var benchRese_nocarry_0231 e_nocarry_0231

func BenchmarkE_nocarry_0231SetBytes(b *testing.B) {
	var x e_nocarry_0231
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0231MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0231.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0231)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0231)
		}
	})
}

func BenchmarkE_nocarry_0231Inverse(b *testing.B) {
	var x e_nocarry_0231
	x.SetRandom()
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0231Butterfly(b *testing.B) {
	var x e_nocarry_0231
	x.SetRandom()
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0231)
	}
}

func BenchmarkE_nocarry_0231Exp(b *testing.B) {
	var x e_nocarry_0231
	x.SetRandom()
	benchRese_nocarry_0231.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0231Double(b *testing.B) {
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Double(&benchRese_nocarry_0231)
	}
}

func BenchmarkE_nocarry_0231Add(b *testing.B) {
	var x e_nocarry_0231
	x.SetRandom()
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Add(&x, &benchRese_nocarry_0231)
	}
}

func BenchmarkE_nocarry_0231Sub(b *testing.B) {
	var x e_nocarry_0231
	x.SetRandom()
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Sub(&x, &benchRese_nocarry_0231)
	}
}

func BenchmarkE_nocarry_0231Neg(b *testing.B) {
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Neg(&benchRese_nocarry_0231)
	}
}

func BenchmarkE_nocarry_0231Div(b *testing.B) {
	var x e_nocarry_0231
	x.SetRandom()
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Div(&x, &benchRese_nocarry_0231)
	}
}

func BenchmarkE_nocarry_0231FromMont(b *testing.B) {
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.FromMont()
	}
}

func BenchmarkE_nocarry_0231ToMont(b *testing.B) {
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.ToMont()
	}
}
func BenchmarkE_nocarry_0231Square(b *testing.B) {
	benchRese_nocarry_0231.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Square(&benchRese_nocarry_0231)
	}
}

func BenchmarkE_nocarry_0231Sqrt(b *testing.B) {
	var a e_nocarry_0231
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0231Mul(b *testing.B) {
	x := e_nocarry_0231{
		6188720959108545208,
	...
	benchRese_nocarry_0231.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Mul(&benchRese_nocarry_0231, &x)
	}
}

func BenchmarkE_nocarry_0231Cmp(b *testing.B) {
	x := e_nocarry_0231{
		6188720959108545208,
		18057206320662311164,
		18154425228593573443,
	...
	benchRese_nocarry_0231 = x
	benchRese_nocarry_0231[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0231.Cmp(&x)
	}
}

func TestE_nocarry_0231Cmp(t *testing.T) {
	var x, y e_nocarry_0231
...
func TestE_nocarry_0231IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0231
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0231

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0231{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0231
	one.SetOne()
	e.Sub(&qe_nocarry_0231, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0231{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0231{0, uint64(i)})
	}
...
func TestE_nocarry_0231NegZero(t *testing.T) {
	var a, b e_nocarry_0231
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0231Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0231, len(staticTestValues))
...
func TestE_nocarry_0231Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0231) bool {
			var b e_nocarry_0231
...
func TestE_nocarry_0231InverseExp(t *testing.T) {
...
func TestE_nocarry_0231MulByConstants(t *testing.T) {
...
func TestE_nocarry_0231Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0231) bool {
...
func TestE_nocarry_0231LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0231Halve(t *testing.T) {
...
func TestE_nocarry_0231FromMont(t *testing.T) {
...
type testPaire_nocarry_0231 struct {
	element e_nocarry_0231
	bigint  big.Int
}

func (z *e_nocarry_0231) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0231[3] {
		return true
	}
	if z[3] < qe_nocarry_0231[3] {
		return false
	...
	return z[0] >= qe_nocarry_0231[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0231

		g.element = e_nocarry_0231{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0231[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0231[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0231 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0231[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0231[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0231[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0231[3], carry)
...
func Benchmarke_nocarry_0231InverseNew(b *testing.B) {
	var x e_nocarry_0231
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0231
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0231
		var xInv e_nocarry_0231
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0231
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0231
...
func testLinearComb(t *testing.T, x *e_nocarry_0231, xC int64, y *e_nocarry_0231, yC int64) {
	...
	var z e_nocarry_0231
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0231, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0231
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0231, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0231
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0231, xHi uint64) {
	var res e_nocarry_0231
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0231) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0231) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0231, c int64, result *e_nocarry_0231, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0231) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0231) uint64 {
