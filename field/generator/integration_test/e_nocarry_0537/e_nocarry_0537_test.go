...
var benchRese_nocarry_0537 e_nocarry_0537

func BenchmarkE_nocarry_0537SetBytes(b *testing.B) {
	var x e_nocarry_0537
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0537MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0537.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0537)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0537)
		}
	})
}

func BenchmarkE_nocarry_0537Inverse(b *testing.B) {
	var x e_nocarry_0537
	x.SetRandom()
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0537Butterfly(b *testing.B) {
	var x e_nocarry_0537
	x.SetRandom()
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0537)
	}
}

func BenchmarkE_nocarry_0537Exp(b *testing.B) {
	var x e_nocarry_0537
	x.SetRandom()
	benchRese_nocarry_0537.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0537Double(b *testing.B) {
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Double(&benchRese_nocarry_0537)
	}
}

func BenchmarkE_nocarry_0537Add(b *testing.B) {
	var x e_nocarry_0537
	x.SetRandom()
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Add(&x, &benchRese_nocarry_0537)
	}
}

func BenchmarkE_nocarry_0537Sub(b *testing.B) {
	var x e_nocarry_0537
	x.SetRandom()
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Sub(&x, &benchRese_nocarry_0537)
	}
}

func BenchmarkE_nocarry_0537Neg(b *testing.B) {
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Neg(&benchRese_nocarry_0537)
	}
}

func BenchmarkE_nocarry_0537Div(b *testing.B) {
	var x e_nocarry_0537
	x.SetRandom()
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Div(&x, &benchRese_nocarry_0537)
	}
}

func BenchmarkE_nocarry_0537FromMont(b *testing.B) {
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.FromMont()
	}
}

func BenchmarkE_nocarry_0537ToMont(b *testing.B) {
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.ToMont()
	}
}
func BenchmarkE_nocarry_0537Square(b *testing.B) {
	benchRese_nocarry_0537.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Square(&benchRese_nocarry_0537)
	}
}

func BenchmarkE_nocarry_0537Sqrt(b *testing.B) {
	var a e_nocarry_0537
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0537Mul(b *testing.B) {
	x := e_nocarry_0537{
		4114782578408944438,
	...
	benchRese_nocarry_0537.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Mul(&benchRese_nocarry_0537, &x)
	}
}

func BenchmarkE_nocarry_0537Cmp(b *testing.B) {
	x := e_nocarry_0537{
		4114782578408944438,
		10164428579997264010,
		269185410529836439,
	...
	benchRese_nocarry_0537 = x
	benchRese_nocarry_0537[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0537.Cmp(&x)
	}
}

func TestE_nocarry_0537Cmp(t *testing.T) {
	var x, y e_nocarry_0537
...
func TestE_nocarry_0537IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0537
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0537

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0537{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0537
	one.SetOne()
	e.Sub(&qe_nocarry_0537, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0537{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0537{0, uint64(i)})
	}
...
func TestE_nocarry_0537NegZero(t *testing.T) {
	var a, b e_nocarry_0537
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0537Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0537, len(staticTestValues))
...
func TestE_nocarry_0537Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0537) bool {
			var b e_nocarry_0537
...
func TestE_nocarry_0537InverseExp(t *testing.T) {
...
func TestE_nocarry_0537MulByConstants(t *testing.T) {
...
func TestE_nocarry_0537Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0537) bool {
...
func TestE_nocarry_0537LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0537Halve(t *testing.T) {
...
func TestE_nocarry_0537FromMont(t *testing.T) {
...
type testPaire_nocarry_0537 struct {
	element e_nocarry_0537
	bigint  big.Int
}

func (z *e_nocarry_0537) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0537[8] {
		return true
	}
	if z[8] < qe_nocarry_0537[8] {
		return false
	...
	return z[0] >= qe_nocarry_0537[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0537

		g.element = e_nocarry_0537{
		...
		if qe_nocarry_0537[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0537[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0537 {
			var g e_nocarry_0537
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0537[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0537[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0537[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0537[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0537[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0537[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0537[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0537[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0537[8], carry)
...
func Benchmarke_nocarry_0537InverseNew(b *testing.B) {
	var x e_nocarry_0537
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0537
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0537
		var xInv e_nocarry_0537
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0537
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0537
...
func testLinearComb(t *testing.T, x *e_nocarry_0537, xC int64, y *e_nocarry_0537, yC int64) {
	...
	var z e_nocarry_0537
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0537, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0537
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0537, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0537
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0537, xHi uint64) {
	var res e_nocarry_0537
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0537) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0537) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0537, c int64, result *e_nocarry_0537, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0537) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0537) uint64 {
