...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xb306f975695c31e7, R12
	ADDQ R12, AX
	MOVQ $0xe9539d4944688c2d, R12
	ADCQ R12, DX
	MOVQ $0xe3155821efb2d0cc, R12
	ADCQ R12, CX
	MOVQ $0x10d2b0cbe57af2ec, R12
	ADCQ R12, BX
	MOVQ $0x75a6140a12ceb536, R12
	ADCQ R12, SI
	MOVQ $0xf33f4bee02b51f75, R12
	ADCQ R12, DI
	MOVQ $0x19c343f1ad8e9748, R12
	ADCQ R12, R8
	MOVQ $0x2a54dff5fe672ad6, R12
	ADCQ R12, R9
	MOVQ $0x00000000018ab1cb, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xb306f975695c31e7, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xe9539d4944688c2d, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xe3155821efb2d0cc, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x10d2b0cbe57af2ec, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x75a6140a12ceb536, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xf33f4bee02b51f75, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x19c343f1ad8e9748, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x2a54dff5fe672ad6, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000000018ab1cb, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xb306f975695c31e7, AX
	ADDQ AX, DX
	MOVQ $0xe9539d4944688c2d, AX
	ADCQ AX, CX
	MOVQ $0xe3155821efb2d0cc, AX
	ADCQ AX, BX
	MOVQ $0x10d2b0cbe57af2ec, AX
	ADCQ AX, SI
	MOVQ $0x75a6140a12ceb536, AX
	ADCQ AX, DI
	MOVQ $0xf33f4bee02b51f75, AX
	ADCQ AX, R8
	MOVQ $0x19c343f1ad8e9748, AX
	ADCQ AX, R9
	MOVQ $0x2a54dff5fe672ad6, AX
	ADCQ AX, R10
	MOVQ $0x00000000018ab1cb, AX
	ADCQ AX, R11
