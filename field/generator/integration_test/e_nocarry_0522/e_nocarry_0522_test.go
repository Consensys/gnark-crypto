...
var benchRese_nocarry_0522 e_nocarry_0522

func BenchmarkE_nocarry_0522SetBytes(b *testing.B) {
	var x e_nocarry_0522
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0522MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0522.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0522)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0522)
		}
	})
}

func BenchmarkE_nocarry_0522Inverse(b *testing.B) {
	var x e_nocarry_0522
	x.SetRandom()
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0522Butterfly(b *testing.B) {
	var x e_nocarry_0522
	x.SetRandom()
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0522)
	}
}

func BenchmarkE_nocarry_0522Exp(b *testing.B) {
	var x e_nocarry_0522
	x.SetRandom()
	benchRese_nocarry_0522.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0522Double(b *testing.B) {
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Double(&benchRese_nocarry_0522)
	}
}

func BenchmarkE_nocarry_0522Add(b *testing.B) {
	var x e_nocarry_0522
	x.SetRandom()
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Add(&x, &benchRese_nocarry_0522)
	}
}

func BenchmarkE_nocarry_0522Sub(b *testing.B) {
	var x e_nocarry_0522
	x.SetRandom()
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Sub(&x, &benchRese_nocarry_0522)
	}
}

func BenchmarkE_nocarry_0522Neg(b *testing.B) {
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Neg(&benchRese_nocarry_0522)
	}
}

func BenchmarkE_nocarry_0522Div(b *testing.B) {
	var x e_nocarry_0522
	x.SetRandom()
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Div(&x, &benchRese_nocarry_0522)
	}
}

func BenchmarkE_nocarry_0522FromMont(b *testing.B) {
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.FromMont()
	}
}

func BenchmarkE_nocarry_0522ToMont(b *testing.B) {
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.ToMont()
	}
}
func BenchmarkE_nocarry_0522Square(b *testing.B) {
	benchRese_nocarry_0522.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Square(&benchRese_nocarry_0522)
	}
}

func BenchmarkE_nocarry_0522Sqrt(b *testing.B) {
	var a e_nocarry_0522
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0522Mul(b *testing.B) {
	x := e_nocarry_0522{
		5803784091086508352,
		6646776856504037735,
	...
	benchRese_nocarry_0522.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Mul(&benchRese_nocarry_0522, &x)
	}
}

func BenchmarkE_nocarry_0522Cmp(b *testing.B) {
	x := e_nocarry_0522{
		5803784091086508352,
		6646776856504037735,
		17224215719951254755,
	...
	benchRese_nocarry_0522 = x
	benchRese_nocarry_0522[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0522.Cmp(&x)
	}
}

func TestE_nocarry_0522Cmp(t *testing.T) {
	var x, y e_nocarry_0522
...
func TestE_nocarry_0522IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0522
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0522

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0522{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0522
	one.SetOne()
	e.Sub(&qe_nocarry_0522, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0522{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0522{0, uint64(i)})
	}
...
func TestE_nocarry_0522NegZero(t *testing.T) {
	var a, b e_nocarry_0522
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0522Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0522, len(staticTestValues))
...
func TestE_nocarry_0522Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0522) bool {
			var b e_nocarry_0522
...
func TestE_nocarry_0522InverseExp(t *testing.T) {
...
func TestE_nocarry_0522MulByConstants(t *testing.T) {
...
func TestE_nocarry_0522Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0522) bool {
...
func TestE_nocarry_0522LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0522Halve(t *testing.T) {
...
func TestE_nocarry_0522FromMont(t *testing.T) {
...
type testPaire_nocarry_0522 struct {
	element e_nocarry_0522
	bigint  big.Int
}

func (z *e_nocarry_0522) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0522[8] {
		return true
	}
	if z[8] < qe_nocarry_0522[8] {
		return false
	...
	return z[0] >= qe_nocarry_0522[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0522

		g.element = e_nocarry_0522{
		...
		if qe_nocarry_0522[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0522[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0522 {
			var g e_nocarry_0522
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0522[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0522[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0522[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0522[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0522[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0522[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0522[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0522[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0522[8], carry)
...
func Benchmarke_nocarry_0522InverseNew(b *testing.B) {
	var x e_nocarry_0522
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0522
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0522
		var xInv e_nocarry_0522
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0522
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0522
...
func testLinearComb(t *testing.T, x *e_nocarry_0522, xC int64, y *e_nocarry_0522, yC int64) {
	...
	var z e_nocarry_0522
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0522, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0522
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0522, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0522
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0522, xHi uint64) {
	var res e_nocarry_0522
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0522) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0522) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0522, c int64, result *e_nocarry_0522, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0522) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0522) uint64 {
