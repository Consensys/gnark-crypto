...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x20a4b907b2040b97, R12
	ADDQ R12, AX
	MOVQ $0x161afc8d174580df, R12
	ADCQ R12, DX
	MOVQ $0x36d34f24a0ce2f80, R12
	ADCQ R12, CX
	MOVQ $0xf8998d18400e6176, R12
	ADCQ R12, BX
	MOVQ $0x80ccd65c1dfa2af8, R12
	ADCQ R12, SI
	MOVQ $0xbeddcc46bff45259, R12
	ADCQ R12, DI
	MOVQ $0x84bd49e272c06b89, R12
	ADCQ R12, R8
	MOVQ $0x3b20de7d63ef0c67, R12
	ADCQ R12, R9
	MOVQ $0x00000000000003a4, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x20a4b907b2040b97, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x161afc8d174580df, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x36d34f24a0ce2f80, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xf8998d18400e6176, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x80ccd65c1dfa2af8, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xbeddcc46bff45259, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x84bd49e272c06b89, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x3b20de7d63ef0c67, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000000000003a4, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x20a4b907b2040b97, AX
	ADDQ AX, DX
	MOVQ $0x161afc8d174580df, AX
	ADCQ AX, CX
	MOVQ $0x36d34f24a0ce2f80, AX
	ADCQ AX, BX
	MOVQ $0xf8998d18400e6176, AX
	ADCQ AX, SI
	MOVQ $0x80ccd65c1dfa2af8, AX
	ADCQ AX, DI
	MOVQ $0xbeddcc46bff45259, AX
	ADCQ AX, R8
	MOVQ $0x84bd49e272c06b89, AX
	ADCQ AX, R9
	MOVQ $0x3b20de7d63ef0c67, AX
	ADCQ AX, R10
	MOVQ $0x00000000000003a4, AX
	ADCQ AX, R11
