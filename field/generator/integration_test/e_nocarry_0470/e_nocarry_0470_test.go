...
var benchRese_nocarry_0470 e_nocarry_0470

func BenchmarkE_nocarry_0470SetBytes(b *testing.B) {
	var x e_nocarry_0470
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0470MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0470.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0470)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0470)
		}
	})
}

func BenchmarkE_nocarry_0470Inverse(b *testing.B) {
	var x e_nocarry_0470
	x.SetRandom()
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0470Butterfly(b *testing.B) {
	var x e_nocarry_0470
	x.SetRandom()
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0470)
	}
}

func BenchmarkE_nocarry_0470Exp(b *testing.B) {
	var x e_nocarry_0470
	x.SetRandom()
	benchRese_nocarry_0470.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0470Double(b *testing.B) {
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Double(&benchRese_nocarry_0470)
	}
}

func BenchmarkE_nocarry_0470Add(b *testing.B) {
	var x e_nocarry_0470
	x.SetRandom()
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Add(&x, &benchRese_nocarry_0470)
	}
}

func BenchmarkE_nocarry_0470Sub(b *testing.B) {
	var x e_nocarry_0470
	x.SetRandom()
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Sub(&x, &benchRese_nocarry_0470)
	}
}

func BenchmarkE_nocarry_0470Neg(b *testing.B) {
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Neg(&benchRese_nocarry_0470)
	}
}

func BenchmarkE_nocarry_0470Div(b *testing.B) {
	var x e_nocarry_0470
	x.SetRandom()
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Div(&x, &benchRese_nocarry_0470)
	}
}

func BenchmarkE_nocarry_0470FromMont(b *testing.B) {
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.FromMont()
	}
}

func BenchmarkE_nocarry_0470ToMont(b *testing.B) {
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.ToMont()
	}
}
func BenchmarkE_nocarry_0470Square(b *testing.B) {
	benchRese_nocarry_0470.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Square(&benchRese_nocarry_0470)
	}
}

func BenchmarkE_nocarry_0470Sqrt(b *testing.B) {
	var a e_nocarry_0470
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0470Mul(b *testing.B) {
	x := e_nocarry_0470{
	...
	benchRese_nocarry_0470.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Mul(&benchRese_nocarry_0470, &x)
	}
}

func BenchmarkE_nocarry_0470Cmp(b *testing.B) {
	x := e_nocarry_0470{
		12844870092561185532,
		11991266572375890436,
		10401294087649237302,
	...
	benchRese_nocarry_0470 = x
	benchRese_nocarry_0470[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0470.Cmp(&x)
	}
}

func TestE_nocarry_0470Cmp(t *testing.T) {
	var x, y e_nocarry_0470
...
func TestE_nocarry_0470IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0470
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0470

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0470{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0470
	one.SetOne()
	e.Sub(&qe_nocarry_0470, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0470{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0470{0, uint64(i)})
	}
...
func TestE_nocarry_0470NegZero(t *testing.T) {
	var a, b e_nocarry_0470
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0470Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0470, len(staticTestValues))
...
func TestE_nocarry_0470Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0470) bool {
			var b e_nocarry_0470
...
func TestE_nocarry_0470InverseExp(t *testing.T) {
...
func TestE_nocarry_0470MulByConstants(t *testing.T) {
...
func TestE_nocarry_0470Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0470) bool {
...
func TestE_nocarry_0470LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0470Halve(t *testing.T) {
...
func TestE_nocarry_0470FromMont(t *testing.T) {
...
type testPaire_nocarry_0470 struct {
	element e_nocarry_0470
	bigint  big.Int
}

func (z *e_nocarry_0470) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0470[7] {
		return true
	}
	if z[7] < qe_nocarry_0470[7] {
		return false
	...
	return z[0] >= qe_nocarry_0470[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0470

		g.element = e_nocarry_0470{
		...
		if qe_nocarry_0470[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0470[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0470 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0470[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0470[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0470[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0470[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0470[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0470[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0470[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0470[7], carry)
...
func Benchmarke_nocarry_0470InverseNew(b *testing.B) {
	var x e_nocarry_0470
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0470
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0470
		var xInv e_nocarry_0470
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0470
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0470
...
func testLinearComb(t *testing.T, x *e_nocarry_0470, xC int64, y *e_nocarry_0470, yC int64) {
	...
	var z e_nocarry_0470
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0470, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0470
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0470, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0470
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0470, xHi uint64) {
	var res e_nocarry_0470
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0470) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0470) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0470, c int64, result *e_nocarry_0470, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0470) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0470) uint64 {
