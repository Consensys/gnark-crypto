...
var benchRese_nocarry_0211 e_nocarry_0211

func BenchmarkE_nocarry_0211SetBytes(b *testing.B) {
	var x e_nocarry_0211
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0211MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0211.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0211)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0211)
		}
	})
}

func BenchmarkE_nocarry_0211Inverse(b *testing.B) {
	var x e_nocarry_0211
	x.SetRandom()
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0211Butterfly(b *testing.B) {
	var x e_nocarry_0211
	x.SetRandom()
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0211)
	}
}

func BenchmarkE_nocarry_0211Exp(b *testing.B) {
	var x e_nocarry_0211
	x.SetRandom()
	benchRese_nocarry_0211.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0211Double(b *testing.B) {
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Double(&benchRese_nocarry_0211)
	}
}

func BenchmarkE_nocarry_0211Add(b *testing.B) {
	var x e_nocarry_0211
	x.SetRandom()
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Add(&x, &benchRese_nocarry_0211)
	}
}

func BenchmarkE_nocarry_0211Sub(b *testing.B) {
	var x e_nocarry_0211
	x.SetRandom()
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Sub(&x, &benchRese_nocarry_0211)
	}
}

func BenchmarkE_nocarry_0211Neg(b *testing.B) {
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Neg(&benchRese_nocarry_0211)
	}
}

func BenchmarkE_nocarry_0211Div(b *testing.B) {
	var x e_nocarry_0211
	x.SetRandom()
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Div(&x, &benchRese_nocarry_0211)
	}
}

func BenchmarkE_nocarry_0211FromMont(b *testing.B) {
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.FromMont()
	}
}

func BenchmarkE_nocarry_0211ToMont(b *testing.B) {
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.ToMont()
	}
}
func BenchmarkE_nocarry_0211Square(b *testing.B) {
	benchRese_nocarry_0211.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Square(&benchRese_nocarry_0211)
	}
}

func BenchmarkE_nocarry_0211Sqrt(b *testing.B) {
	var a e_nocarry_0211
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0211Mul(b *testing.B) {
	x := e_nocarry_0211{
		433646168643592356,
	...
	benchRese_nocarry_0211.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Mul(&benchRese_nocarry_0211, &x)
	}
}

func BenchmarkE_nocarry_0211Cmp(b *testing.B) {
	x := e_nocarry_0211{
		433646168643592356,
		12021956762343241936,
		11971856050466592605,
	...
	benchRese_nocarry_0211 = x
	benchRese_nocarry_0211[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0211.Cmp(&x)
	}
}

func TestE_nocarry_0211Cmp(t *testing.T) {
	var x, y e_nocarry_0211
...
func TestE_nocarry_0211IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0211
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0211

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0211{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0211
	one.SetOne()
	e.Sub(&qe_nocarry_0211, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0211{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0211{0, uint64(i)})
	}
...
func TestE_nocarry_0211NegZero(t *testing.T) {
	var a, b e_nocarry_0211
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0211Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0211, len(staticTestValues))
...
func TestE_nocarry_0211Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0211) bool {
			var b e_nocarry_0211
...
func TestE_nocarry_0211InverseExp(t *testing.T) {
...
func TestE_nocarry_0211MulByConstants(t *testing.T) {
...
func TestE_nocarry_0211Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0211) bool {
...
func TestE_nocarry_0211LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0211Halve(t *testing.T) {
...
func TestE_nocarry_0211FromMont(t *testing.T) {
...
type testPaire_nocarry_0211 struct {
	element e_nocarry_0211
	bigint  big.Int
}

func (z *e_nocarry_0211) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0211[3] {
		return true
	}
	if z[3] < qe_nocarry_0211[3] {
		return false
	...
	return z[0] >= qe_nocarry_0211[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0211

		g.element = e_nocarry_0211{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0211[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0211[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0211 {
			var g e_nocarry_0211
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0211[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0211[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0211[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0211[3], carry)
...
func Benchmarke_nocarry_0211InverseNew(b *testing.B) {
	var x e_nocarry_0211
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0211
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0211
		var xInv e_nocarry_0211
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0211
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0211
...
func testLinearComb(t *testing.T, x *e_nocarry_0211, xC int64, y *e_nocarry_0211, yC int64) {
	...
	var z e_nocarry_0211
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0211, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0211
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0211, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0211
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0211, xHi uint64) {
	var res e_nocarry_0211
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0211) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0211) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0211, c int64, result *e_nocarry_0211, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0211) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0211) uint64 {
