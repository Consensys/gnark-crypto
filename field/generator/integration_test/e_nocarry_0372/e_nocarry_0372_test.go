...
var benchRese_nocarry_0372 e_nocarry_0372

func BenchmarkE_nocarry_0372SetBytes(b *testing.B) {
	var x e_nocarry_0372
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0372MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0372.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0372)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0372)
		}
	})
}

func BenchmarkE_nocarry_0372Inverse(b *testing.B) {
	var x e_nocarry_0372
	x.SetRandom()
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0372Butterfly(b *testing.B) {
	var x e_nocarry_0372
	x.SetRandom()
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0372)
	}
}

func BenchmarkE_nocarry_0372Exp(b *testing.B) {
	var x e_nocarry_0372
	x.SetRandom()
	benchRese_nocarry_0372.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0372Double(b *testing.B) {
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Double(&benchRese_nocarry_0372)
	}
}

func BenchmarkE_nocarry_0372Add(b *testing.B) {
	var x e_nocarry_0372
	x.SetRandom()
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Add(&x, &benchRese_nocarry_0372)
	}
}

func BenchmarkE_nocarry_0372Sub(b *testing.B) {
	var x e_nocarry_0372
	x.SetRandom()
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Sub(&x, &benchRese_nocarry_0372)
	}
}

func BenchmarkE_nocarry_0372Neg(b *testing.B) {
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Neg(&benchRese_nocarry_0372)
	}
}

func BenchmarkE_nocarry_0372Div(b *testing.B) {
	var x e_nocarry_0372
	x.SetRandom()
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Div(&x, &benchRese_nocarry_0372)
	}
}

func BenchmarkE_nocarry_0372FromMont(b *testing.B) {
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.FromMont()
	}
}

func BenchmarkE_nocarry_0372ToMont(b *testing.B) {
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.ToMont()
	}
}
func BenchmarkE_nocarry_0372Square(b *testing.B) {
	benchRese_nocarry_0372.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Square(&benchRese_nocarry_0372)
	}
}

func BenchmarkE_nocarry_0372Sqrt(b *testing.B) {
	var a e_nocarry_0372
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0372Mul(b *testing.B) {
	x := e_nocarry_0372{
		5948618808767580553,
		9368163402628418083,
	...
	benchRese_nocarry_0372.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Mul(&benchRese_nocarry_0372, &x)
	}
}

func BenchmarkE_nocarry_0372Cmp(b *testing.B) {
	x := e_nocarry_0372{
		5948618808767580553,
		9368163402628418083,
		13881123562540502575,
	...
	benchRese_nocarry_0372 = x
	benchRese_nocarry_0372[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0372.Cmp(&x)
	}
}

func TestE_nocarry_0372Cmp(t *testing.T) {
	var x, y e_nocarry_0372
...
func TestE_nocarry_0372IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0372
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0372

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0372{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0372
	one.SetOne()
	e.Sub(&qe_nocarry_0372, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0372{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0372{0, uint64(i)})
	}
...
func TestE_nocarry_0372NegZero(t *testing.T) {
	var a, b e_nocarry_0372
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0372Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0372, len(staticTestValues))
...
func TestE_nocarry_0372Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0372) bool {
			var b e_nocarry_0372
...
func TestE_nocarry_0372InverseExp(t *testing.T) {
...
func TestE_nocarry_0372MulByConstants(t *testing.T) {
...
func TestE_nocarry_0372Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0372) bool {
...
func TestE_nocarry_0372LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0372Halve(t *testing.T) {
...
func TestE_nocarry_0372FromMont(t *testing.T) {
...
type testPaire_nocarry_0372 struct {
	element e_nocarry_0372
	bigint  big.Int
}

func (z *e_nocarry_0372) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0372[5] {
		return true
	}
	if z[5] < qe_nocarry_0372[5] {
		return false
	...
	return z[0] >= qe_nocarry_0372[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0372

		g.element = e_nocarry_0372{
		...
		if qe_nocarry_0372[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0372[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0372 {
			var g e_nocarry_0372
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0372[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0372[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0372[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0372[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0372[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0372[5], carry)
...
func Benchmarke_nocarry_0372InverseNew(b *testing.B) {
	var x e_nocarry_0372
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0372
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0372
		var xInv e_nocarry_0372
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0372
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0372
...
func testLinearComb(t *testing.T, x *e_nocarry_0372, xC int64, y *e_nocarry_0372, yC int64) {
	...
	var z e_nocarry_0372
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0372, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0372
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0372, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0372
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0372, xHi uint64) {
	var res e_nocarry_0372
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0372) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0372) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0372, c int64, result *e_nocarry_0372, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0372) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0372) uint64 {
