...
// modulus q
DATA q<>+0(SB)/8, $0x49597b80a5fd733d
DATA q<>+8(SB)/8, $0x9a0fed202d9df197
DATA q<>+16(SB)/8, $0x2926e1d1cc80f6bc
DATA q<>+24(SB)/8, $0x04fa2d4de3286dfe
DATA q<>+32(SB)/8, $0x5f1ffc4793121e35
DATA q<>+40(SB)/8, $0x000e5b1630157fd5
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x13bd940391cb83eb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x49597b80a5fd733d, R10
	MOVQ    $0x9a0fed202d9df197, R11
	MOVQ    $0x2926e1d1cc80f6bc, R12
	MOVQ    $0x04fa2d4de3286dfe, R13
	MOVQ    $0x5f1ffc4793121e35, R14
	MOVQ    $0x000e5b1630157fd5, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x9a0fed202d9df197, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x2926e1d1cc80f6bc, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x04fa2d4de3286dfe, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x5f1ffc4793121e35, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000e5b1630157fd5, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x49597b80a5fd733d, CX
	MOVQ    $0x9a0fed202d9df197, BX
	MOVQ    $0x2926e1d1cc80f6bc, SI
	MOVQ    $0x04fa2d4de3286dfe, DI
	MOVQ    $0x5f1ffc4793121e35, R8
	MOVQ    $0x000e5b1630157fd5, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
