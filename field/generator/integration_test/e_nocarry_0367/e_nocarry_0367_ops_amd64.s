...
// modulus q
DATA q<>+0(SB)/8, $0xe8a1dd21c44faa43
DATA q<>+8(SB)/8, $0x2ff7480335345a57
DATA q<>+16(SB)/8, $0x0b7ce8e5719486d4
DATA q<>+24(SB)/8, $0xe2a6b28290095cd0
DATA q<>+32(SB)/8, $0x3ba2e0ec7b79a8d2
DATA q<>+40(SB)/8, $0x0000638c7f9a8e00
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x3f938b0fd5898d95
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xe8a1dd21c44faa43, R10
	MOVQ    $0x2ff7480335345a57, R11
	MOVQ    $0x0b7ce8e5719486d4, R12
	MOVQ    $0xe2a6b28290095cd0, R13
	MOVQ    $0x3ba2e0ec7b79a8d2, R14
	MOVQ    $0x0000638c7f9a8e00, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x2ff7480335345a57, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x0b7ce8e5719486d4, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xe2a6b28290095cd0, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x3ba2e0ec7b79a8d2, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000638c7f9a8e00, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xe8a1dd21c44faa43, CX
	MOVQ    $0x2ff7480335345a57, BX
	MOVQ    $0x0b7ce8e5719486d4, SI
	MOVQ    $0xe2a6b28290095cd0, DI
	MOVQ    $0x3ba2e0ec7b79a8d2, R8
	MOVQ    $0x0000638c7f9a8e00, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
