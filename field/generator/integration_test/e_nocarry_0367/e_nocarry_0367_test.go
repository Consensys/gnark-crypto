...
var benchRese_nocarry_0367 e_nocarry_0367

func BenchmarkE_nocarry_0367SetBytes(b *testing.B) {
	var x e_nocarry_0367
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0367MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0367.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0367)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0367)
		}
	})
}

func BenchmarkE_nocarry_0367Inverse(b *testing.B) {
	var x e_nocarry_0367
	x.SetRandom()
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0367Butterfly(b *testing.B) {
	var x e_nocarry_0367
	x.SetRandom()
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0367)
	}
}

func BenchmarkE_nocarry_0367Exp(b *testing.B) {
	var x e_nocarry_0367
	x.SetRandom()
	benchRese_nocarry_0367.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0367Double(b *testing.B) {
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Double(&benchRese_nocarry_0367)
	}
}

func BenchmarkE_nocarry_0367Add(b *testing.B) {
	var x e_nocarry_0367
	x.SetRandom()
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Add(&x, &benchRese_nocarry_0367)
	}
}

func BenchmarkE_nocarry_0367Sub(b *testing.B) {
	var x e_nocarry_0367
	x.SetRandom()
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Sub(&x, &benchRese_nocarry_0367)
	}
}

func BenchmarkE_nocarry_0367Neg(b *testing.B) {
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Neg(&benchRese_nocarry_0367)
	}
}

func BenchmarkE_nocarry_0367Div(b *testing.B) {
	var x e_nocarry_0367
	x.SetRandom()
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Div(&x, &benchRese_nocarry_0367)
	}
}

func BenchmarkE_nocarry_0367FromMont(b *testing.B) {
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.FromMont()
	}
}

func BenchmarkE_nocarry_0367ToMont(b *testing.B) {
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.ToMont()
	}
}
func BenchmarkE_nocarry_0367Square(b *testing.B) {
	benchRese_nocarry_0367.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Square(&benchRese_nocarry_0367)
	}
}

func BenchmarkE_nocarry_0367Sqrt(b *testing.B) {
	var a e_nocarry_0367
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0367Mul(b *testing.B) {
	x := e_nocarry_0367{
		294158994157602951,
		9739568534254916484,
		4414044040637557190,
	...
	benchRese_nocarry_0367.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Mul(&benchRese_nocarry_0367, &x)
	}
}

func BenchmarkE_nocarry_0367Cmp(b *testing.B) {
	x := e_nocarry_0367{
		294158994157602951,
		9739568534254916484,
		4414044040637557190,
	...
	benchRese_nocarry_0367 = x
	benchRese_nocarry_0367[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0367.Cmp(&x)
	}
}

func TestE_nocarry_0367Cmp(t *testing.T) {
	var x, y e_nocarry_0367
...
func TestE_nocarry_0367IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0367
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0367

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0367{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0367
	one.SetOne()
	e.Sub(&qe_nocarry_0367, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0367{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0367{0, uint64(i)})
	}
...
func TestE_nocarry_0367NegZero(t *testing.T) {
	var a, b e_nocarry_0367
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0367Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0367, len(staticTestValues))
...
func TestE_nocarry_0367Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0367) bool {
			var b e_nocarry_0367
...
func TestE_nocarry_0367InverseExp(t *testing.T) {
...
func TestE_nocarry_0367MulByConstants(t *testing.T) {
...
func TestE_nocarry_0367Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0367) bool {
...
func TestE_nocarry_0367LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0367Halve(t *testing.T) {
...
func TestE_nocarry_0367FromMont(t *testing.T) {
...
type testPaire_nocarry_0367 struct {
	element e_nocarry_0367
	bigint  big.Int
}

func (z *e_nocarry_0367) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0367[5] {
		return true
	}
	if z[5] < qe_nocarry_0367[5] {
		return false
	...
	return z[0] >= qe_nocarry_0367[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0367

		g.element = e_nocarry_0367{
		...
		if qe_nocarry_0367[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0367[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0367 {
			var g e_nocarry_0367
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0367[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0367[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0367[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0367[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0367[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0367[5], carry)
...
func Benchmarke_nocarry_0367InverseNew(b *testing.B) {
	var x e_nocarry_0367
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0367
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0367
		var xInv e_nocarry_0367
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0367
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0367
...
func testLinearComb(t *testing.T, x *e_nocarry_0367, xC int64, y *e_nocarry_0367, yC int64) {
	...
	var z e_nocarry_0367
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0367, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0367
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0367, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0367
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0367, xHi uint64) {
	var res e_nocarry_0367
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0367) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0367) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0367, c int64, result *e_nocarry_0367, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0367) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0367) uint64 {
