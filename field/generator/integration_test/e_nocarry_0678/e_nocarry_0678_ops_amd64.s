...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xbe20f617666e2681, R14
	ADDQ R14, AX
	MOVQ $0xf83d31bb43f27916, R14
	ADCQ R14, DX
	MOVQ $0x5a03fc4fdbdeb9ce, R14
	ADCQ R14, CX
	MOVQ $0x6c25ca9cb6471797, R14
	ADCQ R14, BX
	MOVQ $0x384923b416a393fa, R14
	ADCQ R14, SI
	MOVQ $0xb99f732a9e382529, R14
	ADCQ R14, DI
	MOVQ $0xd2b0618a8b5a30b8, R14
	ADCQ R14, R8
	MOVQ $0xe0ac9b766bb39891, R14
	ADCQ R14, R9
	MOVQ $0x3a8e8b441fca317b, R14
	ADCQ R14, R10
	MOVQ $0xff9f47246fcc9540, R14
	ADCQ R14, R11
	MOVQ $0x00000036067863b5, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xbe20f617666e2681, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xf83d31bb43f27916, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x5a03fc4fdbdeb9ce, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x6c25ca9cb6471797, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x384923b416a393fa, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xb99f732a9e382529, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xd2b0618a8b5a30b8, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xe0ac9b766bb39891, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x3a8e8b441fca317b, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xff9f47246fcc9540, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000036067863b5, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xbe20f617666e2681, AX
	ADDQ AX, DX
	MOVQ $0xf83d31bb43f27916, AX
	ADCQ AX, CX
	MOVQ $0x5a03fc4fdbdeb9ce, AX
	ADCQ AX, BX
	MOVQ $0x6c25ca9cb6471797, AX
	ADCQ AX, SI
	MOVQ $0x384923b416a393fa, AX
	ADCQ AX, DI
	MOVQ $0xb99f732a9e382529, AX
	ADCQ AX, R8
	MOVQ $0xd2b0618a8b5a30b8, AX
	ADCQ AX, R9
	MOVQ $0xe0ac9b766bb39891, AX
	ADCQ AX, R10
	MOVQ $0x3a8e8b441fca317b, AX
	ADCQ AX, R11
	MOVQ $0xff9f47246fcc9540, AX
	ADCQ AX, R12
	MOVQ $0x00000036067863b5, AX
	ADCQ AX, R13
