...
var benchRese_nocarry_0678 e_nocarry_0678

func BenchmarkE_nocarry_0678SetBytes(b *testing.B) {
	var x e_nocarry_0678
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0678MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0678.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0678)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0678)
		}
	})
}

func BenchmarkE_nocarry_0678Inverse(b *testing.B) {
	var x e_nocarry_0678
	x.SetRandom()
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0678Butterfly(b *testing.B) {
	var x e_nocarry_0678
	x.SetRandom()
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0678)
	}
}

func BenchmarkE_nocarry_0678Exp(b *testing.B) {
	var x e_nocarry_0678
	x.SetRandom()
	benchRese_nocarry_0678.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0678Double(b *testing.B) {
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Double(&benchRese_nocarry_0678)
	}
}

func BenchmarkE_nocarry_0678Add(b *testing.B) {
	var x e_nocarry_0678
	x.SetRandom()
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Add(&x, &benchRese_nocarry_0678)
	}
}

func BenchmarkE_nocarry_0678Sub(b *testing.B) {
	var x e_nocarry_0678
	x.SetRandom()
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Sub(&x, &benchRese_nocarry_0678)
	}
}

func BenchmarkE_nocarry_0678Neg(b *testing.B) {
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Neg(&benchRese_nocarry_0678)
	}
}

func BenchmarkE_nocarry_0678Div(b *testing.B) {
	var x e_nocarry_0678
	x.SetRandom()
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Div(&x, &benchRese_nocarry_0678)
	}
}

func BenchmarkE_nocarry_0678FromMont(b *testing.B) {
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.FromMont()
	}
}

func BenchmarkE_nocarry_0678ToMont(b *testing.B) {
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.ToMont()
	}
}
func BenchmarkE_nocarry_0678Square(b *testing.B) {
	benchRese_nocarry_0678.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Square(&benchRese_nocarry_0678)
	}
}

func BenchmarkE_nocarry_0678Sqrt(b *testing.B) {
	var a e_nocarry_0678
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0678Mul(b *testing.B) {
	x := e_nocarry_0678{
		273606947743973706,
		3464412692890843633,
		8435940272544525640,
	...
	benchRese_nocarry_0678.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Mul(&benchRese_nocarry_0678, &x)
	}
}

func BenchmarkE_nocarry_0678Cmp(b *testing.B) {
	x := e_nocarry_0678{
		273606947743973706,
		3464412692890843633,
		8435940272544525640,
	...
	benchRese_nocarry_0678 = x
	benchRese_nocarry_0678[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0678.Cmp(&x)
	}
}

func TestE_nocarry_0678Cmp(t *testing.T) {
	var x, y e_nocarry_0678
...
func TestE_nocarry_0678IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0678
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0678

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0678{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0678
	one.SetOne()
	e.Sub(&qe_nocarry_0678, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0678{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0678{0, uint64(i)})
	}
...
func TestE_nocarry_0678NegZero(t *testing.T) {
	var a, b e_nocarry_0678
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0678Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0678, len(staticTestValues))
...
func TestE_nocarry_0678Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0678) bool {
			var b e_nocarry_0678
...
func TestE_nocarry_0678InverseExp(t *testing.T) {
...
func TestE_nocarry_0678MulByConstants(t *testing.T) {
...
func TestE_nocarry_0678Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0678) bool {
...
func TestE_nocarry_0678LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0678Halve(t *testing.T) {
...
func TestE_nocarry_0678FromMont(t *testing.T) {
...
type testPaire_nocarry_0678 struct {
	element e_nocarry_0678
	bigint  big.Int
}

func (z *e_nocarry_0678) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0678[10] {
		return true
	}
	if z[10] < qe_nocarry_0678[10] {
		return false
	...
	return z[0] >= qe_nocarry_0678[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0678

		g.element = e_nocarry_0678{
		...
		if qe_nocarry_0678[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0678[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0678 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0678[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0678[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0678[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0678[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0678[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0678[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0678[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0678[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0678[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0678[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0678[10], carry)
...
func Benchmarke_nocarry_0678InverseNew(b *testing.B) {
	var x e_nocarry_0678
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0678
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0678
		var xInv e_nocarry_0678
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0678
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0678
...
func testLinearComb(t *testing.T, x *e_nocarry_0678, xC int64, y *e_nocarry_0678, yC int64) {
	...
	var z e_nocarry_0678
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0678, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0678
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0678, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0678
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0678, xHi uint64) {
	var res e_nocarry_0678
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0678) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0678) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0678, c int64, result *e_nocarry_0678, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0678) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0678) uint64 {
