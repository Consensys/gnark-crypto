...
var benchRese_nocarry_0222 e_nocarry_0222

func BenchmarkE_nocarry_0222SetBytes(b *testing.B) {
	var x e_nocarry_0222
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0222MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0222.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0222)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0222)
		}
	})
}

func BenchmarkE_nocarry_0222Inverse(b *testing.B) {
	var x e_nocarry_0222
	x.SetRandom()
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0222Butterfly(b *testing.B) {
	var x e_nocarry_0222
	x.SetRandom()
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0222)
	}
}

func BenchmarkE_nocarry_0222Exp(b *testing.B) {
	var x e_nocarry_0222
	x.SetRandom()
	benchRese_nocarry_0222.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0222Double(b *testing.B) {
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Double(&benchRese_nocarry_0222)
	}
}

func BenchmarkE_nocarry_0222Add(b *testing.B) {
	var x e_nocarry_0222
	x.SetRandom()
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Add(&x, &benchRese_nocarry_0222)
	}
}

func BenchmarkE_nocarry_0222Sub(b *testing.B) {
	var x e_nocarry_0222
	x.SetRandom()
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Sub(&x, &benchRese_nocarry_0222)
	}
}

func BenchmarkE_nocarry_0222Neg(b *testing.B) {
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Neg(&benchRese_nocarry_0222)
	}
}

func BenchmarkE_nocarry_0222Div(b *testing.B) {
	var x e_nocarry_0222
	x.SetRandom()
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Div(&x, &benchRese_nocarry_0222)
	}
}

func BenchmarkE_nocarry_0222FromMont(b *testing.B) {
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.FromMont()
	}
}

func BenchmarkE_nocarry_0222ToMont(b *testing.B) {
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.ToMont()
	}
}
func BenchmarkE_nocarry_0222Square(b *testing.B) {
	benchRese_nocarry_0222.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Square(&benchRese_nocarry_0222)
	}
}

func BenchmarkE_nocarry_0222Sqrt(b *testing.B) {
	var a e_nocarry_0222
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0222Mul(b *testing.B) {
	x := e_nocarry_0222{
		5462126560913810148,
		8710668230371278552,
	...
	benchRese_nocarry_0222.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Mul(&benchRese_nocarry_0222, &x)
	}
}

func BenchmarkE_nocarry_0222Cmp(b *testing.B) {
	x := e_nocarry_0222{
		5462126560913810148,
		8710668230371278552,
		13739923123260917056,
	...
	benchRese_nocarry_0222 = x
	benchRese_nocarry_0222[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0222.Cmp(&x)
	}
}

func TestE_nocarry_0222Cmp(t *testing.T) {
	var x, y e_nocarry_0222
...
func TestE_nocarry_0222IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0222
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0222

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0222{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0222
	one.SetOne()
	e.Sub(&qe_nocarry_0222, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0222{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0222{0, uint64(i)})
	}
...
func TestE_nocarry_0222NegZero(t *testing.T) {
	var a, b e_nocarry_0222
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0222Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0222, len(staticTestValues))
...
func TestE_nocarry_0222Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0222) bool {
			var b e_nocarry_0222
...
func TestE_nocarry_0222InverseExp(t *testing.T) {
...
func TestE_nocarry_0222MulByConstants(t *testing.T) {
...
func TestE_nocarry_0222Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0222) bool {
...
func TestE_nocarry_0222LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0222Halve(t *testing.T) {
...
func TestE_nocarry_0222FromMont(t *testing.T) {
...
type testPaire_nocarry_0222 struct {
	element e_nocarry_0222
	bigint  big.Int
}

func (z *e_nocarry_0222) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0222[3] {
		return true
	}
	if z[3] < qe_nocarry_0222[3] {
		return false
	...
	return z[0] >= qe_nocarry_0222[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0222

		g.element = e_nocarry_0222{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0222[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0222[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0222 {
			var g e_nocarry_0222
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0222[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0222[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0222[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0222[3], carry)
...
func Benchmarke_nocarry_0222InverseNew(b *testing.B) {
	var x e_nocarry_0222
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0222
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0222
		var xInv e_nocarry_0222
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0222
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0222
...
func testLinearComb(t *testing.T, x *e_nocarry_0222, xC int64, y *e_nocarry_0222, yC int64) {
	...
	var z e_nocarry_0222
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0222, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0222
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0222, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0222
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0222, xHi uint64) {
	var res e_nocarry_0222
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0222) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0222) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0222, c int64, result *e_nocarry_0222, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0222) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0222) uint64 {
