...
var benchRese_nocarry_0466 e_nocarry_0466

func BenchmarkE_nocarry_0466SetBytes(b *testing.B) {
	var x e_nocarry_0466
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0466MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0466.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0466)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0466)
		}
	})
}

func BenchmarkE_nocarry_0466Inverse(b *testing.B) {
	var x e_nocarry_0466
	x.SetRandom()
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0466Butterfly(b *testing.B) {
	var x e_nocarry_0466
	x.SetRandom()
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0466)
	}
}

func BenchmarkE_nocarry_0466Exp(b *testing.B) {
	var x e_nocarry_0466
	x.SetRandom()
	benchRese_nocarry_0466.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0466Double(b *testing.B) {
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Double(&benchRese_nocarry_0466)
	}
}

func BenchmarkE_nocarry_0466Add(b *testing.B) {
	var x e_nocarry_0466
	x.SetRandom()
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Add(&x, &benchRese_nocarry_0466)
	}
}

func BenchmarkE_nocarry_0466Sub(b *testing.B) {
	var x e_nocarry_0466
	x.SetRandom()
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Sub(&x, &benchRese_nocarry_0466)
	}
}

func BenchmarkE_nocarry_0466Neg(b *testing.B) {
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Neg(&benchRese_nocarry_0466)
	}
}

func BenchmarkE_nocarry_0466Div(b *testing.B) {
	var x e_nocarry_0466
	x.SetRandom()
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Div(&x, &benchRese_nocarry_0466)
	}
}

func BenchmarkE_nocarry_0466FromMont(b *testing.B) {
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.FromMont()
	}
}

func BenchmarkE_nocarry_0466ToMont(b *testing.B) {
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.ToMont()
	}
}
func BenchmarkE_nocarry_0466Square(b *testing.B) {
	benchRese_nocarry_0466.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Square(&benchRese_nocarry_0466)
	}
}

func BenchmarkE_nocarry_0466Sqrt(b *testing.B) {
	var a e_nocarry_0466
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0466Mul(b *testing.B) {
	x := e_nocarry_0466{
		7442959992696149233,
		5609460682092606913,
		9279221149735271963,
	...
	benchRese_nocarry_0466.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Mul(&benchRese_nocarry_0466, &x)
	}
}

func BenchmarkE_nocarry_0466Cmp(b *testing.B) {
	x := e_nocarry_0466{
		7442959992696149233,
		5609460682092606913,
		9279221149735271963,
	...
	benchRese_nocarry_0466 = x
	benchRese_nocarry_0466[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0466.Cmp(&x)
	}
}

func TestE_nocarry_0466Cmp(t *testing.T) {
	var x, y e_nocarry_0466
...
func TestE_nocarry_0466IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0466
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0466

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0466{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0466
	one.SetOne()
	e.Sub(&qe_nocarry_0466, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0466{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0466{0, uint64(i)})
	}
...
func TestE_nocarry_0466NegZero(t *testing.T) {
	var a, b e_nocarry_0466
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0466Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0466, len(staticTestValues))
...
func TestE_nocarry_0466Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0466) bool {
			var b e_nocarry_0466
...
func TestE_nocarry_0466InverseExp(t *testing.T) {
...
func TestE_nocarry_0466MulByConstants(t *testing.T) {
...
func TestE_nocarry_0466Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0466) bool {
...
func TestE_nocarry_0466LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0466Halve(t *testing.T) {
...
func TestE_nocarry_0466FromMont(t *testing.T) {
...
type testPaire_nocarry_0466 struct {
	element e_nocarry_0466
	bigint  big.Int
}

func (z *e_nocarry_0466) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0466[7] {
		return true
	}
	if z[7] < qe_nocarry_0466[7] {
		return false
	...
	return z[0] >= qe_nocarry_0466[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0466

		g.element = e_nocarry_0466{
		...
		if qe_nocarry_0466[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0466[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0466 {
			var g e_nocarry_0466
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0466[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0466[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0466[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0466[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0466[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0466[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0466[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0466[7], carry)
...
func Benchmarke_nocarry_0466InverseNew(b *testing.B) {
	var x e_nocarry_0466
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0466
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0466
		var xInv e_nocarry_0466
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0466
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0466
...
func testLinearComb(t *testing.T, x *e_nocarry_0466, xC int64, y *e_nocarry_0466, yC int64) {
	...
	var z e_nocarry_0466
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0466, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0466
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0466, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0466
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0466, xHi uint64) {
	var res e_nocarry_0466
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0466) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0466) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0466, c int64, result *e_nocarry_0466, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0466) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0466) uint64 {
