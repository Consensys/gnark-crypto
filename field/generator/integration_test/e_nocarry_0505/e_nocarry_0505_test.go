...
var benchRese_nocarry_0505 e_nocarry_0505

func BenchmarkE_nocarry_0505SetBytes(b *testing.B) {
	var x e_nocarry_0505
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0505MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0505.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0505)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0505)
		}
	})
}

func BenchmarkE_nocarry_0505Inverse(b *testing.B) {
	var x e_nocarry_0505
	x.SetRandom()
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0505Butterfly(b *testing.B) {
	var x e_nocarry_0505
	x.SetRandom()
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0505)
	}
}

func BenchmarkE_nocarry_0505Exp(b *testing.B) {
	var x e_nocarry_0505
	x.SetRandom()
	benchRese_nocarry_0505.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0505Double(b *testing.B) {
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Double(&benchRese_nocarry_0505)
	}
}

func BenchmarkE_nocarry_0505Add(b *testing.B) {
	var x e_nocarry_0505
	x.SetRandom()
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Add(&x, &benchRese_nocarry_0505)
	}
}

func BenchmarkE_nocarry_0505Sub(b *testing.B) {
	var x e_nocarry_0505
	x.SetRandom()
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Sub(&x, &benchRese_nocarry_0505)
	}
}

func BenchmarkE_nocarry_0505Neg(b *testing.B) {
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Neg(&benchRese_nocarry_0505)
	}
}

func BenchmarkE_nocarry_0505Div(b *testing.B) {
	var x e_nocarry_0505
	x.SetRandom()
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Div(&x, &benchRese_nocarry_0505)
	}
}

func BenchmarkE_nocarry_0505FromMont(b *testing.B) {
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.FromMont()
	}
}

func BenchmarkE_nocarry_0505ToMont(b *testing.B) {
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.ToMont()
	}
}
func BenchmarkE_nocarry_0505Square(b *testing.B) {
	benchRese_nocarry_0505.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Square(&benchRese_nocarry_0505)
	}
}

func BenchmarkE_nocarry_0505Sqrt(b *testing.B) {
	var a e_nocarry_0505
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0505Mul(b *testing.B) {
	x := e_nocarry_0505{
		6276018020761603584,
	...
	benchRese_nocarry_0505.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Mul(&benchRese_nocarry_0505, &x)
	}
}

func BenchmarkE_nocarry_0505Cmp(b *testing.B) {
	x := e_nocarry_0505{
		6276018020761603584,
		17089863183431146396,
		13889160247517835775,
	...
	benchRese_nocarry_0505 = x
	benchRese_nocarry_0505[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0505.Cmp(&x)
	}
}

func TestE_nocarry_0505Cmp(t *testing.T) {
	var x, y e_nocarry_0505
...
func TestE_nocarry_0505IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0505
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0505

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0505{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0505
	one.SetOne()
	e.Sub(&qe_nocarry_0505, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0505{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0505{0, uint64(i)})
	}
...
func TestE_nocarry_0505NegZero(t *testing.T) {
	var a, b e_nocarry_0505
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0505Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0505, len(staticTestValues))
...
func TestE_nocarry_0505Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0505) bool {
			var b e_nocarry_0505
...
func TestE_nocarry_0505InverseExp(t *testing.T) {
...
func TestE_nocarry_0505MulByConstants(t *testing.T) {
...
func TestE_nocarry_0505Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0505) bool {
...
func TestE_nocarry_0505LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0505Halve(t *testing.T) {
...
func TestE_nocarry_0505FromMont(t *testing.T) {
...
type testPaire_nocarry_0505 struct {
	element e_nocarry_0505
	bigint  big.Int
}

func (z *e_nocarry_0505) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0505[7] {
		return true
	}
	if z[7] < qe_nocarry_0505[7] {
		return false
	...
	return z[0] >= qe_nocarry_0505[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0505

		g.element = e_nocarry_0505{
		...
		if qe_nocarry_0505[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0505[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0505 {
			var g e_nocarry_0505
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0505[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0505[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0505[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0505[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0505[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0505[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0505[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0505[7], carry)
...
func Benchmarke_nocarry_0505InverseNew(b *testing.B) {
	var x e_nocarry_0505
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0505
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0505
		var xInv e_nocarry_0505
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0505
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0505
...
func testLinearComb(t *testing.T, x *e_nocarry_0505, xC int64, y *e_nocarry_0505, yC int64) {
	...
	var z e_nocarry_0505
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0505, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0505
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0505, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0505
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0505, xHi uint64) {
	var res e_nocarry_0505
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0505) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0505) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0505, c int64, result *e_nocarry_0505, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0505) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0505) uint64 {
