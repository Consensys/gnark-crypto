...
var benchRese_nocarry_0587 e_nocarry_0587

func BenchmarkE_nocarry_0587SetBytes(b *testing.B) {
	var x e_nocarry_0587
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0587MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0587.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0587)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0587)
		}
	})
}

func BenchmarkE_nocarry_0587Inverse(b *testing.B) {
	var x e_nocarry_0587
	x.SetRandom()
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0587Butterfly(b *testing.B) {
	var x e_nocarry_0587
	x.SetRandom()
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0587)
	}
}

func BenchmarkE_nocarry_0587Exp(b *testing.B) {
	var x e_nocarry_0587
	x.SetRandom()
	benchRese_nocarry_0587.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0587Double(b *testing.B) {
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Double(&benchRese_nocarry_0587)
	}
}

func BenchmarkE_nocarry_0587Add(b *testing.B) {
	var x e_nocarry_0587
	x.SetRandom()
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Add(&x, &benchRese_nocarry_0587)
	}
}

func BenchmarkE_nocarry_0587Sub(b *testing.B) {
	var x e_nocarry_0587
	x.SetRandom()
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Sub(&x, &benchRese_nocarry_0587)
	}
}

func BenchmarkE_nocarry_0587Neg(b *testing.B) {
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Neg(&benchRese_nocarry_0587)
	}
}

func BenchmarkE_nocarry_0587Div(b *testing.B) {
	var x e_nocarry_0587
	x.SetRandom()
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Div(&x, &benchRese_nocarry_0587)
	}
}

func BenchmarkE_nocarry_0587FromMont(b *testing.B) {
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.FromMont()
	}
}

func BenchmarkE_nocarry_0587ToMont(b *testing.B) {
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.ToMont()
	}
}
func BenchmarkE_nocarry_0587Square(b *testing.B) {
	benchRese_nocarry_0587.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Square(&benchRese_nocarry_0587)
	}
}

func BenchmarkE_nocarry_0587Sqrt(b *testing.B) {
	var a e_nocarry_0587
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0587Mul(b *testing.B) {
	x := e_nocarry_0587{
		8388104268543523565,
	...
	benchRese_nocarry_0587.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Mul(&benchRese_nocarry_0587, &x)
	}
}

func BenchmarkE_nocarry_0587Cmp(b *testing.B) {
	x := e_nocarry_0587{
		8388104268543523565,
		18264973095249513048,
		4622012768776534849,
	...
	benchRese_nocarry_0587 = x
	benchRese_nocarry_0587[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0587.Cmp(&x)
	}
}

func TestE_nocarry_0587Cmp(t *testing.T) {
	var x, y e_nocarry_0587
...
func TestE_nocarry_0587IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0587
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0587

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0587{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0587
	one.SetOne()
	e.Sub(&qe_nocarry_0587, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0587{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0587{0, uint64(i)})
	}
...
func TestE_nocarry_0587NegZero(t *testing.T) {
	var a, b e_nocarry_0587
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0587Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0587, len(staticTestValues))
...
func TestE_nocarry_0587Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0587) bool {
			var b e_nocarry_0587
...
func TestE_nocarry_0587InverseExp(t *testing.T) {
...
func TestE_nocarry_0587MulByConstants(t *testing.T) {
...
func TestE_nocarry_0587Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0587) bool {
...
func TestE_nocarry_0587LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0587Halve(t *testing.T) {
...
func TestE_nocarry_0587FromMont(t *testing.T) {
...
type testPaire_nocarry_0587 struct {
	element e_nocarry_0587
	bigint  big.Int
}

func (z *e_nocarry_0587) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0587[9] {
		return true
	}
	if z[9] < qe_nocarry_0587[9] {
		return false
	...
	return z[0] >= qe_nocarry_0587[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0587

		g.element = e_nocarry_0587{
		...
		if qe_nocarry_0587[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0587[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0587 {
			var g e_nocarry_0587
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0587[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0587[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0587[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0587[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0587[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0587[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0587[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0587[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0587[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0587[9], carry)
...
func Benchmarke_nocarry_0587InverseNew(b *testing.B) {
	var x e_nocarry_0587
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0587
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0587
		var xInv e_nocarry_0587
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0587
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0587
...
func testLinearComb(t *testing.T, x *e_nocarry_0587, xC int64, y *e_nocarry_0587, yC int64) {
	...
	var z e_nocarry_0587
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0587, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0587
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0587, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0587
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0587, xHi uint64) {
	var res e_nocarry_0587
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0587) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0587) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0587, c int64, result *e_nocarry_0587, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0587) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0587) uint64 {
