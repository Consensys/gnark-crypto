...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xee6e5ef933b1dd15, R13
	ADDQ R13, AX
	MOVQ $0x1edd72403b569d6c, R13
	ADCQ R13, DX
	MOVQ $0x9929624212b23c97, R13
	ADCQ R13, CX
	MOVQ $0xf24be7a66f6a07a5, R13
	ADCQ R13, BX
	MOVQ $0xae3e7c036e2046be, R13
	ADCQ R13, SI
	MOVQ $0x66a0adcaa4b12164, R13
	ADCQ R13, DI
	MOVQ $0x7016a7d1d38e357b, R13
	ADCQ R13, R8
	MOVQ $0x5c6d27c6fc96fb87, R13
	ADCQ R13, R9
	MOVQ $0x2ad85a1f1240c887, R13
	ADCQ R13, R10
	MOVQ $0x00000000000006eb, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xee6e5ef933b1dd15, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x1edd72403b569d6c, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x9929624212b23c97, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xf24be7a66f6a07a5, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xae3e7c036e2046be, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x66a0adcaa4b12164, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x7016a7d1d38e357b, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x5c6d27c6fc96fb87, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x2ad85a1f1240c887, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000000006eb, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xee6e5ef933b1dd15, AX
	ADDQ AX, DX
	MOVQ $0x1edd72403b569d6c, AX
	ADCQ AX, CX
	MOVQ $0x9929624212b23c97, AX
	ADCQ AX, BX
	MOVQ $0xf24be7a66f6a07a5, AX
	ADCQ AX, SI
	MOVQ $0xae3e7c036e2046be, AX
	ADCQ AX, DI
	MOVQ $0x66a0adcaa4b12164, AX
	ADCQ AX, R8
	MOVQ $0x7016a7d1d38e357b, AX
	ADCQ AX, R9
	MOVQ $0x5c6d27c6fc96fb87, AX
	ADCQ AX, R10
	MOVQ $0x2ad85a1f1240c887, AX
	ADCQ AX, R11
	MOVQ $0x00000000000006eb, AX
	ADCQ AX, R12
