...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x98ae91f929c58f07, R12
	ADDQ R12, AX
	MOVQ $0xed9fa061878c4a4d, R12
	ADCQ R12, DX
	MOVQ $0x120d679b156de5ae, R12
	ADCQ R12, CX
	MOVQ $0xb0e118c8c1cb76da, R12
	ADCQ R12, BX
	MOVQ $0x7daa737bdb5a50ff, R12
	ADCQ R12, SI
	MOVQ $0xad4015bc7252ce3a, R12
	ADCQ R12, DI
	MOVQ $0x505e1d39a2f8bde7, R12
	ADCQ R12, R8
	MOVQ $0x723df83c39dbf98a, R12
	ADCQ R12, R9
	MOVQ $0x00000faf562ee7c7, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x98ae91f929c58f07, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xed9fa061878c4a4d, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x120d679b156de5ae, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xb0e118c8c1cb76da, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x7daa737bdb5a50ff, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xad4015bc7252ce3a, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x505e1d39a2f8bde7, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x723df83c39dbf98a, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000faf562ee7c7, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x98ae91f929c58f07, AX
	ADDQ AX, DX
	MOVQ $0xed9fa061878c4a4d, AX
	ADCQ AX, CX
	MOVQ $0x120d679b156de5ae, AX
	ADCQ AX, BX
	MOVQ $0xb0e118c8c1cb76da, AX
	ADCQ AX, SI
	MOVQ $0x7daa737bdb5a50ff, AX
	ADCQ AX, DI
	MOVQ $0xad4015bc7252ce3a, AX
	ADCQ AX, R8
	MOVQ $0x505e1d39a2f8bde7, AX
	ADCQ AX, R9
	MOVQ $0x723df83c39dbf98a, AX
	ADCQ AX, R10
	MOVQ $0x00000faf562ee7c7, AX
	ADCQ AX, R11
