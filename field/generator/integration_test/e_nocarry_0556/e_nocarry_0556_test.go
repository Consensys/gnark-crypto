...
var benchRese_nocarry_0556 e_nocarry_0556

func BenchmarkE_nocarry_0556SetBytes(b *testing.B) {
	var x e_nocarry_0556
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0556MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0556.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0556)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0556)
		}
	})
}

func BenchmarkE_nocarry_0556Inverse(b *testing.B) {
	var x e_nocarry_0556
	x.SetRandom()
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0556Butterfly(b *testing.B) {
	var x e_nocarry_0556
	x.SetRandom()
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0556)
	}
}

func BenchmarkE_nocarry_0556Exp(b *testing.B) {
	var x e_nocarry_0556
	x.SetRandom()
	benchRese_nocarry_0556.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0556Double(b *testing.B) {
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Double(&benchRese_nocarry_0556)
	}
}

func BenchmarkE_nocarry_0556Add(b *testing.B) {
	var x e_nocarry_0556
	x.SetRandom()
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Add(&x, &benchRese_nocarry_0556)
	}
}

func BenchmarkE_nocarry_0556Sub(b *testing.B) {
	var x e_nocarry_0556
	x.SetRandom()
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Sub(&x, &benchRese_nocarry_0556)
	}
}

func BenchmarkE_nocarry_0556Neg(b *testing.B) {
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Neg(&benchRese_nocarry_0556)
	}
}

func BenchmarkE_nocarry_0556Div(b *testing.B) {
	var x e_nocarry_0556
	x.SetRandom()
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Div(&x, &benchRese_nocarry_0556)
	}
}

func BenchmarkE_nocarry_0556FromMont(b *testing.B) {
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.FromMont()
	}
}

func BenchmarkE_nocarry_0556ToMont(b *testing.B) {
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.ToMont()
	}
}
func BenchmarkE_nocarry_0556Square(b *testing.B) {
	benchRese_nocarry_0556.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Square(&benchRese_nocarry_0556)
	}
}

func BenchmarkE_nocarry_0556Sqrt(b *testing.B) {
	var a e_nocarry_0556
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0556Mul(b *testing.B) {
	x := e_nocarry_0556{
		112367091334754015,
		6118949289102064870,
	...
	benchRese_nocarry_0556.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Mul(&benchRese_nocarry_0556, &x)
	}
}

func BenchmarkE_nocarry_0556Cmp(b *testing.B) {
	x := e_nocarry_0556{
		112367091334754015,
		6118949289102064870,
		13220291490324617267,
	...
	benchRese_nocarry_0556 = x
	benchRese_nocarry_0556[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0556.Cmp(&x)
	}
}

func TestE_nocarry_0556Cmp(t *testing.T) {
	var x, y e_nocarry_0556
...
func TestE_nocarry_0556IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0556
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0556

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0556{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0556
	one.SetOne()
	e.Sub(&qe_nocarry_0556, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0556{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0556{0, uint64(i)})
	}
...
func TestE_nocarry_0556NegZero(t *testing.T) {
	var a, b e_nocarry_0556
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0556Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0556, len(staticTestValues))
...
func TestE_nocarry_0556Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0556) bool {
			var b e_nocarry_0556
...
func TestE_nocarry_0556InverseExp(t *testing.T) {
...
func TestE_nocarry_0556MulByConstants(t *testing.T) {
...
func TestE_nocarry_0556Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0556) bool {
...
func TestE_nocarry_0556LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0556Halve(t *testing.T) {
...
func TestE_nocarry_0556FromMont(t *testing.T) {
...
type testPaire_nocarry_0556 struct {
	element e_nocarry_0556
	bigint  big.Int
}

func (z *e_nocarry_0556) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0556[8] {
		return true
	}
	if z[8] < qe_nocarry_0556[8] {
		return false
	...
	return z[0] >= qe_nocarry_0556[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0556

		g.element = e_nocarry_0556{
		...
		if qe_nocarry_0556[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0556[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0556 {
			var g e_nocarry_0556
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0556[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0556[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0556[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0556[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0556[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0556[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0556[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0556[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0556[8], carry)
...
func Benchmarke_nocarry_0556InverseNew(b *testing.B) {
	var x e_nocarry_0556
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0556
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0556
		var xInv e_nocarry_0556
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0556
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0556
...
func testLinearComb(t *testing.T, x *e_nocarry_0556, xC int64, y *e_nocarry_0556, yC int64) {
	...
	var z e_nocarry_0556
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0556, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0556
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0556, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0556
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0556, xHi uint64) {
	var res e_nocarry_0556
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0556) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0556) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0556, c int64, result *e_nocarry_0556, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0556) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0556) uint64 {
