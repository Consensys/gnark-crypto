...
var benchRese_nocarry_0300 e_nocarry_0300

func BenchmarkE_nocarry_0300SetBytes(b *testing.B) {
	var x e_nocarry_0300
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0300MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0300.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0300)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0300)
		}
	})
}

func BenchmarkE_nocarry_0300Inverse(b *testing.B) {
	var x e_nocarry_0300
	x.SetRandom()
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0300Butterfly(b *testing.B) {
	var x e_nocarry_0300
	x.SetRandom()
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0300)
	}
}

func BenchmarkE_nocarry_0300Exp(b *testing.B) {
	var x e_nocarry_0300
	x.SetRandom()
	benchRese_nocarry_0300.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0300Double(b *testing.B) {
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Double(&benchRese_nocarry_0300)
	}
}

func BenchmarkE_nocarry_0300Add(b *testing.B) {
	var x e_nocarry_0300
	x.SetRandom()
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Add(&x, &benchRese_nocarry_0300)
	}
}

func BenchmarkE_nocarry_0300Sub(b *testing.B) {
	var x e_nocarry_0300
	x.SetRandom()
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Sub(&x, &benchRese_nocarry_0300)
	}
}

func BenchmarkE_nocarry_0300Neg(b *testing.B) {
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Neg(&benchRese_nocarry_0300)
	}
}

func BenchmarkE_nocarry_0300Div(b *testing.B) {
	var x e_nocarry_0300
	x.SetRandom()
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Div(&x, &benchRese_nocarry_0300)
	}
}

func BenchmarkE_nocarry_0300FromMont(b *testing.B) {
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.FromMont()
	}
}

func BenchmarkE_nocarry_0300ToMont(b *testing.B) {
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.ToMont()
	}
}
func BenchmarkE_nocarry_0300Square(b *testing.B) {
	benchRese_nocarry_0300.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Square(&benchRese_nocarry_0300)
	}
}

func BenchmarkE_nocarry_0300Sqrt(b *testing.B) {
	var a e_nocarry_0300
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0300Mul(b *testing.B) {
	x := e_nocarry_0300{
	...
	benchRese_nocarry_0300.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Mul(&benchRese_nocarry_0300, &x)
	}
}

func BenchmarkE_nocarry_0300Cmp(b *testing.B) {
	x := e_nocarry_0300{
		15173544231609940117,
		13874567929557736227,
		9897308358278830343,
	...
	benchRese_nocarry_0300 = x
	benchRese_nocarry_0300[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0300.Cmp(&x)
	}
}

func TestE_nocarry_0300Cmp(t *testing.T) {
	var x, y e_nocarry_0300
...
func TestE_nocarry_0300IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0300
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0300

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0300{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0300
	one.SetOne()
	e.Sub(&qe_nocarry_0300, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0300{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0300{0, uint64(i)})
	}
...
func TestE_nocarry_0300NegZero(t *testing.T) {
	var a, b e_nocarry_0300
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0300Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0300, len(staticTestValues))
...
func TestE_nocarry_0300Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0300) bool {
			var b e_nocarry_0300
...
func TestE_nocarry_0300InverseExp(t *testing.T) {
...
func TestE_nocarry_0300MulByConstants(t *testing.T) {
...
func TestE_nocarry_0300Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0300) bool {
...
func TestE_nocarry_0300LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0300Halve(t *testing.T) {
...
func TestE_nocarry_0300FromMont(t *testing.T) {
...
type testPaire_nocarry_0300 struct {
	element e_nocarry_0300
	bigint  big.Int
}

func (z *e_nocarry_0300) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0300[4] {
		return true
	}
	if z[4] < qe_nocarry_0300[4] {
		return false
	...
	return z[0] >= qe_nocarry_0300[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0300

		g.element = e_nocarry_0300{
		...
		if qe_nocarry_0300[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0300[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0300 {
			var g e_nocarry_0300
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0300[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0300[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0300[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0300[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0300[4], carry)
...
func Benchmarke_nocarry_0300InverseNew(b *testing.B) {
	var x e_nocarry_0300
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0300
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0300
		var xInv e_nocarry_0300
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0300
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0300
...
func testLinearComb(t *testing.T, x *e_nocarry_0300, xC int64, y *e_nocarry_0300, yC int64) {
	...
	var z e_nocarry_0300
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0300, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0300
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0300, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0300
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0300, xHi uint64) {
	var res e_nocarry_0300
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0300) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0300) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0300, c int64, result *e_nocarry_0300, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0300) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0300) uint64 {
