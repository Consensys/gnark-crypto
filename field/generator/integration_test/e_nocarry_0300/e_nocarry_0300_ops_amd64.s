...
// modulus q
DATA q<>+0(SB)/8, $0xa59fdab1e600b2ad
DATA q<>+8(SB)/8, $0x8ca5b2d7e16002cc
DATA q<>+16(SB)/8, $0xbbd58fe26909430b
DATA q<>+24(SB)/8, $0x254c51d3987fbd79
DATA q<>+32(SB)/8, $0x00000db6d78ba3e6
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0b21753ea00e7edb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xa59fdab1e600b2ad, R9
	MOVQ    $0x8ca5b2d7e16002cc, R10
	MOVQ    $0xbbd58fe26909430b, R11
	MOVQ    $0x254c51d3987fbd79, R12
	MOVQ    $0x00000db6d78ba3e6, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x8ca5b2d7e16002cc, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xbbd58fe26909430b, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x254c51d3987fbd79, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00000db6d78ba3e6, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xa59fdab1e600b2ad, CX
	MOVQ    $0x8ca5b2d7e16002cc, BX
	MOVQ    $0xbbd58fe26909430b, SI
	MOVQ    $0x254c51d3987fbd79, DI
	MOVQ    $0x00000db6d78ba3e6, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
