...
var benchRese_nocarry_0159 e_nocarry_0159

func BenchmarkE_nocarry_0159SetBytes(b *testing.B) {
	var x e_nocarry_0159
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0159MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0159.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0159)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0159)
		}
	})
}

func BenchmarkE_nocarry_0159Inverse(b *testing.B) {
	var x e_nocarry_0159
	x.SetRandom()
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0159Butterfly(b *testing.B) {
	var x e_nocarry_0159
	x.SetRandom()
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0159)
	}
}

func BenchmarkE_nocarry_0159Exp(b *testing.B) {
	var x e_nocarry_0159
	x.SetRandom()
	benchRese_nocarry_0159.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0159Double(b *testing.B) {
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Double(&benchRese_nocarry_0159)
	}
}

func BenchmarkE_nocarry_0159Add(b *testing.B) {
	var x e_nocarry_0159
	x.SetRandom()
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Add(&x, &benchRese_nocarry_0159)
	}
}

func BenchmarkE_nocarry_0159Sub(b *testing.B) {
	var x e_nocarry_0159
	x.SetRandom()
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Sub(&x, &benchRese_nocarry_0159)
	}
}

func BenchmarkE_nocarry_0159Neg(b *testing.B) {
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Neg(&benchRese_nocarry_0159)
	}
}

func BenchmarkE_nocarry_0159Div(b *testing.B) {
	var x e_nocarry_0159
	x.SetRandom()
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Div(&x, &benchRese_nocarry_0159)
	}
}

func BenchmarkE_nocarry_0159FromMont(b *testing.B) {
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.FromMont()
	}
}

func BenchmarkE_nocarry_0159ToMont(b *testing.B) {
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.ToMont()
	}
}
func BenchmarkE_nocarry_0159Square(b *testing.B) {
	benchRese_nocarry_0159.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Square(&benchRese_nocarry_0159)
	}
}

func BenchmarkE_nocarry_0159Sqrt(b *testing.B) {
	var a e_nocarry_0159
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0159Mul(b *testing.B) {
	x := e_nocarry_0159{
		14878335850728594567,
		11468984792772964452,
		1128827741,
	}
	benchRese_nocarry_0159.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Mul(&benchRese_nocarry_0159, &x)
	}
}

func BenchmarkE_nocarry_0159Cmp(b *testing.B) {
	x := e_nocarry_0159{
		14878335850728594567,
		11468984792772964452,
		1128827741,
	}
	benchRese_nocarry_0159 = x
	benchRese_nocarry_0159[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0159.Cmp(&x)
	}
}

func TestE_nocarry_0159Cmp(t *testing.T) {
	var x, y e_nocarry_0159
...
func TestE_nocarry_0159IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0159
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0159

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0159{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0159
	one.SetOne()
	e.Sub(&qe_nocarry_0159, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0159{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0159{0, uint64(i)})
	}
...
func TestE_nocarry_0159NegZero(t *testing.T) {
	var a, b e_nocarry_0159
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0159Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0159, len(staticTestValues))
...
func TestE_nocarry_0159Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0159) bool {
			var b e_nocarry_0159
...
func TestE_nocarry_0159InverseExp(t *testing.T) {
...
func TestE_nocarry_0159MulByConstants(t *testing.T) {
...
func TestE_nocarry_0159Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0159) bool {
...
func TestE_nocarry_0159LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0159Halve(t *testing.T) {
...
func TestE_nocarry_0159FromMont(t *testing.T) {
...
type testPaire_nocarry_0159 struct {
	element e_nocarry_0159
	bigint  big.Int
}

func (z *e_nocarry_0159) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0159[2] {
		return true
	}
	if z[2] < qe_nocarry_0159[2] {
		return false
	...
	return z[0] >= qe_nocarry_0159[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0159

		g.element = e_nocarry_0159{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0159[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0159[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0159 {
			var g e_nocarry_0159
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0159[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0159[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0159[2], carry)
...
func Benchmarke_nocarry_0159InverseNew(b *testing.B) {
	var x e_nocarry_0159
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0159
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0159
		var xInv e_nocarry_0159
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0159
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0159
...
func testLinearComb(t *testing.T, x *e_nocarry_0159, xC int64, y *e_nocarry_0159, yC int64) {
	...
	var z e_nocarry_0159
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0159, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0159
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0159, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0159
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0159, xHi uint64) {
	var res e_nocarry_0159
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0159) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0159) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0159, c int64, result *e_nocarry_0159, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0159) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0159) uint64 {
