...
var benchRese_nocarry_0401 e_nocarry_0401

func BenchmarkE_nocarry_0401SetBytes(b *testing.B) {
	var x e_nocarry_0401
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0401MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0401.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0401)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0401)
		}
	})
}

func BenchmarkE_nocarry_0401Inverse(b *testing.B) {
	var x e_nocarry_0401
	x.SetRandom()
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0401Butterfly(b *testing.B) {
	var x e_nocarry_0401
	x.SetRandom()
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0401)
	}
}

func BenchmarkE_nocarry_0401Exp(b *testing.B) {
	var x e_nocarry_0401
	x.SetRandom()
	benchRese_nocarry_0401.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0401Double(b *testing.B) {
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Double(&benchRese_nocarry_0401)
	}
}

func BenchmarkE_nocarry_0401Add(b *testing.B) {
	var x e_nocarry_0401
	x.SetRandom()
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Add(&x, &benchRese_nocarry_0401)
	}
}

func BenchmarkE_nocarry_0401Sub(b *testing.B) {
	var x e_nocarry_0401
	x.SetRandom()
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Sub(&x, &benchRese_nocarry_0401)
	}
}

func BenchmarkE_nocarry_0401Neg(b *testing.B) {
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Neg(&benchRese_nocarry_0401)
	}
}

func BenchmarkE_nocarry_0401Div(b *testing.B) {
	var x e_nocarry_0401
	x.SetRandom()
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Div(&x, &benchRese_nocarry_0401)
	}
}

func BenchmarkE_nocarry_0401FromMont(b *testing.B) {
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.FromMont()
	}
}

func BenchmarkE_nocarry_0401ToMont(b *testing.B) {
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.ToMont()
	}
}
func BenchmarkE_nocarry_0401Square(b *testing.B) {
	benchRese_nocarry_0401.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Square(&benchRese_nocarry_0401)
	}
}

func BenchmarkE_nocarry_0401Sqrt(b *testing.B) {
	var a e_nocarry_0401
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0401Mul(b *testing.B) {
	x := e_nocarry_0401{
		7688470083109233178,
		3575542021717979798,
		9246626041310543105,
	...
	benchRese_nocarry_0401.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Mul(&benchRese_nocarry_0401, &x)
	}
}

func BenchmarkE_nocarry_0401Cmp(b *testing.B) {
	x := e_nocarry_0401{
		7688470083109233178,
		3575542021717979798,
		9246626041310543105,
	...
	benchRese_nocarry_0401 = x
	benchRese_nocarry_0401[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0401.Cmp(&x)
	}
}

func TestE_nocarry_0401Cmp(t *testing.T) {
	var x, y e_nocarry_0401
...
func TestE_nocarry_0401IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0401
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0401

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0401{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0401
	one.SetOne()
	e.Sub(&qe_nocarry_0401, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0401{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0401{0, uint64(i)})
	}
...
func TestE_nocarry_0401NegZero(t *testing.T) {
	var a, b e_nocarry_0401
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0401Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0401, len(staticTestValues))
...
func TestE_nocarry_0401Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0401) bool {
			var b e_nocarry_0401
...
func TestE_nocarry_0401InverseExp(t *testing.T) {
...
func TestE_nocarry_0401MulByConstants(t *testing.T) {
...
func TestE_nocarry_0401Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0401) bool {
...
func TestE_nocarry_0401LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0401Halve(t *testing.T) {
...
func TestE_nocarry_0401FromMont(t *testing.T) {
...
type testPaire_nocarry_0401 struct {
	element e_nocarry_0401
	bigint  big.Int
}

func (z *e_nocarry_0401) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0401[6] {
		return true
	}
	if z[6] < qe_nocarry_0401[6] {
		return false
	...
	return z[0] >= qe_nocarry_0401[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0401

		g.element = e_nocarry_0401{
		...
		if qe_nocarry_0401[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0401[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0401 {
			var g e_nocarry_0401
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0401[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0401[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0401[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0401[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0401[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0401[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0401[6], carry)
...
func Benchmarke_nocarry_0401InverseNew(b *testing.B) {
	var x e_nocarry_0401
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0401
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0401
		var xInv e_nocarry_0401
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0401
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0401
...
func testLinearComb(t *testing.T, x *e_nocarry_0401, xC int64, y *e_nocarry_0401, yC int64) {
	...
	var z e_nocarry_0401
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0401, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0401
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0401, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0401
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0401, xHi uint64) {
	var res e_nocarry_0401
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0401) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0401) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0401, c int64, result *e_nocarry_0401, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0401) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0401) uint64 {
