...
var benchRese_nocarry_0206 e_nocarry_0206

func BenchmarkE_nocarry_0206SetBytes(b *testing.B) {
	var x e_nocarry_0206
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0206MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0206.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0206)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0206)
		}
	})
}

func BenchmarkE_nocarry_0206Inverse(b *testing.B) {
	var x e_nocarry_0206
	x.SetRandom()
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0206Butterfly(b *testing.B) {
	var x e_nocarry_0206
	x.SetRandom()
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0206)
	}
}

func BenchmarkE_nocarry_0206Exp(b *testing.B) {
	var x e_nocarry_0206
	x.SetRandom()
	benchRese_nocarry_0206.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0206Double(b *testing.B) {
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Double(&benchRese_nocarry_0206)
	}
}

func BenchmarkE_nocarry_0206Add(b *testing.B) {
	var x e_nocarry_0206
	x.SetRandom()
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Add(&x, &benchRese_nocarry_0206)
	}
}

func BenchmarkE_nocarry_0206Sub(b *testing.B) {
	var x e_nocarry_0206
	x.SetRandom()
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Sub(&x, &benchRese_nocarry_0206)
	}
}

func BenchmarkE_nocarry_0206Neg(b *testing.B) {
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Neg(&benchRese_nocarry_0206)
	}
}

func BenchmarkE_nocarry_0206Div(b *testing.B) {
	var x e_nocarry_0206
	x.SetRandom()
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Div(&x, &benchRese_nocarry_0206)
	}
}

func BenchmarkE_nocarry_0206FromMont(b *testing.B) {
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.FromMont()
	}
}

func BenchmarkE_nocarry_0206ToMont(b *testing.B) {
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.ToMont()
	}
}
func BenchmarkE_nocarry_0206Square(b *testing.B) {
	benchRese_nocarry_0206.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Square(&benchRese_nocarry_0206)
	}
}

func BenchmarkE_nocarry_0206Sqrt(b *testing.B) {
	var a e_nocarry_0206
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0206Mul(b *testing.B) {
	x := e_nocarry_0206{
	...
	benchRese_nocarry_0206.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Mul(&benchRese_nocarry_0206, &x)
	}
}

func BenchmarkE_nocarry_0206Cmp(b *testing.B) {
	x := e_nocarry_0206{
		14000754515316133208,
		11729515523783998536,
		7720093495984451147,
	...
	benchRese_nocarry_0206 = x
	benchRese_nocarry_0206[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0206.Cmp(&x)
	}
}

func TestE_nocarry_0206Cmp(t *testing.T) {
	var x, y e_nocarry_0206
...
func TestE_nocarry_0206IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0206
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0206

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0206{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0206
	one.SetOne()
	e.Sub(&qe_nocarry_0206, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0206{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0206{0, uint64(i)})
	}
...
func TestE_nocarry_0206NegZero(t *testing.T) {
	var a, b e_nocarry_0206
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0206Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0206, len(staticTestValues))
...
func TestE_nocarry_0206Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0206) bool {
			var b e_nocarry_0206
...
func TestE_nocarry_0206InverseExp(t *testing.T) {
...
func TestE_nocarry_0206MulByConstants(t *testing.T) {
...
func TestE_nocarry_0206Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0206) bool {
...
func TestE_nocarry_0206LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0206Halve(t *testing.T) {
...
func TestE_nocarry_0206FromMont(t *testing.T) {
...
type testPaire_nocarry_0206 struct {
	element e_nocarry_0206
	bigint  big.Int
}

func (z *e_nocarry_0206) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0206[3] {
		return true
	}
	if z[3] < qe_nocarry_0206[3] {
		return false
	...
	return z[0] >= qe_nocarry_0206[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0206

		g.element = e_nocarry_0206{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0206[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0206[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0206 {
			var g e_nocarry_0206
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0206[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0206[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0206[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0206[3], carry)
...
func Benchmarke_nocarry_0206InverseNew(b *testing.B) {
	var x e_nocarry_0206
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0206
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0206
		var xInv e_nocarry_0206
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0206
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0206
...
func testLinearComb(t *testing.T, x *e_nocarry_0206, xC int64, y *e_nocarry_0206, yC int64) {
	...
	var z e_nocarry_0206
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0206, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0206
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0206, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0206
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0206, xHi uint64) {
	var res e_nocarry_0206
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0206) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0206) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0206, c int64, result *e_nocarry_0206, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0206) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0206) uint64 {
