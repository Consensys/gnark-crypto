...
// modulus q
DATA q<>+0(SB)/8, $0x55202201888381d7
DATA q<>+8(SB)/8, $0xa2beca0eed1bea52
DATA q<>+16(SB)/8, $0x89de9762a89c59a3
DATA q<>+24(SB)/8, $0x0000000000003f5a
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x2c0fdb88f1b3fe19
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x55202201888381d7, R8
	MOVQ    $0xa2beca0eed1bea52, R9
	MOVQ    $0x89de9762a89c59a3, R10
	MOVQ    $0x0000000000003f5a, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xa2beca0eed1bea52, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x89de9762a89c59a3, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000000000003f5a, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x55202201888381d7, R12
	MOVQ    $0xa2beca0eed1bea52, R13
	MOVQ    $0x89de9762a89c59a3, R14
	MOVQ    $0x0000000000003f5a, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
