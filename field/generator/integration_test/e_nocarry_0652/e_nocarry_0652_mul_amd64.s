...
// modulus q
DATA q<>+0(SB)/8, $0x1707913854149ea5
DATA q<>+8(SB)/8, $0x896ca80354f0aab9
DATA q<>+16(SB)/8, $0x7963b7833b2b3dc6
DATA q<>+24(SB)/8, $0xbb2837a0d17cfb8d
DATA q<>+32(SB)/8, $0xd372331357929797
DATA q<>+40(SB)/8, $0x7eb7d4227a9b5269
DATA q<>+48(SB)/8, $0x29acd7f05a7a1dad
DATA q<>+56(SB)/8, $0xbfc330816687b60f
DATA q<>+64(SB)/8, $0xd37097be45e16c5b
DATA q<>+72(SB)/8, $0x3a50b23ac7aae5d2
DATA q<>+80(SB)/8, $0x0000000000000e0b
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x8f9389b1a245e6d3
