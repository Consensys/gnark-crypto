...
var benchRese_nocarry_0652 e_nocarry_0652

func BenchmarkE_nocarry_0652SetBytes(b *testing.B) {
	var x e_nocarry_0652
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0652MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0652.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0652)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0652)
		}
	})
}

func BenchmarkE_nocarry_0652Inverse(b *testing.B) {
	var x e_nocarry_0652
	x.SetRandom()
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0652Butterfly(b *testing.B) {
	var x e_nocarry_0652
	x.SetRandom()
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0652)
	}
}

func BenchmarkE_nocarry_0652Exp(b *testing.B) {
	var x e_nocarry_0652
	x.SetRandom()
	benchRese_nocarry_0652.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0652Double(b *testing.B) {
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Double(&benchRese_nocarry_0652)
	}
}

func BenchmarkE_nocarry_0652Add(b *testing.B) {
	var x e_nocarry_0652
	x.SetRandom()
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Add(&x, &benchRese_nocarry_0652)
	}
}

func BenchmarkE_nocarry_0652Sub(b *testing.B) {
	var x e_nocarry_0652
	x.SetRandom()
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Sub(&x, &benchRese_nocarry_0652)
	}
}

func BenchmarkE_nocarry_0652Neg(b *testing.B) {
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Neg(&benchRese_nocarry_0652)
	}
}

func BenchmarkE_nocarry_0652Div(b *testing.B) {
	var x e_nocarry_0652
	x.SetRandom()
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Div(&x, &benchRese_nocarry_0652)
	}
}

func BenchmarkE_nocarry_0652FromMont(b *testing.B) {
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.FromMont()
	}
}

func BenchmarkE_nocarry_0652ToMont(b *testing.B) {
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.ToMont()
	}
}
func BenchmarkE_nocarry_0652Square(b *testing.B) {
	benchRese_nocarry_0652.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Square(&benchRese_nocarry_0652)
	}
}

func BenchmarkE_nocarry_0652Sqrt(b *testing.B) {
	var a e_nocarry_0652
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0652Mul(b *testing.B) {
	x := e_nocarry_0652{
	...
	benchRese_nocarry_0652.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Mul(&benchRese_nocarry_0652, &x)
	}
}

func BenchmarkE_nocarry_0652Cmp(b *testing.B) {
	x := e_nocarry_0652{
		16452900704346805601,
		5835015848053125253,
		14641485515451205376,
	...
	benchRese_nocarry_0652 = x
	benchRese_nocarry_0652[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0652.Cmp(&x)
	}
}

func TestE_nocarry_0652Cmp(t *testing.T) {
	var x, y e_nocarry_0652
...
func TestE_nocarry_0652IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0652
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0652

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0652{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0652
	one.SetOne()
	e.Sub(&qe_nocarry_0652, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0652{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0652{0, uint64(i)})
	}
...
func TestE_nocarry_0652NegZero(t *testing.T) {
	var a, b e_nocarry_0652
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0652Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0652, len(staticTestValues))
...
func TestE_nocarry_0652Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0652) bool {
			var b e_nocarry_0652
...
func TestE_nocarry_0652InverseExp(t *testing.T) {
...
func TestE_nocarry_0652MulByConstants(t *testing.T) {
...
func TestE_nocarry_0652Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0652) bool {
...
func TestE_nocarry_0652LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0652Halve(t *testing.T) {
...
func TestE_nocarry_0652FromMont(t *testing.T) {
...
type testPaire_nocarry_0652 struct {
	element e_nocarry_0652
	bigint  big.Int
}

func (z *e_nocarry_0652) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0652[10] {
		return true
	}
	if z[10] < qe_nocarry_0652[10] {
		return false
	...
	return z[0] >= qe_nocarry_0652[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0652

		g.element = e_nocarry_0652{
		...
		if qe_nocarry_0652[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0652[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0652 {
			var g e_nocarry_0652
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0652[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0652[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0652[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0652[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0652[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0652[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0652[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0652[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0652[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0652[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0652[10], carry)
...
func Benchmarke_nocarry_0652InverseNew(b *testing.B) {
	var x e_nocarry_0652
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0652
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0652
		var xInv e_nocarry_0652
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0652
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0652
...
func testLinearComb(t *testing.T, x *e_nocarry_0652, xC int64, y *e_nocarry_0652, yC int64) {
	...
	var z e_nocarry_0652
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0652, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0652
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0652, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0652
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0652, xHi uint64) {
	var res e_nocarry_0652
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0652) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0652) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0652, c int64, result *e_nocarry_0652, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0652) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0652) uint64 {
