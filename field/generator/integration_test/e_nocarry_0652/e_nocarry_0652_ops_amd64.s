...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x1707913854149ea5, R14
	ADDQ R14, AX
	MOVQ $0x896ca80354f0aab9, R14
	ADCQ R14, DX
	MOVQ $0x7963b7833b2b3dc6, R14
	ADCQ R14, CX
	MOVQ $0xbb2837a0d17cfb8d, R14
	ADCQ R14, BX
	MOVQ $0xd372331357929797, R14
	ADCQ R14, SI
	MOVQ $0x7eb7d4227a9b5269, R14
	ADCQ R14, DI
	MOVQ $0x29acd7f05a7a1dad, R14
	ADCQ R14, R8
	MOVQ $0xbfc330816687b60f, R14
	ADCQ R14, R9
	MOVQ $0xd37097be45e16c5b, R14
	ADCQ R14, R10
	MOVQ $0x3a50b23ac7aae5d2, R14
	ADCQ R14, R11
	MOVQ $0x0000000000000e0b, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x1707913854149ea5, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x896ca80354f0aab9, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x7963b7833b2b3dc6, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xbb2837a0d17cfb8d, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xd372331357929797, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x7eb7d4227a9b5269, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x29acd7f05a7a1dad, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xbfc330816687b60f, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xd37097be45e16c5b, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x3a50b23ac7aae5d2, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000000000e0b, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x1707913854149ea5, AX
	ADDQ AX, DX
	MOVQ $0x896ca80354f0aab9, AX
	ADCQ AX, CX
	MOVQ $0x7963b7833b2b3dc6, AX
	ADCQ AX, BX
	MOVQ $0xbb2837a0d17cfb8d, AX
	ADCQ AX, SI
	MOVQ $0xd372331357929797, AX
	ADCQ AX, DI
	MOVQ $0x7eb7d4227a9b5269, AX
	ADCQ AX, R8
	MOVQ $0x29acd7f05a7a1dad, AX
	ADCQ AX, R9
	MOVQ $0xbfc330816687b60f, AX
	ADCQ AX, R10
	MOVQ $0xd37097be45e16c5b, AX
	ADCQ AX, R11
	MOVQ $0x3a50b23ac7aae5d2, AX
	ADCQ AX, R12
	MOVQ $0x0000000000000e0b, AX
	ADCQ AX, R13
