...
var benchRese_nocarry_0282 e_nocarry_0282

func BenchmarkE_nocarry_0282SetBytes(b *testing.B) {
	var x e_nocarry_0282
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0282MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0282.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0282)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0282)
		}
	})
}

func BenchmarkE_nocarry_0282Inverse(b *testing.B) {
	var x e_nocarry_0282
	x.SetRandom()
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0282Butterfly(b *testing.B) {
	var x e_nocarry_0282
	x.SetRandom()
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0282)
	}
}

func BenchmarkE_nocarry_0282Exp(b *testing.B) {
	var x e_nocarry_0282
	x.SetRandom()
	benchRese_nocarry_0282.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0282Double(b *testing.B) {
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Double(&benchRese_nocarry_0282)
	}
}

func BenchmarkE_nocarry_0282Add(b *testing.B) {
	var x e_nocarry_0282
	x.SetRandom()
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Add(&x, &benchRese_nocarry_0282)
	}
}

func BenchmarkE_nocarry_0282Sub(b *testing.B) {
	var x e_nocarry_0282
	x.SetRandom()
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Sub(&x, &benchRese_nocarry_0282)
	}
}

func BenchmarkE_nocarry_0282Neg(b *testing.B) {
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Neg(&benchRese_nocarry_0282)
	}
}

func BenchmarkE_nocarry_0282Div(b *testing.B) {
	var x e_nocarry_0282
	x.SetRandom()
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Div(&x, &benchRese_nocarry_0282)
	}
}

func BenchmarkE_nocarry_0282FromMont(b *testing.B) {
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.FromMont()
	}
}

func BenchmarkE_nocarry_0282ToMont(b *testing.B) {
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.ToMont()
	}
}
func BenchmarkE_nocarry_0282Square(b *testing.B) {
	benchRese_nocarry_0282.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Square(&benchRese_nocarry_0282)
	}
}

func BenchmarkE_nocarry_0282Sqrt(b *testing.B) {
	var a e_nocarry_0282
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0282Mul(b *testing.B) {
	x := e_nocarry_0282{
	...
	benchRese_nocarry_0282.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Mul(&benchRese_nocarry_0282, &x)
	}
}

func BenchmarkE_nocarry_0282Cmp(b *testing.B) {
	x := e_nocarry_0282{
		13363947189567550944,
		1711531687408278680,
		8196343485852703101,
	...
	benchRese_nocarry_0282 = x
	benchRese_nocarry_0282[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0282.Cmp(&x)
	}
}

func TestE_nocarry_0282Cmp(t *testing.T) {
	var x, y e_nocarry_0282
...
func TestE_nocarry_0282IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0282
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0282

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0282{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0282
	one.SetOne()
	e.Sub(&qe_nocarry_0282, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0282{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0282{0, uint64(i)})
	}
...
func TestE_nocarry_0282NegZero(t *testing.T) {
	var a, b e_nocarry_0282
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0282Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0282, len(staticTestValues))
...
func TestE_nocarry_0282Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0282) bool {
			var b e_nocarry_0282
...
func TestE_nocarry_0282InverseExp(t *testing.T) {
...
func TestE_nocarry_0282MulByConstants(t *testing.T) {
...
func TestE_nocarry_0282Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0282) bool {
...
func TestE_nocarry_0282LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0282Halve(t *testing.T) {
...
func TestE_nocarry_0282FromMont(t *testing.T) {
...
type testPaire_nocarry_0282 struct {
	element e_nocarry_0282
	bigint  big.Int
}

func (z *e_nocarry_0282) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0282[4] {
		return true
	}
	if z[4] < qe_nocarry_0282[4] {
		return false
	...
	return z[0] >= qe_nocarry_0282[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0282

		g.element = e_nocarry_0282{
		...
		if qe_nocarry_0282[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0282[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0282 {
			var g e_nocarry_0282
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0282[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0282[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0282[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0282[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0282[4], carry)
...
func Benchmarke_nocarry_0282InverseNew(b *testing.B) {
	var x e_nocarry_0282
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0282
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0282
		var xInv e_nocarry_0282
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0282
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0282
...
func testLinearComb(t *testing.T, x *e_nocarry_0282, xC int64, y *e_nocarry_0282, yC int64) {
	...
	var z e_nocarry_0282
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0282, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0282
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0282, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0282
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0282, xHi uint64) {
	var res e_nocarry_0282
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0282) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0282) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0282, c int64, result *e_nocarry_0282, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0282) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0282) uint64 {
