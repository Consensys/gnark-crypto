...
// modulus q
DATA q<>+0(SB)/8, $0x3a0b238633efd435
DATA q<>+8(SB)/8, $0x22d5d992a83f53d0
DATA q<>+16(SB)/8, $0xf506dd8f8d9f7b36
DATA q<>+24(SB)/8, $0x0827182c5dbe3ae2
DATA q<>+32(SB)/8, $0x0000000003279c04
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xf2add0f76f8c21e3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x3a0b238633efd435, R9
	MOVQ    $0x22d5d992a83f53d0, R10
	MOVQ    $0xf506dd8f8d9f7b36, R11
	MOVQ    $0x0827182c5dbe3ae2, R12
	MOVQ    $0x0000000003279c04, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x22d5d992a83f53d0, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xf506dd8f8d9f7b36, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x0827182c5dbe3ae2, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000003279c04, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x3a0b238633efd435, CX
	MOVQ    $0x22d5d992a83f53d0, BX
	MOVQ    $0xf506dd8f8d9f7b36, SI
	MOVQ    $0x0827182c5dbe3ae2, DI
	MOVQ    $0x0000000003279c04, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
