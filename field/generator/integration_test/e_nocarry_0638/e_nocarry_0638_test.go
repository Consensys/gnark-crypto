...
var benchRese_nocarry_0638 e_nocarry_0638

func BenchmarkE_nocarry_0638SetBytes(b *testing.B) {
	var x e_nocarry_0638
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0638MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0638.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0638)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0638)
		}
	})
}

func BenchmarkE_nocarry_0638Inverse(b *testing.B) {
	var x e_nocarry_0638
	x.SetRandom()
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0638Butterfly(b *testing.B) {
	var x e_nocarry_0638
	x.SetRandom()
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0638)
	}
}

func BenchmarkE_nocarry_0638Exp(b *testing.B) {
	var x e_nocarry_0638
	x.SetRandom()
	benchRese_nocarry_0638.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0638Double(b *testing.B) {
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Double(&benchRese_nocarry_0638)
	}
}

func BenchmarkE_nocarry_0638Add(b *testing.B) {
	var x e_nocarry_0638
	x.SetRandom()
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Add(&x, &benchRese_nocarry_0638)
	}
}

func BenchmarkE_nocarry_0638Sub(b *testing.B) {
	var x e_nocarry_0638
	x.SetRandom()
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Sub(&x, &benchRese_nocarry_0638)
	}
}

func BenchmarkE_nocarry_0638Neg(b *testing.B) {
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Neg(&benchRese_nocarry_0638)
	}
}

func BenchmarkE_nocarry_0638Div(b *testing.B) {
	var x e_nocarry_0638
	x.SetRandom()
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Div(&x, &benchRese_nocarry_0638)
	}
}

func BenchmarkE_nocarry_0638FromMont(b *testing.B) {
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.FromMont()
	}
}

func BenchmarkE_nocarry_0638ToMont(b *testing.B) {
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.ToMont()
	}
}
func BenchmarkE_nocarry_0638Square(b *testing.B) {
	benchRese_nocarry_0638.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Square(&benchRese_nocarry_0638)
	}
}

func BenchmarkE_nocarry_0638Sqrt(b *testing.B) {
	var a e_nocarry_0638
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0638Mul(b *testing.B) {
	x := e_nocarry_0638{
	...
	benchRese_nocarry_0638.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Mul(&benchRese_nocarry_0638, &x)
	}
}

func BenchmarkE_nocarry_0638Cmp(b *testing.B) {
	x := e_nocarry_0638{
		16712270971485385991,
		3670005619610777006,
		14029776035256393594,
	...
	benchRese_nocarry_0638 = x
	benchRese_nocarry_0638[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0638.Cmp(&x)
	}
}

func TestE_nocarry_0638Cmp(t *testing.T) {
	var x, y e_nocarry_0638
...
func TestE_nocarry_0638IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0638
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0638

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0638{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0638
	one.SetOne()
	e.Sub(&qe_nocarry_0638, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0638{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0638{0, uint64(i)})
	}
...
func TestE_nocarry_0638NegZero(t *testing.T) {
	var a, b e_nocarry_0638
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0638Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0638, len(staticTestValues))
...
func TestE_nocarry_0638Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0638) bool {
			var b e_nocarry_0638
...
func TestE_nocarry_0638InverseExp(t *testing.T) {
...
func TestE_nocarry_0638MulByConstants(t *testing.T) {
...
func TestE_nocarry_0638Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0638) bool {
...
func TestE_nocarry_0638LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0638Halve(t *testing.T) {
...
func TestE_nocarry_0638FromMont(t *testing.T) {
...
type testPaire_nocarry_0638 struct {
	element e_nocarry_0638
	bigint  big.Int
}

func (z *e_nocarry_0638) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0638[9] {
		return true
	}
	if z[9] < qe_nocarry_0638[9] {
		return false
	...
	return z[0] >= qe_nocarry_0638[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0638

		g.element = e_nocarry_0638{
		...
		if qe_nocarry_0638[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0638[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0638 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0638[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0638[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0638[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0638[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0638[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0638[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0638[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0638[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0638[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0638[9], carry)
...
func Benchmarke_nocarry_0638InverseNew(b *testing.B) {
	var x e_nocarry_0638
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0638
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0638
		var xInv e_nocarry_0638
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0638
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0638
...
func testLinearComb(t *testing.T, x *e_nocarry_0638, xC int64, y *e_nocarry_0638, yC int64) {
	...
	var z e_nocarry_0638
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0638, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0638
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0638, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0638
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0638, xHi uint64) {
	var res e_nocarry_0638
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0638) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0638) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0638, c int64, result *e_nocarry_0638, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0638) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0638) uint64 {
