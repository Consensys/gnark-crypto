...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xd52e8d79f31bbe11, R13
	ADDQ R13, AX
	MOVQ $0x8fd7d63b53e7ba59, R13
	ADCQ R13, DX
	MOVQ $0x92090a6175a6c353, R13
	ADCQ R13, CX
	MOVQ $0x1b23da697e691910, R13
	ADCQ R13, BX
	MOVQ $0xf7e14a5321b12ab5, R13
	ADCQ R13, SI
	MOVQ $0xae6cd2ecf35c6113, R13
	ADCQ R13, DI
	MOVQ $0x363b2701944a2dc1, R13
	ADCQ R13, R8
	MOVQ $0x768cfbaf1baf3274, R13
	ADCQ R13, R9
	MOVQ $0x82b2757b959210dc, R13
	ADCQ R13, R10
	MOVQ $0x3823ef6246c0cc55, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xd52e8d79f31bbe11, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x8fd7d63b53e7ba59, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x92090a6175a6c353, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x1b23da697e691910, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xf7e14a5321b12ab5, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xae6cd2ecf35c6113, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x363b2701944a2dc1, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x768cfbaf1baf3274, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x82b2757b959210dc, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x3823ef6246c0cc55, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xd52e8d79f31bbe11, AX
	ADDQ AX, DX
	MOVQ $0x8fd7d63b53e7ba59, AX
	ADCQ AX, CX
	MOVQ $0x92090a6175a6c353, AX
	ADCQ AX, BX
	MOVQ $0x1b23da697e691910, AX
	ADCQ AX, SI
	MOVQ $0xf7e14a5321b12ab5, AX
	ADCQ AX, DI
	MOVQ $0xae6cd2ecf35c6113, AX
	ADCQ AX, R8
	MOVQ $0x363b2701944a2dc1, AX
	ADCQ AX, R9
	MOVQ $0x768cfbaf1baf3274, AX
	ADCQ AX, R10
	MOVQ $0x82b2757b959210dc, AX
	ADCQ AX, R11
	MOVQ $0x3823ef6246c0cc55, AX
	ADCQ AX, R12
