...
var benchRese_nocarry_0541 e_nocarry_0541

func BenchmarkE_nocarry_0541SetBytes(b *testing.B) {
	var x e_nocarry_0541
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0541MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0541.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0541)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0541)
		}
	})
}

func BenchmarkE_nocarry_0541Inverse(b *testing.B) {
	var x e_nocarry_0541
	x.SetRandom()
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0541Butterfly(b *testing.B) {
	var x e_nocarry_0541
	x.SetRandom()
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0541)
	}
}

func BenchmarkE_nocarry_0541Exp(b *testing.B) {
	var x e_nocarry_0541
	x.SetRandom()
	benchRese_nocarry_0541.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0541Double(b *testing.B) {
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Double(&benchRese_nocarry_0541)
	}
}

func BenchmarkE_nocarry_0541Add(b *testing.B) {
	var x e_nocarry_0541
	x.SetRandom()
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Add(&x, &benchRese_nocarry_0541)
	}
}

func BenchmarkE_nocarry_0541Sub(b *testing.B) {
	var x e_nocarry_0541
	x.SetRandom()
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Sub(&x, &benchRese_nocarry_0541)
	}
}

func BenchmarkE_nocarry_0541Neg(b *testing.B) {
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Neg(&benchRese_nocarry_0541)
	}
}

func BenchmarkE_nocarry_0541Div(b *testing.B) {
	var x e_nocarry_0541
	x.SetRandom()
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Div(&x, &benchRese_nocarry_0541)
	}
}

func BenchmarkE_nocarry_0541FromMont(b *testing.B) {
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.FromMont()
	}
}

func BenchmarkE_nocarry_0541ToMont(b *testing.B) {
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.ToMont()
	}
}
func BenchmarkE_nocarry_0541Square(b *testing.B) {
	benchRese_nocarry_0541.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Square(&benchRese_nocarry_0541)
	}
}

func BenchmarkE_nocarry_0541Sqrt(b *testing.B) {
	var a e_nocarry_0541
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0541Mul(b *testing.B) {
	x := e_nocarry_0541{
	...
	benchRese_nocarry_0541.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Mul(&benchRese_nocarry_0541, &x)
	}
}

func BenchmarkE_nocarry_0541Cmp(b *testing.B) {
	x := e_nocarry_0541{
		10215351205301777235,
		5474017686618560501,
		3153851917814640472,
	...
	benchRese_nocarry_0541 = x
	benchRese_nocarry_0541[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0541.Cmp(&x)
	}
}

func TestE_nocarry_0541Cmp(t *testing.T) {
	var x, y e_nocarry_0541
...
func TestE_nocarry_0541IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0541
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0541

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0541{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0541
	one.SetOne()
	e.Sub(&qe_nocarry_0541, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0541{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0541{0, uint64(i)})
	}
...
func TestE_nocarry_0541NegZero(t *testing.T) {
	var a, b e_nocarry_0541
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0541Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0541, len(staticTestValues))
...
func TestE_nocarry_0541Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0541) bool {
			var b e_nocarry_0541
...
func TestE_nocarry_0541InverseExp(t *testing.T) {
...
func TestE_nocarry_0541MulByConstants(t *testing.T) {
...
func TestE_nocarry_0541Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0541) bool {
...
func TestE_nocarry_0541LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0541Halve(t *testing.T) {
...
func TestE_nocarry_0541FromMont(t *testing.T) {
...
type testPaire_nocarry_0541 struct {
	element e_nocarry_0541
	bigint  big.Int
}

func (z *e_nocarry_0541) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0541[8] {
		return true
	}
	if z[8] < qe_nocarry_0541[8] {
		return false
	...
	return z[0] >= qe_nocarry_0541[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0541

		g.element = e_nocarry_0541{
		...
		if qe_nocarry_0541[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0541[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0541 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0541[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0541[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0541[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0541[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0541[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0541[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0541[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0541[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0541[8], carry)
...
func Benchmarke_nocarry_0541InverseNew(b *testing.B) {
	var x e_nocarry_0541
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0541
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0541
		var xInv e_nocarry_0541
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0541
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0541
...
func testLinearComb(t *testing.T, x *e_nocarry_0541, xC int64, y *e_nocarry_0541, yC int64) {
	...
	var z e_nocarry_0541
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0541, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0541
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0541, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0541
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0541, xHi uint64) {
	var res e_nocarry_0541
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0541) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0541) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0541, c int64, result *e_nocarry_0541, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0541) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0541) uint64 {
