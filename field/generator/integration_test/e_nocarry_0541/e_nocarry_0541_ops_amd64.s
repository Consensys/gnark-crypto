...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x074c598e43049241, R12
	ADDQ R12, AX
	MOVQ $0x8a9a80a4a38dbb18, R12
	ADCQ R12, DX
	MOVQ $0x4d2c6f6eb940e1ed, R12
	ADCQ R12, CX
	MOVQ $0xb01f8976d05110e7, R12
	ADCQ R12, BX
	MOVQ $0xce1056fdd7dad8a5, R12
	ADCQ R12, SI
	MOVQ $0x9d6ee53fec3f6370, R12
	ADCQ R12, DI
	MOVQ $0x5bdbca4a0702d67b, R12
	ADCQ R12, R8
	MOVQ $0x6c637ab16743d6fb, R12
	ADCQ R12, R9
	MOVQ $0x000000001aad366b, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x074c598e43049241, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x8a9a80a4a38dbb18, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x4d2c6f6eb940e1ed, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xb01f8976d05110e7, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xce1056fdd7dad8a5, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x9d6ee53fec3f6370, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x5bdbca4a0702d67b, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x6c637ab16743d6fb, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000001aad366b, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x074c598e43049241, AX
	ADDQ AX, DX
	MOVQ $0x8a9a80a4a38dbb18, AX
	ADCQ AX, CX
	MOVQ $0x4d2c6f6eb940e1ed, AX
	ADCQ AX, BX
	MOVQ $0xb01f8976d05110e7, AX
	ADCQ AX, SI
	MOVQ $0xce1056fdd7dad8a5, AX
	ADCQ AX, DI
	MOVQ $0x9d6ee53fec3f6370, AX
	ADCQ AX, R8
	MOVQ $0x5bdbca4a0702d67b, AX
	ADCQ AX, R9
	MOVQ $0x6c637ab16743d6fb, AX
	ADCQ AX, R10
	MOVQ $0x000000001aad366b, AX
	ADCQ AX, R11
