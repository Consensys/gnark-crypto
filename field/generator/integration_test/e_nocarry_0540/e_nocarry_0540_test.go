...
var benchRese_nocarry_0540 e_nocarry_0540

func BenchmarkE_nocarry_0540SetBytes(b *testing.B) {
	var x e_nocarry_0540
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0540MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0540.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0540)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0540)
		}
	})
}

func BenchmarkE_nocarry_0540Inverse(b *testing.B) {
	var x e_nocarry_0540
	x.SetRandom()
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0540Butterfly(b *testing.B) {
	var x e_nocarry_0540
	x.SetRandom()
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0540)
	}
}

func BenchmarkE_nocarry_0540Exp(b *testing.B) {
	var x e_nocarry_0540
	x.SetRandom()
	benchRese_nocarry_0540.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0540Double(b *testing.B) {
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Double(&benchRese_nocarry_0540)
	}
}

func BenchmarkE_nocarry_0540Add(b *testing.B) {
	var x e_nocarry_0540
	x.SetRandom()
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Add(&x, &benchRese_nocarry_0540)
	}
}

func BenchmarkE_nocarry_0540Sub(b *testing.B) {
	var x e_nocarry_0540
	x.SetRandom()
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Sub(&x, &benchRese_nocarry_0540)
	}
}

func BenchmarkE_nocarry_0540Neg(b *testing.B) {
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Neg(&benchRese_nocarry_0540)
	}
}

func BenchmarkE_nocarry_0540Div(b *testing.B) {
	var x e_nocarry_0540
	x.SetRandom()
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Div(&x, &benchRese_nocarry_0540)
	}
}

func BenchmarkE_nocarry_0540FromMont(b *testing.B) {
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.FromMont()
	}
}

func BenchmarkE_nocarry_0540ToMont(b *testing.B) {
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.ToMont()
	}
}
func BenchmarkE_nocarry_0540Square(b *testing.B) {
	benchRese_nocarry_0540.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Square(&benchRese_nocarry_0540)
	}
}

func BenchmarkE_nocarry_0540Sqrt(b *testing.B) {
	var a e_nocarry_0540
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0540Mul(b *testing.B) {
	x := e_nocarry_0540{
	...
	benchRese_nocarry_0540.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Mul(&benchRese_nocarry_0540, &x)
	}
}

func BenchmarkE_nocarry_0540Cmp(b *testing.B) {
	x := e_nocarry_0540{
		15031697494616992670,
		96606711176373205,
		12743443826664775010,
	...
	benchRese_nocarry_0540 = x
	benchRese_nocarry_0540[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0540.Cmp(&x)
	}
}

func TestE_nocarry_0540Cmp(t *testing.T) {
	var x, y e_nocarry_0540
...
func TestE_nocarry_0540IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0540
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0540

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0540{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0540
	one.SetOne()
	e.Sub(&qe_nocarry_0540, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0540{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0540{0, uint64(i)})
	}
...
func TestE_nocarry_0540NegZero(t *testing.T) {
	var a, b e_nocarry_0540
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0540Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0540, len(staticTestValues))
...
func TestE_nocarry_0540Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0540) bool {
			var b e_nocarry_0540
...
func TestE_nocarry_0540InverseExp(t *testing.T) {
...
func TestE_nocarry_0540MulByConstants(t *testing.T) {
...
func TestE_nocarry_0540Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0540) bool {
...
func TestE_nocarry_0540LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0540Halve(t *testing.T) {
...
func TestE_nocarry_0540FromMont(t *testing.T) {
...
type testPaire_nocarry_0540 struct {
	element e_nocarry_0540
	bigint  big.Int
}

func (z *e_nocarry_0540) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0540[8] {
		return true
	}
	if z[8] < qe_nocarry_0540[8] {
		return false
	...
	return z[0] >= qe_nocarry_0540[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0540

		g.element = e_nocarry_0540{
		...
		if qe_nocarry_0540[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0540[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0540 {
			var g e_nocarry_0540
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0540[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0540[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0540[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0540[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0540[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0540[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0540[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0540[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0540[8], carry)
...
func Benchmarke_nocarry_0540InverseNew(b *testing.B) {
	var x e_nocarry_0540
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0540
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0540
		var xInv e_nocarry_0540
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0540
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0540
...
func testLinearComb(t *testing.T, x *e_nocarry_0540, xC int64, y *e_nocarry_0540, yC int64) {
	...
	var z e_nocarry_0540
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0540, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0540
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0540, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0540
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0540, xHi uint64) {
	var res e_nocarry_0540
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0540) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0540) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0540, c int64, result *e_nocarry_0540, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0540) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0540) uint64 {
