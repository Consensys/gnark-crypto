...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x3b0b114d7f3e46e7, R12
	ADDQ R12, AX
	MOVQ $0xc457bae22d9099e2, R12
	ADCQ R12, DX
	MOVQ $0xca7b20c1893c8b32, R12
	ADCQ R12, CX
	MOVQ $0x952ad737f2e753f0, R12
	ADCQ R12, BX
	MOVQ $0xfbb356ef42881bdf, R12
	ADCQ R12, SI
	MOVQ $0x3e0e70e8333c7871, R12
	ADCQ R12, DI
	MOVQ $0x8529aff280e2e208, R12
	ADCQ R12, R8
	MOVQ $0x2441f9e754981c7a, R12
	ADCQ R12, R9
	MOVQ $0x000000000c8f2e85, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x3b0b114d7f3e46e7, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xc457bae22d9099e2, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xca7b20c1893c8b32, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x952ad737f2e753f0, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xfbb356ef42881bdf, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x3e0e70e8333c7871, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x8529aff280e2e208, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x2441f9e754981c7a, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000000c8f2e85, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x3b0b114d7f3e46e7, AX
	ADDQ AX, DX
	MOVQ $0xc457bae22d9099e2, AX
	ADCQ AX, CX
	MOVQ $0xca7b20c1893c8b32, AX
	ADCQ AX, BX
	MOVQ $0x952ad737f2e753f0, AX
	ADCQ AX, SI
	MOVQ $0xfbb356ef42881bdf, AX
	ADCQ AX, DI
	MOVQ $0x3e0e70e8333c7871, AX
	ADCQ AX, R8
	MOVQ $0x8529aff280e2e208, AX
	ADCQ AX, R9
	MOVQ $0x2441f9e754981c7a, AX
	ADCQ AX, R10
	MOVQ $0x000000000c8f2e85, AX
	ADCQ AX, R11
