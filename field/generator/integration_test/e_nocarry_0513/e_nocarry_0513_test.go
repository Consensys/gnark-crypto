...
var benchRese_nocarry_0513 e_nocarry_0513

func BenchmarkE_nocarry_0513SetBytes(b *testing.B) {
	var x e_nocarry_0513
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0513MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0513.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0513)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0513)
		}
	})
}

func BenchmarkE_nocarry_0513Inverse(b *testing.B) {
	var x e_nocarry_0513
	x.SetRandom()
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0513Butterfly(b *testing.B) {
	var x e_nocarry_0513
	x.SetRandom()
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0513)
	}
}

func BenchmarkE_nocarry_0513Exp(b *testing.B) {
	var x e_nocarry_0513
	x.SetRandom()
	benchRese_nocarry_0513.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0513Double(b *testing.B) {
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Double(&benchRese_nocarry_0513)
	}
}

func BenchmarkE_nocarry_0513Add(b *testing.B) {
	var x e_nocarry_0513
	x.SetRandom()
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Add(&x, &benchRese_nocarry_0513)
	}
}

func BenchmarkE_nocarry_0513Sub(b *testing.B) {
	var x e_nocarry_0513
	x.SetRandom()
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Sub(&x, &benchRese_nocarry_0513)
	}
}

func BenchmarkE_nocarry_0513Neg(b *testing.B) {
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Neg(&benchRese_nocarry_0513)
	}
}

func BenchmarkE_nocarry_0513Div(b *testing.B) {
	var x e_nocarry_0513
	x.SetRandom()
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Div(&x, &benchRese_nocarry_0513)
	}
}

func BenchmarkE_nocarry_0513FromMont(b *testing.B) {
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.FromMont()
	}
}

func BenchmarkE_nocarry_0513ToMont(b *testing.B) {
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.ToMont()
	}
}
func BenchmarkE_nocarry_0513Square(b *testing.B) {
	benchRese_nocarry_0513.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Square(&benchRese_nocarry_0513)
	}
}

func BenchmarkE_nocarry_0513Sqrt(b *testing.B) {
	var a e_nocarry_0513
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0513Mul(b *testing.B) {
	x := e_nocarry_0513{
	...
	benchRese_nocarry_0513.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Mul(&benchRese_nocarry_0513, &x)
	}
}

func BenchmarkE_nocarry_0513Cmp(b *testing.B) {
	x := e_nocarry_0513{
		15203164878506984825,
		3153375221279220180,
		11751325191708184881,
	...
	benchRese_nocarry_0513 = x
	benchRese_nocarry_0513[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0513.Cmp(&x)
	}
}

func TestE_nocarry_0513Cmp(t *testing.T) {
	var x, y e_nocarry_0513
...
func TestE_nocarry_0513IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0513
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0513

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0513{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0513
	one.SetOne()
	e.Sub(&qe_nocarry_0513, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0513{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0513{0, uint64(i)})
	}
...
func TestE_nocarry_0513NegZero(t *testing.T) {
	var a, b e_nocarry_0513
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0513Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0513, len(staticTestValues))
...
func TestE_nocarry_0513Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0513) bool {
			var b e_nocarry_0513
...
func TestE_nocarry_0513InverseExp(t *testing.T) {
...
func TestE_nocarry_0513MulByConstants(t *testing.T) {
...
func TestE_nocarry_0513Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0513) bool {
...
func TestE_nocarry_0513LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0513Halve(t *testing.T) {
...
func TestE_nocarry_0513FromMont(t *testing.T) {
...
type testPaire_nocarry_0513 struct {
	element e_nocarry_0513
	bigint  big.Int
}

func (z *e_nocarry_0513) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0513[8] {
		return true
	}
	if z[8] < qe_nocarry_0513[8] {
		return false
	...
	return z[0] >= qe_nocarry_0513[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0513

		g.element = e_nocarry_0513{
		...
		if qe_nocarry_0513[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0513[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0513 {
			var g e_nocarry_0513
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0513[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0513[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0513[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0513[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0513[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0513[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0513[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0513[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0513[8], carry)
...
func Benchmarke_nocarry_0513InverseNew(b *testing.B) {
	var x e_nocarry_0513
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0513
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0513
		var xInv e_nocarry_0513
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0513
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0513
...
func testLinearComb(t *testing.T, x *e_nocarry_0513, xC int64, y *e_nocarry_0513, yC int64) {
	...
	var z e_nocarry_0513
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0513, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0513
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0513, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0513
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0513, xHi uint64) {
	var res e_nocarry_0513
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0513) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0513) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0513, c int64, result *e_nocarry_0513, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0513) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0513) uint64 {
