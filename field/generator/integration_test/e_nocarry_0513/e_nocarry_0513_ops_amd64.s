...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x8bec96f150b7d275, R12
	ADDQ R12, AX
	MOVQ $0x0c41729ba636150d, R12
	ADCQ R12, DX
	MOVQ $0x173789f9dc901432, R12
	ADCQ R12, CX
	MOVQ $0x202852871f701dc1, R12
	ADCQ R12, BX
	MOVQ $0xa39c0341b6c46d82, R12
	ADCQ R12, SI
	MOVQ $0x3da6577ff55f64a7, R12
	ADCQ R12, DI
	MOVQ $0x025092de62db7abe, R12
	ADCQ R12, R8
	MOVQ $0x843a03920c548316, R12
	ADCQ R12, R9
	MOVQ $1, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x8bec96f150b7d275, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x0c41729ba636150d, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x173789f9dc901432, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x202852871f701dc1, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xa39c0341b6c46d82, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x3da6577ff55f64a7, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x025092de62db7abe, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x843a03920c548316, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $1, R13
	SBBQ  R11, R13
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x8bec96f150b7d275, AX
	ADDQ AX, DX
	MOVQ $0x0c41729ba636150d, AX
	ADCQ AX, CX
	MOVQ $0x173789f9dc901432, AX
	ADCQ AX, BX
	MOVQ $0x202852871f701dc1, AX
	ADCQ AX, SI
	MOVQ $0xa39c0341b6c46d82, AX
	ADCQ AX, DI
	MOVQ $0x3da6577ff55f64a7, AX
	ADCQ AX, R8
	MOVQ $0x025092de62db7abe, AX
	ADCQ AX, R9
	MOVQ $0x843a03920c548316, AX
	ADCQ AX, R10
	MOVQ $1, AX
	ADCQ AX, R11
