...
var benchRese_nocarry_0162 e_nocarry_0162

func BenchmarkE_nocarry_0162SetBytes(b *testing.B) {
	var x e_nocarry_0162
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0162MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0162.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0162)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0162)
		}
	})
}

func BenchmarkE_nocarry_0162Inverse(b *testing.B) {
	var x e_nocarry_0162
	x.SetRandom()
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0162Butterfly(b *testing.B) {
	var x e_nocarry_0162
	x.SetRandom()
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0162)
	}
}

func BenchmarkE_nocarry_0162Exp(b *testing.B) {
	var x e_nocarry_0162
	x.SetRandom()
	benchRese_nocarry_0162.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0162Double(b *testing.B) {
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Double(&benchRese_nocarry_0162)
	}
}

func BenchmarkE_nocarry_0162Add(b *testing.B) {
	var x e_nocarry_0162
	x.SetRandom()
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Add(&x, &benchRese_nocarry_0162)
	}
}

func BenchmarkE_nocarry_0162Sub(b *testing.B) {
	var x e_nocarry_0162
	x.SetRandom()
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Sub(&x, &benchRese_nocarry_0162)
	}
}

func BenchmarkE_nocarry_0162Neg(b *testing.B) {
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Neg(&benchRese_nocarry_0162)
	}
}

func BenchmarkE_nocarry_0162Div(b *testing.B) {
	var x e_nocarry_0162
	x.SetRandom()
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Div(&x, &benchRese_nocarry_0162)
	}
}

func BenchmarkE_nocarry_0162FromMont(b *testing.B) {
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.FromMont()
	}
}

func BenchmarkE_nocarry_0162ToMont(b *testing.B) {
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.ToMont()
	}
}
func BenchmarkE_nocarry_0162Square(b *testing.B) {
	benchRese_nocarry_0162.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Square(&benchRese_nocarry_0162)
	}
}

func BenchmarkE_nocarry_0162Sqrt(b *testing.B) {
	var a e_nocarry_0162
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0162Mul(b *testing.B) {
	x := e_nocarry_0162{
		14901457133920964038,
		13861294936041722977,
		555855545,
	}
	benchRese_nocarry_0162.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Mul(&benchRese_nocarry_0162, &x)
	}
}

func BenchmarkE_nocarry_0162Cmp(b *testing.B) {
	x := e_nocarry_0162{
		14901457133920964038,
		13861294936041722977,
		555855545,
	}
	benchRese_nocarry_0162 = x
	benchRese_nocarry_0162[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0162.Cmp(&x)
	}
}

func TestE_nocarry_0162Cmp(t *testing.T) {
	var x, y e_nocarry_0162
...
func TestE_nocarry_0162IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0162
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0162

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0162{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0162
	one.SetOne()
	e.Sub(&qe_nocarry_0162, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0162{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0162{0, uint64(i)})
	}
...
func TestE_nocarry_0162NegZero(t *testing.T) {
	var a, b e_nocarry_0162
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0162Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0162, len(staticTestValues))
...
func TestE_nocarry_0162Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0162) bool {
			var b e_nocarry_0162
...
func TestE_nocarry_0162InverseExp(t *testing.T) {
...
func TestE_nocarry_0162MulByConstants(t *testing.T) {
...
func TestE_nocarry_0162Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0162) bool {
...
func TestE_nocarry_0162LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0162Halve(t *testing.T) {
...
func TestE_nocarry_0162FromMont(t *testing.T) {
...
type testPaire_nocarry_0162 struct {
	element e_nocarry_0162
	bigint  big.Int
}

func (z *e_nocarry_0162) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0162[2] {
		return true
	}
	if z[2] < qe_nocarry_0162[2] {
		return false
	...
	return z[0] >= qe_nocarry_0162[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0162

		g.element = e_nocarry_0162{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0162[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0162[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0162 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0162[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0162[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0162[2], carry)
...
func Benchmarke_nocarry_0162InverseNew(b *testing.B) {
	var x e_nocarry_0162
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0162
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0162
		var xInv e_nocarry_0162
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0162
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0162
...
func testLinearComb(t *testing.T, x *e_nocarry_0162, xC int64, y *e_nocarry_0162, yC int64) {
	...
	var z e_nocarry_0162
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0162, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0162
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0162, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0162
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0162, xHi uint64) {
	var res e_nocarry_0162
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0162) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0162) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0162, c int64, result *e_nocarry_0162, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0162) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0162) uint64 {
