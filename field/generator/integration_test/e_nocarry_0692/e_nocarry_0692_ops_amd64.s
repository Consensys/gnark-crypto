...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x3673e830d50206cd, R14
	ADDQ R14, AX
	MOVQ $0xf16642e72d9d7230, R14
	ADCQ R14, DX
	MOVQ $0x83512732f83c7095, R14
	ADCQ R14, CX
	MOVQ $0x75eb93576d6834f6, R14
	ADCQ R14, BX
	MOVQ $0xf8c38ba1ad6d6cd6, R14
	ADCQ R14, SI
	MOVQ $0xf965972b5ea85c01, R14
	ADCQ R14, DI
	MOVQ $0xe9babbe9162a7f86, R14
	ADCQ R14, R8
	MOVQ $0xcafbc71da217897a, R14
	ADCQ R14, R9
	MOVQ $0xe3f6e08b1e53c927, R14
	ADCQ R14, R10
	MOVQ $0x0ecf5b28ea86e588, R14
	ADCQ R14, R11
	MOVQ $0x000f0432010c878c, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x3673e830d50206cd, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xf16642e72d9d7230, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x83512732f83c7095, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x75eb93576d6834f6, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xf8c38ba1ad6d6cd6, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xf965972b5ea85c01, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xe9babbe9162a7f86, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xcafbc71da217897a, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xe3f6e08b1e53c927, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x0ecf5b28ea86e588, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000f0432010c878c, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x3673e830d50206cd, AX
	ADDQ AX, DX
	MOVQ $0xf16642e72d9d7230, AX
	ADCQ AX, CX
	MOVQ $0x83512732f83c7095, AX
	ADCQ AX, BX
	MOVQ $0x75eb93576d6834f6, AX
	ADCQ AX, SI
	MOVQ $0xf8c38ba1ad6d6cd6, AX
	ADCQ AX, DI
	MOVQ $0xf965972b5ea85c01, AX
	ADCQ AX, R8
	MOVQ $0xe9babbe9162a7f86, AX
	ADCQ AX, R9
	MOVQ $0xcafbc71da217897a, AX
	ADCQ AX, R10
	MOVQ $0xe3f6e08b1e53c927, AX
	ADCQ AX, R11
	MOVQ $0x0ecf5b28ea86e588, AX
	ADCQ AX, R12
	MOVQ $0x000f0432010c878c, AX
	ADCQ AX, R13
