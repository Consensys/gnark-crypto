...
var benchRese_nocarry_0692 e_nocarry_0692

func BenchmarkE_nocarry_0692SetBytes(b *testing.B) {
	var x e_nocarry_0692
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0692MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0692.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0692)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0692)
		}
	})
}

func BenchmarkE_nocarry_0692Inverse(b *testing.B) {
	var x e_nocarry_0692
	x.SetRandom()
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0692Butterfly(b *testing.B) {
	var x e_nocarry_0692
	x.SetRandom()
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0692)
	}
}

func BenchmarkE_nocarry_0692Exp(b *testing.B) {
	var x e_nocarry_0692
	x.SetRandom()
	benchRese_nocarry_0692.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0692Double(b *testing.B) {
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Double(&benchRese_nocarry_0692)
	}
}

func BenchmarkE_nocarry_0692Add(b *testing.B) {
	var x e_nocarry_0692
	x.SetRandom()
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Add(&x, &benchRese_nocarry_0692)
	}
}

func BenchmarkE_nocarry_0692Sub(b *testing.B) {
	var x e_nocarry_0692
	x.SetRandom()
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Sub(&x, &benchRese_nocarry_0692)
	}
}

func BenchmarkE_nocarry_0692Neg(b *testing.B) {
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Neg(&benchRese_nocarry_0692)
	}
}

func BenchmarkE_nocarry_0692Div(b *testing.B) {
	var x e_nocarry_0692
	x.SetRandom()
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Div(&x, &benchRese_nocarry_0692)
	}
}

func BenchmarkE_nocarry_0692FromMont(b *testing.B) {
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.FromMont()
	}
}

func BenchmarkE_nocarry_0692ToMont(b *testing.B) {
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.ToMont()
	}
}
func BenchmarkE_nocarry_0692Square(b *testing.B) {
	benchRese_nocarry_0692.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Square(&benchRese_nocarry_0692)
	}
}

func BenchmarkE_nocarry_0692Sqrt(b *testing.B) {
	var a e_nocarry_0692
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0692Mul(b *testing.B) {
	x := e_nocarry_0692{
		2952289520365220633,
		2606787921674291497,
		3823377227029948443,
	...
	benchRese_nocarry_0692.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Mul(&benchRese_nocarry_0692, &x)
	}
}

func BenchmarkE_nocarry_0692Cmp(b *testing.B) {
	x := e_nocarry_0692{
		2952289520365220633,
		2606787921674291497,
		3823377227029948443,
	...
	benchRese_nocarry_0692 = x
	benchRese_nocarry_0692[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0692.Cmp(&x)
	}
}

func TestE_nocarry_0692Cmp(t *testing.T) {
	var x, y e_nocarry_0692
...
func TestE_nocarry_0692IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0692
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0692

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0692{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0692
	one.SetOne()
	e.Sub(&qe_nocarry_0692, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0692{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0692{0, uint64(i)})
	}
...
func TestE_nocarry_0692NegZero(t *testing.T) {
	var a, b e_nocarry_0692
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0692Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0692, len(staticTestValues))
...
func TestE_nocarry_0692Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0692) bool {
			var b e_nocarry_0692
...
func TestE_nocarry_0692InverseExp(t *testing.T) {
...
func TestE_nocarry_0692MulByConstants(t *testing.T) {
...
func TestE_nocarry_0692Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0692) bool {
...
func TestE_nocarry_0692LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0692Halve(t *testing.T) {
...
func TestE_nocarry_0692FromMont(t *testing.T) {
...
type testPaire_nocarry_0692 struct {
	element e_nocarry_0692
	bigint  big.Int
}

func (z *e_nocarry_0692) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0692[10] {
		return true
	}
	if z[10] < qe_nocarry_0692[10] {
		return false
	...
	return z[0] >= qe_nocarry_0692[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0692

		g.element = e_nocarry_0692{
		...
		if qe_nocarry_0692[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0692[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0692 {
			var g e_nocarry_0692
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0692[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0692[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0692[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0692[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0692[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0692[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0692[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0692[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0692[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0692[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0692[10], carry)
...
func Benchmarke_nocarry_0692InverseNew(b *testing.B) {
	var x e_nocarry_0692
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0692
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0692
		var xInv e_nocarry_0692
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0692
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0692
...
func testLinearComb(t *testing.T, x *e_nocarry_0692, xC int64, y *e_nocarry_0692, yC int64) {
	...
	var z e_nocarry_0692
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0692, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0692
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0692, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0692
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0692, xHi uint64) {
	var res e_nocarry_0692
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0692) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0692) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0692, c int64, result *e_nocarry_0692, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0692) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0692) uint64 {
