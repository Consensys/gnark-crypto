...
// modulus q
DATA q<>+0(SB)/8, $0x627584eaca863e39
DATA q<>+8(SB)/8, $0x07a82ad13c4b1a26
DATA q<>+16(SB)/8, $0x9686aef34f97cf04
DATA q<>+24(SB)/8, $0x03c1702d19193bd9
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xbc8a378cc379aff7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x627584eaca863e39, R8
	MOVQ    $0x07a82ad13c4b1a26, R9
	MOVQ    $0x9686aef34f97cf04, R10
	MOVQ    $0x03c1702d19193bd9, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x07a82ad13c4b1a26, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x9686aef34f97cf04, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x03c1702d19193bd9, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x627584eaca863e39, R12
	MOVQ    $0x07a82ad13c4b1a26, R13
	MOVQ    $0x9686aef34f97cf04, R14
	MOVQ    $0x03c1702d19193bd9, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
