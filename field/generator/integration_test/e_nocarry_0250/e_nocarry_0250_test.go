...
var benchRese_nocarry_0250 e_nocarry_0250

func BenchmarkE_nocarry_0250SetBytes(b *testing.B) {
	var x e_nocarry_0250
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0250MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0250.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0250)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0250)
		}
	})
}

func BenchmarkE_nocarry_0250Inverse(b *testing.B) {
	var x e_nocarry_0250
	x.SetRandom()
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0250Butterfly(b *testing.B) {
	var x e_nocarry_0250
	x.SetRandom()
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0250)
	}
}

func BenchmarkE_nocarry_0250Exp(b *testing.B) {
	var x e_nocarry_0250
	x.SetRandom()
	benchRese_nocarry_0250.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0250Double(b *testing.B) {
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Double(&benchRese_nocarry_0250)
	}
}

func BenchmarkE_nocarry_0250Add(b *testing.B) {
	var x e_nocarry_0250
	x.SetRandom()
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Add(&x, &benchRese_nocarry_0250)
	}
}

func BenchmarkE_nocarry_0250Sub(b *testing.B) {
	var x e_nocarry_0250
	x.SetRandom()
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Sub(&x, &benchRese_nocarry_0250)
	}
}

func BenchmarkE_nocarry_0250Neg(b *testing.B) {
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Neg(&benchRese_nocarry_0250)
	}
}

func BenchmarkE_nocarry_0250Div(b *testing.B) {
	var x e_nocarry_0250
	x.SetRandom()
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Div(&x, &benchRese_nocarry_0250)
	}
}

func BenchmarkE_nocarry_0250FromMont(b *testing.B) {
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.FromMont()
	}
}

func BenchmarkE_nocarry_0250ToMont(b *testing.B) {
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.ToMont()
	}
}
func BenchmarkE_nocarry_0250Square(b *testing.B) {
	benchRese_nocarry_0250.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Square(&benchRese_nocarry_0250)
	}
}

func BenchmarkE_nocarry_0250Sqrt(b *testing.B) {
	var a e_nocarry_0250
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0250Mul(b *testing.B) {
	x := e_nocarry_0250{
	...
	benchRese_nocarry_0250.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Mul(&benchRese_nocarry_0250, &x)
	}
}

func BenchmarkE_nocarry_0250Cmp(b *testing.B) {
	x := e_nocarry_0250{
		10554207862612238474,
		12800032044304573467,
		3857593529798740514,
	...
	benchRese_nocarry_0250 = x
	benchRese_nocarry_0250[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0250.Cmp(&x)
	}
}

func TestE_nocarry_0250Cmp(t *testing.T) {
	var x, y e_nocarry_0250
...
func TestE_nocarry_0250IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0250
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0250

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0250{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0250
	one.SetOne()
	e.Sub(&qe_nocarry_0250, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0250{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0250{0, uint64(i)})
	}
...
func TestE_nocarry_0250NegZero(t *testing.T) {
	var a, b e_nocarry_0250
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0250Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0250, len(staticTestValues))
...
func TestE_nocarry_0250Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0250) bool {
			var b e_nocarry_0250
...
func TestE_nocarry_0250InverseExp(t *testing.T) {
...
func TestE_nocarry_0250MulByConstants(t *testing.T) {
...
func TestE_nocarry_0250Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0250) bool {
...
func TestE_nocarry_0250LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0250Halve(t *testing.T) {
...
func TestE_nocarry_0250FromMont(t *testing.T) {
...
type testPaire_nocarry_0250 struct {
	element e_nocarry_0250
	bigint  big.Int
}

func (z *e_nocarry_0250) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0250[3] {
		return true
	}
	if z[3] < qe_nocarry_0250[3] {
		return false
	...
	return z[0] >= qe_nocarry_0250[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0250

		g.element = e_nocarry_0250{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0250[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0250[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0250 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0250[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0250[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0250[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0250[3], carry)
...
func Benchmarke_nocarry_0250InverseNew(b *testing.B) {
	var x e_nocarry_0250
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0250
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0250
		var xInv e_nocarry_0250
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0250
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0250
...
func testLinearComb(t *testing.T, x *e_nocarry_0250, xC int64, y *e_nocarry_0250, yC int64) {
	...
	var z e_nocarry_0250
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0250, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0250
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0250, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0250
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0250, xHi uint64) {
	var res e_nocarry_0250
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0250) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0250) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0250, c int64, result *e_nocarry_0250, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0250) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0250) uint64 {
