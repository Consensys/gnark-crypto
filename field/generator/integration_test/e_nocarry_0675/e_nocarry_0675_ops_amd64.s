...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x3b5d445d01f7fe7b, R14
	ADDQ R14, AX
	MOVQ $0x524bb100cccf7c1f, R14
	ADCQ R14, DX
	MOVQ $0x4fc1d3cf05d112f3, R14
	ADCQ R14, CX
	MOVQ $0x5331007668396f0b, R14
	ADCQ R14, BX
	MOVQ $0xea64a7ca33d731ae, R14
	ADCQ R14, SI
	MOVQ $0x8719b200fb95bffc, R14
	ADCQ R14, DI
	MOVQ $0x304aae7ab0045ec9, R14
	ADCQ R14, R8
	MOVQ $0xe920f596becfd08a, R14
	ADCQ R14, R9
	MOVQ $0x22576e410b7d35c1, R14
	ADCQ R14, R10
	MOVQ $0x6e43f3e31e34566a, R14
	ADCQ R14, R11
	MOVQ $0x000000071d421d9f, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x3b5d445d01f7fe7b, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x524bb100cccf7c1f, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x4fc1d3cf05d112f3, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x5331007668396f0b, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xea64a7ca33d731ae, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x8719b200fb95bffc, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x304aae7ab0045ec9, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xe920f596becfd08a, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x22576e410b7d35c1, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x6e43f3e31e34566a, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000071d421d9f, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x3b5d445d01f7fe7b, AX
	ADDQ AX, DX
	MOVQ $0x524bb100cccf7c1f, AX
	ADCQ AX, CX
	MOVQ $0x4fc1d3cf05d112f3, AX
	ADCQ AX, BX
	MOVQ $0x5331007668396f0b, AX
	ADCQ AX, SI
	MOVQ $0xea64a7ca33d731ae, AX
	ADCQ AX, DI
	MOVQ $0x8719b200fb95bffc, AX
	ADCQ AX, R8
	MOVQ $0x304aae7ab0045ec9, AX
	ADCQ AX, R9
	MOVQ $0xe920f596becfd08a, AX
	ADCQ AX, R10
	MOVQ $0x22576e410b7d35c1, AX
	ADCQ AX, R11
	MOVQ $0x6e43f3e31e34566a, AX
	ADCQ AX, R12
	MOVQ $0x000000071d421d9f, AX
	ADCQ AX, R13
