...
var benchRese_nocarry_0675 e_nocarry_0675

func BenchmarkE_nocarry_0675SetBytes(b *testing.B) {
	var x e_nocarry_0675
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0675MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0675.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0675)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0675)
		}
	})
}

func BenchmarkE_nocarry_0675Inverse(b *testing.B) {
	var x e_nocarry_0675
	x.SetRandom()
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0675Butterfly(b *testing.B) {
	var x e_nocarry_0675
	x.SetRandom()
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0675)
	}
}

func BenchmarkE_nocarry_0675Exp(b *testing.B) {
	var x e_nocarry_0675
	x.SetRandom()
	benchRese_nocarry_0675.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0675Double(b *testing.B) {
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Double(&benchRese_nocarry_0675)
	}
}

func BenchmarkE_nocarry_0675Add(b *testing.B) {
	var x e_nocarry_0675
	x.SetRandom()
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Add(&x, &benchRese_nocarry_0675)
	}
}

func BenchmarkE_nocarry_0675Sub(b *testing.B) {
	var x e_nocarry_0675
	x.SetRandom()
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Sub(&x, &benchRese_nocarry_0675)
	}
}

func BenchmarkE_nocarry_0675Neg(b *testing.B) {
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Neg(&benchRese_nocarry_0675)
	}
}

func BenchmarkE_nocarry_0675Div(b *testing.B) {
	var x e_nocarry_0675
	x.SetRandom()
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Div(&x, &benchRese_nocarry_0675)
	}
}

func BenchmarkE_nocarry_0675FromMont(b *testing.B) {
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.FromMont()
	}
}

func BenchmarkE_nocarry_0675ToMont(b *testing.B) {
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.ToMont()
	}
}
func BenchmarkE_nocarry_0675Square(b *testing.B) {
	benchRese_nocarry_0675.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Square(&benchRese_nocarry_0675)
	}
}

func BenchmarkE_nocarry_0675Sqrt(b *testing.B) {
	var a e_nocarry_0675
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0675Mul(b *testing.B) {
	x := e_nocarry_0675{
	...
	benchRese_nocarry_0675.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Mul(&benchRese_nocarry_0675, &x)
	}
}

func BenchmarkE_nocarry_0675Cmp(b *testing.B) {
	x := e_nocarry_0675{
		10416402557864844597,
		15903220953567273163,
		3390337039137811546,
	...
	benchRese_nocarry_0675 = x
	benchRese_nocarry_0675[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0675.Cmp(&x)
	}
}

func TestE_nocarry_0675Cmp(t *testing.T) {
	var x, y e_nocarry_0675
...
func TestE_nocarry_0675IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0675
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0675

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0675{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0675
	one.SetOne()
	e.Sub(&qe_nocarry_0675, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0675{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0675{0, uint64(i)})
	}
...
func TestE_nocarry_0675NegZero(t *testing.T) {
	var a, b e_nocarry_0675
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0675Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0675, len(staticTestValues))
...
func TestE_nocarry_0675Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0675) bool {
			var b e_nocarry_0675
...
func TestE_nocarry_0675InverseExp(t *testing.T) {
...
func TestE_nocarry_0675MulByConstants(t *testing.T) {
...
func TestE_nocarry_0675Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0675) bool {
...
func TestE_nocarry_0675LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0675Halve(t *testing.T) {
...
func TestE_nocarry_0675FromMont(t *testing.T) {
...
type testPaire_nocarry_0675 struct {
	element e_nocarry_0675
	bigint  big.Int
}

func (z *e_nocarry_0675) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0675[10] {
		return true
	}
	if z[10] < qe_nocarry_0675[10] {
		return false
	...
	return z[0] >= qe_nocarry_0675[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0675

		g.element = e_nocarry_0675{
		...
		if qe_nocarry_0675[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0675[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0675 {
			var g e_nocarry_0675
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0675[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0675[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0675[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0675[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0675[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0675[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0675[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0675[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0675[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0675[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0675[10], carry)
...
func Benchmarke_nocarry_0675InverseNew(b *testing.B) {
	var x e_nocarry_0675
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0675
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0675
		var xInv e_nocarry_0675
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0675
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0675
...
func testLinearComb(t *testing.T, x *e_nocarry_0675, xC int64, y *e_nocarry_0675, yC int64) {
	...
	var z e_nocarry_0675
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0675, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0675
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0675, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0675
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0675, xHi uint64) {
	var res e_nocarry_0675
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0675) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0675) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0675, c int64, result *e_nocarry_0675, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0675) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0675) uint64 {
