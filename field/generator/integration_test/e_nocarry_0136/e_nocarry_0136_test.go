...
var benchRese_nocarry_0136 e_nocarry_0136

func BenchmarkE_nocarry_0136SetBytes(b *testing.B) {
	var x e_nocarry_0136
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0136MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0136.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0136)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0136)
		}
	})
}

func BenchmarkE_nocarry_0136Inverse(b *testing.B) {
	var x e_nocarry_0136
	x.SetRandom()
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0136Butterfly(b *testing.B) {
	var x e_nocarry_0136
	x.SetRandom()
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0136)
	}
}

func BenchmarkE_nocarry_0136Exp(b *testing.B) {
	var x e_nocarry_0136
	x.SetRandom()
	benchRese_nocarry_0136.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0136Double(b *testing.B) {
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Double(&benchRese_nocarry_0136)
	}
}

func BenchmarkE_nocarry_0136Add(b *testing.B) {
	var x e_nocarry_0136
	x.SetRandom()
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Add(&x, &benchRese_nocarry_0136)
	}
}

func BenchmarkE_nocarry_0136Sub(b *testing.B) {
	var x e_nocarry_0136
	x.SetRandom()
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Sub(&x, &benchRese_nocarry_0136)
	}
}

func BenchmarkE_nocarry_0136Neg(b *testing.B) {
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Neg(&benchRese_nocarry_0136)
	}
}

func BenchmarkE_nocarry_0136Div(b *testing.B) {
	var x e_nocarry_0136
	x.SetRandom()
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Div(&x, &benchRese_nocarry_0136)
	}
}

func BenchmarkE_nocarry_0136FromMont(b *testing.B) {
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.FromMont()
	}
}

func BenchmarkE_nocarry_0136ToMont(b *testing.B) {
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.ToMont()
	}
}
func BenchmarkE_nocarry_0136Square(b *testing.B) {
	benchRese_nocarry_0136.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Square(&benchRese_nocarry_0136)
	}
}

func BenchmarkE_nocarry_0136Sqrt(b *testing.B) {
	var a e_nocarry_0136
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0136Mul(b *testing.B) {
	x := e_nocarry_0136{
		14597049447703149086,
		15733218379191697316,
		219,
	}
	benchRese_nocarry_0136.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Mul(&benchRese_nocarry_0136, &x)
	}
}

func BenchmarkE_nocarry_0136Cmp(b *testing.B) {
	x := e_nocarry_0136{
		14597049447703149086,
		15733218379191697316,
		219,
	}
	benchRese_nocarry_0136 = x
	benchRese_nocarry_0136[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0136.Cmp(&x)
	}
}

func TestE_nocarry_0136Cmp(t *testing.T) {
	var x, y e_nocarry_0136
...
func TestE_nocarry_0136IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0136
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0136

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0136{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0136
	one.SetOne()
	e.Sub(&qe_nocarry_0136, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0136{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0136{0, uint64(i)})
	}
...
func TestE_nocarry_0136NegZero(t *testing.T) {
	var a, b e_nocarry_0136
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0136Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0136, len(staticTestValues))
...
func TestE_nocarry_0136Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0136) bool {
			var b e_nocarry_0136
...
func TestE_nocarry_0136InverseExp(t *testing.T) {
...
func TestE_nocarry_0136MulByConstants(t *testing.T) {
...
func TestE_nocarry_0136Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0136) bool {
...
func TestE_nocarry_0136LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0136Halve(t *testing.T) {
...
func TestE_nocarry_0136FromMont(t *testing.T) {
...
type testPaire_nocarry_0136 struct {
	element e_nocarry_0136
	bigint  big.Int
}

func (z *e_nocarry_0136) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0136[2] {
		return true
	}
	if z[2] < qe_nocarry_0136[2] {
		return false
	...
	return z[0] >= qe_nocarry_0136[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0136

		g.element = e_nocarry_0136{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0136[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0136[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0136 {
			var g e_nocarry_0136
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0136[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0136[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0136[2], carry)
...
func Benchmarke_nocarry_0136InverseNew(b *testing.B) {
	var x e_nocarry_0136
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0136
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0136
		var xInv e_nocarry_0136
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0136
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0136
...
func testLinearComb(t *testing.T, x *e_nocarry_0136, xC int64, y *e_nocarry_0136, yC int64) {
	...
	var z e_nocarry_0136
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0136, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0136
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0136, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0136
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0136, xHi uint64) {
	var res e_nocarry_0136
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0136) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0136) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0136, c int64, result *e_nocarry_0136, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0136) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0136) uint64 {
