...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_cios_0128{uint64(i)})
		staticTestValues = append(staticTestValues, e_cios_0128{0, uint64(i)})
	}
...
func (z *e_cios_0128) biggerOrEqualModulus() bool {
	if z[1] > qe_cios_0128[1] {
		return true
	}
	if z[1] < qe_cios_0128[1] {
		return false
