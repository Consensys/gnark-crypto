...
var benchRese_nocarry_0475 e_nocarry_0475

func BenchmarkE_nocarry_0475SetBytes(b *testing.B) {
	var x e_nocarry_0475
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0475MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0475.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0475)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0475)
		}
	})
}

func BenchmarkE_nocarry_0475Inverse(b *testing.B) {
	var x e_nocarry_0475
	x.SetRandom()
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0475Butterfly(b *testing.B) {
	var x e_nocarry_0475
	x.SetRandom()
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0475)
	}
}

func BenchmarkE_nocarry_0475Exp(b *testing.B) {
	var x e_nocarry_0475
	x.SetRandom()
	benchRese_nocarry_0475.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0475Double(b *testing.B) {
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Double(&benchRese_nocarry_0475)
	}
}

func BenchmarkE_nocarry_0475Add(b *testing.B) {
	var x e_nocarry_0475
	x.SetRandom()
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Add(&x, &benchRese_nocarry_0475)
	}
}

func BenchmarkE_nocarry_0475Sub(b *testing.B) {
	var x e_nocarry_0475
	x.SetRandom()
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Sub(&x, &benchRese_nocarry_0475)
	}
}

func BenchmarkE_nocarry_0475Neg(b *testing.B) {
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Neg(&benchRese_nocarry_0475)
	}
}

func BenchmarkE_nocarry_0475Div(b *testing.B) {
	var x e_nocarry_0475
	x.SetRandom()
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Div(&x, &benchRese_nocarry_0475)
	}
}

func BenchmarkE_nocarry_0475FromMont(b *testing.B) {
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.FromMont()
	}
}

func BenchmarkE_nocarry_0475ToMont(b *testing.B) {
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.ToMont()
	}
}
func BenchmarkE_nocarry_0475Square(b *testing.B) {
	benchRese_nocarry_0475.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Square(&benchRese_nocarry_0475)
	}
}

func BenchmarkE_nocarry_0475Sqrt(b *testing.B) {
	var a e_nocarry_0475
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0475Mul(b *testing.B) {
	x := e_nocarry_0475{
		8351606432259566350,
		5103466844872655162,
	...
	benchRese_nocarry_0475.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Mul(&benchRese_nocarry_0475, &x)
	}
}

func BenchmarkE_nocarry_0475Cmp(b *testing.B) {
	x := e_nocarry_0475{
		8351606432259566350,
		5103466844872655162,
		17347635897102131548,
	...
	benchRese_nocarry_0475 = x
	benchRese_nocarry_0475[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0475.Cmp(&x)
	}
}

func TestE_nocarry_0475Cmp(t *testing.T) {
	var x, y e_nocarry_0475
...
func TestE_nocarry_0475IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0475
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0475

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0475{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0475
	one.SetOne()
	e.Sub(&qe_nocarry_0475, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0475{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0475{0, uint64(i)})
	}
...
func TestE_nocarry_0475NegZero(t *testing.T) {
	var a, b e_nocarry_0475
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0475Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0475, len(staticTestValues))
...
func TestE_nocarry_0475Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0475) bool {
			var b e_nocarry_0475
...
func TestE_nocarry_0475InverseExp(t *testing.T) {
...
func TestE_nocarry_0475MulByConstants(t *testing.T) {
...
func TestE_nocarry_0475Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0475) bool {
...
func TestE_nocarry_0475LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0475Halve(t *testing.T) {
...
func TestE_nocarry_0475FromMont(t *testing.T) {
...
type testPaire_nocarry_0475 struct {
	element e_nocarry_0475
	bigint  big.Int
}

func (z *e_nocarry_0475) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0475[7] {
		return true
	}
	if z[7] < qe_nocarry_0475[7] {
		return false
	...
	return z[0] >= qe_nocarry_0475[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0475

		g.element = e_nocarry_0475{
		...
		if qe_nocarry_0475[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0475[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0475 {
			var g e_nocarry_0475
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0475[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0475[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0475[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0475[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0475[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0475[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0475[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0475[7], carry)
...
func Benchmarke_nocarry_0475InverseNew(b *testing.B) {
	var x e_nocarry_0475
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0475
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0475
		var xInv e_nocarry_0475
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0475
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0475
...
func testLinearComb(t *testing.T, x *e_nocarry_0475, xC int64, y *e_nocarry_0475, yC int64) {
	...
	var z e_nocarry_0475
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0475, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0475
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0475, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0475
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0475, xHi uint64) {
	var res e_nocarry_0475
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0475) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0475) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0475, c int64, result *e_nocarry_0475, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0475) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0475) uint64 {
