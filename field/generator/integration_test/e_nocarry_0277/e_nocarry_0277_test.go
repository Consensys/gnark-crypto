...
var benchRese_nocarry_0277 e_nocarry_0277

func BenchmarkE_nocarry_0277SetBytes(b *testing.B) {
	var x e_nocarry_0277
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0277MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0277.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0277)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0277)
		}
	})
}

func BenchmarkE_nocarry_0277Inverse(b *testing.B) {
	var x e_nocarry_0277
	x.SetRandom()
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0277Butterfly(b *testing.B) {
	var x e_nocarry_0277
	x.SetRandom()
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0277)
	}
}

func BenchmarkE_nocarry_0277Exp(b *testing.B) {
	var x e_nocarry_0277
	x.SetRandom()
	benchRese_nocarry_0277.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0277Double(b *testing.B) {
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Double(&benchRese_nocarry_0277)
	}
}

func BenchmarkE_nocarry_0277Add(b *testing.B) {
	var x e_nocarry_0277
	x.SetRandom()
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Add(&x, &benchRese_nocarry_0277)
	}
}

func BenchmarkE_nocarry_0277Sub(b *testing.B) {
	var x e_nocarry_0277
	x.SetRandom()
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Sub(&x, &benchRese_nocarry_0277)
	}
}

func BenchmarkE_nocarry_0277Neg(b *testing.B) {
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Neg(&benchRese_nocarry_0277)
	}
}

func BenchmarkE_nocarry_0277Div(b *testing.B) {
	var x e_nocarry_0277
	x.SetRandom()
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Div(&x, &benchRese_nocarry_0277)
	}
}

func BenchmarkE_nocarry_0277FromMont(b *testing.B) {
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.FromMont()
	}
}

func BenchmarkE_nocarry_0277ToMont(b *testing.B) {
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.ToMont()
	}
}
func BenchmarkE_nocarry_0277Square(b *testing.B) {
	benchRese_nocarry_0277.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Square(&benchRese_nocarry_0277)
	}
}

func BenchmarkE_nocarry_0277Sqrt(b *testing.B) {
	var a e_nocarry_0277
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0277Mul(b *testing.B) {
	x := e_nocarry_0277{
	...
	benchRese_nocarry_0277.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Mul(&benchRese_nocarry_0277, &x)
	}
}

func BenchmarkE_nocarry_0277Cmp(b *testing.B) {
	x := e_nocarry_0277{
		12344919092965741742,
		2362861748187060989,
		4116312679637211462,
	...
	benchRese_nocarry_0277 = x
	benchRese_nocarry_0277[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0277.Cmp(&x)
	}
}

func TestE_nocarry_0277Cmp(t *testing.T) {
	var x, y e_nocarry_0277
...
func TestE_nocarry_0277IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0277
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0277

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0277{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0277
	one.SetOne()
	e.Sub(&qe_nocarry_0277, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0277{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0277{0, uint64(i)})
	}
...
func TestE_nocarry_0277NegZero(t *testing.T) {
	var a, b e_nocarry_0277
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0277Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0277, len(staticTestValues))
...
func TestE_nocarry_0277Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0277) bool {
			var b e_nocarry_0277
...
func TestE_nocarry_0277InverseExp(t *testing.T) {
...
func TestE_nocarry_0277MulByConstants(t *testing.T) {
...
func TestE_nocarry_0277Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0277) bool {
...
func TestE_nocarry_0277LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0277Halve(t *testing.T) {
...
func TestE_nocarry_0277FromMont(t *testing.T) {
...
type testPaire_nocarry_0277 struct {
	element e_nocarry_0277
	bigint  big.Int
}

func (z *e_nocarry_0277) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0277[4] {
		return true
	}
	if z[4] < qe_nocarry_0277[4] {
		return false
	...
	return z[0] >= qe_nocarry_0277[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0277

		g.element = e_nocarry_0277{
		...
		if qe_nocarry_0277[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0277[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0277 {
			var g e_nocarry_0277
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0277[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0277[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0277[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0277[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0277[4], carry)
...
func Benchmarke_nocarry_0277InverseNew(b *testing.B) {
	var x e_nocarry_0277
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0277
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0277
		var xInv e_nocarry_0277
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0277
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0277
...
func testLinearComb(t *testing.T, x *e_nocarry_0277, xC int64, y *e_nocarry_0277, yC int64) {
	...
	var z e_nocarry_0277
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0277, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0277
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0277, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0277
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0277, xHi uint64) {
	var res e_nocarry_0277
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0277) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0277) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0277, c int64, result *e_nocarry_0277, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0277) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0277) uint64 {
