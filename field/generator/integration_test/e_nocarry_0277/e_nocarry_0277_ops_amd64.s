...
// modulus q
DATA q<>+0(SB)/8, $0xd024a9e35707aafb
DATA q<>+8(SB)/8, $0x56406cc4d79374d2
DATA q<>+16(SB)/8, $0xf904e224129ea117
DATA q<>+24(SB)/8, $0x81c7a0b4349c7265
DATA q<>+32(SB)/8, $0x000000000018df06
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xccd5669f69e82fcd
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xd024a9e35707aafb, R9
	MOVQ    $0x56406cc4d79374d2, R10
	MOVQ    $0xf904e224129ea117, R11
	MOVQ    $0x81c7a0b4349c7265, R12
	MOVQ    $0x000000000018df06, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x56406cc4d79374d2, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xf904e224129ea117, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x81c7a0b4349c7265, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000000018df06, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xd024a9e35707aafb, CX
	MOVQ    $0x56406cc4d79374d2, BX
	MOVQ    $0xf904e224129ea117, SI
	MOVQ    $0x81c7a0b4349c7265, DI
	MOVQ    $0x000000000018df06, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
