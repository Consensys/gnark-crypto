...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xbdca9825402e29f5, R13
	ADDQ R13, AX
	MOVQ $0x17afa31a8c1aec10, R13
	ADCQ R13, DX
	MOVQ $0x2b5cc7864ec94789, R13
	ADCQ R13, CX
	MOVQ $0x29349f8e799c59eb, R13
	ADCQ R13, BX
	MOVQ $0xf579b07bc0333c16, R13
	ADCQ R13, SI
	MOVQ $0xf315546d11e138b9, R13
	ADCQ R13, DI
	MOVQ $0xbd2104b7f99f51e8, R13
	ADCQ R13, R8
	MOVQ $0xba1699a4d44049a3, R13
	ADCQ R13, R9
	MOVQ $0xaa74cdc00752d83c, R13
	ADCQ R13, R10
	MOVQ $0x00000000001a5a04, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xbdca9825402e29f5, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x17afa31a8c1aec10, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x2b5cc7864ec94789, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x29349f8e799c59eb, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xf579b07bc0333c16, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xf315546d11e138b9, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xbd2104b7f99f51e8, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xba1699a4d44049a3, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xaa74cdc00752d83c, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000001a5a04, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xbdca9825402e29f5, AX
	ADDQ AX, DX
	MOVQ $0x17afa31a8c1aec10, AX
	ADCQ AX, CX
	MOVQ $0x2b5cc7864ec94789, AX
	ADCQ AX, BX
	MOVQ $0x29349f8e799c59eb, AX
	ADCQ AX, SI
	MOVQ $0xf579b07bc0333c16, AX
	ADCQ AX, DI
	MOVQ $0xf315546d11e138b9, AX
	ADCQ AX, R8
	MOVQ $0xbd2104b7f99f51e8, AX
	ADCQ AX, R9
	MOVQ $0xba1699a4d44049a3, AX
	ADCQ AX, R10
	MOVQ $0xaa74cdc00752d83c, AX
	ADCQ AX, R11
	MOVQ $0x00000000001a5a04, AX
	ADCQ AX, R12
