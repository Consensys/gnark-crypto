...
var benchRese_nocarry_0597 e_nocarry_0597

func BenchmarkE_nocarry_0597SetBytes(b *testing.B) {
	var x e_nocarry_0597
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0597MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0597.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0597)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0597)
		}
	})
}

func BenchmarkE_nocarry_0597Inverse(b *testing.B) {
	var x e_nocarry_0597
	x.SetRandom()
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0597Butterfly(b *testing.B) {
	var x e_nocarry_0597
	x.SetRandom()
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0597)
	}
}

func BenchmarkE_nocarry_0597Exp(b *testing.B) {
	var x e_nocarry_0597
	x.SetRandom()
	benchRese_nocarry_0597.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0597Double(b *testing.B) {
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Double(&benchRese_nocarry_0597)
	}
}

func BenchmarkE_nocarry_0597Add(b *testing.B) {
	var x e_nocarry_0597
	x.SetRandom()
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Add(&x, &benchRese_nocarry_0597)
	}
}

func BenchmarkE_nocarry_0597Sub(b *testing.B) {
	var x e_nocarry_0597
	x.SetRandom()
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Sub(&x, &benchRese_nocarry_0597)
	}
}

func BenchmarkE_nocarry_0597Neg(b *testing.B) {
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Neg(&benchRese_nocarry_0597)
	}
}

func BenchmarkE_nocarry_0597Div(b *testing.B) {
	var x e_nocarry_0597
	x.SetRandom()
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Div(&x, &benchRese_nocarry_0597)
	}
}

func BenchmarkE_nocarry_0597FromMont(b *testing.B) {
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.FromMont()
	}
}

func BenchmarkE_nocarry_0597ToMont(b *testing.B) {
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.ToMont()
	}
}
func BenchmarkE_nocarry_0597Square(b *testing.B) {
	benchRese_nocarry_0597.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Square(&benchRese_nocarry_0597)
	}
}

func BenchmarkE_nocarry_0597Sqrt(b *testing.B) {
	var a e_nocarry_0597
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0597Mul(b *testing.B) {
	x := e_nocarry_0597{
	...
	benchRese_nocarry_0597.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Mul(&benchRese_nocarry_0597, &x)
	}
}

func BenchmarkE_nocarry_0597Cmp(b *testing.B) {
	x := e_nocarry_0597{
		11312218645292768533,
		12050077656935543449,
		5999731486000056372,
	...
	benchRese_nocarry_0597 = x
	benchRese_nocarry_0597[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0597.Cmp(&x)
	}
}

func TestE_nocarry_0597Cmp(t *testing.T) {
	var x, y e_nocarry_0597
...
func TestE_nocarry_0597IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0597
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0597

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0597{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0597
	one.SetOne()
	e.Sub(&qe_nocarry_0597, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0597{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0597{0, uint64(i)})
	}
...
func TestE_nocarry_0597NegZero(t *testing.T) {
	var a, b e_nocarry_0597
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0597Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0597, len(staticTestValues))
...
func TestE_nocarry_0597Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0597) bool {
			var b e_nocarry_0597
...
func TestE_nocarry_0597InverseExp(t *testing.T) {
...
func TestE_nocarry_0597MulByConstants(t *testing.T) {
...
func TestE_nocarry_0597Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0597) bool {
...
func TestE_nocarry_0597LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0597Halve(t *testing.T) {
...
func TestE_nocarry_0597FromMont(t *testing.T) {
...
type testPaire_nocarry_0597 struct {
	element e_nocarry_0597
	bigint  big.Int
}

func (z *e_nocarry_0597) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0597[9] {
		return true
	}
	if z[9] < qe_nocarry_0597[9] {
		return false
	...
	return z[0] >= qe_nocarry_0597[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0597

		g.element = e_nocarry_0597{
		...
		if qe_nocarry_0597[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0597[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0597 {
			var g e_nocarry_0597
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0597[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0597[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0597[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0597[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0597[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0597[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0597[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0597[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0597[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0597[9], carry)
...
func Benchmarke_nocarry_0597InverseNew(b *testing.B) {
	var x e_nocarry_0597
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0597
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0597
		var xInv e_nocarry_0597
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0597
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0597
...
func testLinearComb(t *testing.T, x *e_nocarry_0597, xC int64, y *e_nocarry_0597, yC int64) {
	...
	var z e_nocarry_0597
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0597, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0597
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0597, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0597
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0597, xHi uint64) {
	var res e_nocarry_0597
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0597) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0597) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0597, c int64, result *e_nocarry_0597, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0597) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0597) uint64 {
