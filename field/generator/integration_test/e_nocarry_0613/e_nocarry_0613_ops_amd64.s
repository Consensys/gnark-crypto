...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xa1e08d2968d80f03, R13
	ADDQ R13, AX
	MOVQ $0x8884c2416c7e12dd, R13
	ADCQ R13, DX
	MOVQ $0x801de4e313dddaef, R13
	ADCQ R13, CX
	MOVQ $0x5244271a526ea1c1, R13
	ADCQ R13, BX
	MOVQ $0xea2ce098a3d196c2, R13
	ADCQ R13, SI
	MOVQ $0x81b8518136d3ddb9, R13
	ADCQ R13, DI
	MOVQ $0xd2792e82b646b521, R13
	ADCQ R13, R8
	MOVQ $0x6abb0ffdf6400900, R13
	ADCQ R13, R9
	MOVQ $0x31775551d91adeab, R13
	ADCQ R13, R10
	MOVQ $0x0000001d3edc959b, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xa1e08d2968d80f03, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x8884c2416c7e12dd, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x801de4e313dddaef, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x5244271a526ea1c1, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xea2ce098a3d196c2, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x81b8518136d3ddb9, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xd2792e82b646b521, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x6abb0ffdf6400900, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x31775551d91adeab, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000001d3edc959b, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xa1e08d2968d80f03, AX
	ADDQ AX, DX
	MOVQ $0x8884c2416c7e12dd, AX
	ADCQ AX, CX
	MOVQ $0x801de4e313dddaef, AX
	ADCQ AX, BX
	MOVQ $0x5244271a526ea1c1, AX
	ADCQ AX, SI
	MOVQ $0xea2ce098a3d196c2, AX
	ADCQ AX, DI
	MOVQ $0x81b8518136d3ddb9, AX
	ADCQ AX, R8
	MOVQ $0xd2792e82b646b521, AX
	ADCQ AX, R9
	MOVQ $0x6abb0ffdf6400900, AX
	ADCQ AX, R10
	MOVQ $0x31775551d91adeab, AX
	ADCQ AX, R11
	MOVQ $0x0000001d3edc959b, AX
	ADCQ AX, R12
