...
var benchRese_nocarry_0613 e_nocarry_0613

func BenchmarkE_nocarry_0613SetBytes(b *testing.B) {
	var x e_nocarry_0613
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0613MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0613.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0613)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0613)
		}
	})
}

func BenchmarkE_nocarry_0613Inverse(b *testing.B) {
	var x e_nocarry_0613
	x.SetRandom()
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0613Butterfly(b *testing.B) {
	var x e_nocarry_0613
	x.SetRandom()
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0613)
	}
}

func BenchmarkE_nocarry_0613Exp(b *testing.B) {
	var x e_nocarry_0613
	x.SetRandom()
	benchRese_nocarry_0613.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0613Double(b *testing.B) {
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Double(&benchRese_nocarry_0613)
	}
}

func BenchmarkE_nocarry_0613Add(b *testing.B) {
	var x e_nocarry_0613
	x.SetRandom()
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Add(&x, &benchRese_nocarry_0613)
	}
}

func BenchmarkE_nocarry_0613Sub(b *testing.B) {
	var x e_nocarry_0613
	x.SetRandom()
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Sub(&x, &benchRese_nocarry_0613)
	}
}

func BenchmarkE_nocarry_0613Neg(b *testing.B) {
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Neg(&benchRese_nocarry_0613)
	}
}

func BenchmarkE_nocarry_0613Div(b *testing.B) {
	var x e_nocarry_0613
	x.SetRandom()
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Div(&x, &benchRese_nocarry_0613)
	}
}

func BenchmarkE_nocarry_0613FromMont(b *testing.B) {
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.FromMont()
	}
}

func BenchmarkE_nocarry_0613ToMont(b *testing.B) {
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.ToMont()
	}
}
func BenchmarkE_nocarry_0613Square(b *testing.B) {
	benchRese_nocarry_0613.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Square(&benchRese_nocarry_0613)
	}
}

func BenchmarkE_nocarry_0613Sqrt(b *testing.B) {
	var a e_nocarry_0613
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0613Mul(b *testing.B) {
	x := e_nocarry_0613{
		9677826603334499188,
	...
	benchRese_nocarry_0613.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Mul(&benchRese_nocarry_0613, &x)
	}
}

func BenchmarkE_nocarry_0613Cmp(b *testing.B) {
	x := e_nocarry_0613{
		9677826603334499188,
		13866986982692290038,
		8525671687491473540,
	...
	benchRese_nocarry_0613 = x
	benchRese_nocarry_0613[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0613.Cmp(&x)
	}
}

func TestE_nocarry_0613Cmp(t *testing.T) {
	var x, y e_nocarry_0613
...
func TestE_nocarry_0613IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0613
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0613

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0613{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0613
	one.SetOne()
	e.Sub(&qe_nocarry_0613, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0613{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0613{0, uint64(i)})
	}
...
func TestE_nocarry_0613NegZero(t *testing.T) {
	var a, b e_nocarry_0613
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0613Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0613, len(staticTestValues))
...
func TestE_nocarry_0613Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0613) bool {
			var b e_nocarry_0613
...
func TestE_nocarry_0613InverseExp(t *testing.T) {
...
func TestE_nocarry_0613MulByConstants(t *testing.T) {
...
func TestE_nocarry_0613Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0613) bool {
...
func TestE_nocarry_0613LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0613Halve(t *testing.T) {
...
func TestE_nocarry_0613FromMont(t *testing.T) {
...
type testPaire_nocarry_0613 struct {
	element e_nocarry_0613
	bigint  big.Int
}

func (z *e_nocarry_0613) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0613[9] {
		return true
	}
	if z[9] < qe_nocarry_0613[9] {
		return false
	...
	return z[0] >= qe_nocarry_0613[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0613

		g.element = e_nocarry_0613{
		...
		if qe_nocarry_0613[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0613[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0613 {
			var g e_nocarry_0613
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0613[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0613[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0613[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0613[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0613[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0613[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0613[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0613[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0613[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0613[9], carry)
...
func Benchmarke_nocarry_0613InverseNew(b *testing.B) {
	var x e_nocarry_0613
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0613
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0613
		var xInv e_nocarry_0613
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0613
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0613
...
func testLinearComb(t *testing.T, x *e_nocarry_0613, xC int64, y *e_nocarry_0613, yC int64) {
	...
	var z e_nocarry_0613
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0613, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0613
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0613, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0613
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0613, xHi uint64) {
	var res e_nocarry_0613
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0613) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0613) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0613, c int64, result *e_nocarry_0613, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0613) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0613) uint64 {
