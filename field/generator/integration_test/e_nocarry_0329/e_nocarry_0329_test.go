...
var benchRese_nocarry_0329 e_nocarry_0329

func BenchmarkE_nocarry_0329SetBytes(b *testing.B) {
	var x e_nocarry_0329
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0329MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0329.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0329)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0329)
		}
	})
}

func BenchmarkE_nocarry_0329Inverse(b *testing.B) {
	var x e_nocarry_0329
	x.SetRandom()
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0329Butterfly(b *testing.B) {
	var x e_nocarry_0329
	x.SetRandom()
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0329)
	}
}

func BenchmarkE_nocarry_0329Exp(b *testing.B) {
	var x e_nocarry_0329
	x.SetRandom()
	benchRese_nocarry_0329.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0329Double(b *testing.B) {
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Double(&benchRese_nocarry_0329)
	}
}

func BenchmarkE_nocarry_0329Add(b *testing.B) {
	var x e_nocarry_0329
	x.SetRandom()
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Add(&x, &benchRese_nocarry_0329)
	}
}

func BenchmarkE_nocarry_0329Sub(b *testing.B) {
	var x e_nocarry_0329
	x.SetRandom()
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Sub(&x, &benchRese_nocarry_0329)
	}
}

func BenchmarkE_nocarry_0329Neg(b *testing.B) {
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Neg(&benchRese_nocarry_0329)
	}
}

func BenchmarkE_nocarry_0329Div(b *testing.B) {
	var x e_nocarry_0329
	x.SetRandom()
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Div(&x, &benchRese_nocarry_0329)
	}
}

func BenchmarkE_nocarry_0329FromMont(b *testing.B) {
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.FromMont()
	}
}

func BenchmarkE_nocarry_0329ToMont(b *testing.B) {
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.ToMont()
	}
}
func BenchmarkE_nocarry_0329Square(b *testing.B) {
	benchRese_nocarry_0329.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Square(&benchRese_nocarry_0329)
	}
}

func BenchmarkE_nocarry_0329Sqrt(b *testing.B) {
	var a e_nocarry_0329
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0329Mul(b *testing.B) {
	x := e_nocarry_0329{
	...
	benchRese_nocarry_0329.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Mul(&benchRese_nocarry_0329, &x)
	}
}

func BenchmarkE_nocarry_0329Cmp(b *testing.B) {
	x := e_nocarry_0329{
		11790939337107990163,
		5095276044276023029,
		14988506635717574979,
	...
	benchRese_nocarry_0329 = x
	benchRese_nocarry_0329[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0329.Cmp(&x)
	}
}

func TestE_nocarry_0329Cmp(t *testing.T) {
	var x, y e_nocarry_0329
...
func TestE_nocarry_0329IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0329
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0329

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0329{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0329
	one.SetOne()
	e.Sub(&qe_nocarry_0329, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0329{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0329{0, uint64(i)})
	}
...
func TestE_nocarry_0329NegZero(t *testing.T) {
	var a, b e_nocarry_0329
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0329Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0329, len(staticTestValues))
...
func TestE_nocarry_0329Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0329) bool {
			var b e_nocarry_0329
...
func TestE_nocarry_0329InverseExp(t *testing.T) {
...
func TestE_nocarry_0329MulByConstants(t *testing.T) {
...
func TestE_nocarry_0329Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0329) bool {
...
func TestE_nocarry_0329LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0329Halve(t *testing.T) {
...
func TestE_nocarry_0329FromMont(t *testing.T) {
...
type testPaire_nocarry_0329 struct {
	element e_nocarry_0329
	bigint  big.Int
}

func (z *e_nocarry_0329) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0329[5] {
		return true
	}
	if z[5] < qe_nocarry_0329[5] {
		return false
	...
	return z[0] >= qe_nocarry_0329[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0329

		g.element = e_nocarry_0329{
		...
		if qe_nocarry_0329[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0329[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0329 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0329[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0329[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0329[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0329[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0329[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0329[5], carry)
...
func Benchmarke_nocarry_0329InverseNew(b *testing.B) {
	var x e_nocarry_0329
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0329
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0329
		var xInv e_nocarry_0329
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0329
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0329
...
func testLinearComb(t *testing.T, x *e_nocarry_0329, xC int64, y *e_nocarry_0329, yC int64) {
	...
	var z e_nocarry_0329
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0329, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0329
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0329, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0329
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0329, xHi uint64) {
	var res e_nocarry_0329
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0329) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0329) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0329, c int64, result *e_nocarry_0329, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0329) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0329) uint64 {
