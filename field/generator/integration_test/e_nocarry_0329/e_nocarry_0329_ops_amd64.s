...
// modulus q
DATA q<>+0(SB)/8, $0xcb1985f6973bb7d9
DATA q<>+8(SB)/8, $0xc0c667f75ad168d8
DATA q<>+16(SB)/8, $0x9be133932434f572
DATA q<>+24(SB)/8, $0xb67f824d5ad6661d
DATA q<>+32(SB)/8, $0x15a9aeada155eafc
DATA q<>+40(SB)/8, $0x00000000000001f0
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x82f19e9e5e98a797
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xcb1985f6973bb7d9, R10
	MOVQ    $0xc0c667f75ad168d8, R11
	MOVQ    $0x9be133932434f572, R12
	MOVQ    $0xb67f824d5ad6661d, R13
	MOVQ    $0x15a9aeada155eafc, R14
	MOVQ    $0x00000000000001f0, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xc0c667f75ad168d8, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x9be133932434f572, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xb67f824d5ad6661d, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x15a9aeada155eafc, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000000000001f0, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xcb1985f6973bb7d9, CX
	MOVQ    $0xc0c667f75ad168d8, BX
	MOVQ    $0x9be133932434f572, SI
	MOVQ    $0xb67f824d5ad6661d, DI
	MOVQ    $0x15a9aeada155eafc, R8
	MOVQ    $0x00000000000001f0, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
