...
// modulus q
DATA q<>+0(SB)/8, $0xa1198e6ac5a29bad
DATA q<>+8(SB)/8, $0xd29360a8c66ee6aa
DATA q<>+16(SB)/8, $0xb17cec436bbbf6ad
DATA q<>+24(SB)/8, $0x0000000000034125
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x32bb1671a2927fdb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xa1198e6ac5a29bad, R8
	MOVQ    $0xd29360a8c66ee6aa, R9
	MOVQ    $0xb17cec436bbbf6ad, R10
	MOVQ    $0x0000000000034125, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xd29360a8c66ee6aa, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xb17cec436bbbf6ad, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000000000034125, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xa1198e6ac5a29bad, R12
	MOVQ    $0xd29360a8c66ee6aa, R13
	MOVQ    $0xb17cec436bbbf6ad, R14
	MOVQ    $0x0000000000034125, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
