...
var benchRese_nocarry_0210 e_nocarry_0210

func BenchmarkE_nocarry_0210SetBytes(b *testing.B) {
	var x e_nocarry_0210
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0210MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0210.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0210)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0210)
		}
	})
}

func BenchmarkE_nocarry_0210Inverse(b *testing.B) {
	var x e_nocarry_0210
	x.SetRandom()
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0210Butterfly(b *testing.B) {
	var x e_nocarry_0210
	x.SetRandom()
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0210)
	}
}

func BenchmarkE_nocarry_0210Exp(b *testing.B) {
	var x e_nocarry_0210
	x.SetRandom()
	benchRese_nocarry_0210.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0210Double(b *testing.B) {
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Double(&benchRese_nocarry_0210)
	}
}

func BenchmarkE_nocarry_0210Add(b *testing.B) {
	var x e_nocarry_0210
	x.SetRandom()
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Add(&x, &benchRese_nocarry_0210)
	}
}

func BenchmarkE_nocarry_0210Sub(b *testing.B) {
	var x e_nocarry_0210
	x.SetRandom()
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Sub(&x, &benchRese_nocarry_0210)
	}
}

func BenchmarkE_nocarry_0210Neg(b *testing.B) {
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Neg(&benchRese_nocarry_0210)
	}
}

func BenchmarkE_nocarry_0210Div(b *testing.B) {
	var x e_nocarry_0210
	x.SetRandom()
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Div(&x, &benchRese_nocarry_0210)
	}
}

func BenchmarkE_nocarry_0210FromMont(b *testing.B) {
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.FromMont()
	}
}

func BenchmarkE_nocarry_0210ToMont(b *testing.B) {
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.ToMont()
	}
}
func BenchmarkE_nocarry_0210Square(b *testing.B) {
	benchRese_nocarry_0210.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Square(&benchRese_nocarry_0210)
	}
}

func BenchmarkE_nocarry_0210Sqrt(b *testing.B) {
	var a e_nocarry_0210
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0210Mul(b *testing.B) {
	x := e_nocarry_0210{
		1770781936195297045,
		935751253252396393,
		3674240116379279623,
	...
	benchRese_nocarry_0210.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Mul(&benchRese_nocarry_0210, &x)
	}
}

func BenchmarkE_nocarry_0210Cmp(b *testing.B) {
	x := e_nocarry_0210{
		1770781936195297045,
		935751253252396393,
		3674240116379279623,
	...
	benchRese_nocarry_0210 = x
	benchRese_nocarry_0210[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0210.Cmp(&x)
	}
}

func TestE_nocarry_0210Cmp(t *testing.T) {
	var x, y e_nocarry_0210
...
func TestE_nocarry_0210IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0210
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0210

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0210{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0210
	one.SetOne()
	e.Sub(&qe_nocarry_0210, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0210{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0210{0, uint64(i)})
	}
...
func TestE_nocarry_0210NegZero(t *testing.T) {
	var a, b e_nocarry_0210
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0210Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0210, len(staticTestValues))
...
func TestE_nocarry_0210Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0210) bool {
			var b e_nocarry_0210
...
func TestE_nocarry_0210InverseExp(t *testing.T) {
...
func TestE_nocarry_0210MulByConstants(t *testing.T) {
...
func TestE_nocarry_0210Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0210) bool {
...
func TestE_nocarry_0210LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0210Halve(t *testing.T) {
...
func TestE_nocarry_0210FromMont(t *testing.T) {
...
type testPaire_nocarry_0210 struct {
	element e_nocarry_0210
	bigint  big.Int
}

func (z *e_nocarry_0210) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0210[3] {
		return true
	}
	if z[3] < qe_nocarry_0210[3] {
		return false
	...
	return z[0] >= qe_nocarry_0210[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0210

		g.element = e_nocarry_0210{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0210[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0210[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0210 {
			var g e_nocarry_0210
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0210[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0210[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0210[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0210[3], carry)
...
func Benchmarke_nocarry_0210InverseNew(b *testing.B) {
	var x e_nocarry_0210
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0210
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0210
		var xInv e_nocarry_0210
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0210
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0210
...
func testLinearComb(t *testing.T, x *e_nocarry_0210, xC int64, y *e_nocarry_0210, yC int64) {
	...
	var z e_nocarry_0210
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0210, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0210
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0210, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0210
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0210, xHi uint64) {
	var res e_nocarry_0210
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0210) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0210) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0210, c int64, result *e_nocarry_0210, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0210) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0210) uint64 {
