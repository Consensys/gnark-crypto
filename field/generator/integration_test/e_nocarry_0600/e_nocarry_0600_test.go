...
var benchRese_nocarry_0600 e_nocarry_0600

func BenchmarkE_nocarry_0600SetBytes(b *testing.B) {
	var x e_nocarry_0600
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0600MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0600.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0600)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0600)
		}
	})
}

func BenchmarkE_nocarry_0600Inverse(b *testing.B) {
	var x e_nocarry_0600
	x.SetRandom()
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0600Butterfly(b *testing.B) {
	var x e_nocarry_0600
	x.SetRandom()
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0600)
	}
}

func BenchmarkE_nocarry_0600Exp(b *testing.B) {
	var x e_nocarry_0600
	x.SetRandom()
	benchRese_nocarry_0600.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0600Double(b *testing.B) {
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Double(&benchRese_nocarry_0600)
	}
}

func BenchmarkE_nocarry_0600Add(b *testing.B) {
	var x e_nocarry_0600
	x.SetRandom()
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Add(&x, &benchRese_nocarry_0600)
	}
}

func BenchmarkE_nocarry_0600Sub(b *testing.B) {
	var x e_nocarry_0600
	x.SetRandom()
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Sub(&x, &benchRese_nocarry_0600)
	}
}

func BenchmarkE_nocarry_0600Neg(b *testing.B) {
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Neg(&benchRese_nocarry_0600)
	}
}

func BenchmarkE_nocarry_0600Div(b *testing.B) {
	var x e_nocarry_0600
	x.SetRandom()
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Div(&x, &benchRese_nocarry_0600)
	}
}

func BenchmarkE_nocarry_0600FromMont(b *testing.B) {
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.FromMont()
	}
}

func BenchmarkE_nocarry_0600ToMont(b *testing.B) {
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.ToMont()
	}
}
func BenchmarkE_nocarry_0600Square(b *testing.B) {
	benchRese_nocarry_0600.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Square(&benchRese_nocarry_0600)
	}
}

func BenchmarkE_nocarry_0600Sqrt(b *testing.B) {
	var a e_nocarry_0600
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0600Mul(b *testing.B) {
	x := e_nocarry_0600{
	...
	benchRese_nocarry_0600.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Mul(&benchRese_nocarry_0600, &x)
	}
}

func BenchmarkE_nocarry_0600Cmp(b *testing.B) {
	x := e_nocarry_0600{
		11277672570725965430,
		18213133310339288324,
		7510915283986713208,
	...
	benchRese_nocarry_0600 = x
	benchRese_nocarry_0600[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0600.Cmp(&x)
	}
}

func TestE_nocarry_0600Cmp(t *testing.T) {
	var x, y e_nocarry_0600
...
func TestE_nocarry_0600IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0600
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0600

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0600{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0600
	one.SetOne()
	e.Sub(&qe_nocarry_0600, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0600{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0600{0, uint64(i)})
	}
...
func TestE_nocarry_0600NegZero(t *testing.T) {
	var a, b e_nocarry_0600
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0600Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0600, len(staticTestValues))
...
func TestE_nocarry_0600Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0600) bool {
			var b e_nocarry_0600
...
func TestE_nocarry_0600InverseExp(t *testing.T) {
...
func TestE_nocarry_0600MulByConstants(t *testing.T) {
...
func TestE_nocarry_0600Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0600) bool {
...
func TestE_nocarry_0600LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0600Halve(t *testing.T) {
...
func TestE_nocarry_0600FromMont(t *testing.T) {
...
type testPaire_nocarry_0600 struct {
	element e_nocarry_0600
	bigint  big.Int
}

func (z *e_nocarry_0600) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0600[9] {
		return true
	}
	if z[9] < qe_nocarry_0600[9] {
		return false
	...
	return z[0] >= qe_nocarry_0600[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0600

		g.element = e_nocarry_0600{
		...
		if qe_nocarry_0600[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0600[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0600 {
			var g e_nocarry_0600
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0600[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0600[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0600[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0600[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0600[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0600[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0600[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0600[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0600[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0600[9], carry)
...
func Benchmarke_nocarry_0600InverseNew(b *testing.B) {
	var x e_nocarry_0600
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0600
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0600
		var xInv e_nocarry_0600
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0600
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0600
...
func testLinearComb(t *testing.T, x *e_nocarry_0600, xC int64, y *e_nocarry_0600, yC int64) {
	...
	var z e_nocarry_0600
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0600, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0600
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0600, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0600
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0600, xHi uint64) {
	var res e_nocarry_0600
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0600) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0600) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0600, c int64, result *e_nocarry_0600, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0600) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0600) uint64 {
