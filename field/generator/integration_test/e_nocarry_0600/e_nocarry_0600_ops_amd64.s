...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x824edd239e4d325f, R13
	ADDQ R13, AX
	MOVQ $0x129293567ae7c4dc, R13
	ADCQ R13, DX
	MOVQ $0xfce7a5f0b3e54f75, R13
	ADCQ R13, CX
	MOVQ $0xa4d3befe33a6e046, R13
	ADCQ R13, BX
	MOVQ $0xdd34eef8c1ee8a90, R13
	ADCQ R13, SI
	MOVQ $0xfff57c1f0dc56110, R13
	ADCQ R13, DI
	MOVQ $0x927489942c18c4f1, R13
	ADCQ R13, R8
	MOVQ $0x58087f1f163ab253, R13
	ADCQ R13, R9
	MOVQ $0x3ed1e3702b4b2a2a, R13
	ADCQ R13, R10
	MOVQ $0x0000000000dac69f, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x824edd239e4d325f, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x129293567ae7c4dc, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xfce7a5f0b3e54f75, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xa4d3befe33a6e046, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xdd34eef8c1ee8a90, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xfff57c1f0dc56110, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x927489942c18c4f1, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x58087f1f163ab253, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x3ed1e3702b4b2a2a, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000000dac69f, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x824edd239e4d325f, AX
	ADDQ AX, DX
	MOVQ $0x129293567ae7c4dc, AX
	ADCQ AX, CX
	MOVQ $0xfce7a5f0b3e54f75, AX
	ADCQ AX, BX
	MOVQ $0xa4d3befe33a6e046, AX
	ADCQ AX, SI
	MOVQ $0xdd34eef8c1ee8a90, AX
	ADCQ AX, DI
	MOVQ $0xfff57c1f0dc56110, AX
	ADCQ AX, R8
	MOVQ $0x927489942c18c4f1, AX
	ADCQ AX, R9
	MOVQ $0x58087f1f163ab253, AX
	ADCQ AX, R10
	MOVQ $0x3ed1e3702b4b2a2a, AX
	ADCQ AX, R11
	MOVQ $0x0000000000dac69f, AX
	ADCQ AX, R12
