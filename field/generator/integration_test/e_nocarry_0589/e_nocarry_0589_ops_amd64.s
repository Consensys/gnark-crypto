...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x25cecd5e5e877f57, R13
	ADDQ R13, AX
	MOVQ $0x2202271e6f14d143, R13
	ADCQ R13, DX
	MOVQ $0x4f124e10bbcfb1d9, R13
	ADCQ R13, CX
	MOVQ $0xabe83b371ec0579d, R13
	ADCQ R13, BX
	MOVQ $0xada8d19288d3f75e, R13
	ADCQ R13, SI
	MOVQ $0x03793a31712bb3f5, R13
	ADCQ R13, DI
	MOVQ $0xab4c90ed7f9cf366, R13
	ADCQ R13, R8
	MOVQ $0x95305c17ca3045d0, R13
	ADCQ R13, R9
	MOVQ $0x1f4deaa4389dd7dc, R13
	ADCQ R13, R10
	MOVQ $0x00000000000019f5, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x25cecd5e5e877f57, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x2202271e6f14d143, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x4f124e10bbcfb1d9, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xabe83b371ec0579d, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xada8d19288d3f75e, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x03793a31712bb3f5, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xab4c90ed7f9cf366, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x95305c17ca3045d0, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x1f4deaa4389dd7dc, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000000019f5, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x25cecd5e5e877f57, AX
	ADDQ AX, DX
	MOVQ $0x2202271e6f14d143, AX
	ADCQ AX, CX
	MOVQ $0x4f124e10bbcfb1d9, AX
	ADCQ AX, BX
	MOVQ $0xabe83b371ec0579d, AX
	ADCQ AX, SI
	MOVQ $0xada8d19288d3f75e, AX
	ADCQ AX, DI
	MOVQ $0x03793a31712bb3f5, AX
	ADCQ AX, R8
	MOVQ $0xab4c90ed7f9cf366, AX
	ADCQ AX, R9
	MOVQ $0x95305c17ca3045d0, AX
	ADCQ AX, R10
	MOVQ $0x1f4deaa4389dd7dc, AX
	ADCQ AX, R11
	MOVQ $0x00000000000019f5, AX
	ADCQ AX, R12
