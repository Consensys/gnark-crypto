...
var benchRese_nocarry_0589 e_nocarry_0589

func BenchmarkE_nocarry_0589SetBytes(b *testing.B) {
	var x e_nocarry_0589
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0589MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0589.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0589)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0589)
		}
	})
}

func BenchmarkE_nocarry_0589Inverse(b *testing.B) {
	var x e_nocarry_0589
	x.SetRandom()
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0589Butterfly(b *testing.B) {
	var x e_nocarry_0589
	x.SetRandom()
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0589)
	}
}

func BenchmarkE_nocarry_0589Exp(b *testing.B) {
	var x e_nocarry_0589
	x.SetRandom()
	benchRese_nocarry_0589.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0589Double(b *testing.B) {
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Double(&benchRese_nocarry_0589)
	}
}

func BenchmarkE_nocarry_0589Add(b *testing.B) {
	var x e_nocarry_0589
	x.SetRandom()
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Add(&x, &benchRese_nocarry_0589)
	}
}

func BenchmarkE_nocarry_0589Sub(b *testing.B) {
	var x e_nocarry_0589
	x.SetRandom()
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Sub(&x, &benchRese_nocarry_0589)
	}
}

func BenchmarkE_nocarry_0589Neg(b *testing.B) {
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Neg(&benchRese_nocarry_0589)
	}
}

func BenchmarkE_nocarry_0589Div(b *testing.B) {
	var x e_nocarry_0589
	x.SetRandom()
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Div(&x, &benchRese_nocarry_0589)
	}
}

func BenchmarkE_nocarry_0589FromMont(b *testing.B) {
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.FromMont()
	}
}

func BenchmarkE_nocarry_0589ToMont(b *testing.B) {
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.ToMont()
	}
}
func BenchmarkE_nocarry_0589Square(b *testing.B) {
	benchRese_nocarry_0589.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Square(&benchRese_nocarry_0589)
	}
}

func BenchmarkE_nocarry_0589Sqrt(b *testing.B) {
	var a e_nocarry_0589
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0589Mul(b *testing.B) {
	x := e_nocarry_0589{
		6334342449505086854,
		8136975984490010297,
	...
	benchRese_nocarry_0589.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Mul(&benchRese_nocarry_0589, &x)
	}
}

func BenchmarkE_nocarry_0589Cmp(b *testing.B) {
	x := e_nocarry_0589{
		6334342449505086854,
		8136975984490010297,
		13980672891637892408,
	...
	benchRese_nocarry_0589 = x
	benchRese_nocarry_0589[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0589.Cmp(&x)
	}
}

func TestE_nocarry_0589Cmp(t *testing.T) {
	var x, y e_nocarry_0589
...
func TestE_nocarry_0589IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0589
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0589

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0589{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0589
	one.SetOne()
	e.Sub(&qe_nocarry_0589, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0589{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0589{0, uint64(i)})
	}
...
func TestE_nocarry_0589NegZero(t *testing.T) {
	var a, b e_nocarry_0589
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0589Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0589, len(staticTestValues))
...
func TestE_nocarry_0589Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0589) bool {
			var b e_nocarry_0589
...
func TestE_nocarry_0589InverseExp(t *testing.T) {
...
func TestE_nocarry_0589MulByConstants(t *testing.T) {
...
func TestE_nocarry_0589Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0589) bool {
...
func TestE_nocarry_0589LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0589Halve(t *testing.T) {
...
func TestE_nocarry_0589FromMont(t *testing.T) {
...
type testPaire_nocarry_0589 struct {
	element e_nocarry_0589
	bigint  big.Int
}

func (z *e_nocarry_0589) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0589[9] {
		return true
	}
	if z[9] < qe_nocarry_0589[9] {
		return false
	...
	return z[0] >= qe_nocarry_0589[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0589

		g.element = e_nocarry_0589{
		...
		if qe_nocarry_0589[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0589[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0589 {
			var g e_nocarry_0589
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0589[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0589[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0589[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0589[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0589[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0589[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0589[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0589[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0589[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0589[9], carry)
...
func Benchmarke_nocarry_0589InverseNew(b *testing.B) {
	var x e_nocarry_0589
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0589
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0589
		var xInv e_nocarry_0589
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0589
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0589
...
func testLinearComb(t *testing.T, x *e_nocarry_0589, xC int64, y *e_nocarry_0589, yC int64) {
	...
	var z e_nocarry_0589
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0589, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0589
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0589, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0589
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0589, xHi uint64) {
	var res e_nocarry_0589
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0589) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0589) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0589, c int64, result *e_nocarry_0589, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0589) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0589) uint64 {
