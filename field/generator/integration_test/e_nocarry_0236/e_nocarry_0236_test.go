...
var benchRese_nocarry_0236 e_nocarry_0236

func BenchmarkE_nocarry_0236SetBytes(b *testing.B) {
	var x e_nocarry_0236
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0236MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0236.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0236)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0236)
		}
	})
}

func BenchmarkE_nocarry_0236Inverse(b *testing.B) {
	var x e_nocarry_0236
	x.SetRandom()
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0236Butterfly(b *testing.B) {
	var x e_nocarry_0236
	x.SetRandom()
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0236)
	}
}

func BenchmarkE_nocarry_0236Exp(b *testing.B) {
	var x e_nocarry_0236
	x.SetRandom()
	benchRese_nocarry_0236.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0236Double(b *testing.B) {
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Double(&benchRese_nocarry_0236)
	}
}

func BenchmarkE_nocarry_0236Add(b *testing.B) {
	var x e_nocarry_0236
	x.SetRandom()
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Add(&x, &benchRese_nocarry_0236)
	}
}

func BenchmarkE_nocarry_0236Sub(b *testing.B) {
	var x e_nocarry_0236
	x.SetRandom()
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Sub(&x, &benchRese_nocarry_0236)
	}
}

func BenchmarkE_nocarry_0236Neg(b *testing.B) {
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Neg(&benchRese_nocarry_0236)
	}
}

func BenchmarkE_nocarry_0236Div(b *testing.B) {
	var x e_nocarry_0236
	x.SetRandom()
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Div(&x, &benchRese_nocarry_0236)
	}
}

func BenchmarkE_nocarry_0236FromMont(b *testing.B) {
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.FromMont()
	}
}

func BenchmarkE_nocarry_0236ToMont(b *testing.B) {
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.ToMont()
	}
}
func BenchmarkE_nocarry_0236Square(b *testing.B) {
	benchRese_nocarry_0236.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Square(&benchRese_nocarry_0236)
	}
}

func BenchmarkE_nocarry_0236Sqrt(b *testing.B) {
	var a e_nocarry_0236
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0236Mul(b *testing.B) {
	x := e_nocarry_0236{
	...
	benchRese_nocarry_0236.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Mul(&benchRese_nocarry_0236, &x)
	}
}

func BenchmarkE_nocarry_0236Cmp(b *testing.B) {
	x := e_nocarry_0236{
		14134034241212629204,
		13523981681105836217,
		3788096096751987131,
	...
	benchRese_nocarry_0236 = x
	benchRese_nocarry_0236[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0236.Cmp(&x)
	}
}

func TestE_nocarry_0236Cmp(t *testing.T) {
	var x, y e_nocarry_0236
...
func TestE_nocarry_0236IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0236
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0236

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0236{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0236
	one.SetOne()
	e.Sub(&qe_nocarry_0236, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0236{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0236{0, uint64(i)})
	}
...
func TestE_nocarry_0236NegZero(t *testing.T) {
	var a, b e_nocarry_0236
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0236Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0236, len(staticTestValues))
...
func TestE_nocarry_0236Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0236) bool {
			var b e_nocarry_0236
...
func TestE_nocarry_0236InverseExp(t *testing.T) {
...
func TestE_nocarry_0236MulByConstants(t *testing.T) {
...
func TestE_nocarry_0236Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0236) bool {
...
func TestE_nocarry_0236LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0236Halve(t *testing.T) {
...
func TestE_nocarry_0236FromMont(t *testing.T) {
...
type testPaire_nocarry_0236 struct {
	element e_nocarry_0236
	bigint  big.Int
}

func (z *e_nocarry_0236) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0236[3] {
		return true
	}
	if z[3] < qe_nocarry_0236[3] {
		return false
	...
	return z[0] >= qe_nocarry_0236[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0236

		g.element = e_nocarry_0236{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0236[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0236[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0236 {
			var g e_nocarry_0236
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0236[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0236[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0236[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0236[3], carry)
...
func Benchmarke_nocarry_0236InverseNew(b *testing.B) {
	var x e_nocarry_0236
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0236
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0236
		var xInv e_nocarry_0236
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0236
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0236
...
func testLinearComb(t *testing.T, x *e_nocarry_0236, xC int64, y *e_nocarry_0236, yC int64) {
	...
	var z e_nocarry_0236
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0236, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0236
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0236, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0236
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0236, xHi uint64) {
	var res e_nocarry_0236
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0236) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0236) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0236, c int64, result *e_nocarry_0236, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0236) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0236) uint64 {
