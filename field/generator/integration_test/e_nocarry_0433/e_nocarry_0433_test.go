...
var benchRese_nocarry_0433 e_nocarry_0433

func BenchmarkE_nocarry_0433SetBytes(b *testing.B) {
	var x e_nocarry_0433
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0433MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0433.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0433)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0433)
		}
	})
}

func BenchmarkE_nocarry_0433Inverse(b *testing.B) {
	var x e_nocarry_0433
	x.SetRandom()
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0433Butterfly(b *testing.B) {
	var x e_nocarry_0433
	x.SetRandom()
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0433)
	}
}

func BenchmarkE_nocarry_0433Exp(b *testing.B) {
	var x e_nocarry_0433
	x.SetRandom()
	benchRese_nocarry_0433.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0433Double(b *testing.B) {
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Double(&benchRese_nocarry_0433)
	}
}

func BenchmarkE_nocarry_0433Add(b *testing.B) {
	var x e_nocarry_0433
	x.SetRandom()
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Add(&x, &benchRese_nocarry_0433)
	}
}

func BenchmarkE_nocarry_0433Sub(b *testing.B) {
	var x e_nocarry_0433
	x.SetRandom()
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Sub(&x, &benchRese_nocarry_0433)
	}
}

func BenchmarkE_nocarry_0433Neg(b *testing.B) {
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Neg(&benchRese_nocarry_0433)
	}
}

func BenchmarkE_nocarry_0433Div(b *testing.B) {
	var x e_nocarry_0433
	x.SetRandom()
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Div(&x, &benchRese_nocarry_0433)
	}
}

func BenchmarkE_nocarry_0433FromMont(b *testing.B) {
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.FromMont()
	}
}

func BenchmarkE_nocarry_0433ToMont(b *testing.B) {
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.ToMont()
	}
}
func BenchmarkE_nocarry_0433Square(b *testing.B) {
	benchRese_nocarry_0433.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Square(&benchRese_nocarry_0433)
	}
}

func BenchmarkE_nocarry_0433Sqrt(b *testing.B) {
	var a e_nocarry_0433
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0433Mul(b *testing.B) {
	x := e_nocarry_0433{
	...
	benchRese_nocarry_0433.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Mul(&benchRese_nocarry_0433, &x)
	}
}

func BenchmarkE_nocarry_0433Cmp(b *testing.B) {
	x := e_nocarry_0433{
		16609827228604933342,
		5425547463077148792,
		4528075105787659397,
	...
	benchRese_nocarry_0433 = x
	benchRese_nocarry_0433[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0433.Cmp(&x)
	}
}

func TestE_nocarry_0433Cmp(t *testing.T) {
	var x, y e_nocarry_0433
...
func TestE_nocarry_0433IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0433
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0433

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0433{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0433
	one.SetOne()
	e.Sub(&qe_nocarry_0433, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0433{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0433{0, uint64(i)})
	}
...
func TestE_nocarry_0433NegZero(t *testing.T) {
	var a, b e_nocarry_0433
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0433Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0433, len(staticTestValues))
...
func TestE_nocarry_0433Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0433) bool {
			var b e_nocarry_0433
...
func TestE_nocarry_0433InverseExp(t *testing.T) {
...
func TestE_nocarry_0433MulByConstants(t *testing.T) {
...
func TestE_nocarry_0433Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0433) bool {
...
func TestE_nocarry_0433LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0433Halve(t *testing.T) {
...
func TestE_nocarry_0433FromMont(t *testing.T) {
...
type testPaire_nocarry_0433 struct {
	element e_nocarry_0433
	bigint  big.Int
}

func (z *e_nocarry_0433) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0433[6] {
		return true
	}
	if z[6] < qe_nocarry_0433[6] {
		return false
	...
	return z[0] >= qe_nocarry_0433[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0433

		g.element = e_nocarry_0433{
		...
		if qe_nocarry_0433[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0433[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0433 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0433[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0433[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0433[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0433[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0433[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0433[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0433[6], carry)
...
func Benchmarke_nocarry_0433InverseNew(b *testing.B) {
	var x e_nocarry_0433
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0433
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0433
		var xInv e_nocarry_0433
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0433
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0433
...
func testLinearComb(t *testing.T, x *e_nocarry_0433, xC int64, y *e_nocarry_0433, yC int64) {
	...
	var z e_nocarry_0433
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0433, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0433
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0433, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0433
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0433, xHi uint64) {
	var res e_nocarry_0433
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0433) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0433) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0433, c int64, result *e_nocarry_0433, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0433) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0433) uint64 {
