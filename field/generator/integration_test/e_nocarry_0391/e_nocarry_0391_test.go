...
var benchRese_nocarry_0391 e_nocarry_0391

func BenchmarkE_nocarry_0391SetBytes(b *testing.B) {
	var x e_nocarry_0391
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0391MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0391.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0391)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0391)
		}
	})
}

func BenchmarkE_nocarry_0391Inverse(b *testing.B) {
	var x e_nocarry_0391
	x.SetRandom()
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0391Butterfly(b *testing.B) {
	var x e_nocarry_0391
	x.SetRandom()
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0391)
	}
}

func BenchmarkE_nocarry_0391Exp(b *testing.B) {
	var x e_nocarry_0391
	x.SetRandom()
	benchRese_nocarry_0391.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0391Double(b *testing.B) {
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Double(&benchRese_nocarry_0391)
	}
}

func BenchmarkE_nocarry_0391Add(b *testing.B) {
	var x e_nocarry_0391
	x.SetRandom()
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Add(&x, &benchRese_nocarry_0391)
	}
}

func BenchmarkE_nocarry_0391Sub(b *testing.B) {
	var x e_nocarry_0391
	x.SetRandom()
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Sub(&x, &benchRese_nocarry_0391)
	}
}

func BenchmarkE_nocarry_0391Neg(b *testing.B) {
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Neg(&benchRese_nocarry_0391)
	}
}

func BenchmarkE_nocarry_0391Div(b *testing.B) {
	var x e_nocarry_0391
	x.SetRandom()
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Div(&x, &benchRese_nocarry_0391)
	}
}

func BenchmarkE_nocarry_0391FromMont(b *testing.B) {
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.FromMont()
	}
}

func BenchmarkE_nocarry_0391ToMont(b *testing.B) {
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.ToMont()
	}
}
func BenchmarkE_nocarry_0391Square(b *testing.B) {
	benchRese_nocarry_0391.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Square(&benchRese_nocarry_0391)
	}
}

func BenchmarkE_nocarry_0391Sqrt(b *testing.B) {
	var a e_nocarry_0391
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0391Mul(b *testing.B) {
	x := e_nocarry_0391{
		3104054187291156105,
		157382064436852765,
	...
	benchRese_nocarry_0391.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Mul(&benchRese_nocarry_0391, &x)
	}
}

func BenchmarkE_nocarry_0391Cmp(b *testing.B) {
	x := e_nocarry_0391{
		3104054187291156105,
		157382064436852765,
		13315139751620771478,
	...
	benchRese_nocarry_0391 = x
	benchRese_nocarry_0391[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0391.Cmp(&x)
	}
}

func TestE_nocarry_0391Cmp(t *testing.T) {
	var x, y e_nocarry_0391
...
func TestE_nocarry_0391IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0391
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0391

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0391{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0391
	one.SetOne()
	e.Sub(&qe_nocarry_0391, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0391{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0391{0, uint64(i)})
	}
...
func TestE_nocarry_0391NegZero(t *testing.T) {
	var a, b e_nocarry_0391
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0391Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0391, len(staticTestValues))
...
func TestE_nocarry_0391Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0391) bool {
			var b e_nocarry_0391
...
func TestE_nocarry_0391InverseExp(t *testing.T) {
...
func TestE_nocarry_0391MulByConstants(t *testing.T) {
...
func TestE_nocarry_0391Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0391) bool {
...
func TestE_nocarry_0391LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0391Halve(t *testing.T) {
...
func TestE_nocarry_0391FromMont(t *testing.T) {
...
type testPaire_nocarry_0391 struct {
	element e_nocarry_0391
	bigint  big.Int
}

func (z *e_nocarry_0391) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0391[6] {
		return true
	}
	if z[6] < qe_nocarry_0391[6] {
		return false
	...
	return z[0] >= qe_nocarry_0391[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0391

		g.element = e_nocarry_0391{
		...
		if qe_nocarry_0391[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0391[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0391 {
			var g e_nocarry_0391
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0391[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0391[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0391[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0391[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0391[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0391[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0391[6], carry)
...
func Benchmarke_nocarry_0391InverseNew(b *testing.B) {
	var x e_nocarry_0391
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0391
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0391
		var xInv e_nocarry_0391
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0391
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0391
...
func testLinearComb(t *testing.T, x *e_nocarry_0391, xC int64, y *e_nocarry_0391, yC int64) {
	...
	var z e_nocarry_0391
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0391, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0391
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0391, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0391
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0391, xHi uint64) {
	var res e_nocarry_0391
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0391) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0391) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0391, c int64, result *e_nocarry_0391, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0391) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0391) uint64 {
