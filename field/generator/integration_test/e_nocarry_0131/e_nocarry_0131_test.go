...
var benchRese_nocarry_0131 e_nocarry_0131

func BenchmarkE_nocarry_0131SetBytes(b *testing.B) {
	var x e_nocarry_0131
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0131MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0131.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0131)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0131)
		}
	})
}

func BenchmarkE_nocarry_0131Inverse(b *testing.B) {
	var x e_nocarry_0131
	x.SetRandom()
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0131Butterfly(b *testing.B) {
	var x e_nocarry_0131
	x.SetRandom()
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0131)
	}
}

func BenchmarkE_nocarry_0131Exp(b *testing.B) {
	var x e_nocarry_0131
	x.SetRandom()
	benchRese_nocarry_0131.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0131Double(b *testing.B) {
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Double(&benchRese_nocarry_0131)
	}
}

func BenchmarkE_nocarry_0131Add(b *testing.B) {
	var x e_nocarry_0131
	x.SetRandom()
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Add(&x, &benchRese_nocarry_0131)
	}
}

func BenchmarkE_nocarry_0131Sub(b *testing.B) {
	var x e_nocarry_0131
	x.SetRandom()
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Sub(&x, &benchRese_nocarry_0131)
	}
}

func BenchmarkE_nocarry_0131Neg(b *testing.B) {
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Neg(&benchRese_nocarry_0131)
	}
}

func BenchmarkE_nocarry_0131Div(b *testing.B) {
	var x e_nocarry_0131
	x.SetRandom()
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Div(&x, &benchRese_nocarry_0131)
	}
}

func BenchmarkE_nocarry_0131FromMont(b *testing.B) {
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.FromMont()
	}
}

func BenchmarkE_nocarry_0131ToMont(b *testing.B) {
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.ToMont()
	}
}
func BenchmarkE_nocarry_0131Square(b *testing.B) {
	benchRese_nocarry_0131.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Square(&benchRese_nocarry_0131)
	}
}

func BenchmarkE_nocarry_0131Sqrt(b *testing.B) {
	var a e_nocarry_0131
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0131Mul(b *testing.B) {
	x := e_nocarry_0131{
		6190807228309686849,
		17793320744343680040,
		2,
	}
	benchRese_nocarry_0131.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Mul(&benchRese_nocarry_0131, &x)
	}
}

func BenchmarkE_nocarry_0131Cmp(b *testing.B) {
	x := e_nocarry_0131{
		6190807228309686849,
		17793320744343680040,
		2,
	}
	benchRese_nocarry_0131 = x
	benchRese_nocarry_0131[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0131.Cmp(&x)
	}
}

func TestE_nocarry_0131Cmp(t *testing.T) {
	var x, y e_nocarry_0131
...
func TestE_nocarry_0131IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0131
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0131

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0131{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0131
	one.SetOne()
	e.Sub(&qe_nocarry_0131, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0131{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0131{0, uint64(i)})
	}
...
func TestE_nocarry_0131NegZero(t *testing.T) {
	var a, b e_nocarry_0131
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0131Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0131, len(staticTestValues))
...
func TestE_nocarry_0131Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0131) bool {
			var b e_nocarry_0131
...
func TestE_nocarry_0131InverseExp(t *testing.T) {
...
func TestE_nocarry_0131MulByConstants(t *testing.T) {
...
func TestE_nocarry_0131Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0131) bool {
...
func TestE_nocarry_0131LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0131Halve(t *testing.T) {
...
func TestE_nocarry_0131FromMont(t *testing.T) {
...
type testPaire_nocarry_0131 struct {
	element e_nocarry_0131
	bigint  big.Int
}

func (z *e_nocarry_0131) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0131[2] {
		return true
	}
	if z[2] < qe_nocarry_0131[2] {
		return false
	...
	return z[0] >= qe_nocarry_0131[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0131

		g.element = e_nocarry_0131{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0131[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0131[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0131 {
			var g e_nocarry_0131
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0131[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0131[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0131[2], carry)
...
func Benchmarke_nocarry_0131InverseNew(b *testing.B) {
	var x e_nocarry_0131
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0131
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0131
		var xInv e_nocarry_0131
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0131
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0131
...
func testLinearComb(t *testing.T, x *e_nocarry_0131, xC int64, y *e_nocarry_0131, yC int64) {
	...
	var z e_nocarry_0131
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0131, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0131
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0131, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0131
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0131, xHi uint64) {
	var res e_nocarry_0131
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0131) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0131) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0131, c int64, result *e_nocarry_0131, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0131) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0131) uint64 {
