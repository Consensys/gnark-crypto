...
// modulus q
DATA q<>+0(SB)/8, $0x99515e35dd024675
DATA q<>+8(SB)/8, $0x4ce0e03968907af3
DATA q<>+16(SB)/8, $0x0000000000000006
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0aded2ea9fef2623
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x99515e35dd024675, DI
	MOVQ    $0x4ce0e03968907af3, R8
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x4ce0e03968907af3, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x0000000000000006, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x99515e35dd024675, R10
	MOVQ    $0x4ce0e03968907af3, R11
	MOVQ    $0x0000000000000006, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
