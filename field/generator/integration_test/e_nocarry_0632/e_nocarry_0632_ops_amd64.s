...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x0b53435123d18969, R13
	ADDQ R13, AX
	MOVQ $0x58a62da800e478e1, R13
	ADCQ R13, DX
	MOVQ $0xc9bd2bb8e6434708, R13
	ADCQ R13, CX
	MOVQ $0x30f6bc80ae12e10c, R13
	ADCQ R13, BX
	MOVQ $0x6401c56762d357fc, R13
	ADCQ R13, SI
	MOVQ $0x479b7fc530ec7ff2, R13
	ADCQ R13, DI
	MOVQ $0x3b5c0eeb23cc3fab, R13
	ADCQ R13, R8
	MOVQ $0x1f420e3fd011447e, R13
	ADCQ R13, R9
	MOVQ $0x28b658e9998d7fb1, R13
	ADCQ R13, R10
	MOVQ $0x00e5ca1e08ff56a3, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x0b53435123d18969, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x58a62da800e478e1, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xc9bd2bb8e6434708, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x30f6bc80ae12e10c, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x6401c56762d357fc, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x479b7fc530ec7ff2, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x3b5c0eeb23cc3fab, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x1f420e3fd011447e, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x28b658e9998d7fb1, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00e5ca1e08ff56a3, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x0b53435123d18969, AX
	ADDQ AX, DX
	MOVQ $0x58a62da800e478e1, AX
	ADCQ AX, CX
	MOVQ $0xc9bd2bb8e6434708, AX
	ADCQ AX, BX
	MOVQ $0x30f6bc80ae12e10c, AX
	ADCQ AX, SI
	MOVQ $0x6401c56762d357fc, AX
	ADCQ AX, DI
	MOVQ $0x479b7fc530ec7ff2, AX
	ADCQ AX, R8
	MOVQ $0x3b5c0eeb23cc3fab, AX
	ADCQ AX, R9
	MOVQ $0x1f420e3fd011447e, AX
	ADCQ AX, R10
	MOVQ $0x28b658e9998d7fb1, AX
	ADCQ AX, R11
	MOVQ $0x00e5ca1e08ff56a3, AX
	ADCQ AX, R12
