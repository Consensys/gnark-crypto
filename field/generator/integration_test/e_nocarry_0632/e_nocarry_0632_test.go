...
var benchRese_nocarry_0632 e_nocarry_0632

func BenchmarkE_nocarry_0632SetBytes(b *testing.B) {
	var x e_nocarry_0632
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0632MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0632.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0632)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0632)
		}
	})
}

func BenchmarkE_nocarry_0632Inverse(b *testing.B) {
	var x e_nocarry_0632
	x.SetRandom()
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0632Butterfly(b *testing.B) {
	var x e_nocarry_0632
	x.SetRandom()
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0632)
	}
}

func BenchmarkE_nocarry_0632Exp(b *testing.B) {
	var x e_nocarry_0632
	x.SetRandom()
	benchRese_nocarry_0632.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0632Double(b *testing.B) {
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Double(&benchRese_nocarry_0632)
	}
}

func BenchmarkE_nocarry_0632Add(b *testing.B) {
	var x e_nocarry_0632
	x.SetRandom()
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Add(&x, &benchRese_nocarry_0632)
	}
}

func BenchmarkE_nocarry_0632Sub(b *testing.B) {
	var x e_nocarry_0632
	x.SetRandom()
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Sub(&x, &benchRese_nocarry_0632)
	}
}

func BenchmarkE_nocarry_0632Neg(b *testing.B) {
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Neg(&benchRese_nocarry_0632)
	}
}

func BenchmarkE_nocarry_0632Div(b *testing.B) {
	var x e_nocarry_0632
	x.SetRandom()
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Div(&x, &benchRese_nocarry_0632)
	}
}

func BenchmarkE_nocarry_0632FromMont(b *testing.B) {
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.FromMont()
	}
}

func BenchmarkE_nocarry_0632ToMont(b *testing.B) {
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.ToMont()
	}
}
func BenchmarkE_nocarry_0632Square(b *testing.B) {
	benchRese_nocarry_0632.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Square(&benchRese_nocarry_0632)
	}
}

func BenchmarkE_nocarry_0632Sqrt(b *testing.B) {
	var a e_nocarry_0632
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0632Mul(b *testing.B) {
	x := e_nocarry_0632{
	...
	benchRese_nocarry_0632.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Mul(&benchRese_nocarry_0632, &x)
	}
}

func BenchmarkE_nocarry_0632Cmp(b *testing.B) {
	x := e_nocarry_0632{
		14095748637358075099,
		14972327332075549804,
		7361626879976866655,
	...
	benchRese_nocarry_0632 = x
	benchRese_nocarry_0632[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0632.Cmp(&x)
	}
}

func TestE_nocarry_0632Cmp(t *testing.T) {
	var x, y e_nocarry_0632
...
func TestE_nocarry_0632IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0632
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0632

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0632{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0632
	one.SetOne()
	e.Sub(&qe_nocarry_0632, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0632{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0632{0, uint64(i)})
	}
...
func TestE_nocarry_0632NegZero(t *testing.T) {
	var a, b e_nocarry_0632
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0632Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0632, len(staticTestValues))
...
func TestE_nocarry_0632Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0632) bool {
			var b e_nocarry_0632
...
func TestE_nocarry_0632InverseExp(t *testing.T) {
...
func TestE_nocarry_0632MulByConstants(t *testing.T) {
...
func TestE_nocarry_0632Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0632) bool {
...
func TestE_nocarry_0632LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0632Halve(t *testing.T) {
...
func TestE_nocarry_0632FromMont(t *testing.T) {
...
type testPaire_nocarry_0632 struct {
	element e_nocarry_0632
	bigint  big.Int
}

func (z *e_nocarry_0632) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0632[9] {
		return true
	}
	if z[9] < qe_nocarry_0632[9] {
		return false
	...
	return z[0] >= qe_nocarry_0632[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0632

		g.element = e_nocarry_0632{
		...
		if qe_nocarry_0632[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0632[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0632 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0632[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0632[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0632[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0632[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0632[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0632[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0632[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0632[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0632[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0632[9], carry)
...
func Benchmarke_nocarry_0632InverseNew(b *testing.B) {
	var x e_nocarry_0632
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0632
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0632
		var xInv e_nocarry_0632
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0632
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0632
...
func testLinearComb(t *testing.T, x *e_nocarry_0632, xC int64, y *e_nocarry_0632, yC int64) {
	...
	var z e_nocarry_0632
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0632, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0632
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0632, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0632
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0632, xHi uint64) {
	var res e_nocarry_0632
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0632) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0632) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0632, c int64, result *e_nocarry_0632, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0632) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0632) uint64 {
