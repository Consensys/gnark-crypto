...
var benchRese_nocarry_0472 e_nocarry_0472

func BenchmarkE_nocarry_0472SetBytes(b *testing.B) {
	var x e_nocarry_0472
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0472MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0472.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0472)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0472)
		}
	})
}

func BenchmarkE_nocarry_0472Inverse(b *testing.B) {
	var x e_nocarry_0472
	x.SetRandom()
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0472Butterfly(b *testing.B) {
	var x e_nocarry_0472
	x.SetRandom()
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0472)
	}
}

func BenchmarkE_nocarry_0472Exp(b *testing.B) {
	var x e_nocarry_0472
	x.SetRandom()
	benchRese_nocarry_0472.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0472Double(b *testing.B) {
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Double(&benchRese_nocarry_0472)
	}
}

func BenchmarkE_nocarry_0472Add(b *testing.B) {
	var x e_nocarry_0472
	x.SetRandom()
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Add(&x, &benchRese_nocarry_0472)
	}
}

func BenchmarkE_nocarry_0472Sub(b *testing.B) {
	var x e_nocarry_0472
	x.SetRandom()
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Sub(&x, &benchRese_nocarry_0472)
	}
}

func BenchmarkE_nocarry_0472Neg(b *testing.B) {
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Neg(&benchRese_nocarry_0472)
	}
}

func BenchmarkE_nocarry_0472Div(b *testing.B) {
	var x e_nocarry_0472
	x.SetRandom()
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Div(&x, &benchRese_nocarry_0472)
	}
}

func BenchmarkE_nocarry_0472FromMont(b *testing.B) {
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.FromMont()
	}
}

func BenchmarkE_nocarry_0472ToMont(b *testing.B) {
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.ToMont()
	}
}
func BenchmarkE_nocarry_0472Square(b *testing.B) {
	benchRese_nocarry_0472.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Square(&benchRese_nocarry_0472)
	}
}

func BenchmarkE_nocarry_0472Sqrt(b *testing.B) {
	var a e_nocarry_0472
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0472Mul(b *testing.B) {
	x := e_nocarry_0472{
	...
	benchRese_nocarry_0472.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Mul(&benchRese_nocarry_0472, &x)
	}
}

func BenchmarkE_nocarry_0472Cmp(b *testing.B) {
	x := e_nocarry_0472{
		10433326033758727629,
		7947234372306043542,
		12030387278003081139,
	...
	benchRese_nocarry_0472 = x
	benchRese_nocarry_0472[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0472.Cmp(&x)
	}
}

func TestE_nocarry_0472Cmp(t *testing.T) {
	var x, y e_nocarry_0472
...
func TestE_nocarry_0472IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0472
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0472

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0472{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0472
	one.SetOne()
	e.Sub(&qe_nocarry_0472, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0472{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0472{0, uint64(i)})
	}
...
func TestE_nocarry_0472NegZero(t *testing.T) {
	var a, b e_nocarry_0472
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0472Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0472, len(staticTestValues))
...
func TestE_nocarry_0472Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0472) bool {
			var b e_nocarry_0472
...
func TestE_nocarry_0472InverseExp(t *testing.T) {
...
func TestE_nocarry_0472MulByConstants(t *testing.T) {
...
func TestE_nocarry_0472Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0472) bool {
...
func TestE_nocarry_0472LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0472Halve(t *testing.T) {
...
func TestE_nocarry_0472FromMont(t *testing.T) {
...
type testPaire_nocarry_0472 struct {
	element e_nocarry_0472
	bigint  big.Int
}

func (z *e_nocarry_0472) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0472[7] {
		return true
	}
	if z[7] < qe_nocarry_0472[7] {
		return false
	...
	return z[0] >= qe_nocarry_0472[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0472

		g.element = e_nocarry_0472{
		...
		if qe_nocarry_0472[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0472[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0472 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0472[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0472[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0472[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0472[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0472[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0472[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0472[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0472[7], carry)
...
func Benchmarke_nocarry_0472InverseNew(b *testing.B) {
	var x e_nocarry_0472
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0472
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0472
		var xInv e_nocarry_0472
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0472
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0472
...
func testLinearComb(t *testing.T, x *e_nocarry_0472, xC int64, y *e_nocarry_0472, yC int64) {
	...
	var z e_nocarry_0472
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0472, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0472
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0472, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0472
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0472, xHi uint64) {
	var res e_nocarry_0472
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0472) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0472) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0472, c int64, result *e_nocarry_0472, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0472) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0472) uint64 {
