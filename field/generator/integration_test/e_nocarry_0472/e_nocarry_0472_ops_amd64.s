...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 56(R10), R9
	JCC  l1
	MOVQ $0x0419818694323a01, R11
	ADDQ R11, AX
	MOVQ $0xcea010a3701446d4, R11
	ADCQ R11, DX
	MOVQ $0x51d13f86d73e7ab9, R11
	ADCQ R11, CX
	MOVQ $0xbd305de373d0ea50, R11
	ADCQ R11, BX
	MOVQ $0x0c8209c20e613ec2, R11
	ADCQ R11, SI
	MOVQ $0xb7c1e3c9c282817a, R11
	ADCQ R11, DI
	MOVQ $0x6f715fb95e330c6b, R11
	ADCQ R11, R8
	MOVQ $0x0000000000c38f70, R11
	ADCQ R11, R9
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x0419818694323a01, R12
	SUBQ  DX, R12
	MOVQ  R12, 0(R11)
	MOVQ  $0xcea010a3701446d4, R12
	SBBQ  CX, R12
	MOVQ  R12, 8(R11)
	MOVQ  $0x51d13f86d73e7ab9, R12
	SBBQ  BX, R12
	MOVQ  R12, 16(R11)
	MOVQ  $0xbd305de373d0ea50, R12
	SBBQ  SI, R12
	MOVQ  R12, 24(R11)
	MOVQ  $0x0c8209c20e613ec2, R12
	SBBQ  DI, R12
	MOVQ  R12, 32(R11)
	MOVQ  $0xb7c1e3c9c282817a, R12
	SBBQ  R8, R12
	MOVQ  R12, 40(R11)
	MOVQ  $0x6f715fb95e330c6b, R12
	SBBQ  R9, R12
	MOVQ  R12, 48(R11)
	MOVQ  $0x0000000000c38f70, R12
	SBBQ  R10, R12
	MOVQ  R12, 56(R11)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	SBBQ 56(AX), R10
	JCC  l3
	MOVQ $0x0419818694323a01, AX
	ADDQ AX, DX
	MOVQ $0xcea010a3701446d4, AX
	ADCQ AX, CX
	MOVQ $0x51d13f86d73e7ab9, AX
	ADCQ AX, BX
	MOVQ $0xbd305de373d0ea50, AX
	ADCQ AX, SI
	MOVQ $0x0c8209c20e613ec2, AX
	ADCQ AX, DI
	MOVQ $0xb7c1e3c9c282817a, AX
	ADCQ AX, R8
	MOVQ $0x6f715fb95e330c6b, AX
	ADCQ AX, R9
	MOVQ $0x0000000000c38f70, AX
	ADCQ AX, R10
