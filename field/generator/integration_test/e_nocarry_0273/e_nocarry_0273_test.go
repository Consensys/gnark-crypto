...
var benchRese_nocarry_0273 e_nocarry_0273

func BenchmarkE_nocarry_0273SetBytes(b *testing.B) {
	var x e_nocarry_0273
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0273MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0273.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0273)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0273)
		}
	})
}

func BenchmarkE_nocarry_0273Inverse(b *testing.B) {
	var x e_nocarry_0273
	x.SetRandom()
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0273Butterfly(b *testing.B) {
	var x e_nocarry_0273
	x.SetRandom()
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0273)
	}
}

func BenchmarkE_nocarry_0273Exp(b *testing.B) {
	var x e_nocarry_0273
	x.SetRandom()
	benchRese_nocarry_0273.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0273Double(b *testing.B) {
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Double(&benchRese_nocarry_0273)
	}
}

func BenchmarkE_nocarry_0273Add(b *testing.B) {
	var x e_nocarry_0273
	x.SetRandom()
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Add(&x, &benchRese_nocarry_0273)
	}
}

func BenchmarkE_nocarry_0273Sub(b *testing.B) {
	var x e_nocarry_0273
	x.SetRandom()
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Sub(&x, &benchRese_nocarry_0273)
	}
}

func BenchmarkE_nocarry_0273Neg(b *testing.B) {
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Neg(&benchRese_nocarry_0273)
	}
}

func BenchmarkE_nocarry_0273Div(b *testing.B) {
	var x e_nocarry_0273
	x.SetRandom()
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Div(&x, &benchRese_nocarry_0273)
	}
}

func BenchmarkE_nocarry_0273FromMont(b *testing.B) {
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.FromMont()
	}
}

func BenchmarkE_nocarry_0273ToMont(b *testing.B) {
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.ToMont()
	}
}
func BenchmarkE_nocarry_0273Square(b *testing.B) {
	benchRese_nocarry_0273.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Square(&benchRese_nocarry_0273)
	}
}

func BenchmarkE_nocarry_0273Sqrt(b *testing.B) {
	var a e_nocarry_0273
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0273Mul(b *testing.B) {
	x := e_nocarry_0273{
		7351569445166395264,
	...
	benchRese_nocarry_0273.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Mul(&benchRese_nocarry_0273, &x)
	}
}

func BenchmarkE_nocarry_0273Cmp(b *testing.B) {
	x := e_nocarry_0273{
		7351569445166395264,
		11638697655154071565,
		4942884684304223060,
	...
	benchRese_nocarry_0273 = x
	benchRese_nocarry_0273[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0273.Cmp(&x)
	}
}

func TestE_nocarry_0273Cmp(t *testing.T) {
	var x, y e_nocarry_0273
...
func TestE_nocarry_0273IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0273
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0273

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0273{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0273
	one.SetOne()
	e.Sub(&qe_nocarry_0273, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0273{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0273{0, uint64(i)})
	}
...
func TestE_nocarry_0273NegZero(t *testing.T) {
	var a, b e_nocarry_0273
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0273Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0273, len(staticTestValues))
...
func TestE_nocarry_0273Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0273) bool {
			var b e_nocarry_0273
...
func TestE_nocarry_0273InverseExp(t *testing.T) {
...
func TestE_nocarry_0273MulByConstants(t *testing.T) {
...
func TestE_nocarry_0273Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0273) bool {
...
func TestE_nocarry_0273LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0273Halve(t *testing.T) {
...
func TestE_nocarry_0273FromMont(t *testing.T) {
...
type testPaire_nocarry_0273 struct {
	element e_nocarry_0273
	bigint  big.Int
}

func (z *e_nocarry_0273) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0273[4] {
		return true
	}
	if z[4] < qe_nocarry_0273[4] {
		return false
	...
	return z[0] >= qe_nocarry_0273[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0273

		g.element = e_nocarry_0273{
		...
		if qe_nocarry_0273[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0273[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0273 {
			var g e_nocarry_0273
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0273[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0273[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0273[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0273[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0273[4], carry)
...
func Benchmarke_nocarry_0273InverseNew(b *testing.B) {
	var x e_nocarry_0273
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0273
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0273
		var xInv e_nocarry_0273
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0273
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0273
...
func testLinearComb(t *testing.T, x *e_nocarry_0273, xC int64, y *e_nocarry_0273, yC int64) {
	...
	var z e_nocarry_0273
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0273, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0273
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0273, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0273
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0273, xHi uint64) {
	var res e_nocarry_0273
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0273) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0273) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0273, c int64, result *e_nocarry_0273, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0273) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0273) uint64 {
