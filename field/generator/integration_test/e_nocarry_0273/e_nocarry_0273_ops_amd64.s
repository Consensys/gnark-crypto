...
// modulus q
DATA q<>+0(SB)/8, $0x50840cc60fdc3825
DATA q<>+8(SB)/8, $0xf3e402cbb2eb0470
DATA q<>+16(SB)/8, $0xd43929dc605a8aa9
DATA q<>+24(SB)/8, $0x89b799f333fa1fd5
DATA q<>+32(SB)/8, $0x000000000001cf36
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xe0d8fdd349d2dc53
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x50840cc60fdc3825, R9
	MOVQ    $0xf3e402cbb2eb0470, R10
	MOVQ    $0xd43929dc605a8aa9, R11
	MOVQ    $0x89b799f333fa1fd5, R12
	MOVQ    $0x000000000001cf36, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xf3e402cbb2eb0470, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xd43929dc605a8aa9, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x89b799f333fa1fd5, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000000001cf36, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x50840cc60fdc3825, CX
	MOVQ    $0xf3e402cbb2eb0470, BX
	MOVQ    $0xd43929dc605a8aa9, SI
	MOVQ    $0x89b799f333fa1fd5, DI
	MOVQ    $0x000000000001cf36, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
