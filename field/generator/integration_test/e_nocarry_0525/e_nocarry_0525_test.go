...
var benchRese_nocarry_0525 e_nocarry_0525

func BenchmarkE_nocarry_0525SetBytes(b *testing.B) {
	var x e_nocarry_0525
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0525MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0525.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0525)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0525)
		}
	})
}

func BenchmarkE_nocarry_0525Inverse(b *testing.B) {
	var x e_nocarry_0525
	x.SetRandom()
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0525Butterfly(b *testing.B) {
	var x e_nocarry_0525
	x.SetRandom()
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0525)
	}
}

func BenchmarkE_nocarry_0525Exp(b *testing.B) {
	var x e_nocarry_0525
	x.SetRandom()
	benchRese_nocarry_0525.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0525Double(b *testing.B) {
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Double(&benchRese_nocarry_0525)
	}
}

func BenchmarkE_nocarry_0525Add(b *testing.B) {
	var x e_nocarry_0525
	x.SetRandom()
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Add(&x, &benchRese_nocarry_0525)
	}
}

func BenchmarkE_nocarry_0525Sub(b *testing.B) {
	var x e_nocarry_0525
	x.SetRandom()
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Sub(&x, &benchRese_nocarry_0525)
	}
}

func BenchmarkE_nocarry_0525Neg(b *testing.B) {
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Neg(&benchRese_nocarry_0525)
	}
}

func BenchmarkE_nocarry_0525Div(b *testing.B) {
	var x e_nocarry_0525
	x.SetRandom()
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Div(&x, &benchRese_nocarry_0525)
	}
}

func BenchmarkE_nocarry_0525FromMont(b *testing.B) {
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.FromMont()
	}
}

func BenchmarkE_nocarry_0525ToMont(b *testing.B) {
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.ToMont()
	}
}
func BenchmarkE_nocarry_0525Square(b *testing.B) {
	benchRese_nocarry_0525.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Square(&benchRese_nocarry_0525)
	}
}

func BenchmarkE_nocarry_0525Sqrt(b *testing.B) {
	var a e_nocarry_0525
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0525Mul(b *testing.B) {
	x := e_nocarry_0525{
		1119718621416521901,
		397274088285112627,
	...
	benchRese_nocarry_0525.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Mul(&benchRese_nocarry_0525, &x)
	}
}

func BenchmarkE_nocarry_0525Cmp(b *testing.B) {
	x := e_nocarry_0525{
		1119718621416521901,
		397274088285112627,
		11643793837334977226,
	...
	benchRese_nocarry_0525 = x
	benchRese_nocarry_0525[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0525.Cmp(&x)
	}
}

func TestE_nocarry_0525Cmp(t *testing.T) {
	var x, y e_nocarry_0525
...
func TestE_nocarry_0525IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0525
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0525

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0525{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0525
	one.SetOne()
	e.Sub(&qe_nocarry_0525, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0525{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0525{0, uint64(i)})
	}
...
func TestE_nocarry_0525NegZero(t *testing.T) {
	var a, b e_nocarry_0525
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0525Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0525, len(staticTestValues))
...
func TestE_nocarry_0525Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0525) bool {
			var b e_nocarry_0525
...
func TestE_nocarry_0525InverseExp(t *testing.T) {
...
func TestE_nocarry_0525MulByConstants(t *testing.T) {
...
func TestE_nocarry_0525Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0525) bool {
...
func TestE_nocarry_0525LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0525Halve(t *testing.T) {
...
func TestE_nocarry_0525FromMont(t *testing.T) {
...
type testPaire_nocarry_0525 struct {
	element e_nocarry_0525
	bigint  big.Int
}

func (z *e_nocarry_0525) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0525[8] {
		return true
	}
	if z[8] < qe_nocarry_0525[8] {
		return false
	...
	return z[0] >= qe_nocarry_0525[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0525

		g.element = e_nocarry_0525{
		...
		if qe_nocarry_0525[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0525[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0525 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0525[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0525[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0525[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0525[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0525[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0525[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0525[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0525[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0525[8], carry)
...
func Benchmarke_nocarry_0525InverseNew(b *testing.B) {
	var x e_nocarry_0525
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0525
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0525
		var xInv e_nocarry_0525
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0525
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0525
...
func testLinearComb(t *testing.T, x *e_nocarry_0525, xC int64, y *e_nocarry_0525, yC int64) {
	...
	var z e_nocarry_0525
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0525, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0525
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0525, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0525
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0525, xHi uint64) {
	var res e_nocarry_0525
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0525) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0525) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0525, c int64, result *e_nocarry_0525, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0525) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0525) uint64 {
