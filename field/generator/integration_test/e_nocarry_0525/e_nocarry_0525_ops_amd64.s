...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x45fd847a73c65db9, R12
	ADDQ R12, AX
	MOVQ $0x5ded55e3a38c6128, R12
	ADCQ R12, DX
	MOVQ $0x99aef9af58889e8a, R12
	ADCQ R12, CX
	MOVQ $0xe0ba4470898533e4, R12
	ADCQ R12, BX
	MOVQ $0xdd8fc946b48f477d, R12
	ADCQ R12, SI
	MOVQ $0x6cdaebb3d95f061d, R12
	ADCQ R12, DI
	MOVQ $0x4183ee853e738cf4, R12
	ADCQ R12, R8
	MOVQ $0xa0710fa0f55b9c17, R12
	ADCQ R12, R9
	MOVQ $0x0000000000001adb, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x45fd847a73c65db9, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x5ded55e3a38c6128, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x99aef9af58889e8a, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xe0ba4470898533e4, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xdd8fc946b48f477d, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x6cdaebb3d95f061d, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x4183ee853e738cf4, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xa0710fa0f55b9c17, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000000001adb, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x45fd847a73c65db9, AX
	ADDQ AX, DX
	MOVQ $0x5ded55e3a38c6128, AX
	ADCQ AX, CX
	MOVQ $0x99aef9af58889e8a, AX
	ADCQ AX, BX
	MOVQ $0xe0ba4470898533e4, AX
	ADCQ AX, SI
	MOVQ $0xdd8fc946b48f477d, AX
	ADCQ AX, DI
	MOVQ $0x6cdaebb3d95f061d, AX
	ADCQ AX, R8
	MOVQ $0x4183ee853e738cf4, AX
	ADCQ AX, R9
	MOVQ $0xa0710fa0f55b9c17, AX
	ADCQ AX, R10
	MOVQ $0x0000000000001adb, AX
	ADCQ AX, R11
