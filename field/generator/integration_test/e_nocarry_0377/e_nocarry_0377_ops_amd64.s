...
// modulus q
DATA q<>+0(SB)/8, $0x23bcd6a395e8087b
DATA q<>+8(SB)/8, $0x45c33bfc8831769e
DATA q<>+16(SB)/8, $0xae90d07552249697
DATA q<>+24(SB)/8, $0x9838a80d9714f713
DATA q<>+32(SB)/8, $0x6b12833efdb3e142
DATA q<>+40(SB)/8, $0x01b77535960e89ae
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x790598373bc1694d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x23bcd6a395e8087b, R10
	MOVQ    $0x45c33bfc8831769e, R11
	MOVQ    $0xae90d07552249697, R12
	MOVQ    $0x9838a80d9714f713, R13
	MOVQ    $0x6b12833efdb3e142, R14
	MOVQ    $0x01b77535960e89ae, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x45c33bfc8831769e, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xae90d07552249697, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x9838a80d9714f713, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x6b12833efdb3e142, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x01b77535960e89ae, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x23bcd6a395e8087b, CX
	MOVQ    $0x45c33bfc8831769e, BX
	MOVQ    $0xae90d07552249697, SI
	MOVQ    $0x9838a80d9714f713, DI
	MOVQ    $0x6b12833efdb3e142, R8
	MOVQ    $0x01b77535960e89ae, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
