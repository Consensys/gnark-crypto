...
var benchRese_nocarry_0377 e_nocarry_0377

func BenchmarkE_nocarry_0377SetBytes(b *testing.B) {
	var x e_nocarry_0377
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0377MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0377.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0377)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0377)
		}
	})
}

func BenchmarkE_nocarry_0377Inverse(b *testing.B) {
	var x e_nocarry_0377
	x.SetRandom()
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0377Butterfly(b *testing.B) {
	var x e_nocarry_0377
	x.SetRandom()
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0377)
	}
}

func BenchmarkE_nocarry_0377Exp(b *testing.B) {
	var x e_nocarry_0377
	x.SetRandom()
	benchRese_nocarry_0377.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0377Double(b *testing.B) {
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Double(&benchRese_nocarry_0377)
	}
}

func BenchmarkE_nocarry_0377Add(b *testing.B) {
	var x e_nocarry_0377
	x.SetRandom()
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Add(&x, &benchRese_nocarry_0377)
	}
}

func BenchmarkE_nocarry_0377Sub(b *testing.B) {
	var x e_nocarry_0377
	x.SetRandom()
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Sub(&x, &benchRese_nocarry_0377)
	}
}

func BenchmarkE_nocarry_0377Neg(b *testing.B) {
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Neg(&benchRese_nocarry_0377)
	}
}

func BenchmarkE_nocarry_0377Div(b *testing.B) {
	var x e_nocarry_0377
	x.SetRandom()
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Div(&x, &benchRese_nocarry_0377)
	}
}

func BenchmarkE_nocarry_0377FromMont(b *testing.B) {
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.FromMont()
	}
}

func BenchmarkE_nocarry_0377ToMont(b *testing.B) {
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.ToMont()
	}
}
func BenchmarkE_nocarry_0377Square(b *testing.B) {
	benchRese_nocarry_0377.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Square(&benchRese_nocarry_0377)
	}
}

func BenchmarkE_nocarry_0377Sqrt(b *testing.B) {
	var a e_nocarry_0377
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0377Mul(b *testing.B) {
	x := e_nocarry_0377{
		4133114184357021339,
		5137754950987808531,
		4268774174316102977,
	...
	benchRese_nocarry_0377.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Mul(&benchRese_nocarry_0377, &x)
	}
}

func BenchmarkE_nocarry_0377Cmp(b *testing.B) {
	x := e_nocarry_0377{
		4133114184357021339,
		5137754950987808531,
		4268774174316102977,
	...
	benchRese_nocarry_0377 = x
	benchRese_nocarry_0377[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0377.Cmp(&x)
	}
}

func TestE_nocarry_0377Cmp(t *testing.T) {
	var x, y e_nocarry_0377
...
func TestE_nocarry_0377IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0377
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0377

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0377{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0377
	one.SetOne()
	e.Sub(&qe_nocarry_0377, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0377{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0377{0, uint64(i)})
	}
...
func TestE_nocarry_0377NegZero(t *testing.T) {
	var a, b e_nocarry_0377
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0377Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0377, len(staticTestValues))
...
func TestE_nocarry_0377Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0377) bool {
			var b e_nocarry_0377
...
func TestE_nocarry_0377InverseExp(t *testing.T) {
...
func TestE_nocarry_0377MulByConstants(t *testing.T) {
...
func TestE_nocarry_0377Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0377) bool {
...
func TestE_nocarry_0377LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0377Halve(t *testing.T) {
...
func TestE_nocarry_0377FromMont(t *testing.T) {
...
type testPaire_nocarry_0377 struct {
	element e_nocarry_0377
	bigint  big.Int
}

func (z *e_nocarry_0377) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0377[5] {
		return true
	}
	if z[5] < qe_nocarry_0377[5] {
		return false
	...
	return z[0] >= qe_nocarry_0377[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0377

		g.element = e_nocarry_0377{
		...
		if qe_nocarry_0377[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0377[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0377 {
			var g e_nocarry_0377
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0377[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0377[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0377[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0377[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0377[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0377[5], carry)
...
func Benchmarke_nocarry_0377InverseNew(b *testing.B) {
	var x e_nocarry_0377
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0377
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0377
		var xInv e_nocarry_0377
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0377
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0377
...
func testLinearComb(t *testing.T, x *e_nocarry_0377, xC int64, y *e_nocarry_0377, yC int64) {
	...
	var z e_nocarry_0377
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0377, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0377
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0377, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0377
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0377, xHi uint64) {
	var res e_nocarry_0377
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0377) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0377) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0377, c int64, result *e_nocarry_0377, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0377) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0377) uint64 {
