...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x71b8a025815b7a67, R14
	ADDQ R14, AX
	MOVQ $0x1b2383d923859fa2, R14
	ADCQ R14, DX
	MOVQ $0xb710ff9e27bc469f, R14
	ADCQ R14, CX
	MOVQ $0x24364ab4eac58c98, R14
	ADCQ R14, BX
	MOVQ $0xcbafbf56c66c42fa, R14
	ADCQ R14, SI
	MOVQ $0xcac86ae5d1f28b02, R14
	ADCQ R14, DI
	MOVQ $0xa3f2886ed2c8d48d, R14
	ADCQ R14, R8
	MOVQ $0x5670ad3b902621e1, R14
	ADCQ R14, R9
	MOVQ $0x20a84975c901a970, R14
	ADCQ R14, R10
	MOVQ $0x7db66181197333d6, R14
	ADCQ R14, R11
	MOVQ $0x000000003f1dfc32, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x71b8a025815b7a67, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x1b2383d923859fa2, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xb710ff9e27bc469f, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x24364ab4eac58c98, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xcbafbf56c66c42fa, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xcac86ae5d1f28b02, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xa3f2886ed2c8d48d, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x5670ad3b902621e1, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x20a84975c901a970, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x7db66181197333d6, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000003f1dfc32, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x71b8a025815b7a67, AX
	ADDQ AX, DX
	MOVQ $0x1b2383d923859fa2, AX
	ADCQ AX, CX
	MOVQ $0xb710ff9e27bc469f, AX
	ADCQ AX, BX
	MOVQ $0x24364ab4eac58c98, AX
	ADCQ AX, SI
	MOVQ $0xcbafbf56c66c42fa, AX
	ADCQ AX, DI
	MOVQ $0xcac86ae5d1f28b02, AX
	ADCQ AX, R8
	MOVQ $0xa3f2886ed2c8d48d, AX
	ADCQ AX, R9
	MOVQ $0x5670ad3b902621e1, AX
	ADCQ AX, R10
	MOVQ $0x20a84975c901a970, AX
	ADCQ AX, R11
	MOVQ $0x7db66181197333d6, AX
	ADCQ AX, R12
	MOVQ $0x000000003f1dfc32, AX
	ADCQ AX, R13
