...
var benchRese_nocarry_0670 e_nocarry_0670

func BenchmarkE_nocarry_0670SetBytes(b *testing.B) {
	var x e_nocarry_0670
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0670MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0670.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0670)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0670)
		}
	})
}

func BenchmarkE_nocarry_0670Inverse(b *testing.B) {
	var x e_nocarry_0670
	x.SetRandom()
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0670Butterfly(b *testing.B) {
	var x e_nocarry_0670
	x.SetRandom()
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0670)
	}
}

func BenchmarkE_nocarry_0670Exp(b *testing.B) {
	var x e_nocarry_0670
	x.SetRandom()
	benchRese_nocarry_0670.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0670Double(b *testing.B) {
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Double(&benchRese_nocarry_0670)
	}
}

func BenchmarkE_nocarry_0670Add(b *testing.B) {
	var x e_nocarry_0670
	x.SetRandom()
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Add(&x, &benchRese_nocarry_0670)
	}
}

func BenchmarkE_nocarry_0670Sub(b *testing.B) {
	var x e_nocarry_0670
	x.SetRandom()
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Sub(&x, &benchRese_nocarry_0670)
	}
}

func BenchmarkE_nocarry_0670Neg(b *testing.B) {
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Neg(&benchRese_nocarry_0670)
	}
}

func BenchmarkE_nocarry_0670Div(b *testing.B) {
	var x e_nocarry_0670
	x.SetRandom()
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Div(&x, &benchRese_nocarry_0670)
	}
}

func BenchmarkE_nocarry_0670FromMont(b *testing.B) {
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.FromMont()
	}
}

func BenchmarkE_nocarry_0670ToMont(b *testing.B) {
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.ToMont()
	}
}
func BenchmarkE_nocarry_0670Square(b *testing.B) {
	benchRese_nocarry_0670.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Square(&benchRese_nocarry_0670)
	}
}

func BenchmarkE_nocarry_0670Sqrt(b *testing.B) {
	var a e_nocarry_0670
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0670Mul(b *testing.B) {
	x := e_nocarry_0670{
		745113878192221970,
	...
	benchRese_nocarry_0670.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Mul(&benchRese_nocarry_0670, &x)
	}
}

func BenchmarkE_nocarry_0670Cmp(b *testing.B) {
	x := e_nocarry_0670{
		745113878192221970,
		11026462789753116308,
		15303627539252248352,
	...
	benchRese_nocarry_0670 = x
	benchRese_nocarry_0670[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0670.Cmp(&x)
	}
}

func TestE_nocarry_0670Cmp(t *testing.T) {
	var x, y e_nocarry_0670
...
func TestE_nocarry_0670IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0670
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0670

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0670{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0670
	one.SetOne()
	e.Sub(&qe_nocarry_0670, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0670{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0670{0, uint64(i)})
	}
...
func TestE_nocarry_0670NegZero(t *testing.T) {
	var a, b e_nocarry_0670
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0670Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0670, len(staticTestValues))
...
func TestE_nocarry_0670Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0670) bool {
			var b e_nocarry_0670
...
func TestE_nocarry_0670InverseExp(t *testing.T) {
...
func TestE_nocarry_0670MulByConstants(t *testing.T) {
...
func TestE_nocarry_0670Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0670) bool {
...
func TestE_nocarry_0670LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0670Halve(t *testing.T) {
...
func TestE_nocarry_0670FromMont(t *testing.T) {
...
type testPaire_nocarry_0670 struct {
	element e_nocarry_0670
	bigint  big.Int
}

func (z *e_nocarry_0670) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0670[10] {
		return true
	}
	if z[10] < qe_nocarry_0670[10] {
		return false
	...
	return z[0] >= qe_nocarry_0670[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0670

		g.element = e_nocarry_0670{
		...
		if qe_nocarry_0670[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0670[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0670 {
			var g e_nocarry_0670
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0670[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0670[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0670[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0670[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0670[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0670[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0670[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0670[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0670[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0670[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0670[10], carry)
...
func Benchmarke_nocarry_0670InverseNew(b *testing.B) {
	var x e_nocarry_0670
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0670
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0670
		var xInv e_nocarry_0670
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0670
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0670
...
func testLinearComb(t *testing.T, x *e_nocarry_0670, xC int64, y *e_nocarry_0670, yC int64) {
	...
	var z e_nocarry_0670
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0670, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0670
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0670, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0670
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0670, xHi uint64) {
	var res e_nocarry_0670
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0670) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0670) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0670, c int64, result *e_nocarry_0670, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0670) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0670) uint64 {
