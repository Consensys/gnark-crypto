...
var benchRese_nocarry_0266 e_nocarry_0266

func BenchmarkE_nocarry_0266SetBytes(b *testing.B) {
	var x e_nocarry_0266
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0266MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0266.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0266)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0266)
		}
	})
}

func BenchmarkE_nocarry_0266Inverse(b *testing.B) {
	var x e_nocarry_0266
	x.SetRandom()
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0266Butterfly(b *testing.B) {
	var x e_nocarry_0266
	x.SetRandom()
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0266)
	}
}

func BenchmarkE_nocarry_0266Exp(b *testing.B) {
	var x e_nocarry_0266
	x.SetRandom()
	benchRese_nocarry_0266.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0266Double(b *testing.B) {
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Double(&benchRese_nocarry_0266)
	}
}

func BenchmarkE_nocarry_0266Add(b *testing.B) {
	var x e_nocarry_0266
	x.SetRandom()
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Add(&x, &benchRese_nocarry_0266)
	}
}

func BenchmarkE_nocarry_0266Sub(b *testing.B) {
	var x e_nocarry_0266
	x.SetRandom()
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Sub(&x, &benchRese_nocarry_0266)
	}
}

func BenchmarkE_nocarry_0266Neg(b *testing.B) {
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Neg(&benchRese_nocarry_0266)
	}
}

func BenchmarkE_nocarry_0266Div(b *testing.B) {
	var x e_nocarry_0266
	x.SetRandom()
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Div(&x, &benchRese_nocarry_0266)
	}
}

func BenchmarkE_nocarry_0266FromMont(b *testing.B) {
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.FromMont()
	}
}

func BenchmarkE_nocarry_0266ToMont(b *testing.B) {
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.ToMont()
	}
}
func BenchmarkE_nocarry_0266Square(b *testing.B) {
	benchRese_nocarry_0266.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Square(&benchRese_nocarry_0266)
	}
}

func BenchmarkE_nocarry_0266Sqrt(b *testing.B) {
	var a e_nocarry_0266
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0266Mul(b *testing.B) {
	x := e_nocarry_0266{
		5173772402480344395,
	...
	benchRese_nocarry_0266.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Mul(&benchRese_nocarry_0266, &x)
	}
}

func BenchmarkE_nocarry_0266Cmp(b *testing.B) {
	x := e_nocarry_0266{
		5173772402480344395,
		17657662138651562715,
		1148754933352911692,
	...
	benchRese_nocarry_0266 = x
	benchRese_nocarry_0266[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0266.Cmp(&x)
	}
}

func TestE_nocarry_0266Cmp(t *testing.T) {
	var x, y e_nocarry_0266
...
func TestE_nocarry_0266IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0266
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0266

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0266{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0266
	one.SetOne()
	e.Sub(&qe_nocarry_0266, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0266{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0266{0, uint64(i)})
	}
...
func TestE_nocarry_0266NegZero(t *testing.T) {
	var a, b e_nocarry_0266
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0266Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0266, len(staticTestValues))
...
func TestE_nocarry_0266Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0266) bool {
			var b e_nocarry_0266
...
func TestE_nocarry_0266InverseExp(t *testing.T) {
...
func TestE_nocarry_0266MulByConstants(t *testing.T) {
...
func TestE_nocarry_0266Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0266) bool {
...
func TestE_nocarry_0266LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0266Halve(t *testing.T) {
...
func TestE_nocarry_0266FromMont(t *testing.T) {
...
type testPaire_nocarry_0266 struct {
	element e_nocarry_0266
	bigint  big.Int
}

func (z *e_nocarry_0266) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0266[4] {
		return true
	}
	if z[4] < qe_nocarry_0266[4] {
		return false
	...
	return z[0] >= qe_nocarry_0266[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0266

		g.element = e_nocarry_0266{
		...
		if qe_nocarry_0266[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0266[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0266 {
			var g e_nocarry_0266
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0266[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0266[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0266[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0266[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0266[4], carry)
...
func Benchmarke_nocarry_0266InverseNew(b *testing.B) {
	var x e_nocarry_0266
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0266
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0266
		var xInv e_nocarry_0266
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0266
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0266
...
func testLinearComb(t *testing.T, x *e_nocarry_0266, xC int64, y *e_nocarry_0266, yC int64) {
	...
	var z e_nocarry_0266
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0266, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0266
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0266, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0266
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0266, xHi uint64) {
	var res e_nocarry_0266
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0266) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0266) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0266, c int64, result *e_nocarry_0266, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0266) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0266) uint64 {
