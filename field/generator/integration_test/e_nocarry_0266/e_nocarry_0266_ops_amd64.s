...
// modulus q
DATA q<>+0(SB)/8, $0xc7343c809da84f75
DATA q<>+8(SB)/8, $0x20b28fdc4614b30a
DATA q<>+16(SB)/8, $0x3454903d4795b298
DATA q<>+24(SB)/8, $0x5c81e2b2e12e1337
DATA q<>+32(SB)/8, $0x000000000000037f
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xbc3885958adf3723
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xc7343c809da84f75, R9
	MOVQ    $0x20b28fdc4614b30a, R10
	MOVQ    $0x3454903d4795b298, R11
	MOVQ    $0x5c81e2b2e12e1337, R12
	MOVQ    $0x000000000000037f, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x20b28fdc4614b30a, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x3454903d4795b298, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x5c81e2b2e12e1337, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000000000037f, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xc7343c809da84f75, CX
	MOVQ    $0x20b28fdc4614b30a, BX
	MOVQ    $0x3454903d4795b298, SI
	MOVQ    $0x5c81e2b2e12e1337, DI
	MOVQ    $0x000000000000037f, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
