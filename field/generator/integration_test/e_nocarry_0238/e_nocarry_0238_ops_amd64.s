...
// modulus q
DATA q<>+0(SB)/8, $0x7629896a5bb2b687
DATA q<>+8(SB)/8, $0xeab9538f0a4f8717
DATA q<>+16(SB)/8, $0xbb11b5643c878dc5
DATA q<>+24(SB)/8, $0x0000335187c02210
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xdec5a6fdb7d7d0c9
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x7629896a5bb2b687, R8
	MOVQ    $0xeab9538f0a4f8717, R9
	MOVQ    $0xbb11b5643c878dc5, R10
	MOVQ    $0x0000335187c02210, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xeab9538f0a4f8717, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xbb11b5643c878dc5, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000335187c02210, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x7629896a5bb2b687, R12
	MOVQ    $0xeab9538f0a4f8717, R13
	MOVQ    $0xbb11b5643c878dc5, R14
	MOVQ    $0x0000335187c02210, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
