...
var benchRese_nocarry_0238 e_nocarry_0238

func BenchmarkE_nocarry_0238SetBytes(b *testing.B) {
	var x e_nocarry_0238
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0238MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0238.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0238)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0238)
		}
	})
}

func BenchmarkE_nocarry_0238Inverse(b *testing.B) {
	var x e_nocarry_0238
	x.SetRandom()
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0238Butterfly(b *testing.B) {
	var x e_nocarry_0238
	x.SetRandom()
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0238)
	}
}

func BenchmarkE_nocarry_0238Exp(b *testing.B) {
	var x e_nocarry_0238
	x.SetRandom()
	benchRese_nocarry_0238.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0238Double(b *testing.B) {
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Double(&benchRese_nocarry_0238)
	}
}

func BenchmarkE_nocarry_0238Add(b *testing.B) {
	var x e_nocarry_0238
	x.SetRandom()
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Add(&x, &benchRese_nocarry_0238)
	}
}

func BenchmarkE_nocarry_0238Sub(b *testing.B) {
	var x e_nocarry_0238
	x.SetRandom()
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Sub(&x, &benchRese_nocarry_0238)
	}
}

func BenchmarkE_nocarry_0238Neg(b *testing.B) {
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Neg(&benchRese_nocarry_0238)
	}
}

func BenchmarkE_nocarry_0238Div(b *testing.B) {
	var x e_nocarry_0238
	x.SetRandom()
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Div(&x, &benchRese_nocarry_0238)
	}
}

func BenchmarkE_nocarry_0238FromMont(b *testing.B) {
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.FromMont()
	}
}

func BenchmarkE_nocarry_0238ToMont(b *testing.B) {
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.ToMont()
	}
}
func BenchmarkE_nocarry_0238Square(b *testing.B) {
	benchRese_nocarry_0238.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Square(&benchRese_nocarry_0238)
	}
}

func BenchmarkE_nocarry_0238Sqrt(b *testing.B) {
	var a e_nocarry_0238
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0238Mul(b *testing.B) {
	x := e_nocarry_0238{
	...
	benchRese_nocarry_0238.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Mul(&benchRese_nocarry_0238, &x)
	}
}

func BenchmarkE_nocarry_0238Cmp(b *testing.B) {
	x := e_nocarry_0238{
		16281931077767714769,
		16583882976652068723,
		18035594118708830266,
	...
	benchRese_nocarry_0238 = x
	benchRese_nocarry_0238[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0238.Cmp(&x)
	}
}

func TestE_nocarry_0238Cmp(t *testing.T) {
	var x, y e_nocarry_0238
...
func TestE_nocarry_0238IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0238
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0238

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0238{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0238
	one.SetOne()
	e.Sub(&qe_nocarry_0238, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0238{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0238{0, uint64(i)})
	}
...
func TestE_nocarry_0238NegZero(t *testing.T) {
	var a, b e_nocarry_0238
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0238Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0238, len(staticTestValues))
...
func TestE_nocarry_0238Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0238) bool {
			var b e_nocarry_0238
...
func TestE_nocarry_0238InverseExp(t *testing.T) {
...
func TestE_nocarry_0238MulByConstants(t *testing.T) {
...
func TestE_nocarry_0238Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0238) bool {
...
func TestE_nocarry_0238LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0238Halve(t *testing.T) {
...
func TestE_nocarry_0238FromMont(t *testing.T) {
...
type testPaire_nocarry_0238 struct {
	element e_nocarry_0238
	bigint  big.Int
}

func (z *e_nocarry_0238) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0238[3] {
		return true
	}
	if z[3] < qe_nocarry_0238[3] {
		return false
	...
	return z[0] >= qe_nocarry_0238[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0238

		g.element = e_nocarry_0238{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0238[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0238[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0238 {
			var g e_nocarry_0238
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0238[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0238[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0238[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0238[3], carry)
...
func Benchmarke_nocarry_0238InverseNew(b *testing.B) {
	var x e_nocarry_0238
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0238
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0238
		var xInv e_nocarry_0238
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0238
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0238
...
func testLinearComb(t *testing.T, x *e_nocarry_0238, xC int64, y *e_nocarry_0238, yC int64) {
	...
	var z e_nocarry_0238
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0238, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0238
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0238, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0238
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0238, xHi uint64) {
	var res e_nocarry_0238
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0238) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0238) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0238, c int64, result *e_nocarry_0238, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0238) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0238) uint64 {
