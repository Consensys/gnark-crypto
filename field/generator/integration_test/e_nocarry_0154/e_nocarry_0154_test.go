...
var benchRese_nocarry_0154 e_nocarry_0154

func BenchmarkE_nocarry_0154SetBytes(b *testing.B) {
	var x e_nocarry_0154
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0154MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0154.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0154)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0154)
		}
	})
}

func BenchmarkE_nocarry_0154Inverse(b *testing.B) {
	var x e_nocarry_0154
	x.SetRandom()
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0154Butterfly(b *testing.B) {
	var x e_nocarry_0154
	x.SetRandom()
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0154)
	}
}

func BenchmarkE_nocarry_0154Exp(b *testing.B) {
	var x e_nocarry_0154
	x.SetRandom()
	benchRese_nocarry_0154.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0154Double(b *testing.B) {
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Double(&benchRese_nocarry_0154)
	}
}

func BenchmarkE_nocarry_0154Add(b *testing.B) {
	var x e_nocarry_0154
	x.SetRandom()
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Add(&x, &benchRese_nocarry_0154)
	}
}

func BenchmarkE_nocarry_0154Sub(b *testing.B) {
	var x e_nocarry_0154
	x.SetRandom()
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Sub(&x, &benchRese_nocarry_0154)
	}
}

func BenchmarkE_nocarry_0154Neg(b *testing.B) {
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Neg(&benchRese_nocarry_0154)
	}
}

func BenchmarkE_nocarry_0154Div(b *testing.B) {
	var x e_nocarry_0154
	x.SetRandom()
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Div(&x, &benchRese_nocarry_0154)
	}
}

func BenchmarkE_nocarry_0154FromMont(b *testing.B) {
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.FromMont()
	}
}

func BenchmarkE_nocarry_0154ToMont(b *testing.B) {
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.ToMont()
	}
}
func BenchmarkE_nocarry_0154Square(b *testing.B) {
	benchRese_nocarry_0154.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Square(&benchRese_nocarry_0154)
	}
}

func BenchmarkE_nocarry_0154Sqrt(b *testing.B) {
	var a e_nocarry_0154
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0154Mul(b *testing.B) {
	x := e_nocarry_0154{
		3273317618157863636,
		2934562978477367056,
		4871263,
	}
	benchRese_nocarry_0154.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Mul(&benchRese_nocarry_0154, &x)
	}
}

func BenchmarkE_nocarry_0154Cmp(b *testing.B) {
	x := e_nocarry_0154{
		3273317618157863636,
		2934562978477367056,
		4871263,
	}
	benchRese_nocarry_0154 = x
	benchRese_nocarry_0154[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0154.Cmp(&x)
	}
}

func TestE_nocarry_0154Cmp(t *testing.T) {
	var x, y e_nocarry_0154
...
func TestE_nocarry_0154IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0154
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0154

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0154{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0154
	one.SetOne()
	e.Sub(&qe_nocarry_0154, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0154{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0154{0, uint64(i)})
	}
...
func TestE_nocarry_0154NegZero(t *testing.T) {
	var a, b e_nocarry_0154
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0154Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0154, len(staticTestValues))
...
func TestE_nocarry_0154Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0154) bool {
			var b e_nocarry_0154
...
func TestE_nocarry_0154InverseExp(t *testing.T) {
...
func TestE_nocarry_0154MulByConstants(t *testing.T) {
...
func TestE_nocarry_0154Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0154) bool {
...
func TestE_nocarry_0154LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0154Halve(t *testing.T) {
...
func TestE_nocarry_0154FromMont(t *testing.T) {
...
type testPaire_nocarry_0154 struct {
	element e_nocarry_0154
	bigint  big.Int
}

func (z *e_nocarry_0154) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0154[2] {
		return true
	}
	if z[2] < qe_nocarry_0154[2] {
		return false
	...
	return z[0] >= qe_nocarry_0154[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0154

		g.element = e_nocarry_0154{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0154[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0154[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0154 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0154[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0154[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0154[2], carry)
...
func Benchmarke_nocarry_0154InverseNew(b *testing.B) {
	var x e_nocarry_0154
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0154
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0154
		var xInv e_nocarry_0154
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0154
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0154
...
func testLinearComb(t *testing.T, x *e_nocarry_0154, xC int64, y *e_nocarry_0154, yC int64) {
	...
	var z e_nocarry_0154
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0154, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0154
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0154, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0154
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0154, xHi uint64) {
	var res e_nocarry_0154
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0154) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0154) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0154, c int64, result *e_nocarry_0154, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0154) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0154) uint64 {
