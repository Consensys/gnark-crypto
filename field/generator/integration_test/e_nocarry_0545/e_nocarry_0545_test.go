...
var benchRese_nocarry_0545 e_nocarry_0545

func BenchmarkE_nocarry_0545SetBytes(b *testing.B) {
	var x e_nocarry_0545
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0545MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0545.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0545)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0545)
		}
	})
}

func BenchmarkE_nocarry_0545Inverse(b *testing.B) {
	var x e_nocarry_0545
	x.SetRandom()
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0545Butterfly(b *testing.B) {
	var x e_nocarry_0545
	x.SetRandom()
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0545)
	}
}

func BenchmarkE_nocarry_0545Exp(b *testing.B) {
	var x e_nocarry_0545
	x.SetRandom()
	benchRese_nocarry_0545.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0545Double(b *testing.B) {
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Double(&benchRese_nocarry_0545)
	}
}

func BenchmarkE_nocarry_0545Add(b *testing.B) {
	var x e_nocarry_0545
	x.SetRandom()
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Add(&x, &benchRese_nocarry_0545)
	}
}

func BenchmarkE_nocarry_0545Sub(b *testing.B) {
	var x e_nocarry_0545
	x.SetRandom()
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Sub(&x, &benchRese_nocarry_0545)
	}
}

func BenchmarkE_nocarry_0545Neg(b *testing.B) {
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Neg(&benchRese_nocarry_0545)
	}
}

func BenchmarkE_nocarry_0545Div(b *testing.B) {
	var x e_nocarry_0545
	x.SetRandom()
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Div(&x, &benchRese_nocarry_0545)
	}
}

func BenchmarkE_nocarry_0545FromMont(b *testing.B) {
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.FromMont()
	}
}

func BenchmarkE_nocarry_0545ToMont(b *testing.B) {
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.ToMont()
	}
}
func BenchmarkE_nocarry_0545Square(b *testing.B) {
	benchRese_nocarry_0545.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Square(&benchRese_nocarry_0545)
	}
}

func BenchmarkE_nocarry_0545Sqrt(b *testing.B) {
	var a e_nocarry_0545
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0545Mul(b *testing.B) {
	x := e_nocarry_0545{
		5891033460308040379,
		6927189164683473864,
		1879628867065116283,
	...
	benchRese_nocarry_0545.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Mul(&benchRese_nocarry_0545, &x)
	}
}

func BenchmarkE_nocarry_0545Cmp(b *testing.B) {
	x := e_nocarry_0545{
		5891033460308040379,
		6927189164683473864,
		1879628867065116283,
	...
	benchRese_nocarry_0545 = x
	benchRese_nocarry_0545[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0545.Cmp(&x)
	}
}

func TestE_nocarry_0545Cmp(t *testing.T) {
	var x, y e_nocarry_0545
...
func TestE_nocarry_0545IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0545
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0545

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0545{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0545
	one.SetOne()
	e.Sub(&qe_nocarry_0545, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0545{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0545{0, uint64(i)})
	}
...
func TestE_nocarry_0545NegZero(t *testing.T) {
	var a, b e_nocarry_0545
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0545Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0545, len(staticTestValues))
...
func TestE_nocarry_0545Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0545) bool {
			var b e_nocarry_0545
...
func TestE_nocarry_0545InverseExp(t *testing.T) {
...
func TestE_nocarry_0545MulByConstants(t *testing.T) {
...
func TestE_nocarry_0545Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0545) bool {
...
func TestE_nocarry_0545LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0545Halve(t *testing.T) {
...
func TestE_nocarry_0545FromMont(t *testing.T) {
...
type testPaire_nocarry_0545 struct {
	element e_nocarry_0545
	bigint  big.Int
}

func (z *e_nocarry_0545) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0545[8] {
		return true
	}
	if z[8] < qe_nocarry_0545[8] {
		return false
	...
	return z[0] >= qe_nocarry_0545[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0545

		g.element = e_nocarry_0545{
		...
		if qe_nocarry_0545[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0545[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0545 {
			var g e_nocarry_0545
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0545[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0545[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0545[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0545[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0545[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0545[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0545[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0545[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0545[8], carry)
...
func Benchmarke_nocarry_0545InverseNew(b *testing.B) {
	var x e_nocarry_0545
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0545
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0545
		var xInv e_nocarry_0545
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0545
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0545
...
func testLinearComb(t *testing.T, x *e_nocarry_0545, xC int64, y *e_nocarry_0545, yC int64) {
	...
	var z e_nocarry_0545
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0545, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0545
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0545, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0545
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0545, xHi uint64) {
	var res e_nocarry_0545
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0545) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0545) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0545, c int64, result *e_nocarry_0545, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0545) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0545) uint64 {
