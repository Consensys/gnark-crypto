...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x45e617573afb689d, R12
	ADDQ R12, AX
	MOVQ $0xaee294f66585c350, R12
	ADCQ R12, DX
	MOVQ $0x4c8da057c057192e, R12
	ADCQ R12, CX
	MOVQ $0xe54cea41123a4f7e, R12
	ADCQ R12, BX
	MOVQ $0x243a59a56a850308, R12
	ADCQ R12, SI
	MOVQ $0x4281bdd76ca20885, R12
	ADCQ R12, DI
	MOVQ $0x34e306f786ed64cc, R12
	ADCQ R12, R8
	MOVQ $0x94d775b23a3e8114, R12
	ADCQ R12, R9
	MOVQ $0x00000001df355d05, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x45e617573afb689d, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xaee294f66585c350, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x4c8da057c057192e, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xe54cea41123a4f7e, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x243a59a56a850308, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x4281bdd76ca20885, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x34e306f786ed64cc, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x94d775b23a3e8114, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000001df355d05, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x45e617573afb689d, AX
	ADDQ AX, DX
	MOVQ $0xaee294f66585c350, AX
	ADCQ AX, CX
	MOVQ $0x4c8da057c057192e, AX
	ADCQ AX, BX
	MOVQ $0xe54cea41123a4f7e, AX
	ADCQ AX, SI
	MOVQ $0x243a59a56a850308, AX
	ADCQ AX, DI
	MOVQ $0x4281bdd76ca20885, AX
	ADCQ AX, R8
	MOVQ $0x34e306f786ed64cc, AX
	ADCQ AX, R9
	MOVQ $0x94d775b23a3e8114, AX
	ADCQ AX, R10
	MOVQ $0x00000001df355d05, AX
	ADCQ AX, R11
