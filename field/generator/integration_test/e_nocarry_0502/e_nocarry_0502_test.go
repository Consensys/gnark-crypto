...
var benchRese_nocarry_0502 e_nocarry_0502

func BenchmarkE_nocarry_0502SetBytes(b *testing.B) {
	var x e_nocarry_0502
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0502MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0502.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0502)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0502)
		}
	})
}

func BenchmarkE_nocarry_0502Inverse(b *testing.B) {
	var x e_nocarry_0502
	x.SetRandom()
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0502Butterfly(b *testing.B) {
	var x e_nocarry_0502
	x.SetRandom()
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0502)
	}
}

func BenchmarkE_nocarry_0502Exp(b *testing.B) {
	var x e_nocarry_0502
	x.SetRandom()
	benchRese_nocarry_0502.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0502Double(b *testing.B) {
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Double(&benchRese_nocarry_0502)
	}
}

func BenchmarkE_nocarry_0502Add(b *testing.B) {
	var x e_nocarry_0502
	x.SetRandom()
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Add(&x, &benchRese_nocarry_0502)
	}
}

func BenchmarkE_nocarry_0502Sub(b *testing.B) {
	var x e_nocarry_0502
	x.SetRandom()
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Sub(&x, &benchRese_nocarry_0502)
	}
}

func BenchmarkE_nocarry_0502Neg(b *testing.B) {
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Neg(&benchRese_nocarry_0502)
	}
}

func BenchmarkE_nocarry_0502Div(b *testing.B) {
	var x e_nocarry_0502
	x.SetRandom()
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Div(&x, &benchRese_nocarry_0502)
	}
}

func BenchmarkE_nocarry_0502FromMont(b *testing.B) {
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.FromMont()
	}
}

func BenchmarkE_nocarry_0502ToMont(b *testing.B) {
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.ToMont()
	}
}
func BenchmarkE_nocarry_0502Square(b *testing.B) {
	benchRese_nocarry_0502.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Square(&benchRese_nocarry_0502)
	}
}

func BenchmarkE_nocarry_0502Sqrt(b *testing.B) {
	var a e_nocarry_0502
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0502Mul(b *testing.B) {
	x := e_nocarry_0502{
		4896905824936954735,
		4525652252955183781,
	...
	benchRese_nocarry_0502.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Mul(&benchRese_nocarry_0502, &x)
	}
}

func BenchmarkE_nocarry_0502Cmp(b *testing.B) {
	x := e_nocarry_0502{
		4896905824936954735,
		4525652252955183781,
		13549232357576653881,
	...
	benchRese_nocarry_0502 = x
	benchRese_nocarry_0502[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0502.Cmp(&x)
	}
}

func TestE_nocarry_0502Cmp(t *testing.T) {
	var x, y e_nocarry_0502
...
func TestE_nocarry_0502IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0502
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0502

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0502{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0502
	one.SetOne()
	e.Sub(&qe_nocarry_0502, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0502{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0502{0, uint64(i)})
	}
...
func TestE_nocarry_0502NegZero(t *testing.T) {
	var a, b e_nocarry_0502
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0502Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0502, len(staticTestValues))
...
func TestE_nocarry_0502Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0502) bool {
			var b e_nocarry_0502
...
func TestE_nocarry_0502InverseExp(t *testing.T) {
...
func TestE_nocarry_0502MulByConstants(t *testing.T) {
...
func TestE_nocarry_0502Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0502) bool {
...
func TestE_nocarry_0502LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0502Halve(t *testing.T) {
...
func TestE_nocarry_0502FromMont(t *testing.T) {
...
type testPaire_nocarry_0502 struct {
	element e_nocarry_0502
	bigint  big.Int
}

func (z *e_nocarry_0502) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0502[7] {
		return true
	}
	if z[7] < qe_nocarry_0502[7] {
		return false
	...
	return z[0] >= qe_nocarry_0502[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0502

		g.element = e_nocarry_0502{
		...
		if qe_nocarry_0502[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0502[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0502 {
			var g e_nocarry_0502
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0502[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0502[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0502[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0502[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0502[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0502[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0502[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0502[7], carry)
...
func Benchmarke_nocarry_0502InverseNew(b *testing.B) {
	var x e_nocarry_0502
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0502
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0502
		var xInv e_nocarry_0502
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0502
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0502
...
func testLinearComb(t *testing.T, x *e_nocarry_0502, xC int64, y *e_nocarry_0502, yC int64) {
	...
	var z e_nocarry_0502
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0502, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0502
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0502, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0502
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0502, xHi uint64) {
	var res e_nocarry_0502
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0502) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0502) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0502, c int64, result *e_nocarry_0502, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0502) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0502) uint64 {
