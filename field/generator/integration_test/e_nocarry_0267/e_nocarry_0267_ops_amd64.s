...
// modulus q
DATA q<>+0(SB)/8, $0xbfee7e1916ddc389
DATA q<>+8(SB)/8, $0x34f13bd59bc2212c
DATA q<>+16(SB)/8, $0x772bb75f2a7a7e3d
DATA q<>+24(SB)/8, $0x9e582b90c5c1d427
DATA q<>+32(SB)/8, $0x000000000000061f
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x5da521ae59465d47
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xbfee7e1916ddc389, R9
	MOVQ    $0x34f13bd59bc2212c, R10
	MOVQ    $0x772bb75f2a7a7e3d, R11
	MOVQ    $0x9e582b90c5c1d427, R12
	MOVQ    $0x000000000000061f, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x34f13bd59bc2212c, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x772bb75f2a7a7e3d, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x9e582b90c5c1d427, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000000000061f, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xbfee7e1916ddc389, CX
	MOVQ    $0x34f13bd59bc2212c, BX
	MOVQ    $0x772bb75f2a7a7e3d, SI
	MOVQ    $0x9e582b90c5c1d427, DI
	MOVQ    $0x000000000000061f, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
