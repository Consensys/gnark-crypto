...
var benchRese_nocarry_0267 e_nocarry_0267

func BenchmarkE_nocarry_0267SetBytes(b *testing.B) {
	var x e_nocarry_0267
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0267MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0267.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0267)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0267)
		}
	})
}

func BenchmarkE_nocarry_0267Inverse(b *testing.B) {
	var x e_nocarry_0267
	x.SetRandom()
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0267Butterfly(b *testing.B) {
	var x e_nocarry_0267
	x.SetRandom()
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0267)
	}
}

func BenchmarkE_nocarry_0267Exp(b *testing.B) {
	var x e_nocarry_0267
	x.SetRandom()
	benchRese_nocarry_0267.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0267Double(b *testing.B) {
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Double(&benchRese_nocarry_0267)
	}
}

func BenchmarkE_nocarry_0267Add(b *testing.B) {
	var x e_nocarry_0267
	x.SetRandom()
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Add(&x, &benchRese_nocarry_0267)
	}
}

func BenchmarkE_nocarry_0267Sub(b *testing.B) {
	var x e_nocarry_0267
	x.SetRandom()
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Sub(&x, &benchRese_nocarry_0267)
	}
}

func BenchmarkE_nocarry_0267Neg(b *testing.B) {
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Neg(&benchRese_nocarry_0267)
	}
}

func BenchmarkE_nocarry_0267Div(b *testing.B) {
	var x e_nocarry_0267
	x.SetRandom()
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Div(&x, &benchRese_nocarry_0267)
	}
}

func BenchmarkE_nocarry_0267FromMont(b *testing.B) {
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.FromMont()
	}
}

func BenchmarkE_nocarry_0267ToMont(b *testing.B) {
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.ToMont()
	}
}
func BenchmarkE_nocarry_0267Square(b *testing.B) {
	benchRese_nocarry_0267.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Square(&benchRese_nocarry_0267)
	}
}

func BenchmarkE_nocarry_0267Sqrt(b *testing.B) {
	var a e_nocarry_0267
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0267Mul(b *testing.B) {
	x := e_nocarry_0267{
	...
	benchRese_nocarry_0267.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Mul(&benchRese_nocarry_0267, &x)
	}
}

func BenchmarkE_nocarry_0267Cmp(b *testing.B) {
	x := e_nocarry_0267{
		18433697028700924288,
		1500846779095147812,
		14157618839458583565,
	...
	benchRese_nocarry_0267 = x
	benchRese_nocarry_0267[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0267.Cmp(&x)
	}
}

func TestE_nocarry_0267Cmp(t *testing.T) {
	var x, y e_nocarry_0267
...
func TestE_nocarry_0267IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0267
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0267

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0267{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0267
	one.SetOne()
	e.Sub(&qe_nocarry_0267, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0267{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0267{0, uint64(i)})
	}
...
func TestE_nocarry_0267NegZero(t *testing.T) {
	var a, b e_nocarry_0267
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0267Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0267, len(staticTestValues))
...
func TestE_nocarry_0267Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0267) bool {
			var b e_nocarry_0267
...
func TestE_nocarry_0267InverseExp(t *testing.T) {
...
func TestE_nocarry_0267MulByConstants(t *testing.T) {
...
func TestE_nocarry_0267Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0267) bool {
...
func TestE_nocarry_0267LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0267Halve(t *testing.T) {
...
func TestE_nocarry_0267FromMont(t *testing.T) {
...
type testPaire_nocarry_0267 struct {
	element e_nocarry_0267
	bigint  big.Int
}

func (z *e_nocarry_0267) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0267[4] {
		return true
	}
	if z[4] < qe_nocarry_0267[4] {
		return false
	...
	return z[0] >= qe_nocarry_0267[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0267

		g.element = e_nocarry_0267{
		...
		if qe_nocarry_0267[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0267[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0267 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0267[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0267[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0267[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0267[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0267[4], carry)
...
func Benchmarke_nocarry_0267InverseNew(b *testing.B) {
	var x e_nocarry_0267
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0267
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0267
		var xInv e_nocarry_0267
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0267
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0267
...
func testLinearComb(t *testing.T, x *e_nocarry_0267, xC int64, y *e_nocarry_0267, yC int64) {
	...
	var z e_nocarry_0267
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0267, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0267
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0267, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0267
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0267, xHi uint64) {
	var res e_nocarry_0267
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0267) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0267) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0267, c int64, result *e_nocarry_0267, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0267) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0267) uint64 {
