...
var benchRese_nocarry_0431 e_nocarry_0431

func BenchmarkE_nocarry_0431SetBytes(b *testing.B) {
	var x e_nocarry_0431
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0431MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0431.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0431)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0431)
		}
	})
}

func BenchmarkE_nocarry_0431Inverse(b *testing.B) {
	var x e_nocarry_0431
	x.SetRandom()
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0431Butterfly(b *testing.B) {
	var x e_nocarry_0431
	x.SetRandom()
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0431)
	}
}

func BenchmarkE_nocarry_0431Exp(b *testing.B) {
	var x e_nocarry_0431
	x.SetRandom()
	benchRese_nocarry_0431.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0431Double(b *testing.B) {
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Double(&benchRese_nocarry_0431)
	}
}

func BenchmarkE_nocarry_0431Add(b *testing.B) {
	var x e_nocarry_0431
	x.SetRandom()
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Add(&x, &benchRese_nocarry_0431)
	}
}

func BenchmarkE_nocarry_0431Sub(b *testing.B) {
	var x e_nocarry_0431
	x.SetRandom()
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Sub(&x, &benchRese_nocarry_0431)
	}
}

func BenchmarkE_nocarry_0431Neg(b *testing.B) {
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Neg(&benchRese_nocarry_0431)
	}
}

func BenchmarkE_nocarry_0431Div(b *testing.B) {
	var x e_nocarry_0431
	x.SetRandom()
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Div(&x, &benchRese_nocarry_0431)
	}
}

func BenchmarkE_nocarry_0431FromMont(b *testing.B) {
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.FromMont()
	}
}

func BenchmarkE_nocarry_0431ToMont(b *testing.B) {
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.ToMont()
	}
}
func BenchmarkE_nocarry_0431Square(b *testing.B) {
	benchRese_nocarry_0431.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Square(&benchRese_nocarry_0431)
	}
}

func BenchmarkE_nocarry_0431Sqrt(b *testing.B) {
	var a e_nocarry_0431
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0431Mul(b *testing.B) {
	x := e_nocarry_0431{
	...
	benchRese_nocarry_0431.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Mul(&benchRese_nocarry_0431, &x)
	}
}

func BenchmarkE_nocarry_0431Cmp(b *testing.B) {
	x := e_nocarry_0431{
		15627178730025723741,
		2229863224486605463,
		10082444387344650068,
	...
	benchRese_nocarry_0431 = x
	benchRese_nocarry_0431[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0431.Cmp(&x)
	}
}

func TestE_nocarry_0431Cmp(t *testing.T) {
	var x, y e_nocarry_0431
...
func TestE_nocarry_0431IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0431
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0431

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0431{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0431
	one.SetOne()
	e.Sub(&qe_nocarry_0431, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0431{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0431{0, uint64(i)})
	}
...
func TestE_nocarry_0431NegZero(t *testing.T) {
	var a, b e_nocarry_0431
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0431Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0431, len(staticTestValues))
...
func TestE_nocarry_0431Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0431) bool {
			var b e_nocarry_0431
...
func TestE_nocarry_0431InverseExp(t *testing.T) {
...
func TestE_nocarry_0431MulByConstants(t *testing.T) {
...
func TestE_nocarry_0431Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0431) bool {
...
func TestE_nocarry_0431LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0431Halve(t *testing.T) {
...
func TestE_nocarry_0431FromMont(t *testing.T) {
...
type testPaire_nocarry_0431 struct {
	element e_nocarry_0431
	bigint  big.Int
}

func (z *e_nocarry_0431) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0431[6] {
		return true
	}
	if z[6] < qe_nocarry_0431[6] {
		return false
	...
	return z[0] >= qe_nocarry_0431[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0431

		g.element = e_nocarry_0431{
		...
		if qe_nocarry_0431[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0431[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0431 {
			var g e_nocarry_0431
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0431[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0431[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0431[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0431[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0431[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0431[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0431[6], carry)
...
func Benchmarke_nocarry_0431InverseNew(b *testing.B) {
	var x e_nocarry_0431
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0431
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0431
		var xInv e_nocarry_0431
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0431
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0431
...
func testLinearComb(t *testing.T, x *e_nocarry_0431, xC int64, y *e_nocarry_0431, yC int64) {
	...
	var z e_nocarry_0431
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0431, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0431
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0431, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0431
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0431, xHi uint64) {
	var res e_nocarry_0431
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0431) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0431) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0431, c int64, result *e_nocarry_0431, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0431) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0431) uint64 {
