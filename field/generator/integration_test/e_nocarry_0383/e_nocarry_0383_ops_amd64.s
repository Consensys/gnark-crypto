...
// modulus q
DATA q<>+0(SB)/8, $0x6bc74208e64914f5
DATA q<>+8(SB)/8, $0x2712ef142896c712
DATA q<>+16(SB)/8, $0x0b402935993e101f
DATA q<>+24(SB)/8, $0x0d04ba9c91fbf51f
DATA q<>+32(SB)/8, $0x7b2c9cc783d32bee
DATA q<>+40(SB)/8, $0x7f75957baac802e3
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xff3b84f1f99008a3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x6bc74208e64914f5, R10
	MOVQ    $0x2712ef142896c712, R11
	MOVQ    $0x0b402935993e101f, R12
	MOVQ    $0x0d04ba9c91fbf51f, R13
	MOVQ    $0x7b2c9cc783d32bee, R14
	MOVQ    $0x7f75957baac802e3, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x2712ef142896c712, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x0b402935993e101f, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x0d04ba9c91fbf51f, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x7b2c9cc783d32bee, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x7f75957baac802e3, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x6bc74208e64914f5, CX
	MOVQ    $0x2712ef142896c712, BX
	MOVQ    $0x0b402935993e101f, SI
	MOVQ    $0x0d04ba9c91fbf51f, DI
	MOVQ    $0x7b2c9cc783d32bee, R8
	MOVQ    $0x7f75957baac802e3, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
