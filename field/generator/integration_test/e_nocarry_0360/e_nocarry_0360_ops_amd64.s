...
// modulus q
DATA q<>+0(SB)/8, $0xd93fc25cb4cc0bdd
DATA q<>+8(SB)/8, $0xc6276a12169f1834
DATA q<>+16(SB)/8, $0x31172f07cbbdd9c7
DATA q<>+24(SB)/8, $0x39be3dd2e894f8dd
DATA q<>+32(SB)/8, $0x6d2a014c176df27d
DATA q<>+40(SB)/8, $0x000000fe17a59ad7
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x75f2d7cce8165b8b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xd93fc25cb4cc0bdd, R10
	MOVQ    $0xc6276a12169f1834, R11
	MOVQ    $0x31172f07cbbdd9c7, R12
	MOVQ    $0x39be3dd2e894f8dd, R13
	MOVQ    $0x6d2a014c176df27d, R14
	MOVQ    $0x000000fe17a59ad7, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xc6276a12169f1834, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x31172f07cbbdd9c7, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x39be3dd2e894f8dd, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x6d2a014c176df27d, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000fe17a59ad7, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xd93fc25cb4cc0bdd, CX
	MOVQ    $0xc6276a12169f1834, BX
	MOVQ    $0x31172f07cbbdd9c7, SI
	MOVQ    $0x39be3dd2e894f8dd, DI
	MOVQ    $0x6d2a014c176df27d, R8
	MOVQ    $0x000000fe17a59ad7, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
