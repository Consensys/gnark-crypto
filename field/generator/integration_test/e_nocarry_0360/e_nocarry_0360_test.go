...
var benchRese_nocarry_0360 e_nocarry_0360

func BenchmarkE_nocarry_0360SetBytes(b *testing.B) {
	var x e_nocarry_0360
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0360MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0360.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0360)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0360)
		}
	})
}

func BenchmarkE_nocarry_0360Inverse(b *testing.B) {
	var x e_nocarry_0360
	x.SetRandom()
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0360Butterfly(b *testing.B) {
	var x e_nocarry_0360
	x.SetRandom()
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0360)
	}
}

func BenchmarkE_nocarry_0360Exp(b *testing.B) {
	var x e_nocarry_0360
	x.SetRandom()
	benchRese_nocarry_0360.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0360Double(b *testing.B) {
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Double(&benchRese_nocarry_0360)
	}
}

func BenchmarkE_nocarry_0360Add(b *testing.B) {
	var x e_nocarry_0360
	x.SetRandom()
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Add(&x, &benchRese_nocarry_0360)
	}
}

func BenchmarkE_nocarry_0360Sub(b *testing.B) {
	var x e_nocarry_0360
	x.SetRandom()
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Sub(&x, &benchRese_nocarry_0360)
	}
}

func BenchmarkE_nocarry_0360Neg(b *testing.B) {
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Neg(&benchRese_nocarry_0360)
	}
}

func BenchmarkE_nocarry_0360Div(b *testing.B) {
	var x e_nocarry_0360
	x.SetRandom()
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Div(&x, &benchRese_nocarry_0360)
	}
}

func BenchmarkE_nocarry_0360FromMont(b *testing.B) {
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.FromMont()
	}
}

func BenchmarkE_nocarry_0360ToMont(b *testing.B) {
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.ToMont()
	}
}
func BenchmarkE_nocarry_0360Square(b *testing.B) {
	benchRese_nocarry_0360.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Square(&benchRese_nocarry_0360)
	}
}

func BenchmarkE_nocarry_0360Sqrt(b *testing.B) {
	var a e_nocarry_0360
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0360Mul(b *testing.B) {
	x := e_nocarry_0360{
		8542266238536117255,
	...
	benchRese_nocarry_0360.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Mul(&benchRese_nocarry_0360, &x)
	}
}

func BenchmarkE_nocarry_0360Cmp(b *testing.B) {
	x := e_nocarry_0360{
		8542266238536117255,
		10967533601114316618,
		16876964692270356466,
	...
	benchRese_nocarry_0360 = x
	benchRese_nocarry_0360[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0360.Cmp(&x)
	}
}

func TestE_nocarry_0360Cmp(t *testing.T) {
	var x, y e_nocarry_0360
...
func TestE_nocarry_0360IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0360
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0360

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0360{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0360
	one.SetOne()
	e.Sub(&qe_nocarry_0360, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0360{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0360{0, uint64(i)})
	}
...
func TestE_nocarry_0360NegZero(t *testing.T) {
	var a, b e_nocarry_0360
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0360Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0360, len(staticTestValues))
...
func TestE_nocarry_0360Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0360) bool {
			var b e_nocarry_0360
...
func TestE_nocarry_0360InverseExp(t *testing.T) {
...
func TestE_nocarry_0360MulByConstants(t *testing.T) {
...
func TestE_nocarry_0360Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0360) bool {
...
func TestE_nocarry_0360LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0360Halve(t *testing.T) {
...
func TestE_nocarry_0360FromMont(t *testing.T) {
...
type testPaire_nocarry_0360 struct {
	element e_nocarry_0360
	bigint  big.Int
}

func (z *e_nocarry_0360) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0360[5] {
		return true
	}
	if z[5] < qe_nocarry_0360[5] {
		return false
	...
	return z[0] >= qe_nocarry_0360[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0360

		g.element = e_nocarry_0360{
		...
		if qe_nocarry_0360[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0360[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0360 {
			var g e_nocarry_0360
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0360[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0360[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0360[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0360[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0360[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0360[5], carry)
...
func Benchmarke_nocarry_0360InverseNew(b *testing.B) {
	var x e_nocarry_0360
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0360
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0360
		var xInv e_nocarry_0360
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0360
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0360
...
func testLinearComb(t *testing.T, x *e_nocarry_0360, xC int64, y *e_nocarry_0360, yC int64) {
	...
	var z e_nocarry_0360
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0360, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0360
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0360, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0360
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0360, xHi uint64) {
	var res e_nocarry_0360
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0360) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0360) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0360, c int64, result *e_nocarry_0360, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0360) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0360) uint64 {
