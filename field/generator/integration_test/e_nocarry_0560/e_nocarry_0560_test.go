...
var benchRese_nocarry_0560 e_nocarry_0560

func BenchmarkE_nocarry_0560SetBytes(b *testing.B) {
	var x e_nocarry_0560
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0560MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0560.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0560)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0560)
		}
	})
}

func BenchmarkE_nocarry_0560Inverse(b *testing.B) {
	var x e_nocarry_0560
	x.SetRandom()
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0560Butterfly(b *testing.B) {
	var x e_nocarry_0560
	x.SetRandom()
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0560)
	}
}

func BenchmarkE_nocarry_0560Exp(b *testing.B) {
	var x e_nocarry_0560
	x.SetRandom()
	benchRese_nocarry_0560.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0560Double(b *testing.B) {
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Double(&benchRese_nocarry_0560)
	}
}

func BenchmarkE_nocarry_0560Add(b *testing.B) {
	var x e_nocarry_0560
	x.SetRandom()
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Add(&x, &benchRese_nocarry_0560)
	}
}

func BenchmarkE_nocarry_0560Sub(b *testing.B) {
	var x e_nocarry_0560
	x.SetRandom()
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Sub(&x, &benchRese_nocarry_0560)
	}
}

func BenchmarkE_nocarry_0560Neg(b *testing.B) {
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Neg(&benchRese_nocarry_0560)
	}
}

func BenchmarkE_nocarry_0560Div(b *testing.B) {
	var x e_nocarry_0560
	x.SetRandom()
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Div(&x, &benchRese_nocarry_0560)
	}
}

func BenchmarkE_nocarry_0560FromMont(b *testing.B) {
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.FromMont()
	}
}

func BenchmarkE_nocarry_0560ToMont(b *testing.B) {
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.ToMont()
	}
}
func BenchmarkE_nocarry_0560Square(b *testing.B) {
	benchRese_nocarry_0560.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Square(&benchRese_nocarry_0560)
	}
}

func BenchmarkE_nocarry_0560Sqrt(b *testing.B) {
	var a e_nocarry_0560
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0560Mul(b *testing.B) {
	x := e_nocarry_0560{
	...
	benchRese_nocarry_0560.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Mul(&benchRese_nocarry_0560, &x)
	}
}

func BenchmarkE_nocarry_0560Cmp(b *testing.B) {
	x := e_nocarry_0560{
		13976697514221233915,
		3336528066837654989,
		4446804538458290922,
	...
	benchRese_nocarry_0560 = x
	benchRese_nocarry_0560[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0560.Cmp(&x)
	}
}

func TestE_nocarry_0560Cmp(t *testing.T) {
	var x, y e_nocarry_0560
...
func TestE_nocarry_0560IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0560
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0560

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0560{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0560
	one.SetOne()
	e.Sub(&qe_nocarry_0560, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0560{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0560{0, uint64(i)})
	}
...
func TestE_nocarry_0560NegZero(t *testing.T) {
	var a, b e_nocarry_0560
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0560Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0560, len(staticTestValues))
...
func TestE_nocarry_0560Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0560) bool {
			var b e_nocarry_0560
...
func TestE_nocarry_0560InverseExp(t *testing.T) {
...
func TestE_nocarry_0560MulByConstants(t *testing.T) {
...
func TestE_nocarry_0560Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0560) bool {
...
func TestE_nocarry_0560LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0560Halve(t *testing.T) {
...
func TestE_nocarry_0560FromMont(t *testing.T) {
...
type testPaire_nocarry_0560 struct {
	element e_nocarry_0560
	bigint  big.Int
}

func (z *e_nocarry_0560) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0560[8] {
		return true
	}
	if z[8] < qe_nocarry_0560[8] {
		return false
	...
	return z[0] >= qe_nocarry_0560[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0560

		g.element = e_nocarry_0560{
		...
		if qe_nocarry_0560[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0560[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0560 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0560[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0560[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0560[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0560[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0560[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0560[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0560[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0560[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0560[8], carry)
...
func Benchmarke_nocarry_0560InverseNew(b *testing.B) {
	var x e_nocarry_0560
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0560
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0560
		var xInv e_nocarry_0560
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0560
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0560
...
func testLinearComb(t *testing.T, x *e_nocarry_0560, xC int64, y *e_nocarry_0560, yC int64) {
	...
	var z e_nocarry_0560
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0560, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0560
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0560, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0560
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0560, xHi uint64) {
	var res e_nocarry_0560
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0560) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0560) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0560, c int64, result *e_nocarry_0560, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0560) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0560) uint64 {
