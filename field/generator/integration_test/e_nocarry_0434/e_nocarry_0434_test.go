...
var benchRese_nocarry_0434 e_nocarry_0434

func BenchmarkE_nocarry_0434SetBytes(b *testing.B) {
	var x e_nocarry_0434
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0434MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0434.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0434)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0434)
		}
	})
}

func BenchmarkE_nocarry_0434Inverse(b *testing.B) {
	var x e_nocarry_0434
	x.SetRandom()
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0434Butterfly(b *testing.B) {
	var x e_nocarry_0434
	x.SetRandom()
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0434)
	}
}

func BenchmarkE_nocarry_0434Exp(b *testing.B) {
	var x e_nocarry_0434
	x.SetRandom()
	benchRese_nocarry_0434.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0434Double(b *testing.B) {
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Double(&benchRese_nocarry_0434)
	}
}

func BenchmarkE_nocarry_0434Add(b *testing.B) {
	var x e_nocarry_0434
	x.SetRandom()
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Add(&x, &benchRese_nocarry_0434)
	}
}

func BenchmarkE_nocarry_0434Sub(b *testing.B) {
	var x e_nocarry_0434
	x.SetRandom()
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Sub(&x, &benchRese_nocarry_0434)
	}
}

func BenchmarkE_nocarry_0434Neg(b *testing.B) {
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Neg(&benchRese_nocarry_0434)
	}
}

func BenchmarkE_nocarry_0434Div(b *testing.B) {
	var x e_nocarry_0434
	x.SetRandom()
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Div(&x, &benchRese_nocarry_0434)
	}
}

func BenchmarkE_nocarry_0434FromMont(b *testing.B) {
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.FromMont()
	}
}

func BenchmarkE_nocarry_0434ToMont(b *testing.B) {
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.ToMont()
	}
}
func BenchmarkE_nocarry_0434Square(b *testing.B) {
	benchRese_nocarry_0434.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Square(&benchRese_nocarry_0434)
	}
}

func BenchmarkE_nocarry_0434Sqrt(b *testing.B) {
	var a e_nocarry_0434
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0434Mul(b *testing.B) {
	x := e_nocarry_0434{
	...
	benchRese_nocarry_0434.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Mul(&benchRese_nocarry_0434, &x)
	}
}

func BenchmarkE_nocarry_0434Cmp(b *testing.B) {
	x := e_nocarry_0434{
		12427274503979851327,
		17886861488586541197,
		16201748421389050126,
	...
	benchRese_nocarry_0434 = x
	benchRese_nocarry_0434[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0434.Cmp(&x)
	}
}

func TestE_nocarry_0434Cmp(t *testing.T) {
	var x, y e_nocarry_0434
...
func TestE_nocarry_0434IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0434
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0434

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0434{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0434
	one.SetOne()
	e.Sub(&qe_nocarry_0434, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0434{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0434{0, uint64(i)})
	}
...
func TestE_nocarry_0434NegZero(t *testing.T) {
	var a, b e_nocarry_0434
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0434Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0434, len(staticTestValues))
...
func TestE_nocarry_0434Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0434) bool {
			var b e_nocarry_0434
...
func TestE_nocarry_0434InverseExp(t *testing.T) {
...
func TestE_nocarry_0434MulByConstants(t *testing.T) {
...
func TestE_nocarry_0434Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0434) bool {
...
func TestE_nocarry_0434LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0434Halve(t *testing.T) {
...
func TestE_nocarry_0434FromMont(t *testing.T) {
...
type testPaire_nocarry_0434 struct {
	element e_nocarry_0434
	bigint  big.Int
}

func (z *e_nocarry_0434) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0434[6] {
		return true
	}
	if z[6] < qe_nocarry_0434[6] {
		return false
	...
	return z[0] >= qe_nocarry_0434[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0434

		g.element = e_nocarry_0434{
		...
		if qe_nocarry_0434[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0434[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0434 {
			var g e_nocarry_0434
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0434[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0434[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0434[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0434[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0434[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0434[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0434[6], carry)
...
func Benchmarke_nocarry_0434InverseNew(b *testing.B) {
	var x e_nocarry_0434
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0434
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0434
		var xInv e_nocarry_0434
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0434
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0434
...
func testLinearComb(t *testing.T, x *e_nocarry_0434, xC int64, y *e_nocarry_0434, yC int64) {
	...
	var z e_nocarry_0434
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0434, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0434
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0434, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0434
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0434, xHi uint64) {
	var res e_nocarry_0434
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0434) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0434) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0434, c int64, result *e_nocarry_0434, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0434) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0434) uint64 {
