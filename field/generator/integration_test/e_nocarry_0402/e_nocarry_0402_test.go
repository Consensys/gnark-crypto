...
var benchRese_nocarry_0402 e_nocarry_0402

func BenchmarkE_nocarry_0402SetBytes(b *testing.B) {
	var x e_nocarry_0402
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0402MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0402.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0402)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0402)
		}
	})
}

func BenchmarkE_nocarry_0402Inverse(b *testing.B) {
	var x e_nocarry_0402
	x.SetRandom()
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0402Butterfly(b *testing.B) {
	var x e_nocarry_0402
	x.SetRandom()
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0402)
	}
}

func BenchmarkE_nocarry_0402Exp(b *testing.B) {
	var x e_nocarry_0402
	x.SetRandom()
	benchRese_nocarry_0402.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0402Double(b *testing.B) {
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Double(&benchRese_nocarry_0402)
	}
}

func BenchmarkE_nocarry_0402Add(b *testing.B) {
	var x e_nocarry_0402
	x.SetRandom()
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Add(&x, &benchRese_nocarry_0402)
	}
}

func BenchmarkE_nocarry_0402Sub(b *testing.B) {
	var x e_nocarry_0402
	x.SetRandom()
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Sub(&x, &benchRese_nocarry_0402)
	}
}

func BenchmarkE_nocarry_0402Neg(b *testing.B) {
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Neg(&benchRese_nocarry_0402)
	}
}

func BenchmarkE_nocarry_0402Div(b *testing.B) {
	var x e_nocarry_0402
	x.SetRandom()
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Div(&x, &benchRese_nocarry_0402)
	}
}

func BenchmarkE_nocarry_0402FromMont(b *testing.B) {
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.FromMont()
	}
}

func BenchmarkE_nocarry_0402ToMont(b *testing.B) {
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.ToMont()
	}
}
func BenchmarkE_nocarry_0402Square(b *testing.B) {
	benchRese_nocarry_0402.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Square(&benchRese_nocarry_0402)
	}
}

func BenchmarkE_nocarry_0402Sqrt(b *testing.B) {
	var a e_nocarry_0402
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0402Mul(b *testing.B) {
	x := e_nocarry_0402{
		2064945961043004707,
	...
	benchRese_nocarry_0402.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Mul(&benchRese_nocarry_0402, &x)
	}
}

func BenchmarkE_nocarry_0402Cmp(b *testing.B) {
	x := e_nocarry_0402{
		2064945961043004707,
		17257716674437796810,
		11885946240631660485,
	...
	benchRese_nocarry_0402 = x
	benchRese_nocarry_0402[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0402.Cmp(&x)
	}
}

func TestE_nocarry_0402Cmp(t *testing.T) {
	var x, y e_nocarry_0402
...
func TestE_nocarry_0402IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0402
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0402

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0402{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0402
	one.SetOne()
	e.Sub(&qe_nocarry_0402, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0402{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0402{0, uint64(i)})
	}
...
func TestE_nocarry_0402NegZero(t *testing.T) {
	var a, b e_nocarry_0402
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0402Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0402, len(staticTestValues))
...
func TestE_nocarry_0402Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0402) bool {
			var b e_nocarry_0402
...
func TestE_nocarry_0402InverseExp(t *testing.T) {
...
func TestE_nocarry_0402MulByConstants(t *testing.T) {
...
func TestE_nocarry_0402Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0402) bool {
...
func TestE_nocarry_0402LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0402Halve(t *testing.T) {
...
func TestE_nocarry_0402FromMont(t *testing.T) {
...
type testPaire_nocarry_0402 struct {
	element e_nocarry_0402
	bigint  big.Int
}

func (z *e_nocarry_0402) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0402[6] {
		return true
	}
	if z[6] < qe_nocarry_0402[6] {
		return false
	...
	return z[0] >= qe_nocarry_0402[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0402

		g.element = e_nocarry_0402{
		...
		if qe_nocarry_0402[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0402[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0402 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0402[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0402[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0402[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0402[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0402[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0402[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0402[6], carry)
...
func Benchmarke_nocarry_0402InverseNew(b *testing.B) {
	var x e_nocarry_0402
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0402
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0402
		var xInv e_nocarry_0402
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0402
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0402
...
func testLinearComb(t *testing.T, x *e_nocarry_0402, xC int64, y *e_nocarry_0402, yC int64) {
	...
	var z e_nocarry_0402
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0402, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0402
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0402, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0402
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0402, xHi uint64) {
	var res e_nocarry_0402
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0402) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0402) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0402, c int64, result *e_nocarry_0402, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0402) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0402) uint64 {
