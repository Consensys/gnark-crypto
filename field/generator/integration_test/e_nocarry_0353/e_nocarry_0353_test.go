...
var benchRese_nocarry_0353 e_nocarry_0353

func BenchmarkE_nocarry_0353SetBytes(b *testing.B) {
	var x e_nocarry_0353
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0353MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0353.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0353)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0353)
		}
	})
}

func BenchmarkE_nocarry_0353Inverse(b *testing.B) {
	var x e_nocarry_0353
	x.SetRandom()
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0353Butterfly(b *testing.B) {
	var x e_nocarry_0353
	x.SetRandom()
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0353)
	}
}

func BenchmarkE_nocarry_0353Exp(b *testing.B) {
	var x e_nocarry_0353
	x.SetRandom()
	benchRese_nocarry_0353.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0353Double(b *testing.B) {
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Double(&benchRese_nocarry_0353)
	}
}

func BenchmarkE_nocarry_0353Add(b *testing.B) {
	var x e_nocarry_0353
	x.SetRandom()
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Add(&x, &benchRese_nocarry_0353)
	}
}

func BenchmarkE_nocarry_0353Sub(b *testing.B) {
	var x e_nocarry_0353
	x.SetRandom()
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Sub(&x, &benchRese_nocarry_0353)
	}
}

func BenchmarkE_nocarry_0353Neg(b *testing.B) {
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Neg(&benchRese_nocarry_0353)
	}
}

func BenchmarkE_nocarry_0353Div(b *testing.B) {
	var x e_nocarry_0353
	x.SetRandom()
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Div(&x, &benchRese_nocarry_0353)
	}
}

func BenchmarkE_nocarry_0353FromMont(b *testing.B) {
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.FromMont()
	}
}

func BenchmarkE_nocarry_0353ToMont(b *testing.B) {
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.ToMont()
	}
}
func BenchmarkE_nocarry_0353Square(b *testing.B) {
	benchRese_nocarry_0353.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Square(&benchRese_nocarry_0353)
	}
}

func BenchmarkE_nocarry_0353Sqrt(b *testing.B) {
	var a e_nocarry_0353
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0353Mul(b *testing.B) {
	x := e_nocarry_0353{
	...
	benchRese_nocarry_0353.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Mul(&benchRese_nocarry_0353, &x)
	}
}

func BenchmarkE_nocarry_0353Cmp(b *testing.B) {
	x := e_nocarry_0353{
		18362127863604957573,
		9285436755511003807,
		13528908328699466195,
	...
	benchRese_nocarry_0353 = x
	benchRese_nocarry_0353[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0353.Cmp(&x)
	}
}

func TestE_nocarry_0353Cmp(t *testing.T) {
	var x, y e_nocarry_0353
...
func TestE_nocarry_0353IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0353
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0353

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0353{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0353
	one.SetOne()
	e.Sub(&qe_nocarry_0353, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0353{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0353{0, uint64(i)})
	}
...
func TestE_nocarry_0353NegZero(t *testing.T) {
	var a, b e_nocarry_0353
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0353Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0353, len(staticTestValues))
...
func TestE_nocarry_0353Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0353) bool {
			var b e_nocarry_0353
...
func TestE_nocarry_0353InverseExp(t *testing.T) {
...
func TestE_nocarry_0353MulByConstants(t *testing.T) {
...
func TestE_nocarry_0353Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0353) bool {
...
func TestE_nocarry_0353LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0353Halve(t *testing.T) {
...
func TestE_nocarry_0353FromMont(t *testing.T) {
...
type testPaire_nocarry_0353 struct {
	element e_nocarry_0353
	bigint  big.Int
}

func (z *e_nocarry_0353) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0353[5] {
		return true
	}
	if z[5] < qe_nocarry_0353[5] {
		return false
	...
	return z[0] >= qe_nocarry_0353[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0353

		g.element = e_nocarry_0353{
		...
		if qe_nocarry_0353[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0353[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0353 {
			var g e_nocarry_0353
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0353[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0353[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0353[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0353[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0353[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0353[5], carry)
...
func Benchmarke_nocarry_0353InverseNew(b *testing.B) {
	var x e_nocarry_0353
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0353
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0353
		var xInv e_nocarry_0353
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0353
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0353
...
func testLinearComb(t *testing.T, x *e_nocarry_0353, xC int64, y *e_nocarry_0353, yC int64) {
	...
	var z e_nocarry_0353
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0353, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0353
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0353, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0353
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0353, xHi uint64) {
	var res e_nocarry_0353
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0353) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0353) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0353, c int64, result *e_nocarry_0353, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0353) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0353) uint64 {
