...
// modulus q
DATA q<>+0(SB)/8, $0x9ea278918f1c043b
DATA q<>+8(SB)/8, $0x9d50830650c858af
DATA q<>+16(SB)/8, $0x6bdfb8643b39ce4b
DATA q<>+24(SB)/8, $0x28b252b55d2e26ba
DATA q<>+32(SB)/8, $0x893c4457be0b3500
DATA q<>+40(SB)/8, $0x00000001872ce0e4
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x1e70797d161bcb0d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x9ea278918f1c043b, R10
	MOVQ    $0x9d50830650c858af, R11
	MOVQ    $0x6bdfb8643b39ce4b, R12
	MOVQ    $0x28b252b55d2e26ba, R13
	MOVQ    $0x893c4457be0b3500, R14
	MOVQ    $0x00000001872ce0e4, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x9d50830650c858af, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x6bdfb8643b39ce4b, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x28b252b55d2e26ba, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x893c4457be0b3500, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000001872ce0e4, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x9ea278918f1c043b, CX
	MOVQ    $0x9d50830650c858af, BX
	MOVQ    $0x6bdfb8643b39ce4b, SI
	MOVQ    $0x28b252b55d2e26ba, DI
	MOVQ    $0x893c4457be0b3500, R8
	MOVQ    $0x00000001872ce0e4, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
