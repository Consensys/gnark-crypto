...
var benchRese_nocarry_0414 e_nocarry_0414

func BenchmarkE_nocarry_0414SetBytes(b *testing.B) {
	var x e_nocarry_0414
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0414MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0414.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0414)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0414)
		}
	})
}

func BenchmarkE_nocarry_0414Inverse(b *testing.B) {
	var x e_nocarry_0414
	x.SetRandom()
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0414Butterfly(b *testing.B) {
	var x e_nocarry_0414
	x.SetRandom()
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0414)
	}
}

func BenchmarkE_nocarry_0414Exp(b *testing.B) {
	var x e_nocarry_0414
	x.SetRandom()
	benchRese_nocarry_0414.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0414Double(b *testing.B) {
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Double(&benchRese_nocarry_0414)
	}
}

func BenchmarkE_nocarry_0414Add(b *testing.B) {
	var x e_nocarry_0414
	x.SetRandom()
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Add(&x, &benchRese_nocarry_0414)
	}
}

func BenchmarkE_nocarry_0414Sub(b *testing.B) {
	var x e_nocarry_0414
	x.SetRandom()
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Sub(&x, &benchRese_nocarry_0414)
	}
}

func BenchmarkE_nocarry_0414Neg(b *testing.B) {
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Neg(&benchRese_nocarry_0414)
	}
}

func BenchmarkE_nocarry_0414Div(b *testing.B) {
	var x e_nocarry_0414
	x.SetRandom()
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Div(&x, &benchRese_nocarry_0414)
	}
}

func BenchmarkE_nocarry_0414FromMont(b *testing.B) {
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.FromMont()
	}
}

func BenchmarkE_nocarry_0414ToMont(b *testing.B) {
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.ToMont()
	}
}
func BenchmarkE_nocarry_0414Square(b *testing.B) {
	benchRese_nocarry_0414.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Square(&benchRese_nocarry_0414)
	}
}

func BenchmarkE_nocarry_0414Sqrt(b *testing.B) {
	var a e_nocarry_0414
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0414Mul(b *testing.B) {
	x := e_nocarry_0414{
	...
	benchRese_nocarry_0414.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Mul(&benchRese_nocarry_0414, &x)
	}
}

func BenchmarkE_nocarry_0414Cmp(b *testing.B) {
	x := e_nocarry_0414{
		16158938521611003692,
		790495744864060897,
		3492579313480463670,
	...
	benchRese_nocarry_0414 = x
	benchRese_nocarry_0414[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0414.Cmp(&x)
	}
}

func TestE_nocarry_0414Cmp(t *testing.T) {
	var x, y e_nocarry_0414
...
func TestE_nocarry_0414IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0414
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0414

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0414{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0414
	one.SetOne()
	e.Sub(&qe_nocarry_0414, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0414{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0414{0, uint64(i)})
	}
...
func TestE_nocarry_0414NegZero(t *testing.T) {
	var a, b e_nocarry_0414
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0414Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0414, len(staticTestValues))
...
func TestE_nocarry_0414Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0414) bool {
			var b e_nocarry_0414
...
func TestE_nocarry_0414InverseExp(t *testing.T) {
...
func TestE_nocarry_0414MulByConstants(t *testing.T) {
...
func TestE_nocarry_0414Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0414) bool {
...
func TestE_nocarry_0414LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0414Halve(t *testing.T) {
...
func TestE_nocarry_0414FromMont(t *testing.T) {
...
type testPaire_nocarry_0414 struct {
	element e_nocarry_0414
	bigint  big.Int
}

func (z *e_nocarry_0414) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0414[6] {
		return true
	}
	if z[6] < qe_nocarry_0414[6] {
		return false
	...
	return z[0] >= qe_nocarry_0414[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0414

		g.element = e_nocarry_0414{
		...
		if qe_nocarry_0414[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0414[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0414 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0414[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0414[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0414[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0414[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0414[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0414[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0414[6], carry)
...
func Benchmarke_nocarry_0414InverseNew(b *testing.B) {
	var x e_nocarry_0414
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0414
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0414
		var xInv e_nocarry_0414
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0414
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0414
...
func testLinearComb(t *testing.T, x *e_nocarry_0414, xC int64, y *e_nocarry_0414, yC int64) {
	...
	var z e_nocarry_0414
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0414, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0414
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0414, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0414
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0414, xHi uint64) {
	var res e_nocarry_0414
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0414) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0414) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0414, c int64, result *e_nocarry_0414, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0414) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0414) uint64 {
