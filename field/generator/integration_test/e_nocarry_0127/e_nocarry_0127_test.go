...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0127{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0127{0, uint64(i)})
	}
...
func (z *e_nocarry_0127) biggerOrEqualModulus() bool {
	if z[1] > qe_nocarry_0127[1] {
		return true
	}
	if z[1] < qe_nocarry_0127[1] {
		return false
...
func Benchmarke_nocarry_0127InverseNew(b *testing.B) {
	var x e_nocarry_0127
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0127, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0127, xHi uint64) {
