...
// modulus q
DATA q<>+0(SB)/8, $0x56e582fd85acb5a1
DATA q<>+8(SB)/8, $0x6fdc7a2098148881
GLOBL q<>(SB), (RODATA+NOPTR), $16

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x83dc501fd2fb919f
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SUBQ    0(CX), AX
	SBBQ    8(CX), DX
	MOVQ    $0x56e582fd85acb5a1, SI
	MOVQ    $0x6fdc7a2098148881, DI
	CMOVQCC BX, SI
	CMOVQCC BX, DI
	ADDQ    SI, AX
	ADCQ    DI, DX
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SUBQ    0(DX), SI
	SBBQ    8(DX), DI
	MOVQ    $0x56e582fd85acb5a1, R8
	MOVQ    $0x6fdc7a2098148881, R9
	CMOVQCC AX, R8
	CMOVQCC AX, R9
	ADDQ    R8, SI
	ADCQ    R9, DI
