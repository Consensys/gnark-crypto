...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x76b4d045d0aae439, R13
	ADDQ R13, AX
	MOVQ $0xb7cf7123eac73b4f, R13
	ADCQ R13, DX
	MOVQ $0xf8cefc4a48f7b136, R13
	ADCQ R13, CX
	MOVQ $0xe8e7f4a299d851a7, R13
	ADCQ R13, BX
	MOVQ $0x7a320f81bf34537e, R13
	ADCQ R13, SI
	MOVQ $0xd633e03c258e5c98, R13
	ADCQ R13, DI
	MOVQ $0xf37ae59755400b5c, R13
	ADCQ R13, R8
	MOVQ $0x413c509d2afd8a87, R13
	ADCQ R13, R9
	MOVQ $0x786c2b371c939fab, R13
	ADCQ R13, R10
	MOVQ $0x0000073638a3c320, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x76b4d045d0aae439, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xb7cf7123eac73b4f, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xf8cefc4a48f7b136, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xe8e7f4a299d851a7, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x7a320f81bf34537e, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xd633e03c258e5c98, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xf37ae59755400b5c, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x413c509d2afd8a87, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x786c2b371c939fab, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000073638a3c320, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x76b4d045d0aae439, AX
	ADDQ AX, DX
	MOVQ $0xb7cf7123eac73b4f, AX
	ADCQ AX, CX
	MOVQ $0xf8cefc4a48f7b136, AX
	ADCQ AX, BX
	MOVQ $0xe8e7f4a299d851a7, AX
	ADCQ AX, SI
	MOVQ $0x7a320f81bf34537e, AX
	ADCQ AX, DI
	MOVQ $0xd633e03c258e5c98, AX
	ADCQ AX, R8
	MOVQ $0xf37ae59755400b5c, AX
	ADCQ AX, R9
	MOVQ $0x413c509d2afd8a87, AX
	ADCQ AX, R10
	MOVQ $0x786c2b371c939fab, AX
	ADCQ AX, R11
	MOVQ $0x0000073638a3c320, AX
	ADCQ AX, R12
