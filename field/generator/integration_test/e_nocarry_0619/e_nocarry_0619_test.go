...
var benchRese_nocarry_0619 e_nocarry_0619

func BenchmarkE_nocarry_0619SetBytes(b *testing.B) {
	var x e_nocarry_0619
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0619MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0619.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0619)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0619)
		}
	})
}

func BenchmarkE_nocarry_0619Inverse(b *testing.B) {
	var x e_nocarry_0619
	x.SetRandom()
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0619Butterfly(b *testing.B) {
	var x e_nocarry_0619
	x.SetRandom()
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0619)
	}
}

func BenchmarkE_nocarry_0619Exp(b *testing.B) {
	var x e_nocarry_0619
	x.SetRandom()
	benchRese_nocarry_0619.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0619Double(b *testing.B) {
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Double(&benchRese_nocarry_0619)
	}
}

func BenchmarkE_nocarry_0619Add(b *testing.B) {
	var x e_nocarry_0619
	x.SetRandom()
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Add(&x, &benchRese_nocarry_0619)
	}
}

func BenchmarkE_nocarry_0619Sub(b *testing.B) {
	var x e_nocarry_0619
	x.SetRandom()
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Sub(&x, &benchRese_nocarry_0619)
	}
}

func BenchmarkE_nocarry_0619Neg(b *testing.B) {
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Neg(&benchRese_nocarry_0619)
	}
}

func BenchmarkE_nocarry_0619Div(b *testing.B) {
	var x e_nocarry_0619
	x.SetRandom()
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Div(&x, &benchRese_nocarry_0619)
	}
}

func BenchmarkE_nocarry_0619FromMont(b *testing.B) {
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.FromMont()
	}
}

func BenchmarkE_nocarry_0619ToMont(b *testing.B) {
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.ToMont()
	}
}
func BenchmarkE_nocarry_0619Square(b *testing.B) {
	benchRese_nocarry_0619.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Square(&benchRese_nocarry_0619)
	}
}

func BenchmarkE_nocarry_0619Sqrt(b *testing.B) {
	var a e_nocarry_0619
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0619Mul(b *testing.B) {
	x := e_nocarry_0619{
		9109490988154999144,
		5929569979149509720,
	...
	benchRese_nocarry_0619.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Mul(&benchRese_nocarry_0619, &x)
	}
}

func BenchmarkE_nocarry_0619Cmp(b *testing.B) {
	x := e_nocarry_0619{
		9109490988154999144,
		5929569979149509720,
		11190987312139284922,
	...
	benchRese_nocarry_0619 = x
	benchRese_nocarry_0619[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0619.Cmp(&x)
	}
}

func TestE_nocarry_0619Cmp(t *testing.T) {
	var x, y e_nocarry_0619
...
func TestE_nocarry_0619IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0619
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0619

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0619{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0619
	one.SetOne()
	e.Sub(&qe_nocarry_0619, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0619{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0619{0, uint64(i)})
	}
...
func TestE_nocarry_0619NegZero(t *testing.T) {
	var a, b e_nocarry_0619
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0619Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0619, len(staticTestValues))
...
func TestE_nocarry_0619Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0619) bool {
			var b e_nocarry_0619
...
func TestE_nocarry_0619InverseExp(t *testing.T) {
...
func TestE_nocarry_0619MulByConstants(t *testing.T) {
...
func TestE_nocarry_0619Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0619) bool {
...
func TestE_nocarry_0619LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0619Halve(t *testing.T) {
...
func TestE_nocarry_0619FromMont(t *testing.T) {
...
type testPaire_nocarry_0619 struct {
	element e_nocarry_0619
	bigint  big.Int
}

func (z *e_nocarry_0619) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0619[9] {
		return true
	}
	if z[9] < qe_nocarry_0619[9] {
		return false
	...
	return z[0] >= qe_nocarry_0619[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0619

		g.element = e_nocarry_0619{
		...
		if qe_nocarry_0619[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0619[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0619 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0619[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0619[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0619[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0619[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0619[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0619[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0619[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0619[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0619[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0619[9], carry)
...
func Benchmarke_nocarry_0619InverseNew(b *testing.B) {
	var x e_nocarry_0619
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0619
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0619
		var xInv e_nocarry_0619
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0619
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0619
...
func testLinearComb(t *testing.T, x *e_nocarry_0619, xC int64, y *e_nocarry_0619, yC int64) {
	...
	var z e_nocarry_0619
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0619, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0619
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0619, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0619
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0619, xHi uint64) {
	var res e_nocarry_0619
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0619) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0619) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0619, c int64, result *e_nocarry_0619, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0619) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0619) uint64 {
