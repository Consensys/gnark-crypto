...
var benchRese_nocarry_0174 e_nocarry_0174

func BenchmarkE_nocarry_0174SetBytes(b *testing.B) {
	var x e_nocarry_0174
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0174MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0174.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0174)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0174)
		}
	})
}

func BenchmarkE_nocarry_0174Inverse(b *testing.B) {
	var x e_nocarry_0174
	x.SetRandom()
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0174Butterfly(b *testing.B) {
	var x e_nocarry_0174
	x.SetRandom()
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0174)
	}
}

func BenchmarkE_nocarry_0174Exp(b *testing.B) {
	var x e_nocarry_0174
	x.SetRandom()
	benchRese_nocarry_0174.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0174Double(b *testing.B) {
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Double(&benchRese_nocarry_0174)
	}
}

func BenchmarkE_nocarry_0174Add(b *testing.B) {
	var x e_nocarry_0174
	x.SetRandom()
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Add(&x, &benchRese_nocarry_0174)
	}
}

func BenchmarkE_nocarry_0174Sub(b *testing.B) {
	var x e_nocarry_0174
	x.SetRandom()
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Sub(&x, &benchRese_nocarry_0174)
	}
}

func BenchmarkE_nocarry_0174Neg(b *testing.B) {
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Neg(&benchRese_nocarry_0174)
	}
}

func BenchmarkE_nocarry_0174Div(b *testing.B) {
	var x e_nocarry_0174
	x.SetRandom()
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Div(&x, &benchRese_nocarry_0174)
	}
}

func BenchmarkE_nocarry_0174FromMont(b *testing.B) {
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.FromMont()
	}
}

func BenchmarkE_nocarry_0174ToMont(b *testing.B) {
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.ToMont()
	}
}
func BenchmarkE_nocarry_0174Square(b *testing.B) {
	benchRese_nocarry_0174.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Square(&benchRese_nocarry_0174)
	}
}

func BenchmarkE_nocarry_0174Sqrt(b *testing.B) {
	var a e_nocarry_0174
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0174Mul(b *testing.B) {
	x := e_nocarry_0174{
		9001433641889628543,
		2231513073061212816,
		42111763290124,
	}
	benchRese_nocarry_0174.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Mul(&benchRese_nocarry_0174, &x)
	}
}

func BenchmarkE_nocarry_0174Cmp(b *testing.B) {
	x := e_nocarry_0174{
		9001433641889628543,
		2231513073061212816,
		42111763290124,
	}
	benchRese_nocarry_0174 = x
	benchRese_nocarry_0174[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0174.Cmp(&x)
	}
}

func TestE_nocarry_0174Cmp(t *testing.T) {
	var x, y e_nocarry_0174
...
func TestE_nocarry_0174IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0174
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0174

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0174{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0174
	one.SetOne()
	e.Sub(&qe_nocarry_0174, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0174{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0174{0, uint64(i)})
	}
...
func TestE_nocarry_0174NegZero(t *testing.T) {
	var a, b e_nocarry_0174
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0174Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0174, len(staticTestValues))
...
func TestE_nocarry_0174Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0174) bool {
			var b e_nocarry_0174
...
func TestE_nocarry_0174InverseExp(t *testing.T) {
...
func TestE_nocarry_0174MulByConstants(t *testing.T) {
...
func TestE_nocarry_0174Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0174) bool {
...
func TestE_nocarry_0174LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0174Halve(t *testing.T) {
...
func TestE_nocarry_0174FromMont(t *testing.T) {
...
type testPaire_nocarry_0174 struct {
	element e_nocarry_0174
	bigint  big.Int
}

func (z *e_nocarry_0174) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0174[2] {
		return true
	}
	if z[2] < qe_nocarry_0174[2] {
		return false
	...
	return z[0] >= qe_nocarry_0174[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0174

		g.element = e_nocarry_0174{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0174[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0174[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0174 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0174[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0174[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0174[2], carry)
...
func Benchmarke_nocarry_0174InverseNew(b *testing.B) {
	var x e_nocarry_0174
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0174
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0174
		var xInv e_nocarry_0174
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0174
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0174
...
func testLinearComb(t *testing.T, x *e_nocarry_0174, xC int64, y *e_nocarry_0174, yC int64) {
	...
	var z e_nocarry_0174
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0174, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0174
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0174, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0174
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0174, xHi uint64) {
	var res e_nocarry_0174
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0174) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0174) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0174, c int64, result *e_nocarry_0174, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0174) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0174) uint64 {
