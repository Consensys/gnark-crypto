...
var benchRese_nocarry_0216 e_nocarry_0216

func BenchmarkE_nocarry_0216SetBytes(b *testing.B) {
	var x e_nocarry_0216
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0216MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0216.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0216)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0216)
		}
	})
}

func BenchmarkE_nocarry_0216Inverse(b *testing.B) {
	var x e_nocarry_0216
	x.SetRandom()
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0216Butterfly(b *testing.B) {
	var x e_nocarry_0216
	x.SetRandom()
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0216)
	}
}

func BenchmarkE_nocarry_0216Exp(b *testing.B) {
	var x e_nocarry_0216
	x.SetRandom()
	benchRese_nocarry_0216.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0216Double(b *testing.B) {
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Double(&benchRese_nocarry_0216)
	}
}

func BenchmarkE_nocarry_0216Add(b *testing.B) {
	var x e_nocarry_0216
	x.SetRandom()
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Add(&x, &benchRese_nocarry_0216)
	}
}

func BenchmarkE_nocarry_0216Sub(b *testing.B) {
	var x e_nocarry_0216
	x.SetRandom()
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Sub(&x, &benchRese_nocarry_0216)
	}
}

func BenchmarkE_nocarry_0216Neg(b *testing.B) {
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Neg(&benchRese_nocarry_0216)
	}
}

func BenchmarkE_nocarry_0216Div(b *testing.B) {
	var x e_nocarry_0216
	x.SetRandom()
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Div(&x, &benchRese_nocarry_0216)
	}
}

func BenchmarkE_nocarry_0216FromMont(b *testing.B) {
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.FromMont()
	}
}

func BenchmarkE_nocarry_0216ToMont(b *testing.B) {
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.ToMont()
	}
}
func BenchmarkE_nocarry_0216Square(b *testing.B) {
	benchRese_nocarry_0216.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Square(&benchRese_nocarry_0216)
	}
}

func BenchmarkE_nocarry_0216Sqrt(b *testing.B) {
	var a e_nocarry_0216
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0216Mul(b *testing.B) {
	x := e_nocarry_0216{
		5031057010204723301,
		2063140756354185272,
	...
	benchRese_nocarry_0216.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Mul(&benchRese_nocarry_0216, &x)
	}
}

func BenchmarkE_nocarry_0216Cmp(b *testing.B) {
	x := e_nocarry_0216{
		5031057010204723301,
		2063140756354185272,
		15397087392650880554,
	...
	benchRese_nocarry_0216 = x
	benchRese_nocarry_0216[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0216.Cmp(&x)
	}
}

func TestE_nocarry_0216Cmp(t *testing.T) {
	var x, y e_nocarry_0216
...
func TestE_nocarry_0216IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0216
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0216

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0216{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0216
	one.SetOne()
	e.Sub(&qe_nocarry_0216, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0216{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0216{0, uint64(i)})
	}
...
func TestE_nocarry_0216NegZero(t *testing.T) {
	var a, b e_nocarry_0216
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0216Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0216, len(staticTestValues))
...
func TestE_nocarry_0216Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0216) bool {
			var b e_nocarry_0216
...
func TestE_nocarry_0216InverseExp(t *testing.T) {
...
func TestE_nocarry_0216MulByConstants(t *testing.T) {
...
func TestE_nocarry_0216Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0216) bool {
...
func TestE_nocarry_0216LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0216Halve(t *testing.T) {
...
func TestE_nocarry_0216FromMont(t *testing.T) {
...
type testPaire_nocarry_0216 struct {
	element e_nocarry_0216
	bigint  big.Int
}

func (z *e_nocarry_0216) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0216[3] {
		return true
	}
	if z[3] < qe_nocarry_0216[3] {
		return false
	...
	return z[0] >= qe_nocarry_0216[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0216

		g.element = e_nocarry_0216{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0216[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0216[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0216 {
			var g e_nocarry_0216
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0216[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0216[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0216[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0216[3], carry)
...
func Benchmarke_nocarry_0216InverseNew(b *testing.B) {
	var x e_nocarry_0216
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0216
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0216
		var xInv e_nocarry_0216
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0216
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0216
...
func testLinearComb(t *testing.T, x *e_nocarry_0216, xC int64, y *e_nocarry_0216, yC int64) {
	...
	var z e_nocarry_0216
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0216, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0216
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0216, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0216
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0216, xHi uint64) {
	var res e_nocarry_0216
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0216) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0216) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0216, c int64, result *e_nocarry_0216, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0216) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0216) uint64 {
