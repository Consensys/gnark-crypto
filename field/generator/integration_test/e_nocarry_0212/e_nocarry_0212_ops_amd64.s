...
// modulus q
DATA q<>+0(SB)/8, $0xc6ca274b9c98a0c7
DATA q<>+8(SB)/8, $0xeaca397ddc77d136
DATA q<>+16(SB)/8, $0x7f605d4f49a60e7c
DATA q<>+24(SB)/8, $0x00000000000eb9e0
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x4be3646655c3df09
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xc6ca274b9c98a0c7, R8
	MOVQ    $0xeaca397ddc77d136, R9
	MOVQ    $0x7f605d4f49a60e7c, R10
	MOVQ    $0x00000000000eb9e0, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xeaca397ddc77d136, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x7f605d4f49a60e7c, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000000000eb9e0, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xc6ca274b9c98a0c7, R12
	MOVQ    $0xeaca397ddc77d136, R13
	MOVQ    $0x7f605d4f49a60e7c, R14
	MOVQ    $0x00000000000eb9e0, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
