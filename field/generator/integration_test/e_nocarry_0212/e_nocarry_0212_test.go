...
var benchRese_nocarry_0212 e_nocarry_0212

func BenchmarkE_nocarry_0212SetBytes(b *testing.B) {
	var x e_nocarry_0212
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0212MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0212.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0212)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0212)
		}
	})
}

func BenchmarkE_nocarry_0212Inverse(b *testing.B) {
	var x e_nocarry_0212
	x.SetRandom()
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0212Butterfly(b *testing.B) {
	var x e_nocarry_0212
	x.SetRandom()
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0212)
	}
}

func BenchmarkE_nocarry_0212Exp(b *testing.B) {
	var x e_nocarry_0212
	x.SetRandom()
	benchRese_nocarry_0212.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0212Double(b *testing.B) {
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Double(&benchRese_nocarry_0212)
	}
}

func BenchmarkE_nocarry_0212Add(b *testing.B) {
	var x e_nocarry_0212
	x.SetRandom()
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Add(&x, &benchRese_nocarry_0212)
	}
}

func BenchmarkE_nocarry_0212Sub(b *testing.B) {
	var x e_nocarry_0212
	x.SetRandom()
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Sub(&x, &benchRese_nocarry_0212)
	}
}

func BenchmarkE_nocarry_0212Neg(b *testing.B) {
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Neg(&benchRese_nocarry_0212)
	}
}

func BenchmarkE_nocarry_0212Div(b *testing.B) {
	var x e_nocarry_0212
	x.SetRandom()
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Div(&x, &benchRese_nocarry_0212)
	}
}

func BenchmarkE_nocarry_0212FromMont(b *testing.B) {
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.FromMont()
	}
}

func BenchmarkE_nocarry_0212ToMont(b *testing.B) {
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.ToMont()
	}
}
func BenchmarkE_nocarry_0212Square(b *testing.B) {
	benchRese_nocarry_0212.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Square(&benchRese_nocarry_0212)
	}
}

func BenchmarkE_nocarry_0212Sqrt(b *testing.B) {
	var a e_nocarry_0212
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0212Mul(b *testing.B) {
	x := e_nocarry_0212{
		3978934948112897491,
	...
	benchRese_nocarry_0212.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Mul(&benchRese_nocarry_0212, &x)
	}
}

func BenchmarkE_nocarry_0212Cmp(b *testing.B) {
	x := e_nocarry_0212{
		3978934948112897491,
		12830060154779466394,
		2076366980288658624,
	...
	benchRese_nocarry_0212 = x
	benchRese_nocarry_0212[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0212.Cmp(&x)
	}
}

func TestE_nocarry_0212Cmp(t *testing.T) {
	var x, y e_nocarry_0212
...
func TestE_nocarry_0212IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0212
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0212

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0212{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0212
	one.SetOne()
	e.Sub(&qe_nocarry_0212, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0212{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0212{0, uint64(i)})
	}
...
func TestE_nocarry_0212NegZero(t *testing.T) {
	var a, b e_nocarry_0212
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0212Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0212, len(staticTestValues))
...
func TestE_nocarry_0212Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0212) bool {
			var b e_nocarry_0212
...
func TestE_nocarry_0212InverseExp(t *testing.T) {
...
func TestE_nocarry_0212MulByConstants(t *testing.T) {
...
func TestE_nocarry_0212Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0212) bool {
...
func TestE_nocarry_0212LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0212Halve(t *testing.T) {
...
func TestE_nocarry_0212FromMont(t *testing.T) {
...
type testPaire_nocarry_0212 struct {
	element e_nocarry_0212
	bigint  big.Int
}

func (z *e_nocarry_0212) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0212[3] {
		return true
	}
	if z[3] < qe_nocarry_0212[3] {
		return false
	...
	return z[0] >= qe_nocarry_0212[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0212

		g.element = e_nocarry_0212{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0212[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0212[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0212 {
			var g e_nocarry_0212
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0212[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0212[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0212[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0212[3], carry)
...
func Benchmarke_nocarry_0212InverseNew(b *testing.B) {
	var x e_nocarry_0212
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0212
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0212
		var xInv e_nocarry_0212
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0212
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0212
...
func testLinearComb(t *testing.T, x *e_nocarry_0212, xC int64, y *e_nocarry_0212, yC int64) {
	...
	var z e_nocarry_0212
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0212, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0212
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0212, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0212
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0212, xHi uint64) {
	var res e_nocarry_0212
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0212) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0212) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0212, c int64, result *e_nocarry_0212, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0212) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0212) uint64 {
