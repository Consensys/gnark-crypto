...
var benchRese_nocarry_0594 e_nocarry_0594

func BenchmarkE_nocarry_0594SetBytes(b *testing.B) {
	var x e_nocarry_0594
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0594MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0594.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0594)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0594)
		}
	})
}

func BenchmarkE_nocarry_0594Inverse(b *testing.B) {
	var x e_nocarry_0594
	x.SetRandom()
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0594Butterfly(b *testing.B) {
	var x e_nocarry_0594
	x.SetRandom()
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0594)
	}
}

func BenchmarkE_nocarry_0594Exp(b *testing.B) {
	var x e_nocarry_0594
	x.SetRandom()
	benchRese_nocarry_0594.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0594Double(b *testing.B) {
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Double(&benchRese_nocarry_0594)
	}
}

func BenchmarkE_nocarry_0594Add(b *testing.B) {
	var x e_nocarry_0594
	x.SetRandom()
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Add(&x, &benchRese_nocarry_0594)
	}
}

func BenchmarkE_nocarry_0594Sub(b *testing.B) {
	var x e_nocarry_0594
	x.SetRandom()
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Sub(&x, &benchRese_nocarry_0594)
	}
}

func BenchmarkE_nocarry_0594Neg(b *testing.B) {
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Neg(&benchRese_nocarry_0594)
	}
}

func BenchmarkE_nocarry_0594Div(b *testing.B) {
	var x e_nocarry_0594
	x.SetRandom()
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Div(&x, &benchRese_nocarry_0594)
	}
}

func BenchmarkE_nocarry_0594FromMont(b *testing.B) {
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.FromMont()
	}
}

func BenchmarkE_nocarry_0594ToMont(b *testing.B) {
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.ToMont()
	}
}
func BenchmarkE_nocarry_0594Square(b *testing.B) {
	benchRese_nocarry_0594.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Square(&benchRese_nocarry_0594)
	}
}

func BenchmarkE_nocarry_0594Sqrt(b *testing.B) {
	var a e_nocarry_0594
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0594Mul(b *testing.B) {
	x := e_nocarry_0594{
	...
	benchRese_nocarry_0594.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Mul(&benchRese_nocarry_0594, &x)
	}
}

func BenchmarkE_nocarry_0594Cmp(b *testing.B) {
	x := e_nocarry_0594{
		18421601931685534384,
		18336658390159058250,
		2004728055811451737,
	...
	benchRese_nocarry_0594 = x
	benchRese_nocarry_0594[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0594.Cmp(&x)
	}
}

func TestE_nocarry_0594Cmp(t *testing.T) {
	var x, y e_nocarry_0594
...
func TestE_nocarry_0594IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0594
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0594

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0594{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0594
	one.SetOne()
	e.Sub(&qe_nocarry_0594, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0594{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0594{0, uint64(i)})
	}
...
func TestE_nocarry_0594NegZero(t *testing.T) {
	var a, b e_nocarry_0594
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0594Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0594, len(staticTestValues))
...
func TestE_nocarry_0594Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0594) bool {
			var b e_nocarry_0594
...
func TestE_nocarry_0594InverseExp(t *testing.T) {
...
func TestE_nocarry_0594MulByConstants(t *testing.T) {
...
func TestE_nocarry_0594Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0594) bool {
...
func TestE_nocarry_0594LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0594Halve(t *testing.T) {
...
func TestE_nocarry_0594FromMont(t *testing.T) {
...
type testPaire_nocarry_0594 struct {
	element e_nocarry_0594
	bigint  big.Int
}

func (z *e_nocarry_0594) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0594[9] {
		return true
	}
	if z[9] < qe_nocarry_0594[9] {
		return false
	...
	return z[0] >= qe_nocarry_0594[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0594

		g.element = e_nocarry_0594{
		...
		if qe_nocarry_0594[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0594[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0594 {
			var g e_nocarry_0594
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0594[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0594[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0594[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0594[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0594[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0594[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0594[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0594[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0594[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0594[9], carry)
...
func Benchmarke_nocarry_0594InverseNew(b *testing.B) {
	var x e_nocarry_0594
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0594
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0594
		var xInv e_nocarry_0594
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0594
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0594
...
func testLinearComb(t *testing.T, x *e_nocarry_0594, xC int64, y *e_nocarry_0594, yC int64) {
	...
	var z e_nocarry_0594
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0594, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0594
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0594, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0594
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0594, xHi uint64) {
	var res e_nocarry_0594
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0594) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0594) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0594, c int64, result *e_nocarry_0594, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0594) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0594) uint64 {
