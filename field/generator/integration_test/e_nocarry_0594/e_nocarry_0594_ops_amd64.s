...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x1d5388ff3f035d43, R13
	ADDQ R13, AX
	MOVQ $0xd128ca188274a336, R13
	ADCQ R13, DX
	MOVQ $0x4602642616578467, R13
	ADCQ R13, CX
	MOVQ $0xddead234f954be0f, R13
	ADCQ R13, BX
	MOVQ $0x35cbc77a43428d2e, R13
	ADCQ R13, SI
	MOVQ $0x92671c80b0e376d2, R13
	ADCQ R13, DI
	MOVQ $0x90e7dbf6d4978b75, R13
	ADCQ R13, R8
	MOVQ $0xb6ba283ceff234fa, R13
	ADCQ R13, R9
	MOVQ $0x4911cdf28eca1a17, R13
	ADCQ R13, R10
	MOVQ $0x0000000000035b2b, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x1d5388ff3f035d43, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xd128ca188274a336, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x4602642616578467, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xddead234f954be0f, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x35cbc77a43428d2e, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x92671c80b0e376d2, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x90e7dbf6d4978b75, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xb6ba283ceff234fa, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x4911cdf28eca1a17, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000000035b2b, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x1d5388ff3f035d43, AX
	ADDQ AX, DX
	MOVQ $0xd128ca188274a336, AX
	ADCQ AX, CX
	MOVQ $0x4602642616578467, AX
	ADCQ AX, BX
	MOVQ $0xddead234f954be0f, AX
	ADCQ AX, SI
	MOVQ $0x35cbc77a43428d2e, AX
	ADCQ AX, DI
	MOVQ $0x92671c80b0e376d2, AX
	ADCQ AX, R8
	MOVQ $0x90e7dbf6d4978b75, AX
	ADCQ AX, R9
	MOVQ $0xb6ba283ceff234fa, AX
	ADCQ AX, R10
	MOVQ $0x4911cdf28eca1a17, AX
	ADCQ AX, R11
	MOVQ $0x0000000000035b2b, AX
	ADCQ AX, R12
