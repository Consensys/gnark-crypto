...
// modulus q
DATA q<>+0(SB)/8, $0x59b78d50d6d7d5d5
DATA q<>+8(SB)/8, $0x4fc50ba359d34a1d
DATA q<>+16(SB)/8, $0x230b6b0e9f9988d7
DATA q<>+24(SB)/8, $0x804ac16d76e8b77c
DATA q<>+32(SB)/8, $0xf01cb4278ac73341
DATA q<>+40(SB)/8, $0x0003a3a74277de2e
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x4f17b7582b3d4483
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x59b78d50d6d7d5d5, R10
	MOVQ    $0x4fc50ba359d34a1d, R11
	MOVQ    $0x230b6b0e9f9988d7, R12
	MOVQ    $0x804ac16d76e8b77c, R13
	MOVQ    $0xf01cb4278ac73341, R14
	MOVQ    $0x0003a3a74277de2e, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x4fc50ba359d34a1d, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x230b6b0e9f9988d7, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x804ac16d76e8b77c, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xf01cb4278ac73341, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0003a3a74277de2e, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x59b78d50d6d7d5d5, CX
	MOVQ    $0x4fc50ba359d34a1d, BX
	MOVQ    $0x230b6b0e9f9988d7, SI
	MOVQ    $0x804ac16d76e8b77c, DI
	MOVQ    $0xf01cb4278ac73341, R8
	MOVQ    $0x0003a3a74277de2e, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
