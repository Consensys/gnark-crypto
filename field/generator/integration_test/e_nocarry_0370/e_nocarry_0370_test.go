...
var benchRese_nocarry_0370 e_nocarry_0370

func BenchmarkE_nocarry_0370SetBytes(b *testing.B) {
	var x e_nocarry_0370
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0370MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0370.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0370)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0370)
		}
	})
}

func BenchmarkE_nocarry_0370Inverse(b *testing.B) {
	var x e_nocarry_0370
	x.SetRandom()
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0370Butterfly(b *testing.B) {
	var x e_nocarry_0370
	x.SetRandom()
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0370)
	}
}

func BenchmarkE_nocarry_0370Exp(b *testing.B) {
	var x e_nocarry_0370
	x.SetRandom()
	benchRese_nocarry_0370.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0370Double(b *testing.B) {
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Double(&benchRese_nocarry_0370)
	}
}

func BenchmarkE_nocarry_0370Add(b *testing.B) {
	var x e_nocarry_0370
	x.SetRandom()
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Add(&x, &benchRese_nocarry_0370)
	}
}

func BenchmarkE_nocarry_0370Sub(b *testing.B) {
	var x e_nocarry_0370
	x.SetRandom()
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Sub(&x, &benchRese_nocarry_0370)
	}
}

func BenchmarkE_nocarry_0370Neg(b *testing.B) {
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Neg(&benchRese_nocarry_0370)
	}
}

func BenchmarkE_nocarry_0370Div(b *testing.B) {
	var x e_nocarry_0370
	x.SetRandom()
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Div(&x, &benchRese_nocarry_0370)
	}
}

func BenchmarkE_nocarry_0370FromMont(b *testing.B) {
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.FromMont()
	}
}

func BenchmarkE_nocarry_0370ToMont(b *testing.B) {
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.ToMont()
	}
}
func BenchmarkE_nocarry_0370Square(b *testing.B) {
	benchRese_nocarry_0370.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Square(&benchRese_nocarry_0370)
	}
}

func BenchmarkE_nocarry_0370Sqrt(b *testing.B) {
	var a e_nocarry_0370
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0370Mul(b *testing.B) {
	x := e_nocarry_0370{
	...
	benchRese_nocarry_0370.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Mul(&benchRese_nocarry_0370, &x)
	}
}

func BenchmarkE_nocarry_0370Cmp(b *testing.B) {
	x := e_nocarry_0370{
		15528474476438225057,
		8750213856025545932,
		17224398004277190612,
	...
	benchRese_nocarry_0370 = x
	benchRese_nocarry_0370[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0370.Cmp(&x)
	}
}

func TestE_nocarry_0370Cmp(t *testing.T) {
	var x, y e_nocarry_0370
...
func TestE_nocarry_0370IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0370
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0370

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0370{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0370
	one.SetOne()
	e.Sub(&qe_nocarry_0370, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0370{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0370{0, uint64(i)})
	}
...
func TestE_nocarry_0370NegZero(t *testing.T) {
	var a, b e_nocarry_0370
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0370Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0370, len(staticTestValues))
...
func TestE_nocarry_0370Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0370) bool {
			var b e_nocarry_0370
...
func TestE_nocarry_0370InverseExp(t *testing.T) {
...
func TestE_nocarry_0370MulByConstants(t *testing.T) {
...
func TestE_nocarry_0370Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0370) bool {
...
func TestE_nocarry_0370LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0370Halve(t *testing.T) {
...
func TestE_nocarry_0370FromMont(t *testing.T) {
...
type testPaire_nocarry_0370 struct {
	element e_nocarry_0370
	bigint  big.Int
}

func (z *e_nocarry_0370) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0370[5] {
		return true
	}
	if z[5] < qe_nocarry_0370[5] {
		return false
	...
	return z[0] >= qe_nocarry_0370[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0370

		g.element = e_nocarry_0370{
		...
		if qe_nocarry_0370[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0370[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0370 {
			var g e_nocarry_0370
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0370[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0370[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0370[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0370[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0370[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0370[5], carry)
...
func Benchmarke_nocarry_0370InverseNew(b *testing.B) {
	var x e_nocarry_0370
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0370
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0370
		var xInv e_nocarry_0370
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0370
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0370
...
func testLinearComb(t *testing.T, x *e_nocarry_0370, xC int64, y *e_nocarry_0370, yC int64) {
	...
	var z e_nocarry_0370
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0370, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0370
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0370, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0370
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0370, xHi uint64) {
	var res e_nocarry_0370
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0370) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0370) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0370, c int64, result *e_nocarry_0370, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0370) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0370) uint64 {
