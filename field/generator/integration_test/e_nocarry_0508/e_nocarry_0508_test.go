...
var benchRese_nocarry_0508 e_nocarry_0508

func BenchmarkE_nocarry_0508SetBytes(b *testing.B) {
	var x e_nocarry_0508
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0508MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0508.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0508)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0508)
		}
	})
}

func BenchmarkE_nocarry_0508Inverse(b *testing.B) {
	var x e_nocarry_0508
	x.SetRandom()
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0508Butterfly(b *testing.B) {
	var x e_nocarry_0508
	x.SetRandom()
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0508)
	}
}

func BenchmarkE_nocarry_0508Exp(b *testing.B) {
	var x e_nocarry_0508
	x.SetRandom()
	benchRese_nocarry_0508.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0508Double(b *testing.B) {
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Double(&benchRese_nocarry_0508)
	}
}

func BenchmarkE_nocarry_0508Add(b *testing.B) {
	var x e_nocarry_0508
	x.SetRandom()
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Add(&x, &benchRese_nocarry_0508)
	}
}

func BenchmarkE_nocarry_0508Sub(b *testing.B) {
	var x e_nocarry_0508
	x.SetRandom()
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Sub(&x, &benchRese_nocarry_0508)
	}
}

func BenchmarkE_nocarry_0508Neg(b *testing.B) {
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Neg(&benchRese_nocarry_0508)
	}
}

func BenchmarkE_nocarry_0508Div(b *testing.B) {
	var x e_nocarry_0508
	x.SetRandom()
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Div(&x, &benchRese_nocarry_0508)
	}
}

func BenchmarkE_nocarry_0508FromMont(b *testing.B) {
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.FromMont()
	}
}

func BenchmarkE_nocarry_0508ToMont(b *testing.B) {
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.ToMont()
	}
}
func BenchmarkE_nocarry_0508Square(b *testing.B) {
	benchRese_nocarry_0508.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Square(&benchRese_nocarry_0508)
	}
}

func BenchmarkE_nocarry_0508Sqrt(b *testing.B) {
	var a e_nocarry_0508
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0508Mul(b *testing.B) {
	x := e_nocarry_0508{
	...
	benchRese_nocarry_0508.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Mul(&benchRese_nocarry_0508, &x)
	}
}

func BenchmarkE_nocarry_0508Cmp(b *testing.B) {
	x := e_nocarry_0508{
		16145518578244093523,
		3619625873279465052,
		7443283809495110637,
	...
	benchRese_nocarry_0508 = x
	benchRese_nocarry_0508[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0508.Cmp(&x)
	}
}

func TestE_nocarry_0508Cmp(t *testing.T) {
	var x, y e_nocarry_0508
...
func TestE_nocarry_0508IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0508
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0508

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0508{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0508
	one.SetOne()
	e.Sub(&qe_nocarry_0508, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0508{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0508{0, uint64(i)})
	}
...
func TestE_nocarry_0508NegZero(t *testing.T) {
	var a, b e_nocarry_0508
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0508Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0508, len(staticTestValues))
...
func TestE_nocarry_0508Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0508) bool {
			var b e_nocarry_0508
...
func TestE_nocarry_0508InverseExp(t *testing.T) {
...
func TestE_nocarry_0508MulByConstants(t *testing.T) {
...
func TestE_nocarry_0508Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0508) bool {
...
func TestE_nocarry_0508LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0508Halve(t *testing.T) {
...
func TestE_nocarry_0508FromMont(t *testing.T) {
...
type testPaire_nocarry_0508 struct {
	element e_nocarry_0508
	bigint  big.Int
}

func (z *e_nocarry_0508) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0508[7] {
		return true
	}
	if z[7] < qe_nocarry_0508[7] {
		return false
	...
	return z[0] >= qe_nocarry_0508[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0508

		g.element = e_nocarry_0508{
		...
		if qe_nocarry_0508[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0508[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0508 {
			var g e_nocarry_0508
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0508[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0508[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0508[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0508[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0508[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0508[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0508[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0508[7], carry)
...
func Benchmarke_nocarry_0508InverseNew(b *testing.B) {
	var x e_nocarry_0508
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0508
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0508
		var xInv e_nocarry_0508
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0508
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0508
...
func testLinearComb(t *testing.T, x *e_nocarry_0508, xC int64, y *e_nocarry_0508, yC int64) {
	...
	var z e_nocarry_0508
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0508, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0508
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0508, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0508
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0508, xHi uint64) {
	var res e_nocarry_0508
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0508) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0508) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0508, c int64, result *e_nocarry_0508, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0508) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0508) uint64 {
