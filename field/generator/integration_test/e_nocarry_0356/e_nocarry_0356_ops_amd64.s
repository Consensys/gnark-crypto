...
// modulus q
DATA q<>+0(SB)/8, $0x4e61f47fd35db01f
DATA q<>+8(SB)/8, $0x7f90bbce6fd78ccc
DATA q<>+16(SB)/8, $0x09dfd5fddba98970
DATA q<>+24(SB)/8, $0xd2a62761b1d85a71
DATA q<>+32(SB)/8, $0x0610d88c1eea7a8b
DATA q<>+40(SB)/8, $0x0000000ed8df19f9
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xd6d6c11a6a1a3421
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x4e61f47fd35db01f, R10
	MOVQ    $0x7f90bbce6fd78ccc, R11
	MOVQ    $0x09dfd5fddba98970, R12
	MOVQ    $0xd2a62761b1d85a71, R13
	MOVQ    $0x0610d88c1eea7a8b, R14
	MOVQ    $0x0000000ed8df19f9, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x7f90bbce6fd78ccc, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x09dfd5fddba98970, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xd2a62761b1d85a71, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x0610d88c1eea7a8b, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000ed8df19f9, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x4e61f47fd35db01f, CX
	MOVQ    $0x7f90bbce6fd78ccc, BX
	MOVQ    $0x09dfd5fddba98970, SI
	MOVQ    $0xd2a62761b1d85a71, DI
	MOVQ    $0x0610d88c1eea7a8b, R8
	MOVQ    $0x0000000ed8df19f9, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
