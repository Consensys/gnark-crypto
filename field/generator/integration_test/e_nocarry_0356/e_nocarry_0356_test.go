...
var benchRese_nocarry_0356 e_nocarry_0356

func BenchmarkE_nocarry_0356SetBytes(b *testing.B) {
	var x e_nocarry_0356
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0356MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0356.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0356)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0356)
		}
	})
}

func BenchmarkE_nocarry_0356Inverse(b *testing.B) {
	var x e_nocarry_0356
	x.SetRandom()
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0356Butterfly(b *testing.B) {
	var x e_nocarry_0356
	x.SetRandom()
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0356)
	}
}

func BenchmarkE_nocarry_0356Exp(b *testing.B) {
	var x e_nocarry_0356
	x.SetRandom()
	benchRese_nocarry_0356.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0356Double(b *testing.B) {
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Double(&benchRese_nocarry_0356)
	}
}

func BenchmarkE_nocarry_0356Add(b *testing.B) {
	var x e_nocarry_0356
	x.SetRandom()
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Add(&x, &benchRese_nocarry_0356)
	}
}

func BenchmarkE_nocarry_0356Sub(b *testing.B) {
	var x e_nocarry_0356
	x.SetRandom()
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Sub(&x, &benchRese_nocarry_0356)
	}
}

func BenchmarkE_nocarry_0356Neg(b *testing.B) {
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Neg(&benchRese_nocarry_0356)
	}
}

func BenchmarkE_nocarry_0356Div(b *testing.B) {
	var x e_nocarry_0356
	x.SetRandom()
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Div(&x, &benchRese_nocarry_0356)
	}
}

func BenchmarkE_nocarry_0356FromMont(b *testing.B) {
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.FromMont()
	}
}

func BenchmarkE_nocarry_0356ToMont(b *testing.B) {
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.ToMont()
	}
}
func BenchmarkE_nocarry_0356Square(b *testing.B) {
	benchRese_nocarry_0356.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Square(&benchRese_nocarry_0356)
	}
}

func BenchmarkE_nocarry_0356Sqrt(b *testing.B) {
	var a e_nocarry_0356
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0356Mul(b *testing.B) {
	x := e_nocarry_0356{
	...
	benchRese_nocarry_0356.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Mul(&benchRese_nocarry_0356, &x)
	}
}

func BenchmarkE_nocarry_0356Cmp(b *testing.B) {
	x := e_nocarry_0356{
		10374982288166650891,
		10319009424373759515,
		13848826867895242585,
	...
	benchRese_nocarry_0356 = x
	benchRese_nocarry_0356[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0356.Cmp(&x)
	}
}

func TestE_nocarry_0356Cmp(t *testing.T) {
	var x, y e_nocarry_0356
...
func TestE_nocarry_0356IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0356
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0356

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0356{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0356
	one.SetOne()
	e.Sub(&qe_nocarry_0356, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0356{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0356{0, uint64(i)})
	}
...
func TestE_nocarry_0356NegZero(t *testing.T) {
	var a, b e_nocarry_0356
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0356Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0356, len(staticTestValues))
...
func TestE_nocarry_0356Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0356) bool {
			var b e_nocarry_0356
...
func TestE_nocarry_0356InverseExp(t *testing.T) {
...
func TestE_nocarry_0356MulByConstants(t *testing.T) {
...
func TestE_nocarry_0356Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0356) bool {
...
func TestE_nocarry_0356LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0356Halve(t *testing.T) {
...
func TestE_nocarry_0356FromMont(t *testing.T) {
...
type testPaire_nocarry_0356 struct {
	element e_nocarry_0356
	bigint  big.Int
}

func (z *e_nocarry_0356) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0356[5] {
		return true
	}
	if z[5] < qe_nocarry_0356[5] {
		return false
	...
	return z[0] >= qe_nocarry_0356[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0356

		g.element = e_nocarry_0356{
		...
		if qe_nocarry_0356[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0356[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0356 {
			var g e_nocarry_0356
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0356[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0356[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0356[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0356[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0356[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0356[5], carry)
...
func Benchmarke_nocarry_0356InverseNew(b *testing.B) {
	var x e_nocarry_0356
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0356
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0356
		var xInv e_nocarry_0356
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0356
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0356
...
func testLinearComb(t *testing.T, x *e_nocarry_0356, xC int64, y *e_nocarry_0356, yC int64) {
	...
	var z e_nocarry_0356
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0356, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0356
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0356, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0356
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0356, xHi uint64) {
	var res e_nocarry_0356
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0356) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0356) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0356, c int64, result *e_nocarry_0356, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0356) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0356) uint64 {
