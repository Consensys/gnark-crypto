...
var benchRese_nocarry_0309 e_nocarry_0309

func BenchmarkE_nocarry_0309SetBytes(b *testing.B) {
	var x e_nocarry_0309
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0309MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0309.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0309)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0309)
		}
	})
}

func BenchmarkE_nocarry_0309Inverse(b *testing.B) {
	var x e_nocarry_0309
	x.SetRandom()
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0309Butterfly(b *testing.B) {
	var x e_nocarry_0309
	x.SetRandom()
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0309)
	}
}

func BenchmarkE_nocarry_0309Exp(b *testing.B) {
	var x e_nocarry_0309
	x.SetRandom()
	benchRese_nocarry_0309.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0309Double(b *testing.B) {
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Double(&benchRese_nocarry_0309)
	}
}

func BenchmarkE_nocarry_0309Add(b *testing.B) {
	var x e_nocarry_0309
	x.SetRandom()
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Add(&x, &benchRese_nocarry_0309)
	}
}

func BenchmarkE_nocarry_0309Sub(b *testing.B) {
	var x e_nocarry_0309
	x.SetRandom()
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Sub(&x, &benchRese_nocarry_0309)
	}
}

func BenchmarkE_nocarry_0309Neg(b *testing.B) {
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Neg(&benchRese_nocarry_0309)
	}
}

func BenchmarkE_nocarry_0309Div(b *testing.B) {
	var x e_nocarry_0309
	x.SetRandom()
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Div(&x, &benchRese_nocarry_0309)
	}
}

func BenchmarkE_nocarry_0309FromMont(b *testing.B) {
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.FromMont()
	}
}

func BenchmarkE_nocarry_0309ToMont(b *testing.B) {
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.ToMont()
	}
}
func BenchmarkE_nocarry_0309Square(b *testing.B) {
	benchRese_nocarry_0309.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Square(&benchRese_nocarry_0309)
	}
}

func BenchmarkE_nocarry_0309Sqrt(b *testing.B) {
	var a e_nocarry_0309
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0309Mul(b *testing.B) {
	x := e_nocarry_0309{
	...
	benchRese_nocarry_0309.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Mul(&benchRese_nocarry_0309, &x)
	}
}

func BenchmarkE_nocarry_0309Cmp(b *testing.B) {
	x := e_nocarry_0309{
		10370357373343804898,
		7573513088620320833,
		4838805586716191961,
	...
	benchRese_nocarry_0309 = x
	benchRese_nocarry_0309[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0309.Cmp(&x)
	}
}

func TestE_nocarry_0309Cmp(t *testing.T) {
	var x, y e_nocarry_0309
...
func TestE_nocarry_0309IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0309
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0309

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0309{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0309
	one.SetOne()
	e.Sub(&qe_nocarry_0309, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0309{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0309{0, uint64(i)})
	}
...
func TestE_nocarry_0309NegZero(t *testing.T) {
	var a, b e_nocarry_0309
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0309Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0309, len(staticTestValues))
...
func TestE_nocarry_0309Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0309) bool {
			var b e_nocarry_0309
...
func TestE_nocarry_0309InverseExp(t *testing.T) {
...
func TestE_nocarry_0309MulByConstants(t *testing.T) {
...
func TestE_nocarry_0309Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0309) bool {
...
func TestE_nocarry_0309LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0309Halve(t *testing.T) {
...
func TestE_nocarry_0309FromMont(t *testing.T) {
...
type testPaire_nocarry_0309 struct {
	element e_nocarry_0309
	bigint  big.Int
}

func (z *e_nocarry_0309) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0309[4] {
		return true
	}
	if z[4] < qe_nocarry_0309[4] {
		return false
	...
	return z[0] >= qe_nocarry_0309[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0309

		g.element = e_nocarry_0309{
		...
		if qe_nocarry_0309[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0309[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0309 {
			var g e_nocarry_0309
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0309[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0309[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0309[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0309[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0309[4], carry)
...
func Benchmarke_nocarry_0309InverseNew(b *testing.B) {
	var x e_nocarry_0309
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0309
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0309
		var xInv e_nocarry_0309
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0309
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0309
...
func testLinearComb(t *testing.T, x *e_nocarry_0309, xC int64, y *e_nocarry_0309, yC int64) {
	...
	var z e_nocarry_0309
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0309, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0309
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0309, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0309
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0309, xHi uint64) {
	var res e_nocarry_0309
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0309) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0309) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0309, c int64, result *e_nocarry_0309, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0309) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0309) uint64 {
