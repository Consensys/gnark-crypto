...
// modulus q
DATA q<>+0(SB)/8, $0x0b1c7b31f774c187
DATA q<>+8(SB)/8, $0xe9e1213cbd9d62b7
DATA q<>+16(SB)/8, $0x54cb1bd562fd41c3
DATA q<>+24(SB)/8, $0x7a3fc8eb362fcad0
DATA q<>+32(SB)/8, $0x001c64b8396d78e0
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xb552a222f0b2cbc9
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x0b1c7b31f774c187, R9
	MOVQ    $0xe9e1213cbd9d62b7, R10
	MOVQ    $0x54cb1bd562fd41c3, R11
	MOVQ    $0x7a3fc8eb362fcad0, R12
	MOVQ    $0x001c64b8396d78e0, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xe9e1213cbd9d62b7, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x54cb1bd562fd41c3, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x7a3fc8eb362fcad0, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x001c64b8396d78e0, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x0b1c7b31f774c187, CX
	MOVQ    $0xe9e1213cbd9d62b7, BX
	MOVQ    $0x54cb1bd562fd41c3, SI
	MOVQ    $0x7a3fc8eb362fcad0, DI
	MOVQ    $0x001c64b8396d78e0, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
