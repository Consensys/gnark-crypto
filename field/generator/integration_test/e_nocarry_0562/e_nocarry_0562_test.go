...
var benchRese_nocarry_0562 e_nocarry_0562

func BenchmarkE_nocarry_0562SetBytes(b *testing.B) {
	var x e_nocarry_0562
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0562MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0562.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0562)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0562)
		}
	})
}

func BenchmarkE_nocarry_0562Inverse(b *testing.B) {
	var x e_nocarry_0562
	x.SetRandom()
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0562Butterfly(b *testing.B) {
	var x e_nocarry_0562
	x.SetRandom()
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0562)
	}
}

func BenchmarkE_nocarry_0562Exp(b *testing.B) {
	var x e_nocarry_0562
	x.SetRandom()
	benchRese_nocarry_0562.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0562Double(b *testing.B) {
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Double(&benchRese_nocarry_0562)
	}
}

func BenchmarkE_nocarry_0562Add(b *testing.B) {
	var x e_nocarry_0562
	x.SetRandom()
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Add(&x, &benchRese_nocarry_0562)
	}
}

func BenchmarkE_nocarry_0562Sub(b *testing.B) {
	var x e_nocarry_0562
	x.SetRandom()
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Sub(&x, &benchRese_nocarry_0562)
	}
}

func BenchmarkE_nocarry_0562Neg(b *testing.B) {
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Neg(&benchRese_nocarry_0562)
	}
}

func BenchmarkE_nocarry_0562Div(b *testing.B) {
	var x e_nocarry_0562
	x.SetRandom()
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Div(&x, &benchRese_nocarry_0562)
	}
}

func BenchmarkE_nocarry_0562FromMont(b *testing.B) {
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.FromMont()
	}
}

func BenchmarkE_nocarry_0562ToMont(b *testing.B) {
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.ToMont()
	}
}
func BenchmarkE_nocarry_0562Square(b *testing.B) {
	benchRese_nocarry_0562.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Square(&benchRese_nocarry_0562)
	}
}

func BenchmarkE_nocarry_0562Sqrt(b *testing.B) {
	var a e_nocarry_0562
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0562Mul(b *testing.B) {
	x := e_nocarry_0562{
		6567133678349300387,
	...
	benchRese_nocarry_0562.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Mul(&benchRese_nocarry_0562, &x)
	}
}

func BenchmarkE_nocarry_0562Cmp(b *testing.B) {
	x := e_nocarry_0562{
		6567133678349300387,
		14650801490406738003,
		13357298983953819910,
	...
	benchRese_nocarry_0562 = x
	benchRese_nocarry_0562[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0562.Cmp(&x)
	}
}

func TestE_nocarry_0562Cmp(t *testing.T) {
	var x, y e_nocarry_0562
...
func TestE_nocarry_0562IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0562
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0562

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0562{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0562
	one.SetOne()
	e.Sub(&qe_nocarry_0562, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0562{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0562{0, uint64(i)})
	}
...
func TestE_nocarry_0562NegZero(t *testing.T) {
	var a, b e_nocarry_0562
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0562Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0562, len(staticTestValues))
...
func TestE_nocarry_0562Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0562) bool {
			var b e_nocarry_0562
...
func TestE_nocarry_0562InverseExp(t *testing.T) {
...
func TestE_nocarry_0562MulByConstants(t *testing.T) {
...
func TestE_nocarry_0562Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0562) bool {
...
func TestE_nocarry_0562LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0562Halve(t *testing.T) {
...
func TestE_nocarry_0562FromMont(t *testing.T) {
...
type testPaire_nocarry_0562 struct {
	element e_nocarry_0562
	bigint  big.Int
}

func (z *e_nocarry_0562) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0562[8] {
		return true
	}
	if z[8] < qe_nocarry_0562[8] {
		return false
	...
	return z[0] >= qe_nocarry_0562[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0562

		g.element = e_nocarry_0562{
		...
		if qe_nocarry_0562[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0562[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0562 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0562[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0562[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0562[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0562[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0562[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0562[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0562[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0562[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0562[8], carry)
...
func Benchmarke_nocarry_0562InverseNew(b *testing.B) {
	var x e_nocarry_0562
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0562
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0562
		var xInv e_nocarry_0562
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0562
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0562
...
func testLinearComb(t *testing.T, x *e_nocarry_0562, xC int64, y *e_nocarry_0562, yC int64) {
	...
	var z e_nocarry_0562
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0562, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0562
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0562, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0562
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0562, xHi uint64) {
	var res e_nocarry_0562
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0562) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0562) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0562, c int64, result *e_nocarry_0562, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0562) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0562) uint64 {
