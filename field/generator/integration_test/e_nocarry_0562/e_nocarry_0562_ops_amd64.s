...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x4b85cb93d6f4bf31, R12
	ADDQ R12, AX
	MOVQ $0x8dfbe382bd360bcf, R12
	ADCQ R12, DX
	MOVQ $0x8fb28de04937daa6, R12
	ADCQ R12, CX
	MOVQ $0xd84abfb340b11f07, R12
	ADCQ R12, BX
	MOVQ $0xcd35ea3b8ee93b38, R12
	ADCQ R12, SI
	MOVQ $0x21bf35511c36f5ce, R12
	ADCQ R12, DI
	MOVQ $0x22870c1b92382dd2, R12
	ADCQ R12, R8
	MOVQ $0xa2cb179e0218de98, R12
	ADCQ R12, R9
	MOVQ $0x0003b945c20f3e99, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x4b85cb93d6f4bf31, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x8dfbe382bd360bcf, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x8fb28de04937daa6, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xd84abfb340b11f07, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xcd35ea3b8ee93b38, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x21bf35511c36f5ce, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x22870c1b92382dd2, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xa2cb179e0218de98, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0003b945c20f3e99, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x4b85cb93d6f4bf31, AX
	ADDQ AX, DX
	MOVQ $0x8dfbe382bd360bcf, AX
	ADCQ AX, CX
	MOVQ $0x8fb28de04937daa6, AX
	ADCQ AX, BX
	MOVQ $0xd84abfb340b11f07, AX
	ADCQ AX, SI
	MOVQ $0xcd35ea3b8ee93b38, AX
	ADCQ AX, DI
	MOVQ $0x21bf35511c36f5ce, AX
	ADCQ AX, R8
	MOVQ $0x22870c1b92382dd2, AX
	ADCQ AX, R9
	MOVQ $0xa2cb179e0218de98, AX
	ADCQ AX, R10
	MOVQ $0x0003b945c20f3e99, AX
	ADCQ AX, R11
