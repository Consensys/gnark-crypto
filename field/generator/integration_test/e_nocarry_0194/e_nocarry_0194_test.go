...
var benchRese_nocarry_0194 e_nocarry_0194

func BenchmarkE_nocarry_0194SetBytes(b *testing.B) {
	var x e_nocarry_0194
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0194MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0194.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0194)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0194)
		}
	})
}

func BenchmarkE_nocarry_0194Inverse(b *testing.B) {
	var x e_nocarry_0194
	x.SetRandom()
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0194Butterfly(b *testing.B) {
	var x e_nocarry_0194
	x.SetRandom()
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0194)
	}
}

func BenchmarkE_nocarry_0194Exp(b *testing.B) {
	var x e_nocarry_0194
	x.SetRandom()
	benchRese_nocarry_0194.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0194Double(b *testing.B) {
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Double(&benchRese_nocarry_0194)
	}
}

func BenchmarkE_nocarry_0194Add(b *testing.B) {
	var x e_nocarry_0194
	x.SetRandom()
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Add(&x, &benchRese_nocarry_0194)
	}
}

func BenchmarkE_nocarry_0194Sub(b *testing.B) {
	var x e_nocarry_0194
	x.SetRandom()
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Sub(&x, &benchRese_nocarry_0194)
	}
}

func BenchmarkE_nocarry_0194Neg(b *testing.B) {
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Neg(&benchRese_nocarry_0194)
	}
}

func BenchmarkE_nocarry_0194Div(b *testing.B) {
	var x e_nocarry_0194
	x.SetRandom()
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Div(&x, &benchRese_nocarry_0194)
	}
}

func BenchmarkE_nocarry_0194FromMont(b *testing.B) {
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.FromMont()
	}
}

func BenchmarkE_nocarry_0194ToMont(b *testing.B) {
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.ToMont()
	}
}
func BenchmarkE_nocarry_0194Square(b *testing.B) {
	benchRese_nocarry_0194.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Square(&benchRese_nocarry_0194)
	}
}

func BenchmarkE_nocarry_0194Sqrt(b *testing.B) {
	var a e_nocarry_0194
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0194Mul(b *testing.B) {
	x := e_nocarry_0194{
	...
	benchRese_nocarry_0194.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Mul(&benchRese_nocarry_0194, &x)
	}
}

func BenchmarkE_nocarry_0194Cmp(b *testing.B) {
	x := e_nocarry_0194{
		15207335612453694098,
		1304044931741488451,
		8694858731737739844,
	...
	benchRese_nocarry_0194 = x
	benchRese_nocarry_0194[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0194.Cmp(&x)
	}
}

func TestE_nocarry_0194Cmp(t *testing.T) {
	var x, y e_nocarry_0194
...
func TestE_nocarry_0194IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0194
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0194

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0194{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0194
	one.SetOne()
	e.Sub(&qe_nocarry_0194, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0194{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0194{0, uint64(i)})
	}
...
func TestE_nocarry_0194NegZero(t *testing.T) {
	var a, b e_nocarry_0194
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0194Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0194, len(staticTestValues))
...
func TestE_nocarry_0194Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0194) bool {
			var b e_nocarry_0194
...
func TestE_nocarry_0194InverseExp(t *testing.T) {
...
func TestE_nocarry_0194MulByConstants(t *testing.T) {
...
func TestE_nocarry_0194Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0194) bool {
...
func TestE_nocarry_0194LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0194Halve(t *testing.T) {
...
func TestE_nocarry_0194FromMont(t *testing.T) {
...
type testPaire_nocarry_0194 struct {
	element e_nocarry_0194
	bigint  big.Int
}

func (z *e_nocarry_0194) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0194[3] {
		return true
	}
	if z[3] < qe_nocarry_0194[3] {
		return false
	...
	return z[0] >= qe_nocarry_0194[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0194

		g.element = e_nocarry_0194{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0194[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0194[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0194 {
			var g e_nocarry_0194
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0194[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0194[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0194[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0194[3], carry)
...
func Benchmarke_nocarry_0194InverseNew(b *testing.B) {
	var x e_nocarry_0194
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0194
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0194
		var xInv e_nocarry_0194
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0194
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0194
...
func testLinearComb(t *testing.T, x *e_nocarry_0194, xC int64, y *e_nocarry_0194, yC int64) {
	...
	var z e_nocarry_0194
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0194, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0194
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0194, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0194
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0194, xHi uint64) {
	var res e_nocarry_0194
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0194) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0194) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0194, c int64, result *e_nocarry_0194, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0194) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0194) uint64 {
