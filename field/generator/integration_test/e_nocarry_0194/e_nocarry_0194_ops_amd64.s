...
// modulus q
DATA q<>+0(SB)/8, $0xbdfff896863ab02b
DATA q<>+8(SB)/8, $0xdc9c87f928ca961a
DATA q<>+16(SB)/8, $0x9e8a76a114f337fa
DATA q<>+24(SB)/8, $0x0000000000000003
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x35700451193f717d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xbdfff896863ab02b, R8
	MOVQ    $0xdc9c87f928ca961a, R9
	MOVQ    $0x9e8a76a114f337fa, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xdc9c87f928ca961a, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x9e8a76a114f337fa, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xbdfff896863ab02b, R12
	MOVQ    $0xdc9c87f928ca961a, R13
	MOVQ    $0x9e8a76a114f337fa, R14
