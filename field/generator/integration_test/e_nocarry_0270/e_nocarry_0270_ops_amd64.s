...
// modulus q
DATA q<>+0(SB)/8, $0xf4b7544a8445eeb9
DATA q<>+8(SB)/8, $0x3dfe59ef8bf87644
DATA q<>+16(SB)/8, $0xf71a440bba67dceb
DATA q<>+24(SB)/8, $0x307c695185fa0675
DATA q<>+32(SB)/8, $0x0000000000003f83
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x9a6621661e2a4877
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xf4b7544a8445eeb9, R9
	MOVQ    $0x3dfe59ef8bf87644, R10
	MOVQ    $0xf71a440bba67dceb, R11
	MOVQ    $0x307c695185fa0675, R12
	MOVQ    $0x0000000000003f83, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x3dfe59ef8bf87644, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xf71a440bba67dceb, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x307c695185fa0675, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000003f83, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xf4b7544a8445eeb9, CX
	MOVQ    $0x3dfe59ef8bf87644, BX
	MOVQ    $0xf71a440bba67dceb, SI
	MOVQ    $0x307c695185fa0675, DI
	MOVQ    $0x0000000000003f83, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
