...
var benchRese_nocarry_0270 e_nocarry_0270

func BenchmarkE_nocarry_0270SetBytes(b *testing.B) {
	var x e_nocarry_0270
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0270MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0270.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0270)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0270)
		}
	})
}

func BenchmarkE_nocarry_0270Inverse(b *testing.B) {
	var x e_nocarry_0270
	x.SetRandom()
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0270Butterfly(b *testing.B) {
	var x e_nocarry_0270
	x.SetRandom()
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0270)
	}
}

func BenchmarkE_nocarry_0270Exp(b *testing.B) {
	var x e_nocarry_0270
	x.SetRandom()
	benchRese_nocarry_0270.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0270Double(b *testing.B) {
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Double(&benchRese_nocarry_0270)
	}
}

func BenchmarkE_nocarry_0270Add(b *testing.B) {
	var x e_nocarry_0270
	x.SetRandom()
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Add(&x, &benchRese_nocarry_0270)
	}
}

func BenchmarkE_nocarry_0270Sub(b *testing.B) {
	var x e_nocarry_0270
	x.SetRandom()
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Sub(&x, &benchRese_nocarry_0270)
	}
}

func BenchmarkE_nocarry_0270Neg(b *testing.B) {
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Neg(&benchRese_nocarry_0270)
	}
}

func BenchmarkE_nocarry_0270Div(b *testing.B) {
	var x e_nocarry_0270
	x.SetRandom()
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Div(&x, &benchRese_nocarry_0270)
	}
}

func BenchmarkE_nocarry_0270FromMont(b *testing.B) {
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.FromMont()
	}
}

func BenchmarkE_nocarry_0270ToMont(b *testing.B) {
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.ToMont()
	}
}
func BenchmarkE_nocarry_0270Square(b *testing.B) {
	benchRese_nocarry_0270.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Square(&benchRese_nocarry_0270)
	}
}

func BenchmarkE_nocarry_0270Sqrt(b *testing.B) {
	var a e_nocarry_0270
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0270Mul(b *testing.B) {
	x := e_nocarry_0270{
	...
	benchRese_nocarry_0270.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Mul(&benchRese_nocarry_0270, &x)
	}
}

func BenchmarkE_nocarry_0270Cmp(b *testing.B) {
	x := e_nocarry_0270{
		10193191690754304660,
		2801631519866408131,
		4519783353339009588,
	...
	benchRese_nocarry_0270 = x
	benchRese_nocarry_0270[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0270.Cmp(&x)
	}
}

func TestE_nocarry_0270Cmp(t *testing.T) {
	var x, y e_nocarry_0270
...
func TestE_nocarry_0270IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0270
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0270

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0270{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0270
	one.SetOne()
	e.Sub(&qe_nocarry_0270, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0270{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0270{0, uint64(i)})
	}
...
func TestE_nocarry_0270NegZero(t *testing.T) {
	var a, b e_nocarry_0270
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0270Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0270, len(staticTestValues))
...
func TestE_nocarry_0270Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0270) bool {
			var b e_nocarry_0270
...
func TestE_nocarry_0270InverseExp(t *testing.T) {
...
func TestE_nocarry_0270MulByConstants(t *testing.T) {
...
func TestE_nocarry_0270Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0270) bool {
...
func TestE_nocarry_0270LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0270Halve(t *testing.T) {
...
func TestE_nocarry_0270FromMont(t *testing.T) {
...
type testPaire_nocarry_0270 struct {
	element e_nocarry_0270
	bigint  big.Int
}

func (z *e_nocarry_0270) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0270[4] {
		return true
	}
	if z[4] < qe_nocarry_0270[4] {
		return false
	...
	return z[0] >= qe_nocarry_0270[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0270

		g.element = e_nocarry_0270{
		...
		if qe_nocarry_0270[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0270[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0270 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0270[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0270[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0270[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0270[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0270[4], carry)
...
func Benchmarke_nocarry_0270InverseNew(b *testing.B) {
	var x e_nocarry_0270
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0270
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0270
		var xInv e_nocarry_0270
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0270
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0270
...
func testLinearComb(t *testing.T, x *e_nocarry_0270, xC int64, y *e_nocarry_0270, yC int64) {
	...
	var z e_nocarry_0270
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0270, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0270
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0270, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0270
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0270, xHi uint64) {
	var res e_nocarry_0270
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0270) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0270) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0270, c int64, result *e_nocarry_0270, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0270) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0270) uint64 {
