...
// modulus q
DATA q<>+0(SB)/8, $0x36979ca1235d3185
DATA q<>+8(SB)/8, $0xdf20d146a73fce3f
DATA q<>+16(SB)/8, $0xe1c43a90227bd057
DATA q<>+24(SB)/8, $0xeb39ddef89e7d2a0
DATA q<>+32(SB)/8, $0x489468be47781034
DATA q<>+40(SB)/8, $0x00000ed6211a96c5
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x54b68491d71ae0b3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x36979ca1235d3185, R10
	MOVQ    $0xdf20d146a73fce3f, R11
	MOVQ    $0xe1c43a90227bd057, R12
	MOVQ    $0xeb39ddef89e7d2a0, R13
	MOVQ    $0x489468be47781034, R14
	MOVQ    $0x00000ed6211a96c5, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xdf20d146a73fce3f, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xe1c43a90227bd057, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xeb39ddef89e7d2a0, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x489468be47781034, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000ed6211a96c5, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x36979ca1235d3185, CX
	MOVQ    $0xdf20d146a73fce3f, BX
	MOVQ    $0xe1c43a90227bd057, SI
	MOVQ    $0xeb39ddef89e7d2a0, DI
	MOVQ    $0x489468be47781034, R8
	MOVQ    $0x00000ed6211a96c5, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
