...
var benchRese_nocarry_0364 e_nocarry_0364

func BenchmarkE_nocarry_0364SetBytes(b *testing.B) {
	var x e_nocarry_0364
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0364MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0364.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0364)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0364)
		}
	})
}

func BenchmarkE_nocarry_0364Inverse(b *testing.B) {
	var x e_nocarry_0364
	x.SetRandom()
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0364Butterfly(b *testing.B) {
	var x e_nocarry_0364
	x.SetRandom()
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0364)
	}
}

func BenchmarkE_nocarry_0364Exp(b *testing.B) {
	var x e_nocarry_0364
	x.SetRandom()
	benchRese_nocarry_0364.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0364Double(b *testing.B) {
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Double(&benchRese_nocarry_0364)
	}
}

func BenchmarkE_nocarry_0364Add(b *testing.B) {
	var x e_nocarry_0364
	x.SetRandom()
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Add(&x, &benchRese_nocarry_0364)
	}
}

func BenchmarkE_nocarry_0364Sub(b *testing.B) {
	var x e_nocarry_0364
	x.SetRandom()
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Sub(&x, &benchRese_nocarry_0364)
	}
}

func BenchmarkE_nocarry_0364Neg(b *testing.B) {
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Neg(&benchRese_nocarry_0364)
	}
}

func BenchmarkE_nocarry_0364Div(b *testing.B) {
	var x e_nocarry_0364
	x.SetRandom()
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Div(&x, &benchRese_nocarry_0364)
	}
}

func BenchmarkE_nocarry_0364FromMont(b *testing.B) {
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.FromMont()
	}
}

func BenchmarkE_nocarry_0364ToMont(b *testing.B) {
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.ToMont()
	}
}
func BenchmarkE_nocarry_0364Square(b *testing.B) {
	benchRese_nocarry_0364.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Square(&benchRese_nocarry_0364)
	}
}

func BenchmarkE_nocarry_0364Sqrt(b *testing.B) {
	var a e_nocarry_0364
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0364Mul(b *testing.B) {
	x := e_nocarry_0364{
		7837654867061683481,
	...
	benchRese_nocarry_0364.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Mul(&benchRese_nocarry_0364, &x)
	}
}

func BenchmarkE_nocarry_0364Cmp(b *testing.B) {
	x := e_nocarry_0364{
		7837654867061683481,
		13769522936826095823,
		1588014948418090587,
	...
	benchRese_nocarry_0364 = x
	benchRese_nocarry_0364[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0364.Cmp(&x)
	}
}

func TestE_nocarry_0364Cmp(t *testing.T) {
	var x, y e_nocarry_0364
...
func TestE_nocarry_0364IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0364
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0364

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0364{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0364
	one.SetOne()
	e.Sub(&qe_nocarry_0364, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0364{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0364{0, uint64(i)})
	}
...
func TestE_nocarry_0364NegZero(t *testing.T) {
	var a, b e_nocarry_0364
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0364Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0364, len(staticTestValues))
...
func TestE_nocarry_0364Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0364) bool {
			var b e_nocarry_0364
...
func TestE_nocarry_0364InverseExp(t *testing.T) {
...
func TestE_nocarry_0364MulByConstants(t *testing.T) {
...
func TestE_nocarry_0364Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0364) bool {
...
func TestE_nocarry_0364LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0364Halve(t *testing.T) {
...
func TestE_nocarry_0364FromMont(t *testing.T) {
...
type testPaire_nocarry_0364 struct {
	element e_nocarry_0364
	bigint  big.Int
}

func (z *e_nocarry_0364) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0364[5] {
		return true
	}
	if z[5] < qe_nocarry_0364[5] {
		return false
	...
	return z[0] >= qe_nocarry_0364[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0364

		g.element = e_nocarry_0364{
		...
		if qe_nocarry_0364[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0364[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0364 {
			var g e_nocarry_0364
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0364[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0364[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0364[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0364[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0364[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0364[5], carry)
...
func Benchmarke_nocarry_0364InverseNew(b *testing.B) {
	var x e_nocarry_0364
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0364
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0364
		var xInv e_nocarry_0364
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0364
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0364
...
func testLinearComb(t *testing.T, x *e_nocarry_0364, xC int64, y *e_nocarry_0364, yC int64) {
	...
	var z e_nocarry_0364
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0364, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0364
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0364, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0364
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0364, xHi uint64) {
	var res e_nocarry_0364
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0364) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0364) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0364, c int64, result *e_nocarry_0364, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0364) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0364) uint64 {
