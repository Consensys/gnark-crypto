...
var benchRese_nocarry_0263 e_nocarry_0263

func BenchmarkE_nocarry_0263SetBytes(b *testing.B) {
	var x e_nocarry_0263
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0263MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0263.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0263)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0263)
		}
	})
}

func BenchmarkE_nocarry_0263Inverse(b *testing.B) {
	var x e_nocarry_0263
	x.SetRandom()
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0263Butterfly(b *testing.B) {
	var x e_nocarry_0263
	x.SetRandom()
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0263)
	}
}

func BenchmarkE_nocarry_0263Exp(b *testing.B) {
	var x e_nocarry_0263
	x.SetRandom()
	benchRese_nocarry_0263.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0263Double(b *testing.B) {
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Double(&benchRese_nocarry_0263)
	}
}

func BenchmarkE_nocarry_0263Add(b *testing.B) {
	var x e_nocarry_0263
	x.SetRandom()
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Add(&x, &benchRese_nocarry_0263)
	}
}

func BenchmarkE_nocarry_0263Sub(b *testing.B) {
	var x e_nocarry_0263
	x.SetRandom()
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Sub(&x, &benchRese_nocarry_0263)
	}
}

func BenchmarkE_nocarry_0263Neg(b *testing.B) {
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Neg(&benchRese_nocarry_0263)
	}
}

func BenchmarkE_nocarry_0263Div(b *testing.B) {
	var x e_nocarry_0263
	x.SetRandom()
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Div(&x, &benchRese_nocarry_0263)
	}
}

func BenchmarkE_nocarry_0263FromMont(b *testing.B) {
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.FromMont()
	}
}

func BenchmarkE_nocarry_0263ToMont(b *testing.B) {
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.ToMont()
	}
}
func BenchmarkE_nocarry_0263Square(b *testing.B) {
	benchRese_nocarry_0263.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Square(&benchRese_nocarry_0263)
	}
}

func BenchmarkE_nocarry_0263Sqrt(b *testing.B) {
	var a e_nocarry_0263
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0263Mul(b *testing.B) {
	x := e_nocarry_0263{
		8883731783989633144,
		5564393348711377173,
		1495581374901975472,
	...
	benchRese_nocarry_0263.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Mul(&benchRese_nocarry_0263, &x)
	}
}

func BenchmarkE_nocarry_0263Cmp(b *testing.B) {
	x := e_nocarry_0263{
		8883731783989633144,
		5564393348711377173,
		1495581374901975472,
	...
	benchRese_nocarry_0263 = x
	benchRese_nocarry_0263[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0263.Cmp(&x)
	}
}

func TestE_nocarry_0263Cmp(t *testing.T) {
	var x, y e_nocarry_0263
...
func TestE_nocarry_0263IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0263
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0263

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0263{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0263
	one.SetOne()
	e.Sub(&qe_nocarry_0263, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0263{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0263{0, uint64(i)})
	}
...
func TestE_nocarry_0263NegZero(t *testing.T) {
	var a, b e_nocarry_0263
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0263Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0263, len(staticTestValues))
...
func TestE_nocarry_0263Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0263) bool {
			var b e_nocarry_0263
...
func TestE_nocarry_0263InverseExp(t *testing.T) {
...
func TestE_nocarry_0263MulByConstants(t *testing.T) {
...
func TestE_nocarry_0263Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0263) bool {
...
func TestE_nocarry_0263LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0263Halve(t *testing.T) {
...
func TestE_nocarry_0263FromMont(t *testing.T) {
...
type testPaire_nocarry_0263 struct {
	element e_nocarry_0263
	bigint  big.Int
}

func (z *e_nocarry_0263) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0263[4] {
		return true
	}
	if z[4] < qe_nocarry_0263[4] {
		return false
	...
	return z[0] >= qe_nocarry_0263[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0263

		g.element = e_nocarry_0263{
		...
		if qe_nocarry_0263[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0263[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0263 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0263[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0263[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0263[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0263[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0263[4], carry)
...
func Benchmarke_nocarry_0263InverseNew(b *testing.B) {
	var x e_nocarry_0263
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0263
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0263
		var xInv e_nocarry_0263
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0263
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0263
...
func testLinearComb(t *testing.T, x *e_nocarry_0263, xC int64, y *e_nocarry_0263, yC int64) {
	...
	var z e_nocarry_0263
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0263, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0263
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0263, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0263
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0263, xHi uint64) {
	var res e_nocarry_0263
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0263) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0263) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0263, c int64, result *e_nocarry_0263, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0263) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0263) uint64 {
