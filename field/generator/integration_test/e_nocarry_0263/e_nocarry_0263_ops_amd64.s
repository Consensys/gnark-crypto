...
// modulus q
DATA q<>+0(SB)/8, $0xe72a4241f9f45121
DATA q<>+8(SB)/8, $0x1c7f6ad193deea90
DATA q<>+16(SB)/8, $0xbf2219370c8979cf
DATA q<>+24(SB)/8, $0x9d87649ef58ef8d9
DATA q<>+32(SB)/8, $0x0000000000000074
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xb484296fd45b8d1f
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xe72a4241f9f45121, R9
	MOVQ    $0x1c7f6ad193deea90, R10
	MOVQ    $0xbf2219370c8979cf, R11
	MOVQ    $0x9d87649ef58ef8d9, R12
	MOVQ    $0x0000000000000074, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x1c7f6ad193deea90, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xbf2219370c8979cf, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x9d87649ef58ef8d9, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000000074, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xe72a4241f9f45121, CX
	MOVQ    $0x1c7f6ad193deea90, BX
	MOVQ    $0xbf2219370c8979cf, SI
	MOVQ    $0x9d87649ef58ef8d9, DI
	MOVQ    $0x0000000000000074, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
