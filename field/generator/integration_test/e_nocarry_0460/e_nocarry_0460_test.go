...
var benchRese_nocarry_0460 e_nocarry_0460

func BenchmarkE_nocarry_0460SetBytes(b *testing.B) {
	var x e_nocarry_0460
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0460MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0460.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0460)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0460)
		}
	})
}

func BenchmarkE_nocarry_0460Inverse(b *testing.B) {
	var x e_nocarry_0460
	x.SetRandom()
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0460Butterfly(b *testing.B) {
	var x e_nocarry_0460
	x.SetRandom()
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0460)
	}
}

func BenchmarkE_nocarry_0460Exp(b *testing.B) {
	var x e_nocarry_0460
	x.SetRandom()
	benchRese_nocarry_0460.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0460Double(b *testing.B) {
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Double(&benchRese_nocarry_0460)
	}
}

func BenchmarkE_nocarry_0460Add(b *testing.B) {
	var x e_nocarry_0460
	x.SetRandom()
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Add(&x, &benchRese_nocarry_0460)
	}
}

func BenchmarkE_nocarry_0460Sub(b *testing.B) {
	var x e_nocarry_0460
	x.SetRandom()
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Sub(&x, &benchRese_nocarry_0460)
	}
}

func BenchmarkE_nocarry_0460Neg(b *testing.B) {
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Neg(&benchRese_nocarry_0460)
	}
}

func BenchmarkE_nocarry_0460Div(b *testing.B) {
	var x e_nocarry_0460
	x.SetRandom()
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Div(&x, &benchRese_nocarry_0460)
	}
}

func BenchmarkE_nocarry_0460FromMont(b *testing.B) {
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.FromMont()
	}
}

func BenchmarkE_nocarry_0460ToMont(b *testing.B) {
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.ToMont()
	}
}
func BenchmarkE_nocarry_0460Square(b *testing.B) {
	benchRese_nocarry_0460.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Square(&benchRese_nocarry_0460)
	}
}

func BenchmarkE_nocarry_0460Sqrt(b *testing.B) {
	var a e_nocarry_0460
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0460Mul(b *testing.B) {
	x := e_nocarry_0460{
	...
	benchRese_nocarry_0460.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Mul(&benchRese_nocarry_0460, &x)
	}
}

func BenchmarkE_nocarry_0460Cmp(b *testing.B) {
	x := e_nocarry_0460{
		16044693334102149390,
		16506364173774135823,
		7998805892869398767,
	...
	benchRese_nocarry_0460 = x
	benchRese_nocarry_0460[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0460.Cmp(&x)
	}
}

func TestE_nocarry_0460Cmp(t *testing.T) {
	var x, y e_nocarry_0460
...
func TestE_nocarry_0460IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0460
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0460

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0460{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0460
	one.SetOne()
	e.Sub(&qe_nocarry_0460, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0460{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0460{0, uint64(i)})
	}
...
func TestE_nocarry_0460NegZero(t *testing.T) {
	var a, b e_nocarry_0460
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0460Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0460, len(staticTestValues))
...
func TestE_nocarry_0460Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0460) bool {
			var b e_nocarry_0460
...
func TestE_nocarry_0460InverseExp(t *testing.T) {
...
func TestE_nocarry_0460MulByConstants(t *testing.T) {
...
func TestE_nocarry_0460Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0460) bool {
...
func TestE_nocarry_0460LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0460Halve(t *testing.T) {
...
func TestE_nocarry_0460FromMont(t *testing.T) {
...
type testPaire_nocarry_0460 struct {
	element e_nocarry_0460
	bigint  big.Int
}

func (z *e_nocarry_0460) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0460[7] {
		return true
	}
	if z[7] < qe_nocarry_0460[7] {
		return false
	...
	return z[0] >= qe_nocarry_0460[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0460

		g.element = e_nocarry_0460{
		...
		if qe_nocarry_0460[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0460[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0460 {
			var g e_nocarry_0460
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0460[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0460[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0460[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0460[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0460[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0460[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0460[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0460[7], carry)
...
func Benchmarke_nocarry_0460InverseNew(b *testing.B) {
	var x e_nocarry_0460
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0460
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0460
		var xInv e_nocarry_0460
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0460
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0460
...
func testLinearComb(t *testing.T, x *e_nocarry_0460, xC int64, y *e_nocarry_0460, yC int64) {
	...
	var z e_nocarry_0460
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0460, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0460
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0460, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0460
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0460, xHi uint64) {
	var res e_nocarry_0460
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0460) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0460) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0460, c int64, result *e_nocarry_0460, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0460) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0460) uint64 {
