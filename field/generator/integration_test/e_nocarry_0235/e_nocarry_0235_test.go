...
var benchRese_nocarry_0235 e_nocarry_0235

func BenchmarkE_nocarry_0235SetBytes(b *testing.B) {
	var x e_nocarry_0235
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0235MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0235.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0235)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0235)
		}
	})
}

func BenchmarkE_nocarry_0235Inverse(b *testing.B) {
	var x e_nocarry_0235
	x.SetRandom()
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0235Butterfly(b *testing.B) {
	var x e_nocarry_0235
	x.SetRandom()
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0235)
	}
}

func BenchmarkE_nocarry_0235Exp(b *testing.B) {
	var x e_nocarry_0235
	x.SetRandom()
	benchRese_nocarry_0235.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0235Double(b *testing.B) {
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Double(&benchRese_nocarry_0235)
	}
}

func BenchmarkE_nocarry_0235Add(b *testing.B) {
	var x e_nocarry_0235
	x.SetRandom()
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Add(&x, &benchRese_nocarry_0235)
	}
}

func BenchmarkE_nocarry_0235Sub(b *testing.B) {
	var x e_nocarry_0235
	x.SetRandom()
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Sub(&x, &benchRese_nocarry_0235)
	}
}

func BenchmarkE_nocarry_0235Neg(b *testing.B) {
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Neg(&benchRese_nocarry_0235)
	}
}

func BenchmarkE_nocarry_0235Div(b *testing.B) {
	var x e_nocarry_0235
	x.SetRandom()
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Div(&x, &benchRese_nocarry_0235)
	}
}

func BenchmarkE_nocarry_0235FromMont(b *testing.B) {
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.FromMont()
	}
}

func BenchmarkE_nocarry_0235ToMont(b *testing.B) {
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.ToMont()
	}
}
func BenchmarkE_nocarry_0235Square(b *testing.B) {
	benchRese_nocarry_0235.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Square(&benchRese_nocarry_0235)
	}
}

func BenchmarkE_nocarry_0235Sqrt(b *testing.B) {
	var a e_nocarry_0235
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0235Mul(b *testing.B) {
	x := e_nocarry_0235{
	...
	benchRese_nocarry_0235.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Mul(&benchRese_nocarry_0235, &x)
	}
}

func BenchmarkE_nocarry_0235Cmp(b *testing.B) {
	x := e_nocarry_0235{
		13192648127344090564,
		1915813370919605577,
		5583686759510830864,
	...
	benchRese_nocarry_0235 = x
	benchRese_nocarry_0235[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0235.Cmp(&x)
	}
}

func TestE_nocarry_0235Cmp(t *testing.T) {
	var x, y e_nocarry_0235
...
func TestE_nocarry_0235IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0235
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0235

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0235{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0235
	one.SetOne()
	e.Sub(&qe_nocarry_0235, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0235{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0235{0, uint64(i)})
	}
...
func TestE_nocarry_0235NegZero(t *testing.T) {
	var a, b e_nocarry_0235
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0235Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0235, len(staticTestValues))
...
func TestE_nocarry_0235Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0235) bool {
			var b e_nocarry_0235
...
func TestE_nocarry_0235InverseExp(t *testing.T) {
...
func TestE_nocarry_0235MulByConstants(t *testing.T) {
...
func TestE_nocarry_0235Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0235) bool {
...
func TestE_nocarry_0235LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0235Halve(t *testing.T) {
...
func TestE_nocarry_0235FromMont(t *testing.T) {
...
type testPaire_nocarry_0235 struct {
	element e_nocarry_0235
	bigint  big.Int
}

func (z *e_nocarry_0235) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0235[3] {
		return true
	}
	if z[3] < qe_nocarry_0235[3] {
		return false
	...
	return z[0] >= qe_nocarry_0235[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0235

		g.element = e_nocarry_0235{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0235[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0235[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0235 {
			var g e_nocarry_0235
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0235[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0235[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0235[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0235[3], carry)
...
func Benchmarke_nocarry_0235InverseNew(b *testing.B) {
	var x e_nocarry_0235
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0235
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0235
		var xInv e_nocarry_0235
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0235
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0235
...
func testLinearComb(t *testing.T, x *e_nocarry_0235, xC int64, y *e_nocarry_0235, yC int64) {
	...
	var z e_nocarry_0235
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0235, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0235
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0235, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0235
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0235, xHi uint64) {
	var res e_nocarry_0235
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0235) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0235) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0235, c int64, result *e_nocarry_0235, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0235) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0235) uint64 {
