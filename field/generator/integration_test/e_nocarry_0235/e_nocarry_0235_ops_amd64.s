...
// modulus q
DATA q<>+0(SB)/8, $0x598986be18d3a785
DATA q<>+8(SB)/8, $0x7d786a1cbdef1c1d
DATA q<>+16(SB)/8, $0x078dd3b441bc13dc
DATA q<>+24(SB)/8, $0x0000073d5ba11174
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xec10fc137afdc6b3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x598986be18d3a785, R8
	MOVQ    $0x7d786a1cbdef1c1d, R9
	MOVQ    $0x078dd3b441bc13dc, R10
	MOVQ    $0x0000073d5ba11174, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x7d786a1cbdef1c1d, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x078dd3b441bc13dc, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000073d5ba11174, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x598986be18d3a785, R12
	MOVQ    $0x7d786a1cbdef1c1d, R13
	MOVQ    $0x078dd3b441bc13dc, R14
	MOVQ    $0x0000073d5ba11174, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
