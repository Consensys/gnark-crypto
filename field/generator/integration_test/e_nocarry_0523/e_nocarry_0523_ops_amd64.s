...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x9c3242d9cf27359b, R12
	ADDQ R12, AX
	MOVQ $0x84fd14da80742ab5, R12
	ADCQ R12, DX
	MOVQ $0xd657121a17eceef0, R12
	ADCQ R12, CX
	MOVQ $0xbb74eebbd9b9c713, R12
	ADCQ R12, BX
	MOVQ $0x7a64000d2ce499d0, R12
	ADCQ R12, SI
	MOVQ $0x52107823aef726ff, R12
	ADCQ R12, DI
	MOVQ $0xa14bf455c097d53a, R12
	ADCQ R12, R8
	MOVQ $0x627f7398eca2a252, R12
	ADCQ R12, R9
	MOVQ $0x000000000000062d, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x9c3242d9cf27359b, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x84fd14da80742ab5, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xd657121a17eceef0, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xbb74eebbd9b9c713, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x7a64000d2ce499d0, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x52107823aef726ff, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xa14bf455c097d53a, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x627f7398eca2a252, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000000000062d, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x9c3242d9cf27359b, AX
	ADDQ AX, DX
	MOVQ $0x84fd14da80742ab5, AX
	ADCQ AX, CX
	MOVQ $0xd657121a17eceef0, AX
	ADCQ AX, BX
	MOVQ $0xbb74eebbd9b9c713, AX
	ADCQ AX, SI
	MOVQ $0x7a64000d2ce499d0, AX
	ADCQ AX, DI
	MOVQ $0x52107823aef726ff, AX
	ADCQ AX, R8
	MOVQ $0xa14bf455c097d53a, AX
	ADCQ AX, R9
	MOVQ $0x627f7398eca2a252, AX
	ADCQ AX, R10
	MOVQ $0x000000000000062d, AX
	ADCQ AX, R11
