...
var benchRese_nocarry_0523 e_nocarry_0523

func BenchmarkE_nocarry_0523SetBytes(b *testing.B) {
	var x e_nocarry_0523
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0523MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0523.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0523)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0523)
		}
	})
}

func BenchmarkE_nocarry_0523Inverse(b *testing.B) {
	var x e_nocarry_0523
	x.SetRandom()
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0523Butterfly(b *testing.B) {
	var x e_nocarry_0523
	x.SetRandom()
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0523)
	}
}

func BenchmarkE_nocarry_0523Exp(b *testing.B) {
	var x e_nocarry_0523
	x.SetRandom()
	benchRese_nocarry_0523.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0523Double(b *testing.B) {
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Double(&benchRese_nocarry_0523)
	}
}

func BenchmarkE_nocarry_0523Add(b *testing.B) {
	var x e_nocarry_0523
	x.SetRandom()
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Add(&x, &benchRese_nocarry_0523)
	}
}

func BenchmarkE_nocarry_0523Sub(b *testing.B) {
	var x e_nocarry_0523
	x.SetRandom()
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Sub(&x, &benchRese_nocarry_0523)
	}
}

func BenchmarkE_nocarry_0523Neg(b *testing.B) {
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Neg(&benchRese_nocarry_0523)
	}
}

func BenchmarkE_nocarry_0523Div(b *testing.B) {
	var x e_nocarry_0523
	x.SetRandom()
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Div(&x, &benchRese_nocarry_0523)
	}
}

func BenchmarkE_nocarry_0523FromMont(b *testing.B) {
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.FromMont()
	}
}

func BenchmarkE_nocarry_0523ToMont(b *testing.B) {
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.ToMont()
	}
}
func BenchmarkE_nocarry_0523Square(b *testing.B) {
	benchRese_nocarry_0523.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Square(&benchRese_nocarry_0523)
	}
}

func BenchmarkE_nocarry_0523Sqrt(b *testing.B) {
	var a e_nocarry_0523
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0523Mul(b *testing.B) {
	x := e_nocarry_0523{
		6296982576160375089,
		349904686755447966,
	...
	benchRese_nocarry_0523.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Mul(&benchRese_nocarry_0523, &x)
	}
}

func BenchmarkE_nocarry_0523Cmp(b *testing.B) {
	x := e_nocarry_0523{
		6296982576160375089,
		349904686755447966,
		11334023492882574974,
	...
	benchRese_nocarry_0523 = x
	benchRese_nocarry_0523[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0523.Cmp(&x)
	}
}

func TestE_nocarry_0523Cmp(t *testing.T) {
	var x, y e_nocarry_0523
...
func TestE_nocarry_0523IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0523
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0523

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0523{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0523
	one.SetOne()
	e.Sub(&qe_nocarry_0523, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0523{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0523{0, uint64(i)})
	}
...
func TestE_nocarry_0523NegZero(t *testing.T) {
	var a, b e_nocarry_0523
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0523Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0523, len(staticTestValues))
...
func TestE_nocarry_0523Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0523) bool {
			var b e_nocarry_0523
...
func TestE_nocarry_0523InverseExp(t *testing.T) {
...
func TestE_nocarry_0523MulByConstants(t *testing.T) {
...
func TestE_nocarry_0523Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0523) bool {
...
func TestE_nocarry_0523LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0523Halve(t *testing.T) {
...
func TestE_nocarry_0523FromMont(t *testing.T) {
...
type testPaire_nocarry_0523 struct {
	element e_nocarry_0523
	bigint  big.Int
}

func (z *e_nocarry_0523) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0523[8] {
		return true
	}
	if z[8] < qe_nocarry_0523[8] {
		return false
	...
	return z[0] >= qe_nocarry_0523[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0523

		g.element = e_nocarry_0523{
		...
		if qe_nocarry_0523[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0523[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0523 {
			var g e_nocarry_0523
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0523[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0523[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0523[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0523[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0523[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0523[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0523[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0523[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0523[8], carry)
...
func Benchmarke_nocarry_0523InverseNew(b *testing.B) {
	var x e_nocarry_0523
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0523
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0523
		var xInv e_nocarry_0523
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0523
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0523
...
func testLinearComb(t *testing.T, x *e_nocarry_0523, xC int64, y *e_nocarry_0523, yC int64) {
	...
	var z e_nocarry_0523
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0523, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0523
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0523, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0523
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0523, xHi uint64) {
	var res e_nocarry_0523
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0523) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0523) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0523, c int64, result *e_nocarry_0523, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0523) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0523) uint64 {
