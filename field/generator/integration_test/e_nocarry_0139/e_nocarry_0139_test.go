...
var benchRese_nocarry_0139 e_nocarry_0139

func BenchmarkE_nocarry_0139SetBytes(b *testing.B) {
	var x e_nocarry_0139
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0139MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0139.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0139)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0139)
		}
	})
}

func BenchmarkE_nocarry_0139Inverse(b *testing.B) {
	var x e_nocarry_0139
	x.SetRandom()
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0139Butterfly(b *testing.B) {
	var x e_nocarry_0139
	x.SetRandom()
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0139)
	}
}

func BenchmarkE_nocarry_0139Exp(b *testing.B) {
	var x e_nocarry_0139
	x.SetRandom()
	benchRese_nocarry_0139.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0139Double(b *testing.B) {
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Double(&benchRese_nocarry_0139)
	}
}

func BenchmarkE_nocarry_0139Add(b *testing.B) {
	var x e_nocarry_0139
	x.SetRandom()
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Add(&x, &benchRese_nocarry_0139)
	}
}

func BenchmarkE_nocarry_0139Sub(b *testing.B) {
	var x e_nocarry_0139
	x.SetRandom()
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Sub(&x, &benchRese_nocarry_0139)
	}
}

func BenchmarkE_nocarry_0139Neg(b *testing.B) {
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Neg(&benchRese_nocarry_0139)
	}
}

func BenchmarkE_nocarry_0139Div(b *testing.B) {
	var x e_nocarry_0139
	x.SetRandom()
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Div(&x, &benchRese_nocarry_0139)
	}
}

func BenchmarkE_nocarry_0139FromMont(b *testing.B) {
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.FromMont()
	}
}

func BenchmarkE_nocarry_0139ToMont(b *testing.B) {
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.ToMont()
	}
}
func BenchmarkE_nocarry_0139Square(b *testing.B) {
	benchRese_nocarry_0139.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Square(&benchRese_nocarry_0139)
	}
}

func BenchmarkE_nocarry_0139Sqrt(b *testing.B) {
	var a e_nocarry_0139
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0139Mul(b *testing.B) {
	x := e_nocarry_0139{
		6266679830581137441,
		17327954477347889233,
		1196,
	}
	benchRese_nocarry_0139.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Mul(&benchRese_nocarry_0139, &x)
	}
}

func BenchmarkE_nocarry_0139Cmp(b *testing.B) {
	x := e_nocarry_0139{
		6266679830581137441,
		17327954477347889233,
		1196,
	}
	benchRese_nocarry_0139 = x
	benchRese_nocarry_0139[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0139.Cmp(&x)
	}
}

func TestE_nocarry_0139Cmp(t *testing.T) {
	var x, y e_nocarry_0139
...
func TestE_nocarry_0139IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0139
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0139

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0139{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0139
	one.SetOne()
	e.Sub(&qe_nocarry_0139, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0139{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0139{0, uint64(i)})
	}
...
func TestE_nocarry_0139NegZero(t *testing.T) {
	var a, b e_nocarry_0139
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0139Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0139, len(staticTestValues))
...
func TestE_nocarry_0139Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0139) bool {
			var b e_nocarry_0139
...
func TestE_nocarry_0139InverseExp(t *testing.T) {
...
func TestE_nocarry_0139MulByConstants(t *testing.T) {
...
func TestE_nocarry_0139Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0139) bool {
...
func TestE_nocarry_0139LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0139Halve(t *testing.T) {
...
func TestE_nocarry_0139FromMont(t *testing.T) {
...
type testPaire_nocarry_0139 struct {
	element e_nocarry_0139
	bigint  big.Int
}

func (z *e_nocarry_0139) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0139[2] {
		return true
	}
	if z[2] < qe_nocarry_0139[2] {
		return false
	...
	return z[0] >= qe_nocarry_0139[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0139

		g.element = e_nocarry_0139{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0139[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0139[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0139 {
			var g e_nocarry_0139
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0139[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0139[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0139[2], carry)
...
func Benchmarke_nocarry_0139InverseNew(b *testing.B) {
	var x e_nocarry_0139
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0139
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0139
		var xInv e_nocarry_0139
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0139
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0139
...
func testLinearComb(t *testing.T, x *e_nocarry_0139, xC int64, y *e_nocarry_0139, yC int64) {
	...
	var z e_nocarry_0139
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0139, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0139
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0139, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0139
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0139, xHi uint64) {
	var res e_nocarry_0139
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0139) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0139) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0139, c int64, result *e_nocarry_0139, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0139) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0139) uint64 {
