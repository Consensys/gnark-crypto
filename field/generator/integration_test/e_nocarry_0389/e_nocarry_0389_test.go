...
var benchRese_nocarry_0389 e_nocarry_0389

func BenchmarkE_nocarry_0389SetBytes(b *testing.B) {
	var x e_nocarry_0389
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0389MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0389.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0389)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0389)
		}
	})
}

func BenchmarkE_nocarry_0389Inverse(b *testing.B) {
	var x e_nocarry_0389
	x.SetRandom()
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0389Butterfly(b *testing.B) {
	var x e_nocarry_0389
	x.SetRandom()
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0389)
	}
}

func BenchmarkE_nocarry_0389Exp(b *testing.B) {
	var x e_nocarry_0389
	x.SetRandom()
	benchRese_nocarry_0389.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0389Double(b *testing.B) {
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Double(&benchRese_nocarry_0389)
	}
}

func BenchmarkE_nocarry_0389Add(b *testing.B) {
	var x e_nocarry_0389
	x.SetRandom()
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Add(&x, &benchRese_nocarry_0389)
	}
}

func BenchmarkE_nocarry_0389Sub(b *testing.B) {
	var x e_nocarry_0389
	x.SetRandom()
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Sub(&x, &benchRese_nocarry_0389)
	}
}

func BenchmarkE_nocarry_0389Neg(b *testing.B) {
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Neg(&benchRese_nocarry_0389)
	}
}

func BenchmarkE_nocarry_0389Div(b *testing.B) {
	var x e_nocarry_0389
	x.SetRandom()
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Div(&x, &benchRese_nocarry_0389)
	}
}

func BenchmarkE_nocarry_0389FromMont(b *testing.B) {
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.FromMont()
	}
}

func BenchmarkE_nocarry_0389ToMont(b *testing.B) {
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.ToMont()
	}
}
func BenchmarkE_nocarry_0389Square(b *testing.B) {
	benchRese_nocarry_0389.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Square(&benchRese_nocarry_0389)
	}
}

func BenchmarkE_nocarry_0389Sqrt(b *testing.B) {
	var a e_nocarry_0389
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0389Mul(b *testing.B) {
	x := e_nocarry_0389{
	...
	benchRese_nocarry_0389.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Mul(&benchRese_nocarry_0389, &x)
	}
}

func BenchmarkE_nocarry_0389Cmp(b *testing.B) {
	x := e_nocarry_0389{
		16667910042070663405,
		9592432622868690983,
		7585422013054750316,
	...
	benchRese_nocarry_0389 = x
	benchRese_nocarry_0389[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0389.Cmp(&x)
	}
}

func TestE_nocarry_0389Cmp(t *testing.T) {
	var x, y e_nocarry_0389
...
func TestE_nocarry_0389IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0389
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0389

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0389{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0389
	one.SetOne()
	e.Sub(&qe_nocarry_0389, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0389{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0389{0, uint64(i)})
	}
...
func TestE_nocarry_0389NegZero(t *testing.T) {
	var a, b e_nocarry_0389
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0389Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0389, len(staticTestValues))
...
func TestE_nocarry_0389Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0389) bool {
			var b e_nocarry_0389
...
func TestE_nocarry_0389InverseExp(t *testing.T) {
...
func TestE_nocarry_0389MulByConstants(t *testing.T) {
...
func TestE_nocarry_0389Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0389) bool {
...
func TestE_nocarry_0389LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0389Halve(t *testing.T) {
...
func TestE_nocarry_0389FromMont(t *testing.T) {
...
type testPaire_nocarry_0389 struct {
	element e_nocarry_0389
	bigint  big.Int
}

func (z *e_nocarry_0389) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0389[6] {
		return true
	}
	if z[6] < qe_nocarry_0389[6] {
		return false
	...
	return z[0] >= qe_nocarry_0389[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0389

		g.element = e_nocarry_0389{
		...
		if qe_nocarry_0389[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0389[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0389 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0389[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0389[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0389[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0389[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0389[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0389[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0389[6], carry)
...
func Benchmarke_nocarry_0389InverseNew(b *testing.B) {
	var x e_nocarry_0389
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0389
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0389
		var xInv e_nocarry_0389
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0389
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0389
...
func testLinearComb(t *testing.T, x *e_nocarry_0389, xC int64, y *e_nocarry_0389, yC int64) {
	...
	var z e_nocarry_0389
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0389, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0389
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0389, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0389
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0389, xHi uint64) {
	var res e_nocarry_0389
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0389) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0389) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0389, c int64, result *e_nocarry_0389, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0389) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0389) uint64 {
