...
var benchRese_nocarry_0287 e_nocarry_0287

func BenchmarkE_nocarry_0287SetBytes(b *testing.B) {
	var x e_nocarry_0287
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0287MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0287.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0287)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0287)
		}
	})
}

func BenchmarkE_nocarry_0287Inverse(b *testing.B) {
	var x e_nocarry_0287
	x.SetRandom()
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0287Butterfly(b *testing.B) {
	var x e_nocarry_0287
	x.SetRandom()
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0287)
	}
}

func BenchmarkE_nocarry_0287Exp(b *testing.B) {
	var x e_nocarry_0287
	x.SetRandom()
	benchRese_nocarry_0287.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0287Double(b *testing.B) {
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Double(&benchRese_nocarry_0287)
	}
}

func BenchmarkE_nocarry_0287Add(b *testing.B) {
	var x e_nocarry_0287
	x.SetRandom()
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Add(&x, &benchRese_nocarry_0287)
	}
}

func BenchmarkE_nocarry_0287Sub(b *testing.B) {
	var x e_nocarry_0287
	x.SetRandom()
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Sub(&x, &benchRese_nocarry_0287)
	}
}

func BenchmarkE_nocarry_0287Neg(b *testing.B) {
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Neg(&benchRese_nocarry_0287)
	}
}

func BenchmarkE_nocarry_0287Div(b *testing.B) {
	var x e_nocarry_0287
	x.SetRandom()
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Div(&x, &benchRese_nocarry_0287)
	}
}

func BenchmarkE_nocarry_0287FromMont(b *testing.B) {
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.FromMont()
	}
}

func BenchmarkE_nocarry_0287ToMont(b *testing.B) {
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.ToMont()
	}
}
func BenchmarkE_nocarry_0287Square(b *testing.B) {
	benchRese_nocarry_0287.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Square(&benchRese_nocarry_0287)
	}
}

func BenchmarkE_nocarry_0287Sqrt(b *testing.B) {
	var a e_nocarry_0287
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0287Mul(b *testing.B) {
	x := e_nocarry_0287{
		2072260320443992797,
	...
	benchRese_nocarry_0287.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Mul(&benchRese_nocarry_0287, &x)
	}
}

func BenchmarkE_nocarry_0287Cmp(b *testing.B) {
	x := e_nocarry_0287{
		2072260320443992797,
		10042520867735623036,
		3595343610747440547,
	...
	benchRese_nocarry_0287 = x
	benchRese_nocarry_0287[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0287.Cmp(&x)
	}
}

func TestE_nocarry_0287Cmp(t *testing.T) {
	var x, y e_nocarry_0287
...
func TestE_nocarry_0287IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0287
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0287

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0287{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0287
	one.SetOne()
	e.Sub(&qe_nocarry_0287, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0287{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0287{0, uint64(i)})
	}
...
func TestE_nocarry_0287NegZero(t *testing.T) {
	var a, b e_nocarry_0287
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0287Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0287, len(staticTestValues))
...
func TestE_nocarry_0287Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0287) bool {
			var b e_nocarry_0287
...
func TestE_nocarry_0287InverseExp(t *testing.T) {
...
func TestE_nocarry_0287MulByConstants(t *testing.T) {
...
func TestE_nocarry_0287Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0287) bool {
...
func TestE_nocarry_0287LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0287Halve(t *testing.T) {
...
func TestE_nocarry_0287FromMont(t *testing.T) {
...
type testPaire_nocarry_0287 struct {
	element e_nocarry_0287
	bigint  big.Int
}

func (z *e_nocarry_0287) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0287[4] {
		return true
	}
	if z[4] < qe_nocarry_0287[4] {
		return false
	...
	return z[0] >= qe_nocarry_0287[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0287

		g.element = e_nocarry_0287{
		...
		if qe_nocarry_0287[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0287[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0287 {
			var g e_nocarry_0287
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0287[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0287[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0287[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0287[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0287[4], carry)
...
func Benchmarke_nocarry_0287InverseNew(b *testing.B) {
	var x e_nocarry_0287
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0287
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0287
		var xInv e_nocarry_0287
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0287
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0287
...
func testLinearComb(t *testing.T, x *e_nocarry_0287, xC int64, y *e_nocarry_0287, yC int64) {
	...
	var z e_nocarry_0287
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0287, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0287
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0287, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0287
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0287, xHi uint64) {
	var res e_nocarry_0287
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0287) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0287) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0287, c int64, result *e_nocarry_0287, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0287) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0287) uint64 {
