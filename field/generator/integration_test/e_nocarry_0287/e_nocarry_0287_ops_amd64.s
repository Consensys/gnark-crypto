...
// modulus q
DATA q<>+0(SB)/8, $0xff7e62a6e3284393
DATA q<>+8(SB)/8, $0x417c2a23b09ec2b7
DATA q<>+16(SB)/8, $0xe131cc57fbba8954
DATA q<>+24(SB)/8, $0x8480dd9bfe4fe890
DATA q<>+32(SB)/8, $0x000000007e1ee962
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x896cf7c124a1ad65
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xff7e62a6e3284393, R9
	MOVQ    $0x417c2a23b09ec2b7, R10
	MOVQ    $0xe131cc57fbba8954, R11
	MOVQ    $0x8480dd9bfe4fe890, R12
	MOVQ    $0x000000007e1ee962, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x417c2a23b09ec2b7, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xe131cc57fbba8954, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x8480dd9bfe4fe890, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000007e1ee962, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xff7e62a6e3284393, CX
	MOVQ    $0x417c2a23b09ec2b7, BX
	MOVQ    $0xe131cc57fbba8954, SI
	MOVQ    $0x8480dd9bfe4fe890, DI
	MOVQ    $0x000000007e1ee962, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
