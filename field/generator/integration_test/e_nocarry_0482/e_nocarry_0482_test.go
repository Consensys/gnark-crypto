...
var benchRese_nocarry_0482 e_nocarry_0482

func BenchmarkE_nocarry_0482SetBytes(b *testing.B) {
	var x e_nocarry_0482
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0482MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0482.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0482)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0482)
		}
	})
}

func BenchmarkE_nocarry_0482Inverse(b *testing.B) {
	var x e_nocarry_0482
	x.SetRandom()
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0482Butterfly(b *testing.B) {
	var x e_nocarry_0482
	x.SetRandom()
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0482)
	}
}

func BenchmarkE_nocarry_0482Exp(b *testing.B) {
	var x e_nocarry_0482
	x.SetRandom()
	benchRese_nocarry_0482.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0482Double(b *testing.B) {
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Double(&benchRese_nocarry_0482)
	}
}

func BenchmarkE_nocarry_0482Add(b *testing.B) {
	var x e_nocarry_0482
	x.SetRandom()
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Add(&x, &benchRese_nocarry_0482)
	}
}

func BenchmarkE_nocarry_0482Sub(b *testing.B) {
	var x e_nocarry_0482
	x.SetRandom()
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Sub(&x, &benchRese_nocarry_0482)
	}
}

func BenchmarkE_nocarry_0482Neg(b *testing.B) {
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Neg(&benchRese_nocarry_0482)
	}
}

func BenchmarkE_nocarry_0482Div(b *testing.B) {
	var x e_nocarry_0482
	x.SetRandom()
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Div(&x, &benchRese_nocarry_0482)
	}
}

func BenchmarkE_nocarry_0482FromMont(b *testing.B) {
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.FromMont()
	}
}

func BenchmarkE_nocarry_0482ToMont(b *testing.B) {
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.ToMont()
	}
}
func BenchmarkE_nocarry_0482Square(b *testing.B) {
	benchRese_nocarry_0482.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Square(&benchRese_nocarry_0482)
	}
}

func BenchmarkE_nocarry_0482Sqrt(b *testing.B) {
	var a e_nocarry_0482
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0482Mul(b *testing.B) {
	x := e_nocarry_0482{
	...
	benchRese_nocarry_0482.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Mul(&benchRese_nocarry_0482, &x)
	}
}

func BenchmarkE_nocarry_0482Cmp(b *testing.B) {
	x := e_nocarry_0482{
		11090257621260770580,
		3961591378156972596,
		2513148876941922290,
	...
	benchRese_nocarry_0482 = x
	benchRese_nocarry_0482[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0482.Cmp(&x)
	}
}

func TestE_nocarry_0482Cmp(t *testing.T) {
	var x, y e_nocarry_0482
...
func TestE_nocarry_0482IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0482
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0482

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0482{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0482
	one.SetOne()
	e.Sub(&qe_nocarry_0482, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0482{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0482{0, uint64(i)})
	}
...
func TestE_nocarry_0482NegZero(t *testing.T) {
	var a, b e_nocarry_0482
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0482Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0482, len(staticTestValues))
...
func TestE_nocarry_0482Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0482) bool {
			var b e_nocarry_0482
...
func TestE_nocarry_0482InverseExp(t *testing.T) {
...
func TestE_nocarry_0482MulByConstants(t *testing.T) {
...
func TestE_nocarry_0482Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0482) bool {
...
func TestE_nocarry_0482LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0482Halve(t *testing.T) {
...
func TestE_nocarry_0482FromMont(t *testing.T) {
...
type testPaire_nocarry_0482 struct {
	element e_nocarry_0482
	bigint  big.Int
}

func (z *e_nocarry_0482) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0482[7] {
		return true
	}
	if z[7] < qe_nocarry_0482[7] {
		return false
	...
	return z[0] >= qe_nocarry_0482[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0482

		g.element = e_nocarry_0482{
		...
		if qe_nocarry_0482[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0482[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0482 {
			var g e_nocarry_0482
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0482[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0482[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0482[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0482[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0482[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0482[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0482[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0482[7], carry)
...
func Benchmarke_nocarry_0482InverseNew(b *testing.B) {
	var x e_nocarry_0482
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0482
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0482
		var xInv e_nocarry_0482
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0482
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0482
...
func testLinearComb(t *testing.T, x *e_nocarry_0482, xC int64, y *e_nocarry_0482, yC int64) {
	...
	var z e_nocarry_0482
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0482, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0482
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0482, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0482
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0482, xHi uint64) {
	var res e_nocarry_0482
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0482) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0482) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0482, c int64, result *e_nocarry_0482, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0482) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0482) uint64 {
