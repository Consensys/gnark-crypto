...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x7defb8f7d65dd33d, R14
	ADDQ R14, AX
	MOVQ $0x5ffa4a9772848489, R14
	ADCQ R14, DX
	MOVQ $0x62f84fb237bc2f0c, R14
	ADCQ R14, CX
	MOVQ $0xcdb4369328f994b0, R14
	ADCQ R14, BX
	MOVQ $0xdae82dbc0cea7afe, R14
	ADCQ R14, SI
	MOVQ $0x1595d619b678e2d4, R14
	ADCQ R14, DI
	MOVQ $0x3e5a041df962c996, R14
	ADCQ R14, R8
	MOVQ $0xba180769c0e02279, R14
	ADCQ R14, R9
	MOVQ $0x9092f79cc9816927, R14
	ADCQ R14, R10
	MOVQ $0x822fd9b20adcdc2b, R14
	ADCQ R14, R11
	MOVQ $0x030b82fc7d096099, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x7defb8f7d65dd33d, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x5ffa4a9772848489, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x62f84fb237bc2f0c, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xcdb4369328f994b0, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xdae82dbc0cea7afe, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x1595d619b678e2d4, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x3e5a041df962c996, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xba180769c0e02279, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x9092f79cc9816927, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x822fd9b20adcdc2b, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x030b82fc7d096099, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x7defb8f7d65dd33d, AX
	ADDQ AX, DX
	MOVQ $0x5ffa4a9772848489, AX
	ADCQ AX, CX
	MOVQ $0x62f84fb237bc2f0c, AX
	ADCQ AX, BX
	MOVQ $0xcdb4369328f994b0, AX
	ADCQ AX, SI
	MOVQ $0xdae82dbc0cea7afe, AX
	ADCQ AX, DI
	MOVQ $0x1595d619b678e2d4, AX
	ADCQ AX, R8
	MOVQ $0x3e5a041df962c996, AX
	ADCQ AX, R9
	MOVQ $0xba180769c0e02279, AX
	ADCQ AX, R10
	MOVQ $0x9092f79cc9816927, AX
	ADCQ AX, R11
	MOVQ $0x822fd9b20adcdc2b, AX
	ADCQ AX, R12
	MOVQ $0x030b82fc7d096099, AX
	ADCQ AX, R13
