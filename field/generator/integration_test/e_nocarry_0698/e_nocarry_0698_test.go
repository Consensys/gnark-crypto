...
var benchRese_nocarry_0698 e_nocarry_0698

func BenchmarkE_nocarry_0698SetBytes(b *testing.B) {
	var x e_nocarry_0698
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0698MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0698.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0698)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0698)
		}
	})
}

func BenchmarkE_nocarry_0698Inverse(b *testing.B) {
	var x e_nocarry_0698
	x.SetRandom()
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0698Butterfly(b *testing.B) {
	var x e_nocarry_0698
	x.SetRandom()
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0698)
	}
}

func BenchmarkE_nocarry_0698Exp(b *testing.B) {
	var x e_nocarry_0698
	x.SetRandom()
	benchRese_nocarry_0698.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0698Double(b *testing.B) {
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Double(&benchRese_nocarry_0698)
	}
}

func BenchmarkE_nocarry_0698Add(b *testing.B) {
	var x e_nocarry_0698
	x.SetRandom()
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Add(&x, &benchRese_nocarry_0698)
	}
}

func BenchmarkE_nocarry_0698Sub(b *testing.B) {
	var x e_nocarry_0698
	x.SetRandom()
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Sub(&x, &benchRese_nocarry_0698)
	}
}

func BenchmarkE_nocarry_0698Neg(b *testing.B) {
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Neg(&benchRese_nocarry_0698)
	}
}

func BenchmarkE_nocarry_0698Div(b *testing.B) {
	var x e_nocarry_0698
	x.SetRandom()
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Div(&x, &benchRese_nocarry_0698)
	}
}

func BenchmarkE_nocarry_0698FromMont(b *testing.B) {
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.FromMont()
	}
}

func BenchmarkE_nocarry_0698ToMont(b *testing.B) {
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.ToMont()
	}
}
func BenchmarkE_nocarry_0698Square(b *testing.B) {
	benchRese_nocarry_0698.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Square(&benchRese_nocarry_0698)
	}
}

func BenchmarkE_nocarry_0698Sqrt(b *testing.B) {
	var a e_nocarry_0698
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0698Mul(b *testing.B) {
	x := e_nocarry_0698{
		630557840342759489,
		5770533298051703058,
	...
	benchRese_nocarry_0698.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Mul(&benchRese_nocarry_0698, &x)
	}
}

func BenchmarkE_nocarry_0698Cmp(b *testing.B) {
	x := e_nocarry_0698{
		630557840342759489,
		5770533298051703058,
		15885717156130118556,
	...
	benchRese_nocarry_0698 = x
	benchRese_nocarry_0698[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0698.Cmp(&x)
	}
}

func TestE_nocarry_0698Cmp(t *testing.T) {
	var x, y e_nocarry_0698
...
func TestE_nocarry_0698IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0698
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0698

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0698{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0698
	one.SetOne()
	e.Sub(&qe_nocarry_0698, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0698{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0698{0, uint64(i)})
	}
...
func TestE_nocarry_0698NegZero(t *testing.T) {
	var a, b e_nocarry_0698
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0698Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0698, len(staticTestValues))
...
func TestE_nocarry_0698Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0698) bool {
			var b e_nocarry_0698
...
func TestE_nocarry_0698InverseExp(t *testing.T) {
...
func TestE_nocarry_0698MulByConstants(t *testing.T) {
...
func TestE_nocarry_0698Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0698) bool {
...
func TestE_nocarry_0698LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0698Halve(t *testing.T) {
...
func TestE_nocarry_0698FromMont(t *testing.T) {
...
type testPaire_nocarry_0698 struct {
	element e_nocarry_0698
	bigint  big.Int
}

func (z *e_nocarry_0698) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0698[10] {
		return true
	}
	if z[10] < qe_nocarry_0698[10] {
		return false
	...
	return z[0] >= qe_nocarry_0698[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0698

		g.element = e_nocarry_0698{
		...
		if qe_nocarry_0698[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0698[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0698 {
			var g e_nocarry_0698
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0698[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0698[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0698[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0698[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0698[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0698[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0698[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0698[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0698[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0698[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0698[10], carry)
...
func Benchmarke_nocarry_0698InverseNew(b *testing.B) {
	var x e_nocarry_0698
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0698
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0698
		var xInv e_nocarry_0698
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0698
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0698
...
func testLinearComb(t *testing.T, x *e_nocarry_0698, xC int64, y *e_nocarry_0698, yC int64) {
	...
	var z e_nocarry_0698
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0698, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0698
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0698, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0698
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0698, xHi uint64) {
	var res e_nocarry_0698
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0698) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0698) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0698, c int64, result *e_nocarry_0698, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0698) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0698) uint64 {
