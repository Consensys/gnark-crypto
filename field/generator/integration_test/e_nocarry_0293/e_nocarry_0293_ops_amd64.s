...
// modulus q
DATA q<>+0(SB)/8, $0x5be5f8dbbcf87de9
DATA q<>+8(SB)/8, $0xa5803a44e2b4145d
DATA q<>+16(SB)/8, $0x475393a0a8ff0d12
DATA q<>+24(SB)/8, $0xee5a180e5ec52d00
DATA q<>+32(SB)/8, $0x0000001b695c900a
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x2a9277be5b2bd5a7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x5be5f8dbbcf87de9, R9
	MOVQ    $0xa5803a44e2b4145d, R10
	MOVQ    $0x475393a0a8ff0d12, R11
	MOVQ    $0xee5a180e5ec52d00, R12
	MOVQ    $0x0000001b695c900a, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xa5803a44e2b4145d, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x475393a0a8ff0d12, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xee5a180e5ec52d00, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000001b695c900a, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x5be5f8dbbcf87de9, CX
	MOVQ    $0xa5803a44e2b4145d, BX
	MOVQ    $0x475393a0a8ff0d12, SI
	MOVQ    $0xee5a180e5ec52d00, DI
	MOVQ    $0x0000001b695c900a, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
