...
var benchRese_nocarry_0293 e_nocarry_0293

func BenchmarkE_nocarry_0293SetBytes(b *testing.B) {
	var x e_nocarry_0293
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0293MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0293.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0293)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0293)
		}
	})
}

func BenchmarkE_nocarry_0293Inverse(b *testing.B) {
	var x e_nocarry_0293
	x.SetRandom()
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0293Butterfly(b *testing.B) {
	var x e_nocarry_0293
	x.SetRandom()
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0293)
	}
}

func BenchmarkE_nocarry_0293Exp(b *testing.B) {
	var x e_nocarry_0293
	x.SetRandom()
	benchRese_nocarry_0293.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0293Double(b *testing.B) {
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Double(&benchRese_nocarry_0293)
	}
}

func BenchmarkE_nocarry_0293Add(b *testing.B) {
	var x e_nocarry_0293
	x.SetRandom()
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Add(&x, &benchRese_nocarry_0293)
	}
}

func BenchmarkE_nocarry_0293Sub(b *testing.B) {
	var x e_nocarry_0293
	x.SetRandom()
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Sub(&x, &benchRese_nocarry_0293)
	}
}

func BenchmarkE_nocarry_0293Neg(b *testing.B) {
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Neg(&benchRese_nocarry_0293)
	}
}

func BenchmarkE_nocarry_0293Div(b *testing.B) {
	var x e_nocarry_0293
	x.SetRandom()
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Div(&x, &benchRese_nocarry_0293)
	}
}

func BenchmarkE_nocarry_0293FromMont(b *testing.B) {
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.FromMont()
	}
}

func BenchmarkE_nocarry_0293ToMont(b *testing.B) {
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.ToMont()
	}
}
func BenchmarkE_nocarry_0293Square(b *testing.B) {
	benchRese_nocarry_0293.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Square(&benchRese_nocarry_0293)
	}
}

func BenchmarkE_nocarry_0293Sqrt(b *testing.B) {
	var a e_nocarry_0293
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0293Mul(b *testing.B) {
	x := e_nocarry_0293{
	...
	benchRese_nocarry_0293.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Mul(&benchRese_nocarry_0293, &x)
	}
}

func BenchmarkE_nocarry_0293Cmp(b *testing.B) {
	x := e_nocarry_0293{
		17726696300400603059,
		5084582988150681542,
		6374393605424827378,
	...
	benchRese_nocarry_0293 = x
	benchRese_nocarry_0293[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0293.Cmp(&x)
	}
}

func TestE_nocarry_0293Cmp(t *testing.T) {
	var x, y e_nocarry_0293
...
func TestE_nocarry_0293IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0293
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0293

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0293{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0293
	one.SetOne()
	e.Sub(&qe_nocarry_0293, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0293{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0293{0, uint64(i)})
	}
...
func TestE_nocarry_0293NegZero(t *testing.T) {
	var a, b e_nocarry_0293
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0293Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0293, len(staticTestValues))
...
func TestE_nocarry_0293Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0293) bool {
			var b e_nocarry_0293
...
func TestE_nocarry_0293InverseExp(t *testing.T) {
...
func TestE_nocarry_0293MulByConstants(t *testing.T) {
...
func TestE_nocarry_0293Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0293) bool {
...
func TestE_nocarry_0293LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0293Halve(t *testing.T) {
...
func TestE_nocarry_0293FromMont(t *testing.T) {
...
type testPaire_nocarry_0293 struct {
	element e_nocarry_0293
	bigint  big.Int
}

func (z *e_nocarry_0293) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0293[4] {
		return true
	}
	if z[4] < qe_nocarry_0293[4] {
		return false
	...
	return z[0] >= qe_nocarry_0293[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0293

		g.element = e_nocarry_0293{
		...
		if qe_nocarry_0293[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0293[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0293 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0293[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0293[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0293[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0293[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0293[4], carry)
...
func Benchmarke_nocarry_0293InverseNew(b *testing.B) {
	var x e_nocarry_0293
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0293
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0293
		var xInv e_nocarry_0293
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0293
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0293
...
func testLinearComb(t *testing.T, x *e_nocarry_0293, xC int64, y *e_nocarry_0293, yC int64) {
	...
	var z e_nocarry_0293
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0293, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0293
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0293, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0293
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0293, xHi uint64) {
	var res e_nocarry_0293
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0293) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0293) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0293, c int64, result *e_nocarry_0293, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0293) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0293) uint64 {
