...
var benchRese_nocarry_0581 e_nocarry_0581

func BenchmarkE_nocarry_0581SetBytes(b *testing.B) {
	var x e_nocarry_0581
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0581MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0581.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0581)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0581)
		}
	})
}

func BenchmarkE_nocarry_0581Inverse(b *testing.B) {
	var x e_nocarry_0581
	x.SetRandom()
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0581Butterfly(b *testing.B) {
	var x e_nocarry_0581
	x.SetRandom()
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0581)
	}
}

func BenchmarkE_nocarry_0581Exp(b *testing.B) {
	var x e_nocarry_0581
	x.SetRandom()
	benchRese_nocarry_0581.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0581Double(b *testing.B) {
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Double(&benchRese_nocarry_0581)
	}
}

func BenchmarkE_nocarry_0581Add(b *testing.B) {
	var x e_nocarry_0581
	x.SetRandom()
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Add(&x, &benchRese_nocarry_0581)
	}
}

func BenchmarkE_nocarry_0581Sub(b *testing.B) {
	var x e_nocarry_0581
	x.SetRandom()
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Sub(&x, &benchRese_nocarry_0581)
	}
}

func BenchmarkE_nocarry_0581Neg(b *testing.B) {
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Neg(&benchRese_nocarry_0581)
	}
}

func BenchmarkE_nocarry_0581Div(b *testing.B) {
	var x e_nocarry_0581
	x.SetRandom()
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Div(&x, &benchRese_nocarry_0581)
	}
}

func BenchmarkE_nocarry_0581FromMont(b *testing.B) {
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.FromMont()
	}
}

func BenchmarkE_nocarry_0581ToMont(b *testing.B) {
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.ToMont()
	}
}
func BenchmarkE_nocarry_0581Square(b *testing.B) {
	benchRese_nocarry_0581.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Square(&benchRese_nocarry_0581)
	}
}

func BenchmarkE_nocarry_0581Sqrt(b *testing.B) {
	var a e_nocarry_0581
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0581Mul(b *testing.B) {
	x := e_nocarry_0581{
	...
	benchRese_nocarry_0581.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Mul(&benchRese_nocarry_0581, &x)
	}
}

func BenchmarkE_nocarry_0581Cmp(b *testing.B) {
	x := e_nocarry_0581{
		13108921246188184088,
		7708240245998961838,
		393299655582450154,
	...
	benchRese_nocarry_0581 = x
	benchRese_nocarry_0581[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0581.Cmp(&x)
	}
}

func TestE_nocarry_0581Cmp(t *testing.T) {
	var x, y e_nocarry_0581
...
func TestE_nocarry_0581IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0581
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0581

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0581{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0581
	one.SetOne()
	e.Sub(&qe_nocarry_0581, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0581{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0581{0, uint64(i)})
	}
...
func TestE_nocarry_0581NegZero(t *testing.T) {
	var a, b e_nocarry_0581
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0581Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0581, len(staticTestValues))
...
func TestE_nocarry_0581Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0581) bool {
			var b e_nocarry_0581
...
func TestE_nocarry_0581InverseExp(t *testing.T) {
...
func TestE_nocarry_0581MulByConstants(t *testing.T) {
...
func TestE_nocarry_0581Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0581) bool {
...
func TestE_nocarry_0581LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0581Halve(t *testing.T) {
...
func TestE_nocarry_0581FromMont(t *testing.T) {
...
type testPaire_nocarry_0581 struct {
	element e_nocarry_0581
	bigint  big.Int
}

func (z *e_nocarry_0581) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0581[9] {
		return true
	}
	if z[9] < qe_nocarry_0581[9] {
		return false
	...
	return z[0] >= qe_nocarry_0581[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0581

		g.element = e_nocarry_0581{
		...
		if qe_nocarry_0581[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0581[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0581 {
			var g e_nocarry_0581
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0581[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0581[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0581[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0581[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0581[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0581[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0581[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0581[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0581[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0581[9], carry)
...
func Benchmarke_nocarry_0581InverseNew(b *testing.B) {
	var x e_nocarry_0581
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0581
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0581
		var xInv e_nocarry_0581
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0581
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0581
...
func testLinearComb(t *testing.T, x *e_nocarry_0581, xC int64, y *e_nocarry_0581, yC int64) {
	...
	var z e_nocarry_0581
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0581, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0581
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0581, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0581
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0581, xHi uint64) {
	var res e_nocarry_0581
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0581) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0581) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0581, c int64, result *e_nocarry_0581, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0581) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0581) uint64 {
