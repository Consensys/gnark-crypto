...
// modulus q
DATA q<>+0(SB)/8, $0x6237bc0f939a494b
DATA q<>+8(SB)/8, $0x50c42e1c8ee80d9e
DATA q<>+16(SB)/8, $0x7b33f91101981f18
DATA q<>+24(SB)/8, $0xd69ce47ffbe31b77
DATA q<>+32(SB)/8, $0xea9aa7e8462065fc
DATA q<>+40(SB)/8, $0x291e3d46f1e50c40
DATA q<>+48(SB)/8, $0x3576472e618291a1
DATA q<>+56(SB)/8, $0x78df60373ba33ffd
DATA q<>+64(SB)/8, $0x86b2f7eb771e61f2
DATA q<>+72(SB)/8, $0x000000000000001e
GLOBL q<>(SB), (RODATA+NOPTR), $80

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x553509a1ab20079d
