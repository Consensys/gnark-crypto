...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x6237bc0f939a494b, R13
	ADDQ R13, AX
	MOVQ $0x50c42e1c8ee80d9e, R13
	ADCQ R13, DX
	MOVQ $0x7b33f91101981f18, R13
	ADCQ R13, CX
	MOVQ $0xd69ce47ffbe31b77, R13
	ADCQ R13, BX
	MOVQ $0xea9aa7e8462065fc, R13
	ADCQ R13, SI
	MOVQ $0x291e3d46f1e50c40, R13
	ADCQ R13, DI
	MOVQ $0x3576472e618291a1, R13
	ADCQ R13, R8
	MOVQ $0x78df60373ba33ffd, R13
	ADCQ R13, R9
	MOVQ $0x86b2f7eb771e61f2, R13
	ADCQ R13, R10
	MOVQ $0x000000000000001e, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x6237bc0f939a494b, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x50c42e1c8ee80d9e, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x7b33f91101981f18, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xd69ce47ffbe31b77, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xea9aa7e8462065fc, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x291e3d46f1e50c40, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x3576472e618291a1, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x78df60373ba33ffd, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x86b2f7eb771e61f2, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000000000001e, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x6237bc0f939a494b, AX
	ADDQ AX, DX
	MOVQ $0x50c42e1c8ee80d9e, AX
	ADCQ AX, CX
	MOVQ $0x7b33f91101981f18, AX
	ADCQ AX, BX
	MOVQ $0xd69ce47ffbe31b77, AX
	ADCQ AX, SI
	MOVQ $0xea9aa7e8462065fc, AX
	ADCQ AX, DI
	MOVQ $0x291e3d46f1e50c40, AX
	ADCQ AX, R8
	MOVQ $0x3576472e618291a1, AX
	ADCQ AX, R9
	MOVQ $0x78df60373ba33ffd, AX
	ADCQ AX, R10
	MOVQ $0x86b2f7eb771e61f2, AX
	ADCQ AX, R11
	MOVQ $0x000000000000001e, AX
	ADCQ AX, R12
