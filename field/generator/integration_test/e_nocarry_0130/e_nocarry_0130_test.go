...
var benchRese_nocarry_0130 e_nocarry_0130

func BenchmarkE_nocarry_0130SetBytes(b *testing.B) {
	var x e_nocarry_0130
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0130MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0130.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0130)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0130)
		}
	})
}

func BenchmarkE_nocarry_0130Inverse(b *testing.B) {
	var x e_nocarry_0130
	x.SetRandom()
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0130Butterfly(b *testing.B) {
	var x e_nocarry_0130
	x.SetRandom()
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0130)
	}
}

func BenchmarkE_nocarry_0130Exp(b *testing.B) {
	var x e_nocarry_0130
	x.SetRandom()
	benchRese_nocarry_0130.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0130Double(b *testing.B) {
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Double(&benchRese_nocarry_0130)
	}
}

func BenchmarkE_nocarry_0130Add(b *testing.B) {
	var x e_nocarry_0130
	x.SetRandom()
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Add(&x, &benchRese_nocarry_0130)
	}
}

func BenchmarkE_nocarry_0130Sub(b *testing.B) {
	var x e_nocarry_0130
	x.SetRandom()
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Sub(&x, &benchRese_nocarry_0130)
	}
}

func BenchmarkE_nocarry_0130Neg(b *testing.B) {
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Neg(&benchRese_nocarry_0130)
	}
}

func BenchmarkE_nocarry_0130Div(b *testing.B) {
	var x e_nocarry_0130
	x.SetRandom()
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Div(&x, &benchRese_nocarry_0130)
	}
}

func BenchmarkE_nocarry_0130FromMont(b *testing.B) {
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.FromMont()
	}
}

func BenchmarkE_nocarry_0130ToMont(b *testing.B) {
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.ToMont()
	}
}
func BenchmarkE_nocarry_0130Square(b *testing.B) {
	benchRese_nocarry_0130.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Square(&benchRese_nocarry_0130)
	}
}

func BenchmarkE_nocarry_0130Sqrt(b *testing.B) {
	var a e_nocarry_0130
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0130Mul(b *testing.B) {
	x := e_nocarry_0130{
		4953017453661576010,
		663822262387536670,
		3,
	}
	benchRese_nocarry_0130.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Mul(&benchRese_nocarry_0130, &x)
	}
}

func BenchmarkE_nocarry_0130Cmp(b *testing.B) {
	x := e_nocarry_0130{
		4953017453661576010,
		663822262387536670,
		3,
	}
	benchRese_nocarry_0130 = x
	benchRese_nocarry_0130[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0130.Cmp(&x)
	}
}

func TestE_nocarry_0130Cmp(t *testing.T) {
	var x, y e_nocarry_0130
...
func TestE_nocarry_0130IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0130
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0130

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0130{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0130
	one.SetOne()
	e.Sub(&qe_nocarry_0130, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0130{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0130{0, uint64(i)})
	}
...
func TestE_nocarry_0130NegZero(t *testing.T) {
	var a, b e_nocarry_0130
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0130Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0130, len(staticTestValues))
...
func TestE_nocarry_0130Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0130) bool {
			var b e_nocarry_0130
...
func TestE_nocarry_0130InverseExp(t *testing.T) {
...
func TestE_nocarry_0130MulByConstants(t *testing.T) {
...
func TestE_nocarry_0130Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0130) bool {
...
func TestE_nocarry_0130LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0130Halve(t *testing.T) {
...
func TestE_nocarry_0130FromMont(t *testing.T) {
...
type testPaire_nocarry_0130 struct {
	element e_nocarry_0130
	bigint  big.Int
}

func (z *e_nocarry_0130) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0130[2] {
		return true
	}
	if z[2] < qe_nocarry_0130[2] {
		return false
	...
	return z[0] >= qe_nocarry_0130[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0130

		g.element = e_nocarry_0130{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0130[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0130[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0130 {
			var g e_nocarry_0130
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0130[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0130[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0130[2], carry)
...
func Benchmarke_nocarry_0130InverseNew(b *testing.B) {
	var x e_nocarry_0130
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0130
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0130
		var xInv e_nocarry_0130
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0130
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0130
...
func testLinearComb(t *testing.T, x *e_nocarry_0130, xC int64, y *e_nocarry_0130, yC int64) {
	...
	var z e_nocarry_0130
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0130, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0130
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0130, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0130
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0130, xHi uint64) {
	var res e_nocarry_0130
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0130) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0130) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0130, c int64, result *e_nocarry_0130, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0130) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0130) uint64 {
