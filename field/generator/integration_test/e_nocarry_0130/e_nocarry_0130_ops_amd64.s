...
// modulus q
DATA q<>+0(SB)/8, $0xda60afedc2039a2f
DATA q<>+8(SB)/8, $0x3fa6d591770d5fc5
DATA q<>+16(SB)/8, $0x0000000000000003
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0864326743821331
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xda60afedc2039a2f, DI
	MOVQ    $0x3fa6d591770d5fc5, R8
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xda60afedc2039a2f, R10
	MOVQ    $0x3fa6d591770d5fc5, R11
