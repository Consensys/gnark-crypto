...
// modulus q
DATA q<>+0(SB)/8, $0x7df7f25275fd289b
DATA q<>+8(SB)/8, $0xfa57c19234ef95b5
DATA q<>+16(SB)/8, $0x6ee9818b38480d48
DATA q<>+24(SB)/8, $0x599de63622ad5877
DATA q<>+32(SB)/8, $0xb2e08cc194c8b93e
DATA q<>+40(SB)/8, $0xc01e160b2d22dc7f
DATA q<>+48(SB)/8, $0xbaf26ae21b385b3d
DATA q<>+56(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $64

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x172d056cedb5826d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 56(R10), R9
	JCC  l1
	MOVQ $0x7df7f25275fd289b, R11
	ADDQ R11, AX
	MOVQ $0xfa57c19234ef95b5, R11
	ADCQ R11, DX
	MOVQ $0x6ee9818b38480d48, R11
	ADCQ R11, CX
	MOVQ $0x599de63622ad5877, R11
	ADCQ R11, BX
	MOVQ $0xb2e08cc194c8b93e, R11
	ADCQ R11, SI
	MOVQ $0xc01e160b2d22dc7f, R11
	ADCQ R11, DI
	MOVQ $0xbaf26ae21b385b3d, R11
	ADCQ R11, R8
	MOVQ $1, R11
	ADCQ R11, R9
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x7df7f25275fd289b, R12
	SUBQ  DX, R12
	MOVQ  R12, 0(R11)
	MOVQ  $0xfa57c19234ef95b5, R12
	SBBQ  CX, R12
	MOVQ  R12, 8(R11)
	MOVQ  $0x6ee9818b38480d48, R12
	SBBQ  BX, R12
	MOVQ  R12, 16(R11)
	MOVQ  $0x599de63622ad5877, R12
	SBBQ  SI, R12
	MOVQ  R12, 24(R11)
	MOVQ  $0xb2e08cc194c8b93e, R12
	SBBQ  DI, R12
	MOVQ  R12, 32(R11)
	MOVQ  $0xc01e160b2d22dc7f, R12
	SBBQ  R8, R12
	MOVQ  R12, 40(R11)
	MOVQ  $0xbaf26ae21b385b3d, R12
	SBBQ  R9, R12
	MOVQ  R12, 48(R11)
	MOVQ  $1, R12
	SBBQ  R10, R12
...
TEXT ·Butterfly(SB), $24-16
	...
	SBBQ 56(AX), R10
	JCC  l3
	MOVQ $0x7df7f25275fd289b, AX
	ADDQ AX, DX
	MOVQ $0xfa57c19234ef95b5, AX
	ADCQ AX, CX
	MOVQ $0x6ee9818b38480d48, AX
	ADCQ AX, BX
	MOVQ $0x599de63622ad5877, AX
	ADCQ AX, SI
	MOVQ $0xb2e08cc194c8b93e, AX
	ADCQ AX, DI
	MOVQ $0xc01e160b2d22dc7f, AX
	ADCQ AX, R8
	MOVQ $0xbaf26ae21b385b3d, AX
	ADCQ AX, R9
	MOVQ $1, AX
	ADCQ AX, R10
