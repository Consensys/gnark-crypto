...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0449{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0449{0, uint64(i)})
	}
...
func (z *e_nocarry_0449) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0449[7] {
		return true
	}
	if z[7] < qe_nocarry_0449[7] {
		return false
...
func Benchmarke_nocarry_0449InverseNew(b *testing.B) {
	var x e_nocarry_0449
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0449, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0449, xHi uint64) {
