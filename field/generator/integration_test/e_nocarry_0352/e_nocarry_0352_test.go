...
var benchRese_nocarry_0352 e_nocarry_0352

func BenchmarkE_nocarry_0352SetBytes(b *testing.B) {
	var x e_nocarry_0352
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0352MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0352.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0352)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0352)
		}
	})
}

func BenchmarkE_nocarry_0352Inverse(b *testing.B) {
	var x e_nocarry_0352
	x.SetRandom()
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0352Butterfly(b *testing.B) {
	var x e_nocarry_0352
	x.SetRandom()
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0352)
	}
}

func BenchmarkE_nocarry_0352Exp(b *testing.B) {
	var x e_nocarry_0352
	x.SetRandom()
	benchRese_nocarry_0352.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0352Double(b *testing.B) {
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Double(&benchRese_nocarry_0352)
	}
}

func BenchmarkE_nocarry_0352Add(b *testing.B) {
	var x e_nocarry_0352
	x.SetRandom()
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Add(&x, &benchRese_nocarry_0352)
	}
}

func BenchmarkE_nocarry_0352Sub(b *testing.B) {
	var x e_nocarry_0352
	x.SetRandom()
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Sub(&x, &benchRese_nocarry_0352)
	}
}

func BenchmarkE_nocarry_0352Neg(b *testing.B) {
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Neg(&benchRese_nocarry_0352)
	}
}

func BenchmarkE_nocarry_0352Div(b *testing.B) {
	var x e_nocarry_0352
	x.SetRandom()
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Div(&x, &benchRese_nocarry_0352)
	}
}

func BenchmarkE_nocarry_0352FromMont(b *testing.B) {
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.FromMont()
	}
}

func BenchmarkE_nocarry_0352ToMont(b *testing.B) {
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.ToMont()
	}
}
func BenchmarkE_nocarry_0352Square(b *testing.B) {
	benchRese_nocarry_0352.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Square(&benchRese_nocarry_0352)
	}
}

func BenchmarkE_nocarry_0352Sqrt(b *testing.B) {
	var a e_nocarry_0352
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0352Mul(b *testing.B) {
	x := e_nocarry_0352{
	...
	benchRese_nocarry_0352.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Mul(&benchRese_nocarry_0352, &x)
	}
}

func BenchmarkE_nocarry_0352Cmp(b *testing.B) {
	x := e_nocarry_0352{
		16580603744604351528,
		3099103550751824911,
		7954079832241695965,
	...
	benchRese_nocarry_0352 = x
	benchRese_nocarry_0352[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0352.Cmp(&x)
	}
}

func TestE_nocarry_0352Cmp(t *testing.T) {
	var x, y e_nocarry_0352
...
func TestE_nocarry_0352IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0352
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0352

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0352{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0352
	one.SetOne()
	e.Sub(&qe_nocarry_0352, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0352{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0352{0, uint64(i)})
	}
...
func TestE_nocarry_0352NegZero(t *testing.T) {
	var a, b e_nocarry_0352
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0352Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0352, len(staticTestValues))
...
func TestE_nocarry_0352Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0352) bool {
			var b e_nocarry_0352
...
func TestE_nocarry_0352InverseExp(t *testing.T) {
...
func TestE_nocarry_0352MulByConstants(t *testing.T) {
...
func TestE_nocarry_0352Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0352) bool {
...
func TestE_nocarry_0352LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0352Halve(t *testing.T) {
...
func TestE_nocarry_0352FromMont(t *testing.T) {
...
type testPaire_nocarry_0352 struct {
	element e_nocarry_0352
	bigint  big.Int
}

func (z *e_nocarry_0352) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0352[5] {
		return true
	}
	if z[5] < qe_nocarry_0352[5] {
		return false
	...
	return z[0] >= qe_nocarry_0352[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0352

		g.element = e_nocarry_0352{
		...
		if qe_nocarry_0352[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0352[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0352 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0352[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0352[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0352[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0352[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0352[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0352[5], carry)
...
func Benchmarke_nocarry_0352InverseNew(b *testing.B) {
	var x e_nocarry_0352
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0352
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0352
		var xInv e_nocarry_0352
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0352
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0352
...
func testLinearComb(t *testing.T, x *e_nocarry_0352, xC int64, y *e_nocarry_0352, yC int64) {
	...
	var z e_nocarry_0352
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0352, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0352
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0352, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0352
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0352, xHi uint64) {
	var res e_nocarry_0352
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0352) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0352) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0352, c int64, result *e_nocarry_0352, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0352) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0352) uint64 {
