...
// modulus q
DATA q<>+0(SB)/8, $0x2988fd5f3544e819
DATA q<>+8(SB)/8, $0xc934f99f658a46eb
DATA q<>+16(SB)/8, $0x1892721d606ad379
DATA q<>+24(SB)/8, $0x0d753d3ef651cee2
DATA q<>+32(SB)/8, $0x07fb4fc4c34d94f8
DATA q<>+40(SB)/8, $0x00000000e2842492
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x25ce2fee7b680bd7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x2988fd5f3544e819, R10
	MOVQ    $0xc934f99f658a46eb, R11
	MOVQ    $0x1892721d606ad379, R12
	MOVQ    $0x0d753d3ef651cee2, R13
	MOVQ    $0x07fb4fc4c34d94f8, R14
	MOVQ    $0x00000000e2842492, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xc934f99f658a46eb, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x1892721d606ad379, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x0d753d3ef651cee2, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x07fb4fc4c34d94f8, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000000e2842492, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x2988fd5f3544e819, CX
	MOVQ    $0xc934f99f658a46eb, BX
	MOVQ    $0x1892721d606ad379, SI
	MOVQ    $0x0d753d3ef651cee2, DI
	MOVQ    $0x07fb4fc4c34d94f8, R8
	MOVQ    $0x00000000e2842492, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
