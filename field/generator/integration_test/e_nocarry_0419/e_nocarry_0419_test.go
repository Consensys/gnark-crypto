...
var benchRese_nocarry_0419 e_nocarry_0419

func BenchmarkE_nocarry_0419SetBytes(b *testing.B) {
	var x e_nocarry_0419
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0419MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0419.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0419)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0419)
		}
	})
}

func BenchmarkE_nocarry_0419Inverse(b *testing.B) {
	var x e_nocarry_0419
	x.SetRandom()
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0419Butterfly(b *testing.B) {
	var x e_nocarry_0419
	x.SetRandom()
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0419)
	}
}

func BenchmarkE_nocarry_0419Exp(b *testing.B) {
	var x e_nocarry_0419
	x.SetRandom()
	benchRese_nocarry_0419.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0419Double(b *testing.B) {
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Double(&benchRese_nocarry_0419)
	}
}

func BenchmarkE_nocarry_0419Add(b *testing.B) {
	var x e_nocarry_0419
	x.SetRandom()
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Add(&x, &benchRese_nocarry_0419)
	}
}

func BenchmarkE_nocarry_0419Sub(b *testing.B) {
	var x e_nocarry_0419
	x.SetRandom()
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Sub(&x, &benchRese_nocarry_0419)
	}
}

func BenchmarkE_nocarry_0419Neg(b *testing.B) {
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Neg(&benchRese_nocarry_0419)
	}
}

func BenchmarkE_nocarry_0419Div(b *testing.B) {
	var x e_nocarry_0419
	x.SetRandom()
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Div(&x, &benchRese_nocarry_0419)
	}
}

func BenchmarkE_nocarry_0419FromMont(b *testing.B) {
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.FromMont()
	}
}

func BenchmarkE_nocarry_0419ToMont(b *testing.B) {
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.ToMont()
	}
}
func BenchmarkE_nocarry_0419Square(b *testing.B) {
	benchRese_nocarry_0419.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Square(&benchRese_nocarry_0419)
	}
}

func BenchmarkE_nocarry_0419Sqrt(b *testing.B) {
	var a e_nocarry_0419
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0419Mul(b *testing.B) {
	x := e_nocarry_0419{
	...
	benchRese_nocarry_0419.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Mul(&benchRese_nocarry_0419, &x)
	}
}

func BenchmarkE_nocarry_0419Cmp(b *testing.B) {
	x := e_nocarry_0419{
		12624679637656289677,
		6552024977928800861,
		10677805267560122567,
	...
	benchRese_nocarry_0419 = x
	benchRese_nocarry_0419[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0419.Cmp(&x)
	}
}

func TestE_nocarry_0419Cmp(t *testing.T) {
	var x, y e_nocarry_0419
...
func TestE_nocarry_0419IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0419
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0419

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0419{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0419
	one.SetOne()
	e.Sub(&qe_nocarry_0419, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0419{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0419{0, uint64(i)})
	}
...
func TestE_nocarry_0419NegZero(t *testing.T) {
	var a, b e_nocarry_0419
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0419Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0419, len(staticTestValues))
...
func TestE_nocarry_0419Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0419) bool {
			var b e_nocarry_0419
...
func TestE_nocarry_0419InverseExp(t *testing.T) {
...
func TestE_nocarry_0419MulByConstants(t *testing.T) {
...
func TestE_nocarry_0419Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0419) bool {
...
func TestE_nocarry_0419LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0419Halve(t *testing.T) {
...
func TestE_nocarry_0419FromMont(t *testing.T) {
...
type testPaire_nocarry_0419 struct {
	element e_nocarry_0419
	bigint  big.Int
}

func (z *e_nocarry_0419) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0419[6] {
		return true
	}
	if z[6] < qe_nocarry_0419[6] {
		return false
	...
	return z[0] >= qe_nocarry_0419[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0419

		g.element = e_nocarry_0419{
		...
		if qe_nocarry_0419[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0419[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0419 {
			var g e_nocarry_0419
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0419[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0419[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0419[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0419[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0419[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0419[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0419[6], carry)
...
func Benchmarke_nocarry_0419InverseNew(b *testing.B) {
	var x e_nocarry_0419
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0419
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0419
		var xInv e_nocarry_0419
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0419
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0419
...
func testLinearComb(t *testing.T, x *e_nocarry_0419, xC int64, y *e_nocarry_0419, yC int64) {
	...
	var z e_nocarry_0419
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0419, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0419
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0419, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0419
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0419, xHi uint64) {
	var res e_nocarry_0419
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0419) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0419) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0419, c int64, result *e_nocarry_0419, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0419) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0419) uint64 {
