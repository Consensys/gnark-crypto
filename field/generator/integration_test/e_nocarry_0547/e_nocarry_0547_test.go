...
var benchRese_nocarry_0547 e_nocarry_0547

func BenchmarkE_nocarry_0547SetBytes(b *testing.B) {
	var x e_nocarry_0547
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0547MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0547.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0547)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0547)
		}
	})
}

func BenchmarkE_nocarry_0547Inverse(b *testing.B) {
	var x e_nocarry_0547
	x.SetRandom()
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0547Butterfly(b *testing.B) {
	var x e_nocarry_0547
	x.SetRandom()
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0547)
	}
}

func BenchmarkE_nocarry_0547Exp(b *testing.B) {
	var x e_nocarry_0547
	x.SetRandom()
	benchRese_nocarry_0547.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0547Double(b *testing.B) {
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Double(&benchRese_nocarry_0547)
	}
}

func BenchmarkE_nocarry_0547Add(b *testing.B) {
	var x e_nocarry_0547
	x.SetRandom()
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Add(&x, &benchRese_nocarry_0547)
	}
}

func BenchmarkE_nocarry_0547Sub(b *testing.B) {
	var x e_nocarry_0547
	x.SetRandom()
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Sub(&x, &benchRese_nocarry_0547)
	}
}

func BenchmarkE_nocarry_0547Neg(b *testing.B) {
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Neg(&benchRese_nocarry_0547)
	}
}

func BenchmarkE_nocarry_0547Div(b *testing.B) {
	var x e_nocarry_0547
	x.SetRandom()
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Div(&x, &benchRese_nocarry_0547)
	}
}

func BenchmarkE_nocarry_0547FromMont(b *testing.B) {
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.FromMont()
	}
}

func BenchmarkE_nocarry_0547ToMont(b *testing.B) {
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.ToMont()
	}
}
func BenchmarkE_nocarry_0547Square(b *testing.B) {
	benchRese_nocarry_0547.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Square(&benchRese_nocarry_0547)
	}
}

func BenchmarkE_nocarry_0547Sqrt(b *testing.B) {
	var a e_nocarry_0547
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0547Mul(b *testing.B) {
	x := e_nocarry_0547{
		1469167447047064902,
		2011483338351117386,
		4975977525845502940,
	...
	benchRese_nocarry_0547.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Mul(&benchRese_nocarry_0547, &x)
	}
}

func BenchmarkE_nocarry_0547Cmp(b *testing.B) {
	x := e_nocarry_0547{
		1469167447047064902,
		2011483338351117386,
		4975977525845502940,
	...
	benchRese_nocarry_0547 = x
	benchRese_nocarry_0547[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0547.Cmp(&x)
	}
}

func TestE_nocarry_0547Cmp(t *testing.T) {
	var x, y e_nocarry_0547
...
func TestE_nocarry_0547IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0547
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0547

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0547{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0547
	one.SetOne()
	e.Sub(&qe_nocarry_0547, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0547{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0547{0, uint64(i)})
	}
...
func TestE_nocarry_0547NegZero(t *testing.T) {
	var a, b e_nocarry_0547
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0547Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0547, len(staticTestValues))
...
func TestE_nocarry_0547Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0547) bool {
			var b e_nocarry_0547
...
func TestE_nocarry_0547InverseExp(t *testing.T) {
...
func TestE_nocarry_0547MulByConstants(t *testing.T) {
...
func TestE_nocarry_0547Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0547) bool {
...
func TestE_nocarry_0547LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0547Halve(t *testing.T) {
...
func TestE_nocarry_0547FromMont(t *testing.T) {
...
type testPaire_nocarry_0547 struct {
	element e_nocarry_0547
	bigint  big.Int
}

func (z *e_nocarry_0547) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0547[8] {
		return true
	}
	if z[8] < qe_nocarry_0547[8] {
		return false
	...
	return z[0] >= qe_nocarry_0547[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0547

		g.element = e_nocarry_0547{
		...
		if qe_nocarry_0547[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0547[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0547 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0547[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0547[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0547[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0547[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0547[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0547[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0547[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0547[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0547[8], carry)
...
func Benchmarke_nocarry_0547InverseNew(b *testing.B) {
	var x e_nocarry_0547
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0547
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0547
		var xInv e_nocarry_0547
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0547
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0547
...
func testLinearComb(t *testing.T, x *e_nocarry_0547, xC int64, y *e_nocarry_0547, yC int64) {
	...
	var z e_nocarry_0547
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0547, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0547
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0547, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0547
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0547, xHi uint64) {
	var res e_nocarry_0547
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0547) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0547) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0547, c int64, result *e_nocarry_0547, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0547) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0547) uint64 {
