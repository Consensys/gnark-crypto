...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x3482e7f74cc84909, R12
	ADDQ R12, AX
	MOVQ $0x2843ac3223321c8b, R12
	ADCQ R12, DX
	MOVQ $0x1de3ce57ddf2f252, R12
	ADCQ R12, CX
	MOVQ $0xf8da2a0932134ba9, R12
	ADCQ R12, BX
	MOVQ $0xe81e62e86a1c83c9, R12
	ADCQ R12, SI
	MOVQ $0x8701af4c29d81991, R12
	ADCQ R12, DI
	MOVQ $0x579356c410261319, R12
	ADCQ R12, R8
	MOVQ $0x0263dcb54b5eb0f3, R12
	ADCQ R12, R9
	MOVQ $0x000000074b520a38, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x3482e7f74cc84909, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x2843ac3223321c8b, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x1de3ce57ddf2f252, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xf8da2a0932134ba9, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xe81e62e86a1c83c9, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x8701af4c29d81991, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x579356c410261319, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x0263dcb54b5eb0f3, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000074b520a38, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x3482e7f74cc84909, AX
	ADDQ AX, DX
	MOVQ $0x2843ac3223321c8b, AX
	ADCQ AX, CX
	MOVQ $0x1de3ce57ddf2f252, AX
	ADCQ AX, BX
	MOVQ $0xf8da2a0932134ba9, AX
	ADCQ AX, SI
	MOVQ $0xe81e62e86a1c83c9, AX
	ADCQ AX, DI
	MOVQ $0x8701af4c29d81991, AX
	ADCQ AX, R8
	MOVQ $0x579356c410261319, AX
	ADCQ AX, R9
	MOVQ $0x0263dcb54b5eb0f3, AX
	ADCQ AX, R10
	MOVQ $0x000000074b520a38, AX
	ADCQ AX, R11
