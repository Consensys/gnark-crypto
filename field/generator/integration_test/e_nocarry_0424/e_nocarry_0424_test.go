...
var benchRese_nocarry_0424 e_nocarry_0424

func BenchmarkE_nocarry_0424SetBytes(b *testing.B) {
	var x e_nocarry_0424
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0424MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0424.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0424)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0424)
		}
	})
}

func BenchmarkE_nocarry_0424Inverse(b *testing.B) {
	var x e_nocarry_0424
	x.SetRandom()
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0424Butterfly(b *testing.B) {
	var x e_nocarry_0424
	x.SetRandom()
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0424)
	}
}

func BenchmarkE_nocarry_0424Exp(b *testing.B) {
	var x e_nocarry_0424
	x.SetRandom()
	benchRese_nocarry_0424.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0424Double(b *testing.B) {
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Double(&benchRese_nocarry_0424)
	}
}

func BenchmarkE_nocarry_0424Add(b *testing.B) {
	var x e_nocarry_0424
	x.SetRandom()
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Add(&x, &benchRese_nocarry_0424)
	}
}

func BenchmarkE_nocarry_0424Sub(b *testing.B) {
	var x e_nocarry_0424
	x.SetRandom()
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Sub(&x, &benchRese_nocarry_0424)
	}
}

func BenchmarkE_nocarry_0424Neg(b *testing.B) {
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Neg(&benchRese_nocarry_0424)
	}
}

func BenchmarkE_nocarry_0424Div(b *testing.B) {
	var x e_nocarry_0424
	x.SetRandom()
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Div(&x, &benchRese_nocarry_0424)
	}
}

func BenchmarkE_nocarry_0424FromMont(b *testing.B) {
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.FromMont()
	}
}

func BenchmarkE_nocarry_0424ToMont(b *testing.B) {
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.ToMont()
	}
}
func BenchmarkE_nocarry_0424Square(b *testing.B) {
	benchRese_nocarry_0424.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Square(&benchRese_nocarry_0424)
	}
}

func BenchmarkE_nocarry_0424Sqrt(b *testing.B) {
	var a e_nocarry_0424
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0424Mul(b *testing.B) {
	x := e_nocarry_0424{
	...
	benchRese_nocarry_0424.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Mul(&benchRese_nocarry_0424, &x)
	}
}

func BenchmarkE_nocarry_0424Cmp(b *testing.B) {
	x := e_nocarry_0424{
		14750272190734844236,
		4011461019989475019,
		17822402726891605112,
	...
	benchRese_nocarry_0424 = x
	benchRese_nocarry_0424[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0424.Cmp(&x)
	}
}

func TestE_nocarry_0424Cmp(t *testing.T) {
	var x, y e_nocarry_0424
...
func TestE_nocarry_0424IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0424
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0424

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0424{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0424
	one.SetOne()
	e.Sub(&qe_nocarry_0424, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0424{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0424{0, uint64(i)})
	}
...
func TestE_nocarry_0424NegZero(t *testing.T) {
	var a, b e_nocarry_0424
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0424Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0424, len(staticTestValues))
...
func TestE_nocarry_0424Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0424) bool {
			var b e_nocarry_0424
...
func TestE_nocarry_0424InverseExp(t *testing.T) {
...
func TestE_nocarry_0424MulByConstants(t *testing.T) {
...
func TestE_nocarry_0424Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0424) bool {
...
func TestE_nocarry_0424LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0424Halve(t *testing.T) {
...
func TestE_nocarry_0424FromMont(t *testing.T) {
...
type testPaire_nocarry_0424 struct {
	element e_nocarry_0424
	bigint  big.Int
}

func (z *e_nocarry_0424) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0424[6] {
		return true
	}
	if z[6] < qe_nocarry_0424[6] {
		return false
	...
	return z[0] >= qe_nocarry_0424[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0424

		g.element = e_nocarry_0424{
		...
		if qe_nocarry_0424[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0424[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0424 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0424[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0424[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0424[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0424[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0424[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0424[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0424[6], carry)
...
func Benchmarke_nocarry_0424InverseNew(b *testing.B) {
	var x e_nocarry_0424
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0424
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0424
		var xInv e_nocarry_0424
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0424
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0424
...
func testLinearComb(t *testing.T, x *e_nocarry_0424, xC int64, y *e_nocarry_0424, yC int64) {
	...
	var z e_nocarry_0424
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0424, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0424
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0424, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0424
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0424, xHi uint64) {
	var res e_nocarry_0424
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0424) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0424) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0424, c int64, result *e_nocarry_0424, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0424) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0424) uint64 {
