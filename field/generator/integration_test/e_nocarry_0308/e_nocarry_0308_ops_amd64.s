...
// modulus q
DATA q<>+0(SB)/8, $0x04a02264efff97f5
DATA q<>+8(SB)/8, $0x575079ba7381da02
DATA q<>+16(SB)/8, $0x1ed22121aade2704
DATA q<>+24(SB)/8, $0x7cd5d17678e17d5a
DATA q<>+32(SB)/8, $0x000c390252659ef8
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xffb26a9c7bf4e3a3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x04a02264efff97f5, R9
	MOVQ    $0x575079ba7381da02, R10
	MOVQ    $0x1ed22121aade2704, R11
	MOVQ    $0x7cd5d17678e17d5a, R12
	MOVQ    $0x000c390252659ef8, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x575079ba7381da02, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x1ed22121aade2704, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x7cd5d17678e17d5a, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000c390252659ef8, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x04a02264efff97f5, CX
	MOVQ    $0x575079ba7381da02, BX
	MOVQ    $0x1ed22121aade2704, SI
	MOVQ    $0x7cd5d17678e17d5a, DI
	MOVQ    $0x000c390252659ef8, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
