...
var benchRese_nocarry_0308 e_nocarry_0308

func BenchmarkE_nocarry_0308SetBytes(b *testing.B) {
	var x e_nocarry_0308
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0308MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0308.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0308)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0308)
		}
	})
}

func BenchmarkE_nocarry_0308Inverse(b *testing.B) {
	var x e_nocarry_0308
	x.SetRandom()
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0308Butterfly(b *testing.B) {
	var x e_nocarry_0308
	x.SetRandom()
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0308)
	}
}

func BenchmarkE_nocarry_0308Exp(b *testing.B) {
	var x e_nocarry_0308
	x.SetRandom()
	benchRese_nocarry_0308.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0308Double(b *testing.B) {
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Double(&benchRese_nocarry_0308)
	}
}

func BenchmarkE_nocarry_0308Add(b *testing.B) {
	var x e_nocarry_0308
	x.SetRandom()
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Add(&x, &benchRese_nocarry_0308)
	}
}

func BenchmarkE_nocarry_0308Sub(b *testing.B) {
	var x e_nocarry_0308
	x.SetRandom()
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Sub(&x, &benchRese_nocarry_0308)
	}
}

func BenchmarkE_nocarry_0308Neg(b *testing.B) {
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Neg(&benchRese_nocarry_0308)
	}
}

func BenchmarkE_nocarry_0308Div(b *testing.B) {
	var x e_nocarry_0308
	x.SetRandom()
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Div(&x, &benchRese_nocarry_0308)
	}
}

func BenchmarkE_nocarry_0308FromMont(b *testing.B) {
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.FromMont()
	}
}

func BenchmarkE_nocarry_0308ToMont(b *testing.B) {
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.ToMont()
	}
}
func BenchmarkE_nocarry_0308Square(b *testing.B) {
	benchRese_nocarry_0308.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Square(&benchRese_nocarry_0308)
	}
}

func BenchmarkE_nocarry_0308Sqrt(b *testing.B) {
	var a e_nocarry_0308
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0308Mul(b *testing.B) {
	x := e_nocarry_0308{
		6709575481354980925,
		1714091223010135930,
		8285377968402055894,
	...
	benchRese_nocarry_0308.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Mul(&benchRese_nocarry_0308, &x)
	}
}

func BenchmarkE_nocarry_0308Cmp(b *testing.B) {
	x := e_nocarry_0308{
		6709575481354980925,
		1714091223010135930,
		8285377968402055894,
	...
	benchRese_nocarry_0308 = x
	benchRese_nocarry_0308[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0308.Cmp(&x)
	}
}

func TestE_nocarry_0308Cmp(t *testing.T) {
	var x, y e_nocarry_0308
...
func TestE_nocarry_0308IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0308
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0308

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0308{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0308
	one.SetOne()
	e.Sub(&qe_nocarry_0308, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0308{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0308{0, uint64(i)})
	}
...
func TestE_nocarry_0308NegZero(t *testing.T) {
	var a, b e_nocarry_0308
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0308Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0308, len(staticTestValues))
...
func TestE_nocarry_0308Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0308) bool {
			var b e_nocarry_0308
...
func TestE_nocarry_0308InverseExp(t *testing.T) {
...
func TestE_nocarry_0308MulByConstants(t *testing.T) {
...
func TestE_nocarry_0308Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0308) bool {
...
func TestE_nocarry_0308LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0308Halve(t *testing.T) {
...
func TestE_nocarry_0308FromMont(t *testing.T) {
...
type testPaire_nocarry_0308 struct {
	element e_nocarry_0308
	bigint  big.Int
}

func (z *e_nocarry_0308) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0308[4] {
		return true
	}
	if z[4] < qe_nocarry_0308[4] {
		return false
	...
	return z[0] >= qe_nocarry_0308[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0308

		g.element = e_nocarry_0308{
		...
		if qe_nocarry_0308[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0308[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0308 {
			var g e_nocarry_0308
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0308[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0308[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0308[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0308[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0308[4], carry)
...
func Benchmarke_nocarry_0308InverseNew(b *testing.B) {
	var x e_nocarry_0308
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0308
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0308
		var xInv e_nocarry_0308
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0308
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0308
...
func testLinearComb(t *testing.T, x *e_nocarry_0308, xC int64, y *e_nocarry_0308, yC int64) {
	...
	var z e_nocarry_0308
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0308, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0308
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0308, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0308
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0308, xHi uint64) {
	var res e_nocarry_0308
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0308) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0308) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0308, c int64, result *e_nocarry_0308, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0308) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0308) uint64 {
