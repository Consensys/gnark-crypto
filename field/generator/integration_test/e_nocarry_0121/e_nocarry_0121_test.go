...
var benchRese_nocarry_0121 e_nocarry_0121

func BenchmarkE_nocarry_0121SetBytes(b *testing.B) {
	var x e_nocarry_0121
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0121MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0121.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0121)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0121)
		}
	})
}

func BenchmarkE_nocarry_0121Inverse(b *testing.B) {
	var x e_nocarry_0121
	x.SetRandom()
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0121Butterfly(b *testing.B) {
	var x e_nocarry_0121
	x.SetRandom()
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0121)
	}
}

func BenchmarkE_nocarry_0121Exp(b *testing.B) {
	var x e_nocarry_0121
	x.SetRandom()
	benchRese_nocarry_0121.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0121Double(b *testing.B) {
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Double(&benchRese_nocarry_0121)
	}
}

func BenchmarkE_nocarry_0121Add(b *testing.B) {
	var x e_nocarry_0121
	x.SetRandom()
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Add(&x, &benchRese_nocarry_0121)
	}
}

func BenchmarkE_nocarry_0121Sub(b *testing.B) {
	var x e_nocarry_0121
	x.SetRandom()
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Sub(&x, &benchRese_nocarry_0121)
	}
}

func BenchmarkE_nocarry_0121Neg(b *testing.B) {
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Neg(&benchRese_nocarry_0121)
	}
}

func BenchmarkE_nocarry_0121Div(b *testing.B) {
	var x e_nocarry_0121
	x.SetRandom()
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Div(&x, &benchRese_nocarry_0121)
	}
}

func BenchmarkE_nocarry_0121FromMont(b *testing.B) {
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.FromMont()
	}
}

func BenchmarkE_nocarry_0121ToMont(b *testing.B) {
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.ToMont()
	}
}
func BenchmarkE_nocarry_0121Square(b *testing.B) {
	benchRese_nocarry_0121.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Square(&benchRese_nocarry_0121)
	}
}

func BenchmarkE_nocarry_0121Sqrt(b *testing.B) {
	var a e_nocarry_0121
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0121Mul(b *testing.B) {
	x := e_nocarry_0121{
		12268980151032936129,
		132825813092019203,
	}
	benchRese_nocarry_0121.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Mul(&benchRese_nocarry_0121, &x)
	}
}

func BenchmarkE_nocarry_0121Cmp(b *testing.B) {
	x := e_nocarry_0121{
		12268980151032936129,
		132825813092019203,
	}
	benchRese_nocarry_0121 = x
	benchRese_nocarry_0121[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0121.Cmp(&x)
	}
}

func TestE_nocarry_0121Cmp(t *testing.T) {
	var x, y e_nocarry_0121
...
func TestE_nocarry_0121IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0121
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0121

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0121{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0121
	one.SetOne()
	e.Sub(&qe_nocarry_0121, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0121{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0121{0, uint64(i)})
	}
...
func TestE_nocarry_0121NegZero(t *testing.T) {
	var a, b e_nocarry_0121
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0121Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0121, len(staticTestValues))
...
func TestE_nocarry_0121Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0121) bool {
			var b e_nocarry_0121
...
func TestE_nocarry_0121InverseExp(t *testing.T) {
...
func TestE_nocarry_0121MulByConstants(t *testing.T) {
...
func TestE_nocarry_0121Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0121) bool {
...
func TestE_nocarry_0121LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0121Halve(t *testing.T) {
...
func TestE_nocarry_0121FromMont(t *testing.T) {
...
type testPaire_nocarry_0121 struct {
	element e_nocarry_0121
	bigint  big.Int
}

func (z *e_nocarry_0121) biggerOrEqualModulus() bool {
	if z[1] > qe_nocarry_0121[1] {
		return true
	}
	if z[1] < qe_nocarry_0121[1] {
		return false
	...
	return z[0] >= qe_nocarry_0121[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0121

		g.element = e_nocarry_0121{
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0121[1] != ^uint64(0) {
			g.element[1] %= (qe_nocarry_0121[1] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0121 {
			var g e_nocarry_0121
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0121[0], carry)
		a[1], _ = bits.Add64(a[1], qe_nocarry_0121[1], carry)
...
func Benchmarke_nocarry_0121InverseNew(b *testing.B) {
	var x e_nocarry_0121
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0121
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0121
		var xInv e_nocarry_0121
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0121
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0121
...
func testLinearComb(t *testing.T, x *e_nocarry_0121, xC int64, y *e_nocarry_0121, yC int64) {
	...
	var z e_nocarry_0121
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0121, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0121
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0121, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0121
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0121, xHi uint64) {
	var res e_nocarry_0121
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0121) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0121) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0121, c int64, result *e_nocarry_0121, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0121) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0121) uint64 {
