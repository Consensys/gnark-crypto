...
// modulus q
DATA q<>+0(SB)/8, $0x3823ac559c1b5bbd
DATA q<>+8(SB)/8, $0x01ddefdf9726edca
GLOBL q<>(SB), (RODATA+NOPTR), $16

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x227c3d419849c86b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SUBQ    0(CX), AX
	SBBQ    8(CX), DX
	MOVQ    $0x3823ac559c1b5bbd, SI
	MOVQ    $0x01ddefdf9726edca, DI
	CMOVQCC BX, SI
	CMOVQCC BX, DI
	ADDQ    SI, AX
	ADCQ    DI, DX
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SUBQ    0(DX), SI
	SBBQ    8(DX), DI
	MOVQ    $0x3823ac559c1b5bbd, R8
	MOVQ    $0x01ddefdf9726edca, R9
	CMOVQCC AX, R8
	CMOVQCC AX, R9
	ADDQ    R8, SI
	ADCQ    R9, DI
