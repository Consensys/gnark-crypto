...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x357d60c5a960a6af, R14
	ADDQ R14, AX
	MOVQ $0x9fa1a99a4125827c, R14
	ADCQ R14, DX
	MOVQ $0x6b70b7f344b46b5c, R14
	ADCQ R14, CX
	MOVQ $0x2f341c3531b70d5a, R14
	ADCQ R14, BX
	MOVQ $0x89d7a8679eaecf4b, R14
	ADCQ R14, SI
	MOVQ $0x861bd75c5e70e423, R14
	ADCQ R14, DI
	MOVQ $0x3ae647db92982b94, R14
	ADCQ R14, R8
	MOVQ $0xfea9c9963a4661f5, R14
	ADCQ R14, R9
	MOVQ $0x4bbf3b7e507df685, R14
	ADCQ R14, R10
	MOVQ $0x94a26a2eed699c1f, R14
	ADCQ R14, R11
	MOVQ $0x00000000000036ce, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x357d60c5a960a6af, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x9fa1a99a4125827c, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x6b70b7f344b46b5c, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x2f341c3531b70d5a, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x89d7a8679eaecf4b, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x861bd75c5e70e423, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x3ae647db92982b94, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xfea9c9963a4661f5, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x4bbf3b7e507df685, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x94a26a2eed699c1f, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000000036ce, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x357d60c5a960a6af, AX
	ADDQ AX, DX
	MOVQ $0x9fa1a99a4125827c, AX
	ADCQ AX, CX
	MOVQ $0x6b70b7f344b46b5c, AX
	ADCQ AX, BX
	MOVQ $0x2f341c3531b70d5a, AX
	ADCQ AX, SI
	MOVQ $0x89d7a8679eaecf4b, AX
	ADCQ AX, DI
	MOVQ $0x861bd75c5e70e423, AX
	ADCQ AX, R8
	MOVQ $0x3ae647db92982b94, AX
	ADCQ AX, R9
	MOVQ $0xfea9c9963a4661f5, AX
	ADCQ AX, R10
	MOVQ $0x4bbf3b7e507df685, AX
	ADCQ AX, R11
	MOVQ $0x94a26a2eed699c1f, AX
	ADCQ AX, R12
	MOVQ $0x00000000000036ce, AX
	ADCQ AX, R13
