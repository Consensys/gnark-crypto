...
var benchRese_nocarry_0654 e_nocarry_0654

func BenchmarkE_nocarry_0654SetBytes(b *testing.B) {
	var x e_nocarry_0654
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0654MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0654.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0654)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0654)
		}
	})
}

func BenchmarkE_nocarry_0654Inverse(b *testing.B) {
	var x e_nocarry_0654
	x.SetRandom()
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0654Butterfly(b *testing.B) {
	var x e_nocarry_0654
	x.SetRandom()
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0654)
	}
}

func BenchmarkE_nocarry_0654Exp(b *testing.B) {
	var x e_nocarry_0654
	x.SetRandom()
	benchRese_nocarry_0654.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0654Double(b *testing.B) {
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Double(&benchRese_nocarry_0654)
	}
}

func BenchmarkE_nocarry_0654Add(b *testing.B) {
	var x e_nocarry_0654
	x.SetRandom()
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Add(&x, &benchRese_nocarry_0654)
	}
}

func BenchmarkE_nocarry_0654Sub(b *testing.B) {
	var x e_nocarry_0654
	x.SetRandom()
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Sub(&x, &benchRese_nocarry_0654)
	}
}

func BenchmarkE_nocarry_0654Neg(b *testing.B) {
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Neg(&benchRese_nocarry_0654)
	}
}

func BenchmarkE_nocarry_0654Div(b *testing.B) {
	var x e_nocarry_0654
	x.SetRandom()
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Div(&x, &benchRese_nocarry_0654)
	}
}

func BenchmarkE_nocarry_0654FromMont(b *testing.B) {
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.FromMont()
	}
}

func BenchmarkE_nocarry_0654ToMont(b *testing.B) {
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.ToMont()
	}
}
func BenchmarkE_nocarry_0654Square(b *testing.B) {
	benchRese_nocarry_0654.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Square(&benchRese_nocarry_0654)
	}
}

func BenchmarkE_nocarry_0654Sqrt(b *testing.B) {
	var a e_nocarry_0654
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0654Mul(b *testing.B) {
	x := e_nocarry_0654{
		6179242149721792012,
		1873449881965675562,
	...
	benchRese_nocarry_0654.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Mul(&benchRese_nocarry_0654, &x)
	}
}

func BenchmarkE_nocarry_0654Cmp(b *testing.B) {
	x := e_nocarry_0654{
		6179242149721792012,
		1873449881965675562,
		13778013230451400881,
	...
	benchRese_nocarry_0654 = x
	benchRese_nocarry_0654[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0654.Cmp(&x)
	}
}

func TestE_nocarry_0654Cmp(t *testing.T) {
	var x, y e_nocarry_0654
...
func TestE_nocarry_0654IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0654
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0654

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0654{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0654
	one.SetOne()
	e.Sub(&qe_nocarry_0654, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0654{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0654{0, uint64(i)})
	}
...
func TestE_nocarry_0654NegZero(t *testing.T) {
	var a, b e_nocarry_0654
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0654Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0654, len(staticTestValues))
...
func TestE_nocarry_0654Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0654) bool {
			var b e_nocarry_0654
...
func TestE_nocarry_0654InverseExp(t *testing.T) {
...
func TestE_nocarry_0654MulByConstants(t *testing.T) {
...
func TestE_nocarry_0654Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0654) bool {
...
func TestE_nocarry_0654LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0654Halve(t *testing.T) {
...
func TestE_nocarry_0654FromMont(t *testing.T) {
...
type testPaire_nocarry_0654 struct {
	element e_nocarry_0654
	bigint  big.Int
}

func (z *e_nocarry_0654) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0654[10] {
		return true
	}
	if z[10] < qe_nocarry_0654[10] {
		return false
	...
	return z[0] >= qe_nocarry_0654[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0654

		g.element = e_nocarry_0654{
		...
		if qe_nocarry_0654[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0654[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0654 {
			var g e_nocarry_0654
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0654[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0654[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0654[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0654[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0654[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0654[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0654[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0654[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0654[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0654[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0654[10], carry)
...
func Benchmarke_nocarry_0654InverseNew(b *testing.B) {
	var x e_nocarry_0654
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0654
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0654
		var xInv e_nocarry_0654
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0654
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0654
...
func testLinearComb(t *testing.T, x *e_nocarry_0654, xC int64, y *e_nocarry_0654, yC int64) {
	...
	var z e_nocarry_0654
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0654, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0654
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0654, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0654
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0654, xHi uint64) {
	var res e_nocarry_0654
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0654) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0654) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0654, c int64, result *e_nocarry_0654, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0654) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0654) uint64 {
