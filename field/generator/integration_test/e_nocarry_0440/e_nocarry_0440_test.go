...
var benchRese_nocarry_0440 e_nocarry_0440

func BenchmarkE_nocarry_0440SetBytes(b *testing.B) {
	var x e_nocarry_0440
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0440MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0440.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0440)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0440)
		}
	})
}

func BenchmarkE_nocarry_0440Inverse(b *testing.B) {
	var x e_nocarry_0440
	x.SetRandom()
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0440Butterfly(b *testing.B) {
	var x e_nocarry_0440
	x.SetRandom()
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0440)
	}
}

func BenchmarkE_nocarry_0440Exp(b *testing.B) {
	var x e_nocarry_0440
	x.SetRandom()
	benchRese_nocarry_0440.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0440Double(b *testing.B) {
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Double(&benchRese_nocarry_0440)
	}
}

func BenchmarkE_nocarry_0440Add(b *testing.B) {
	var x e_nocarry_0440
	x.SetRandom()
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Add(&x, &benchRese_nocarry_0440)
	}
}

func BenchmarkE_nocarry_0440Sub(b *testing.B) {
	var x e_nocarry_0440
	x.SetRandom()
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Sub(&x, &benchRese_nocarry_0440)
	}
}

func BenchmarkE_nocarry_0440Neg(b *testing.B) {
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Neg(&benchRese_nocarry_0440)
	}
}

func BenchmarkE_nocarry_0440Div(b *testing.B) {
	var x e_nocarry_0440
	x.SetRandom()
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Div(&x, &benchRese_nocarry_0440)
	}
}

func BenchmarkE_nocarry_0440FromMont(b *testing.B) {
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.FromMont()
	}
}

func BenchmarkE_nocarry_0440ToMont(b *testing.B) {
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.ToMont()
	}
}
func BenchmarkE_nocarry_0440Square(b *testing.B) {
	benchRese_nocarry_0440.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Square(&benchRese_nocarry_0440)
	}
}

func BenchmarkE_nocarry_0440Sqrt(b *testing.B) {
	var a e_nocarry_0440
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0440Mul(b *testing.B) {
	x := e_nocarry_0440{
	...
	benchRese_nocarry_0440.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Mul(&benchRese_nocarry_0440, &x)
	}
}

func BenchmarkE_nocarry_0440Cmp(b *testing.B) {
	x := e_nocarry_0440{
		13667847914360645255,
		14742827401333750214,
		4316557826401474636,
	...
	benchRese_nocarry_0440 = x
	benchRese_nocarry_0440[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0440.Cmp(&x)
	}
}

func TestE_nocarry_0440Cmp(t *testing.T) {
	var x, y e_nocarry_0440
...
func TestE_nocarry_0440IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0440
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0440

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0440{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0440
	one.SetOne()
	e.Sub(&qe_nocarry_0440, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0440{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0440{0, uint64(i)})
	}
...
func TestE_nocarry_0440NegZero(t *testing.T) {
	var a, b e_nocarry_0440
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0440Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0440, len(staticTestValues))
...
func TestE_nocarry_0440Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0440) bool {
			var b e_nocarry_0440
...
func TestE_nocarry_0440InverseExp(t *testing.T) {
...
func TestE_nocarry_0440MulByConstants(t *testing.T) {
...
func TestE_nocarry_0440Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0440) bool {
...
func TestE_nocarry_0440LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0440Halve(t *testing.T) {
...
func TestE_nocarry_0440FromMont(t *testing.T) {
...
type testPaire_nocarry_0440 struct {
	element e_nocarry_0440
	bigint  big.Int
}

func (z *e_nocarry_0440) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0440[6] {
		return true
	}
	if z[6] < qe_nocarry_0440[6] {
		return false
	...
	return z[0] >= qe_nocarry_0440[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0440

		g.element = e_nocarry_0440{
		...
		if qe_nocarry_0440[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0440[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0440 {
			var g e_nocarry_0440
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0440[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0440[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0440[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0440[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0440[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0440[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0440[6], carry)
...
func Benchmarke_nocarry_0440InverseNew(b *testing.B) {
	var x e_nocarry_0440
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0440
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0440
		var xInv e_nocarry_0440
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0440
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0440
...
func testLinearComb(t *testing.T, x *e_nocarry_0440, xC int64, y *e_nocarry_0440, yC int64) {
	...
	var z e_nocarry_0440
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0440, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0440
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0440, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0440
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0440, xHi uint64) {
	var res e_nocarry_0440
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0440) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0440) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0440, c int64, result *e_nocarry_0440, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0440) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0440) uint64 {
