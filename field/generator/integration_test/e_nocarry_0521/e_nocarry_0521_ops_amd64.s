...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x6abe453d4f3ac855, R12
	ADDQ R12, AX
	MOVQ $0x55686a59ce47942b, R12
	ADCQ R12, DX
	MOVQ $0xc0468af18c8c84b1, R12
	ADCQ R12, CX
	MOVQ $0xf327f000af6b9a17, R12
	ADCQ R12, BX
	MOVQ $0x00bf1f3857259190, R12
	ADCQ R12, SI
	MOVQ $0xb30ca057c475c9e1, R12
	ADCQ R12, DI
	MOVQ $0x83040967e071e0b3, R12
	ADCQ R12, R8
	MOVQ $0x952dbf9f7e46d2e6, R12
	ADCQ R12, R9
	MOVQ $0x00000000000001fa, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x6abe453d4f3ac855, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x55686a59ce47942b, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xc0468af18c8c84b1, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xf327f000af6b9a17, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x00bf1f3857259190, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xb30ca057c475c9e1, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x83040967e071e0b3, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x952dbf9f7e46d2e6, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000000000001fa, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x6abe453d4f3ac855, AX
	ADDQ AX, DX
	MOVQ $0x55686a59ce47942b, AX
	ADCQ AX, CX
	MOVQ $0xc0468af18c8c84b1, AX
	ADCQ AX, BX
	MOVQ $0xf327f000af6b9a17, AX
	ADCQ AX, SI
	MOVQ $0x00bf1f3857259190, AX
	ADCQ AX, DI
	MOVQ $0xb30ca057c475c9e1, AX
	ADCQ AX, R8
	MOVQ $0x83040967e071e0b3, AX
	ADCQ AX, R9
	MOVQ $0x952dbf9f7e46d2e6, AX
	ADCQ AX, R10
	MOVQ $0x00000000000001fa, AX
	ADCQ AX, R11
