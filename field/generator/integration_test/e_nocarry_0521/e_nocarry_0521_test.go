...
var benchRese_nocarry_0521 e_nocarry_0521

func BenchmarkE_nocarry_0521SetBytes(b *testing.B) {
	var x e_nocarry_0521
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0521MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0521.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0521)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0521)
		}
	})
}

func BenchmarkE_nocarry_0521Inverse(b *testing.B) {
	var x e_nocarry_0521
	x.SetRandom()
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0521Butterfly(b *testing.B) {
	var x e_nocarry_0521
	x.SetRandom()
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0521)
	}
}

func BenchmarkE_nocarry_0521Exp(b *testing.B) {
	var x e_nocarry_0521
	x.SetRandom()
	benchRese_nocarry_0521.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0521Double(b *testing.B) {
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Double(&benchRese_nocarry_0521)
	}
}

func BenchmarkE_nocarry_0521Add(b *testing.B) {
	var x e_nocarry_0521
	x.SetRandom()
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Add(&x, &benchRese_nocarry_0521)
	}
}

func BenchmarkE_nocarry_0521Sub(b *testing.B) {
	var x e_nocarry_0521
	x.SetRandom()
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Sub(&x, &benchRese_nocarry_0521)
	}
}

func BenchmarkE_nocarry_0521Neg(b *testing.B) {
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Neg(&benchRese_nocarry_0521)
	}
}

func BenchmarkE_nocarry_0521Div(b *testing.B) {
	var x e_nocarry_0521
	x.SetRandom()
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Div(&x, &benchRese_nocarry_0521)
	}
}

func BenchmarkE_nocarry_0521FromMont(b *testing.B) {
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.FromMont()
	}
}

func BenchmarkE_nocarry_0521ToMont(b *testing.B) {
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.ToMont()
	}
}
func BenchmarkE_nocarry_0521Square(b *testing.B) {
	benchRese_nocarry_0521.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Square(&benchRese_nocarry_0521)
	}
}

func BenchmarkE_nocarry_0521Sqrt(b *testing.B) {
	var a e_nocarry_0521
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0521Mul(b *testing.B) {
	x := e_nocarry_0521{
		76518890540896807,
	...
	benchRese_nocarry_0521.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Mul(&benchRese_nocarry_0521, &x)
	}
}

func BenchmarkE_nocarry_0521Cmp(b *testing.B) {
	x := e_nocarry_0521{
		76518890540896807,
		17445450787194059145,
		5545354851941003993,
	...
	benchRese_nocarry_0521 = x
	benchRese_nocarry_0521[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0521.Cmp(&x)
	}
}

func TestE_nocarry_0521Cmp(t *testing.T) {
	var x, y e_nocarry_0521
...
func TestE_nocarry_0521IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0521
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0521

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0521{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0521
	one.SetOne()
	e.Sub(&qe_nocarry_0521, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0521{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0521{0, uint64(i)})
	}
...
func TestE_nocarry_0521NegZero(t *testing.T) {
	var a, b e_nocarry_0521
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0521Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0521, len(staticTestValues))
...
func TestE_nocarry_0521Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0521) bool {
			var b e_nocarry_0521
...
func TestE_nocarry_0521InverseExp(t *testing.T) {
...
func TestE_nocarry_0521MulByConstants(t *testing.T) {
...
func TestE_nocarry_0521Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0521) bool {
...
func TestE_nocarry_0521LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0521Halve(t *testing.T) {
...
func TestE_nocarry_0521FromMont(t *testing.T) {
...
type testPaire_nocarry_0521 struct {
	element e_nocarry_0521
	bigint  big.Int
}

func (z *e_nocarry_0521) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0521[8] {
		return true
	}
	if z[8] < qe_nocarry_0521[8] {
		return false
	...
	return z[0] >= qe_nocarry_0521[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0521

		g.element = e_nocarry_0521{
		...
		if qe_nocarry_0521[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0521[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0521 {
			var g e_nocarry_0521
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0521[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0521[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0521[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0521[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0521[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0521[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0521[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0521[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0521[8], carry)
...
func Benchmarke_nocarry_0521InverseNew(b *testing.B) {
	var x e_nocarry_0521
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0521
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0521
		var xInv e_nocarry_0521
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0521
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0521
...
func testLinearComb(t *testing.T, x *e_nocarry_0521, xC int64, y *e_nocarry_0521, yC int64) {
	...
	var z e_nocarry_0521
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0521, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0521
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0521, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0521
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0521, xHi uint64) {
	var res e_nocarry_0521
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0521) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0521) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0521, c int64, result *e_nocarry_0521, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0521) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0521) uint64 {
