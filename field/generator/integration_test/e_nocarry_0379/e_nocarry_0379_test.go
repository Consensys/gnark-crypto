...
var benchRese_nocarry_0379 e_nocarry_0379

func BenchmarkE_nocarry_0379SetBytes(b *testing.B) {
	var x e_nocarry_0379
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0379MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0379.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0379)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0379)
		}
	})
}

func BenchmarkE_nocarry_0379Inverse(b *testing.B) {
	var x e_nocarry_0379
	x.SetRandom()
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0379Butterfly(b *testing.B) {
	var x e_nocarry_0379
	x.SetRandom()
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0379)
	}
}

func BenchmarkE_nocarry_0379Exp(b *testing.B) {
	var x e_nocarry_0379
	x.SetRandom()
	benchRese_nocarry_0379.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0379Double(b *testing.B) {
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Double(&benchRese_nocarry_0379)
	}
}

func BenchmarkE_nocarry_0379Add(b *testing.B) {
	var x e_nocarry_0379
	x.SetRandom()
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Add(&x, &benchRese_nocarry_0379)
	}
}

func BenchmarkE_nocarry_0379Sub(b *testing.B) {
	var x e_nocarry_0379
	x.SetRandom()
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Sub(&x, &benchRese_nocarry_0379)
	}
}

func BenchmarkE_nocarry_0379Neg(b *testing.B) {
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Neg(&benchRese_nocarry_0379)
	}
}

func BenchmarkE_nocarry_0379Div(b *testing.B) {
	var x e_nocarry_0379
	x.SetRandom()
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Div(&x, &benchRese_nocarry_0379)
	}
}

func BenchmarkE_nocarry_0379FromMont(b *testing.B) {
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.FromMont()
	}
}

func BenchmarkE_nocarry_0379ToMont(b *testing.B) {
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.ToMont()
	}
}
func BenchmarkE_nocarry_0379Square(b *testing.B) {
	benchRese_nocarry_0379.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Square(&benchRese_nocarry_0379)
	}
}

func BenchmarkE_nocarry_0379Sqrt(b *testing.B) {
	var a e_nocarry_0379
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0379Mul(b *testing.B) {
	x := e_nocarry_0379{
	...
	benchRese_nocarry_0379.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Mul(&benchRese_nocarry_0379, &x)
	}
}

func BenchmarkE_nocarry_0379Cmp(b *testing.B) {
	x := e_nocarry_0379{
		14075254891988108105,
		10169259917170809135,
		18086539193536932228,
	...
	benchRese_nocarry_0379 = x
	benchRese_nocarry_0379[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0379.Cmp(&x)
	}
}

func TestE_nocarry_0379Cmp(t *testing.T) {
	var x, y e_nocarry_0379
...
func TestE_nocarry_0379IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0379
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0379

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0379{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0379
	one.SetOne()
	e.Sub(&qe_nocarry_0379, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0379{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0379{0, uint64(i)})
	}
...
func TestE_nocarry_0379NegZero(t *testing.T) {
	var a, b e_nocarry_0379
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0379Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0379, len(staticTestValues))
...
func TestE_nocarry_0379Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0379) bool {
			var b e_nocarry_0379
...
func TestE_nocarry_0379InverseExp(t *testing.T) {
...
func TestE_nocarry_0379MulByConstants(t *testing.T) {
...
func TestE_nocarry_0379Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0379) bool {
...
func TestE_nocarry_0379LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0379Halve(t *testing.T) {
...
func TestE_nocarry_0379FromMont(t *testing.T) {
...
type testPaire_nocarry_0379 struct {
	element e_nocarry_0379
	bigint  big.Int
}

func (z *e_nocarry_0379) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0379[5] {
		return true
	}
	if z[5] < qe_nocarry_0379[5] {
		return false
	...
	return z[0] >= qe_nocarry_0379[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0379

		g.element = e_nocarry_0379{
		...
		if qe_nocarry_0379[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0379[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0379 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0379[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0379[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0379[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0379[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0379[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0379[5], carry)
...
func Benchmarke_nocarry_0379InverseNew(b *testing.B) {
	var x e_nocarry_0379
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0379
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0379
		var xInv e_nocarry_0379
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0379
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0379
...
func testLinearComb(t *testing.T, x *e_nocarry_0379, xC int64, y *e_nocarry_0379, yC int64) {
	...
	var z e_nocarry_0379
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0379, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0379
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0379, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0379
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0379, xHi uint64) {
	var res e_nocarry_0379
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0379) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0379) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0379, c int64, result *e_nocarry_0379, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0379) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0379) uint64 {
