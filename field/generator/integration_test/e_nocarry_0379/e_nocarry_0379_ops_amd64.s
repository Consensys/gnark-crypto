...
// modulus q
DATA q<>+0(SB)/8, $0x9d0e3aba3ee520d1
DATA q<>+8(SB)/8, $0x388dec4278e3a1f1
DATA q<>+16(SB)/8, $0xdc2130185b1f6980
DATA q<>+24(SB)/8, $0x49d369f3a012bdff
DATA q<>+32(SB)/8, $0x9e429f4b4458adba
DATA q<>+40(SB)/8, $0x0715013abd7acd98
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xdd58de68d2b8c7cf
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x9d0e3aba3ee520d1, R10
	MOVQ    $0x388dec4278e3a1f1, R11
	MOVQ    $0xdc2130185b1f6980, R12
	MOVQ    $0x49d369f3a012bdff, R13
	MOVQ    $0x9e429f4b4458adba, R14
	MOVQ    $0x0715013abd7acd98, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x388dec4278e3a1f1, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xdc2130185b1f6980, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x49d369f3a012bdff, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x9e429f4b4458adba, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0715013abd7acd98, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x9d0e3aba3ee520d1, CX
	MOVQ    $0x388dec4278e3a1f1, BX
	MOVQ    $0xdc2130185b1f6980, SI
	MOVQ    $0x49d369f3a012bdff, DI
	MOVQ    $0x9e429f4b4458adba, R8
	MOVQ    $0x0715013abd7acd98, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
