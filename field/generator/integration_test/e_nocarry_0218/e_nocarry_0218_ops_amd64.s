...
// modulus q
DATA q<>+0(SB)/8, $0x45c89d9c1c4bff1d
DATA q<>+8(SB)/8, $0x77e74bfadde7f9d5
DATA q<>+16(SB)/8, $0x7a8e73c2aa2777dd
DATA q<>+24(SB)/8, $0x0000000003bb1f97
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x3383f1b5c18d44cb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x45c89d9c1c4bff1d, R8
	MOVQ    $0x77e74bfadde7f9d5, R9
	MOVQ    $0x7a8e73c2aa2777dd, R10
	MOVQ    $0x0000000003bb1f97, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x77e74bfadde7f9d5, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x7a8e73c2aa2777dd, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000000003bb1f97, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x45c89d9c1c4bff1d, R12
	MOVQ    $0x77e74bfadde7f9d5, R13
	MOVQ    $0x7a8e73c2aa2777dd, R14
	MOVQ    $0x0000000003bb1f97, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
