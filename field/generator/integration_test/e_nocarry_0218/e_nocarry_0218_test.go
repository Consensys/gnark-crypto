...
var benchRese_nocarry_0218 e_nocarry_0218

func BenchmarkE_nocarry_0218SetBytes(b *testing.B) {
	var x e_nocarry_0218
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0218MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0218.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0218)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0218)
		}
	})
}

func BenchmarkE_nocarry_0218Inverse(b *testing.B) {
	var x e_nocarry_0218
	x.SetRandom()
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0218Butterfly(b *testing.B) {
	var x e_nocarry_0218
	x.SetRandom()
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0218)
	}
}

func BenchmarkE_nocarry_0218Exp(b *testing.B) {
	var x e_nocarry_0218
	x.SetRandom()
	benchRese_nocarry_0218.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0218Double(b *testing.B) {
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Double(&benchRese_nocarry_0218)
	}
}

func BenchmarkE_nocarry_0218Add(b *testing.B) {
	var x e_nocarry_0218
	x.SetRandom()
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Add(&x, &benchRese_nocarry_0218)
	}
}

func BenchmarkE_nocarry_0218Sub(b *testing.B) {
	var x e_nocarry_0218
	x.SetRandom()
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Sub(&x, &benchRese_nocarry_0218)
	}
}

func BenchmarkE_nocarry_0218Neg(b *testing.B) {
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Neg(&benchRese_nocarry_0218)
	}
}

func BenchmarkE_nocarry_0218Div(b *testing.B) {
	var x e_nocarry_0218
	x.SetRandom()
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Div(&x, &benchRese_nocarry_0218)
	}
}

func BenchmarkE_nocarry_0218FromMont(b *testing.B) {
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.FromMont()
	}
}

func BenchmarkE_nocarry_0218ToMont(b *testing.B) {
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.ToMont()
	}
}
func BenchmarkE_nocarry_0218Square(b *testing.B) {
	benchRese_nocarry_0218.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Square(&benchRese_nocarry_0218)
	}
}

func BenchmarkE_nocarry_0218Sqrt(b *testing.B) {
	var a e_nocarry_0218
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0218Mul(b *testing.B) {
	x := e_nocarry_0218{
		8385595123249427944,
		2631926863688223725,
		2890237731084790904,
	...
	benchRese_nocarry_0218.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Mul(&benchRese_nocarry_0218, &x)
	}
}

func BenchmarkE_nocarry_0218Cmp(b *testing.B) {
	x := e_nocarry_0218{
		8385595123249427944,
		2631926863688223725,
		2890237731084790904,
	...
	benchRese_nocarry_0218 = x
	benchRese_nocarry_0218[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0218.Cmp(&x)
	}
}

func TestE_nocarry_0218Cmp(t *testing.T) {
	var x, y e_nocarry_0218
...
func TestE_nocarry_0218IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0218
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0218

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0218{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0218
	one.SetOne()
	e.Sub(&qe_nocarry_0218, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0218{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0218{0, uint64(i)})
	}
...
func TestE_nocarry_0218NegZero(t *testing.T) {
	var a, b e_nocarry_0218
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0218Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0218, len(staticTestValues))
...
func TestE_nocarry_0218Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0218) bool {
			var b e_nocarry_0218
...
func TestE_nocarry_0218InverseExp(t *testing.T) {
...
func TestE_nocarry_0218MulByConstants(t *testing.T) {
...
func TestE_nocarry_0218Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0218) bool {
...
func TestE_nocarry_0218LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0218Halve(t *testing.T) {
...
func TestE_nocarry_0218FromMont(t *testing.T) {
...
type testPaire_nocarry_0218 struct {
	element e_nocarry_0218
	bigint  big.Int
}

func (z *e_nocarry_0218) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0218[3] {
		return true
	}
	if z[3] < qe_nocarry_0218[3] {
		return false
	...
	return z[0] >= qe_nocarry_0218[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0218

		g.element = e_nocarry_0218{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0218[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0218[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0218 {
			var g e_nocarry_0218
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0218[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0218[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0218[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0218[3], carry)
...
func Benchmarke_nocarry_0218InverseNew(b *testing.B) {
	var x e_nocarry_0218
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0218
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0218
		var xInv e_nocarry_0218
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0218
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0218
...
func testLinearComb(t *testing.T, x *e_nocarry_0218, xC int64, y *e_nocarry_0218, yC int64) {
	...
	var z e_nocarry_0218
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0218, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0218
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0218, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0218
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0218, xHi uint64) {
	var res e_nocarry_0218
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0218) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0218) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0218, c int64, result *e_nocarry_0218, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0218) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0218) uint64 {
