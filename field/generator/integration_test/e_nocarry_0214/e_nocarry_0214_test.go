...
var benchRese_nocarry_0214 e_nocarry_0214

func BenchmarkE_nocarry_0214SetBytes(b *testing.B) {
	var x e_nocarry_0214
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0214MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0214.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0214)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0214)
		}
	})
}

func BenchmarkE_nocarry_0214Inverse(b *testing.B) {
	var x e_nocarry_0214
	x.SetRandom()
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0214Butterfly(b *testing.B) {
	var x e_nocarry_0214
	x.SetRandom()
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0214)
	}
}

func BenchmarkE_nocarry_0214Exp(b *testing.B) {
	var x e_nocarry_0214
	x.SetRandom()
	benchRese_nocarry_0214.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0214Double(b *testing.B) {
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Double(&benchRese_nocarry_0214)
	}
}

func BenchmarkE_nocarry_0214Add(b *testing.B) {
	var x e_nocarry_0214
	x.SetRandom()
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Add(&x, &benchRese_nocarry_0214)
	}
}

func BenchmarkE_nocarry_0214Sub(b *testing.B) {
	var x e_nocarry_0214
	x.SetRandom()
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Sub(&x, &benchRese_nocarry_0214)
	}
}

func BenchmarkE_nocarry_0214Neg(b *testing.B) {
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Neg(&benchRese_nocarry_0214)
	}
}

func BenchmarkE_nocarry_0214Div(b *testing.B) {
	var x e_nocarry_0214
	x.SetRandom()
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Div(&x, &benchRese_nocarry_0214)
	}
}

func BenchmarkE_nocarry_0214FromMont(b *testing.B) {
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.FromMont()
	}
}

func BenchmarkE_nocarry_0214ToMont(b *testing.B) {
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.ToMont()
	}
}
func BenchmarkE_nocarry_0214Square(b *testing.B) {
	benchRese_nocarry_0214.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Square(&benchRese_nocarry_0214)
	}
}

func BenchmarkE_nocarry_0214Sqrt(b *testing.B) {
	var a e_nocarry_0214
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0214Mul(b *testing.B) {
	x := e_nocarry_0214{
	...
	benchRese_nocarry_0214.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Mul(&benchRese_nocarry_0214, &x)
	}
}

func BenchmarkE_nocarry_0214Cmp(b *testing.B) {
	x := e_nocarry_0214{
		10711442146945284723,
		17564215794804871607,
		365730709736763482,
	...
	benchRese_nocarry_0214 = x
	benchRese_nocarry_0214[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0214.Cmp(&x)
	}
}

func TestE_nocarry_0214Cmp(t *testing.T) {
	var x, y e_nocarry_0214
...
func TestE_nocarry_0214IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0214
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0214

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0214{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0214
	one.SetOne()
	e.Sub(&qe_nocarry_0214, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0214{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0214{0, uint64(i)})
	}
...
func TestE_nocarry_0214NegZero(t *testing.T) {
	var a, b e_nocarry_0214
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0214Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0214, len(staticTestValues))
...
func TestE_nocarry_0214Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0214) bool {
			var b e_nocarry_0214
...
func TestE_nocarry_0214InverseExp(t *testing.T) {
...
func TestE_nocarry_0214MulByConstants(t *testing.T) {
...
func TestE_nocarry_0214Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0214) bool {
...
func TestE_nocarry_0214LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0214Halve(t *testing.T) {
...
func TestE_nocarry_0214FromMont(t *testing.T) {
...
type testPaire_nocarry_0214 struct {
	element e_nocarry_0214
	bigint  big.Int
}

func (z *e_nocarry_0214) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0214[3] {
		return true
	}
	if z[3] < qe_nocarry_0214[3] {
		return false
	...
	return z[0] >= qe_nocarry_0214[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0214

		g.element = e_nocarry_0214{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0214[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0214[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0214 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0214[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0214[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0214[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0214[3], carry)
...
func Benchmarke_nocarry_0214InverseNew(b *testing.B) {
	var x e_nocarry_0214
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0214
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0214
		var xInv e_nocarry_0214
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0214
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0214
...
func testLinearComb(t *testing.T, x *e_nocarry_0214, xC int64, y *e_nocarry_0214, yC int64) {
	...
	var z e_nocarry_0214
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0214, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0214
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0214, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0214
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0214, xHi uint64) {
	var res e_nocarry_0214
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0214) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0214) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0214, c int64, result *e_nocarry_0214, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0214) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0214) uint64 {
