...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x8f93b4e0158f8cf7, R14
	ADDQ R14, AX
	MOVQ $0x813d4e379b1c7c67, R14
	ADCQ R14, DX
	MOVQ $0xd3cd346d4a7cd33f, R14
	ADCQ R14, CX
	MOVQ $0xea121b2e59188f0f, R14
	ADCQ R14, BX
	MOVQ $0xac5ae4b702342379, R14
	ADCQ R14, SI
	MOVQ $0x1cdb8a5f767d8d49, R14
	ADCQ R14, DI
	MOVQ $0xbfc467120d06bd1a, R14
	ADCQ R14, R8
	MOVQ $0xa86672ef7b3074c6, R14
	ADCQ R14, R9
	MOVQ $0xb57b9de7cced3243, R14
	ADCQ R14, R10
	MOVQ $0xd900de3ae7034124, R14
	ADCQ R14, R11
	MOVQ $0x3d509b81c64cb0d8, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x8f93b4e0158f8cf7, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x813d4e379b1c7c67, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xd3cd346d4a7cd33f, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xea121b2e59188f0f, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xac5ae4b702342379, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x1cdb8a5f767d8d49, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xbfc467120d06bd1a, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xa86672ef7b3074c6, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xb57b9de7cced3243, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xd900de3ae7034124, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x3d509b81c64cb0d8, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x8f93b4e0158f8cf7, AX
	ADDQ AX, DX
	MOVQ $0x813d4e379b1c7c67, AX
	ADCQ AX, CX
	MOVQ $0xd3cd346d4a7cd33f, AX
	ADCQ AX, BX
	MOVQ $0xea121b2e59188f0f, AX
	ADCQ AX, SI
	MOVQ $0xac5ae4b702342379, AX
	ADCQ AX, DI
	MOVQ $0x1cdb8a5f767d8d49, AX
	ADCQ AX, R8
	MOVQ $0xbfc467120d06bd1a, AX
	ADCQ AX, R9
	MOVQ $0xa86672ef7b3074c6, AX
	ADCQ AX, R10
	MOVQ $0xb57b9de7cced3243, AX
	ADCQ AX, R11
	MOVQ $0xd900de3ae7034124, AX
	ADCQ AX, R12
	MOVQ $0x3d509b81c64cb0d8, AX
	ADCQ AX, R13
