...
var benchRese_nocarry_0702 e_nocarry_0702

func BenchmarkE_nocarry_0702SetBytes(b *testing.B) {
	var x e_nocarry_0702
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0702MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0702.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0702)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0702)
		}
	})
}

func BenchmarkE_nocarry_0702Inverse(b *testing.B) {
	var x e_nocarry_0702
	x.SetRandom()
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0702Butterfly(b *testing.B) {
	var x e_nocarry_0702
	x.SetRandom()
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0702)
	}
}

func BenchmarkE_nocarry_0702Exp(b *testing.B) {
	var x e_nocarry_0702
	x.SetRandom()
	benchRese_nocarry_0702.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0702Double(b *testing.B) {
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Double(&benchRese_nocarry_0702)
	}
}

func BenchmarkE_nocarry_0702Add(b *testing.B) {
	var x e_nocarry_0702
	x.SetRandom()
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Add(&x, &benchRese_nocarry_0702)
	}
}

func BenchmarkE_nocarry_0702Sub(b *testing.B) {
	var x e_nocarry_0702
	x.SetRandom()
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Sub(&x, &benchRese_nocarry_0702)
	}
}

func BenchmarkE_nocarry_0702Neg(b *testing.B) {
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Neg(&benchRese_nocarry_0702)
	}
}

func BenchmarkE_nocarry_0702Div(b *testing.B) {
	var x e_nocarry_0702
	x.SetRandom()
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Div(&x, &benchRese_nocarry_0702)
	}
}

func BenchmarkE_nocarry_0702FromMont(b *testing.B) {
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.FromMont()
	}
}

func BenchmarkE_nocarry_0702ToMont(b *testing.B) {
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.ToMont()
	}
}
func BenchmarkE_nocarry_0702Square(b *testing.B) {
	benchRese_nocarry_0702.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Square(&benchRese_nocarry_0702)
	}
}

func BenchmarkE_nocarry_0702Sqrt(b *testing.B) {
	var a e_nocarry_0702
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0702Mul(b *testing.B) {
	x := e_nocarry_0702{
		3630232002939130795,
		9340836361894246747,
	...
	benchRese_nocarry_0702.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Mul(&benchRese_nocarry_0702, &x)
	}
}

func BenchmarkE_nocarry_0702Cmp(b *testing.B) {
	x := e_nocarry_0702{
		3630232002939130795,
		9340836361894246747,
		16745320433561550683,
	...
	benchRese_nocarry_0702 = x
	benchRese_nocarry_0702[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0702.Cmp(&x)
	}
}

func TestE_nocarry_0702Cmp(t *testing.T) {
	var x, y e_nocarry_0702
...
func TestE_nocarry_0702IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0702
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0702

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0702{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0702
	one.SetOne()
	e.Sub(&qe_nocarry_0702, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0702{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0702{0, uint64(i)})
	}
...
func TestE_nocarry_0702NegZero(t *testing.T) {
	var a, b e_nocarry_0702
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0702Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0702, len(staticTestValues))
...
func TestE_nocarry_0702Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0702) bool {
			var b e_nocarry_0702
...
func TestE_nocarry_0702InverseExp(t *testing.T) {
...
func TestE_nocarry_0702MulByConstants(t *testing.T) {
...
func TestE_nocarry_0702Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0702) bool {
...
func TestE_nocarry_0702LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0702Halve(t *testing.T) {
...
func TestE_nocarry_0702FromMont(t *testing.T) {
...
type testPaire_nocarry_0702 struct {
	element e_nocarry_0702
	bigint  big.Int
}

func (z *e_nocarry_0702) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0702[10] {
		return true
	}
	if z[10] < qe_nocarry_0702[10] {
		return false
	...
	return z[0] >= qe_nocarry_0702[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0702

		g.element = e_nocarry_0702{
		...
		if qe_nocarry_0702[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0702[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0702 {
			var g e_nocarry_0702
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0702[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0702[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0702[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0702[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0702[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0702[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0702[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0702[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0702[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0702[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0702[10], carry)
...
func Benchmarke_nocarry_0702InverseNew(b *testing.B) {
	var x e_nocarry_0702
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0702
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0702
		var xInv e_nocarry_0702
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0702
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0702
...
func testLinearComb(t *testing.T, x *e_nocarry_0702, xC int64, y *e_nocarry_0702, yC int64) {
	...
	var z e_nocarry_0702
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0702, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0702
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0702, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0702
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0702, xHi uint64) {
	var res e_nocarry_0702
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0702) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0702) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0702, c int64, result *e_nocarry_0702, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0702) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0702) uint64 {
