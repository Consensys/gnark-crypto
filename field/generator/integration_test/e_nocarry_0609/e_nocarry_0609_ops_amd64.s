...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x4ed16a2b14298d77, R13
	ADDQ R13, AX
	MOVQ $0x2bcd00940c7e4094, R13
	ADCQ R13, DX
	MOVQ $0xfecd38e054aa50bf, R13
	ADCQ R13, CX
	MOVQ $0xe49d8d925c48435b, R13
	ADCQ R13, BX
	MOVQ $0x298f5ca96ebecc27, R13
	ADCQ R13, SI
	MOVQ $0x5d3fd4317610370d, R13
	ADCQ R13, DI
	MOVQ $0x83d6fcfd685f3c90, R13
	ADCQ R13, R8
	MOVQ $0xdcb0624893cdbca8, R13
	ADCQ R13, R9
	MOVQ $0xa003e7b41f4a7d1a, R13
	ADCQ R13, R10
	MOVQ $0x00000001b7490806, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x4ed16a2b14298d77, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x2bcd00940c7e4094, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xfecd38e054aa50bf, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xe49d8d925c48435b, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x298f5ca96ebecc27, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x5d3fd4317610370d, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x83d6fcfd685f3c90, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xdcb0624893cdbca8, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xa003e7b41f4a7d1a, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000001b7490806, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x4ed16a2b14298d77, AX
	ADDQ AX, DX
	MOVQ $0x2bcd00940c7e4094, AX
	ADCQ AX, CX
	MOVQ $0xfecd38e054aa50bf, AX
	ADCQ AX, BX
	MOVQ $0xe49d8d925c48435b, AX
	ADCQ AX, SI
	MOVQ $0x298f5ca96ebecc27, AX
	ADCQ AX, DI
	MOVQ $0x5d3fd4317610370d, AX
	ADCQ AX, R8
	MOVQ $0x83d6fcfd685f3c90, AX
	ADCQ AX, R9
	MOVQ $0xdcb0624893cdbca8, AX
	ADCQ AX, R10
	MOVQ $0xa003e7b41f4a7d1a, AX
	ADCQ AX, R11
	MOVQ $0x00000001b7490806, AX
	ADCQ AX, R12
