...
var benchRese_nocarry_0609 e_nocarry_0609

func BenchmarkE_nocarry_0609SetBytes(b *testing.B) {
	var x e_nocarry_0609
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0609MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0609.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0609)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0609)
		}
	})
}

func BenchmarkE_nocarry_0609Inverse(b *testing.B) {
	var x e_nocarry_0609
	x.SetRandom()
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0609Butterfly(b *testing.B) {
	var x e_nocarry_0609
	x.SetRandom()
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0609)
	}
}

func BenchmarkE_nocarry_0609Exp(b *testing.B) {
	var x e_nocarry_0609
	x.SetRandom()
	benchRese_nocarry_0609.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0609Double(b *testing.B) {
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Double(&benchRese_nocarry_0609)
	}
}

func BenchmarkE_nocarry_0609Add(b *testing.B) {
	var x e_nocarry_0609
	x.SetRandom()
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Add(&x, &benchRese_nocarry_0609)
	}
}

func BenchmarkE_nocarry_0609Sub(b *testing.B) {
	var x e_nocarry_0609
	x.SetRandom()
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Sub(&x, &benchRese_nocarry_0609)
	}
}

func BenchmarkE_nocarry_0609Neg(b *testing.B) {
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Neg(&benchRese_nocarry_0609)
	}
}

func BenchmarkE_nocarry_0609Div(b *testing.B) {
	var x e_nocarry_0609
	x.SetRandom()
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Div(&x, &benchRese_nocarry_0609)
	}
}

func BenchmarkE_nocarry_0609FromMont(b *testing.B) {
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.FromMont()
	}
}

func BenchmarkE_nocarry_0609ToMont(b *testing.B) {
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.ToMont()
	}
}
func BenchmarkE_nocarry_0609Square(b *testing.B) {
	benchRese_nocarry_0609.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Square(&benchRese_nocarry_0609)
	}
}

func BenchmarkE_nocarry_0609Sqrt(b *testing.B) {
	var a e_nocarry_0609
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0609Mul(b *testing.B) {
	x := e_nocarry_0609{
		487789098645733927,
		691360869067612329,
	...
	benchRese_nocarry_0609.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Mul(&benchRese_nocarry_0609, &x)
	}
}

func BenchmarkE_nocarry_0609Cmp(b *testing.B) {
	x := e_nocarry_0609{
		487789098645733927,
		691360869067612329,
		11698988356116414836,
	...
	benchRese_nocarry_0609 = x
	benchRese_nocarry_0609[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0609.Cmp(&x)
	}
}

func TestE_nocarry_0609Cmp(t *testing.T) {
	var x, y e_nocarry_0609
...
func TestE_nocarry_0609IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0609
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0609

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0609{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0609
	one.SetOne()
	e.Sub(&qe_nocarry_0609, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0609{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0609{0, uint64(i)})
	}
...
func TestE_nocarry_0609NegZero(t *testing.T) {
	var a, b e_nocarry_0609
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0609Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0609, len(staticTestValues))
...
func TestE_nocarry_0609Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0609) bool {
			var b e_nocarry_0609
...
func TestE_nocarry_0609InverseExp(t *testing.T) {
...
func TestE_nocarry_0609MulByConstants(t *testing.T) {
...
func TestE_nocarry_0609Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0609) bool {
...
func TestE_nocarry_0609LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0609Halve(t *testing.T) {
...
func TestE_nocarry_0609FromMont(t *testing.T) {
...
type testPaire_nocarry_0609 struct {
	element e_nocarry_0609
	bigint  big.Int
}

func (z *e_nocarry_0609) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0609[9] {
		return true
	}
	if z[9] < qe_nocarry_0609[9] {
		return false
	...
	return z[0] >= qe_nocarry_0609[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0609

		g.element = e_nocarry_0609{
		...
		if qe_nocarry_0609[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0609[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0609 {
			var g e_nocarry_0609
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0609[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0609[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0609[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0609[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0609[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0609[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0609[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0609[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0609[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0609[9], carry)
...
func Benchmarke_nocarry_0609InverseNew(b *testing.B) {
	var x e_nocarry_0609
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0609
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0609
		var xInv e_nocarry_0609
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0609
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0609
...
func testLinearComb(t *testing.T, x *e_nocarry_0609, xC int64, y *e_nocarry_0609, yC int64) {
	...
	var z e_nocarry_0609
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0609, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0609
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0609, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0609
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0609, xHi uint64) {
	var res e_nocarry_0609
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0609) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0609) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0609, c int64, result *e_nocarry_0609, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0609) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0609) uint64 {
