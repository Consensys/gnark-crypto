...
// modulus q
DATA q<>+0(SB)/8, $0xe80e24e7a5fc065d
DATA q<>+8(SB)/8, $0x9c3dd28a40bb28c6
DATA q<>+16(SB)/8, $0x798f522652a0ae99
DATA q<>+24(SB)/8, $0x68560eb432feae7c
DATA q<>+32(SB)/8, $0x96acfb99d72f275d
DATA q<>+40(SB)/8, $0x9d872b0fb60da062
DATA q<>+48(SB)/8, $0x208da7c5635c894b
DATA q<>+56(SB)/8, $0x3187c0218cda26de
DATA q<>+64(SB)/8, $0x926965556d6c12ea
DATA q<>+72(SB)/8, $0x0000000000073063
GLOBL q<>(SB), (RODATA+NOPTR), $80

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x6847413fdeab020b
