...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xe80e24e7a5fc065d, R13
	ADDQ R13, AX
	MOVQ $0x9c3dd28a40bb28c6, R13
	ADCQ R13, DX
	MOVQ $0x798f522652a0ae99, R13
	ADCQ R13, CX
	MOVQ $0x68560eb432feae7c, R13
	ADCQ R13, BX
	MOVQ $0x96acfb99d72f275d, R13
	ADCQ R13, SI
	MOVQ $0x9d872b0fb60da062, R13
	ADCQ R13, DI
	MOVQ $0x208da7c5635c894b, R13
	ADCQ R13, R8
	MOVQ $0x3187c0218cda26de, R13
	ADCQ R13, R9
	MOVQ $0x926965556d6c12ea, R13
	ADCQ R13, R10
	MOVQ $0x0000000000073063, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xe80e24e7a5fc065d, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x9c3dd28a40bb28c6, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x798f522652a0ae99, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x68560eb432feae7c, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x96acfb99d72f275d, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x9d872b0fb60da062, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x208da7c5635c894b, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x3187c0218cda26de, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x926965556d6c12ea, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000000073063, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xe80e24e7a5fc065d, AX
	ADDQ AX, DX
	MOVQ $0x9c3dd28a40bb28c6, AX
	ADCQ AX, CX
	MOVQ $0x798f522652a0ae99, AX
	ADCQ AX, BX
	MOVQ $0x68560eb432feae7c, AX
	ADCQ AX, SI
	MOVQ $0x96acfb99d72f275d, AX
	ADCQ AX, DI
	MOVQ $0x9d872b0fb60da062, AX
	ADCQ AX, R8
	MOVQ $0x208da7c5635c894b, AX
	ADCQ AX, R9
	MOVQ $0x3187c0218cda26de, AX
	ADCQ AX, R10
	MOVQ $0x926965556d6c12ea, AX
	ADCQ AX, R11
	MOVQ $0x0000000000073063, AX
	ADCQ AX, R12
