...
var benchRese_nocarry_0595 e_nocarry_0595

func BenchmarkE_nocarry_0595SetBytes(b *testing.B) {
	var x e_nocarry_0595
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0595MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0595.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0595)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0595)
		}
	})
}

func BenchmarkE_nocarry_0595Inverse(b *testing.B) {
	var x e_nocarry_0595
	x.SetRandom()
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0595Butterfly(b *testing.B) {
	var x e_nocarry_0595
	x.SetRandom()
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0595)
	}
}

func BenchmarkE_nocarry_0595Exp(b *testing.B) {
	var x e_nocarry_0595
	x.SetRandom()
	benchRese_nocarry_0595.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0595Double(b *testing.B) {
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Double(&benchRese_nocarry_0595)
	}
}

func BenchmarkE_nocarry_0595Add(b *testing.B) {
	var x e_nocarry_0595
	x.SetRandom()
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Add(&x, &benchRese_nocarry_0595)
	}
}

func BenchmarkE_nocarry_0595Sub(b *testing.B) {
	var x e_nocarry_0595
	x.SetRandom()
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Sub(&x, &benchRese_nocarry_0595)
	}
}

func BenchmarkE_nocarry_0595Neg(b *testing.B) {
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Neg(&benchRese_nocarry_0595)
	}
}

func BenchmarkE_nocarry_0595Div(b *testing.B) {
	var x e_nocarry_0595
	x.SetRandom()
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Div(&x, &benchRese_nocarry_0595)
	}
}

func BenchmarkE_nocarry_0595FromMont(b *testing.B) {
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.FromMont()
	}
}

func BenchmarkE_nocarry_0595ToMont(b *testing.B) {
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.ToMont()
	}
}
func BenchmarkE_nocarry_0595Square(b *testing.B) {
	benchRese_nocarry_0595.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Square(&benchRese_nocarry_0595)
	}
}

func BenchmarkE_nocarry_0595Sqrt(b *testing.B) {
	var a e_nocarry_0595
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0595Mul(b *testing.B) {
	x := e_nocarry_0595{
	...
	benchRese_nocarry_0595.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Mul(&benchRese_nocarry_0595, &x)
	}
}

func BenchmarkE_nocarry_0595Cmp(b *testing.B) {
	x := e_nocarry_0595{
		15130287976834662841,
		15236885724674964402,
		12421231551190882402,
	...
	benchRese_nocarry_0595 = x
	benchRese_nocarry_0595[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0595.Cmp(&x)
	}
}

func TestE_nocarry_0595Cmp(t *testing.T) {
	var x, y e_nocarry_0595
...
func TestE_nocarry_0595IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0595
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0595

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0595{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0595
	one.SetOne()
	e.Sub(&qe_nocarry_0595, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0595{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0595{0, uint64(i)})
	}
...
func TestE_nocarry_0595NegZero(t *testing.T) {
	var a, b e_nocarry_0595
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0595Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0595, len(staticTestValues))
...
func TestE_nocarry_0595Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0595) bool {
			var b e_nocarry_0595
...
func TestE_nocarry_0595InverseExp(t *testing.T) {
...
func TestE_nocarry_0595MulByConstants(t *testing.T) {
...
func TestE_nocarry_0595Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0595) bool {
...
func TestE_nocarry_0595LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0595Halve(t *testing.T) {
...
func TestE_nocarry_0595FromMont(t *testing.T) {
...
type testPaire_nocarry_0595 struct {
	element e_nocarry_0595
	bigint  big.Int
}

func (z *e_nocarry_0595) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0595[9] {
		return true
	}
	if z[9] < qe_nocarry_0595[9] {
		return false
	...
	return z[0] >= qe_nocarry_0595[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0595

		g.element = e_nocarry_0595{
		...
		if qe_nocarry_0595[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0595[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0595 {
			var g e_nocarry_0595
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0595[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0595[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0595[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0595[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0595[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0595[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0595[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0595[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0595[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0595[9], carry)
...
func Benchmarke_nocarry_0595InverseNew(b *testing.B) {
	var x e_nocarry_0595
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0595
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0595
		var xInv e_nocarry_0595
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0595
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0595
...
func testLinearComb(t *testing.T, x *e_nocarry_0595, xC int64, y *e_nocarry_0595, yC int64) {
	...
	var z e_nocarry_0595
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0595, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0595
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0595, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0595
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0595, xHi uint64) {
	var res e_nocarry_0595
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0595) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0595) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0595, c int64, result *e_nocarry_0595, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0595) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0595) uint64 {
