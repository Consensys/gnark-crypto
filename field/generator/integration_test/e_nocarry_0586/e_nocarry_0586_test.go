...
var benchRese_nocarry_0586 e_nocarry_0586

func BenchmarkE_nocarry_0586SetBytes(b *testing.B) {
	var x e_nocarry_0586
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0586MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0586.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0586)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0586)
		}
	})
}

func BenchmarkE_nocarry_0586Inverse(b *testing.B) {
	var x e_nocarry_0586
	x.SetRandom()
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0586Butterfly(b *testing.B) {
	var x e_nocarry_0586
	x.SetRandom()
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0586)
	}
}

func BenchmarkE_nocarry_0586Exp(b *testing.B) {
	var x e_nocarry_0586
	x.SetRandom()
	benchRese_nocarry_0586.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0586Double(b *testing.B) {
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Double(&benchRese_nocarry_0586)
	}
}

func BenchmarkE_nocarry_0586Add(b *testing.B) {
	var x e_nocarry_0586
	x.SetRandom()
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Add(&x, &benchRese_nocarry_0586)
	}
}

func BenchmarkE_nocarry_0586Sub(b *testing.B) {
	var x e_nocarry_0586
	x.SetRandom()
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Sub(&x, &benchRese_nocarry_0586)
	}
}

func BenchmarkE_nocarry_0586Neg(b *testing.B) {
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Neg(&benchRese_nocarry_0586)
	}
}

func BenchmarkE_nocarry_0586Div(b *testing.B) {
	var x e_nocarry_0586
	x.SetRandom()
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Div(&x, &benchRese_nocarry_0586)
	}
}

func BenchmarkE_nocarry_0586FromMont(b *testing.B) {
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.FromMont()
	}
}

func BenchmarkE_nocarry_0586ToMont(b *testing.B) {
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.ToMont()
	}
}
func BenchmarkE_nocarry_0586Square(b *testing.B) {
	benchRese_nocarry_0586.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Square(&benchRese_nocarry_0586)
	}
}

func BenchmarkE_nocarry_0586Sqrt(b *testing.B) {
	var a e_nocarry_0586
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0586Mul(b *testing.B) {
	x := e_nocarry_0586{
		5058120159187479119,
		2480437762424704483,
		5694120609044733429,
	...
	benchRese_nocarry_0586.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Mul(&benchRese_nocarry_0586, &x)
	}
}

func BenchmarkE_nocarry_0586Cmp(b *testing.B) {
	x := e_nocarry_0586{
		5058120159187479119,
		2480437762424704483,
		5694120609044733429,
	...
	benchRese_nocarry_0586 = x
	benchRese_nocarry_0586[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0586.Cmp(&x)
	}
}

func TestE_nocarry_0586Cmp(t *testing.T) {
	var x, y e_nocarry_0586
...
func TestE_nocarry_0586IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0586
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0586

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0586{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0586
	one.SetOne()
	e.Sub(&qe_nocarry_0586, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0586{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0586{0, uint64(i)})
	}
...
func TestE_nocarry_0586NegZero(t *testing.T) {
	var a, b e_nocarry_0586
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0586Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0586, len(staticTestValues))
...
func TestE_nocarry_0586Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0586) bool {
			var b e_nocarry_0586
...
func TestE_nocarry_0586InverseExp(t *testing.T) {
...
func TestE_nocarry_0586MulByConstants(t *testing.T) {
...
func TestE_nocarry_0586Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0586) bool {
...
func TestE_nocarry_0586LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0586Halve(t *testing.T) {
...
func TestE_nocarry_0586FromMont(t *testing.T) {
...
type testPaire_nocarry_0586 struct {
	element e_nocarry_0586
	bigint  big.Int
}

func (z *e_nocarry_0586) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0586[9] {
		return true
	}
	if z[9] < qe_nocarry_0586[9] {
		return false
	...
	return z[0] >= qe_nocarry_0586[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0586

		g.element = e_nocarry_0586{
		...
		if qe_nocarry_0586[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0586[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0586 {
			var g e_nocarry_0586
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0586[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0586[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0586[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0586[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0586[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0586[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0586[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0586[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0586[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0586[9], carry)
...
func Benchmarke_nocarry_0586InverseNew(b *testing.B) {
	var x e_nocarry_0586
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0586
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0586
		var xInv e_nocarry_0586
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0586
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0586
...
func testLinearComb(t *testing.T, x *e_nocarry_0586, xC int64, y *e_nocarry_0586, yC int64) {
	...
	var z e_nocarry_0586
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0586, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0586
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0586, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0586
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0586, xHi uint64) {
	var res e_nocarry_0586
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0586) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0586) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0586, c int64, result *e_nocarry_0586, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0586) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0586) uint64 {
