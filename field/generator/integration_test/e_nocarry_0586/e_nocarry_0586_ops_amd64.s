...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x913a3462871f6df3, R13
	ADDQ R13, AX
	MOVQ $0xf8aa2aca1b57eeaf, R13
	ADCQ R13, DX
	MOVQ $0x81f3fab95222f3ed, R13
	ADCQ R13, CX
	MOVQ $0xd2d321e706515b31, R13
	ADCQ R13, BX
	MOVQ $0xdb330b098939af34, R13
	ADCQ R13, SI
	MOVQ $0x503e6398b806e18a, R13
	ADCQ R13, DI
	MOVQ $0xcc1dbde7aa0318b8, R13
	ADCQ R13, R8
	MOVQ $0x1681c65c781ebbe5, R13
	ADCQ R13, R9
	MOVQ $0x5ae659dce647df89, R13
	ADCQ R13, R10
	MOVQ $0x00000000000003aa, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x913a3462871f6df3, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xf8aa2aca1b57eeaf, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x81f3fab95222f3ed, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xd2d321e706515b31, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xdb330b098939af34, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x503e6398b806e18a, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xcc1dbde7aa0318b8, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x1681c65c781ebbe5, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x5ae659dce647df89, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000000003aa, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x913a3462871f6df3, AX
	ADDQ AX, DX
	MOVQ $0xf8aa2aca1b57eeaf, AX
	ADCQ AX, CX
	MOVQ $0x81f3fab95222f3ed, AX
	ADCQ AX, BX
	MOVQ $0xd2d321e706515b31, AX
	ADCQ AX, SI
	MOVQ $0xdb330b098939af34, AX
	ADCQ AX, DI
	MOVQ $0x503e6398b806e18a, AX
	ADCQ AX, R8
	MOVQ $0xcc1dbde7aa0318b8, AX
	ADCQ AX, R9
	MOVQ $0x1681c65c781ebbe5, AX
	ADCQ AX, R10
	MOVQ $0x5ae659dce647df89, AX
	ADCQ AX, R11
	MOVQ $0x00000000000003aa, AX
	ADCQ AX, R12
