...
var benchRese_nocarry_0642 e_nocarry_0642

func BenchmarkE_nocarry_0642SetBytes(b *testing.B) {
	var x e_nocarry_0642
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0642MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0642.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0642)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0642)
		}
	})
}

func BenchmarkE_nocarry_0642Inverse(b *testing.B) {
	var x e_nocarry_0642
	x.SetRandom()
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0642Butterfly(b *testing.B) {
	var x e_nocarry_0642
	x.SetRandom()
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0642)
	}
}

func BenchmarkE_nocarry_0642Exp(b *testing.B) {
	var x e_nocarry_0642
	x.SetRandom()
	benchRese_nocarry_0642.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0642Double(b *testing.B) {
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Double(&benchRese_nocarry_0642)
	}
}

func BenchmarkE_nocarry_0642Add(b *testing.B) {
	var x e_nocarry_0642
	x.SetRandom()
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Add(&x, &benchRese_nocarry_0642)
	}
}

func BenchmarkE_nocarry_0642Sub(b *testing.B) {
	var x e_nocarry_0642
	x.SetRandom()
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Sub(&x, &benchRese_nocarry_0642)
	}
}

func BenchmarkE_nocarry_0642Neg(b *testing.B) {
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Neg(&benchRese_nocarry_0642)
	}
}

func BenchmarkE_nocarry_0642Div(b *testing.B) {
	var x e_nocarry_0642
	x.SetRandom()
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Div(&x, &benchRese_nocarry_0642)
	}
}

func BenchmarkE_nocarry_0642FromMont(b *testing.B) {
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.FromMont()
	}
}

func BenchmarkE_nocarry_0642ToMont(b *testing.B) {
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.ToMont()
	}
}
func BenchmarkE_nocarry_0642Square(b *testing.B) {
	benchRese_nocarry_0642.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Square(&benchRese_nocarry_0642)
	}
}

func BenchmarkE_nocarry_0642Sqrt(b *testing.B) {
	var a e_nocarry_0642
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0642Mul(b *testing.B) {
	x := e_nocarry_0642{
	...
	benchRese_nocarry_0642.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Mul(&benchRese_nocarry_0642, &x)
	}
}

func BenchmarkE_nocarry_0642Cmp(b *testing.B) {
	x := e_nocarry_0642{
		17119968973329583766,
		14516464940086081425,
		2791200834222007299,
	...
	benchRese_nocarry_0642 = x
	benchRese_nocarry_0642[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0642.Cmp(&x)
	}
}

func TestE_nocarry_0642Cmp(t *testing.T) {
	var x, y e_nocarry_0642
...
func TestE_nocarry_0642IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0642
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0642

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0642{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0642
	one.SetOne()
	e.Sub(&qe_nocarry_0642, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0642{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0642{0, uint64(i)})
	}
...
func TestE_nocarry_0642NegZero(t *testing.T) {
	var a, b e_nocarry_0642
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0642Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0642, len(staticTestValues))
...
func TestE_nocarry_0642Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0642) bool {
			var b e_nocarry_0642
...
func TestE_nocarry_0642InverseExp(t *testing.T) {
...
func TestE_nocarry_0642MulByConstants(t *testing.T) {
...
func TestE_nocarry_0642Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0642) bool {
...
func TestE_nocarry_0642LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0642Halve(t *testing.T) {
...
func TestE_nocarry_0642FromMont(t *testing.T) {
...
type testPaire_nocarry_0642 struct {
	element e_nocarry_0642
	bigint  big.Int
}

func (z *e_nocarry_0642) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0642[10] {
		return true
	}
	if z[10] < qe_nocarry_0642[10] {
		return false
	...
	return z[0] >= qe_nocarry_0642[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0642

		g.element = e_nocarry_0642{
		...
		if qe_nocarry_0642[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0642[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0642 {
			var g e_nocarry_0642
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0642[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0642[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0642[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0642[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0642[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0642[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0642[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0642[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0642[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0642[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0642[10], carry)
...
func Benchmarke_nocarry_0642InverseNew(b *testing.B) {
	var x e_nocarry_0642
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0642
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0642
		var xInv e_nocarry_0642
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0642
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0642
...
func testLinearComb(t *testing.T, x *e_nocarry_0642, xC int64, y *e_nocarry_0642, yC int64) {
	...
	var z e_nocarry_0642
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0642, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0642
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0642, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0642
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0642, xHi uint64) {
	var res e_nocarry_0642
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0642) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0642) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0642, c int64, result *e_nocarry_0642, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0642) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0642) uint64 {
