...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xcc9e04f5a3383ec5, R14
	ADDQ R14, AX
	MOVQ $0x789da2d6e3ffd0c1, R14
	ADCQ R14, DX
	MOVQ $0xc879a9f025aeee2e, R14
	ADCQ R14, CX
	MOVQ $0xfceac2f2f11d6e00, R14
	ADCQ R14, BX
	MOVQ $0xfe67ee319d74c1b2, R14
	ADCQ R14, SI
	MOVQ $0xf6fddfa3a30506cb, R14
	ADCQ R14, DI
	MOVQ $0xf3abc795cc747148, R14
	ADCQ R14, R8
	MOVQ $0x502151fe223b7e6c, R14
	ADCQ R14, R9
	MOVQ $0x6815c1ee77f20627, R14
	ADCQ R14, R10
	MOVQ $0x0066e7f13b75c49e, R14
	ADCQ R14, R11
	MOVQ $0x0000000000000003, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xcc9e04f5a3383ec5, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x789da2d6e3ffd0c1, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xc879a9f025aeee2e, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xfceac2f2f11d6e00, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xfe67ee319d74c1b2, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xf6fddfa3a30506cb, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xf3abc795cc747148, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x502151fe223b7e6c, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x6815c1ee77f20627, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x0066e7f13b75c49e, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xcc9e04f5a3383ec5, AX
	ADDQ AX, DX
	MOVQ $0x789da2d6e3ffd0c1, AX
	ADCQ AX, CX
	MOVQ $0xc879a9f025aeee2e, AX
	ADCQ AX, BX
	MOVQ $0xfceac2f2f11d6e00, AX
	ADCQ AX, SI
	MOVQ $0xfe67ee319d74c1b2, AX
	ADCQ AX, DI
	MOVQ $0xf6fddfa3a30506cb, AX
	ADCQ AX, R8
	MOVQ $0xf3abc795cc747148, AX
	ADCQ AX, R9
	MOVQ $0x502151fe223b7e6c, AX
	ADCQ AX, R10
	MOVQ $0x6815c1ee77f20627, AX
	ADCQ AX, R11
	MOVQ $0x0066e7f13b75c49e, AX
	ADCQ AX, R12
