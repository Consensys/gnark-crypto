...
var benchRese_nocarry_0590 e_nocarry_0590

func BenchmarkE_nocarry_0590SetBytes(b *testing.B) {
	var x e_nocarry_0590
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0590MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0590.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0590)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0590)
		}
	})
}

func BenchmarkE_nocarry_0590Inverse(b *testing.B) {
	var x e_nocarry_0590
	x.SetRandom()
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0590Butterfly(b *testing.B) {
	var x e_nocarry_0590
	x.SetRandom()
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0590)
	}
}

func BenchmarkE_nocarry_0590Exp(b *testing.B) {
	var x e_nocarry_0590
	x.SetRandom()
	benchRese_nocarry_0590.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0590Double(b *testing.B) {
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Double(&benchRese_nocarry_0590)
	}
}

func BenchmarkE_nocarry_0590Add(b *testing.B) {
	var x e_nocarry_0590
	x.SetRandom()
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Add(&x, &benchRese_nocarry_0590)
	}
}

func BenchmarkE_nocarry_0590Sub(b *testing.B) {
	var x e_nocarry_0590
	x.SetRandom()
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Sub(&x, &benchRese_nocarry_0590)
	}
}

func BenchmarkE_nocarry_0590Neg(b *testing.B) {
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Neg(&benchRese_nocarry_0590)
	}
}

func BenchmarkE_nocarry_0590Div(b *testing.B) {
	var x e_nocarry_0590
	x.SetRandom()
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Div(&x, &benchRese_nocarry_0590)
	}
}

func BenchmarkE_nocarry_0590FromMont(b *testing.B) {
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.FromMont()
	}
}

func BenchmarkE_nocarry_0590ToMont(b *testing.B) {
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.ToMont()
	}
}
func BenchmarkE_nocarry_0590Square(b *testing.B) {
	benchRese_nocarry_0590.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Square(&benchRese_nocarry_0590)
	}
}

func BenchmarkE_nocarry_0590Sqrt(b *testing.B) {
	var a e_nocarry_0590
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0590Mul(b *testing.B) {
	x := e_nocarry_0590{
		6539659131177849859,
		2607175842794713847,
		950947200040000835,
	...
	benchRese_nocarry_0590.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Mul(&benchRese_nocarry_0590, &x)
	}
}

func BenchmarkE_nocarry_0590Cmp(b *testing.B) {
	x := e_nocarry_0590{
		6539659131177849859,
		2607175842794713847,
		950947200040000835,
	...
	benchRese_nocarry_0590 = x
	benchRese_nocarry_0590[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0590.Cmp(&x)
	}
}

func TestE_nocarry_0590Cmp(t *testing.T) {
	var x, y e_nocarry_0590
...
func TestE_nocarry_0590IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0590
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0590

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0590{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0590
	one.SetOne()
	e.Sub(&qe_nocarry_0590, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0590{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0590{0, uint64(i)})
	}
...
func TestE_nocarry_0590NegZero(t *testing.T) {
	var a, b e_nocarry_0590
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0590Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0590, len(staticTestValues))
...
func TestE_nocarry_0590Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0590) bool {
			var b e_nocarry_0590
...
func TestE_nocarry_0590InverseExp(t *testing.T) {
...
func TestE_nocarry_0590MulByConstants(t *testing.T) {
...
func TestE_nocarry_0590Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0590) bool {
...
func TestE_nocarry_0590LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0590Halve(t *testing.T) {
...
func TestE_nocarry_0590FromMont(t *testing.T) {
...
type testPaire_nocarry_0590 struct {
	element e_nocarry_0590
	bigint  big.Int
}

func (z *e_nocarry_0590) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0590[9] {
		return true
	}
	if z[9] < qe_nocarry_0590[9] {
		return false
	...
	return z[0] >= qe_nocarry_0590[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0590

		g.element = e_nocarry_0590{
		...
		if qe_nocarry_0590[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0590[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0590 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0590[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0590[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0590[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0590[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0590[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0590[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0590[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0590[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0590[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0590[9], carry)
...
func Benchmarke_nocarry_0590InverseNew(b *testing.B) {
	var x e_nocarry_0590
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0590
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0590
		var xInv e_nocarry_0590
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0590
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0590
...
func testLinearComb(t *testing.T, x *e_nocarry_0590, xC int64, y *e_nocarry_0590, yC int64) {
	...
	var z e_nocarry_0590
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0590, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0590
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0590, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0590
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0590, xHi uint64) {
	var res e_nocarry_0590
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0590) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0590) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0590, c int64, result *e_nocarry_0590, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0590) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0590) uint64 {
