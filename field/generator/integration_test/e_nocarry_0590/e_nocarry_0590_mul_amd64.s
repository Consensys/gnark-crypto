...
// modulus q
DATA q<>+0(SB)/8, $0x94fb44c4b3547599
DATA q<>+8(SB)/8, $0x31afc9bc31cfb99e
DATA q<>+16(SB)/8, $0xd159affe192b3c61
DATA q<>+24(SB)/8, $0x6946d0cfec83eacf
DATA q<>+32(SB)/8, $0x39c09dd302d803eb
DATA q<>+40(SB)/8, $0x628eecfda93ab63a
DATA q<>+48(SB)/8, $0xca499809210e4899
DATA q<>+56(SB)/8, $0x59833759e6d1c4bd
DATA q<>+64(SB)/8, $0xe622faae2b52b0be
DATA q<>+72(SB)/8, $0x0000000000003ca9
GLOBL q<>(SB), (RODATA+NOPTR), $80

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xc9d41ba268aff157
