...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x94fb44c4b3547599, R13
	ADDQ R13, AX
	MOVQ $0x31afc9bc31cfb99e, R13
	ADCQ R13, DX
	MOVQ $0xd159affe192b3c61, R13
	ADCQ R13, CX
	MOVQ $0x6946d0cfec83eacf, R13
	ADCQ R13, BX
	MOVQ $0x39c09dd302d803eb, R13
	ADCQ R13, SI
	MOVQ $0x628eecfda93ab63a, R13
	ADCQ R13, DI
	MOVQ $0xca499809210e4899, R13
	ADCQ R13, R8
	MOVQ $0x59833759e6d1c4bd, R13
	ADCQ R13, R9
	MOVQ $0xe622faae2b52b0be, R13
	ADCQ R13, R10
	MOVQ $0x0000000000003ca9, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x94fb44c4b3547599, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x31afc9bc31cfb99e, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xd159affe192b3c61, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x6946d0cfec83eacf, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x39c09dd302d803eb, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x628eecfda93ab63a, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xca499809210e4899, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x59833759e6d1c4bd, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xe622faae2b52b0be, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000000003ca9, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x94fb44c4b3547599, AX
	ADDQ AX, DX
	MOVQ $0x31afc9bc31cfb99e, AX
	ADCQ AX, CX
	MOVQ $0xd159affe192b3c61, AX
	ADCQ AX, BX
	MOVQ $0x6946d0cfec83eacf, AX
	ADCQ AX, SI
	MOVQ $0x39c09dd302d803eb, AX
	ADCQ AX, DI
	MOVQ $0x628eecfda93ab63a, AX
	ADCQ AX, R8
	MOVQ $0xca499809210e4899, AX
	ADCQ AX, R9
	MOVQ $0x59833759e6d1c4bd, AX
	ADCQ AX, R10
	MOVQ $0xe622faae2b52b0be, AX
	ADCQ AX, R11
	MOVQ $0x0000000000003ca9, AX
	ADCQ AX, R12
