...
// modulus q
DATA q<>+0(SB)/8, $0x0408bad04a486255
DATA q<>+8(SB)/8, $0x82ff6806652f38b9
DATA q<>+16(SB)/8, $0x4135424732910360
DATA q<>+24(SB)/8, $0xa7176d94c7a9be06
DATA q<>+32(SB)/8, $0x01af1095cb029fcf
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xb3d5dbc32d5e7503
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x0408bad04a486255, R9
	MOVQ    $0x82ff6806652f38b9, R10
	MOVQ    $0x4135424732910360, R11
	MOVQ    $0xa7176d94c7a9be06, R12
	MOVQ    $0x01af1095cb029fcf, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x82ff6806652f38b9, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x4135424732910360, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xa7176d94c7a9be06, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x01af1095cb029fcf, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x0408bad04a486255, CX
	MOVQ    $0x82ff6806652f38b9, BX
	MOVQ    $0x4135424732910360, SI
	MOVQ    $0xa7176d94c7a9be06, DI
	MOVQ    $0x01af1095cb029fcf, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
