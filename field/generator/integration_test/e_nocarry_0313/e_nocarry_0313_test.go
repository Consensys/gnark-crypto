...
var benchRese_nocarry_0313 e_nocarry_0313

func BenchmarkE_nocarry_0313SetBytes(b *testing.B) {
	var x e_nocarry_0313
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0313MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0313.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0313)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0313)
		}
	})
}

func BenchmarkE_nocarry_0313Inverse(b *testing.B) {
	var x e_nocarry_0313
	x.SetRandom()
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0313Butterfly(b *testing.B) {
	var x e_nocarry_0313
	x.SetRandom()
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0313)
	}
}

func BenchmarkE_nocarry_0313Exp(b *testing.B) {
	var x e_nocarry_0313
	x.SetRandom()
	benchRese_nocarry_0313.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0313Double(b *testing.B) {
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Double(&benchRese_nocarry_0313)
	}
}

func BenchmarkE_nocarry_0313Add(b *testing.B) {
	var x e_nocarry_0313
	x.SetRandom()
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Add(&x, &benchRese_nocarry_0313)
	}
}

func BenchmarkE_nocarry_0313Sub(b *testing.B) {
	var x e_nocarry_0313
	x.SetRandom()
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Sub(&x, &benchRese_nocarry_0313)
	}
}

func BenchmarkE_nocarry_0313Neg(b *testing.B) {
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Neg(&benchRese_nocarry_0313)
	}
}

func BenchmarkE_nocarry_0313Div(b *testing.B) {
	var x e_nocarry_0313
	x.SetRandom()
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Div(&x, &benchRese_nocarry_0313)
	}
}

func BenchmarkE_nocarry_0313FromMont(b *testing.B) {
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.FromMont()
	}
}

func BenchmarkE_nocarry_0313ToMont(b *testing.B) {
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.ToMont()
	}
}
func BenchmarkE_nocarry_0313Square(b *testing.B) {
	benchRese_nocarry_0313.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Square(&benchRese_nocarry_0313)
	}
}

func BenchmarkE_nocarry_0313Sqrt(b *testing.B) {
	var a e_nocarry_0313
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0313Mul(b *testing.B) {
	x := e_nocarry_0313{
	...
	benchRese_nocarry_0313.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Mul(&benchRese_nocarry_0313, &x)
	}
}

func BenchmarkE_nocarry_0313Cmp(b *testing.B) {
	x := e_nocarry_0313{
		11165683150578834731,
		15526839742327131092,
		13882580525948320212,
	...
	benchRese_nocarry_0313 = x
	benchRese_nocarry_0313[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0313.Cmp(&x)
	}
}

func TestE_nocarry_0313Cmp(t *testing.T) {
	var x, y e_nocarry_0313
...
func TestE_nocarry_0313IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0313
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0313

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0313{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0313
	one.SetOne()
	e.Sub(&qe_nocarry_0313, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0313{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0313{0, uint64(i)})
	}
...
func TestE_nocarry_0313NegZero(t *testing.T) {
	var a, b e_nocarry_0313
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0313Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0313, len(staticTestValues))
...
func TestE_nocarry_0313Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0313) bool {
			var b e_nocarry_0313
...
func TestE_nocarry_0313InverseExp(t *testing.T) {
...
func TestE_nocarry_0313MulByConstants(t *testing.T) {
...
func TestE_nocarry_0313Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0313) bool {
...
func TestE_nocarry_0313LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0313Halve(t *testing.T) {
...
func TestE_nocarry_0313FromMont(t *testing.T) {
...
type testPaire_nocarry_0313 struct {
	element e_nocarry_0313
	bigint  big.Int
}

func (z *e_nocarry_0313) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0313[4] {
		return true
	}
	if z[4] < qe_nocarry_0313[4] {
		return false
	...
	return z[0] >= qe_nocarry_0313[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0313

		g.element = e_nocarry_0313{
		...
		if qe_nocarry_0313[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0313[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0313 {
			var g e_nocarry_0313
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0313[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0313[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0313[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0313[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0313[4], carry)
...
func Benchmarke_nocarry_0313InverseNew(b *testing.B) {
	var x e_nocarry_0313
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0313
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0313
		var xInv e_nocarry_0313
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0313
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0313
...
func testLinearComb(t *testing.T, x *e_nocarry_0313, xC int64, y *e_nocarry_0313, yC int64) {
	...
	var z e_nocarry_0313
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0313, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0313
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0313, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0313
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0313, xHi uint64) {
	var res e_nocarry_0313
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0313) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0313) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0313, c int64, result *e_nocarry_0313, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0313) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0313) uint64 {
