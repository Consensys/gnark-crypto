...
var benchRese_nocarry_0122 e_nocarry_0122

func BenchmarkE_nocarry_0122SetBytes(b *testing.B) {
	var x e_nocarry_0122
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0122MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0122.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0122)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0122)
		}
	})
}

func BenchmarkE_nocarry_0122Inverse(b *testing.B) {
	var x e_nocarry_0122
	x.SetRandom()
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0122Butterfly(b *testing.B) {
	var x e_nocarry_0122
	x.SetRandom()
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0122)
	}
}

func BenchmarkE_nocarry_0122Exp(b *testing.B) {
	var x e_nocarry_0122
	x.SetRandom()
	benchRese_nocarry_0122.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0122Double(b *testing.B) {
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Double(&benchRese_nocarry_0122)
	}
}

func BenchmarkE_nocarry_0122Add(b *testing.B) {
	var x e_nocarry_0122
	x.SetRandom()
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Add(&x, &benchRese_nocarry_0122)
	}
}

func BenchmarkE_nocarry_0122Sub(b *testing.B) {
	var x e_nocarry_0122
	x.SetRandom()
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Sub(&x, &benchRese_nocarry_0122)
	}
}

func BenchmarkE_nocarry_0122Neg(b *testing.B) {
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Neg(&benchRese_nocarry_0122)
	}
}

func BenchmarkE_nocarry_0122Div(b *testing.B) {
	var x e_nocarry_0122
	x.SetRandom()
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Div(&x, &benchRese_nocarry_0122)
	}
}

func BenchmarkE_nocarry_0122FromMont(b *testing.B) {
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.FromMont()
	}
}

func BenchmarkE_nocarry_0122ToMont(b *testing.B) {
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.ToMont()
	}
}
func BenchmarkE_nocarry_0122Square(b *testing.B) {
	benchRese_nocarry_0122.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Square(&benchRese_nocarry_0122)
	}
}

func BenchmarkE_nocarry_0122Sqrt(b *testing.B) {
	var a e_nocarry_0122
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0122Mul(b *testing.B) {
	x := e_nocarry_0122{
		5381327895321290236,
		133915554298862671,
	}
	benchRese_nocarry_0122.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Mul(&benchRese_nocarry_0122, &x)
	}
}

func BenchmarkE_nocarry_0122Cmp(b *testing.B) {
	x := e_nocarry_0122{
		5381327895321290236,
		133915554298862671,
	}
	benchRese_nocarry_0122 = x
	benchRese_nocarry_0122[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0122.Cmp(&x)
	}
}

func TestE_nocarry_0122Cmp(t *testing.T) {
	var x, y e_nocarry_0122
...
func TestE_nocarry_0122IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0122
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0122

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0122{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0122
	one.SetOne()
	e.Sub(&qe_nocarry_0122, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0122{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0122{0, uint64(i)})
	}
...
func TestE_nocarry_0122NegZero(t *testing.T) {
	var a, b e_nocarry_0122
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0122Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0122, len(staticTestValues))
...
func TestE_nocarry_0122Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0122) bool {
			var b e_nocarry_0122
...
func TestE_nocarry_0122InverseExp(t *testing.T) {
...
func TestE_nocarry_0122MulByConstants(t *testing.T) {
...
func TestE_nocarry_0122Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0122) bool {
...
func TestE_nocarry_0122LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0122Halve(t *testing.T) {
...
func TestE_nocarry_0122FromMont(t *testing.T) {
...
type testPaire_nocarry_0122 struct {
	element e_nocarry_0122
	bigint  big.Int
}

func (z *e_nocarry_0122) biggerOrEqualModulus() bool {
	if z[1] > qe_nocarry_0122[1] {
		return true
	}
	if z[1] < qe_nocarry_0122[1] {
		return false
	...
	return z[0] >= qe_nocarry_0122[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0122

		g.element = e_nocarry_0122{
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0122[1] != ^uint64(0) {
			g.element[1] %= (qe_nocarry_0122[1] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0122 {
			var g e_nocarry_0122
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0122[0], carry)
		a[1], _ = bits.Add64(a[1], qe_nocarry_0122[1], carry)
...
func Benchmarke_nocarry_0122InverseNew(b *testing.B) {
	var x e_nocarry_0122
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0122
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0122
		var xInv e_nocarry_0122
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0122
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0122
...
func testLinearComb(t *testing.T, x *e_nocarry_0122, xC int64, y *e_nocarry_0122, yC int64) {
	...
	var z e_nocarry_0122
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0122, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0122
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0122, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0122
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0122, xHi uint64) {
	var res e_nocarry_0122
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0122) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0122) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0122, c int64, result *e_nocarry_0122, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0122) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0122) uint64 {
