...
// modulus q
DATA q<>+0(SB)/8, $0x3da894b9cec37cc5
DATA q<>+8(SB)/8, $0x0311c83a26df4fb9
GLOBL q<>(SB), (RODATA+NOPTR), $16

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x60d29360b3795df3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SUBQ    0(CX), AX
	SBBQ    8(CX), DX
	MOVQ    $0x3da894b9cec37cc5, SI
	MOVQ    $0x0311c83a26df4fb9, DI
	CMOVQCC BX, SI
	CMOVQCC BX, DI
	ADDQ    SI, AX
	ADCQ    DI, DX
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SUBQ    0(DX), SI
	SBBQ    8(DX), DI
	MOVQ    $0x3da894b9cec37cc5, R8
	MOVQ    $0x0311c83a26df4fb9, R9
	CMOVQCC AX, R8
	CMOVQCC AX, R9
	ADDQ    R8, SI
	ADCQ    R9, DI
