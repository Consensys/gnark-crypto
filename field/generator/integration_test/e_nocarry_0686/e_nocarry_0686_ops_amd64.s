...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x14b4f0bdc71b5a35, R14
	ADDQ R14, AX
	MOVQ $0x219ca5aba67b564e, R14
	ADCQ R14, DX
	MOVQ $0xff37a6516575932e, R14
	ADCQ R14, CX
	MOVQ $0x571a6a23f674a259, R14
	ADCQ R14, BX
	MOVQ $0xe1251c3cea89a606, R14
	ADCQ R14, SI
	MOVQ $0x8d8bd53a0efa90a1, R14
	ADCQ R14, DI
	MOVQ $0x9745c85fce328579, R14
	ADCQ R14, R8
	MOVQ $0xab8915df9c381359, R14
	ADCQ R14, R9
	MOVQ $0x2f45db64c472a0cb, R14
	ADCQ R14, R10
	MOVQ $0x997f5a4cf7fecc7d, R14
	ADCQ R14, R11
	MOVQ $0x00003cd7a14a049e, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x14b4f0bdc71b5a35, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x219ca5aba67b564e, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xff37a6516575932e, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x571a6a23f674a259, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xe1251c3cea89a606, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x8d8bd53a0efa90a1, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x9745c85fce328579, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xab8915df9c381359, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x2f45db64c472a0cb, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x997f5a4cf7fecc7d, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00003cd7a14a049e, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x14b4f0bdc71b5a35, AX
	ADDQ AX, DX
	MOVQ $0x219ca5aba67b564e, AX
	ADCQ AX, CX
	MOVQ $0xff37a6516575932e, AX
	ADCQ AX, BX
	MOVQ $0x571a6a23f674a259, AX
	ADCQ AX, SI
	MOVQ $0xe1251c3cea89a606, AX
	ADCQ AX, DI
	MOVQ $0x8d8bd53a0efa90a1, AX
	ADCQ AX, R8
	MOVQ $0x9745c85fce328579, AX
	ADCQ AX, R9
	MOVQ $0xab8915df9c381359, AX
	ADCQ AX, R10
	MOVQ $0x2f45db64c472a0cb, AX
	ADCQ AX, R11
	MOVQ $0x997f5a4cf7fecc7d, AX
	ADCQ AX, R12
	MOVQ $0x00003cd7a14a049e, AX
	ADCQ AX, R13
