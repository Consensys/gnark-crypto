...
// modulus q
DATA q<>+0(SB)/8, $0x14b4f0bdc71b5a35
DATA q<>+8(SB)/8, $0x219ca5aba67b564e
DATA q<>+16(SB)/8, $0xff37a6516575932e
DATA q<>+24(SB)/8, $0x571a6a23f674a259
DATA q<>+32(SB)/8, $0xe1251c3cea89a606
DATA q<>+40(SB)/8, $0x8d8bd53a0efa90a1
DATA q<>+48(SB)/8, $0x9745c85fce328579
DATA q<>+56(SB)/8, $0xab8915df9c381359
DATA q<>+64(SB)/8, $0x2f45db64c472a0cb
DATA q<>+72(SB)/8, $0x997f5a4cf7fecc7d
DATA q<>+80(SB)/8, $0x00003cd7a14a049e
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x500e8b3d859b57e3
