...
var benchRese_nocarry_0686 e_nocarry_0686

func BenchmarkE_nocarry_0686SetBytes(b *testing.B) {
	var x e_nocarry_0686
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0686MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0686.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0686)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0686)
		}
	})
}

func BenchmarkE_nocarry_0686Inverse(b *testing.B) {
	var x e_nocarry_0686
	x.SetRandom()
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0686Butterfly(b *testing.B) {
	var x e_nocarry_0686
	x.SetRandom()
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0686)
	}
}

func BenchmarkE_nocarry_0686Exp(b *testing.B) {
	var x e_nocarry_0686
	x.SetRandom()
	benchRese_nocarry_0686.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0686Double(b *testing.B) {
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Double(&benchRese_nocarry_0686)
	}
}

func BenchmarkE_nocarry_0686Add(b *testing.B) {
	var x e_nocarry_0686
	x.SetRandom()
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Add(&x, &benchRese_nocarry_0686)
	}
}

func BenchmarkE_nocarry_0686Sub(b *testing.B) {
	var x e_nocarry_0686
	x.SetRandom()
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Sub(&x, &benchRese_nocarry_0686)
	}
}

func BenchmarkE_nocarry_0686Neg(b *testing.B) {
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Neg(&benchRese_nocarry_0686)
	}
}

func BenchmarkE_nocarry_0686Div(b *testing.B) {
	var x e_nocarry_0686
	x.SetRandom()
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Div(&x, &benchRese_nocarry_0686)
	}
}

func BenchmarkE_nocarry_0686FromMont(b *testing.B) {
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.FromMont()
	}
}

func BenchmarkE_nocarry_0686ToMont(b *testing.B) {
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.ToMont()
	}
}
func BenchmarkE_nocarry_0686Square(b *testing.B) {
	benchRese_nocarry_0686.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Square(&benchRese_nocarry_0686)
	}
}

func BenchmarkE_nocarry_0686Sqrt(b *testing.B) {
	var a e_nocarry_0686
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0686Mul(b *testing.B) {
	x := e_nocarry_0686{
	...
	benchRese_nocarry_0686.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Mul(&benchRese_nocarry_0686, &x)
	}
}

func BenchmarkE_nocarry_0686Cmp(b *testing.B) {
	x := e_nocarry_0686{
		10805276095284855908,
		3791189911486664775,
		11876795632511122650,
	...
	benchRese_nocarry_0686 = x
	benchRese_nocarry_0686[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0686.Cmp(&x)
	}
}

func TestE_nocarry_0686Cmp(t *testing.T) {
	var x, y e_nocarry_0686
...
func TestE_nocarry_0686IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0686
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0686

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0686{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0686
	one.SetOne()
	e.Sub(&qe_nocarry_0686, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0686{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0686{0, uint64(i)})
	}
...
func TestE_nocarry_0686NegZero(t *testing.T) {
	var a, b e_nocarry_0686
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0686Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0686, len(staticTestValues))
...
func TestE_nocarry_0686Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0686) bool {
			var b e_nocarry_0686
...
func TestE_nocarry_0686InverseExp(t *testing.T) {
...
func TestE_nocarry_0686MulByConstants(t *testing.T) {
...
func TestE_nocarry_0686Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0686) bool {
...
func TestE_nocarry_0686LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0686Halve(t *testing.T) {
...
func TestE_nocarry_0686FromMont(t *testing.T) {
...
type testPaire_nocarry_0686 struct {
	element e_nocarry_0686
	bigint  big.Int
}

func (z *e_nocarry_0686) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0686[10] {
		return true
	}
	if z[10] < qe_nocarry_0686[10] {
		return false
	...
	return z[0] >= qe_nocarry_0686[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0686

		g.element = e_nocarry_0686{
		...
		if qe_nocarry_0686[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0686[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0686 {
			var g e_nocarry_0686
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0686[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0686[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0686[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0686[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0686[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0686[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0686[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0686[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0686[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0686[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0686[10], carry)
...
func Benchmarke_nocarry_0686InverseNew(b *testing.B) {
	var x e_nocarry_0686
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0686
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0686
		var xInv e_nocarry_0686
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0686
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0686
...
func testLinearComb(t *testing.T, x *e_nocarry_0686, xC int64, y *e_nocarry_0686, yC int64) {
	...
	var z e_nocarry_0686
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0686, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0686
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0686, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0686
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0686, xHi uint64) {
	var res e_nocarry_0686
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0686) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0686) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0686, c int64, result *e_nocarry_0686, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0686) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0686) uint64 {
