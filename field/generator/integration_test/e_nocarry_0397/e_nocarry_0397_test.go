...
var benchRese_nocarry_0397 e_nocarry_0397

func BenchmarkE_nocarry_0397SetBytes(b *testing.B) {
	var x e_nocarry_0397
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0397MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0397.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0397)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0397)
		}
	})
}

func BenchmarkE_nocarry_0397Inverse(b *testing.B) {
	var x e_nocarry_0397
	x.SetRandom()
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0397Butterfly(b *testing.B) {
	var x e_nocarry_0397
	x.SetRandom()
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0397)
	}
}

func BenchmarkE_nocarry_0397Exp(b *testing.B) {
	var x e_nocarry_0397
	x.SetRandom()
	benchRese_nocarry_0397.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0397Double(b *testing.B) {
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Double(&benchRese_nocarry_0397)
	}
}

func BenchmarkE_nocarry_0397Add(b *testing.B) {
	var x e_nocarry_0397
	x.SetRandom()
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Add(&x, &benchRese_nocarry_0397)
	}
}

func BenchmarkE_nocarry_0397Sub(b *testing.B) {
	var x e_nocarry_0397
	x.SetRandom()
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Sub(&x, &benchRese_nocarry_0397)
	}
}

func BenchmarkE_nocarry_0397Neg(b *testing.B) {
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Neg(&benchRese_nocarry_0397)
	}
}

func BenchmarkE_nocarry_0397Div(b *testing.B) {
	var x e_nocarry_0397
	x.SetRandom()
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Div(&x, &benchRese_nocarry_0397)
	}
}

func BenchmarkE_nocarry_0397FromMont(b *testing.B) {
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.FromMont()
	}
}

func BenchmarkE_nocarry_0397ToMont(b *testing.B) {
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.ToMont()
	}
}
func BenchmarkE_nocarry_0397Square(b *testing.B) {
	benchRese_nocarry_0397.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Square(&benchRese_nocarry_0397)
	}
}

func BenchmarkE_nocarry_0397Sqrt(b *testing.B) {
	var a e_nocarry_0397
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0397Mul(b *testing.B) {
	x := e_nocarry_0397{
		9336030506658365539,
		4294683659198156278,
	...
	benchRese_nocarry_0397.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Mul(&benchRese_nocarry_0397, &x)
	}
}

func BenchmarkE_nocarry_0397Cmp(b *testing.B) {
	x := e_nocarry_0397{
		9336030506658365539,
		4294683659198156278,
		10985610767659393142,
	...
	benchRese_nocarry_0397 = x
	benchRese_nocarry_0397[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0397.Cmp(&x)
	}
}

func TestE_nocarry_0397Cmp(t *testing.T) {
	var x, y e_nocarry_0397
...
func TestE_nocarry_0397IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0397
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0397

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0397{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0397
	one.SetOne()
	e.Sub(&qe_nocarry_0397, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0397{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0397{0, uint64(i)})
	}
...
func TestE_nocarry_0397NegZero(t *testing.T) {
	var a, b e_nocarry_0397
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0397Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0397, len(staticTestValues))
...
func TestE_nocarry_0397Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0397) bool {
			var b e_nocarry_0397
...
func TestE_nocarry_0397InverseExp(t *testing.T) {
...
func TestE_nocarry_0397MulByConstants(t *testing.T) {
...
func TestE_nocarry_0397Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0397) bool {
...
func TestE_nocarry_0397LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0397Halve(t *testing.T) {
...
func TestE_nocarry_0397FromMont(t *testing.T) {
...
type testPaire_nocarry_0397 struct {
	element e_nocarry_0397
	bigint  big.Int
}

func (z *e_nocarry_0397) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0397[6] {
		return true
	}
	if z[6] < qe_nocarry_0397[6] {
		return false
	...
	return z[0] >= qe_nocarry_0397[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0397

		g.element = e_nocarry_0397{
		...
		if qe_nocarry_0397[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0397[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0397 {
			var g e_nocarry_0397
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0397[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0397[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0397[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0397[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0397[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0397[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0397[6], carry)
...
func Benchmarke_nocarry_0397InverseNew(b *testing.B) {
	var x e_nocarry_0397
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0397
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0397
		var xInv e_nocarry_0397
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0397
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0397
...
func testLinearComb(t *testing.T, x *e_nocarry_0397, xC int64, y *e_nocarry_0397, yC int64) {
	...
	var z e_nocarry_0397
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0397, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0397
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0397, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0397
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0397, xHi uint64) {
	var res e_nocarry_0397
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0397) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0397) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0397, c int64, result *e_nocarry_0397, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0397) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0397) uint64 {
