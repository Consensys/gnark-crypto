...
var benchRese_nocarry_0452 e_nocarry_0452

func BenchmarkE_nocarry_0452SetBytes(b *testing.B) {
	var x e_nocarry_0452
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0452MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0452.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0452)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0452)
		}
	})
}

func BenchmarkE_nocarry_0452Inverse(b *testing.B) {
	var x e_nocarry_0452
	x.SetRandom()
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0452Butterfly(b *testing.B) {
	var x e_nocarry_0452
	x.SetRandom()
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0452)
	}
}

func BenchmarkE_nocarry_0452Exp(b *testing.B) {
	var x e_nocarry_0452
	x.SetRandom()
	benchRese_nocarry_0452.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0452Double(b *testing.B) {
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Double(&benchRese_nocarry_0452)
	}
}

func BenchmarkE_nocarry_0452Add(b *testing.B) {
	var x e_nocarry_0452
	x.SetRandom()
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Add(&x, &benchRese_nocarry_0452)
	}
}

func BenchmarkE_nocarry_0452Sub(b *testing.B) {
	var x e_nocarry_0452
	x.SetRandom()
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Sub(&x, &benchRese_nocarry_0452)
	}
}

func BenchmarkE_nocarry_0452Neg(b *testing.B) {
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Neg(&benchRese_nocarry_0452)
	}
}

func BenchmarkE_nocarry_0452Div(b *testing.B) {
	var x e_nocarry_0452
	x.SetRandom()
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Div(&x, &benchRese_nocarry_0452)
	}
}

func BenchmarkE_nocarry_0452FromMont(b *testing.B) {
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.FromMont()
	}
}

func BenchmarkE_nocarry_0452ToMont(b *testing.B) {
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.ToMont()
	}
}
func BenchmarkE_nocarry_0452Square(b *testing.B) {
	benchRese_nocarry_0452.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Square(&benchRese_nocarry_0452)
	}
}

func BenchmarkE_nocarry_0452Sqrt(b *testing.B) {
	var a e_nocarry_0452
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0452Mul(b *testing.B) {
	x := e_nocarry_0452{
		7545444618122703291,
		5452484025392667896,
	...
	benchRese_nocarry_0452.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Mul(&benchRese_nocarry_0452, &x)
	}
}

func BenchmarkE_nocarry_0452Cmp(b *testing.B) {
	x := e_nocarry_0452{
		7545444618122703291,
		5452484025392667896,
		17391479670132891903,
	...
	benchRese_nocarry_0452 = x
	benchRese_nocarry_0452[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0452.Cmp(&x)
	}
}

func TestE_nocarry_0452Cmp(t *testing.T) {
	var x, y e_nocarry_0452
...
func TestE_nocarry_0452IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0452
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0452

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0452{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0452
	one.SetOne()
	e.Sub(&qe_nocarry_0452, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0452{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0452{0, uint64(i)})
	}
...
func TestE_nocarry_0452NegZero(t *testing.T) {
	var a, b e_nocarry_0452
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0452Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0452, len(staticTestValues))
...
func TestE_nocarry_0452Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0452) bool {
			var b e_nocarry_0452
...
func TestE_nocarry_0452InverseExp(t *testing.T) {
...
func TestE_nocarry_0452MulByConstants(t *testing.T) {
...
func TestE_nocarry_0452Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0452) bool {
...
func TestE_nocarry_0452LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0452Halve(t *testing.T) {
...
func TestE_nocarry_0452FromMont(t *testing.T) {
...
type testPaire_nocarry_0452 struct {
	element e_nocarry_0452
	bigint  big.Int
}

func (z *e_nocarry_0452) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0452[7] {
		return true
	}
	if z[7] < qe_nocarry_0452[7] {
		return false
	...
	return z[0] >= qe_nocarry_0452[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0452

		g.element = e_nocarry_0452{
		...
		if qe_nocarry_0452[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0452[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0452 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0452[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0452[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0452[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0452[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0452[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0452[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0452[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0452[7], carry)
...
func Benchmarke_nocarry_0452InverseNew(b *testing.B) {
	var x e_nocarry_0452
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0452
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0452
		var xInv e_nocarry_0452
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0452
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0452
...
func testLinearComb(t *testing.T, x *e_nocarry_0452, xC int64, y *e_nocarry_0452, yC int64) {
	...
	var z e_nocarry_0452
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0452, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0452
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0452, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0452
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0452, xHi uint64) {
	var res e_nocarry_0452
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0452) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0452) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0452, c int64, result *e_nocarry_0452, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0452) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0452) uint64 {
