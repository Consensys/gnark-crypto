...
// modulus q
DATA q<>+0(SB)/8, $0x4dfb4d2561ef12a3
DATA q<>+8(SB)/8, $0x9720933e64f1cffa
DATA q<>+16(SB)/8, $0xa863a0c9255fed69
DATA q<>+24(SB)/8, $0x01911ac96234db7d
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x5b392b12cd3ccef5
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x4dfb4d2561ef12a3, R8
	MOVQ    $0x9720933e64f1cffa, R9
	MOVQ    $0xa863a0c9255fed69, R10
	MOVQ    $0x01911ac96234db7d, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x9720933e64f1cffa, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xa863a0c9255fed69, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x01911ac96234db7d, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x4dfb4d2561ef12a3, R12
	MOVQ    $0x9720933e64f1cffa, R13
	MOVQ    $0xa863a0c9255fed69, R14
	MOVQ    $0x01911ac96234db7d, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
