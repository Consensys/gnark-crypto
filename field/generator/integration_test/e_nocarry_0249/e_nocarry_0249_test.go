...
var benchRese_nocarry_0249 e_nocarry_0249

func BenchmarkE_nocarry_0249SetBytes(b *testing.B) {
	var x e_nocarry_0249
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0249MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0249.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0249)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0249)
		}
	})
}

func BenchmarkE_nocarry_0249Inverse(b *testing.B) {
	var x e_nocarry_0249
	x.SetRandom()
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0249Butterfly(b *testing.B) {
	var x e_nocarry_0249
	x.SetRandom()
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0249)
	}
}

func BenchmarkE_nocarry_0249Exp(b *testing.B) {
	var x e_nocarry_0249
	x.SetRandom()
	benchRese_nocarry_0249.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0249Double(b *testing.B) {
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Double(&benchRese_nocarry_0249)
	}
}

func BenchmarkE_nocarry_0249Add(b *testing.B) {
	var x e_nocarry_0249
	x.SetRandom()
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Add(&x, &benchRese_nocarry_0249)
	}
}

func BenchmarkE_nocarry_0249Sub(b *testing.B) {
	var x e_nocarry_0249
	x.SetRandom()
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Sub(&x, &benchRese_nocarry_0249)
	}
}

func BenchmarkE_nocarry_0249Neg(b *testing.B) {
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Neg(&benchRese_nocarry_0249)
	}
}

func BenchmarkE_nocarry_0249Div(b *testing.B) {
	var x e_nocarry_0249
	x.SetRandom()
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Div(&x, &benchRese_nocarry_0249)
	}
}

func BenchmarkE_nocarry_0249FromMont(b *testing.B) {
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.FromMont()
	}
}

func BenchmarkE_nocarry_0249ToMont(b *testing.B) {
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.ToMont()
	}
}
func BenchmarkE_nocarry_0249Square(b *testing.B) {
	benchRese_nocarry_0249.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Square(&benchRese_nocarry_0249)
	}
}

func BenchmarkE_nocarry_0249Sqrt(b *testing.B) {
	var a e_nocarry_0249
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0249Mul(b *testing.B) {
	x := e_nocarry_0249{
	...
	benchRese_nocarry_0249.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Mul(&benchRese_nocarry_0249, &x)
	}
}

func BenchmarkE_nocarry_0249Cmp(b *testing.B) {
	x := e_nocarry_0249{
		10943753681098263892,
		13939212228832633222,
		3922422479949117253,
	...
	benchRese_nocarry_0249 = x
	benchRese_nocarry_0249[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0249.Cmp(&x)
	}
}

func TestE_nocarry_0249Cmp(t *testing.T) {
	var x, y e_nocarry_0249
...
func TestE_nocarry_0249IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0249
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0249

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0249{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0249
	one.SetOne()
	e.Sub(&qe_nocarry_0249, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0249{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0249{0, uint64(i)})
	}
...
func TestE_nocarry_0249NegZero(t *testing.T) {
	var a, b e_nocarry_0249
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0249Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0249, len(staticTestValues))
...
func TestE_nocarry_0249Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0249) bool {
			var b e_nocarry_0249
...
func TestE_nocarry_0249InverseExp(t *testing.T) {
...
func TestE_nocarry_0249MulByConstants(t *testing.T) {
...
func TestE_nocarry_0249Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0249) bool {
...
func TestE_nocarry_0249LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0249Halve(t *testing.T) {
...
func TestE_nocarry_0249FromMont(t *testing.T) {
...
type testPaire_nocarry_0249 struct {
	element e_nocarry_0249
	bigint  big.Int
}

func (z *e_nocarry_0249) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0249[3] {
		return true
	}
	if z[3] < qe_nocarry_0249[3] {
		return false
	...
	return z[0] >= qe_nocarry_0249[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0249

		g.element = e_nocarry_0249{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0249[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0249[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0249 {
			var g e_nocarry_0249
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0249[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0249[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0249[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0249[3], carry)
...
func Benchmarke_nocarry_0249InverseNew(b *testing.B) {
	var x e_nocarry_0249
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0249
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0249
		var xInv e_nocarry_0249
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0249
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0249
...
func testLinearComb(t *testing.T, x *e_nocarry_0249, xC int64, y *e_nocarry_0249, yC int64) {
	...
	var z e_nocarry_0249
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0249, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0249
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0249, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0249
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0249, xHi uint64) {
	var res e_nocarry_0249
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0249) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0249) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0249, c int64, result *e_nocarry_0249, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0249) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0249) uint64 {
