...
var benchRese_nocarry_0244 e_nocarry_0244

func BenchmarkE_nocarry_0244SetBytes(b *testing.B) {
	var x e_nocarry_0244
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0244MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0244.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0244)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0244)
		}
	})
}

func BenchmarkE_nocarry_0244Inverse(b *testing.B) {
	var x e_nocarry_0244
	x.SetRandom()
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0244Butterfly(b *testing.B) {
	var x e_nocarry_0244
	x.SetRandom()
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0244)
	}
}

func BenchmarkE_nocarry_0244Exp(b *testing.B) {
	var x e_nocarry_0244
	x.SetRandom()
	benchRese_nocarry_0244.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0244Double(b *testing.B) {
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Double(&benchRese_nocarry_0244)
	}
}

func BenchmarkE_nocarry_0244Add(b *testing.B) {
	var x e_nocarry_0244
	x.SetRandom()
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Add(&x, &benchRese_nocarry_0244)
	}
}

func BenchmarkE_nocarry_0244Sub(b *testing.B) {
	var x e_nocarry_0244
	x.SetRandom()
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Sub(&x, &benchRese_nocarry_0244)
	}
}

func BenchmarkE_nocarry_0244Neg(b *testing.B) {
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Neg(&benchRese_nocarry_0244)
	}
}

func BenchmarkE_nocarry_0244Div(b *testing.B) {
	var x e_nocarry_0244
	x.SetRandom()
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Div(&x, &benchRese_nocarry_0244)
	}
}

func BenchmarkE_nocarry_0244FromMont(b *testing.B) {
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.FromMont()
	}
}

func BenchmarkE_nocarry_0244ToMont(b *testing.B) {
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.ToMont()
	}
}
func BenchmarkE_nocarry_0244Square(b *testing.B) {
	benchRese_nocarry_0244.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Square(&benchRese_nocarry_0244)
	}
}

func BenchmarkE_nocarry_0244Sqrt(b *testing.B) {
	var a e_nocarry_0244
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0244Mul(b *testing.B) {
	x := e_nocarry_0244{
		6819402214929199612,
	...
	benchRese_nocarry_0244.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Mul(&benchRese_nocarry_0244, &x)
	}
}

func BenchmarkE_nocarry_0244Cmp(b *testing.B) {
	x := e_nocarry_0244{
		6819402214929199612,
		12721888115848532288,
		2850258079831307104,
	...
	benchRese_nocarry_0244 = x
	benchRese_nocarry_0244[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0244.Cmp(&x)
	}
}

func TestE_nocarry_0244Cmp(t *testing.T) {
	var x, y e_nocarry_0244
...
func TestE_nocarry_0244IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0244
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0244

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0244{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0244
	one.SetOne()
	e.Sub(&qe_nocarry_0244, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0244{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0244{0, uint64(i)})
	}
...
func TestE_nocarry_0244NegZero(t *testing.T) {
	var a, b e_nocarry_0244
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0244Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0244, len(staticTestValues))
...
func TestE_nocarry_0244Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0244) bool {
			var b e_nocarry_0244
...
func TestE_nocarry_0244InverseExp(t *testing.T) {
...
func TestE_nocarry_0244MulByConstants(t *testing.T) {
...
func TestE_nocarry_0244Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0244) bool {
...
func TestE_nocarry_0244LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0244Halve(t *testing.T) {
...
func TestE_nocarry_0244FromMont(t *testing.T) {
...
type testPaire_nocarry_0244 struct {
	element e_nocarry_0244
	bigint  big.Int
}

func (z *e_nocarry_0244) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0244[3] {
		return true
	}
	if z[3] < qe_nocarry_0244[3] {
		return false
	...
	return z[0] >= qe_nocarry_0244[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0244

		g.element = e_nocarry_0244{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0244[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0244[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0244 {
			var g e_nocarry_0244
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0244[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0244[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0244[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0244[3], carry)
...
func Benchmarke_nocarry_0244InverseNew(b *testing.B) {
	var x e_nocarry_0244
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0244
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0244
		var xInv e_nocarry_0244
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0244
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0244
...
func testLinearComb(t *testing.T, x *e_nocarry_0244, xC int64, y *e_nocarry_0244, yC int64) {
	...
	var z e_nocarry_0244
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0244, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0244
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0244, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0244
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0244, xHi uint64) {
	var res e_nocarry_0244
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0244) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0244) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0244, c int64, result *e_nocarry_0244, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0244) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0244) uint64 {
