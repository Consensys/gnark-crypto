...
// modulus q
DATA q<>+0(SB)/8, $0x0c1943215557a3ff
DATA q<>+8(SB)/8, $0x81a359f02a5814d1
DATA q<>+16(SB)/8, $0x6496fec95dc83082
DATA q<>+24(SB)/8, $0x000cc19dd7b5953f
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xfee1f9a87667a401
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x0c1943215557a3ff, R8
	MOVQ    $0x81a359f02a5814d1, R9
	MOVQ    $0x6496fec95dc83082, R10
	MOVQ    $0x000cc19dd7b5953f, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x81a359f02a5814d1, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x6496fec95dc83082, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x000cc19dd7b5953f, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x0c1943215557a3ff, R12
	MOVQ    $0x81a359f02a5814d1, R13
	MOVQ    $0x6496fec95dc83082, R14
	MOVQ    $0x000cc19dd7b5953f, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
