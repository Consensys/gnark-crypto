...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x28a630383e7dc027, R13
	ADDQ R13, AX
	MOVQ $0x5560b4760eeeb839, R13
	ADCQ R13, DX
	MOVQ $0xc2365a623301fca8, R13
	ADCQ R13, CX
	MOVQ $0x877e9ff4f926a1dd, R13
	ADCQ R13, BX
	MOVQ $0x8c985394755e6c64, R13
	ADCQ R13, SI
	MOVQ $0x289c55cb6b947212, R13
	ADCQ R13, DI
	MOVQ $0x0b3a46cf0a2a218e, R13
	ADCQ R13, R8
	MOVQ $0x001f480714105fca, R13
	ADCQ R13, R9
	MOVQ $0x9a4290c87253e5f2, R13
	ADCQ R13, R10
	MOVQ $0x000000003a339f11, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x28a630383e7dc027, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x5560b4760eeeb839, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xc2365a623301fca8, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x877e9ff4f926a1dd, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x8c985394755e6c64, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x289c55cb6b947212, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x0b3a46cf0a2a218e, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x001f480714105fca, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x9a4290c87253e5f2, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000003a339f11, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x28a630383e7dc027, AX
	ADDQ AX, DX
	MOVQ $0x5560b4760eeeb839, AX
	ADCQ AX, CX
	MOVQ $0xc2365a623301fca8, AX
	ADCQ AX, BX
	MOVQ $0x877e9ff4f926a1dd, AX
	ADCQ AX, SI
	MOVQ $0x8c985394755e6c64, AX
	ADCQ AX, DI
	MOVQ $0x289c55cb6b947212, AX
	ADCQ AX, R8
	MOVQ $0x0b3a46cf0a2a218e, AX
	ADCQ AX, R9
	MOVQ $0x001f480714105fca, AX
	ADCQ AX, R10
	MOVQ $0x9a4290c87253e5f2, AX
	ADCQ AX, R11
	MOVQ $0x000000003a339f11, AX
	ADCQ AX, R12
