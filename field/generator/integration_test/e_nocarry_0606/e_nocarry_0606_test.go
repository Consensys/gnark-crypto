...
var benchRese_nocarry_0606 e_nocarry_0606

func BenchmarkE_nocarry_0606SetBytes(b *testing.B) {
	var x e_nocarry_0606
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0606MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0606.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0606)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0606)
		}
	})
}

func BenchmarkE_nocarry_0606Inverse(b *testing.B) {
	var x e_nocarry_0606
	x.SetRandom()
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0606Butterfly(b *testing.B) {
	var x e_nocarry_0606
	x.SetRandom()
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0606)
	}
}

func BenchmarkE_nocarry_0606Exp(b *testing.B) {
	var x e_nocarry_0606
	x.SetRandom()
	benchRese_nocarry_0606.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0606Double(b *testing.B) {
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Double(&benchRese_nocarry_0606)
	}
}

func BenchmarkE_nocarry_0606Add(b *testing.B) {
	var x e_nocarry_0606
	x.SetRandom()
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Add(&x, &benchRese_nocarry_0606)
	}
}

func BenchmarkE_nocarry_0606Sub(b *testing.B) {
	var x e_nocarry_0606
	x.SetRandom()
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Sub(&x, &benchRese_nocarry_0606)
	}
}

func BenchmarkE_nocarry_0606Neg(b *testing.B) {
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Neg(&benchRese_nocarry_0606)
	}
}

func BenchmarkE_nocarry_0606Div(b *testing.B) {
	var x e_nocarry_0606
	x.SetRandom()
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Div(&x, &benchRese_nocarry_0606)
	}
}

func BenchmarkE_nocarry_0606FromMont(b *testing.B) {
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.FromMont()
	}
}

func BenchmarkE_nocarry_0606ToMont(b *testing.B) {
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.ToMont()
	}
}
func BenchmarkE_nocarry_0606Square(b *testing.B) {
	benchRese_nocarry_0606.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Square(&benchRese_nocarry_0606)
	}
}

func BenchmarkE_nocarry_0606Sqrt(b *testing.B) {
	var a e_nocarry_0606
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0606Mul(b *testing.B) {
	x := e_nocarry_0606{
	...
	benchRese_nocarry_0606.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Mul(&benchRese_nocarry_0606, &x)
	}
}

func BenchmarkE_nocarry_0606Cmp(b *testing.B) {
	x := e_nocarry_0606{
		13211370865563514364,
		12103665801382180860,
		4530577306546413765,
	...
	benchRese_nocarry_0606 = x
	benchRese_nocarry_0606[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0606.Cmp(&x)
	}
}

func TestE_nocarry_0606Cmp(t *testing.T) {
	var x, y e_nocarry_0606
...
func TestE_nocarry_0606IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0606
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0606

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0606{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0606
	one.SetOne()
	e.Sub(&qe_nocarry_0606, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0606{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0606{0, uint64(i)})
	}
...
func TestE_nocarry_0606NegZero(t *testing.T) {
	var a, b e_nocarry_0606
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0606Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0606, len(staticTestValues))
...
func TestE_nocarry_0606Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0606) bool {
			var b e_nocarry_0606
...
func TestE_nocarry_0606InverseExp(t *testing.T) {
...
func TestE_nocarry_0606MulByConstants(t *testing.T) {
...
func TestE_nocarry_0606Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0606) bool {
...
func TestE_nocarry_0606LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0606Halve(t *testing.T) {
...
func TestE_nocarry_0606FromMont(t *testing.T) {
...
type testPaire_nocarry_0606 struct {
	element e_nocarry_0606
	bigint  big.Int
}

func (z *e_nocarry_0606) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0606[9] {
		return true
	}
	if z[9] < qe_nocarry_0606[9] {
		return false
	...
	return z[0] >= qe_nocarry_0606[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0606

		g.element = e_nocarry_0606{
		...
		if qe_nocarry_0606[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0606[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0606 {
			var g e_nocarry_0606
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0606[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0606[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0606[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0606[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0606[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0606[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0606[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0606[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0606[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0606[9], carry)
...
func Benchmarke_nocarry_0606InverseNew(b *testing.B) {
	var x e_nocarry_0606
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0606
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0606
		var xInv e_nocarry_0606
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0606
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0606
...
func testLinearComb(t *testing.T, x *e_nocarry_0606, xC int64, y *e_nocarry_0606, yC int64) {
	...
	var z e_nocarry_0606
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0606, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0606
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0606, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0606
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0606, xHi uint64) {
	var res e_nocarry_0606
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0606) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0606) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0606, c int64, result *e_nocarry_0606, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0606) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0606) uint64 {
