...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x390016fa2949977f, R13
	ADDQ R13, AX
	MOVQ $0xcc35ca77958c87e1, R13
	ADCQ R13, DX
	MOVQ $0x851846784de9f2dd, R13
	ADCQ R13, CX
	MOVQ $0xc6a4fe1ede451a8d, R13
	ADCQ R13, BX
	MOVQ $0xfbc31605347ac69e, R13
	ADCQ R13, SI
	MOVQ $0x6f05731f5d1baf46, R13
	ADCQ R13, DI
	MOVQ $0xebff09bac81a62be, R13
	ADCQ R13, R8
	MOVQ $0x328959392e970a83, R13
	ADCQ R13, R9
	MOVQ $0x39e254f8986d3567, R13
	ADCQ R13, R10
	MOVQ $0x00000000000001ea, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x390016fa2949977f, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xcc35ca77958c87e1, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x851846784de9f2dd, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xc6a4fe1ede451a8d, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xfbc31605347ac69e, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x6f05731f5d1baf46, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xebff09bac81a62be, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x328959392e970a83, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x39e254f8986d3567, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000000001ea, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x390016fa2949977f, AX
	ADDQ AX, DX
	MOVQ $0xcc35ca77958c87e1, AX
	ADCQ AX, CX
	MOVQ $0x851846784de9f2dd, AX
	ADCQ AX, BX
	MOVQ $0xc6a4fe1ede451a8d, AX
	ADCQ AX, SI
	MOVQ $0xfbc31605347ac69e, AX
	ADCQ AX, DI
	MOVQ $0x6f05731f5d1baf46, AX
	ADCQ AX, R8
	MOVQ $0xebff09bac81a62be, AX
	ADCQ AX, R9
	MOVQ $0x328959392e970a83, AX
	ADCQ AX, R10
	MOVQ $0x39e254f8986d3567, AX
	ADCQ AX, R11
	MOVQ $0x00000000000001ea, AX
	ADCQ AX, R12
