...
var benchRese_nocarry_0585 e_nocarry_0585

func BenchmarkE_nocarry_0585SetBytes(b *testing.B) {
	var x e_nocarry_0585
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0585MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0585.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0585)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0585)
		}
	})
}

func BenchmarkE_nocarry_0585Inverse(b *testing.B) {
	var x e_nocarry_0585
	x.SetRandom()
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0585Butterfly(b *testing.B) {
	var x e_nocarry_0585
	x.SetRandom()
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0585)
	}
}

func BenchmarkE_nocarry_0585Exp(b *testing.B) {
	var x e_nocarry_0585
	x.SetRandom()
	benchRese_nocarry_0585.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0585Double(b *testing.B) {
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Double(&benchRese_nocarry_0585)
	}
}

func BenchmarkE_nocarry_0585Add(b *testing.B) {
	var x e_nocarry_0585
	x.SetRandom()
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Add(&x, &benchRese_nocarry_0585)
	}
}

func BenchmarkE_nocarry_0585Sub(b *testing.B) {
	var x e_nocarry_0585
	x.SetRandom()
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Sub(&x, &benchRese_nocarry_0585)
	}
}

func BenchmarkE_nocarry_0585Neg(b *testing.B) {
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Neg(&benchRese_nocarry_0585)
	}
}

func BenchmarkE_nocarry_0585Div(b *testing.B) {
	var x e_nocarry_0585
	x.SetRandom()
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Div(&x, &benchRese_nocarry_0585)
	}
}

func BenchmarkE_nocarry_0585FromMont(b *testing.B) {
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.FromMont()
	}
}

func BenchmarkE_nocarry_0585ToMont(b *testing.B) {
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.ToMont()
	}
}
func BenchmarkE_nocarry_0585Square(b *testing.B) {
	benchRese_nocarry_0585.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Square(&benchRese_nocarry_0585)
	}
}

func BenchmarkE_nocarry_0585Sqrt(b *testing.B) {
	var a e_nocarry_0585
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0585Mul(b *testing.B) {
	x := e_nocarry_0585{
	...
	benchRese_nocarry_0585.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Mul(&benchRese_nocarry_0585, &x)
	}
}

func BenchmarkE_nocarry_0585Cmp(b *testing.B) {
	x := e_nocarry_0585{
		18245238928889931290,
		2584054807672350949,
		14895502163764921835,
	...
	benchRese_nocarry_0585 = x
	benchRese_nocarry_0585[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0585.Cmp(&x)
	}
}

func TestE_nocarry_0585Cmp(t *testing.T) {
	var x, y e_nocarry_0585
...
func TestE_nocarry_0585IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0585
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0585

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0585{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0585
	one.SetOne()
	e.Sub(&qe_nocarry_0585, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0585{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0585{0, uint64(i)})
	}
...
func TestE_nocarry_0585NegZero(t *testing.T) {
	var a, b e_nocarry_0585
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0585Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0585, len(staticTestValues))
...
func TestE_nocarry_0585Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0585) bool {
			var b e_nocarry_0585
...
func TestE_nocarry_0585InverseExp(t *testing.T) {
...
func TestE_nocarry_0585MulByConstants(t *testing.T) {
...
func TestE_nocarry_0585Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0585) bool {
...
func TestE_nocarry_0585LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0585Halve(t *testing.T) {
...
func TestE_nocarry_0585FromMont(t *testing.T) {
...
type testPaire_nocarry_0585 struct {
	element e_nocarry_0585
	bigint  big.Int
}

func (z *e_nocarry_0585) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0585[9] {
		return true
	}
	if z[9] < qe_nocarry_0585[9] {
		return false
	...
	return z[0] >= qe_nocarry_0585[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0585

		g.element = e_nocarry_0585{
		...
		if qe_nocarry_0585[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0585[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0585 {
			var g e_nocarry_0585
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0585[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0585[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0585[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0585[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0585[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0585[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0585[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0585[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0585[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0585[9], carry)
...
func Benchmarke_nocarry_0585InverseNew(b *testing.B) {
	var x e_nocarry_0585
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0585
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0585
		var xInv e_nocarry_0585
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0585
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0585
...
func testLinearComb(t *testing.T, x *e_nocarry_0585, xC int64, y *e_nocarry_0585, yC int64) {
	...
	var z e_nocarry_0585
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0585, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0585
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0585, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0585
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0585, xHi uint64) {
	var res e_nocarry_0585
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0585) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0585) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0585, c int64, result *e_nocarry_0585, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0585) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0585) uint64 {
