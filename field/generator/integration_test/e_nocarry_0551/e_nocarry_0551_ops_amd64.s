...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x25fb4d3bafd7d9d1, R12
	ADDQ R12, AX
	MOVQ $0x3f7ed85125e60861, R12
	ADCQ R12, DX
	MOVQ $0xd9a769b4b80e8603, R12
	ADCQ R12, CX
	MOVQ $0xa16bd6147fb54fda, R12
	ADCQ R12, BX
	MOVQ $0x87694abf975ebc2d, R12
	ADCQ R12, SI
	MOVQ $0xba50046a0fca4ae6, R12
	ADCQ R12, DI
	MOVQ $0x4c539983b0dc6da6, R12
	ADCQ R12, R8
	MOVQ $0x6e01008aa6ab96e6, R12
	ADCQ R12, R9
	MOVQ $0x00000073268e563d, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x25fb4d3bafd7d9d1, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x3f7ed85125e60861, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xd9a769b4b80e8603, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xa16bd6147fb54fda, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x87694abf975ebc2d, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xba50046a0fca4ae6, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x4c539983b0dc6da6, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x6e01008aa6ab96e6, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000073268e563d, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x25fb4d3bafd7d9d1, AX
	ADDQ AX, DX
	MOVQ $0x3f7ed85125e60861, AX
	ADCQ AX, CX
	MOVQ $0xd9a769b4b80e8603, AX
	ADCQ AX, BX
	MOVQ $0xa16bd6147fb54fda, AX
	ADCQ AX, SI
	MOVQ $0x87694abf975ebc2d, AX
	ADCQ AX, DI
	MOVQ $0xba50046a0fca4ae6, AX
	ADCQ AX, R8
	MOVQ $0x4c539983b0dc6da6, AX
	ADCQ AX, R9
	MOVQ $0x6e01008aa6ab96e6, AX
	ADCQ AX, R10
	MOVQ $0x00000073268e563d, AX
	ADCQ AX, R11
