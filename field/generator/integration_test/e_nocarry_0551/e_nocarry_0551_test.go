...
var benchRese_nocarry_0551 e_nocarry_0551

func BenchmarkE_nocarry_0551SetBytes(b *testing.B) {
	var x e_nocarry_0551
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0551MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0551.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0551)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0551)
		}
	})
}

func BenchmarkE_nocarry_0551Inverse(b *testing.B) {
	var x e_nocarry_0551
	x.SetRandom()
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0551Butterfly(b *testing.B) {
	var x e_nocarry_0551
	x.SetRandom()
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0551)
	}
}

func BenchmarkE_nocarry_0551Exp(b *testing.B) {
	var x e_nocarry_0551
	x.SetRandom()
	benchRese_nocarry_0551.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0551Double(b *testing.B) {
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Double(&benchRese_nocarry_0551)
	}
}

func BenchmarkE_nocarry_0551Add(b *testing.B) {
	var x e_nocarry_0551
	x.SetRandom()
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Add(&x, &benchRese_nocarry_0551)
	}
}

func BenchmarkE_nocarry_0551Sub(b *testing.B) {
	var x e_nocarry_0551
	x.SetRandom()
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Sub(&x, &benchRese_nocarry_0551)
	}
}

func BenchmarkE_nocarry_0551Neg(b *testing.B) {
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Neg(&benchRese_nocarry_0551)
	}
}

func BenchmarkE_nocarry_0551Div(b *testing.B) {
	var x e_nocarry_0551
	x.SetRandom()
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Div(&x, &benchRese_nocarry_0551)
	}
}

func BenchmarkE_nocarry_0551FromMont(b *testing.B) {
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.FromMont()
	}
}

func BenchmarkE_nocarry_0551ToMont(b *testing.B) {
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.ToMont()
	}
}
func BenchmarkE_nocarry_0551Square(b *testing.B) {
	benchRese_nocarry_0551.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Square(&benchRese_nocarry_0551)
	}
}

func BenchmarkE_nocarry_0551Sqrt(b *testing.B) {
	var a e_nocarry_0551
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0551Mul(b *testing.B) {
	x := e_nocarry_0551{
	...
	benchRese_nocarry_0551.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Mul(&benchRese_nocarry_0551, &x)
	}
}

func BenchmarkE_nocarry_0551Cmp(b *testing.B) {
	x := e_nocarry_0551{
		17530664467291592559,
		5693377163862353709,
		15054023735571176127,
	...
	benchRese_nocarry_0551 = x
	benchRese_nocarry_0551[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0551.Cmp(&x)
	}
}

func TestE_nocarry_0551Cmp(t *testing.T) {
	var x, y e_nocarry_0551
...
func TestE_nocarry_0551IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0551
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0551

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0551{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0551
	one.SetOne()
	e.Sub(&qe_nocarry_0551, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0551{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0551{0, uint64(i)})
	}
...
func TestE_nocarry_0551NegZero(t *testing.T) {
	var a, b e_nocarry_0551
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0551Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0551, len(staticTestValues))
...
func TestE_nocarry_0551Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0551) bool {
			var b e_nocarry_0551
...
func TestE_nocarry_0551InverseExp(t *testing.T) {
...
func TestE_nocarry_0551MulByConstants(t *testing.T) {
...
func TestE_nocarry_0551Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0551) bool {
...
func TestE_nocarry_0551LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0551Halve(t *testing.T) {
...
func TestE_nocarry_0551FromMont(t *testing.T) {
...
type testPaire_nocarry_0551 struct {
	element e_nocarry_0551
	bigint  big.Int
}

func (z *e_nocarry_0551) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0551[8] {
		return true
	}
	if z[8] < qe_nocarry_0551[8] {
		return false
	...
	return z[0] >= qe_nocarry_0551[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0551

		g.element = e_nocarry_0551{
		...
		if qe_nocarry_0551[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0551[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0551 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0551[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0551[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0551[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0551[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0551[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0551[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0551[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0551[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0551[8], carry)
...
func Benchmarke_nocarry_0551InverseNew(b *testing.B) {
	var x e_nocarry_0551
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0551
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0551
		var xInv e_nocarry_0551
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0551
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0551
...
func testLinearComb(t *testing.T, x *e_nocarry_0551, xC int64, y *e_nocarry_0551, yC int64) {
	...
	var z e_nocarry_0551
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0551, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0551
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0551, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0551
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0551, xHi uint64) {
	var res e_nocarry_0551
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0551) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0551) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0551, c int64, result *e_nocarry_0551, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0551) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0551) uint64 {
