...
var benchRese_nocarry_0406 e_nocarry_0406

func BenchmarkE_nocarry_0406SetBytes(b *testing.B) {
	var x e_nocarry_0406
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0406MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0406.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0406)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0406)
		}
	})
}

func BenchmarkE_nocarry_0406Inverse(b *testing.B) {
	var x e_nocarry_0406
	x.SetRandom()
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0406Butterfly(b *testing.B) {
	var x e_nocarry_0406
	x.SetRandom()
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0406)
	}
}

func BenchmarkE_nocarry_0406Exp(b *testing.B) {
	var x e_nocarry_0406
	x.SetRandom()
	benchRese_nocarry_0406.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0406Double(b *testing.B) {
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Double(&benchRese_nocarry_0406)
	}
}

func BenchmarkE_nocarry_0406Add(b *testing.B) {
	var x e_nocarry_0406
	x.SetRandom()
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Add(&x, &benchRese_nocarry_0406)
	}
}

func BenchmarkE_nocarry_0406Sub(b *testing.B) {
	var x e_nocarry_0406
	x.SetRandom()
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Sub(&x, &benchRese_nocarry_0406)
	}
}

func BenchmarkE_nocarry_0406Neg(b *testing.B) {
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Neg(&benchRese_nocarry_0406)
	}
}

func BenchmarkE_nocarry_0406Div(b *testing.B) {
	var x e_nocarry_0406
	x.SetRandom()
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Div(&x, &benchRese_nocarry_0406)
	}
}

func BenchmarkE_nocarry_0406FromMont(b *testing.B) {
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.FromMont()
	}
}

func BenchmarkE_nocarry_0406ToMont(b *testing.B) {
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.ToMont()
	}
}
func BenchmarkE_nocarry_0406Square(b *testing.B) {
	benchRese_nocarry_0406.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Square(&benchRese_nocarry_0406)
	}
}

func BenchmarkE_nocarry_0406Sqrt(b *testing.B) {
	var a e_nocarry_0406
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0406Mul(b *testing.B) {
	x := e_nocarry_0406{
		6059480561677146963,
		5561699363622351002,
		9019008802160509404,
	...
	benchRese_nocarry_0406.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Mul(&benchRese_nocarry_0406, &x)
	}
}

func BenchmarkE_nocarry_0406Cmp(b *testing.B) {
	x := e_nocarry_0406{
		6059480561677146963,
		5561699363622351002,
		9019008802160509404,
	...
	benchRese_nocarry_0406 = x
	benchRese_nocarry_0406[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0406.Cmp(&x)
	}
}

func TestE_nocarry_0406Cmp(t *testing.T) {
	var x, y e_nocarry_0406
...
func TestE_nocarry_0406IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0406
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0406

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0406{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0406
	one.SetOne()
	e.Sub(&qe_nocarry_0406, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0406{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0406{0, uint64(i)})
	}
...
func TestE_nocarry_0406NegZero(t *testing.T) {
	var a, b e_nocarry_0406
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0406Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0406, len(staticTestValues))
...
func TestE_nocarry_0406Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0406) bool {
			var b e_nocarry_0406
...
func TestE_nocarry_0406InverseExp(t *testing.T) {
...
func TestE_nocarry_0406MulByConstants(t *testing.T) {
...
func TestE_nocarry_0406Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0406) bool {
...
func TestE_nocarry_0406LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0406Halve(t *testing.T) {
...
func TestE_nocarry_0406FromMont(t *testing.T) {
...
type testPaire_nocarry_0406 struct {
	element e_nocarry_0406
	bigint  big.Int
}

func (z *e_nocarry_0406) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0406[6] {
		return true
	}
	if z[6] < qe_nocarry_0406[6] {
		return false
	...
	return z[0] >= qe_nocarry_0406[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0406

		g.element = e_nocarry_0406{
		...
		if qe_nocarry_0406[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0406[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0406 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0406[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0406[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0406[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0406[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0406[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0406[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0406[6], carry)
...
func Benchmarke_nocarry_0406InverseNew(b *testing.B) {
	var x e_nocarry_0406
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0406
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0406
		var xInv e_nocarry_0406
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0406
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0406
...
func testLinearComb(t *testing.T, x *e_nocarry_0406, xC int64, y *e_nocarry_0406, yC int64) {
	...
	var z e_nocarry_0406
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0406, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0406
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0406, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0406
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0406, xHi uint64) {
	var res e_nocarry_0406
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0406) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0406) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0406, c int64, result *e_nocarry_0406, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0406) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0406) uint64 {
