...
var benchRese_nocarry_0454 e_nocarry_0454

func BenchmarkE_nocarry_0454SetBytes(b *testing.B) {
	var x e_nocarry_0454
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0454MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0454.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0454)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0454)
		}
	})
}

func BenchmarkE_nocarry_0454Inverse(b *testing.B) {
	var x e_nocarry_0454
	x.SetRandom()
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0454Butterfly(b *testing.B) {
	var x e_nocarry_0454
	x.SetRandom()
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0454)
	}
}

func BenchmarkE_nocarry_0454Exp(b *testing.B) {
	var x e_nocarry_0454
	x.SetRandom()
	benchRese_nocarry_0454.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0454Double(b *testing.B) {
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Double(&benchRese_nocarry_0454)
	}
}

func BenchmarkE_nocarry_0454Add(b *testing.B) {
	var x e_nocarry_0454
	x.SetRandom()
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Add(&x, &benchRese_nocarry_0454)
	}
}

func BenchmarkE_nocarry_0454Sub(b *testing.B) {
	var x e_nocarry_0454
	x.SetRandom()
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Sub(&x, &benchRese_nocarry_0454)
	}
}

func BenchmarkE_nocarry_0454Neg(b *testing.B) {
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Neg(&benchRese_nocarry_0454)
	}
}

func BenchmarkE_nocarry_0454Div(b *testing.B) {
	var x e_nocarry_0454
	x.SetRandom()
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Div(&x, &benchRese_nocarry_0454)
	}
}

func BenchmarkE_nocarry_0454FromMont(b *testing.B) {
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.FromMont()
	}
}

func BenchmarkE_nocarry_0454ToMont(b *testing.B) {
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.ToMont()
	}
}
func BenchmarkE_nocarry_0454Square(b *testing.B) {
	benchRese_nocarry_0454.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Square(&benchRese_nocarry_0454)
	}
}

func BenchmarkE_nocarry_0454Sqrt(b *testing.B) {
	var a e_nocarry_0454
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0454Mul(b *testing.B) {
	x := e_nocarry_0454{
		2917066403894164095,
	...
	benchRese_nocarry_0454.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Mul(&benchRese_nocarry_0454, &x)
	}
}

func BenchmarkE_nocarry_0454Cmp(b *testing.B) {
	x := e_nocarry_0454{
		2917066403894164095,
		12497857513649525980,
		17429194819922897289,
	...
	benchRese_nocarry_0454 = x
	benchRese_nocarry_0454[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0454.Cmp(&x)
	}
}

func TestE_nocarry_0454Cmp(t *testing.T) {
	var x, y e_nocarry_0454
...
func TestE_nocarry_0454IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0454
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0454

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0454{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0454
	one.SetOne()
	e.Sub(&qe_nocarry_0454, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0454{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0454{0, uint64(i)})
	}
...
func TestE_nocarry_0454NegZero(t *testing.T) {
	var a, b e_nocarry_0454
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0454Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0454, len(staticTestValues))
...
func TestE_nocarry_0454Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0454) bool {
			var b e_nocarry_0454
...
func TestE_nocarry_0454InverseExp(t *testing.T) {
...
func TestE_nocarry_0454MulByConstants(t *testing.T) {
...
func TestE_nocarry_0454Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0454) bool {
...
func TestE_nocarry_0454LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0454Halve(t *testing.T) {
...
func TestE_nocarry_0454FromMont(t *testing.T) {
...
type testPaire_nocarry_0454 struct {
	element e_nocarry_0454
	bigint  big.Int
}

func (z *e_nocarry_0454) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0454[7] {
		return true
	}
	if z[7] < qe_nocarry_0454[7] {
		return false
	...
	return z[0] >= qe_nocarry_0454[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0454

		g.element = e_nocarry_0454{
		...
		if qe_nocarry_0454[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0454[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0454 {
			var g e_nocarry_0454
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0454[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0454[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0454[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0454[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0454[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0454[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0454[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0454[7], carry)
...
func Benchmarke_nocarry_0454InverseNew(b *testing.B) {
	var x e_nocarry_0454
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0454
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0454
		var xInv e_nocarry_0454
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0454
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0454
...
func testLinearComb(t *testing.T, x *e_nocarry_0454, xC int64, y *e_nocarry_0454, yC int64) {
	...
	var z e_nocarry_0454
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0454, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0454
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0454, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0454
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0454, xHi uint64) {
	var res e_nocarry_0454
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0454) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0454) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0454, c int64, result *e_nocarry_0454, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0454) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0454) uint64 {
