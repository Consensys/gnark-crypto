...
// modulus q
DATA q<>+0(SB)/8, $0x1e14325a4caba98f
DATA q<>+8(SB)/8, $0x1d831063ad38dc38
DATA q<>+16(SB)/8, $0xfef5a1afa938c36f
DATA q<>+24(SB)/8, $0x0f251a8494c062ee
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x2e734ae6db14aa91
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x1e14325a4caba98f, R8
	MOVQ    $0x1d831063ad38dc38, R9
	MOVQ    $0xfef5a1afa938c36f, R10
	MOVQ    $0x0f251a8494c062ee, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x1d831063ad38dc38, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xfef5a1afa938c36f, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0f251a8494c062ee, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x1e14325a4caba98f, R12
	MOVQ    $0x1d831063ad38dc38, R13
	MOVQ    $0xfef5a1afa938c36f, R14
	MOVQ    $0x0f251a8494c062ee, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
