...
var benchRese_nocarry_0252 e_nocarry_0252

func BenchmarkE_nocarry_0252SetBytes(b *testing.B) {
	var x e_nocarry_0252
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0252MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0252.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0252)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0252)
		}
	})
}

func BenchmarkE_nocarry_0252Inverse(b *testing.B) {
	var x e_nocarry_0252
	x.SetRandom()
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0252Butterfly(b *testing.B) {
	var x e_nocarry_0252
	x.SetRandom()
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0252)
	}
}

func BenchmarkE_nocarry_0252Exp(b *testing.B) {
	var x e_nocarry_0252
	x.SetRandom()
	benchRese_nocarry_0252.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0252Double(b *testing.B) {
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Double(&benchRese_nocarry_0252)
	}
}

func BenchmarkE_nocarry_0252Add(b *testing.B) {
	var x e_nocarry_0252
	x.SetRandom()
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Add(&x, &benchRese_nocarry_0252)
	}
}

func BenchmarkE_nocarry_0252Sub(b *testing.B) {
	var x e_nocarry_0252
	x.SetRandom()
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Sub(&x, &benchRese_nocarry_0252)
	}
}

func BenchmarkE_nocarry_0252Neg(b *testing.B) {
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Neg(&benchRese_nocarry_0252)
	}
}

func BenchmarkE_nocarry_0252Div(b *testing.B) {
	var x e_nocarry_0252
	x.SetRandom()
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Div(&x, &benchRese_nocarry_0252)
	}
}

func BenchmarkE_nocarry_0252FromMont(b *testing.B) {
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.FromMont()
	}
}

func BenchmarkE_nocarry_0252ToMont(b *testing.B) {
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.ToMont()
	}
}
func BenchmarkE_nocarry_0252Square(b *testing.B) {
	benchRese_nocarry_0252.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Square(&benchRese_nocarry_0252)
	}
}

func BenchmarkE_nocarry_0252Sqrt(b *testing.B) {
	var a e_nocarry_0252
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0252Mul(b *testing.B) {
	x := e_nocarry_0252{
		5716242120715526994,
	...
	benchRese_nocarry_0252.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Mul(&benchRese_nocarry_0252, &x)
	}
}

func BenchmarkE_nocarry_0252Cmp(b *testing.B) {
	x := e_nocarry_0252{
		5716242120715526994,
		16833813830585806604,
		434322325853857346,
	...
	benchRese_nocarry_0252 = x
	benchRese_nocarry_0252[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0252.Cmp(&x)
	}
}

func TestE_nocarry_0252Cmp(t *testing.T) {
	var x, y e_nocarry_0252
...
func TestE_nocarry_0252IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0252
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0252

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0252{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0252
	one.SetOne()
	e.Sub(&qe_nocarry_0252, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0252{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0252{0, uint64(i)})
	}
...
func TestE_nocarry_0252NegZero(t *testing.T) {
	var a, b e_nocarry_0252
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0252Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0252, len(staticTestValues))
...
func TestE_nocarry_0252Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0252) bool {
			var b e_nocarry_0252
...
func TestE_nocarry_0252InverseExp(t *testing.T) {
...
func TestE_nocarry_0252MulByConstants(t *testing.T) {
...
func TestE_nocarry_0252Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0252) bool {
...
func TestE_nocarry_0252LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0252Halve(t *testing.T) {
...
func TestE_nocarry_0252FromMont(t *testing.T) {
...
type testPaire_nocarry_0252 struct {
	element e_nocarry_0252
	bigint  big.Int
}

func (z *e_nocarry_0252) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0252[3] {
		return true
	}
	if z[3] < qe_nocarry_0252[3] {
		return false
	...
	return z[0] >= qe_nocarry_0252[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0252

		g.element = e_nocarry_0252{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0252[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0252[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0252 {
			var g e_nocarry_0252
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0252[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0252[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0252[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0252[3], carry)
...
func Benchmarke_nocarry_0252InverseNew(b *testing.B) {
	var x e_nocarry_0252
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0252
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0252
		var xInv e_nocarry_0252
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0252
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0252
...
func testLinearComb(t *testing.T, x *e_nocarry_0252, xC int64, y *e_nocarry_0252, yC int64) {
	...
	var z e_nocarry_0252
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0252, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0252
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0252, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0252
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0252, xHi uint64) {
	var res e_nocarry_0252
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0252) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0252) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0252, c int64, result *e_nocarry_0252, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0252) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0252) uint64 {
