...
var benchRese_nocarry_0569 e_nocarry_0569

func BenchmarkE_nocarry_0569SetBytes(b *testing.B) {
	var x e_nocarry_0569
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0569MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0569.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0569)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0569)
		}
	})
}

func BenchmarkE_nocarry_0569Inverse(b *testing.B) {
	var x e_nocarry_0569
	x.SetRandom()
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0569Butterfly(b *testing.B) {
	var x e_nocarry_0569
	x.SetRandom()
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0569)
	}
}

func BenchmarkE_nocarry_0569Exp(b *testing.B) {
	var x e_nocarry_0569
	x.SetRandom()
	benchRese_nocarry_0569.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0569Double(b *testing.B) {
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Double(&benchRese_nocarry_0569)
	}
}

func BenchmarkE_nocarry_0569Add(b *testing.B) {
	var x e_nocarry_0569
	x.SetRandom()
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Add(&x, &benchRese_nocarry_0569)
	}
}

func BenchmarkE_nocarry_0569Sub(b *testing.B) {
	var x e_nocarry_0569
	x.SetRandom()
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Sub(&x, &benchRese_nocarry_0569)
	}
}

func BenchmarkE_nocarry_0569Neg(b *testing.B) {
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Neg(&benchRese_nocarry_0569)
	}
}

func BenchmarkE_nocarry_0569Div(b *testing.B) {
	var x e_nocarry_0569
	x.SetRandom()
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Div(&x, &benchRese_nocarry_0569)
	}
}

func BenchmarkE_nocarry_0569FromMont(b *testing.B) {
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.FromMont()
	}
}

func BenchmarkE_nocarry_0569ToMont(b *testing.B) {
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.ToMont()
	}
}
func BenchmarkE_nocarry_0569Square(b *testing.B) {
	benchRese_nocarry_0569.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Square(&benchRese_nocarry_0569)
	}
}

func BenchmarkE_nocarry_0569Sqrt(b *testing.B) {
	var a e_nocarry_0569
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0569Mul(b *testing.B) {
	x := e_nocarry_0569{
	...
	benchRese_nocarry_0569.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Mul(&benchRese_nocarry_0569, &x)
	}
}

func BenchmarkE_nocarry_0569Cmp(b *testing.B) {
	x := e_nocarry_0569{
		13111993835599298971,
		14864518614524568867,
		15797327338469367664,
	...
	benchRese_nocarry_0569 = x
	benchRese_nocarry_0569[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0569.Cmp(&x)
	}
}

func TestE_nocarry_0569Cmp(t *testing.T) {
	var x, y e_nocarry_0569
...
func TestE_nocarry_0569IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0569
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0569

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0569{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0569
	one.SetOne()
	e.Sub(&qe_nocarry_0569, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0569{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0569{0, uint64(i)})
	}
...
func TestE_nocarry_0569NegZero(t *testing.T) {
	var a, b e_nocarry_0569
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0569Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0569, len(staticTestValues))
...
func TestE_nocarry_0569Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0569) bool {
			var b e_nocarry_0569
...
func TestE_nocarry_0569InverseExp(t *testing.T) {
...
func TestE_nocarry_0569MulByConstants(t *testing.T) {
...
func TestE_nocarry_0569Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0569) bool {
...
func TestE_nocarry_0569LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0569Halve(t *testing.T) {
...
func TestE_nocarry_0569FromMont(t *testing.T) {
...
type testPaire_nocarry_0569 struct {
	element e_nocarry_0569
	bigint  big.Int
}

func (z *e_nocarry_0569) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0569[8] {
		return true
	}
	if z[8] < qe_nocarry_0569[8] {
		return false
	...
	return z[0] >= qe_nocarry_0569[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0569

		g.element = e_nocarry_0569{
		...
		if qe_nocarry_0569[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0569[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0569 {
			var g e_nocarry_0569
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0569[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0569[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0569[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0569[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0569[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0569[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0569[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0569[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0569[8], carry)
...
func Benchmarke_nocarry_0569InverseNew(b *testing.B) {
	var x e_nocarry_0569
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0569
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0569
		var xInv e_nocarry_0569
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0569
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0569
...
func testLinearComb(t *testing.T, x *e_nocarry_0569, xC int64, y *e_nocarry_0569, yC int64) {
	...
	var z e_nocarry_0569
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0569, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0569
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0569, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0569
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0569, xHi uint64) {
	var res e_nocarry_0569
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0569) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0569) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0569, c int64, result *e_nocarry_0569, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0569) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0569) uint64 {
