...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xf1d3f3ea14715acb, R12
	ADDQ R12, AX
	MOVQ $0x9464234c9a502557, R12
	ADCQ R12, DX
	MOVQ $0xe87519a5dc3177c5, R12
	ADCQ R12, CX
	MOVQ $0x22c034e728e10a92, R12
	ADCQ R12, BX
	MOVQ $0x6820a1ba4efcf8c8, R12
	ADCQ R12, SI
	MOVQ $0x0ed30d61e553c9cd, R12
	ADCQ R12, DI
	MOVQ $0xd221984dd8daa1f8, R12
	ADCQ R12, R8
	MOVQ $0xaf8ca64dee166270, R12
	ADCQ R12, R9
	MOVQ $0x01e0d2d5233e60ad, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf1d3f3ea14715acb, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x9464234c9a502557, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xe87519a5dc3177c5, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x22c034e728e10a92, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x6820a1ba4efcf8c8, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x0ed30d61e553c9cd, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xd221984dd8daa1f8, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xaf8ca64dee166270, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x01e0d2d5233e60ad, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xf1d3f3ea14715acb, AX
	ADDQ AX, DX
	MOVQ $0x9464234c9a502557, AX
	ADCQ AX, CX
	MOVQ $0xe87519a5dc3177c5, AX
	ADCQ AX, BX
	MOVQ $0x22c034e728e10a92, AX
	ADCQ AX, SI
	MOVQ $0x6820a1ba4efcf8c8, AX
	ADCQ AX, DI
	MOVQ $0x0ed30d61e553c9cd, AX
	ADCQ AX, R8
	MOVQ $0xd221984dd8daa1f8, AX
	ADCQ AX, R9
	MOVQ $0xaf8ca64dee166270, AX
	ADCQ AX, R10
	MOVQ $0x01e0d2d5233e60ad, AX
	ADCQ AX, R11
