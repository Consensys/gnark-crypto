...
var benchRese_nocarry_0519 e_nocarry_0519

func BenchmarkE_nocarry_0519SetBytes(b *testing.B) {
	var x e_nocarry_0519
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0519MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0519.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0519)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0519)
		}
	})
}

func BenchmarkE_nocarry_0519Inverse(b *testing.B) {
	var x e_nocarry_0519
	x.SetRandom()
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0519Butterfly(b *testing.B) {
	var x e_nocarry_0519
	x.SetRandom()
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0519)
	}
}

func BenchmarkE_nocarry_0519Exp(b *testing.B) {
	var x e_nocarry_0519
	x.SetRandom()
	benchRese_nocarry_0519.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0519Double(b *testing.B) {
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Double(&benchRese_nocarry_0519)
	}
}

func BenchmarkE_nocarry_0519Add(b *testing.B) {
	var x e_nocarry_0519
	x.SetRandom()
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Add(&x, &benchRese_nocarry_0519)
	}
}

func BenchmarkE_nocarry_0519Sub(b *testing.B) {
	var x e_nocarry_0519
	x.SetRandom()
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Sub(&x, &benchRese_nocarry_0519)
	}
}

func BenchmarkE_nocarry_0519Neg(b *testing.B) {
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Neg(&benchRese_nocarry_0519)
	}
}

func BenchmarkE_nocarry_0519Div(b *testing.B) {
	var x e_nocarry_0519
	x.SetRandom()
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Div(&x, &benchRese_nocarry_0519)
	}
}

func BenchmarkE_nocarry_0519FromMont(b *testing.B) {
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.FromMont()
	}
}

func BenchmarkE_nocarry_0519ToMont(b *testing.B) {
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.ToMont()
	}
}
func BenchmarkE_nocarry_0519Square(b *testing.B) {
	benchRese_nocarry_0519.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Square(&benchRese_nocarry_0519)
	}
}

func BenchmarkE_nocarry_0519Sqrt(b *testing.B) {
	var a e_nocarry_0519
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0519Mul(b *testing.B) {
	x := e_nocarry_0519{
		6915404877686000460,
	...
	benchRese_nocarry_0519.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Mul(&benchRese_nocarry_0519, &x)
	}
}

func BenchmarkE_nocarry_0519Cmp(b *testing.B) {
	x := e_nocarry_0519{
		6915404877686000460,
		17798276035324785311,
		2261081149696269087,
	...
	benchRese_nocarry_0519 = x
	benchRese_nocarry_0519[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0519.Cmp(&x)
	}
}

func TestE_nocarry_0519Cmp(t *testing.T) {
	var x, y e_nocarry_0519
...
func TestE_nocarry_0519IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0519
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0519

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0519{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0519
	one.SetOne()
	e.Sub(&qe_nocarry_0519, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0519{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0519{0, uint64(i)})
	}
...
func TestE_nocarry_0519NegZero(t *testing.T) {
	var a, b e_nocarry_0519
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0519Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0519, len(staticTestValues))
...
func TestE_nocarry_0519Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0519) bool {
			var b e_nocarry_0519
...
func TestE_nocarry_0519InverseExp(t *testing.T) {
...
func TestE_nocarry_0519MulByConstants(t *testing.T) {
...
func TestE_nocarry_0519Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0519) bool {
...
func TestE_nocarry_0519LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0519Halve(t *testing.T) {
...
func TestE_nocarry_0519FromMont(t *testing.T) {
...
type testPaire_nocarry_0519 struct {
	element e_nocarry_0519
	bigint  big.Int
}

func (z *e_nocarry_0519) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0519[8] {
		return true
	}
	if z[8] < qe_nocarry_0519[8] {
		return false
	...
	return z[0] >= qe_nocarry_0519[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0519

		g.element = e_nocarry_0519{
		...
		if qe_nocarry_0519[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0519[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0519 {
			var g e_nocarry_0519
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0519[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0519[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0519[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0519[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0519[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0519[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0519[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0519[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0519[8], carry)
...
func Benchmarke_nocarry_0519InverseNew(b *testing.B) {
	var x e_nocarry_0519
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0519
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0519
		var xInv e_nocarry_0519
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0519
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0519
...
func testLinearComb(t *testing.T, x *e_nocarry_0519, xC int64, y *e_nocarry_0519, yC int64) {
	...
	var z e_nocarry_0519
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0519, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0519
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0519, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0519
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0519, xHi uint64) {
	var res e_nocarry_0519
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0519) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0519) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0519, c int64, result *e_nocarry_0519, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0519) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0519) uint64 {
