...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x8320ec4db62419d5, R12
	ADDQ R12, AX
	MOVQ $0x9793e0d5a609b638, R12
	ADCQ R12, DX
	MOVQ $0x4c069d588ea33880, R12
	ADCQ R12, CX
	MOVQ $0x27a76fb449fb6dee, R12
	ADCQ R12, BX
	MOVQ $0x4cd50b630734298d, R12
	ADCQ R12, SI
	MOVQ $0xb8794dd053c9886e, R12
	ADCQ R12, DI
	MOVQ $0x1d220ca4ac6a1a01, R12
	ADCQ R12, R8
	MOVQ $0x56190ddc328897c5, R12
	ADCQ R12, R9
	MOVQ $0x0000000000000075, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x8320ec4db62419d5, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x9793e0d5a609b638, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x4c069d588ea33880, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x27a76fb449fb6dee, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x4cd50b630734298d, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xb8794dd053c9886e, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x1d220ca4ac6a1a01, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x56190ddc328897c5, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000000000075, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x8320ec4db62419d5, AX
	ADDQ AX, DX
	MOVQ $0x9793e0d5a609b638, AX
	ADCQ AX, CX
	MOVQ $0x4c069d588ea33880, AX
	ADCQ AX, BX
	MOVQ $0x27a76fb449fb6dee, AX
	ADCQ AX, SI
	MOVQ $0x4cd50b630734298d, AX
	ADCQ AX, DI
	MOVQ $0xb8794dd053c9886e, AX
	ADCQ AX, R8
	MOVQ $0x1d220ca4ac6a1a01, AX
	ADCQ AX, R9
	MOVQ $0x56190ddc328897c5, AX
	ADCQ AX, R10
	MOVQ $0x0000000000000075, AX
	ADCQ AX, R11
