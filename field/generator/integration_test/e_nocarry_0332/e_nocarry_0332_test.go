...
var benchRese_nocarry_0332 e_nocarry_0332

func BenchmarkE_nocarry_0332SetBytes(b *testing.B) {
	var x e_nocarry_0332
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0332MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0332.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0332)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0332)
		}
	})
}

func BenchmarkE_nocarry_0332Inverse(b *testing.B) {
	var x e_nocarry_0332
	x.SetRandom()
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0332Butterfly(b *testing.B) {
	var x e_nocarry_0332
	x.SetRandom()
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0332)
	}
}

func BenchmarkE_nocarry_0332Exp(b *testing.B) {
	var x e_nocarry_0332
	x.SetRandom()
	benchRese_nocarry_0332.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0332Double(b *testing.B) {
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Double(&benchRese_nocarry_0332)
	}
}

func BenchmarkE_nocarry_0332Add(b *testing.B) {
	var x e_nocarry_0332
	x.SetRandom()
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Add(&x, &benchRese_nocarry_0332)
	}
}

func BenchmarkE_nocarry_0332Sub(b *testing.B) {
	var x e_nocarry_0332
	x.SetRandom()
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Sub(&x, &benchRese_nocarry_0332)
	}
}

func BenchmarkE_nocarry_0332Neg(b *testing.B) {
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Neg(&benchRese_nocarry_0332)
	}
}

func BenchmarkE_nocarry_0332Div(b *testing.B) {
	var x e_nocarry_0332
	x.SetRandom()
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Div(&x, &benchRese_nocarry_0332)
	}
}

func BenchmarkE_nocarry_0332FromMont(b *testing.B) {
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.FromMont()
	}
}

func BenchmarkE_nocarry_0332ToMont(b *testing.B) {
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.ToMont()
	}
}
func BenchmarkE_nocarry_0332Square(b *testing.B) {
	benchRese_nocarry_0332.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Square(&benchRese_nocarry_0332)
	}
}

func BenchmarkE_nocarry_0332Sqrt(b *testing.B) {
	var a e_nocarry_0332
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0332Mul(b *testing.B) {
	x := e_nocarry_0332{
		2189818085727824084,
	...
	benchRese_nocarry_0332.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Mul(&benchRese_nocarry_0332, &x)
	}
}

func BenchmarkE_nocarry_0332Cmp(b *testing.B) {
	x := e_nocarry_0332{
		2189818085727824084,
		12235612408824311486,
		13729673770539971193,
	...
	benchRese_nocarry_0332 = x
	benchRese_nocarry_0332[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0332.Cmp(&x)
	}
}

func TestE_nocarry_0332Cmp(t *testing.T) {
	var x, y e_nocarry_0332
...
func TestE_nocarry_0332IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0332
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0332

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0332{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0332
	one.SetOne()
	e.Sub(&qe_nocarry_0332, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0332{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0332{0, uint64(i)})
	}
...
func TestE_nocarry_0332NegZero(t *testing.T) {
	var a, b e_nocarry_0332
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0332Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0332, len(staticTestValues))
...
func TestE_nocarry_0332Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0332) bool {
			var b e_nocarry_0332
...
func TestE_nocarry_0332InverseExp(t *testing.T) {
...
func TestE_nocarry_0332MulByConstants(t *testing.T) {
...
func TestE_nocarry_0332Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0332) bool {
...
func TestE_nocarry_0332LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0332Halve(t *testing.T) {
...
func TestE_nocarry_0332FromMont(t *testing.T) {
...
type testPaire_nocarry_0332 struct {
	element e_nocarry_0332
	bigint  big.Int
}

func (z *e_nocarry_0332) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0332[5] {
		return true
	}
	if z[5] < qe_nocarry_0332[5] {
		return false
	...
	return z[0] >= qe_nocarry_0332[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0332

		g.element = e_nocarry_0332{
		...
		if qe_nocarry_0332[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0332[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0332 {
			var g e_nocarry_0332
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0332[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0332[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0332[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0332[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0332[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0332[5], carry)
...
func Benchmarke_nocarry_0332InverseNew(b *testing.B) {
	var x e_nocarry_0332
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0332
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0332
		var xInv e_nocarry_0332
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0332
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0332
...
func testLinearComb(t *testing.T, x *e_nocarry_0332, xC int64, y *e_nocarry_0332, yC int64) {
	...
	var z e_nocarry_0332
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0332, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0332
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0332, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0332
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0332, xHi uint64) {
	var res e_nocarry_0332
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0332) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0332) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0332, c int64, result *e_nocarry_0332, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0332) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0332) uint64 {
