...
// modulus q
DATA q<>+0(SB)/8, $0x108f1ac7da4bbbb3
DATA q<>+8(SB)/8, $0x6c3e6ffae26d38d5
DATA q<>+16(SB)/8, $0x6782f6e36a205d85
DATA q<>+24(SB)/8, $0x6884c284e4ae3b14
DATA q<>+32(SB)/8, $0x4c90c919c59ba0d7
DATA q<>+40(SB)/8, $0x0000000000000cbe
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x2d2a9665174c9485
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x108f1ac7da4bbbb3, R10
	MOVQ    $0x6c3e6ffae26d38d5, R11
	MOVQ    $0x6782f6e36a205d85, R12
	MOVQ    $0x6884c284e4ae3b14, R13
	MOVQ    $0x4c90c919c59ba0d7, R14
	MOVQ    $0x0000000000000cbe, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x6c3e6ffae26d38d5, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x6782f6e36a205d85, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x6884c284e4ae3b14, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x4c90c919c59ba0d7, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000000000cbe, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x108f1ac7da4bbbb3, CX
	MOVQ    $0x6c3e6ffae26d38d5, BX
	MOVQ    $0x6782f6e36a205d85, SI
	MOVQ    $0x6884c284e4ae3b14, DI
	MOVQ    $0x4c90c919c59ba0d7, R8
	MOVQ    $0x0000000000000cbe, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
