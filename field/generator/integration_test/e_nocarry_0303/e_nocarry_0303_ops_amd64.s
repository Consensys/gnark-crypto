...
// modulus q
DATA q<>+0(SB)/8, $0x9be4060ac784d765
DATA q<>+8(SB)/8, $0xbd65d21dfb4c61fa
DATA q<>+16(SB)/8, $0xe07a03d1757d420b
DATA q<>+24(SB)/8, $0xe367808a10db60fe
DATA q<>+32(SB)/8, $0x0000714acd569ffd
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x2bafab72109c7d93
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x9be4060ac784d765, R9
	MOVQ    $0xbd65d21dfb4c61fa, R10
	MOVQ    $0xe07a03d1757d420b, R11
	MOVQ    $0xe367808a10db60fe, R12
	MOVQ    $0x0000714acd569ffd, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xbd65d21dfb4c61fa, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xe07a03d1757d420b, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xe367808a10db60fe, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000714acd569ffd, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x9be4060ac784d765, CX
	MOVQ    $0xbd65d21dfb4c61fa, BX
	MOVQ    $0xe07a03d1757d420b, SI
	MOVQ    $0xe367808a10db60fe, DI
	MOVQ    $0x0000714acd569ffd, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
