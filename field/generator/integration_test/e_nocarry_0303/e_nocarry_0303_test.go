...
var benchRese_nocarry_0303 e_nocarry_0303

func BenchmarkE_nocarry_0303SetBytes(b *testing.B) {
	var x e_nocarry_0303
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0303MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0303.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0303)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0303)
		}
	})
}

func BenchmarkE_nocarry_0303Inverse(b *testing.B) {
	var x e_nocarry_0303
	x.SetRandom()
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0303Butterfly(b *testing.B) {
	var x e_nocarry_0303
	x.SetRandom()
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0303)
	}
}

func BenchmarkE_nocarry_0303Exp(b *testing.B) {
	var x e_nocarry_0303
	x.SetRandom()
	benchRese_nocarry_0303.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0303Double(b *testing.B) {
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Double(&benchRese_nocarry_0303)
	}
}

func BenchmarkE_nocarry_0303Add(b *testing.B) {
	var x e_nocarry_0303
	x.SetRandom()
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Add(&x, &benchRese_nocarry_0303)
	}
}

func BenchmarkE_nocarry_0303Sub(b *testing.B) {
	var x e_nocarry_0303
	x.SetRandom()
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Sub(&x, &benchRese_nocarry_0303)
	}
}

func BenchmarkE_nocarry_0303Neg(b *testing.B) {
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Neg(&benchRese_nocarry_0303)
	}
}

func BenchmarkE_nocarry_0303Div(b *testing.B) {
	var x e_nocarry_0303
	x.SetRandom()
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Div(&x, &benchRese_nocarry_0303)
	}
}

func BenchmarkE_nocarry_0303FromMont(b *testing.B) {
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.FromMont()
	}
}

func BenchmarkE_nocarry_0303ToMont(b *testing.B) {
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.ToMont()
	}
}
func BenchmarkE_nocarry_0303Square(b *testing.B) {
	benchRese_nocarry_0303.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Square(&benchRese_nocarry_0303)
	}
}

func BenchmarkE_nocarry_0303Sqrt(b *testing.B) {
	var a e_nocarry_0303
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0303Mul(b *testing.B) {
	x := e_nocarry_0303{
	...
	benchRese_nocarry_0303.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Mul(&benchRese_nocarry_0303, &x)
	}
}

func BenchmarkE_nocarry_0303Cmp(b *testing.B) {
	x := e_nocarry_0303{
		16784484447473162856,
		199825834998739784,
		3990280941488789762,
	...
	benchRese_nocarry_0303 = x
	benchRese_nocarry_0303[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0303.Cmp(&x)
	}
}

func TestE_nocarry_0303Cmp(t *testing.T) {
	var x, y e_nocarry_0303
...
func TestE_nocarry_0303IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0303
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0303

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0303{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0303
	one.SetOne()
	e.Sub(&qe_nocarry_0303, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0303{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0303{0, uint64(i)})
	}
...
func TestE_nocarry_0303NegZero(t *testing.T) {
	var a, b e_nocarry_0303
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0303Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0303, len(staticTestValues))
...
func TestE_nocarry_0303Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0303) bool {
			var b e_nocarry_0303
...
func TestE_nocarry_0303InverseExp(t *testing.T) {
...
func TestE_nocarry_0303MulByConstants(t *testing.T) {
...
func TestE_nocarry_0303Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0303) bool {
...
func TestE_nocarry_0303LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0303Halve(t *testing.T) {
...
func TestE_nocarry_0303FromMont(t *testing.T) {
...
type testPaire_nocarry_0303 struct {
	element e_nocarry_0303
	bigint  big.Int
}

func (z *e_nocarry_0303) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0303[4] {
		return true
	}
	if z[4] < qe_nocarry_0303[4] {
		return false
	...
	return z[0] >= qe_nocarry_0303[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0303

		g.element = e_nocarry_0303{
		...
		if qe_nocarry_0303[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0303[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0303 {
			var g e_nocarry_0303
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0303[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0303[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0303[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0303[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0303[4], carry)
...
func Benchmarke_nocarry_0303InverseNew(b *testing.B) {
	var x e_nocarry_0303
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0303
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0303
		var xInv e_nocarry_0303
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0303
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0303
...
func testLinearComb(t *testing.T, x *e_nocarry_0303, xC int64, y *e_nocarry_0303, yC int64) {
	...
	var z e_nocarry_0303
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0303, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0303
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0303, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0303
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0303, xHi uint64) {
	var res e_nocarry_0303
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0303) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0303) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0303, c int64, result *e_nocarry_0303, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0303) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0303) uint64 {
