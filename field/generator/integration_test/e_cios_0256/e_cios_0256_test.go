...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_cios_0256{uint64(i)})
		staticTestValues = append(staticTestValues, e_cios_0256{0, uint64(i)})
	}
...
func (z *e_cios_0256) biggerOrEqualModulus() bool {
	if z[3] > qe_cios_0256[3] {
		return true
	}
	if z[3] < qe_cios_0256[3] {
		return false
