...
var benchRese_nocarry_0444 e_nocarry_0444

func BenchmarkE_nocarry_0444SetBytes(b *testing.B) {
	var x e_nocarry_0444
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0444MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0444.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0444)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0444)
		}
	})
}

func BenchmarkE_nocarry_0444Inverse(b *testing.B) {
	var x e_nocarry_0444
	x.SetRandom()
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0444Butterfly(b *testing.B) {
	var x e_nocarry_0444
	x.SetRandom()
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0444)
	}
}

func BenchmarkE_nocarry_0444Exp(b *testing.B) {
	var x e_nocarry_0444
	x.SetRandom()
	benchRese_nocarry_0444.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0444Double(b *testing.B) {
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Double(&benchRese_nocarry_0444)
	}
}

func BenchmarkE_nocarry_0444Add(b *testing.B) {
	var x e_nocarry_0444
	x.SetRandom()
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Add(&x, &benchRese_nocarry_0444)
	}
}

func BenchmarkE_nocarry_0444Sub(b *testing.B) {
	var x e_nocarry_0444
	x.SetRandom()
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Sub(&x, &benchRese_nocarry_0444)
	}
}

func BenchmarkE_nocarry_0444Neg(b *testing.B) {
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Neg(&benchRese_nocarry_0444)
	}
}

func BenchmarkE_nocarry_0444Div(b *testing.B) {
	var x e_nocarry_0444
	x.SetRandom()
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Div(&x, &benchRese_nocarry_0444)
	}
}

func BenchmarkE_nocarry_0444FromMont(b *testing.B) {
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.FromMont()
	}
}

func BenchmarkE_nocarry_0444ToMont(b *testing.B) {
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.ToMont()
	}
}
func BenchmarkE_nocarry_0444Square(b *testing.B) {
	benchRese_nocarry_0444.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Square(&benchRese_nocarry_0444)
	}
}

func BenchmarkE_nocarry_0444Sqrt(b *testing.B) {
	var a e_nocarry_0444
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0444Mul(b *testing.B) {
	x := e_nocarry_0444{
		5342332375605425567,
	...
	benchRese_nocarry_0444.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Mul(&benchRese_nocarry_0444, &x)
	}
}

func BenchmarkE_nocarry_0444Cmp(b *testing.B) {
	x := e_nocarry_0444{
		5342332375605425567,
		18313387315768828124,
		15125413471313359111,
	...
	benchRese_nocarry_0444 = x
	benchRese_nocarry_0444[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0444.Cmp(&x)
	}
}

func TestE_nocarry_0444Cmp(t *testing.T) {
	var x, y e_nocarry_0444
...
func TestE_nocarry_0444IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0444
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0444

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0444{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0444
	one.SetOne()
	e.Sub(&qe_nocarry_0444, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0444{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0444{0, uint64(i)})
	}
...
func TestE_nocarry_0444NegZero(t *testing.T) {
	var a, b e_nocarry_0444
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0444Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0444, len(staticTestValues))
...
func TestE_nocarry_0444Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0444) bool {
			var b e_nocarry_0444
...
func TestE_nocarry_0444InverseExp(t *testing.T) {
...
func TestE_nocarry_0444MulByConstants(t *testing.T) {
...
func TestE_nocarry_0444Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0444) bool {
...
func TestE_nocarry_0444LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0444Halve(t *testing.T) {
...
func TestE_nocarry_0444FromMont(t *testing.T) {
...
type testPaire_nocarry_0444 struct {
	element e_nocarry_0444
	bigint  big.Int
}

func (z *e_nocarry_0444) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0444[6] {
		return true
	}
	if z[6] < qe_nocarry_0444[6] {
		return false
	...
	return z[0] >= qe_nocarry_0444[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0444

		g.element = e_nocarry_0444{
		...
		if qe_nocarry_0444[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0444[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0444 {
			var g e_nocarry_0444
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0444[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0444[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0444[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0444[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0444[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0444[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0444[6], carry)
...
func Benchmarke_nocarry_0444InverseNew(b *testing.B) {
	var x e_nocarry_0444
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0444
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0444
		var xInv e_nocarry_0444
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0444
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0444
...
func testLinearComb(t *testing.T, x *e_nocarry_0444, xC int64, y *e_nocarry_0444, yC int64) {
	...
	var z e_nocarry_0444
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0444, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0444
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0444, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0444
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0444, xHi uint64) {
	var res e_nocarry_0444
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0444) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0444) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0444, c int64, result *e_nocarry_0444, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0444) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0444) uint64 {
