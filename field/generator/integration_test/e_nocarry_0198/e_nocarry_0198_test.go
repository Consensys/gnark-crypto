...
var benchRese_nocarry_0198 e_nocarry_0198

func BenchmarkE_nocarry_0198SetBytes(b *testing.B) {
	var x e_nocarry_0198
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0198MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0198.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0198)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0198)
		}
	})
}

func BenchmarkE_nocarry_0198Inverse(b *testing.B) {
	var x e_nocarry_0198
	x.SetRandom()
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0198Butterfly(b *testing.B) {
	var x e_nocarry_0198
	x.SetRandom()
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0198)
	}
}

func BenchmarkE_nocarry_0198Exp(b *testing.B) {
	var x e_nocarry_0198
	x.SetRandom()
	benchRese_nocarry_0198.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0198Double(b *testing.B) {
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Double(&benchRese_nocarry_0198)
	}
}

func BenchmarkE_nocarry_0198Add(b *testing.B) {
	var x e_nocarry_0198
	x.SetRandom()
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Add(&x, &benchRese_nocarry_0198)
	}
}

func BenchmarkE_nocarry_0198Sub(b *testing.B) {
	var x e_nocarry_0198
	x.SetRandom()
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Sub(&x, &benchRese_nocarry_0198)
	}
}

func BenchmarkE_nocarry_0198Neg(b *testing.B) {
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Neg(&benchRese_nocarry_0198)
	}
}

func BenchmarkE_nocarry_0198Div(b *testing.B) {
	var x e_nocarry_0198
	x.SetRandom()
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Div(&x, &benchRese_nocarry_0198)
	}
}

func BenchmarkE_nocarry_0198FromMont(b *testing.B) {
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.FromMont()
	}
}

func BenchmarkE_nocarry_0198ToMont(b *testing.B) {
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.ToMont()
	}
}
func BenchmarkE_nocarry_0198Square(b *testing.B) {
	benchRese_nocarry_0198.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Square(&benchRese_nocarry_0198)
	}
}

func BenchmarkE_nocarry_0198Sqrt(b *testing.B) {
	var a e_nocarry_0198
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0198Mul(b *testing.B) {
	x := e_nocarry_0198{
		6847019237990388534,
	...
	benchRese_nocarry_0198.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Mul(&benchRese_nocarry_0198, &x)
	}
}

func BenchmarkE_nocarry_0198Cmp(b *testing.B) {
	x := e_nocarry_0198{
		6847019237990388534,
		16052504147481550331,
		16086374079657628912,
	...
	benchRese_nocarry_0198 = x
	benchRese_nocarry_0198[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0198.Cmp(&x)
	}
}

func TestE_nocarry_0198Cmp(t *testing.T) {
	var x, y e_nocarry_0198
...
func TestE_nocarry_0198IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0198
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0198

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0198{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0198
	one.SetOne()
	e.Sub(&qe_nocarry_0198, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0198{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0198{0, uint64(i)})
	}
...
func TestE_nocarry_0198NegZero(t *testing.T) {
	var a, b e_nocarry_0198
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0198Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0198, len(staticTestValues))
...
func TestE_nocarry_0198Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0198) bool {
			var b e_nocarry_0198
...
func TestE_nocarry_0198InverseExp(t *testing.T) {
...
func TestE_nocarry_0198MulByConstants(t *testing.T) {
...
func TestE_nocarry_0198Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0198) bool {
...
func TestE_nocarry_0198LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0198Halve(t *testing.T) {
...
func TestE_nocarry_0198FromMont(t *testing.T) {
...
type testPaire_nocarry_0198 struct {
	element e_nocarry_0198
	bigint  big.Int
}

func (z *e_nocarry_0198) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0198[3] {
		return true
	}
	if z[3] < qe_nocarry_0198[3] {
		return false
	...
	return z[0] >= qe_nocarry_0198[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0198

		g.element = e_nocarry_0198{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0198[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0198[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0198 {
			var g e_nocarry_0198
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0198[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0198[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0198[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0198[3], carry)
...
func Benchmarke_nocarry_0198InverseNew(b *testing.B) {
	var x e_nocarry_0198
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0198
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0198
		var xInv e_nocarry_0198
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0198
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0198
...
func testLinearComb(t *testing.T, x *e_nocarry_0198, xC int64, y *e_nocarry_0198, yC int64) {
	...
	var z e_nocarry_0198
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0198, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0198
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0198, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0198
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0198, xHi uint64) {
	var res e_nocarry_0198
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0198) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0198) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0198, c int64, result *e_nocarry_0198, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0198) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0198) uint64 {
