...
// modulus q
DATA q<>+0(SB)/8, $0x936d29483c0fb76f
DATA q<>+8(SB)/8, $0x98dc9f64b7c8227c
DATA q<>+16(SB)/8, $0xabc0164a514f32f8
DATA q<>+24(SB)/8, $0x000000000000003d
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x84df735ae82c7871
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x936d29483c0fb76f, R8
	MOVQ    $0x98dc9f64b7c8227c, R9
	MOVQ    $0xabc0164a514f32f8, R10
	MOVQ    $0x000000000000003d, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x98dc9f64b7c8227c, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xabc0164a514f32f8, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x000000000000003d, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x936d29483c0fb76f, R12
	MOVQ    $0x98dc9f64b7c8227c, R13
	MOVQ    $0xabc0164a514f32f8, R14
	MOVQ    $0x000000000000003d, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
