...
// modulus q
DATA q<>+0(SB)/8, $0xcf9105a8d83f378b
DATA q<>+8(SB)/8, $0x4830e166dd8e81e4
DATA q<>+16(SB)/8, $0xf24fd94dbd3b1d2e
DATA q<>+24(SB)/8, $0x459675c46c4dbe3d
DATA q<>+32(SB)/8, $0xb86b05325677880a
DATA q<>+40(SB)/8, $0x0000000000001dc7
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x47fe48982fc0c7dd
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xcf9105a8d83f378b, R10
	MOVQ    $0x4830e166dd8e81e4, R11
	MOVQ    $0xf24fd94dbd3b1d2e, R12
	MOVQ    $0x459675c46c4dbe3d, R13
	MOVQ    $0xb86b05325677880a, R14
	MOVQ    $0x0000000000001dc7, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x4830e166dd8e81e4, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xf24fd94dbd3b1d2e, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x459675c46c4dbe3d, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xb86b05325677880a, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000000001dc7, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xcf9105a8d83f378b, CX
	MOVQ    $0x4830e166dd8e81e4, BX
	MOVQ    $0xf24fd94dbd3b1d2e, SI
	MOVQ    $0x459675c46c4dbe3d, DI
	MOVQ    $0xb86b05325677880a, R8
	MOVQ    $0x0000000000001dc7, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
