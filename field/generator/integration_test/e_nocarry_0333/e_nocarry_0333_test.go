...
var benchRese_nocarry_0333 e_nocarry_0333

func BenchmarkE_nocarry_0333SetBytes(b *testing.B) {
	var x e_nocarry_0333
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0333MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0333.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0333)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0333)
		}
	})
}

func BenchmarkE_nocarry_0333Inverse(b *testing.B) {
	var x e_nocarry_0333
	x.SetRandom()
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0333Butterfly(b *testing.B) {
	var x e_nocarry_0333
	x.SetRandom()
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0333)
	}
}

func BenchmarkE_nocarry_0333Exp(b *testing.B) {
	var x e_nocarry_0333
	x.SetRandom()
	benchRese_nocarry_0333.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0333Double(b *testing.B) {
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Double(&benchRese_nocarry_0333)
	}
}

func BenchmarkE_nocarry_0333Add(b *testing.B) {
	var x e_nocarry_0333
	x.SetRandom()
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Add(&x, &benchRese_nocarry_0333)
	}
}

func BenchmarkE_nocarry_0333Sub(b *testing.B) {
	var x e_nocarry_0333
	x.SetRandom()
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Sub(&x, &benchRese_nocarry_0333)
	}
}

func BenchmarkE_nocarry_0333Neg(b *testing.B) {
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Neg(&benchRese_nocarry_0333)
	}
}

func BenchmarkE_nocarry_0333Div(b *testing.B) {
	var x e_nocarry_0333
	x.SetRandom()
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Div(&x, &benchRese_nocarry_0333)
	}
}

func BenchmarkE_nocarry_0333FromMont(b *testing.B) {
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.FromMont()
	}
}

func BenchmarkE_nocarry_0333ToMont(b *testing.B) {
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.ToMont()
	}
}
func BenchmarkE_nocarry_0333Square(b *testing.B) {
	benchRese_nocarry_0333.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Square(&benchRese_nocarry_0333)
	}
}

func BenchmarkE_nocarry_0333Sqrt(b *testing.B) {
	var a e_nocarry_0333
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0333Mul(b *testing.B) {
	x := e_nocarry_0333{
	...
	benchRese_nocarry_0333.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Mul(&benchRese_nocarry_0333, &x)
	}
}

func BenchmarkE_nocarry_0333Cmp(b *testing.B) {
	x := e_nocarry_0333{
		16697002294802619870,
		5988314627834284434,
		6507896095713795321,
	...
	benchRese_nocarry_0333 = x
	benchRese_nocarry_0333[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0333.Cmp(&x)
	}
}

func TestE_nocarry_0333Cmp(t *testing.T) {
	var x, y e_nocarry_0333
...
func TestE_nocarry_0333IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0333
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0333

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0333{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0333
	one.SetOne()
	e.Sub(&qe_nocarry_0333, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0333{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0333{0, uint64(i)})
	}
...
func TestE_nocarry_0333NegZero(t *testing.T) {
	var a, b e_nocarry_0333
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0333Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0333, len(staticTestValues))
...
func TestE_nocarry_0333Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0333) bool {
			var b e_nocarry_0333
...
func TestE_nocarry_0333InverseExp(t *testing.T) {
...
func TestE_nocarry_0333MulByConstants(t *testing.T) {
...
func TestE_nocarry_0333Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0333) bool {
...
func TestE_nocarry_0333LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0333Halve(t *testing.T) {
...
func TestE_nocarry_0333FromMont(t *testing.T) {
...
type testPaire_nocarry_0333 struct {
	element e_nocarry_0333
	bigint  big.Int
}

func (z *e_nocarry_0333) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0333[5] {
		return true
	}
	if z[5] < qe_nocarry_0333[5] {
		return false
	...
	return z[0] >= qe_nocarry_0333[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0333

		g.element = e_nocarry_0333{
		...
		if qe_nocarry_0333[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0333[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0333 {
			var g e_nocarry_0333
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0333[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0333[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0333[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0333[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0333[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0333[5], carry)
...
func Benchmarke_nocarry_0333InverseNew(b *testing.B) {
	var x e_nocarry_0333
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0333
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0333
		var xInv e_nocarry_0333
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0333
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0333
...
func testLinearComb(t *testing.T, x *e_nocarry_0333, xC int64, y *e_nocarry_0333, yC int64) {
	...
	var z e_nocarry_0333
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0333, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0333
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0333, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0333
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0333, xHi uint64) {
	var res e_nocarry_0333
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0333) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0333) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0333, c int64, result *e_nocarry_0333, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0333) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0333) uint64 {
