...
var benchRese_nocarry_0425 e_nocarry_0425

func BenchmarkE_nocarry_0425SetBytes(b *testing.B) {
	var x e_nocarry_0425
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0425MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0425.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0425)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0425)
		}
	})
}

func BenchmarkE_nocarry_0425Inverse(b *testing.B) {
	var x e_nocarry_0425
	x.SetRandom()
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0425Butterfly(b *testing.B) {
	var x e_nocarry_0425
	x.SetRandom()
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0425)
	}
}

func BenchmarkE_nocarry_0425Exp(b *testing.B) {
	var x e_nocarry_0425
	x.SetRandom()
	benchRese_nocarry_0425.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0425Double(b *testing.B) {
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Double(&benchRese_nocarry_0425)
	}
}

func BenchmarkE_nocarry_0425Add(b *testing.B) {
	var x e_nocarry_0425
	x.SetRandom()
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Add(&x, &benchRese_nocarry_0425)
	}
}

func BenchmarkE_nocarry_0425Sub(b *testing.B) {
	var x e_nocarry_0425
	x.SetRandom()
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Sub(&x, &benchRese_nocarry_0425)
	}
}

func BenchmarkE_nocarry_0425Neg(b *testing.B) {
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Neg(&benchRese_nocarry_0425)
	}
}

func BenchmarkE_nocarry_0425Div(b *testing.B) {
	var x e_nocarry_0425
	x.SetRandom()
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Div(&x, &benchRese_nocarry_0425)
	}
}

func BenchmarkE_nocarry_0425FromMont(b *testing.B) {
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.FromMont()
	}
}

func BenchmarkE_nocarry_0425ToMont(b *testing.B) {
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.ToMont()
	}
}
func BenchmarkE_nocarry_0425Square(b *testing.B) {
	benchRese_nocarry_0425.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Square(&benchRese_nocarry_0425)
	}
}

func BenchmarkE_nocarry_0425Sqrt(b *testing.B) {
	var a e_nocarry_0425
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0425Mul(b *testing.B) {
	x := e_nocarry_0425{
	...
	benchRese_nocarry_0425.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Mul(&benchRese_nocarry_0425, &x)
	}
}

func BenchmarkE_nocarry_0425Cmp(b *testing.B) {
	x := e_nocarry_0425{
		15993092867407973785,
		17923933859061823987,
		17065225106765629008,
	...
	benchRese_nocarry_0425 = x
	benchRese_nocarry_0425[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0425.Cmp(&x)
	}
}

func TestE_nocarry_0425Cmp(t *testing.T) {
	var x, y e_nocarry_0425
...
func TestE_nocarry_0425IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0425
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0425

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0425{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0425
	one.SetOne()
	e.Sub(&qe_nocarry_0425, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0425{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0425{0, uint64(i)})
	}
...
func TestE_nocarry_0425NegZero(t *testing.T) {
	var a, b e_nocarry_0425
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0425Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0425, len(staticTestValues))
...
func TestE_nocarry_0425Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0425) bool {
			var b e_nocarry_0425
...
func TestE_nocarry_0425InverseExp(t *testing.T) {
...
func TestE_nocarry_0425MulByConstants(t *testing.T) {
...
func TestE_nocarry_0425Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0425) bool {
...
func TestE_nocarry_0425LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0425Halve(t *testing.T) {
...
func TestE_nocarry_0425FromMont(t *testing.T) {
...
type testPaire_nocarry_0425 struct {
	element e_nocarry_0425
	bigint  big.Int
}

func (z *e_nocarry_0425) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0425[6] {
		return true
	}
	if z[6] < qe_nocarry_0425[6] {
		return false
	...
	return z[0] >= qe_nocarry_0425[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0425

		g.element = e_nocarry_0425{
		...
		if qe_nocarry_0425[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0425[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0425 {
			var g e_nocarry_0425
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0425[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0425[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0425[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0425[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0425[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0425[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0425[6], carry)
...
func Benchmarke_nocarry_0425InverseNew(b *testing.B) {
	var x e_nocarry_0425
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0425
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0425
		var xInv e_nocarry_0425
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0425
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0425
...
func testLinearComb(t *testing.T, x *e_nocarry_0425, xC int64, y *e_nocarry_0425, yC int64) {
	...
	var z e_nocarry_0425
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0425, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0425
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0425, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0425
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0425, xHi uint64) {
	var res e_nocarry_0425
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0425) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0425) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0425, c int64, result *e_nocarry_0425, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0425) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0425) uint64 {
