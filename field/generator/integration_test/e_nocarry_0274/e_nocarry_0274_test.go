...
var benchRese_nocarry_0274 e_nocarry_0274

func BenchmarkE_nocarry_0274SetBytes(b *testing.B) {
	var x e_nocarry_0274
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0274MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0274.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0274)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0274)
		}
	})
}

func BenchmarkE_nocarry_0274Inverse(b *testing.B) {
	var x e_nocarry_0274
	x.SetRandom()
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0274Butterfly(b *testing.B) {
	var x e_nocarry_0274
	x.SetRandom()
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0274)
	}
}

func BenchmarkE_nocarry_0274Exp(b *testing.B) {
	var x e_nocarry_0274
	x.SetRandom()
	benchRese_nocarry_0274.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0274Double(b *testing.B) {
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Double(&benchRese_nocarry_0274)
	}
}

func BenchmarkE_nocarry_0274Add(b *testing.B) {
	var x e_nocarry_0274
	x.SetRandom()
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Add(&x, &benchRese_nocarry_0274)
	}
}

func BenchmarkE_nocarry_0274Sub(b *testing.B) {
	var x e_nocarry_0274
	x.SetRandom()
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Sub(&x, &benchRese_nocarry_0274)
	}
}

func BenchmarkE_nocarry_0274Neg(b *testing.B) {
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Neg(&benchRese_nocarry_0274)
	}
}

func BenchmarkE_nocarry_0274Div(b *testing.B) {
	var x e_nocarry_0274
	x.SetRandom()
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Div(&x, &benchRese_nocarry_0274)
	}
}

func BenchmarkE_nocarry_0274FromMont(b *testing.B) {
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.FromMont()
	}
}

func BenchmarkE_nocarry_0274ToMont(b *testing.B) {
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.ToMont()
	}
}
func BenchmarkE_nocarry_0274Square(b *testing.B) {
	benchRese_nocarry_0274.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Square(&benchRese_nocarry_0274)
	}
}

func BenchmarkE_nocarry_0274Sqrt(b *testing.B) {
	var a e_nocarry_0274
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0274Mul(b *testing.B) {
	x := e_nocarry_0274{
		9925492035052465611,
		1015688637419060908,
	...
	benchRese_nocarry_0274.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Mul(&benchRese_nocarry_0274, &x)
	}
}

func BenchmarkE_nocarry_0274Cmp(b *testing.B) {
	x := e_nocarry_0274{
		9925492035052465611,
		1015688637419060908,
		14084756004793563787,
	...
	benchRese_nocarry_0274 = x
	benchRese_nocarry_0274[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0274.Cmp(&x)
	}
}

func TestE_nocarry_0274Cmp(t *testing.T) {
	var x, y e_nocarry_0274
...
func TestE_nocarry_0274IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0274
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0274

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0274{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0274
	one.SetOne()
	e.Sub(&qe_nocarry_0274, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0274{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0274{0, uint64(i)})
	}
...
func TestE_nocarry_0274NegZero(t *testing.T) {
	var a, b e_nocarry_0274
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0274Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0274, len(staticTestValues))
...
func TestE_nocarry_0274Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0274) bool {
			var b e_nocarry_0274
...
func TestE_nocarry_0274InverseExp(t *testing.T) {
...
func TestE_nocarry_0274MulByConstants(t *testing.T) {
...
func TestE_nocarry_0274Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0274) bool {
...
func TestE_nocarry_0274LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0274Halve(t *testing.T) {
...
func TestE_nocarry_0274FromMont(t *testing.T) {
...
type testPaire_nocarry_0274 struct {
	element e_nocarry_0274
	bigint  big.Int
}

func (z *e_nocarry_0274) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0274[4] {
		return true
	}
	if z[4] < qe_nocarry_0274[4] {
		return false
	...
	return z[0] >= qe_nocarry_0274[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0274

		g.element = e_nocarry_0274{
		...
		if qe_nocarry_0274[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0274[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0274 {
			var g e_nocarry_0274
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0274[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0274[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0274[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0274[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0274[4], carry)
...
func Benchmarke_nocarry_0274InverseNew(b *testing.B) {
	var x e_nocarry_0274
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0274
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0274
		var xInv e_nocarry_0274
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0274
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0274
...
func testLinearComb(t *testing.T, x *e_nocarry_0274, xC int64, y *e_nocarry_0274, yC int64) {
	...
	var z e_nocarry_0274
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0274, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0274
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0274, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0274
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0274, xHi uint64) {
	var res e_nocarry_0274
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0274) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0274) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0274, c int64, result *e_nocarry_0274, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0274) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0274) uint64 {
