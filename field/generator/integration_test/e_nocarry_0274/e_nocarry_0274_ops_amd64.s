...
// modulus q
DATA q<>+0(SB)/8, $0x17292d72ae1f4cab
DATA q<>+8(SB)/8, $0x28d46ffa2923e719
DATA q<>+16(SB)/8, $0x8049ebac9d961568
DATA q<>+24(SB)/8, $0xf5d539cd6e44d30a
DATA q<>+32(SB)/8, $0x0000000000037d3c
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xdab3fdc7672db1fd
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x17292d72ae1f4cab, R9
	MOVQ    $0x28d46ffa2923e719, R10
	MOVQ    $0x8049ebac9d961568, R11
	MOVQ    $0xf5d539cd6e44d30a, R12
	MOVQ    $0x0000000000037d3c, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x28d46ffa2923e719, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x8049ebac9d961568, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xf5d539cd6e44d30a, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000037d3c, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x17292d72ae1f4cab, CX
	MOVQ    $0x28d46ffa2923e719, BX
	MOVQ    $0x8049ebac9d961568, SI
	MOVQ    $0xf5d539cd6e44d30a, DI
	MOVQ    $0x0000000000037d3c, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
