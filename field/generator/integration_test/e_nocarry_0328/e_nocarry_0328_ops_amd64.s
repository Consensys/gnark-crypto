...
// modulus q
DATA q<>+0(SB)/8, $0x64bd1da506f70c6f
DATA q<>+8(SB)/8, $0xc3540ac7c7af6d93
DATA q<>+16(SB)/8, $0xd3c1082daa002dc5
DATA q<>+24(SB)/8, $0x846f3c98bdc58a15
DATA q<>+32(SB)/8, $0x6fafc3d961d9a6d4
DATA q<>+40(SB)/8, $0x00000000000000c1
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x9c28b854267c2d71
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x64bd1da506f70c6f, R10
	MOVQ    $0xc3540ac7c7af6d93, R11
	MOVQ    $0xd3c1082daa002dc5, R12
	MOVQ    $0x846f3c98bdc58a15, R13
	MOVQ    $0x6fafc3d961d9a6d4, R14
	MOVQ    $0x00000000000000c1, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xc3540ac7c7af6d93, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xd3c1082daa002dc5, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x846f3c98bdc58a15, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x6fafc3d961d9a6d4, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000000000000c1, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x64bd1da506f70c6f, CX
	MOVQ    $0xc3540ac7c7af6d93, BX
	MOVQ    $0xd3c1082daa002dc5, SI
	MOVQ    $0x846f3c98bdc58a15, DI
	MOVQ    $0x6fafc3d961d9a6d4, R8
	MOVQ    $0x00000000000000c1, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
