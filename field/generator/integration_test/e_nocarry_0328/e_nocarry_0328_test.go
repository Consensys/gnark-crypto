...
var benchRese_nocarry_0328 e_nocarry_0328

func BenchmarkE_nocarry_0328SetBytes(b *testing.B) {
	var x e_nocarry_0328
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0328MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0328.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0328)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0328)
		}
	})
}

func BenchmarkE_nocarry_0328Inverse(b *testing.B) {
	var x e_nocarry_0328
	x.SetRandom()
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0328Butterfly(b *testing.B) {
	var x e_nocarry_0328
	x.SetRandom()
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0328)
	}
}

func BenchmarkE_nocarry_0328Exp(b *testing.B) {
	var x e_nocarry_0328
	x.SetRandom()
	benchRese_nocarry_0328.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0328Double(b *testing.B) {
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Double(&benchRese_nocarry_0328)
	}
}

func BenchmarkE_nocarry_0328Add(b *testing.B) {
	var x e_nocarry_0328
	x.SetRandom()
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Add(&x, &benchRese_nocarry_0328)
	}
}

func BenchmarkE_nocarry_0328Sub(b *testing.B) {
	var x e_nocarry_0328
	x.SetRandom()
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Sub(&x, &benchRese_nocarry_0328)
	}
}

func BenchmarkE_nocarry_0328Neg(b *testing.B) {
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Neg(&benchRese_nocarry_0328)
	}
}

func BenchmarkE_nocarry_0328Div(b *testing.B) {
	var x e_nocarry_0328
	x.SetRandom()
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Div(&x, &benchRese_nocarry_0328)
	}
}

func BenchmarkE_nocarry_0328FromMont(b *testing.B) {
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.FromMont()
	}
}

func BenchmarkE_nocarry_0328ToMont(b *testing.B) {
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.ToMont()
	}
}
func BenchmarkE_nocarry_0328Square(b *testing.B) {
	benchRese_nocarry_0328.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Square(&benchRese_nocarry_0328)
	}
}

func BenchmarkE_nocarry_0328Sqrt(b *testing.B) {
	var a e_nocarry_0328
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0328Mul(b *testing.B) {
	x := e_nocarry_0328{
		1828894721497439220,
		976298782222913199,
		6000897599279960565,
	...
	benchRese_nocarry_0328.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Mul(&benchRese_nocarry_0328, &x)
	}
}

func BenchmarkE_nocarry_0328Cmp(b *testing.B) {
	x := e_nocarry_0328{
		1828894721497439220,
		976298782222913199,
		6000897599279960565,
	...
	benchRese_nocarry_0328 = x
	benchRese_nocarry_0328[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0328.Cmp(&x)
	}
}

func TestE_nocarry_0328Cmp(t *testing.T) {
	var x, y e_nocarry_0328
...
func TestE_nocarry_0328IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0328
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0328

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0328{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0328
	one.SetOne()
	e.Sub(&qe_nocarry_0328, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0328{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0328{0, uint64(i)})
	}
...
func TestE_nocarry_0328NegZero(t *testing.T) {
	var a, b e_nocarry_0328
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0328Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0328, len(staticTestValues))
...
func TestE_nocarry_0328Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0328) bool {
			var b e_nocarry_0328
...
func TestE_nocarry_0328InverseExp(t *testing.T) {
...
func TestE_nocarry_0328MulByConstants(t *testing.T) {
...
func TestE_nocarry_0328Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0328) bool {
...
func TestE_nocarry_0328LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0328Halve(t *testing.T) {
...
func TestE_nocarry_0328FromMont(t *testing.T) {
...
type testPaire_nocarry_0328 struct {
	element e_nocarry_0328
	bigint  big.Int
}

func (z *e_nocarry_0328) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0328[5] {
		return true
	}
	if z[5] < qe_nocarry_0328[5] {
		return false
	...
	return z[0] >= qe_nocarry_0328[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0328

		g.element = e_nocarry_0328{
		...
		if qe_nocarry_0328[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0328[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0328 {
			var g e_nocarry_0328
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0328[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0328[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0328[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0328[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0328[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0328[5], carry)
...
func Benchmarke_nocarry_0328InverseNew(b *testing.B) {
	var x e_nocarry_0328
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0328
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0328
		var xInv e_nocarry_0328
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0328
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0328
...
func testLinearComb(t *testing.T, x *e_nocarry_0328, xC int64, y *e_nocarry_0328, yC int64) {
	...
	var z e_nocarry_0328
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0328, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0328
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0328, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0328
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0328, xHi uint64) {
	var res e_nocarry_0328
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0328) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0328) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0328, c int64, result *e_nocarry_0328, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0328) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0328) uint64 {
