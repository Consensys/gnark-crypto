...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xd6c7cd95911ad2f3, R12
	ADDQ R12, AX
	MOVQ $0x85e89b0667ae5007, R12
	ADCQ R12, DX
	MOVQ $0x4db3a32cf4837ee1, R12
	ADCQ R12, CX
	MOVQ $0x68da33708a7c34c1, R12
	ADCQ R12, BX
	MOVQ $0x40c893eebafb4bb6, R12
	ADCQ R12, SI
	MOVQ $0xca50293eb60e028b, R12
	ADCQ R12, DI
	MOVQ $0xc7c197e42cfec783, R12
	ADCQ R12, R8
	MOVQ $0xf23ba899757df6ab, R12
	ADCQ R12, R9
	MOVQ $0x00000000001cb145, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xd6c7cd95911ad2f3, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x85e89b0667ae5007, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x4db3a32cf4837ee1, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x68da33708a7c34c1, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x40c893eebafb4bb6, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xca50293eb60e028b, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xc7c197e42cfec783, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xf23ba899757df6ab, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000000001cb145, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xd6c7cd95911ad2f3, AX
	ADDQ AX, DX
	MOVQ $0x85e89b0667ae5007, AX
	ADCQ AX, CX
	MOVQ $0x4db3a32cf4837ee1, AX
	ADCQ AX, BX
	MOVQ $0x68da33708a7c34c1, AX
	ADCQ AX, SI
	MOVQ $0x40c893eebafb4bb6, AX
	ADCQ AX, DI
	MOVQ $0xca50293eb60e028b, AX
	ADCQ AX, R8
	MOVQ $0xc7c197e42cfec783, AX
	ADCQ AX, R9
	MOVQ $0xf23ba899757df6ab, AX
	ADCQ AX, R10
	MOVQ $0x00000000001cb145, AX
	ADCQ AX, R11
