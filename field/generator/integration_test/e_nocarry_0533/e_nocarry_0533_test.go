...
var benchRese_nocarry_0533 e_nocarry_0533

func BenchmarkE_nocarry_0533SetBytes(b *testing.B) {
	var x e_nocarry_0533
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0533MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0533.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0533)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0533)
		}
	})
}

func BenchmarkE_nocarry_0533Inverse(b *testing.B) {
	var x e_nocarry_0533
	x.SetRandom()
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0533Butterfly(b *testing.B) {
	var x e_nocarry_0533
	x.SetRandom()
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0533)
	}
}

func BenchmarkE_nocarry_0533Exp(b *testing.B) {
	var x e_nocarry_0533
	x.SetRandom()
	benchRese_nocarry_0533.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0533Double(b *testing.B) {
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Double(&benchRese_nocarry_0533)
	}
}

func BenchmarkE_nocarry_0533Add(b *testing.B) {
	var x e_nocarry_0533
	x.SetRandom()
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Add(&x, &benchRese_nocarry_0533)
	}
}

func BenchmarkE_nocarry_0533Sub(b *testing.B) {
	var x e_nocarry_0533
	x.SetRandom()
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Sub(&x, &benchRese_nocarry_0533)
	}
}

func BenchmarkE_nocarry_0533Neg(b *testing.B) {
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Neg(&benchRese_nocarry_0533)
	}
}

func BenchmarkE_nocarry_0533Div(b *testing.B) {
	var x e_nocarry_0533
	x.SetRandom()
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Div(&x, &benchRese_nocarry_0533)
	}
}

func BenchmarkE_nocarry_0533FromMont(b *testing.B) {
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.FromMont()
	}
}

func BenchmarkE_nocarry_0533ToMont(b *testing.B) {
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.ToMont()
	}
}
func BenchmarkE_nocarry_0533Square(b *testing.B) {
	benchRese_nocarry_0533.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Square(&benchRese_nocarry_0533)
	}
}

func BenchmarkE_nocarry_0533Sqrt(b *testing.B) {
	var a e_nocarry_0533
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0533Mul(b *testing.B) {
	x := e_nocarry_0533{
		3063783423626362621,
	...
	benchRese_nocarry_0533.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Mul(&benchRese_nocarry_0533, &x)
	}
}

func BenchmarkE_nocarry_0533Cmp(b *testing.B) {
	x := e_nocarry_0533{
		3063783423626362621,
		16031589150787419027,
		6335818580290215416,
	...
	benchRese_nocarry_0533 = x
	benchRese_nocarry_0533[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0533.Cmp(&x)
	}
}

func TestE_nocarry_0533Cmp(t *testing.T) {
	var x, y e_nocarry_0533
...
func TestE_nocarry_0533IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0533
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0533

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0533{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0533
	one.SetOne()
	e.Sub(&qe_nocarry_0533, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0533{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0533{0, uint64(i)})
	}
...
func TestE_nocarry_0533NegZero(t *testing.T) {
	var a, b e_nocarry_0533
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0533Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0533, len(staticTestValues))
...
func TestE_nocarry_0533Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0533) bool {
			var b e_nocarry_0533
...
func TestE_nocarry_0533InverseExp(t *testing.T) {
...
func TestE_nocarry_0533MulByConstants(t *testing.T) {
...
func TestE_nocarry_0533Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0533) bool {
...
func TestE_nocarry_0533LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0533Halve(t *testing.T) {
...
func TestE_nocarry_0533FromMont(t *testing.T) {
...
type testPaire_nocarry_0533 struct {
	element e_nocarry_0533
	bigint  big.Int
}

func (z *e_nocarry_0533) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0533[8] {
		return true
	}
	if z[8] < qe_nocarry_0533[8] {
		return false
	...
	return z[0] >= qe_nocarry_0533[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0533

		g.element = e_nocarry_0533{
		...
		if qe_nocarry_0533[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0533[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0533 {
			var g e_nocarry_0533
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0533[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0533[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0533[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0533[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0533[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0533[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0533[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0533[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0533[8], carry)
...
func Benchmarke_nocarry_0533InverseNew(b *testing.B) {
	var x e_nocarry_0533
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0533
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0533
		var xInv e_nocarry_0533
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0533
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0533
...
func testLinearComb(t *testing.T, x *e_nocarry_0533, xC int64, y *e_nocarry_0533, yC int64) {
	...
	var z e_nocarry_0533
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0533, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0533
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0533, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0533
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0533, xHi uint64) {
	var res e_nocarry_0533
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0533) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0533) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0533, c int64, result *e_nocarry_0533, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0533) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0533) uint64 {
