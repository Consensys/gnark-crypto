...
var benchRese_nocarry_0657 e_nocarry_0657

func BenchmarkE_nocarry_0657SetBytes(b *testing.B) {
	var x e_nocarry_0657
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0657MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0657.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0657)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0657)
		}
	})
}

func BenchmarkE_nocarry_0657Inverse(b *testing.B) {
	var x e_nocarry_0657
	x.SetRandom()
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0657Butterfly(b *testing.B) {
	var x e_nocarry_0657
	x.SetRandom()
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0657)
	}
}

func BenchmarkE_nocarry_0657Exp(b *testing.B) {
	var x e_nocarry_0657
	x.SetRandom()
	benchRese_nocarry_0657.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0657Double(b *testing.B) {
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Double(&benchRese_nocarry_0657)
	}
}

func BenchmarkE_nocarry_0657Add(b *testing.B) {
	var x e_nocarry_0657
	x.SetRandom()
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Add(&x, &benchRese_nocarry_0657)
	}
}

func BenchmarkE_nocarry_0657Sub(b *testing.B) {
	var x e_nocarry_0657
	x.SetRandom()
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Sub(&x, &benchRese_nocarry_0657)
	}
}

func BenchmarkE_nocarry_0657Neg(b *testing.B) {
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Neg(&benchRese_nocarry_0657)
	}
}

func BenchmarkE_nocarry_0657Div(b *testing.B) {
	var x e_nocarry_0657
	x.SetRandom()
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Div(&x, &benchRese_nocarry_0657)
	}
}

func BenchmarkE_nocarry_0657FromMont(b *testing.B) {
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.FromMont()
	}
}

func BenchmarkE_nocarry_0657ToMont(b *testing.B) {
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.ToMont()
	}
}
func BenchmarkE_nocarry_0657Square(b *testing.B) {
	benchRese_nocarry_0657.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Square(&benchRese_nocarry_0657)
	}
}

func BenchmarkE_nocarry_0657Sqrt(b *testing.B) {
	var a e_nocarry_0657
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0657Mul(b *testing.B) {
	x := e_nocarry_0657{
		193945220138670369,
		1292824755900821573,
	...
	benchRese_nocarry_0657.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Mul(&benchRese_nocarry_0657, &x)
	}
}

func BenchmarkE_nocarry_0657Cmp(b *testing.B) {
	x := e_nocarry_0657{
		193945220138670369,
		1292824755900821573,
		11097311171521110060,
	...
	benchRese_nocarry_0657 = x
	benchRese_nocarry_0657[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0657.Cmp(&x)
	}
}

func TestE_nocarry_0657Cmp(t *testing.T) {
	var x, y e_nocarry_0657
...
func TestE_nocarry_0657IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0657
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0657

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0657{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0657
	one.SetOne()
	e.Sub(&qe_nocarry_0657, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0657{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0657{0, uint64(i)})
	}
...
func TestE_nocarry_0657NegZero(t *testing.T) {
	var a, b e_nocarry_0657
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0657Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0657, len(staticTestValues))
...
func TestE_nocarry_0657Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0657) bool {
			var b e_nocarry_0657
...
func TestE_nocarry_0657InverseExp(t *testing.T) {
...
func TestE_nocarry_0657MulByConstants(t *testing.T) {
...
func TestE_nocarry_0657Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0657) bool {
...
func TestE_nocarry_0657LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0657Halve(t *testing.T) {
...
func TestE_nocarry_0657FromMont(t *testing.T) {
...
type testPaire_nocarry_0657 struct {
	element e_nocarry_0657
	bigint  big.Int
}

func (z *e_nocarry_0657) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0657[10] {
		return true
	}
	if z[10] < qe_nocarry_0657[10] {
		return false
	...
	return z[0] >= qe_nocarry_0657[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0657

		g.element = e_nocarry_0657{
		...
		if qe_nocarry_0657[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0657[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0657 {
			var g e_nocarry_0657
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0657[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0657[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0657[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0657[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0657[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0657[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0657[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0657[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0657[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0657[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0657[10], carry)
...
func Benchmarke_nocarry_0657InverseNew(b *testing.B) {
	var x e_nocarry_0657
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0657
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0657
		var xInv e_nocarry_0657
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0657
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0657
...
func testLinearComb(t *testing.T, x *e_nocarry_0657, xC int64, y *e_nocarry_0657, yC int64) {
	...
	var z e_nocarry_0657
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0657, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0657
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0657, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0657
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0657, xHi uint64) {
	var res e_nocarry_0657
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0657) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0657) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0657, c int64, result *e_nocarry_0657, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0657) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0657) uint64 {
