...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x098896da9269452d, R14
	ADDQ R14, AX
	MOVQ $0x09a59de0c579f77d, R14
	ADCQ R14, DX
	MOVQ $0xcafe3afbdd3602bd, R14
	ADCQ R14, CX
	MOVQ $0x4d8ab4885ef4f3d6, R14
	ADCQ R14, BX
	MOVQ $0x6cd30420a3b9ffd5, R14
	ADCQ R14, SI
	MOVQ $0x70ca773ae054b32f, R14
	ADCQ R14, DI
	MOVQ $0xf52edc31925048ce, R14
	ADCQ R14, R8
	MOVQ $0x29dace1812be7e3f, R14
	ADCQ R14, R9
	MOVQ $0x1282ef4b8cf98bea, R14
	ADCQ R14, R10
	MOVQ $0xf2e2bc9d464fe2a8, R14
	ADCQ R14, R11
	MOVQ $0x000000000001996a, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x098896da9269452d, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x09a59de0c579f77d, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xcafe3afbdd3602bd, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x4d8ab4885ef4f3d6, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x6cd30420a3b9ffd5, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x70ca773ae054b32f, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xf52edc31925048ce, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x29dace1812be7e3f, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x1282ef4b8cf98bea, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xf2e2bc9d464fe2a8, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000000001996a, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x098896da9269452d, AX
	ADDQ AX, DX
	MOVQ $0x09a59de0c579f77d, AX
	ADCQ AX, CX
	MOVQ $0xcafe3afbdd3602bd, AX
	ADCQ AX, BX
	MOVQ $0x4d8ab4885ef4f3d6, AX
	ADCQ AX, SI
	MOVQ $0x6cd30420a3b9ffd5, AX
	ADCQ AX, DI
	MOVQ $0x70ca773ae054b32f, AX
	ADCQ AX, R8
	MOVQ $0xf52edc31925048ce, AX
	ADCQ AX, R9
	MOVQ $0x29dace1812be7e3f, AX
	ADCQ AX, R10
	MOVQ $0x1282ef4b8cf98bea, AX
	ADCQ AX, R11
	MOVQ $0xf2e2bc9d464fe2a8, AX
	ADCQ AX, R12
	MOVQ $0x000000000001996a, AX
	ADCQ AX, R13
