...
var benchRese_nocarry_0326 e_nocarry_0326

func BenchmarkE_nocarry_0326SetBytes(b *testing.B) {
	var x e_nocarry_0326
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0326MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0326.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0326)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0326)
		}
	})
}

func BenchmarkE_nocarry_0326Inverse(b *testing.B) {
	var x e_nocarry_0326
	x.SetRandom()
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0326Butterfly(b *testing.B) {
	var x e_nocarry_0326
	x.SetRandom()
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0326)
	}
}

func BenchmarkE_nocarry_0326Exp(b *testing.B) {
	var x e_nocarry_0326
	x.SetRandom()
	benchRese_nocarry_0326.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0326Double(b *testing.B) {
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Double(&benchRese_nocarry_0326)
	}
}

func BenchmarkE_nocarry_0326Add(b *testing.B) {
	var x e_nocarry_0326
	x.SetRandom()
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Add(&x, &benchRese_nocarry_0326)
	}
}

func BenchmarkE_nocarry_0326Sub(b *testing.B) {
	var x e_nocarry_0326
	x.SetRandom()
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Sub(&x, &benchRese_nocarry_0326)
	}
}

func BenchmarkE_nocarry_0326Neg(b *testing.B) {
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Neg(&benchRese_nocarry_0326)
	}
}

func BenchmarkE_nocarry_0326Div(b *testing.B) {
	var x e_nocarry_0326
	x.SetRandom()
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Div(&x, &benchRese_nocarry_0326)
	}
}

func BenchmarkE_nocarry_0326FromMont(b *testing.B) {
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.FromMont()
	}
}

func BenchmarkE_nocarry_0326ToMont(b *testing.B) {
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.ToMont()
	}
}
func BenchmarkE_nocarry_0326Square(b *testing.B) {
	benchRese_nocarry_0326.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Square(&benchRese_nocarry_0326)
	}
}

func BenchmarkE_nocarry_0326Sqrt(b *testing.B) {
	var a e_nocarry_0326
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0326Mul(b *testing.B) {
	x := e_nocarry_0326{
	...
	benchRese_nocarry_0326.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Mul(&benchRese_nocarry_0326, &x)
	}
}

func BenchmarkE_nocarry_0326Cmp(b *testing.B) {
	x := e_nocarry_0326{
		17081109324860628151,
		5115219162471947274,
		8071747923719247431,
	...
	benchRese_nocarry_0326 = x
	benchRese_nocarry_0326[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0326.Cmp(&x)
	}
}

func TestE_nocarry_0326Cmp(t *testing.T) {
	var x, y e_nocarry_0326
...
func TestE_nocarry_0326IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0326
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0326

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0326{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0326
	one.SetOne()
	e.Sub(&qe_nocarry_0326, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0326{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0326{0, uint64(i)})
	}
...
func TestE_nocarry_0326NegZero(t *testing.T) {
	var a, b e_nocarry_0326
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0326Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0326, len(staticTestValues))
...
func TestE_nocarry_0326Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0326) bool {
			var b e_nocarry_0326
...
func TestE_nocarry_0326InverseExp(t *testing.T) {
...
func TestE_nocarry_0326MulByConstants(t *testing.T) {
...
func TestE_nocarry_0326Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0326) bool {
...
func TestE_nocarry_0326LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0326Halve(t *testing.T) {
...
func TestE_nocarry_0326FromMont(t *testing.T) {
...
type testPaire_nocarry_0326 struct {
	element e_nocarry_0326
	bigint  big.Int
}

func (z *e_nocarry_0326) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0326[5] {
		return true
	}
	if z[5] < qe_nocarry_0326[5] {
		return false
	...
	return z[0] >= qe_nocarry_0326[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0326

		g.element = e_nocarry_0326{
		...
		if qe_nocarry_0326[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0326[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0326 {
			var g e_nocarry_0326
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0326[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0326[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0326[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0326[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0326[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0326[5], carry)
...
func Benchmarke_nocarry_0326InverseNew(b *testing.B) {
	var x e_nocarry_0326
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0326
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0326
		var xInv e_nocarry_0326
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0326
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0326
...
func testLinearComb(t *testing.T, x *e_nocarry_0326, xC int64, y *e_nocarry_0326, yC int64) {
	...
	var z e_nocarry_0326
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0326, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0326
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0326, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0326
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0326, xHi uint64) {
	var res e_nocarry_0326
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0326) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0326) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0326, c int64, result *e_nocarry_0326, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0326) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0326) uint64 {
