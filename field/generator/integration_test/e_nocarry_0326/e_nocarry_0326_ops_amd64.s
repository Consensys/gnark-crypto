...
// modulus q
DATA q<>+0(SB)/8, $0x08c8e9edef7fcf73
DATA q<>+8(SB)/8, $0x5646ec0203b59a25
DATA q<>+16(SB)/8, $0xfb41510a2d5c7a9e
DATA q<>+24(SB)/8, $0x53e0956e491101d8
DATA q<>+32(SB)/8, $0x7ec35f2472e0c915
DATA q<>+40(SB)/8, $0x000000000000003e
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x1b6eab86d66d1245
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x08c8e9edef7fcf73, R10
	MOVQ    $0x5646ec0203b59a25, R11
	MOVQ    $0xfb41510a2d5c7a9e, R12
	MOVQ    $0x53e0956e491101d8, R13
	MOVQ    $0x7ec35f2472e0c915, R14
	MOVQ    $0x000000000000003e, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x5646ec0203b59a25, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xfb41510a2d5c7a9e, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x53e0956e491101d8, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x7ec35f2472e0c915, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000000000003e, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x08c8e9edef7fcf73, CX
	MOVQ    $0x5646ec0203b59a25, BX
	MOVQ    $0xfb41510a2d5c7a9e, SI
	MOVQ    $0x53e0956e491101d8, DI
	MOVQ    $0x7ec35f2472e0c915, R8
	MOVQ    $0x000000000000003e, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
