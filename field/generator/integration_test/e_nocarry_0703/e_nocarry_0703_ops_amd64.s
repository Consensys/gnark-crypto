...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xfd6758f46bb0f7dd, R14
	ADDQ R14, AX
	MOVQ $0xb9b3be905b84f2f1, R14
	ADCQ R14, DX
	MOVQ $0x9df519629755e819, R14
	ADCQ R14, CX
	MOVQ $0x632bd0564f78de98, R14
	ADCQ R14, BX
	MOVQ $0x043a31c1611f9dfd, R14
	ADCQ R14, SI
	MOVQ $0xe28938d503eb98be, R14
	ADCQ R14, DI
	MOVQ $0xce5d5b21644e3baf, R14
	ADCQ R14, R8
	MOVQ $0x0151d027defd3d6e, R14
	ADCQ R14, R9
	MOVQ $0x5e02dae45807fd11, R14
	ADCQ R14, R10
	MOVQ $0xf7588aade56d138c, R14
	ADCQ R14, R11
	MOVQ $0x622ea801f842d3ac, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xfd6758f46bb0f7dd, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xb9b3be905b84f2f1, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x9df519629755e819, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x632bd0564f78de98, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x043a31c1611f9dfd, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xe28938d503eb98be, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xce5d5b21644e3baf, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x0151d027defd3d6e, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x5e02dae45807fd11, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xf7588aade56d138c, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x622ea801f842d3ac, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xfd6758f46bb0f7dd, AX
	ADDQ AX, DX
	MOVQ $0xb9b3be905b84f2f1, AX
	ADCQ AX, CX
	MOVQ $0x9df519629755e819, AX
	ADCQ AX, BX
	MOVQ $0x632bd0564f78de98, AX
	ADCQ AX, SI
	MOVQ $0x043a31c1611f9dfd, AX
	ADCQ AX, DI
	MOVQ $0xe28938d503eb98be, AX
	ADCQ AX, R8
	MOVQ $0xce5d5b21644e3baf, AX
	ADCQ AX, R9
	MOVQ $0x0151d027defd3d6e, AX
	ADCQ AX, R10
	MOVQ $0x5e02dae45807fd11, AX
	ADCQ AX, R11
	MOVQ $0xf7588aade56d138c, AX
	ADCQ AX, R12
	MOVQ $0x622ea801f842d3ac, AX
	ADCQ AX, R13
