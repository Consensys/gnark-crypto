...
// modulus q
DATA q<>+0(SB)/8, $0xfd6758f46bb0f7dd
DATA q<>+8(SB)/8, $0xb9b3be905b84f2f1
DATA q<>+16(SB)/8, $0x9df519629755e819
DATA q<>+24(SB)/8, $0x632bd0564f78de98
DATA q<>+32(SB)/8, $0x043a31c1611f9dfd
DATA q<>+40(SB)/8, $0xe28938d503eb98be
DATA q<>+48(SB)/8, $0xce5d5b21644e3baf
DATA q<>+56(SB)/8, $0x0151d027defd3d6e
DATA q<>+64(SB)/8, $0x5e02dae45807fd11
DATA q<>+72(SB)/8, $0xf7588aade56d138c
DATA q<>+80(SB)/8, $0x622ea801f842d3ac
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xfecc9f2678b5e78b
