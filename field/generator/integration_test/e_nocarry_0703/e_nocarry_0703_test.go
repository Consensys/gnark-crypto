...
var benchRese_nocarry_0703 e_nocarry_0703

func BenchmarkE_nocarry_0703SetBytes(b *testing.B) {
	var x e_nocarry_0703
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0703MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0703.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0703)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0703)
		}
	})
}

func BenchmarkE_nocarry_0703Inverse(b *testing.B) {
	var x e_nocarry_0703
	x.SetRandom()
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0703Butterfly(b *testing.B) {
	var x e_nocarry_0703
	x.SetRandom()
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0703)
	}
}

func BenchmarkE_nocarry_0703Exp(b *testing.B) {
	var x e_nocarry_0703
	x.SetRandom()
	benchRese_nocarry_0703.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0703Double(b *testing.B) {
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Double(&benchRese_nocarry_0703)
	}
}

func BenchmarkE_nocarry_0703Add(b *testing.B) {
	var x e_nocarry_0703
	x.SetRandom()
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Add(&x, &benchRese_nocarry_0703)
	}
}

func BenchmarkE_nocarry_0703Sub(b *testing.B) {
	var x e_nocarry_0703
	x.SetRandom()
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Sub(&x, &benchRese_nocarry_0703)
	}
}

func BenchmarkE_nocarry_0703Neg(b *testing.B) {
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Neg(&benchRese_nocarry_0703)
	}
}

func BenchmarkE_nocarry_0703Div(b *testing.B) {
	var x e_nocarry_0703
	x.SetRandom()
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Div(&x, &benchRese_nocarry_0703)
	}
}

func BenchmarkE_nocarry_0703FromMont(b *testing.B) {
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.FromMont()
	}
}

func BenchmarkE_nocarry_0703ToMont(b *testing.B) {
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.ToMont()
	}
}
func BenchmarkE_nocarry_0703Square(b *testing.B) {
	benchRese_nocarry_0703.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Square(&benchRese_nocarry_0703)
	}
}

func BenchmarkE_nocarry_0703Sqrt(b *testing.B) {
	var a e_nocarry_0703
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0703Mul(b *testing.B) {
	x := e_nocarry_0703{
		1260525221227090017,
	...
	benchRese_nocarry_0703.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Mul(&benchRese_nocarry_0703, &x)
	}
}

func BenchmarkE_nocarry_0703Cmp(b *testing.B) {
	x := e_nocarry_0703{
		1260525221227090017,
		18393261735206954742,
		9875270097442042314,
	...
	benchRese_nocarry_0703 = x
	benchRese_nocarry_0703[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0703.Cmp(&x)
	}
}

func TestE_nocarry_0703Cmp(t *testing.T) {
	var x, y e_nocarry_0703
...
func TestE_nocarry_0703IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0703
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0703

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0703{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0703
	one.SetOne()
	e.Sub(&qe_nocarry_0703, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0703{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0703{0, uint64(i)})
	}
...
func TestE_nocarry_0703NegZero(t *testing.T) {
	var a, b e_nocarry_0703
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0703Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0703, len(staticTestValues))
...
func TestE_nocarry_0703Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0703) bool {
			var b e_nocarry_0703
...
func TestE_nocarry_0703InverseExp(t *testing.T) {
...
func TestE_nocarry_0703MulByConstants(t *testing.T) {
...
func TestE_nocarry_0703Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0703) bool {
...
func TestE_nocarry_0703LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0703Halve(t *testing.T) {
...
func TestE_nocarry_0703FromMont(t *testing.T) {
...
type testPaire_nocarry_0703 struct {
	element e_nocarry_0703
	bigint  big.Int
}

func (z *e_nocarry_0703) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0703[10] {
		return true
	}
	if z[10] < qe_nocarry_0703[10] {
		return false
	...
	return z[0] >= qe_nocarry_0703[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0703

		g.element = e_nocarry_0703{
		...
		if qe_nocarry_0703[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0703[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0703 {
			var g e_nocarry_0703
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0703[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0703[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0703[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0703[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0703[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0703[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0703[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0703[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0703[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0703[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0703[10], carry)
...
func Benchmarke_nocarry_0703InverseNew(b *testing.B) {
	var x e_nocarry_0703
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0703
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0703
		var xInv e_nocarry_0703
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0703
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0703
...
func testLinearComb(t *testing.T, x *e_nocarry_0703, xC int64, y *e_nocarry_0703, yC int64) {
	...
	var z e_nocarry_0703
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0703, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0703
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0703, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0703
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0703, xHi uint64) {
	var res e_nocarry_0703
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0703) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0703) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0703, c int64, result *e_nocarry_0703, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0703) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0703) uint64 {
