...
var benchRese_nocarry_0246 e_nocarry_0246

func BenchmarkE_nocarry_0246SetBytes(b *testing.B) {
	var x e_nocarry_0246
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0246MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0246.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0246)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0246)
		}
	})
}

func BenchmarkE_nocarry_0246Inverse(b *testing.B) {
	var x e_nocarry_0246
	x.SetRandom()
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0246Butterfly(b *testing.B) {
	var x e_nocarry_0246
	x.SetRandom()
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0246)
	}
}

func BenchmarkE_nocarry_0246Exp(b *testing.B) {
	var x e_nocarry_0246
	x.SetRandom()
	benchRese_nocarry_0246.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0246Double(b *testing.B) {
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Double(&benchRese_nocarry_0246)
	}
}

func BenchmarkE_nocarry_0246Add(b *testing.B) {
	var x e_nocarry_0246
	x.SetRandom()
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Add(&x, &benchRese_nocarry_0246)
	}
}

func BenchmarkE_nocarry_0246Sub(b *testing.B) {
	var x e_nocarry_0246
	x.SetRandom()
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Sub(&x, &benchRese_nocarry_0246)
	}
}

func BenchmarkE_nocarry_0246Neg(b *testing.B) {
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Neg(&benchRese_nocarry_0246)
	}
}

func BenchmarkE_nocarry_0246Div(b *testing.B) {
	var x e_nocarry_0246
	x.SetRandom()
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Div(&x, &benchRese_nocarry_0246)
	}
}

func BenchmarkE_nocarry_0246FromMont(b *testing.B) {
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.FromMont()
	}
}

func BenchmarkE_nocarry_0246ToMont(b *testing.B) {
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.ToMont()
	}
}
func BenchmarkE_nocarry_0246Square(b *testing.B) {
	benchRese_nocarry_0246.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Square(&benchRese_nocarry_0246)
	}
}

func BenchmarkE_nocarry_0246Sqrt(b *testing.B) {
	var a e_nocarry_0246
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0246Mul(b *testing.B) {
	x := e_nocarry_0246{
	...
	benchRese_nocarry_0246.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Mul(&benchRese_nocarry_0246, &x)
	}
}

func BenchmarkE_nocarry_0246Cmp(b *testing.B) {
	x := e_nocarry_0246{
		12060424702009086887,
		5311895748702178361,
		10748200324972574762,
	...
	benchRese_nocarry_0246 = x
	benchRese_nocarry_0246[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0246.Cmp(&x)
	}
}

func TestE_nocarry_0246Cmp(t *testing.T) {
	var x, y e_nocarry_0246
...
func TestE_nocarry_0246IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0246
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0246

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0246{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0246
	one.SetOne()
	e.Sub(&qe_nocarry_0246, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0246{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0246{0, uint64(i)})
	}
...
func TestE_nocarry_0246NegZero(t *testing.T) {
	var a, b e_nocarry_0246
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0246Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0246, len(staticTestValues))
...
func TestE_nocarry_0246Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0246) bool {
			var b e_nocarry_0246
...
func TestE_nocarry_0246InverseExp(t *testing.T) {
...
func TestE_nocarry_0246MulByConstants(t *testing.T) {
...
func TestE_nocarry_0246Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0246) bool {
...
func TestE_nocarry_0246LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0246Halve(t *testing.T) {
...
func TestE_nocarry_0246FromMont(t *testing.T) {
...
type testPaire_nocarry_0246 struct {
	element e_nocarry_0246
	bigint  big.Int
}

func (z *e_nocarry_0246) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0246[3] {
		return true
	}
	if z[3] < qe_nocarry_0246[3] {
		return false
	...
	return z[0] >= qe_nocarry_0246[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0246

		g.element = e_nocarry_0246{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0246[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0246[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0246 {
			var g e_nocarry_0246
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0246[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0246[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0246[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0246[3], carry)
...
func Benchmarke_nocarry_0246InverseNew(b *testing.B) {
	var x e_nocarry_0246
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0246
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0246
		var xInv e_nocarry_0246
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0246
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0246
...
func testLinearComb(t *testing.T, x *e_nocarry_0246, xC int64, y *e_nocarry_0246, yC int64) {
	...
	var z e_nocarry_0246
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0246, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0246
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0246, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0246
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0246, xHi uint64) {
	var res e_nocarry_0246
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0246) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0246) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0246, c int64, result *e_nocarry_0246, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0246) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0246) uint64 {
