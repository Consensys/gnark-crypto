...
// modulus q
DATA q<>+0(SB)/8, $0xc1039ad3d9ad828b
DATA q<>+8(SB)/8, $0xc3bf6a7123d55889
DATA q<>+16(SB)/8, $0xc15e9a96a9f08250
DATA q<>+24(SB)/8, $0x003970f60d4ea945
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x8e747871a452aadd
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xc1039ad3d9ad828b, R8
	MOVQ    $0xc3bf6a7123d55889, R9
	MOVQ    $0xc15e9a96a9f08250, R10
	MOVQ    $0x003970f60d4ea945, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xc3bf6a7123d55889, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xc15e9a96a9f08250, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x003970f60d4ea945, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xc1039ad3d9ad828b, R12
	MOVQ    $0xc3bf6a7123d55889, R13
	MOVQ    $0xc15e9a96a9f08250, R14
	MOVQ    $0x003970f60d4ea945, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
