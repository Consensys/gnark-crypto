...
// modulus q
DATA q<>+0(SB)/8, $0xfe1d8d943577bf13
DATA q<>+8(SB)/8, $0x2943c60296eddc96
DATA q<>+16(SB)/8, $0xe5eae2abde634ee1
DATA q<>+24(SB)/8, $0x00000000000001e6
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x8b0a08ac74941ce5
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xfe1d8d943577bf13, R8
	MOVQ    $0x2943c60296eddc96, R9
	MOVQ    $0xe5eae2abde634ee1, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x2943c60296eddc96, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xe5eae2abde634ee1, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000000000001e6, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xfe1d8d943577bf13, R12
	MOVQ    $0x2943c60296eddc96, R13
	MOVQ    $0xe5eae2abde634ee1, R14
	MOVQ    $0x00000000000001e6, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
