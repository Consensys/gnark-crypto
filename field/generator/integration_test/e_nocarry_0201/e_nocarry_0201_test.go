...
var benchRese_nocarry_0201 e_nocarry_0201

func BenchmarkE_nocarry_0201SetBytes(b *testing.B) {
	var x e_nocarry_0201
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0201MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0201.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0201)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0201)
		}
	})
}

func BenchmarkE_nocarry_0201Inverse(b *testing.B) {
	var x e_nocarry_0201
	x.SetRandom()
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0201Butterfly(b *testing.B) {
	var x e_nocarry_0201
	x.SetRandom()
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0201)
	}
}

func BenchmarkE_nocarry_0201Exp(b *testing.B) {
	var x e_nocarry_0201
	x.SetRandom()
	benchRese_nocarry_0201.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0201Double(b *testing.B) {
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Double(&benchRese_nocarry_0201)
	}
}

func BenchmarkE_nocarry_0201Add(b *testing.B) {
	var x e_nocarry_0201
	x.SetRandom()
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Add(&x, &benchRese_nocarry_0201)
	}
}

func BenchmarkE_nocarry_0201Sub(b *testing.B) {
	var x e_nocarry_0201
	x.SetRandom()
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Sub(&x, &benchRese_nocarry_0201)
	}
}

func BenchmarkE_nocarry_0201Neg(b *testing.B) {
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Neg(&benchRese_nocarry_0201)
	}
}

func BenchmarkE_nocarry_0201Div(b *testing.B) {
	var x e_nocarry_0201
	x.SetRandom()
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Div(&x, &benchRese_nocarry_0201)
	}
}

func BenchmarkE_nocarry_0201FromMont(b *testing.B) {
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.FromMont()
	}
}

func BenchmarkE_nocarry_0201ToMont(b *testing.B) {
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.ToMont()
	}
}
func BenchmarkE_nocarry_0201Square(b *testing.B) {
	benchRese_nocarry_0201.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Square(&benchRese_nocarry_0201)
	}
}

func BenchmarkE_nocarry_0201Sqrt(b *testing.B) {
	var a e_nocarry_0201
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0201Mul(b *testing.B) {
	x := e_nocarry_0201{
	...
	benchRese_nocarry_0201.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Mul(&benchRese_nocarry_0201, &x)
	}
}

func BenchmarkE_nocarry_0201Cmp(b *testing.B) {
	x := e_nocarry_0201{
		13850811151489047805,
		11044276469827543129,
		13702876769900629096,
	...
	benchRese_nocarry_0201 = x
	benchRese_nocarry_0201[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0201.Cmp(&x)
	}
}

func TestE_nocarry_0201Cmp(t *testing.T) {
	var x, y e_nocarry_0201
...
func TestE_nocarry_0201IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0201
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0201

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0201{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0201
	one.SetOne()
	e.Sub(&qe_nocarry_0201, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0201{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0201{0, uint64(i)})
	}
...
func TestE_nocarry_0201NegZero(t *testing.T) {
	var a, b e_nocarry_0201
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0201Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0201, len(staticTestValues))
...
func TestE_nocarry_0201Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0201) bool {
			var b e_nocarry_0201
...
func TestE_nocarry_0201InverseExp(t *testing.T) {
...
func TestE_nocarry_0201MulByConstants(t *testing.T) {
...
func TestE_nocarry_0201Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0201) bool {
...
func TestE_nocarry_0201LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0201Halve(t *testing.T) {
...
func TestE_nocarry_0201FromMont(t *testing.T) {
...
type testPaire_nocarry_0201 struct {
	element e_nocarry_0201
	bigint  big.Int
}

func (z *e_nocarry_0201) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0201[3] {
		return true
	}
	if z[3] < qe_nocarry_0201[3] {
		return false
	...
	return z[0] >= qe_nocarry_0201[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0201

		g.element = e_nocarry_0201{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0201[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0201[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0201 {
			var g e_nocarry_0201
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0201[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0201[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0201[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0201[3], carry)
...
func Benchmarke_nocarry_0201InverseNew(b *testing.B) {
	var x e_nocarry_0201
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0201
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0201
		var xInv e_nocarry_0201
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0201
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0201
...
func testLinearComb(t *testing.T, x *e_nocarry_0201, xC int64, y *e_nocarry_0201, yC int64) {
	...
	var z e_nocarry_0201
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0201, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0201
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0201, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0201
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0201, xHi uint64) {
	var res e_nocarry_0201
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0201) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0201) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0201, c int64, result *e_nocarry_0201, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0201) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0201) uint64 {
