...
// modulus q
DATA q<>+0(SB)/8, $0x60b1908e7531ba1d
DATA q<>+8(SB)/8, $0xa24f6720e81283b3
DATA q<>+16(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x772beea2896327cb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x60b1908e7531ba1d, DI
	MOVQ    $0xa24f6720e81283b3, R8
	MOVQ    $1, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x60b1908e7531ba1d, R10
	MOVQ    $0xa24f6720e81283b3, R11
	MOVQ    $1, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
