...
var benchRese_nocarry_0651 e_nocarry_0651

func BenchmarkE_nocarry_0651SetBytes(b *testing.B) {
	var x e_nocarry_0651
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0651MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0651.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0651)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0651)
		}
	})
}

func BenchmarkE_nocarry_0651Inverse(b *testing.B) {
	var x e_nocarry_0651
	x.SetRandom()
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0651Butterfly(b *testing.B) {
	var x e_nocarry_0651
	x.SetRandom()
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0651)
	}
}

func BenchmarkE_nocarry_0651Exp(b *testing.B) {
	var x e_nocarry_0651
	x.SetRandom()
	benchRese_nocarry_0651.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0651Double(b *testing.B) {
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Double(&benchRese_nocarry_0651)
	}
}

func BenchmarkE_nocarry_0651Add(b *testing.B) {
	var x e_nocarry_0651
	x.SetRandom()
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Add(&x, &benchRese_nocarry_0651)
	}
}

func BenchmarkE_nocarry_0651Sub(b *testing.B) {
	var x e_nocarry_0651
	x.SetRandom()
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Sub(&x, &benchRese_nocarry_0651)
	}
}

func BenchmarkE_nocarry_0651Neg(b *testing.B) {
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Neg(&benchRese_nocarry_0651)
	}
}

func BenchmarkE_nocarry_0651Div(b *testing.B) {
	var x e_nocarry_0651
	x.SetRandom()
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Div(&x, &benchRese_nocarry_0651)
	}
}

func BenchmarkE_nocarry_0651FromMont(b *testing.B) {
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.FromMont()
	}
}

func BenchmarkE_nocarry_0651ToMont(b *testing.B) {
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.ToMont()
	}
}
func BenchmarkE_nocarry_0651Square(b *testing.B) {
	benchRese_nocarry_0651.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Square(&benchRese_nocarry_0651)
	}
}

func BenchmarkE_nocarry_0651Sqrt(b *testing.B) {
	var a e_nocarry_0651
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0651Mul(b *testing.B) {
	x := e_nocarry_0651{
		1673046671414685310,
	...
	benchRese_nocarry_0651.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Mul(&benchRese_nocarry_0651, &x)
	}
}

func BenchmarkE_nocarry_0651Cmp(b *testing.B) {
	x := e_nocarry_0651{
		1673046671414685310,
		12986690898097105774,
		11616073895163324621,
	...
	benchRese_nocarry_0651 = x
	benchRese_nocarry_0651[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0651.Cmp(&x)
	}
}

func TestE_nocarry_0651Cmp(t *testing.T) {
	var x, y e_nocarry_0651
...
func TestE_nocarry_0651IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0651
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0651

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0651{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0651
	one.SetOne()
	e.Sub(&qe_nocarry_0651, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0651{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0651{0, uint64(i)})
	}
...
func TestE_nocarry_0651NegZero(t *testing.T) {
	var a, b e_nocarry_0651
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0651Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0651, len(staticTestValues))
...
func TestE_nocarry_0651Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0651) bool {
			var b e_nocarry_0651
...
func TestE_nocarry_0651InverseExp(t *testing.T) {
...
func TestE_nocarry_0651MulByConstants(t *testing.T) {
...
func TestE_nocarry_0651Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0651) bool {
...
func TestE_nocarry_0651LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0651Halve(t *testing.T) {
...
func TestE_nocarry_0651FromMont(t *testing.T) {
...
type testPaire_nocarry_0651 struct {
	element e_nocarry_0651
	bigint  big.Int
}

func (z *e_nocarry_0651) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0651[10] {
		return true
	}
	if z[10] < qe_nocarry_0651[10] {
		return false
	...
	return z[0] >= qe_nocarry_0651[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0651

		g.element = e_nocarry_0651{
		...
		if qe_nocarry_0651[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0651[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0651 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0651[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0651[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0651[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0651[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0651[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0651[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0651[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0651[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0651[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0651[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0651[10], carry)
...
func Benchmarke_nocarry_0651InverseNew(b *testing.B) {
	var x e_nocarry_0651
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0651
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0651
		var xInv e_nocarry_0651
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0651
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0651
...
func testLinearComb(t *testing.T, x *e_nocarry_0651, xC int64, y *e_nocarry_0651, yC int64) {
	...
	var z e_nocarry_0651
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0651, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0651
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0651, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0651
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0651, xHi uint64) {
	var res e_nocarry_0651
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0651) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0651) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0651, c int64, result *e_nocarry_0651, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0651) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0651) uint64 {
