...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x05c0c93acac9d1c1, R14
	ADDQ R14, AX
	MOVQ $0xdc685d20090ea14b, R14
	ADCQ R14, DX
	MOVQ $0x6aecd72ec0e29939, R14
	ADCQ R14, CX
	MOVQ $0x787fcbb58c52bc28, R14
	ADCQ R14, BX
	MOVQ $0x6350e1597eb09995, R14
	ADCQ R14, SI
	MOVQ $0x6d48acc70577e891, R14
	ADCQ R14, DI
	MOVQ $0x08663313512fa89e, R14
	ADCQ R14, R8
	MOVQ $0x7ace4a2d6af3ee61, R14
	ADCQ R14, R9
	MOVQ $0x19f384043dcdf182, R14
	ADCQ R14, R10
	MOVQ $0x06f5d9dd6babd5e3, R14
	ADCQ R14, R11
	MOVQ $0x00000000000007d2, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x05c0c93acac9d1c1, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xdc685d20090ea14b, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x6aecd72ec0e29939, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x787fcbb58c52bc28, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x6350e1597eb09995, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x6d48acc70577e891, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x08663313512fa89e, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x7ace4a2d6af3ee61, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x19f384043dcdf182, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x06f5d9dd6babd5e3, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000000007d2, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x05c0c93acac9d1c1, AX
	ADDQ AX, DX
	MOVQ $0xdc685d20090ea14b, AX
	ADCQ AX, CX
	MOVQ $0x6aecd72ec0e29939, AX
	ADCQ AX, BX
	MOVQ $0x787fcbb58c52bc28, AX
	ADCQ AX, SI
	MOVQ $0x6350e1597eb09995, AX
	ADCQ AX, DI
	MOVQ $0x6d48acc70577e891, AX
	ADCQ AX, R8
	MOVQ $0x08663313512fa89e, AX
	ADCQ AX, R9
	MOVQ $0x7ace4a2d6af3ee61, AX
	ADCQ AX, R10
	MOVQ $0x19f384043dcdf182, AX
	ADCQ AX, R11
	MOVQ $0x06f5d9dd6babd5e3, AX
	ADCQ AX, R12
	MOVQ $0x00000000000007d2, AX
	ADCQ AX, R13
