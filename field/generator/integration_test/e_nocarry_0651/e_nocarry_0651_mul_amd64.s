...
// modulus q
DATA q<>+0(SB)/8, $0x05c0c93acac9d1c1
DATA q<>+8(SB)/8, $0xdc685d20090ea14b
DATA q<>+16(SB)/8, $0x6aecd72ec0e29939
DATA q<>+24(SB)/8, $0x787fcbb58c52bc28
DATA q<>+32(SB)/8, $0x6350e1597eb09995
DATA q<>+40(SB)/8, $0x6d48acc70577e891
DATA q<>+48(SB)/8, $0x08663313512fa89e
DATA q<>+56(SB)/8, $0x7ace4a2d6af3ee61
DATA q<>+64(SB)/8, $0x19f384043dcdf182
DATA q<>+72(SB)/8, $0x06f5d9dd6babd5e3
DATA q<>+80(SB)/8, $0x00000000000007d2
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x66ad99af8acac1bf
