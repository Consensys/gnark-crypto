...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xf358828328cb155d, R14
	ADDQ R14, AX
	MOVQ $0x489d25d922a31348, R14
	ADCQ R14, DX
	MOVQ $0xb64052f4560bc0f8, R14
	ADCQ R14, CX
	MOVQ $0xe7347f8cebb438f6, R14
	ADCQ R14, BX
	MOVQ $0xf0bfde8cb655f3f9, R14
	ADCQ R14, SI
	MOVQ $0xbe7e1f1260b9ce05, R14
	ADCQ R14, DI
	MOVQ $0x642eb8bea69666a6, R14
	ADCQ R14, R8
	MOVQ $0xccb466d86d40c3c6, R14
	ADCQ R14, R9
	MOVQ $0x72e930a0706a529d, R14
	ADCQ R14, R10
	MOVQ $0x4bf67f81ef9c67c0, R14
	ADCQ R14, R11
	MOVQ $0x00dceb2786190526, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf358828328cb155d, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x489d25d922a31348, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xb64052f4560bc0f8, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xe7347f8cebb438f6, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xf0bfde8cb655f3f9, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xbe7e1f1260b9ce05, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x642eb8bea69666a6, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xccb466d86d40c3c6, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x72e930a0706a529d, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x4bf67f81ef9c67c0, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00dceb2786190526, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xf358828328cb155d, AX
	ADDQ AX, DX
	MOVQ $0x489d25d922a31348, AX
	ADCQ AX, CX
	MOVQ $0xb64052f4560bc0f8, AX
	ADCQ AX, BX
	MOVQ $0xe7347f8cebb438f6, AX
	ADCQ AX, SI
	MOVQ $0xf0bfde8cb655f3f9, AX
	ADCQ AX, DI
	MOVQ $0xbe7e1f1260b9ce05, AX
	ADCQ AX, R8
	MOVQ $0x642eb8bea69666a6, AX
	ADCQ AX, R9
	MOVQ $0xccb466d86d40c3c6, AX
	ADCQ AX, R10
	MOVQ $0x72e930a0706a529d, AX
	ADCQ AX, R11
	MOVQ $0x4bf67f81ef9c67c0, AX
	ADCQ AX, R12
	MOVQ $0x00dceb2786190526, AX
	ADCQ AX, R13
