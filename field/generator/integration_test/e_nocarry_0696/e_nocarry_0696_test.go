...
var benchRese_nocarry_0696 e_nocarry_0696

func BenchmarkE_nocarry_0696SetBytes(b *testing.B) {
	var x e_nocarry_0696
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0696MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0696.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0696)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0696)
		}
	})
}

func BenchmarkE_nocarry_0696Inverse(b *testing.B) {
	var x e_nocarry_0696
	x.SetRandom()
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0696Butterfly(b *testing.B) {
	var x e_nocarry_0696
	x.SetRandom()
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0696)
	}
}

func BenchmarkE_nocarry_0696Exp(b *testing.B) {
	var x e_nocarry_0696
	x.SetRandom()
	benchRese_nocarry_0696.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0696Double(b *testing.B) {
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Double(&benchRese_nocarry_0696)
	}
}

func BenchmarkE_nocarry_0696Add(b *testing.B) {
	var x e_nocarry_0696
	x.SetRandom()
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Add(&x, &benchRese_nocarry_0696)
	}
}

func BenchmarkE_nocarry_0696Sub(b *testing.B) {
	var x e_nocarry_0696
	x.SetRandom()
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Sub(&x, &benchRese_nocarry_0696)
	}
}

func BenchmarkE_nocarry_0696Neg(b *testing.B) {
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Neg(&benchRese_nocarry_0696)
	}
}

func BenchmarkE_nocarry_0696Div(b *testing.B) {
	var x e_nocarry_0696
	x.SetRandom()
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Div(&x, &benchRese_nocarry_0696)
	}
}

func BenchmarkE_nocarry_0696FromMont(b *testing.B) {
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.FromMont()
	}
}

func BenchmarkE_nocarry_0696ToMont(b *testing.B) {
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.ToMont()
	}
}
func BenchmarkE_nocarry_0696Square(b *testing.B) {
	benchRese_nocarry_0696.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Square(&benchRese_nocarry_0696)
	}
}

func BenchmarkE_nocarry_0696Sqrt(b *testing.B) {
	var a e_nocarry_0696
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0696Mul(b *testing.B) {
	x := e_nocarry_0696{
		6227551404892220863,
		5777694296420707402,
		5618768402619924495,
	...
	benchRese_nocarry_0696.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Mul(&benchRese_nocarry_0696, &x)
	}
}

func BenchmarkE_nocarry_0696Cmp(b *testing.B) {
	x := e_nocarry_0696{
		6227551404892220863,
		5777694296420707402,
		5618768402619924495,
	...
	benchRese_nocarry_0696 = x
	benchRese_nocarry_0696[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0696.Cmp(&x)
	}
}

func TestE_nocarry_0696Cmp(t *testing.T) {
	var x, y e_nocarry_0696
...
func TestE_nocarry_0696IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0696
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0696

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0696{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0696
	one.SetOne()
	e.Sub(&qe_nocarry_0696, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0696{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0696{0, uint64(i)})
	}
...
func TestE_nocarry_0696NegZero(t *testing.T) {
	var a, b e_nocarry_0696
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0696Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0696, len(staticTestValues))
...
func TestE_nocarry_0696Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0696) bool {
			var b e_nocarry_0696
...
func TestE_nocarry_0696InverseExp(t *testing.T) {
...
func TestE_nocarry_0696MulByConstants(t *testing.T) {
...
func TestE_nocarry_0696Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0696) bool {
...
func TestE_nocarry_0696LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0696Halve(t *testing.T) {
...
func TestE_nocarry_0696FromMont(t *testing.T) {
...
type testPaire_nocarry_0696 struct {
	element e_nocarry_0696
	bigint  big.Int
}

func (z *e_nocarry_0696) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0696[10] {
		return true
	}
	if z[10] < qe_nocarry_0696[10] {
		return false
	...
	return z[0] >= qe_nocarry_0696[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0696

		g.element = e_nocarry_0696{
		...
		if qe_nocarry_0696[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0696[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0696 {
			var g e_nocarry_0696
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0696[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0696[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0696[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0696[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0696[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0696[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0696[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0696[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0696[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0696[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0696[10], carry)
...
func Benchmarke_nocarry_0696InverseNew(b *testing.B) {
	var x e_nocarry_0696
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0696
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0696
		var xInv e_nocarry_0696
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0696
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0696
...
func testLinearComb(t *testing.T, x *e_nocarry_0696, xC int64, y *e_nocarry_0696, yC int64) {
	...
	var z e_nocarry_0696
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0696, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0696
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0696, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0696
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0696, xHi uint64) {
	var res e_nocarry_0696
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0696) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0696) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0696, c int64, result *e_nocarry_0696, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0696) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0696) uint64 {
