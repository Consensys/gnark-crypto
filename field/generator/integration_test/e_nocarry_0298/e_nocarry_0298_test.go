...
var benchRese_nocarry_0298 e_nocarry_0298

func BenchmarkE_nocarry_0298SetBytes(b *testing.B) {
	var x e_nocarry_0298
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0298MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0298.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0298)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0298)
		}
	})
}

func BenchmarkE_nocarry_0298Inverse(b *testing.B) {
	var x e_nocarry_0298
	x.SetRandom()
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0298Butterfly(b *testing.B) {
	var x e_nocarry_0298
	x.SetRandom()
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0298)
	}
}

func BenchmarkE_nocarry_0298Exp(b *testing.B) {
	var x e_nocarry_0298
	x.SetRandom()
	benchRese_nocarry_0298.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0298Double(b *testing.B) {
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Double(&benchRese_nocarry_0298)
	}
}

func BenchmarkE_nocarry_0298Add(b *testing.B) {
	var x e_nocarry_0298
	x.SetRandom()
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Add(&x, &benchRese_nocarry_0298)
	}
}

func BenchmarkE_nocarry_0298Sub(b *testing.B) {
	var x e_nocarry_0298
	x.SetRandom()
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Sub(&x, &benchRese_nocarry_0298)
	}
}

func BenchmarkE_nocarry_0298Neg(b *testing.B) {
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Neg(&benchRese_nocarry_0298)
	}
}

func BenchmarkE_nocarry_0298Div(b *testing.B) {
	var x e_nocarry_0298
	x.SetRandom()
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Div(&x, &benchRese_nocarry_0298)
	}
}

func BenchmarkE_nocarry_0298FromMont(b *testing.B) {
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.FromMont()
	}
}

func BenchmarkE_nocarry_0298ToMont(b *testing.B) {
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.ToMont()
	}
}
func BenchmarkE_nocarry_0298Square(b *testing.B) {
	benchRese_nocarry_0298.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Square(&benchRese_nocarry_0298)
	}
}

func BenchmarkE_nocarry_0298Sqrt(b *testing.B) {
	var a e_nocarry_0298
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0298Mul(b *testing.B) {
	x := e_nocarry_0298{
	...
	benchRese_nocarry_0298.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Mul(&benchRese_nocarry_0298, &x)
	}
}

func BenchmarkE_nocarry_0298Cmp(b *testing.B) {
	x := e_nocarry_0298{
		13280563630292077908,
		11102230890325450318,
		10354941293511788525,
	...
	benchRese_nocarry_0298 = x
	benchRese_nocarry_0298[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0298.Cmp(&x)
	}
}

func TestE_nocarry_0298Cmp(t *testing.T) {
	var x, y e_nocarry_0298
...
func TestE_nocarry_0298IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0298
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0298

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0298{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0298
	one.SetOne()
	e.Sub(&qe_nocarry_0298, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0298{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0298{0, uint64(i)})
	}
...
func TestE_nocarry_0298NegZero(t *testing.T) {
	var a, b e_nocarry_0298
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0298Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0298, len(staticTestValues))
...
func TestE_nocarry_0298Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0298) bool {
			var b e_nocarry_0298
...
func TestE_nocarry_0298InverseExp(t *testing.T) {
...
func TestE_nocarry_0298MulByConstants(t *testing.T) {
...
func TestE_nocarry_0298Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0298) bool {
...
func TestE_nocarry_0298LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0298Halve(t *testing.T) {
...
func TestE_nocarry_0298FromMont(t *testing.T) {
...
type testPaire_nocarry_0298 struct {
	element e_nocarry_0298
	bigint  big.Int
}

func (z *e_nocarry_0298) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0298[4] {
		return true
	}
	if z[4] < qe_nocarry_0298[4] {
		return false
	...
	return z[0] >= qe_nocarry_0298[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0298

		g.element = e_nocarry_0298{
		...
		if qe_nocarry_0298[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0298[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0298 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0298[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0298[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0298[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0298[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0298[4], carry)
...
func Benchmarke_nocarry_0298InverseNew(b *testing.B) {
	var x e_nocarry_0298
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0298
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0298
		var xInv e_nocarry_0298
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0298
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0298
...
func testLinearComb(t *testing.T, x *e_nocarry_0298, xC int64, y *e_nocarry_0298, yC int64) {
	...
	var z e_nocarry_0298
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0298, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0298
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0298, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0298
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0298, xHi uint64) {
	var res e_nocarry_0298
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0298) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0298) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0298, c int64, result *e_nocarry_0298, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0298) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0298) uint64 {
