...
// modulus q
DATA q<>+0(SB)/8, $0x6ac7b550c18c4b91
DATA q<>+8(SB)/8, $0xc3b9238d2ef7d174
DATA q<>+16(SB)/8, $0xcbdb1b5e7b490faa
DATA q<>+24(SB)/8, $0xecdab8d18d1db93a
DATA q<>+32(SB)/8, $0x0000031f0ffaea8b
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x6a3c9700047c2a8f
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x6ac7b550c18c4b91, R9
	MOVQ    $0xc3b9238d2ef7d174, R10
	MOVQ    $0xcbdb1b5e7b490faa, R11
	MOVQ    $0xecdab8d18d1db93a, R12
	MOVQ    $0x0000031f0ffaea8b, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xc3b9238d2ef7d174, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xcbdb1b5e7b490faa, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xecdab8d18d1db93a, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000031f0ffaea8b, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x6ac7b550c18c4b91, CX
	MOVQ    $0xc3b9238d2ef7d174, BX
	MOVQ    $0xcbdb1b5e7b490faa, SI
	MOVQ    $0xecdab8d18d1db93a, DI
	MOVQ    $0x0000031f0ffaea8b, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
