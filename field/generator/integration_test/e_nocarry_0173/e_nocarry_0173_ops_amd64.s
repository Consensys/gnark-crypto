...
// modulus q
DATA q<>+0(SB)/8, $0xde0c2a4ff9cc8e1d
DATA q<>+8(SB)/8, $0x04835f83ef055d4e
DATA q<>+16(SB)/8, $0x00001e6c842453ae
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x786c7f394eb35bcb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xde0c2a4ff9cc8e1d, DI
	MOVQ    $0x04835f83ef055d4e, R8
	MOVQ    $0x00001e6c842453ae, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x04835f83ef055d4e, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x00001e6c842453ae, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xde0c2a4ff9cc8e1d, R10
	MOVQ    $0x04835f83ef055d4e, R11
	MOVQ    $0x00001e6c842453ae, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
