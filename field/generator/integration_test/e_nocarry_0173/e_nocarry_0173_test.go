...
var benchRese_nocarry_0173 e_nocarry_0173

func BenchmarkE_nocarry_0173SetBytes(b *testing.B) {
	var x e_nocarry_0173
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0173MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0173.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0173)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0173)
		}
	})
}

func BenchmarkE_nocarry_0173Inverse(b *testing.B) {
	var x e_nocarry_0173
	x.SetRandom()
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0173Butterfly(b *testing.B) {
	var x e_nocarry_0173
	x.SetRandom()
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0173)
	}
}

func BenchmarkE_nocarry_0173Exp(b *testing.B) {
	var x e_nocarry_0173
	x.SetRandom()
	benchRese_nocarry_0173.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0173Double(b *testing.B) {
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Double(&benchRese_nocarry_0173)
	}
}

func BenchmarkE_nocarry_0173Add(b *testing.B) {
	var x e_nocarry_0173
	x.SetRandom()
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Add(&x, &benchRese_nocarry_0173)
	}
}

func BenchmarkE_nocarry_0173Sub(b *testing.B) {
	var x e_nocarry_0173
	x.SetRandom()
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Sub(&x, &benchRese_nocarry_0173)
	}
}

func BenchmarkE_nocarry_0173Neg(b *testing.B) {
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Neg(&benchRese_nocarry_0173)
	}
}

func BenchmarkE_nocarry_0173Div(b *testing.B) {
	var x e_nocarry_0173
	x.SetRandom()
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Div(&x, &benchRese_nocarry_0173)
	}
}

func BenchmarkE_nocarry_0173FromMont(b *testing.B) {
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.FromMont()
	}
}

func BenchmarkE_nocarry_0173ToMont(b *testing.B) {
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.ToMont()
	}
}
func BenchmarkE_nocarry_0173Square(b *testing.B) {
	benchRese_nocarry_0173.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Square(&benchRese_nocarry_0173)
	}
}

func BenchmarkE_nocarry_0173Sqrt(b *testing.B) {
	var a e_nocarry_0173
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0173Mul(b *testing.B) {
	x := e_nocarry_0173{
		9450990054917752325,
		329625913004559065,
		11450825773964,
	}
	benchRese_nocarry_0173.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Mul(&benchRese_nocarry_0173, &x)
	}
}

func BenchmarkE_nocarry_0173Cmp(b *testing.B) {
	x := e_nocarry_0173{
		9450990054917752325,
		329625913004559065,
		11450825773964,
	}
	benchRese_nocarry_0173 = x
	benchRese_nocarry_0173[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0173.Cmp(&x)
	}
}

func TestE_nocarry_0173Cmp(t *testing.T) {
	var x, y e_nocarry_0173
...
func TestE_nocarry_0173IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0173
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0173

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0173{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0173
	one.SetOne()
	e.Sub(&qe_nocarry_0173, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0173{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0173{0, uint64(i)})
	}
...
func TestE_nocarry_0173NegZero(t *testing.T) {
	var a, b e_nocarry_0173
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0173Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0173, len(staticTestValues))
...
func TestE_nocarry_0173Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0173) bool {
			var b e_nocarry_0173
...
func TestE_nocarry_0173InverseExp(t *testing.T) {
...
func TestE_nocarry_0173MulByConstants(t *testing.T) {
...
func TestE_nocarry_0173Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0173) bool {
...
func TestE_nocarry_0173LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0173Halve(t *testing.T) {
...
func TestE_nocarry_0173FromMont(t *testing.T) {
...
type testPaire_nocarry_0173 struct {
	element e_nocarry_0173
	bigint  big.Int
}

func (z *e_nocarry_0173) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0173[2] {
		return true
	}
	if z[2] < qe_nocarry_0173[2] {
		return false
	...
	return z[0] >= qe_nocarry_0173[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0173

		g.element = e_nocarry_0173{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0173[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0173[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0173 {
			var g e_nocarry_0173
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0173[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0173[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0173[2], carry)
...
func Benchmarke_nocarry_0173InverseNew(b *testing.B) {
	var x e_nocarry_0173
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0173
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0173
		var xInv e_nocarry_0173
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0173
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0173
...
func testLinearComb(t *testing.T, x *e_nocarry_0173, xC int64, y *e_nocarry_0173, yC int64) {
	...
	var z e_nocarry_0173
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0173, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0173
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0173, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0173
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0173, xHi uint64) {
	var res e_nocarry_0173
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0173) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0173) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0173, c int64, result *e_nocarry_0173, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0173) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0173) uint64 {
