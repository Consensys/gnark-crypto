...
var benchRese_nocarry_0295 e_nocarry_0295

func BenchmarkE_nocarry_0295SetBytes(b *testing.B) {
	var x e_nocarry_0295
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0295MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0295.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0295)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0295)
		}
	})
}

func BenchmarkE_nocarry_0295Inverse(b *testing.B) {
	var x e_nocarry_0295
	x.SetRandom()
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0295Butterfly(b *testing.B) {
	var x e_nocarry_0295
	x.SetRandom()
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0295)
	}
}

func BenchmarkE_nocarry_0295Exp(b *testing.B) {
	var x e_nocarry_0295
	x.SetRandom()
	benchRese_nocarry_0295.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0295Double(b *testing.B) {
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Double(&benchRese_nocarry_0295)
	}
}

func BenchmarkE_nocarry_0295Add(b *testing.B) {
	var x e_nocarry_0295
	x.SetRandom()
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Add(&x, &benchRese_nocarry_0295)
	}
}

func BenchmarkE_nocarry_0295Sub(b *testing.B) {
	var x e_nocarry_0295
	x.SetRandom()
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Sub(&x, &benchRese_nocarry_0295)
	}
}

func BenchmarkE_nocarry_0295Neg(b *testing.B) {
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Neg(&benchRese_nocarry_0295)
	}
}

func BenchmarkE_nocarry_0295Div(b *testing.B) {
	var x e_nocarry_0295
	x.SetRandom()
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Div(&x, &benchRese_nocarry_0295)
	}
}

func BenchmarkE_nocarry_0295FromMont(b *testing.B) {
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.FromMont()
	}
}

func BenchmarkE_nocarry_0295ToMont(b *testing.B) {
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.ToMont()
	}
}
func BenchmarkE_nocarry_0295Square(b *testing.B) {
	benchRese_nocarry_0295.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Square(&benchRese_nocarry_0295)
	}
}

func BenchmarkE_nocarry_0295Sqrt(b *testing.B) {
	var a e_nocarry_0295
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0295Mul(b *testing.B) {
	x := e_nocarry_0295{
	...
	benchRese_nocarry_0295.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Mul(&benchRese_nocarry_0295, &x)
	}
}

func BenchmarkE_nocarry_0295Cmp(b *testing.B) {
	x := e_nocarry_0295{
		11949877819145115850,
		16383392866930794285,
		12704171291328400361,
	...
	benchRese_nocarry_0295 = x
	benchRese_nocarry_0295[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0295.Cmp(&x)
	}
}

func TestE_nocarry_0295Cmp(t *testing.T) {
	var x, y e_nocarry_0295
...
func TestE_nocarry_0295IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0295
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0295

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0295{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0295
	one.SetOne()
	e.Sub(&qe_nocarry_0295, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0295{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0295{0, uint64(i)})
	}
...
func TestE_nocarry_0295NegZero(t *testing.T) {
	var a, b e_nocarry_0295
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0295Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0295, len(staticTestValues))
...
func TestE_nocarry_0295Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0295) bool {
			var b e_nocarry_0295
...
func TestE_nocarry_0295InverseExp(t *testing.T) {
...
func TestE_nocarry_0295MulByConstants(t *testing.T) {
...
func TestE_nocarry_0295Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0295) bool {
...
func TestE_nocarry_0295LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0295Halve(t *testing.T) {
...
func TestE_nocarry_0295FromMont(t *testing.T) {
...
type testPaire_nocarry_0295 struct {
	element e_nocarry_0295
	bigint  big.Int
}

func (z *e_nocarry_0295) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0295[4] {
		return true
	}
	if z[4] < qe_nocarry_0295[4] {
		return false
	...
	return z[0] >= qe_nocarry_0295[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0295

		g.element = e_nocarry_0295{
		...
		if qe_nocarry_0295[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0295[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0295 {
			var g e_nocarry_0295
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0295[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0295[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0295[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0295[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0295[4], carry)
...
func Benchmarke_nocarry_0295InverseNew(b *testing.B) {
	var x e_nocarry_0295
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0295
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0295
		var xInv e_nocarry_0295
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0295
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0295
...
func testLinearComb(t *testing.T, x *e_nocarry_0295, xC int64, y *e_nocarry_0295, yC int64) {
	...
	var z e_nocarry_0295
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0295, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0295
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0295, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0295
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0295, xHi uint64) {
	var res e_nocarry_0295
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0295) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0295) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0295, c int64, result *e_nocarry_0295, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0295) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0295) uint64 {
