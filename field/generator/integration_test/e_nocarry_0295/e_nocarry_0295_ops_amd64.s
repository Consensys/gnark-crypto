...
// modulus q
DATA q<>+0(SB)/8, $0x1958477b4e255295
DATA q<>+8(SB)/8, $0x88dd8007e0e1ac80
DATA q<>+16(SB)/8, $0xaeba3bdfe63d02f0
DATA q<>+24(SB)/8, $0xc91d6d6ed7f93525
DATA q<>+32(SB)/8, $0x0000006a1598ad8e
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xeeb1821a46901743
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x1958477b4e255295, R9
	MOVQ    $0x88dd8007e0e1ac80, R10
	MOVQ    $0xaeba3bdfe63d02f0, R11
	MOVQ    $0xc91d6d6ed7f93525, R12
	MOVQ    $0x0000006a1598ad8e, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x88dd8007e0e1ac80, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xaeba3bdfe63d02f0, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xc91d6d6ed7f93525, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000006a1598ad8e, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x1958477b4e255295, CX
	MOVQ    $0x88dd8007e0e1ac80, BX
	MOVQ    $0xaeba3bdfe63d02f0, SI
	MOVQ    $0xc91d6d6ed7f93525, DI
	MOVQ    $0x0000006a1598ad8e, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
