...
var benchRese_nocarry_0199 e_nocarry_0199

func BenchmarkE_nocarry_0199SetBytes(b *testing.B) {
	var x e_nocarry_0199
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0199MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0199.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0199)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0199)
		}
	})
}

func BenchmarkE_nocarry_0199Inverse(b *testing.B) {
	var x e_nocarry_0199
	x.SetRandom()
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0199Butterfly(b *testing.B) {
	var x e_nocarry_0199
	x.SetRandom()
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0199)
	}
}

func BenchmarkE_nocarry_0199Exp(b *testing.B) {
	var x e_nocarry_0199
	x.SetRandom()
	benchRese_nocarry_0199.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0199Double(b *testing.B) {
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Double(&benchRese_nocarry_0199)
	}
}

func BenchmarkE_nocarry_0199Add(b *testing.B) {
	var x e_nocarry_0199
	x.SetRandom()
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Add(&x, &benchRese_nocarry_0199)
	}
}

func BenchmarkE_nocarry_0199Sub(b *testing.B) {
	var x e_nocarry_0199
	x.SetRandom()
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Sub(&x, &benchRese_nocarry_0199)
	}
}

func BenchmarkE_nocarry_0199Neg(b *testing.B) {
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Neg(&benchRese_nocarry_0199)
	}
}

func BenchmarkE_nocarry_0199Div(b *testing.B) {
	var x e_nocarry_0199
	x.SetRandom()
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Div(&x, &benchRese_nocarry_0199)
	}
}

func BenchmarkE_nocarry_0199FromMont(b *testing.B) {
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.FromMont()
	}
}

func BenchmarkE_nocarry_0199ToMont(b *testing.B) {
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.ToMont()
	}
}
func BenchmarkE_nocarry_0199Square(b *testing.B) {
	benchRese_nocarry_0199.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Square(&benchRese_nocarry_0199)
	}
}

func BenchmarkE_nocarry_0199Sqrt(b *testing.B) {
	var a e_nocarry_0199
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0199Mul(b *testing.B) {
	x := e_nocarry_0199{
		3073249264096646533,
		511007801063769638,
	...
	benchRese_nocarry_0199.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Mul(&benchRese_nocarry_0199, &x)
	}
}

func BenchmarkE_nocarry_0199Cmp(b *testing.B) {
	x := e_nocarry_0199{
		3073249264096646533,
		511007801063769638,
		14513616979320897353,
	...
	benchRese_nocarry_0199 = x
	benchRese_nocarry_0199[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0199.Cmp(&x)
	}
}

func TestE_nocarry_0199Cmp(t *testing.T) {
	var x, y e_nocarry_0199
...
func TestE_nocarry_0199IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0199
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0199

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0199{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0199
	one.SetOne()
	e.Sub(&qe_nocarry_0199, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0199{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0199{0, uint64(i)})
	}
...
func TestE_nocarry_0199NegZero(t *testing.T) {
	var a, b e_nocarry_0199
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0199Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0199, len(staticTestValues))
...
func TestE_nocarry_0199Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0199) bool {
			var b e_nocarry_0199
...
func TestE_nocarry_0199InverseExp(t *testing.T) {
...
func TestE_nocarry_0199MulByConstants(t *testing.T) {
...
func TestE_nocarry_0199Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0199) bool {
...
func TestE_nocarry_0199LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0199Halve(t *testing.T) {
...
func TestE_nocarry_0199FromMont(t *testing.T) {
...
type testPaire_nocarry_0199 struct {
	element e_nocarry_0199
	bigint  big.Int
}

func (z *e_nocarry_0199) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0199[3] {
		return true
	}
	if z[3] < qe_nocarry_0199[3] {
		return false
	...
	return z[0] >= qe_nocarry_0199[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0199

		g.element = e_nocarry_0199{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0199[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0199[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0199 {
			var g e_nocarry_0199
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0199[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0199[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0199[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0199[3], carry)
...
func Benchmarke_nocarry_0199InverseNew(b *testing.B) {
	var x e_nocarry_0199
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0199
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0199
		var xInv e_nocarry_0199
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0199
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0199
...
func testLinearComb(t *testing.T, x *e_nocarry_0199, xC int64, y *e_nocarry_0199, yC int64) {
	...
	var z e_nocarry_0199
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0199, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0199
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0199, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0199
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0199, xHi uint64) {
	var res e_nocarry_0199
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0199) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0199) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0199, c int64, result *e_nocarry_0199, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0199) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0199) uint64 {
