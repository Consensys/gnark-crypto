...
var benchRese_cios_0576 e_cios_0576

func BenchmarkE_cios_0576SetBytes(b *testing.B) {
	var x e_cios_0576
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.SetBytes(bb[:])
	}

}

func BenchmarkE_cios_0576MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_cios_0576.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_cios_0576)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_cios_0576)
		}
	})
}

func BenchmarkE_cios_0576Inverse(b *testing.B) {
	var x e_cios_0576
	x.SetRandom()
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Inverse(&x)
	}

}

func BenchmarkE_cios_0576Butterfly(b *testing.B) {
	var x e_cios_0576
	x.SetRandom()
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_cios_0576)
	}
}

func BenchmarkE_cios_0576Exp(b *testing.B) {
	var x e_cios_0576
	x.SetRandom()
	benchRese_cios_0576.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Exp(x, b1)
	}
}

func BenchmarkE_cios_0576Double(b *testing.B) {
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Double(&benchRese_cios_0576)
	}
}

func BenchmarkE_cios_0576Add(b *testing.B) {
	var x e_cios_0576
	x.SetRandom()
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Add(&x, &benchRese_cios_0576)
	}
}

func BenchmarkE_cios_0576Sub(b *testing.B) {
	var x e_cios_0576
	x.SetRandom()
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Sub(&x, &benchRese_cios_0576)
	}
}

func BenchmarkE_cios_0576Neg(b *testing.B) {
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Neg(&benchRese_cios_0576)
	}
}

func BenchmarkE_cios_0576Div(b *testing.B) {
	var x e_cios_0576
	x.SetRandom()
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Div(&x, &benchRese_cios_0576)
	}
}

func BenchmarkE_cios_0576FromMont(b *testing.B) {
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.FromMont()
	}
}

func BenchmarkE_cios_0576ToMont(b *testing.B) {
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.ToMont()
	}
}
func BenchmarkE_cios_0576Square(b *testing.B) {
	benchRese_cios_0576.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Square(&benchRese_cios_0576)
	}
}

func BenchmarkE_cios_0576Sqrt(b *testing.B) {
	var a e_cios_0576
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Sqrt(&a)
	}
}

func BenchmarkE_cios_0576Mul(b *testing.B) {
	x := e_cios_0576{
		8562925767185433300,
	...
	benchRese_cios_0576.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Mul(&benchRese_cios_0576, &x)
	}
}

func BenchmarkE_cios_0576Cmp(b *testing.B) {
	x := e_cios_0576{
		8562925767185433300,
		15931029948920738227,
		5146083154620528089,
	...
	benchRese_cios_0576 = x
	benchRese_cios_0576[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0576.Cmp(&x)
	}
}

func TestE_cios_0576Cmp(t *testing.T) {
	var x, y e_cios_0576
...
func TestE_cios_0576IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_cios_0576
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_cios_0576

func init() {
	staticTestValues = append(staticTestValues, e_cios_0576{}) // zero
	staticTestValues = append(staticTestValues, One())         // one
	staticTestValues = append(staticTestValues, rSquare)       // r^2
	var e, one e_cios_0576
	one.SetOne()
	e.Sub(&qe_cios_0576, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_cios_0576{uint64(i)})
		staticTestValues = append(staticTestValues, e_cios_0576{0, uint64(i)})
	}
...
func TestE_cios_0576NegZero(t *testing.T) {
	var a, b e_cios_0576
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
...
func TestE_cios_0576Reduce(t *testing.T) {
	testValues := make([]e_cios_0576, len(staticTestValues))
...
func TestE_cios_0576Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_cios_0576) bool {
			var b e_cios_0576
...
func TestE_cios_0576InverseExp(t *testing.T) {
...
func TestE_cios_0576MulByConstants(t *testing.T) {
...
func TestE_cios_0576Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_cios_0576) bool {
...
func TestE_cios_0576LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0576Halve(t *testing.T) {
...
func TestE_cios_0576FromMont(t *testing.T) {
...
type testPaire_cios_0576 struct {
	element e_cios_0576
	bigint  big.Int
}

func (z *e_cios_0576) biggerOrEqualModulus() bool {
	if z[8] > qe_cios_0576[8] {
		return true
	}
	if z[8] < qe_cios_0576[8] {
		return false
	...
	return z[0] >= qe_cios_0576[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_cios_0576

		g.element = e_cios_0576{
		...
		if qe_cios_0576[8] != ^uint64(0) {
			g.element[8] %= (qe_cios_0576[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_cios_0576[0], carry)
		a[1], carry = bits.Add64(a[1], qe_cios_0576[1], carry)
		a[2], carry = bits.Add64(a[2], qe_cios_0576[2], carry)
		a[3], carry = bits.Add64(a[3], qe_cios_0576[3], carry)
		a[4], carry = bits.Add64(a[4], qe_cios_0576[4], carry)
		a[5], carry = bits.Add64(a[5], qe_cios_0576[5], carry)
		a[6], carry = bits.Add64(a[6], qe_cios_0576[6], carry)
		a[7], carry = bits.Add64(a[7], qe_cios_0576[7], carry)
		a[8], _ = bits.Add64(a[8], qe_cios_0576[8], carry)
