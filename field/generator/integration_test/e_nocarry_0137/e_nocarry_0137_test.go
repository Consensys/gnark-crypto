...
var benchRese_nocarry_0137 e_nocarry_0137

func BenchmarkE_nocarry_0137SetBytes(b *testing.B) {
	var x e_nocarry_0137
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0137MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0137.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0137)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0137)
		}
	})
}

func BenchmarkE_nocarry_0137Inverse(b *testing.B) {
	var x e_nocarry_0137
	x.SetRandom()
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0137Butterfly(b *testing.B) {
	var x e_nocarry_0137
	x.SetRandom()
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0137)
	}
}

func BenchmarkE_nocarry_0137Exp(b *testing.B) {
	var x e_nocarry_0137
	x.SetRandom()
	benchRese_nocarry_0137.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0137Double(b *testing.B) {
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Double(&benchRese_nocarry_0137)
	}
}

func BenchmarkE_nocarry_0137Add(b *testing.B) {
	var x e_nocarry_0137
	x.SetRandom()
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Add(&x, &benchRese_nocarry_0137)
	}
}

func BenchmarkE_nocarry_0137Sub(b *testing.B) {
	var x e_nocarry_0137
	x.SetRandom()
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Sub(&x, &benchRese_nocarry_0137)
	}
}

func BenchmarkE_nocarry_0137Neg(b *testing.B) {
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Neg(&benchRese_nocarry_0137)
	}
}

func BenchmarkE_nocarry_0137Div(b *testing.B) {
	var x e_nocarry_0137
	x.SetRandom()
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Div(&x, &benchRese_nocarry_0137)
	}
}

func BenchmarkE_nocarry_0137FromMont(b *testing.B) {
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.FromMont()
	}
}

func BenchmarkE_nocarry_0137ToMont(b *testing.B) {
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.ToMont()
	}
}
func BenchmarkE_nocarry_0137Square(b *testing.B) {
	benchRese_nocarry_0137.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Square(&benchRese_nocarry_0137)
	}
}

func BenchmarkE_nocarry_0137Sqrt(b *testing.B) {
	var a e_nocarry_0137
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0137Mul(b *testing.B) {
	x := e_nocarry_0137{
		6302834832546500579,
		13037710061780110463,
		342,
	}
	benchRese_nocarry_0137.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Mul(&benchRese_nocarry_0137, &x)
	}
}

func BenchmarkE_nocarry_0137Cmp(b *testing.B) {
	x := e_nocarry_0137{
		6302834832546500579,
		13037710061780110463,
		342,
	}
	benchRese_nocarry_0137 = x
	benchRese_nocarry_0137[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0137.Cmp(&x)
	}
}

func TestE_nocarry_0137Cmp(t *testing.T) {
	var x, y e_nocarry_0137
...
func TestE_nocarry_0137IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0137
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0137

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0137{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0137
	one.SetOne()
	e.Sub(&qe_nocarry_0137, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0137{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0137{0, uint64(i)})
	}
...
func TestE_nocarry_0137NegZero(t *testing.T) {
	var a, b e_nocarry_0137
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0137Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0137, len(staticTestValues))
...
func TestE_nocarry_0137Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0137) bool {
			var b e_nocarry_0137
...
func TestE_nocarry_0137InverseExp(t *testing.T) {
...
func TestE_nocarry_0137MulByConstants(t *testing.T) {
...
func TestE_nocarry_0137Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0137) bool {
...
func TestE_nocarry_0137LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0137Halve(t *testing.T) {
...
func TestE_nocarry_0137FromMont(t *testing.T) {
...
type testPaire_nocarry_0137 struct {
	element e_nocarry_0137
	bigint  big.Int
}

func (z *e_nocarry_0137) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0137[2] {
		return true
	}
	if z[2] < qe_nocarry_0137[2] {
		return false
	...
	return z[0] >= qe_nocarry_0137[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0137

		g.element = e_nocarry_0137{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0137[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0137[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0137 {
			var g e_nocarry_0137
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0137[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0137[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0137[2], carry)
...
func Benchmarke_nocarry_0137InverseNew(b *testing.B) {
	var x e_nocarry_0137
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0137
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0137
		var xInv e_nocarry_0137
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0137
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0137
...
func testLinearComb(t *testing.T, x *e_nocarry_0137, xC int64, y *e_nocarry_0137, yC int64) {
	...
	var z e_nocarry_0137
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0137, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0137
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0137, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0137
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0137, xHi uint64) {
	var res e_nocarry_0137
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0137) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0137) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0137, c int64, result *e_nocarry_0137, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0137) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0137) uint64 {
