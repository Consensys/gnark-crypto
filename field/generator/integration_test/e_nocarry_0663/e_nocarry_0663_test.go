...
var benchRese_nocarry_0663 e_nocarry_0663

func BenchmarkE_nocarry_0663SetBytes(b *testing.B) {
	var x e_nocarry_0663
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0663MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0663.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0663)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0663)
		}
	})
}

func BenchmarkE_nocarry_0663Inverse(b *testing.B) {
	var x e_nocarry_0663
	x.SetRandom()
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0663Butterfly(b *testing.B) {
	var x e_nocarry_0663
	x.SetRandom()
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0663)
	}
}

func BenchmarkE_nocarry_0663Exp(b *testing.B) {
	var x e_nocarry_0663
	x.SetRandom()
	benchRese_nocarry_0663.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0663Double(b *testing.B) {
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Double(&benchRese_nocarry_0663)
	}
}

func BenchmarkE_nocarry_0663Add(b *testing.B) {
	var x e_nocarry_0663
	x.SetRandom()
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Add(&x, &benchRese_nocarry_0663)
	}
}

func BenchmarkE_nocarry_0663Sub(b *testing.B) {
	var x e_nocarry_0663
	x.SetRandom()
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Sub(&x, &benchRese_nocarry_0663)
	}
}

func BenchmarkE_nocarry_0663Neg(b *testing.B) {
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Neg(&benchRese_nocarry_0663)
	}
}

func BenchmarkE_nocarry_0663Div(b *testing.B) {
	var x e_nocarry_0663
	x.SetRandom()
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Div(&x, &benchRese_nocarry_0663)
	}
}

func BenchmarkE_nocarry_0663FromMont(b *testing.B) {
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.FromMont()
	}
}

func BenchmarkE_nocarry_0663ToMont(b *testing.B) {
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.ToMont()
	}
}
func BenchmarkE_nocarry_0663Square(b *testing.B) {
	benchRese_nocarry_0663.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Square(&benchRese_nocarry_0663)
	}
}

func BenchmarkE_nocarry_0663Sqrt(b *testing.B) {
	var a e_nocarry_0663
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0663Mul(b *testing.B) {
	x := e_nocarry_0663{
	...
	benchRese_nocarry_0663.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Mul(&benchRese_nocarry_0663, &x)
	}
}

func BenchmarkE_nocarry_0663Cmp(b *testing.B) {
	x := e_nocarry_0663{
		13934015861468418092,
		11598413584310262741,
		186982924478985608,
	...
	benchRese_nocarry_0663 = x
	benchRese_nocarry_0663[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0663.Cmp(&x)
	}
}

func TestE_nocarry_0663Cmp(t *testing.T) {
	var x, y e_nocarry_0663
...
func TestE_nocarry_0663IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0663
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0663

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0663{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0663
	one.SetOne()
	e.Sub(&qe_nocarry_0663, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0663{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0663{0, uint64(i)})
	}
...
func TestE_nocarry_0663NegZero(t *testing.T) {
	var a, b e_nocarry_0663
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0663Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0663, len(staticTestValues))
...
func TestE_nocarry_0663Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0663) bool {
			var b e_nocarry_0663
...
func TestE_nocarry_0663InverseExp(t *testing.T) {
...
func TestE_nocarry_0663MulByConstants(t *testing.T) {
...
func TestE_nocarry_0663Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0663) bool {
...
func TestE_nocarry_0663LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0663Halve(t *testing.T) {
...
func TestE_nocarry_0663FromMont(t *testing.T) {
...
type testPaire_nocarry_0663 struct {
	element e_nocarry_0663
	bigint  big.Int
}

func (z *e_nocarry_0663) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0663[10] {
		return true
	}
	if z[10] < qe_nocarry_0663[10] {
		return false
	...
	return z[0] >= qe_nocarry_0663[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0663

		g.element = e_nocarry_0663{
		...
		if qe_nocarry_0663[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0663[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0663 {
			var g e_nocarry_0663
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0663[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0663[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0663[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0663[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0663[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0663[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0663[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0663[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0663[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0663[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0663[10], carry)
...
func Benchmarke_nocarry_0663InverseNew(b *testing.B) {
	var x e_nocarry_0663
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0663
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0663
		var xInv e_nocarry_0663
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0663
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0663
...
func testLinearComb(t *testing.T, x *e_nocarry_0663, xC int64, y *e_nocarry_0663, yC int64) {
	...
	var z e_nocarry_0663
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0663, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0663
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0663, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0663
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0663, xHi uint64) {
	var res e_nocarry_0663
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0663) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0663) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0663, c int64, result *e_nocarry_0663, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0663) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0663) uint64 {
