...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xadef31169cfd518b, R14
	ADDQ R14, AX
	MOVQ $0x29282223dcc3c571, R14
	ADCQ R14, DX
	MOVQ $0x1eb1cd8e058f685a, R14
	ADCQ R14, CX
	MOVQ $0xff472bdb4dcd8f14, R14
	ADCQ R14, BX
	MOVQ $0x6800f9c9132cd13b, R14
	ADCQ R14, SI
	MOVQ $0x0fc71a14a9db70e2, R14
	ADCQ R14, DI
	MOVQ $0x95a083074a9cf4d3, R14
	ADCQ R14, R8
	MOVQ $0x9c7f6d40afa9e860, R14
	ADCQ R14, R9
	MOVQ $0x082bab2e14f5e688, R14
	ADCQ R14, R10
	MOVQ $0x32f66e5ee8460829, R14
	ADCQ R14, R11
	MOVQ $0x0000000000656d9c, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xadef31169cfd518b, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x29282223dcc3c571, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x1eb1cd8e058f685a, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xff472bdb4dcd8f14, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x6800f9c9132cd13b, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x0fc71a14a9db70e2, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x95a083074a9cf4d3, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x9c7f6d40afa9e860, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x082bab2e14f5e688, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x32f66e5ee8460829, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000000656d9c, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xadef31169cfd518b, AX
	ADDQ AX, DX
	MOVQ $0x29282223dcc3c571, AX
	ADCQ AX, CX
	MOVQ $0x1eb1cd8e058f685a, AX
	ADCQ AX, BX
	MOVQ $0xff472bdb4dcd8f14, AX
	ADCQ AX, SI
	MOVQ $0x6800f9c9132cd13b, AX
	ADCQ AX, DI
	MOVQ $0x0fc71a14a9db70e2, AX
	ADCQ AX, R8
	MOVQ $0x95a083074a9cf4d3, AX
	ADCQ AX, R9
	MOVQ $0x9c7f6d40afa9e860, AX
	ADCQ AX, R10
	MOVQ $0x082bab2e14f5e688, AX
	ADCQ AX, R11
	MOVQ $0x32f66e5ee8460829, AX
	ADCQ AX, R12
	MOVQ $0x0000000000656d9c, AX
	ADCQ AX, R13
