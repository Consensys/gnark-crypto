...
// modulus q
DATA q<>+0(SB)/8, $0xadef31169cfd518b
DATA q<>+8(SB)/8, $0x29282223dcc3c571
DATA q<>+16(SB)/8, $0x1eb1cd8e058f685a
DATA q<>+24(SB)/8, $0xff472bdb4dcd8f14
DATA q<>+32(SB)/8, $0x6800f9c9132cd13b
DATA q<>+40(SB)/8, $0x0fc71a14a9db70e2
DATA q<>+48(SB)/8, $0x95a083074a9cf4d3
DATA q<>+56(SB)/8, $0x9c7f6d40afa9e860
DATA q<>+64(SB)/8, $0x082bab2e14f5e688
DATA q<>+72(SB)/8, $0x32f66e5ee8460829
DATA q<>+80(SB)/8, $0x0000000000656d9c
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xd69befa332bf31dd
