...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x2ab51ffc76c5a5e5, R14
	ADDQ R14, AX
	MOVQ $0x2e64616f1556267b, R14
	ADCQ R14, DX
	MOVQ $0x02638e51293753d8, R14
	ADCQ R14, CX
	MOVQ $0x5ef1772021af8f22, R14
	ADCQ R14, BX
	MOVQ $0x5e3d572ac6a80946, R14
	ADCQ R14, SI
	MOVQ $0x4bbbd32406adda17, R14
	ADCQ R14, DI
	MOVQ $0x56437aa22eb6911d, R14
	ADCQ R14, R8
	MOVQ $0x6bda49ac98a9a13a, R14
	ADCQ R14, R9
	MOVQ $0x0ac679b403530331, R14
	ADCQ R14, R10
	MOVQ $0xa7d28e9d9f3fce2c, R14
	ADCQ R14, R11
	MOVQ $0x00001af03ac9fae4, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x2ab51ffc76c5a5e5, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x2e64616f1556267b, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x02638e51293753d8, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x5ef1772021af8f22, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x5e3d572ac6a80946, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x4bbbd32406adda17, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x56437aa22eb6911d, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x6bda49ac98a9a13a, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x0ac679b403530331, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xa7d28e9d9f3fce2c, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00001af03ac9fae4, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x2ab51ffc76c5a5e5, AX
	ADDQ AX, DX
	MOVQ $0x2e64616f1556267b, AX
	ADCQ AX, CX
	MOVQ $0x02638e51293753d8, AX
	ADCQ AX, BX
	MOVQ $0x5ef1772021af8f22, AX
	ADCQ AX, SI
	MOVQ $0x5e3d572ac6a80946, AX
	ADCQ AX, DI
	MOVQ $0x4bbbd32406adda17, AX
	ADCQ AX, R8
	MOVQ $0x56437aa22eb6911d, AX
	ADCQ AX, R9
	MOVQ $0x6bda49ac98a9a13a, AX
	ADCQ AX, R10
	MOVQ $0x0ac679b403530331, AX
	ADCQ AX, R11
	MOVQ $0xa7d28e9d9f3fce2c, AX
	ADCQ AX, R12
	MOVQ $0x00001af03ac9fae4, AX
	ADCQ AX, R13
