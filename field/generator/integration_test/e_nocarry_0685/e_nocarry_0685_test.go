...
var benchRese_nocarry_0685 e_nocarry_0685

func BenchmarkE_nocarry_0685SetBytes(b *testing.B) {
	var x e_nocarry_0685
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0685MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0685.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0685)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0685)
		}
	})
}

func BenchmarkE_nocarry_0685Inverse(b *testing.B) {
	var x e_nocarry_0685
	x.SetRandom()
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0685Butterfly(b *testing.B) {
	var x e_nocarry_0685
	x.SetRandom()
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0685)
	}
}

func BenchmarkE_nocarry_0685Exp(b *testing.B) {
	var x e_nocarry_0685
	x.SetRandom()
	benchRese_nocarry_0685.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0685Double(b *testing.B) {
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Double(&benchRese_nocarry_0685)
	}
}

func BenchmarkE_nocarry_0685Add(b *testing.B) {
	var x e_nocarry_0685
	x.SetRandom()
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Add(&x, &benchRese_nocarry_0685)
	}
}

func BenchmarkE_nocarry_0685Sub(b *testing.B) {
	var x e_nocarry_0685
	x.SetRandom()
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Sub(&x, &benchRese_nocarry_0685)
	}
}

func BenchmarkE_nocarry_0685Neg(b *testing.B) {
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Neg(&benchRese_nocarry_0685)
	}
}

func BenchmarkE_nocarry_0685Div(b *testing.B) {
	var x e_nocarry_0685
	x.SetRandom()
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Div(&x, &benchRese_nocarry_0685)
	}
}

func BenchmarkE_nocarry_0685FromMont(b *testing.B) {
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.FromMont()
	}
}

func BenchmarkE_nocarry_0685ToMont(b *testing.B) {
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.ToMont()
	}
}
func BenchmarkE_nocarry_0685Square(b *testing.B) {
	benchRese_nocarry_0685.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Square(&benchRese_nocarry_0685)
	}
}

func BenchmarkE_nocarry_0685Sqrt(b *testing.B) {
	var a e_nocarry_0685
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0685Mul(b *testing.B) {
	x := e_nocarry_0685{
		3112167251923030274,
		1567809059886027752,
	...
	benchRese_nocarry_0685.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Mul(&benchRese_nocarry_0685, &x)
	}
}

func BenchmarkE_nocarry_0685Cmp(b *testing.B) {
	x := e_nocarry_0685{
		3112167251923030274,
		1567809059886027752,
		10102027857853606876,
	...
	benchRese_nocarry_0685 = x
	benchRese_nocarry_0685[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0685.Cmp(&x)
	}
}

func TestE_nocarry_0685Cmp(t *testing.T) {
	var x, y e_nocarry_0685
...
func TestE_nocarry_0685IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0685
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0685

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0685{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0685
	one.SetOne()
	e.Sub(&qe_nocarry_0685, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0685{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0685{0, uint64(i)})
	}
...
func TestE_nocarry_0685NegZero(t *testing.T) {
	var a, b e_nocarry_0685
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0685Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0685, len(staticTestValues))
...
func TestE_nocarry_0685Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0685) bool {
			var b e_nocarry_0685
...
func TestE_nocarry_0685InverseExp(t *testing.T) {
...
func TestE_nocarry_0685MulByConstants(t *testing.T) {
...
func TestE_nocarry_0685Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0685) bool {
...
func TestE_nocarry_0685LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0685Halve(t *testing.T) {
...
func TestE_nocarry_0685FromMont(t *testing.T) {
...
type testPaire_nocarry_0685 struct {
	element e_nocarry_0685
	bigint  big.Int
}

func (z *e_nocarry_0685) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0685[10] {
		return true
	}
	if z[10] < qe_nocarry_0685[10] {
		return false
	...
	return z[0] >= qe_nocarry_0685[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0685

		g.element = e_nocarry_0685{
		...
		if qe_nocarry_0685[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0685[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0685 {
			var g e_nocarry_0685
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0685[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0685[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0685[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0685[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0685[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0685[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0685[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0685[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0685[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0685[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0685[10], carry)
...
func Benchmarke_nocarry_0685InverseNew(b *testing.B) {
	var x e_nocarry_0685
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0685
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0685
		var xInv e_nocarry_0685
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0685
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0685
...
func testLinearComb(t *testing.T, x *e_nocarry_0685, xC int64, y *e_nocarry_0685, yC int64) {
	...
	var z e_nocarry_0685
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0685, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0685
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0685, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0685
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0685, xHi uint64) {
	var res e_nocarry_0685
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0685) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0685) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0685, c int64, result *e_nocarry_0685, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0685) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0685) uint64 {
