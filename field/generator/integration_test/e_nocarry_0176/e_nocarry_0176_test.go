...
var benchRese_nocarry_0176 e_nocarry_0176

func BenchmarkE_nocarry_0176SetBytes(b *testing.B) {
	var x e_nocarry_0176
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0176MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0176.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0176)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0176)
		}
	})
}

func BenchmarkE_nocarry_0176Inverse(b *testing.B) {
	var x e_nocarry_0176
	x.SetRandom()
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0176Butterfly(b *testing.B) {
	var x e_nocarry_0176
	x.SetRandom()
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0176)
	}
}

func BenchmarkE_nocarry_0176Exp(b *testing.B) {
	var x e_nocarry_0176
	x.SetRandom()
	benchRese_nocarry_0176.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0176Double(b *testing.B) {
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Double(&benchRese_nocarry_0176)
	}
}

func BenchmarkE_nocarry_0176Add(b *testing.B) {
	var x e_nocarry_0176
	x.SetRandom()
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Add(&x, &benchRese_nocarry_0176)
	}
}

func BenchmarkE_nocarry_0176Sub(b *testing.B) {
	var x e_nocarry_0176
	x.SetRandom()
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Sub(&x, &benchRese_nocarry_0176)
	}
}

func BenchmarkE_nocarry_0176Neg(b *testing.B) {
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Neg(&benchRese_nocarry_0176)
	}
}

func BenchmarkE_nocarry_0176Div(b *testing.B) {
	var x e_nocarry_0176
	x.SetRandom()
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Div(&x, &benchRese_nocarry_0176)
	}
}

func BenchmarkE_nocarry_0176FromMont(b *testing.B) {
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.FromMont()
	}
}

func BenchmarkE_nocarry_0176ToMont(b *testing.B) {
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.ToMont()
	}
}
func BenchmarkE_nocarry_0176Square(b *testing.B) {
	benchRese_nocarry_0176.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Square(&benchRese_nocarry_0176)
	}
}

func BenchmarkE_nocarry_0176Sqrt(b *testing.B) {
	var a e_nocarry_0176
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0176Mul(b *testing.B) {
	x := e_nocarry_0176{
		6530549755056796325,
		3438153637325008893,
		136226311171962,
	}
	benchRese_nocarry_0176.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Mul(&benchRese_nocarry_0176, &x)
	}
}

func BenchmarkE_nocarry_0176Cmp(b *testing.B) {
	x := e_nocarry_0176{
		6530549755056796325,
		3438153637325008893,
		136226311171962,
	}
	benchRese_nocarry_0176 = x
	benchRese_nocarry_0176[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0176.Cmp(&x)
	}
}

func TestE_nocarry_0176Cmp(t *testing.T) {
	var x, y e_nocarry_0176
...
func TestE_nocarry_0176IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0176
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0176

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0176{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0176
	one.SetOne()
	e.Sub(&qe_nocarry_0176, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0176{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0176{0, uint64(i)})
	}
...
func TestE_nocarry_0176NegZero(t *testing.T) {
	var a, b e_nocarry_0176
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0176Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0176, len(staticTestValues))
...
func TestE_nocarry_0176Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0176) bool {
			var b e_nocarry_0176
...
func TestE_nocarry_0176InverseExp(t *testing.T) {
...
func TestE_nocarry_0176MulByConstants(t *testing.T) {
...
func TestE_nocarry_0176Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0176) bool {
...
func TestE_nocarry_0176LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0176Halve(t *testing.T) {
...
func TestE_nocarry_0176FromMont(t *testing.T) {
...
type testPaire_nocarry_0176 struct {
	element e_nocarry_0176
	bigint  big.Int
}

func (z *e_nocarry_0176) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0176[2] {
		return true
	}
	if z[2] < qe_nocarry_0176[2] {
		return false
	...
	return z[0] >= qe_nocarry_0176[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0176

		g.element = e_nocarry_0176{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0176[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0176[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0176 {
			var g e_nocarry_0176
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0176[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0176[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0176[2], carry)
...
func Benchmarke_nocarry_0176InverseNew(b *testing.B) {
	var x e_nocarry_0176
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0176
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0176
		var xInv e_nocarry_0176
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0176
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0176
...
func testLinearComb(t *testing.T, x *e_nocarry_0176, xC int64, y *e_nocarry_0176, yC int64) {
	...
	var z e_nocarry_0176
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0176, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0176
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0176, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0176
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0176, xHi uint64) {
	var res e_nocarry_0176
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0176) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0176) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0176, c int64, result *e_nocarry_0176, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0176) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0176) uint64 {
