...
var benchRese_nocarry_0510 e_nocarry_0510

func BenchmarkE_nocarry_0510SetBytes(b *testing.B) {
	var x e_nocarry_0510
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0510MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0510.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0510)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0510)
		}
	})
}

func BenchmarkE_nocarry_0510Inverse(b *testing.B) {
	var x e_nocarry_0510
	x.SetRandom()
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0510Butterfly(b *testing.B) {
	var x e_nocarry_0510
	x.SetRandom()
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0510)
	}
}

func BenchmarkE_nocarry_0510Exp(b *testing.B) {
	var x e_nocarry_0510
	x.SetRandom()
	benchRese_nocarry_0510.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0510Double(b *testing.B) {
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Double(&benchRese_nocarry_0510)
	}
}

func BenchmarkE_nocarry_0510Add(b *testing.B) {
	var x e_nocarry_0510
	x.SetRandom()
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Add(&x, &benchRese_nocarry_0510)
	}
}

func BenchmarkE_nocarry_0510Sub(b *testing.B) {
	var x e_nocarry_0510
	x.SetRandom()
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Sub(&x, &benchRese_nocarry_0510)
	}
}

func BenchmarkE_nocarry_0510Neg(b *testing.B) {
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Neg(&benchRese_nocarry_0510)
	}
}

func BenchmarkE_nocarry_0510Div(b *testing.B) {
	var x e_nocarry_0510
	x.SetRandom()
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Div(&x, &benchRese_nocarry_0510)
	}
}

func BenchmarkE_nocarry_0510FromMont(b *testing.B) {
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.FromMont()
	}
}

func BenchmarkE_nocarry_0510ToMont(b *testing.B) {
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.ToMont()
	}
}
func BenchmarkE_nocarry_0510Square(b *testing.B) {
	benchRese_nocarry_0510.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Square(&benchRese_nocarry_0510)
	}
}

func BenchmarkE_nocarry_0510Sqrt(b *testing.B) {
	var a e_nocarry_0510
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0510Mul(b *testing.B) {
	x := e_nocarry_0510{
	...
	benchRese_nocarry_0510.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Mul(&benchRese_nocarry_0510, &x)
	}
}

func BenchmarkE_nocarry_0510Cmp(b *testing.B) {
	x := e_nocarry_0510{
		13456460999438502135,
		15297777550426590514,
		11507022963792800711,
	...
	benchRese_nocarry_0510 = x
	benchRese_nocarry_0510[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0510.Cmp(&x)
	}
}

func TestE_nocarry_0510Cmp(t *testing.T) {
	var x, y e_nocarry_0510
...
func TestE_nocarry_0510IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0510
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0510

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0510{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0510
	one.SetOne()
	e.Sub(&qe_nocarry_0510, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0510{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0510{0, uint64(i)})
	}
...
func TestE_nocarry_0510NegZero(t *testing.T) {
	var a, b e_nocarry_0510
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0510Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0510, len(staticTestValues))
...
func TestE_nocarry_0510Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0510) bool {
			var b e_nocarry_0510
...
func TestE_nocarry_0510InverseExp(t *testing.T) {
...
func TestE_nocarry_0510MulByConstants(t *testing.T) {
...
func TestE_nocarry_0510Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0510) bool {
...
func TestE_nocarry_0510LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0510Halve(t *testing.T) {
...
func TestE_nocarry_0510FromMont(t *testing.T) {
...
type testPaire_nocarry_0510 struct {
	element e_nocarry_0510
	bigint  big.Int
}

func (z *e_nocarry_0510) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0510[7] {
		return true
	}
	if z[7] < qe_nocarry_0510[7] {
		return false
	...
	return z[0] >= qe_nocarry_0510[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0510

		g.element = e_nocarry_0510{
		...
		if qe_nocarry_0510[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0510[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0510 {
			var g e_nocarry_0510
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0510[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0510[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0510[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0510[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0510[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0510[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0510[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0510[7], carry)
...
func Benchmarke_nocarry_0510InverseNew(b *testing.B) {
	var x e_nocarry_0510
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0510
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0510
		var xInv e_nocarry_0510
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0510
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0510
...
func testLinearComb(t *testing.T, x *e_nocarry_0510, xC int64, y *e_nocarry_0510, yC int64) {
	...
	var z e_nocarry_0510
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0510, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0510
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0510, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0510
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0510, xHi uint64) {
	var res e_nocarry_0510
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0510) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0510) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0510, c int64, result *e_nocarry_0510, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0510) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0510) uint64 {
