...
var benchRese_nocarry_0304 e_nocarry_0304

func BenchmarkE_nocarry_0304SetBytes(b *testing.B) {
	var x e_nocarry_0304
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0304MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0304.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0304)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0304)
		}
	})
}

func BenchmarkE_nocarry_0304Inverse(b *testing.B) {
	var x e_nocarry_0304
	x.SetRandom()
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0304Butterfly(b *testing.B) {
	var x e_nocarry_0304
	x.SetRandom()
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0304)
	}
}

func BenchmarkE_nocarry_0304Exp(b *testing.B) {
	var x e_nocarry_0304
	x.SetRandom()
	benchRese_nocarry_0304.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0304Double(b *testing.B) {
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Double(&benchRese_nocarry_0304)
	}
}

func BenchmarkE_nocarry_0304Add(b *testing.B) {
	var x e_nocarry_0304
	x.SetRandom()
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Add(&x, &benchRese_nocarry_0304)
	}
}

func BenchmarkE_nocarry_0304Sub(b *testing.B) {
	var x e_nocarry_0304
	x.SetRandom()
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Sub(&x, &benchRese_nocarry_0304)
	}
}

func BenchmarkE_nocarry_0304Neg(b *testing.B) {
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Neg(&benchRese_nocarry_0304)
	}
}

func BenchmarkE_nocarry_0304Div(b *testing.B) {
	var x e_nocarry_0304
	x.SetRandom()
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Div(&x, &benchRese_nocarry_0304)
	}
}

func BenchmarkE_nocarry_0304FromMont(b *testing.B) {
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.FromMont()
	}
}

func BenchmarkE_nocarry_0304ToMont(b *testing.B) {
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.ToMont()
	}
}
func BenchmarkE_nocarry_0304Square(b *testing.B) {
	benchRese_nocarry_0304.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Square(&benchRese_nocarry_0304)
	}
}

func BenchmarkE_nocarry_0304Sqrt(b *testing.B) {
	var a e_nocarry_0304
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0304Mul(b *testing.B) {
	x := e_nocarry_0304{
	...
	benchRese_nocarry_0304.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Mul(&benchRese_nocarry_0304, &x)
	}
}

func BenchmarkE_nocarry_0304Cmp(b *testing.B) {
	x := e_nocarry_0304{
		15395266459644483081,
		15781550812695814640,
		9030554411615638421,
	...
	benchRese_nocarry_0304 = x
	benchRese_nocarry_0304[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0304.Cmp(&x)
	}
}

func TestE_nocarry_0304Cmp(t *testing.T) {
	var x, y e_nocarry_0304
...
func TestE_nocarry_0304IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0304
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0304

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0304{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0304
	one.SetOne()
	e.Sub(&qe_nocarry_0304, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0304{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0304{0, uint64(i)})
	}
...
func TestE_nocarry_0304NegZero(t *testing.T) {
	var a, b e_nocarry_0304
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0304Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0304, len(staticTestValues))
...
func TestE_nocarry_0304Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0304) bool {
			var b e_nocarry_0304
...
func TestE_nocarry_0304InverseExp(t *testing.T) {
...
func TestE_nocarry_0304MulByConstants(t *testing.T) {
...
func TestE_nocarry_0304Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0304) bool {
...
func TestE_nocarry_0304LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0304Halve(t *testing.T) {
...
func TestE_nocarry_0304FromMont(t *testing.T) {
...
type testPaire_nocarry_0304 struct {
	element e_nocarry_0304
	bigint  big.Int
}

func (z *e_nocarry_0304) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0304[4] {
		return true
	}
	if z[4] < qe_nocarry_0304[4] {
		return false
	...
	return z[0] >= qe_nocarry_0304[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0304

		g.element = e_nocarry_0304{
		...
		if qe_nocarry_0304[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0304[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0304 {
			var g e_nocarry_0304
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0304[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0304[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0304[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0304[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0304[4], carry)
...
func Benchmarke_nocarry_0304InverseNew(b *testing.B) {
	var x e_nocarry_0304
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0304
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0304
		var xInv e_nocarry_0304
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0304
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0304
...
func testLinearComb(t *testing.T, x *e_nocarry_0304, xC int64, y *e_nocarry_0304, yC int64) {
	...
	var z e_nocarry_0304
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0304, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0304
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0304, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0304
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0304, xHi uint64) {
	var res e_nocarry_0304
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0304) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0304) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0304, c int64, result *e_nocarry_0304, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0304) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0304) uint64 {
