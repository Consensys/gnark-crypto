...
// modulus q
DATA q<>+0(SB)/8, $0xb8ec125e92f98ca5
DATA q<>+8(SB)/8, $0x165973ff6e66c3f1
DATA q<>+16(SB)/8, $0x10079b76a9c9803c
DATA q<>+24(SB)/8, $0x45be32c134285186
DATA q<>+32(SB)/8, $0x0000d3a54d19832b
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xda954bd76adc84d3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xb8ec125e92f98ca5, R9
	MOVQ    $0x165973ff6e66c3f1, R10
	MOVQ    $0x10079b76a9c9803c, R11
	MOVQ    $0x45be32c134285186, R12
	MOVQ    $0x0000d3a54d19832b, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x165973ff6e66c3f1, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x10079b76a9c9803c, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x45be32c134285186, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000d3a54d19832b, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xb8ec125e92f98ca5, CX
	MOVQ    $0x165973ff6e66c3f1, BX
	MOVQ    $0x10079b76a9c9803c, SI
	MOVQ    $0x45be32c134285186, DI
	MOVQ    $0x0000d3a54d19832b, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
