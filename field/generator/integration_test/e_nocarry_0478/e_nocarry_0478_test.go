...
var benchRese_nocarry_0478 e_nocarry_0478

func BenchmarkE_nocarry_0478SetBytes(b *testing.B) {
	var x e_nocarry_0478
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0478MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0478.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0478)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0478)
		}
	})
}

func BenchmarkE_nocarry_0478Inverse(b *testing.B) {
	var x e_nocarry_0478
	x.SetRandom()
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0478Butterfly(b *testing.B) {
	var x e_nocarry_0478
	x.SetRandom()
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0478)
	}
}

func BenchmarkE_nocarry_0478Exp(b *testing.B) {
	var x e_nocarry_0478
	x.SetRandom()
	benchRese_nocarry_0478.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0478Double(b *testing.B) {
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Double(&benchRese_nocarry_0478)
	}
}

func BenchmarkE_nocarry_0478Add(b *testing.B) {
	var x e_nocarry_0478
	x.SetRandom()
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Add(&x, &benchRese_nocarry_0478)
	}
}

func BenchmarkE_nocarry_0478Sub(b *testing.B) {
	var x e_nocarry_0478
	x.SetRandom()
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Sub(&x, &benchRese_nocarry_0478)
	}
}

func BenchmarkE_nocarry_0478Neg(b *testing.B) {
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Neg(&benchRese_nocarry_0478)
	}
}

func BenchmarkE_nocarry_0478Div(b *testing.B) {
	var x e_nocarry_0478
	x.SetRandom()
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Div(&x, &benchRese_nocarry_0478)
	}
}

func BenchmarkE_nocarry_0478FromMont(b *testing.B) {
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.FromMont()
	}
}

func BenchmarkE_nocarry_0478ToMont(b *testing.B) {
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.ToMont()
	}
}
func BenchmarkE_nocarry_0478Square(b *testing.B) {
	benchRese_nocarry_0478.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Square(&benchRese_nocarry_0478)
	}
}

func BenchmarkE_nocarry_0478Sqrt(b *testing.B) {
	var a e_nocarry_0478
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0478Mul(b *testing.B) {
	x := e_nocarry_0478{
		2949569021179554323,
	...
	benchRese_nocarry_0478.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Mul(&benchRese_nocarry_0478, &x)
	}
}

func BenchmarkE_nocarry_0478Cmp(b *testing.B) {
	x := e_nocarry_0478{
		2949569021179554323,
		10118686294681612558,
		516549273602357993,
	...
	benchRese_nocarry_0478 = x
	benchRese_nocarry_0478[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0478.Cmp(&x)
	}
}

func TestE_nocarry_0478Cmp(t *testing.T) {
	var x, y e_nocarry_0478
...
func TestE_nocarry_0478IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0478
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0478

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0478{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0478
	one.SetOne()
	e.Sub(&qe_nocarry_0478, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0478{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0478{0, uint64(i)})
	}
...
func TestE_nocarry_0478NegZero(t *testing.T) {
	var a, b e_nocarry_0478
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0478Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0478, len(staticTestValues))
...
func TestE_nocarry_0478Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0478) bool {
			var b e_nocarry_0478
...
func TestE_nocarry_0478InverseExp(t *testing.T) {
...
func TestE_nocarry_0478MulByConstants(t *testing.T) {
...
func TestE_nocarry_0478Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0478) bool {
...
func TestE_nocarry_0478LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0478Halve(t *testing.T) {
...
func TestE_nocarry_0478FromMont(t *testing.T) {
...
type testPaire_nocarry_0478 struct {
	element e_nocarry_0478
	bigint  big.Int
}

func (z *e_nocarry_0478) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0478[7] {
		return true
	}
	if z[7] < qe_nocarry_0478[7] {
		return false
	...
	return z[0] >= qe_nocarry_0478[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0478

		g.element = e_nocarry_0478{
		...
		if qe_nocarry_0478[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0478[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0478 {
			var g e_nocarry_0478
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0478[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0478[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0478[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0478[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0478[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0478[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0478[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0478[7], carry)
...
func Benchmarke_nocarry_0478InverseNew(b *testing.B) {
	var x e_nocarry_0478
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0478
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0478
		var xInv e_nocarry_0478
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0478
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0478
...
func testLinearComb(t *testing.T, x *e_nocarry_0478, xC int64, y *e_nocarry_0478, yC int64) {
	...
	var z e_nocarry_0478
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0478, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0478
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0478, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0478
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0478, xHi uint64) {
	var res e_nocarry_0478
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0478) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0478) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0478, c int64, result *e_nocarry_0478, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0478) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0478) uint64 {
