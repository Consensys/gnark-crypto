...
var benchRese_nocarry_0646 e_nocarry_0646

func BenchmarkE_nocarry_0646SetBytes(b *testing.B) {
	var x e_nocarry_0646
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0646MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0646.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0646)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0646)
		}
	})
}

func BenchmarkE_nocarry_0646Inverse(b *testing.B) {
	var x e_nocarry_0646
	x.SetRandom()
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0646Butterfly(b *testing.B) {
	var x e_nocarry_0646
	x.SetRandom()
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0646)
	}
}

func BenchmarkE_nocarry_0646Exp(b *testing.B) {
	var x e_nocarry_0646
	x.SetRandom()
	benchRese_nocarry_0646.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0646Double(b *testing.B) {
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Double(&benchRese_nocarry_0646)
	}
}

func BenchmarkE_nocarry_0646Add(b *testing.B) {
	var x e_nocarry_0646
	x.SetRandom()
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Add(&x, &benchRese_nocarry_0646)
	}
}

func BenchmarkE_nocarry_0646Sub(b *testing.B) {
	var x e_nocarry_0646
	x.SetRandom()
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Sub(&x, &benchRese_nocarry_0646)
	}
}

func BenchmarkE_nocarry_0646Neg(b *testing.B) {
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Neg(&benchRese_nocarry_0646)
	}
}

func BenchmarkE_nocarry_0646Div(b *testing.B) {
	var x e_nocarry_0646
	x.SetRandom()
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Div(&x, &benchRese_nocarry_0646)
	}
}

func BenchmarkE_nocarry_0646FromMont(b *testing.B) {
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.FromMont()
	}
}

func BenchmarkE_nocarry_0646ToMont(b *testing.B) {
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.ToMont()
	}
}
func BenchmarkE_nocarry_0646Square(b *testing.B) {
	benchRese_nocarry_0646.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Square(&benchRese_nocarry_0646)
	}
}

func BenchmarkE_nocarry_0646Sqrt(b *testing.B) {
	var a e_nocarry_0646
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0646Mul(b *testing.B) {
	x := e_nocarry_0646{
		9007371723893215629,
	...
	benchRese_nocarry_0646.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Mul(&benchRese_nocarry_0646, &x)
	}
}

func BenchmarkE_nocarry_0646Cmp(b *testing.B) {
	x := e_nocarry_0646{
		9007371723893215629,
		18111421837051280418,
		7494680609548452616,
	...
	benchRese_nocarry_0646 = x
	benchRese_nocarry_0646[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0646.Cmp(&x)
	}
}

func TestE_nocarry_0646Cmp(t *testing.T) {
	var x, y e_nocarry_0646
...
func TestE_nocarry_0646IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0646
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0646

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0646{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0646
	one.SetOne()
	e.Sub(&qe_nocarry_0646, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0646{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0646{0, uint64(i)})
	}
...
func TestE_nocarry_0646NegZero(t *testing.T) {
	var a, b e_nocarry_0646
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0646Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0646, len(staticTestValues))
...
func TestE_nocarry_0646Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0646) bool {
			var b e_nocarry_0646
...
func TestE_nocarry_0646InverseExp(t *testing.T) {
...
func TestE_nocarry_0646MulByConstants(t *testing.T) {
...
func TestE_nocarry_0646Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0646) bool {
...
func TestE_nocarry_0646LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0646Halve(t *testing.T) {
...
func TestE_nocarry_0646FromMont(t *testing.T) {
...
type testPaire_nocarry_0646 struct {
	element e_nocarry_0646
	bigint  big.Int
}

func (z *e_nocarry_0646) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0646[10] {
		return true
	}
	if z[10] < qe_nocarry_0646[10] {
		return false
	...
	return z[0] >= qe_nocarry_0646[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0646

		g.element = e_nocarry_0646{
		...
		if qe_nocarry_0646[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0646[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0646 {
			var g e_nocarry_0646
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0646[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0646[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0646[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0646[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0646[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0646[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0646[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0646[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0646[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0646[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0646[10], carry)
...
func Benchmarke_nocarry_0646InverseNew(b *testing.B) {
	var x e_nocarry_0646
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0646
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0646
		var xInv e_nocarry_0646
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0646
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0646
...
func testLinearComb(t *testing.T, x *e_nocarry_0646, xC int64, y *e_nocarry_0646, yC int64) {
	...
	var z e_nocarry_0646
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0646, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0646
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0646, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0646
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0646, xHi uint64) {
	var res e_nocarry_0646
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0646) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0646) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0646, c int64, result *e_nocarry_0646, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0646) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0646) uint64 {
