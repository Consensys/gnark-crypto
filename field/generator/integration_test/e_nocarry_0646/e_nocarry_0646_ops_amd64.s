...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x77123a89819504e7, R14
	ADDQ R14, AX
	MOVQ $0xabacfd5acacf36ec, R14
	ADCQ R14, DX
	MOVQ $0xeafa88706ec734e5, R14
	ADCQ R14, CX
	MOVQ $0xceccb100eb3016ac, R14
	ADCQ R14, BX
	MOVQ $0xec94424f069b731f, R14
	ADCQ R14, SI
	MOVQ $0x586c3516e78210ba, R14
	ADCQ R14, DI
	MOVQ $0xf8a7808228d9731c, R14
	ADCQ R14, R8
	MOVQ $0x9b7a4270a2419361, R14
	ADCQ R14, R9
	MOVQ $0x6eed086fd429aff7, R14
	ADCQ R14, R10
	MOVQ $0x191f0687c7dbf11c, R14
	ADCQ R14, R11
	MOVQ $0x0000000000000030, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x77123a89819504e7, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xabacfd5acacf36ec, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xeafa88706ec734e5, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xceccb100eb3016ac, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xec94424f069b731f, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x586c3516e78210ba, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xf8a7808228d9731c, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x9b7a4270a2419361, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x6eed086fd429aff7, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x191f0687c7dbf11c, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000000000030, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x77123a89819504e7, AX
	ADDQ AX, DX
	MOVQ $0xabacfd5acacf36ec, AX
	ADCQ AX, CX
	MOVQ $0xeafa88706ec734e5, AX
	ADCQ AX, BX
	MOVQ $0xceccb100eb3016ac, AX
	ADCQ AX, SI
	MOVQ $0xec94424f069b731f, AX
	ADCQ AX, DI
	MOVQ $0x586c3516e78210ba, AX
	ADCQ AX, R8
	MOVQ $0xf8a7808228d9731c, AX
	ADCQ AX, R9
	MOVQ $0x9b7a4270a2419361, AX
	ADCQ AX, R10
	MOVQ $0x6eed086fd429aff7, AX
	ADCQ AX, R11
	MOVQ $0x191f0687c7dbf11c, AX
	ADCQ AX, R12
	MOVQ $0x0000000000000030, AX
	ADCQ AX, R13
