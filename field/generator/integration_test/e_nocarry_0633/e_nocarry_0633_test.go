...
var benchRese_nocarry_0633 e_nocarry_0633

func BenchmarkE_nocarry_0633SetBytes(b *testing.B) {
	var x e_nocarry_0633
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0633MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0633.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0633)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0633)
		}
	})
}

func BenchmarkE_nocarry_0633Inverse(b *testing.B) {
	var x e_nocarry_0633
	x.SetRandom()
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0633Butterfly(b *testing.B) {
	var x e_nocarry_0633
	x.SetRandom()
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0633)
	}
}

func BenchmarkE_nocarry_0633Exp(b *testing.B) {
	var x e_nocarry_0633
	x.SetRandom()
	benchRese_nocarry_0633.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0633Double(b *testing.B) {
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Double(&benchRese_nocarry_0633)
	}
}

func BenchmarkE_nocarry_0633Add(b *testing.B) {
	var x e_nocarry_0633
	x.SetRandom()
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Add(&x, &benchRese_nocarry_0633)
	}
}

func BenchmarkE_nocarry_0633Sub(b *testing.B) {
	var x e_nocarry_0633
	x.SetRandom()
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Sub(&x, &benchRese_nocarry_0633)
	}
}

func BenchmarkE_nocarry_0633Neg(b *testing.B) {
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Neg(&benchRese_nocarry_0633)
	}
}

func BenchmarkE_nocarry_0633Div(b *testing.B) {
	var x e_nocarry_0633
	x.SetRandom()
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Div(&x, &benchRese_nocarry_0633)
	}
}

func BenchmarkE_nocarry_0633FromMont(b *testing.B) {
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.FromMont()
	}
}

func BenchmarkE_nocarry_0633ToMont(b *testing.B) {
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.ToMont()
	}
}
func BenchmarkE_nocarry_0633Square(b *testing.B) {
	benchRese_nocarry_0633.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Square(&benchRese_nocarry_0633)
	}
}

func BenchmarkE_nocarry_0633Sqrt(b *testing.B) {
	var a e_nocarry_0633
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0633Mul(b *testing.B) {
	x := e_nocarry_0633{
	...
	benchRese_nocarry_0633.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Mul(&benchRese_nocarry_0633, &x)
	}
}

func BenchmarkE_nocarry_0633Cmp(b *testing.B) {
	x := e_nocarry_0633{
		17195363805881893177,
		8446107025834934780,
		2672247646418279046,
	...
	benchRese_nocarry_0633 = x
	benchRese_nocarry_0633[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0633.Cmp(&x)
	}
}

func TestE_nocarry_0633Cmp(t *testing.T) {
	var x, y e_nocarry_0633
...
func TestE_nocarry_0633IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0633
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0633

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0633{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0633
	one.SetOne()
	e.Sub(&qe_nocarry_0633, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0633{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0633{0, uint64(i)})
	}
...
func TestE_nocarry_0633NegZero(t *testing.T) {
	var a, b e_nocarry_0633
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0633Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0633, len(staticTestValues))
...
func TestE_nocarry_0633Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0633) bool {
			var b e_nocarry_0633
...
func TestE_nocarry_0633InverseExp(t *testing.T) {
...
func TestE_nocarry_0633MulByConstants(t *testing.T) {
...
func TestE_nocarry_0633Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0633) bool {
...
func TestE_nocarry_0633LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0633Halve(t *testing.T) {
...
func TestE_nocarry_0633FromMont(t *testing.T) {
...
type testPaire_nocarry_0633 struct {
	element e_nocarry_0633
	bigint  big.Int
}

func (z *e_nocarry_0633) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0633[9] {
		return true
	}
	if z[9] < qe_nocarry_0633[9] {
		return false
	...
	return z[0] >= qe_nocarry_0633[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0633

		g.element = e_nocarry_0633{
		...
		if qe_nocarry_0633[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0633[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0633 {
			var g e_nocarry_0633
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0633[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0633[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0633[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0633[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0633[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0633[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0633[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0633[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0633[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0633[9], carry)
...
func Benchmarke_nocarry_0633InverseNew(b *testing.B) {
	var x e_nocarry_0633
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0633
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0633
		var xInv e_nocarry_0633
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0633
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0633
...
func testLinearComb(t *testing.T, x *e_nocarry_0633, xC int64, y *e_nocarry_0633, yC int64) {
	...
	var z e_nocarry_0633
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0633, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0633
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0633, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0633
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0633, xHi uint64) {
	var res e_nocarry_0633
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0633) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0633) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0633, c int64, result *e_nocarry_0633, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0633) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0633) uint64 {
