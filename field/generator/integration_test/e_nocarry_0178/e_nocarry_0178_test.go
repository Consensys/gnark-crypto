...
var benchRese_nocarry_0178 e_nocarry_0178

func BenchmarkE_nocarry_0178SetBytes(b *testing.B) {
	var x e_nocarry_0178
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0178MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0178.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0178)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0178)
		}
	})
}

func BenchmarkE_nocarry_0178Inverse(b *testing.B) {
	var x e_nocarry_0178
	x.SetRandom()
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0178Butterfly(b *testing.B) {
	var x e_nocarry_0178
	x.SetRandom()
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0178)
	}
}

func BenchmarkE_nocarry_0178Exp(b *testing.B) {
	var x e_nocarry_0178
	x.SetRandom()
	benchRese_nocarry_0178.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0178Double(b *testing.B) {
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Double(&benchRese_nocarry_0178)
	}
}

func BenchmarkE_nocarry_0178Add(b *testing.B) {
	var x e_nocarry_0178
	x.SetRandom()
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Add(&x, &benchRese_nocarry_0178)
	}
}

func BenchmarkE_nocarry_0178Sub(b *testing.B) {
	var x e_nocarry_0178
	x.SetRandom()
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Sub(&x, &benchRese_nocarry_0178)
	}
}

func BenchmarkE_nocarry_0178Neg(b *testing.B) {
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Neg(&benchRese_nocarry_0178)
	}
}

func BenchmarkE_nocarry_0178Div(b *testing.B) {
	var x e_nocarry_0178
	x.SetRandom()
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Div(&x, &benchRese_nocarry_0178)
	}
}

func BenchmarkE_nocarry_0178FromMont(b *testing.B) {
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.FromMont()
	}
}

func BenchmarkE_nocarry_0178ToMont(b *testing.B) {
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.ToMont()
	}
}
func BenchmarkE_nocarry_0178Square(b *testing.B) {
	benchRese_nocarry_0178.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Square(&benchRese_nocarry_0178)
	}
}

func BenchmarkE_nocarry_0178Sqrt(b *testing.B) {
	var a e_nocarry_0178
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0178Mul(b *testing.B) {
	x := e_nocarry_0178{
		16004107444515305775,
		13733687396684731087,
		137818245382957,
	}
	benchRese_nocarry_0178.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Mul(&benchRese_nocarry_0178, &x)
	}
}

func BenchmarkE_nocarry_0178Cmp(b *testing.B) {
	x := e_nocarry_0178{
		16004107444515305775,
		13733687396684731087,
		137818245382957,
	}
	benchRese_nocarry_0178 = x
	benchRese_nocarry_0178[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0178.Cmp(&x)
	}
}

func TestE_nocarry_0178Cmp(t *testing.T) {
	var x, y e_nocarry_0178
...
func TestE_nocarry_0178IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0178
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0178

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0178{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0178
	one.SetOne()
	e.Sub(&qe_nocarry_0178, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0178{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0178{0, uint64(i)})
	}
...
func TestE_nocarry_0178NegZero(t *testing.T) {
	var a, b e_nocarry_0178
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0178Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0178, len(staticTestValues))
...
func TestE_nocarry_0178Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0178) bool {
			var b e_nocarry_0178
...
func TestE_nocarry_0178InverseExp(t *testing.T) {
...
func TestE_nocarry_0178MulByConstants(t *testing.T) {
...
func TestE_nocarry_0178Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0178) bool {
...
func TestE_nocarry_0178LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0178Halve(t *testing.T) {
...
func TestE_nocarry_0178FromMont(t *testing.T) {
...
type testPaire_nocarry_0178 struct {
	element e_nocarry_0178
	bigint  big.Int
}

func (z *e_nocarry_0178) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0178[2] {
		return true
	}
	if z[2] < qe_nocarry_0178[2] {
		return false
	...
	return z[0] >= qe_nocarry_0178[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0178

		g.element = e_nocarry_0178{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0178[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0178[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0178 {
			var g e_nocarry_0178
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0178[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0178[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0178[2], carry)
...
func Benchmarke_nocarry_0178InverseNew(b *testing.B) {
	var x e_nocarry_0178
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0178
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0178
		var xInv e_nocarry_0178
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0178
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0178
...
func testLinearComb(t *testing.T, x *e_nocarry_0178, xC int64, y *e_nocarry_0178, yC int64) {
	...
	var z e_nocarry_0178
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0178, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0178
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0178, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0178
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0178, xHi uint64) {
	var res e_nocarry_0178
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0178) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0178) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0178, c int64, result *e_nocarry_0178, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0178) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0178) uint64 {
