...
var benchRese_nocarry_0476 e_nocarry_0476

func BenchmarkE_nocarry_0476SetBytes(b *testing.B) {
	var x e_nocarry_0476
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0476MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0476.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0476)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0476)
		}
	})
}

func BenchmarkE_nocarry_0476Inverse(b *testing.B) {
	var x e_nocarry_0476
	x.SetRandom()
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0476Butterfly(b *testing.B) {
	var x e_nocarry_0476
	x.SetRandom()
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0476)
	}
}

func BenchmarkE_nocarry_0476Exp(b *testing.B) {
	var x e_nocarry_0476
	x.SetRandom()
	benchRese_nocarry_0476.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0476Double(b *testing.B) {
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Double(&benchRese_nocarry_0476)
	}
}

func BenchmarkE_nocarry_0476Add(b *testing.B) {
	var x e_nocarry_0476
	x.SetRandom()
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Add(&x, &benchRese_nocarry_0476)
	}
}

func BenchmarkE_nocarry_0476Sub(b *testing.B) {
	var x e_nocarry_0476
	x.SetRandom()
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Sub(&x, &benchRese_nocarry_0476)
	}
}

func BenchmarkE_nocarry_0476Neg(b *testing.B) {
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Neg(&benchRese_nocarry_0476)
	}
}

func BenchmarkE_nocarry_0476Div(b *testing.B) {
	var x e_nocarry_0476
	x.SetRandom()
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Div(&x, &benchRese_nocarry_0476)
	}
}

func BenchmarkE_nocarry_0476FromMont(b *testing.B) {
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.FromMont()
	}
}

func BenchmarkE_nocarry_0476ToMont(b *testing.B) {
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.ToMont()
	}
}
func BenchmarkE_nocarry_0476Square(b *testing.B) {
	benchRese_nocarry_0476.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Square(&benchRese_nocarry_0476)
	}
}

func BenchmarkE_nocarry_0476Sqrt(b *testing.B) {
	var a e_nocarry_0476
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0476Mul(b *testing.B) {
	x := e_nocarry_0476{
	...
	benchRese_nocarry_0476.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Mul(&benchRese_nocarry_0476, &x)
	}
}

func BenchmarkE_nocarry_0476Cmp(b *testing.B) {
	x := e_nocarry_0476{
		11909735262322031542,
		6537896696525166328,
		2637500098358926768,
	...
	benchRese_nocarry_0476 = x
	benchRese_nocarry_0476[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0476.Cmp(&x)
	}
}

func TestE_nocarry_0476Cmp(t *testing.T) {
	var x, y e_nocarry_0476
...
func TestE_nocarry_0476IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0476
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0476

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0476{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0476
	one.SetOne()
	e.Sub(&qe_nocarry_0476, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0476{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0476{0, uint64(i)})
	}
...
func TestE_nocarry_0476NegZero(t *testing.T) {
	var a, b e_nocarry_0476
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0476Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0476, len(staticTestValues))
...
func TestE_nocarry_0476Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0476) bool {
			var b e_nocarry_0476
...
func TestE_nocarry_0476InverseExp(t *testing.T) {
...
func TestE_nocarry_0476MulByConstants(t *testing.T) {
...
func TestE_nocarry_0476Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0476) bool {
...
func TestE_nocarry_0476LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0476Halve(t *testing.T) {
...
func TestE_nocarry_0476FromMont(t *testing.T) {
...
type testPaire_nocarry_0476 struct {
	element e_nocarry_0476
	bigint  big.Int
}

func (z *e_nocarry_0476) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0476[7] {
		return true
	}
	if z[7] < qe_nocarry_0476[7] {
		return false
	...
	return z[0] >= qe_nocarry_0476[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0476

		g.element = e_nocarry_0476{
		...
		if qe_nocarry_0476[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0476[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0476 {
			var g e_nocarry_0476
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0476[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0476[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0476[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0476[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0476[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0476[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0476[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0476[7], carry)
...
func Benchmarke_nocarry_0476InverseNew(b *testing.B) {
	var x e_nocarry_0476
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0476
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0476
		var xInv e_nocarry_0476
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0476
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0476
...
func testLinearComb(t *testing.T, x *e_nocarry_0476, xC int64, y *e_nocarry_0476, yC int64) {
	...
	var z e_nocarry_0476
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0476, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0476
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0476, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0476
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0476, xHi uint64) {
	var res e_nocarry_0476
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0476) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0476) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0476, c int64, result *e_nocarry_0476, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0476) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0476) uint64 {
