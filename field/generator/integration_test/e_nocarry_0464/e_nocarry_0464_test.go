...
var benchRese_nocarry_0464 e_nocarry_0464

func BenchmarkE_nocarry_0464SetBytes(b *testing.B) {
	var x e_nocarry_0464
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0464MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0464.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0464)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0464)
		}
	})
}

func BenchmarkE_nocarry_0464Inverse(b *testing.B) {
	var x e_nocarry_0464
	x.SetRandom()
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0464Butterfly(b *testing.B) {
	var x e_nocarry_0464
	x.SetRandom()
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0464)
	}
}

func BenchmarkE_nocarry_0464Exp(b *testing.B) {
	var x e_nocarry_0464
	x.SetRandom()
	benchRese_nocarry_0464.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0464Double(b *testing.B) {
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Double(&benchRese_nocarry_0464)
	}
}

func BenchmarkE_nocarry_0464Add(b *testing.B) {
	var x e_nocarry_0464
	x.SetRandom()
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Add(&x, &benchRese_nocarry_0464)
	}
}

func BenchmarkE_nocarry_0464Sub(b *testing.B) {
	var x e_nocarry_0464
	x.SetRandom()
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Sub(&x, &benchRese_nocarry_0464)
	}
}

func BenchmarkE_nocarry_0464Neg(b *testing.B) {
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Neg(&benchRese_nocarry_0464)
	}
}

func BenchmarkE_nocarry_0464Div(b *testing.B) {
	var x e_nocarry_0464
	x.SetRandom()
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Div(&x, &benchRese_nocarry_0464)
	}
}

func BenchmarkE_nocarry_0464FromMont(b *testing.B) {
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.FromMont()
	}
}

func BenchmarkE_nocarry_0464ToMont(b *testing.B) {
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.ToMont()
	}
}
func BenchmarkE_nocarry_0464Square(b *testing.B) {
	benchRese_nocarry_0464.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Square(&benchRese_nocarry_0464)
	}
}

func BenchmarkE_nocarry_0464Sqrt(b *testing.B) {
	var a e_nocarry_0464
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0464Mul(b *testing.B) {
	x := e_nocarry_0464{
	...
	benchRese_nocarry_0464.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Mul(&benchRese_nocarry_0464, &x)
	}
}

func BenchmarkE_nocarry_0464Cmp(b *testing.B) {
	x := e_nocarry_0464{
		17703778483199843367,
		11506787002804827610,
		16983449361620283796,
	...
	benchRese_nocarry_0464 = x
	benchRese_nocarry_0464[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0464.Cmp(&x)
	}
}

func TestE_nocarry_0464Cmp(t *testing.T) {
	var x, y e_nocarry_0464
...
func TestE_nocarry_0464IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0464
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0464

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0464{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0464
	one.SetOne()
	e.Sub(&qe_nocarry_0464, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0464{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0464{0, uint64(i)})
	}
...
func TestE_nocarry_0464NegZero(t *testing.T) {
	var a, b e_nocarry_0464
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0464Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0464, len(staticTestValues))
...
func TestE_nocarry_0464Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0464) bool {
			var b e_nocarry_0464
...
func TestE_nocarry_0464InverseExp(t *testing.T) {
...
func TestE_nocarry_0464MulByConstants(t *testing.T) {
...
func TestE_nocarry_0464Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0464) bool {
...
func TestE_nocarry_0464LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0464Halve(t *testing.T) {
...
func TestE_nocarry_0464FromMont(t *testing.T) {
...
type testPaire_nocarry_0464 struct {
	element e_nocarry_0464
	bigint  big.Int
}

func (z *e_nocarry_0464) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0464[7] {
		return true
	}
	if z[7] < qe_nocarry_0464[7] {
		return false
	...
	return z[0] >= qe_nocarry_0464[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0464

		g.element = e_nocarry_0464{
		...
		if qe_nocarry_0464[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0464[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0464 {
			var g e_nocarry_0464
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0464[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0464[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0464[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0464[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0464[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0464[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0464[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0464[7], carry)
...
func Benchmarke_nocarry_0464InverseNew(b *testing.B) {
	var x e_nocarry_0464
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0464
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0464
		var xInv e_nocarry_0464
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0464
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0464
...
func testLinearComb(t *testing.T, x *e_nocarry_0464, xC int64, y *e_nocarry_0464, yC int64) {
	...
	var z e_nocarry_0464
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0464, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0464
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0464, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0464
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0464, xHi uint64) {
	var res e_nocarry_0464
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0464) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0464) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0464, c int64, result *e_nocarry_0464, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0464) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0464) uint64 {
