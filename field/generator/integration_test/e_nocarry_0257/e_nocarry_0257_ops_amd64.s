...
// modulus q
DATA q<>+0(SB)/8, $0x0b3265dccd6a01a9
DATA q<>+8(SB)/8, $0xff904f5e7716e7e0
DATA q<>+16(SB)/8, $0xbc1d2a216f092dec
DATA q<>+24(SB)/8, $0xced4aa9747cbb962
DATA q<>+32(SB)/8, $1
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xe808c0c31bfdcd67
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x0b3265dccd6a01a9, R9
	MOVQ    $0xff904f5e7716e7e0, R10
	MOVQ    $0xbc1d2a216f092dec, R11
	MOVQ    $0xced4aa9747cbb962, R12
	MOVQ    $1, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xff904f5e7716e7e0, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xbc1d2a216f092dec, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xced4aa9747cbb962, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $1, R9
	SBBQ  DI, R9
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x0b3265dccd6a01a9, CX
	MOVQ    $0xff904f5e7716e7e0, BX
	MOVQ    $0xbc1d2a216f092dec, SI
	MOVQ    $0xced4aa9747cbb962, DI
	MOVQ    $1, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
