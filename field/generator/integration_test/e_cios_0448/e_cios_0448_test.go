...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_cios_0448{uint64(i)})
		staticTestValues = append(staticTestValues, e_cios_0448{0, uint64(i)})
	}
...
func (z *e_cios_0448) biggerOrEqualModulus() bool {
	if z[6] > qe_cios_0448[6] {
		return true
	}
	if z[6] < qe_cios_0448[6] {
		return false
