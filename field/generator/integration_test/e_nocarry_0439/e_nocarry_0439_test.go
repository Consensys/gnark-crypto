...
var benchRese_nocarry_0439 e_nocarry_0439

func BenchmarkE_nocarry_0439SetBytes(b *testing.B) {
	var x e_nocarry_0439
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0439MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0439.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0439)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0439)
		}
	})
}

func BenchmarkE_nocarry_0439Inverse(b *testing.B) {
	var x e_nocarry_0439
	x.SetRandom()
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0439Butterfly(b *testing.B) {
	var x e_nocarry_0439
	x.SetRandom()
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0439)
	}
}

func BenchmarkE_nocarry_0439Exp(b *testing.B) {
	var x e_nocarry_0439
	x.SetRandom()
	benchRese_nocarry_0439.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0439Double(b *testing.B) {
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Double(&benchRese_nocarry_0439)
	}
}

func BenchmarkE_nocarry_0439Add(b *testing.B) {
	var x e_nocarry_0439
	x.SetRandom()
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Add(&x, &benchRese_nocarry_0439)
	}
}

func BenchmarkE_nocarry_0439Sub(b *testing.B) {
	var x e_nocarry_0439
	x.SetRandom()
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Sub(&x, &benchRese_nocarry_0439)
	}
}

func BenchmarkE_nocarry_0439Neg(b *testing.B) {
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Neg(&benchRese_nocarry_0439)
	}
}

func BenchmarkE_nocarry_0439Div(b *testing.B) {
	var x e_nocarry_0439
	x.SetRandom()
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Div(&x, &benchRese_nocarry_0439)
	}
}

func BenchmarkE_nocarry_0439FromMont(b *testing.B) {
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.FromMont()
	}
}

func BenchmarkE_nocarry_0439ToMont(b *testing.B) {
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.ToMont()
	}
}
func BenchmarkE_nocarry_0439Square(b *testing.B) {
	benchRese_nocarry_0439.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Square(&benchRese_nocarry_0439)
	}
}

func BenchmarkE_nocarry_0439Sqrt(b *testing.B) {
	var a e_nocarry_0439
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0439Mul(b *testing.B) {
	x := e_nocarry_0439{
	...
	benchRese_nocarry_0439.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Mul(&benchRese_nocarry_0439, &x)
	}
}

func BenchmarkE_nocarry_0439Cmp(b *testing.B) {
	x := e_nocarry_0439{
		14329504800881719680,
		18107027421034177168,
		16931191115058055190,
	...
	benchRese_nocarry_0439 = x
	benchRese_nocarry_0439[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0439.Cmp(&x)
	}
}

func TestE_nocarry_0439Cmp(t *testing.T) {
	var x, y e_nocarry_0439
...
func TestE_nocarry_0439IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0439
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0439

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0439{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0439
	one.SetOne()
	e.Sub(&qe_nocarry_0439, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0439{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0439{0, uint64(i)})
	}
...
func TestE_nocarry_0439NegZero(t *testing.T) {
	var a, b e_nocarry_0439
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0439Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0439, len(staticTestValues))
...
func TestE_nocarry_0439Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0439) bool {
			var b e_nocarry_0439
...
func TestE_nocarry_0439InverseExp(t *testing.T) {
...
func TestE_nocarry_0439MulByConstants(t *testing.T) {
...
func TestE_nocarry_0439Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0439) bool {
...
func TestE_nocarry_0439LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0439Halve(t *testing.T) {
...
func TestE_nocarry_0439FromMont(t *testing.T) {
...
type testPaire_nocarry_0439 struct {
	element e_nocarry_0439
	bigint  big.Int
}

func (z *e_nocarry_0439) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0439[6] {
		return true
	}
	if z[6] < qe_nocarry_0439[6] {
		return false
	...
	return z[0] >= qe_nocarry_0439[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0439

		g.element = e_nocarry_0439{
		...
		if qe_nocarry_0439[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0439[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0439 {
			var g e_nocarry_0439
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0439[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0439[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0439[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0439[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0439[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0439[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0439[6], carry)
...
func Benchmarke_nocarry_0439InverseNew(b *testing.B) {
	var x e_nocarry_0439
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0439
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0439
		var xInv e_nocarry_0439
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0439
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0439
...
func testLinearComb(t *testing.T, x *e_nocarry_0439, xC int64, y *e_nocarry_0439, yC int64) {
	...
	var z e_nocarry_0439
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0439, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0439
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0439, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0439
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0439, xHi uint64) {
	var res e_nocarry_0439
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0439) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0439) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0439, c int64, result *e_nocarry_0439, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0439) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0439) uint64 {
