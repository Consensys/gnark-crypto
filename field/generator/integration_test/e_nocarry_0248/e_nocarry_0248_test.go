...
var benchRese_nocarry_0248 e_nocarry_0248

func BenchmarkE_nocarry_0248SetBytes(b *testing.B) {
	var x e_nocarry_0248
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0248MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0248.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0248)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0248)
		}
	})
}

func BenchmarkE_nocarry_0248Inverse(b *testing.B) {
	var x e_nocarry_0248
	x.SetRandom()
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0248Butterfly(b *testing.B) {
	var x e_nocarry_0248
	x.SetRandom()
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0248)
	}
}

func BenchmarkE_nocarry_0248Exp(b *testing.B) {
	var x e_nocarry_0248
	x.SetRandom()
	benchRese_nocarry_0248.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0248Double(b *testing.B) {
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Double(&benchRese_nocarry_0248)
	}
}

func BenchmarkE_nocarry_0248Add(b *testing.B) {
	var x e_nocarry_0248
	x.SetRandom()
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Add(&x, &benchRese_nocarry_0248)
	}
}

func BenchmarkE_nocarry_0248Sub(b *testing.B) {
	var x e_nocarry_0248
	x.SetRandom()
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Sub(&x, &benchRese_nocarry_0248)
	}
}

func BenchmarkE_nocarry_0248Neg(b *testing.B) {
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Neg(&benchRese_nocarry_0248)
	}
}

func BenchmarkE_nocarry_0248Div(b *testing.B) {
	var x e_nocarry_0248
	x.SetRandom()
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Div(&x, &benchRese_nocarry_0248)
	}
}

func BenchmarkE_nocarry_0248FromMont(b *testing.B) {
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.FromMont()
	}
}

func BenchmarkE_nocarry_0248ToMont(b *testing.B) {
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.ToMont()
	}
}
func BenchmarkE_nocarry_0248Square(b *testing.B) {
	benchRese_nocarry_0248.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Square(&benchRese_nocarry_0248)
	}
}

func BenchmarkE_nocarry_0248Sqrt(b *testing.B) {
	var a e_nocarry_0248
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0248Mul(b *testing.B) {
	x := e_nocarry_0248{
		1688928563013181900,
	...
	benchRese_nocarry_0248.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Mul(&benchRese_nocarry_0248, &x)
	}
}

func BenchmarkE_nocarry_0248Cmp(b *testing.B) {
	x := e_nocarry_0248{
		1688928563013181900,
		15229555009347064270,
		3404920856091794200,
	...
	benchRese_nocarry_0248 = x
	benchRese_nocarry_0248[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0248.Cmp(&x)
	}
}

func TestE_nocarry_0248Cmp(t *testing.T) {
	var x, y e_nocarry_0248
...
func TestE_nocarry_0248IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0248
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0248

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0248{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0248
	one.SetOne()
	e.Sub(&qe_nocarry_0248, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0248{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0248{0, uint64(i)})
	}
...
func TestE_nocarry_0248NegZero(t *testing.T) {
	var a, b e_nocarry_0248
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0248Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0248, len(staticTestValues))
...
func TestE_nocarry_0248Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0248) bool {
			var b e_nocarry_0248
...
func TestE_nocarry_0248InverseExp(t *testing.T) {
...
func TestE_nocarry_0248MulByConstants(t *testing.T) {
...
func TestE_nocarry_0248Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0248) bool {
...
func TestE_nocarry_0248LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0248Halve(t *testing.T) {
...
func TestE_nocarry_0248FromMont(t *testing.T) {
...
type testPaire_nocarry_0248 struct {
	element e_nocarry_0248
	bigint  big.Int
}

func (z *e_nocarry_0248) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0248[3] {
		return true
	}
	if z[3] < qe_nocarry_0248[3] {
		return false
	...
	return z[0] >= qe_nocarry_0248[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0248

		g.element = e_nocarry_0248{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0248[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0248[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0248 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0248[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0248[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0248[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0248[3], carry)
...
func Benchmarke_nocarry_0248InverseNew(b *testing.B) {
	var x e_nocarry_0248
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0248
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0248
		var xInv e_nocarry_0248
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0248
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0248
...
func testLinearComb(t *testing.T, x *e_nocarry_0248, xC int64, y *e_nocarry_0248, yC int64) {
	...
	var z e_nocarry_0248
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0248, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0248
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0248, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0248
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0248, xHi uint64) {
	var res e_nocarry_0248
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0248) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0248) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0248, c int64, result *e_nocarry_0248, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0248) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0248) uint64 {
