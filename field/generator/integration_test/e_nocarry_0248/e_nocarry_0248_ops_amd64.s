...
// modulus q
DATA q<>+0(SB)/8, $0x6963c46054eaced9
DATA q<>+8(SB)/8, $0xe693d6c519328aeb
DATA q<>+16(SB)/8, $0x6f01fa655f7f310c
DATA q<>+24(SB)/8, $0x00fa4fa1fb53b412
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x41ab2075ffdd2e97
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x6963c46054eaced9, R8
	MOVQ    $0xe693d6c519328aeb, R9
	MOVQ    $0x6f01fa655f7f310c, R10
	MOVQ    $0x00fa4fa1fb53b412, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xe693d6c519328aeb, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x6f01fa655f7f310c, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00fa4fa1fb53b412, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x6963c46054eaced9, R12
	MOVQ    $0xe693d6c519328aeb, R13
	MOVQ    $0x6f01fa655f7f310c, R14
	MOVQ    $0x00fa4fa1fb53b412, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
