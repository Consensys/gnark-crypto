...
var benchRese_nocarry_0135 e_nocarry_0135

func BenchmarkE_nocarry_0135SetBytes(b *testing.B) {
	var x e_nocarry_0135
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0135MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0135.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0135)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0135)
		}
	})
}

func BenchmarkE_nocarry_0135Inverse(b *testing.B) {
	var x e_nocarry_0135
	x.SetRandom()
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0135Butterfly(b *testing.B) {
	var x e_nocarry_0135
	x.SetRandom()
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0135)
	}
}

func BenchmarkE_nocarry_0135Exp(b *testing.B) {
	var x e_nocarry_0135
	x.SetRandom()
	benchRese_nocarry_0135.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0135Double(b *testing.B) {
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Double(&benchRese_nocarry_0135)
	}
}

func BenchmarkE_nocarry_0135Add(b *testing.B) {
	var x e_nocarry_0135
	x.SetRandom()
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Add(&x, &benchRese_nocarry_0135)
	}
}

func BenchmarkE_nocarry_0135Sub(b *testing.B) {
	var x e_nocarry_0135
	x.SetRandom()
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Sub(&x, &benchRese_nocarry_0135)
	}
}

func BenchmarkE_nocarry_0135Neg(b *testing.B) {
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Neg(&benchRese_nocarry_0135)
	}
}

func BenchmarkE_nocarry_0135Div(b *testing.B) {
	var x e_nocarry_0135
	x.SetRandom()
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Div(&x, &benchRese_nocarry_0135)
	}
}

func BenchmarkE_nocarry_0135FromMont(b *testing.B) {
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.FromMont()
	}
}

func BenchmarkE_nocarry_0135ToMont(b *testing.B) {
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.ToMont()
	}
}
func BenchmarkE_nocarry_0135Square(b *testing.B) {
	benchRese_nocarry_0135.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Square(&benchRese_nocarry_0135)
	}
}

func BenchmarkE_nocarry_0135Sqrt(b *testing.B) {
	var a e_nocarry_0135
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0135Mul(b *testing.B) {
	x := e_nocarry_0135{
		4138806021898629846,
		4708669483086414616,
		55,
	}
	benchRese_nocarry_0135.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Mul(&benchRese_nocarry_0135, &x)
	}
}

func BenchmarkE_nocarry_0135Cmp(b *testing.B) {
	x := e_nocarry_0135{
		4138806021898629846,
		4708669483086414616,
		55,
	}
	benchRese_nocarry_0135 = x
	benchRese_nocarry_0135[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0135.Cmp(&x)
	}
}

func TestE_nocarry_0135Cmp(t *testing.T) {
	var x, y e_nocarry_0135
...
func TestE_nocarry_0135IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0135
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0135

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0135{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0135
	one.SetOne()
	e.Sub(&qe_nocarry_0135, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0135{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0135{0, uint64(i)})
	}
...
func TestE_nocarry_0135NegZero(t *testing.T) {
	var a, b e_nocarry_0135
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0135Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0135, len(staticTestValues))
...
func TestE_nocarry_0135Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0135) bool {
			var b e_nocarry_0135
...
func TestE_nocarry_0135InverseExp(t *testing.T) {
...
func TestE_nocarry_0135MulByConstants(t *testing.T) {
...
func TestE_nocarry_0135Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0135) bool {
...
func TestE_nocarry_0135LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0135Halve(t *testing.T) {
...
func TestE_nocarry_0135FromMont(t *testing.T) {
...
type testPaire_nocarry_0135 struct {
	element e_nocarry_0135
	bigint  big.Int
}

func (z *e_nocarry_0135) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0135[2] {
		return true
	}
	if z[2] < qe_nocarry_0135[2] {
		return false
	...
	return z[0] >= qe_nocarry_0135[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0135

		g.element = e_nocarry_0135{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0135[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0135[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0135 {
			var g e_nocarry_0135
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0135[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0135[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0135[2], carry)
...
func Benchmarke_nocarry_0135InverseNew(b *testing.B) {
	var x e_nocarry_0135
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0135
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0135
		var xInv e_nocarry_0135
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0135
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0135
...
func testLinearComb(t *testing.T, x *e_nocarry_0135, xC int64, y *e_nocarry_0135, yC int64) {
	...
	var z e_nocarry_0135
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0135, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0135
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0135, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0135
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0135, xHi uint64) {
	var res e_nocarry_0135
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0135) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0135) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0135, c int64, result *e_nocarry_0135, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0135) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0135) uint64 {
