...
var benchRese_nocarry_0601 e_nocarry_0601

func BenchmarkE_nocarry_0601SetBytes(b *testing.B) {
	var x e_nocarry_0601
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0601MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0601.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0601)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0601)
		}
	})
}

func BenchmarkE_nocarry_0601Inverse(b *testing.B) {
	var x e_nocarry_0601
	x.SetRandom()
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0601Butterfly(b *testing.B) {
	var x e_nocarry_0601
	x.SetRandom()
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0601)
	}
}

func BenchmarkE_nocarry_0601Exp(b *testing.B) {
	var x e_nocarry_0601
	x.SetRandom()
	benchRese_nocarry_0601.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0601Double(b *testing.B) {
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Double(&benchRese_nocarry_0601)
	}
}

func BenchmarkE_nocarry_0601Add(b *testing.B) {
	var x e_nocarry_0601
	x.SetRandom()
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Add(&x, &benchRese_nocarry_0601)
	}
}

func BenchmarkE_nocarry_0601Sub(b *testing.B) {
	var x e_nocarry_0601
	x.SetRandom()
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Sub(&x, &benchRese_nocarry_0601)
	}
}

func BenchmarkE_nocarry_0601Neg(b *testing.B) {
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Neg(&benchRese_nocarry_0601)
	}
}

func BenchmarkE_nocarry_0601Div(b *testing.B) {
	var x e_nocarry_0601
	x.SetRandom()
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Div(&x, &benchRese_nocarry_0601)
	}
}

func BenchmarkE_nocarry_0601FromMont(b *testing.B) {
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.FromMont()
	}
}

func BenchmarkE_nocarry_0601ToMont(b *testing.B) {
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.ToMont()
	}
}
func BenchmarkE_nocarry_0601Square(b *testing.B) {
	benchRese_nocarry_0601.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Square(&benchRese_nocarry_0601)
	}
}

func BenchmarkE_nocarry_0601Sqrt(b *testing.B) {
	var a e_nocarry_0601
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0601Mul(b *testing.B) {
	x := e_nocarry_0601{
		8773063431273618412,
		7404336615695200005,
	...
	benchRese_nocarry_0601.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Mul(&benchRese_nocarry_0601, &x)
	}
}

func BenchmarkE_nocarry_0601Cmp(b *testing.B) {
	x := e_nocarry_0601{
		8773063431273618412,
		7404336615695200005,
		17429931536247322466,
	...
	benchRese_nocarry_0601 = x
	benchRese_nocarry_0601[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0601.Cmp(&x)
	}
}

func TestE_nocarry_0601Cmp(t *testing.T) {
	var x, y e_nocarry_0601
...
func TestE_nocarry_0601IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0601
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0601

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0601{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0601
	one.SetOne()
	e.Sub(&qe_nocarry_0601, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0601{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0601{0, uint64(i)})
	}
...
func TestE_nocarry_0601NegZero(t *testing.T) {
	var a, b e_nocarry_0601
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0601Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0601, len(staticTestValues))
...
func TestE_nocarry_0601Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0601) bool {
			var b e_nocarry_0601
...
func TestE_nocarry_0601InverseExp(t *testing.T) {
...
func TestE_nocarry_0601MulByConstants(t *testing.T) {
...
func TestE_nocarry_0601Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0601) bool {
...
func TestE_nocarry_0601LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0601Halve(t *testing.T) {
...
func TestE_nocarry_0601FromMont(t *testing.T) {
...
type testPaire_nocarry_0601 struct {
	element e_nocarry_0601
	bigint  big.Int
}

func (z *e_nocarry_0601) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0601[9] {
		return true
	}
	if z[9] < qe_nocarry_0601[9] {
		return false
	...
	return z[0] >= qe_nocarry_0601[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0601

		g.element = e_nocarry_0601{
		...
		if qe_nocarry_0601[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0601[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0601 {
			var g e_nocarry_0601
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0601[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0601[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0601[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0601[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0601[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0601[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0601[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0601[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0601[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0601[9], carry)
...
func Benchmarke_nocarry_0601InverseNew(b *testing.B) {
	var x e_nocarry_0601
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0601
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0601
		var xInv e_nocarry_0601
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0601
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0601
...
func testLinearComb(t *testing.T, x *e_nocarry_0601, xC int64, y *e_nocarry_0601, yC int64) {
	...
	var z e_nocarry_0601
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0601, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0601
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0601, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0601
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0601, xHi uint64) {
	var res e_nocarry_0601
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0601) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0601) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0601, c int64, result *e_nocarry_0601, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0601) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0601) uint64 {
