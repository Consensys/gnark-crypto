...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x23b71b4a0ce2dd87, R13
	ADDQ R13, AX
	MOVQ $0x21a4fad18b066883, R13
	ADCQ R13, DX
	MOVQ $0x1a1e6f0e0872d223, R13
	ADCQ R13, CX
	MOVQ $0x679452f3731e0720, R13
	ADCQ R13, BX
	MOVQ $0x296949c51ceb9d63, R13
	ADCQ R13, SI
	MOVQ $0x4e62ce30c2b0e51b, R13
	ADCQ R13, DI
	MOVQ $0x044ec2d1d8e116dc, R13
	ADCQ R13, R8
	MOVQ $0x05c12ec8705b9174, R13
	ADCQ R13, R9
	MOVQ $0xdd5b357b4a5dbce2, R13
	ADCQ R13, R10
	MOVQ $0x0000000001f69ed2, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x23b71b4a0ce2dd87, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x21a4fad18b066883, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x1a1e6f0e0872d223, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x679452f3731e0720, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x296949c51ceb9d63, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x4e62ce30c2b0e51b, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x044ec2d1d8e116dc, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x05c12ec8705b9174, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xdd5b357b4a5dbce2, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000001f69ed2, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x23b71b4a0ce2dd87, AX
	ADDQ AX, DX
	MOVQ $0x21a4fad18b066883, AX
	ADCQ AX, CX
	MOVQ $0x1a1e6f0e0872d223, AX
	ADCQ AX, BX
	MOVQ $0x679452f3731e0720, AX
	ADCQ AX, SI
	MOVQ $0x296949c51ceb9d63, AX
	ADCQ AX, DI
	MOVQ $0x4e62ce30c2b0e51b, AX
	ADCQ AX, R8
	MOVQ $0x044ec2d1d8e116dc, AX
	ADCQ AX, R9
	MOVQ $0x05c12ec8705b9174, AX
	ADCQ AX, R10
	MOVQ $0xdd5b357b4a5dbce2, AX
	ADCQ AX, R11
	MOVQ $0x0000000001f69ed2, AX
	ADCQ AX, R12
