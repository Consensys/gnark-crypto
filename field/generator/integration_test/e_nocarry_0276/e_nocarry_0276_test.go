...
var benchRese_nocarry_0276 e_nocarry_0276

func BenchmarkE_nocarry_0276SetBytes(b *testing.B) {
	var x e_nocarry_0276
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0276MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0276.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0276)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0276)
		}
	})
}

func BenchmarkE_nocarry_0276Inverse(b *testing.B) {
	var x e_nocarry_0276
	x.SetRandom()
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0276Butterfly(b *testing.B) {
	var x e_nocarry_0276
	x.SetRandom()
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0276)
	}
}

func BenchmarkE_nocarry_0276Exp(b *testing.B) {
	var x e_nocarry_0276
	x.SetRandom()
	benchRese_nocarry_0276.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0276Double(b *testing.B) {
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Double(&benchRese_nocarry_0276)
	}
}

func BenchmarkE_nocarry_0276Add(b *testing.B) {
	var x e_nocarry_0276
	x.SetRandom()
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Add(&x, &benchRese_nocarry_0276)
	}
}

func BenchmarkE_nocarry_0276Sub(b *testing.B) {
	var x e_nocarry_0276
	x.SetRandom()
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Sub(&x, &benchRese_nocarry_0276)
	}
}

func BenchmarkE_nocarry_0276Neg(b *testing.B) {
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Neg(&benchRese_nocarry_0276)
	}
}

func BenchmarkE_nocarry_0276Div(b *testing.B) {
	var x e_nocarry_0276
	x.SetRandom()
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Div(&x, &benchRese_nocarry_0276)
	}
}

func BenchmarkE_nocarry_0276FromMont(b *testing.B) {
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.FromMont()
	}
}

func BenchmarkE_nocarry_0276ToMont(b *testing.B) {
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.ToMont()
	}
}
func BenchmarkE_nocarry_0276Square(b *testing.B) {
	benchRese_nocarry_0276.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Square(&benchRese_nocarry_0276)
	}
}

func BenchmarkE_nocarry_0276Sqrt(b *testing.B) {
	var a e_nocarry_0276
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0276Mul(b *testing.B) {
	x := e_nocarry_0276{
	...
	benchRese_nocarry_0276.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Mul(&benchRese_nocarry_0276, &x)
	}
}

func BenchmarkE_nocarry_0276Cmp(b *testing.B) {
	x := e_nocarry_0276{
		11277333059807704451,
		7611363352979975707,
		1775024447317814446,
	...
	benchRese_nocarry_0276 = x
	benchRese_nocarry_0276[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0276.Cmp(&x)
	}
}

func TestE_nocarry_0276Cmp(t *testing.T) {
	var x, y e_nocarry_0276
...
func TestE_nocarry_0276IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0276
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0276

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0276{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0276
	one.SetOne()
	e.Sub(&qe_nocarry_0276, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0276{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0276{0, uint64(i)})
	}
...
func TestE_nocarry_0276NegZero(t *testing.T) {
	var a, b e_nocarry_0276
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0276Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0276, len(staticTestValues))
...
func TestE_nocarry_0276Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0276) bool {
			var b e_nocarry_0276
...
func TestE_nocarry_0276InverseExp(t *testing.T) {
...
func TestE_nocarry_0276MulByConstants(t *testing.T) {
...
func TestE_nocarry_0276Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0276) bool {
...
func TestE_nocarry_0276LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0276Halve(t *testing.T) {
...
func TestE_nocarry_0276FromMont(t *testing.T) {
...
type testPaire_nocarry_0276 struct {
	element e_nocarry_0276
	bigint  big.Int
}

func (z *e_nocarry_0276) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0276[4] {
		return true
	}
	if z[4] < qe_nocarry_0276[4] {
		return false
	...
	return z[0] >= qe_nocarry_0276[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0276

		g.element = e_nocarry_0276{
		...
		if qe_nocarry_0276[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0276[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0276 {
			var g e_nocarry_0276
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0276[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0276[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0276[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0276[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0276[4], carry)
...
func Benchmarke_nocarry_0276InverseNew(b *testing.B) {
	var x e_nocarry_0276
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0276
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0276
		var xInv e_nocarry_0276
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0276
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0276
...
func testLinearComb(t *testing.T, x *e_nocarry_0276, xC int64, y *e_nocarry_0276, yC int64) {
	...
	var z e_nocarry_0276
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0276, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0276
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0276, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0276
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0276, xHi uint64) {
	var res e_nocarry_0276
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0276) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0276) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0276, c int64, result *e_nocarry_0276, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0276) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0276) uint64 {
