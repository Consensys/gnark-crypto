...
// modulus q
DATA q<>+0(SB)/8, $0xd6f2377993dbbc4b
DATA q<>+8(SB)/8, $0xaf7d44808a3eb741
DATA q<>+16(SB)/8, $0x3446d5fd46611252
DATA q<>+24(SB)/8, $0xc762b9e7a24934f5
DATA q<>+32(SB)/8, $0xc2e65c692ec2e295
DATA q<>+40(SB)/8, $0x0000000000fa2725
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xceb5ae510858d29d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xd6f2377993dbbc4b, R10
	MOVQ    $0xaf7d44808a3eb741, R11
	MOVQ    $0x3446d5fd46611252, R12
	MOVQ    $0xc762b9e7a24934f5, R13
	MOVQ    $0xc2e65c692ec2e295, R14
	MOVQ    $0x0000000000fa2725, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xaf7d44808a3eb741, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x3446d5fd46611252, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xc762b9e7a24934f5, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xc2e65c692ec2e295, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000000fa2725, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xd6f2377993dbbc4b, CX
	MOVQ    $0xaf7d44808a3eb741, BX
	MOVQ    $0x3446d5fd46611252, SI
	MOVQ    $0xc762b9e7a24934f5, DI
	MOVQ    $0xc2e65c692ec2e295, R8
	MOVQ    $0x0000000000fa2725, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
