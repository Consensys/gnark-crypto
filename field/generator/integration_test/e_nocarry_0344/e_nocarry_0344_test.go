...
var benchRese_nocarry_0344 e_nocarry_0344

func BenchmarkE_nocarry_0344SetBytes(b *testing.B) {
	var x e_nocarry_0344
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0344MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0344.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0344)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0344)
		}
	})
}

func BenchmarkE_nocarry_0344Inverse(b *testing.B) {
	var x e_nocarry_0344
	x.SetRandom()
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0344Butterfly(b *testing.B) {
	var x e_nocarry_0344
	x.SetRandom()
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0344)
	}
}

func BenchmarkE_nocarry_0344Exp(b *testing.B) {
	var x e_nocarry_0344
	x.SetRandom()
	benchRese_nocarry_0344.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0344Double(b *testing.B) {
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Double(&benchRese_nocarry_0344)
	}
}

func BenchmarkE_nocarry_0344Add(b *testing.B) {
	var x e_nocarry_0344
	x.SetRandom()
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Add(&x, &benchRese_nocarry_0344)
	}
}

func BenchmarkE_nocarry_0344Sub(b *testing.B) {
	var x e_nocarry_0344
	x.SetRandom()
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Sub(&x, &benchRese_nocarry_0344)
	}
}

func BenchmarkE_nocarry_0344Neg(b *testing.B) {
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Neg(&benchRese_nocarry_0344)
	}
}

func BenchmarkE_nocarry_0344Div(b *testing.B) {
	var x e_nocarry_0344
	x.SetRandom()
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Div(&x, &benchRese_nocarry_0344)
	}
}

func BenchmarkE_nocarry_0344FromMont(b *testing.B) {
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.FromMont()
	}
}

func BenchmarkE_nocarry_0344ToMont(b *testing.B) {
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.ToMont()
	}
}
func BenchmarkE_nocarry_0344Square(b *testing.B) {
	benchRese_nocarry_0344.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Square(&benchRese_nocarry_0344)
	}
}

func BenchmarkE_nocarry_0344Sqrt(b *testing.B) {
	var a e_nocarry_0344
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0344Mul(b *testing.B) {
	x := e_nocarry_0344{
	...
	benchRese_nocarry_0344.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Mul(&benchRese_nocarry_0344, &x)
	}
}

func BenchmarkE_nocarry_0344Cmp(b *testing.B) {
	x := e_nocarry_0344{
		16771818722298863227,
		13173410145949130150,
		7241707900629613214,
	...
	benchRese_nocarry_0344 = x
	benchRese_nocarry_0344[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0344.Cmp(&x)
	}
}

func TestE_nocarry_0344Cmp(t *testing.T) {
	var x, y e_nocarry_0344
...
func TestE_nocarry_0344IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0344
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0344

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0344{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0344
	one.SetOne()
	e.Sub(&qe_nocarry_0344, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0344{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0344{0, uint64(i)})
	}
...
func TestE_nocarry_0344NegZero(t *testing.T) {
	var a, b e_nocarry_0344
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0344Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0344, len(staticTestValues))
...
func TestE_nocarry_0344Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0344) bool {
			var b e_nocarry_0344
...
func TestE_nocarry_0344InverseExp(t *testing.T) {
...
func TestE_nocarry_0344MulByConstants(t *testing.T) {
...
func TestE_nocarry_0344Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0344) bool {
...
func TestE_nocarry_0344LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0344Halve(t *testing.T) {
...
func TestE_nocarry_0344FromMont(t *testing.T) {
...
type testPaire_nocarry_0344 struct {
	element e_nocarry_0344
	bigint  big.Int
}

func (z *e_nocarry_0344) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0344[5] {
		return true
	}
	if z[5] < qe_nocarry_0344[5] {
		return false
	...
	return z[0] >= qe_nocarry_0344[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0344

		g.element = e_nocarry_0344{
		...
		if qe_nocarry_0344[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0344[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0344 {
			var g e_nocarry_0344
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0344[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0344[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0344[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0344[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0344[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0344[5], carry)
...
func Benchmarke_nocarry_0344InverseNew(b *testing.B) {
	var x e_nocarry_0344
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0344
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0344
		var xInv e_nocarry_0344
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0344
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0344
...
func testLinearComb(t *testing.T, x *e_nocarry_0344, xC int64, y *e_nocarry_0344, yC int64) {
	...
	var z e_nocarry_0344
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0344, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0344
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0344, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0344
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0344, xHi uint64) {
	var res e_nocarry_0344
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0344) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0344) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0344, c int64, result *e_nocarry_0344, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0344) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0344) uint64 {
