...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x25a8e6528244388f, R14
	ADDQ R14, AX
	MOVQ $0xa5f4068bba02d78c, R14
	ADCQ R14, DX
	MOVQ $0xa252ef6f3f072895, R14
	ADCQ R14, CX
	MOVQ $0xa9cc428dbf3809c3, R14
	ADCQ R14, BX
	MOVQ $0x04db858bcb93afd0, R14
	ADCQ R14, SI
	MOVQ $0x0e18400b658b8b98, R14
	ADCQ R14, DI
	MOVQ $0xbc1e9e31df27d258, R14
	ADCQ R14, R8
	MOVQ $0xfd38de15e383015f, R14
	ADCQ R14, R9
	MOVQ $0xc2973fe3d422374d, R14
	ADCQ R14, R10
	MOVQ $0xada982341ce1b8c0, R14
	ADCQ R14, R11
	MOVQ $0x00000000cce20d59, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x25a8e6528244388f, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xa5f4068bba02d78c, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xa252ef6f3f072895, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xa9cc428dbf3809c3, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x04db858bcb93afd0, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x0e18400b658b8b98, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xbc1e9e31df27d258, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xfd38de15e383015f, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xc2973fe3d422374d, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xada982341ce1b8c0, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000cce20d59, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x25a8e6528244388f, AX
	ADDQ AX, DX
	MOVQ $0xa5f4068bba02d78c, AX
	ADCQ AX, CX
	MOVQ $0xa252ef6f3f072895, AX
	ADCQ AX, BX
	MOVQ $0xa9cc428dbf3809c3, AX
	ADCQ AX, SI
	MOVQ $0x04db858bcb93afd0, AX
	ADCQ AX, DI
	MOVQ $0x0e18400b658b8b98, AX
	ADCQ AX, R8
	MOVQ $0xbc1e9e31df27d258, AX
	ADCQ AX, R9
	MOVQ $0xfd38de15e383015f, AX
	ADCQ AX, R10
	MOVQ $0xc2973fe3d422374d, AX
	ADCQ AX, R11
	MOVQ $0xada982341ce1b8c0, AX
	ADCQ AX, R12
	MOVQ $0x00000000cce20d59, AX
	ADCQ AX, R13
