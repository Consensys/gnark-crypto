...
var benchRese_nocarry_0672 e_nocarry_0672

func BenchmarkE_nocarry_0672SetBytes(b *testing.B) {
	var x e_nocarry_0672
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0672MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0672.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0672)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0672)
		}
	})
}

func BenchmarkE_nocarry_0672Inverse(b *testing.B) {
	var x e_nocarry_0672
	x.SetRandom()
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0672Butterfly(b *testing.B) {
	var x e_nocarry_0672
	x.SetRandom()
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0672)
	}
}

func BenchmarkE_nocarry_0672Exp(b *testing.B) {
	var x e_nocarry_0672
	x.SetRandom()
	benchRese_nocarry_0672.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0672Double(b *testing.B) {
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Double(&benchRese_nocarry_0672)
	}
}

func BenchmarkE_nocarry_0672Add(b *testing.B) {
	var x e_nocarry_0672
	x.SetRandom()
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Add(&x, &benchRese_nocarry_0672)
	}
}

func BenchmarkE_nocarry_0672Sub(b *testing.B) {
	var x e_nocarry_0672
	x.SetRandom()
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Sub(&x, &benchRese_nocarry_0672)
	}
}

func BenchmarkE_nocarry_0672Neg(b *testing.B) {
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Neg(&benchRese_nocarry_0672)
	}
}

func BenchmarkE_nocarry_0672Div(b *testing.B) {
	var x e_nocarry_0672
	x.SetRandom()
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Div(&x, &benchRese_nocarry_0672)
	}
}

func BenchmarkE_nocarry_0672FromMont(b *testing.B) {
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.FromMont()
	}
}

func BenchmarkE_nocarry_0672ToMont(b *testing.B) {
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.ToMont()
	}
}
func BenchmarkE_nocarry_0672Square(b *testing.B) {
	benchRese_nocarry_0672.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Square(&benchRese_nocarry_0672)
	}
}

func BenchmarkE_nocarry_0672Sqrt(b *testing.B) {
	var a e_nocarry_0672
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0672Mul(b *testing.B) {
	x := e_nocarry_0672{
	...
	benchRese_nocarry_0672.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Mul(&benchRese_nocarry_0672, &x)
	}
}

func BenchmarkE_nocarry_0672Cmp(b *testing.B) {
	x := e_nocarry_0672{
		17666334928328098651,
		3580027475812295254,
		15752211556740704396,
	...
	benchRese_nocarry_0672 = x
	benchRese_nocarry_0672[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0672.Cmp(&x)
	}
}

func TestE_nocarry_0672Cmp(t *testing.T) {
	var x, y e_nocarry_0672
...
func TestE_nocarry_0672IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0672
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0672

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0672{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0672
	one.SetOne()
	e.Sub(&qe_nocarry_0672, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0672{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0672{0, uint64(i)})
	}
...
func TestE_nocarry_0672NegZero(t *testing.T) {
	var a, b e_nocarry_0672
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0672Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0672, len(staticTestValues))
...
func TestE_nocarry_0672Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0672) bool {
			var b e_nocarry_0672
...
func TestE_nocarry_0672InverseExp(t *testing.T) {
...
func TestE_nocarry_0672MulByConstants(t *testing.T) {
...
func TestE_nocarry_0672Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0672) bool {
...
func TestE_nocarry_0672LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0672Halve(t *testing.T) {
...
func TestE_nocarry_0672FromMont(t *testing.T) {
...
type testPaire_nocarry_0672 struct {
	element e_nocarry_0672
	bigint  big.Int
}

func (z *e_nocarry_0672) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0672[10] {
		return true
	}
	if z[10] < qe_nocarry_0672[10] {
		return false
	...
	return z[0] >= qe_nocarry_0672[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0672

		g.element = e_nocarry_0672{
		...
		if qe_nocarry_0672[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0672[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0672 {
			var g e_nocarry_0672
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0672[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0672[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0672[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0672[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0672[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0672[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0672[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0672[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0672[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0672[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0672[10], carry)
...
func Benchmarke_nocarry_0672InverseNew(b *testing.B) {
	var x e_nocarry_0672
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0672
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0672
		var xInv e_nocarry_0672
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0672
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0672
...
func testLinearComb(t *testing.T, x *e_nocarry_0672, xC int64, y *e_nocarry_0672, yC int64) {
	...
	var z e_nocarry_0672
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0672, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0672
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0672, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0672
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0672, xHi uint64) {
	var res e_nocarry_0672
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0672) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0672) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0672, c int64, result *e_nocarry_0672, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0672) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0672) uint64 {
