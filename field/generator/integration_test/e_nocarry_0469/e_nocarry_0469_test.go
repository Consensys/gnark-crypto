...
var benchRese_nocarry_0469 e_nocarry_0469

func BenchmarkE_nocarry_0469SetBytes(b *testing.B) {
	var x e_nocarry_0469
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0469MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0469.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0469)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0469)
		}
	})
}

func BenchmarkE_nocarry_0469Inverse(b *testing.B) {
	var x e_nocarry_0469
	x.SetRandom()
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0469Butterfly(b *testing.B) {
	var x e_nocarry_0469
	x.SetRandom()
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0469)
	}
}

func BenchmarkE_nocarry_0469Exp(b *testing.B) {
	var x e_nocarry_0469
	x.SetRandom()
	benchRese_nocarry_0469.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0469Double(b *testing.B) {
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Double(&benchRese_nocarry_0469)
	}
}

func BenchmarkE_nocarry_0469Add(b *testing.B) {
	var x e_nocarry_0469
	x.SetRandom()
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Add(&x, &benchRese_nocarry_0469)
	}
}

func BenchmarkE_nocarry_0469Sub(b *testing.B) {
	var x e_nocarry_0469
	x.SetRandom()
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Sub(&x, &benchRese_nocarry_0469)
	}
}

func BenchmarkE_nocarry_0469Neg(b *testing.B) {
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Neg(&benchRese_nocarry_0469)
	}
}

func BenchmarkE_nocarry_0469Div(b *testing.B) {
	var x e_nocarry_0469
	x.SetRandom()
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Div(&x, &benchRese_nocarry_0469)
	}
}

func BenchmarkE_nocarry_0469FromMont(b *testing.B) {
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.FromMont()
	}
}

func BenchmarkE_nocarry_0469ToMont(b *testing.B) {
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.ToMont()
	}
}
func BenchmarkE_nocarry_0469Square(b *testing.B) {
	benchRese_nocarry_0469.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Square(&benchRese_nocarry_0469)
	}
}

func BenchmarkE_nocarry_0469Sqrt(b *testing.B) {
	var a e_nocarry_0469
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0469Mul(b *testing.B) {
	x := e_nocarry_0469{
	...
	benchRese_nocarry_0469.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Mul(&benchRese_nocarry_0469, &x)
	}
}

func BenchmarkE_nocarry_0469Cmp(b *testing.B) {
	x := e_nocarry_0469{
		18114251006094874984,
		11891265554888474088,
		1977285457119365556,
	...
	benchRese_nocarry_0469 = x
	benchRese_nocarry_0469[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0469.Cmp(&x)
	}
}

func TestE_nocarry_0469Cmp(t *testing.T) {
	var x, y e_nocarry_0469
...
func TestE_nocarry_0469IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0469
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0469

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0469{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0469
	one.SetOne()
	e.Sub(&qe_nocarry_0469, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0469{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0469{0, uint64(i)})
	}
...
func TestE_nocarry_0469NegZero(t *testing.T) {
	var a, b e_nocarry_0469
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0469Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0469, len(staticTestValues))
...
func TestE_nocarry_0469Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0469) bool {
			var b e_nocarry_0469
...
func TestE_nocarry_0469InverseExp(t *testing.T) {
...
func TestE_nocarry_0469MulByConstants(t *testing.T) {
...
func TestE_nocarry_0469Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0469) bool {
...
func TestE_nocarry_0469LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0469Halve(t *testing.T) {
...
func TestE_nocarry_0469FromMont(t *testing.T) {
...
type testPaire_nocarry_0469 struct {
	element e_nocarry_0469
	bigint  big.Int
}

func (z *e_nocarry_0469) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0469[7] {
		return true
	}
	if z[7] < qe_nocarry_0469[7] {
		return false
	...
	return z[0] >= qe_nocarry_0469[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0469

		g.element = e_nocarry_0469{
		...
		if qe_nocarry_0469[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0469[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0469 {
			var g e_nocarry_0469
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0469[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0469[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0469[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0469[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0469[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0469[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0469[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0469[7], carry)
...
func Benchmarke_nocarry_0469InverseNew(b *testing.B) {
	var x e_nocarry_0469
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0469
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0469
		var xInv e_nocarry_0469
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0469
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0469
...
func testLinearComb(t *testing.T, x *e_nocarry_0469, xC int64, y *e_nocarry_0469, yC int64) {
	...
	var z e_nocarry_0469
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0469, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0469
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0469, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0469
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0469, xHi uint64) {
	var res e_nocarry_0469
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0469) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0469) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0469, c int64, result *e_nocarry_0469, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0469) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0469) uint64 {
