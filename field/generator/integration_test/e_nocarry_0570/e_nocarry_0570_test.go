...
var benchRese_nocarry_0570 e_nocarry_0570

func BenchmarkE_nocarry_0570SetBytes(b *testing.B) {
	var x e_nocarry_0570
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0570MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0570.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0570)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0570)
		}
	})
}

func BenchmarkE_nocarry_0570Inverse(b *testing.B) {
	var x e_nocarry_0570
	x.SetRandom()
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0570Butterfly(b *testing.B) {
	var x e_nocarry_0570
	x.SetRandom()
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0570)
	}
}

func BenchmarkE_nocarry_0570Exp(b *testing.B) {
	var x e_nocarry_0570
	x.SetRandom()
	benchRese_nocarry_0570.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0570Double(b *testing.B) {
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Double(&benchRese_nocarry_0570)
	}
}

func BenchmarkE_nocarry_0570Add(b *testing.B) {
	var x e_nocarry_0570
	x.SetRandom()
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Add(&x, &benchRese_nocarry_0570)
	}
}

func BenchmarkE_nocarry_0570Sub(b *testing.B) {
	var x e_nocarry_0570
	x.SetRandom()
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Sub(&x, &benchRese_nocarry_0570)
	}
}

func BenchmarkE_nocarry_0570Neg(b *testing.B) {
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Neg(&benchRese_nocarry_0570)
	}
}

func BenchmarkE_nocarry_0570Div(b *testing.B) {
	var x e_nocarry_0570
	x.SetRandom()
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Div(&x, &benchRese_nocarry_0570)
	}
}

func BenchmarkE_nocarry_0570FromMont(b *testing.B) {
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.FromMont()
	}
}

func BenchmarkE_nocarry_0570ToMont(b *testing.B) {
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.ToMont()
	}
}
func BenchmarkE_nocarry_0570Square(b *testing.B) {
	benchRese_nocarry_0570.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Square(&benchRese_nocarry_0570)
	}
}

func BenchmarkE_nocarry_0570Sqrt(b *testing.B) {
	var a e_nocarry_0570
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0570Mul(b *testing.B) {
	x := e_nocarry_0570{
	...
	benchRese_nocarry_0570.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Mul(&benchRese_nocarry_0570, &x)
	}
}

func BenchmarkE_nocarry_0570Cmp(b *testing.B) {
	x := e_nocarry_0570{
		17882969869017463639,
		10524411472169524000,
		9073741939009581065,
	...
	benchRese_nocarry_0570 = x
	benchRese_nocarry_0570[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0570.Cmp(&x)
	}
}

func TestE_nocarry_0570Cmp(t *testing.T) {
	var x, y e_nocarry_0570
...
func TestE_nocarry_0570IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0570
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0570

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0570{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0570
	one.SetOne()
	e.Sub(&qe_nocarry_0570, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0570{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0570{0, uint64(i)})
	}
...
func TestE_nocarry_0570NegZero(t *testing.T) {
	var a, b e_nocarry_0570
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0570Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0570, len(staticTestValues))
...
func TestE_nocarry_0570Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0570) bool {
			var b e_nocarry_0570
...
func TestE_nocarry_0570InverseExp(t *testing.T) {
...
func TestE_nocarry_0570MulByConstants(t *testing.T) {
...
func TestE_nocarry_0570Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0570) bool {
...
func TestE_nocarry_0570LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0570Halve(t *testing.T) {
...
func TestE_nocarry_0570FromMont(t *testing.T) {
...
type testPaire_nocarry_0570 struct {
	element e_nocarry_0570
	bigint  big.Int
}

func (z *e_nocarry_0570) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0570[8] {
		return true
	}
	if z[8] < qe_nocarry_0570[8] {
		return false
	...
	return z[0] >= qe_nocarry_0570[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0570

		g.element = e_nocarry_0570{
		...
		if qe_nocarry_0570[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0570[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0570 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0570[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0570[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0570[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0570[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0570[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0570[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0570[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0570[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0570[8], carry)
...
func Benchmarke_nocarry_0570InverseNew(b *testing.B) {
	var x e_nocarry_0570
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0570
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0570
		var xInv e_nocarry_0570
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0570
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0570
...
func testLinearComb(t *testing.T, x *e_nocarry_0570, xC int64, y *e_nocarry_0570, yC int64) {
	...
	var z e_nocarry_0570
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0570, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0570
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0570, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0570
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0570, xHi uint64) {
	var res e_nocarry_0570
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0570) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0570) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0570, c int64, result *e_nocarry_0570, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0570) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0570) uint64 {
