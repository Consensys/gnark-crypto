...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x29630e4cc662c191, R12
	ADDQ R12, AX
	MOVQ $0xe2569d35c072259f, R12
	ADCQ R12, DX
	MOVQ $0xf0ad345d8d44136b, R12
	ADCQ R12, CX
	MOVQ $0xf22225814ab8dd72, R12
	ADCQ R12, BX
	MOVQ $0xe5875348aebe13a4, R12
	ADCQ R12, SI
	MOVQ $0x1481eaa20590dbdb, R12
	ADCQ R12, DI
	MOVQ $0x3f8b0373ba90fb29, R12
	ADCQ R12, R8
	MOVQ $0x1aadc0727b669c36, R12
	ADCQ R12, R9
	MOVQ $0x03548d86a2973145, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x29630e4cc662c191, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xe2569d35c072259f, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xf0ad345d8d44136b, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xf22225814ab8dd72, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xe5875348aebe13a4, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x1481eaa20590dbdb, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x3f8b0373ba90fb29, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x1aadc0727b669c36, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x03548d86a2973145, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x29630e4cc662c191, AX
	ADDQ AX, DX
	MOVQ $0xe2569d35c072259f, AX
	ADCQ AX, CX
	MOVQ $0xf0ad345d8d44136b, AX
	ADCQ AX, BX
	MOVQ $0xf22225814ab8dd72, AX
	ADCQ AX, SI
	MOVQ $0xe5875348aebe13a4, AX
	ADCQ AX, DI
	MOVQ $0x1481eaa20590dbdb, AX
	ADCQ AX, R8
	MOVQ $0x3f8b0373ba90fb29, AX
	ADCQ AX, R9
	MOVQ $0x1aadc0727b669c36, AX
	ADCQ AX, R10
	MOVQ $0x03548d86a2973145, AX
	ADCQ AX, R11
