...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xa0ffc5638df00f07, R13
	ADDQ R13, AX
	MOVQ $0x75873cb80fa74c21, R13
	ADCQ R13, DX
	MOVQ $0xfef0e5905a364ddd, R13
	ADCQ R13, CX
	MOVQ $0x4dd4c4b4babcfdec, R13
	ADCQ R13, BX
	MOVQ $0xf731d1a94b7f4ed2, R13
	ADCQ R13, SI
	MOVQ $0x605440dba44f55d3, R13
	ADCQ R13, DI
	MOVQ $0x84d5dc5ecebb66f2, R13
	ADCQ R13, R8
	MOVQ $0x0eca3abff16a6607, R13
	ADCQ R13, R9
	MOVQ $0xb7eaf551cee7eb80, R13
	ADCQ R13, R10
	MOVQ $0x000079f1ddd73dd5, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xa0ffc5638df00f07, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x75873cb80fa74c21, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xfef0e5905a364ddd, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x4dd4c4b4babcfdec, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xf731d1a94b7f4ed2, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x605440dba44f55d3, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x84d5dc5ecebb66f2, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x0eca3abff16a6607, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xb7eaf551cee7eb80, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000079f1ddd73dd5, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xa0ffc5638df00f07, AX
	ADDQ AX, DX
	MOVQ $0x75873cb80fa74c21, AX
	ADCQ AX, CX
	MOVQ $0xfef0e5905a364ddd, AX
	ADCQ AX, BX
	MOVQ $0x4dd4c4b4babcfdec, AX
	ADCQ AX, SI
	MOVQ $0xf731d1a94b7f4ed2, AX
	ADCQ AX, DI
	MOVQ $0x605440dba44f55d3, AX
	ADCQ AX, R8
	MOVQ $0x84d5dc5ecebb66f2, AX
	ADCQ AX, R9
	MOVQ $0x0eca3abff16a6607, AX
	ADCQ AX, R10
	MOVQ $0xb7eaf551cee7eb80, AX
	ADCQ AX, R11
	MOVQ $0x000079f1ddd73dd5, AX
	ADCQ AX, R12
