...
var benchRese_nocarry_0623 e_nocarry_0623

func BenchmarkE_nocarry_0623SetBytes(b *testing.B) {
	var x e_nocarry_0623
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0623MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0623.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0623)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0623)
		}
	})
}

func BenchmarkE_nocarry_0623Inverse(b *testing.B) {
	var x e_nocarry_0623
	x.SetRandom()
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0623Butterfly(b *testing.B) {
	var x e_nocarry_0623
	x.SetRandom()
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0623)
	}
}

func BenchmarkE_nocarry_0623Exp(b *testing.B) {
	var x e_nocarry_0623
	x.SetRandom()
	benchRese_nocarry_0623.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0623Double(b *testing.B) {
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Double(&benchRese_nocarry_0623)
	}
}

func BenchmarkE_nocarry_0623Add(b *testing.B) {
	var x e_nocarry_0623
	x.SetRandom()
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Add(&x, &benchRese_nocarry_0623)
	}
}

func BenchmarkE_nocarry_0623Sub(b *testing.B) {
	var x e_nocarry_0623
	x.SetRandom()
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Sub(&x, &benchRese_nocarry_0623)
	}
}

func BenchmarkE_nocarry_0623Neg(b *testing.B) {
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Neg(&benchRese_nocarry_0623)
	}
}

func BenchmarkE_nocarry_0623Div(b *testing.B) {
	var x e_nocarry_0623
	x.SetRandom()
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Div(&x, &benchRese_nocarry_0623)
	}
}

func BenchmarkE_nocarry_0623FromMont(b *testing.B) {
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.FromMont()
	}
}

func BenchmarkE_nocarry_0623ToMont(b *testing.B) {
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.ToMont()
	}
}
func BenchmarkE_nocarry_0623Square(b *testing.B) {
	benchRese_nocarry_0623.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Square(&benchRese_nocarry_0623)
	}
}

func BenchmarkE_nocarry_0623Sqrt(b *testing.B) {
	var a e_nocarry_0623
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0623Mul(b *testing.B) {
	x := e_nocarry_0623{
		4977083808087085362,
	...
	benchRese_nocarry_0623.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Mul(&benchRese_nocarry_0623, &x)
	}
}

func BenchmarkE_nocarry_0623Cmp(b *testing.B) {
	x := e_nocarry_0623{
		4977083808087085362,
		15783956361706769564,
		18095381577680275553,
	...
	benchRese_nocarry_0623 = x
	benchRese_nocarry_0623[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0623.Cmp(&x)
	}
}

func TestE_nocarry_0623Cmp(t *testing.T) {
	var x, y e_nocarry_0623
...
func TestE_nocarry_0623IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0623
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0623

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0623{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0623
	one.SetOne()
	e.Sub(&qe_nocarry_0623, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0623{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0623{0, uint64(i)})
	}
...
func TestE_nocarry_0623NegZero(t *testing.T) {
	var a, b e_nocarry_0623
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0623Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0623, len(staticTestValues))
...
func TestE_nocarry_0623Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0623) bool {
			var b e_nocarry_0623
...
func TestE_nocarry_0623InverseExp(t *testing.T) {
...
func TestE_nocarry_0623MulByConstants(t *testing.T) {
...
func TestE_nocarry_0623Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0623) bool {
...
func TestE_nocarry_0623LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0623Halve(t *testing.T) {
...
func TestE_nocarry_0623FromMont(t *testing.T) {
...
type testPaire_nocarry_0623 struct {
	element e_nocarry_0623
	bigint  big.Int
}

func (z *e_nocarry_0623) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0623[9] {
		return true
	}
	if z[9] < qe_nocarry_0623[9] {
		return false
	...
	return z[0] >= qe_nocarry_0623[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0623

		g.element = e_nocarry_0623{
		...
		if qe_nocarry_0623[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0623[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0623 {
			var g e_nocarry_0623
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0623[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0623[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0623[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0623[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0623[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0623[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0623[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0623[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0623[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0623[9], carry)
...
func Benchmarke_nocarry_0623InverseNew(b *testing.B) {
	var x e_nocarry_0623
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0623
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0623
		var xInv e_nocarry_0623
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0623
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0623
...
func testLinearComb(t *testing.T, x *e_nocarry_0623, xC int64, y *e_nocarry_0623, yC int64) {
	...
	var z e_nocarry_0623
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0623, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0623
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0623, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0623
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0623, xHi uint64) {
	var res e_nocarry_0623
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0623) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0623) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0623, c int64, result *e_nocarry_0623, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0623) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0623) uint64 {
