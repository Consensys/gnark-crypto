...
var benchRese_nocarry_0271 e_nocarry_0271

func BenchmarkE_nocarry_0271SetBytes(b *testing.B) {
	var x e_nocarry_0271
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0271MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0271.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0271)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0271)
		}
	})
}

func BenchmarkE_nocarry_0271Inverse(b *testing.B) {
	var x e_nocarry_0271
	x.SetRandom()
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0271Butterfly(b *testing.B) {
	var x e_nocarry_0271
	x.SetRandom()
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0271)
	}
}

func BenchmarkE_nocarry_0271Exp(b *testing.B) {
	var x e_nocarry_0271
	x.SetRandom()
	benchRese_nocarry_0271.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0271Double(b *testing.B) {
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Double(&benchRese_nocarry_0271)
	}
}

func BenchmarkE_nocarry_0271Add(b *testing.B) {
	var x e_nocarry_0271
	x.SetRandom()
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Add(&x, &benchRese_nocarry_0271)
	}
}

func BenchmarkE_nocarry_0271Sub(b *testing.B) {
	var x e_nocarry_0271
	x.SetRandom()
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Sub(&x, &benchRese_nocarry_0271)
	}
}

func BenchmarkE_nocarry_0271Neg(b *testing.B) {
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Neg(&benchRese_nocarry_0271)
	}
}

func BenchmarkE_nocarry_0271Div(b *testing.B) {
	var x e_nocarry_0271
	x.SetRandom()
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Div(&x, &benchRese_nocarry_0271)
	}
}

func BenchmarkE_nocarry_0271FromMont(b *testing.B) {
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.FromMont()
	}
}

func BenchmarkE_nocarry_0271ToMont(b *testing.B) {
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.ToMont()
	}
}
func BenchmarkE_nocarry_0271Square(b *testing.B) {
	benchRese_nocarry_0271.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Square(&benchRese_nocarry_0271)
	}
}

func BenchmarkE_nocarry_0271Sqrt(b *testing.B) {
	var a e_nocarry_0271
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0271Mul(b *testing.B) {
	x := e_nocarry_0271{
		8297591059942352409,
		5874963834169749944,
		3356821476474686870,
	...
	benchRese_nocarry_0271.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Mul(&benchRese_nocarry_0271, &x)
	}
}

func BenchmarkE_nocarry_0271Cmp(b *testing.B) {
	x := e_nocarry_0271{
		8297591059942352409,
		5874963834169749944,
		3356821476474686870,
	...
	benchRese_nocarry_0271 = x
	benchRese_nocarry_0271[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0271.Cmp(&x)
	}
}

func TestE_nocarry_0271Cmp(t *testing.T) {
	var x, y e_nocarry_0271
...
func TestE_nocarry_0271IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0271
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0271

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0271{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0271
	one.SetOne()
	e.Sub(&qe_nocarry_0271, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0271{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0271{0, uint64(i)})
	}
...
func TestE_nocarry_0271NegZero(t *testing.T) {
	var a, b e_nocarry_0271
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0271Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0271, len(staticTestValues))
...
func TestE_nocarry_0271Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0271) bool {
			var b e_nocarry_0271
...
func TestE_nocarry_0271InverseExp(t *testing.T) {
...
func TestE_nocarry_0271MulByConstants(t *testing.T) {
...
func TestE_nocarry_0271Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0271) bool {
...
func TestE_nocarry_0271LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0271Halve(t *testing.T) {
...
func TestE_nocarry_0271FromMont(t *testing.T) {
...
type testPaire_nocarry_0271 struct {
	element e_nocarry_0271
	bigint  big.Int
}

func (z *e_nocarry_0271) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0271[4] {
		return true
	}
	if z[4] < qe_nocarry_0271[4] {
		return false
	...
	return z[0] >= qe_nocarry_0271[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0271

		g.element = e_nocarry_0271{
		...
		if qe_nocarry_0271[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0271[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0271 {
			var g e_nocarry_0271
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0271[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0271[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0271[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0271[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0271[4], carry)
...
func Benchmarke_nocarry_0271InverseNew(b *testing.B) {
	var x e_nocarry_0271
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0271
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0271
		var xInv e_nocarry_0271
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0271
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0271
...
func testLinearComb(t *testing.T, x *e_nocarry_0271, xC int64, y *e_nocarry_0271, yC int64) {
	...
	var z e_nocarry_0271
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0271, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0271
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0271, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0271
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0271, xHi uint64) {
	var res e_nocarry_0271
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0271) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0271) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0271, c int64, result *e_nocarry_0271, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0271) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0271) uint64 {
