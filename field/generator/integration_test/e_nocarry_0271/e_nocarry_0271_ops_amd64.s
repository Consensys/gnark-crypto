...
// modulus q
DATA q<>+0(SB)/8, $0x1156b07f83161cc7
DATA q<>+8(SB)/8, $0x0b91172c9a500047
DATA q<>+16(SB)/8, $0x017f267f6242b518
DATA q<>+24(SB)/8, $0x174391b3674901c7
DATA q<>+32(SB)/8, $0x0000000000006722
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xf9eb262c67501b09
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x1156b07f83161cc7, R9
	MOVQ    $0x0b91172c9a500047, R10
	MOVQ    $0x017f267f6242b518, R11
	MOVQ    $0x174391b3674901c7, R12
	MOVQ    $0x0000000000006722, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x0b91172c9a500047, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x017f267f6242b518, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x174391b3674901c7, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000006722, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x1156b07f83161cc7, CX
	MOVQ    $0x0b91172c9a500047, BX
	MOVQ    $0x017f267f6242b518, SI
	MOVQ    $0x174391b3674901c7, DI
	MOVQ    $0x0000000000006722, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
