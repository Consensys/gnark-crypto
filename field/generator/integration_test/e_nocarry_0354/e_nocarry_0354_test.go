...
var benchRese_nocarry_0354 e_nocarry_0354

func BenchmarkE_nocarry_0354SetBytes(b *testing.B) {
	var x e_nocarry_0354
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0354MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0354.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0354)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0354)
		}
	})
}

func BenchmarkE_nocarry_0354Inverse(b *testing.B) {
	var x e_nocarry_0354
	x.SetRandom()
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0354Butterfly(b *testing.B) {
	var x e_nocarry_0354
	x.SetRandom()
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0354)
	}
}

func BenchmarkE_nocarry_0354Exp(b *testing.B) {
	var x e_nocarry_0354
	x.SetRandom()
	benchRese_nocarry_0354.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0354Double(b *testing.B) {
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Double(&benchRese_nocarry_0354)
	}
}

func BenchmarkE_nocarry_0354Add(b *testing.B) {
	var x e_nocarry_0354
	x.SetRandom()
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Add(&x, &benchRese_nocarry_0354)
	}
}

func BenchmarkE_nocarry_0354Sub(b *testing.B) {
	var x e_nocarry_0354
	x.SetRandom()
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Sub(&x, &benchRese_nocarry_0354)
	}
}

func BenchmarkE_nocarry_0354Neg(b *testing.B) {
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Neg(&benchRese_nocarry_0354)
	}
}

func BenchmarkE_nocarry_0354Div(b *testing.B) {
	var x e_nocarry_0354
	x.SetRandom()
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Div(&x, &benchRese_nocarry_0354)
	}
}

func BenchmarkE_nocarry_0354FromMont(b *testing.B) {
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.FromMont()
	}
}

func BenchmarkE_nocarry_0354ToMont(b *testing.B) {
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.ToMont()
	}
}
func BenchmarkE_nocarry_0354Square(b *testing.B) {
	benchRese_nocarry_0354.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Square(&benchRese_nocarry_0354)
	}
}

func BenchmarkE_nocarry_0354Sqrt(b *testing.B) {
	var a e_nocarry_0354
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0354Mul(b *testing.B) {
	x := e_nocarry_0354{
	...
	benchRese_nocarry_0354.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Mul(&benchRese_nocarry_0354, &x)
	}
}

func BenchmarkE_nocarry_0354Cmp(b *testing.B) {
	x := e_nocarry_0354{
		15413568705676605893,
		59111532329059355,
		4611345836749682855,
	...
	benchRese_nocarry_0354 = x
	benchRese_nocarry_0354[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0354.Cmp(&x)
	}
}

func TestE_nocarry_0354Cmp(t *testing.T) {
	var x, y e_nocarry_0354
...
func TestE_nocarry_0354IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0354
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0354

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0354{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0354
	one.SetOne()
	e.Sub(&qe_nocarry_0354, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0354{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0354{0, uint64(i)})
	}
...
func TestE_nocarry_0354NegZero(t *testing.T) {
	var a, b e_nocarry_0354
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0354Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0354, len(staticTestValues))
...
func TestE_nocarry_0354Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0354) bool {
			var b e_nocarry_0354
...
func TestE_nocarry_0354InverseExp(t *testing.T) {
...
func TestE_nocarry_0354MulByConstants(t *testing.T) {
...
func TestE_nocarry_0354Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0354) bool {
...
func TestE_nocarry_0354LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0354Halve(t *testing.T) {
...
func TestE_nocarry_0354FromMont(t *testing.T) {
...
type testPaire_nocarry_0354 struct {
	element e_nocarry_0354
	bigint  big.Int
}

func (z *e_nocarry_0354) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0354[5] {
		return true
	}
	if z[5] < qe_nocarry_0354[5] {
		return false
	...
	return z[0] >= qe_nocarry_0354[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0354

		g.element = e_nocarry_0354{
		...
		if qe_nocarry_0354[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0354[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0354 {
			var g e_nocarry_0354
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0354[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0354[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0354[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0354[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0354[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0354[5], carry)
...
func Benchmarke_nocarry_0354InverseNew(b *testing.B) {
	var x e_nocarry_0354
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0354
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0354
		var xInv e_nocarry_0354
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0354
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0354
...
func testLinearComb(t *testing.T, x *e_nocarry_0354, xC int64, y *e_nocarry_0354, yC int64) {
	...
	var z e_nocarry_0354
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0354, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0354
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0354, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0354
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0354, xHi uint64) {
	var res e_nocarry_0354
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0354) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0354) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0354, c int64, result *e_nocarry_0354, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0354) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0354) uint64 {
