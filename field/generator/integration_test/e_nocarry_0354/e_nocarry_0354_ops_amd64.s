...
// modulus q
DATA q<>+0(SB)/8, $0xcea7d1da0dc11ad7
DATA q<>+8(SB)/8, $0xe175e6dca6f61a71
DATA q<>+16(SB)/8, $0x537f88b11386324d
DATA q<>+24(SB)/8, $0xa291ee0928386f9a
DATA q<>+32(SB)/8, $0xb5680eeac0273d74
DATA q<>+40(SB)/8, $0x00000003a1f20598
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x09651a4dfa4b8719
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xcea7d1da0dc11ad7, R10
	MOVQ    $0xe175e6dca6f61a71, R11
	MOVQ    $0x537f88b11386324d, R12
	MOVQ    $0xa291ee0928386f9a, R13
	MOVQ    $0xb5680eeac0273d74, R14
	MOVQ    $0x00000003a1f20598, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xe175e6dca6f61a71, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x537f88b11386324d, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xa291ee0928386f9a, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xb5680eeac0273d74, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000003a1f20598, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xcea7d1da0dc11ad7, CX
	MOVQ    $0xe175e6dca6f61a71, BX
	MOVQ    $0x537f88b11386324d, SI
	MOVQ    $0xa291ee0928386f9a, DI
	MOVQ    $0xb5680eeac0273d74, R8
	MOVQ    $0x00000003a1f20598, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
