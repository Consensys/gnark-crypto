...
// modulus q
DATA q<>+0(SB)/8, $0xf06f26111d3de3a5
DATA q<>+8(SB)/8, $0x588365b359e29671
DATA q<>+16(SB)/8, $0xa3537ea37f7f2efc
DATA q<>+24(SB)/8, $0x488f6c88e53ec312
DATA q<>+32(SB)/8, $0x4b2c57116be5c4dd
DATA q<>+40(SB)/8, $0x0000000000653def
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xff3a737a23bdb3d3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xf06f26111d3de3a5, R10
	MOVQ    $0x588365b359e29671, R11
	MOVQ    $0xa3537ea37f7f2efc, R12
	MOVQ    $0x488f6c88e53ec312, R13
	MOVQ    $0x4b2c57116be5c4dd, R14
	MOVQ    $0x0000000000653def, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x588365b359e29671, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xa3537ea37f7f2efc, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x488f6c88e53ec312, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x4b2c57116be5c4dd, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000000653def, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xf06f26111d3de3a5, CX
	MOVQ    $0x588365b359e29671, BX
	MOVQ    $0xa3537ea37f7f2efc, SI
	MOVQ    $0x488f6c88e53ec312, DI
	MOVQ    $0x4b2c57116be5c4dd, R8
	MOVQ    $0x0000000000653def, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
