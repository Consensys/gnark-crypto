...
var benchRese_nocarry_0343 e_nocarry_0343

func BenchmarkE_nocarry_0343SetBytes(b *testing.B) {
	var x e_nocarry_0343
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0343MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0343.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0343)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0343)
		}
	})
}

func BenchmarkE_nocarry_0343Inverse(b *testing.B) {
	var x e_nocarry_0343
	x.SetRandom()
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0343Butterfly(b *testing.B) {
	var x e_nocarry_0343
	x.SetRandom()
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0343)
	}
}

func BenchmarkE_nocarry_0343Exp(b *testing.B) {
	var x e_nocarry_0343
	x.SetRandom()
	benchRese_nocarry_0343.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0343Double(b *testing.B) {
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Double(&benchRese_nocarry_0343)
	}
}

func BenchmarkE_nocarry_0343Add(b *testing.B) {
	var x e_nocarry_0343
	x.SetRandom()
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Add(&x, &benchRese_nocarry_0343)
	}
}

func BenchmarkE_nocarry_0343Sub(b *testing.B) {
	var x e_nocarry_0343
	x.SetRandom()
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Sub(&x, &benchRese_nocarry_0343)
	}
}

func BenchmarkE_nocarry_0343Neg(b *testing.B) {
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Neg(&benchRese_nocarry_0343)
	}
}

func BenchmarkE_nocarry_0343Div(b *testing.B) {
	var x e_nocarry_0343
	x.SetRandom()
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Div(&x, &benchRese_nocarry_0343)
	}
}

func BenchmarkE_nocarry_0343FromMont(b *testing.B) {
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.FromMont()
	}
}

func BenchmarkE_nocarry_0343ToMont(b *testing.B) {
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.ToMont()
	}
}
func BenchmarkE_nocarry_0343Square(b *testing.B) {
	benchRese_nocarry_0343.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Square(&benchRese_nocarry_0343)
	}
}

func BenchmarkE_nocarry_0343Sqrt(b *testing.B) {
	var a e_nocarry_0343
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0343Mul(b *testing.B) {
	x := e_nocarry_0343{
	...
	benchRese_nocarry_0343.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Mul(&benchRese_nocarry_0343, &x)
	}
}

func BenchmarkE_nocarry_0343Cmp(b *testing.B) {
	x := e_nocarry_0343{
		15874993715109569955,
		5146050635343893669,
		17681225960409799084,
	...
	benchRese_nocarry_0343 = x
	benchRese_nocarry_0343[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0343.Cmp(&x)
	}
}

func TestE_nocarry_0343Cmp(t *testing.T) {
	var x, y e_nocarry_0343
...
func TestE_nocarry_0343IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0343
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0343

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0343{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0343
	one.SetOne()
	e.Sub(&qe_nocarry_0343, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0343{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0343{0, uint64(i)})
	}
...
func TestE_nocarry_0343NegZero(t *testing.T) {
	var a, b e_nocarry_0343
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0343Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0343, len(staticTestValues))
...
func TestE_nocarry_0343Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0343) bool {
			var b e_nocarry_0343
...
func TestE_nocarry_0343InverseExp(t *testing.T) {
...
func TestE_nocarry_0343MulByConstants(t *testing.T) {
...
func TestE_nocarry_0343Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0343) bool {
...
func TestE_nocarry_0343LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0343Halve(t *testing.T) {
...
func TestE_nocarry_0343FromMont(t *testing.T) {
...
type testPaire_nocarry_0343 struct {
	element e_nocarry_0343
	bigint  big.Int
}

func (z *e_nocarry_0343) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0343[5] {
		return true
	}
	if z[5] < qe_nocarry_0343[5] {
		return false
	...
	return z[0] >= qe_nocarry_0343[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0343

		g.element = e_nocarry_0343{
		...
		if qe_nocarry_0343[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0343[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0343 {
			var g e_nocarry_0343
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0343[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0343[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0343[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0343[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0343[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0343[5], carry)
...
func Benchmarke_nocarry_0343InverseNew(b *testing.B) {
	var x e_nocarry_0343
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0343
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0343
		var xInv e_nocarry_0343
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0343
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0343
...
func testLinearComb(t *testing.T, x *e_nocarry_0343, xC int64, y *e_nocarry_0343, yC int64) {
	...
	var z e_nocarry_0343
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0343, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0343
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0343, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0343
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0343, xHi uint64) {
	var res e_nocarry_0343
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0343) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0343) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0343, c int64, result *e_nocarry_0343, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0343) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0343) uint64 {
