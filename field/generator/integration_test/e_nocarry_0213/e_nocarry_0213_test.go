...
var benchRese_nocarry_0213 e_nocarry_0213

func BenchmarkE_nocarry_0213SetBytes(b *testing.B) {
	var x e_nocarry_0213
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0213MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0213.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0213)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0213)
		}
	})
}

func BenchmarkE_nocarry_0213Inverse(b *testing.B) {
	var x e_nocarry_0213
	x.SetRandom()
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0213Butterfly(b *testing.B) {
	var x e_nocarry_0213
	x.SetRandom()
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0213)
	}
}

func BenchmarkE_nocarry_0213Exp(b *testing.B) {
	var x e_nocarry_0213
	x.SetRandom()
	benchRese_nocarry_0213.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0213Double(b *testing.B) {
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Double(&benchRese_nocarry_0213)
	}
}

func BenchmarkE_nocarry_0213Add(b *testing.B) {
	var x e_nocarry_0213
	x.SetRandom()
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Add(&x, &benchRese_nocarry_0213)
	}
}

func BenchmarkE_nocarry_0213Sub(b *testing.B) {
	var x e_nocarry_0213
	x.SetRandom()
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Sub(&x, &benchRese_nocarry_0213)
	}
}

func BenchmarkE_nocarry_0213Neg(b *testing.B) {
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Neg(&benchRese_nocarry_0213)
	}
}

func BenchmarkE_nocarry_0213Div(b *testing.B) {
	var x e_nocarry_0213
	x.SetRandom()
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Div(&x, &benchRese_nocarry_0213)
	}
}

func BenchmarkE_nocarry_0213FromMont(b *testing.B) {
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.FromMont()
	}
}

func BenchmarkE_nocarry_0213ToMont(b *testing.B) {
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.ToMont()
	}
}
func BenchmarkE_nocarry_0213Square(b *testing.B) {
	benchRese_nocarry_0213.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Square(&benchRese_nocarry_0213)
	}
}

func BenchmarkE_nocarry_0213Sqrt(b *testing.B) {
	var a e_nocarry_0213
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0213Mul(b *testing.B) {
	x := e_nocarry_0213{
	...
	benchRese_nocarry_0213.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Mul(&benchRese_nocarry_0213, &x)
	}
}

func BenchmarkE_nocarry_0213Cmp(b *testing.B) {
	x := e_nocarry_0213{
		12752217827631788660,
		11691251568041964265,
		17796941740688080078,
	...
	benchRese_nocarry_0213 = x
	benchRese_nocarry_0213[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0213.Cmp(&x)
	}
}

func TestE_nocarry_0213Cmp(t *testing.T) {
	var x, y e_nocarry_0213
...
func TestE_nocarry_0213IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0213
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0213

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0213{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0213
	one.SetOne()
	e.Sub(&qe_nocarry_0213, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0213{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0213{0, uint64(i)})
	}
...
func TestE_nocarry_0213NegZero(t *testing.T) {
	var a, b e_nocarry_0213
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0213Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0213, len(staticTestValues))
...
func TestE_nocarry_0213Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0213) bool {
			var b e_nocarry_0213
...
func TestE_nocarry_0213InverseExp(t *testing.T) {
...
func TestE_nocarry_0213MulByConstants(t *testing.T) {
...
func TestE_nocarry_0213Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0213) bool {
...
func TestE_nocarry_0213LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0213Halve(t *testing.T) {
...
func TestE_nocarry_0213FromMont(t *testing.T) {
...
type testPaire_nocarry_0213 struct {
	element e_nocarry_0213
	bigint  big.Int
}

func (z *e_nocarry_0213) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0213[3] {
		return true
	}
	if z[3] < qe_nocarry_0213[3] {
		return false
	...
	return z[0] >= qe_nocarry_0213[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0213

		g.element = e_nocarry_0213{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0213[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0213[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0213 {
			var g e_nocarry_0213
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0213[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0213[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0213[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0213[3], carry)
...
func Benchmarke_nocarry_0213InverseNew(b *testing.B) {
	var x e_nocarry_0213
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0213
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0213
		var xInv e_nocarry_0213
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0213
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0213
...
func testLinearComb(t *testing.T, x *e_nocarry_0213, xC int64, y *e_nocarry_0213, yC int64) {
	...
	var z e_nocarry_0213
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0213, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0213
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0213, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0213
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0213, xHi uint64) {
	var res e_nocarry_0213
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0213) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0213) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0213, c int64, result *e_nocarry_0213, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0213) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0213) uint64 {
