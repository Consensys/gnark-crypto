...
// modulus q
DATA q<>+0(SB)/8, $0xc9e94810fa793a07
DATA q<>+8(SB)/8, $0xab26061d6c13584f
DATA q<>+16(SB)/8, $0x1a05de79e04d3f0f
DATA q<>+24(SB)/8, $0x00000000001fd436
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x987408fae290ec49
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xc9e94810fa793a07, R8
	MOVQ    $0xab26061d6c13584f, R9
	MOVQ    $0x1a05de79e04d3f0f, R10
	MOVQ    $0x00000000001fd436, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xab26061d6c13584f, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x1a05de79e04d3f0f, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000000001fd436, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xc9e94810fa793a07, R12
	MOVQ    $0xab26061d6c13584f, R13
	MOVQ    $0x1a05de79e04d3f0f, R14
	MOVQ    $0x00000000001fd436, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
