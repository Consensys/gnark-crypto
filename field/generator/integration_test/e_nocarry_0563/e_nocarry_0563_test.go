...
var benchRese_nocarry_0563 e_nocarry_0563

func BenchmarkE_nocarry_0563SetBytes(b *testing.B) {
	var x e_nocarry_0563
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0563MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0563.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0563)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0563)
		}
	})
}

func BenchmarkE_nocarry_0563Inverse(b *testing.B) {
	var x e_nocarry_0563
	x.SetRandom()
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0563Butterfly(b *testing.B) {
	var x e_nocarry_0563
	x.SetRandom()
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0563)
	}
}

func BenchmarkE_nocarry_0563Exp(b *testing.B) {
	var x e_nocarry_0563
	x.SetRandom()
	benchRese_nocarry_0563.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0563Double(b *testing.B) {
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Double(&benchRese_nocarry_0563)
	}
}

func BenchmarkE_nocarry_0563Add(b *testing.B) {
	var x e_nocarry_0563
	x.SetRandom()
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Add(&x, &benchRese_nocarry_0563)
	}
}

func BenchmarkE_nocarry_0563Sub(b *testing.B) {
	var x e_nocarry_0563
	x.SetRandom()
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Sub(&x, &benchRese_nocarry_0563)
	}
}

func BenchmarkE_nocarry_0563Neg(b *testing.B) {
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Neg(&benchRese_nocarry_0563)
	}
}

func BenchmarkE_nocarry_0563Div(b *testing.B) {
	var x e_nocarry_0563
	x.SetRandom()
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Div(&x, &benchRese_nocarry_0563)
	}
}

func BenchmarkE_nocarry_0563FromMont(b *testing.B) {
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.FromMont()
	}
}

func BenchmarkE_nocarry_0563ToMont(b *testing.B) {
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.ToMont()
	}
}
func BenchmarkE_nocarry_0563Square(b *testing.B) {
	benchRese_nocarry_0563.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Square(&benchRese_nocarry_0563)
	}
}

func BenchmarkE_nocarry_0563Sqrt(b *testing.B) {
	var a e_nocarry_0563
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0563Mul(b *testing.B) {
	x := e_nocarry_0563{
		9004516986263493397,
	...
	benchRese_nocarry_0563.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Mul(&benchRese_nocarry_0563, &x)
	}
}

func BenchmarkE_nocarry_0563Cmp(b *testing.B) {
	x := e_nocarry_0563{
		9004516986263493397,
		14583853175049818531,
		3477779892956108267,
	...
	benchRese_nocarry_0563 = x
	benchRese_nocarry_0563[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0563.Cmp(&x)
	}
}

func TestE_nocarry_0563Cmp(t *testing.T) {
	var x, y e_nocarry_0563
...
func TestE_nocarry_0563IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0563
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0563

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0563{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0563
	one.SetOne()
	e.Sub(&qe_nocarry_0563, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0563{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0563{0, uint64(i)})
	}
...
func TestE_nocarry_0563NegZero(t *testing.T) {
	var a, b e_nocarry_0563
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0563Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0563, len(staticTestValues))
...
func TestE_nocarry_0563Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0563) bool {
			var b e_nocarry_0563
...
func TestE_nocarry_0563InverseExp(t *testing.T) {
...
func TestE_nocarry_0563MulByConstants(t *testing.T) {
...
func TestE_nocarry_0563Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0563) bool {
...
func TestE_nocarry_0563LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0563Halve(t *testing.T) {
...
func TestE_nocarry_0563FromMont(t *testing.T) {
...
type testPaire_nocarry_0563 struct {
	element e_nocarry_0563
	bigint  big.Int
}

func (z *e_nocarry_0563) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0563[8] {
		return true
	}
	if z[8] < qe_nocarry_0563[8] {
		return false
	...
	return z[0] >= qe_nocarry_0563[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0563

		g.element = e_nocarry_0563{
		...
		if qe_nocarry_0563[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0563[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0563 {
			var g e_nocarry_0563
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0563[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0563[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0563[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0563[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0563[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0563[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0563[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0563[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0563[8], carry)
...
func Benchmarke_nocarry_0563InverseNew(b *testing.B) {
	var x e_nocarry_0563
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0563
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0563
		var xInv e_nocarry_0563
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0563
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0563
...
func testLinearComb(t *testing.T, x *e_nocarry_0563, xC int64, y *e_nocarry_0563, yC int64) {
	...
	var z e_nocarry_0563
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0563, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0563
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0563, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0563
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0563, xHi uint64) {
	var res e_nocarry_0563
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0563) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0563) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0563, c int64, result *e_nocarry_0563, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0563) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0563) uint64 {
