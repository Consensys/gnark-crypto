...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x228d9c0fd354ec3b, R12
	ADDQ R12, AX
	MOVQ $0xc72c3226771e5658, R12
	ADCQ R12, DX
	MOVQ $0x849f157277127383, R12
	ADCQ R12, CX
	MOVQ $0x92905b67d0a85b9b, R12
	ADCQ R12, BX
	MOVQ $0xffb82a16eadcb492, R12
	ADCQ R12, SI
	MOVQ $0x13a54eb1c0fc3b16, R12
	ADCQ R12, DI
	MOVQ $0xd155b2a361311c2e, R12
	ADCQ R12, R8
	MOVQ $0xd51503873bb589cb, R12
	ADCQ R12, R9
	MOVQ $0x0006a4f100d3703d, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x228d9c0fd354ec3b, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xc72c3226771e5658, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x849f157277127383, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x92905b67d0a85b9b, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xffb82a16eadcb492, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x13a54eb1c0fc3b16, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xd155b2a361311c2e, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xd51503873bb589cb, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0006a4f100d3703d, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x228d9c0fd354ec3b, AX
	ADDQ AX, DX
	MOVQ $0xc72c3226771e5658, AX
	ADCQ AX, CX
	MOVQ $0x849f157277127383, AX
	ADCQ AX, BX
	MOVQ $0x92905b67d0a85b9b, AX
	ADCQ AX, SI
	MOVQ $0xffb82a16eadcb492, AX
	ADCQ AX, DI
	MOVQ $0x13a54eb1c0fc3b16, AX
	ADCQ AX, R8
	MOVQ $0xd155b2a361311c2e, AX
	ADCQ AX, R9
	MOVQ $0xd51503873bb589cb, AX
	ADCQ AX, R10
	MOVQ $0x0006a4f100d3703d, AX
	ADCQ AX, R11
