...
var benchRese_nocarry_0202 e_nocarry_0202

func BenchmarkE_nocarry_0202SetBytes(b *testing.B) {
	var x e_nocarry_0202
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0202MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0202.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0202)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0202)
		}
	})
}

func BenchmarkE_nocarry_0202Inverse(b *testing.B) {
	var x e_nocarry_0202
	x.SetRandom()
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0202Butterfly(b *testing.B) {
	var x e_nocarry_0202
	x.SetRandom()
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0202)
	}
}

func BenchmarkE_nocarry_0202Exp(b *testing.B) {
	var x e_nocarry_0202
	x.SetRandom()
	benchRese_nocarry_0202.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0202Double(b *testing.B) {
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Double(&benchRese_nocarry_0202)
	}
}

func BenchmarkE_nocarry_0202Add(b *testing.B) {
	var x e_nocarry_0202
	x.SetRandom()
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Add(&x, &benchRese_nocarry_0202)
	}
}

func BenchmarkE_nocarry_0202Sub(b *testing.B) {
	var x e_nocarry_0202
	x.SetRandom()
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Sub(&x, &benchRese_nocarry_0202)
	}
}

func BenchmarkE_nocarry_0202Neg(b *testing.B) {
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Neg(&benchRese_nocarry_0202)
	}
}

func BenchmarkE_nocarry_0202Div(b *testing.B) {
	var x e_nocarry_0202
	x.SetRandom()
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Div(&x, &benchRese_nocarry_0202)
	}
}

func BenchmarkE_nocarry_0202FromMont(b *testing.B) {
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.FromMont()
	}
}

func BenchmarkE_nocarry_0202ToMont(b *testing.B) {
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.ToMont()
	}
}
func BenchmarkE_nocarry_0202Square(b *testing.B) {
	benchRese_nocarry_0202.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Square(&benchRese_nocarry_0202)
	}
}

func BenchmarkE_nocarry_0202Sqrt(b *testing.B) {
	var a e_nocarry_0202
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0202Mul(b *testing.B) {
	x := e_nocarry_0202{
		6308345665492159699,
	...
	benchRese_nocarry_0202.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Mul(&benchRese_nocarry_0202, &x)
	}
}

func BenchmarkE_nocarry_0202Cmp(b *testing.B) {
	x := e_nocarry_0202{
		6308345665492159699,
		17762069866831923977,
		13824956208104304592,
	...
	benchRese_nocarry_0202 = x
	benchRese_nocarry_0202[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0202.Cmp(&x)
	}
}

func TestE_nocarry_0202Cmp(t *testing.T) {
	var x, y e_nocarry_0202
...
func TestE_nocarry_0202IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0202
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0202

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0202{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0202
	one.SetOne()
	e.Sub(&qe_nocarry_0202, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0202{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0202{0, uint64(i)})
	}
...
func TestE_nocarry_0202NegZero(t *testing.T) {
	var a, b e_nocarry_0202
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0202Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0202, len(staticTestValues))
...
func TestE_nocarry_0202Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0202) bool {
			var b e_nocarry_0202
...
func TestE_nocarry_0202InverseExp(t *testing.T) {
...
func TestE_nocarry_0202MulByConstants(t *testing.T) {
...
func TestE_nocarry_0202Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0202) bool {
...
func TestE_nocarry_0202LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0202Halve(t *testing.T) {
...
func TestE_nocarry_0202FromMont(t *testing.T) {
...
type testPaire_nocarry_0202 struct {
	element e_nocarry_0202
	bigint  big.Int
}

func (z *e_nocarry_0202) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0202[3] {
		return true
	}
	if z[3] < qe_nocarry_0202[3] {
		return false
	...
	return z[0] >= qe_nocarry_0202[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0202

		g.element = e_nocarry_0202{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0202[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0202[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0202 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0202[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0202[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0202[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0202[3], carry)
...
func Benchmarke_nocarry_0202InverseNew(b *testing.B) {
	var x e_nocarry_0202
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0202
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0202
		var xInv e_nocarry_0202
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0202
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0202
...
func testLinearComb(t *testing.T, x *e_nocarry_0202, xC int64, y *e_nocarry_0202, yC int64) {
	...
	var z e_nocarry_0202
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0202, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0202
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0202, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0202
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0202, xHi uint64) {
	var res e_nocarry_0202
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0202) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0202) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0202, c int64, result *e_nocarry_0202, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0202) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0202) uint64 {
