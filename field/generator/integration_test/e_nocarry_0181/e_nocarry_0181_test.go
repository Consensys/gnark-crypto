...
var benchRese_nocarry_0181 e_nocarry_0181

func BenchmarkE_nocarry_0181SetBytes(b *testing.B) {
	var x e_nocarry_0181
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0181MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0181.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0181)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0181)
		}
	})
}

func BenchmarkE_nocarry_0181Inverse(b *testing.B) {
	var x e_nocarry_0181
	x.SetRandom()
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0181Butterfly(b *testing.B) {
	var x e_nocarry_0181
	x.SetRandom()
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0181)
	}
}

func BenchmarkE_nocarry_0181Exp(b *testing.B) {
	var x e_nocarry_0181
	x.SetRandom()
	benchRese_nocarry_0181.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0181Double(b *testing.B) {
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Double(&benchRese_nocarry_0181)
	}
}

func BenchmarkE_nocarry_0181Add(b *testing.B) {
	var x e_nocarry_0181
	x.SetRandom()
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Add(&x, &benchRese_nocarry_0181)
	}
}

func BenchmarkE_nocarry_0181Sub(b *testing.B) {
	var x e_nocarry_0181
	x.SetRandom()
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Sub(&x, &benchRese_nocarry_0181)
	}
}

func BenchmarkE_nocarry_0181Neg(b *testing.B) {
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Neg(&benchRese_nocarry_0181)
	}
}

func BenchmarkE_nocarry_0181Div(b *testing.B) {
	var x e_nocarry_0181
	x.SetRandom()
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Div(&x, &benchRese_nocarry_0181)
	}
}

func BenchmarkE_nocarry_0181FromMont(b *testing.B) {
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.FromMont()
	}
}

func BenchmarkE_nocarry_0181ToMont(b *testing.B) {
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.ToMont()
	}
}
func BenchmarkE_nocarry_0181Square(b *testing.B) {
	benchRese_nocarry_0181.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Square(&benchRese_nocarry_0181)
	}
}

func BenchmarkE_nocarry_0181Sqrt(b *testing.B) {
	var a e_nocarry_0181
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0181Mul(b *testing.B) {
	x := e_nocarry_0181{
		10499252634739422724,
		7269837967101335977,
		5805784850691852,
	}
	benchRese_nocarry_0181.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Mul(&benchRese_nocarry_0181, &x)
	}
}

func BenchmarkE_nocarry_0181Cmp(b *testing.B) {
	x := e_nocarry_0181{
		10499252634739422724,
		7269837967101335977,
		5805784850691852,
	}
	benchRese_nocarry_0181 = x
	benchRese_nocarry_0181[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0181.Cmp(&x)
	}
}

func TestE_nocarry_0181Cmp(t *testing.T) {
	var x, y e_nocarry_0181
...
func TestE_nocarry_0181IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0181
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0181

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0181{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0181
	one.SetOne()
	e.Sub(&qe_nocarry_0181, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0181{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0181{0, uint64(i)})
	}
...
func TestE_nocarry_0181NegZero(t *testing.T) {
	var a, b e_nocarry_0181
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0181Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0181, len(staticTestValues))
...
func TestE_nocarry_0181Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0181) bool {
			var b e_nocarry_0181
...
func TestE_nocarry_0181InverseExp(t *testing.T) {
...
func TestE_nocarry_0181MulByConstants(t *testing.T) {
...
func TestE_nocarry_0181Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0181) bool {
...
func TestE_nocarry_0181LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0181Halve(t *testing.T) {
...
func TestE_nocarry_0181FromMont(t *testing.T) {
...
type testPaire_nocarry_0181 struct {
	element e_nocarry_0181
	bigint  big.Int
}

func (z *e_nocarry_0181) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0181[2] {
		return true
	}
	if z[2] < qe_nocarry_0181[2] {
		return false
	...
	return z[0] >= qe_nocarry_0181[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0181

		g.element = e_nocarry_0181{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0181[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0181[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0181 {
			var g e_nocarry_0181
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0181[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0181[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0181[2], carry)
...
func Benchmarke_nocarry_0181InverseNew(b *testing.B) {
	var x e_nocarry_0181
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0181
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0181
		var xInv e_nocarry_0181
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0181
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0181
...
func testLinearComb(t *testing.T, x *e_nocarry_0181, xC int64, y *e_nocarry_0181, yC int64) {
	...
	var z e_nocarry_0181
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0181, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0181
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0181, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0181
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0181, xHi uint64) {
	var res e_nocarry_0181
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0181) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0181) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0181, c int64, result *e_nocarry_0181, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0181) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0181) uint64 {
