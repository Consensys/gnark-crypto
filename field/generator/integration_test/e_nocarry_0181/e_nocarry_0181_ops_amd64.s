...
// modulus q
DATA q<>+0(SB)/8, $0xd8d51ad52dbdd39d
DATA q<>+8(SB)/8, $0x075be90f29c2e1cc
DATA q<>+16(SB)/8, $0x001f98f146e4d98c
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xc2568ba4c749b54b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xd8d51ad52dbdd39d, DI
	MOVQ    $0x075be90f29c2e1cc, R8
	MOVQ    $0x001f98f146e4d98c, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x075be90f29c2e1cc, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x001f98f146e4d98c, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xd8d51ad52dbdd39d, R10
	MOVQ    $0x075be90f29c2e1cc, R11
	MOVQ    $0x001f98f146e4d98c, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
