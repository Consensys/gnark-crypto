...
var benchRese_nocarry_0557 e_nocarry_0557

func BenchmarkE_nocarry_0557SetBytes(b *testing.B) {
	var x e_nocarry_0557
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0557MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0557.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0557)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0557)
		}
	})
}

func BenchmarkE_nocarry_0557Inverse(b *testing.B) {
	var x e_nocarry_0557
	x.SetRandom()
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0557Butterfly(b *testing.B) {
	var x e_nocarry_0557
	x.SetRandom()
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0557)
	}
}

func BenchmarkE_nocarry_0557Exp(b *testing.B) {
	var x e_nocarry_0557
	x.SetRandom()
	benchRese_nocarry_0557.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0557Double(b *testing.B) {
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Double(&benchRese_nocarry_0557)
	}
}

func BenchmarkE_nocarry_0557Add(b *testing.B) {
	var x e_nocarry_0557
	x.SetRandom()
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Add(&x, &benchRese_nocarry_0557)
	}
}

func BenchmarkE_nocarry_0557Sub(b *testing.B) {
	var x e_nocarry_0557
	x.SetRandom()
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Sub(&x, &benchRese_nocarry_0557)
	}
}

func BenchmarkE_nocarry_0557Neg(b *testing.B) {
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Neg(&benchRese_nocarry_0557)
	}
}

func BenchmarkE_nocarry_0557Div(b *testing.B) {
	var x e_nocarry_0557
	x.SetRandom()
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Div(&x, &benchRese_nocarry_0557)
	}
}

func BenchmarkE_nocarry_0557FromMont(b *testing.B) {
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.FromMont()
	}
}

func BenchmarkE_nocarry_0557ToMont(b *testing.B) {
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.ToMont()
	}
}
func BenchmarkE_nocarry_0557Square(b *testing.B) {
	benchRese_nocarry_0557.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Square(&benchRese_nocarry_0557)
	}
}

func BenchmarkE_nocarry_0557Sqrt(b *testing.B) {
	var a e_nocarry_0557
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0557Mul(b *testing.B) {
	x := e_nocarry_0557{
	...
	benchRese_nocarry_0557.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Mul(&benchRese_nocarry_0557, &x)
	}
}

func BenchmarkE_nocarry_0557Cmp(b *testing.B) {
	x := e_nocarry_0557{
		11907123930781205716,
		6809723365888456394,
		9267233337476111438,
	...
	benchRese_nocarry_0557 = x
	benchRese_nocarry_0557[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0557.Cmp(&x)
	}
}

func TestE_nocarry_0557Cmp(t *testing.T) {
	var x, y e_nocarry_0557
...
func TestE_nocarry_0557IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0557
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0557

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0557{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0557
	one.SetOne()
	e.Sub(&qe_nocarry_0557, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0557{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0557{0, uint64(i)})
	}
...
func TestE_nocarry_0557NegZero(t *testing.T) {
	var a, b e_nocarry_0557
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0557Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0557, len(staticTestValues))
...
func TestE_nocarry_0557Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0557) bool {
			var b e_nocarry_0557
...
func TestE_nocarry_0557InverseExp(t *testing.T) {
...
func TestE_nocarry_0557MulByConstants(t *testing.T) {
...
func TestE_nocarry_0557Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0557) bool {
...
func TestE_nocarry_0557LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0557Halve(t *testing.T) {
...
func TestE_nocarry_0557FromMont(t *testing.T) {
...
type testPaire_nocarry_0557 struct {
	element e_nocarry_0557
	bigint  big.Int
}

func (z *e_nocarry_0557) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0557[8] {
		return true
	}
	if z[8] < qe_nocarry_0557[8] {
		return false
	...
	return z[0] >= qe_nocarry_0557[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0557

		g.element = e_nocarry_0557{
		...
		if qe_nocarry_0557[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0557[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0557 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0557[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0557[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0557[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0557[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0557[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0557[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0557[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0557[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0557[8], carry)
...
func Benchmarke_nocarry_0557InverseNew(b *testing.B) {
	var x e_nocarry_0557
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0557
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0557
		var xInv e_nocarry_0557
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0557
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0557
...
func testLinearComb(t *testing.T, x *e_nocarry_0557, xC int64, y *e_nocarry_0557, yC int64) {
	...
	var z e_nocarry_0557
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0557, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0557
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0557, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0557
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0557, xHi uint64) {
	var res e_nocarry_0557
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0557) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0557) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0557, c int64, result *e_nocarry_0557, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0557) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0557) uint64 {
