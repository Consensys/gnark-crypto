...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xf53eabb642d6ac89, R12
	ADDQ R12, AX
	MOVQ $0x259c2bc12455a86c, R12
	ADCQ R12, DX
	MOVQ $0x864a581fc95e3acc, R12
	ADCQ R12, CX
	MOVQ $0x74ae504141a75e92, R12
	ADCQ R12, BX
	MOVQ $0xc4421594af2bc6b9, R12
	ADCQ R12, SI
	MOVQ $0xf90ff5eeea760b50, R12
	ADCQ R12, DI
	MOVQ $0x76850e0042658e94, R12
	ADCQ R12, R8
	MOVQ $0x4e0d3ace63ec3a7f, R12
	ADCQ R12, R9
	MOVQ $0x00001bacaad047ef, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf53eabb642d6ac89, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x259c2bc12455a86c, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x864a581fc95e3acc, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x74ae504141a75e92, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xc4421594af2bc6b9, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xf90ff5eeea760b50, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x76850e0042658e94, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x4e0d3ace63ec3a7f, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00001bacaad047ef, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xf53eabb642d6ac89, AX
	ADDQ AX, DX
	MOVQ $0x259c2bc12455a86c, AX
	ADCQ AX, CX
	MOVQ $0x864a581fc95e3acc, AX
	ADCQ AX, BX
	MOVQ $0x74ae504141a75e92, AX
	ADCQ AX, SI
	MOVQ $0xc4421594af2bc6b9, AX
	ADCQ AX, DI
	MOVQ $0xf90ff5eeea760b50, AX
	ADCQ AX, R8
	MOVQ $0x76850e0042658e94, AX
	ADCQ AX, R9
	MOVQ $0x4e0d3ace63ec3a7f, AX
	ADCQ AX, R10
	MOVQ $0x00001bacaad047ef, AX
	ADCQ AX, R11
