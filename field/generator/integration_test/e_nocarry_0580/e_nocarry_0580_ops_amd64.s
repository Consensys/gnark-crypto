...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x734315a415ec3d3d, R13
	ADDQ R13, AX
	MOVQ $0x8797decc7edd73bc, R13
	ADCQ R13, DX
	MOVQ $0x556eba27ec0b5d95, R13
	ADCQ R13, CX
	MOVQ $0x01bb6cbfb2568868, R13
	ADCQ R13, BX
	MOVQ $0xd410e1704fd0f03a, R13
	ADCQ R13, SI
	MOVQ $0x30f1d5dc1fa1b02a, R13
	ADCQ R13, DI
	MOVQ $0x56fe1aac67a2482f, R13
	ADCQ R13, R8
	MOVQ $0x13021d6c3d4f1464, R13
	ADCQ R13, R9
	MOVQ $0x7ac66e39942737b9, R13
	ADCQ R13, R10
	MOVQ $0x000000000000000d, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x734315a415ec3d3d, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x8797decc7edd73bc, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x556eba27ec0b5d95, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x01bb6cbfb2568868, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xd410e1704fd0f03a, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x30f1d5dc1fa1b02a, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x56fe1aac67a2482f, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x13021d6c3d4f1464, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x7ac66e39942737b9, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x734315a415ec3d3d, AX
	ADDQ AX, DX
	MOVQ $0x8797decc7edd73bc, AX
	ADCQ AX, CX
	MOVQ $0x556eba27ec0b5d95, AX
	ADCQ AX, BX
	MOVQ $0x01bb6cbfb2568868, AX
	ADCQ AX, SI
	MOVQ $0xd410e1704fd0f03a, AX
	ADCQ AX, DI
	MOVQ $0x30f1d5dc1fa1b02a, AX
	ADCQ AX, R8
	MOVQ $0x56fe1aac67a2482f, AX
	ADCQ AX, R9
	MOVQ $0x13021d6c3d4f1464, AX
	ADCQ AX, R10
	MOVQ $0x7ac66e39942737b9, AX
	ADCQ AX, R11
