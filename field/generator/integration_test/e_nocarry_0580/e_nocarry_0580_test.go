...
var benchRese_nocarry_0580 e_nocarry_0580

func BenchmarkE_nocarry_0580SetBytes(b *testing.B) {
	var x e_nocarry_0580
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0580MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0580.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0580)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0580)
		}
	})
}

func BenchmarkE_nocarry_0580Inverse(b *testing.B) {
	var x e_nocarry_0580
	x.SetRandom()
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0580Butterfly(b *testing.B) {
	var x e_nocarry_0580
	x.SetRandom()
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0580)
	}
}

func BenchmarkE_nocarry_0580Exp(b *testing.B) {
	var x e_nocarry_0580
	x.SetRandom()
	benchRese_nocarry_0580.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0580Double(b *testing.B) {
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Double(&benchRese_nocarry_0580)
	}
}

func BenchmarkE_nocarry_0580Add(b *testing.B) {
	var x e_nocarry_0580
	x.SetRandom()
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Add(&x, &benchRese_nocarry_0580)
	}
}

func BenchmarkE_nocarry_0580Sub(b *testing.B) {
	var x e_nocarry_0580
	x.SetRandom()
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Sub(&x, &benchRese_nocarry_0580)
	}
}

func BenchmarkE_nocarry_0580Neg(b *testing.B) {
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Neg(&benchRese_nocarry_0580)
	}
}

func BenchmarkE_nocarry_0580Div(b *testing.B) {
	var x e_nocarry_0580
	x.SetRandom()
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Div(&x, &benchRese_nocarry_0580)
	}
}

func BenchmarkE_nocarry_0580FromMont(b *testing.B) {
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.FromMont()
	}
}

func BenchmarkE_nocarry_0580ToMont(b *testing.B) {
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.ToMont()
	}
}
func BenchmarkE_nocarry_0580Square(b *testing.B) {
	benchRese_nocarry_0580.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Square(&benchRese_nocarry_0580)
	}
}

func BenchmarkE_nocarry_0580Sqrt(b *testing.B) {
	var a e_nocarry_0580
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0580Mul(b *testing.B) {
	x := e_nocarry_0580{
	...
	benchRese_nocarry_0580.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Mul(&benchRese_nocarry_0580, &x)
	}
}

func BenchmarkE_nocarry_0580Cmp(b *testing.B) {
	x := e_nocarry_0580{
		11420694965460875298,
		11349822869833340790,
		2925206910557247584,
	...
	benchRese_nocarry_0580 = x
	benchRese_nocarry_0580[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0580.Cmp(&x)
	}
}

func TestE_nocarry_0580Cmp(t *testing.T) {
	var x, y e_nocarry_0580
...
func TestE_nocarry_0580IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0580
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0580

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0580{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0580
	one.SetOne()
	e.Sub(&qe_nocarry_0580, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0580{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0580{0, uint64(i)})
	}
...
func TestE_nocarry_0580NegZero(t *testing.T) {
	var a, b e_nocarry_0580
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0580Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0580, len(staticTestValues))
...
func TestE_nocarry_0580Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0580) bool {
			var b e_nocarry_0580
...
func TestE_nocarry_0580InverseExp(t *testing.T) {
...
func TestE_nocarry_0580MulByConstants(t *testing.T) {
...
func TestE_nocarry_0580Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0580) bool {
...
func TestE_nocarry_0580LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0580Halve(t *testing.T) {
...
func TestE_nocarry_0580FromMont(t *testing.T) {
...
type testPaire_nocarry_0580 struct {
	element e_nocarry_0580
	bigint  big.Int
}

func (z *e_nocarry_0580) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0580[9] {
		return true
	}
	if z[9] < qe_nocarry_0580[9] {
		return false
	...
	return z[0] >= qe_nocarry_0580[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0580

		g.element = e_nocarry_0580{
		...
		if qe_nocarry_0580[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0580[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0580 {
			var g e_nocarry_0580
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0580[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0580[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0580[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0580[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0580[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0580[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0580[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0580[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0580[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0580[9], carry)
...
func Benchmarke_nocarry_0580InverseNew(b *testing.B) {
	var x e_nocarry_0580
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0580
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0580
		var xInv e_nocarry_0580
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0580
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0580
...
func testLinearComb(t *testing.T, x *e_nocarry_0580, xC int64, y *e_nocarry_0580, yC int64) {
	...
	var z e_nocarry_0580
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0580, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0580
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0580, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0580
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0580, xHi uint64) {
	var res e_nocarry_0580
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0580) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0580) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0580, c int64, result *e_nocarry_0580, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0580) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0580) uint64 {
