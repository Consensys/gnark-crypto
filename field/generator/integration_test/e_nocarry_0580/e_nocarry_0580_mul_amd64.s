...
// modulus q
DATA q<>+0(SB)/8, $0x734315a415ec3d3d
DATA q<>+8(SB)/8, $0x8797decc7edd73bc
DATA q<>+16(SB)/8, $0x556eba27ec0b5d95
DATA q<>+24(SB)/8, $0x01bb6cbfb2568868
DATA q<>+32(SB)/8, $0xd410e1704fd0f03a
DATA q<>+40(SB)/8, $0x30f1d5dc1fa1b02a
DATA q<>+48(SB)/8, $0x56fe1aac67a2482f
DATA q<>+56(SB)/8, $0x13021d6c3d4f1464
DATA q<>+64(SB)/8, $0x7ac66e39942737b9
DATA q<>+72(SB)/8, $0x000000000000000d
GLOBL q<>(SB), (RODATA+NOPTR), $80

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x908411c2fd017deb
