...
var benchRese_nocarry_0310 e_nocarry_0310

func BenchmarkE_nocarry_0310SetBytes(b *testing.B) {
	var x e_nocarry_0310
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0310MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0310.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0310)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0310)
		}
	})
}

func BenchmarkE_nocarry_0310Inverse(b *testing.B) {
	var x e_nocarry_0310
	x.SetRandom()
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0310Butterfly(b *testing.B) {
	var x e_nocarry_0310
	x.SetRandom()
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0310)
	}
}

func BenchmarkE_nocarry_0310Exp(b *testing.B) {
	var x e_nocarry_0310
	x.SetRandom()
	benchRese_nocarry_0310.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0310Double(b *testing.B) {
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Double(&benchRese_nocarry_0310)
	}
}

func BenchmarkE_nocarry_0310Add(b *testing.B) {
	var x e_nocarry_0310
	x.SetRandom()
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Add(&x, &benchRese_nocarry_0310)
	}
}

func BenchmarkE_nocarry_0310Sub(b *testing.B) {
	var x e_nocarry_0310
	x.SetRandom()
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Sub(&x, &benchRese_nocarry_0310)
	}
}

func BenchmarkE_nocarry_0310Neg(b *testing.B) {
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Neg(&benchRese_nocarry_0310)
	}
}

func BenchmarkE_nocarry_0310Div(b *testing.B) {
	var x e_nocarry_0310
	x.SetRandom()
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Div(&x, &benchRese_nocarry_0310)
	}
}

func BenchmarkE_nocarry_0310FromMont(b *testing.B) {
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.FromMont()
	}
}

func BenchmarkE_nocarry_0310ToMont(b *testing.B) {
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.ToMont()
	}
}
func BenchmarkE_nocarry_0310Square(b *testing.B) {
	benchRese_nocarry_0310.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Square(&benchRese_nocarry_0310)
	}
}

func BenchmarkE_nocarry_0310Sqrt(b *testing.B) {
	var a e_nocarry_0310
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0310Mul(b *testing.B) {
	x := e_nocarry_0310{
		959307656528362474,
		8835868321173283979,
		4943431480836845210,
	...
	benchRese_nocarry_0310.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Mul(&benchRese_nocarry_0310, &x)
	}
}

func BenchmarkE_nocarry_0310Cmp(b *testing.B) {
	x := e_nocarry_0310{
		959307656528362474,
		8835868321173283979,
		4943431480836845210,
	...
	benchRese_nocarry_0310 = x
	benchRese_nocarry_0310[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0310.Cmp(&x)
	}
}

func TestE_nocarry_0310Cmp(t *testing.T) {
	var x, y e_nocarry_0310
...
func TestE_nocarry_0310IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0310
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0310

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0310{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0310
	one.SetOne()
	e.Sub(&qe_nocarry_0310, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0310{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0310{0, uint64(i)})
	}
...
func TestE_nocarry_0310NegZero(t *testing.T) {
	var a, b e_nocarry_0310
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0310Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0310, len(staticTestValues))
...
func TestE_nocarry_0310Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0310) bool {
			var b e_nocarry_0310
...
func TestE_nocarry_0310InverseExp(t *testing.T) {
...
func TestE_nocarry_0310MulByConstants(t *testing.T) {
...
func TestE_nocarry_0310Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0310) bool {
...
func TestE_nocarry_0310LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0310Halve(t *testing.T) {
...
func TestE_nocarry_0310FromMont(t *testing.T) {
...
type testPaire_nocarry_0310 struct {
	element e_nocarry_0310
	bigint  big.Int
}

func (z *e_nocarry_0310) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0310[4] {
		return true
	}
	if z[4] < qe_nocarry_0310[4] {
		return false
	...
	return z[0] >= qe_nocarry_0310[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0310

		g.element = e_nocarry_0310{
		...
		if qe_nocarry_0310[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0310[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0310 {
			var g e_nocarry_0310
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0310[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0310[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0310[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0310[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0310[4], carry)
...
func Benchmarke_nocarry_0310InverseNew(b *testing.B) {
	var x e_nocarry_0310
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0310
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0310
		var xInv e_nocarry_0310
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0310
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0310
...
func testLinearComb(t *testing.T, x *e_nocarry_0310, xC int64, y *e_nocarry_0310, yC int64) {
	...
	var z e_nocarry_0310
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0310, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0310
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0310, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0310
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0310, xHi uint64) {
	var res e_nocarry_0310
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0310) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0310) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0310, c int64, result *e_nocarry_0310, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0310) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0310) uint64 {
