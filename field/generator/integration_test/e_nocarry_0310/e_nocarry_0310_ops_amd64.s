...
// modulus q
DATA q<>+0(SB)/8, $0x6cc6b85b9f278747
DATA q<>+8(SB)/8, $0xf42e3532d9443fd4
DATA q<>+16(SB)/8, $0x97b365dcf2ac506d
DATA q<>+24(SB)/8, $0x7c1f71efaa3b7b2e
DATA q<>+32(SB)/8, $0x00392a4c7b3a64d2
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xce82aa37ef360d89
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x6cc6b85b9f278747, R9
	MOVQ    $0xf42e3532d9443fd4, R10
	MOVQ    $0x97b365dcf2ac506d, R11
	MOVQ    $0x7c1f71efaa3b7b2e, R12
	MOVQ    $0x00392a4c7b3a64d2, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xf42e3532d9443fd4, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x97b365dcf2ac506d, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x7c1f71efaa3b7b2e, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00392a4c7b3a64d2, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x6cc6b85b9f278747, CX
	MOVQ    $0xf42e3532d9443fd4, BX
	MOVQ    $0x97b365dcf2ac506d, SI
	MOVQ    $0x7c1f71efaa3b7b2e, DI
	MOVQ    $0x00392a4c7b3a64d2, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
