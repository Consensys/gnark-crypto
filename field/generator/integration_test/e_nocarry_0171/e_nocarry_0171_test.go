...
var benchRese_nocarry_0171 e_nocarry_0171

func BenchmarkE_nocarry_0171SetBytes(b *testing.B) {
	var x e_nocarry_0171
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0171MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0171.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0171)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0171)
		}
	})
}

func BenchmarkE_nocarry_0171Inverse(b *testing.B) {
	var x e_nocarry_0171
	x.SetRandom()
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0171Butterfly(b *testing.B) {
	var x e_nocarry_0171
	x.SetRandom()
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0171)
	}
}

func BenchmarkE_nocarry_0171Exp(b *testing.B) {
	var x e_nocarry_0171
	x.SetRandom()
	benchRese_nocarry_0171.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0171Double(b *testing.B) {
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Double(&benchRese_nocarry_0171)
	}
}

func BenchmarkE_nocarry_0171Add(b *testing.B) {
	var x e_nocarry_0171
	x.SetRandom()
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Add(&x, &benchRese_nocarry_0171)
	}
}

func BenchmarkE_nocarry_0171Sub(b *testing.B) {
	var x e_nocarry_0171
	x.SetRandom()
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Sub(&x, &benchRese_nocarry_0171)
	}
}

func BenchmarkE_nocarry_0171Neg(b *testing.B) {
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Neg(&benchRese_nocarry_0171)
	}
}

func BenchmarkE_nocarry_0171Div(b *testing.B) {
	var x e_nocarry_0171
	x.SetRandom()
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Div(&x, &benchRese_nocarry_0171)
	}
}

func BenchmarkE_nocarry_0171FromMont(b *testing.B) {
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.FromMont()
	}
}

func BenchmarkE_nocarry_0171ToMont(b *testing.B) {
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.ToMont()
	}
}
func BenchmarkE_nocarry_0171Square(b *testing.B) {
	benchRese_nocarry_0171.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Square(&benchRese_nocarry_0171)
	}
}

func BenchmarkE_nocarry_0171Sqrt(b *testing.B) {
	var a e_nocarry_0171
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0171Mul(b *testing.B) {
	x := e_nocarry_0171{
		18106196720313258214,
		5382795476092670971,
		1392734082415,
	}
	benchRese_nocarry_0171.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Mul(&benchRese_nocarry_0171, &x)
	}
}

func BenchmarkE_nocarry_0171Cmp(b *testing.B) {
	x := e_nocarry_0171{
		18106196720313258214,
		5382795476092670971,
		1392734082415,
	}
	benchRese_nocarry_0171 = x
	benchRese_nocarry_0171[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0171.Cmp(&x)
	}
}

func TestE_nocarry_0171Cmp(t *testing.T) {
	var x, y e_nocarry_0171
...
func TestE_nocarry_0171IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0171
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0171

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0171{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0171
	one.SetOne()
	e.Sub(&qe_nocarry_0171, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0171{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0171{0, uint64(i)})
	}
...
func TestE_nocarry_0171NegZero(t *testing.T) {
	var a, b e_nocarry_0171
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0171Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0171, len(staticTestValues))
...
func TestE_nocarry_0171Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0171) bool {
			var b e_nocarry_0171
...
func TestE_nocarry_0171InverseExp(t *testing.T) {
...
func TestE_nocarry_0171MulByConstants(t *testing.T) {
...
func TestE_nocarry_0171Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0171) bool {
...
func TestE_nocarry_0171LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0171Halve(t *testing.T) {
...
func TestE_nocarry_0171FromMont(t *testing.T) {
...
type testPaire_nocarry_0171 struct {
	element e_nocarry_0171
	bigint  big.Int
}

func (z *e_nocarry_0171) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0171[2] {
		return true
	}
	if z[2] < qe_nocarry_0171[2] {
		return false
	...
	return z[0] >= qe_nocarry_0171[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0171

		g.element = e_nocarry_0171{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0171[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0171[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0171 {
			var g e_nocarry_0171
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0171[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0171[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0171[2], carry)
...
func Benchmarke_nocarry_0171InverseNew(b *testing.B) {
	var x e_nocarry_0171
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0171
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0171
		var xInv e_nocarry_0171
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0171
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0171
...
func testLinearComb(t *testing.T, x *e_nocarry_0171, xC int64, y *e_nocarry_0171, yC int64) {
	...
	var z e_nocarry_0171
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0171, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0171
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0171, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0171
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0171, xHi uint64) {
	var res e_nocarry_0171
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0171) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0171) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0171, c int64, result *e_nocarry_0171, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0171) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0171) uint64 {
