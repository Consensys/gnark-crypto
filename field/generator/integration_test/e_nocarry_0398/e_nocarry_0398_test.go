...
var benchRese_nocarry_0398 e_nocarry_0398

func BenchmarkE_nocarry_0398SetBytes(b *testing.B) {
	var x e_nocarry_0398
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0398MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0398.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0398)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0398)
		}
	})
}

func BenchmarkE_nocarry_0398Inverse(b *testing.B) {
	var x e_nocarry_0398
	x.SetRandom()
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0398Butterfly(b *testing.B) {
	var x e_nocarry_0398
	x.SetRandom()
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0398)
	}
}

func BenchmarkE_nocarry_0398Exp(b *testing.B) {
	var x e_nocarry_0398
	x.SetRandom()
	benchRese_nocarry_0398.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0398Double(b *testing.B) {
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Double(&benchRese_nocarry_0398)
	}
}

func BenchmarkE_nocarry_0398Add(b *testing.B) {
	var x e_nocarry_0398
	x.SetRandom()
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Add(&x, &benchRese_nocarry_0398)
	}
}

func BenchmarkE_nocarry_0398Sub(b *testing.B) {
	var x e_nocarry_0398
	x.SetRandom()
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Sub(&x, &benchRese_nocarry_0398)
	}
}

func BenchmarkE_nocarry_0398Neg(b *testing.B) {
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Neg(&benchRese_nocarry_0398)
	}
}

func BenchmarkE_nocarry_0398Div(b *testing.B) {
	var x e_nocarry_0398
	x.SetRandom()
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Div(&x, &benchRese_nocarry_0398)
	}
}

func BenchmarkE_nocarry_0398FromMont(b *testing.B) {
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.FromMont()
	}
}

func BenchmarkE_nocarry_0398ToMont(b *testing.B) {
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.ToMont()
	}
}
func BenchmarkE_nocarry_0398Square(b *testing.B) {
	benchRese_nocarry_0398.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Square(&benchRese_nocarry_0398)
	}
}

func BenchmarkE_nocarry_0398Sqrt(b *testing.B) {
	var a e_nocarry_0398
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0398Mul(b *testing.B) {
	x := e_nocarry_0398{
		9204009259700698638,
		9540606837404991680,
		3106387001406246885,
	...
	benchRese_nocarry_0398.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Mul(&benchRese_nocarry_0398, &x)
	}
}

func BenchmarkE_nocarry_0398Cmp(b *testing.B) {
	x := e_nocarry_0398{
		9204009259700698638,
		9540606837404991680,
		3106387001406246885,
	...
	benchRese_nocarry_0398 = x
	benchRese_nocarry_0398[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0398.Cmp(&x)
	}
}

func TestE_nocarry_0398Cmp(t *testing.T) {
	var x, y e_nocarry_0398
...
func TestE_nocarry_0398IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0398
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0398

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0398{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0398
	one.SetOne()
	e.Sub(&qe_nocarry_0398, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0398{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0398{0, uint64(i)})
	}
...
func TestE_nocarry_0398NegZero(t *testing.T) {
	var a, b e_nocarry_0398
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0398Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0398, len(staticTestValues))
...
func TestE_nocarry_0398Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0398) bool {
			var b e_nocarry_0398
...
func TestE_nocarry_0398InverseExp(t *testing.T) {
...
func TestE_nocarry_0398MulByConstants(t *testing.T) {
...
func TestE_nocarry_0398Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0398) bool {
...
func TestE_nocarry_0398LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0398Halve(t *testing.T) {
...
func TestE_nocarry_0398FromMont(t *testing.T) {
...
type testPaire_nocarry_0398 struct {
	element e_nocarry_0398
	bigint  big.Int
}

func (z *e_nocarry_0398) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0398[6] {
		return true
	}
	if z[6] < qe_nocarry_0398[6] {
		return false
	...
	return z[0] >= qe_nocarry_0398[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0398

		g.element = e_nocarry_0398{
		...
		if qe_nocarry_0398[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0398[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0398 {
			var g e_nocarry_0398
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0398[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0398[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0398[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0398[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0398[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0398[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0398[6], carry)
...
func Benchmarke_nocarry_0398InverseNew(b *testing.B) {
	var x e_nocarry_0398
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0398
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0398
		var xInv e_nocarry_0398
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0398
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0398
...
func testLinearComb(t *testing.T, x *e_nocarry_0398, xC int64, y *e_nocarry_0398, yC int64) {
	...
	var z e_nocarry_0398
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0398, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0398
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0398, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0398
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0398, xHi uint64) {
	var res e_nocarry_0398
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0398) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0398) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0398, c int64, result *e_nocarry_0398, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0398) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0398) uint64 {
