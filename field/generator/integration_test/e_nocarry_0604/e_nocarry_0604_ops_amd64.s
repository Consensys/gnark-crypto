...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xb86ad01d50fcf745, R13
	ADDQ R13, AX
	MOVQ $0x1cec72955bc79bf7, R13
	ADCQ R13, DX
	MOVQ $0x39bbe473232899f0, R13
	ADCQ R13, CX
	MOVQ $0x2961a7ba1d43748e, R13
	ADCQ R13, BX
	MOVQ $0x4f9ebfb8a8bd719e, R13
	ADCQ R13, SI
	MOVQ $0x203e908da7b8fa98, R13
	ADCQ R13, DI
	MOVQ $0xad2df99407bf8cef, R13
	ADCQ R13, R8
	MOVQ $0xdebc31384cd0b418, R13
	ADCQ R13, R9
	MOVQ $0x03e06897a13a1e43, R13
	ADCQ R13, R10
	MOVQ $0x000000000e1e613f, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xb86ad01d50fcf745, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x1cec72955bc79bf7, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x39bbe473232899f0, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x2961a7ba1d43748e, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x4f9ebfb8a8bd719e, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x203e908da7b8fa98, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xad2df99407bf8cef, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xdebc31384cd0b418, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x03e06897a13a1e43, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000000e1e613f, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xb86ad01d50fcf745, AX
	ADDQ AX, DX
	MOVQ $0x1cec72955bc79bf7, AX
	ADCQ AX, CX
	MOVQ $0x39bbe473232899f0, AX
	ADCQ AX, BX
	MOVQ $0x2961a7ba1d43748e, AX
	ADCQ AX, SI
	MOVQ $0x4f9ebfb8a8bd719e, AX
	ADCQ AX, DI
	MOVQ $0x203e908da7b8fa98, AX
	ADCQ AX, R8
	MOVQ $0xad2df99407bf8cef, AX
	ADCQ AX, R9
	MOVQ $0xdebc31384cd0b418, AX
	ADCQ AX, R10
	MOVQ $0x03e06897a13a1e43, AX
	ADCQ AX, R11
	MOVQ $0x000000000e1e613f, AX
	ADCQ AX, R12
