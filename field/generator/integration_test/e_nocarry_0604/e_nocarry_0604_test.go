...
var benchRese_nocarry_0604 e_nocarry_0604

func BenchmarkE_nocarry_0604SetBytes(b *testing.B) {
	var x e_nocarry_0604
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0604MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0604.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0604)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0604)
		}
	})
}

func BenchmarkE_nocarry_0604Inverse(b *testing.B) {
	var x e_nocarry_0604
	x.SetRandom()
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0604Butterfly(b *testing.B) {
	var x e_nocarry_0604
	x.SetRandom()
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0604)
	}
}

func BenchmarkE_nocarry_0604Exp(b *testing.B) {
	var x e_nocarry_0604
	x.SetRandom()
	benchRese_nocarry_0604.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0604Double(b *testing.B) {
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Double(&benchRese_nocarry_0604)
	}
}

func BenchmarkE_nocarry_0604Add(b *testing.B) {
	var x e_nocarry_0604
	x.SetRandom()
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Add(&x, &benchRese_nocarry_0604)
	}
}

func BenchmarkE_nocarry_0604Sub(b *testing.B) {
	var x e_nocarry_0604
	x.SetRandom()
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Sub(&x, &benchRese_nocarry_0604)
	}
}

func BenchmarkE_nocarry_0604Neg(b *testing.B) {
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Neg(&benchRese_nocarry_0604)
	}
}

func BenchmarkE_nocarry_0604Div(b *testing.B) {
	var x e_nocarry_0604
	x.SetRandom()
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Div(&x, &benchRese_nocarry_0604)
	}
}

func BenchmarkE_nocarry_0604FromMont(b *testing.B) {
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.FromMont()
	}
}

func BenchmarkE_nocarry_0604ToMont(b *testing.B) {
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.ToMont()
	}
}
func BenchmarkE_nocarry_0604Square(b *testing.B) {
	benchRese_nocarry_0604.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Square(&benchRese_nocarry_0604)
	}
}

func BenchmarkE_nocarry_0604Sqrt(b *testing.B) {
	var a e_nocarry_0604
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0604Mul(b *testing.B) {
	x := e_nocarry_0604{
		9069143919139459499,
		500668906544182832,
		5320798582277979560,
	...
	benchRese_nocarry_0604.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Mul(&benchRese_nocarry_0604, &x)
	}
}

func BenchmarkE_nocarry_0604Cmp(b *testing.B) {
	x := e_nocarry_0604{
		9069143919139459499,
		500668906544182832,
		5320798582277979560,
	...
	benchRese_nocarry_0604 = x
	benchRese_nocarry_0604[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0604.Cmp(&x)
	}
}

func TestE_nocarry_0604Cmp(t *testing.T) {
	var x, y e_nocarry_0604
...
func TestE_nocarry_0604IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0604
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0604

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0604{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0604
	one.SetOne()
	e.Sub(&qe_nocarry_0604, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0604{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0604{0, uint64(i)})
	}
...
func TestE_nocarry_0604NegZero(t *testing.T) {
	var a, b e_nocarry_0604
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0604Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0604, len(staticTestValues))
...
func TestE_nocarry_0604Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0604) bool {
			var b e_nocarry_0604
...
func TestE_nocarry_0604InverseExp(t *testing.T) {
...
func TestE_nocarry_0604MulByConstants(t *testing.T) {
...
func TestE_nocarry_0604Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0604) bool {
...
func TestE_nocarry_0604LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0604Halve(t *testing.T) {
...
func TestE_nocarry_0604FromMont(t *testing.T) {
...
type testPaire_nocarry_0604 struct {
	element e_nocarry_0604
	bigint  big.Int
}

func (z *e_nocarry_0604) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0604[9] {
		return true
	}
	if z[9] < qe_nocarry_0604[9] {
		return false
	...
	return z[0] >= qe_nocarry_0604[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0604

		g.element = e_nocarry_0604{
		...
		if qe_nocarry_0604[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0604[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0604 {
			var g e_nocarry_0604
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0604[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0604[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0604[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0604[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0604[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0604[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0604[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0604[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0604[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0604[9], carry)
...
func Benchmarke_nocarry_0604InverseNew(b *testing.B) {
	var x e_nocarry_0604
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0604
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0604
		var xInv e_nocarry_0604
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0604
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0604
...
func testLinearComb(t *testing.T, x *e_nocarry_0604, xC int64, y *e_nocarry_0604, yC int64) {
	...
	var z e_nocarry_0604
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0604, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0604
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0604, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0604
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0604, xHi uint64) {
	var res e_nocarry_0604
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0604) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0604) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0604, c int64, result *e_nocarry_0604, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0604) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0604) uint64 {
