...
var benchRese_nocarry_0416 e_nocarry_0416

func BenchmarkE_nocarry_0416SetBytes(b *testing.B) {
	var x e_nocarry_0416
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0416MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0416.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0416)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0416)
		}
	})
}

func BenchmarkE_nocarry_0416Inverse(b *testing.B) {
	var x e_nocarry_0416
	x.SetRandom()
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0416Butterfly(b *testing.B) {
	var x e_nocarry_0416
	x.SetRandom()
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0416)
	}
}

func BenchmarkE_nocarry_0416Exp(b *testing.B) {
	var x e_nocarry_0416
	x.SetRandom()
	benchRese_nocarry_0416.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0416Double(b *testing.B) {
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Double(&benchRese_nocarry_0416)
	}
}

func BenchmarkE_nocarry_0416Add(b *testing.B) {
	var x e_nocarry_0416
	x.SetRandom()
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Add(&x, &benchRese_nocarry_0416)
	}
}

func BenchmarkE_nocarry_0416Sub(b *testing.B) {
	var x e_nocarry_0416
	x.SetRandom()
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Sub(&x, &benchRese_nocarry_0416)
	}
}

func BenchmarkE_nocarry_0416Neg(b *testing.B) {
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Neg(&benchRese_nocarry_0416)
	}
}

func BenchmarkE_nocarry_0416Div(b *testing.B) {
	var x e_nocarry_0416
	x.SetRandom()
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Div(&x, &benchRese_nocarry_0416)
	}
}

func BenchmarkE_nocarry_0416FromMont(b *testing.B) {
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.FromMont()
	}
}

func BenchmarkE_nocarry_0416ToMont(b *testing.B) {
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.ToMont()
	}
}
func BenchmarkE_nocarry_0416Square(b *testing.B) {
	benchRese_nocarry_0416.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Square(&benchRese_nocarry_0416)
	}
}

func BenchmarkE_nocarry_0416Sqrt(b *testing.B) {
	var a e_nocarry_0416
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0416Mul(b *testing.B) {
	x := e_nocarry_0416{
		8657231220140772819,
		4228692638981286595,
	...
	benchRese_nocarry_0416.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Mul(&benchRese_nocarry_0416, &x)
	}
}

func BenchmarkE_nocarry_0416Cmp(b *testing.B) {
	x := e_nocarry_0416{
		8657231220140772819,
		4228692638981286595,
		15268109188630029018,
	...
	benchRese_nocarry_0416 = x
	benchRese_nocarry_0416[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0416.Cmp(&x)
	}
}

func TestE_nocarry_0416Cmp(t *testing.T) {
	var x, y e_nocarry_0416
...
func TestE_nocarry_0416IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0416
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0416

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0416{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0416
	one.SetOne()
	e.Sub(&qe_nocarry_0416, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0416{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0416{0, uint64(i)})
	}
...
func TestE_nocarry_0416NegZero(t *testing.T) {
	var a, b e_nocarry_0416
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0416Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0416, len(staticTestValues))
...
func TestE_nocarry_0416Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0416) bool {
			var b e_nocarry_0416
...
func TestE_nocarry_0416InverseExp(t *testing.T) {
...
func TestE_nocarry_0416MulByConstants(t *testing.T) {
...
func TestE_nocarry_0416Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0416) bool {
...
func TestE_nocarry_0416LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0416Halve(t *testing.T) {
...
func TestE_nocarry_0416FromMont(t *testing.T) {
...
type testPaire_nocarry_0416 struct {
	element e_nocarry_0416
	bigint  big.Int
}

func (z *e_nocarry_0416) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0416[6] {
		return true
	}
	if z[6] < qe_nocarry_0416[6] {
		return false
	...
	return z[0] >= qe_nocarry_0416[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0416

		g.element = e_nocarry_0416{
		...
		if qe_nocarry_0416[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0416[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0416 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0416[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0416[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0416[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0416[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0416[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0416[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0416[6], carry)
...
func Benchmarke_nocarry_0416InverseNew(b *testing.B) {
	var x e_nocarry_0416
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0416
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0416
		var xInv e_nocarry_0416
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0416
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0416
...
func testLinearComb(t *testing.T, x *e_nocarry_0416, xC int64, y *e_nocarry_0416, yC int64) {
	...
	var z e_nocarry_0416
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0416, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0416
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0416, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0416
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0416, xHi uint64) {
	var res e_nocarry_0416
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0416) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0416) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0416, c int64, result *e_nocarry_0416, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0416) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0416) uint64 {
