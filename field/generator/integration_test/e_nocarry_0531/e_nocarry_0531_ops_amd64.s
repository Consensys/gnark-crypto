...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x35dc70e62a1eb299, R12
	ADDQ R12, AX
	MOVQ $0xec0b041e8ed7f505, R12
	ADCQ R12, DX
	MOVQ $0x1d3908c91e5a53ce, R12
	ADCQ R12, CX
	MOVQ $0x719ddc7cf1bf8ccb, R12
	ADCQ R12, BX
	MOVQ $0xe3fe0458b71dc38a, R12
	ADCQ R12, SI
	MOVQ $0x7d9cccef17f4b4f2, R12
	ADCQ R12, DI
	MOVQ $0xf1de4b1d6dce53f0, R12
	ADCQ R12, R8
	MOVQ $0xbcd6a7ffdcc284ae, R12
	ADCQ R12, R9
	MOVQ $0x0000000000070562, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x35dc70e62a1eb299, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xec0b041e8ed7f505, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x1d3908c91e5a53ce, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x719ddc7cf1bf8ccb, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xe3fe0458b71dc38a, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x7d9cccef17f4b4f2, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xf1de4b1d6dce53f0, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xbcd6a7ffdcc284ae, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000000070562, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x35dc70e62a1eb299, AX
	ADDQ AX, DX
	MOVQ $0xec0b041e8ed7f505, AX
	ADCQ AX, CX
	MOVQ $0x1d3908c91e5a53ce, AX
	ADCQ AX, BX
	MOVQ $0x719ddc7cf1bf8ccb, AX
	ADCQ AX, SI
	MOVQ $0xe3fe0458b71dc38a, AX
	ADCQ AX, DI
	MOVQ $0x7d9cccef17f4b4f2, AX
	ADCQ AX, R8
	MOVQ $0xf1de4b1d6dce53f0, AX
	ADCQ AX, R9
	MOVQ $0xbcd6a7ffdcc284ae, AX
	ADCQ AX, R10
	MOVQ $0x0000000000070562, AX
	ADCQ AX, R11
