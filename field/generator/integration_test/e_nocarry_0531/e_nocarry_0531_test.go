...
var benchRese_nocarry_0531 e_nocarry_0531

func BenchmarkE_nocarry_0531SetBytes(b *testing.B) {
	var x e_nocarry_0531
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0531MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0531.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0531)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0531)
		}
	})
}

func BenchmarkE_nocarry_0531Inverse(b *testing.B) {
	var x e_nocarry_0531
	x.SetRandom()
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0531Butterfly(b *testing.B) {
	var x e_nocarry_0531
	x.SetRandom()
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0531)
	}
}

func BenchmarkE_nocarry_0531Exp(b *testing.B) {
	var x e_nocarry_0531
	x.SetRandom()
	benchRese_nocarry_0531.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0531Double(b *testing.B) {
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Double(&benchRese_nocarry_0531)
	}
}

func BenchmarkE_nocarry_0531Add(b *testing.B) {
	var x e_nocarry_0531
	x.SetRandom()
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Add(&x, &benchRese_nocarry_0531)
	}
}

func BenchmarkE_nocarry_0531Sub(b *testing.B) {
	var x e_nocarry_0531
	x.SetRandom()
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Sub(&x, &benchRese_nocarry_0531)
	}
}

func BenchmarkE_nocarry_0531Neg(b *testing.B) {
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Neg(&benchRese_nocarry_0531)
	}
}

func BenchmarkE_nocarry_0531Div(b *testing.B) {
	var x e_nocarry_0531
	x.SetRandom()
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Div(&x, &benchRese_nocarry_0531)
	}
}

func BenchmarkE_nocarry_0531FromMont(b *testing.B) {
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.FromMont()
	}
}

func BenchmarkE_nocarry_0531ToMont(b *testing.B) {
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.ToMont()
	}
}
func BenchmarkE_nocarry_0531Square(b *testing.B) {
	benchRese_nocarry_0531.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Square(&benchRese_nocarry_0531)
	}
}

func BenchmarkE_nocarry_0531Sqrt(b *testing.B) {
	var a e_nocarry_0531
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0531Mul(b *testing.B) {
	x := e_nocarry_0531{
		3597004335239857475,
		6535935333814278522,
		4532020937899802205,
	...
	benchRese_nocarry_0531.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Mul(&benchRese_nocarry_0531, &x)
	}
}

func BenchmarkE_nocarry_0531Cmp(b *testing.B) {
	x := e_nocarry_0531{
		3597004335239857475,
		6535935333814278522,
		4532020937899802205,
	...
	benchRese_nocarry_0531 = x
	benchRese_nocarry_0531[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0531.Cmp(&x)
	}
}

func TestE_nocarry_0531Cmp(t *testing.T) {
	var x, y e_nocarry_0531
...
func TestE_nocarry_0531IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0531
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0531

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0531{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0531
	one.SetOne()
	e.Sub(&qe_nocarry_0531, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0531{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0531{0, uint64(i)})
	}
...
func TestE_nocarry_0531NegZero(t *testing.T) {
	var a, b e_nocarry_0531
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0531Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0531, len(staticTestValues))
...
func TestE_nocarry_0531Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0531) bool {
			var b e_nocarry_0531
...
func TestE_nocarry_0531InverseExp(t *testing.T) {
...
func TestE_nocarry_0531MulByConstants(t *testing.T) {
...
func TestE_nocarry_0531Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0531) bool {
...
func TestE_nocarry_0531LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0531Halve(t *testing.T) {
...
func TestE_nocarry_0531FromMont(t *testing.T) {
...
type testPaire_nocarry_0531 struct {
	element e_nocarry_0531
	bigint  big.Int
}

func (z *e_nocarry_0531) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0531[8] {
		return true
	}
	if z[8] < qe_nocarry_0531[8] {
		return false
	...
	return z[0] >= qe_nocarry_0531[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0531

		g.element = e_nocarry_0531{
		...
		if qe_nocarry_0531[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0531[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0531 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0531[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0531[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0531[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0531[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0531[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0531[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0531[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0531[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0531[8], carry)
...
func Benchmarke_nocarry_0531InverseNew(b *testing.B) {
	var x e_nocarry_0531
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0531
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0531
		var xInv e_nocarry_0531
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0531
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0531
...
func testLinearComb(t *testing.T, x *e_nocarry_0531, xC int64, y *e_nocarry_0531, yC int64) {
	...
	var z e_nocarry_0531
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0531, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0531
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0531, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0531
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0531, xHi uint64) {
	var res e_nocarry_0531
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0531) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0531) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0531, c int64, result *e_nocarry_0531, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0531) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0531) uint64 {
