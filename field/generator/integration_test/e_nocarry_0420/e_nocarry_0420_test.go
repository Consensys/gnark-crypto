...
var benchRese_nocarry_0420 e_nocarry_0420

func BenchmarkE_nocarry_0420SetBytes(b *testing.B) {
	var x e_nocarry_0420
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0420MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0420.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0420)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0420)
		}
	})
}

func BenchmarkE_nocarry_0420Inverse(b *testing.B) {
	var x e_nocarry_0420
	x.SetRandom()
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0420Butterfly(b *testing.B) {
	var x e_nocarry_0420
	x.SetRandom()
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0420)
	}
}

func BenchmarkE_nocarry_0420Exp(b *testing.B) {
	var x e_nocarry_0420
	x.SetRandom()
	benchRese_nocarry_0420.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0420Double(b *testing.B) {
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Double(&benchRese_nocarry_0420)
	}
}

func BenchmarkE_nocarry_0420Add(b *testing.B) {
	var x e_nocarry_0420
	x.SetRandom()
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Add(&x, &benchRese_nocarry_0420)
	}
}

func BenchmarkE_nocarry_0420Sub(b *testing.B) {
	var x e_nocarry_0420
	x.SetRandom()
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Sub(&x, &benchRese_nocarry_0420)
	}
}

func BenchmarkE_nocarry_0420Neg(b *testing.B) {
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Neg(&benchRese_nocarry_0420)
	}
}

func BenchmarkE_nocarry_0420Div(b *testing.B) {
	var x e_nocarry_0420
	x.SetRandom()
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Div(&x, &benchRese_nocarry_0420)
	}
}

func BenchmarkE_nocarry_0420FromMont(b *testing.B) {
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.FromMont()
	}
}

func BenchmarkE_nocarry_0420ToMont(b *testing.B) {
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.ToMont()
	}
}
func BenchmarkE_nocarry_0420Square(b *testing.B) {
	benchRese_nocarry_0420.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Square(&benchRese_nocarry_0420)
	}
}

func BenchmarkE_nocarry_0420Sqrt(b *testing.B) {
	var a e_nocarry_0420
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0420Mul(b *testing.B) {
	x := e_nocarry_0420{
		7232790120389586003,
		5211258127258020456,
	...
	benchRese_nocarry_0420.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Mul(&benchRese_nocarry_0420, &x)
	}
}

func BenchmarkE_nocarry_0420Cmp(b *testing.B) {
	x := e_nocarry_0420{
		7232790120389586003,
		5211258127258020456,
		13191803415402458839,
	...
	benchRese_nocarry_0420 = x
	benchRese_nocarry_0420[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0420.Cmp(&x)
	}
}

func TestE_nocarry_0420Cmp(t *testing.T) {
	var x, y e_nocarry_0420
...
func TestE_nocarry_0420IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0420
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0420

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0420{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0420
	one.SetOne()
	e.Sub(&qe_nocarry_0420, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0420{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0420{0, uint64(i)})
	}
...
func TestE_nocarry_0420NegZero(t *testing.T) {
	var a, b e_nocarry_0420
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0420Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0420, len(staticTestValues))
...
func TestE_nocarry_0420Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0420) bool {
			var b e_nocarry_0420
...
func TestE_nocarry_0420InverseExp(t *testing.T) {
...
func TestE_nocarry_0420MulByConstants(t *testing.T) {
...
func TestE_nocarry_0420Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0420) bool {
...
func TestE_nocarry_0420LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0420Halve(t *testing.T) {
...
func TestE_nocarry_0420FromMont(t *testing.T) {
...
type testPaire_nocarry_0420 struct {
	element e_nocarry_0420
	bigint  big.Int
}

func (z *e_nocarry_0420) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0420[6] {
		return true
	}
	if z[6] < qe_nocarry_0420[6] {
		return false
	...
	return z[0] >= qe_nocarry_0420[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0420

		g.element = e_nocarry_0420{
		...
		if qe_nocarry_0420[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0420[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0420 {
			var g e_nocarry_0420
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0420[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0420[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0420[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0420[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0420[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0420[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0420[6], carry)
...
func Benchmarke_nocarry_0420InverseNew(b *testing.B) {
	var x e_nocarry_0420
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0420
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0420
		var xInv e_nocarry_0420
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0420
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0420
...
func testLinearComb(t *testing.T, x *e_nocarry_0420, xC int64, y *e_nocarry_0420, yC int64) {
	...
	var z e_nocarry_0420
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0420, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0420
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0420, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0420
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0420, xHi uint64) {
	var res e_nocarry_0420
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0420) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0420) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0420, c int64, result *e_nocarry_0420, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0420) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0420) uint64 {
