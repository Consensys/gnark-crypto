...
var benchRese_nocarry_0480 e_nocarry_0480

func BenchmarkE_nocarry_0480SetBytes(b *testing.B) {
	var x e_nocarry_0480
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0480MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0480.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0480)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0480)
		}
	})
}

func BenchmarkE_nocarry_0480Inverse(b *testing.B) {
	var x e_nocarry_0480
	x.SetRandom()
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0480Butterfly(b *testing.B) {
	var x e_nocarry_0480
	x.SetRandom()
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0480)
	}
}

func BenchmarkE_nocarry_0480Exp(b *testing.B) {
	var x e_nocarry_0480
	x.SetRandom()
	benchRese_nocarry_0480.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0480Double(b *testing.B) {
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Double(&benchRese_nocarry_0480)
	}
}

func BenchmarkE_nocarry_0480Add(b *testing.B) {
	var x e_nocarry_0480
	x.SetRandom()
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Add(&x, &benchRese_nocarry_0480)
	}
}

func BenchmarkE_nocarry_0480Sub(b *testing.B) {
	var x e_nocarry_0480
	x.SetRandom()
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Sub(&x, &benchRese_nocarry_0480)
	}
}

func BenchmarkE_nocarry_0480Neg(b *testing.B) {
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Neg(&benchRese_nocarry_0480)
	}
}

func BenchmarkE_nocarry_0480Div(b *testing.B) {
	var x e_nocarry_0480
	x.SetRandom()
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Div(&x, &benchRese_nocarry_0480)
	}
}

func BenchmarkE_nocarry_0480FromMont(b *testing.B) {
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.FromMont()
	}
}

func BenchmarkE_nocarry_0480ToMont(b *testing.B) {
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.ToMont()
	}
}
func BenchmarkE_nocarry_0480Square(b *testing.B) {
	benchRese_nocarry_0480.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Square(&benchRese_nocarry_0480)
	}
}

func BenchmarkE_nocarry_0480Sqrt(b *testing.B) {
	var a e_nocarry_0480
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0480Mul(b *testing.B) {
	x := e_nocarry_0480{
	...
	benchRese_nocarry_0480.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Mul(&benchRese_nocarry_0480, &x)
	}
}

func BenchmarkE_nocarry_0480Cmp(b *testing.B) {
	x := e_nocarry_0480{
		15828328987374811196,
		10853269492209542033,
		1833225238900659787,
	...
	benchRese_nocarry_0480 = x
	benchRese_nocarry_0480[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0480.Cmp(&x)
	}
}

func TestE_nocarry_0480Cmp(t *testing.T) {
	var x, y e_nocarry_0480
...
func TestE_nocarry_0480IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0480
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0480

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0480{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0480
	one.SetOne()
	e.Sub(&qe_nocarry_0480, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0480{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0480{0, uint64(i)})
	}
...
func TestE_nocarry_0480NegZero(t *testing.T) {
	var a, b e_nocarry_0480
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0480Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0480, len(staticTestValues))
...
func TestE_nocarry_0480Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0480) bool {
			var b e_nocarry_0480
...
func TestE_nocarry_0480InverseExp(t *testing.T) {
...
func TestE_nocarry_0480MulByConstants(t *testing.T) {
...
func TestE_nocarry_0480Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0480) bool {
...
func TestE_nocarry_0480LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0480Halve(t *testing.T) {
...
func TestE_nocarry_0480FromMont(t *testing.T) {
...
type testPaire_nocarry_0480 struct {
	element e_nocarry_0480
	bigint  big.Int
}

func (z *e_nocarry_0480) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0480[7] {
		return true
	}
	if z[7] < qe_nocarry_0480[7] {
		return false
	...
	return z[0] >= qe_nocarry_0480[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0480

		g.element = e_nocarry_0480{
		...
		if qe_nocarry_0480[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0480[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0480 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0480[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0480[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0480[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0480[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0480[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0480[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0480[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0480[7], carry)
...
func Benchmarke_nocarry_0480InverseNew(b *testing.B) {
	var x e_nocarry_0480
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0480
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0480
		var xInv e_nocarry_0480
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0480
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0480
...
func testLinearComb(t *testing.T, x *e_nocarry_0480, xC int64, y *e_nocarry_0480, yC int64) {
	...
	var z e_nocarry_0480
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0480, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0480
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0480, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0480
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0480, xHi uint64) {
	var res e_nocarry_0480
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0480) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0480) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0480, c int64, result *e_nocarry_0480, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0480) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0480) uint64 {
