...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x1b5523c5ab739309, R13
	ADDQ R13, AX
	MOVQ $0x0422b5a8fa170810, R13
	ADCQ R13, DX
	MOVQ $0xb5721be808e88223, R13
	ADCQ R13, CX
	MOVQ $0x8703c062ef6fb283, R13
	ADCQ R13, BX
	MOVQ $0xdded17c572741141, R13
	ADCQ R13, SI
	MOVQ $0x4f8afd749d56cbe1, R13
	ADCQ R13, DI
	MOVQ $0x3f27509af1e18c8d, R13
	ADCQ R13, R8
	MOVQ $0xd4329ea00c8816db, R13
	ADCQ R13, R9
	MOVQ $0xf0db97007fbb993c, R13
	ADCQ R13, R10
	MOVQ $0x0000003cee56f512, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x1b5523c5ab739309, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x0422b5a8fa170810, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xb5721be808e88223, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x8703c062ef6fb283, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xdded17c572741141, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x4f8afd749d56cbe1, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x3f27509af1e18c8d, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xd4329ea00c8816db, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xf0db97007fbb993c, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000003cee56f512, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x1b5523c5ab739309, AX
	ADDQ AX, DX
	MOVQ $0x0422b5a8fa170810, AX
	ADCQ AX, CX
	MOVQ $0xb5721be808e88223, AX
	ADCQ AX, BX
	MOVQ $0x8703c062ef6fb283, AX
	ADCQ AX, SI
	MOVQ $0xdded17c572741141, AX
	ADCQ AX, DI
	MOVQ $0x4f8afd749d56cbe1, AX
	ADCQ AX, R8
	MOVQ $0x3f27509af1e18c8d, AX
	ADCQ AX, R9
	MOVQ $0xd4329ea00c8816db, AX
	ADCQ AX, R10
	MOVQ $0xf0db97007fbb993c, AX
	ADCQ AX, R11
	MOVQ $0x0000003cee56f512, AX
	ADCQ AX, R12
