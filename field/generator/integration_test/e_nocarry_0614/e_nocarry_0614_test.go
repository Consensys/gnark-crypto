...
var benchRese_nocarry_0614 e_nocarry_0614

func BenchmarkE_nocarry_0614SetBytes(b *testing.B) {
	var x e_nocarry_0614
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0614MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0614.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0614)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0614)
		}
	})
}

func BenchmarkE_nocarry_0614Inverse(b *testing.B) {
	var x e_nocarry_0614
	x.SetRandom()
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0614Butterfly(b *testing.B) {
	var x e_nocarry_0614
	x.SetRandom()
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0614)
	}
}

func BenchmarkE_nocarry_0614Exp(b *testing.B) {
	var x e_nocarry_0614
	x.SetRandom()
	benchRese_nocarry_0614.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0614Double(b *testing.B) {
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Double(&benchRese_nocarry_0614)
	}
}

func BenchmarkE_nocarry_0614Add(b *testing.B) {
	var x e_nocarry_0614
	x.SetRandom()
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Add(&x, &benchRese_nocarry_0614)
	}
}

func BenchmarkE_nocarry_0614Sub(b *testing.B) {
	var x e_nocarry_0614
	x.SetRandom()
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Sub(&x, &benchRese_nocarry_0614)
	}
}

func BenchmarkE_nocarry_0614Neg(b *testing.B) {
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Neg(&benchRese_nocarry_0614)
	}
}

func BenchmarkE_nocarry_0614Div(b *testing.B) {
	var x e_nocarry_0614
	x.SetRandom()
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Div(&x, &benchRese_nocarry_0614)
	}
}

func BenchmarkE_nocarry_0614FromMont(b *testing.B) {
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.FromMont()
	}
}

func BenchmarkE_nocarry_0614ToMont(b *testing.B) {
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.ToMont()
	}
}
func BenchmarkE_nocarry_0614Square(b *testing.B) {
	benchRese_nocarry_0614.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Square(&benchRese_nocarry_0614)
	}
}

func BenchmarkE_nocarry_0614Sqrt(b *testing.B) {
	var a e_nocarry_0614
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0614Mul(b *testing.B) {
	x := e_nocarry_0614{
		6334976564298282066,
		4256497253688892023,
	...
	benchRese_nocarry_0614.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Mul(&benchRese_nocarry_0614, &x)
	}
}

func BenchmarkE_nocarry_0614Cmp(b *testing.B) {
	x := e_nocarry_0614{
		6334976564298282066,
		4256497253688892023,
		12783743251357434121,
	...
	benchRese_nocarry_0614 = x
	benchRese_nocarry_0614[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0614.Cmp(&x)
	}
}

func TestE_nocarry_0614Cmp(t *testing.T) {
	var x, y e_nocarry_0614
...
func TestE_nocarry_0614IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0614
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0614

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0614{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0614
	one.SetOne()
	e.Sub(&qe_nocarry_0614, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0614{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0614{0, uint64(i)})
	}
...
func TestE_nocarry_0614NegZero(t *testing.T) {
	var a, b e_nocarry_0614
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0614Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0614, len(staticTestValues))
...
func TestE_nocarry_0614Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0614) bool {
			var b e_nocarry_0614
...
func TestE_nocarry_0614InverseExp(t *testing.T) {
...
func TestE_nocarry_0614MulByConstants(t *testing.T) {
...
func TestE_nocarry_0614Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0614) bool {
...
func TestE_nocarry_0614LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0614Halve(t *testing.T) {
...
func TestE_nocarry_0614FromMont(t *testing.T) {
...
type testPaire_nocarry_0614 struct {
	element e_nocarry_0614
	bigint  big.Int
}

func (z *e_nocarry_0614) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0614[9] {
		return true
	}
	if z[9] < qe_nocarry_0614[9] {
		return false
	...
	return z[0] >= qe_nocarry_0614[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0614

		g.element = e_nocarry_0614{
		...
		if qe_nocarry_0614[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0614[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0614 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0614[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0614[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0614[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0614[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0614[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0614[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0614[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0614[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0614[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0614[9], carry)
...
func Benchmarke_nocarry_0614InverseNew(b *testing.B) {
	var x e_nocarry_0614
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0614
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0614
		var xInv e_nocarry_0614
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0614
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0614
...
func testLinearComb(t *testing.T, x *e_nocarry_0614, xC int64, y *e_nocarry_0614, yC int64) {
	...
	var z e_nocarry_0614
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0614, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0614
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0614, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0614
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0614, xHi uint64) {
	var res e_nocarry_0614
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0614) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0614) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0614, c int64, result *e_nocarry_0614, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0614) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0614) uint64 {
