...
var benchRese_nocarry_0426 e_nocarry_0426

func BenchmarkE_nocarry_0426SetBytes(b *testing.B) {
	var x e_nocarry_0426
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0426MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0426.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0426)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0426)
		}
	})
}

func BenchmarkE_nocarry_0426Inverse(b *testing.B) {
	var x e_nocarry_0426
	x.SetRandom()
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0426Butterfly(b *testing.B) {
	var x e_nocarry_0426
	x.SetRandom()
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0426)
	}
}

func BenchmarkE_nocarry_0426Exp(b *testing.B) {
	var x e_nocarry_0426
	x.SetRandom()
	benchRese_nocarry_0426.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0426Double(b *testing.B) {
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Double(&benchRese_nocarry_0426)
	}
}

func BenchmarkE_nocarry_0426Add(b *testing.B) {
	var x e_nocarry_0426
	x.SetRandom()
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Add(&x, &benchRese_nocarry_0426)
	}
}

func BenchmarkE_nocarry_0426Sub(b *testing.B) {
	var x e_nocarry_0426
	x.SetRandom()
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Sub(&x, &benchRese_nocarry_0426)
	}
}

func BenchmarkE_nocarry_0426Neg(b *testing.B) {
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Neg(&benchRese_nocarry_0426)
	}
}

func BenchmarkE_nocarry_0426Div(b *testing.B) {
	var x e_nocarry_0426
	x.SetRandom()
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Div(&x, &benchRese_nocarry_0426)
	}
}

func BenchmarkE_nocarry_0426FromMont(b *testing.B) {
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.FromMont()
	}
}

func BenchmarkE_nocarry_0426ToMont(b *testing.B) {
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.ToMont()
	}
}
func BenchmarkE_nocarry_0426Square(b *testing.B) {
	benchRese_nocarry_0426.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Square(&benchRese_nocarry_0426)
	}
}

func BenchmarkE_nocarry_0426Sqrt(b *testing.B) {
	var a e_nocarry_0426
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0426Mul(b *testing.B) {
	x := e_nocarry_0426{
		7623697386936901683,
		3307603330958785002,
	...
	benchRese_nocarry_0426.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Mul(&benchRese_nocarry_0426, &x)
	}
}

func BenchmarkE_nocarry_0426Cmp(b *testing.B) {
	x := e_nocarry_0426{
		7623697386936901683,
		3307603330958785002,
		13514197385147166180,
	...
	benchRese_nocarry_0426 = x
	benchRese_nocarry_0426[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0426.Cmp(&x)
	}
}

func TestE_nocarry_0426Cmp(t *testing.T) {
	var x, y e_nocarry_0426
...
func TestE_nocarry_0426IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0426
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0426

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0426{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0426
	one.SetOne()
	e.Sub(&qe_nocarry_0426, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0426{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0426{0, uint64(i)})
	}
...
func TestE_nocarry_0426NegZero(t *testing.T) {
	var a, b e_nocarry_0426
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0426Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0426, len(staticTestValues))
...
func TestE_nocarry_0426Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0426) bool {
			var b e_nocarry_0426
...
func TestE_nocarry_0426InverseExp(t *testing.T) {
...
func TestE_nocarry_0426MulByConstants(t *testing.T) {
...
func TestE_nocarry_0426Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0426) bool {
...
func TestE_nocarry_0426LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0426Halve(t *testing.T) {
...
func TestE_nocarry_0426FromMont(t *testing.T) {
...
type testPaire_nocarry_0426 struct {
	element e_nocarry_0426
	bigint  big.Int
}

func (z *e_nocarry_0426) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0426[6] {
		return true
	}
	if z[6] < qe_nocarry_0426[6] {
		return false
	...
	return z[0] >= qe_nocarry_0426[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0426

		g.element = e_nocarry_0426{
		...
		if qe_nocarry_0426[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0426[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0426 {
			var g e_nocarry_0426
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0426[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0426[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0426[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0426[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0426[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0426[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0426[6], carry)
...
func Benchmarke_nocarry_0426InverseNew(b *testing.B) {
	var x e_nocarry_0426
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0426
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0426
		var xInv e_nocarry_0426
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0426
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0426
...
func testLinearComb(t *testing.T, x *e_nocarry_0426, xC int64, y *e_nocarry_0426, yC int64) {
	...
	var z e_nocarry_0426
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0426, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0426
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0426, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0426
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0426, xHi uint64) {
	var res e_nocarry_0426
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0426) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0426) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0426, c int64, result *e_nocarry_0426, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0426) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0426) uint64 {
