...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x8432ad9d8316b559, R12
	ADDQ R12, AX
	MOVQ $0xe148799ef64c5242, R12
	ADCQ R12, DX
	MOVQ $0xd8382e1725d4a26e, R12
	ADCQ R12, CX
	MOVQ $0xe37bb79309c0a92c, R12
	ADCQ R12, BX
	MOVQ $0xa044c7e4dfd73d88, R12
	ADCQ R12, SI
	MOVQ $0xd3c912dd6dca89b2, R12
	ADCQ R12, DI
	MOVQ $0x51f3d566fbf66812, R12
	ADCQ R12, R8
	MOVQ $0x93e4e7325bdc9c26, R12
	ADCQ R12, R9
	MOVQ $0x000000000033049e, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x8432ad9d8316b559, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xe148799ef64c5242, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xd8382e1725d4a26e, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xe37bb79309c0a92c, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xa044c7e4dfd73d88, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xd3c912dd6dca89b2, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x51f3d566fbf66812, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x93e4e7325bdc9c26, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000000033049e, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x8432ad9d8316b559, AX
	ADDQ AX, DX
	MOVQ $0xe148799ef64c5242, AX
	ADCQ AX, CX
	MOVQ $0xd8382e1725d4a26e, AX
	ADCQ AX, BX
	MOVQ $0xe37bb79309c0a92c, AX
	ADCQ AX, SI
	MOVQ $0xa044c7e4dfd73d88, AX
	ADCQ AX, DI
	MOVQ $0xd3c912dd6dca89b2, AX
	ADCQ AX, R8
	MOVQ $0x51f3d566fbf66812, AX
	ADCQ AX, R9
	MOVQ $0x93e4e7325bdc9c26, AX
	ADCQ AX, R10
	MOVQ $0x000000000033049e, AX
	ADCQ AX, R11
