...
var benchRese_nocarry_0534 e_nocarry_0534

func BenchmarkE_nocarry_0534SetBytes(b *testing.B) {
	var x e_nocarry_0534
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0534MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0534.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0534)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0534)
		}
	})
}

func BenchmarkE_nocarry_0534Inverse(b *testing.B) {
	var x e_nocarry_0534
	x.SetRandom()
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0534Butterfly(b *testing.B) {
	var x e_nocarry_0534
	x.SetRandom()
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0534)
	}
}

func BenchmarkE_nocarry_0534Exp(b *testing.B) {
	var x e_nocarry_0534
	x.SetRandom()
	benchRese_nocarry_0534.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0534Double(b *testing.B) {
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Double(&benchRese_nocarry_0534)
	}
}

func BenchmarkE_nocarry_0534Add(b *testing.B) {
	var x e_nocarry_0534
	x.SetRandom()
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Add(&x, &benchRese_nocarry_0534)
	}
}

func BenchmarkE_nocarry_0534Sub(b *testing.B) {
	var x e_nocarry_0534
	x.SetRandom()
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Sub(&x, &benchRese_nocarry_0534)
	}
}

func BenchmarkE_nocarry_0534Neg(b *testing.B) {
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Neg(&benchRese_nocarry_0534)
	}
}

func BenchmarkE_nocarry_0534Div(b *testing.B) {
	var x e_nocarry_0534
	x.SetRandom()
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Div(&x, &benchRese_nocarry_0534)
	}
}

func BenchmarkE_nocarry_0534FromMont(b *testing.B) {
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.FromMont()
	}
}

func BenchmarkE_nocarry_0534ToMont(b *testing.B) {
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.ToMont()
	}
}
func BenchmarkE_nocarry_0534Square(b *testing.B) {
	benchRese_nocarry_0534.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Square(&benchRese_nocarry_0534)
	}
}

func BenchmarkE_nocarry_0534Sqrt(b *testing.B) {
	var a e_nocarry_0534
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0534Mul(b *testing.B) {
	x := e_nocarry_0534{
	...
	benchRese_nocarry_0534.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Mul(&benchRese_nocarry_0534, &x)
	}
}

func BenchmarkE_nocarry_0534Cmp(b *testing.B) {
	x := e_nocarry_0534{
		16670837374147172565,
		46343741929071901,
		14019732610784462255,
	...
	benchRese_nocarry_0534 = x
	benchRese_nocarry_0534[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0534.Cmp(&x)
	}
}

func TestE_nocarry_0534Cmp(t *testing.T) {
	var x, y e_nocarry_0534
...
func TestE_nocarry_0534IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0534
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0534

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0534{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0534
	one.SetOne()
	e.Sub(&qe_nocarry_0534, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0534{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0534{0, uint64(i)})
	}
...
func TestE_nocarry_0534NegZero(t *testing.T) {
	var a, b e_nocarry_0534
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0534Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0534, len(staticTestValues))
...
func TestE_nocarry_0534Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0534) bool {
			var b e_nocarry_0534
...
func TestE_nocarry_0534InverseExp(t *testing.T) {
...
func TestE_nocarry_0534MulByConstants(t *testing.T) {
...
func TestE_nocarry_0534Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0534) bool {
...
func TestE_nocarry_0534LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0534Halve(t *testing.T) {
...
func TestE_nocarry_0534FromMont(t *testing.T) {
...
type testPaire_nocarry_0534 struct {
	element e_nocarry_0534
	bigint  big.Int
}

func (z *e_nocarry_0534) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0534[8] {
		return true
	}
	if z[8] < qe_nocarry_0534[8] {
		return false
	...
	return z[0] >= qe_nocarry_0534[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0534

		g.element = e_nocarry_0534{
		...
		if qe_nocarry_0534[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0534[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0534 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0534[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0534[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0534[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0534[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0534[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0534[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0534[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0534[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0534[8], carry)
...
func Benchmarke_nocarry_0534InverseNew(b *testing.B) {
	var x e_nocarry_0534
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0534
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0534
		var xInv e_nocarry_0534
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0534
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0534
...
func testLinearComb(t *testing.T, x *e_nocarry_0534, xC int64, y *e_nocarry_0534, yC int64) {
	...
	var z e_nocarry_0534
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0534, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0534
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0534, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0534
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0534, xHi uint64) {
	var res e_nocarry_0534
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0534) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0534) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0534, c int64, result *e_nocarry_0534, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0534) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0534) uint64 {
