...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x6b0555d27ed7ed07, R14
	ADDQ R14, AX
	MOVQ $0x36d1183f00683c20, R14
	ADCQ R14, DX
	MOVQ $0x5269285121c659c5, R14
	ADCQ R14, CX
	MOVQ $0xa7ec8c31ce9b20dc, R14
	ADCQ R14, BX
	MOVQ $0x4e1b1f3eaecb5ee6, R14
	ADCQ R14, SI
	MOVQ $0xc02e6ad3a1743d0f, R14
	ADCQ R14, DI
	MOVQ $0xefb4e22da44447fd, R14
	ADCQ R14, R8
	MOVQ $0x2ddb80bb1beb9fcd, R14
	ADCQ R14, R9
	MOVQ $0x47067456e4c18959, R14
	ADCQ R14, R10
	MOVQ $0x33bf1edee347aa70, R14
	ADCQ R14, R11
	MOVQ $0x0ce819264d6290d1, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x6b0555d27ed7ed07, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x36d1183f00683c20, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x5269285121c659c5, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xa7ec8c31ce9b20dc, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x4e1b1f3eaecb5ee6, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xc02e6ad3a1743d0f, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xefb4e22da44447fd, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x2ddb80bb1beb9fcd, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x47067456e4c18959, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x33bf1edee347aa70, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0ce819264d6290d1, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x6b0555d27ed7ed07, AX
	ADDQ AX, DX
	MOVQ $0x36d1183f00683c20, AX
	ADCQ AX, CX
	MOVQ $0x5269285121c659c5, AX
	ADCQ AX, BX
	MOVQ $0xa7ec8c31ce9b20dc, AX
	ADCQ AX, SI
	MOVQ $0x4e1b1f3eaecb5ee6, AX
	ADCQ AX, DI
	MOVQ $0xc02e6ad3a1743d0f, AX
	ADCQ AX, R8
	MOVQ $0xefb4e22da44447fd, AX
	ADCQ AX, R9
	MOVQ $0x2ddb80bb1beb9fcd, AX
	ADCQ AX, R10
	MOVQ $0x47067456e4c18959, AX
	ADCQ AX, R11
	MOVQ $0x33bf1edee347aa70, AX
	ADCQ AX, R12
	MOVQ $0x0ce819264d6290d1, AX
	ADCQ AX, R13
