...
var benchRese_nocarry_0700 e_nocarry_0700

func BenchmarkE_nocarry_0700SetBytes(b *testing.B) {
	var x e_nocarry_0700
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0700MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0700.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0700)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0700)
		}
	})
}

func BenchmarkE_nocarry_0700Inverse(b *testing.B) {
	var x e_nocarry_0700
	x.SetRandom()
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0700Butterfly(b *testing.B) {
	var x e_nocarry_0700
	x.SetRandom()
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0700)
	}
}

func BenchmarkE_nocarry_0700Exp(b *testing.B) {
	var x e_nocarry_0700
	x.SetRandom()
	benchRese_nocarry_0700.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0700Double(b *testing.B) {
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Double(&benchRese_nocarry_0700)
	}
}

func BenchmarkE_nocarry_0700Add(b *testing.B) {
	var x e_nocarry_0700
	x.SetRandom()
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Add(&x, &benchRese_nocarry_0700)
	}
}

func BenchmarkE_nocarry_0700Sub(b *testing.B) {
	var x e_nocarry_0700
	x.SetRandom()
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Sub(&x, &benchRese_nocarry_0700)
	}
}

func BenchmarkE_nocarry_0700Neg(b *testing.B) {
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Neg(&benchRese_nocarry_0700)
	}
}

func BenchmarkE_nocarry_0700Div(b *testing.B) {
	var x e_nocarry_0700
	x.SetRandom()
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Div(&x, &benchRese_nocarry_0700)
	}
}

func BenchmarkE_nocarry_0700FromMont(b *testing.B) {
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.FromMont()
	}
}

func BenchmarkE_nocarry_0700ToMont(b *testing.B) {
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.ToMont()
	}
}
func BenchmarkE_nocarry_0700Square(b *testing.B) {
	benchRese_nocarry_0700.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Square(&benchRese_nocarry_0700)
	}
}

func BenchmarkE_nocarry_0700Sqrt(b *testing.B) {
	var a e_nocarry_0700
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0700Mul(b *testing.B) {
	x := e_nocarry_0700{
		5201792310739142594,
	...
	benchRese_nocarry_0700.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Mul(&benchRese_nocarry_0700, &x)
	}
}

func BenchmarkE_nocarry_0700Cmp(b *testing.B) {
	x := e_nocarry_0700{
		5201792310739142594,
		11161571703480681801,
		17013143924747227539,
	...
	benchRese_nocarry_0700 = x
	benchRese_nocarry_0700[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0700.Cmp(&x)
	}
}

func TestE_nocarry_0700Cmp(t *testing.T) {
	var x, y e_nocarry_0700
...
func TestE_nocarry_0700IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0700
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0700

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0700{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0700
	one.SetOne()
	e.Sub(&qe_nocarry_0700, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0700{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0700{0, uint64(i)})
	}
...
func TestE_nocarry_0700NegZero(t *testing.T) {
	var a, b e_nocarry_0700
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0700Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0700, len(staticTestValues))
...
func TestE_nocarry_0700Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0700) bool {
			var b e_nocarry_0700
...
func TestE_nocarry_0700InverseExp(t *testing.T) {
...
func TestE_nocarry_0700MulByConstants(t *testing.T) {
...
func TestE_nocarry_0700Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0700) bool {
...
func TestE_nocarry_0700LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0700Halve(t *testing.T) {
...
func TestE_nocarry_0700FromMont(t *testing.T) {
...
type testPaire_nocarry_0700 struct {
	element e_nocarry_0700
	bigint  big.Int
}

func (z *e_nocarry_0700) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0700[10] {
		return true
	}
	if z[10] < qe_nocarry_0700[10] {
		return false
	...
	return z[0] >= qe_nocarry_0700[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0700

		g.element = e_nocarry_0700{
		...
		if qe_nocarry_0700[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0700[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0700 {
			var g e_nocarry_0700
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0700[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0700[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0700[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0700[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0700[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0700[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0700[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0700[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0700[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0700[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0700[10], carry)
...
func Benchmarke_nocarry_0700InverseNew(b *testing.B) {
	var x e_nocarry_0700
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0700
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0700
		var xInv e_nocarry_0700
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0700
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0700
...
func testLinearComb(t *testing.T, x *e_nocarry_0700, xC int64, y *e_nocarry_0700, yC int64) {
	...
	var z e_nocarry_0700
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0700, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0700
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0700, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0700
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0700, xHi uint64) {
	var res e_nocarry_0700
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0700) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0700) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0700, c int64, result *e_nocarry_0700, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0700) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0700) uint64 {
