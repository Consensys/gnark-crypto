...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xaccec262d200f2f5, R12
	ADDQ R12, AX
	MOVQ $0xb7aaf5ced743d7ac, R12
	ADCQ R12, DX
	MOVQ $0xffc3d247cb9e0b59, R12
	ADCQ R12, CX
	MOVQ $0x07f44ed33e8b440c, R12
	ADCQ R12, BX
	MOVQ $0x1e25d8ce6fb125d5, R12
	ADCQ R12, SI
	MOVQ $0x2e39283ab03255ab, R12
	ADCQ R12, DI
	MOVQ $0x10bf0659a1fa32ba, R12
	ADCQ R12, R8
	MOVQ $0xe9963b0257e809bb, R12
	ADCQ R12, R9
	MOVQ $0x000000000000f693, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xaccec262d200f2f5, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xb7aaf5ced743d7ac, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xffc3d247cb9e0b59, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x07f44ed33e8b440c, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x1e25d8ce6fb125d5, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x2e39283ab03255ab, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x10bf0659a1fa32ba, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xe9963b0257e809bb, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000000000f693, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xaccec262d200f2f5, AX
	ADDQ AX, DX
	MOVQ $0xb7aaf5ced743d7ac, AX
	ADCQ AX, CX
	MOVQ $0xffc3d247cb9e0b59, AX
	ADCQ AX, BX
	MOVQ $0x07f44ed33e8b440c, AX
	ADCQ AX, SI
	MOVQ $0x1e25d8ce6fb125d5, AX
	ADCQ AX, DI
	MOVQ $0x2e39283ab03255ab, AX
	ADCQ AX, R8
	MOVQ $0x10bf0659a1fa32ba, AX
	ADCQ AX, R9
	MOVQ $0xe9963b0257e809bb, AX
	ADCQ AX, R10
	MOVQ $0x000000000000f693, AX
	ADCQ AX, R11
