...
var benchRese_nocarry_0528 e_nocarry_0528

func BenchmarkE_nocarry_0528SetBytes(b *testing.B) {
	var x e_nocarry_0528
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0528MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0528.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0528)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0528)
		}
	})
}

func BenchmarkE_nocarry_0528Inverse(b *testing.B) {
	var x e_nocarry_0528
	x.SetRandom()
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0528Butterfly(b *testing.B) {
	var x e_nocarry_0528
	x.SetRandom()
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0528)
	}
}

func BenchmarkE_nocarry_0528Exp(b *testing.B) {
	var x e_nocarry_0528
	x.SetRandom()
	benchRese_nocarry_0528.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0528Double(b *testing.B) {
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Double(&benchRese_nocarry_0528)
	}
}

func BenchmarkE_nocarry_0528Add(b *testing.B) {
	var x e_nocarry_0528
	x.SetRandom()
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Add(&x, &benchRese_nocarry_0528)
	}
}

func BenchmarkE_nocarry_0528Sub(b *testing.B) {
	var x e_nocarry_0528
	x.SetRandom()
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Sub(&x, &benchRese_nocarry_0528)
	}
}

func BenchmarkE_nocarry_0528Neg(b *testing.B) {
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Neg(&benchRese_nocarry_0528)
	}
}

func BenchmarkE_nocarry_0528Div(b *testing.B) {
	var x e_nocarry_0528
	x.SetRandom()
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Div(&x, &benchRese_nocarry_0528)
	}
}

func BenchmarkE_nocarry_0528FromMont(b *testing.B) {
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.FromMont()
	}
}

func BenchmarkE_nocarry_0528ToMont(b *testing.B) {
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.ToMont()
	}
}
func BenchmarkE_nocarry_0528Square(b *testing.B) {
	benchRese_nocarry_0528.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Square(&benchRese_nocarry_0528)
	}
}

func BenchmarkE_nocarry_0528Sqrt(b *testing.B) {
	var a e_nocarry_0528
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0528Mul(b *testing.B) {
	x := e_nocarry_0528{
		7901746526781680575,
	...
	benchRese_nocarry_0528.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Mul(&benchRese_nocarry_0528, &x)
	}
}

func BenchmarkE_nocarry_0528Cmp(b *testing.B) {
	x := e_nocarry_0528{
		7901746526781680575,
		16978073288807319920,
		2345974790697488206,
	...
	benchRese_nocarry_0528 = x
	benchRese_nocarry_0528[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0528.Cmp(&x)
	}
}

func TestE_nocarry_0528Cmp(t *testing.T) {
	var x, y e_nocarry_0528
...
func TestE_nocarry_0528IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0528
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0528

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0528{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0528
	one.SetOne()
	e.Sub(&qe_nocarry_0528, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0528{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0528{0, uint64(i)})
	}
...
func TestE_nocarry_0528NegZero(t *testing.T) {
	var a, b e_nocarry_0528
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0528Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0528, len(staticTestValues))
...
func TestE_nocarry_0528Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0528) bool {
			var b e_nocarry_0528
...
func TestE_nocarry_0528InverseExp(t *testing.T) {
...
func TestE_nocarry_0528MulByConstants(t *testing.T) {
...
func TestE_nocarry_0528Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0528) bool {
...
func TestE_nocarry_0528LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0528Halve(t *testing.T) {
...
func TestE_nocarry_0528FromMont(t *testing.T) {
...
type testPaire_nocarry_0528 struct {
	element e_nocarry_0528
	bigint  big.Int
}

func (z *e_nocarry_0528) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0528[8] {
		return true
	}
	if z[8] < qe_nocarry_0528[8] {
		return false
	...
	return z[0] >= qe_nocarry_0528[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0528

		g.element = e_nocarry_0528{
		...
		if qe_nocarry_0528[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0528[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0528 {
			var g e_nocarry_0528
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0528[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0528[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0528[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0528[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0528[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0528[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0528[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0528[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0528[8], carry)
...
func Benchmarke_nocarry_0528InverseNew(b *testing.B) {
	var x e_nocarry_0528
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0528
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0528
		var xInv e_nocarry_0528
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0528
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0528
...
func testLinearComb(t *testing.T, x *e_nocarry_0528, xC int64, y *e_nocarry_0528, yC int64) {
	...
	var z e_nocarry_0528
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0528, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0528
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0528, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0528
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0528, xHi uint64) {
	var res e_nocarry_0528
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0528) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0528) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0528, c int64, result *e_nocarry_0528, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0528) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0528) uint64 {
