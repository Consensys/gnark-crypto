...
// modulus q
DATA q<>+0(SB)/8, $0xec2a032aaaa5f903
DATA q<>+8(SB)/8, $0xa4d40c6670b390e1
DATA q<>+16(SB)/8, $0x0310f2e8a7c66f5b
DATA q<>+24(SB)/8, $0x0a34144b96525306
DATA q<>+32(SB)/8, $0x000325b029fc8eae
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x2eadabbac6c4c655
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xec2a032aaaa5f903, R9
	MOVQ    $0xa4d40c6670b390e1, R10
	MOVQ    $0x0310f2e8a7c66f5b, R11
	MOVQ    $0x0a34144b96525306, R12
	MOVQ    $0x000325b029fc8eae, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xa4d40c6670b390e1, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x0310f2e8a7c66f5b, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x0a34144b96525306, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000325b029fc8eae, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xec2a032aaaa5f903, CX
	MOVQ    $0xa4d40c6670b390e1, BX
	MOVQ    $0x0310f2e8a7c66f5b, SI
	MOVQ    $0x0a34144b96525306, DI
	MOVQ    $0x000325b029fc8eae, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
