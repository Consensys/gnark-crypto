...
var benchRese_nocarry_0306 e_nocarry_0306

func BenchmarkE_nocarry_0306SetBytes(b *testing.B) {
	var x e_nocarry_0306
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0306MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0306.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0306)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0306)
		}
	})
}

func BenchmarkE_nocarry_0306Inverse(b *testing.B) {
	var x e_nocarry_0306
	x.SetRandom()
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0306Butterfly(b *testing.B) {
	var x e_nocarry_0306
	x.SetRandom()
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0306)
	}
}

func BenchmarkE_nocarry_0306Exp(b *testing.B) {
	var x e_nocarry_0306
	x.SetRandom()
	benchRese_nocarry_0306.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0306Double(b *testing.B) {
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Double(&benchRese_nocarry_0306)
	}
}

func BenchmarkE_nocarry_0306Add(b *testing.B) {
	var x e_nocarry_0306
	x.SetRandom()
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Add(&x, &benchRese_nocarry_0306)
	}
}

func BenchmarkE_nocarry_0306Sub(b *testing.B) {
	var x e_nocarry_0306
	x.SetRandom()
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Sub(&x, &benchRese_nocarry_0306)
	}
}

func BenchmarkE_nocarry_0306Neg(b *testing.B) {
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Neg(&benchRese_nocarry_0306)
	}
}

func BenchmarkE_nocarry_0306Div(b *testing.B) {
	var x e_nocarry_0306
	x.SetRandom()
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Div(&x, &benchRese_nocarry_0306)
	}
}

func BenchmarkE_nocarry_0306FromMont(b *testing.B) {
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.FromMont()
	}
}

func BenchmarkE_nocarry_0306ToMont(b *testing.B) {
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.ToMont()
	}
}
func BenchmarkE_nocarry_0306Square(b *testing.B) {
	benchRese_nocarry_0306.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Square(&benchRese_nocarry_0306)
	}
}

func BenchmarkE_nocarry_0306Sqrt(b *testing.B) {
	var a e_nocarry_0306
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0306Mul(b *testing.B) {
	x := e_nocarry_0306{
		4746778892761892282,
	...
	benchRese_nocarry_0306.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Mul(&benchRese_nocarry_0306, &x)
	}
}

func BenchmarkE_nocarry_0306Cmp(b *testing.B) {
	x := e_nocarry_0306{
		4746778892761892282,
		14947334287935663274,
		18152386366445136019,
	...
	benchRese_nocarry_0306 = x
	benchRese_nocarry_0306[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0306.Cmp(&x)
	}
}

func TestE_nocarry_0306Cmp(t *testing.T) {
	var x, y e_nocarry_0306
...
func TestE_nocarry_0306IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0306
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0306

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0306{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0306
	one.SetOne()
	e.Sub(&qe_nocarry_0306, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0306{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0306{0, uint64(i)})
	}
...
func TestE_nocarry_0306NegZero(t *testing.T) {
	var a, b e_nocarry_0306
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0306Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0306, len(staticTestValues))
...
func TestE_nocarry_0306Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0306) bool {
			var b e_nocarry_0306
...
func TestE_nocarry_0306InverseExp(t *testing.T) {
...
func TestE_nocarry_0306MulByConstants(t *testing.T) {
...
func TestE_nocarry_0306Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0306) bool {
...
func TestE_nocarry_0306LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0306Halve(t *testing.T) {
...
func TestE_nocarry_0306FromMont(t *testing.T) {
...
type testPaire_nocarry_0306 struct {
	element e_nocarry_0306
	bigint  big.Int
}

func (z *e_nocarry_0306) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0306[4] {
		return true
	}
	if z[4] < qe_nocarry_0306[4] {
		return false
	...
	return z[0] >= qe_nocarry_0306[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0306

		g.element = e_nocarry_0306{
		...
		if qe_nocarry_0306[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0306[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0306 {
			var g e_nocarry_0306
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0306[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0306[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0306[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0306[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0306[4], carry)
...
func Benchmarke_nocarry_0306InverseNew(b *testing.B) {
	var x e_nocarry_0306
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0306
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0306
		var xInv e_nocarry_0306
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0306
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0306
...
func testLinearComb(t *testing.T, x *e_nocarry_0306, xC int64, y *e_nocarry_0306, yC int64) {
	...
	var z e_nocarry_0306
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0306, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0306
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0306, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0306
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0306, xHi uint64) {
	var res e_nocarry_0306
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0306) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0306) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0306, c int64, result *e_nocarry_0306, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0306) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0306) uint64 {
