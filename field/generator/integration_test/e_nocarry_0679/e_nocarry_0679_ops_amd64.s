...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x9553f4fd041d998b, R14
	ADDQ R14, AX
	MOVQ $0x148636e08242adb7, R14
	ADCQ R14, DX
	MOVQ $0x42b1eb3dd62f1465, R14
	ADCQ R14, CX
	MOVQ $0xa6cca0522e1d58b7, R14
	ADCQ R14, BX
	MOVQ $0x0ad27ee593361c1d, R14
	ADCQ R14, SI
	MOVQ $0x70e19171daa54444, R14
	ADCQ R14, DI
	MOVQ $0x1ecb7ca76877176a, R14
	ADCQ R14, R8
	MOVQ $0xc46145d93f03aa30, R14
	ADCQ R14, R9
	MOVQ $0xcab3fbfaa697a115, R14
	ADCQ R14, R10
	MOVQ $0xe4b964e52a263bd0, R14
	ADCQ R14, R11
	MOVQ $0x0000007a71de87bf, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x9553f4fd041d998b, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x148636e08242adb7, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x42b1eb3dd62f1465, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xa6cca0522e1d58b7, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x0ad27ee593361c1d, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x70e19171daa54444, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x1ecb7ca76877176a, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xc46145d93f03aa30, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xcab3fbfaa697a115, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xe4b964e52a263bd0, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000007a71de87bf, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x9553f4fd041d998b, AX
	ADDQ AX, DX
	MOVQ $0x148636e08242adb7, AX
	ADCQ AX, CX
	MOVQ $0x42b1eb3dd62f1465, AX
	ADCQ AX, BX
	MOVQ $0xa6cca0522e1d58b7, AX
	ADCQ AX, SI
	MOVQ $0x0ad27ee593361c1d, AX
	ADCQ AX, DI
	MOVQ $0x70e19171daa54444, AX
	ADCQ AX, R8
	MOVQ $0x1ecb7ca76877176a, AX
	ADCQ AX, R9
	MOVQ $0xc46145d93f03aa30, AX
	ADCQ AX, R10
	MOVQ $0xcab3fbfaa697a115, AX
	ADCQ AX, R11
	MOVQ $0xe4b964e52a263bd0, AX
	ADCQ AX, R12
	MOVQ $0x0000007a71de87bf, AX
	ADCQ AX, R13
