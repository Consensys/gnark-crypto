...
var benchRese_nocarry_0679 e_nocarry_0679

func BenchmarkE_nocarry_0679SetBytes(b *testing.B) {
	var x e_nocarry_0679
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0679MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0679.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0679)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0679)
		}
	})
}

func BenchmarkE_nocarry_0679Inverse(b *testing.B) {
	var x e_nocarry_0679
	x.SetRandom()
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0679Butterfly(b *testing.B) {
	var x e_nocarry_0679
	x.SetRandom()
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0679)
	}
}

func BenchmarkE_nocarry_0679Exp(b *testing.B) {
	var x e_nocarry_0679
	x.SetRandom()
	benchRese_nocarry_0679.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0679Double(b *testing.B) {
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Double(&benchRese_nocarry_0679)
	}
}

func BenchmarkE_nocarry_0679Add(b *testing.B) {
	var x e_nocarry_0679
	x.SetRandom()
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Add(&x, &benchRese_nocarry_0679)
	}
}

func BenchmarkE_nocarry_0679Sub(b *testing.B) {
	var x e_nocarry_0679
	x.SetRandom()
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Sub(&x, &benchRese_nocarry_0679)
	}
}

func BenchmarkE_nocarry_0679Neg(b *testing.B) {
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Neg(&benchRese_nocarry_0679)
	}
}

func BenchmarkE_nocarry_0679Div(b *testing.B) {
	var x e_nocarry_0679
	x.SetRandom()
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Div(&x, &benchRese_nocarry_0679)
	}
}

func BenchmarkE_nocarry_0679FromMont(b *testing.B) {
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.FromMont()
	}
}

func BenchmarkE_nocarry_0679ToMont(b *testing.B) {
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.ToMont()
	}
}
func BenchmarkE_nocarry_0679Square(b *testing.B) {
	benchRese_nocarry_0679.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Square(&benchRese_nocarry_0679)
	}
}

func BenchmarkE_nocarry_0679Sqrt(b *testing.B) {
	var a e_nocarry_0679
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0679Mul(b *testing.B) {
	x := e_nocarry_0679{
	...
	benchRese_nocarry_0679.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Mul(&benchRese_nocarry_0679, &x)
	}
}

func BenchmarkE_nocarry_0679Cmp(b *testing.B) {
	x := e_nocarry_0679{
		12432675051474488024,
		730108338569467603,
		4844337317926448911,
	...
	benchRese_nocarry_0679 = x
	benchRese_nocarry_0679[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0679.Cmp(&x)
	}
}

func TestE_nocarry_0679Cmp(t *testing.T) {
	var x, y e_nocarry_0679
...
func TestE_nocarry_0679IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0679
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0679

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0679{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0679
	one.SetOne()
	e.Sub(&qe_nocarry_0679, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0679{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0679{0, uint64(i)})
	}
...
func TestE_nocarry_0679NegZero(t *testing.T) {
	var a, b e_nocarry_0679
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0679Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0679, len(staticTestValues))
...
func TestE_nocarry_0679Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0679) bool {
			var b e_nocarry_0679
...
func TestE_nocarry_0679InverseExp(t *testing.T) {
...
func TestE_nocarry_0679MulByConstants(t *testing.T) {
...
func TestE_nocarry_0679Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0679) bool {
...
func TestE_nocarry_0679LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0679Halve(t *testing.T) {
...
func TestE_nocarry_0679FromMont(t *testing.T) {
...
type testPaire_nocarry_0679 struct {
	element e_nocarry_0679
	bigint  big.Int
}

func (z *e_nocarry_0679) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0679[10] {
		return true
	}
	if z[10] < qe_nocarry_0679[10] {
		return false
	...
	return z[0] >= qe_nocarry_0679[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0679

		g.element = e_nocarry_0679{
		...
		if qe_nocarry_0679[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0679[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0679 {
			var g e_nocarry_0679
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0679[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0679[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0679[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0679[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0679[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0679[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0679[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0679[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0679[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0679[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0679[10], carry)
...
func Benchmarke_nocarry_0679InverseNew(b *testing.B) {
	var x e_nocarry_0679
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0679
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0679
		var xInv e_nocarry_0679
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0679
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0679
...
func testLinearComb(t *testing.T, x *e_nocarry_0679, xC int64, y *e_nocarry_0679, yC int64) {
	...
	var z e_nocarry_0679
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0679, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0679
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0679, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0679
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0679, xHi uint64) {
	var res e_nocarry_0679
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0679) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0679) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0679, c int64, result *e_nocarry_0679, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0679) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0679) uint64 {
