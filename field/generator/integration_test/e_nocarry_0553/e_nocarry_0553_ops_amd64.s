...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x86ad0be1ac7775cb, R12
	ADDQ R12, AX
	MOVQ $0x796fa7d95a67ee63, R12
	ADCQ R12, DX
	MOVQ $0x730203c4a2c3d221, R12
	ADCQ R12, CX
	MOVQ $0x8b58440284acc026, R12
	ADCQ R12, BX
	MOVQ $0xa79d1b3bcb78559d, R12
	ADCQ R12, SI
	MOVQ $0x2215101eede95ee7, R12
	ADCQ R12, DI
	MOVQ $0xb85939010ced3736, R12
	ADCQ R12, R8
	MOVQ $0xe97199c222907d17, R12
	ADCQ R12, R9
	MOVQ $0x000001bd2cdc2ef3, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x86ad0be1ac7775cb, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x796fa7d95a67ee63, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x730203c4a2c3d221, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x8b58440284acc026, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xa79d1b3bcb78559d, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x2215101eede95ee7, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xb85939010ced3736, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xe97199c222907d17, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000001bd2cdc2ef3, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x86ad0be1ac7775cb, AX
	ADDQ AX, DX
	MOVQ $0x796fa7d95a67ee63, AX
	ADCQ AX, CX
	MOVQ $0x730203c4a2c3d221, AX
	ADCQ AX, BX
	MOVQ $0x8b58440284acc026, AX
	ADCQ AX, SI
	MOVQ $0xa79d1b3bcb78559d, AX
	ADCQ AX, DI
	MOVQ $0x2215101eede95ee7, AX
	ADCQ AX, R8
	MOVQ $0xb85939010ced3736, AX
	ADCQ AX, R9
	MOVQ $0xe97199c222907d17, AX
	ADCQ AX, R10
	MOVQ $0x000001bd2cdc2ef3, AX
	ADCQ AX, R11
