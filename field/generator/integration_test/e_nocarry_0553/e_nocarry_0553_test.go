...
var benchRese_nocarry_0553 e_nocarry_0553

func BenchmarkE_nocarry_0553SetBytes(b *testing.B) {
	var x e_nocarry_0553
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0553MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0553.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0553)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0553)
		}
	})
}

func BenchmarkE_nocarry_0553Inverse(b *testing.B) {
	var x e_nocarry_0553
	x.SetRandom()
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0553Butterfly(b *testing.B) {
	var x e_nocarry_0553
	x.SetRandom()
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0553)
	}
}

func BenchmarkE_nocarry_0553Exp(b *testing.B) {
	var x e_nocarry_0553
	x.SetRandom()
	benchRese_nocarry_0553.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0553Double(b *testing.B) {
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Double(&benchRese_nocarry_0553)
	}
}

func BenchmarkE_nocarry_0553Add(b *testing.B) {
	var x e_nocarry_0553
	x.SetRandom()
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Add(&x, &benchRese_nocarry_0553)
	}
}

func BenchmarkE_nocarry_0553Sub(b *testing.B) {
	var x e_nocarry_0553
	x.SetRandom()
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Sub(&x, &benchRese_nocarry_0553)
	}
}

func BenchmarkE_nocarry_0553Neg(b *testing.B) {
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Neg(&benchRese_nocarry_0553)
	}
}

func BenchmarkE_nocarry_0553Div(b *testing.B) {
	var x e_nocarry_0553
	x.SetRandom()
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Div(&x, &benchRese_nocarry_0553)
	}
}

func BenchmarkE_nocarry_0553FromMont(b *testing.B) {
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.FromMont()
	}
}

func BenchmarkE_nocarry_0553ToMont(b *testing.B) {
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.ToMont()
	}
}
func BenchmarkE_nocarry_0553Square(b *testing.B) {
	benchRese_nocarry_0553.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Square(&benchRese_nocarry_0553)
	}
}

func BenchmarkE_nocarry_0553Sqrt(b *testing.B) {
	var a e_nocarry_0553
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0553Mul(b *testing.B) {
	x := e_nocarry_0553{
	...
	benchRese_nocarry_0553.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Mul(&benchRese_nocarry_0553, &x)
	}
}

func BenchmarkE_nocarry_0553Cmp(b *testing.B) {
	x := e_nocarry_0553{
		13980189906088647776,
		14007538560948000543,
		14430752915887497622,
	...
	benchRese_nocarry_0553 = x
	benchRese_nocarry_0553[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0553.Cmp(&x)
	}
}

func TestE_nocarry_0553Cmp(t *testing.T) {
	var x, y e_nocarry_0553
...
func TestE_nocarry_0553IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0553
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0553

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0553{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0553
	one.SetOne()
	e.Sub(&qe_nocarry_0553, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0553{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0553{0, uint64(i)})
	}
...
func TestE_nocarry_0553NegZero(t *testing.T) {
	var a, b e_nocarry_0553
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0553Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0553, len(staticTestValues))
...
func TestE_nocarry_0553Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0553) bool {
			var b e_nocarry_0553
...
func TestE_nocarry_0553InverseExp(t *testing.T) {
...
func TestE_nocarry_0553MulByConstants(t *testing.T) {
...
func TestE_nocarry_0553Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0553) bool {
...
func TestE_nocarry_0553LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0553Halve(t *testing.T) {
...
func TestE_nocarry_0553FromMont(t *testing.T) {
...
type testPaire_nocarry_0553 struct {
	element e_nocarry_0553
	bigint  big.Int
}

func (z *e_nocarry_0553) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0553[8] {
		return true
	}
	if z[8] < qe_nocarry_0553[8] {
		return false
	...
	return z[0] >= qe_nocarry_0553[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0553

		g.element = e_nocarry_0553{
		...
		if qe_nocarry_0553[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0553[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0553 {
			var g e_nocarry_0553
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0553[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0553[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0553[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0553[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0553[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0553[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0553[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0553[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0553[8], carry)
...
func Benchmarke_nocarry_0553InverseNew(b *testing.B) {
	var x e_nocarry_0553
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0553
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0553
		var xInv e_nocarry_0553
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0553
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0553
...
func testLinearComb(t *testing.T, x *e_nocarry_0553, xC int64, y *e_nocarry_0553, yC int64) {
	...
	var z e_nocarry_0553
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0553, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0553
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0553, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0553
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0553, xHi uint64) {
	var res e_nocarry_0553
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0553) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0553) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0553, c int64, result *e_nocarry_0553, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0553) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0553) uint64 {
