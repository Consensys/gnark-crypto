...
var benchRese_nocarry_0390 e_nocarry_0390

func BenchmarkE_nocarry_0390SetBytes(b *testing.B) {
	var x e_nocarry_0390
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0390MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0390.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0390)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0390)
		}
	})
}

func BenchmarkE_nocarry_0390Inverse(b *testing.B) {
	var x e_nocarry_0390
	x.SetRandom()
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0390Butterfly(b *testing.B) {
	var x e_nocarry_0390
	x.SetRandom()
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0390)
	}
}

func BenchmarkE_nocarry_0390Exp(b *testing.B) {
	var x e_nocarry_0390
	x.SetRandom()
	benchRese_nocarry_0390.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0390Double(b *testing.B) {
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Double(&benchRese_nocarry_0390)
	}
}

func BenchmarkE_nocarry_0390Add(b *testing.B) {
	var x e_nocarry_0390
	x.SetRandom()
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Add(&x, &benchRese_nocarry_0390)
	}
}

func BenchmarkE_nocarry_0390Sub(b *testing.B) {
	var x e_nocarry_0390
	x.SetRandom()
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Sub(&x, &benchRese_nocarry_0390)
	}
}

func BenchmarkE_nocarry_0390Neg(b *testing.B) {
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Neg(&benchRese_nocarry_0390)
	}
}

func BenchmarkE_nocarry_0390Div(b *testing.B) {
	var x e_nocarry_0390
	x.SetRandom()
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Div(&x, &benchRese_nocarry_0390)
	}
}

func BenchmarkE_nocarry_0390FromMont(b *testing.B) {
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.FromMont()
	}
}

func BenchmarkE_nocarry_0390ToMont(b *testing.B) {
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.ToMont()
	}
}
func BenchmarkE_nocarry_0390Square(b *testing.B) {
	benchRese_nocarry_0390.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Square(&benchRese_nocarry_0390)
	}
}

func BenchmarkE_nocarry_0390Sqrt(b *testing.B) {
	var a e_nocarry_0390
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0390Mul(b *testing.B) {
	x := e_nocarry_0390{
		9137621421321847568,
		7449341656178553503,
		724704897616675476,
	...
	benchRese_nocarry_0390.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Mul(&benchRese_nocarry_0390, &x)
	}
}

func BenchmarkE_nocarry_0390Cmp(b *testing.B) {
	x := e_nocarry_0390{
		9137621421321847568,
		7449341656178553503,
		724704897616675476,
	...
	benchRese_nocarry_0390 = x
	benchRese_nocarry_0390[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0390.Cmp(&x)
	}
}

func TestE_nocarry_0390Cmp(t *testing.T) {
	var x, y e_nocarry_0390
...
func TestE_nocarry_0390IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0390
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0390

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0390{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0390
	one.SetOne()
	e.Sub(&qe_nocarry_0390, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0390{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0390{0, uint64(i)})
	}
...
func TestE_nocarry_0390NegZero(t *testing.T) {
	var a, b e_nocarry_0390
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0390Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0390, len(staticTestValues))
...
func TestE_nocarry_0390Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0390) bool {
			var b e_nocarry_0390
...
func TestE_nocarry_0390InverseExp(t *testing.T) {
...
func TestE_nocarry_0390MulByConstants(t *testing.T) {
...
func TestE_nocarry_0390Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0390) bool {
...
func TestE_nocarry_0390LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0390Halve(t *testing.T) {
...
func TestE_nocarry_0390FromMont(t *testing.T) {
...
type testPaire_nocarry_0390 struct {
	element e_nocarry_0390
	bigint  big.Int
}

func (z *e_nocarry_0390) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0390[6] {
		return true
	}
	if z[6] < qe_nocarry_0390[6] {
		return false
	...
	return z[0] >= qe_nocarry_0390[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0390

		g.element = e_nocarry_0390{
		...
		if qe_nocarry_0390[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0390[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0390 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0390[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0390[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0390[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0390[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0390[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0390[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0390[6], carry)
...
func Benchmarke_nocarry_0390InverseNew(b *testing.B) {
	var x e_nocarry_0390
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0390
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0390
		var xInv e_nocarry_0390
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0390
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0390
...
func testLinearComb(t *testing.T, x *e_nocarry_0390, xC int64, y *e_nocarry_0390, yC int64) {
	...
	var z e_nocarry_0390
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0390, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0390
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0390, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0390
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0390, xHi uint64) {
	var res e_nocarry_0390
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0390) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0390) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0390, c int64, result *e_nocarry_0390, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0390) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0390) uint64 {
