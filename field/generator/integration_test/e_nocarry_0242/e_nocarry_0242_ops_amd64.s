...
// modulus q
DATA q<>+0(SB)/8, $0xea3b8a5717de7167
DATA q<>+8(SB)/8, $0xe791d17e7ecc56f9
DATA q<>+16(SB)/8, $0x5ce3a895c2d4f3e4
DATA q<>+24(SB)/8, $0x00037d3e303bdbb1
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x238dda6c27dae5a9
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xea3b8a5717de7167, R8
	MOVQ    $0xe791d17e7ecc56f9, R9
	MOVQ    $0x5ce3a895c2d4f3e4, R10
	MOVQ    $0x00037d3e303bdbb1, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xe791d17e7ecc56f9, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x5ce3a895c2d4f3e4, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00037d3e303bdbb1, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xea3b8a5717de7167, R12
	MOVQ    $0xe791d17e7ecc56f9, R13
	MOVQ    $0x5ce3a895c2d4f3e4, R14
	MOVQ    $0x00037d3e303bdbb1, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
