...
var benchRese_nocarry_0242 e_nocarry_0242

func BenchmarkE_nocarry_0242SetBytes(b *testing.B) {
	var x e_nocarry_0242
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0242MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0242.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0242)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0242)
		}
	})
}

func BenchmarkE_nocarry_0242Inverse(b *testing.B) {
	var x e_nocarry_0242
	x.SetRandom()
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0242Butterfly(b *testing.B) {
	var x e_nocarry_0242
	x.SetRandom()
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0242)
	}
}

func BenchmarkE_nocarry_0242Exp(b *testing.B) {
	var x e_nocarry_0242
	x.SetRandom()
	benchRese_nocarry_0242.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0242Double(b *testing.B) {
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Double(&benchRese_nocarry_0242)
	}
}

func BenchmarkE_nocarry_0242Add(b *testing.B) {
	var x e_nocarry_0242
	x.SetRandom()
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Add(&x, &benchRese_nocarry_0242)
	}
}

func BenchmarkE_nocarry_0242Sub(b *testing.B) {
	var x e_nocarry_0242
	x.SetRandom()
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Sub(&x, &benchRese_nocarry_0242)
	}
}

func BenchmarkE_nocarry_0242Neg(b *testing.B) {
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Neg(&benchRese_nocarry_0242)
	}
}

func BenchmarkE_nocarry_0242Div(b *testing.B) {
	var x e_nocarry_0242
	x.SetRandom()
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Div(&x, &benchRese_nocarry_0242)
	}
}

func BenchmarkE_nocarry_0242FromMont(b *testing.B) {
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.FromMont()
	}
}

func BenchmarkE_nocarry_0242ToMont(b *testing.B) {
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.ToMont()
	}
}
func BenchmarkE_nocarry_0242Square(b *testing.B) {
	benchRese_nocarry_0242.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Square(&benchRese_nocarry_0242)
	}
}

func BenchmarkE_nocarry_0242Sqrt(b *testing.B) {
	var a e_nocarry_0242
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0242Mul(b *testing.B) {
	x := e_nocarry_0242{
	...
	benchRese_nocarry_0242.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Mul(&benchRese_nocarry_0242, &x)
	}
}

func BenchmarkE_nocarry_0242Cmp(b *testing.B) {
	x := e_nocarry_0242{
		17158078040908926849,
		2257255380378152201,
		15993520484361752525,
	...
	benchRese_nocarry_0242 = x
	benchRese_nocarry_0242[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0242.Cmp(&x)
	}
}

func TestE_nocarry_0242Cmp(t *testing.T) {
	var x, y e_nocarry_0242
...
func TestE_nocarry_0242IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0242
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0242

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0242{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0242
	one.SetOne()
	e.Sub(&qe_nocarry_0242, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0242{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0242{0, uint64(i)})
	}
...
func TestE_nocarry_0242NegZero(t *testing.T) {
	var a, b e_nocarry_0242
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0242Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0242, len(staticTestValues))
...
func TestE_nocarry_0242Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0242) bool {
			var b e_nocarry_0242
...
func TestE_nocarry_0242InverseExp(t *testing.T) {
...
func TestE_nocarry_0242MulByConstants(t *testing.T) {
...
func TestE_nocarry_0242Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0242) bool {
...
func TestE_nocarry_0242LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0242Halve(t *testing.T) {
...
func TestE_nocarry_0242FromMont(t *testing.T) {
...
type testPaire_nocarry_0242 struct {
	element e_nocarry_0242
	bigint  big.Int
}

func (z *e_nocarry_0242) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0242[3] {
		return true
	}
	if z[3] < qe_nocarry_0242[3] {
		return false
	...
	return z[0] >= qe_nocarry_0242[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0242

		g.element = e_nocarry_0242{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0242[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0242[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0242 {
			var g e_nocarry_0242
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0242[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0242[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0242[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0242[3], carry)
...
func Benchmarke_nocarry_0242InverseNew(b *testing.B) {
	var x e_nocarry_0242
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0242
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0242
		var xInv e_nocarry_0242
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0242
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0242
...
func testLinearComb(t *testing.T, x *e_nocarry_0242, xC int64, y *e_nocarry_0242, yC int64) {
	...
	var z e_nocarry_0242
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0242, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0242
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0242, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0242
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0242, xHi uint64) {
	var res e_nocarry_0242
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0242) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0242) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0242, c int64, result *e_nocarry_0242, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0242) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0242) uint64 {
