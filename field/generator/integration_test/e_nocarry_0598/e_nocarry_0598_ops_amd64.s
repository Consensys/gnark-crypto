...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x945f94767a6ad3c9, R13
	ADDQ R13, AX
	MOVQ $0xd1e55623f7f95095, R13
	ADCQ R13, DX
	MOVQ $0x0628fe5beea30072, R13
	ADCQ R13, CX
	MOVQ $0x6da69e4970cae542, R13
	ADCQ R13, BX
	MOVQ $0xa0e51e43225d8765, R13
	ADCQ R13, SI
	MOVQ $0x0cda728bc2796631, R13
	ADCQ R13, DI
	MOVQ $0x87aefb8730b1baa4, R13
	ADCQ R13, R8
	MOVQ $0x5cfbea52bacbf113, R13
	ADCQ R13, R9
	MOVQ $0x37fa576f9e231c92, R13
	ADCQ R13, R10
	MOVQ $0x00000000003bf8db, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x945f94767a6ad3c9, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xd1e55623f7f95095, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x0628fe5beea30072, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x6da69e4970cae542, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xa0e51e43225d8765, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x0cda728bc2796631, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x87aefb8730b1baa4, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x5cfbea52bacbf113, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x37fa576f9e231c92, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000003bf8db, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x945f94767a6ad3c9, AX
	ADDQ AX, DX
	MOVQ $0xd1e55623f7f95095, AX
	ADCQ AX, CX
	MOVQ $0x0628fe5beea30072, AX
	ADCQ AX, BX
	MOVQ $0x6da69e4970cae542, AX
	ADCQ AX, SI
	MOVQ $0xa0e51e43225d8765, AX
	ADCQ AX, DI
	MOVQ $0x0cda728bc2796631, AX
	ADCQ AX, R8
	MOVQ $0x87aefb8730b1baa4, AX
	ADCQ AX, R9
	MOVQ $0x5cfbea52bacbf113, AX
	ADCQ AX, R10
	MOVQ $0x37fa576f9e231c92, AX
	ADCQ AX, R11
	MOVQ $0x00000000003bf8db, AX
	ADCQ AX, R12
