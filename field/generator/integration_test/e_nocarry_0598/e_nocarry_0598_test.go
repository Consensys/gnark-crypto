...
var benchRese_nocarry_0598 e_nocarry_0598

func BenchmarkE_nocarry_0598SetBytes(b *testing.B) {
	var x e_nocarry_0598
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0598MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0598.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0598)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0598)
		}
	})
}

func BenchmarkE_nocarry_0598Inverse(b *testing.B) {
	var x e_nocarry_0598
	x.SetRandom()
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0598Butterfly(b *testing.B) {
	var x e_nocarry_0598
	x.SetRandom()
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0598)
	}
}

func BenchmarkE_nocarry_0598Exp(b *testing.B) {
	var x e_nocarry_0598
	x.SetRandom()
	benchRese_nocarry_0598.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0598Double(b *testing.B) {
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Double(&benchRese_nocarry_0598)
	}
}

func BenchmarkE_nocarry_0598Add(b *testing.B) {
	var x e_nocarry_0598
	x.SetRandom()
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Add(&x, &benchRese_nocarry_0598)
	}
}

func BenchmarkE_nocarry_0598Sub(b *testing.B) {
	var x e_nocarry_0598
	x.SetRandom()
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Sub(&x, &benchRese_nocarry_0598)
	}
}

func BenchmarkE_nocarry_0598Neg(b *testing.B) {
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Neg(&benchRese_nocarry_0598)
	}
}

func BenchmarkE_nocarry_0598Div(b *testing.B) {
	var x e_nocarry_0598
	x.SetRandom()
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Div(&x, &benchRese_nocarry_0598)
	}
}

func BenchmarkE_nocarry_0598FromMont(b *testing.B) {
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.FromMont()
	}
}

func BenchmarkE_nocarry_0598ToMont(b *testing.B) {
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.ToMont()
	}
}
func BenchmarkE_nocarry_0598Square(b *testing.B) {
	benchRese_nocarry_0598.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Square(&benchRese_nocarry_0598)
	}
}

func BenchmarkE_nocarry_0598Sqrt(b *testing.B) {
	var a e_nocarry_0598
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0598Mul(b *testing.B) {
	x := e_nocarry_0598{
		9597796739869190063,
	...
	benchRese_nocarry_0598.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Mul(&benchRese_nocarry_0598, &x)
	}
}

func BenchmarkE_nocarry_0598Cmp(b *testing.B) {
	x := e_nocarry_0598{
		9597796739869190063,
		13527317445013624885,
		17079939916923115070,
	...
	benchRese_nocarry_0598 = x
	benchRese_nocarry_0598[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0598.Cmp(&x)
	}
}

func TestE_nocarry_0598Cmp(t *testing.T) {
	var x, y e_nocarry_0598
...
func TestE_nocarry_0598IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0598
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0598

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0598{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0598
	one.SetOne()
	e.Sub(&qe_nocarry_0598, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0598{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0598{0, uint64(i)})
	}
...
func TestE_nocarry_0598NegZero(t *testing.T) {
	var a, b e_nocarry_0598
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0598Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0598, len(staticTestValues))
...
func TestE_nocarry_0598Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0598) bool {
			var b e_nocarry_0598
...
func TestE_nocarry_0598InverseExp(t *testing.T) {
...
func TestE_nocarry_0598MulByConstants(t *testing.T) {
...
func TestE_nocarry_0598Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0598) bool {
...
func TestE_nocarry_0598LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0598Halve(t *testing.T) {
...
func TestE_nocarry_0598FromMont(t *testing.T) {
...
type testPaire_nocarry_0598 struct {
	element e_nocarry_0598
	bigint  big.Int
}

func (z *e_nocarry_0598) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0598[9] {
		return true
	}
	if z[9] < qe_nocarry_0598[9] {
		return false
	...
	return z[0] >= qe_nocarry_0598[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0598

		g.element = e_nocarry_0598{
		...
		if qe_nocarry_0598[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0598[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0598 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0598[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0598[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0598[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0598[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0598[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0598[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0598[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0598[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0598[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0598[9], carry)
...
func Benchmarke_nocarry_0598InverseNew(b *testing.B) {
	var x e_nocarry_0598
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0598
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0598
		var xInv e_nocarry_0598
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0598
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0598
...
func testLinearComb(t *testing.T, x *e_nocarry_0598, xC int64, y *e_nocarry_0598, yC int64) {
	...
	var z e_nocarry_0598
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0598, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0598
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0598, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0598
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0598, xHi uint64) {
	var res e_nocarry_0598
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0598) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0598) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0598, c int64, result *e_nocarry_0598, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0598) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0598) uint64 {
