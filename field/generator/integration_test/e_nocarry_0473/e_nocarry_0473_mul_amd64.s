...
// modulus q
DATA q<>+0(SB)/8, $0x710c76d1e647a7af
DATA q<>+8(SB)/8, $0xc477688f4e3acde5
DATA q<>+16(SB)/8, $0xfda0bf6e4ee27d31
DATA q<>+24(SB)/8, $0xa67b57a90d4ac944
DATA q<>+32(SB)/8, $0x1c028b8d8b00d9b4
DATA q<>+40(SB)/8, $0xddc517580d2662db
DATA q<>+48(SB)/8, $0x39717ec12173655f
DATA q<>+56(SB)/8, $0x0000000001c349b1
GLOBL q<>(SB), (RODATA+NOPTR), $64

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x4aba9efcb80ff0b1
