...
var benchRese_nocarry_0473 e_nocarry_0473

func BenchmarkE_nocarry_0473SetBytes(b *testing.B) {
	var x e_nocarry_0473
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0473MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0473.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0473)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0473)
		}
	})
}

func BenchmarkE_nocarry_0473Inverse(b *testing.B) {
	var x e_nocarry_0473
	x.SetRandom()
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0473Butterfly(b *testing.B) {
	var x e_nocarry_0473
	x.SetRandom()
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0473)
	}
}

func BenchmarkE_nocarry_0473Exp(b *testing.B) {
	var x e_nocarry_0473
	x.SetRandom()
	benchRese_nocarry_0473.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0473Double(b *testing.B) {
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Double(&benchRese_nocarry_0473)
	}
}

func BenchmarkE_nocarry_0473Add(b *testing.B) {
	var x e_nocarry_0473
	x.SetRandom()
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Add(&x, &benchRese_nocarry_0473)
	}
}

func BenchmarkE_nocarry_0473Sub(b *testing.B) {
	var x e_nocarry_0473
	x.SetRandom()
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Sub(&x, &benchRese_nocarry_0473)
	}
}

func BenchmarkE_nocarry_0473Neg(b *testing.B) {
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Neg(&benchRese_nocarry_0473)
	}
}

func BenchmarkE_nocarry_0473Div(b *testing.B) {
	var x e_nocarry_0473
	x.SetRandom()
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Div(&x, &benchRese_nocarry_0473)
	}
}

func BenchmarkE_nocarry_0473FromMont(b *testing.B) {
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.FromMont()
	}
}

func BenchmarkE_nocarry_0473ToMont(b *testing.B) {
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.ToMont()
	}
}
func BenchmarkE_nocarry_0473Square(b *testing.B) {
	benchRese_nocarry_0473.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Square(&benchRese_nocarry_0473)
	}
}

func BenchmarkE_nocarry_0473Sqrt(b *testing.B) {
	var a e_nocarry_0473
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0473Mul(b *testing.B) {
	x := e_nocarry_0473{
	...
	benchRese_nocarry_0473.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Mul(&benchRese_nocarry_0473, &x)
	}
}

func BenchmarkE_nocarry_0473Cmp(b *testing.B) {
	x := e_nocarry_0473{
		10021706769234111714,
		10851611104578606469,
		13919615942611835937,
	...
	benchRese_nocarry_0473 = x
	benchRese_nocarry_0473[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0473.Cmp(&x)
	}
}

func TestE_nocarry_0473Cmp(t *testing.T) {
	var x, y e_nocarry_0473
...
func TestE_nocarry_0473IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0473
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0473

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0473{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0473
	one.SetOne()
	e.Sub(&qe_nocarry_0473, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0473{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0473{0, uint64(i)})
	}
...
func TestE_nocarry_0473NegZero(t *testing.T) {
	var a, b e_nocarry_0473
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0473Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0473, len(staticTestValues))
...
func TestE_nocarry_0473Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0473) bool {
			var b e_nocarry_0473
...
func TestE_nocarry_0473InverseExp(t *testing.T) {
...
func TestE_nocarry_0473MulByConstants(t *testing.T) {
...
func TestE_nocarry_0473Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0473) bool {
...
func TestE_nocarry_0473LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0473Halve(t *testing.T) {
...
func TestE_nocarry_0473FromMont(t *testing.T) {
...
type testPaire_nocarry_0473 struct {
	element e_nocarry_0473
	bigint  big.Int
}

func (z *e_nocarry_0473) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0473[7] {
		return true
	}
	if z[7] < qe_nocarry_0473[7] {
		return false
	...
	return z[0] >= qe_nocarry_0473[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0473

		g.element = e_nocarry_0473{
		...
		if qe_nocarry_0473[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0473[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0473 {
			var g e_nocarry_0473
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0473[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0473[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0473[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0473[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0473[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0473[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0473[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0473[7], carry)
...
func Benchmarke_nocarry_0473InverseNew(b *testing.B) {
	var x e_nocarry_0473
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0473
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0473
		var xInv e_nocarry_0473
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0473
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0473
...
func testLinearComb(t *testing.T, x *e_nocarry_0473, xC int64, y *e_nocarry_0473, yC int64) {
	...
	var z e_nocarry_0473
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0473, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0473
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0473, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0473
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0473, xHi uint64) {
	var res e_nocarry_0473
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0473) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0473) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0473, c int64, result *e_nocarry_0473, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0473) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0473) uint64 {
