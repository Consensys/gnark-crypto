...
var benchRese_nocarry_0166 e_nocarry_0166

func BenchmarkE_nocarry_0166SetBytes(b *testing.B) {
	var x e_nocarry_0166
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0166MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0166.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0166)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0166)
		}
	})
}

func BenchmarkE_nocarry_0166Inverse(b *testing.B) {
	var x e_nocarry_0166
	x.SetRandom()
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0166Butterfly(b *testing.B) {
	var x e_nocarry_0166
	x.SetRandom()
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0166)
	}
}

func BenchmarkE_nocarry_0166Exp(b *testing.B) {
	var x e_nocarry_0166
	x.SetRandom()
	benchRese_nocarry_0166.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0166Double(b *testing.B) {
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Double(&benchRese_nocarry_0166)
	}
}

func BenchmarkE_nocarry_0166Add(b *testing.B) {
	var x e_nocarry_0166
	x.SetRandom()
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Add(&x, &benchRese_nocarry_0166)
	}
}

func BenchmarkE_nocarry_0166Sub(b *testing.B) {
	var x e_nocarry_0166
	x.SetRandom()
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Sub(&x, &benchRese_nocarry_0166)
	}
}

func BenchmarkE_nocarry_0166Neg(b *testing.B) {
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Neg(&benchRese_nocarry_0166)
	}
}

func BenchmarkE_nocarry_0166Div(b *testing.B) {
	var x e_nocarry_0166
	x.SetRandom()
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Div(&x, &benchRese_nocarry_0166)
	}
}

func BenchmarkE_nocarry_0166FromMont(b *testing.B) {
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.FromMont()
	}
}

func BenchmarkE_nocarry_0166ToMont(b *testing.B) {
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.ToMont()
	}
}
func BenchmarkE_nocarry_0166Square(b *testing.B) {
	benchRese_nocarry_0166.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Square(&benchRese_nocarry_0166)
	}
}

func BenchmarkE_nocarry_0166Sqrt(b *testing.B) {
	var a e_nocarry_0166
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0166Mul(b *testing.B) {
	x := e_nocarry_0166{
		12316777715123434383,
		3531470487560826328,
		193392509039,
	}
	benchRese_nocarry_0166.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Mul(&benchRese_nocarry_0166, &x)
	}
}

func BenchmarkE_nocarry_0166Cmp(b *testing.B) {
	x := e_nocarry_0166{
		12316777715123434383,
		3531470487560826328,
		193392509039,
	}
	benchRese_nocarry_0166 = x
	benchRese_nocarry_0166[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0166.Cmp(&x)
	}
}

func TestE_nocarry_0166Cmp(t *testing.T) {
	var x, y e_nocarry_0166
...
func TestE_nocarry_0166IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0166
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0166

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0166{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0166
	one.SetOne()
	e.Sub(&qe_nocarry_0166, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0166{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0166{0, uint64(i)})
	}
...
func TestE_nocarry_0166NegZero(t *testing.T) {
	var a, b e_nocarry_0166
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0166Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0166, len(staticTestValues))
...
func TestE_nocarry_0166Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0166) bool {
			var b e_nocarry_0166
...
func TestE_nocarry_0166InverseExp(t *testing.T) {
...
func TestE_nocarry_0166MulByConstants(t *testing.T) {
...
func TestE_nocarry_0166Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0166) bool {
...
func TestE_nocarry_0166LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0166Halve(t *testing.T) {
...
func TestE_nocarry_0166FromMont(t *testing.T) {
...
type testPaire_nocarry_0166 struct {
	element e_nocarry_0166
	bigint  big.Int
}

func (z *e_nocarry_0166) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0166[2] {
		return true
	}
	if z[2] < qe_nocarry_0166[2] {
		return false
	...
	return z[0] >= qe_nocarry_0166[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0166

		g.element = e_nocarry_0166{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0166[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0166[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0166 {
			var g e_nocarry_0166
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0166[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0166[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0166[2], carry)
...
func Benchmarke_nocarry_0166InverseNew(b *testing.B) {
	var x e_nocarry_0166
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0166
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0166
		var xInv e_nocarry_0166
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0166
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0166
...
func testLinearComb(t *testing.T, x *e_nocarry_0166, xC int64, y *e_nocarry_0166, yC int64) {
	...
	var z e_nocarry_0166
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0166, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0166
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0166, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0166
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0166, xHi uint64) {
	var res e_nocarry_0166
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0166) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0166) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0166, c int64, result *e_nocarry_0166, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0166) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0166) uint64 {
