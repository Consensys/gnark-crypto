...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xcc701b7e61574905, R13
	ADDQ R13, AX
	MOVQ $0x6c169d90756303b8, R13
	ADCQ R13, DX
	MOVQ $0x2e7b1d6d4ef1c63d, R13
	ADCQ R13, CX
	MOVQ $0x9c70f7088c972a75, R13
	ADCQ R13, BX
	MOVQ $0x9cf0d75d8dfaf43c, R13
	ADCQ R13, SI
	MOVQ $0x40556485c8b50233, R13
	ADCQ R13, DI
	MOVQ $0x2c37cd402da138c8, R13
	ADCQ R13, R8
	MOVQ $0x7907c5ffb82b55bd, R13
	ADCQ R13, R9
	MOVQ $0x9ee1017b8fefe2d4, R13
	ADCQ R13, R10
	MOVQ $0x001ea1b8b1e5daab, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xcc701b7e61574905, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x6c169d90756303b8, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x2e7b1d6d4ef1c63d, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x9c70f7088c972a75, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x9cf0d75d8dfaf43c, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x40556485c8b50233, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x2c37cd402da138c8, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x7907c5ffb82b55bd, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x9ee1017b8fefe2d4, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x001ea1b8b1e5daab, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xcc701b7e61574905, AX
	ADDQ AX, DX
	MOVQ $0x6c169d90756303b8, AX
	ADCQ AX, CX
	MOVQ $0x2e7b1d6d4ef1c63d, AX
	ADCQ AX, BX
	MOVQ $0x9c70f7088c972a75, AX
	ADCQ AX, SI
	MOVQ $0x9cf0d75d8dfaf43c, AX
	ADCQ AX, DI
	MOVQ $0x40556485c8b50233, AX
	ADCQ AX, R8
	MOVQ $0x2c37cd402da138c8, AX
	ADCQ AX, R9
	MOVQ $0x7907c5ffb82b55bd, AX
	ADCQ AX, R10
	MOVQ $0x9ee1017b8fefe2d4, AX
	ADCQ AX, R11
	MOVQ $0x001ea1b8b1e5daab, AX
	ADCQ AX, R12
