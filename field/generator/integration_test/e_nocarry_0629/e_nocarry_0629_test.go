...
var benchRese_nocarry_0629 e_nocarry_0629

func BenchmarkE_nocarry_0629SetBytes(b *testing.B) {
	var x e_nocarry_0629
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0629MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0629.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0629)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0629)
		}
	})
}

func BenchmarkE_nocarry_0629Inverse(b *testing.B) {
	var x e_nocarry_0629
	x.SetRandom()
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0629Butterfly(b *testing.B) {
	var x e_nocarry_0629
	x.SetRandom()
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0629)
	}
}

func BenchmarkE_nocarry_0629Exp(b *testing.B) {
	var x e_nocarry_0629
	x.SetRandom()
	benchRese_nocarry_0629.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0629Double(b *testing.B) {
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Double(&benchRese_nocarry_0629)
	}
}

func BenchmarkE_nocarry_0629Add(b *testing.B) {
	var x e_nocarry_0629
	x.SetRandom()
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Add(&x, &benchRese_nocarry_0629)
	}
}

func BenchmarkE_nocarry_0629Sub(b *testing.B) {
	var x e_nocarry_0629
	x.SetRandom()
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Sub(&x, &benchRese_nocarry_0629)
	}
}

func BenchmarkE_nocarry_0629Neg(b *testing.B) {
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Neg(&benchRese_nocarry_0629)
	}
}

func BenchmarkE_nocarry_0629Div(b *testing.B) {
	var x e_nocarry_0629
	x.SetRandom()
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Div(&x, &benchRese_nocarry_0629)
	}
}

func BenchmarkE_nocarry_0629FromMont(b *testing.B) {
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.FromMont()
	}
}

func BenchmarkE_nocarry_0629ToMont(b *testing.B) {
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.ToMont()
	}
}
func BenchmarkE_nocarry_0629Square(b *testing.B) {
	benchRese_nocarry_0629.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Square(&benchRese_nocarry_0629)
	}
}

func BenchmarkE_nocarry_0629Sqrt(b *testing.B) {
	var a e_nocarry_0629
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0629Mul(b *testing.B) {
	x := e_nocarry_0629{
		1476533659852558257,
		6272807429078888614,
		9480509998453245523,
	...
	benchRese_nocarry_0629.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Mul(&benchRese_nocarry_0629, &x)
	}
}

func BenchmarkE_nocarry_0629Cmp(b *testing.B) {
	x := e_nocarry_0629{
		1476533659852558257,
		6272807429078888614,
		9480509998453245523,
	...
	benchRese_nocarry_0629 = x
	benchRese_nocarry_0629[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0629.Cmp(&x)
	}
}

func TestE_nocarry_0629Cmp(t *testing.T) {
	var x, y e_nocarry_0629
...
func TestE_nocarry_0629IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0629
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0629

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0629{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0629
	one.SetOne()
	e.Sub(&qe_nocarry_0629, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0629{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0629{0, uint64(i)})
	}
...
func TestE_nocarry_0629NegZero(t *testing.T) {
	var a, b e_nocarry_0629
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0629Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0629, len(staticTestValues))
...
func TestE_nocarry_0629Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0629) bool {
			var b e_nocarry_0629
...
func TestE_nocarry_0629InverseExp(t *testing.T) {
...
func TestE_nocarry_0629MulByConstants(t *testing.T) {
...
func TestE_nocarry_0629Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0629) bool {
...
func TestE_nocarry_0629LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0629Halve(t *testing.T) {
...
func TestE_nocarry_0629FromMont(t *testing.T) {
...
type testPaire_nocarry_0629 struct {
	element e_nocarry_0629
	bigint  big.Int
}

func (z *e_nocarry_0629) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0629[9] {
		return true
	}
	if z[9] < qe_nocarry_0629[9] {
		return false
	...
	return z[0] >= qe_nocarry_0629[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0629

		g.element = e_nocarry_0629{
		...
		if qe_nocarry_0629[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0629[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0629 {
			var g e_nocarry_0629
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0629[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0629[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0629[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0629[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0629[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0629[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0629[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0629[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0629[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0629[9], carry)
...
func Benchmarke_nocarry_0629InverseNew(b *testing.B) {
	var x e_nocarry_0629
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0629
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0629
		var xInv e_nocarry_0629
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0629
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0629
...
func testLinearComb(t *testing.T, x *e_nocarry_0629, xC int64, y *e_nocarry_0629, yC int64) {
	...
	var z e_nocarry_0629
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0629, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0629
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0629, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0629
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0629, xHi uint64) {
	var res e_nocarry_0629
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0629) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0629) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0629, c int64, result *e_nocarry_0629, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0629) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0629) uint64 {
