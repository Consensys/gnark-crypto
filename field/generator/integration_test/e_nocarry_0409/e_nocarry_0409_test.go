...
var benchRese_nocarry_0409 e_nocarry_0409

func BenchmarkE_nocarry_0409SetBytes(b *testing.B) {
	var x e_nocarry_0409
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0409MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0409.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0409)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0409)
		}
	})
}

func BenchmarkE_nocarry_0409Inverse(b *testing.B) {
	var x e_nocarry_0409
	x.SetRandom()
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0409Butterfly(b *testing.B) {
	var x e_nocarry_0409
	x.SetRandom()
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0409)
	}
}

func BenchmarkE_nocarry_0409Exp(b *testing.B) {
	var x e_nocarry_0409
	x.SetRandom()
	benchRese_nocarry_0409.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0409Double(b *testing.B) {
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Double(&benchRese_nocarry_0409)
	}
}

func BenchmarkE_nocarry_0409Add(b *testing.B) {
	var x e_nocarry_0409
	x.SetRandom()
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Add(&x, &benchRese_nocarry_0409)
	}
}

func BenchmarkE_nocarry_0409Sub(b *testing.B) {
	var x e_nocarry_0409
	x.SetRandom()
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Sub(&x, &benchRese_nocarry_0409)
	}
}

func BenchmarkE_nocarry_0409Neg(b *testing.B) {
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Neg(&benchRese_nocarry_0409)
	}
}

func BenchmarkE_nocarry_0409Div(b *testing.B) {
	var x e_nocarry_0409
	x.SetRandom()
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Div(&x, &benchRese_nocarry_0409)
	}
}

func BenchmarkE_nocarry_0409FromMont(b *testing.B) {
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.FromMont()
	}
}

func BenchmarkE_nocarry_0409ToMont(b *testing.B) {
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.ToMont()
	}
}
func BenchmarkE_nocarry_0409Square(b *testing.B) {
	benchRese_nocarry_0409.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Square(&benchRese_nocarry_0409)
	}
}

func BenchmarkE_nocarry_0409Sqrt(b *testing.B) {
	var a e_nocarry_0409
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0409Mul(b *testing.B) {
	x := e_nocarry_0409{
		2607735367923789711,
	...
	benchRese_nocarry_0409.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Mul(&benchRese_nocarry_0409, &x)
	}
}

func BenchmarkE_nocarry_0409Cmp(b *testing.B) {
	x := e_nocarry_0409{
		2607735367923789711,
		16724075738580382487,
		10936512138623929026,
	...
	benchRese_nocarry_0409 = x
	benchRese_nocarry_0409[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0409.Cmp(&x)
	}
}

func TestE_nocarry_0409Cmp(t *testing.T) {
	var x, y e_nocarry_0409
...
func TestE_nocarry_0409IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0409
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0409

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0409{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0409
	one.SetOne()
	e.Sub(&qe_nocarry_0409, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0409{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0409{0, uint64(i)})
	}
...
func TestE_nocarry_0409NegZero(t *testing.T) {
	var a, b e_nocarry_0409
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0409Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0409, len(staticTestValues))
...
func TestE_nocarry_0409Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0409) bool {
			var b e_nocarry_0409
...
func TestE_nocarry_0409InverseExp(t *testing.T) {
...
func TestE_nocarry_0409MulByConstants(t *testing.T) {
...
func TestE_nocarry_0409Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0409) bool {
...
func TestE_nocarry_0409LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0409Halve(t *testing.T) {
...
func TestE_nocarry_0409FromMont(t *testing.T) {
...
type testPaire_nocarry_0409 struct {
	element e_nocarry_0409
	bigint  big.Int
}

func (z *e_nocarry_0409) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0409[6] {
		return true
	}
	if z[6] < qe_nocarry_0409[6] {
		return false
	...
	return z[0] >= qe_nocarry_0409[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0409

		g.element = e_nocarry_0409{
		...
		if qe_nocarry_0409[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0409[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0409 {
			var g e_nocarry_0409
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0409[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0409[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0409[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0409[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0409[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0409[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0409[6], carry)
...
func Benchmarke_nocarry_0409InverseNew(b *testing.B) {
	var x e_nocarry_0409
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0409
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0409
		var xInv e_nocarry_0409
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0409
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0409
...
func testLinearComb(t *testing.T, x *e_nocarry_0409, xC int64, y *e_nocarry_0409, yC int64) {
	...
	var z e_nocarry_0409
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0409, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0409
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0409, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0409
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0409, xHi uint64) {
	var res e_nocarry_0409
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0409) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0409) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0409, c int64, result *e_nocarry_0409, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0409) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0409) uint64 {
