...
// modulus q
DATA q<>+0(SB)/8, $0xbff6cc28274de249
DATA q<>+8(SB)/8, $0x1d8a6b60fb0bdd4b
DATA q<>+16(SB)/8, $0xf0ae98631b9598fc
DATA q<>+24(SB)/8, $0x4c7d323db42736d0
DATA q<>+32(SB)/8, $0x2b07c744cbfaa248
DATA q<>+40(SB)/8, $0x19de63c85be2f53a
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x735ba67d64e85007
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xbff6cc28274de249, R10
	MOVQ    $0x1d8a6b60fb0bdd4b, R11
	MOVQ    $0xf0ae98631b9598fc, R12
	MOVQ    $0x4c7d323db42736d0, R13
	MOVQ    $0x2b07c744cbfaa248, R14
	MOVQ    $0x19de63c85be2f53a, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x1d8a6b60fb0bdd4b, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xf0ae98631b9598fc, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x4c7d323db42736d0, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x2b07c744cbfaa248, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x19de63c85be2f53a, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xbff6cc28274de249, CX
	MOVQ    $0x1d8a6b60fb0bdd4b, BX
	MOVQ    $0xf0ae98631b9598fc, SI
	MOVQ    $0x4c7d323db42736d0, DI
	MOVQ    $0x2b07c744cbfaa248, R8
	MOVQ    $0x19de63c85be2f53a, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
