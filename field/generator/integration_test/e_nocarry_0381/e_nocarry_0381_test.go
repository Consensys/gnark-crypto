...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0381{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0381{0, uint64(i)})
	}
...
func (z *e_nocarry_0381) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0381[5] {
		return true
	}
	if z[5] < qe_nocarry_0381[5] {
		return false
...
func Benchmarke_nocarry_0381InverseNew(b *testing.B) {
	var x e_nocarry_0381
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0381, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0381, xHi uint64) {
