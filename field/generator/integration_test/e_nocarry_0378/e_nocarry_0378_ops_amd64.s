...
// modulus q
DATA q<>+0(SB)/8, $0x821ac98683961e2f
DATA q<>+8(SB)/8, $0xc6f3801ee4c4adee
DATA q<>+16(SB)/8, $0x1c07c1392519b2b9
DATA q<>+24(SB)/8, $0xf742132deeb23a2a
DATA q<>+32(SB)/8, $0x6ef4c7a36ca049cd
DATA q<>+40(SB)/8, $0x0327ff368dd49bd3
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xa707dde43fd21731
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x821ac98683961e2f, R10
	MOVQ    $0xc6f3801ee4c4adee, R11
	MOVQ    $0x1c07c1392519b2b9, R12
	MOVQ    $0xf742132deeb23a2a, R13
	MOVQ    $0x6ef4c7a36ca049cd, R14
	MOVQ    $0x0327ff368dd49bd3, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xc6f3801ee4c4adee, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x1c07c1392519b2b9, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xf742132deeb23a2a, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x6ef4c7a36ca049cd, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0327ff368dd49bd3, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x821ac98683961e2f, CX
	MOVQ    $0xc6f3801ee4c4adee, BX
	MOVQ    $0x1c07c1392519b2b9, SI
	MOVQ    $0xf742132deeb23a2a, DI
	MOVQ    $0x6ef4c7a36ca049cd, R8
	MOVQ    $0x0327ff368dd49bd3, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
