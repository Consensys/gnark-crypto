...
var benchRese_nocarry_0378 e_nocarry_0378

func BenchmarkE_nocarry_0378SetBytes(b *testing.B) {
	var x e_nocarry_0378
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0378MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0378.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0378)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0378)
		}
	})
}

func BenchmarkE_nocarry_0378Inverse(b *testing.B) {
	var x e_nocarry_0378
	x.SetRandom()
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0378Butterfly(b *testing.B) {
	var x e_nocarry_0378
	x.SetRandom()
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0378)
	}
}

func BenchmarkE_nocarry_0378Exp(b *testing.B) {
	var x e_nocarry_0378
	x.SetRandom()
	benchRese_nocarry_0378.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0378Double(b *testing.B) {
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Double(&benchRese_nocarry_0378)
	}
}

func BenchmarkE_nocarry_0378Add(b *testing.B) {
	var x e_nocarry_0378
	x.SetRandom()
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Add(&x, &benchRese_nocarry_0378)
	}
}

func BenchmarkE_nocarry_0378Sub(b *testing.B) {
	var x e_nocarry_0378
	x.SetRandom()
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Sub(&x, &benchRese_nocarry_0378)
	}
}

func BenchmarkE_nocarry_0378Neg(b *testing.B) {
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Neg(&benchRese_nocarry_0378)
	}
}

func BenchmarkE_nocarry_0378Div(b *testing.B) {
	var x e_nocarry_0378
	x.SetRandom()
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Div(&x, &benchRese_nocarry_0378)
	}
}

func BenchmarkE_nocarry_0378FromMont(b *testing.B) {
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.FromMont()
	}
}

func BenchmarkE_nocarry_0378ToMont(b *testing.B) {
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.ToMont()
	}
}
func BenchmarkE_nocarry_0378Square(b *testing.B) {
	benchRese_nocarry_0378.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Square(&benchRese_nocarry_0378)
	}
}

func BenchmarkE_nocarry_0378Sqrt(b *testing.B) {
	var a e_nocarry_0378
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0378Mul(b *testing.B) {
	x := e_nocarry_0378{
	...
	benchRese_nocarry_0378.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Mul(&benchRese_nocarry_0378, &x)
	}
}

func BenchmarkE_nocarry_0378Cmp(b *testing.B) {
	x := e_nocarry_0378{
		16749906419510764793,
		18197713894867658141,
		3796968928704591674,
	...
	benchRese_nocarry_0378 = x
	benchRese_nocarry_0378[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0378.Cmp(&x)
	}
}

func TestE_nocarry_0378Cmp(t *testing.T) {
	var x, y e_nocarry_0378
...
func TestE_nocarry_0378IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0378
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0378

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0378{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0378
	one.SetOne()
	e.Sub(&qe_nocarry_0378, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0378{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0378{0, uint64(i)})
	}
...
func TestE_nocarry_0378NegZero(t *testing.T) {
	var a, b e_nocarry_0378
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0378Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0378, len(staticTestValues))
...
func TestE_nocarry_0378Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0378) bool {
			var b e_nocarry_0378
...
func TestE_nocarry_0378InverseExp(t *testing.T) {
...
func TestE_nocarry_0378MulByConstants(t *testing.T) {
...
func TestE_nocarry_0378Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0378) bool {
...
func TestE_nocarry_0378LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0378Halve(t *testing.T) {
...
func TestE_nocarry_0378FromMont(t *testing.T) {
...
type testPaire_nocarry_0378 struct {
	element e_nocarry_0378
	bigint  big.Int
}

func (z *e_nocarry_0378) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0378[5] {
		return true
	}
	if z[5] < qe_nocarry_0378[5] {
		return false
	...
	return z[0] >= qe_nocarry_0378[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0378

		g.element = e_nocarry_0378{
		...
		if qe_nocarry_0378[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0378[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0378 {
			var g e_nocarry_0378
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0378[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0378[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0378[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0378[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0378[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0378[5], carry)
...
func Benchmarke_nocarry_0378InverseNew(b *testing.B) {
	var x e_nocarry_0378
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0378
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0378
		var xInv e_nocarry_0378
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0378
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0378
...
func testLinearComb(t *testing.T, x *e_nocarry_0378, xC int64, y *e_nocarry_0378, yC int64) {
	...
	var z e_nocarry_0378
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0378, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0378
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0378, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0378
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0378, xHi uint64) {
	var res e_nocarry_0378
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0378) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0378) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0378, c int64, result *e_nocarry_0378, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0378) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0378) uint64 {
