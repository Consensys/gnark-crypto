...
// modulus q
DATA q<>+0(SB)/8, $0x1d21f65b607c7557
DATA q<>+8(SB)/8, $0xd2bd914b1f40b469
DATA q<>+16(SB)/8, $0xb9d18c7b8bf9b8e0
DATA q<>+24(SB)/8, $0x171289283bb64fe5
DATA q<>+32(SB)/8, $0xfbee572144fd4a48
DATA q<>+40(SB)/8, $0x0000000000000305
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x66a6af8afc7eb999
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x1d21f65b607c7557, R10
	MOVQ    $0xd2bd914b1f40b469, R11
	MOVQ    $0xb9d18c7b8bf9b8e0, R12
	MOVQ    $0x171289283bb64fe5, R13
	MOVQ    $0xfbee572144fd4a48, R14
	MOVQ    $0x0000000000000305, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xd2bd914b1f40b469, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xb9d18c7b8bf9b8e0, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x171289283bb64fe5, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xfbee572144fd4a48, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000000000305, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x1d21f65b607c7557, CX
	MOVQ    $0xd2bd914b1f40b469, BX
	MOVQ    $0xb9d18c7b8bf9b8e0, SI
	MOVQ    $0x171289283bb64fe5, DI
	MOVQ    $0xfbee572144fd4a48, R8
	MOVQ    $0x0000000000000305, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
