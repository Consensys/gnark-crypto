...
var benchRese_nocarry_0330 e_nocarry_0330

func BenchmarkE_nocarry_0330SetBytes(b *testing.B) {
	var x e_nocarry_0330
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0330MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0330.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0330)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0330)
		}
	})
}

func BenchmarkE_nocarry_0330Inverse(b *testing.B) {
	var x e_nocarry_0330
	x.SetRandom()
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0330Butterfly(b *testing.B) {
	var x e_nocarry_0330
	x.SetRandom()
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0330)
	}
}

func BenchmarkE_nocarry_0330Exp(b *testing.B) {
	var x e_nocarry_0330
	x.SetRandom()
	benchRese_nocarry_0330.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0330Double(b *testing.B) {
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Double(&benchRese_nocarry_0330)
	}
}

func BenchmarkE_nocarry_0330Add(b *testing.B) {
	var x e_nocarry_0330
	x.SetRandom()
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Add(&x, &benchRese_nocarry_0330)
	}
}

func BenchmarkE_nocarry_0330Sub(b *testing.B) {
	var x e_nocarry_0330
	x.SetRandom()
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Sub(&x, &benchRese_nocarry_0330)
	}
}

func BenchmarkE_nocarry_0330Neg(b *testing.B) {
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Neg(&benchRese_nocarry_0330)
	}
}

func BenchmarkE_nocarry_0330Div(b *testing.B) {
	var x e_nocarry_0330
	x.SetRandom()
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Div(&x, &benchRese_nocarry_0330)
	}
}

func BenchmarkE_nocarry_0330FromMont(b *testing.B) {
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.FromMont()
	}
}

func BenchmarkE_nocarry_0330ToMont(b *testing.B) {
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.ToMont()
	}
}
func BenchmarkE_nocarry_0330Square(b *testing.B) {
	benchRese_nocarry_0330.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Square(&benchRese_nocarry_0330)
	}
}

func BenchmarkE_nocarry_0330Sqrt(b *testing.B) {
	var a e_nocarry_0330
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0330Mul(b *testing.B) {
	x := e_nocarry_0330{
	...
	benchRese_nocarry_0330.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Mul(&benchRese_nocarry_0330, &x)
	}
}

func BenchmarkE_nocarry_0330Cmp(b *testing.B) {
	x := e_nocarry_0330{
		15487554534646622453,
		9064196648980287114,
		13203139680937703421,
	...
	benchRese_nocarry_0330 = x
	benchRese_nocarry_0330[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0330.Cmp(&x)
	}
}

func TestE_nocarry_0330Cmp(t *testing.T) {
	var x, y e_nocarry_0330
...
func TestE_nocarry_0330IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0330
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0330

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0330{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0330
	one.SetOne()
	e.Sub(&qe_nocarry_0330, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0330{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0330{0, uint64(i)})
	}
...
func TestE_nocarry_0330NegZero(t *testing.T) {
	var a, b e_nocarry_0330
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0330Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0330, len(staticTestValues))
...
func TestE_nocarry_0330Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0330) bool {
			var b e_nocarry_0330
...
func TestE_nocarry_0330InverseExp(t *testing.T) {
...
func TestE_nocarry_0330MulByConstants(t *testing.T) {
...
func TestE_nocarry_0330Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0330) bool {
...
func TestE_nocarry_0330LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0330Halve(t *testing.T) {
...
func TestE_nocarry_0330FromMont(t *testing.T) {
...
type testPaire_nocarry_0330 struct {
	element e_nocarry_0330
	bigint  big.Int
}

func (z *e_nocarry_0330) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0330[5] {
		return true
	}
	if z[5] < qe_nocarry_0330[5] {
		return false
	...
	return z[0] >= qe_nocarry_0330[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0330

		g.element = e_nocarry_0330{
		...
		if qe_nocarry_0330[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0330[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0330 {
			var g e_nocarry_0330
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0330[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0330[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0330[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0330[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0330[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0330[5], carry)
...
func Benchmarke_nocarry_0330InverseNew(b *testing.B) {
	var x e_nocarry_0330
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0330
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0330
		var xInv e_nocarry_0330
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0330
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0330
...
func testLinearComb(t *testing.T, x *e_nocarry_0330, xC int64, y *e_nocarry_0330, yC int64) {
	...
	var z e_nocarry_0330
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0330, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0330
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0330, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0330
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0330, xHi uint64) {
	var res e_nocarry_0330
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0330) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0330) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0330, c int64, result *e_nocarry_0330, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0330) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0330) uint64 {
