...
// modulus q
DATA q<>+0(SB)/8, $0x57032e4341b25e79
DATA q<>+8(SB)/8, $0x839945a8a36fd53c
DATA q<>+16(SB)/8, $0xc53229ea0c031923
DATA q<>+24(SB)/8, $0xf2c30526f6685da6
DATA q<>+32(SB)/8, $0x00000000000001ec
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x903e5ce1359e5437
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x57032e4341b25e79, R9
	MOVQ    $0x839945a8a36fd53c, R10
	MOVQ    $0xc53229ea0c031923, R11
	MOVQ    $0xf2c30526f6685da6, R12
	MOVQ    $0x00000000000001ec, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x839945a8a36fd53c, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xc53229ea0c031923, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xf2c30526f6685da6, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00000000000001ec, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x57032e4341b25e79, CX
	MOVQ    $0x839945a8a36fd53c, BX
	MOVQ    $0xc53229ea0c031923, SI
	MOVQ    $0xf2c30526f6685da6, DI
	MOVQ    $0x00000000000001ec, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
