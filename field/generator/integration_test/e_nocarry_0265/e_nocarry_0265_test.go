...
var benchRese_nocarry_0265 e_nocarry_0265

func BenchmarkE_nocarry_0265SetBytes(b *testing.B) {
	var x e_nocarry_0265
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0265MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0265.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0265)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0265)
		}
	})
}

func BenchmarkE_nocarry_0265Inverse(b *testing.B) {
	var x e_nocarry_0265
	x.SetRandom()
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0265Butterfly(b *testing.B) {
	var x e_nocarry_0265
	x.SetRandom()
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0265)
	}
}

func BenchmarkE_nocarry_0265Exp(b *testing.B) {
	var x e_nocarry_0265
	x.SetRandom()
	benchRese_nocarry_0265.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0265Double(b *testing.B) {
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Double(&benchRese_nocarry_0265)
	}
}

func BenchmarkE_nocarry_0265Add(b *testing.B) {
	var x e_nocarry_0265
	x.SetRandom()
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Add(&x, &benchRese_nocarry_0265)
	}
}

func BenchmarkE_nocarry_0265Sub(b *testing.B) {
	var x e_nocarry_0265
	x.SetRandom()
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Sub(&x, &benchRese_nocarry_0265)
	}
}

func BenchmarkE_nocarry_0265Neg(b *testing.B) {
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Neg(&benchRese_nocarry_0265)
	}
}

func BenchmarkE_nocarry_0265Div(b *testing.B) {
	var x e_nocarry_0265
	x.SetRandom()
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Div(&x, &benchRese_nocarry_0265)
	}
}

func BenchmarkE_nocarry_0265FromMont(b *testing.B) {
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.FromMont()
	}
}

func BenchmarkE_nocarry_0265ToMont(b *testing.B) {
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.ToMont()
	}
}
func BenchmarkE_nocarry_0265Square(b *testing.B) {
	benchRese_nocarry_0265.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Square(&benchRese_nocarry_0265)
	}
}

func BenchmarkE_nocarry_0265Sqrt(b *testing.B) {
	var a e_nocarry_0265
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0265Mul(b *testing.B) {
	x := e_nocarry_0265{
		7962195926124620840,
		542065632775694357,
	...
	benchRese_nocarry_0265.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Mul(&benchRese_nocarry_0265, &x)
	}
}

func BenchmarkE_nocarry_0265Cmp(b *testing.B) {
	x := e_nocarry_0265{
		7962195926124620840,
		542065632775694357,
		15455328717429249221,
	...
	benchRese_nocarry_0265 = x
	benchRese_nocarry_0265[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0265.Cmp(&x)
	}
}

func TestE_nocarry_0265Cmp(t *testing.T) {
	var x, y e_nocarry_0265
...
func TestE_nocarry_0265IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0265
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0265

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0265{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0265
	one.SetOne()
	e.Sub(&qe_nocarry_0265, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0265{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0265{0, uint64(i)})
	}
...
func TestE_nocarry_0265NegZero(t *testing.T) {
	var a, b e_nocarry_0265
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0265Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0265, len(staticTestValues))
...
func TestE_nocarry_0265Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0265) bool {
			var b e_nocarry_0265
...
func TestE_nocarry_0265InverseExp(t *testing.T) {
...
func TestE_nocarry_0265MulByConstants(t *testing.T) {
...
func TestE_nocarry_0265Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0265) bool {
...
func TestE_nocarry_0265LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0265Halve(t *testing.T) {
...
func TestE_nocarry_0265FromMont(t *testing.T) {
...
type testPaire_nocarry_0265 struct {
	element e_nocarry_0265
	bigint  big.Int
}

func (z *e_nocarry_0265) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0265[4] {
		return true
	}
	if z[4] < qe_nocarry_0265[4] {
		return false
	...
	return z[0] >= qe_nocarry_0265[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0265

		g.element = e_nocarry_0265{
		...
		if qe_nocarry_0265[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0265[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0265 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0265[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0265[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0265[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0265[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0265[4], carry)
...
func Benchmarke_nocarry_0265InverseNew(b *testing.B) {
	var x e_nocarry_0265
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0265
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0265
		var xInv e_nocarry_0265
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0265
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0265
...
func testLinearComb(t *testing.T, x *e_nocarry_0265, xC int64, y *e_nocarry_0265, yC int64) {
	...
	var z e_nocarry_0265
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0265, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0265
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0265, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0265
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0265, xHi uint64) {
	var res e_nocarry_0265
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0265) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0265) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0265, c int64, result *e_nocarry_0265, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0265) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0265) uint64 {
