...
var benchRese_nocarry_0559 e_nocarry_0559

func BenchmarkE_nocarry_0559SetBytes(b *testing.B) {
	var x e_nocarry_0559
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0559MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0559.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0559)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0559)
		}
	})
}

func BenchmarkE_nocarry_0559Inverse(b *testing.B) {
	var x e_nocarry_0559
	x.SetRandom()
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0559Butterfly(b *testing.B) {
	var x e_nocarry_0559
	x.SetRandom()
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0559)
	}
}

func BenchmarkE_nocarry_0559Exp(b *testing.B) {
	var x e_nocarry_0559
	x.SetRandom()
	benchRese_nocarry_0559.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0559Double(b *testing.B) {
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Double(&benchRese_nocarry_0559)
	}
}

func BenchmarkE_nocarry_0559Add(b *testing.B) {
	var x e_nocarry_0559
	x.SetRandom()
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Add(&x, &benchRese_nocarry_0559)
	}
}

func BenchmarkE_nocarry_0559Sub(b *testing.B) {
	var x e_nocarry_0559
	x.SetRandom()
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Sub(&x, &benchRese_nocarry_0559)
	}
}

func BenchmarkE_nocarry_0559Neg(b *testing.B) {
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Neg(&benchRese_nocarry_0559)
	}
}

func BenchmarkE_nocarry_0559Div(b *testing.B) {
	var x e_nocarry_0559
	x.SetRandom()
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Div(&x, &benchRese_nocarry_0559)
	}
}

func BenchmarkE_nocarry_0559FromMont(b *testing.B) {
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.FromMont()
	}
}

func BenchmarkE_nocarry_0559ToMont(b *testing.B) {
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.ToMont()
	}
}
func BenchmarkE_nocarry_0559Square(b *testing.B) {
	benchRese_nocarry_0559.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Square(&benchRese_nocarry_0559)
	}
}

func BenchmarkE_nocarry_0559Sqrt(b *testing.B) {
	var a e_nocarry_0559
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0559Mul(b *testing.B) {
	x := e_nocarry_0559{
		4815682197492755923,
		7872793830783661539,
		8048781979914485862,
	...
	benchRese_nocarry_0559.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Mul(&benchRese_nocarry_0559, &x)
	}
}

func BenchmarkE_nocarry_0559Cmp(b *testing.B) {
	x := e_nocarry_0559{
		4815682197492755923,
		7872793830783661539,
		8048781979914485862,
	...
	benchRese_nocarry_0559 = x
	benchRese_nocarry_0559[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0559.Cmp(&x)
	}
}

func TestE_nocarry_0559Cmp(t *testing.T) {
	var x, y e_nocarry_0559
...
func TestE_nocarry_0559IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0559
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0559

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0559{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0559
	one.SetOne()
	e.Sub(&qe_nocarry_0559, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0559{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0559{0, uint64(i)})
	}
...
func TestE_nocarry_0559NegZero(t *testing.T) {
	var a, b e_nocarry_0559
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0559Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0559, len(staticTestValues))
...
func TestE_nocarry_0559Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0559) bool {
			var b e_nocarry_0559
...
func TestE_nocarry_0559InverseExp(t *testing.T) {
...
func TestE_nocarry_0559MulByConstants(t *testing.T) {
...
func TestE_nocarry_0559Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0559) bool {
...
func TestE_nocarry_0559LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0559Halve(t *testing.T) {
...
func TestE_nocarry_0559FromMont(t *testing.T) {
...
type testPaire_nocarry_0559 struct {
	element e_nocarry_0559
	bigint  big.Int
}

func (z *e_nocarry_0559) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0559[8] {
		return true
	}
	if z[8] < qe_nocarry_0559[8] {
		return false
	...
	return z[0] >= qe_nocarry_0559[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0559

		g.element = e_nocarry_0559{
		...
		if qe_nocarry_0559[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0559[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0559 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0559[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0559[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0559[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0559[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0559[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0559[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0559[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0559[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0559[8], carry)
...
func Benchmarke_nocarry_0559InverseNew(b *testing.B) {
	var x e_nocarry_0559
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0559
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0559
		var xInv e_nocarry_0559
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0559
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0559
...
func testLinearComb(t *testing.T, x *e_nocarry_0559, xC int64, y *e_nocarry_0559, yC int64) {
	...
	var z e_nocarry_0559
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0559, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0559
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0559, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0559
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0559, xHi uint64) {
	var res e_nocarry_0559
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0559) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0559) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0559, c int64, result *e_nocarry_0559, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0559) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0559) uint64 {
