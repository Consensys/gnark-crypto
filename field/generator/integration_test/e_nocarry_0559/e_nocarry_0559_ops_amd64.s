...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x11289059a778f031, R12
	ADDQ R12, AX
	MOVQ $0x289606cfd9b641f9, R12
	ADCQ R12, DX
	MOVQ $0x51556a3f79eb227d, R12
	ADCQ R12, CX
	MOVQ $0xad9d75699dd4bb09, R12
	ADCQ R12, BX
	MOVQ $0x69e6a0e55bbdebe6, R12
	ADCQ R12, SI
	MOVQ $0xa8f6f007c29f6f78, R12
	ADCQ R12, DI
	MOVQ $0x6cdace2f26a6fdde, R12
	ADCQ R12, R8
	MOVQ $0x5db8fda6eb5169b9, R12
	ADCQ R12, R9
	MOVQ $0x00006eb7fa5ddf6b, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x11289059a778f031, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x289606cfd9b641f9, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x51556a3f79eb227d, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xad9d75699dd4bb09, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x69e6a0e55bbdebe6, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xa8f6f007c29f6f78, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x6cdace2f26a6fdde, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x5db8fda6eb5169b9, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00006eb7fa5ddf6b, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x11289059a778f031, AX
	ADDQ AX, DX
	MOVQ $0x289606cfd9b641f9, AX
	ADCQ AX, CX
	MOVQ $0x51556a3f79eb227d, AX
	ADCQ AX, BX
	MOVQ $0xad9d75699dd4bb09, AX
	ADCQ AX, SI
	MOVQ $0x69e6a0e55bbdebe6, AX
	ADCQ AX, DI
	MOVQ $0xa8f6f007c29f6f78, AX
	ADCQ AX, R8
	MOVQ $0x6cdace2f26a6fdde, AX
	ADCQ AX, R9
	MOVQ $0x5db8fda6eb5169b9, AX
	ADCQ AX, R10
	MOVQ $0x00006eb7fa5ddf6b, AX
	ADCQ AX, R11
