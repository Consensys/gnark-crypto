...
var benchRese_nocarry_0411 e_nocarry_0411

func BenchmarkE_nocarry_0411SetBytes(b *testing.B) {
	var x e_nocarry_0411
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0411MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0411.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0411)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0411)
		}
	})
}

func BenchmarkE_nocarry_0411Inverse(b *testing.B) {
	var x e_nocarry_0411
	x.SetRandom()
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0411Butterfly(b *testing.B) {
	var x e_nocarry_0411
	x.SetRandom()
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0411)
	}
}

func BenchmarkE_nocarry_0411Exp(b *testing.B) {
	var x e_nocarry_0411
	x.SetRandom()
	benchRese_nocarry_0411.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0411Double(b *testing.B) {
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Double(&benchRese_nocarry_0411)
	}
}

func BenchmarkE_nocarry_0411Add(b *testing.B) {
	var x e_nocarry_0411
	x.SetRandom()
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Add(&x, &benchRese_nocarry_0411)
	}
}

func BenchmarkE_nocarry_0411Sub(b *testing.B) {
	var x e_nocarry_0411
	x.SetRandom()
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Sub(&x, &benchRese_nocarry_0411)
	}
}

func BenchmarkE_nocarry_0411Neg(b *testing.B) {
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Neg(&benchRese_nocarry_0411)
	}
}

func BenchmarkE_nocarry_0411Div(b *testing.B) {
	var x e_nocarry_0411
	x.SetRandom()
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Div(&x, &benchRese_nocarry_0411)
	}
}

func BenchmarkE_nocarry_0411FromMont(b *testing.B) {
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.FromMont()
	}
}

func BenchmarkE_nocarry_0411ToMont(b *testing.B) {
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.ToMont()
	}
}
func BenchmarkE_nocarry_0411Square(b *testing.B) {
	benchRese_nocarry_0411.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Square(&benchRese_nocarry_0411)
	}
}

func BenchmarkE_nocarry_0411Sqrt(b *testing.B) {
	var a e_nocarry_0411
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0411Mul(b *testing.B) {
	x := e_nocarry_0411{
	...
	benchRese_nocarry_0411.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Mul(&benchRese_nocarry_0411, &x)
	}
}

func BenchmarkE_nocarry_0411Cmp(b *testing.B) {
	x := e_nocarry_0411{
		13663535102535969362,
		4926611999192815558,
		9588970025361705173,
	...
	benchRese_nocarry_0411 = x
	benchRese_nocarry_0411[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0411.Cmp(&x)
	}
}

func TestE_nocarry_0411Cmp(t *testing.T) {
	var x, y e_nocarry_0411
...
func TestE_nocarry_0411IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0411
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0411

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0411{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0411
	one.SetOne()
	e.Sub(&qe_nocarry_0411, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0411{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0411{0, uint64(i)})
	}
...
func TestE_nocarry_0411NegZero(t *testing.T) {
	var a, b e_nocarry_0411
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0411Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0411, len(staticTestValues))
...
func TestE_nocarry_0411Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0411) bool {
			var b e_nocarry_0411
...
func TestE_nocarry_0411InverseExp(t *testing.T) {
...
func TestE_nocarry_0411MulByConstants(t *testing.T) {
...
func TestE_nocarry_0411Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0411) bool {
...
func TestE_nocarry_0411LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0411Halve(t *testing.T) {
...
func TestE_nocarry_0411FromMont(t *testing.T) {
...
type testPaire_nocarry_0411 struct {
	element e_nocarry_0411
	bigint  big.Int
}

func (z *e_nocarry_0411) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0411[6] {
		return true
	}
	if z[6] < qe_nocarry_0411[6] {
		return false
	...
	return z[0] >= qe_nocarry_0411[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0411

		g.element = e_nocarry_0411{
		...
		if qe_nocarry_0411[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0411[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0411 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0411[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0411[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0411[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0411[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0411[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0411[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0411[6], carry)
...
func Benchmarke_nocarry_0411InverseNew(b *testing.B) {
	var x e_nocarry_0411
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0411
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0411
		var xInv e_nocarry_0411
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0411
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0411
...
func testLinearComb(t *testing.T, x *e_nocarry_0411, xC int64, y *e_nocarry_0411, yC int64) {
	...
	var z e_nocarry_0411
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0411, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0411
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0411, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0411
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0411, xHi uint64) {
	var res e_nocarry_0411
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0411) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0411) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0411, c int64, result *e_nocarry_0411, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0411) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0411) uint64 {
