...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x523f588668217ef3, R12
	ADDQ R12, AX
	MOVQ $0xb2b379105a946173, R12
	ADCQ R12, DX
	MOVQ $0x94de00532328ad09, R12
	ADCQ R12, CX
	MOVQ $0xc8413ce48774ee66, R12
	ADCQ R12, BX
	MOVQ $0xc88237cee0cb3513, R12
	ADCQ R12, SI
	MOVQ $0x6a1fe6ed762f58ee, R12
	ADCQ R12, DI
	MOVQ $0xf84368981c8e7a79, R12
	ADCQ R12, R8
	MOVQ $0xc4208f3b6637f100, R12
	ADCQ R12, R9
	MOVQ $0x0069dc2afd74260e, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x523f588668217ef3, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xb2b379105a946173, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x94de00532328ad09, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xc8413ce48774ee66, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xc88237cee0cb3513, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x6a1fe6ed762f58ee, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xf84368981c8e7a79, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xc4208f3b6637f100, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0069dc2afd74260e, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x523f588668217ef3, AX
	ADDQ AX, DX
	MOVQ $0xb2b379105a946173, AX
	ADCQ AX, CX
	MOVQ $0x94de00532328ad09, AX
	ADCQ AX, BX
	MOVQ $0xc8413ce48774ee66, AX
	ADCQ AX, SI
	MOVQ $0xc88237cee0cb3513, AX
	ADCQ AX, DI
	MOVQ $0x6a1fe6ed762f58ee, AX
	ADCQ AX, R8
	MOVQ $0xf84368981c8e7a79, AX
	ADCQ AX, R9
	MOVQ $0xc4208f3b6637f100, AX
	ADCQ AX, R10
	MOVQ $0x0069dc2afd74260e, AX
	ADCQ AX, R11
