...
var benchRese_nocarry_0567 e_nocarry_0567

func BenchmarkE_nocarry_0567SetBytes(b *testing.B) {
	var x e_nocarry_0567
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0567MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0567.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0567)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0567)
		}
	})
}

func BenchmarkE_nocarry_0567Inverse(b *testing.B) {
	var x e_nocarry_0567
	x.SetRandom()
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0567Butterfly(b *testing.B) {
	var x e_nocarry_0567
	x.SetRandom()
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0567)
	}
}

func BenchmarkE_nocarry_0567Exp(b *testing.B) {
	var x e_nocarry_0567
	x.SetRandom()
	benchRese_nocarry_0567.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0567Double(b *testing.B) {
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Double(&benchRese_nocarry_0567)
	}
}

func BenchmarkE_nocarry_0567Add(b *testing.B) {
	var x e_nocarry_0567
	x.SetRandom()
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Add(&x, &benchRese_nocarry_0567)
	}
}

func BenchmarkE_nocarry_0567Sub(b *testing.B) {
	var x e_nocarry_0567
	x.SetRandom()
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Sub(&x, &benchRese_nocarry_0567)
	}
}

func BenchmarkE_nocarry_0567Neg(b *testing.B) {
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Neg(&benchRese_nocarry_0567)
	}
}

func BenchmarkE_nocarry_0567Div(b *testing.B) {
	var x e_nocarry_0567
	x.SetRandom()
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Div(&x, &benchRese_nocarry_0567)
	}
}

func BenchmarkE_nocarry_0567FromMont(b *testing.B) {
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.FromMont()
	}
}

func BenchmarkE_nocarry_0567ToMont(b *testing.B) {
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.ToMont()
	}
}
func BenchmarkE_nocarry_0567Square(b *testing.B) {
	benchRese_nocarry_0567.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Square(&benchRese_nocarry_0567)
	}
}

func BenchmarkE_nocarry_0567Sqrt(b *testing.B) {
	var a e_nocarry_0567
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0567Mul(b *testing.B) {
	x := e_nocarry_0567{
	...
	benchRese_nocarry_0567.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Mul(&benchRese_nocarry_0567, &x)
	}
}

func BenchmarkE_nocarry_0567Cmp(b *testing.B) {
	x := e_nocarry_0567{
		18009526841313272016,
		6403099475832168902,
		7765220927945539918,
	...
	benchRese_nocarry_0567 = x
	benchRese_nocarry_0567[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0567.Cmp(&x)
	}
}

func TestE_nocarry_0567Cmp(t *testing.T) {
	var x, y e_nocarry_0567
...
func TestE_nocarry_0567IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0567
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0567

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0567{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0567
	one.SetOne()
	e.Sub(&qe_nocarry_0567, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0567{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0567{0, uint64(i)})
	}
...
func TestE_nocarry_0567NegZero(t *testing.T) {
	var a, b e_nocarry_0567
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0567Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0567, len(staticTestValues))
...
func TestE_nocarry_0567Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0567) bool {
			var b e_nocarry_0567
...
func TestE_nocarry_0567InverseExp(t *testing.T) {
...
func TestE_nocarry_0567MulByConstants(t *testing.T) {
...
func TestE_nocarry_0567Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0567) bool {
...
func TestE_nocarry_0567LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0567Halve(t *testing.T) {
...
func TestE_nocarry_0567FromMont(t *testing.T) {
...
type testPaire_nocarry_0567 struct {
	element e_nocarry_0567
	bigint  big.Int
}

func (z *e_nocarry_0567) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0567[8] {
		return true
	}
	if z[8] < qe_nocarry_0567[8] {
		return false
	...
	return z[0] >= qe_nocarry_0567[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0567

		g.element = e_nocarry_0567{
		...
		if qe_nocarry_0567[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0567[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0567 {
			var g e_nocarry_0567
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0567[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0567[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0567[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0567[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0567[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0567[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0567[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0567[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0567[8], carry)
...
func Benchmarke_nocarry_0567InverseNew(b *testing.B) {
	var x e_nocarry_0567
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0567
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0567
		var xInv e_nocarry_0567
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0567
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0567
...
func testLinearComb(t *testing.T, x *e_nocarry_0567, xC int64, y *e_nocarry_0567, yC int64) {
	...
	var z e_nocarry_0567
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0567, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0567
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0567, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0567
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0567, xHi uint64) {
	var res e_nocarry_0567
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0567) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0567) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0567, c int64, result *e_nocarry_0567, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0567) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0567) uint64 {
