...
var benchRese_nocarry_0138 e_nocarry_0138

func BenchmarkE_nocarry_0138SetBytes(b *testing.B) {
	var x e_nocarry_0138
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0138MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0138.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0138)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0138)
		}
	})
}

func BenchmarkE_nocarry_0138Inverse(b *testing.B) {
	var x e_nocarry_0138
	x.SetRandom()
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0138Butterfly(b *testing.B) {
	var x e_nocarry_0138
	x.SetRandom()
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0138)
	}
}

func BenchmarkE_nocarry_0138Exp(b *testing.B) {
	var x e_nocarry_0138
	x.SetRandom()
	benchRese_nocarry_0138.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0138Double(b *testing.B) {
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Double(&benchRese_nocarry_0138)
	}
}

func BenchmarkE_nocarry_0138Add(b *testing.B) {
	var x e_nocarry_0138
	x.SetRandom()
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Add(&x, &benchRese_nocarry_0138)
	}
}

func BenchmarkE_nocarry_0138Sub(b *testing.B) {
	var x e_nocarry_0138
	x.SetRandom()
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Sub(&x, &benchRese_nocarry_0138)
	}
}

func BenchmarkE_nocarry_0138Neg(b *testing.B) {
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Neg(&benchRese_nocarry_0138)
	}
}

func BenchmarkE_nocarry_0138Div(b *testing.B) {
	var x e_nocarry_0138
	x.SetRandom()
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Div(&x, &benchRese_nocarry_0138)
	}
}

func BenchmarkE_nocarry_0138FromMont(b *testing.B) {
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.FromMont()
	}
}

func BenchmarkE_nocarry_0138ToMont(b *testing.B) {
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.ToMont()
	}
}
func BenchmarkE_nocarry_0138Square(b *testing.B) {
	benchRese_nocarry_0138.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Square(&benchRese_nocarry_0138)
	}
}

func BenchmarkE_nocarry_0138Sqrt(b *testing.B) {
	var a e_nocarry_0138
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0138Mul(b *testing.B) {
	x := e_nocarry_0138{
		5340233653787277341,
		15189171269751853599,
		479,
	}
	benchRese_nocarry_0138.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Mul(&benchRese_nocarry_0138, &x)
	}
}

func BenchmarkE_nocarry_0138Cmp(b *testing.B) {
	x := e_nocarry_0138{
		5340233653787277341,
		15189171269751853599,
		479,
	}
	benchRese_nocarry_0138 = x
	benchRese_nocarry_0138[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0138.Cmp(&x)
	}
}

func TestE_nocarry_0138Cmp(t *testing.T) {
	var x, y e_nocarry_0138
...
func TestE_nocarry_0138IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0138
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0138

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0138{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0138
	one.SetOne()
	e.Sub(&qe_nocarry_0138, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0138{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0138{0, uint64(i)})
	}
...
func TestE_nocarry_0138NegZero(t *testing.T) {
	var a, b e_nocarry_0138
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0138Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0138, len(staticTestValues))
...
func TestE_nocarry_0138Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0138) bool {
			var b e_nocarry_0138
...
func TestE_nocarry_0138InverseExp(t *testing.T) {
...
func TestE_nocarry_0138MulByConstants(t *testing.T) {
...
func TestE_nocarry_0138Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0138) bool {
...
func TestE_nocarry_0138LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0138Halve(t *testing.T) {
...
func TestE_nocarry_0138FromMont(t *testing.T) {
...
type testPaire_nocarry_0138 struct {
	element e_nocarry_0138
	bigint  big.Int
}

func (z *e_nocarry_0138) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0138[2] {
		return true
	}
	if z[2] < qe_nocarry_0138[2] {
		return false
	...
	return z[0] >= qe_nocarry_0138[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0138

		g.element = e_nocarry_0138{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0138[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0138[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0138 {
			var g e_nocarry_0138
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0138[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0138[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0138[2], carry)
...
func Benchmarke_nocarry_0138InverseNew(b *testing.B) {
	var x e_nocarry_0138
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0138
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0138
		var xInv e_nocarry_0138
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0138
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0138
...
func testLinearComb(t *testing.T, x *e_nocarry_0138, xC int64, y *e_nocarry_0138, yC int64) {
	...
	var z e_nocarry_0138
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0138, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0138
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0138, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0138
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0138, xHi uint64) {
	var res e_nocarry_0138
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0138) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0138) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0138, c int64, result *e_nocarry_0138, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0138) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0138) uint64 {
