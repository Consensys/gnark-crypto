...
// modulus q
DATA q<>+0(SB)/8, $0x7124720eb756deed
DATA q<>+8(SB)/8, $0xf3c4f98c48c61761
DATA q<>+16(SB)/8, $0x745d5828673a06a3
DATA q<>+24(SB)/8, $0x88f3b62ff01f6e13
DATA q<>+32(SB)/8, $0x007ebe89b80f15d4
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x01cb6e8e7353d11b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x7124720eb756deed, R9
	MOVQ    $0xf3c4f98c48c61761, R10
	MOVQ    $0x745d5828673a06a3, R11
	MOVQ    $0x88f3b62ff01f6e13, R12
	MOVQ    $0x007ebe89b80f15d4, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xf3c4f98c48c61761, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x745d5828673a06a3, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x88f3b62ff01f6e13, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x007ebe89b80f15d4, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x7124720eb756deed, CX
	MOVQ    $0xf3c4f98c48c61761, BX
	MOVQ    $0x745d5828673a06a3, SI
	MOVQ    $0x88f3b62ff01f6e13, DI
	MOVQ    $0x007ebe89b80f15d4, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
