...
var benchRese_nocarry_0311 e_nocarry_0311

func BenchmarkE_nocarry_0311SetBytes(b *testing.B) {
	var x e_nocarry_0311
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0311MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0311.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0311)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0311)
		}
	})
}

func BenchmarkE_nocarry_0311Inverse(b *testing.B) {
	var x e_nocarry_0311
	x.SetRandom()
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0311Butterfly(b *testing.B) {
	var x e_nocarry_0311
	x.SetRandom()
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0311)
	}
}

func BenchmarkE_nocarry_0311Exp(b *testing.B) {
	var x e_nocarry_0311
	x.SetRandom()
	benchRese_nocarry_0311.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0311Double(b *testing.B) {
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Double(&benchRese_nocarry_0311)
	}
}

func BenchmarkE_nocarry_0311Add(b *testing.B) {
	var x e_nocarry_0311
	x.SetRandom()
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Add(&x, &benchRese_nocarry_0311)
	}
}

func BenchmarkE_nocarry_0311Sub(b *testing.B) {
	var x e_nocarry_0311
	x.SetRandom()
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Sub(&x, &benchRese_nocarry_0311)
	}
}

func BenchmarkE_nocarry_0311Neg(b *testing.B) {
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Neg(&benchRese_nocarry_0311)
	}
}

func BenchmarkE_nocarry_0311Div(b *testing.B) {
	var x e_nocarry_0311
	x.SetRandom()
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Div(&x, &benchRese_nocarry_0311)
	}
}

func BenchmarkE_nocarry_0311FromMont(b *testing.B) {
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.FromMont()
	}
}

func BenchmarkE_nocarry_0311ToMont(b *testing.B) {
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.ToMont()
	}
}
func BenchmarkE_nocarry_0311Square(b *testing.B) {
	benchRese_nocarry_0311.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Square(&benchRese_nocarry_0311)
	}
}

func BenchmarkE_nocarry_0311Sqrt(b *testing.B) {
	var a e_nocarry_0311
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0311Mul(b *testing.B) {
	x := e_nocarry_0311{
	...
	benchRese_nocarry_0311.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Mul(&benchRese_nocarry_0311, &x)
	}
}

func BenchmarkE_nocarry_0311Cmp(b *testing.B) {
	x := e_nocarry_0311{
		13025940746002497556,
		13445228759126604185,
		15845408129453405071,
	...
	benchRese_nocarry_0311 = x
	benchRese_nocarry_0311[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0311.Cmp(&x)
	}
}

func TestE_nocarry_0311Cmp(t *testing.T) {
	var x, y e_nocarry_0311
...
func TestE_nocarry_0311IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0311
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0311

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0311{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0311
	one.SetOne()
	e.Sub(&qe_nocarry_0311, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0311{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0311{0, uint64(i)})
	}
...
func TestE_nocarry_0311NegZero(t *testing.T) {
	var a, b e_nocarry_0311
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0311Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0311, len(staticTestValues))
...
func TestE_nocarry_0311Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0311) bool {
			var b e_nocarry_0311
...
func TestE_nocarry_0311InverseExp(t *testing.T) {
...
func TestE_nocarry_0311MulByConstants(t *testing.T) {
...
func TestE_nocarry_0311Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0311) bool {
...
func TestE_nocarry_0311LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0311Halve(t *testing.T) {
...
func TestE_nocarry_0311FromMont(t *testing.T) {
...
type testPaire_nocarry_0311 struct {
	element e_nocarry_0311
	bigint  big.Int
}

func (z *e_nocarry_0311) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0311[4] {
		return true
	}
	if z[4] < qe_nocarry_0311[4] {
		return false
	...
	return z[0] >= qe_nocarry_0311[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0311

		g.element = e_nocarry_0311{
		...
		if qe_nocarry_0311[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0311[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0311 {
			var g e_nocarry_0311
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0311[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0311[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0311[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0311[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0311[4], carry)
...
func Benchmarke_nocarry_0311InverseNew(b *testing.B) {
	var x e_nocarry_0311
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0311
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0311
		var xInv e_nocarry_0311
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0311
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0311
...
func testLinearComb(t *testing.T, x *e_nocarry_0311, xC int64, y *e_nocarry_0311, yC int64) {
	...
	var z e_nocarry_0311
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0311, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0311
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0311, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0311
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0311, xHi uint64) {
	var res e_nocarry_0311
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0311) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0311) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0311, c int64, result *e_nocarry_0311, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0311) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0311) uint64 {
