...
// modulus q
DATA q<>+0(SB)/8, $0x529382f60bc16a1f
DATA q<>+8(SB)/8, $0x2c5046aaa744197e
DATA q<>+16(SB)/8, $0xead0e208555dd5d8
DATA q<>+24(SB)/8, $0x00000000000006df
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x581a302500886e21
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x529382f60bc16a1f, R8
	MOVQ    $0x2c5046aaa744197e, R9
	MOVQ    $0xead0e208555dd5d8, R10
	MOVQ    $0x00000000000006df, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x2c5046aaa744197e, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xead0e208555dd5d8, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000000000006df, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x529382f60bc16a1f, R12
	MOVQ    $0x2c5046aaa744197e, R13
	MOVQ    $0xead0e208555dd5d8, R14
	MOVQ    $0x00000000000006df, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
