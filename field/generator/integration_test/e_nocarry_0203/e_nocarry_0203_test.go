...
var benchRese_nocarry_0203 e_nocarry_0203

func BenchmarkE_nocarry_0203SetBytes(b *testing.B) {
	var x e_nocarry_0203
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0203MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0203.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0203)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0203)
		}
	})
}

func BenchmarkE_nocarry_0203Inverse(b *testing.B) {
	var x e_nocarry_0203
	x.SetRandom()
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0203Butterfly(b *testing.B) {
	var x e_nocarry_0203
	x.SetRandom()
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0203)
	}
}

func BenchmarkE_nocarry_0203Exp(b *testing.B) {
	var x e_nocarry_0203
	x.SetRandom()
	benchRese_nocarry_0203.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0203Double(b *testing.B) {
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Double(&benchRese_nocarry_0203)
	}
}

func BenchmarkE_nocarry_0203Add(b *testing.B) {
	var x e_nocarry_0203
	x.SetRandom()
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Add(&x, &benchRese_nocarry_0203)
	}
}

func BenchmarkE_nocarry_0203Sub(b *testing.B) {
	var x e_nocarry_0203
	x.SetRandom()
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Sub(&x, &benchRese_nocarry_0203)
	}
}

func BenchmarkE_nocarry_0203Neg(b *testing.B) {
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Neg(&benchRese_nocarry_0203)
	}
}

func BenchmarkE_nocarry_0203Div(b *testing.B) {
	var x e_nocarry_0203
	x.SetRandom()
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Div(&x, &benchRese_nocarry_0203)
	}
}

func BenchmarkE_nocarry_0203FromMont(b *testing.B) {
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.FromMont()
	}
}

func BenchmarkE_nocarry_0203ToMont(b *testing.B) {
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.ToMont()
	}
}
func BenchmarkE_nocarry_0203Square(b *testing.B) {
	benchRese_nocarry_0203.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Square(&benchRese_nocarry_0203)
	}
}

func BenchmarkE_nocarry_0203Sqrt(b *testing.B) {
	var a e_nocarry_0203
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0203Mul(b *testing.B) {
	x := e_nocarry_0203{
		3323484201687825899,
		3310408827595152997,
	...
	benchRese_nocarry_0203.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Mul(&benchRese_nocarry_0203, &x)
	}
}

func BenchmarkE_nocarry_0203Cmp(b *testing.B) {
	x := e_nocarry_0203{
		3323484201687825899,
		3310408827595152997,
		14903173206573039602,
	...
	benchRese_nocarry_0203 = x
	benchRese_nocarry_0203[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0203.Cmp(&x)
	}
}

func TestE_nocarry_0203Cmp(t *testing.T) {
	var x, y e_nocarry_0203
...
func TestE_nocarry_0203IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0203
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0203

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0203{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0203
	one.SetOne()
	e.Sub(&qe_nocarry_0203, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0203{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0203{0, uint64(i)})
	}
...
func TestE_nocarry_0203NegZero(t *testing.T) {
	var a, b e_nocarry_0203
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0203Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0203, len(staticTestValues))
...
func TestE_nocarry_0203Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0203) bool {
			var b e_nocarry_0203
...
func TestE_nocarry_0203InverseExp(t *testing.T) {
...
func TestE_nocarry_0203MulByConstants(t *testing.T) {
...
func TestE_nocarry_0203Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0203) bool {
...
func TestE_nocarry_0203LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0203Halve(t *testing.T) {
...
func TestE_nocarry_0203FromMont(t *testing.T) {
...
type testPaire_nocarry_0203 struct {
	element e_nocarry_0203
	bigint  big.Int
}

func (z *e_nocarry_0203) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0203[3] {
		return true
	}
	if z[3] < qe_nocarry_0203[3] {
		return false
	...
	return z[0] >= qe_nocarry_0203[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0203

		g.element = e_nocarry_0203{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0203[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0203[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0203 {
			var g e_nocarry_0203
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0203[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0203[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0203[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0203[3], carry)
...
func Benchmarke_nocarry_0203InverseNew(b *testing.B) {
	var x e_nocarry_0203
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0203
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0203
		var xInv e_nocarry_0203
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0203
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0203
...
func testLinearComb(t *testing.T, x *e_nocarry_0203, xC int64, y *e_nocarry_0203, yC int64) {
	...
	var z e_nocarry_0203
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0203, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0203
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0203, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0203
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0203, xHi uint64) {
	var res e_nocarry_0203
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0203) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0203) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0203, c int64, result *e_nocarry_0203, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0203) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0203) uint64 {
