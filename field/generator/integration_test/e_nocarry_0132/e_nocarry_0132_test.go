...
var benchRese_nocarry_0132 e_nocarry_0132

func BenchmarkE_nocarry_0132SetBytes(b *testing.B) {
	var x e_nocarry_0132
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0132MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0132.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0132)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0132)
		}
	})
}

func BenchmarkE_nocarry_0132Inverse(b *testing.B) {
	var x e_nocarry_0132
	x.SetRandom()
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0132Butterfly(b *testing.B) {
	var x e_nocarry_0132
	x.SetRandom()
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0132)
	}
}

func BenchmarkE_nocarry_0132Exp(b *testing.B) {
	var x e_nocarry_0132
	x.SetRandom()
	benchRese_nocarry_0132.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0132Double(b *testing.B) {
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Double(&benchRese_nocarry_0132)
	}
}

func BenchmarkE_nocarry_0132Add(b *testing.B) {
	var x e_nocarry_0132
	x.SetRandom()
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Add(&x, &benchRese_nocarry_0132)
	}
}

func BenchmarkE_nocarry_0132Sub(b *testing.B) {
	var x e_nocarry_0132
	x.SetRandom()
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Sub(&x, &benchRese_nocarry_0132)
	}
}

func BenchmarkE_nocarry_0132Neg(b *testing.B) {
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Neg(&benchRese_nocarry_0132)
	}
}

func BenchmarkE_nocarry_0132Div(b *testing.B) {
	var x e_nocarry_0132
	x.SetRandom()
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Div(&x, &benchRese_nocarry_0132)
	}
}

func BenchmarkE_nocarry_0132FromMont(b *testing.B) {
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.FromMont()
	}
}

func BenchmarkE_nocarry_0132ToMont(b *testing.B) {
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.ToMont()
	}
}
func BenchmarkE_nocarry_0132Square(b *testing.B) {
	benchRese_nocarry_0132.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Square(&benchRese_nocarry_0132)
	}
}

func BenchmarkE_nocarry_0132Sqrt(b *testing.B) {
	var a e_nocarry_0132
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0132Mul(b *testing.B) {
	x := e_nocarry_0132{
		16590999803496385733,
		1518863864554765708,
		4,
	}
	benchRese_nocarry_0132.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Mul(&benchRese_nocarry_0132, &x)
	}
}

func BenchmarkE_nocarry_0132Cmp(b *testing.B) {
	x := e_nocarry_0132{
		16590999803496385733,
		1518863864554765708,
		4,
	}
	benchRese_nocarry_0132 = x
	benchRese_nocarry_0132[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0132.Cmp(&x)
	}
}

func TestE_nocarry_0132Cmp(t *testing.T) {
	var x, y e_nocarry_0132
...
func TestE_nocarry_0132IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0132
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0132

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0132{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0132
	one.SetOne()
	e.Sub(&qe_nocarry_0132, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0132{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0132{0, uint64(i)})
	}
...
func TestE_nocarry_0132NegZero(t *testing.T) {
	var a, b e_nocarry_0132
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0132Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0132, len(staticTestValues))
...
func TestE_nocarry_0132Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0132) bool {
			var b e_nocarry_0132
...
func TestE_nocarry_0132InverseExp(t *testing.T) {
...
func TestE_nocarry_0132MulByConstants(t *testing.T) {
...
func TestE_nocarry_0132Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0132) bool {
...
func TestE_nocarry_0132LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0132Halve(t *testing.T) {
...
func TestE_nocarry_0132FromMont(t *testing.T) {
...
type testPaire_nocarry_0132 struct {
	element e_nocarry_0132
	bigint  big.Int
}

func (z *e_nocarry_0132) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0132[2] {
		return true
	}
	if z[2] < qe_nocarry_0132[2] {
		return false
	...
	return z[0] >= qe_nocarry_0132[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0132

		g.element = e_nocarry_0132{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0132[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0132[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0132 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0132[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0132[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0132[2], carry)
...
func Benchmarke_nocarry_0132InverseNew(b *testing.B) {
	var x e_nocarry_0132
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0132
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0132
		var xInv e_nocarry_0132
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0132
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0132
...
func testLinearComb(t *testing.T, x *e_nocarry_0132, xC int64, y *e_nocarry_0132, yC int64) {
	...
	var z e_nocarry_0132
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0132, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0132
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0132, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0132
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0132, xHi uint64) {
	var res e_nocarry_0132
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0132) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0132) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0132, c int64, result *e_nocarry_0132, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0132) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0132) uint64 {
