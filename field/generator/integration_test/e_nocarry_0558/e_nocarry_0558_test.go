...
var benchRese_nocarry_0558 e_nocarry_0558

func BenchmarkE_nocarry_0558SetBytes(b *testing.B) {
	var x e_nocarry_0558
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0558MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0558.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0558)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0558)
		}
	})
}

func BenchmarkE_nocarry_0558Inverse(b *testing.B) {
	var x e_nocarry_0558
	x.SetRandom()
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0558Butterfly(b *testing.B) {
	var x e_nocarry_0558
	x.SetRandom()
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0558)
	}
}

func BenchmarkE_nocarry_0558Exp(b *testing.B) {
	var x e_nocarry_0558
	x.SetRandom()
	benchRese_nocarry_0558.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0558Double(b *testing.B) {
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Double(&benchRese_nocarry_0558)
	}
}

func BenchmarkE_nocarry_0558Add(b *testing.B) {
	var x e_nocarry_0558
	x.SetRandom()
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Add(&x, &benchRese_nocarry_0558)
	}
}

func BenchmarkE_nocarry_0558Sub(b *testing.B) {
	var x e_nocarry_0558
	x.SetRandom()
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Sub(&x, &benchRese_nocarry_0558)
	}
}

func BenchmarkE_nocarry_0558Neg(b *testing.B) {
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Neg(&benchRese_nocarry_0558)
	}
}

func BenchmarkE_nocarry_0558Div(b *testing.B) {
	var x e_nocarry_0558
	x.SetRandom()
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Div(&x, &benchRese_nocarry_0558)
	}
}

func BenchmarkE_nocarry_0558FromMont(b *testing.B) {
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.FromMont()
	}
}

func BenchmarkE_nocarry_0558ToMont(b *testing.B) {
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.ToMont()
	}
}
func BenchmarkE_nocarry_0558Square(b *testing.B) {
	benchRese_nocarry_0558.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Square(&benchRese_nocarry_0558)
	}
}

func BenchmarkE_nocarry_0558Sqrt(b *testing.B) {
	var a e_nocarry_0558
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0558Mul(b *testing.B) {
	x := e_nocarry_0558{
		1141255993817769466,
	...
	benchRese_nocarry_0558.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Mul(&benchRese_nocarry_0558, &x)
	}
}

func BenchmarkE_nocarry_0558Cmp(b *testing.B) {
	x := e_nocarry_0558{
		1141255993817769466,
		15062622634413439368,
		416989471261644018,
	...
	benchRese_nocarry_0558 = x
	benchRese_nocarry_0558[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0558.Cmp(&x)
	}
}

func TestE_nocarry_0558Cmp(t *testing.T) {
	var x, y e_nocarry_0558
...
func TestE_nocarry_0558IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0558
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0558

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0558{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0558
	one.SetOne()
	e.Sub(&qe_nocarry_0558, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0558{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0558{0, uint64(i)})
	}
...
func TestE_nocarry_0558NegZero(t *testing.T) {
	var a, b e_nocarry_0558
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0558Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0558, len(staticTestValues))
...
func TestE_nocarry_0558Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0558) bool {
			var b e_nocarry_0558
...
func TestE_nocarry_0558InverseExp(t *testing.T) {
...
func TestE_nocarry_0558MulByConstants(t *testing.T) {
...
func TestE_nocarry_0558Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0558) bool {
...
func TestE_nocarry_0558LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0558Halve(t *testing.T) {
...
func TestE_nocarry_0558FromMont(t *testing.T) {
...
type testPaire_nocarry_0558 struct {
	element e_nocarry_0558
	bigint  big.Int
}

func (z *e_nocarry_0558) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0558[8] {
		return true
	}
	if z[8] < qe_nocarry_0558[8] {
		return false
	...
	return z[0] >= qe_nocarry_0558[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0558

		g.element = e_nocarry_0558{
		...
		if qe_nocarry_0558[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0558[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0558 {
			var g e_nocarry_0558
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0558[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0558[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0558[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0558[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0558[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0558[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0558[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0558[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0558[8], carry)
...
func Benchmarke_nocarry_0558InverseNew(b *testing.B) {
	var x e_nocarry_0558
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0558
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0558
		var xInv e_nocarry_0558
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0558
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0558
...
func testLinearComb(t *testing.T, x *e_nocarry_0558, xC int64, y *e_nocarry_0558, yC int64) {
	...
	var z e_nocarry_0558
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0558, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0558
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0558, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0558
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0558, xHi uint64) {
	var res e_nocarry_0558
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0558) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0558) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0558, c int64, result *e_nocarry_0558, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0558) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0558) uint64 {
