...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x1a7a32c1edab1aab, R12
	ADDQ R12, AX
	MOVQ $0x8605eae92fe88785, R12
	ADCQ R12, DX
	MOVQ $0x1c7999a5427a6e69, R12
	ADCQ R12, CX
	MOVQ $0x1705fadfbe1ab03b, R12
	ADCQ R12, BX
	MOVQ $0xd3e3880ce4f1b91e, R12
	ADCQ R12, SI
	MOVQ $0x7326a8d4f7f3146e, R12
	ADCQ R12, DI
	MOVQ $0x97cdc21433521395, R12
	ADCQ R12, R8
	MOVQ $0x87e7f23965e64566, R12
	ADCQ R12, R9
	MOVQ $0x0000388d5d7e9b31, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x1a7a32c1edab1aab, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x8605eae92fe88785, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x1c7999a5427a6e69, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x1705fadfbe1ab03b, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xd3e3880ce4f1b91e, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x7326a8d4f7f3146e, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x97cdc21433521395, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x87e7f23965e64566, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000388d5d7e9b31, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x1a7a32c1edab1aab, AX
	ADDQ AX, DX
	MOVQ $0x8605eae92fe88785, AX
	ADCQ AX, CX
	MOVQ $0x1c7999a5427a6e69, AX
	ADCQ AX, BX
	MOVQ $0x1705fadfbe1ab03b, AX
	ADCQ AX, SI
	MOVQ $0xd3e3880ce4f1b91e, AX
	ADCQ AX, DI
	MOVQ $0x7326a8d4f7f3146e, AX
	ADCQ AX, R8
	MOVQ $0x97cdc21433521395, AX
	ADCQ AX, R9
	MOVQ $0x87e7f23965e64566, AX
	ADCQ AX, R10
	MOVQ $0x0000388d5d7e9b31, AX
	ADCQ AX, R11
