...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x1345c48440543d15, R14
	ADDQ R14, AX
	MOVQ $0xb1313dd26afab12d, R14
	ADCQ R14, DX
	MOVQ $0x01eefbfbf5e255a7, R14
	ADCQ R14, CX
	MOVQ $0x80795d13c19cb75a, R14
	ADCQ R14, BX
	MOVQ $0xd14a0439ea52bf7d, R14
	ADCQ R14, SI
	MOVQ $0xad01f472835a486f, R14
	ADCQ R14, DI
	MOVQ $0x03af8bedcb2a46ba, R14
	ADCQ R14, R8
	MOVQ $0x5f04ceb6dd733fc0, R14
	ADCQ R14, R9
	MOVQ $0x8af3a02a33bedd1d, R14
	ADCQ R14, R10
	MOVQ $0xd14cd2d59833ccfb, R14
	ADCQ R14, R11
	MOVQ $0x00000000000d3ae3, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x1345c48440543d15, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xb1313dd26afab12d, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x01eefbfbf5e255a7, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x80795d13c19cb75a, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xd14a0439ea52bf7d, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xad01f472835a486f, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x03af8bedcb2a46ba, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x5f04ceb6dd733fc0, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x8af3a02a33bedd1d, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xd14cd2d59833ccfb, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000000d3ae3, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x1345c48440543d15, AX
	ADDQ AX, DX
	MOVQ $0xb1313dd26afab12d, AX
	ADCQ AX, CX
	MOVQ $0x01eefbfbf5e255a7, AX
	ADCQ AX, BX
	MOVQ $0x80795d13c19cb75a, AX
	ADCQ AX, SI
	MOVQ $0xd14a0439ea52bf7d, AX
	ADCQ AX, DI
	MOVQ $0xad01f472835a486f, AX
	ADCQ AX, R8
	MOVQ $0x03af8bedcb2a46ba, AX
	ADCQ AX, R9
	MOVQ $0x5f04ceb6dd733fc0, AX
	ADCQ AX, R10
	MOVQ $0x8af3a02a33bedd1d, AX
	ADCQ AX, R11
	MOVQ $0xd14cd2d59833ccfb, AX
	ADCQ AX, R12
	MOVQ $0x00000000000d3ae3, AX
	ADCQ AX, R13
