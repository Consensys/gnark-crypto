...
// modulus q
DATA q<>+0(SB)/8, $0x1345c48440543d15
DATA q<>+8(SB)/8, $0xb1313dd26afab12d
DATA q<>+16(SB)/8, $0x01eefbfbf5e255a7
DATA q<>+24(SB)/8, $0x80795d13c19cb75a
DATA q<>+32(SB)/8, $0xd14a0439ea52bf7d
DATA q<>+40(SB)/8, $0xad01f472835a486f
DATA q<>+48(SB)/8, $0x03af8bedcb2a46ba
DATA q<>+56(SB)/8, $0x5f04ceb6dd733fc0
DATA q<>+64(SB)/8, $0x8af3a02a33bedd1d
DATA q<>+72(SB)/8, $0xd14cd2d59833ccfb
DATA q<>+80(SB)/8, $0x00000000000d3ae3
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x83f2191603b7d5c3
