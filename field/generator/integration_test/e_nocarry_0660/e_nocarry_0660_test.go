...
var benchRese_nocarry_0660 e_nocarry_0660

func BenchmarkE_nocarry_0660SetBytes(b *testing.B) {
	var x e_nocarry_0660
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0660MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0660.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0660)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0660)
		}
	})
}

func BenchmarkE_nocarry_0660Inverse(b *testing.B) {
	var x e_nocarry_0660
	x.SetRandom()
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0660Butterfly(b *testing.B) {
	var x e_nocarry_0660
	x.SetRandom()
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0660)
	}
}

func BenchmarkE_nocarry_0660Exp(b *testing.B) {
	var x e_nocarry_0660
	x.SetRandom()
	benchRese_nocarry_0660.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0660Double(b *testing.B) {
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Double(&benchRese_nocarry_0660)
	}
}

func BenchmarkE_nocarry_0660Add(b *testing.B) {
	var x e_nocarry_0660
	x.SetRandom()
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Add(&x, &benchRese_nocarry_0660)
	}
}

func BenchmarkE_nocarry_0660Sub(b *testing.B) {
	var x e_nocarry_0660
	x.SetRandom()
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Sub(&x, &benchRese_nocarry_0660)
	}
}

func BenchmarkE_nocarry_0660Neg(b *testing.B) {
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Neg(&benchRese_nocarry_0660)
	}
}

func BenchmarkE_nocarry_0660Div(b *testing.B) {
	var x e_nocarry_0660
	x.SetRandom()
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Div(&x, &benchRese_nocarry_0660)
	}
}

func BenchmarkE_nocarry_0660FromMont(b *testing.B) {
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.FromMont()
	}
}

func BenchmarkE_nocarry_0660ToMont(b *testing.B) {
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.ToMont()
	}
}
func BenchmarkE_nocarry_0660Square(b *testing.B) {
	benchRese_nocarry_0660.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Square(&benchRese_nocarry_0660)
	}
}

func BenchmarkE_nocarry_0660Sqrt(b *testing.B) {
	var a e_nocarry_0660
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0660Mul(b *testing.B) {
	x := e_nocarry_0660{
		9972229084808159849,
	...
	benchRese_nocarry_0660.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Mul(&benchRese_nocarry_0660, &x)
	}
}

func BenchmarkE_nocarry_0660Cmp(b *testing.B) {
	x := e_nocarry_0660{
		9972229084808159849,
		11813527958031257656,
		2955856154028631848,
	...
	benchRese_nocarry_0660 = x
	benchRese_nocarry_0660[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0660.Cmp(&x)
	}
}

func TestE_nocarry_0660Cmp(t *testing.T) {
	var x, y e_nocarry_0660
...
func TestE_nocarry_0660IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0660
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0660

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0660{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0660
	one.SetOne()
	e.Sub(&qe_nocarry_0660, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0660{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0660{0, uint64(i)})
	}
...
func TestE_nocarry_0660NegZero(t *testing.T) {
	var a, b e_nocarry_0660
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0660Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0660, len(staticTestValues))
...
func TestE_nocarry_0660Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0660) bool {
			var b e_nocarry_0660
...
func TestE_nocarry_0660InverseExp(t *testing.T) {
...
func TestE_nocarry_0660MulByConstants(t *testing.T) {
...
func TestE_nocarry_0660Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0660) bool {
...
func TestE_nocarry_0660LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0660Halve(t *testing.T) {
...
func TestE_nocarry_0660FromMont(t *testing.T) {
...
type testPaire_nocarry_0660 struct {
	element e_nocarry_0660
	bigint  big.Int
}

func (z *e_nocarry_0660) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0660[10] {
		return true
	}
	if z[10] < qe_nocarry_0660[10] {
		return false
	...
	return z[0] >= qe_nocarry_0660[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0660

		g.element = e_nocarry_0660{
		...
		if qe_nocarry_0660[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0660[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0660 {
			var g e_nocarry_0660
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0660[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0660[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0660[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0660[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0660[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0660[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0660[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0660[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0660[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0660[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0660[10], carry)
...
func Benchmarke_nocarry_0660InverseNew(b *testing.B) {
	var x e_nocarry_0660
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0660
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0660
		var xInv e_nocarry_0660
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0660
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0660
...
func testLinearComb(t *testing.T, x *e_nocarry_0660, xC int64, y *e_nocarry_0660, yC int64) {
	...
	var z e_nocarry_0660
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0660, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0660
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0660, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0660
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0660, xHi uint64) {
	var res e_nocarry_0660
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0660) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0660) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0660, c int64, result *e_nocarry_0660, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0660) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0660) uint64 {
