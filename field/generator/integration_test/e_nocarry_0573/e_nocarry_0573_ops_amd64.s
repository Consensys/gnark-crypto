...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x061a33dce26ec8e9, R12
	ADDQ R12, AX
	MOVQ $0x4bc25bee3f7600bb, R12
	ADCQ R12, DX
	MOVQ $0xb8f8f545a519f21d, R12
	ADCQ R12, CX
	MOVQ $0xe8f67e627ab6afed, R12
	ADCQ R12, BX
	MOVQ $0xa71bfdcfc1f74746, R12
	ADCQ R12, SI
	MOVQ $0xf095f6c4a99d643a, R12
	ADCQ R12, DI
	MOVQ $0xb5d71eab08d96ef7, R12
	ADCQ R12, R8
	MOVQ $0xa339d4e83d98222d, R12
	ADCQ R12, R9
	MOVQ $0x1cfc25215037b80e, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x061a33dce26ec8e9, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x4bc25bee3f7600bb, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xb8f8f545a519f21d, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xe8f67e627ab6afed, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xa71bfdcfc1f74746, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xf095f6c4a99d643a, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xb5d71eab08d96ef7, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xa339d4e83d98222d, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x1cfc25215037b80e, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x061a33dce26ec8e9, AX
	ADDQ AX, DX
	MOVQ $0x4bc25bee3f7600bb, AX
	ADCQ AX, CX
	MOVQ $0xb8f8f545a519f21d, AX
	ADCQ AX, BX
	MOVQ $0xe8f67e627ab6afed, AX
	ADCQ AX, SI
	MOVQ $0xa71bfdcfc1f74746, AX
	ADCQ AX, DI
	MOVQ $0xf095f6c4a99d643a, AX
	ADCQ AX, R8
	MOVQ $0xb5d71eab08d96ef7, AX
	ADCQ AX, R9
	MOVQ $0xa339d4e83d98222d, AX
	ADCQ AX, R10
	MOVQ $0x1cfc25215037b80e, AX
	ADCQ AX, R11
