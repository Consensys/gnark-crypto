...
var benchRese_nocarry_0415 e_nocarry_0415

func BenchmarkE_nocarry_0415SetBytes(b *testing.B) {
	var x e_nocarry_0415
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0415MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0415.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0415)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0415)
		}
	})
}

func BenchmarkE_nocarry_0415Inverse(b *testing.B) {
	var x e_nocarry_0415
	x.SetRandom()
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0415Butterfly(b *testing.B) {
	var x e_nocarry_0415
	x.SetRandom()
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0415)
	}
}

func BenchmarkE_nocarry_0415Exp(b *testing.B) {
	var x e_nocarry_0415
	x.SetRandom()
	benchRese_nocarry_0415.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0415Double(b *testing.B) {
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Double(&benchRese_nocarry_0415)
	}
}

func BenchmarkE_nocarry_0415Add(b *testing.B) {
	var x e_nocarry_0415
	x.SetRandom()
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Add(&x, &benchRese_nocarry_0415)
	}
}

func BenchmarkE_nocarry_0415Sub(b *testing.B) {
	var x e_nocarry_0415
	x.SetRandom()
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Sub(&x, &benchRese_nocarry_0415)
	}
}

func BenchmarkE_nocarry_0415Neg(b *testing.B) {
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Neg(&benchRese_nocarry_0415)
	}
}

func BenchmarkE_nocarry_0415Div(b *testing.B) {
	var x e_nocarry_0415
	x.SetRandom()
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Div(&x, &benchRese_nocarry_0415)
	}
}

func BenchmarkE_nocarry_0415FromMont(b *testing.B) {
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.FromMont()
	}
}

func BenchmarkE_nocarry_0415ToMont(b *testing.B) {
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.ToMont()
	}
}
func BenchmarkE_nocarry_0415Square(b *testing.B) {
	benchRese_nocarry_0415.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Square(&benchRese_nocarry_0415)
	}
}

func BenchmarkE_nocarry_0415Sqrt(b *testing.B) {
	var a e_nocarry_0415
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0415Mul(b *testing.B) {
	x := e_nocarry_0415{
	...
	benchRese_nocarry_0415.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Mul(&benchRese_nocarry_0415, &x)
	}
}

func BenchmarkE_nocarry_0415Cmp(b *testing.B) {
	x := e_nocarry_0415{
		11169550223426482125,
		2149931745062861920,
		4685377203616052755,
	...
	benchRese_nocarry_0415 = x
	benchRese_nocarry_0415[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0415.Cmp(&x)
	}
}

func TestE_nocarry_0415Cmp(t *testing.T) {
	var x, y e_nocarry_0415
...
func TestE_nocarry_0415IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0415
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0415

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0415{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0415
	one.SetOne()
	e.Sub(&qe_nocarry_0415, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0415{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0415{0, uint64(i)})
	}
...
func TestE_nocarry_0415NegZero(t *testing.T) {
	var a, b e_nocarry_0415
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0415Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0415, len(staticTestValues))
...
func TestE_nocarry_0415Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0415) bool {
			var b e_nocarry_0415
...
func TestE_nocarry_0415InverseExp(t *testing.T) {
...
func TestE_nocarry_0415MulByConstants(t *testing.T) {
...
func TestE_nocarry_0415Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0415) bool {
...
func TestE_nocarry_0415LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0415Halve(t *testing.T) {
...
func TestE_nocarry_0415FromMont(t *testing.T) {
...
type testPaire_nocarry_0415 struct {
	element e_nocarry_0415
	bigint  big.Int
}

func (z *e_nocarry_0415) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0415[6] {
		return true
	}
	if z[6] < qe_nocarry_0415[6] {
		return false
	...
	return z[0] >= qe_nocarry_0415[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0415

		g.element = e_nocarry_0415{
		...
		if qe_nocarry_0415[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0415[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0415 {
			var g e_nocarry_0415
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0415[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0415[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0415[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0415[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0415[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0415[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0415[6], carry)
...
func Benchmarke_nocarry_0415InverseNew(b *testing.B) {
	var x e_nocarry_0415
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0415
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0415
		var xInv e_nocarry_0415
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0415
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0415
...
func testLinearComb(t *testing.T, x *e_nocarry_0415, xC int64, y *e_nocarry_0415, yC int64) {
	...
	var z e_nocarry_0415
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0415, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0415
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0415, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0415
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0415, xHi uint64) {
	var res e_nocarry_0415
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0415) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0415) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0415, c int64, result *e_nocarry_0415, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0415) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0415) uint64 {
