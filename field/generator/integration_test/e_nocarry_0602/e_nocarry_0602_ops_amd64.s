...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xda3d2960d282f32d, R13
	ADDQ R13, AX
	MOVQ $0xd1aa3feb9aaf6432, R13
	ADCQ R13, DX
	MOVQ $0x8586e7ab6ba601c4, R13
	ADCQ R13, CX
	MOVQ $0xc3e4895c954cd039, R13
	ADCQ R13, BX
	MOVQ $0xbeb4a4e754b08752, R13
	ADCQ R13, SI
	MOVQ $0x4b99cc67634b7909, R13
	ADCQ R13, DI
	MOVQ $0x402cbc2ca133474e, R13
	ADCQ R13, R8
	MOVQ $0xc9696db629790bce, R13
	ADCQ R13, R9
	MOVQ $0xb0666ce5870b85b2, R13
	ADCQ R13, R10
	MOVQ $0x00000000032437c7, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xda3d2960d282f32d, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xd1aa3feb9aaf6432, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x8586e7ab6ba601c4, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xc3e4895c954cd039, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xbeb4a4e754b08752, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x4b99cc67634b7909, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x402cbc2ca133474e, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xc9696db629790bce, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xb0666ce5870b85b2, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000032437c7, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xda3d2960d282f32d, AX
	ADDQ AX, DX
	MOVQ $0xd1aa3feb9aaf6432, AX
	ADCQ AX, CX
	MOVQ $0x8586e7ab6ba601c4, AX
	ADCQ AX, BX
	MOVQ $0xc3e4895c954cd039, AX
	ADCQ AX, SI
	MOVQ $0xbeb4a4e754b08752, AX
	ADCQ AX, DI
	MOVQ $0x4b99cc67634b7909, AX
	ADCQ AX, R8
	MOVQ $0x402cbc2ca133474e, AX
	ADCQ AX, R9
	MOVQ $0xc9696db629790bce, AX
	ADCQ AX, R10
	MOVQ $0xb0666ce5870b85b2, AX
	ADCQ AX, R11
	MOVQ $0x00000000032437c7, AX
	ADCQ AX, R12
