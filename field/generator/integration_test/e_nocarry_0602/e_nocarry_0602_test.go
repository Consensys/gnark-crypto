...
var benchRese_nocarry_0602 e_nocarry_0602

func BenchmarkE_nocarry_0602SetBytes(b *testing.B) {
	var x e_nocarry_0602
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0602MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0602.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0602)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0602)
		}
	})
}

func BenchmarkE_nocarry_0602Inverse(b *testing.B) {
	var x e_nocarry_0602
	x.SetRandom()
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0602Butterfly(b *testing.B) {
	var x e_nocarry_0602
	x.SetRandom()
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0602)
	}
}

func BenchmarkE_nocarry_0602Exp(b *testing.B) {
	var x e_nocarry_0602
	x.SetRandom()
	benchRese_nocarry_0602.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0602Double(b *testing.B) {
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Double(&benchRese_nocarry_0602)
	}
}

func BenchmarkE_nocarry_0602Add(b *testing.B) {
	var x e_nocarry_0602
	x.SetRandom()
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Add(&x, &benchRese_nocarry_0602)
	}
}

func BenchmarkE_nocarry_0602Sub(b *testing.B) {
	var x e_nocarry_0602
	x.SetRandom()
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Sub(&x, &benchRese_nocarry_0602)
	}
}

func BenchmarkE_nocarry_0602Neg(b *testing.B) {
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Neg(&benchRese_nocarry_0602)
	}
}

func BenchmarkE_nocarry_0602Div(b *testing.B) {
	var x e_nocarry_0602
	x.SetRandom()
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Div(&x, &benchRese_nocarry_0602)
	}
}

func BenchmarkE_nocarry_0602FromMont(b *testing.B) {
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.FromMont()
	}
}

func BenchmarkE_nocarry_0602ToMont(b *testing.B) {
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.ToMont()
	}
}
func BenchmarkE_nocarry_0602Square(b *testing.B) {
	benchRese_nocarry_0602.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Square(&benchRese_nocarry_0602)
	}
}

func BenchmarkE_nocarry_0602Sqrt(b *testing.B) {
	var a e_nocarry_0602
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0602Mul(b *testing.B) {
	x := e_nocarry_0602{
		4136897872006000855,
		3580524490125182327,
	...
	benchRese_nocarry_0602.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Mul(&benchRese_nocarry_0602, &x)
	}
}

func BenchmarkE_nocarry_0602Cmp(b *testing.B) {
	x := e_nocarry_0602{
		4136897872006000855,
		3580524490125182327,
		11959332740749939840,
	...
	benchRese_nocarry_0602 = x
	benchRese_nocarry_0602[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0602.Cmp(&x)
	}
}

func TestE_nocarry_0602Cmp(t *testing.T) {
	var x, y e_nocarry_0602
...
func TestE_nocarry_0602IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0602
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0602

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0602{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0602
	one.SetOne()
	e.Sub(&qe_nocarry_0602, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0602{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0602{0, uint64(i)})
	}
...
func TestE_nocarry_0602NegZero(t *testing.T) {
	var a, b e_nocarry_0602
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0602Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0602, len(staticTestValues))
...
func TestE_nocarry_0602Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0602) bool {
			var b e_nocarry_0602
...
func TestE_nocarry_0602InverseExp(t *testing.T) {
...
func TestE_nocarry_0602MulByConstants(t *testing.T) {
...
func TestE_nocarry_0602Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0602) bool {
...
func TestE_nocarry_0602LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0602Halve(t *testing.T) {
...
func TestE_nocarry_0602FromMont(t *testing.T) {
...
type testPaire_nocarry_0602 struct {
	element e_nocarry_0602
	bigint  big.Int
}

func (z *e_nocarry_0602) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0602[9] {
		return true
	}
	if z[9] < qe_nocarry_0602[9] {
		return false
	...
	return z[0] >= qe_nocarry_0602[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0602

		g.element = e_nocarry_0602{
		...
		if qe_nocarry_0602[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0602[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0602 {
			var g e_nocarry_0602
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0602[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0602[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0602[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0602[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0602[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0602[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0602[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0602[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0602[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0602[9], carry)
...
func Benchmarke_nocarry_0602InverseNew(b *testing.B) {
	var x e_nocarry_0602
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0602
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0602
		var xInv e_nocarry_0602
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0602
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0602
...
func testLinearComb(t *testing.T, x *e_nocarry_0602, xC int64, y *e_nocarry_0602, yC int64) {
	...
	var z e_nocarry_0602
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0602, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0602
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0602, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0602
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0602, xHi uint64) {
	var res e_nocarry_0602
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0602) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0602) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0602, c int64, result *e_nocarry_0602, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0602) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0602) uint64 {
