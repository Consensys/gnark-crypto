...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xf3a94729a73165db, R13
	ADDQ R13, AX
	MOVQ $0xdadbe6ae64759892, R13
	ADCQ R13, DX
	MOVQ $0x62c02e280e8b3810, R13
	ADCQ R13, CX
	MOVQ $0x765f1aeb590b4981, R13
	ADCQ R13, BX
	MOVQ $0x6aa0ce678f1a2952, R13
	ADCQ R13, SI
	MOVQ $0xac9f400df1a78b9e, R13
	ADCQ R13, DI
	MOVQ $0x63e5f06ea54deb39, R13
	ADCQ R13, R8
	MOVQ $0x80b23acd89095592, R13
	ADCQ R13, R9
	MOVQ $0x46d29978df31b589, R13
	ADCQ R13, R10
	MOVQ $0x000d3f1794d77e50, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf3a94729a73165db, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xdadbe6ae64759892, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x62c02e280e8b3810, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x765f1aeb590b4981, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x6aa0ce678f1a2952, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xac9f400df1a78b9e, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x63e5f06ea54deb39, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x80b23acd89095592, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x46d29978df31b589, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000d3f1794d77e50, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xf3a94729a73165db, AX
	ADDQ AX, DX
	MOVQ $0xdadbe6ae64759892, AX
	ADCQ AX, CX
	MOVQ $0x62c02e280e8b3810, AX
	ADCQ AX, BX
	MOVQ $0x765f1aeb590b4981, AX
	ADCQ AX, SI
	MOVQ $0x6aa0ce678f1a2952, AX
	ADCQ AX, DI
	MOVQ $0xac9f400df1a78b9e, AX
	ADCQ AX, R8
	MOVQ $0x63e5f06ea54deb39, AX
	ADCQ AX, R9
	MOVQ $0x80b23acd89095592, AX
	ADCQ AX, R10
	MOVQ $0x46d29978df31b589, AX
	ADCQ AX, R11
	MOVQ $0x000d3f1794d77e50, AX
	ADCQ AX, R12
