...
var benchRese_nocarry_0628 e_nocarry_0628

func BenchmarkE_nocarry_0628SetBytes(b *testing.B) {
	var x e_nocarry_0628
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0628MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0628.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0628)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0628)
		}
	})
}

func BenchmarkE_nocarry_0628Inverse(b *testing.B) {
	var x e_nocarry_0628
	x.SetRandom()
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0628Butterfly(b *testing.B) {
	var x e_nocarry_0628
	x.SetRandom()
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0628)
	}
}

func BenchmarkE_nocarry_0628Exp(b *testing.B) {
	var x e_nocarry_0628
	x.SetRandom()
	benchRese_nocarry_0628.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0628Double(b *testing.B) {
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Double(&benchRese_nocarry_0628)
	}
}

func BenchmarkE_nocarry_0628Add(b *testing.B) {
	var x e_nocarry_0628
	x.SetRandom()
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Add(&x, &benchRese_nocarry_0628)
	}
}

func BenchmarkE_nocarry_0628Sub(b *testing.B) {
	var x e_nocarry_0628
	x.SetRandom()
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Sub(&x, &benchRese_nocarry_0628)
	}
}

func BenchmarkE_nocarry_0628Neg(b *testing.B) {
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Neg(&benchRese_nocarry_0628)
	}
}

func BenchmarkE_nocarry_0628Div(b *testing.B) {
	var x e_nocarry_0628
	x.SetRandom()
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Div(&x, &benchRese_nocarry_0628)
	}
}

func BenchmarkE_nocarry_0628FromMont(b *testing.B) {
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.FromMont()
	}
}

func BenchmarkE_nocarry_0628ToMont(b *testing.B) {
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.ToMont()
	}
}
func BenchmarkE_nocarry_0628Square(b *testing.B) {
	benchRese_nocarry_0628.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Square(&benchRese_nocarry_0628)
	}
}

func BenchmarkE_nocarry_0628Sqrt(b *testing.B) {
	var a e_nocarry_0628
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0628Mul(b *testing.B) {
	x := e_nocarry_0628{
	...
	benchRese_nocarry_0628.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Mul(&benchRese_nocarry_0628, &x)
	}
}

func BenchmarkE_nocarry_0628Cmp(b *testing.B) {
	x := e_nocarry_0628{
		13692637811764084240,
		9020648079133918565,
		6720766955410491430,
	...
	benchRese_nocarry_0628 = x
	benchRese_nocarry_0628[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0628.Cmp(&x)
	}
}

func TestE_nocarry_0628Cmp(t *testing.T) {
	var x, y e_nocarry_0628
...
func TestE_nocarry_0628IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0628
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0628

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0628{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0628
	one.SetOne()
	e.Sub(&qe_nocarry_0628, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0628{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0628{0, uint64(i)})
	}
...
func TestE_nocarry_0628NegZero(t *testing.T) {
	var a, b e_nocarry_0628
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0628Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0628, len(staticTestValues))
...
func TestE_nocarry_0628Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0628) bool {
			var b e_nocarry_0628
...
func TestE_nocarry_0628InverseExp(t *testing.T) {
...
func TestE_nocarry_0628MulByConstants(t *testing.T) {
...
func TestE_nocarry_0628Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0628) bool {
...
func TestE_nocarry_0628LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0628Halve(t *testing.T) {
...
func TestE_nocarry_0628FromMont(t *testing.T) {
...
type testPaire_nocarry_0628 struct {
	element e_nocarry_0628
	bigint  big.Int
}

func (z *e_nocarry_0628) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0628[9] {
		return true
	}
	if z[9] < qe_nocarry_0628[9] {
		return false
	...
	return z[0] >= qe_nocarry_0628[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0628

		g.element = e_nocarry_0628{
		...
		if qe_nocarry_0628[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0628[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0628 {
			var g e_nocarry_0628
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0628[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0628[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0628[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0628[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0628[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0628[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0628[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0628[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0628[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0628[9], carry)
...
func Benchmarke_nocarry_0628InverseNew(b *testing.B) {
	var x e_nocarry_0628
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0628
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0628
		var xInv e_nocarry_0628
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0628
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0628
...
func testLinearComb(t *testing.T, x *e_nocarry_0628, xC int64, y *e_nocarry_0628, yC int64) {
	...
	var z e_nocarry_0628
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0628, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0628
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0628, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0628
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0628, xHi uint64) {
	var res e_nocarry_0628
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0628) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0628) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0628, c int64, result *e_nocarry_0628, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0628) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0628) uint64 {
