...
var benchRese_nocarry_0408 e_nocarry_0408

func BenchmarkE_nocarry_0408SetBytes(b *testing.B) {
	var x e_nocarry_0408
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0408MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0408.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0408)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0408)
		}
	})
}

func BenchmarkE_nocarry_0408Inverse(b *testing.B) {
	var x e_nocarry_0408
	x.SetRandom()
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0408Butterfly(b *testing.B) {
	var x e_nocarry_0408
	x.SetRandom()
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0408)
	}
}

func BenchmarkE_nocarry_0408Exp(b *testing.B) {
	var x e_nocarry_0408
	x.SetRandom()
	benchRese_nocarry_0408.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0408Double(b *testing.B) {
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Double(&benchRese_nocarry_0408)
	}
}

func BenchmarkE_nocarry_0408Add(b *testing.B) {
	var x e_nocarry_0408
	x.SetRandom()
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Add(&x, &benchRese_nocarry_0408)
	}
}

func BenchmarkE_nocarry_0408Sub(b *testing.B) {
	var x e_nocarry_0408
	x.SetRandom()
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Sub(&x, &benchRese_nocarry_0408)
	}
}

func BenchmarkE_nocarry_0408Neg(b *testing.B) {
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Neg(&benchRese_nocarry_0408)
	}
}

func BenchmarkE_nocarry_0408Div(b *testing.B) {
	var x e_nocarry_0408
	x.SetRandom()
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Div(&x, &benchRese_nocarry_0408)
	}
}

func BenchmarkE_nocarry_0408FromMont(b *testing.B) {
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.FromMont()
	}
}

func BenchmarkE_nocarry_0408ToMont(b *testing.B) {
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.ToMont()
	}
}
func BenchmarkE_nocarry_0408Square(b *testing.B) {
	benchRese_nocarry_0408.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Square(&benchRese_nocarry_0408)
	}
}

func BenchmarkE_nocarry_0408Sqrt(b *testing.B) {
	var a e_nocarry_0408
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0408Mul(b *testing.B) {
	x := e_nocarry_0408{
	...
	benchRese_nocarry_0408.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Mul(&benchRese_nocarry_0408, &x)
	}
}

func BenchmarkE_nocarry_0408Cmp(b *testing.B) {
	x := e_nocarry_0408{
		16087173604711964995,
		4665364646032472560,
		1942674200287015499,
	...
	benchRese_nocarry_0408 = x
	benchRese_nocarry_0408[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0408.Cmp(&x)
	}
}

func TestE_nocarry_0408Cmp(t *testing.T) {
	var x, y e_nocarry_0408
...
func TestE_nocarry_0408IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0408
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0408

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0408{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0408
	one.SetOne()
	e.Sub(&qe_nocarry_0408, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0408{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0408{0, uint64(i)})
	}
...
func TestE_nocarry_0408NegZero(t *testing.T) {
	var a, b e_nocarry_0408
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0408Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0408, len(staticTestValues))
...
func TestE_nocarry_0408Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0408) bool {
			var b e_nocarry_0408
...
func TestE_nocarry_0408InverseExp(t *testing.T) {
...
func TestE_nocarry_0408MulByConstants(t *testing.T) {
...
func TestE_nocarry_0408Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0408) bool {
...
func TestE_nocarry_0408LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0408Halve(t *testing.T) {
...
func TestE_nocarry_0408FromMont(t *testing.T) {
...
type testPaire_nocarry_0408 struct {
	element e_nocarry_0408
	bigint  big.Int
}

func (z *e_nocarry_0408) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0408[6] {
		return true
	}
	if z[6] < qe_nocarry_0408[6] {
		return false
	...
	return z[0] >= qe_nocarry_0408[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0408

		g.element = e_nocarry_0408{
		...
		if qe_nocarry_0408[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0408[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0408 {
			var g e_nocarry_0408
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0408[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0408[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0408[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0408[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0408[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0408[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0408[6], carry)
...
func Benchmarke_nocarry_0408InverseNew(b *testing.B) {
	var x e_nocarry_0408
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0408
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0408
		var xInv e_nocarry_0408
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0408
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0408
...
func testLinearComb(t *testing.T, x *e_nocarry_0408, xC int64, y *e_nocarry_0408, yC int64) {
	...
	var z e_nocarry_0408
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0408, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0408
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0408, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0408
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0408, xHi uint64) {
	var res e_nocarry_0408
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0408) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0408) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0408, c int64, result *e_nocarry_0408, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0408) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0408) uint64 {
