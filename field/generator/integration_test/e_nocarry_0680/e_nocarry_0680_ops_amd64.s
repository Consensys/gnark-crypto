...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xd89ddd7bde26c571, R14
	ADDQ R14, AX
	MOVQ $0x122d187e450690b0, R14
	ADCQ R14, DX
	MOVQ $0xe7d9856b4fda8208, R14
	ADCQ R14, CX
	MOVQ $0x793bf4fa67243ec1, R14
	ADCQ R14, BX
	MOVQ $0x233f00abbc512557, R14
	ADCQ R14, SI
	MOVQ $0x8f255c4c590a9d8b, R14
	ADCQ R14, DI
	MOVQ $0x3282ebce32f9b768, R14
	ADCQ R14, R8
	MOVQ $0x08b3bc7532176cc7, R14
	ADCQ R14, R9
	MOVQ $0xbf8de8c5be7acac5, R14
	ADCQ R14, R10
	MOVQ $0x360c00e0379c61f8, R14
	ADCQ R14, R11
	MOVQ $0x000000fb6a91ac41, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xd89ddd7bde26c571, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x122d187e450690b0, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xe7d9856b4fda8208, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x793bf4fa67243ec1, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x233f00abbc512557, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x8f255c4c590a9d8b, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x3282ebce32f9b768, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x08b3bc7532176cc7, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xbf8de8c5be7acac5, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x360c00e0379c61f8, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000fb6a91ac41, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xd89ddd7bde26c571, AX
	ADDQ AX, DX
	MOVQ $0x122d187e450690b0, AX
	ADCQ AX, CX
	MOVQ $0xe7d9856b4fda8208, AX
	ADCQ AX, BX
	MOVQ $0x793bf4fa67243ec1, AX
	ADCQ AX, SI
	MOVQ $0x233f00abbc512557, AX
	ADCQ AX, DI
	MOVQ $0x8f255c4c590a9d8b, AX
	ADCQ AX, R8
	MOVQ $0x3282ebce32f9b768, AX
	ADCQ AX, R9
	MOVQ $0x08b3bc7532176cc7, AX
	ADCQ AX, R10
	MOVQ $0xbf8de8c5be7acac5, AX
	ADCQ AX, R11
	MOVQ $0x360c00e0379c61f8, AX
	ADCQ AX, R12
	MOVQ $0x000000fb6a91ac41, AX
	ADCQ AX, R13
