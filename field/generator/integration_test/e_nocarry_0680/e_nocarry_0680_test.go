...
var benchRese_nocarry_0680 e_nocarry_0680

func BenchmarkE_nocarry_0680SetBytes(b *testing.B) {
	var x e_nocarry_0680
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0680MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0680.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0680)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0680)
		}
	})
}

func BenchmarkE_nocarry_0680Inverse(b *testing.B) {
	var x e_nocarry_0680
	x.SetRandom()
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0680Butterfly(b *testing.B) {
	var x e_nocarry_0680
	x.SetRandom()
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0680)
	}
}

func BenchmarkE_nocarry_0680Exp(b *testing.B) {
	var x e_nocarry_0680
	x.SetRandom()
	benchRese_nocarry_0680.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0680Double(b *testing.B) {
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Double(&benchRese_nocarry_0680)
	}
}

func BenchmarkE_nocarry_0680Add(b *testing.B) {
	var x e_nocarry_0680
	x.SetRandom()
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Add(&x, &benchRese_nocarry_0680)
	}
}

func BenchmarkE_nocarry_0680Sub(b *testing.B) {
	var x e_nocarry_0680
	x.SetRandom()
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Sub(&x, &benchRese_nocarry_0680)
	}
}

func BenchmarkE_nocarry_0680Neg(b *testing.B) {
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Neg(&benchRese_nocarry_0680)
	}
}

func BenchmarkE_nocarry_0680Div(b *testing.B) {
	var x e_nocarry_0680
	x.SetRandom()
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Div(&x, &benchRese_nocarry_0680)
	}
}

func BenchmarkE_nocarry_0680FromMont(b *testing.B) {
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.FromMont()
	}
}

func BenchmarkE_nocarry_0680ToMont(b *testing.B) {
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.ToMont()
	}
}
func BenchmarkE_nocarry_0680Square(b *testing.B) {
	benchRese_nocarry_0680.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Square(&benchRese_nocarry_0680)
	}
}

func BenchmarkE_nocarry_0680Sqrt(b *testing.B) {
	var a e_nocarry_0680
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0680Mul(b *testing.B) {
	x := e_nocarry_0680{
		4348236420983505016,
		1953472606813357657,
	...
	benchRese_nocarry_0680.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Mul(&benchRese_nocarry_0680, &x)
	}
}

func BenchmarkE_nocarry_0680Cmp(b *testing.B) {
	x := e_nocarry_0680{
		4348236420983505016,
		1953472606813357657,
		10271660688593265230,
	...
	benchRese_nocarry_0680 = x
	benchRese_nocarry_0680[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0680.Cmp(&x)
	}
}

func TestE_nocarry_0680Cmp(t *testing.T) {
	var x, y e_nocarry_0680
...
func TestE_nocarry_0680IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0680
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0680

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0680{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0680
	one.SetOne()
	e.Sub(&qe_nocarry_0680, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0680{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0680{0, uint64(i)})
	}
...
func TestE_nocarry_0680NegZero(t *testing.T) {
	var a, b e_nocarry_0680
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0680Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0680, len(staticTestValues))
...
func TestE_nocarry_0680Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0680) bool {
			var b e_nocarry_0680
...
func TestE_nocarry_0680InverseExp(t *testing.T) {
...
func TestE_nocarry_0680MulByConstants(t *testing.T) {
...
func TestE_nocarry_0680Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0680) bool {
...
func TestE_nocarry_0680LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0680Halve(t *testing.T) {
...
func TestE_nocarry_0680FromMont(t *testing.T) {
...
type testPaire_nocarry_0680 struct {
	element e_nocarry_0680
	bigint  big.Int
}

func (z *e_nocarry_0680) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0680[10] {
		return true
	}
	if z[10] < qe_nocarry_0680[10] {
		return false
	...
	return z[0] >= qe_nocarry_0680[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0680

		g.element = e_nocarry_0680{
		...
		if qe_nocarry_0680[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0680[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0680 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0680[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0680[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0680[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0680[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0680[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0680[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0680[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0680[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0680[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0680[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0680[10], carry)
...
func Benchmarke_nocarry_0680InverseNew(b *testing.B) {
	var x e_nocarry_0680
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0680
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0680
		var xInv e_nocarry_0680
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0680
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0680
...
func testLinearComb(t *testing.T, x *e_nocarry_0680, xC int64, y *e_nocarry_0680, yC int64) {
	...
	var z e_nocarry_0680
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0680, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0680
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0680, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0680
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0680, xHi uint64) {
	var res e_nocarry_0680
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0680) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0680) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0680, c int64, result *e_nocarry_0680, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0680) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0680) uint64 {
