...
// modulus q
DATA q<>+0(SB)/8, $0xd89ddd7bde26c571
DATA q<>+8(SB)/8, $0x122d187e450690b0
DATA q<>+16(SB)/8, $0xe7d9856b4fda8208
DATA q<>+24(SB)/8, $0x793bf4fa67243ec1
DATA q<>+32(SB)/8, $0x233f00abbc512557
DATA q<>+40(SB)/8, $0x8f255c4c590a9d8b
DATA q<>+48(SB)/8, $0x3282ebce32f9b768
DATA q<>+56(SB)/8, $0x08b3bc7532176cc7
DATA q<>+64(SB)/8, $0xbf8de8c5be7acac5
DATA q<>+72(SB)/8, $0x360c00e0379c61f8
DATA q<>+80(SB)/8, $0x000000fb6a91ac41
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x25e0129097f4a46f
