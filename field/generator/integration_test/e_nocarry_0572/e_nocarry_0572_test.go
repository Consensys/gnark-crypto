...
var benchRese_nocarry_0572 e_nocarry_0572

func BenchmarkE_nocarry_0572SetBytes(b *testing.B) {
	var x e_nocarry_0572
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0572MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0572.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0572)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0572)
		}
	})
}

func BenchmarkE_nocarry_0572Inverse(b *testing.B) {
	var x e_nocarry_0572
	x.SetRandom()
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0572Butterfly(b *testing.B) {
	var x e_nocarry_0572
	x.SetRandom()
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0572)
	}
}

func BenchmarkE_nocarry_0572Exp(b *testing.B) {
	var x e_nocarry_0572
	x.SetRandom()
	benchRese_nocarry_0572.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0572Double(b *testing.B) {
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Double(&benchRese_nocarry_0572)
	}
}

func BenchmarkE_nocarry_0572Add(b *testing.B) {
	var x e_nocarry_0572
	x.SetRandom()
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Add(&x, &benchRese_nocarry_0572)
	}
}

func BenchmarkE_nocarry_0572Sub(b *testing.B) {
	var x e_nocarry_0572
	x.SetRandom()
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Sub(&x, &benchRese_nocarry_0572)
	}
}

func BenchmarkE_nocarry_0572Neg(b *testing.B) {
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Neg(&benchRese_nocarry_0572)
	}
}

func BenchmarkE_nocarry_0572Div(b *testing.B) {
	var x e_nocarry_0572
	x.SetRandom()
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Div(&x, &benchRese_nocarry_0572)
	}
}

func BenchmarkE_nocarry_0572FromMont(b *testing.B) {
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.FromMont()
	}
}

func BenchmarkE_nocarry_0572ToMont(b *testing.B) {
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.ToMont()
	}
}
func BenchmarkE_nocarry_0572Square(b *testing.B) {
	benchRese_nocarry_0572.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Square(&benchRese_nocarry_0572)
	}
}

func BenchmarkE_nocarry_0572Sqrt(b *testing.B) {
	var a e_nocarry_0572
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0572Mul(b *testing.B) {
	x := e_nocarry_0572{
		1375762134597936533,
	...
	benchRese_nocarry_0572.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Mul(&benchRese_nocarry_0572, &x)
	}
}

func BenchmarkE_nocarry_0572Cmp(b *testing.B) {
	x := e_nocarry_0572{
		1375762134597936533,
		15538573061920933268,
		9673928547328326144,
	...
	benchRese_nocarry_0572 = x
	benchRese_nocarry_0572[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0572.Cmp(&x)
	}
}

func TestE_nocarry_0572Cmp(t *testing.T) {
	var x, y e_nocarry_0572
...
func TestE_nocarry_0572IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0572
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0572

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0572{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0572
	one.SetOne()
	e.Sub(&qe_nocarry_0572, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0572{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0572{0, uint64(i)})
	}
...
func TestE_nocarry_0572NegZero(t *testing.T) {
	var a, b e_nocarry_0572
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0572Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0572, len(staticTestValues))
...
func TestE_nocarry_0572Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0572) bool {
			var b e_nocarry_0572
...
func TestE_nocarry_0572InverseExp(t *testing.T) {
...
func TestE_nocarry_0572MulByConstants(t *testing.T) {
...
func TestE_nocarry_0572Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0572) bool {
...
func TestE_nocarry_0572LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0572Halve(t *testing.T) {
...
func TestE_nocarry_0572FromMont(t *testing.T) {
...
type testPaire_nocarry_0572 struct {
	element e_nocarry_0572
	bigint  big.Int
}

func (z *e_nocarry_0572) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0572[8] {
		return true
	}
	if z[8] < qe_nocarry_0572[8] {
		return false
	...
	return z[0] >= qe_nocarry_0572[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0572

		g.element = e_nocarry_0572{
		...
		if qe_nocarry_0572[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0572[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0572 {
			var g e_nocarry_0572
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0572[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0572[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0572[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0572[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0572[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0572[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0572[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0572[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0572[8], carry)
...
func Benchmarke_nocarry_0572InverseNew(b *testing.B) {
	var x e_nocarry_0572
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0572
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0572
		var xInv e_nocarry_0572
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0572
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0572
...
func testLinearComb(t *testing.T, x *e_nocarry_0572, xC int64, y *e_nocarry_0572, yC int64) {
	...
	var z e_nocarry_0572
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0572, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0572
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0572, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0572
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0572, xHi uint64) {
	var res e_nocarry_0572
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0572) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0572) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0572, c int64, result *e_nocarry_0572, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0572) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0572) uint64 {
