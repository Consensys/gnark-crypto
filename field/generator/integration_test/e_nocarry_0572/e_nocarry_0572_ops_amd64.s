...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x67ec780f77c00b67, R12
	ADDQ R12, AX
	MOVQ $0x42e7555f9d94b71f, R12
	ADCQ R12, DX
	MOVQ $0x73d4bb583285e64f, R12
	ADCQ R12, CX
	MOVQ $0x1996a140dfe48e28, R12
	ADCQ R12, BX
	MOVQ $0x345bd4371bee11b8, R12
	ADCQ R12, SI
	MOVQ $0x2bffd43ea2395421, R12
	ADCQ R12, DI
	MOVQ $0x82169acb8606f570, R12
	ADCQ R12, R8
	MOVQ $0x3088170ad402d73b, R12
	ADCQ R12, R9
	MOVQ $0x0ee7076e115ed0e6, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x67ec780f77c00b67, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x42e7555f9d94b71f, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x73d4bb583285e64f, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x1996a140dfe48e28, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x345bd4371bee11b8, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x2bffd43ea2395421, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x82169acb8606f570, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x3088170ad402d73b, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0ee7076e115ed0e6, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x67ec780f77c00b67, AX
	ADDQ AX, DX
	MOVQ $0x42e7555f9d94b71f, AX
	ADCQ AX, CX
	MOVQ $0x73d4bb583285e64f, AX
	ADCQ AX, BX
	MOVQ $0x1996a140dfe48e28, AX
	ADCQ AX, SI
	MOVQ $0x345bd4371bee11b8, AX
	ADCQ AX, DI
	MOVQ $0x2bffd43ea2395421, AX
	ADCQ AX, R8
	MOVQ $0x82169acb8606f570, AX
	ADCQ AX, R9
	MOVQ $0x3088170ad402d73b, AX
	ADCQ AX, R10
	MOVQ $0x0ee7076e115ed0e6, AX
	ADCQ AX, R11
