...
var benchRese_nocarry_0489 e_nocarry_0489

func BenchmarkE_nocarry_0489SetBytes(b *testing.B) {
	var x e_nocarry_0489
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0489MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0489.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0489)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0489)
		}
	})
}

func BenchmarkE_nocarry_0489Inverse(b *testing.B) {
	var x e_nocarry_0489
	x.SetRandom()
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0489Butterfly(b *testing.B) {
	var x e_nocarry_0489
	x.SetRandom()
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0489)
	}
}

func BenchmarkE_nocarry_0489Exp(b *testing.B) {
	var x e_nocarry_0489
	x.SetRandom()
	benchRese_nocarry_0489.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0489Double(b *testing.B) {
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Double(&benchRese_nocarry_0489)
	}
}

func BenchmarkE_nocarry_0489Add(b *testing.B) {
	var x e_nocarry_0489
	x.SetRandom()
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Add(&x, &benchRese_nocarry_0489)
	}
}

func BenchmarkE_nocarry_0489Sub(b *testing.B) {
	var x e_nocarry_0489
	x.SetRandom()
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Sub(&x, &benchRese_nocarry_0489)
	}
}

func BenchmarkE_nocarry_0489Neg(b *testing.B) {
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Neg(&benchRese_nocarry_0489)
	}
}

func BenchmarkE_nocarry_0489Div(b *testing.B) {
	var x e_nocarry_0489
	x.SetRandom()
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Div(&x, &benchRese_nocarry_0489)
	}
}

func BenchmarkE_nocarry_0489FromMont(b *testing.B) {
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.FromMont()
	}
}

func BenchmarkE_nocarry_0489ToMont(b *testing.B) {
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.ToMont()
	}
}
func BenchmarkE_nocarry_0489Square(b *testing.B) {
	benchRese_nocarry_0489.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Square(&benchRese_nocarry_0489)
	}
}

func BenchmarkE_nocarry_0489Sqrt(b *testing.B) {
	var a e_nocarry_0489
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0489Mul(b *testing.B) {
	x := e_nocarry_0489{
		4765621981400753036,
	...
	benchRese_nocarry_0489.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Mul(&benchRese_nocarry_0489, &x)
	}
}

func BenchmarkE_nocarry_0489Cmp(b *testing.B) {
	x := e_nocarry_0489{
		4765621981400753036,
		11716458430333970550,
		11922224271758228764,
	...
	benchRese_nocarry_0489 = x
	benchRese_nocarry_0489[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0489.Cmp(&x)
	}
}

func TestE_nocarry_0489Cmp(t *testing.T) {
	var x, y e_nocarry_0489
...
func TestE_nocarry_0489IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0489
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0489

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0489{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0489
	one.SetOne()
	e.Sub(&qe_nocarry_0489, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0489{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0489{0, uint64(i)})
	}
...
func TestE_nocarry_0489NegZero(t *testing.T) {
	var a, b e_nocarry_0489
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0489Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0489, len(staticTestValues))
...
func TestE_nocarry_0489Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0489) bool {
			var b e_nocarry_0489
...
func TestE_nocarry_0489InverseExp(t *testing.T) {
...
func TestE_nocarry_0489MulByConstants(t *testing.T) {
...
func TestE_nocarry_0489Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0489) bool {
...
func TestE_nocarry_0489LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0489Halve(t *testing.T) {
...
func TestE_nocarry_0489FromMont(t *testing.T) {
...
type testPaire_nocarry_0489 struct {
	element e_nocarry_0489
	bigint  big.Int
}

func (z *e_nocarry_0489) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0489[7] {
		return true
	}
	if z[7] < qe_nocarry_0489[7] {
		return false
	...
	return z[0] >= qe_nocarry_0489[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0489

		g.element = e_nocarry_0489{
		...
		if qe_nocarry_0489[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0489[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0489 {
			var g e_nocarry_0489
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0489[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0489[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0489[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0489[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0489[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0489[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0489[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0489[7], carry)
...
func Benchmarke_nocarry_0489InverseNew(b *testing.B) {
	var x e_nocarry_0489
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0489
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0489
		var xInv e_nocarry_0489
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0489
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0489
...
func testLinearComb(t *testing.T, x *e_nocarry_0489, xC int64, y *e_nocarry_0489, yC int64) {
	...
	var z e_nocarry_0489
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0489, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0489
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0489, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0489
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0489, xHi uint64) {
	var res e_nocarry_0489
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0489) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0489) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0489, c int64, result *e_nocarry_0489, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0489) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0489) uint64 {
