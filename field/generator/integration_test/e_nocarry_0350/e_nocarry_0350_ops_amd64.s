...
// modulus q
DATA q<>+0(SB)/8, $0xb11833f428dea1ad
DATA q<>+8(SB)/8, $0x04891d9d22f3393d
DATA q<>+16(SB)/8, $0x0934ac57dbdc35a5
DATA q<>+24(SB)/8, $0x5c32eb6b5cc8eddf
DATA q<>+32(SB)/8, $0xde716bac61f867e6
DATA q<>+40(SB)/8, $0x00000000326c0933
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0236457f2d7a95db
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xb11833f428dea1ad, R10
	MOVQ    $0x04891d9d22f3393d, R11
	MOVQ    $0x0934ac57dbdc35a5, R12
	MOVQ    $0x5c32eb6b5cc8eddf, R13
	MOVQ    $0xde716bac61f867e6, R14
	MOVQ    $0x00000000326c0933, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x04891d9d22f3393d, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x0934ac57dbdc35a5, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x5c32eb6b5cc8eddf, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xde716bac61f867e6, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000000326c0933, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xb11833f428dea1ad, CX
	MOVQ    $0x04891d9d22f3393d, BX
	MOVQ    $0x0934ac57dbdc35a5, SI
	MOVQ    $0x5c32eb6b5cc8eddf, DI
	MOVQ    $0xde716bac61f867e6, R8
	MOVQ    $0x00000000326c0933, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
