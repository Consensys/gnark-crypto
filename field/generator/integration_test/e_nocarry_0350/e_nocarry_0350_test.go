...
var benchRese_nocarry_0350 e_nocarry_0350

func BenchmarkE_nocarry_0350SetBytes(b *testing.B) {
	var x e_nocarry_0350
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0350MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0350.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0350)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0350)
		}
	})
}

func BenchmarkE_nocarry_0350Inverse(b *testing.B) {
	var x e_nocarry_0350
	x.SetRandom()
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0350Butterfly(b *testing.B) {
	var x e_nocarry_0350
	x.SetRandom()
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0350)
	}
}

func BenchmarkE_nocarry_0350Exp(b *testing.B) {
	var x e_nocarry_0350
	x.SetRandom()
	benchRese_nocarry_0350.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0350Double(b *testing.B) {
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Double(&benchRese_nocarry_0350)
	}
}

func BenchmarkE_nocarry_0350Add(b *testing.B) {
	var x e_nocarry_0350
	x.SetRandom()
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Add(&x, &benchRese_nocarry_0350)
	}
}

func BenchmarkE_nocarry_0350Sub(b *testing.B) {
	var x e_nocarry_0350
	x.SetRandom()
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Sub(&x, &benchRese_nocarry_0350)
	}
}

func BenchmarkE_nocarry_0350Neg(b *testing.B) {
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Neg(&benchRese_nocarry_0350)
	}
}

func BenchmarkE_nocarry_0350Div(b *testing.B) {
	var x e_nocarry_0350
	x.SetRandom()
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Div(&x, &benchRese_nocarry_0350)
	}
}

func BenchmarkE_nocarry_0350FromMont(b *testing.B) {
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.FromMont()
	}
}

func BenchmarkE_nocarry_0350ToMont(b *testing.B) {
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.ToMont()
	}
}
func BenchmarkE_nocarry_0350Square(b *testing.B) {
	benchRese_nocarry_0350.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Square(&benchRese_nocarry_0350)
	}
}

func BenchmarkE_nocarry_0350Sqrt(b *testing.B) {
	var a e_nocarry_0350
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0350Mul(b *testing.B) {
	x := e_nocarry_0350{
		764652746042724403,
		8784911675799041208,
		4504125177029959448,
	...
	benchRese_nocarry_0350.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Mul(&benchRese_nocarry_0350, &x)
	}
}

func BenchmarkE_nocarry_0350Cmp(b *testing.B) {
	x := e_nocarry_0350{
		764652746042724403,
		8784911675799041208,
		4504125177029959448,
	...
	benchRese_nocarry_0350 = x
	benchRese_nocarry_0350[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0350.Cmp(&x)
	}
}

func TestE_nocarry_0350Cmp(t *testing.T) {
	var x, y e_nocarry_0350
...
func TestE_nocarry_0350IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0350
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0350

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0350{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0350
	one.SetOne()
	e.Sub(&qe_nocarry_0350, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0350{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0350{0, uint64(i)})
	}
...
func TestE_nocarry_0350NegZero(t *testing.T) {
	var a, b e_nocarry_0350
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0350Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0350, len(staticTestValues))
...
func TestE_nocarry_0350Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0350) bool {
			var b e_nocarry_0350
...
func TestE_nocarry_0350InverseExp(t *testing.T) {
...
func TestE_nocarry_0350MulByConstants(t *testing.T) {
...
func TestE_nocarry_0350Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0350) bool {
...
func TestE_nocarry_0350LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0350Halve(t *testing.T) {
...
func TestE_nocarry_0350FromMont(t *testing.T) {
...
type testPaire_nocarry_0350 struct {
	element e_nocarry_0350
	bigint  big.Int
}

func (z *e_nocarry_0350) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0350[5] {
		return true
	}
	if z[5] < qe_nocarry_0350[5] {
		return false
	...
	return z[0] >= qe_nocarry_0350[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0350

		g.element = e_nocarry_0350{
		...
		if qe_nocarry_0350[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0350[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0350 {
			var g e_nocarry_0350
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0350[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0350[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0350[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0350[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0350[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0350[5], carry)
...
func Benchmarke_nocarry_0350InverseNew(b *testing.B) {
	var x e_nocarry_0350
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0350
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0350
		var xInv e_nocarry_0350
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0350
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0350
...
func testLinearComb(t *testing.T, x *e_nocarry_0350, xC int64, y *e_nocarry_0350, yC int64) {
	...
	var z e_nocarry_0350
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0350, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0350
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0350, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0350
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0350, xHi uint64) {
	var res e_nocarry_0350
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0350) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0350) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0350, c int64, result *e_nocarry_0350, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0350) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0350) uint64 {
