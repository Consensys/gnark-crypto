...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x140e53cea2983319, R14
	ADDQ R14, AX
	MOVQ $0xf23f4569167f5985, R14
	ADCQ R14, DX
	MOVQ $0x4c7d56b51ffb73de, R14
	ADCQ R14, CX
	MOVQ $0xeb69e8fabc91b69c, R14
	ADCQ R14, BX
	MOVQ $0x52ce2c69f6a3a6ac, R14
	ADCQ R14, SI
	MOVQ $0x78e538cacf7e9e78, R14
	ADCQ R14, DI
	MOVQ $0x1a69b643ae0a0d8b, R14
	ADCQ R14, R8
	MOVQ $0xfd2e3e9b919efe4e, R14
	ADCQ R14, R9
	MOVQ $0x048c2b0abeb11bf8, R14
	ADCQ R14, R10
	MOVQ $0xeba80f6498ccc875, R14
	ADCQ R14, R11
	MOVQ $0x000000000000019a, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x140e53cea2983319, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xf23f4569167f5985, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x4c7d56b51ffb73de, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xeb69e8fabc91b69c, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x52ce2c69f6a3a6ac, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x78e538cacf7e9e78, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x1a69b643ae0a0d8b, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xfd2e3e9b919efe4e, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x048c2b0abeb11bf8, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xeba80f6498ccc875, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000000000019a, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x140e53cea2983319, AX
	ADDQ AX, DX
	MOVQ $0xf23f4569167f5985, AX
	ADCQ AX, CX
	MOVQ $0x4c7d56b51ffb73de, AX
	ADCQ AX, BX
	MOVQ $0xeb69e8fabc91b69c, AX
	ADCQ AX, SI
	MOVQ $0x52ce2c69f6a3a6ac, AX
	ADCQ AX, DI
	MOVQ $0x78e538cacf7e9e78, AX
	ADCQ AX, R8
	MOVQ $0x1a69b643ae0a0d8b, AX
	ADCQ AX, R9
	MOVQ $0xfd2e3e9b919efe4e, AX
	ADCQ AX, R10
	MOVQ $0x048c2b0abeb11bf8, AX
	ADCQ AX, R11
	MOVQ $0xeba80f6498ccc875, AX
	ADCQ AX, R12
	MOVQ $0x000000000000019a, AX
	ADCQ AX, R13
