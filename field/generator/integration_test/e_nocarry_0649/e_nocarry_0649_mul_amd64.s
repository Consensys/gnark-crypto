...
// modulus q
DATA q<>+0(SB)/8, $0x140e53cea2983319
DATA q<>+8(SB)/8, $0xf23f4569167f5985
DATA q<>+16(SB)/8, $0x4c7d56b51ffb73de
DATA q<>+24(SB)/8, $0xeb69e8fabc91b69c
DATA q<>+32(SB)/8, $0x52ce2c69f6a3a6ac
DATA q<>+40(SB)/8, $0x78e538cacf7e9e78
DATA q<>+48(SB)/8, $0x1a69b643ae0a0d8b
DATA q<>+56(SB)/8, $0xfd2e3e9b919efe4e
DATA q<>+64(SB)/8, $0x048c2b0abeb11bf8
DATA q<>+72(SB)/8, $0xeba80f6498ccc875
DATA q<>+80(SB)/8, $0x000000000000019a
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xff18f051ee9e86d7
