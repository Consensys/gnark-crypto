...
var benchRese_nocarry_0649 e_nocarry_0649

func BenchmarkE_nocarry_0649SetBytes(b *testing.B) {
	var x e_nocarry_0649
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0649MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0649.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0649)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0649)
		}
	})
}

func BenchmarkE_nocarry_0649Inverse(b *testing.B) {
	var x e_nocarry_0649
	x.SetRandom()
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0649Butterfly(b *testing.B) {
	var x e_nocarry_0649
	x.SetRandom()
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0649)
	}
}

func BenchmarkE_nocarry_0649Exp(b *testing.B) {
	var x e_nocarry_0649
	x.SetRandom()
	benchRese_nocarry_0649.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0649Double(b *testing.B) {
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Double(&benchRese_nocarry_0649)
	}
}

func BenchmarkE_nocarry_0649Add(b *testing.B) {
	var x e_nocarry_0649
	x.SetRandom()
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Add(&x, &benchRese_nocarry_0649)
	}
}

func BenchmarkE_nocarry_0649Sub(b *testing.B) {
	var x e_nocarry_0649
	x.SetRandom()
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Sub(&x, &benchRese_nocarry_0649)
	}
}

func BenchmarkE_nocarry_0649Neg(b *testing.B) {
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Neg(&benchRese_nocarry_0649)
	}
}

func BenchmarkE_nocarry_0649Div(b *testing.B) {
	var x e_nocarry_0649
	x.SetRandom()
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Div(&x, &benchRese_nocarry_0649)
	}
}

func BenchmarkE_nocarry_0649FromMont(b *testing.B) {
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.FromMont()
	}
}

func BenchmarkE_nocarry_0649ToMont(b *testing.B) {
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.ToMont()
	}
}
func BenchmarkE_nocarry_0649Square(b *testing.B) {
	benchRese_nocarry_0649.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Square(&benchRese_nocarry_0649)
	}
}

func BenchmarkE_nocarry_0649Sqrt(b *testing.B) {
	var a e_nocarry_0649
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0649Mul(b *testing.B) {
	x := e_nocarry_0649{
	...
	benchRese_nocarry_0649.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Mul(&benchRese_nocarry_0649, &x)
	}
}

func BenchmarkE_nocarry_0649Cmp(b *testing.B) {
	x := e_nocarry_0649{
		14804724953044367199,
		266345086333535181,
		637356592484605346,
	...
	benchRese_nocarry_0649 = x
	benchRese_nocarry_0649[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0649.Cmp(&x)
	}
}

func TestE_nocarry_0649Cmp(t *testing.T) {
	var x, y e_nocarry_0649
...
func TestE_nocarry_0649IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0649
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0649

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0649{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0649
	one.SetOne()
	e.Sub(&qe_nocarry_0649, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0649{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0649{0, uint64(i)})
	}
...
func TestE_nocarry_0649NegZero(t *testing.T) {
	var a, b e_nocarry_0649
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0649Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0649, len(staticTestValues))
...
func TestE_nocarry_0649Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0649) bool {
			var b e_nocarry_0649
...
func TestE_nocarry_0649InverseExp(t *testing.T) {
...
func TestE_nocarry_0649MulByConstants(t *testing.T) {
...
func TestE_nocarry_0649Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0649) bool {
...
func TestE_nocarry_0649LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0649Halve(t *testing.T) {
...
func TestE_nocarry_0649FromMont(t *testing.T) {
...
type testPaire_nocarry_0649 struct {
	element e_nocarry_0649
	bigint  big.Int
}

func (z *e_nocarry_0649) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0649[10] {
		return true
	}
	if z[10] < qe_nocarry_0649[10] {
		return false
	...
	return z[0] >= qe_nocarry_0649[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0649

		g.element = e_nocarry_0649{
		...
		if qe_nocarry_0649[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0649[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0649 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0649[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0649[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0649[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0649[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0649[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0649[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0649[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0649[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0649[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0649[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0649[10], carry)
...
func Benchmarke_nocarry_0649InverseNew(b *testing.B) {
	var x e_nocarry_0649
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0649
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0649
		var xInv e_nocarry_0649
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0649
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0649
...
func testLinearComb(t *testing.T, x *e_nocarry_0649, xC int64, y *e_nocarry_0649, yC int64) {
	...
	var z e_nocarry_0649
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0649, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0649
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0649, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0649
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0649, xHi uint64) {
	var res e_nocarry_0649
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0649) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0649) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0649, c int64, result *e_nocarry_0649, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0649) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0649) uint64 {
