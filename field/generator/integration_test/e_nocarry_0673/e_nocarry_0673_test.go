...
var benchRese_nocarry_0673 e_nocarry_0673

func BenchmarkE_nocarry_0673SetBytes(b *testing.B) {
	var x e_nocarry_0673
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0673MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0673.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0673)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0673)
		}
	})
}

func BenchmarkE_nocarry_0673Inverse(b *testing.B) {
	var x e_nocarry_0673
	x.SetRandom()
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0673Butterfly(b *testing.B) {
	var x e_nocarry_0673
	x.SetRandom()
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0673)
	}
}

func BenchmarkE_nocarry_0673Exp(b *testing.B) {
	var x e_nocarry_0673
	x.SetRandom()
	benchRese_nocarry_0673.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0673Double(b *testing.B) {
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Double(&benchRese_nocarry_0673)
	}
}

func BenchmarkE_nocarry_0673Add(b *testing.B) {
	var x e_nocarry_0673
	x.SetRandom()
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Add(&x, &benchRese_nocarry_0673)
	}
}

func BenchmarkE_nocarry_0673Sub(b *testing.B) {
	var x e_nocarry_0673
	x.SetRandom()
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Sub(&x, &benchRese_nocarry_0673)
	}
}

func BenchmarkE_nocarry_0673Neg(b *testing.B) {
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Neg(&benchRese_nocarry_0673)
	}
}

func BenchmarkE_nocarry_0673Div(b *testing.B) {
	var x e_nocarry_0673
	x.SetRandom()
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Div(&x, &benchRese_nocarry_0673)
	}
}

func BenchmarkE_nocarry_0673FromMont(b *testing.B) {
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.FromMont()
	}
}

func BenchmarkE_nocarry_0673ToMont(b *testing.B) {
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.ToMont()
	}
}
func BenchmarkE_nocarry_0673Square(b *testing.B) {
	benchRese_nocarry_0673.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Square(&benchRese_nocarry_0673)
	}
}

func BenchmarkE_nocarry_0673Sqrt(b *testing.B) {
	var a e_nocarry_0673
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0673Mul(b *testing.B) {
	x := e_nocarry_0673{
	...
	benchRese_nocarry_0673.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Mul(&benchRese_nocarry_0673, &x)
	}
}

func BenchmarkE_nocarry_0673Cmp(b *testing.B) {
	x := e_nocarry_0673{
		13800789090043114735,
		15548799323038693182,
		17530328305726493256,
	...
	benchRese_nocarry_0673 = x
	benchRese_nocarry_0673[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0673.Cmp(&x)
	}
}

func TestE_nocarry_0673Cmp(t *testing.T) {
	var x, y e_nocarry_0673
...
func TestE_nocarry_0673IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0673
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0673

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0673{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0673
	one.SetOne()
	e.Sub(&qe_nocarry_0673, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0673{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0673{0, uint64(i)})
	}
...
func TestE_nocarry_0673NegZero(t *testing.T) {
	var a, b e_nocarry_0673
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0673Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0673, len(staticTestValues))
...
func TestE_nocarry_0673Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0673) bool {
			var b e_nocarry_0673
...
func TestE_nocarry_0673InverseExp(t *testing.T) {
...
func TestE_nocarry_0673MulByConstants(t *testing.T) {
...
func TestE_nocarry_0673Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0673) bool {
...
func TestE_nocarry_0673LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0673Halve(t *testing.T) {
...
func TestE_nocarry_0673FromMont(t *testing.T) {
...
type testPaire_nocarry_0673 struct {
	element e_nocarry_0673
	bigint  big.Int
}

func (z *e_nocarry_0673) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0673[10] {
		return true
	}
	if z[10] < qe_nocarry_0673[10] {
		return false
	...
	return z[0] >= qe_nocarry_0673[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0673

		g.element = e_nocarry_0673{
		...
		if qe_nocarry_0673[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0673[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0673 {
			var g e_nocarry_0673
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0673[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0673[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0673[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0673[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0673[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0673[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0673[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0673[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0673[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0673[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0673[10], carry)
...
func Benchmarke_nocarry_0673InverseNew(b *testing.B) {
	var x e_nocarry_0673
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0673
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0673
		var xInv e_nocarry_0673
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0673
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0673
...
func testLinearComb(t *testing.T, x *e_nocarry_0673, xC int64, y *e_nocarry_0673, yC int64) {
	...
	var z e_nocarry_0673
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0673, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0673
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0673, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0673
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0673, xHi uint64) {
	var res e_nocarry_0673
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0673) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0673) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0673, c int64, result *e_nocarry_0673, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0673) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0673) uint64 {
