...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xb654d50e37624d07, R14
	ADDQ R14, AX
	MOVQ $0x3545c9c9d59a12f6, R14
	ADCQ R14, DX
	MOVQ $0x8edfcab3daa536a8, R14
	ADCQ R14, CX
	MOVQ $0xfe775c680b2ce97f, R14
	ADCQ R14, BX
	MOVQ $0xd02c5f7ad1abaf93, R14
	ADCQ R14, SI
	MOVQ $0x0ea516b68ad7e354, R14
	ADCQ R14, DI
	MOVQ $0x85ab43eb560f1cb5, R14
	ADCQ R14, R8
	MOVQ $0x8054d386cd733e81, R14
	ADCQ R14, R9
	MOVQ $0x112b2ab6e61c42b3, R14
	ADCQ R14, R10
	MOVQ $0x871218275821a7a5, R14
	ADCQ R14, R11
	MOVQ $0x0000000199424c1b, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xb654d50e37624d07, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x3545c9c9d59a12f6, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x8edfcab3daa536a8, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xfe775c680b2ce97f, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xd02c5f7ad1abaf93, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x0ea516b68ad7e354, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x85ab43eb560f1cb5, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x8054d386cd733e81, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x112b2ab6e61c42b3, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x871218275821a7a5, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000199424c1b, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xb654d50e37624d07, AX
	ADDQ AX, DX
	MOVQ $0x3545c9c9d59a12f6, AX
	ADCQ AX, CX
	MOVQ $0x8edfcab3daa536a8, AX
	ADCQ AX, BX
	MOVQ $0xfe775c680b2ce97f, AX
	ADCQ AX, SI
	MOVQ $0xd02c5f7ad1abaf93, AX
	ADCQ AX, DI
	MOVQ $0x0ea516b68ad7e354, AX
	ADCQ AX, R8
	MOVQ $0x85ab43eb560f1cb5, AX
	ADCQ AX, R9
	MOVQ $0x8054d386cd733e81, AX
	ADCQ AX, R10
	MOVQ $0x112b2ab6e61c42b3, AX
	ADCQ AX, R11
	MOVQ $0x871218275821a7a5, AX
	ADCQ AX, R12
	MOVQ $0x0000000199424c1b, AX
	ADCQ AX, R13
