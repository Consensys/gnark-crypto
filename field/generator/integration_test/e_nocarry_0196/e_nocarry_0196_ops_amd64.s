...
// modulus q
DATA q<>+0(SB)/8, $0x43b7445209250c2d
DATA q<>+8(SB)/8, $0x99033a13e928e716
DATA q<>+16(SB)/8, $0xe5d52d5eb946ac54
DATA q<>+24(SB)/8, $0x000000000000000e
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xa7e47d2e4396dc5b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x43b7445209250c2d, R8
	MOVQ    $0x99033a13e928e716, R9
	MOVQ    $0xe5d52d5eb946ac54, R10
	MOVQ    $0x000000000000000e, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x99033a13e928e716, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xe5d52d5eb946ac54, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x43b7445209250c2d, R12
	MOVQ    $0x99033a13e928e716, R13
	MOVQ    $0xe5d52d5eb946ac54, R14
	MOVQ    $0x000000000000000e, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
