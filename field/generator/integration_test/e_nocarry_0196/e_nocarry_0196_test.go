...
var benchRese_nocarry_0196 e_nocarry_0196

func BenchmarkE_nocarry_0196SetBytes(b *testing.B) {
	var x e_nocarry_0196
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0196MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0196.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0196)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0196)
		}
	})
}

func BenchmarkE_nocarry_0196Inverse(b *testing.B) {
	var x e_nocarry_0196
	x.SetRandom()
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0196Butterfly(b *testing.B) {
	var x e_nocarry_0196
	x.SetRandom()
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0196)
	}
}

func BenchmarkE_nocarry_0196Exp(b *testing.B) {
	var x e_nocarry_0196
	x.SetRandom()
	benchRese_nocarry_0196.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0196Double(b *testing.B) {
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Double(&benchRese_nocarry_0196)
	}
}

func BenchmarkE_nocarry_0196Add(b *testing.B) {
	var x e_nocarry_0196
	x.SetRandom()
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Add(&x, &benchRese_nocarry_0196)
	}
}

func BenchmarkE_nocarry_0196Sub(b *testing.B) {
	var x e_nocarry_0196
	x.SetRandom()
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Sub(&x, &benchRese_nocarry_0196)
	}
}

func BenchmarkE_nocarry_0196Neg(b *testing.B) {
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Neg(&benchRese_nocarry_0196)
	}
}

func BenchmarkE_nocarry_0196Div(b *testing.B) {
	var x e_nocarry_0196
	x.SetRandom()
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Div(&x, &benchRese_nocarry_0196)
	}
}

func BenchmarkE_nocarry_0196FromMont(b *testing.B) {
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.FromMont()
	}
}

func BenchmarkE_nocarry_0196ToMont(b *testing.B) {
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.ToMont()
	}
}
func BenchmarkE_nocarry_0196Square(b *testing.B) {
	benchRese_nocarry_0196.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Square(&benchRese_nocarry_0196)
	}
}

func BenchmarkE_nocarry_0196Sqrt(b *testing.B) {
	var a e_nocarry_0196
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0196Mul(b *testing.B) {
	x := e_nocarry_0196{
	...
	benchRese_nocarry_0196.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Mul(&benchRese_nocarry_0196, &x)
	}
}

func BenchmarkE_nocarry_0196Cmp(b *testing.B) {
	x := e_nocarry_0196{
		16775393374297921808,
		10252660988722560501,
		13667515100912980368,
	...
	benchRese_nocarry_0196 = x
	benchRese_nocarry_0196[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0196.Cmp(&x)
	}
}

func TestE_nocarry_0196Cmp(t *testing.T) {
	var x, y e_nocarry_0196
...
func TestE_nocarry_0196IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0196
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0196

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0196{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0196
	one.SetOne()
	e.Sub(&qe_nocarry_0196, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0196{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0196{0, uint64(i)})
	}
...
func TestE_nocarry_0196NegZero(t *testing.T) {
	var a, b e_nocarry_0196
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0196Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0196, len(staticTestValues))
...
func TestE_nocarry_0196Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0196) bool {
			var b e_nocarry_0196
...
func TestE_nocarry_0196InverseExp(t *testing.T) {
...
func TestE_nocarry_0196MulByConstants(t *testing.T) {
...
func TestE_nocarry_0196Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0196) bool {
...
func TestE_nocarry_0196LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0196Halve(t *testing.T) {
...
func TestE_nocarry_0196FromMont(t *testing.T) {
...
type testPaire_nocarry_0196 struct {
	element e_nocarry_0196
	bigint  big.Int
}

func (z *e_nocarry_0196) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0196[3] {
		return true
	}
	if z[3] < qe_nocarry_0196[3] {
		return false
	...
	return z[0] >= qe_nocarry_0196[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0196

		g.element = e_nocarry_0196{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0196[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0196[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0196 {
			var g e_nocarry_0196
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0196[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0196[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0196[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0196[3], carry)
...
func Benchmarke_nocarry_0196InverseNew(b *testing.B) {
	var x e_nocarry_0196
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0196
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0196
		var xInv e_nocarry_0196
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0196
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0196
...
func testLinearComb(t *testing.T, x *e_nocarry_0196, xC int64, y *e_nocarry_0196, yC int64) {
	...
	var z e_nocarry_0196
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0196, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0196
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0196, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0196
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0196, xHi uint64) {
	var res e_nocarry_0196
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0196) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0196) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0196, c int64, result *e_nocarry_0196, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0196) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0196) uint64 {
