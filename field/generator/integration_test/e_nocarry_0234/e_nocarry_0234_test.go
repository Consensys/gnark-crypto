...
var benchRese_nocarry_0234 e_nocarry_0234

func BenchmarkE_nocarry_0234SetBytes(b *testing.B) {
	var x e_nocarry_0234
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0234MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0234.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0234)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0234)
		}
	})
}

func BenchmarkE_nocarry_0234Inverse(b *testing.B) {
	var x e_nocarry_0234
	x.SetRandom()
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0234Butterfly(b *testing.B) {
	var x e_nocarry_0234
	x.SetRandom()
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0234)
	}
}

func BenchmarkE_nocarry_0234Exp(b *testing.B) {
	var x e_nocarry_0234
	x.SetRandom()
	benchRese_nocarry_0234.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0234Double(b *testing.B) {
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Double(&benchRese_nocarry_0234)
	}
}

func BenchmarkE_nocarry_0234Add(b *testing.B) {
	var x e_nocarry_0234
	x.SetRandom()
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Add(&x, &benchRese_nocarry_0234)
	}
}

func BenchmarkE_nocarry_0234Sub(b *testing.B) {
	var x e_nocarry_0234
	x.SetRandom()
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Sub(&x, &benchRese_nocarry_0234)
	}
}

func BenchmarkE_nocarry_0234Neg(b *testing.B) {
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Neg(&benchRese_nocarry_0234)
	}
}

func BenchmarkE_nocarry_0234Div(b *testing.B) {
	var x e_nocarry_0234
	x.SetRandom()
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Div(&x, &benchRese_nocarry_0234)
	}
}

func BenchmarkE_nocarry_0234FromMont(b *testing.B) {
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.FromMont()
	}
}

func BenchmarkE_nocarry_0234ToMont(b *testing.B) {
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.ToMont()
	}
}
func BenchmarkE_nocarry_0234Square(b *testing.B) {
	benchRese_nocarry_0234.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Square(&benchRese_nocarry_0234)
	}
}

func BenchmarkE_nocarry_0234Sqrt(b *testing.B) {
	var a e_nocarry_0234
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0234Mul(b *testing.B) {
	x := e_nocarry_0234{
		5015724763942232464,
		2482705168449803152,
	...
	benchRese_nocarry_0234.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Mul(&benchRese_nocarry_0234, &x)
	}
}

func BenchmarkE_nocarry_0234Cmp(b *testing.B) {
	x := e_nocarry_0234{
		5015724763942232464,
		2482705168449803152,
		12133856693128551501,
	...
	benchRese_nocarry_0234 = x
	benchRese_nocarry_0234[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0234.Cmp(&x)
	}
}

func TestE_nocarry_0234Cmp(t *testing.T) {
	var x, y e_nocarry_0234
...
func TestE_nocarry_0234IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0234
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0234

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0234{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0234
	one.SetOne()
	e.Sub(&qe_nocarry_0234, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0234{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0234{0, uint64(i)})
	}
...
func TestE_nocarry_0234NegZero(t *testing.T) {
	var a, b e_nocarry_0234
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0234Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0234, len(staticTestValues))
...
func TestE_nocarry_0234Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0234) bool {
			var b e_nocarry_0234
...
func TestE_nocarry_0234InverseExp(t *testing.T) {
...
func TestE_nocarry_0234MulByConstants(t *testing.T) {
...
func TestE_nocarry_0234Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0234) bool {
...
func TestE_nocarry_0234LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0234Halve(t *testing.T) {
...
func TestE_nocarry_0234FromMont(t *testing.T) {
...
type testPaire_nocarry_0234 struct {
	element e_nocarry_0234
	bigint  big.Int
}

func (z *e_nocarry_0234) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0234[3] {
		return true
	}
	if z[3] < qe_nocarry_0234[3] {
		return false
	...
	return z[0] >= qe_nocarry_0234[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0234

		g.element = e_nocarry_0234{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0234[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0234[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0234 {
			var g e_nocarry_0234
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0234[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0234[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0234[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0234[3], carry)
...
func Benchmarke_nocarry_0234InverseNew(b *testing.B) {
	var x e_nocarry_0234
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0234
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0234
		var xInv e_nocarry_0234
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0234
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0234
...
func testLinearComb(t *testing.T, x *e_nocarry_0234, xC int64, y *e_nocarry_0234, yC int64) {
	...
	var z e_nocarry_0234
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0234, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0234
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0234, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0234
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0234, xHi uint64) {
	var res e_nocarry_0234
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0234) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0234) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0234, c int64, result *e_nocarry_0234, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0234) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0234) uint64 {
