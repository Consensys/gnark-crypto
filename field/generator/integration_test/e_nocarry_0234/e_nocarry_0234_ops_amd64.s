...
// modulus q
DATA q<>+0(SB)/8, $0xc168b5a3fec31b35
DATA q<>+8(SB)/8, $0x1fdb27cad6fe0f97
DATA q<>+16(SB)/8, $0x51125114df579b82
DATA q<>+24(SB)/8, $0x00000334b00e0f8d
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xf52424aa21ff60e3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xc168b5a3fec31b35, R8
	MOVQ    $0x1fdb27cad6fe0f97, R9
	MOVQ    $0x51125114df579b82, R10
	MOVQ    $0x00000334b00e0f8d, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x1fdb27cad6fe0f97, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x51125114df579b82, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000334b00e0f8d, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xc168b5a3fec31b35, R12
	MOVQ    $0x1fdb27cad6fe0f97, R13
	MOVQ    $0x51125114df579b82, R14
	MOVQ    $0x00000334b00e0f8d, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
