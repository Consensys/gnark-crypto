...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xe8d220a89c1263e1, R12
	ADDQ R12, AX
	MOVQ $0xe3ddb40b1acd7c9c, R12
	ADCQ R12, DX
	MOVQ $0x00d563c8c3d8397b, R12
	ADCQ R12, CX
	MOVQ $0xa37ab1bfe4f8e4c4, R12
	ADCQ R12, BX
	MOVQ $0x1c51be7b620cd9a5, R12
	ADCQ R12, SI
	MOVQ $0x9c256e124f2a7463, R12
	ADCQ R12, DI
	MOVQ $0x35c2cd87f68f7747, R12
	ADCQ R12, R8
	MOVQ $0x2537a64ae7ec1259, R12
	ADCQ R12, R9
	MOVQ $0x0000000000000007, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xe8d220a89c1263e1, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xe3ddb40b1acd7c9c, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x00d563c8c3d8397b, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xa37ab1bfe4f8e4c4, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x1c51be7b620cd9a5, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x9c256e124f2a7463, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x35c2cd87f68f7747, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x2537a64ae7ec1259, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000000000007, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xe8d220a89c1263e1, AX
	ADDQ AX, DX
	MOVQ $0xe3ddb40b1acd7c9c, AX
	ADCQ AX, CX
	MOVQ $0x00d563c8c3d8397b, AX
	ADCQ AX, BX
	MOVQ $0xa37ab1bfe4f8e4c4, AX
	ADCQ AX, SI
	MOVQ $0x1c51be7b620cd9a5, AX
	ADCQ AX, DI
	MOVQ $0x9c256e124f2a7463, AX
	ADCQ AX, R8
	MOVQ $0x35c2cd87f68f7747, AX
	ADCQ AX, R9
	MOVQ $0x2537a64ae7ec1259, AX
	ADCQ AX, R10
