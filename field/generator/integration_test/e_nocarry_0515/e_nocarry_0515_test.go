...
var benchRese_nocarry_0515 e_nocarry_0515

func BenchmarkE_nocarry_0515SetBytes(b *testing.B) {
	var x e_nocarry_0515
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0515MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0515.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0515)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0515)
		}
	})
}

func BenchmarkE_nocarry_0515Inverse(b *testing.B) {
	var x e_nocarry_0515
	x.SetRandom()
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0515Butterfly(b *testing.B) {
	var x e_nocarry_0515
	x.SetRandom()
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0515)
	}
}

func BenchmarkE_nocarry_0515Exp(b *testing.B) {
	var x e_nocarry_0515
	x.SetRandom()
	benchRese_nocarry_0515.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0515Double(b *testing.B) {
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Double(&benchRese_nocarry_0515)
	}
}

func BenchmarkE_nocarry_0515Add(b *testing.B) {
	var x e_nocarry_0515
	x.SetRandom()
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Add(&x, &benchRese_nocarry_0515)
	}
}

func BenchmarkE_nocarry_0515Sub(b *testing.B) {
	var x e_nocarry_0515
	x.SetRandom()
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Sub(&x, &benchRese_nocarry_0515)
	}
}

func BenchmarkE_nocarry_0515Neg(b *testing.B) {
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Neg(&benchRese_nocarry_0515)
	}
}

func BenchmarkE_nocarry_0515Div(b *testing.B) {
	var x e_nocarry_0515
	x.SetRandom()
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Div(&x, &benchRese_nocarry_0515)
	}
}

func BenchmarkE_nocarry_0515FromMont(b *testing.B) {
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.FromMont()
	}
}

func BenchmarkE_nocarry_0515ToMont(b *testing.B) {
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.ToMont()
	}
}
func BenchmarkE_nocarry_0515Square(b *testing.B) {
	benchRese_nocarry_0515.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Square(&benchRese_nocarry_0515)
	}
}

func BenchmarkE_nocarry_0515Sqrt(b *testing.B) {
	var a e_nocarry_0515
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0515Mul(b *testing.B) {
	x := e_nocarry_0515{
	...
	benchRese_nocarry_0515.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Mul(&benchRese_nocarry_0515, &x)
	}
}

func BenchmarkE_nocarry_0515Cmp(b *testing.B) {
	x := e_nocarry_0515{
		14430224811808630124,
		1177964159132134186,
		16515565292898132271,
	...
	benchRese_nocarry_0515 = x
	benchRese_nocarry_0515[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0515.Cmp(&x)
	}
}

func TestE_nocarry_0515Cmp(t *testing.T) {
	var x, y e_nocarry_0515
...
func TestE_nocarry_0515IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0515
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0515

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0515{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0515
	one.SetOne()
	e.Sub(&qe_nocarry_0515, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0515{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0515{0, uint64(i)})
	}
...
func TestE_nocarry_0515NegZero(t *testing.T) {
	var a, b e_nocarry_0515
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0515Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0515, len(staticTestValues))
...
func TestE_nocarry_0515Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0515) bool {
			var b e_nocarry_0515
...
func TestE_nocarry_0515InverseExp(t *testing.T) {
...
func TestE_nocarry_0515MulByConstants(t *testing.T) {
...
func TestE_nocarry_0515Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0515) bool {
...
func TestE_nocarry_0515LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0515Halve(t *testing.T) {
...
func TestE_nocarry_0515FromMont(t *testing.T) {
...
type testPaire_nocarry_0515 struct {
	element e_nocarry_0515
	bigint  big.Int
}

func (z *e_nocarry_0515) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0515[8] {
		return true
	}
	if z[8] < qe_nocarry_0515[8] {
		return false
	...
	return z[0] >= qe_nocarry_0515[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0515

		g.element = e_nocarry_0515{
		...
		if qe_nocarry_0515[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0515[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0515 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0515[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0515[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0515[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0515[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0515[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0515[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0515[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0515[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0515[8], carry)
...
func Benchmarke_nocarry_0515InverseNew(b *testing.B) {
	var x e_nocarry_0515
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0515
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0515
		var xInv e_nocarry_0515
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0515
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0515
...
func testLinearComb(t *testing.T, x *e_nocarry_0515, xC int64, y *e_nocarry_0515, yC int64) {
	...
	var z e_nocarry_0515
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0515, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0515
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0515, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0515
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0515, xHi uint64) {
	var res e_nocarry_0515
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0515) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0515) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0515, c int64, result *e_nocarry_0515, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0515) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0515) uint64 {
