...
var benchRese_nocarry_0624 e_nocarry_0624

func BenchmarkE_nocarry_0624SetBytes(b *testing.B) {
	var x e_nocarry_0624
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0624MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0624.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0624)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0624)
		}
	})
}

func BenchmarkE_nocarry_0624Inverse(b *testing.B) {
	var x e_nocarry_0624
	x.SetRandom()
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0624Butterfly(b *testing.B) {
	var x e_nocarry_0624
	x.SetRandom()
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0624)
	}
}

func BenchmarkE_nocarry_0624Exp(b *testing.B) {
	var x e_nocarry_0624
	x.SetRandom()
	benchRese_nocarry_0624.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0624Double(b *testing.B) {
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Double(&benchRese_nocarry_0624)
	}
}

func BenchmarkE_nocarry_0624Add(b *testing.B) {
	var x e_nocarry_0624
	x.SetRandom()
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Add(&x, &benchRese_nocarry_0624)
	}
}

func BenchmarkE_nocarry_0624Sub(b *testing.B) {
	var x e_nocarry_0624
	x.SetRandom()
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Sub(&x, &benchRese_nocarry_0624)
	}
}

func BenchmarkE_nocarry_0624Neg(b *testing.B) {
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Neg(&benchRese_nocarry_0624)
	}
}

func BenchmarkE_nocarry_0624Div(b *testing.B) {
	var x e_nocarry_0624
	x.SetRandom()
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Div(&x, &benchRese_nocarry_0624)
	}
}

func BenchmarkE_nocarry_0624FromMont(b *testing.B) {
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.FromMont()
	}
}

func BenchmarkE_nocarry_0624ToMont(b *testing.B) {
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.ToMont()
	}
}
func BenchmarkE_nocarry_0624Square(b *testing.B) {
	benchRese_nocarry_0624.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Square(&benchRese_nocarry_0624)
	}
}

func BenchmarkE_nocarry_0624Sqrt(b *testing.B) {
	var a e_nocarry_0624
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0624Mul(b *testing.B) {
	x := e_nocarry_0624{
	...
	benchRese_nocarry_0624.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Mul(&benchRese_nocarry_0624, &x)
	}
}

func BenchmarkE_nocarry_0624Cmp(b *testing.B) {
	x := e_nocarry_0624{
		14306948135225090449,
		6731373927392343083,
		3222380142603101164,
	...
	benchRese_nocarry_0624 = x
	benchRese_nocarry_0624[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0624.Cmp(&x)
	}
}

func TestE_nocarry_0624Cmp(t *testing.T) {
	var x, y e_nocarry_0624
...
func TestE_nocarry_0624IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0624
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0624

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0624{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0624
	one.SetOne()
	e.Sub(&qe_nocarry_0624, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0624{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0624{0, uint64(i)})
	}
...
func TestE_nocarry_0624NegZero(t *testing.T) {
	var a, b e_nocarry_0624
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0624Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0624, len(staticTestValues))
...
func TestE_nocarry_0624Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0624) bool {
			var b e_nocarry_0624
...
func TestE_nocarry_0624InverseExp(t *testing.T) {
...
func TestE_nocarry_0624MulByConstants(t *testing.T) {
...
func TestE_nocarry_0624Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0624) bool {
...
func TestE_nocarry_0624LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0624Halve(t *testing.T) {
...
func TestE_nocarry_0624FromMont(t *testing.T) {
...
type testPaire_nocarry_0624 struct {
	element e_nocarry_0624
	bigint  big.Int
}

func (z *e_nocarry_0624) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0624[9] {
		return true
	}
	if z[9] < qe_nocarry_0624[9] {
		return false
	...
	return z[0] >= qe_nocarry_0624[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0624

		g.element = e_nocarry_0624{
		...
		if qe_nocarry_0624[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0624[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0624 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0624[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0624[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0624[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0624[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0624[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0624[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0624[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0624[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0624[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0624[9], carry)
...
func Benchmarke_nocarry_0624InverseNew(b *testing.B) {
	var x e_nocarry_0624
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0624
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0624
		var xInv e_nocarry_0624
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0624
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0624
...
func testLinearComb(t *testing.T, x *e_nocarry_0624, xC int64, y *e_nocarry_0624, yC int64) {
	...
	var z e_nocarry_0624
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0624, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0624
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0624, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0624
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0624, xHi uint64) {
	var res e_nocarry_0624
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0624) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0624) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0624, c int64, result *e_nocarry_0624, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0624) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0624) uint64 {
