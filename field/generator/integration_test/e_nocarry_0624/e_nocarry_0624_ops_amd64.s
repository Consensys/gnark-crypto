...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x069890808019fce9, R13
	ADDQ R13, AX
	MOVQ $0x4f18b8ce794c8620, R13
	ADCQ R13, DX
	MOVQ $0x5316abf50de1a2d2, R13
	ADCQ R13, CX
	MOVQ $0x839b48efd74be764, R13
	ADCQ R13, BX
	MOVQ $0x6a33abe8056ea47b, R13
	ADCQ R13, SI
	MOVQ $0x80259470ac85c6a6, R13
	ADCQ R13, DI
	MOVQ $0x5d0ff6e32b28c324, R13
	ADCQ R13, R8
	MOVQ $0x41615c972cb43324, R13
	ADCQ R13, R9
	MOVQ $0x3d3142422681289f, R13
	ADCQ R13, R10
	MOVQ $0x0000edee2c503b6f, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x069890808019fce9, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x4f18b8ce794c8620, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x5316abf50de1a2d2, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x839b48efd74be764, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x6a33abe8056ea47b, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x80259470ac85c6a6, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x5d0ff6e32b28c324, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x41615c972cb43324, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x3d3142422681289f, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000edee2c503b6f, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x069890808019fce9, AX
	ADDQ AX, DX
	MOVQ $0x4f18b8ce794c8620, AX
	ADCQ AX, CX
	MOVQ $0x5316abf50de1a2d2, AX
	ADCQ AX, BX
	MOVQ $0x839b48efd74be764, AX
	ADCQ AX, SI
	MOVQ $0x6a33abe8056ea47b, AX
	ADCQ AX, DI
	MOVQ $0x80259470ac85c6a6, AX
	ADCQ AX, R8
	MOVQ $0x5d0ff6e32b28c324, AX
	ADCQ AX, R9
	MOVQ $0x41615c972cb43324, AX
	ADCQ AX, R10
	MOVQ $0x3d3142422681289f, AX
	ADCQ AX, R11
	MOVQ $0x0000edee2c503b6f, AX
	ADCQ AX, R12
