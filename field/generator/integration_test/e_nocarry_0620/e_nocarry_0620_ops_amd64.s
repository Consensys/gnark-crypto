...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x0f9dbf1a05f05183, R13
	ADDQ R13, AX
	MOVQ $0xf741c5b4be3d6178, R13
	ADCQ R13, DX
	MOVQ $0x14997fb9fa7a02a7, R13
	ADCQ R13, CX
	MOVQ $0x31421958c1a4ab28, R13
	ADCQ R13, BX
	MOVQ $0xe77daa9a9cbb7375, R13
	ADCQ R13, SI
	MOVQ $0x94972e0330091160, R13
	ADCQ R13, DI
	MOVQ $0x3aab3e4d6bb37d5d, R13
	ADCQ R13, R8
	MOVQ $0x737bb1aeb5b38164, R13
	ADCQ R13, R9
	MOVQ $0xce32c743df193a24, R13
	ADCQ R13, R10
	MOVQ $0x00000f4da7a0b497, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x0f9dbf1a05f05183, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xf741c5b4be3d6178, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x14997fb9fa7a02a7, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x31421958c1a4ab28, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xe77daa9a9cbb7375, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x94972e0330091160, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x3aab3e4d6bb37d5d, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x737bb1aeb5b38164, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xce32c743df193a24, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000f4da7a0b497, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x0f9dbf1a05f05183, AX
	ADDQ AX, DX
	MOVQ $0xf741c5b4be3d6178, AX
	ADCQ AX, CX
	MOVQ $0x14997fb9fa7a02a7, AX
	ADCQ AX, BX
	MOVQ $0x31421958c1a4ab28, AX
	ADCQ AX, SI
	MOVQ $0xe77daa9a9cbb7375, AX
	ADCQ AX, DI
	MOVQ $0x94972e0330091160, AX
	ADCQ AX, R8
	MOVQ $0x3aab3e4d6bb37d5d, AX
	ADCQ AX, R9
	MOVQ $0x737bb1aeb5b38164, AX
	ADCQ AX, R10
	MOVQ $0xce32c743df193a24, AX
	ADCQ AX, R11
	MOVQ $0x00000f4da7a0b497, AX
	ADCQ AX, R12
