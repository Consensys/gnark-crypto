...
var benchRese_nocarry_0620 e_nocarry_0620

func BenchmarkE_nocarry_0620SetBytes(b *testing.B) {
	var x e_nocarry_0620
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0620MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0620.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0620)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0620)
		}
	})
}

func BenchmarkE_nocarry_0620Inverse(b *testing.B) {
	var x e_nocarry_0620
	x.SetRandom()
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0620Butterfly(b *testing.B) {
	var x e_nocarry_0620
	x.SetRandom()
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0620)
	}
}

func BenchmarkE_nocarry_0620Exp(b *testing.B) {
	var x e_nocarry_0620
	x.SetRandom()
	benchRese_nocarry_0620.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0620Double(b *testing.B) {
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Double(&benchRese_nocarry_0620)
	}
}

func BenchmarkE_nocarry_0620Add(b *testing.B) {
	var x e_nocarry_0620
	x.SetRandom()
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Add(&x, &benchRese_nocarry_0620)
	}
}

func BenchmarkE_nocarry_0620Sub(b *testing.B) {
	var x e_nocarry_0620
	x.SetRandom()
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Sub(&x, &benchRese_nocarry_0620)
	}
}

func BenchmarkE_nocarry_0620Neg(b *testing.B) {
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Neg(&benchRese_nocarry_0620)
	}
}

func BenchmarkE_nocarry_0620Div(b *testing.B) {
	var x e_nocarry_0620
	x.SetRandom()
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Div(&x, &benchRese_nocarry_0620)
	}
}

func BenchmarkE_nocarry_0620FromMont(b *testing.B) {
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.FromMont()
	}
}

func BenchmarkE_nocarry_0620ToMont(b *testing.B) {
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.ToMont()
	}
}
func BenchmarkE_nocarry_0620Square(b *testing.B) {
	benchRese_nocarry_0620.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Square(&benchRese_nocarry_0620)
	}
}

func BenchmarkE_nocarry_0620Sqrt(b *testing.B) {
	var a e_nocarry_0620
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0620Mul(b *testing.B) {
	x := e_nocarry_0620{
		4768596027497004632,
	...
	benchRese_nocarry_0620.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Mul(&benchRese_nocarry_0620, &x)
	}
}

func BenchmarkE_nocarry_0620Cmp(b *testing.B) {
	x := e_nocarry_0620{
		4768596027497004632,
		11203779012294674429,
		4272521257421424785,
	...
	benchRese_nocarry_0620 = x
	benchRese_nocarry_0620[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0620.Cmp(&x)
	}
}

func TestE_nocarry_0620Cmp(t *testing.T) {
	var x, y e_nocarry_0620
...
func TestE_nocarry_0620IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0620
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0620

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0620{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0620
	one.SetOne()
	e.Sub(&qe_nocarry_0620, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0620{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0620{0, uint64(i)})
	}
...
func TestE_nocarry_0620NegZero(t *testing.T) {
	var a, b e_nocarry_0620
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0620Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0620, len(staticTestValues))
...
func TestE_nocarry_0620Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0620) bool {
			var b e_nocarry_0620
...
func TestE_nocarry_0620InverseExp(t *testing.T) {
...
func TestE_nocarry_0620MulByConstants(t *testing.T) {
...
func TestE_nocarry_0620Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0620) bool {
...
func TestE_nocarry_0620LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0620Halve(t *testing.T) {
...
func TestE_nocarry_0620FromMont(t *testing.T) {
...
type testPaire_nocarry_0620 struct {
	element e_nocarry_0620
	bigint  big.Int
}

func (z *e_nocarry_0620) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0620[9] {
		return true
	}
	if z[9] < qe_nocarry_0620[9] {
		return false
	...
	return z[0] >= qe_nocarry_0620[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0620

		g.element = e_nocarry_0620{
		...
		if qe_nocarry_0620[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0620[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0620 {
			var g e_nocarry_0620
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0620[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0620[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0620[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0620[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0620[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0620[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0620[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0620[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0620[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0620[9], carry)
...
func Benchmarke_nocarry_0620InverseNew(b *testing.B) {
	var x e_nocarry_0620
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0620
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0620
		var xInv e_nocarry_0620
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0620
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0620
...
func testLinearComb(t *testing.T, x *e_nocarry_0620, xC int64, y *e_nocarry_0620, yC int64) {
	...
	var z e_nocarry_0620
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0620, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0620
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0620, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0620
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0620, xHi uint64) {
	var res e_nocarry_0620
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0620) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0620) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0620, c int64, result *e_nocarry_0620, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0620) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0620) uint64 {
