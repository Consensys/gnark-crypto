...
var benchRese_cios_0640 e_cios_0640

func BenchmarkE_cios_0640SetBytes(b *testing.B) {
	var x e_cios_0640
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.SetBytes(bb[:])
	}

}

func BenchmarkE_cios_0640MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_cios_0640.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_cios_0640)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_cios_0640)
		}
	})
}

func BenchmarkE_cios_0640Inverse(b *testing.B) {
	var x e_cios_0640
	x.SetRandom()
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Inverse(&x)
	}

}

func BenchmarkE_cios_0640Butterfly(b *testing.B) {
	var x e_cios_0640
	x.SetRandom()
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_cios_0640)
	}
}

func BenchmarkE_cios_0640Exp(b *testing.B) {
	var x e_cios_0640
	x.SetRandom()
	benchRese_cios_0640.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Exp(x, b1)
	}
}

func BenchmarkE_cios_0640Double(b *testing.B) {
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Double(&benchRese_cios_0640)
	}
}

func BenchmarkE_cios_0640Add(b *testing.B) {
	var x e_cios_0640
	x.SetRandom()
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Add(&x, &benchRese_cios_0640)
	}
}

func BenchmarkE_cios_0640Sub(b *testing.B) {
	var x e_cios_0640
	x.SetRandom()
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Sub(&x, &benchRese_cios_0640)
	}
}

func BenchmarkE_cios_0640Neg(b *testing.B) {
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Neg(&benchRese_cios_0640)
	}
}

func BenchmarkE_cios_0640Div(b *testing.B) {
	var x e_cios_0640
	x.SetRandom()
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Div(&x, &benchRese_cios_0640)
	}
}

func BenchmarkE_cios_0640FromMont(b *testing.B) {
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.FromMont()
	}
}

func BenchmarkE_cios_0640ToMont(b *testing.B) {
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.ToMont()
	}
}
func BenchmarkE_cios_0640Square(b *testing.B) {
	benchRese_cios_0640.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Square(&benchRese_cios_0640)
	}
}

func BenchmarkE_cios_0640Sqrt(b *testing.B) {
	var a e_cios_0640
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Sqrt(&a)
	}
}

func BenchmarkE_cios_0640Mul(b *testing.B) {
	x := e_cios_0640{
	...
	benchRese_cios_0640.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Mul(&benchRese_cios_0640, &x)
	}
}

func BenchmarkE_cios_0640Cmp(b *testing.B) {
	x := e_cios_0640{
		12957957768346294627,
		7701145010578911412,
		12764652011610368834,
	...
	benchRese_cios_0640 = x
	benchRese_cios_0640[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_cios_0640.Cmp(&x)
	}
}

func TestE_cios_0640Cmp(t *testing.T) {
	var x, y e_cios_0640
...
func TestE_cios_0640IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_cios_0640
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_cios_0640

func init() {
	staticTestValues = append(staticTestValues, e_cios_0640{}) // zero
	staticTestValues = append(staticTestValues, One())         // one
	staticTestValues = append(staticTestValues, rSquare)       // r^2
	var e, one e_cios_0640
	one.SetOne()
	e.Sub(&qe_cios_0640, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_cios_0640{uint64(i)})
		staticTestValues = append(staticTestValues, e_cios_0640{0, uint64(i)})
	}
...
func TestE_cios_0640NegZero(t *testing.T) {
	var a, b e_cios_0640
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
...
func TestE_cios_0640Reduce(t *testing.T) {
	testValues := make([]e_cios_0640, len(staticTestValues))
...
func TestE_cios_0640Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_cios_0640) bool {
			var b e_cios_0640
...
func TestE_cios_0640InverseExp(t *testing.T) {
...
func TestE_cios_0640MulByConstants(t *testing.T) {
...
func TestE_cios_0640Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_cios_0640) bool {
...
func TestE_cios_0640LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_cios_0640Halve(t *testing.T) {
...
func TestE_cios_0640FromMont(t *testing.T) {
...
type testPaire_cios_0640 struct {
	element e_cios_0640
	bigint  big.Int
}

func (z *e_cios_0640) biggerOrEqualModulus() bool {
	if z[9] > qe_cios_0640[9] {
		return true
	}
	if z[9] < qe_cios_0640[9] {
		return false
	...
	return z[0] >= qe_cios_0640[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_cios_0640

		g.element = e_cios_0640{
		...
		if qe_cios_0640[9] != ^uint64(0) {
			g.element[9] %= (qe_cios_0640[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_cios_0640[0], carry)
		a[1], carry = bits.Add64(a[1], qe_cios_0640[1], carry)
		a[2], carry = bits.Add64(a[2], qe_cios_0640[2], carry)
		a[3], carry = bits.Add64(a[3], qe_cios_0640[3], carry)
		a[4], carry = bits.Add64(a[4], qe_cios_0640[4], carry)
		a[5], carry = bits.Add64(a[5], qe_cios_0640[5], carry)
		a[6], carry = bits.Add64(a[6], qe_cios_0640[6], carry)
		a[7], carry = bits.Add64(a[7], qe_cios_0640[7], carry)
		a[8], carry = bits.Add64(a[8], qe_cios_0640[8], carry)
		a[9], _ = bits.Add64(a[9], qe_cios_0640[9], carry)
