...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x5ef9076e2bb8af9d, R14
	ADDQ R14, AX
	MOVQ $0x234d40c51cdbfe4b, R14
	ADCQ R14, DX
	MOVQ $0xb219da095cd1566e, R14
	ADCQ R14, CX
	MOVQ $0xc1a5cc35f70410df, R14
	ADCQ R14, BX
	MOVQ $0x6532f23fe7bc7c32, R14
	ADCQ R14, SI
	MOVQ $0x8da72ee8cf2ff218, R14
	ADCQ R14, DI
	MOVQ $0x4eee9785a0954310, R14
	ADCQ R14, R8
	MOVQ $0x471bdac9ae72a4cd, R14
	ADCQ R14, R9
	MOVQ $0xf80f145e6929f641, R14
	ADCQ R14, R10
	MOVQ $0xa797138b42ef575a, R14
	ADCQ R14, R11
	MOVQ $0x003b6a0268fead7e, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x5ef9076e2bb8af9d, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x234d40c51cdbfe4b, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xb219da095cd1566e, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xc1a5cc35f70410df, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x6532f23fe7bc7c32, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x8da72ee8cf2ff218, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x4eee9785a0954310, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x471bdac9ae72a4cd, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xf80f145e6929f641, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xa797138b42ef575a, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x003b6a0268fead7e, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x5ef9076e2bb8af9d, AX
	ADDQ AX, DX
	MOVQ $0x234d40c51cdbfe4b, AX
	ADCQ AX, CX
	MOVQ $0xb219da095cd1566e, AX
	ADCQ AX, BX
	MOVQ $0xc1a5cc35f70410df, AX
	ADCQ AX, SI
	MOVQ $0x6532f23fe7bc7c32, AX
	ADCQ AX, DI
	MOVQ $0x8da72ee8cf2ff218, AX
	ADCQ AX, R8
	MOVQ $0x4eee9785a0954310, AX
	ADCQ AX, R9
	MOVQ $0x471bdac9ae72a4cd, AX
	ADCQ AX, R10
	MOVQ $0xf80f145e6929f641, AX
	ADCQ AX, R11
	MOVQ $0xa797138b42ef575a, AX
	ADCQ AX, R12
	MOVQ $0x003b6a0268fead7e, AX
	ADCQ AX, R13
