...
var benchRese_nocarry_0694 e_nocarry_0694

func BenchmarkE_nocarry_0694SetBytes(b *testing.B) {
	var x e_nocarry_0694
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0694MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0694.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0694)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0694)
		}
	})
}

func BenchmarkE_nocarry_0694Inverse(b *testing.B) {
	var x e_nocarry_0694
	x.SetRandom()
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0694Butterfly(b *testing.B) {
	var x e_nocarry_0694
	x.SetRandom()
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0694)
	}
}

func BenchmarkE_nocarry_0694Exp(b *testing.B) {
	var x e_nocarry_0694
	x.SetRandom()
	benchRese_nocarry_0694.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0694Double(b *testing.B) {
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Double(&benchRese_nocarry_0694)
	}
}

func BenchmarkE_nocarry_0694Add(b *testing.B) {
	var x e_nocarry_0694
	x.SetRandom()
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Add(&x, &benchRese_nocarry_0694)
	}
}

func BenchmarkE_nocarry_0694Sub(b *testing.B) {
	var x e_nocarry_0694
	x.SetRandom()
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Sub(&x, &benchRese_nocarry_0694)
	}
}

func BenchmarkE_nocarry_0694Neg(b *testing.B) {
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Neg(&benchRese_nocarry_0694)
	}
}

func BenchmarkE_nocarry_0694Div(b *testing.B) {
	var x e_nocarry_0694
	x.SetRandom()
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Div(&x, &benchRese_nocarry_0694)
	}
}

func BenchmarkE_nocarry_0694FromMont(b *testing.B) {
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.FromMont()
	}
}

func BenchmarkE_nocarry_0694ToMont(b *testing.B) {
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.ToMont()
	}
}
func BenchmarkE_nocarry_0694Square(b *testing.B) {
	benchRese_nocarry_0694.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Square(&benchRese_nocarry_0694)
	}
}

func BenchmarkE_nocarry_0694Sqrt(b *testing.B) {
	var a e_nocarry_0694
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0694Mul(b *testing.B) {
	x := e_nocarry_0694{
	...
	benchRese_nocarry_0694.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Mul(&benchRese_nocarry_0694, &x)
	}
}

func BenchmarkE_nocarry_0694Cmp(b *testing.B) {
	x := e_nocarry_0694{
		13251667591917996465,
		8727318590544715312,
		777054224024679633,
	...
	benchRese_nocarry_0694 = x
	benchRese_nocarry_0694[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0694.Cmp(&x)
	}
}

func TestE_nocarry_0694Cmp(t *testing.T) {
	var x, y e_nocarry_0694
...
func TestE_nocarry_0694IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0694
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0694

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0694{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0694
	one.SetOne()
	e.Sub(&qe_nocarry_0694, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0694{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0694{0, uint64(i)})
	}
...
func TestE_nocarry_0694NegZero(t *testing.T) {
	var a, b e_nocarry_0694
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0694Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0694, len(staticTestValues))
...
func TestE_nocarry_0694Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0694) bool {
			var b e_nocarry_0694
...
func TestE_nocarry_0694InverseExp(t *testing.T) {
...
func TestE_nocarry_0694MulByConstants(t *testing.T) {
...
func TestE_nocarry_0694Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0694) bool {
...
func TestE_nocarry_0694LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0694Halve(t *testing.T) {
...
func TestE_nocarry_0694FromMont(t *testing.T) {
...
type testPaire_nocarry_0694 struct {
	element e_nocarry_0694
	bigint  big.Int
}

func (z *e_nocarry_0694) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0694[10] {
		return true
	}
	if z[10] < qe_nocarry_0694[10] {
		return false
	...
	return z[0] >= qe_nocarry_0694[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0694

		g.element = e_nocarry_0694{
		...
		if qe_nocarry_0694[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0694[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0694 {
			var g e_nocarry_0694
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0694[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0694[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0694[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0694[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0694[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0694[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0694[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0694[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0694[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0694[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0694[10], carry)
...
func Benchmarke_nocarry_0694InverseNew(b *testing.B) {
	var x e_nocarry_0694
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0694
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0694
		var xInv e_nocarry_0694
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0694
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0694
...
func testLinearComb(t *testing.T, x *e_nocarry_0694, xC int64, y *e_nocarry_0694, yC int64) {
	...
	var z e_nocarry_0694
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0694, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0694
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0694, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0694
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0694, xHi uint64) {
	var res e_nocarry_0694
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0694) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0694) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0694, c int64, result *e_nocarry_0694, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0694) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0694) uint64 {
