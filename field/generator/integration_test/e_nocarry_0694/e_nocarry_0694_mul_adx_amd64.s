...
// modulus q
DATA q<>+0(SB)/8, $0x5ef9076e2bb8af9d
DATA q<>+8(SB)/8, $0x234d40c51cdbfe4b
DATA q<>+16(SB)/8, $0xb219da095cd1566e
DATA q<>+24(SB)/8, $0xc1a5cc35f70410df
DATA q<>+32(SB)/8, $0x6532f23fe7bc7c32
DATA q<>+40(SB)/8, $0x8da72ee8cf2ff218
DATA q<>+48(SB)/8, $0x4eee9785a0954310
DATA q<>+56(SB)/8, $0x471bdac9ae72a4cd
DATA q<>+64(SB)/8, $0xf80f145e6929f641
DATA q<>+72(SB)/8, $0xa797138b42ef575a
DATA q<>+80(SB)/8, $0x003b6a0268fead7e
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xfff67f28fe8db14b
