...
var benchRese_nocarry_0591 e_nocarry_0591

func BenchmarkE_nocarry_0591SetBytes(b *testing.B) {
	var x e_nocarry_0591
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0591MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0591.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0591)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0591)
		}
	})
}

func BenchmarkE_nocarry_0591Inverse(b *testing.B) {
	var x e_nocarry_0591
	x.SetRandom()
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0591Butterfly(b *testing.B) {
	var x e_nocarry_0591
	x.SetRandom()
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0591)
	}
}

func BenchmarkE_nocarry_0591Exp(b *testing.B) {
	var x e_nocarry_0591
	x.SetRandom()
	benchRese_nocarry_0591.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0591Double(b *testing.B) {
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Double(&benchRese_nocarry_0591)
	}
}

func BenchmarkE_nocarry_0591Add(b *testing.B) {
	var x e_nocarry_0591
	x.SetRandom()
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Add(&x, &benchRese_nocarry_0591)
	}
}

func BenchmarkE_nocarry_0591Sub(b *testing.B) {
	var x e_nocarry_0591
	x.SetRandom()
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Sub(&x, &benchRese_nocarry_0591)
	}
}

func BenchmarkE_nocarry_0591Neg(b *testing.B) {
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Neg(&benchRese_nocarry_0591)
	}
}

func BenchmarkE_nocarry_0591Div(b *testing.B) {
	var x e_nocarry_0591
	x.SetRandom()
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Div(&x, &benchRese_nocarry_0591)
	}
}

func BenchmarkE_nocarry_0591FromMont(b *testing.B) {
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.FromMont()
	}
}

func BenchmarkE_nocarry_0591ToMont(b *testing.B) {
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.ToMont()
	}
}
func BenchmarkE_nocarry_0591Square(b *testing.B) {
	benchRese_nocarry_0591.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Square(&benchRese_nocarry_0591)
	}
}

func BenchmarkE_nocarry_0591Sqrt(b *testing.B) {
	var a e_nocarry_0591
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0591Mul(b *testing.B) {
	x := e_nocarry_0591{
	...
	benchRese_nocarry_0591.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Mul(&benchRese_nocarry_0591, &x)
	}
}

func BenchmarkE_nocarry_0591Cmp(b *testing.B) {
	x := e_nocarry_0591{
		12744413481149165891,
		15175585976594823588,
		4524922638831353789,
	...
	benchRese_nocarry_0591 = x
	benchRese_nocarry_0591[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0591.Cmp(&x)
	}
}

func TestE_nocarry_0591Cmp(t *testing.T) {
	var x, y e_nocarry_0591
...
func TestE_nocarry_0591IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0591
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0591

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0591{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0591
	one.SetOne()
	e.Sub(&qe_nocarry_0591, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0591{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0591{0, uint64(i)})
	}
...
func TestE_nocarry_0591NegZero(t *testing.T) {
	var a, b e_nocarry_0591
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0591Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0591, len(staticTestValues))
...
func TestE_nocarry_0591Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0591) bool {
			var b e_nocarry_0591
...
func TestE_nocarry_0591InverseExp(t *testing.T) {
...
func TestE_nocarry_0591MulByConstants(t *testing.T) {
...
func TestE_nocarry_0591Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0591) bool {
...
func TestE_nocarry_0591LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0591Halve(t *testing.T) {
...
func TestE_nocarry_0591FromMont(t *testing.T) {
...
type testPaire_nocarry_0591 struct {
	element e_nocarry_0591
	bigint  big.Int
}

func (z *e_nocarry_0591) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0591[9] {
		return true
	}
	if z[9] < qe_nocarry_0591[9] {
		return false
	...
	return z[0] >= qe_nocarry_0591[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0591

		g.element = e_nocarry_0591{
		...
		if qe_nocarry_0591[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0591[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0591 {
			var g e_nocarry_0591
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0591[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0591[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0591[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0591[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0591[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0591[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0591[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0591[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0591[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0591[9], carry)
...
func Benchmarke_nocarry_0591InverseNew(b *testing.B) {
	var x e_nocarry_0591
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0591
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0591
		var xInv e_nocarry_0591
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0591
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0591
...
func testLinearComb(t *testing.T, x *e_nocarry_0591, xC int64, y *e_nocarry_0591, yC int64) {
	...
	var z e_nocarry_0591
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0591, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0591
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0591, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0591
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0591, xHi uint64) {
	var res e_nocarry_0591
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0591) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0591) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0591, c int64, result *e_nocarry_0591, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0591) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0591) uint64 {
