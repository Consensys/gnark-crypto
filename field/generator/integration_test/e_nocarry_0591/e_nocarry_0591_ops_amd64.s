...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xe0c8aa8d53257b3d, R13
	ADDQ R13, AX
	MOVQ $0xb3b49515dfbe2cd7, R13
	ADCQ R13, DX
	MOVQ $0xf4c9377460c532cd, R13
	ADCQ R13, CX
	MOVQ $0x03fc96d3f878d1b8, R13
	ADCQ R13, BX
	MOVQ $0xf0734df4e9b17b52, R13
	ADCQ R13, SI
	MOVQ $0x3f946ca8dc64a97c, R13
	ADCQ R13, DI
	MOVQ $0x9c5e9fe5a8ae7e69, R13
	ADCQ R13, R8
	MOVQ $0x845745022db542b5, R13
	ADCQ R13, R9
	MOVQ $0xf9ff698861bb8214, R13
	ADCQ R13, R10
	MOVQ $0x000000000000775d, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xe0c8aa8d53257b3d, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xb3b49515dfbe2cd7, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xf4c9377460c532cd, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x03fc96d3f878d1b8, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xf0734df4e9b17b52, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x3f946ca8dc64a97c, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x9c5e9fe5a8ae7e69, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x845745022db542b5, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xf9ff698861bb8214, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000000000775d, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xe0c8aa8d53257b3d, AX
	ADDQ AX, DX
	MOVQ $0xb3b49515dfbe2cd7, AX
	ADCQ AX, CX
	MOVQ $0xf4c9377460c532cd, AX
	ADCQ AX, BX
	MOVQ $0x03fc96d3f878d1b8, AX
	ADCQ AX, SI
	MOVQ $0xf0734df4e9b17b52, AX
	ADCQ AX, DI
	MOVQ $0x3f946ca8dc64a97c, AX
	ADCQ AX, R8
	MOVQ $0x9c5e9fe5a8ae7e69, AX
	ADCQ AX, R9
	MOVQ $0x845745022db542b5, AX
	ADCQ AX, R10
	MOVQ $0xf9ff698861bb8214, AX
	ADCQ AX, R11
	MOVQ $0x000000000000775d, AX
	ADCQ AX, R12
