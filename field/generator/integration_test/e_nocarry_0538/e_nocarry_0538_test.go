...
var benchRese_nocarry_0538 e_nocarry_0538

func BenchmarkE_nocarry_0538SetBytes(b *testing.B) {
	var x e_nocarry_0538
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0538MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0538.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0538)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0538)
		}
	})
}

func BenchmarkE_nocarry_0538Inverse(b *testing.B) {
	var x e_nocarry_0538
	x.SetRandom()
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0538Butterfly(b *testing.B) {
	var x e_nocarry_0538
	x.SetRandom()
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0538)
	}
}

func BenchmarkE_nocarry_0538Exp(b *testing.B) {
	var x e_nocarry_0538
	x.SetRandom()
	benchRese_nocarry_0538.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0538Double(b *testing.B) {
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Double(&benchRese_nocarry_0538)
	}
}

func BenchmarkE_nocarry_0538Add(b *testing.B) {
	var x e_nocarry_0538
	x.SetRandom()
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Add(&x, &benchRese_nocarry_0538)
	}
}

func BenchmarkE_nocarry_0538Sub(b *testing.B) {
	var x e_nocarry_0538
	x.SetRandom()
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Sub(&x, &benchRese_nocarry_0538)
	}
}

func BenchmarkE_nocarry_0538Neg(b *testing.B) {
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Neg(&benchRese_nocarry_0538)
	}
}

func BenchmarkE_nocarry_0538Div(b *testing.B) {
	var x e_nocarry_0538
	x.SetRandom()
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Div(&x, &benchRese_nocarry_0538)
	}
}

func BenchmarkE_nocarry_0538FromMont(b *testing.B) {
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.FromMont()
	}
}

func BenchmarkE_nocarry_0538ToMont(b *testing.B) {
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.ToMont()
	}
}
func BenchmarkE_nocarry_0538Square(b *testing.B) {
	benchRese_nocarry_0538.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Square(&benchRese_nocarry_0538)
	}
}

func BenchmarkE_nocarry_0538Sqrt(b *testing.B) {
	var a e_nocarry_0538
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0538Mul(b *testing.B) {
	x := e_nocarry_0538{
		4948905758978826639,
		2874807252254369818,
		5414962956229900869,
	...
	benchRese_nocarry_0538.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Mul(&benchRese_nocarry_0538, &x)
	}
}

func BenchmarkE_nocarry_0538Cmp(b *testing.B) {
	x := e_nocarry_0538{
		4948905758978826639,
		2874807252254369818,
		5414962956229900869,
	...
	benchRese_nocarry_0538 = x
	benchRese_nocarry_0538[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0538.Cmp(&x)
	}
}

func TestE_nocarry_0538Cmp(t *testing.T) {
	var x, y e_nocarry_0538
...
func TestE_nocarry_0538IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0538
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0538

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0538{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0538
	one.SetOne()
	e.Sub(&qe_nocarry_0538, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0538{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0538{0, uint64(i)})
	}
...
func TestE_nocarry_0538NegZero(t *testing.T) {
	var a, b e_nocarry_0538
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0538Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0538, len(staticTestValues))
...
func TestE_nocarry_0538Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0538) bool {
			var b e_nocarry_0538
...
func TestE_nocarry_0538InverseExp(t *testing.T) {
...
func TestE_nocarry_0538MulByConstants(t *testing.T) {
...
func TestE_nocarry_0538Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0538) bool {
...
func TestE_nocarry_0538LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0538Halve(t *testing.T) {
...
func TestE_nocarry_0538FromMont(t *testing.T) {
...
type testPaire_nocarry_0538 struct {
	element e_nocarry_0538
	bigint  big.Int
}

func (z *e_nocarry_0538) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0538[8] {
		return true
	}
	if z[8] < qe_nocarry_0538[8] {
		return false
	...
	return z[0] >= qe_nocarry_0538[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0538

		g.element = e_nocarry_0538{
		...
		if qe_nocarry_0538[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0538[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0538 {
			var g e_nocarry_0538
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0538[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0538[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0538[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0538[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0538[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0538[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0538[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0538[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0538[8], carry)
...
func Benchmarke_nocarry_0538InverseNew(b *testing.B) {
	var x e_nocarry_0538
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0538
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0538
		var xInv e_nocarry_0538
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0538
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0538
...
func testLinearComb(t *testing.T, x *e_nocarry_0538, xC int64, y *e_nocarry_0538, yC int64) {
	...
	var z e_nocarry_0538
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0538, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0538
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0538, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0538
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0538, xHi uint64) {
	var res e_nocarry_0538
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0538) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0538) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0538, c int64, result *e_nocarry_0538, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0538) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0538) uint64 {
