...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x850057360fff183b, R12
	ADDQ R12, AX
	MOVQ $0x59fdaa1aea09fc29, R12
	ADCQ R12, DX
	MOVQ $0xcd975ed701028f78, R12
	ADCQ R12, CX
	MOVQ $0x69d075894608993b, R12
	ADCQ R12, BX
	MOVQ $0xeb264444bff9b309, R12
	ADCQ R12, SI
	MOVQ $0xb299130848e91daf, R12
	ADCQ R12, DI
	MOVQ $0x6431f79cbbddef47, R12
	ADCQ R12, R8
	MOVQ $0x729491aeb229b4f3, R12
	ADCQ R12, R9
	MOVQ $0x0000000003812acb, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x850057360fff183b, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x59fdaa1aea09fc29, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xcd975ed701028f78, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x69d075894608993b, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xeb264444bff9b309, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xb299130848e91daf, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x6431f79cbbddef47, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x729491aeb229b4f3, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000003812acb, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x850057360fff183b, AX
	ADDQ AX, DX
	MOVQ $0x59fdaa1aea09fc29, AX
	ADCQ AX, CX
	MOVQ $0xcd975ed701028f78, AX
	ADCQ AX, BX
	MOVQ $0x69d075894608993b, AX
	ADCQ AX, SI
	MOVQ $0xeb264444bff9b309, AX
	ADCQ AX, DI
	MOVQ $0xb299130848e91daf, AX
	ADCQ AX, R8
	MOVQ $0x6431f79cbbddef47, AX
	ADCQ AX, R9
	MOVQ $0x729491aeb229b4f3, AX
	ADCQ AX, R10
	MOVQ $0x0000000003812acb, AX
	ADCQ AX, R11
