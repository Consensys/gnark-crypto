...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xa889f47b55538159, R14
	ADDQ R14, AX
	MOVQ $0x53f9a15d4c1fe900, R14
	ADCQ R14, DX
	MOVQ $0x0c80afa1a526b52d, R14
	ADCQ R14, CX
	MOVQ $0x5d35f78bac38398d, R14
	ADCQ R14, BX
	MOVQ $0x8b217e6dda317262, R14
	ADCQ R14, SI
	MOVQ $0x96d4127038f12ecf, R14
	ADCQ R14, DI
	MOVQ $0xc394c9efbcbe1a71, R14
	ADCQ R14, R8
	MOVQ $0x76ddbbcdafa937ef, R14
	ADCQ R14, R9
	MOVQ $0xdac36ffb6944841a, R14
	ADCQ R14, R10
	MOVQ $0x714a78ec25c4baae, R14
	ADCQ R14, R11
	MOVQ $0x00000000000356b0, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xa889f47b55538159, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x53f9a15d4c1fe900, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x0c80afa1a526b52d, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x5d35f78bac38398d, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x8b217e6dda317262, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x96d4127038f12ecf, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xc394c9efbcbe1a71, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x76ddbbcdafa937ef, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xdac36ffb6944841a, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x714a78ec25c4baae, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000000356b0, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xa889f47b55538159, AX
	ADDQ AX, DX
	MOVQ $0x53f9a15d4c1fe900, AX
	ADCQ AX, CX
	MOVQ $0x0c80afa1a526b52d, AX
	ADCQ AX, BX
	MOVQ $0x5d35f78bac38398d, AX
	ADCQ AX, SI
	MOVQ $0x8b217e6dda317262, AX
	ADCQ AX, DI
	MOVQ $0x96d4127038f12ecf, AX
	ADCQ AX, R8
	MOVQ $0xc394c9efbcbe1a71, AX
	ADCQ AX, R9
	MOVQ $0x76ddbbcdafa937ef, AX
	ADCQ AX, R10
	MOVQ $0xdac36ffb6944841a, AX
	ADCQ AX, R11
	MOVQ $0x714a78ec25c4baae, AX
	ADCQ AX, R12
	MOVQ $0x00000000000356b0, AX
	ADCQ AX, R13
