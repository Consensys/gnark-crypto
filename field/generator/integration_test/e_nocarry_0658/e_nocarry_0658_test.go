...
var benchRese_nocarry_0658 e_nocarry_0658

func BenchmarkE_nocarry_0658SetBytes(b *testing.B) {
	var x e_nocarry_0658
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0658MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0658.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0658)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0658)
		}
	})
}

func BenchmarkE_nocarry_0658Inverse(b *testing.B) {
	var x e_nocarry_0658
	x.SetRandom()
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0658Butterfly(b *testing.B) {
	var x e_nocarry_0658
	x.SetRandom()
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0658)
	}
}

func BenchmarkE_nocarry_0658Exp(b *testing.B) {
	var x e_nocarry_0658
	x.SetRandom()
	benchRese_nocarry_0658.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0658Double(b *testing.B) {
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Double(&benchRese_nocarry_0658)
	}
}

func BenchmarkE_nocarry_0658Add(b *testing.B) {
	var x e_nocarry_0658
	x.SetRandom()
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Add(&x, &benchRese_nocarry_0658)
	}
}

func BenchmarkE_nocarry_0658Sub(b *testing.B) {
	var x e_nocarry_0658
	x.SetRandom()
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Sub(&x, &benchRese_nocarry_0658)
	}
}

func BenchmarkE_nocarry_0658Neg(b *testing.B) {
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Neg(&benchRese_nocarry_0658)
	}
}

func BenchmarkE_nocarry_0658Div(b *testing.B) {
	var x e_nocarry_0658
	x.SetRandom()
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Div(&x, &benchRese_nocarry_0658)
	}
}

func BenchmarkE_nocarry_0658FromMont(b *testing.B) {
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.FromMont()
	}
}

func BenchmarkE_nocarry_0658ToMont(b *testing.B) {
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.ToMont()
	}
}
func BenchmarkE_nocarry_0658Square(b *testing.B) {
	benchRese_nocarry_0658.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Square(&benchRese_nocarry_0658)
	}
}

func BenchmarkE_nocarry_0658Sqrt(b *testing.B) {
	var a e_nocarry_0658
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0658Mul(b *testing.B) {
	x := e_nocarry_0658{
		425258866710832311,
	...
	benchRese_nocarry_0658.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Mul(&benchRese_nocarry_0658, &x)
	}
}

func BenchmarkE_nocarry_0658Cmp(b *testing.B) {
	x := e_nocarry_0658{
		425258866710832311,
		16245699638024751318,
		4596574762941092565,
	...
	benchRese_nocarry_0658 = x
	benchRese_nocarry_0658[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0658.Cmp(&x)
	}
}

func TestE_nocarry_0658Cmp(t *testing.T) {
	var x, y e_nocarry_0658
...
func TestE_nocarry_0658IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0658
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0658

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0658{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0658
	one.SetOne()
	e.Sub(&qe_nocarry_0658, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0658{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0658{0, uint64(i)})
	}
...
func TestE_nocarry_0658NegZero(t *testing.T) {
	var a, b e_nocarry_0658
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0658Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0658, len(staticTestValues))
...
func TestE_nocarry_0658Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0658) bool {
			var b e_nocarry_0658
...
func TestE_nocarry_0658InverseExp(t *testing.T) {
...
func TestE_nocarry_0658MulByConstants(t *testing.T) {
...
func TestE_nocarry_0658Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0658) bool {
...
func TestE_nocarry_0658LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0658Halve(t *testing.T) {
...
func TestE_nocarry_0658FromMont(t *testing.T) {
...
type testPaire_nocarry_0658 struct {
	element e_nocarry_0658
	bigint  big.Int
}

func (z *e_nocarry_0658) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0658[10] {
		return true
	}
	if z[10] < qe_nocarry_0658[10] {
		return false
	...
	return z[0] >= qe_nocarry_0658[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0658

		g.element = e_nocarry_0658{
		...
		if qe_nocarry_0658[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0658[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0658 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0658[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0658[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0658[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0658[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0658[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0658[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0658[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0658[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0658[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0658[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0658[10], carry)
...
func Benchmarke_nocarry_0658InverseNew(b *testing.B) {
	var x e_nocarry_0658
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0658
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0658
		var xInv e_nocarry_0658
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0658
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0658
...
func testLinearComb(t *testing.T, x *e_nocarry_0658, xC int64, y *e_nocarry_0658, yC int64) {
	...
	var z e_nocarry_0658
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0658, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0658
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0658, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0658
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0658, xHi uint64) {
	var res e_nocarry_0658
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0658) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0658) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0658, c int64, result *e_nocarry_0658, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0658) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0658) uint64 {
