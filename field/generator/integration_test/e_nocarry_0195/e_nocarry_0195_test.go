...
var benchRese_nocarry_0195 e_nocarry_0195

func BenchmarkE_nocarry_0195SetBytes(b *testing.B) {
	var x e_nocarry_0195
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0195MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0195.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0195)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0195)
		}
	})
}

func BenchmarkE_nocarry_0195Inverse(b *testing.B) {
	var x e_nocarry_0195
	x.SetRandom()
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0195Butterfly(b *testing.B) {
	var x e_nocarry_0195
	x.SetRandom()
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0195)
	}
}

func BenchmarkE_nocarry_0195Exp(b *testing.B) {
	var x e_nocarry_0195
	x.SetRandom()
	benchRese_nocarry_0195.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0195Double(b *testing.B) {
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Double(&benchRese_nocarry_0195)
	}
}

func BenchmarkE_nocarry_0195Add(b *testing.B) {
	var x e_nocarry_0195
	x.SetRandom()
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Add(&x, &benchRese_nocarry_0195)
	}
}

func BenchmarkE_nocarry_0195Sub(b *testing.B) {
	var x e_nocarry_0195
	x.SetRandom()
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Sub(&x, &benchRese_nocarry_0195)
	}
}

func BenchmarkE_nocarry_0195Neg(b *testing.B) {
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Neg(&benchRese_nocarry_0195)
	}
}

func BenchmarkE_nocarry_0195Div(b *testing.B) {
	var x e_nocarry_0195
	x.SetRandom()
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Div(&x, &benchRese_nocarry_0195)
	}
}

func BenchmarkE_nocarry_0195FromMont(b *testing.B) {
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.FromMont()
	}
}

func BenchmarkE_nocarry_0195ToMont(b *testing.B) {
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.ToMont()
	}
}
func BenchmarkE_nocarry_0195Square(b *testing.B) {
	benchRese_nocarry_0195.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Square(&benchRese_nocarry_0195)
	}
}

func BenchmarkE_nocarry_0195Sqrt(b *testing.B) {
	var a e_nocarry_0195
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0195Mul(b *testing.B) {
	x := e_nocarry_0195{
		7281691451409303107,
	...
	benchRese_nocarry_0195.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Mul(&benchRese_nocarry_0195, &x)
	}
}

func BenchmarkE_nocarry_0195Cmp(b *testing.B) {
	x := e_nocarry_0195{
		7281691451409303107,
		10247668520768156731,
		3322592860082066949,
	...
	benchRese_nocarry_0195 = x
	benchRese_nocarry_0195[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0195.Cmp(&x)
	}
}

func TestE_nocarry_0195Cmp(t *testing.T) {
	var x, y e_nocarry_0195
...
func TestE_nocarry_0195IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0195
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0195

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0195{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0195
	one.SetOne()
	e.Sub(&qe_nocarry_0195, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0195{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0195{0, uint64(i)})
	}
...
func TestE_nocarry_0195NegZero(t *testing.T) {
	var a, b e_nocarry_0195
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0195Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0195, len(staticTestValues))
...
func TestE_nocarry_0195Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0195) bool {
			var b e_nocarry_0195
...
func TestE_nocarry_0195InverseExp(t *testing.T) {
...
func TestE_nocarry_0195MulByConstants(t *testing.T) {
...
func TestE_nocarry_0195Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0195) bool {
...
func TestE_nocarry_0195LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0195Halve(t *testing.T) {
...
func TestE_nocarry_0195FromMont(t *testing.T) {
...
type testPaire_nocarry_0195 struct {
	element e_nocarry_0195
	bigint  big.Int
}

func (z *e_nocarry_0195) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0195[3] {
		return true
	}
	if z[3] < qe_nocarry_0195[3] {
		return false
	...
	return z[0] >= qe_nocarry_0195[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0195

		g.element = e_nocarry_0195{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0195[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0195[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0195 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0195[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0195[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0195[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0195[3], carry)
...
func Benchmarke_nocarry_0195InverseNew(b *testing.B) {
	var x e_nocarry_0195
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0195
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0195
		var xInv e_nocarry_0195
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0195
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0195
...
func testLinearComb(t *testing.T, x *e_nocarry_0195, xC int64, y *e_nocarry_0195, yC int64) {
	...
	var z e_nocarry_0195
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0195, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0195
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0195, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0195
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0195, xHi uint64) {
	var res e_nocarry_0195
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0195) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0195) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0195, c int64, result *e_nocarry_0195, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0195) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0195) uint64 {
