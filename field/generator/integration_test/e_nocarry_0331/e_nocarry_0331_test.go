...
var benchRese_nocarry_0331 e_nocarry_0331

func BenchmarkE_nocarry_0331SetBytes(b *testing.B) {
	var x e_nocarry_0331
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0331MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0331.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0331)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0331)
		}
	})
}

func BenchmarkE_nocarry_0331Inverse(b *testing.B) {
	var x e_nocarry_0331
	x.SetRandom()
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0331Butterfly(b *testing.B) {
	var x e_nocarry_0331
	x.SetRandom()
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0331)
	}
}

func BenchmarkE_nocarry_0331Exp(b *testing.B) {
	var x e_nocarry_0331
	x.SetRandom()
	benchRese_nocarry_0331.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0331Double(b *testing.B) {
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Double(&benchRese_nocarry_0331)
	}
}

func BenchmarkE_nocarry_0331Add(b *testing.B) {
	var x e_nocarry_0331
	x.SetRandom()
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Add(&x, &benchRese_nocarry_0331)
	}
}

func BenchmarkE_nocarry_0331Sub(b *testing.B) {
	var x e_nocarry_0331
	x.SetRandom()
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Sub(&x, &benchRese_nocarry_0331)
	}
}

func BenchmarkE_nocarry_0331Neg(b *testing.B) {
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Neg(&benchRese_nocarry_0331)
	}
}

func BenchmarkE_nocarry_0331Div(b *testing.B) {
	var x e_nocarry_0331
	x.SetRandom()
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Div(&x, &benchRese_nocarry_0331)
	}
}

func BenchmarkE_nocarry_0331FromMont(b *testing.B) {
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.FromMont()
	}
}

func BenchmarkE_nocarry_0331ToMont(b *testing.B) {
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.ToMont()
	}
}
func BenchmarkE_nocarry_0331Square(b *testing.B) {
	benchRese_nocarry_0331.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Square(&benchRese_nocarry_0331)
	}
}

func BenchmarkE_nocarry_0331Sqrt(b *testing.B) {
	var a e_nocarry_0331
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0331Mul(b *testing.B) {
	x := e_nocarry_0331{
	...
	benchRese_nocarry_0331.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Mul(&benchRese_nocarry_0331, &x)
	}
}

func BenchmarkE_nocarry_0331Cmp(b *testing.B) {
	x := e_nocarry_0331{
		14983744118492429610,
		2822409780703100245,
		2257909071724931367,
	...
	benchRese_nocarry_0331 = x
	benchRese_nocarry_0331[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0331.Cmp(&x)
	}
}

func TestE_nocarry_0331Cmp(t *testing.T) {
	var x, y e_nocarry_0331
...
func TestE_nocarry_0331IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0331
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0331

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0331{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0331
	one.SetOne()
	e.Sub(&qe_nocarry_0331, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0331{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0331{0, uint64(i)})
	}
...
func TestE_nocarry_0331NegZero(t *testing.T) {
	var a, b e_nocarry_0331
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0331Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0331, len(staticTestValues))
...
func TestE_nocarry_0331Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0331) bool {
			var b e_nocarry_0331
...
func TestE_nocarry_0331InverseExp(t *testing.T) {
...
func TestE_nocarry_0331MulByConstants(t *testing.T) {
...
func TestE_nocarry_0331Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0331) bool {
...
func TestE_nocarry_0331LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0331Halve(t *testing.T) {
...
func TestE_nocarry_0331FromMont(t *testing.T) {
...
type testPaire_nocarry_0331 struct {
	element e_nocarry_0331
	bigint  big.Int
}

func (z *e_nocarry_0331) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0331[5] {
		return true
	}
	if z[5] < qe_nocarry_0331[5] {
		return false
	...
	return z[0] >= qe_nocarry_0331[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0331

		g.element = e_nocarry_0331{
		...
		if qe_nocarry_0331[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0331[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0331 {
			var g e_nocarry_0331
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0331[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0331[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0331[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0331[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0331[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0331[5], carry)
...
func Benchmarke_nocarry_0331InverseNew(b *testing.B) {
	var x e_nocarry_0331
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0331
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0331
		var xInv e_nocarry_0331
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0331
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0331
...
func testLinearComb(t *testing.T, x *e_nocarry_0331, xC int64, y *e_nocarry_0331, yC int64) {
	...
	var z e_nocarry_0331
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0331, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0331
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0331, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0331
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0331, xHi uint64) {
	var res e_nocarry_0331
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0331) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0331) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0331, c int64, result *e_nocarry_0331, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0331) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0331) uint64 {
