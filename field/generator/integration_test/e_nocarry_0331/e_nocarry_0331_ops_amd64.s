...
// modulus q
DATA q<>+0(SB)/8, $0x22d251086a89e29d
DATA q<>+8(SB)/8, $0xfd7c3dea29c2ff60
DATA q<>+16(SB)/8, $0x5cfdbcee84259f97
DATA q<>+24(SB)/8, $0x875c1f788e6e6698
DATA q<>+32(SB)/8, $0x89e223b39c65a7f8
DATA q<>+40(SB)/8, $0x00000000000006de
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x854d947219644c4b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x22d251086a89e29d, R10
	MOVQ    $0xfd7c3dea29c2ff60, R11
	MOVQ    $0x5cfdbcee84259f97, R12
	MOVQ    $0x875c1f788e6e6698, R13
	MOVQ    $0x89e223b39c65a7f8, R14
	MOVQ    $0x00000000000006de, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xfd7c3dea29c2ff60, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x5cfdbcee84259f97, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x875c1f788e6e6698, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x89e223b39c65a7f8, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000000000006de, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x22d251086a89e29d, CX
	MOVQ    $0xfd7c3dea29c2ff60, BX
	MOVQ    $0x5cfdbcee84259f97, SI
	MOVQ    $0x875c1f788e6e6698, DI
	MOVQ    $0x89e223b39c65a7f8, R8
	MOVQ    $0x00000000000006de, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
