...
var benchRese_nocarry_0463 e_nocarry_0463

func BenchmarkE_nocarry_0463SetBytes(b *testing.B) {
	var x e_nocarry_0463
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0463MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0463.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0463)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0463)
		}
	})
}

func BenchmarkE_nocarry_0463Inverse(b *testing.B) {
	var x e_nocarry_0463
	x.SetRandom()
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0463Butterfly(b *testing.B) {
	var x e_nocarry_0463
	x.SetRandom()
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0463)
	}
}

func BenchmarkE_nocarry_0463Exp(b *testing.B) {
	var x e_nocarry_0463
	x.SetRandom()
	benchRese_nocarry_0463.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0463Double(b *testing.B) {
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Double(&benchRese_nocarry_0463)
	}
}

func BenchmarkE_nocarry_0463Add(b *testing.B) {
	var x e_nocarry_0463
	x.SetRandom()
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Add(&x, &benchRese_nocarry_0463)
	}
}

func BenchmarkE_nocarry_0463Sub(b *testing.B) {
	var x e_nocarry_0463
	x.SetRandom()
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Sub(&x, &benchRese_nocarry_0463)
	}
}

func BenchmarkE_nocarry_0463Neg(b *testing.B) {
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Neg(&benchRese_nocarry_0463)
	}
}

func BenchmarkE_nocarry_0463Div(b *testing.B) {
	var x e_nocarry_0463
	x.SetRandom()
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Div(&x, &benchRese_nocarry_0463)
	}
}

func BenchmarkE_nocarry_0463FromMont(b *testing.B) {
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.FromMont()
	}
}

func BenchmarkE_nocarry_0463ToMont(b *testing.B) {
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.ToMont()
	}
}
func BenchmarkE_nocarry_0463Square(b *testing.B) {
	benchRese_nocarry_0463.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Square(&benchRese_nocarry_0463)
	}
}

func BenchmarkE_nocarry_0463Sqrt(b *testing.B) {
	var a e_nocarry_0463
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0463Mul(b *testing.B) {
	x := e_nocarry_0463{
	...
	benchRese_nocarry_0463.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Mul(&benchRese_nocarry_0463, &x)
	}
}

func BenchmarkE_nocarry_0463Cmp(b *testing.B) {
	x := e_nocarry_0463{
		11149125580523521555,
		17672876550090392208,
		1042111508399228426,
	...
	benchRese_nocarry_0463 = x
	benchRese_nocarry_0463[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0463.Cmp(&x)
	}
}

func TestE_nocarry_0463Cmp(t *testing.T) {
	var x, y e_nocarry_0463
...
func TestE_nocarry_0463IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0463
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0463

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0463{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0463
	one.SetOne()
	e.Sub(&qe_nocarry_0463, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0463{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0463{0, uint64(i)})
	}
...
func TestE_nocarry_0463NegZero(t *testing.T) {
	var a, b e_nocarry_0463
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0463Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0463, len(staticTestValues))
...
func TestE_nocarry_0463Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0463) bool {
			var b e_nocarry_0463
...
func TestE_nocarry_0463InverseExp(t *testing.T) {
...
func TestE_nocarry_0463MulByConstants(t *testing.T) {
...
func TestE_nocarry_0463Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0463) bool {
...
func TestE_nocarry_0463LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0463Halve(t *testing.T) {
...
func TestE_nocarry_0463FromMont(t *testing.T) {
...
type testPaire_nocarry_0463 struct {
	element e_nocarry_0463
	bigint  big.Int
}

func (z *e_nocarry_0463) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0463[7] {
		return true
	}
	if z[7] < qe_nocarry_0463[7] {
		return false
	...
	return z[0] >= qe_nocarry_0463[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0463

		g.element = e_nocarry_0463{
		...
		if qe_nocarry_0463[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0463[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0463 {
			var g e_nocarry_0463
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0463[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0463[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0463[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0463[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0463[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0463[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0463[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0463[7], carry)
...
func Benchmarke_nocarry_0463InverseNew(b *testing.B) {
	var x e_nocarry_0463
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0463
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0463
		var xInv e_nocarry_0463
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0463
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0463
...
func testLinearComb(t *testing.T, x *e_nocarry_0463, xC int64, y *e_nocarry_0463, yC int64) {
	...
	var z e_nocarry_0463
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0463, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0463
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0463, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0463
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0463, xHi uint64) {
	var res e_nocarry_0463
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0463) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0463) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0463, c int64, result *e_nocarry_0463, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0463) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0463) uint64 {
