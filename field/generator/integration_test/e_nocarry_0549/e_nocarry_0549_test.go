...
var benchRese_nocarry_0549 e_nocarry_0549

func BenchmarkE_nocarry_0549SetBytes(b *testing.B) {
	var x e_nocarry_0549
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0549MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0549.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0549)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0549)
		}
	})
}

func BenchmarkE_nocarry_0549Inverse(b *testing.B) {
	var x e_nocarry_0549
	x.SetRandom()
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0549Butterfly(b *testing.B) {
	var x e_nocarry_0549
	x.SetRandom()
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0549)
	}
}

func BenchmarkE_nocarry_0549Exp(b *testing.B) {
	var x e_nocarry_0549
	x.SetRandom()
	benchRese_nocarry_0549.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0549Double(b *testing.B) {
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Double(&benchRese_nocarry_0549)
	}
}

func BenchmarkE_nocarry_0549Add(b *testing.B) {
	var x e_nocarry_0549
	x.SetRandom()
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Add(&x, &benchRese_nocarry_0549)
	}
}

func BenchmarkE_nocarry_0549Sub(b *testing.B) {
	var x e_nocarry_0549
	x.SetRandom()
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Sub(&x, &benchRese_nocarry_0549)
	}
}

func BenchmarkE_nocarry_0549Neg(b *testing.B) {
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Neg(&benchRese_nocarry_0549)
	}
}

func BenchmarkE_nocarry_0549Div(b *testing.B) {
	var x e_nocarry_0549
	x.SetRandom()
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Div(&x, &benchRese_nocarry_0549)
	}
}

func BenchmarkE_nocarry_0549FromMont(b *testing.B) {
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.FromMont()
	}
}

func BenchmarkE_nocarry_0549ToMont(b *testing.B) {
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.ToMont()
	}
}
func BenchmarkE_nocarry_0549Square(b *testing.B) {
	benchRese_nocarry_0549.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Square(&benchRese_nocarry_0549)
	}
}

func BenchmarkE_nocarry_0549Sqrt(b *testing.B) {
	var a e_nocarry_0549
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0549Mul(b *testing.B) {
	x := e_nocarry_0549{
		5519413941915485408,
		5612381824405159503,
	...
	benchRese_nocarry_0549.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Mul(&benchRese_nocarry_0549, &x)
	}
}

func BenchmarkE_nocarry_0549Cmp(b *testing.B) {
	x := e_nocarry_0549{
		5519413941915485408,
		5612381824405159503,
		10643446709722285820,
	...
	benchRese_nocarry_0549 = x
	benchRese_nocarry_0549[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0549.Cmp(&x)
	}
}

func TestE_nocarry_0549Cmp(t *testing.T) {
	var x, y e_nocarry_0549
...
func TestE_nocarry_0549IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0549
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0549

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0549{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0549
	one.SetOne()
	e.Sub(&qe_nocarry_0549, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0549{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0549{0, uint64(i)})
	}
...
func TestE_nocarry_0549NegZero(t *testing.T) {
	var a, b e_nocarry_0549
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0549Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0549, len(staticTestValues))
...
func TestE_nocarry_0549Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0549) bool {
			var b e_nocarry_0549
...
func TestE_nocarry_0549InverseExp(t *testing.T) {
...
func TestE_nocarry_0549MulByConstants(t *testing.T) {
...
func TestE_nocarry_0549Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0549) bool {
...
func TestE_nocarry_0549LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0549Halve(t *testing.T) {
...
func TestE_nocarry_0549FromMont(t *testing.T) {
...
type testPaire_nocarry_0549 struct {
	element e_nocarry_0549
	bigint  big.Int
}

func (z *e_nocarry_0549) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0549[8] {
		return true
	}
	if z[8] < qe_nocarry_0549[8] {
		return false
	...
	return z[0] >= qe_nocarry_0549[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0549

		g.element = e_nocarry_0549{
		...
		if qe_nocarry_0549[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0549[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0549 {
			var g e_nocarry_0549
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0549[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0549[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0549[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0549[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0549[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0549[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0549[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0549[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0549[8], carry)
...
func Benchmarke_nocarry_0549InverseNew(b *testing.B) {
	var x e_nocarry_0549
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0549
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0549
		var xInv e_nocarry_0549
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0549
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0549
...
func testLinearComb(t *testing.T, x *e_nocarry_0549, xC int64, y *e_nocarry_0549, yC int64) {
	...
	var z e_nocarry_0549
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0549, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0549
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0549, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0549
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0549, xHi uint64) {
	var res e_nocarry_0549
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0549) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0549) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0549, c int64, result *e_nocarry_0549, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0549) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0549) uint64 {
