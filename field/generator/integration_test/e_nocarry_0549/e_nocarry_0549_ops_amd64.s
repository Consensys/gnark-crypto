...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x5d183f1b7c29bb6f, R12
	ADDQ R12, AX
	MOVQ $0x274050d54ea41a97, R12
	ADCQ R12, DX
	MOVQ $0x2f3f866b70bf0230, R12
	ADCQ R12, CX
	MOVQ $0x49daf8d3364e4ccb, R12
	ADCQ R12, BX
	MOVQ $0x6c855bd4d9a93cfb, R12
	ADCQ R12, SI
	MOVQ $0x74766a4581788801, R12
	ADCQ R12, DI
	MOVQ $0xa0dd0823b7513550, R12
	ADCQ R12, R8
	MOVQ $0x32cb60faf357aace, R12
	ADCQ R12, R9
	MOVQ $0x0000001f58a4c174, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x5d183f1b7c29bb6f, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x274050d54ea41a97, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x2f3f866b70bf0230, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x49daf8d3364e4ccb, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x6c855bd4d9a93cfb, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x74766a4581788801, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xa0dd0823b7513550, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x32cb60faf357aace, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000001f58a4c174, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x5d183f1b7c29bb6f, AX
	ADDQ AX, DX
	MOVQ $0x274050d54ea41a97, AX
	ADCQ AX, CX
	MOVQ $0x2f3f866b70bf0230, AX
	ADCQ AX, BX
	MOVQ $0x49daf8d3364e4ccb, AX
	ADCQ AX, SI
	MOVQ $0x6c855bd4d9a93cfb, AX
	ADCQ AX, DI
	MOVQ $0x74766a4581788801, AX
	ADCQ AX, R8
	MOVQ $0xa0dd0823b7513550, AX
	ADCQ AX, R9
	MOVQ $0x32cb60faf357aace, AX
	ADCQ AX, R10
	MOVQ $0x0000001f58a4c174, AX
	ADCQ AX, R11
