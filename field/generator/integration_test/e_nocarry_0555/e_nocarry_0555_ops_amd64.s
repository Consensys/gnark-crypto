...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x63b4e48475cb818d, R12
	ADDQ R12, AX
	MOVQ $0xfb33aaeb2d78d6d1, R12
	ADCQ R12, DX
	MOVQ $0x78a7ad303eab3dab, R12
	ADCQ R12, CX
	MOVQ $0x072712d53380ec54, R12
	ADCQ R12, BX
	MOVQ $0xdec6ceab6f1e3a14, R12
	ADCQ R12, SI
	MOVQ $0x09afd55cb723a62b, R12
	ADCQ R12, DI
	MOVQ $0x2867c246d9928dd8, R12
	ADCQ R12, R8
	MOVQ $0x342f7477f3be93fa, R12
	ADCQ R12, R9
	MOVQ $0x000007d1f1bd7d50, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x63b4e48475cb818d, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xfb33aaeb2d78d6d1, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x78a7ad303eab3dab, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x072712d53380ec54, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xdec6ceab6f1e3a14, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x09afd55cb723a62b, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x2867c246d9928dd8, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x342f7477f3be93fa, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000007d1f1bd7d50, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x63b4e48475cb818d, AX
	ADDQ AX, DX
	MOVQ $0xfb33aaeb2d78d6d1, AX
	ADCQ AX, CX
	MOVQ $0x78a7ad303eab3dab, AX
	ADCQ AX, BX
	MOVQ $0x072712d53380ec54, AX
	ADCQ AX, SI
	MOVQ $0xdec6ceab6f1e3a14, AX
	ADCQ AX, DI
	MOVQ $0x09afd55cb723a62b, AX
	ADCQ AX, R8
	MOVQ $0x2867c246d9928dd8, AX
	ADCQ AX, R9
	MOVQ $0x342f7477f3be93fa, AX
	ADCQ AX, R10
	MOVQ $0x000007d1f1bd7d50, AX
	ADCQ AX, R11
