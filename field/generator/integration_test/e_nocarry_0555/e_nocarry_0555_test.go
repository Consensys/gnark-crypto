...
var benchRese_nocarry_0555 e_nocarry_0555

func BenchmarkE_nocarry_0555SetBytes(b *testing.B) {
	var x e_nocarry_0555
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0555MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0555.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0555)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0555)
		}
	})
}

func BenchmarkE_nocarry_0555Inverse(b *testing.B) {
	var x e_nocarry_0555
	x.SetRandom()
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0555Butterfly(b *testing.B) {
	var x e_nocarry_0555
	x.SetRandom()
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0555)
	}
}

func BenchmarkE_nocarry_0555Exp(b *testing.B) {
	var x e_nocarry_0555
	x.SetRandom()
	benchRese_nocarry_0555.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0555Double(b *testing.B) {
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Double(&benchRese_nocarry_0555)
	}
}

func BenchmarkE_nocarry_0555Add(b *testing.B) {
	var x e_nocarry_0555
	x.SetRandom()
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Add(&x, &benchRese_nocarry_0555)
	}
}

func BenchmarkE_nocarry_0555Sub(b *testing.B) {
	var x e_nocarry_0555
	x.SetRandom()
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Sub(&x, &benchRese_nocarry_0555)
	}
}

func BenchmarkE_nocarry_0555Neg(b *testing.B) {
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Neg(&benchRese_nocarry_0555)
	}
}

func BenchmarkE_nocarry_0555Div(b *testing.B) {
	var x e_nocarry_0555
	x.SetRandom()
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Div(&x, &benchRese_nocarry_0555)
	}
}

func BenchmarkE_nocarry_0555FromMont(b *testing.B) {
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.FromMont()
	}
}

func BenchmarkE_nocarry_0555ToMont(b *testing.B) {
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.ToMont()
	}
}
func BenchmarkE_nocarry_0555Square(b *testing.B) {
	benchRese_nocarry_0555.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Square(&benchRese_nocarry_0555)
	}
}

func BenchmarkE_nocarry_0555Sqrt(b *testing.B) {
	var a e_nocarry_0555
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0555Mul(b *testing.B) {
	x := e_nocarry_0555{
	...
	benchRese_nocarry_0555.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Mul(&benchRese_nocarry_0555, &x)
	}
}

func BenchmarkE_nocarry_0555Cmp(b *testing.B) {
	x := e_nocarry_0555{
		17525076184257577319,
		4807001600720142944,
		13404006550824470032,
	...
	benchRese_nocarry_0555 = x
	benchRese_nocarry_0555[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0555.Cmp(&x)
	}
}

func TestE_nocarry_0555Cmp(t *testing.T) {
	var x, y e_nocarry_0555
...
func TestE_nocarry_0555IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0555
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0555

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0555{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0555
	one.SetOne()
	e.Sub(&qe_nocarry_0555, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0555{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0555{0, uint64(i)})
	}
...
func TestE_nocarry_0555NegZero(t *testing.T) {
	var a, b e_nocarry_0555
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0555Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0555, len(staticTestValues))
...
func TestE_nocarry_0555Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0555) bool {
			var b e_nocarry_0555
...
func TestE_nocarry_0555InverseExp(t *testing.T) {
...
func TestE_nocarry_0555MulByConstants(t *testing.T) {
...
func TestE_nocarry_0555Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0555) bool {
...
func TestE_nocarry_0555LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0555Halve(t *testing.T) {
...
func TestE_nocarry_0555FromMont(t *testing.T) {
...
type testPaire_nocarry_0555 struct {
	element e_nocarry_0555
	bigint  big.Int
}

func (z *e_nocarry_0555) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0555[8] {
		return true
	}
	if z[8] < qe_nocarry_0555[8] {
		return false
	...
	return z[0] >= qe_nocarry_0555[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0555

		g.element = e_nocarry_0555{
		...
		if qe_nocarry_0555[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0555[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0555 {
			var g e_nocarry_0555
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0555[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0555[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0555[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0555[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0555[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0555[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0555[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0555[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0555[8], carry)
...
func Benchmarke_nocarry_0555InverseNew(b *testing.B) {
	var x e_nocarry_0555
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0555
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0555
		var xInv e_nocarry_0555
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0555
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0555
...
func testLinearComb(t *testing.T, x *e_nocarry_0555, xC int64, y *e_nocarry_0555, yC int64) {
	...
	var z e_nocarry_0555
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0555, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0555
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0555, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0555
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0555, xHi uint64) {
	var res e_nocarry_0555
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0555) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0555) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0555, c int64, result *e_nocarry_0555, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0555) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0555) uint64 {
