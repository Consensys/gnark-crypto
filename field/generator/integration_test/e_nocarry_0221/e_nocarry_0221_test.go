...
var benchRese_nocarry_0221 e_nocarry_0221

func BenchmarkE_nocarry_0221SetBytes(b *testing.B) {
	var x e_nocarry_0221
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0221MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0221.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0221)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0221)
		}
	})
}

func BenchmarkE_nocarry_0221Inverse(b *testing.B) {
	var x e_nocarry_0221
	x.SetRandom()
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0221Butterfly(b *testing.B) {
	var x e_nocarry_0221
	x.SetRandom()
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0221)
	}
}

func BenchmarkE_nocarry_0221Exp(b *testing.B) {
	var x e_nocarry_0221
	x.SetRandom()
	benchRese_nocarry_0221.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0221Double(b *testing.B) {
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Double(&benchRese_nocarry_0221)
	}
}

func BenchmarkE_nocarry_0221Add(b *testing.B) {
	var x e_nocarry_0221
	x.SetRandom()
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Add(&x, &benchRese_nocarry_0221)
	}
}

func BenchmarkE_nocarry_0221Sub(b *testing.B) {
	var x e_nocarry_0221
	x.SetRandom()
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Sub(&x, &benchRese_nocarry_0221)
	}
}

func BenchmarkE_nocarry_0221Neg(b *testing.B) {
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Neg(&benchRese_nocarry_0221)
	}
}

func BenchmarkE_nocarry_0221Div(b *testing.B) {
	var x e_nocarry_0221
	x.SetRandom()
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Div(&x, &benchRese_nocarry_0221)
	}
}

func BenchmarkE_nocarry_0221FromMont(b *testing.B) {
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.FromMont()
	}
}

func BenchmarkE_nocarry_0221ToMont(b *testing.B) {
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.ToMont()
	}
}
func BenchmarkE_nocarry_0221Square(b *testing.B) {
	benchRese_nocarry_0221.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Square(&benchRese_nocarry_0221)
	}
}

func BenchmarkE_nocarry_0221Sqrt(b *testing.B) {
	var a e_nocarry_0221
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0221Mul(b *testing.B) {
	x := e_nocarry_0221{
	...
	benchRese_nocarry_0221.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Mul(&benchRese_nocarry_0221, &x)
	}
}

func BenchmarkE_nocarry_0221Cmp(b *testing.B) {
	x := e_nocarry_0221{
		11967427351617903702,
		9634674168854671579,
		15037428111219166780,
	...
	benchRese_nocarry_0221 = x
	benchRese_nocarry_0221[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0221.Cmp(&x)
	}
}

func TestE_nocarry_0221Cmp(t *testing.T) {
	var x, y e_nocarry_0221
...
func TestE_nocarry_0221IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0221
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0221

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0221{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0221
	one.SetOne()
	e.Sub(&qe_nocarry_0221, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0221{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0221{0, uint64(i)})
	}
...
func TestE_nocarry_0221NegZero(t *testing.T) {
	var a, b e_nocarry_0221
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0221Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0221, len(staticTestValues))
...
func TestE_nocarry_0221Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0221) bool {
			var b e_nocarry_0221
...
func TestE_nocarry_0221InverseExp(t *testing.T) {
...
func TestE_nocarry_0221MulByConstants(t *testing.T) {
...
func TestE_nocarry_0221Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0221) bool {
...
func TestE_nocarry_0221LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0221Halve(t *testing.T) {
...
func TestE_nocarry_0221FromMont(t *testing.T) {
...
type testPaire_nocarry_0221 struct {
	element e_nocarry_0221
	bigint  big.Int
}

func (z *e_nocarry_0221) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0221[3] {
		return true
	}
	if z[3] < qe_nocarry_0221[3] {
		return false
	...
	return z[0] >= qe_nocarry_0221[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0221

		g.element = e_nocarry_0221{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0221[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0221[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0221 {
			var g e_nocarry_0221
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0221[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0221[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0221[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0221[3], carry)
...
func Benchmarke_nocarry_0221InverseNew(b *testing.B) {
	var x e_nocarry_0221
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0221
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0221
		var xInv e_nocarry_0221
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0221
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0221
...
func testLinearComb(t *testing.T, x *e_nocarry_0221, xC int64, y *e_nocarry_0221, yC int64) {
	...
	var z e_nocarry_0221
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0221, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0221
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0221, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0221
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0221, xHi uint64) {
	var res e_nocarry_0221
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0221) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0221) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0221, c int64, result *e_nocarry_0221, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0221) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0221) uint64 {
