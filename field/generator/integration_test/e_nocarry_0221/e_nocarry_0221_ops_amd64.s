...
// modulus q
DATA q<>+0(SB)/8, $0x9080c77a49f7c32d
DATA q<>+8(SB)/8, $0x7cfef82ddfec2a7d
DATA q<>+16(SB)/8, $0xa98162dab93138a4
DATA q<>+24(SB)/8, $0x00000000198e978f
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xfa30f9bec7237b5b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x9080c77a49f7c32d, R8
	MOVQ    $0x7cfef82ddfec2a7d, R9
	MOVQ    $0xa98162dab93138a4, R10
	MOVQ    $0x00000000198e978f, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x7cfef82ddfec2a7d, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xa98162dab93138a4, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000000198e978f, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x9080c77a49f7c32d, R12
	MOVQ    $0x7cfef82ddfec2a7d, R13
	MOVQ    $0xa98162dab93138a4, R14
	MOVQ    $0x00000000198e978f, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
