...
var benchRese_nocarry_0220 e_nocarry_0220

func BenchmarkE_nocarry_0220SetBytes(b *testing.B) {
	var x e_nocarry_0220
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0220MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0220.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0220)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0220)
		}
	})
}

func BenchmarkE_nocarry_0220Inverse(b *testing.B) {
	var x e_nocarry_0220
	x.SetRandom()
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0220Butterfly(b *testing.B) {
	var x e_nocarry_0220
	x.SetRandom()
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0220)
	}
}

func BenchmarkE_nocarry_0220Exp(b *testing.B) {
	var x e_nocarry_0220
	x.SetRandom()
	benchRese_nocarry_0220.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0220Double(b *testing.B) {
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Double(&benchRese_nocarry_0220)
	}
}

func BenchmarkE_nocarry_0220Add(b *testing.B) {
	var x e_nocarry_0220
	x.SetRandom()
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Add(&x, &benchRese_nocarry_0220)
	}
}

func BenchmarkE_nocarry_0220Sub(b *testing.B) {
	var x e_nocarry_0220
	x.SetRandom()
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Sub(&x, &benchRese_nocarry_0220)
	}
}

func BenchmarkE_nocarry_0220Neg(b *testing.B) {
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Neg(&benchRese_nocarry_0220)
	}
}

func BenchmarkE_nocarry_0220Div(b *testing.B) {
	var x e_nocarry_0220
	x.SetRandom()
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Div(&x, &benchRese_nocarry_0220)
	}
}

func BenchmarkE_nocarry_0220FromMont(b *testing.B) {
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.FromMont()
	}
}

func BenchmarkE_nocarry_0220ToMont(b *testing.B) {
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.ToMont()
	}
}
func BenchmarkE_nocarry_0220Square(b *testing.B) {
	benchRese_nocarry_0220.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Square(&benchRese_nocarry_0220)
	}
}

func BenchmarkE_nocarry_0220Sqrt(b *testing.B) {
	var a e_nocarry_0220
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0220Mul(b *testing.B) {
	x := e_nocarry_0220{
	...
	benchRese_nocarry_0220.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Mul(&benchRese_nocarry_0220, &x)
	}
}

func BenchmarkE_nocarry_0220Cmp(b *testing.B) {
	x := e_nocarry_0220{
		14922923111905078726,
		3861709249839024069,
		17750804165538955805,
	...
	benchRese_nocarry_0220 = x
	benchRese_nocarry_0220[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0220.Cmp(&x)
	}
}

func TestE_nocarry_0220Cmp(t *testing.T) {
	var x, y e_nocarry_0220
...
func TestE_nocarry_0220IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0220
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0220

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0220{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0220
	one.SetOne()
	e.Sub(&qe_nocarry_0220, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0220{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0220{0, uint64(i)})
	}
...
func TestE_nocarry_0220NegZero(t *testing.T) {
	var a, b e_nocarry_0220
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0220Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0220, len(staticTestValues))
...
func TestE_nocarry_0220Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0220) bool {
			var b e_nocarry_0220
...
func TestE_nocarry_0220InverseExp(t *testing.T) {
...
func TestE_nocarry_0220MulByConstants(t *testing.T) {
...
func TestE_nocarry_0220Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0220) bool {
...
func TestE_nocarry_0220LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0220Halve(t *testing.T) {
...
func TestE_nocarry_0220FromMont(t *testing.T) {
...
type testPaire_nocarry_0220 struct {
	element e_nocarry_0220
	bigint  big.Int
}

func (z *e_nocarry_0220) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0220[3] {
		return true
	}
	if z[3] < qe_nocarry_0220[3] {
		return false
	...
	return z[0] >= qe_nocarry_0220[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0220

		g.element = e_nocarry_0220{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0220[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0220[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0220 {
			var g e_nocarry_0220
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0220[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0220[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0220[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0220[3], carry)
...
func Benchmarke_nocarry_0220InverseNew(b *testing.B) {
	var x e_nocarry_0220
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0220
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0220
		var xInv e_nocarry_0220
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0220
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0220
...
func testLinearComb(t *testing.T, x *e_nocarry_0220, xC int64, y *e_nocarry_0220, yC int64) {
	...
	var z e_nocarry_0220
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0220, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0220
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0220, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0220
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0220, xHi uint64) {
	var res e_nocarry_0220
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0220) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0220) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0220, c int64, result *e_nocarry_0220, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0220) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0220) uint64 {
