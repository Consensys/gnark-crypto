...
var benchRese_nocarry_0520 e_nocarry_0520

func BenchmarkE_nocarry_0520SetBytes(b *testing.B) {
	var x e_nocarry_0520
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0520MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0520.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0520)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0520)
		}
	})
}

func BenchmarkE_nocarry_0520Inverse(b *testing.B) {
	var x e_nocarry_0520
	x.SetRandom()
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0520Butterfly(b *testing.B) {
	var x e_nocarry_0520
	x.SetRandom()
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0520)
	}
}

func BenchmarkE_nocarry_0520Exp(b *testing.B) {
	var x e_nocarry_0520
	x.SetRandom()
	benchRese_nocarry_0520.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0520Double(b *testing.B) {
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Double(&benchRese_nocarry_0520)
	}
}

func BenchmarkE_nocarry_0520Add(b *testing.B) {
	var x e_nocarry_0520
	x.SetRandom()
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Add(&x, &benchRese_nocarry_0520)
	}
}

func BenchmarkE_nocarry_0520Sub(b *testing.B) {
	var x e_nocarry_0520
	x.SetRandom()
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Sub(&x, &benchRese_nocarry_0520)
	}
}

func BenchmarkE_nocarry_0520Neg(b *testing.B) {
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Neg(&benchRese_nocarry_0520)
	}
}

func BenchmarkE_nocarry_0520Div(b *testing.B) {
	var x e_nocarry_0520
	x.SetRandom()
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Div(&x, &benchRese_nocarry_0520)
	}
}

func BenchmarkE_nocarry_0520FromMont(b *testing.B) {
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.FromMont()
	}
}

func BenchmarkE_nocarry_0520ToMont(b *testing.B) {
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.ToMont()
	}
}
func BenchmarkE_nocarry_0520Square(b *testing.B) {
	benchRese_nocarry_0520.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Square(&benchRese_nocarry_0520)
	}
}

func BenchmarkE_nocarry_0520Sqrt(b *testing.B) {
	var a e_nocarry_0520
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0520Mul(b *testing.B) {
	x := e_nocarry_0520{
		8596741817468462942,
	...
	benchRese_nocarry_0520.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Mul(&benchRese_nocarry_0520, &x)
	}
}

func BenchmarkE_nocarry_0520Cmp(b *testing.B) {
	x := e_nocarry_0520{
		8596741817468462942,
		12529389887773239676,
		6416414831591653655,
	...
	benchRese_nocarry_0520 = x
	benchRese_nocarry_0520[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0520.Cmp(&x)
	}
}

func TestE_nocarry_0520Cmp(t *testing.T) {
	var x, y e_nocarry_0520
...
func TestE_nocarry_0520IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0520
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0520

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0520{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0520
	one.SetOne()
	e.Sub(&qe_nocarry_0520, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0520{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0520{0, uint64(i)})
	}
...
func TestE_nocarry_0520NegZero(t *testing.T) {
	var a, b e_nocarry_0520
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0520Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0520, len(staticTestValues))
...
func TestE_nocarry_0520Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0520) bool {
			var b e_nocarry_0520
...
func TestE_nocarry_0520InverseExp(t *testing.T) {
...
func TestE_nocarry_0520MulByConstants(t *testing.T) {
...
func TestE_nocarry_0520Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0520) bool {
...
func TestE_nocarry_0520LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0520Halve(t *testing.T) {
...
func TestE_nocarry_0520FromMont(t *testing.T) {
...
type testPaire_nocarry_0520 struct {
	element e_nocarry_0520
	bigint  big.Int
}

func (z *e_nocarry_0520) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0520[8] {
		return true
	}
	if z[8] < qe_nocarry_0520[8] {
		return false
	...
	return z[0] >= qe_nocarry_0520[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0520

		g.element = e_nocarry_0520{
		...
		if qe_nocarry_0520[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0520[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0520 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0520[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0520[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0520[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0520[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0520[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0520[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0520[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0520[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0520[8], carry)
...
func Benchmarke_nocarry_0520InverseNew(b *testing.B) {
	var x e_nocarry_0520
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0520
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0520
		var xInv e_nocarry_0520
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0520
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0520
...
func testLinearComb(t *testing.T, x *e_nocarry_0520, xC int64, y *e_nocarry_0520, yC int64) {
	...
	var z e_nocarry_0520
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0520, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0520
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0520, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0520
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0520, xHi uint64) {
	var res e_nocarry_0520
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0520) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0520) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0520, c int64, result *e_nocarry_0520, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0520) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0520) uint64 {
