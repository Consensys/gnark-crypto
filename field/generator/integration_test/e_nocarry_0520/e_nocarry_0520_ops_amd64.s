...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xd8cf536b5e8908e9, R12
	ADDQ R12, AX
	MOVQ $0xcaa17a62fd756d25, R12
	ADCQ R12, DX
	MOVQ $0x73406487ac126ed9, R12
	ADCQ R12, CX
	MOVQ $0x5cccc83bf076f88d, R12
	ADCQ R12, BX
	MOVQ $0xc059af60d0829831, R12
	ADCQ R12, SI
	MOVQ $0x0e53d3f17766f194, R12
	ADCQ R12, DI
	MOVQ $0xe5cc79c0786554c9, R12
	ADCQ R12, R8
	MOVQ $0x00b5a71a3c1eb199, R12
	ADCQ R12, R9
	MOVQ $0x00000000000000d3, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xd8cf536b5e8908e9, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xcaa17a62fd756d25, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x73406487ac126ed9, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x5cccc83bf076f88d, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xc059af60d0829831, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x0e53d3f17766f194, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xe5cc79c0786554c9, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x00b5a71a3c1eb199, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000000000000d3, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xd8cf536b5e8908e9, AX
	ADDQ AX, DX
	MOVQ $0xcaa17a62fd756d25, AX
	ADCQ AX, CX
	MOVQ $0x73406487ac126ed9, AX
	ADCQ AX, BX
	MOVQ $0x5cccc83bf076f88d, AX
	ADCQ AX, SI
	MOVQ $0xc059af60d0829831, AX
	ADCQ AX, DI
	MOVQ $0x0e53d3f17766f194, AX
	ADCQ AX, R8
	MOVQ $0xe5cc79c0786554c9, AX
	ADCQ AX, R9
	MOVQ $0x00b5a71a3c1eb199, AX
	ADCQ AX, R10
	MOVQ $0x00000000000000d3, AX
	ADCQ AX, R11
