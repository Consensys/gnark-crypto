...
var benchRese_nocarry_0233 e_nocarry_0233

func BenchmarkE_nocarry_0233SetBytes(b *testing.B) {
	var x e_nocarry_0233
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0233MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0233.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0233)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0233)
		}
	})
}

func BenchmarkE_nocarry_0233Inverse(b *testing.B) {
	var x e_nocarry_0233
	x.SetRandom()
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0233Butterfly(b *testing.B) {
	var x e_nocarry_0233
	x.SetRandom()
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0233)
	}
}

func BenchmarkE_nocarry_0233Exp(b *testing.B) {
	var x e_nocarry_0233
	x.SetRandom()
	benchRese_nocarry_0233.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0233Double(b *testing.B) {
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Double(&benchRese_nocarry_0233)
	}
}

func BenchmarkE_nocarry_0233Add(b *testing.B) {
	var x e_nocarry_0233
	x.SetRandom()
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Add(&x, &benchRese_nocarry_0233)
	}
}

func BenchmarkE_nocarry_0233Sub(b *testing.B) {
	var x e_nocarry_0233
	x.SetRandom()
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Sub(&x, &benchRese_nocarry_0233)
	}
}

func BenchmarkE_nocarry_0233Neg(b *testing.B) {
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Neg(&benchRese_nocarry_0233)
	}
}

func BenchmarkE_nocarry_0233Div(b *testing.B) {
	var x e_nocarry_0233
	x.SetRandom()
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Div(&x, &benchRese_nocarry_0233)
	}
}

func BenchmarkE_nocarry_0233FromMont(b *testing.B) {
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.FromMont()
	}
}

func BenchmarkE_nocarry_0233ToMont(b *testing.B) {
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.ToMont()
	}
}
func BenchmarkE_nocarry_0233Square(b *testing.B) {
	benchRese_nocarry_0233.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Square(&benchRese_nocarry_0233)
	}
}

func BenchmarkE_nocarry_0233Sqrt(b *testing.B) {
	var a e_nocarry_0233
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0233Mul(b *testing.B) {
	x := e_nocarry_0233{
		2905401756561001613,
	...
	benchRese_nocarry_0233.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Mul(&benchRese_nocarry_0233, &x)
	}
}

func BenchmarkE_nocarry_0233Cmp(b *testing.B) {
	x := e_nocarry_0233{
		2905401756561001613,
		13852519350923633786,
		5157113610154742581,
	...
	benchRese_nocarry_0233 = x
	benchRese_nocarry_0233[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0233.Cmp(&x)
	}
}

func TestE_nocarry_0233Cmp(t *testing.T) {
	var x, y e_nocarry_0233
...
func TestE_nocarry_0233IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0233
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0233

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0233{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0233
	one.SetOne()
	e.Sub(&qe_nocarry_0233, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0233{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0233{0, uint64(i)})
	}
...
func TestE_nocarry_0233NegZero(t *testing.T) {
	var a, b e_nocarry_0233
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0233Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0233, len(staticTestValues))
...
func TestE_nocarry_0233Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0233) bool {
			var b e_nocarry_0233
...
func TestE_nocarry_0233InverseExp(t *testing.T) {
...
func TestE_nocarry_0233MulByConstants(t *testing.T) {
...
func TestE_nocarry_0233Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0233) bool {
...
func TestE_nocarry_0233LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0233Halve(t *testing.T) {
...
func TestE_nocarry_0233FromMont(t *testing.T) {
...
type testPaire_nocarry_0233 struct {
	element e_nocarry_0233
	bigint  big.Int
}

func (z *e_nocarry_0233) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0233[3] {
		return true
	}
	if z[3] < qe_nocarry_0233[3] {
		return false
	...
	return z[0] >= qe_nocarry_0233[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0233

		g.element = e_nocarry_0233{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0233[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0233[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0233 {
			var g e_nocarry_0233
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0233[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0233[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0233[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0233[3], carry)
...
func Benchmarke_nocarry_0233InverseNew(b *testing.B) {
	var x e_nocarry_0233
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0233
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0233
		var xInv e_nocarry_0233
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0233
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0233
...
func testLinearComb(t *testing.T, x *e_nocarry_0233, xC int64, y *e_nocarry_0233, yC int64) {
	...
	var z e_nocarry_0233
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0233, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0233
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0233, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0233
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0233, xHi uint64) {
	var res e_nocarry_0233
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0233) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0233) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0233, c int64, result *e_nocarry_0233, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0233) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0233) uint64 {
