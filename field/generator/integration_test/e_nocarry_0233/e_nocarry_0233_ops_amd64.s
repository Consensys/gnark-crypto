...
// modulus q
DATA q<>+0(SB)/8, $0xeb79ca78f04169fb
DATA q<>+8(SB)/8, $0x5e385dad310544b1
DATA q<>+16(SB)/8, $0x78d4d7987057fbfc
DATA q<>+24(SB)/8, $0x000001c110e1d7ed
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x9e8c226db012c6cd
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xeb79ca78f04169fb, R8
	MOVQ    $0x5e385dad310544b1, R9
	MOVQ    $0x78d4d7987057fbfc, R10
	MOVQ    $0x000001c110e1d7ed, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x5e385dad310544b1, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x78d4d7987057fbfc, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x000001c110e1d7ed, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xeb79ca78f04169fb, R12
	MOVQ    $0x5e385dad310544b1, R13
	MOVQ    $0x78d4d7987057fbfc, R14
	MOVQ    $0x000001c110e1d7ed, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
