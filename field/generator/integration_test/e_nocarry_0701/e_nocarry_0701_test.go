...
var benchRese_nocarry_0701 e_nocarry_0701

func BenchmarkE_nocarry_0701SetBytes(b *testing.B) {
	var x e_nocarry_0701
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0701MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0701.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0701)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0701)
		}
	})
}

func BenchmarkE_nocarry_0701Inverse(b *testing.B) {
	var x e_nocarry_0701
	x.SetRandom()
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0701Butterfly(b *testing.B) {
	var x e_nocarry_0701
	x.SetRandom()
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0701)
	}
}

func BenchmarkE_nocarry_0701Exp(b *testing.B) {
	var x e_nocarry_0701
	x.SetRandom()
	benchRese_nocarry_0701.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0701Double(b *testing.B) {
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Double(&benchRese_nocarry_0701)
	}
}

func BenchmarkE_nocarry_0701Add(b *testing.B) {
	var x e_nocarry_0701
	x.SetRandom()
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Add(&x, &benchRese_nocarry_0701)
	}
}

func BenchmarkE_nocarry_0701Sub(b *testing.B) {
	var x e_nocarry_0701
	x.SetRandom()
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Sub(&x, &benchRese_nocarry_0701)
	}
}

func BenchmarkE_nocarry_0701Neg(b *testing.B) {
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Neg(&benchRese_nocarry_0701)
	}
}

func BenchmarkE_nocarry_0701Div(b *testing.B) {
	var x e_nocarry_0701
	x.SetRandom()
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Div(&x, &benchRese_nocarry_0701)
	}
}

func BenchmarkE_nocarry_0701FromMont(b *testing.B) {
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.FromMont()
	}
}

func BenchmarkE_nocarry_0701ToMont(b *testing.B) {
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.ToMont()
	}
}
func BenchmarkE_nocarry_0701Square(b *testing.B) {
	benchRese_nocarry_0701.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Square(&benchRese_nocarry_0701)
	}
}

func BenchmarkE_nocarry_0701Sqrt(b *testing.B) {
	var a e_nocarry_0701
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0701Mul(b *testing.B) {
	x := e_nocarry_0701{
		9415361847980395756,
		1046540122652215154,
		8242401560832993043,
	...
	benchRese_nocarry_0701.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Mul(&benchRese_nocarry_0701, &x)
	}
}

func BenchmarkE_nocarry_0701Cmp(b *testing.B) {
	x := e_nocarry_0701{
		9415361847980395756,
		1046540122652215154,
		8242401560832993043,
	...
	benchRese_nocarry_0701 = x
	benchRese_nocarry_0701[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0701.Cmp(&x)
	}
}

func TestE_nocarry_0701Cmp(t *testing.T) {
	var x, y e_nocarry_0701
...
func TestE_nocarry_0701IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0701
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0701

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0701{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0701
	one.SetOne()
	e.Sub(&qe_nocarry_0701, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0701{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0701{0, uint64(i)})
	}
...
func TestE_nocarry_0701NegZero(t *testing.T) {
	var a, b e_nocarry_0701
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0701Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0701, len(staticTestValues))
...
func TestE_nocarry_0701Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0701) bool {
			var b e_nocarry_0701
...
func TestE_nocarry_0701InverseExp(t *testing.T) {
...
func TestE_nocarry_0701MulByConstants(t *testing.T) {
...
func TestE_nocarry_0701Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0701) bool {
...
func TestE_nocarry_0701LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0701Halve(t *testing.T) {
...
func TestE_nocarry_0701FromMont(t *testing.T) {
...
type testPaire_nocarry_0701 struct {
	element e_nocarry_0701
	bigint  big.Int
}

func (z *e_nocarry_0701) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0701[10] {
		return true
	}
	if z[10] < qe_nocarry_0701[10] {
		return false
	...
	return z[0] >= qe_nocarry_0701[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0701

		g.element = e_nocarry_0701{
		...
		if qe_nocarry_0701[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0701[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0701 {
			var g e_nocarry_0701
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0701[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0701[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0701[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0701[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0701[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0701[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0701[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0701[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0701[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0701[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0701[10], carry)
...
func Benchmarke_nocarry_0701InverseNew(b *testing.B) {
	var x e_nocarry_0701
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0701
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0701
		var xInv e_nocarry_0701
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0701
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0701
...
func testLinearComb(t *testing.T, x *e_nocarry_0701, xC int64, y *e_nocarry_0701, yC int64) {
	...
	var z e_nocarry_0701
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0701, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0701
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0701, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0701
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0701, xHi uint64) {
	var res e_nocarry_0701
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0701) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0701) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0701, c int64, result *e_nocarry_0701, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0701) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0701) uint64 {
