...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x9b2569f0d5478da7, R14
	ADDQ R14, AX
	MOVQ $0x0cbe55736e25427c, R14
	ADCQ R14, DX
	MOVQ $0x9c2736bc90183e52, R14
	ADCQ R14, CX
	MOVQ $0x6d64b69b5146fea9, R14
	ADCQ R14, BX
	MOVQ $0xdf9f17560a9aa5b1, R14
	ADCQ R14, SI
	MOVQ $0x39a7f227cb05dfe4, R14
	ADCQ R14, DI
	MOVQ $0xbf6fb792f1693bc6, R14
	ADCQ R14, R8
	MOVQ $0xf4b2ea92e9730b65, R14
	ADCQ R14, R9
	MOVQ $0xfee6e9d7c2aad180, R14
	ADCQ R14, R10
	MOVQ $0x1dad5c4276f669dc, R14
	ADCQ R14, R11
	MOVQ $0x19ea35e446400963, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x9b2569f0d5478da7, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x0cbe55736e25427c, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x9c2736bc90183e52, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x6d64b69b5146fea9, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xdf9f17560a9aa5b1, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x39a7f227cb05dfe4, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xbf6fb792f1693bc6, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xf4b2ea92e9730b65, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xfee6e9d7c2aad180, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x1dad5c4276f669dc, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x19ea35e446400963, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x9b2569f0d5478da7, AX
	ADDQ AX, DX
	MOVQ $0x0cbe55736e25427c, AX
	ADCQ AX, CX
	MOVQ $0x9c2736bc90183e52, AX
	ADCQ AX, BX
	MOVQ $0x6d64b69b5146fea9, AX
	ADCQ AX, SI
	MOVQ $0xdf9f17560a9aa5b1, AX
	ADCQ AX, DI
	MOVQ $0x39a7f227cb05dfe4, AX
	ADCQ AX, R8
	MOVQ $0xbf6fb792f1693bc6, AX
	ADCQ AX, R9
	MOVQ $0xf4b2ea92e9730b65, AX
	ADCQ AX, R10
	MOVQ $0xfee6e9d7c2aad180, AX
	ADCQ AX, R11
	MOVQ $0x1dad5c4276f669dc, AX
	ADCQ AX, R12
	MOVQ $0x19ea35e446400963, AX
	ADCQ AX, R13
