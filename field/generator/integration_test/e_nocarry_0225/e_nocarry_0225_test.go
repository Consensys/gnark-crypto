...
var benchRese_nocarry_0225 e_nocarry_0225

func BenchmarkE_nocarry_0225SetBytes(b *testing.B) {
	var x e_nocarry_0225
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0225MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0225.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0225)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0225)
		}
	})
}

func BenchmarkE_nocarry_0225Inverse(b *testing.B) {
	var x e_nocarry_0225
	x.SetRandom()
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0225Butterfly(b *testing.B) {
	var x e_nocarry_0225
	x.SetRandom()
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0225)
	}
}

func BenchmarkE_nocarry_0225Exp(b *testing.B) {
	var x e_nocarry_0225
	x.SetRandom()
	benchRese_nocarry_0225.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0225Double(b *testing.B) {
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Double(&benchRese_nocarry_0225)
	}
}

func BenchmarkE_nocarry_0225Add(b *testing.B) {
	var x e_nocarry_0225
	x.SetRandom()
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Add(&x, &benchRese_nocarry_0225)
	}
}

func BenchmarkE_nocarry_0225Sub(b *testing.B) {
	var x e_nocarry_0225
	x.SetRandom()
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Sub(&x, &benchRese_nocarry_0225)
	}
}

func BenchmarkE_nocarry_0225Neg(b *testing.B) {
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Neg(&benchRese_nocarry_0225)
	}
}

func BenchmarkE_nocarry_0225Div(b *testing.B) {
	var x e_nocarry_0225
	x.SetRandom()
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Div(&x, &benchRese_nocarry_0225)
	}
}

func BenchmarkE_nocarry_0225FromMont(b *testing.B) {
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.FromMont()
	}
}

func BenchmarkE_nocarry_0225ToMont(b *testing.B) {
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.ToMont()
	}
}
func BenchmarkE_nocarry_0225Square(b *testing.B) {
	benchRese_nocarry_0225.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Square(&benchRese_nocarry_0225)
	}
}

func BenchmarkE_nocarry_0225Sqrt(b *testing.B) {
	var a e_nocarry_0225
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0225Mul(b *testing.B) {
	x := e_nocarry_0225{
		4297574241933189176,
	...
	benchRese_nocarry_0225.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Mul(&benchRese_nocarry_0225, &x)
	}
}

func BenchmarkE_nocarry_0225Cmp(b *testing.B) {
	x := e_nocarry_0225{
		4297574241933189176,
		13543641563343109577,
		12249163559750337334,
	...
	benchRese_nocarry_0225 = x
	benchRese_nocarry_0225[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0225.Cmp(&x)
	}
}

func TestE_nocarry_0225Cmp(t *testing.T) {
	var x, y e_nocarry_0225
...
func TestE_nocarry_0225IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0225
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0225

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0225{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0225
	one.SetOne()
	e.Sub(&qe_nocarry_0225, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0225{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0225{0, uint64(i)})
	}
...
func TestE_nocarry_0225NegZero(t *testing.T) {
	var a, b e_nocarry_0225
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0225Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0225, len(staticTestValues))
...
func TestE_nocarry_0225Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0225) bool {
			var b e_nocarry_0225
...
func TestE_nocarry_0225InverseExp(t *testing.T) {
...
func TestE_nocarry_0225MulByConstants(t *testing.T) {
...
func TestE_nocarry_0225Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0225) bool {
...
func TestE_nocarry_0225LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0225Halve(t *testing.T) {
...
func TestE_nocarry_0225FromMont(t *testing.T) {
...
type testPaire_nocarry_0225 struct {
	element e_nocarry_0225
	bigint  big.Int
}

func (z *e_nocarry_0225) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0225[3] {
		return true
	}
	if z[3] < qe_nocarry_0225[3] {
		return false
	...
	return z[0] >= qe_nocarry_0225[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0225

		g.element = e_nocarry_0225{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0225[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0225[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0225 {
			var g e_nocarry_0225
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0225[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0225[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0225[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0225[3], carry)
...
func Benchmarke_nocarry_0225InverseNew(b *testing.B) {
	var x e_nocarry_0225
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0225
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0225
		var xInv e_nocarry_0225
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0225
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0225
...
func testLinearComb(t *testing.T, x *e_nocarry_0225, xC int64, y *e_nocarry_0225, yC int64) {
	...
	var z e_nocarry_0225
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0225, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0225
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0225, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0225
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0225, xHi uint64) {
	var res e_nocarry_0225
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0225) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0225) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0225, c int64, result *e_nocarry_0225, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0225) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0225) uint64 {
