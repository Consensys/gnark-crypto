...
// modulus q
DATA q<>+0(SB)/8, $0x22b4004c8ab3734f
DATA q<>+8(SB)/8, $0xa39dfbfbe6f2a6c2
DATA q<>+16(SB)/8, $0x2fa87914d7cfe9a4
DATA q<>+24(SB)/8, $0x00000001f08e77f7
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x25305685ca2e3c51
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x22b4004c8ab3734f, R8
	MOVQ    $0xa39dfbfbe6f2a6c2, R9
	MOVQ    $0x2fa87914d7cfe9a4, R10
	MOVQ    $0x00000001f08e77f7, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xa39dfbfbe6f2a6c2, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x2fa87914d7cfe9a4, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000001f08e77f7, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x22b4004c8ab3734f, R12
	MOVQ    $0xa39dfbfbe6f2a6c2, R13
	MOVQ    $0x2fa87914d7cfe9a4, R14
	MOVQ    $0x00000001f08e77f7, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
