...
// modulus q
DATA q<>+0(SB)/8, $0x8217f79b0aff4883
DATA q<>+8(SB)/8, $0xbdb3b763f6df06b7
DATA q<>+16(SB)/8, $0x80c04c1862a5c6b8
DATA q<>+24(SB)/8, $0xc358225966dfea39
DATA q<>+32(SB)/8, $0x0000000000000003
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x3465a2e27e66b9d5
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x8217f79b0aff4883, R9
	MOVQ    $0xbdb3b763f6df06b7, R10
	MOVQ    $0x80c04c1862a5c6b8, R11
	MOVQ    $0xc358225966dfea39, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xbdb3b763f6df06b7, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x80c04c1862a5c6b8, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xc358225966dfea39, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x8217f79b0aff4883, CX
	MOVQ    $0xbdb3b763f6df06b7, BX
	MOVQ    $0x80c04c1862a5c6b8, SI
	MOVQ    $0xc358225966dfea39, DI
	MOVQ    $0x0000000000000003, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
