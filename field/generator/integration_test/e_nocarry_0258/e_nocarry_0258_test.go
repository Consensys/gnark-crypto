...
var benchRese_nocarry_0258 e_nocarry_0258

func BenchmarkE_nocarry_0258SetBytes(b *testing.B) {
	var x e_nocarry_0258
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0258MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0258.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0258)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0258)
		}
	})
}

func BenchmarkE_nocarry_0258Inverse(b *testing.B) {
	var x e_nocarry_0258
	x.SetRandom()
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0258Butterfly(b *testing.B) {
	var x e_nocarry_0258
	x.SetRandom()
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0258)
	}
}

func BenchmarkE_nocarry_0258Exp(b *testing.B) {
	var x e_nocarry_0258
	x.SetRandom()
	benchRese_nocarry_0258.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0258Double(b *testing.B) {
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Double(&benchRese_nocarry_0258)
	}
}

func BenchmarkE_nocarry_0258Add(b *testing.B) {
	var x e_nocarry_0258
	x.SetRandom()
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Add(&x, &benchRese_nocarry_0258)
	}
}

func BenchmarkE_nocarry_0258Sub(b *testing.B) {
	var x e_nocarry_0258
	x.SetRandom()
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Sub(&x, &benchRese_nocarry_0258)
	}
}

func BenchmarkE_nocarry_0258Neg(b *testing.B) {
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Neg(&benchRese_nocarry_0258)
	}
}

func BenchmarkE_nocarry_0258Div(b *testing.B) {
	var x e_nocarry_0258
	x.SetRandom()
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Div(&x, &benchRese_nocarry_0258)
	}
}

func BenchmarkE_nocarry_0258FromMont(b *testing.B) {
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.FromMont()
	}
}

func BenchmarkE_nocarry_0258ToMont(b *testing.B) {
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.ToMont()
	}
}
func BenchmarkE_nocarry_0258Square(b *testing.B) {
	benchRese_nocarry_0258.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Square(&benchRese_nocarry_0258)
	}
}

func BenchmarkE_nocarry_0258Sqrt(b *testing.B) {
	var a e_nocarry_0258
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0258Mul(b *testing.B) {
	x := e_nocarry_0258{
		8226052220055722318,
	...
	benchRese_nocarry_0258.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Mul(&benchRese_nocarry_0258, &x)
	}
}

func BenchmarkE_nocarry_0258Cmp(b *testing.B) {
	x := e_nocarry_0258{
		8226052220055722318,
		12444481463576767504,
		14422599825510174000,
	...
	benchRese_nocarry_0258 = x
	benchRese_nocarry_0258[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0258.Cmp(&x)
	}
}

func TestE_nocarry_0258Cmp(t *testing.T) {
	var x, y e_nocarry_0258
...
func TestE_nocarry_0258IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0258
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0258

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0258{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0258
	one.SetOne()
	e.Sub(&qe_nocarry_0258, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0258{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0258{0, uint64(i)})
	}
...
func TestE_nocarry_0258NegZero(t *testing.T) {
	var a, b e_nocarry_0258
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0258Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0258, len(staticTestValues))
...
func TestE_nocarry_0258Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0258) bool {
			var b e_nocarry_0258
...
func TestE_nocarry_0258InverseExp(t *testing.T) {
...
func TestE_nocarry_0258MulByConstants(t *testing.T) {
...
func TestE_nocarry_0258Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0258) bool {
...
func TestE_nocarry_0258LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0258Halve(t *testing.T) {
...
func TestE_nocarry_0258FromMont(t *testing.T) {
...
type testPaire_nocarry_0258 struct {
	element e_nocarry_0258
	bigint  big.Int
}

func (z *e_nocarry_0258) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0258[4] {
		return true
	}
	if z[4] < qe_nocarry_0258[4] {
		return false
	...
	return z[0] >= qe_nocarry_0258[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0258

		g.element = e_nocarry_0258{
		...
		if qe_nocarry_0258[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0258[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0258 {
			var g e_nocarry_0258
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0258[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0258[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0258[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0258[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0258[4], carry)
...
func Benchmarke_nocarry_0258InverseNew(b *testing.B) {
	var x e_nocarry_0258
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0258
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0258
		var xInv e_nocarry_0258
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0258
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0258
...
func testLinearComb(t *testing.T, x *e_nocarry_0258, xC int64, y *e_nocarry_0258, yC int64) {
	...
	var z e_nocarry_0258
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0258, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0258
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0258, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0258
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0258, xHi uint64) {
	var res e_nocarry_0258
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0258) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0258) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0258, c int64, result *e_nocarry_0258, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0258) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0258) uint64 {
