...
// modulus q
DATA q<>+0(SB)/8, $0xeed4321df52adb37
DATA q<>+8(SB)/8, $0x6d9311e800571347
DATA q<>+16(SB)/8, $0xb74c8d0de696a4f2
DATA q<>+24(SB)/8, $0x5138a479aab7e14f
DATA q<>+32(SB)/8, $0x22754bdc62080a88
DATA q<>+40(SB)/8, $0x000007133505c5e5
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xd9364c6701843579
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xeed4321df52adb37, R10
	MOVQ    $0x6d9311e800571347, R11
	MOVQ    $0xb74c8d0de696a4f2, R12
	MOVQ    $0x5138a479aab7e14f, R13
	MOVQ    $0x22754bdc62080a88, R14
	MOVQ    $0x000007133505c5e5, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x6d9311e800571347, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xb74c8d0de696a4f2, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x5138a479aab7e14f, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x22754bdc62080a88, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000007133505c5e5, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xeed4321df52adb37, CX
	MOVQ    $0x6d9311e800571347, BX
	MOVQ    $0xb74c8d0de696a4f2, SI
	MOVQ    $0x5138a479aab7e14f, DI
	MOVQ    $0x22754bdc62080a88, R8
	MOVQ    $0x000007133505c5e5, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
