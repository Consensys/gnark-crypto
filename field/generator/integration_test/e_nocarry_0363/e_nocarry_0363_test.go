...
var benchRese_nocarry_0363 e_nocarry_0363

func BenchmarkE_nocarry_0363SetBytes(b *testing.B) {
	var x e_nocarry_0363
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0363MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0363.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0363)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0363)
		}
	})
}

func BenchmarkE_nocarry_0363Inverse(b *testing.B) {
	var x e_nocarry_0363
	x.SetRandom()
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0363Butterfly(b *testing.B) {
	var x e_nocarry_0363
	x.SetRandom()
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0363)
	}
}

func BenchmarkE_nocarry_0363Exp(b *testing.B) {
	var x e_nocarry_0363
	x.SetRandom()
	benchRese_nocarry_0363.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0363Double(b *testing.B) {
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Double(&benchRese_nocarry_0363)
	}
}

func BenchmarkE_nocarry_0363Add(b *testing.B) {
	var x e_nocarry_0363
	x.SetRandom()
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Add(&x, &benchRese_nocarry_0363)
	}
}

func BenchmarkE_nocarry_0363Sub(b *testing.B) {
	var x e_nocarry_0363
	x.SetRandom()
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Sub(&x, &benchRese_nocarry_0363)
	}
}

func BenchmarkE_nocarry_0363Neg(b *testing.B) {
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Neg(&benchRese_nocarry_0363)
	}
}

func BenchmarkE_nocarry_0363Div(b *testing.B) {
	var x e_nocarry_0363
	x.SetRandom()
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Div(&x, &benchRese_nocarry_0363)
	}
}

func BenchmarkE_nocarry_0363FromMont(b *testing.B) {
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.FromMont()
	}
}

func BenchmarkE_nocarry_0363ToMont(b *testing.B) {
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.ToMont()
	}
}
func BenchmarkE_nocarry_0363Square(b *testing.B) {
	benchRese_nocarry_0363.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Square(&benchRese_nocarry_0363)
	}
}

func BenchmarkE_nocarry_0363Sqrt(b *testing.B) {
	var a e_nocarry_0363
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0363Mul(b *testing.B) {
	x := e_nocarry_0363{
		2872132607003759083,
		7923064405478381140,
		9498490239237205753,
	...
	benchRese_nocarry_0363.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Mul(&benchRese_nocarry_0363, &x)
	}
}

func BenchmarkE_nocarry_0363Cmp(b *testing.B) {
	x := e_nocarry_0363{
		2872132607003759083,
		7923064405478381140,
		9498490239237205753,
	...
	benchRese_nocarry_0363 = x
	benchRese_nocarry_0363[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0363.Cmp(&x)
	}
}

func TestE_nocarry_0363Cmp(t *testing.T) {
	var x, y e_nocarry_0363
...
func TestE_nocarry_0363IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0363
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0363

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0363{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0363
	one.SetOne()
	e.Sub(&qe_nocarry_0363, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0363{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0363{0, uint64(i)})
	}
...
func TestE_nocarry_0363NegZero(t *testing.T) {
	var a, b e_nocarry_0363
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0363Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0363, len(staticTestValues))
...
func TestE_nocarry_0363Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0363) bool {
			var b e_nocarry_0363
...
func TestE_nocarry_0363InverseExp(t *testing.T) {
...
func TestE_nocarry_0363MulByConstants(t *testing.T) {
...
func TestE_nocarry_0363Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0363) bool {
...
func TestE_nocarry_0363LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0363Halve(t *testing.T) {
...
func TestE_nocarry_0363FromMont(t *testing.T) {
...
type testPaire_nocarry_0363 struct {
	element e_nocarry_0363
	bigint  big.Int
}

func (z *e_nocarry_0363) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0363[5] {
		return true
	}
	if z[5] < qe_nocarry_0363[5] {
		return false
	...
	return z[0] >= qe_nocarry_0363[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0363

		g.element = e_nocarry_0363{
		...
		if qe_nocarry_0363[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0363[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0363 {
			var g e_nocarry_0363
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0363[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0363[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0363[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0363[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0363[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0363[5], carry)
...
func Benchmarke_nocarry_0363InverseNew(b *testing.B) {
	var x e_nocarry_0363
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0363
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0363
		var xInv e_nocarry_0363
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0363
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0363
...
func testLinearComb(t *testing.T, x *e_nocarry_0363, xC int64, y *e_nocarry_0363, yC int64) {
	...
	var z e_nocarry_0363
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0363, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0363
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0363, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0363
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0363, xHi uint64) {
	var res e_nocarry_0363
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0363) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0363) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0363, c int64, result *e_nocarry_0363, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0363) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0363) uint64 {
