...
// modulus q
DATA q<>+0(SB)/8, $0x80d9da2f7cca35ef
DATA q<>+8(SB)/8, $0xe5966a8da018f90b
DATA q<>+16(SB)/8, $0x000000000003599c
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x118022c5043a66f1
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x80d9da2f7cca35ef, DI
	MOVQ    $0xe5966a8da018f90b, R8
	MOVQ    $0x000000000003599c, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xe5966a8da018f90b, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x000000000003599c, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x80d9da2f7cca35ef, R10
	MOVQ    $0xe5966a8da018f90b, R11
	MOVQ    $0x000000000003599c, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
