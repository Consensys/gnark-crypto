...
var benchRese_nocarry_0146 e_nocarry_0146

func BenchmarkE_nocarry_0146SetBytes(b *testing.B) {
	var x e_nocarry_0146
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0146MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0146.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0146)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0146)
		}
	})
}

func BenchmarkE_nocarry_0146Inverse(b *testing.B) {
	var x e_nocarry_0146
	x.SetRandom()
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0146Butterfly(b *testing.B) {
	var x e_nocarry_0146
	x.SetRandom()
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0146)
	}
}

func BenchmarkE_nocarry_0146Exp(b *testing.B) {
	var x e_nocarry_0146
	x.SetRandom()
	benchRese_nocarry_0146.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0146Double(b *testing.B) {
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Double(&benchRese_nocarry_0146)
	}
}

func BenchmarkE_nocarry_0146Add(b *testing.B) {
	var x e_nocarry_0146
	x.SetRandom()
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Add(&x, &benchRese_nocarry_0146)
	}
}

func BenchmarkE_nocarry_0146Sub(b *testing.B) {
	var x e_nocarry_0146
	x.SetRandom()
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Sub(&x, &benchRese_nocarry_0146)
	}
}

func BenchmarkE_nocarry_0146Neg(b *testing.B) {
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Neg(&benchRese_nocarry_0146)
	}
}

func BenchmarkE_nocarry_0146Div(b *testing.B) {
	var x e_nocarry_0146
	x.SetRandom()
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Div(&x, &benchRese_nocarry_0146)
	}
}

func BenchmarkE_nocarry_0146FromMont(b *testing.B) {
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.FromMont()
	}
}

func BenchmarkE_nocarry_0146ToMont(b *testing.B) {
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.ToMont()
	}
}
func BenchmarkE_nocarry_0146Square(b *testing.B) {
	benchRese_nocarry_0146.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Square(&benchRese_nocarry_0146)
	}
}

func BenchmarkE_nocarry_0146Sqrt(b *testing.B) {
	var a e_nocarry_0146
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0146Mul(b *testing.B) {
	x := e_nocarry_0146{
		11013517171153579983,
		321533245063855230,
		89862,
	}
	benchRese_nocarry_0146.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Mul(&benchRese_nocarry_0146, &x)
	}
}

func BenchmarkE_nocarry_0146Cmp(b *testing.B) {
	x := e_nocarry_0146{
		11013517171153579983,
		321533245063855230,
		89862,
	}
	benchRese_nocarry_0146 = x
	benchRese_nocarry_0146[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0146.Cmp(&x)
	}
}

func TestE_nocarry_0146Cmp(t *testing.T) {
	var x, y e_nocarry_0146
...
func TestE_nocarry_0146IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0146
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0146

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0146{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0146
	one.SetOne()
	e.Sub(&qe_nocarry_0146, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0146{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0146{0, uint64(i)})
	}
...
func TestE_nocarry_0146NegZero(t *testing.T) {
	var a, b e_nocarry_0146
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0146Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0146, len(staticTestValues))
...
func TestE_nocarry_0146Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0146) bool {
			var b e_nocarry_0146
...
func TestE_nocarry_0146InverseExp(t *testing.T) {
...
func TestE_nocarry_0146MulByConstants(t *testing.T) {
...
func TestE_nocarry_0146Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0146) bool {
...
func TestE_nocarry_0146LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0146Halve(t *testing.T) {
...
func TestE_nocarry_0146FromMont(t *testing.T) {
...
type testPaire_nocarry_0146 struct {
	element e_nocarry_0146
	bigint  big.Int
}

func (z *e_nocarry_0146) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0146[2] {
		return true
	}
	if z[2] < qe_nocarry_0146[2] {
		return false
	...
	return z[0] >= qe_nocarry_0146[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0146

		g.element = e_nocarry_0146{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0146[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0146[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0146 {
			var g e_nocarry_0146
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0146[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0146[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0146[2], carry)
...
func Benchmarke_nocarry_0146InverseNew(b *testing.B) {
	var x e_nocarry_0146
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0146
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0146
		var xInv e_nocarry_0146
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0146
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0146
...
func testLinearComb(t *testing.T, x *e_nocarry_0146, xC int64, y *e_nocarry_0146, yC int64) {
	...
	var z e_nocarry_0146
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0146, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0146
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0146, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0146
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0146, xHi uint64) {
	var res e_nocarry_0146
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0146) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0146) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0146, c int64, result *e_nocarry_0146, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0146) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0146) uint64 {
