...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x846cf5b076cfe659, R12
	ADDQ R12, AX
	MOVQ $0x53aa4432fab8753d, R12
	ADCQ R12, DX
	MOVQ $0xace306d387dcc6bc, R12
	ADCQ R12, CX
	MOVQ $0xdfe130e3177610e5, R12
	ADCQ R12, BX
	MOVQ $0x11b152d61093f521, R12
	ADCQ R12, SI
	MOVQ $0x31e8c1024cbe5727, R12
	ADCQ R12, DI
	MOVQ $0x2d2dd709d703c763, R12
	ADCQ R12, R8
	MOVQ $0x2e82e9a2f2c91a81, R12
	ADCQ R12, R9
	MOVQ $0x0000000000caef53, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x846cf5b076cfe659, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x53aa4432fab8753d, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xace306d387dcc6bc, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xdfe130e3177610e5, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x11b152d61093f521, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x31e8c1024cbe5727, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x2d2dd709d703c763, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x2e82e9a2f2c91a81, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000000caef53, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x846cf5b076cfe659, AX
	ADDQ AX, DX
	MOVQ $0x53aa4432fab8753d, AX
	ADCQ AX, CX
	MOVQ $0xace306d387dcc6bc, AX
	ADCQ AX, BX
	MOVQ $0xdfe130e3177610e5, AX
	ADCQ AX, SI
	MOVQ $0x11b152d61093f521, AX
	ADCQ AX, DI
	MOVQ $0x31e8c1024cbe5727, AX
	ADCQ AX, R8
	MOVQ $0x2d2dd709d703c763, AX
	ADCQ AX, R9
	MOVQ $0x2e82e9a2f2c91a81, AX
	ADCQ AX, R10
	MOVQ $0x0000000000caef53, AX
	ADCQ AX, R11
