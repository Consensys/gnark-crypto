...
var benchRese_nocarry_0536 e_nocarry_0536

func BenchmarkE_nocarry_0536SetBytes(b *testing.B) {
	var x e_nocarry_0536
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0536MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0536.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0536)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0536)
		}
	})
}

func BenchmarkE_nocarry_0536Inverse(b *testing.B) {
	var x e_nocarry_0536
	x.SetRandom()
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0536Butterfly(b *testing.B) {
	var x e_nocarry_0536
	x.SetRandom()
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0536)
	}
}

func BenchmarkE_nocarry_0536Exp(b *testing.B) {
	var x e_nocarry_0536
	x.SetRandom()
	benchRese_nocarry_0536.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0536Double(b *testing.B) {
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Double(&benchRese_nocarry_0536)
	}
}

func BenchmarkE_nocarry_0536Add(b *testing.B) {
	var x e_nocarry_0536
	x.SetRandom()
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Add(&x, &benchRese_nocarry_0536)
	}
}

func BenchmarkE_nocarry_0536Sub(b *testing.B) {
	var x e_nocarry_0536
	x.SetRandom()
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Sub(&x, &benchRese_nocarry_0536)
	}
}

func BenchmarkE_nocarry_0536Neg(b *testing.B) {
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Neg(&benchRese_nocarry_0536)
	}
}

func BenchmarkE_nocarry_0536Div(b *testing.B) {
	var x e_nocarry_0536
	x.SetRandom()
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Div(&x, &benchRese_nocarry_0536)
	}
}

func BenchmarkE_nocarry_0536FromMont(b *testing.B) {
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.FromMont()
	}
}

func BenchmarkE_nocarry_0536ToMont(b *testing.B) {
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.ToMont()
	}
}
func BenchmarkE_nocarry_0536Square(b *testing.B) {
	benchRese_nocarry_0536.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Square(&benchRese_nocarry_0536)
	}
}

func BenchmarkE_nocarry_0536Sqrt(b *testing.B) {
	var a e_nocarry_0536
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0536Mul(b *testing.B) {
	x := e_nocarry_0536{
	...
	benchRese_nocarry_0536.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Mul(&benchRese_nocarry_0536, &x)
	}
}

func BenchmarkE_nocarry_0536Cmp(b *testing.B) {
	x := e_nocarry_0536{
		13930397381418747402,
		900908128205184103,
		4065642865515951371,
	...
	benchRese_nocarry_0536 = x
	benchRese_nocarry_0536[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0536.Cmp(&x)
	}
}

func TestE_nocarry_0536Cmp(t *testing.T) {
	var x, y e_nocarry_0536
...
func TestE_nocarry_0536IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0536
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0536

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0536{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0536
	one.SetOne()
	e.Sub(&qe_nocarry_0536, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0536{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0536{0, uint64(i)})
	}
...
func TestE_nocarry_0536NegZero(t *testing.T) {
	var a, b e_nocarry_0536
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0536Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0536, len(staticTestValues))
...
func TestE_nocarry_0536Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0536) bool {
			var b e_nocarry_0536
...
func TestE_nocarry_0536InverseExp(t *testing.T) {
...
func TestE_nocarry_0536MulByConstants(t *testing.T) {
...
func TestE_nocarry_0536Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0536) bool {
...
func TestE_nocarry_0536LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0536Halve(t *testing.T) {
...
func TestE_nocarry_0536FromMont(t *testing.T) {
...
type testPaire_nocarry_0536 struct {
	element e_nocarry_0536
	bigint  big.Int
}

func (z *e_nocarry_0536) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0536[8] {
		return true
	}
	if z[8] < qe_nocarry_0536[8] {
		return false
	...
	return z[0] >= qe_nocarry_0536[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0536

		g.element = e_nocarry_0536{
		...
		if qe_nocarry_0536[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0536[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0536 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0536[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0536[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0536[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0536[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0536[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0536[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0536[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0536[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0536[8], carry)
...
func Benchmarke_nocarry_0536InverseNew(b *testing.B) {
	var x e_nocarry_0536
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0536
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0536
		var xInv e_nocarry_0536
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0536
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0536
...
func testLinearComb(t *testing.T, x *e_nocarry_0536, xC int64, y *e_nocarry_0536, yC int64) {
	...
	var z e_nocarry_0536
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0536, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0536
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0536, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0536
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0536, xHi uint64) {
	var res e_nocarry_0536
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0536) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0536) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0536, c int64, result *e_nocarry_0536, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0536) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0536) uint64 {
