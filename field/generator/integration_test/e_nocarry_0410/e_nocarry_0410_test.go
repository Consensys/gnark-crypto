...
var benchRese_nocarry_0410 e_nocarry_0410

func BenchmarkE_nocarry_0410SetBytes(b *testing.B) {
	var x e_nocarry_0410
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0410MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0410.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0410)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0410)
		}
	})
}

func BenchmarkE_nocarry_0410Inverse(b *testing.B) {
	var x e_nocarry_0410
	x.SetRandom()
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0410Butterfly(b *testing.B) {
	var x e_nocarry_0410
	x.SetRandom()
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0410)
	}
}

func BenchmarkE_nocarry_0410Exp(b *testing.B) {
	var x e_nocarry_0410
	x.SetRandom()
	benchRese_nocarry_0410.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0410Double(b *testing.B) {
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Double(&benchRese_nocarry_0410)
	}
}

func BenchmarkE_nocarry_0410Add(b *testing.B) {
	var x e_nocarry_0410
	x.SetRandom()
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Add(&x, &benchRese_nocarry_0410)
	}
}

func BenchmarkE_nocarry_0410Sub(b *testing.B) {
	var x e_nocarry_0410
	x.SetRandom()
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Sub(&x, &benchRese_nocarry_0410)
	}
}

func BenchmarkE_nocarry_0410Neg(b *testing.B) {
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Neg(&benchRese_nocarry_0410)
	}
}

func BenchmarkE_nocarry_0410Div(b *testing.B) {
	var x e_nocarry_0410
	x.SetRandom()
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Div(&x, &benchRese_nocarry_0410)
	}
}

func BenchmarkE_nocarry_0410FromMont(b *testing.B) {
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.FromMont()
	}
}

func BenchmarkE_nocarry_0410ToMont(b *testing.B) {
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.ToMont()
	}
}
func BenchmarkE_nocarry_0410Square(b *testing.B) {
	benchRese_nocarry_0410.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Square(&benchRese_nocarry_0410)
	}
}

func BenchmarkE_nocarry_0410Sqrt(b *testing.B) {
	var a e_nocarry_0410
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0410Mul(b *testing.B) {
	x := e_nocarry_0410{
		5074059903022456162,
	...
	benchRese_nocarry_0410.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Mul(&benchRese_nocarry_0410, &x)
	}
}

func BenchmarkE_nocarry_0410Cmp(b *testing.B) {
	x := e_nocarry_0410{
		5074059903022456162,
		15843085389753141207,
		15144287388712073346,
	...
	benchRese_nocarry_0410 = x
	benchRese_nocarry_0410[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0410.Cmp(&x)
	}
}

func TestE_nocarry_0410Cmp(t *testing.T) {
	var x, y e_nocarry_0410
...
func TestE_nocarry_0410IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0410
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0410

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0410{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0410
	one.SetOne()
	e.Sub(&qe_nocarry_0410, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0410{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0410{0, uint64(i)})
	}
...
func TestE_nocarry_0410NegZero(t *testing.T) {
	var a, b e_nocarry_0410
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0410Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0410, len(staticTestValues))
...
func TestE_nocarry_0410Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0410) bool {
			var b e_nocarry_0410
...
func TestE_nocarry_0410InverseExp(t *testing.T) {
...
func TestE_nocarry_0410MulByConstants(t *testing.T) {
...
func TestE_nocarry_0410Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0410) bool {
...
func TestE_nocarry_0410LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0410Halve(t *testing.T) {
...
func TestE_nocarry_0410FromMont(t *testing.T) {
...
type testPaire_nocarry_0410 struct {
	element e_nocarry_0410
	bigint  big.Int
}

func (z *e_nocarry_0410) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0410[6] {
		return true
	}
	if z[6] < qe_nocarry_0410[6] {
		return false
	...
	return z[0] >= qe_nocarry_0410[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0410

		g.element = e_nocarry_0410{
		...
		if qe_nocarry_0410[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0410[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0410 {
			var g e_nocarry_0410
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0410[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0410[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0410[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0410[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0410[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0410[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0410[6], carry)
...
func Benchmarke_nocarry_0410InverseNew(b *testing.B) {
	var x e_nocarry_0410
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0410
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0410
		var xInv e_nocarry_0410
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0410
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0410
...
func testLinearComb(t *testing.T, x *e_nocarry_0410, xC int64, y *e_nocarry_0410, yC int64) {
	...
	var z e_nocarry_0410
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0410, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0410
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0410, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0410
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0410, xHi uint64) {
	var res e_nocarry_0410
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0410) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0410) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0410, c int64, result *e_nocarry_0410, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0410) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0410) uint64 {
