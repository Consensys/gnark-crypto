...
var benchRese_nocarry_0423 e_nocarry_0423

func BenchmarkE_nocarry_0423SetBytes(b *testing.B) {
	var x e_nocarry_0423
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0423MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0423.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0423)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0423)
		}
	})
}

func BenchmarkE_nocarry_0423Inverse(b *testing.B) {
	var x e_nocarry_0423
	x.SetRandom()
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0423Butterfly(b *testing.B) {
	var x e_nocarry_0423
	x.SetRandom()
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0423)
	}
}

func BenchmarkE_nocarry_0423Exp(b *testing.B) {
	var x e_nocarry_0423
	x.SetRandom()
	benchRese_nocarry_0423.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0423Double(b *testing.B) {
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Double(&benchRese_nocarry_0423)
	}
}

func BenchmarkE_nocarry_0423Add(b *testing.B) {
	var x e_nocarry_0423
	x.SetRandom()
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Add(&x, &benchRese_nocarry_0423)
	}
}

func BenchmarkE_nocarry_0423Sub(b *testing.B) {
	var x e_nocarry_0423
	x.SetRandom()
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Sub(&x, &benchRese_nocarry_0423)
	}
}

func BenchmarkE_nocarry_0423Neg(b *testing.B) {
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Neg(&benchRese_nocarry_0423)
	}
}

func BenchmarkE_nocarry_0423Div(b *testing.B) {
	var x e_nocarry_0423
	x.SetRandom()
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Div(&x, &benchRese_nocarry_0423)
	}
}

func BenchmarkE_nocarry_0423FromMont(b *testing.B) {
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.FromMont()
	}
}

func BenchmarkE_nocarry_0423ToMont(b *testing.B) {
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.ToMont()
	}
}
func BenchmarkE_nocarry_0423Square(b *testing.B) {
	benchRese_nocarry_0423.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Square(&benchRese_nocarry_0423)
	}
}

func BenchmarkE_nocarry_0423Sqrt(b *testing.B) {
	var a e_nocarry_0423
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0423Mul(b *testing.B) {
	x := e_nocarry_0423{
		4680220584487000496,
		357798242109407669,
	...
	benchRese_nocarry_0423.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Mul(&benchRese_nocarry_0423, &x)
	}
}

func BenchmarkE_nocarry_0423Cmp(b *testing.B) {
	x := e_nocarry_0423{
		4680220584487000496,
		357798242109407669,
		15299908926893887446,
	...
	benchRese_nocarry_0423 = x
	benchRese_nocarry_0423[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0423.Cmp(&x)
	}
}

func TestE_nocarry_0423Cmp(t *testing.T) {
	var x, y e_nocarry_0423
...
func TestE_nocarry_0423IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0423
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0423

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0423{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0423
	one.SetOne()
	e.Sub(&qe_nocarry_0423, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0423{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0423{0, uint64(i)})
	}
...
func TestE_nocarry_0423NegZero(t *testing.T) {
	var a, b e_nocarry_0423
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0423Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0423, len(staticTestValues))
...
func TestE_nocarry_0423Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0423) bool {
			var b e_nocarry_0423
...
func TestE_nocarry_0423InverseExp(t *testing.T) {
...
func TestE_nocarry_0423MulByConstants(t *testing.T) {
...
func TestE_nocarry_0423Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0423) bool {
...
func TestE_nocarry_0423LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0423Halve(t *testing.T) {
...
func TestE_nocarry_0423FromMont(t *testing.T) {
...
type testPaire_nocarry_0423 struct {
	element e_nocarry_0423
	bigint  big.Int
}

func (z *e_nocarry_0423) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0423[6] {
		return true
	}
	if z[6] < qe_nocarry_0423[6] {
		return false
	...
	return z[0] >= qe_nocarry_0423[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0423

		g.element = e_nocarry_0423{
		...
		if qe_nocarry_0423[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0423[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0423 {
			var g e_nocarry_0423
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0423[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0423[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0423[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0423[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0423[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0423[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0423[6], carry)
...
func Benchmarke_nocarry_0423InverseNew(b *testing.B) {
	var x e_nocarry_0423
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0423
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0423
		var xInv e_nocarry_0423
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0423
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0423
...
func testLinearComb(t *testing.T, x *e_nocarry_0423, xC int64, y *e_nocarry_0423, yC int64) {
	...
	var z e_nocarry_0423
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0423, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0423
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0423, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0423
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0423, xHi uint64) {
	var res e_nocarry_0423
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0423) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0423) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0423, c int64, result *e_nocarry_0423, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0423) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0423) uint64 {
