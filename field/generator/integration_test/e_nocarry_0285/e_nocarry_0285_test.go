...
var benchRese_nocarry_0285 e_nocarry_0285

func BenchmarkE_nocarry_0285SetBytes(b *testing.B) {
	var x e_nocarry_0285
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0285MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0285.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0285)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0285)
		}
	})
}

func BenchmarkE_nocarry_0285Inverse(b *testing.B) {
	var x e_nocarry_0285
	x.SetRandom()
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0285Butterfly(b *testing.B) {
	var x e_nocarry_0285
	x.SetRandom()
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0285)
	}
}

func BenchmarkE_nocarry_0285Exp(b *testing.B) {
	var x e_nocarry_0285
	x.SetRandom()
	benchRese_nocarry_0285.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0285Double(b *testing.B) {
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Double(&benchRese_nocarry_0285)
	}
}

func BenchmarkE_nocarry_0285Add(b *testing.B) {
	var x e_nocarry_0285
	x.SetRandom()
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Add(&x, &benchRese_nocarry_0285)
	}
}

func BenchmarkE_nocarry_0285Sub(b *testing.B) {
	var x e_nocarry_0285
	x.SetRandom()
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Sub(&x, &benchRese_nocarry_0285)
	}
}

func BenchmarkE_nocarry_0285Neg(b *testing.B) {
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Neg(&benchRese_nocarry_0285)
	}
}

func BenchmarkE_nocarry_0285Div(b *testing.B) {
	var x e_nocarry_0285
	x.SetRandom()
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Div(&x, &benchRese_nocarry_0285)
	}
}

func BenchmarkE_nocarry_0285FromMont(b *testing.B) {
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.FromMont()
	}
}

func BenchmarkE_nocarry_0285ToMont(b *testing.B) {
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.ToMont()
	}
}
func BenchmarkE_nocarry_0285Square(b *testing.B) {
	benchRese_nocarry_0285.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Square(&benchRese_nocarry_0285)
	}
}

func BenchmarkE_nocarry_0285Sqrt(b *testing.B) {
	var a e_nocarry_0285
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0285Mul(b *testing.B) {
	x := e_nocarry_0285{
		9167077112746028902,
	...
	benchRese_nocarry_0285.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Mul(&benchRese_nocarry_0285, &x)
	}
}

func BenchmarkE_nocarry_0285Cmp(b *testing.B) {
	x := e_nocarry_0285{
		9167077112746028902,
		12801328159738999404,
		14787346905386395016,
	...
	benchRese_nocarry_0285 = x
	benchRese_nocarry_0285[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0285.Cmp(&x)
	}
}

func TestE_nocarry_0285Cmp(t *testing.T) {
	var x, y e_nocarry_0285
...
func TestE_nocarry_0285IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0285
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0285

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0285{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0285
	one.SetOne()
	e.Sub(&qe_nocarry_0285, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0285{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0285{0, uint64(i)})
	}
...
func TestE_nocarry_0285NegZero(t *testing.T) {
	var a, b e_nocarry_0285
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0285Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0285, len(staticTestValues))
...
func TestE_nocarry_0285Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0285) bool {
			var b e_nocarry_0285
...
func TestE_nocarry_0285InverseExp(t *testing.T) {
...
func TestE_nocarry_0285MulByConstants(t *testing.T) {
...
func TestE_nocarry_0285Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0285) bool {
...
func TestE_nocarry_0285LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0285Halve(t *testing.T) {
...
func TestE_nocarry_0285FromMont(t *testing.T) {
...
type testPaire_nocarry_0285 struct {
	element e_nocarry_0285
	bigint  big.Int
}

func (z *e_nocarry_0285) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0285[4] {
		return true
	}
	if z[4] < qe_nocarry_0285[4] {
		return false
	...
	return z[0] >= qe_nocarry_0285[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0285

		g.element = e_nocarry_0285{
		...
		if qe_nocarry_0285[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0285[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0285 {
			var g e_nocarry_0285
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0285[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0285[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0285[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0285[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0285[4], carry)
...
func Benchmarke_nocarry_0285InverseNew(b *testing.B) {
	var x e_nocarry_0285
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0285
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0285
		var xInv e_nocarry_0285
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0285
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0285
...
func testLinearComb(t *testing.T, x *e_nocarry_0285, xC int64, y *e_nocarry_0285, yC int64) {
	...
	var z e_nocarry_0285
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0285, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0285
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0285, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0285
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0285, xHi uint64) {
	var res e_nocarry_0285
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0285) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0285) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0285, c int64, result *e_nocarry_0285, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0285) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0285) uint64 {
