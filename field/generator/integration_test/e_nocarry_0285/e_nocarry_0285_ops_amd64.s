...
// modulus q
DATA q<>+0(SB)/8, $0x2efb641138f0a5ef
DATA q<>+8(SB)/8, $0x71f34790e8f2b76e
DATA q<>+16(SB)/8, $0xbeb4e395c4b133e0
DATA q<>+24(SB)/8, $0xb6a38901422dae63
DATA q<>+32(SB)/8, $0x00000000186cea61
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0db22c41df22d6f1
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x2efb641138f0a5ef, R9
	MOVQ    $0x71f34790e8f2b76e, R10
	MOVQ    $0xbeb4e395c4b133e0, R11
	MOVQ    $0xb6a38901422dae63, R12
	MOVQ    $0x00000000186cea61, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x71f34790e8f2b76e, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xbeb4e395c4b133e0, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xb6a38901422dae63, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00000000186cea61, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x2efb641138f0a5ef, CX
	MOVQ    $0x71f34790e8f2b76e, BX
	MOVQ    $0xbeb4e395c4b133e0, SI
	MOVQ    $0xb6a38901422dae63, DI
	MOVQ    $0x00000000186cea61, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
