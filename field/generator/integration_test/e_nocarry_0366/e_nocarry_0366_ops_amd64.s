...
// modulus q
DATA q<>+0(SB)/8, $0x280f6fcaf6541e6b
DATA q<>+8(SB)/8, $0x09d871844a1f8df4
DATA q<>+16(SB)/8, $0xecc632e7536cbe1a
DATA q<>+24(SB)/8, $0x769a79d4f3479ff0
DATA q<>+32(SB)/8, $0x2ddd88696a09eb0a
DATA q<>+40(SB)/8, $0x00003dfd6c6b579b
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x32da65d886dd61bd
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x280f6fcaf6541e6b, R10
	MOVQ    $0x09d871844a1f8df4, R11
	MOVQ    $0xecc632e7536cbe1a, R12
	MOVQ    $0x769a79d4f3479ff0, R13
	MOVQ    $0x2ddd88696a09eb0a, R14
	MOVQ    $0x00003dfd6c6b579b, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x09d871844a1f8df4, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xecc632e7536cbe1a, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x769a79d4f3479ff0, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x2ddd88696a09eb0a, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00003dfd6c6b579b, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x280f6fcaf6541e6b, CX
	MOVQ    $0x09d871844a1f8df4, BX
	MOVQ    $0xecc632e7536cbe1a, SI
	MOVQ    $0x769a79d4f3479ff0, DI
	MOVQ    $0x2ddd88696a09eb0a, R8
	MOVQ    $0x00003dfd6c6b579b, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
