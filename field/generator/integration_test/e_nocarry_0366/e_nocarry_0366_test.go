...
var benchRese_nocarry_0366 e_nocarry_0366

func BenchmarkE_nocarry_0366SetBytes(b *testing.B) {
	var x e_nocarry_0366
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0366MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0366.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0366)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0366)
		}
	})
}

func BenchmarkE_nocarry_0366Inverse(b *testing.B) {
	var x e_nocarry_0366
	x.SetRandom()
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0366Butterfly(b *testing.B) {
	var x e_nocarry_0366
	x.SetRandom()
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0366)
	}
}

func BenchmarkE_nocarry_0366Exp(b *testing.B) {
	var x e_nocarry_0366
	x.SetRandom()
	benchRese_nocarry_0366.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0366Double(b *testing.B) {
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Double(&benchRese_nocarry_0366)
	}
}

func BenchmarkE_nocarry_0366Add(b *testing.B) {
	var x e_nocarry_0366
	x.SetRandom()
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Add(&x, &benchRese_nocarry_0366)
	}
}

func BenchmarkE_nocarry_0366Sub(b *testing.B) {
	var x e_nocarry_0366
	x.SetRandom()
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Sub(&x, &benchRese_nocarry_0366)
	}
}

func BenchmarkE_nocarry_0366Neg(b *testing.B) {
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Neg(&benchRese_nocarry_0366)
	}
}

func BenchmarkE_nocarry_0366Div(b *testing.B) {
	var x e_nocarry_0366
	x.SetRandom()
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Div(&x, &benchRese_nocarry_0366)
	}
}

func BenchmarkE_nocarry_0366FromMont(b *testing.B) {
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.FromMont()
	}
}

func BenchmarkE_nocarry_0366ToMont(b *testing.B) {
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.ToMont()
	}
}
func BenchmarkE_nocarry_0366Square(b *testing.B) {
	benchRese_nocarry_0366.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Square(&benchRese_nocarry_0366)
	}
}

func BenchmarkE_nocarry_0366Sqrt(b *testing.B) {
	var a e_nocarry_0366
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0366Mul(b *testing.B) {
	x := e_nocarry_0366{
	...
	benchRese_nocarry_0366.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Mul(&benchRese_nocarry_0366, &x)
	}
}

func BenchmarkE_nocarry_0366Cmp(b *testing.B) {
	x := e_nocarry_0366{
		14339064168981407889,
		2479118429320010857,
		5046642207270647107,
	...
	benchRese_nocarry_0366 = x
	benchRese_nocarry_0366[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0366.Cmp(&x)
	}
}

func TestE_nocarry_0366Cmp(t *testing.T) {
	var x, y e_nocarry_0366
...
func TestE_nocarry_0366IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0366
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0366

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0366{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0366
	one.SetOne()
	e.Sub(&qe_nocarry_0366, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0366{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0366{0, uint64(i)})
	}
...
func TestE_nocarry_0366NegZero(t *testing.T) {
	var a, b e_nocarry_0366
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0366Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0366, len(staticTestValues))
...
func TestE_nocarry_0366Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0366) bool {
			var b e_nocarry_0366
...
func TestE_nocarry_0366InverseExp(t *testing.T) {
...
func TestE_nocarry_0366MulByConstants(t *testing.T) {
...
func TestE_nocarry_0366Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0366) bool {
...
func TestE_nocarry_0366LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0366Halve(t *testing.T) {
...
func TestE_nocarry_0366FromMont(t *testing.T) {
...
type testPaire_nocarry_0366 struct {
	element e_nocarry_0366
	bigint  big.Int
}

func (z *e_nocarry_0366) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0366[5] {
		return true
	}
	if z[5] < qe_nocarry_0366[5] {
		return false
	...
	return z[0] >= qe_nocarry_0366[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0366

		g.element = e_nocarry_0366{
		...
		if qe_nocarry_0366[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0366[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0366 {
			var g e_nocarry_0366
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0366[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0366[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0366[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0366[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0366[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0366[5], carry)
...
func Benchmarke_nocarry_0366InverseNew(b *testing.B) {
	var x e_nocarry_0366
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0366
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0366
		var xInv e_nocarry_0366
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0366
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0366
...
func testLinearComb(t *testing.T, x *e_nocarry_0366, xC int64, y *e_nocarry_0366, yC int64) {
	...
	var z e_nocarry_0366
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0366, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0366
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0366, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0366
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0366, xHi uint64) {
	var res e_nocarry_0366
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0366) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0366) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0366, c int64, result *e_nocarry_0366, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0366) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0366) uint64 {
