...
var benchRese_nocarry_0427 e_nocarry_0427

func BenchmarkE_nocarry_0427SetBytes(b *testing.B) {
	var x e_nocarry_0427
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0427MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0427.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0427)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0427)
		}
	})
}

func BenchmarkE_nocarry_0427Inverse(b *testing.B) {
	var x e_nocarry_0427
	x.SetRandom()
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0427Butterfly(b *testing.B) {
	var x e_nocarry_0427
	x.SetRandom()
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0427)
	}
}

func BenchmarkE_nocarry_0427Exp(b *testing.B) {
	var x e_nocarry_0427
	x.SetRandom()
	benchRese_nocarry_0427.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0427Double(b *testing.B) {
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Double(&benchRese_nocarry_0427)
	}
}

func BenchmarkE_nocarry_0427Add(b *testing.B) {
	var x e_nocarry_0427
	x.SetRandom()
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Add(&x, &benchRese_nocarry_0427)
	}
}

func BenchmarkE_nocarry_0427Sub(b *testing.B) {
	var x e_nocarry_0427
	x.SetRandom()
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Sub(&x, &benchRese_nocarry_0427)
	}
}

func BenchmarkE_nocarry_0427Neg(b *testing.B) {
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Neg(&benchRese_nocarry_0427)
	}
}

func BenchmarkE_nocarry_0427Div(b *testing.B) {
	var x e_nocarry_0427
	x.SetRandom()
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Div(&x, &benchRese_nocarry_0427)
	}
}

func BenchmarkE_nocarry_0427FromMont(b *testing.B) {
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.FromMont()
	}
}

func BenchmarkE_nocarry_0427ToMont(b *testing.B) {
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.ToMont()
	}
}
func BenchmarkE_nocarry_0427Square(b *testing.B) {
	benchRese_nocarry_0427.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Square(&benchRese_nocarry_0427)
	}
}

func BenchmarkE_nocarry_0427Sqrt(b *testing.B) {
	var a e_nocarry_0427
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0427Mul(b *testing.B) {
	x := e_nocarry_0427{
	...
	benchRese_nocarry_0427.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Mul(&benchRese_nocarry_0427, &x)
	}
}

func BenchmarkE_nocarry_0427Cmp(b *testing.B) {
	x := e_nocarry_0427{
		11771130865264115510,
		2471910407778535443,
		15207697302980907001,
	...
	benchRese_nocarry_0427 = x
	benchRese_nocarry_0427[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0427.Cmp(&x)
	}
}

func TestE_nocarry_0427Cmp(t *testing.T) {
	var x, y e_nocarry_0427
...
func TestE_nocarry_0427IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0427
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0427

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0427{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0427
	one.SetOne()
	e.Sub(&qe_nocarry_0427, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0427{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0427{0, uint64(i)})
	}
...
func TestE_nocarry_0427NegZero(t *testing.T) {
	var a, b e_nocarry_0427
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0427Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0427, len(staticTestValues))
...
func TestE_nocarry_0427Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0427) bool {
			var b e_nocarry_0427
...
func TestE_nocarry_0427InverseExp(t *testing.T) {
...
func TestE_nocarry_0427MulByConstants(t *testing.T) {
...
func TestE_nocarry_0427Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0427) bool {
...
func TestE_nocarry_0427LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0427Halve(t *testing.T) {
...
func TestE_nocarry_0427FromMont(t *testing.T) {
...
type testPaire_nocarry_0427 struct {
	element e_nocarry_0427
	bigint  big.Int
}

func (z *e_nocarry_0427) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0427[6] {
		return true
	}
	if z[6] < qe_nocarry_0427[6] {
		return false
	...
	return z[0] >= qe_nocarry_0427[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0427

		g.element = e_nocarry_0427{
		...
		if qe_nocarry_0427[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0427[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0427 {
			var g e_nocarry_0427
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0427[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0427[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0427[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0427[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0427[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0427[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0427[6], carry)
...
func Benchmarke_nocarry_0427InverseNew(b *testing.B) {
	var x e_nocarry_0427
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0427
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0427
		var xInv e_nocarry_0427
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0427
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0427
...
func testLinearComb(t *testing.T, x *e_nocarry_0427, xC int64, y *e_nocarry_0427, yC int64) {
	...
	var z e_nocarry_0427
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0427, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0427
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0427, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0427
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0427, xHi uint64) {
	var res e_nocarry_0427
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0427) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0427) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0427, c int64, result *e_nocarry_0427, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0427) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0427) uint64 {
