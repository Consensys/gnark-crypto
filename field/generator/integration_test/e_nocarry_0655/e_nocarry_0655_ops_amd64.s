...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x1e2870f254b08f2d, R14
	ADDQ R14, AX
	MOVQ $0xadcb9ae5db9a3b3c, R14
	ADCQ R14, DX
	MOVQ $0x12cb9dd5f67cbce1, R14
	ADCQ R14, CX
	MOVQ $0xc0b218678fd2ccda, R14
	ADCQ R14, BX
	MOVQ $0x91397384b433e24a, R14
	ADCQ R14, SI
	MOVQ $0x141f842daaa56c5d, R14
	ADCQ R14, DI
	MOVQ $0xf9e4e2862b7831c6, R14
	ADCQ R14, R8
	MOVQ $0x7bb1fdfcd1c00ce9, R14
	ADCQ R14, R9
	MOVQ $0x0cd2da0a3fbd3c6c, R14
	ADCQ R14, R10
	MOVQ $0xfa65c9eb98a45db3, R14
	ADCQ R14, R11
	MOVQ $0x00000000000073b6, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x1e2870f254b08f2d, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xadcb9ae5db9a3b3c, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x12cb9dd5f67cbce1, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xc0b218678fd2ccda, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x91397384b433e24a, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x141f842daaa56c5d, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xf9e4e2862b7831c6, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x7bb1fdfcd1c00ce9, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x0cd2da0a3fbd3c6c, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xfa65c9eb98a45db3, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000000000073b6, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x1e2870f254b08f2d, AX
	ADDQ AX, DX
	MOVQ $0xadcb9ae5db9a3b3c, AX
	ADCQ AX, CX
	MOVQ $0x12cb9dd5f67cbce1, AX
	ADCQ AX, BX
	MOVQ $0xc0b218678fd2ccda, AX
	ADCQ AX, SI
	MOVQ $0x91397384b433e24a, AX
	ADCQ AX, DI
	MOVQ $0x141f842daaa56c5d, AX
	ADCQ AX, R8
	MOVQ $0xf9e4e2862b7831c6, AX
	ADCQ AX, R9
	MOVQ $0x7bb1fdfcd1c00ce9, AX
	ADCQ AX, R10
	MOVQ $0x0cd2da0a3fbd3c6c, AX
	ADCQ AX, R11
	MOVQ $0xfa65c9eb98a45db3, AX
	ADCQ AX, R12
	MOVQ $0x00000000000073b6, AX
	ADCQ AX, R13
