...
// modulus q
DATA q<>+0(SB)/8, $0x1e2870f254b08f2d
DATA q<>+8(SB)/8, $0xadcb9ae5db9a3b3c
DATA q<>+16(SB)/8, $0x12cb9dd5f67cbce1
DATA q<>+24(SB)/8, $0xc0b218678fd2ccda
DATA q<>+32(SB)/8, $0x91397384b433e24a
DATA q<>+40(SB)/8, $0x141f842daaa56c5d
DATA q<>+48(SB)/8, $0xf9e4e2862b7831c6
DATA q<>+56(SB)/8, $0x7bb1fdfcd1c00ce9
DATA q<>+64(SB)/8, $0x0cd2da0a3fbd3c6c
DATA q<>+72(SB)/8, $0xfa65c9eb98a45db3
DATA q<>+80(SB)/8, $0x00000000000073b6
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x68af7627bf6a675b
