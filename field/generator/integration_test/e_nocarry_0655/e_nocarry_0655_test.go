...
var benchRese_nocarry_0655 e_nocarry_0655

func BenchmarkE_nocarry_0655SetBytes(b *testing.B) {
	var x e_nocarry_0655
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0655MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0655.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0655)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0655)
		}
	})
}

func BenchmarkE_nocarry_0655Inverse(b *testing.B) {
	var x e_nocarry_0655
	x.SetRandom()
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0655Butterfly(b *testing.B) {
	var x e_nocarry_0655
	x.SetRandom()
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0655)
	}
}

func BenchmarkE_nocarry_0655Exp(b *testing.B) {
	var x e_nocarry_0655
	x.SetRandom()
	benchRese_nocarry_0655.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0655Double(b *testing.B) {
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Double(&benchRese_nocarry_0655)
	}
}

func BenchmarkE_nocarry_0655Add(b *testing.B) {
	var x e_nocarry_0655
	x.SetRandom()
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Add(&x, &benchRese_nocarry_0655)
	}
}

func BenchmarkE_nocarry_0655Sub(b *testing.B) {
	var x e_nocarry_0655
	x.SetRandom()
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Sub(&x, &benchRese_nocarry_0655)
	}
}

func BenchmarkE_nocarry_0655Neg(b *testing.B) {
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Neg(&benchRese_nocarry_0655)
	}
}

func BenchmarkE_nocarry_0655Div(b *testing.B) {
	var x e_nocarry_0655
	x.SetRandom()
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Div(&x, &benchRese_nocarry_0655)
	}
}

func BenchmarkE_nocarry_0655FromMont(b *testing.B) {
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.FromMont()
	}
}

func BenchmarkE_nocarry_0655ToMont(b *testing.B) {
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.ToMont()
	}
}
func BenchmarkE_nocarry_0655Square(b *testing.B) {
	benchRese_nocarry_0655.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Square(&benchRese_nocarry_0655)
	}
}

func BenchmarkE_nocarry_0655Sqrt(b *testing.B) {
	var a e_nocarry_0655
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0655Mul(b *testing.B) {
	x := e_nocarry_0655{
	...
	benchRese_nocarry_0655.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Mul(&benchRese_nocarry_0655, &x)
	}
}

func BenchmarkE_nocarry_0655Cmp(b *testing.B) {
	x := e_nocarry_0655{
		12680943165797000187,
		11384879727736003264,
		11633389673682525964,
	...
	benchRese_nocarry_0655 = x
	benchRese_nocarry_0655[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0655.Cmp(&x)
	}
}

func TestE_nocarry_0655Cmp(t *testing.T) {
	var x, y e_nocarry_0655
...
func TestE_nocarry_0655IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0655
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0655

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0655{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0655
	one.SetOne()
	e.Sub(&qe_nocarry_0655, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0655{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0655{0, uint64(i)})
	}
...
func TestE_nocarry_0655NegZero(t *testing.T) {
	var a, b e_nocarry_0655
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0655Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0655, len(staticTestValues))
...
func TestE_nocarry_0655Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0655) bool {
			var b e_nocarry_0655
...
func TestE_nocarry_0655InverseExp(t *testing.T) {
...
func TestE_nocarry_0655MulByConstants(t *testing.T) {
...
func TestE_nocarry_0655Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0655) bool {
...
func TestE_nocarry_0655LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0655Halve(t *testing.T) {
...
func TestE_nocarry_0655FromMont(t *testing.T) {
...
type testPaire_nocarry_0655 struct {
	element e_nocarry_0655
	bigint  big.Int
}

func (z *e_nocarry_0655) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0655[10] {
		return true
	}
	if z[10] < qe_nocarry_0655[10] {
		return false
	...
	return z[0] >= qe_nocarry_0655[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0655

		g.element = e_nocarry_0655{
		...
		if qe_nocarry_0655[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0655[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0655 {
			var g e_nocarry_0655
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0655[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0655[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0655[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0655[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0655[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0655[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0655[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0655[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0655[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0655[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0655[10], carry)
...
func Benchmarke_nocarry_0655InverseNew(b *testing.B) {
	var x e_nocarry_0655
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0655
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0655
		var xInv e_nocarry_0655
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0655
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0655
...
func testLinearComb(t *testing.T, x *e_nocarry_0655, xC int64, y *e_nocarry_0655, yC int64) {
	...
	var z e_nocarry_0655
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0655, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0655
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0655, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0655
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0655, xHi uint64) {
	var res e_nocarry_0655
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0655) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0655) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0655, c int64, result *e_nocarry_0655, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0655) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0655) uint64 {
