...
var benchRese_nocarry_0262 e_nocarry_0262

func BenchmarkE_nocarry_0262SetBytes(b *testing.B) {
	var x e_nocarry_0262
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0262MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0262.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0262)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0262)
		}
	})
}

func BenchmarkE_nocarry_0262Inverse(b *testing.B) {
	var x e_nocarry_0262
	x.SetRandom()
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0262Butterfly(b *testing.B) {
	var x e_nocarry_0262
	x.SetRandom()
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0262)
	}
}

func BenchmarkE_nocarry_0262Exp(b *testing.B) {
	var x e_nocarry_0262
	x.SetRandom()
	benchRese_nocarry_0262.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0262Double(b *testing.B) {
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Double(&benchRese_nocarry_0262)
	}
}

func BenchmarkE_nocarry_0262Add(b *testing.B) {
	var x e_nocarry_0262
	x.SetRandom()
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Add(&x, &benchRese_nocarry_0262)
	}
}

func BenchmarkE_nocarry_0262Sub(b *testing.B) {
	var x e_nocarry_0262
	x.SetRandom()
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Sub(&x, &benchRese_nocarry_0262)
	}
}

func BenchmarkE_nocarry_0262Neg(b *testing.B) {
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Neg(&benchRese_nocarry_0262)
	}
}

func BenchmarkE_nocarry_0262Div(b *testing.B) {
	var x e_nocarry_0262
	x.SetRandom()
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Div(&x, &benchRese_nocarry_0262)
	}
}

func BenchmarkE_nocarry_0262FromMont(b *testing.B) {
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.FromMont()
	}
}

func BenchmarkE_nocarry_0262ToMont(b *testing.B) {
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.ToMont()
	}
}
func BenchmarkE_nocarry_0262Square(b *testing.B) {
	benchRese_nocarry_0262.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Square(&benchRese_nocarry_0262)
	}
}

func BenchmarkE_nocarry_0262Sqrt(b *testing.B) {
	var a e_nocarry_0262
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0262Mul(b *testing.B) {
	x := e_nocarry_0262{
		9462416439442197176,
		9499834315965772871,
		9603820766528643034,
	...
	benchRese_nocarry_0262.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Mul(&benchRese_nocarry_0262, &x)
	}
}

func BenchmarkE_nocarry_0262Cmp(b *testing.B) {
	x := e_nocarry_0262{
		9462416439442197176,
		9499834315965772871,
		9603820766528643034,
	...
	benchRese_nocarry_0262 = x
	benchRese_nocarry_0262[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0262.Cmp(&x)
	}
}

func TestE_nocarry_0262Cmp(t *testing.T) {
	var x, y e_nocarry_0262
...
func TestE_nocarry_0262IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0262
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0262

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0262{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0262
	one.SetOne()
	e.Sub(&qe_nocarry_0262, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0262{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0262{0, uint64(i)})
	}
...
func TestE_nocarry_0262NegZero(t *testing.T) {
	var a, b e_nocarry_0262
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0262Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0262, len(staticTestValues))
...
func TestE_nocarry_0262Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0262) bool {
			var b e_nocarry_0262
...
func TestE_nocarry_0262InverseExp(t *testing.T) {
...
func TestE_nocarry_0262MulByConstants(t *testing.T) {
...
func TestE_nocarry_0262Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0262) bool {
...
func TestE_nocarry_0262LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0262Halve(t *testing.T) {
...
func TestE_nocarry_0262FromMont(t *testing.T) {
...
type testPaire_nocarry_0262 struct {
	element e_nocarry_0262
	bigint  big.Int
}

func (z *e_nocarry_0262) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0262[4] {
		return true
	}
	if z[4] < qe_nocarry_0262[4] {
		return false
	...
	return z[0] >= qe_nocarry_0262[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0262

		g.element = e_nocarry_0262{
		...
		if qe_nocarry_0262[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0262[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0262 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0262[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0262[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0262[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0262[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0262[4], carry)
...
func Benchmarke_nocarry_0262InverseNew(b *testing.B) {
	var x e_nocarry_0262
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0262
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0262
		var xInv e_nocarry_0262
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0262
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0262
...
func testLinearComb(t *testing.T, x *e_nocarry_0262, xC int64, y *e_nocarry_0262, yC int64) {
	...
	var z e_nocarry_0262
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0262, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0262
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0262, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0262
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0262, xHi uint64) {
	var res e_nocarry_0262
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0262) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0262) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0262, c int64, result *e_nocarry_0262, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0262) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0262) uint64 {
