...
// modulus q
DATA q<>+0(SB)/8, $0xe63159d37f302589
DATA q<>+8(SB)/8, $0x43fe31bf4a3750be
DATA q<>+16(SB)/8, $0x0bdb96718404ca49
DATA q<>+24(SB)/8, $0xfd7c03965d69cca5
DATA q<>+32(SB)/8, $0x0000000000000034
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xb05d35ee4fca1f47
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xe63159d37f302589, R9
	MOVQ    $0x43fe31bf4a3750be, R10
	MOVQ    $0x0bdb96718404ca49, R11
	MOVQ    $0xfd7c03965d69cca5, R12
	MOVQ    $0x0000000000000034, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x43fe31bf4a3750be, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x0bdb96718404ca49, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xfd7c03965d69cca5, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000000034, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xe63159d37f302589, CX
	MOVQ    $0x43fe31bf4a3750be, BX
	MOVQ    $0x0bdb96718404ca49, SI
	MOVQ    $0xfd7c03965d69cca5, DI
	MOVQ    $0x0000000000000034, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
