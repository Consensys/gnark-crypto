...
var benchRese_nocarry_0305 e_nocarry_0305

func BenchmarkE_nocarry_0305SetBytes(b *testing.B) {
	var x e_nocarry_0305
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0305MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0305.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0305)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0305)
		}
	})
}

func BenchmarkE_nocarry_0305Inverse(b *testing.B) {
	var x e_nocarry_0305
	x.SetRandom()
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0305Butterfly(b *testing.B) {
	var x e_nocarry_0305
	x.SetRandom()
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0305)
	}
}

func BenchmarkE_nocarry_0305Exp(b *testing.B) {
	var x e_nocarry_0305
	x.SetRandom()
	benchRese_nocarry_0305.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0305Double(b *testing.B) {
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Double(&benchRese_nocarry_0305)
	}
}

func BenchmarkE_nocarry_0305Add(b *testing.B) {
	var x e_nocarry_0305
	x.SetRandom()
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Add(&x, &benchRese_nocarry_0305)
	}
}

func BenchmarkE_nocarry_0305Sub(b *testing.B) {
	var x e_nocarry_0305
	x.SetRandom()
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Sub(&x, &benchRese_nocarry_0305)
	}
}

func BenchmarkE_nocarry_0305Neg(b *testing.B) {
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Neg(&benchRese_nocarry_0305)
	}
}

func BenchmarkE_nocarry_0305Div(b *testing.B) {
	var x e_nocarry_0305
	x.SetRandom()
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Div(&x, &benchRese_nocarry_0305)
	}
}

func BenchmarkE_nocarry_0305FromMont(b *testing.B) {
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.FromMont()
	}
}

func BenchmarkE_nocarry_0305ToMont(b *testing.B) {
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.ToMont()
	}
}
func BenchmarkE_nocarry_0305Square(b *testing.B) {
	benchRese_nocarry_0305.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Square(&benchRese_nocarry_0305)
	}
}

func BenchmarkE_nocarry_0305Sqrt(b *testing.B) {
	var a e_nocarry_0305
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0305Mul(b *testing.B) {
	x := e_nocarry_0305{
	...
	benchRese_nocarry_0305.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Mul(&benchRese_nocarry_0305, &x)
	}
}

func BenchmarkE_nocarry_0305Cmp(b *testing.B) {
	x := e_nocarry_0305{
		11382733049484270745,
		11148115681938244771,
		18190542141790047705,
	...
	benchRese_nocarry_0305 = x
	benchRese_nocarry_0305[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0305.Cmp(&x)
	}
}

func TestE_nocarry_0305Cmp(t *testing.T) {
	var x, y e_nocarry_0305
...
func TestE_nocarry_0305IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0305
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0305

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0305{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0305
	one.SetOne()
	e.Sub(&qe_nocarry_0305, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0305{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0305{0, uint64(i)})
	}
...
func TestE_nocarry_0305NegZero(t *testing.T) {
	var a, b e_nocarry_0305
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0305Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0305, len(staticTestValues))
...
func TestE_nocarry_0305Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0305) bool {
			var b e_nocarry_0305
...
func TestE_nocarry_0305InverseExp(t *testing.T) {
...
func TestE_nocarry_0305MulByConstants(t *testing.T) {
...
func TestE_nocarry_0305Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0305) bool {
...
func TestE_nocarry_0305LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0305Halve(t *testing.T) {
...
func TestE_nocarry_0305FromMont(t *testing.T) {
...
type testPaire_nocarry_0305 struct {
	element e_nocarry_0305
	bigint  big.Int
}

func (z *e_nocarry_0305) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0305[4] {
		return true
	}
	if z[4] < qe_nocarry_0305[4] {
		return false
	...
	return z[0] >= qe_nocarry_0305[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0305

		g.element = e_nocarry_0305{
		...
		if qe_nocarry_0305[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0305[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0305 {
			var g e_nocarry_0305
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0305[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0305[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0305[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0305[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0305[4], carry)
...
func Benchmarke_nocarry_0305InverseNew(b *testing.B) {
	var x e_nocarry_0305
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0305
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0305
		var xInv e_nocarry_0305
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0305
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0305
...
func testLinearComb(t *testing.T, x *e_nocarry_0305, xC int64, y *e_nocarry_0305, yC int64) {
	...
	var z e_nocarry_0305
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0305, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0305
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0305, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0305
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0305, xHi uint64) {
	var res e_nocarry_0305
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0305) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0305) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0305, c int64, result *e_nocarry_0305, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0305) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0305) uint64 {
