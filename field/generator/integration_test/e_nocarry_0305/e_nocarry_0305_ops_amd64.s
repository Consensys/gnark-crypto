...
// modulus q
DATA q<>+0(SB)/8, $0x55af43e6e75443ff
DATA q<>+8(SB)/8, $0x07421cc9ec013eef
DATA q<>+16(SB)/8, $0x9ebbd382d19f586c
DATA q<>+24(SB)/8, $0x65328c9a32f68d1b
DATA q<>+32(SB)/8, $0x0001d6413f11e379
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x57c6bfe7d9644401
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x55af43e6e75443ff, R9
	MOVQ    $0x07421cc9ec013eef, R10
	MOVQ    $0x9ebbd382d19f586c, R11
	MOVQ    $0x65328c9a32f68d1b, R12
	MOVQ    $0x0001d6413f11e379, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x07421cc9ec013eef, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x9ebbd382d19f586c, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x65328c9a32f68d1b, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0001d6413f11e379, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x55af43e6e75443ff, CX
	MOVQ    $0x07421cc9ec013eef, BX
	MOVQ    $0x9ebbd382d19f586c, SI
	MOVQ    $0x65328c9a32f68d1b, DI
	MOVQ    $0x0001d6413f11e379, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
