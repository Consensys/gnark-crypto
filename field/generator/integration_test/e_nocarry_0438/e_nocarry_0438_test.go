...
var benchRese_nocarry_0438 e_nocarry_0438

func BenchmarkE_nocarry_0438SetBytes(b *testing.B) {
	var x e_nocarry_0438
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0438MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0438.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0438)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0438)
		}
	})
}

func BenchmarkE_nocarry_0438Inverse(b *testing.B) {
	var x e_nocarry_0438
	x.SetRandom()
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0438Butterfly(b *testing.B) {
	var x e_nocarry_0438
	x.SetRandom()
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0438)
	}
}

func BenchmarkE_nocarry_0438Exp(b *testing.B) {
	var x e_nocarry_0438
	x.SetRandom()
	benchRese_nocarry_0438.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0438Double(b *testing.B) {
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Double(&benchRese_nocarry_0438)
	}
}

func BenchmarkE_nocarry_0438Add(b *testing.B) {
	var x e_nocarry_0438
	x.SetRandom()
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Add(&x, &benchRese_nocarry_0438)
	}
}

func BenchmarkE_nocarry_0438Sub(b *testing.B) {
	var x e_nocarry_0438
	x.SetRandom()
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Sub(&x, &benchRese_nocarry_0438)
	}
}

func BenchmarkE_nocarry_0438Neg(b *testing.B) {
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Neg(&benchRese_nocarry_0438)
	}
}

func BenchmarkE_nocarry_0438Div(b *testing.B) {
	var x e_nocarry_0438
	x.SetRandom()
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Div(&x, &benchRese_nocarry_0438)
	}
}

func BenchmarkE_nocarry_0438FromMont(b *testing.B) {
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.FromMont()
	}
}

func BenchmarkE_nocarry_0438ToMont(b *testing.B) {
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.ToMont()
	}
}
func BenchmarkE_nocarry_0438Square(b *testing.B) {
	benchRese_nocarry_0438.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Square(&benchRese_nocarry_0438)
	}
}

func BenchmarkE_nocarry_0438Sqrt(b *testing.B) {
	var a e_nocarry_0438
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0438Mul(b *testing.B) {
	x := e_nocarry_0438{
		4911557544703765209,
	...
	benchRese_nocarry_0438.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Mul(&benchRese_nocarry_0438, &x)
	}
}

func BenchmarkE_nocarry_0438Cmp(b *testing.B) {
	x := e_nocarry_0438{
		4911557544703765209,
		12036171492959057228,
		13088167099792617914,
	...
	benchRese_nocarry_0438 = x
	benchRese_nocarry_0438[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0438.Cmp(&x)
	}
}

func TestE_nocarry_0438Cmp(t *testing.T) {
	var x, y e_nocarry_0438
...
func TestE_nocarry_0438IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0438
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0438

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0438{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0438
	one.SetOne()
	e.Sub(&qe_nocarry_0438, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0438{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0438{0, uint64(i)})
	}
...
func TestE_nocarry_0438NegZero(t *testing.T) {
	var a, b e_nocarry_0438
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0438Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0438, len(staticTestValues))
...
func TestE_nocarry_0438Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0438) bool {
			var b e_nocarry_0438
...
func TestE_nocarry_0438InverseExp(t *testing.T) {
...
func TestE_nocarry_0438MulByConstants(t *testing.T) {
...
func TestE_nocarry_0438Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0438) bool {
...
func TestE_nocarry_0438LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0438Halve(t *testing.T) {
...
func TestE_nocarry_0438FromMont(t *testing.T) {
...
type testPaire_nocarry_0438 struct {
	element e_nocarry_0438
	bigint  big.Int
}

func (z *e_nocarry_0438) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0438[6] {
		return true
	}
	if z[6] < qe_nocarry_0438[6] {
		return false
	...
	return z[0] >= qe_nocarry_0438[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0438

		g.element = e_nocarry_0438{
		...
		if qe_nocarry_0438[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0438[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0438 {
			var g e_nocarry_0438
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0438[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0438[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0438[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0438[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0438[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0438[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0438[6], carry)
...
func Benchmarke_nocarry_0438InverseNew(b *testing.B) {
	var x e_nocarry_0438
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0438
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0438
		var xInv e_nocarry_0438
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0438
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0438
...
func testLinearComb(t *testing.T, x *e_nocarry_0438, xC int64, y *e_nocarry_0438, yC int64) {
	...
	var z e_nocarry_0438
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0438, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0438
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0438, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0438
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0438, xHi uint64) {
	var res e_nocarry_0438
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0438) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0438) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0438, c int64, result *e_nocarry_0438, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0438) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0438) uint64 {
