...
var benchRese_nocarry_0237 e_nocarry_0237

func BenchmarkE_nocarry_0237SetBytes(b *testing.B) {
	var x e_nocarry_0237
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0237MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0237.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0237)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0237)
		}
	})
}

func BenchmarkE_nocarry_0237Inverse(b *testing.B) {
	var x e_nocarry_0237
	x.SetRandom()
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0237Butterfly(b *testing.B) {
	var x e_nocarry_0237
	x.SetRandom()
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0237)
	}
}

func BenchmarkE_nocarry_0237Exp(b *testing.B) {
	var x e_nocarry_0237
	x.SetRandom()
	benchRese_nocarry_0237.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0237Double(b *testing.B) {
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Double(&benchRese_nocarry_0237)
	}
}

func BenchmarkE_nocarry_0237Add(b *testing.B) {
	var x e_nocarry_0237
	x.SetRandom()
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Add(&x, &benchRese_nocarry_0237)
	}
}

func BenchmarkE_nocarry_0237Sub(b *testing.B) {
	var x e_nocarry_0237
	x.SetRandom()
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Sub(&x, &benchRese_nocarry_0237)
	}
}

func BenchmarkE_nocarry_0237Neg(b *testing.B) {
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Neg(&benchRese_nocarry_0237)
	}
}

func BenchmarkE_nocarry_0237Div(b *testing.B) {
	var x e_nocarry_0237
	x.SetRandom()
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Div(&x, &benchRese_nocarry_0237)
	}
}

func BenchmarkE_nocarry_0237FromMont(b *testing.B) {
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.FromMont()
	}
}

func BenchmarkE_nocarry_0237ToMont(b *testing.B) {
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.ToMont()
	}
}
func BenchmarkE_nocarry_0237Square(b *testing.B) {
	benchRese_nocarry_0237.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Square(&benchRese_nocarry_0237)
	}
}

func BenchmarkE_nocarry_0237Sqrt(b *testing.B) {
	var a e_nocarry_0237
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0237Mul(b *testing.B) {
	x := e_nocarry_0237{
	...
	benchRese_nocarry_0237.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Mul(&benchRese_nocarry_0237, &x)
	}
}

func BenchmarkE_nocarry_0237Cmp(b *testing.B) {
	x := e_nocarry_0237{
		11724131918663035823,
		14147427280534519086,
		1178228038504342289,
	...
	benchRese_nocarry_0237 = x
	benchRese_nocarry_0237[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0237.Cmp(&x)
	}
}

func TestE_nocarry_0237Cmp(t *testing.T) {
	var x, y e_nocarry_0237
...
func TestE_nocarry_0237IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0237
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0237

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0237{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0237
	one.SetOne()
	e.Sub(&qe_nocarry_0237, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0237{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0237{0, uint64(i)})
	}
...
func TestE_nocarry_0237NegZero(t *testing.T) {
	var a, b e_nocarry_0237
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0237Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0237, len(staticTestValues))
...
func TestE_nocarry_0237Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0237) bool {
			var b e_nocarry_0237
...
func TestE_nocarry_0237InverseExp(t *testing.T) {
...
func TestE_nocarry_0237MulByConstants(t *testing.T) {
...
func TestE_nocarry_0237Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0237) bool {
...
func TestE_nocarry_0237LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0237Halve(t *testing.T) {
...
func TestE_nocarry_0237FromMont(t *testing.T) {
...
type testPaire_nocarry_0237 struct {
	element e_nocarry_0237
	bigint  big.Int
}

func (z *e_nocarry_0237) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0237[3] {
		return true
	}
	if z[3] < qe_nocarry_0237[3] {
		return false
	...
	return z[0] >= qe_nocarry_0237[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0237

		g.element = e_nocarry_0237{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0237[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0237[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0237 {
			var g e_nocarry_0237
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0237[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0237[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0237[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0237[3], carry)
...
func Benchmarke_nocarry_0237InverseNew(b *testing.B) {
	var x e_nocarry_0237
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0237
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0237
		var xInv e_nocarry_0237
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0237
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0237
...
func testLinearComb(t *testing.T, x *e_nocarry_0237, xC int64, y *e_nocarry_0237, yC int64) {
	...
	var z e_nocarry_0237
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0237, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0237
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0237, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0237
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0237, xHi uint64) {
	var res e_nocarry_0237
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0237) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0237) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0237, c int64, result *e_nocarry_0237, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0237) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0237) uint64 {
