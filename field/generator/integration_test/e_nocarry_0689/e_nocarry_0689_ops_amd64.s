...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xd028925ea918e825, R14
	ADDQ R14, AX
	MOVQ $0x90a14e6ea83d26c2, R14
	ADCQ R14, DX
	MOVQ $0x421b72518051f9c8, R14
	ADCQ R14, CX
	MOVQ $0x0c22b967eab93d4f, R14
	ADCQ R14, BX
	MOVQ $0x0971dc9c04ffe170, R14
	ADCQ R14, SI
	MOVQ $0x31b71503b573daec, R14
	ADCQ R14, DI
	MOVQ $0xf4fc720bb0449a49, R14
	ADCQ R14, R8
	MOVQ $0x237427f6579bf8fa, R14
	ADCQ R14, R9
	MOVQ $0xefcc1874bbf4dd1f, R14
	ADCQ R14, R10
	MOVQ $0xa01613a8a86ae787, R14
	ADCQ R14, R11
	MOVQ $0x00019d573c63a722, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xd028925ea918e825, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x90a14e6ea83d26c2, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x421b72518051f9c8, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x0c22b967eab93d4f, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x0971dc9c04ffe170, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x31b71503b573daec, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xf4fc720bb0449a49, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x237427f6579bf8fa, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xefcc1874bbf4dd1f, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xa01613a8a86ae787, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00019d573c63a722, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xd028925ea918e825, AX
	ADDQ AX, DX
	MOVQ $0x90a14e6ea83d26c2, AX
	ADCQ AX, CX
	MOVQ $0x421b72518051f9c8, AX
	ADCQ AX, BX
	MOVQ $0x0c22b967eab93d4f, AX
	ADCQ AX, SI
	MOVQ $0x0971dc9c04ffe170, AX
	ADCQ AX, DI
	MOVQ $0x31b71503b573daec, AX
	ADCQ AX, R8
	MOVQ $0xf4fc720bb0449a49, AX
	ADCQ AX, R9
	MOVQ $0x237427f6579bf8fa, AX
	ADCQ AX, R10
	MOVQ $0xefcc1874bbf4dd1f, AX
	ADCQ AX, R11
	MOVQ $0xa01613a8a86ae787, AX
	ADCQ AX, R12
	MOVQ $0x00019d573c63a722, AX
	ADCQ AX, R13
