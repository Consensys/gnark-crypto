...
var benchRese_nocarry_0689 e_nocarry_0689

func BenchmarkE_nocarry_0689SetBytes(b *testing.B) {
	var x e_nocarry_0689
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0689MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0689.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0689)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0689)
		}
	})
}

func BenchmarkE_nocarry_0689Inverse(b *testing.B) {
	var x e_nocarry_0689
	x.SetRandom()
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0689Butterfly(b *testing.B) {
	var x e_nocarry_0689
	x.SetRandom()
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0689)
	}
}

func BenchmarkE_nocarry_0689Exp(b *testing.B) {
	var x e_nocarry_0689
	x.SetRandom()
	benchRese_nocarry_0689.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0689Double(b *testing.B) {
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Double(&benchRese_nocarry_0689)
	}
}

func BenchmarkE_nocarry_0689Add(b *testing.B) {
	var x e_nocarry_0689
	x.SetRandom()
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Add(&x, &benchRese_nocarry_0689)
	}
}

func BenchmarkE_nocarry_0689Sub(b *testing.B) {
	var x e_nocarry_0689
	x.SetRandom()
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Sub(&x, &benchRese_nocarry_0689)
	}
}

func BenchmarkE_nocarry_0689Neg(b *testing.B) {
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Neg(&benchRese_nocarry_0689)
	}
}

func BenchmarkE_nocarry_0689Div(b *testing.B) {
	var x e_nocarry_0689
	x.SetRandom()
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Div(&x, &benchRese_nocarry_0689)
	}
}

func BenchmarkE_nocarry_0689FromMont(b *testing.B) {
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.FromMont()
	}
}

func BenchmarkE_nocarry_0689ToMont(b *testing.B) {
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.ToMont()
	}
}
func BenchmarkE_nocarry_0689Square(b *testing.B) {
	benchRese_nocarry_0689.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Square(&benchRese_nocarry_0689)
	}
}

func BenchmarkE_nocarry_0689Sqrt(b *testing.B) {
	var a e_nocarry_0689
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0689Mul(b *testing.B) {
	x := e_nocarry_0689{
	...
	benchRese_nocarry_0689.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Mul(&benchRese_nocarry_0689, &x)
	}
}

func BenchmarkE_nocarry_0689Cmp(b *testing.B) {
	x := e_nocarry_0689{
		15406261552415745662,
		3144656985187455790,
		2993383159341635830,
	...
	benchRese_nocarry_0689 = x
	benchRese_nocarry_0689[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0689.Cmp(&x)
	}
}

func TestE_nocarry_0689Cmp(t *testing.T) {
	var x, y e_nocarry_0689
...
func TestE_nocarry_0689IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0689
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0689

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0689{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0689
	one.SetOne()
	e.Sub(&qe_nocarry_0689, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0689{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0689{0, uint64(i)})
	}
...
func TestE_nocarry_0689NegZero(t *testing.T) {
	var a, b e_nocarry_0689
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0689Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0689, len(staticTestValues))
...
func TestE_nocarry_0689Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0689) bool {
			var b e_nocarry_0689
...
func TestE_nocarry_0689InverseExp(t *testing.T) {
...
func TestE_nocarry_0689MulByConstants(t *testing.T) {
...
func TestE_nocarry_0689Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0689) bool {
...
func TestE_nocarry_0689LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0689Halve(t *testing.T) {
...
func TestE_nocarry_0689FromMont(t *testing.T) {
...
type testPaire_nocarry_0689 struct {
	element e_nocarry_0689
	bigint  big.Int
}

func (z *e_nocarry_0689) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0689[10] {
		return true
	}
	if z[10] < qe_nocarry_0689[10] {
		return false
	...
	return z[0] >= qe_nocarry_0689[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0689

		g.element = e_nocarry_0689{
		...
		if qe_nocarry_0689[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0689[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0689 {
			var g e_nocarry_0689
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0689[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0689[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0689[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0689[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0689[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0689[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0689[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0689[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0689[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0689[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0689[10], carry)
...
func Benchmarke_nocarry_0689InverseNew(b *testing.B) {
	var x e_nocarry_0689
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0689
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0689
		var xInv e_nocarry_0689
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0689
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0689
...
func testLinearComb(t *testing.T, x *e_nocarry_0689, xC int64, y *e_nocarry_0689, yC int64) {
	...
	var z e_nocarry_0689
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0689, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0689
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0689, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0689
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0689, xHi uint64) {
	var res e_nocarry_0689
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0689) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0689) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0689, c int64, result *e_nocarry_0689, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0689) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0689) uint64 {
