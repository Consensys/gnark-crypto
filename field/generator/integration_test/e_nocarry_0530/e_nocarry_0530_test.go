...
var benchRese_nocarry_0530 e_nocarry_0530

func BenchmarkE_nocarry_0530SetBytes(b *testing.B) {
	var x e_nocarry_0530
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0530MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0530.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0530)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0530)
		}
	})
}

func BenchmarkE_nocarry_0530Inverse(b *testing.B) {
	var x e_nocarry_0530
	x.SetRandom()
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0530Butterfly(b *testing.B) {
	var x e_nocarry_0530
	x.SetRandom()
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0530)
	}
}

func BenchmarkE_nocarry_0530Exp(b *testing.B) {
	var x e_nocarry_0530
	x.SetRandom()
	benchRese_nocarry_0530.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0530Double(b *testing.B) {
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Double(&benchRese_nocarry_0530)
	}
}

func BenchmarkE_nocarry_0530Add(b *testing.B) {
	var x e_nocarry_0530
	x.SetRandom()
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Add(&x, &benchRese_nocarry_0530)
	}
}

func BenchmarkE_nocarry_0530Sub(b *testing.B) {
	var x e_nocarry_0530
	x.SetRandom()
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Sub(&x, &benchRese_nocarry_0530)
	}
}

func BenchmarkE_nocarry_0530Neg(b *testing.B) {
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Neg(&benchRese_nocarry_0530)
	}
}

func BenchmarkE_nocarry_0530Div(b *testing.B) {
	var x e_nocarry_0530
	x.SetRandom()
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Div(&x, &benchRese_nocarry_0530)
	}
}

func BenchmarkE_nocarry_0530FromMont(b *testing.B) {
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.FromMont()
	}
}

func BenchmarkE_nocarry_0530ToMont(b *testing.B) {
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.ToMont()
	}
}
func BenchmarkE_nocarry_0530Square(b *testing.B) {
	benchRese_nocarry_0530.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Square(&benchRese_nocarry_0530)
	}
}

func BenchmarkE_nocarry_0530Sqrt(b *testing.B) {
	var a e_nocarry_0530
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0530Mul(b *testing.B) {
	x := e_nocarry_0530{
	...
	benchRese_nocarry_0530.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Mul(&benchRese_nocarry_0530, &x)
	}
}

func BenchmarkE_nocarry_0530Cmp(b *testing.B) {
	x := e_nocarry_0530{
		17821607528114018691,
		121534088626300150,
		652014566417759229,
	...
	benchRese_nocarry_0530 = x
	benchRese_nocarry_0530[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0530.Cmp(&x)
	}
}

func TestE_nocarry_0530Cmp(t *testing.T) {
	var x, y e_nocarry_0530
...
func TestE_nocarry_0530IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0530
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0530

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0530{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0530
	one.SetOne()
	e.Sub(&qe_nocarry_0530, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0530{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0530{0, uint64(i)})
	}
...
func TestE_nocarry_0530NegZero(t *testing.T) {
	var a, b e_nocarry_0530
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0530Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0530, len(staticTestValues))
...
func TestE_nocarry_0530Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0530) bool {
			var b e_nocarry_0530
...
func TestE_nocarry_0530InverseExp(t *testing.T) {
...
func TestE_nocarry_0530MulByConstants(t *testing.T) {
...
func TestE_nocarry_0530Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0530) bool {
...
func TestE_nocarry_0530LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0530Halve(t *testing.T) {
...
func TestE_nocarry_0530FromMont(t *testing.T) {
...
type testPaire_nocarry_0530 struct {
	element e_nocarry_0530
	bigint  big.Int
}

func (z *e_nocarry_0530) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0530[8] {
		return true
	}
	if z[8] < qe_nocarry_0530[8] {
		return false
	...
	return z[0] >= qe_nocarry_0530[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0530

		g.element = e_nocarry_0530{
		...
		if qe_nocarry_0530[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0530[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0530 {
			var g e_nocarry_0530
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0530[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0530[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0530[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0530[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0530[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0530[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0530[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0530[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0530[8], carry)
...
func Benchmarke_nocarry_0530InverseNew(b *testing.B) {
	var x e_nocarry_0530
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0530
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0530
		var xInv e_nocarry_0530
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0530
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0530
...
func testLinearComb(t *testing.T, x *e_nocarry_0530, xC int64, y *e_nocarry_0530, yC int64) {
	...
	var z e_nocarry_0530
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0530, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0530
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0530, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0530
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0530, xHi uint64) {
	var res e_nocarry_0530
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0530) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0530) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0530, c int64, result *e_nocarry_0530, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0530) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0530) uint64 {
