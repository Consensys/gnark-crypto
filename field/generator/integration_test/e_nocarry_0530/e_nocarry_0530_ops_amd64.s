...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xb5db3e308d4608af, R12
	ADDQ R12, AX
	MOVQ $0x23ec13c96a928851, R12
	ADCQ R12, DX
	MOVQ $0xf0ce9900c665a132, R12
	ADCQ R12, CX
	MOVQ $0x688ed8c22ee73692, R12
	ADCQ R12, BX
	MOVQ $0xb55b85de23d1835f, R12
	ADCQ R12, SI
	MOVQ $0x2426a0a60df30d4d, R12
	ADCQ R12, DI
	MOVQ $0x7aef02b47135610b, R12
	ADCQ R12, R8
	MOVQ $0x236f58976a80ccdb, R12
	ADCQ R12, R9
	MOVQ $0x000000000003f4f8, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xb5db3e308d4608af, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x23ec13c96a928851, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xf0ce9900c665a132, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x688ed8c22ee73692, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xb55b85de23d1835f, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x2426a0a60df30d4d, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x7aef02b47135610b, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x236f58976a80ccdb, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000000003f4f8, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xb5db3e308d4608af, AX
	ADDQ AX, DX
	MOVQ $0x23ec13c96a928851, AX
	ADCQ AX, CX
	MOVQ $0xf0ce9900c665a132, AX
	ADCQ AX, BX
	MOVQ $0x688ed8c22ee73692, AX
	ADCQ AX, SI
	MOVQ $0xb55b85de23d1835f, AX
	ADCQ AX, DI
	MOVQ $0x2426a0a60df30d4d, AX
	ADCQ AX, R8
	MOVQ $0x7aef02b47135610b, AX
	ADCQ AX, R9
	MOVQ $0x236f58976a80ccdb, AX
	ADCQ AX, R10
	MOVQ $0x000000000003f4f8, AX
	ADCQ AX, R11
