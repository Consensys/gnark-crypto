...
// modulus q
DATA q<>+0(SB)/8, $0xd5214d550975f633
DATA q<>+8(SB)/8, $0x7eaa47ce9f5d4c51
DATA q<>+16(SB)/8, $0x72a4043a2df4550e
DATA q<>+24(SB)/8, $0x5589b935f012a8f0
DATA q<>+32(SB)/8, $0x74877e0da32bf26f
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x713421b3fa6a0b05
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xd5214d550975f633, R9
	MOVQ    $0x7eaa47ce9f5d4c51, R10
	MOVQ    $0x72a4043a2df4550e, R11
	MOVQ    $0x5589b935f012a8f0, R12
	MOVQ    $0x74877e0da32bf26f, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x7eaa47ce9f5d4c51, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x72a4043a2df4550e, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x5589b935f012a8f0, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x74877e0da32bf26f, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xd5214d550975f633, CX
	MOVQ    $0x7eaa47ce9f5d4c51, BX
	MOVQ    $0x72a4043a2df4550e, SI
	MOVQ    $0x5589b935f012a8f0, DI
	MOVQ    $0x74877e0da32bf26f, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
