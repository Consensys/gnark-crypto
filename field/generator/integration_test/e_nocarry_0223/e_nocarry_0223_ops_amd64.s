...
// modulus q
DATA q<>+0(SB)/8, $0x4b5c3cd905a8bdeb
DATA q<>+8(SB)/8, $0xe122409c34a4fb73
DATA q<>+16(SB)/8, $0xda39097be8ad48f3
DATA q<>+24(SB)/8, $0x0000000067274cef
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xaa19c85def6d7d3d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x4b5c3cd905a8bdeb, R8
	MOVQ    $0xe122409c34a4fb73, R9
	MOVQ    $0xda39097be8ad48f3, R10
	MOVQ    $0x0000000067274cef, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xe122409c34a4fb73, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xda39097be8ad48f3, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000000067274cef, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x4b5c3cd905a8bdeb, R12
	MOVQ    $0xe122409c34a4fb73, R13
	MOVQ    $0xda39097be8ad48f3, R14
	MOVQ    $0x0000000067274cef, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
