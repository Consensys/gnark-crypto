...
var benchRese_nocarry_0223 e_nocarry_0223

func BenchmarkE_nocarry_0223SetBytes(b *testing.B) {
	var x e_nocarry_0223
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0223MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0223.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0223)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0223)
		}
	})
}

func BenchmarkE_nocarry_0223Inverse(b *testing.B) {
	var x e_nocarry_0223
	x.SetRandom()
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0223Butterfly(b *testing.B) {
	var x e_nocarry_0223
	x.SetRandom()
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0223)
	}
}

func BenchmarkE_nocarry_0223Exp(b *testing.B) {
	var x e_nocarry_0223
	x.SetRandom()
	benchRese_nocarry_0223.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0223Double(b *testing.B) {
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Double(&benchRese_nocarry_0223)
	}
}

func BenchmarkE_nocarry_0223Add(b *testing.B) {
	var x e_nocarry_0223
	x.SetRandom()
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Add(&x, &benchRese_nocarry_0223)
	}
}

func BenchmarkE_nocarry_0223Sub(b *testing.B) {
	var x e_nocarry_0223
	x.SetRandom()
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Sub(&x, &benchRese_nocarry_0223)
	}
}

func BenchmarkE_nocarry_0223Neg(b *testing.B) {
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Neg(&benchRese_nocarry_0223)
	}
}

func BenchmarkE_nocarry_0223Div(b *testing.B) {
	var x e_nocarry_0223
	x.SetRandom()
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Div(&x, &benchRese_nocarry_0223)
	}
}

func BenchmarkE_nocarry_0223FromMont(b *testing.B) {
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.FromMont()
	}
}

func BenchmarkE_nocarry_0223ToMont(b *testing.B) {
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.ToMont()
	}
}
func BenchmarkE_nocarry_0223Square(b *testing.B) {
	benchRese_nocarry_0223.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Square(&benchRese_nocarry_0223)
	}
}

func BenchmarkE_nocarry_0223Sqrt(b *testing.B) {
	var a e_nocarry_0223
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0223Mul(b *testing.B) {
	x := e_nocarry_0223{
		3853409032090801953,
		7147525836783355247,
	...
	benchRese_nocarry_0223.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Mul(&benchRese_nocarry_0223, &x)
	}
}

func BenchmarkE_nocarry_0223Cmp(b *testing.B) {
	x := e_nocarry_0223{
		3853409032090801953,
		7147525836783355247,
		13273882970942129220,
	...
	benchRese_nocarry_0223 = x
	benchRese_nocarry_0223[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0223.Cmp(&x)
	}
}

func TestE_nocarry_0223Cmp(t *testing.T) {
	var x, y e_nocarry_0223
...
func TestE_nocarry_0223IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0223
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0223

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0223{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0223
	one.SetOne()
	e.Sub(&qe_nocarry_0223, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0223{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0223{0, uint64(i)})
	}
...
func TestE_nocarry_0223NegZero(t *testing.T) {
	var a, b e_nocarry_0223
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0223Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0223, len(staticTestValues))
...
func TestE_nocarry_0223Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0223) bool {
			var b e_nocarry_0223
...
func TestE_nocarry_0223InverseExp(t *testing.T) {
...
func TestE_nocarry_0223MulByConstants(t *testing.T) {
...
func TestE_nocarry_0223Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0223) bool {
...
func TestE_nocarry_0223LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0223Halve(t *testing.T) {
...
func TestE_nocarry_0223FromMont(t *testing.T) {
...
type testPaire_nocarry_0223 struct {
	element e_nocarry_0223
	bigint  big.Int
}

func (z *e_nocarry_0223) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0223[3] {
		return true
	}
	if z[3] < qe_nocarry_0223[3] {
		return false
	...
	return z[0] >= qe_nocarry_0223[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0223

		g.element = e_nocarry_0223{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0223[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0223[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0223 {
			var g e_nocarry_0223
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0223[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0223[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0223[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0223[3], carry)
...
func Benchmarke_nocarry_0223InverseNew(b *testing.B) {
	var x e_nocarry_0223
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0223
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0223
		var xInv e_nocarry_0223
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0223
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0223
...
func testLinearComb(t *testing.T, x *e_nocarry_0223, xC int64, y *e_nocarry_0223, yC int64) {
	...
	var z e_nocarry_0223
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0223, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0223
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0223, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0223
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0223, xHi uint64) {
	var res e_nocarry_0223
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0223) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0223) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0223, c int64, result *e_nocarry_0223, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0223) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0223) uint64 {
