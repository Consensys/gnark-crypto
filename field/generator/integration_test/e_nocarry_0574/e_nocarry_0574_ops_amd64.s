...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x892edfa15f7acfed, R12
	ADDQ R12, AX
	MOVQ $0xd45aec85a7dfc394, R12
	ADCQ R12, DX
	MOVQ $0xcde8224031ffca0d, R12
	ADCQ R12, CX
	MOVQ $0xbe8c9dabba27a3bb, R12
	ADCQ R12, BX
	MOVQ $0xf7878098eef6bcfd, R12
	ADCQ R12, SI
	MOVQ $0xbd5661243f323c86, R12
	ADCQ R12, DI
	MOVQ $0x1b8c47ac3bdb0100, R12
	ADCQ R12, R8
	MOVQ $0x2ef059c9f074c48a, R12
	ADCQ R12, R9
	MOVQ $0x3a7d70d210a9f14a, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x892edfa15f7acfed, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xd45aec85a7dfc394, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xcde8224031ffca0d, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xbe8c9dabba27a3bb, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xf7878098eef6bcfd, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xbd5661243f323c86, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x1b8c47ac3bdb0100, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x2ef059c9f074c48a, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x3a7d70d210a9f14a, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x892edfa15f7acfed, AX
	ADDQ AX, DX
	MOVQ $0xd45aec85a7dfc394, AX
	ADCQ AX, CX
	MOVQ $0xcde8224031ffca0d, AX
	ADCQ AX, BX
	MOVQ $0xbe8c9dabba27a3bb, AX
	ADCQ AX, SI
	MOVQ $0xf7878098eef6bcfd, AX
	ADCQ AX, DI
	MOVQ $0xbd5661243f323c86, AX
	ADCQ AX, R8
	MOVQ $0x1b8c47ac3bdb0100, AX
	ADCQ AX, R9
	MOVQ $0x2ef059c9f074c48a, AX
	ADCQ AX, R10
	MOVQ $0x3a7d70d210a9f14a, AX
	ADCQ AX, R11
