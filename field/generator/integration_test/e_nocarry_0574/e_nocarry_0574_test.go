...
var benchRese_nocarry_0574 e_nocarry_0574

func BenchmarkE_nocarry_0574SetBytes(b *testing.B) {
	var x e_nocarry_0574
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0574MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0574.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0574)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0574)
		}
	})
}

func BenchmarkE_nocarry_0574Inverse(b *testing.B) {
	var x e_nocarry_0574
	x.SetRandom()
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0574Butterfly(b *testing.B) {
	var x e_nocarry_0574
	x.SetRandom()
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0574)
	}
}

func BenchmarkE_nocarry_0574Exp(b *testing.B) {
	var x e_nocarry_0574
	x.SetRandom()
	benchRese_nocarry_0574.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0574Double(b *testing.B) {
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Double(&benchRese_nocarry_0574)
	}
}

func BenchmarkE_nocarry_0574Add(b *testing.B) {
	var x e_nocarry_0574
	x.SetRandom()
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Add(&x, &benchRese_nocarry_0574)
	}
}

func BenchmarkE_nocarry_0574Sub(b *testing.B) {
	var x e_nocarry_0574
	x.SetRandom()
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Sub(&x, &benchRese_nocarry_0574)
	}
}

func BenchmarkE_nocarry_0574Neg(b *testing.B) {
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Neg(&benchRese_nocarry_0574)
	}
}

func BenchmarkE_nocarry_0574Div(b *testing.B) {
	var x e_nocarry_0574
	x.SetRandom()
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Div(&x, &benchRese_nocarry_0574)
	}
}

func BenchmarkE_nocarry_0574FromMont(b *testing.B) {
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.FromMont()
	}
}

func BenchmarkE_nocarry_0574ToMont(b *testing.B) {
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.ToMont()
	}
}
func BenchmarkE_nocarry_0574Square(b *testing.B) {
	benchRese_nocarry_0574.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Square(&benchRese_nocarry_0574)
	}
}

func BenchmarkE_nocarry_0574Sqrt(b *testing.B) {
	var a e_nocarry_0574
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0574Mul(b *testing.B) {
	x := e_nocarry_0574{
	...
	benchRese_nocarry_0574.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Mul(&benchRese_nocarry_0574, &x)
	}
}

func BenchmarkE_nocarry_0574Cmp(b *testing.B) {
	x := e_nocarry_0574{
		17978037236917545360,
		1026108334342947119,
		7929937663501113381,
	...
	benchRese_nocarry_0574 = x
	benchRese_nocarry_0574[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0574.Cmp(&x)
	}
}

func TestE_nocarry_0574Cmp(t *testing.T) {
	var x, y e_nocarry_0574
...
func TestE_nocarry_0574IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0574
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0574

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0574{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0574
	one.SetOne()
	e.Sub(&qe_nocarry_0574, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0574{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0574{0, uint64(i)})
	}
...
func TestE_nocarry_0574NegZero(t *testing.T) {
	var a, b e_nocarry_0574
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0574Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0574, len(staticTestValues))
...
func TestE_nocarry_0574Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0574) bool {
			var b e_nocarry_0574
...
func TestE_nocarry_0574InverseExp(t *testing.T) {
...
func TestE_nocarry_0574MulByConstants(t *testing.T) {
...
func TestE_nocarry_0574Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0574) bool {
...
func TestE_nocarry_0574LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0574Halve(t *testing.T) {
...
func TestE_nocarry_0574FromMont(t *testing.T) {
...
type testPaire_nocarry_0574 struct {
	element e_nocarry_0574
	bigint  big.Int
}

func (z *e_nocarry_0574) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0574[8] {
		return true
	}
	if z[8] < qe_nocarry_0574[8] {
		return false
	...
	return z[0] >= qe_nocarry_0574[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0574

		g.element = e_nocarry_0574{
		...
		if qe_nocarry_0574[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0574[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0574 {
			var g e_nocarry_0574
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0574[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0574[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0574[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0574[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0574[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0574[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0574[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0574[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0574[8], carry)
...
func Benchmarke_nocarry_0574InverseNew(b *testing.B) {
	var x e_nocarry_0574
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0574
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0574
		var xInv e_nocarry_0574
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0574
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0574
...
func testLinearComb(t *testing.T, x *e_nocarry_0574, xC int64, y *e_nocarry_0574, yC int64) {
	...
	var z e_nocarry_0574
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0574, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0574
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0574, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0574
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0574, xHi uint64) {
	var res e_nocarry_0574
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0574) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0574) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0574, c int64, result *e_nocarry_0574, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0574) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0574) uint64 {
