...
var benchRese_nocarry_0232 e_nocarry_0232

func BenchmarkE_nocarry_0232SetBytes(b *testing.B) {
	var x e_nocarry_0232
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0232MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0232.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0232)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0232)
		}
	})
}

func BenchmarkE_nocarry_0232Inverse(b *testing.B) {
	var x e_nocarry_0232
	x.SetRandom()
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0232Butterfly(b *testing.B) {
	var x e_nocarry_0232
	x.SetRandom()
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0232)
	}
}

func BenchmarkE_nocarry_0232Exp(b *testing.B) {
	var x e_nocarry_0232
	x.SetRandom()
	benchRese_nocarry_0232.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0232Double(b *testing.B) {
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Double(&benchRese_nocarry_0232)
	}
}

func BenchmarkE_nocarry_0232Add(b *testing.B) {
	var x e_nocarry_0232
	x.SetRandom()
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Add(&x, &benchRese_nocarry_0232)
	}
}

func BenchmarkE_nocarry_0232Sub(b *testing.B) {
	var x e_nocarry_0232
	x.SetRandom()
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Sub(&x, &benchRese_nocarry_0232)
	}
}

func BenchmarkE_nocarry_0232Neg(b *testing.B) {
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Neg(&benchRese_nocarry_0232)
	}
}

func BenchmarkE_nocarry_0232Div(b *testing.B) {
	var x e_nocarry_0232
	x.SetRandom()
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Div(&x, &benchRese_nocarry_0232)
	}
}

func BenchmarkE_nocarry_0232FromMont(b *testing.B) {
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.FromMont()
	}
}

func BenchmarkE_nocarry_0232ToMont(b *testing.B) {
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.ToMont()
	}
}
func BenchmarkE_nocarry_0232Square(b *testing.B) {
	benchRese_nocarry_0232.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Square(&benchRese_nocarry_0232)
	}
}

func BenchmarkE_nocarry_0232Sqrt(b *testing.B) {
	var a e_nocarry_0232
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0232Mul(b *testing.B) {
	x := e_nocarry_0232{
		4506779406641456329,
		3969074550557994761,
	...
	benchRese_nocarry_0232.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Mul(&benchRese_nocarry_0232, &x)
	}
}

func BenchmarkE_nocarry_0232Cmp(b *testing.B) {
	x := e_nocarry_0232{
		4506779406641456329,
		3969074550557994761,
		16841269430178083256,
	...
	benchRese_nocarry_0232 = x
	benchRese_nocarry_0232[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0232.Cmp(&x)
	}
}

func TestE_nocarry_0232Cmp(t *testing.T) {
	var x, y e_nocarry_0232
...
func TestE_nocarry_0232IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0232
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0232

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0232{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0232
	one.SetOne()
	e.Sub(&qe_nocarry_0232, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0232{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0232{0, uint64(i)})
	}
...
func TestE_nocarry_0232NegZero(t *testing.T) {
	var a, b e_nocarry_0232
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0232Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0232, len(staticTestValues))
...
func TestE_nocarry_0232Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0232) bool {
			var b e_nocarry_0232
...
func TestE_nocarry_0232InverseExp(t *testing.T) {
...
func TestE_nocarry_0232MulByConstants(t *testing.T) {
...
func TestE_nocarry_0232Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0232) bool {
...
func TestE_nocarry_0232LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0232Halve(t *testing.T) {
...
func TestE_nocarry_0232FromMont(t *testing.T) {
...
type testPaire_nocarry_0232 struct {
	element e_nocarry_0232
	bigint  big.Int
}

func (z *e_nocarry_0232) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0232[3] {
		return true
	}
	if z[3] < qe_nocarry_0232[3] {
		return false
	...
	return z[0] >= qe_nocarry_0232[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0232

		g.element = e_nocarry_0232{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0232[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0232[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0232 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0232[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0232[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0232[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0232[3], carry)
...
func Benchmarke_nocarry_0232InverseNew(b *testing.B) {
	var x e_nocarry_0232
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0232
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0232
		var xInv e_nocarry_0232
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0232
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0232
...
func testLinearComb(t *testing.T, x *e_nocarry_0232, xC int64, y *e_nocarry_0232, yC int64) {
	...
	var z e_nocarry_0232
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0232, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0232
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0232, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0232
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0232, xHi uint64) {
	var res e_nocarry_0232
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0232) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0232) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0232, c int64, result *e_nocarry_0232, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0232) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0232) uint64 {
