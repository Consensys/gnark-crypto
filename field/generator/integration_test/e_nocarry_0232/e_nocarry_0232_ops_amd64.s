...
// modulus q
DATA q<>+0(SB)/8, $0x15dec8109b0c0789
DATA q<>+8(SB)/8, $0x785137bca39bf05a
DATA q<>+16(SB)/8, $0xf69cd221237a9df0
DATA q<>+24(SB)/8, $0x000000c9e0194642
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x5528a74647976147
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x15dec8109b0c0789, R8
	MOVQ    $0x785137bca39bf05a, R9
	MOVQ    $0xf69cd221237a9df0, R10
	MOVQ    $0x000000c9e0194642, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x785137bca39bf05a, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xf69cd221237a9df0, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x000000c9e0194642, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x15dec8109b0c0789, R12
	MOVQ    $0x785137bca39bf05a, R13
	MOVQ    $0xf69cd221237a9df0, R14
	MOVQ    $0x000000c9e0194642, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
