...
var benchRese_nocarry_0677 e_nocarry_0677

func BenchmarkE_nocarry_0677SetBytes(b *testing.B) {
	var x e_nocarry_0677
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0677MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0677.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0677)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0677)
		}
	})
}

func BenchmarkE_nocarry_0677Inverse(b *testing.B) {
	var x e_nocarry_0677
	x.SetRandom()
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0677Butterfly(b *testing.B) {
	var x e_nocarry_0677
	x.SetRandom()
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0677)
	}
}

func BenchmarkE_nocarry_0677Exp(b *testing.B) {
	var x e_nocarry_0677
	x.SetRandom()
	benchRese_nocarry_0677.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0677Double(b *testing.B) {
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Double(&benchRese_nocarry_0677)
	}
}

func BenchmarkE_nocarry_0677Add(b *testing.B) {
	var x e_nocarry_0677
	x.SetRandom()
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Add(&x, &benchRese_nocarry_0677)
	}
}

func BenchmarkE_nocarry_0677Sub(b *testing.B) {
	var x e_nocarry_0677
	x.SetRandom()
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Sub(&x, &benchRese_nocarry_0677)
	}
}

func BenchmarkE_nocarry_0677Neg(b *testing.B) {
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Neg(&benchRese_nocarry_0677)
	}
}

func BenchmarkE_nocarry_0677Div(b *testing.B) {
	var x e_nocarry_0677
	x.SetRandom()
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Div(&x, &benchRese_nocarry_0677)
	}
}

func BenchmarkE_nocarry_0677FromMont(b *testing.B) {
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.FromMont()
	}
}

func BenchmarkE_nocarry_0677ToMont(b *testing.B) {
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.ToMont()
	}
}
func BenchmarkE_nocarry_0677Square(b *testing.B) {
	benchRese_nocarry_0677.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Square(&benchRese_nocarry_0677)
	}
}

func BenchmarkE_nocarry_0677Sqrt(b *testing.B) {
	var a e_nocarry_0677
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0677Mul(b *testing.B) {
	x := e_nocarry_0677{
	...
	benchRese_nocarry_0677.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Mul(&benchRese_nocarry_0677, &x)
	}
}

func BenchmarkE_nocarry_0677Cmp(b *testing.B) {
	x := e_nocarry_0677{
		13871033377118258725,
		2705841535983243117,
		2854029578328453534,
	...
	benchRese_nocarry_0677 = x
	benchRese_nocarry_0677[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0677.Cmp(&x)
	}
}

func TestE_nocarry_0677Cmp(t *testing.T) {
	var x, y e_nocarry_0677
...
func TestE_nocarry_0677IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0677
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0677

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0677{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0677
	one.SetOne()
	e.Sub(&qe_nocarry_0677, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0677{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0677{0, uint64(i)})
	}
...
func TestE_nocarry_0677NegZero(t *testing.T) {
	var a, b e_nocarry_0677
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0677Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0677, len(staticTestValues))
...
func TestE_nocarry_0677Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0677) bool {
			var b e_nocarry_0677
...
func TestE_nocarry_0677InverseExp(t *testing.T) {
...
func TestE_nocarry_0677MulByConstants(t *testing.T) {
...
func TestE_nocarry_0677Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0677) bool {
...
func TestE_nocarry_0677LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0677Halve(t *testing.T) {
...
func TestE_nocarry_0677FromMont(t *testing.T) {
...
type testPaire_nocarry_0677 struct {
	element e_nocarry_0677
	bigint  big.Int
}

func (z *e_nocarry_0677) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0677[10] {
		return true
	}
	if z[10] < qe_nocarry_0677[10] {
		return false
	...
	return z[0] >= qe_nocarry_0677[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0677

		g.element = e_nocarry_0677{
		...
		if qe_nocarry_0677[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0677[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0677 {
			var g e_nocarry_0677
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0677[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0677[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0677[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0677[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0677[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0677[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0677[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0677[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0677[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0677[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0677[10], carry)
...
func Benchmarke_nocarry_0677InverseNew(b *testing.B) {
	var x e_nocarry_0677
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0677
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0677
		var xInv e_nocarry_0677
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0677
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0677
...
func testLinearComb(t *testing.T, x *e_nocarry_0677, xC int64, y *e_nocarry_0677, yC int64) {
	...
	var z e_nocarry_0677
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0677, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0677
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0677, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0677
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0677, xHi uint64) {
	var res e_nocarry_0677
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0677) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0677) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0677, c int64, result *e_nocarry_0677, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0677) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0677) uint64 {
