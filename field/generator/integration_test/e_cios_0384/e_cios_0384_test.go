...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_cios_0384{uint64(i)})
		staticTestValues = append(staticTestValues, e_cios_0384{0, uint64(i)})
	}
...
func (z *e_cios_0384) biggerOrEqualModulus() bool {
	if z[5] > qe_cios_0384[5] {
		return true
	}
	if z[5] < qe_cios_0384[5] {
		return false
