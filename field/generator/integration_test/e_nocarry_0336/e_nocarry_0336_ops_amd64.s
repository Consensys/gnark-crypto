...
// modulus q
DATA q<>+0(SB)/8, $0x1f265bbf9828ec27
DATA q<>+8(SB)/8, $0x6d5bd0cc8f3a59ff
DATA q<>+16(SB)/8, $0xedf2ca93ac538503
DATA q<>+24(SB)/8, $0x30f6b6422c86cca4
DATA q<>+32(SB)/8, $0x972e3320c05a0981
DATA q<>+40(SB)/8, $0x000000000000cf3c
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x77f3d90305f23c69
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x1f265bbf9828ec27, R10
	MOVQ    $0x6d5bd0cc8f3a59ff, R11
	MOVQ    $0xedf2ca93ac538503, R12
	MOVQ    $0x30f6b6422c86cca4, R13
	MOVQ    $0x972e3320c05a0981, R14
	MOVQ    $0x000000000000cf3c, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x6d5bd0cc8f3a59ff, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xedf2ca93ac538503, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x30f6b6422c86cca4, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x972e3320c05a0981, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000000000cf3c, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x1f265bbf9828ec27, CX
	MOVQ    $0x6d5bd0cc8f3a59ff, BX
	MOVQ    $0xedf2ca93ac538503, SI
	MOVQ    $0x30f6b6422c86cca4, DI
	MOVQ    $0x972e3320c05a0981, R8
	MOVQ    $0x000000000000cf3c, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
