...
var benchRese_nocarry_0336 e_nocarry_0336

func BenchmarkE_nocarry_0336SetBytes(b *testing.B) {
	var x e_nocarry_0336
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0336MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0336.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0336)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0336)
		}
	})
}

func BenchmarkE_nocarry_0336Inverse(b *testing.B) {
	var x e_nocarry_0336
	x.SetRandom()
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0336Butterfly(b *testing.B) {
	var x e_nocarry_0336
	x.SetRandom()
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0336)
	}
}

func BenchmarkE_nocarry_0336Exp(b *testing.B) {
	var x e_nocarry_0336
	x.SetRandom()
	benchRese_nocarry_0336.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0336Double(b *testing.B) {
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Double(&benchRese_nocarry_0336)
	}
}

func BenchmarkE_nocarry_0336Add(b *testing.B) {
	var x e_nocarry_0336
	x.SetRandom()
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Add(&x, &benchRese_nocarry_0336)
	}
}

func BenchmarkE_nocarry_0336Sub(b *testing.B) {
	var x e_nocarry_0336
	x.SetRandom()
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Sub(&x, &benchRese_nocarry_0336)
	}
}

func BenchmarkE_nocarry_0336Neg(b *testing.B) {
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Neg(&benchRese_nocarry_0336)
	}
}

func BenchmarkE_nocarry_0336Div(b *testing.B) {
	var x e_nocarry_0336
	x.SetRandom()
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Div(&x, &benchRese_nocarry_0336)
	}
}

func BenchmarkE_nocarry_0336FromMont(b *testing.B) {
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.FromMont()
	}
}

func BenchmarkE_nocarry_0336ToMont(b *testing.B) {
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.ToMont()
	}
}
func BenchmarkE_nocarry_0336Square(b *testing.B) {
	benchRese_nocarry_0336.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Square(&benchRese_nocarry_0336)
	}
}

func BenchmarkE_nocarry_0336Sqrt(b *testing.B) {
	var a e_nocarry_0336
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0336Mul(b *testing.B) {
	x := e_nocarry_0336{
		8238288341175584556,
		8834822268047144680,
	...
	benchRese_nocarry_0336.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Mul(&benchRese_nocarry_0336, &x)
	}
}

func BenchmarkE_nocarry_0336Cmp(b *testing.B) {
	x := e_nocarry_0336{
		8238288341175584556,
		8834822268047144680,
		15618309687165811543,
	...
	benchRese_nocarry_0336 = x
	benchRese_nocarry_0336[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0336.Cmp(&x)
	}
}

func TestE_nocarry_0336Cmp(t *testing.T) {
	var x, y e_nocarry_0336
...
func TestE_nocarry_0336IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0336
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0336

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0336{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0336
	one.SetOne()
	e.Sub(&qe_nocarry_0336, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0336{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0336{0, uint64(i)})
	}
...
func TestE_nocarry_0336NegZero(t *testing.T) {
	var a, b e_nocarry_0336
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0336Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0336, len(staticTestValues))
...
func TestE_nocarry_0336Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0336) bool {
			var b e_nocarry_0336
...
func TestE_nocarry_0336InverseExp(t *testing.T) {
...
func TestE_nocarry_0336MulByConstants(t *testing.T) {
...
func TestE_nocarry_0336Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0336) bool {
...
func TestE_nocarry_0336LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0336Halve(t *testing.T) {
...
func TestE_nocarry_0336FromMont(t *testing.T) {
...
type testPaire_nocarry_0336 struct {
	element e_nocarry_0336
	bigint  big.Int
}

func (z *e_nocarry_0336) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0336[5] {
		return true
	}
	if z[5] < qe_nocarry_0336[5] {
		return false
	...
	return z[0] >= qe_nocarry_0336[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0336

		g.element = e_nocarry_0336{
		...
		if qe_nocarry_0336[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0336[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0336 {
			var g e_nocarry_0336
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0336[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0336[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0336[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0336[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0336[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0336[5], carry)
...
func Benchmarke_nocarry_0336InverseNew(b *testing.B) {
	var x e_nocarry_0336
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0336
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0336
		var xInv e_nocarry_0336
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0336
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0336
...
func testLinearComb(t *testing.T, x *e_nocarry_0336, xC int64, y *e_nocarry_0336, yC int64) {
	...
	var z e_nocarry_0336
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0336, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0336
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0336, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0336
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0336, xHi uint64) {
	var res e_nocarry_0336
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0336) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0336) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0336, c int64, result *e_nocarry_0336, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0336) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0336) uint64 {
