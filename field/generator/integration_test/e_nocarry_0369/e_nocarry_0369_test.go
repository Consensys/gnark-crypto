...
var benchRese_nocarry_0369 e_nocarry_0369

func BenchmarkE_nocarry_0369SetBytes(b *testing.B) {
	var x e_nocarry_0369
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0369MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0369.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0369)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0369)
		}
	})
}

func BenchmarkE_nocarry_0369Inverse(b *testing.B) {
	var x e_nocarry_0369
	x.SetRandom()
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0369Butterfly(b *testing.B) {
	var x e_nocarry_0369
	x.SetRandom()
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0369)
	}
}

func BenchmarkE_nocarry_0369Exp(b *testing.B) {
	var x e_nocarry_0369
	x.SetRandom()
	benchRese_nocarry_0369.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0369Double(b *testing.B) {
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Double(&benchRese_nocarry_0369)
	}
}

func BenchmarkE_nocarry_0369Add(b *testing.B) {
	var x e_nocarry_0369
	x.SetRandom()
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Add(&x, &benchRese_nocarry_0369)
	}
}

func BenchmarkE_nocarry_0369Sub(b *testing.B) {
	var x e_nocarry_0369
	x.SetRandom()
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Sub(&x, &benchRese_nocarry_0369)
	}
}

func BenchmarkE_nocarry_0369Neg(b *testing.B) {
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Neg(&benchRese_nocarry_0369)
	}
}

func BenchmarkE_nocarry_0369Div(b *testing.B) {
	var x e_nocarry_0369
	x.SetRandom()
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Div(&x, &benchRese_nocarry_0369)
	}
}

func BenchmarkE_nocarry_0369FromMont(b *testing.B) {
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.FromMont()
	}
}

func BenchmarkE_nocarry_0369ToMont(b *testing.B) {
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.ToMont()
	}
}
func BenchmarkE_nocarry_0369Square(b *testing.B) {
	benchRese_nocarry_0369.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Square(&benchRese_nocarry_0369)
	}
}

func BenchmarkE_nocarry_0369Sqrt(b *testing.B) {
	var a e_nocarry_0369
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0369Mul(b *testing.B) {
	x := e_nocarry_0369{
	...
	benchRese_nocarry_0369.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Mul(&benchRese_nocarry_0369, &x)
	}
}

func BenchmarkE_nocarry_0369Cmp(b *testing.B) {
	x := e_nocarry_0369{
		15936668081288045685,
		2185249894623534772,
		10239235775107986228,
	...
	benchRese_nocarry_0369 = x
	benchRese_nocarry_0369[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0369.Cmp(&x)
	}
}

func TestE_nocarry_0369Cmp(t *testing.T) {
	var x, y e_nocarry_0369
...
func TestE_nocarry_0369IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0369
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0369

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0369{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0369
	one.SetOne()
	e.Sub(&qe_nocarry_0369, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0369{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0369{0, uint64(i)})
	}
...
func TestE_nocarry_0369NegZero(t *testing.T) {
	var a, b e_nocarry_0369
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0369Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0369, len(staticTestValues))
...
func TestE_nocarry_0369Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0369) bool {
			var b e_nocarry_0369
...
func TestE_nocarry_0369InverseExp(t *testing.T) {
...
func TestE_nocarry_0369MulByConstants(t *testing.T) {
...
func TestE_nocarry_0369Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0369) bool {
...
func TestE_nocarry_0369LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0369Halve(t *testing.T) {
...
func TestE_nocarry_0369FromMont(t *testing.T) {
...
type testPaire_nocarry_0369 struct {
	element e_nocarry_0369
	bigint  big.Int
}

func (z *e_nocarry_0369) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0369[5] {
		return true
	}
	if z[5] < qe_nocarry_0369[5] {
		return false
	...
	return z[0] >= qe_nocarry_0369[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0369

		g.element = e_nocarry_0369{
		...
		if qe_nocarry_0369[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0369[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0369 {
			var g e_nocarry_0369
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0369[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0369[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0369[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0369[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0369[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0369[5], carry)
...
func Benchmarke_nocarry_0369InverseNew(b *testing.B) {
	var x e_nocarry_0369
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0369
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0369
		var xInv e_nocarry_0369
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0369
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0369
...
func testLinearComb(t *testing.T, x *e_nocarry_0369, xC int64, y *e_nocarry_0369, yC int64) {
	...
	var z e_nocarry_0369
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0369, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0369
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0369, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0369
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0369, xHi uint64) {
	var res e_nocarry_0369
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0369) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0369) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0369, c int64, result *e_nocarry_0369, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0369) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0369) uint64 {
