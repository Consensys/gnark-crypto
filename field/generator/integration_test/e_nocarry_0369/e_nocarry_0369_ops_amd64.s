...
// modulus q
DATA q<>+0(SB)/8, $0xd44fd64ee4c44bb7
DATA q<>+8(SB)/8, $0x5807d52c97d4f744
DATA q<>+16(SB)/8, $0x96a6d14b6a132d9d
DATA q<>+24(SB)/8, $0xf1e55484f8c606c1
DATA q<>+32(SB)/8, $0x7c48e044d78c62bd
DATA q<>+40(SB)/8, $0x0001a6f57ea2f654
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x7ecaf7acb0b67df9
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xd44fd64ee4c44bb7, R10
	MOVQ    $0x5807d52c97d4f744, R11
	MOVQ    $0x96a6d14b6a132d9d, R12
	MOVQ    $0xf1e55484f8c606c1, R13
	MOVQ    $0x7c48e044d78c62bd, R14
	MOVQ    $0x0001a6f57ea2f654, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x5807d52c97d4f744, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x96a6d14b6a132d9d, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xf1e55484f8c606c1, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x7c48e044d78c62bd, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0001a6f57ea2f654, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xd44fd64ee4c44bb7, CX
	MOVQ    $0x5807d52c97d4f744, BX
	MOVQ    $0x96a6d14b6a132d9d, SI
	MOVQ    $0xf1e55484f8c606c1, DI
	MOVQ    $0x7c48e044d78c62bd, R8
	MOVQ    $0x0001a6f57ea2f654, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
