...
var benchRese_nocarry_0507 e_nocarry_0507

func BenchmarkE_nocarry_0507SetBytes(b *testing.B) {
	var x e_nocarry_0507
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0507MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0507.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0507)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0507)
		}
	})
}

func BenchmarkE_nocarry_0507Inverse(b *testing.B) {
	var x e_nocarry_0507
	x.SetRandom()
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0507Butterfly(b *testing.B) {
	var x e_nocarry_0507
	x.SetRandom()
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0507)
	}
}

func BenchmarkE_nocarry_0507Exp(b *testing.B) {
	var x e_nocarry_0507
	x.SetRandom()
	benchRese_nocarry_0507.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0507Double(b *testing.B) {
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Double(&benchRese_nocarry_0507)
	}
}

func BenchmarkE_nocarry_0507Add(b *testing.B) {
	var x e_nocarry_0507
	x.SetRandom()
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Add(&x, &benchRese_nocarry_0507)
	}
}

func BenchmarkE_nocarry_0507Sub(b *testing.B) {
	var x e_nocarry_0507
	x.SetRandom()
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Sub(&x, &benchRese_nocarry_0507)
	}
}

func BenchmarkE_nocarry_0507Neg(b *testing.B) {
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Neg(&benchRese_nocarry_0507)
	}
}

func BenchmarkE_nocarry_0507Div(b *testing.B) {
	var x e_nocarry_0507
	x.SetRandom()
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Div(&x, &benchRese_nocarry_0507)
	}
}

func BenchmarkE_nocarry_0507FromMont(b *testing.B) {
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.FromMont()
	}
}

func BenchmarkE_nocarry_0507ToMont(b *testing.B) {
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.ToMont()
	}
}
func BenchmarkE_nocarry_0507Square(b *testing.B) {
	benchRese_nocarry_0507.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Square(&benchRese_nocarry_0507)
	}
}

func BenchmarkE_nocarry_0507Sqrt(b *testing.B) {
	var a e_nocarry_0507
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0507Mul(b *testing.B) {
	x := e_nocarry_0507{
		5468616765751424927,
	...
	benchRese_nocarry_0507.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Mul(&benchRese_nocarry_0507, &x)
	}
}

func BenchmarkE_nocarry_0507Cmp(b *testing.B) {
	x := e_nocarry_0507{
		5468616765751424927,
		12115561017644598421,
		11819510736846556545,
	...
	benchRese_nocarry_0507 = x
	benchRese_nocarry_0507[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0507.Cmp(&x)
	}
}

func TestE_nocarry_0507Cmp(t *testing.T) {
	var x, y e_nocarry_0507
...
func TestE_nocarry_0507IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0507
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0507

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0507{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0507
	one.SetOne()
	e.Sub(&qe_nocarry_0507, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0507{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0507{0, uint64(i)})
	}
...
func TestE_nocarry_0507NegZero(t *testing.T) {
	var a, b e_nocarry_0507
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0507Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0507, len(staticTestValues))
...
func TestE_nocarry_0507Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0507) bool {
			var b e_nocarry_0507
...
func TestE_nocarry_0507InverseExp(t *testing.T) {
...
func TestE_nocarry_0507MulByConstants(t *testing.T) {
...
func TestE_nocarry_0507Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0507) bool {
...
func TestE_nocarry_0507LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0507Halve(t *testing.T) {
...
func TestE_nocarry_0507FromMont(t *testing.T) {
...
type testPaire_nocarry_0507 struct {
	element e_nocarry_0507
	bigint  big.Int
}

func (z *e_nocarry_0507) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0507[7] {
		return true
	}
	if z[7] < qe_nocarry_0507[7] {
		return false
	...
	return z[0] >= qe_nocarry_0507[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0507

		g.element = e_nocarry_0507{
		...
		if qe_nocarry_0507[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0507[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0507 {
			var g e_nocarry_0507
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0507[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0507[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0507[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0507[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0507[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0507[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0507[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0507[7], carry)
...
func Benchmarke_nocarry_0507InverseNew(b *testing.B) {
	var x e_nocarry_0507
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0507
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0507
		var xInv e_nocarry_0507
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0507
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0507
...
func testLinearComb(t *testing.T, x *e_nocarry_0507, xC int64, y *e_nocarry_0507, yC int64) {
	...
	var z e_nocarry_0507
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0507, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0507
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0507, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0507
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0507, xHi uint64) {
	var res e_nocarry_0507
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0507) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0507) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0507, c int64, result *e_nocarry_0507, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0507) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0507) uint64 {
