...
var benchRese_nocarry_0188 e_nocarry_0188

func BenchmarkE_nocarry_0188SetBytes(b *testing.B) {
	var x e_nocarry_0188
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0188MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0188.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0188)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0188)
		}
	})
}

func BenchmarkE_nocarry_0188Inverse(b *testing.B) {
	var x e_nocarry_0188
	x.SetRandom()
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0188Butterfly(b *testing.B) {
	var x e_nocarry_0188
	x.SetRandom()
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0188)
	}
}

func BenchmarkE_nocarry_0188Exp(b *testing.B) {
	var x e_nocarry_0188
	x.SetRandom()
	benchRese_nocarry_0188.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0188Double(b *testing.B) {
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Double(&benchRese_nocarry_0188)
	}
}

func BenchmarkE_nocarry_0188Add(b *testing.B) {
	var x e_nocarry_0188
	x.SetRandom()
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Add(&x, &benchRese_nocarry_0188)
	}
}

func BenchmarkE_nocarry_0188Sub(b *testing.B) {
	var x e_nocarry_0188
	x.SetRandom()
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Sub(&x, &benchRese_nocarry_0188)
	}
}

func BenchmarkE_nocarry_0188Neg(b *testing.B) {
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Neg(&benchRese_nocarry_0188)
	}
}

func BenchmarkE_nocarry_0188Div(b *testing.B) {
	var x e_nocarry_0188
	x.SetRandom()
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Div(&x, &benchRese_nocarry_0188)
	}
}

func BenchmarkE_nocarry_0188FromMont(b *testing.B) {
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.FromMont()
	}
}

func BenchmarkE_nocarry_0188ToMont(b *testing.B) {
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.ToMont()
	}
}
func BenchmarkE_nocarry_0188Square(b *testing.B) {
	benchRese_nocarry_0188.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Square(&benchRese_nocarry_0188)
	}
}

func BenchmarkE_nocarry_0188Sqrt(b *testing.B) {
	var a e_nocarry_0188
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0188Mul(b *testing.B) {
	x := e_nocarry_0188{
		4282366005129347251,
		4063577486891577617,
		37474092420341892,
	}
	benchRese_nocarry_0188.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Mul(&benchRese_nocarry_0188, &x)
	}
}

func BenchmarkE_nocarry_0188Cmp(b *testing.B) {
	x := e_nocarry_0188{
		4282366005129347251,
		4063577486891577617,
		37474092420341892,
	}
	benchRese_nocarry_0188 = x
	benchRese_nocarry_0188[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0188.Cmp(&x)
	}
}

func TestE_nocarry_0188Cmp(t *testing.T) {
	var x, y e_nocarry_0188
...
func TestE_nocarry_0188IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0188
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0188

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0188{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0188
	one.SetOne()
	e.Sub(&qe_nocarry_0188, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0188{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0188{0, uint64(i)})
	}
...
func TestE_nocarry_0188NegZero(t *testing.T) {
	var a, b e_nocarry_0188
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0188Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0188, len(staticTestValues))
...
func TestE_nocarry_0188Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0188) bool {
			var b e_nocarry_0188
...
func TestE_nocarry_0188InverseExp(t *testing.T) {
...
func TestE_nocarry_0188MulByConstants(t *testing.T) {
...
func TestE_nocarry_0188Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0188) bool {
...
func TestE_nocarry_0188LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0188Halve(t *testing.T) {
...
func TestE_nocarry_0188FromMont(t *testing.T) {
...
type testPaire_nocarry_0188 struct {
	element e_nocarry_0188
	bigint  big.Int
}

func (z *e_nocarry_0188) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0188[2] {
		return true
	}
	if z[2] < qe_nocarry_0188[2] {
		return false
	...
	return z[0] >= qe_nocarry_0188[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0188

		g.element = e_nocarry_0188{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0188[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0188[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0188 {
			var g e_nocarry_0188
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0188[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0188[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0188[2], carry)
...
func Benchmarke_nocarry_0188InverseNew(b *testing.B) {
	var x e_nocarry_0188
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0188
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0188
		var xInv e_nocarry_0188
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0188
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0188
...
func testLinearComb(t *testing.T, x *e_nocarry_0188, xC int64, y *e_nocarry_0188, yC int64) {
	...
	var z e_nocarry_0188
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0188, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0188
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0188, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0188
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0188, xHi uint64) {
	var res e_nocarry_0188
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0188) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0188) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0188, c int64, result *e_nocarry_0188, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0188) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0188) uint64 {
