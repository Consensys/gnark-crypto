...
// modulus q
DATA q<>+0(SB)/8, $0x3e1a5b27ecd7cedd
DATA q<>+8(SB)/8, $0x325623abb4b69046
DATA q<>+16(SB)/8, $0x0d5b43f7554965ec
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x798d063a2287868b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x3e1a5b27ecd7cedd, DI
	MOVQ    $0x325623abb4b69046, R8
	MOVQ    $0x0d5b43f7554965ec, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x325623abb4b69046, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x0d5b43f7554965ec, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x3e1a5b27ecd7cedd, R10
	MOVQ    $0x325623abb4b69046, R11
	MOVQ    $0x0d5b43f7554965ec, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
