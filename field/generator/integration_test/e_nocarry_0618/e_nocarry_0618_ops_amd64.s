...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x2b6d228264de6667, R13
	ADDQ R13, AX
	MOVQ $0xc958ab717d7cf22a, R13
	ADCQ R13, DX
	MOVQ $0x3a7862a6d1128f5b, R13
	ADCQ R13, CX
	MOVQ $0xdbf4ad9c481a116f, R13
	ADCQ R13, BX
	MOVQ $0x9c228c38adee4617, R13
	ADCQ R13, SI
	MOVQ $0xe8dd623cb42df4bf, R13
	ADCQ R13, DI
	MOVQ $0x4984f4c300d28af2, R13
	ADCQ R13, R8
	MOVQ $0x387f35bdf49378e0, R13
	ADCQ R13, R9
	MOVQ $0x2a3d4ba78d98b364, R13
	ADCQ R13, R10
	MOVQ $0x0000030ebcc787aa, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x2b6d228264de6667, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xc958ab717d7cf22a, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x3a7862a6d1128f5b, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xdbf4ad9c481a116f, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x9c228c38adee4617, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xe8dd623cb42df4bf, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x4984f4c300d28af2, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x387f35bdf49378e0, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x2a3d4ba78d98b364, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000030ebcc787aa, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x2b6d228264de6667, AX
	ADDQ AX, DX
	MOVQ $0xc958ab717d7cf22a, AX
	ADCQ AX, CX
	MOVQ $0x3a7862a6d1128f5b, AX
	ADCQ AX, BX
	MOVQ $0xdbf4ad9c481a116f, AX
	ADCQ AX, SI
	MOVQ $0x9c228c38adee4617, AX
	ADCQ AX, DI
	MOVQ $0xe8dd623cb42df4bf, AX
	ADCQ AX, R8
	MOVQ $0x4984f4c300d28af2, AX
	ADCQ AX, R9
	MOVQ $0x387f35bdf49378e0, AX
	ADCQ AX, R10
	MOVQ $0x2a3d4ba78d98b364, AX
	ADCQ AX, R11
	MOVQ $0x0000030ebcc787aa, AX
	ADCQ AX, R12
