...
var benchRese_nocarry_0618 e_nocarry_0618

func BenchmarkE_nocarry_0618SetBytes(b *testing.B) {
	var x e_nocarry_0618
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0618MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0618.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0618)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0618)
		}
	})
}

func BenchmarkE_nocarry_0618Inverse(b *testing.B) {
	var x e_nocarry_0618
	x.SetRandom()
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0618Butterfly(b *testing.B) {
	var x e_nocarry_0618
	x.SetRandom()
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0618)
	}
}

func BenchmarkE_nocarry_0618Exp(b *testing.B) {
	var x e_nocarry_0618
	x.SetRandom()
	benchRese_nocarry_0618.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0618Double(b *testing.B) {
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Double(&benchRese_nocarry_0618)
	}
}

func BenchmarkE_nocarry_0618Add(b *testing.B) {
	var x e_nocarry_0618
	x.SetRandom()
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Add(&x, &benchRese_nocarry_0618)
	}
}

func BenchmarkE_nocarry_0618Sub(b *testing.B) {
	var x e_nocarry_0618
	x.SetRandom()
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Sub(&x, &benchRese_nocarry_0618)
	}
}

func BenchmarkE_nocarry_0618Neg(b *testing.B) {
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Neg(&benchRese_nocarry_0618)
	}
}

func BenchmarkE_nocarry_0618Div(b *testing.B) {
	var x e_nocarry_0618
	x.SetRandom()
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Div(&x, &benchRese_nocarry_0618)
	}
}

func BenchmarkE_nocarry_0618FromMont(b *testing.B) {
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.FromMont()
	}
}

func BenchmarkE_nocarry_0618ToMont(b *testing.B) {
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.ToMont()
	}
}
func BenchmarkE_nocarry_0618Square(b *testing.B) {
	benchRese_nocarry_0618.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Square(&benchRese_nocarry_0618)
	}
}

func BenchmarkE_nocarry_0618Sqrt(b *testing.B) {
	var a e_nocarry_0618
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0618Mul(b *testing.B) {
	x := e_nocarry_0618{
		7387001598329269419,
		1467588089272684746,
	...
	benchRese_nocarry_0618.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Mul(&benchRese_nocarry_0618, &x)
	}
}

func BenchmarkE_nocarry_0618Cmp(b *testing.B) {
	x := e_nocarry_0618{
		7387001598329269419,
		1467588089272684746,
		16834170343041988622,
	...
	benchRese_nocarry_0618 = x
	benchRese_nocarry_0618[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0618.Cmp(&x)
	}
}

func TestE_nocarry_0618Cmp(t *testing.T) {
	var x, y e_nocarry_0618
...
func TestE_nocarry_0618IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0618
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0618

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0618{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0618
	one.SetOne()
	e.Sub(&qe_nocarry_0618, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0618{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0618{0, uint64(i)})
	}
...
func TestE_nocarry_0618NegZero(t *testing.T) {
	var a, b e_nocarry_0618
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0618Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0618, len(staticTestValues))
...
func TestE_nocarry_0618Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0618) bool {
			var b e_nocarry_0618
...
func TestE_nocarry_0618InverseExp(t *testing.T) {
...
func TestE_nocarry_0618MulByConstants(t *testing.T) {
...
func TestE_nocarry_0618Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0618) bool {
...
func TestE_nocarry_0618LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0618Halve(t *testing.T) {
...
func TestE_nocarry_0618FromMont(t *testing.T) {
...
type testPaire_nocarry_0618 struct {
	element e_nocarry_0618
	bigint  big.Int
}

func (z *e_nocarry_0618) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0618[9] {
		return true
	}
	if z[9] < qe_nocarry_0618[9] {
		return false
	...
	return z[0] >= qe_nocarry_0618[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0618

		g.element = e_nocarry_0618{
		...
		if qe_nocarry_0618[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0618[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0618 {
			var g e_nocarry_0618
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0618[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0618[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0618[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0618[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0618[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0618[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0618[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0618[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0618[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0618[9], carry)
...
func Benchmarke_nocarry_0618InverseNew(b *testing.B) {
	var x e_nocarry_0618
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0618
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0618
		var xInv e_nocarry_0618
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0618
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0618
...
func testLinearComb(t *testing.T, x *e_nocarry_0618, xC int64, y *e_nocarry_0618, yC int64) {
	...
	var z e_nocarry_0618
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0618, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0618
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0618, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0618
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0618, xHi uint64) {
	var res e_nocarry_0618
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0618) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0618) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0618, c int64, result *e_nocarry_0618, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0618) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0618) uint64 {
