...
var benchRese_nocarry_0393 e_nocarry_0393

func BenchmarkE_nocarry_0393SetBytes(b *testing.B) {
	var x e_nocarry_0393
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0393MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0393.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0393)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0393)
		}
	})
}

func BenchmarkE_nocarry_0393Inverse(b *testing.B) {
	var x e_nocarry_0393
	x.SetRandom()
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0393Butterfly(b *testing.B) {
	var x e_nocarry_0393
	x.SetRandom()
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0393)
	}
}

func BenchmarkE_nocarry_0393Exp(b *testing.B) {
	var x e_nocarry_0393
	x.SetRandom()
	benchRese_nocarry_0393.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0393Double(b *testing.B) {
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Double(&benchRese_nocarry_0393)
	}
}

func BenchmarkE_nocarry_0393Add(b *testing.B) {
	var x e_nocarry_0393
	x.SetRandom()
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Add(&x, &benchRese_nocarry_0393)
	}
}

func BenchmarkE_nocarry_0393Sub(b *testing.B) {
	var x e_nocarry_0393
	x.SetRandom()
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Sub(&x, &benchRese_nocarry_0393)
	}
}

func BenchmarkE_nocarry_0393Neg(b *testing.B) {
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Neg(&benchRese_nocarry_0393)
	}
}

func BenchmarkE_nocarry_0393Div(b *testing.B) {
	var x e_nocarry_0393
	x.SetRandom()
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Div(&x, &benchRese_nocarry_0393)
	}
}

func BenchmarkE_nocarry_0393FromMont(b *testing.B) {
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.FromMont()
	}
}

func BenchmarkE_nocarry_0393ToMont(b *testing.B) {
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.ToMont()
	}
}
func BenchmarkE_nocarry_0393Square(b *testing.B) {
	benchRese_nocarry_0393.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Square(&benchRese_nocarry_0393)
	}
}

func BenchmarkE_nocarry_0393Sqrt(b *testing.B) {
	var a e_nocarry_0393
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0393Mul(b *testing.B) {
	x := e_nocarry_0393{
	...
	benchRese_nocarry_0393.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Mul(&benchRese_nocarry_0393, &x)
	}
}

func BenchmarkE_nocarry_0393Cmp(b *testing.B) {
	x := e_nocarry_0393{
		11364986419698522116,
		10406632362329207440,
		2674244104301104057,
	...
	benchRese_nocarry_0393 = x
	benchRese_nocarry_0393[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0393.Cmp(&x)
	}
}

func TestE_nocarry_0393Cmp(t *testing.T) {
	var x, y e_nocarry_0393
...
func TestE_nocarry_0393IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0393
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0393

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0393{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0393
	one.SetOne()
	e.Sub(&qe_nocarry_0393, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0393{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0393{0, uint64(i)})
	}
...
func TestE_nocarry_0393NegZero(t *testing.T) {
	var a, b e_nocarry_0393
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0393Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0393, len(staticTestValues))
...
func TestE_nocarry_0393Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0393) bool {
			var b e_nocarry_0393
...
func TestE_nocarry_0393InverseExp(t *testing.T) {
...
func TestE_nocarry_0393MulByConstants(t *testing.T) {
...
func TestE_nocarry_0393Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0393) bool {
...
func TestE_nocarry_0393LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0393Halve(t *testing.T) {
...
func TestE_nocarry_0393FromMont(t *testing.T) {
...
type testPaire_nocarry_0393 struct {
	element e_nocarry_0393
	bigint  big.Int
}

func (z *e_nocarry_0393) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0393[6] {
		return true
	}
	if z[6] < qe_nocarry_0393[6] {
		return false
	...
	return z[0] >= qe_nocarry_0393[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0393

		g.element = e_nocarry_0393{
		...
		if qe_nocarry_0393[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0393[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0393 {
			var g e_nocarry_0393
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0393[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0393[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0393[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0393[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0393[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0393[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0393[6], carry)
...
func Benchmarke_nocarry_0393InverseNew(b *testing.B) {
	var x e_nocarry_0393
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0393
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0393
		var xInv e_nocarry_0393
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0393
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0393
...
func testLinearComb(t *testing.T, x *e_nocarry_0393, xC int64, y *e_nocarry_0393, yC int64) {
	...
	var z e_nocarry_0393
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0393, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0393
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0393, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0393
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0393, xHi uint64) {
	var res e_nocarry_0393
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0393) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0393) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0393, c int64, result *e_nocarry_0393, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0393) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0393) uint64 {
