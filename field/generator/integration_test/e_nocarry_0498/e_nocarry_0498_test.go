...
var benchRese_nocarry_0498 e_nocarry_0498

func BenchmarkE_nocarry_0498SetBytes(b *testing.B) {
	var x e_nocarry_0498
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0498MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0498.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0498)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0498)
		}
	})
}

func BenchmarkE_nocarry_0498Inverse(b *testing.B) {
	var x e_nocarry_0498
	x.SetRandom()
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0498Butterfly(b *testing.B) {
	var x e_nocarry_0498
	x.SetRandom()
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0498)
	}
}

func BenchmarkE_nocarry_0498Exp(b *testing.B) {
	var x e_nocarry_0498
	x.SetRandom()
	benchRese_nocarry_0498.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0498Double(b *testing.B) {
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Double(&benchRese_nocarry_0498)
	}
}

func BenchmarkE_nocarry_0498Add(b *testing.B) {
	var x e_nocarry_0498
	x.SetRandom()
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Add(&x, &benchRese_nocarry_0498)
	}
}

func BenchmarkE_nocarry_0498Sub(b *testing.B) {
	var x e_nocarry_0498
	x.SetRandom()
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Sub(&x, &benchRese_nocarry_0498)
	}
}

func BenchmarkE_nocarry_0498Neg(b *testing.B) {
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Neg(&benchRese_nocarry_0498)
	}
}

func BenchmarkE_nocarry_0498Div(b *testing.B) {
	var x e_nocarry_0498
	x.SetRandom()
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Div(&x, &benchRese_nocarry_0498)
	}
}

func BenchmarkE_nocarry_0498FromMont(b *testing.B) {
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.FromMont()
	}
}

func BenchmarkE_nocarry_0498ToMont(b *testing.B) {
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.ToMont()
	}
}
func BenchmarkE_nocarry_0498Square(b *testing.B) {
	benchRese_nocarry_0498.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Square(&benchRese_nocarry_0498)
	}
}

func BenchmarkE_nocarry_0498Sqrt(b *testing.B) {
	var a e_nocarry_0498
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0498Mul(b *testing.B) {
	x := e_nocarry_0498{
	...
	benchRese_nocarry_0498.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Mul(&benchRese_nocarry_0498, &x)
	}
}

func BenchmarkE_nocarry_0498Cmp(b *testing.B) {
	x := e_nocarry_0498{
		10889772499414256354,
		16827735151740734873,
		7561481529000275654,
	...
	benchRese_nocarry_0498 = x
	benchRese_nocarry_0498[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0498.Cmp(&x)
	}
}

func TestE_nocarry_0498Cmp(t *testing.T) {
	var x, y e_nocarry_0498
...
func TestE_nocarry_0498IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0498
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0498

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0498{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0498
	one.SetOne()
	e.Sub(&qe_nocarry_0498, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0498{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0498{0, uint64(i)})
	}
...
func TestE_nocarry_0498NegZero(t *testing.T) {
	var a, b e_nocarry_0498
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0498Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0498, len(staticTestValues))
...
func TestE_nocarry_0498Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0498) bool {
			var b e_nocarry_0498
...
func TestE_nocarry_0498InverseExp(t *testing.T) {
...
func TestE_nocarry_0498MulByConstants(t *testing.T) {
...
func TestE_nocarry_0498Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0498) bool {
...
func TestE_nocarry_0498LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0498Halve(t *testing.T) {
...
func TestE_nocarry_0498FromMont(t *testing.T) {
...
type testPaire_nocarry_0498 struct {
	element e_nocarry_0498
	bigint  big.Int
}

func (z *e_nocarry_0498) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0498[7] {
		return true
	}
	if z[7] < qe_nocarry_0498[7] {
		return false
	...
	return z[0] >= qe_nocarry_0498[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0498

		g.element = e_nocarry_0498{
		...
		if qe_nocarry_0498[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0498[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0498 {
			var g e_nocarry_0498
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0498[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0498[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0498[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0498[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0498[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0498[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0498[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0498[7], carry)
...
func Benchmarke_nocarry_0498InverseNew(b *testing.B) {
	var x e_nocarry_0498
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0498
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0498
		var xInv e_nocarry_0498
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0498
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0498
...
func testLinearComb(t *testing.T, x *e_nocarry_0498, xC int64, y *e_nocarry_0498, yC int64) {
	...
	var z e_nocarry_0498
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0498, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0498
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0498, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0498
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0498, xHi uint64) {
	var res e_nocarry_0498
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0498) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0498) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0498, c int64, result *e_nocarry_0498, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0498) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0498) uint64 {
