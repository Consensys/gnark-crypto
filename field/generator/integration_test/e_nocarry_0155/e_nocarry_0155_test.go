...
var benchRese_nocarry_0155 e_nocarry_0155

func BenchmarkE_nocarry_0155SetBytes(b *testing.B) {
	var x e_nocarry_0155
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0155MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0155.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0155)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0155)
		}
	})
}

func BenchmarkE_nocarry_0155Inverse(b *testing.B) {
	var x e_nocarry_0155
	x.SetRandom()
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0155Butterfly(b *testing.B) {
	var x e_nocarry_0155
	x.SetRandom()
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0155)
	}
}

func BenchmarkE_nocarry_0155Exp(b *testing.B) {
	var x e_nocarry_0155
	x.SetRandom()
	benchRese_nocarry_0155.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0155Double(b *testing.B) {
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Double(&benchRese_nocarry_0155)
	}
}

func BenchmarkE_nocarry_0155Add(b *testing.B) {
	var x e_nocarry_0155
	x.SetRandom()
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Add(&x, &benchRese_nocarry_0155)
	}
}

func BenchmarkE_nocarry_0155Sub(b *testing.B) {
	var x e_nocarry_0155
	x.SetRandom()
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Sub(&x, &benchRese_nocarry_0155)
	}
}

func BenchmarkE_nocarry_0155Neg(b *testing.B) {
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Neg(&benchRese_nocarry_0155)
	}
}

func BenchmarkE_nocarry_0155Div(b *testing.B) {
	var x e_nocarry_0155
	x.SetRandom()
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Div(&x, &benchRese_nocarry_0155)
	}
}

func BenchmarkE_nocarry_0155FromMont(b *testing.B) {
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.FromMont()
	}
}

func BenchmarkE_nocarry_0155ToMont(b *testing.B) {
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.ToMont()
	}
}
func BenchmarkE_nocarry_0155Square(b *testing.B) {
	benchRese_nocarry_0155.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Square(&benchRese_nocarry_0155)
	}
}

func BenchmarkE_nocarry_0155Sqrt(b *testing.B) {
	var a e_nocarry_0155
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0155Mul(b *testing.B) {
	x := e_nocarry_0155{
		15798383793872862495,
		8595869258173282396,
		74863416,
	}
	benchRese_nocarry_0155.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Mul(&benchRese_nocarry_0155, &x)
	}
}

func BenchmarkE_nocarry_0155Cmp(b *testing.B) {
	x := e_nocarry_0155{
		15798383793872862495,
		8595869258173282396,
		74863416,
	}
	benchRese_nocarry_0155 = x
	benchRese_nocarry_0155[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0155.Cmp(&x)
	}
}

func TestE_nocarry_0155Cmp(t *testing.T) {
	var x, y e_nocarry_0155
...
func TestE_nocarry_0155IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0155
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0155

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0155{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0155
	one.SetOne()
	e.Sub(&qe_nocarry_0155, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0155{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0155{0, uint64(i)})
	}
...
func TestE_nocarry_0155NegZero(t *testing.T) {
	var a, b e_nocarry_0155
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0155Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0155, len(staticTestValues))
...
func TestE_nocarry_0155Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0155) bool {
			var b e_nocarry_0155
...
func TestE_nocarry_0155InverseExp(t *testing.T) {
...
func TestE_nocarry_0155MulByConstants(t *testing.T) {
...
func TestE_nocarry_0155Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0155) bool {
...
func TestE_nocarry_0155LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0155Halve(t *testing.T) {
...
func TestE_nocarry_0155FromMont(t *testing.T) {
...
type testPaire_nocarry_0155 struct {
	element e_nocarry_0155
	bigint  big.Int
}

func (z *e_nocarry_0155) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0155[2] {
		return true
	}
	if z[2] < qe_nocarry_0155[2] {
		return false
	...
	return z[0] >= qe_nocarry_0155[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0155

		g.element = e_nocarry_0155{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0155[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0155[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0155 {
			var g e_nocarry_0155
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0155[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0155[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0155[2], carry)
...
func Benchmarke_nocarry_0155InverseNew(b *testing.B) {
	var x e_nocarry_0155
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0155
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0155
		var xInv e_nocarry_0155
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0155
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0155
...
func testLinearComb(t *testing.T, x *e_nocarry_0155, xC int64, y *e_nocarry_0155, yC int64) {
	...
	var z e_nocarry_0155
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0155, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0155
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0155, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0155
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0155, xHi uint64) {
	var res e_nocarry_0155
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0155) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0155) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0155, c int64, result *e_nocarry_0155, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0155) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0155) uint64 {
