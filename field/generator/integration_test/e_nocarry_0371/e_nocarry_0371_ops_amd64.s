...
// modulus q
DATA q<>+0(SB)/8, $0x1911eeb605eb4fc5
DATA q<>+8(SB)/8, $0x202ca196af0d7174
DATA q<>+16(SB)/8, $0x43ed9a01bc6e2020
DATA q<>+24(SB)/8, $0x3df7f72e104afa7d
DATA q<>+32(SB)/8, $0x727bb97ae5b05d8a
DATA q<>+40(SB)/8, $0x00061fc7ece43c71
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xf140505b9ac2a8f3
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x1911eeb605eb4fc5, R10
	MOVQ    $0x202ca196af0d7174, R11
	MOVQ    $0x43ed9a01bc6e2020, R12
	MOVQ    $0x3df7f72e104afa7d, R13
	MOVQ    $0x727bb97ae5b05d8a, R14
	MOVQ    $0x00061fc7ece43c71, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x202ca196af0d7174, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x43ed9a01bc6e2020, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x3df7f72e104afa7d, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x727bb97ae5b05d8a, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00061fc7ece43c71, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x1911eeb605eb4fc5, CX
	MOVQ    $0x202ca196af0d7174, BX
	MOVQ    $0x43ed9a01bc6e2020, SI
	MOVQ    $0x3df7f72e104afa7d, DI
	MOVQ    $0x727bb97ae5b05d8a, R8
	MOVQ    $0x00061fc7ece43c71, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
