...
var benchRese_nocarry_0371 e_nocarry_0371

func BenchmarkE_nocarry_0371SetBytes(b *testing.B) {
	var x e_nocarry_0371
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0371MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0371.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0371)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0371)
		}
	})
}

func BenchmarkE_nocarry_0371Inverse(b *testing.B) {
	var x e_nocarry_0371
	x.SetRandom()
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0371Butterfly(b *testing.B) {
	var x e_nocarry_0371
	x.SetRandom()
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0371)
	}
}

func BenchmarkE_nocarry_0371Exp(b *testing.B) {
	var x e_nocarry_0371
	x.SetRandom()
	benchRese_nocarry_0371.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0371Double(b *testing.B) {
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Double(&benchRese_nocarry_0371)
	}
}

func BenchmarkE_nocarry_0371Add(b *testing.B) {
	var x e_nocarry_0371
	x.SetRandom()
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Add(&x, &benchRese_nocarry_0371)
	}
}

func BenchmarkE_nocarry_0371Sub(b *testing.B) {
	var x e_nocarry_0371
	x.SetRandom()
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Sub(&x, &benchRese_nocarry_0371)
	}
}

func BenchmarkE_nocarry_0371Neg(b *testing.B) {
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Neg(&benchRese_nocarry_0371)
	}
}

func BenchmarkE_nocarry_0371Div(b *testing.B) {
	var x e_nocarry_0371
	x.SetRandom()
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Div(&x, &benchRese_nocarry_0371)
	}
}

func BenchmarkE_nocarry_0371FromMont(b *testing.B) {
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.FromMont()
	}
}

func BenchmarkE_nocarry_0371ToMont(b *testing.B) {
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.ToMont()
	}
}
func BenchmarkE_nocarry_0371Square(b *testing.B) {
	benchRese_nocarry_0371.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Square(&benchRese_nocarry_0371)
	}
}

func BenchmarkE_nocarry_0371Sqrt(b *testing.B) {
	var a e_nocarry_0371
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0371Mul(b *testing.B) {
	x := e_nocarry_0371{
	...
	benchRese_nocarry_0371.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Mul(&benchRese_nocarry_0371, &x)
	}
}

func BenchmarkE_nocarry_0371Cmp(b *testing.B) {
	x := e_nocarry_0371{
		11413249492070278638,
		4060960785840247502,
		13450963848429184246,
	...
	benchRese_nocarry_0371 = x
	benchRese_nocarry_0371[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0371.Cmp(&x)
	}
}

func TestE_nocarry_0371Cmp(t *testing.T) {
	var x, y e_nocarry_0371
...
func TestE_nocarry_0371IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0371
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0371

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0371{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0371
	one.SetOne()
	e.Sub(&qe_nocarry_0371, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0371{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0371{0, uint64(i)})
	}
...
func TestE_nocarry_0371NegZero(t *testing.T) {
	var a, b e_nocarry_0371
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0371Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0371, len(staticTestValues))
...
func TestE_nocarry_0371Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0371) bool {
			var b e_nocarry_0371
...
func TestE_nocarry_0371InverseExp(t *testing.T) {
...
func TestE_nocarry_0371MulByConstants(t *testing.T) {
...
func TestE_nocarry_0371Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0371) bool {
...
func TestE_nocarry_0371LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0371Halve(t *testing.T) {
...
func TestE_nocarry_0371FromMont(t *testing.T) {
...
type testPaire_nocarry_0371 struct {
	element e_nocarry_0371
	bigint  big.Int
}

func (z *e_nocarry_0371) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0371[5] {
		return true
	}
	if z[5] < qe_nocarry_0371[5] {
		return false
	...
	return z[0] >= qe_nocarry_0371[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0371

		g.element = e_nocarry_0371{
		...
		if qe_nocarry_0371[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0371[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0371 {
			var g e_nocarry_0371
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0371[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0371[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0371[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0371[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0371[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0371[5], carry)
...
func Benchmarke_nocarry_0371InverseNew(b *testing.B) {
	var x e_nocarry_0371
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0371
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0371
		var xInv e_nocarry_0371
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0371
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0371
...
func testLinearComb(t *testing.T, x *e_nocarry_0371, xC int64, y *e_nocarry_0371, yC int64) {
	...
	var z e_nocarry_0371
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0371, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0371
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0371, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0371
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0371, xHi uint64) {
	var res e_nocarry_0371
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0371) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0371) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0371, c int64, result *e_nocarry_0371, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0371) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0371) uint64 {
