...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xb2e1caad37f50b47, R12
	ADDQ R12, AX
	MOVQ $0x2f0bdf6bf2151401, R12
	ADCQ R12, DX
	MOVQ $0x70b52b84fa2c1a3c, R12
	ADCQ R12, CX
	MOVQ $0xa0c1dc9f36f2092e, R12
	ADCQ R12, BX
	MOVQ $0xaeb6238319b62af6, R12
	ADCQ R12, SI
	MOVQ $0x523f78412a77134a, R12
	ADCQ R12, DI
	MOVQ $0x74af37d3cf526532, R12
	ADCQ R12, R8
	MOVQ $0x9e4889e0f146a13e, R12
	ADCQ R12, R9
	MOVQ $0x0000000000003417, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xb2e1caad37f50b47, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x2f0bdf6bf2151401, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x70b52b84fa2c1a3c, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xa0c1dc9f36f2092e, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xaeb6238319b62af6, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x523f78412a77134a, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x74af37d3cf526532, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x9e4889e0f146a13e, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000000003417, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xb2e1caad37f50b47, AX
	ADDQ AX, DX
	MOVQ $0x2f0bdf6bf2151401, AX
	ADCQ AX, CX
	MOVQ $0x70b52b84fa2c1a3c, AX
	ADCQ AX, BX
	MOVQ $0xa0c1dc9f36f2092e, AX
	ADCQ AX, SI
	MOVQ $0xaeb6238319b62af6, AX
	ADCQ AX, DI
	MOVQ $0x523f78412a77134a, AX
	ADCQ AX, R8
	MOVQ $0x74af37d3cf526532, AX
	ADCQ AX, R9
	MOVQ $0x9e4889e0f146a13e, AX
	ADCQ AX, R10
	MOVQ $0x0000000000003417, AX
	ADCQ AX, R11
