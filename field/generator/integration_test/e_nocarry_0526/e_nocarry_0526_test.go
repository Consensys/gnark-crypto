...
var benchRese_nocarry_0526 e_nocarry_0526

func BenchmarkE_nocarry_0526SetBytes(b *testing.B) {
	var x e_nocarry_0526
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0526MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0526.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0526)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0526)
		}
	})
}

func BenchmarkE_nocarry_0526Inverse(b *testing.B) {
	var x e_nocarry_0526
	x.SetRandom()
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0526Butterfly(b *testing.B) {
	var x e_nocarry_0526
	x.SetRandom()
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0526)
	}
}

func BenchmarkE_nocarry_0526Exp(b *testing.B) {
	var x e_nocarry_0526
	x.SetRandom()
	benchRese_nocarry_0526.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0526Double(b *testing.B) {
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Double(&benchRese_nocarry_0526)
	}
}

func BenchmarkE_nocarry_0526Add(b *testing.B) {
	var x e_nocarry_0526
	x.SetRandom()
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Add(&x, &benchRese_nocarry_0526)
	}
}

func BenchmarkE_nocarry_0526Sub(b *testing.B) {
	var x e_nocarry_0526
	x.SetRandom()
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Sub(&x, &benchRese_nocarry_0526)
	}
}

func BenchmarkE_nocarry_0526Neg(b *testing.B) {
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Neg(&benchRese_nocarry_0526)
	}
}

func BenchmarkE_nocarry_0526Div(b *testing.B) {
	var x e_nocarry_0526
	x.SetRandom()
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Div(&x, &benchRese_nocarry_0526)
	}
}

func BenchmarkE_nocarry_0526FromMont(b *testing.B) {
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.FromMont()
	}
}

func BenchmarkE_nocarry_0526ToMont(b *testing.B) {
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.ToMont()
	}
}
func BenchmarkE_nocarry_0526Square(b *testing.B) {
	benchRese_nocarry_0526.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Square(&benchRese_nocarry_0526)
	}
}

func BenchmarkE_nocarry_0526Sqrt(b *testing.B) {
	var a e_nocarry_0526
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0526Mul(b *testing.B) {
	x := e_nocarry_0526{
	...
	benchRese_nocarry_0526.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Mul(&benchRese_nocarry_0526, &x)
	}
}

func BenchmarkE_nocarry_0526Cmp(b *testing.B) {
	x := e_nocarry_0526{
		13364211648071521259,
		10969636657371820736,
		17460842969000718754,
	...
	benchRese_nocarry_0526 = x
	benchRese_nocarry_0526[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0526.Cmp(&x)
	}
}

func TestE_nocarry_0526Cmp(t *testing.T) {
	var x, y e_nocarry_0526
...
func TestE_nocarry_0526IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0526
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0526

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0526{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0526
	one.SetOne()
	e.Sub(&qe_nocarry_0526, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0526{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0526{0, uint64(i)})
	}
...
func TestE_nocarry_0526NegZero(t *testing.T) {
	var a, b e_nocarry_0526
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0526Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0526, len(staticTestValues))
...
func TestE_nocarry_0526Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0526) bool {
			var b e_nocarry_0526
...
func TestE_nocarry_0526InverseExp(t *testing.T) {
...
func TestE_nocarry_0526MulByConstants(t *testing.T) {
...
func TestE_nocarry_0526Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0526) bool {
...
func TestE_nocarry_0526LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0526Halve(t *testing.T) {
...
func TestE_nocarry_0526FromMont(t *testing.T) {
...
type testPaire_nocarry_0526 struct {
	element e_nocarry_0526
	bigint  big.Int
}

func (z *e_nocarry_0526) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0526[8] {
		return true
	}
	if z[8] < qe_nocarry_0526[8] {
		return false
	...
	return z[0] >= qe_nocarry_0526[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0526

		g.element = e_nocarry_0526{
		...
		if qe_nocarry_0526[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0526[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0526 {
			var g e_nocarry_0526
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0526[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0526[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0526[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0526[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0526[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0526[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0526[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0526[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0526[8], carry)
...
func Benchmarke_nocarry_0526InverseNew(b *testing.B) {
	var x e_nocarry_0526
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0526
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0526
		var xInv e_nocarry_0526
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0526
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0526
...
func testLinearComb(t *testing.T, x *e_nocarry_0526, xC int64, y *e_nocarry_0526, yC int64) {
	...
	var z e_nocarry_0526
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0526, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0526
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0526, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0526
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0526, xHi uint64) {
	var res e_nocarry_0526
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0526) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0526) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0526, c int64, result *e_nocarry_0526, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0526) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0526) uint64 {
