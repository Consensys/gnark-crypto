...
var benchRese_nocarry_0492 e_nocarry_0492

func BenchmarkE_nocarry_0492SetBytes(b *testing.B) {
	var x e_nocarry_0492
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0492MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0492.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0492)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0492)
		}
	})
}

func BenchmarkE_nocarry_0492Inverse(b *testing.B) {
	var x e_nocarry_0492
	x.SetRandom()
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0492Butterfly(b *testing.B) {
	var x e_nocarry_0492
	x.SetRandom()
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0492)
	}
}

func BenchmarkE_nocarry_0492Exp(b *testing.B) {
	var x e_nocarry_0492
	x.SetRandom()
	benchRese_nocarry_0492.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0492Double(b *testing.B) {
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Double(&benchRese_nocarry_0492)
	}
}

func BenchmarkE_nocarry_0492Add(b *testing.B) {
	var x e_nocarry_0492
	x.SetRandom()
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Add(&x, &benchRese_nocarry_0492)
	}
}

func BenchmarkE_nocarry_0492Sub(b *testing.B) {
	var x e_nocarry_0492
	x.SetRandom()
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Sub(&x, &benchRese_nocarry_0492)
	}
}

func BenchmarkE_nocarry_0492Neg(b *testing.B) {
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Neg(&benchRese_nocarry_0492)
	}
}

func BenchmarkE_nocarry_0492Div(b *testing.B) {
	var x e_nocarry_0492
	x.SetRandom()
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Div(&x, &benchRese_nocarry_0492)
	}
}

func BenchmarkE_nocarry_0492FromMont(b *testing.B) {
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.FromMont()
	}
}

func BenchmarkE_nocarry_0492ToMont(b *testing.B) {
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.ToMont()
	}
}
func BenchmarkE_nocarry_0492Square(b *testing.B) {
	benchRese_nocarry_0492.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Square(&benchRese_nocarry_0492)
	}
}

func BenchmarkE_nocarry_0492Sqrt(b *testing.B) {
	var a e_nocarry_0492
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0492Mul(b *testing.B) {
	x := e_nocarry_0492{
	...
	benchRese_nocarry_0492.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Mul(&benchRese_nocarry_0492, &x)
	}
}

func BenchmarkE_nocarry_0492Cmp(b *testing.B) {
	x := e_nocarry_0492{
		17075652440284008562,
		15409809994758683606,
		5553016241882145501,
	...
	benchRese_nocarry_0492 = x
	benchRese_nocarry_0492[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0492.Cmp(&x)
	}
}

func TestE_nocarry_0492Cmp(t *testing.T) {
	var x, y e_nocarry_0492
...
func TestE_nocarry_0492IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0492
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0492

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0492{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0492
	one.SetOne()
	e.Sub(&qe_nocarry_0492, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0492{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0492{0, uint64(i)})
	}
...
func TestE_nocarry_0492NegZero(t *testing.T) {
	var a, b e_nocarry_0492
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0492Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0492, len(staticTestValues))
...
func TestE_nocarry_0492Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0492) bool {
			var b e_nocarry_0492
...
func TestE_nocarry_0492InverseExp(t *testing.T) {
...
func TestE_nocarry_0492MulByConstants(t *testing.T) {
...
func TestE_nocarry_0492Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0492) bool {
...
func TestE_nocarry_0492LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0492Halve(t *testing.T) {
...
func TestE_nocarry_0492FromMont(t *testing.T) {
...
type testPaire_nocarry_0492 struct {
	element e_nocarry_0492
	bigint  big.Int
}

func (z *e_nocarry_0492) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0492[7] {
		return true
	}
	if z[7] < qe_nocarry_0492[7] {
		return false
	...
	return z[0] >= qe_nocarry_0492[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0492

		g.element = e_nocarry_0492{
		...
		if qe_nocarry_0492[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0492[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0492 {
			var g e_nocarry_0492
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0492[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0492[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0492[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0492[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0492[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0492[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0492[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0492[7], carry)
...
func Benchmarke_nocarry_0492InverseNew(b *testing.B) {
	var x e_nocarry_0492
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0492
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0492
		var xInv e_nocarry_0492
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0492
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0492
...
func testLinearComb(t *testing.T, x *e_nocarry_0492, xC int64, y *e_nocarry_0492, yC int64) {
	...
	var z e_nocarry_0492
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0492, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0492
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0492, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0492
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0492, xHi uint64) {
	var res e_nocarry_0492
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0492) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0492) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0492, c int64, result *e_nocarry_0492, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0492) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0492) uint64 {
