...
// modulus q
DATA q<>+0(SB)/8, $0x5cfc7a0f46f72d8d
DATA q<>+8(SB)/8, $0xc5aff49f8972521c
DATA q<>+16(SB)/8, $0x00c6cd86fdf52baf
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xbb32717f353922bb
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x5cfc7a0f46f72d8d, DI
	MOVQ    $0xc5aff49f8972521c, R8
	MOVQ    $0x00c6cd86fdf52baf, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xc5aff49f8972521c, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x00c6cd86fdf52baf, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x5cfc7a0f46f72d8d, R10
	MOVQ    $0xc5aff49f8972521c, R11
	MOVQ    $0x00c6cd86fdf52baf, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
