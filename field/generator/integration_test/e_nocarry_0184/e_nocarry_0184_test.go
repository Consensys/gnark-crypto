...
var benchRese_nocarry_0184 e_nocarry_0184

func BenchmarkE_nocarry_0184SetBytes(b *testing.B) {
	var x e_nocarry_0184
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0184MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0184.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0184)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0184)
		}
	})
}

func BenchmarkE_nocarry_0184Inverse(b *testing.B) {
	var x e_nocarry_0184
	x.SetRandom()
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0184Butterfly(b *testing.B) {
	var x e_nocarry_0184
	x.SetRandom()
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0184)
	}
}

func BenchmarkE_nocarry_0184Exp(b *testing.B) {
	var x e_nocarry_0184
	x.SetRandom()
	benchRese_nocarry_0184.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0184Double(b *testing.B) {
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Double(&benchRese_nocarry_0184)
	}
}

func BenchmarkE_nocarry_0184Add(b *testing.B) {
	var x e_nocarry_0184
	x.SetRandom()
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Add(&x, &benchRese_nocarry_0184)
	}
}

func BenchmarkE_nocarry_0184Sub(b *testing.B) {
	var x e_nocarry_0184
	x.SetRandom()
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Sub(&x, &benchRese_nocarry_0184)
	}
}

func BenchmarkE_nocarry_0184Neg(b *testing.B) {
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Neg(&benchRese_nocarry_0184)
	}
}

func BenchmarkE_nocarry_0184Div(b *testing.B) {
	var x e_nocarry_0184
	x.SetRandom()
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Div(&x, &benchRese_nocarry_0184)
	}
}

func BenchmarkE_nocarry_0184FromMont(b *testing.B) {
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.FromMont()
	}
}

func BenchmarkE_nocarry_0184ToMont(b *testing.B) {
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.ToMont()
	}
}
func BenchmarkE_nocarry_0184Square(b *testing.B) {
	benchRese_nocarry_0184.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Square(&benchRese_nocarry_0184)
	}
}

func BenchmarkE_nocarry_0184Sqrt(b *testing.B) {
	var a e_nocarry_0184
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0184Mul(b *testing.B) {
	x := e_nocarry_0184{
		3649603508166838912,
		9253811308020147466,
		14389549080650790,
	}
	benchRese_nocarry_0184.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Mul(&benchRese_nocarry_0184, &x)
	}
}

func BenchmarkE_nocarry_0184Cmp(b *testing.B) {
	x := e_nocarry_0184{
		3649603508166838912,
		9253811308020147466,
		14389549080650790,
	}
	benchRese_nocarry_0184 = x
	benchRese_nocarry_0184[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0184.Cmp(&x)
	}
}

func TestE_nocarry_0184Cmp(t *testing.T) {
	var x, y e_nocarry_0184
...
func TestE_nocarry_0184IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0184
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0184

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0184{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0184
	one.SetOne()
	e.Sub(&qe_nocarry_0184, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0184{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0184{0, uint64(i)})
	}
...
func TestE_nocarry_0184NegZero(t *testing.T) {
	var a, b e_nocarry_0184
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0184Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0184, len(staticTestValues))
...
func TestE_nocarry_0184Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0184) bool {
			var b e_nocarry_0184
...
func TestE_nocarry_0184InverseExp(t *testing.T) {
...
func TestE_nocarry_0184MulByConstants(t *testing.T) {
...
func TestE_nocarry_0184Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0184) bool {
...
func TestE_nocarry_0184LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0184Halve(t *testing.T) {
...
func TestE_nocarry_0184FromMont(t *testing.T) {
...
type testPaire_nocarry_0184 struct {
	element e_nocarry_0184
	bigint  big.Int
}

func (z *e_nocarry_0184) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0184[2] {
		return true
	}
	if z[2] < qe_nocarry_0184[2] {
		return false
	...
	return z[0] >= qe_nocarry_0184[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0184

		g.element = e_nocarry_0184{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0184[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0184[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0184 {
			var g e_nocarry_0184
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0184[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0184[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0184[2], carry)
...
func Benchmarke_nocarry_0184InverseNew(b *testing.B) {
	var x e_nocarry_0184
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0184
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0184
		var xInv e_nocarry_0184
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0184
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0184
...
func testLinearComb(t *testing.T, x *e_nocarry_0184, xC int64, y *e_nocarry_0184, yC int64) {
	...
	var z e_nocarry_0184
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0184, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0184
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0184, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0184
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0184, xHi uint64) {
	var res e_nocarry_0184
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0184) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0184) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0184, c int64, result *e_nocarry_0184, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0184) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0184) uint64 {
