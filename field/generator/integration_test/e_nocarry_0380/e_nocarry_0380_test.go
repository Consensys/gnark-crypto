...
var benchRese_nocarry_0380 e_nocarry_0380

func BenchmarkE_nocarry_0380SetBytes(b *testing.B) {
	var x e_nocarry_0380
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0380MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0380.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0380)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0380)
		}
	})
}

func BenchmarkE_nocarry_0380Inverse(b *testing.B) {
	var x e_nocarry_0380
	x.SetRandom()
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0380Butterfly(b *testing.B) {
	var x e_nocarry_0380
	x.SetRandom()
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0380)
	}
}

func BenchmarkE_nocarry_0380Exp(b *testing.B) {
	var x e_nocarry_0380
	x.SetRandom()
	benchRese_nocarry_0380.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0380Double(b *testing.B) {
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Double(&benchRese_nocarry_0380)
	}
}

func BenchmarkE_nocarry_0380Add(b *testing.B) {
	var x e_nocarry_0380
	x.SetRandom()
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Add(&x, &benchRese_nocarry_0380)
	}
}

func BenchmarkE_nocarry_0380Sub(b *testing.B) {
	var x e_nocarry_0380
	x.SetRandom()
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Sub(&x, &benchRese_nocarry_0380)
	}
}

func BenchmarkE_nocarry_0380Neg(b *testing.B) {
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Neg(&benchRese_nocarry_0380)
	}
}

func BenchmarkE_nocarry_0380Div(b *testing.B) {
	var x e_nocarry_0380
	x.SetRandom()
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Div(&x, &benchRese_nocarry_0380)
	}
}

func BenchmarkE_nocarry_0380FromMont(b *testing.B) {
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.FromMont()
	}
}

func BenchmarkE_nocarry_0380ToMont(b *testing.B) {
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.ToMont()
	}
}
func BenchmarkE_nocarry_0380Square(b *testing.B) {
	benchRese_nocarry_0380.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Square(&benchRese_nocarry_0380)
	}
}

func BenchmarkE_nocarry_0380Sqrt(b *testing.B) {
	var a e_nocarry_0380
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0380Mul(b *testing.B) {
	x := e_nocarry_0380{
		4459152265549579677,
	...
	benchRese_nocarry_0380.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Mul(&benchRese_nocarry_0380, &x)
	}
}

func BenchmarkE_nocarry_0380Cmp(b *testing.B) {
	x := e_nocarry_0380{
		4459152265549579677,
		10507701225415423654,
		6966214181519917892,
	...
	benchRese_nocarry_0380 = x
	benchRese_nocarry_0380[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0380.Cmp(&x)
	}
}

func TestE_nocarry_0380Cmp(t *testing.T) {
	var x, y e_nocarry_0380
...
func TestE_nocarry_0380IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0380
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0380

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0380{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0380
	one.SetOne()
	e.Sub(&qe_nocarry_0380, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0380{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0380{0, uint64(i)})
	}
...
func TestE_nocarry_0380NegZero(t *testing.T) {
	var a, b e_nocarry_0380
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0380Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0380, len(staticTestValues))
...
func TestE_nocarry_0380Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0380) bool {
			var b e_nocarry_0380
...
func TestE_nocarry_0380InverseExp(t *testing.T) {
...
func TestE_nocarry_0380MulByConstants(t *testing.T) {
...
func TestE_nocarry_0380Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0380) bool {
...
func TestE_nocarry_0380LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0380Halve(t *testing.T) {
...
func TestE_nocarry_0380FromMont(t *testing.T) {
...
type testPaire_nocarry_0380 struct {
	element e_nocarry_0380
	bigint  big.Int
}

func (z *e_nocarry_0380) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0380[5] {
		return true
	}
	if z[5] < qe_nocarry_0380[5] {
		return false
	...
	return z[0] >= qe_nocarry_0380[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0380

		g.element = e_nocarry_0380{
		...
		if qe_nocarry_0380[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0380[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0380 {
			var g e_nocarry_0380
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0380[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0380[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0380[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0380[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0380[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0380[5], carry)
...
func Benchmarke_nocarry_0380InverseNew(b *testing.B) {
	var x e_nocarry_0380
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0380
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0380
		var xInv e_nocarry_0380
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0380
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0380
...
func testLinearComb(t *testing.T, x *e_nocarry_0380, xC int64, y *e_nocarry_0380, yC int64) {
	...
	var z e_nocarry_0380
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0380, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0380
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0380, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0380
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0380, xHi uint64) {
	var res e_nocarry_0380
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0380) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0380) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0380, c int64, result *e_nocarry_0380, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0380) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0380) uint64 {
