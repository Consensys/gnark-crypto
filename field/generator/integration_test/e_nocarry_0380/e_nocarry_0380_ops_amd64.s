...
// modulus q
DATA q<>+0(SB)/8, $0x980a69a6a4afbd07
DATA q<>+8(SB)/8, $0xe778f536217f3a1c
DATA q<>+16(SB)/8, $0x00ed4b154b0fe115
DATA q<>+24(SB)/8, $0x4a50fbc1cd027650
DATA q<>+32(SB)/8, $0xbec7518fa53e0e2c
DATA q<>+40(SB)/8, $0x0d6ce32b463d0b2d
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xd4ff13d2d576df49
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x980a69a6a4afbd07, R10
	MOVQ    $0xe778f536217f3a1c, R11
	MOVQ    $0x00ed4b154b0fe115, R12
	MOVQ    $0x4a50fbc1cd027650, R13
	MOVQ    $0xbec7518fa53e0e2c, R14
	MOVQ    $0x0d6ce32b463d0b2d, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xe778f536217f3a1c, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x00ed4b154b0fe115, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x4a50fbc1cd027650, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xbec7518fa53e0e2c, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0d6ce32b463d0b2d, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x980a69a6a4afbd07, CX
	MOVQ    $0xe778f536217f3a1c, BX
	MOVQ    $0x00ed4b154b0fe115, SI
	MOVQ    $0x4a50fbc1cd027650, DI
	MOVQ    $0xbec7518fa53e0e2c, R8
	MOVQ    $0x0d6ce32b463d0b2d, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
