...
var benchRese_nocarry_0247 e_nocarry_0247

func BenchmarkE_nocarry_0247SetBytes(b *testing.B) {
	var x e_nocarry_0247
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0247MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0247.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0247)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0247)
		}
	})
}

func BenchmarkE_nocarry_0247Inverse(b *testing.B) {
	var x e_nocarry_0247
	x.SetRandom()
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0247Butterfly(b *testing.B) {
	var x e_nocarry_0247
	x.SetRandom()
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0247)
	}
}

func BenchmarkE_nocarry_0247Exp(b *testing.B) {
	var x e_nocarry_0247
	x.SetRandom()
	benchRese_nocarry_0247.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0247Double(b *testing.B) {
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Double(&benchRese_nocarry_0247)
	}
}

func BenchmarkE_nocarry_0247Add(b *testing.B) {
	var x e_nocarry_0247
	x.SetRandom()
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Add(&x, &benchRese_nocarry_0247)
	}
}

func BenchmarkE_nocarry_0247Sub(b *testing.B) {
	var x e_nocarry_0247
	x.SetRandom()
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Sub(&x, &benchRese_nocarry_0247)
	}
}

func BenchmarkE_nocarry_0247Neg(b *testing.B) {
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Neg(&benchRese_nocarry_0247)
	}
}

func BenchmarkE_nocarry_0247Div(b *testing.B) {
	var x e_nocarry_0247
	x.SetRandom()
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Div(&x, &benchRese_nocarry_0247)
	}
}

func BenchmarkE_nocarry_0247FromMont(b *testing.B) {
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.FromMont()
	}
}

func BenchmarkE_nocarry_0247ToMont(b *testing.B) {
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.ToMont()
	}
}
func BenchmarkE_nocarry_0247Square(b *testing.B) {
	benchRese_nocarry_0247.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Square(&benchRese_nocarry_0247)
	}
}

func BenchmarkE_nocarry_0247Sqrt(b *testing.B) {
	var a e_nocarry_0247
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0247Mul(b *testing.B) {
	x := e_nocarry_0247{
	...
	benchRese_nocarry_0247.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Mul(&benchRese_nocarry_0247, &x)
	}
}

func BenchmarkE_nocarry_0247Cmp(b *testing.B) {
	x := e_nocarry_0247{
		14913402393037257613,
		9799856163480969914,
		15345929299382274401,
	...
	benchRese_nocarry_0247 = x
	benchRese_nocarry_0247[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0247.Cmp(&x)
	}
}

func TestE_nocarry_0247Cmp(t *testing.T) {
	var x, y e_nocarry_0247
...
func TestE_nocarry_0247IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0247
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0247

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0247{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0247
	one.SetOne()
	e.Sub(&qe_nocarry_0247, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0247{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0247{0, uint64(i)})
	}
...
func TestE_nocarry_0247NegZero(t *testing.T) {
	var a, b e_nocarry_0247
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0247Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0247, len(staticTestValues))
...
func TestE_nocarry_0247Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0247) bool {
			var b e_nocarry_0247
...
func TestE_nocarry_0247InverseExp(t *testing.T) {
...
func TestE_nocarry_0247MulByConstants(t *testing.T) {
...
func TestE_nocarry_0247Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0247) bool {
...
func TestE_nocarry_0247LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0247Halve(t *testing.T) {
...
func TestE_nocarry_0247FromMont(t *testing.T) {
...
type testPaire_nocarry_0247 struct {
	element e_nocarry_0247
	bigint  big.Int
}

func (z *e_nocarry_0247) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0247[3] {
		return true
	}
	if z[3] < qe_nocarry_0247[3] {
		return false
	...
	return z[0] >= qe_nocarry_0247[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0247

		g.element = e_nocarry_0247{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0247[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0247[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0247 {
			var g e_nocarry_0247
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0247[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0247[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0247[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0247[3], carry)
...
func Benchmarke_nocarry_0247InverseNew(b *testing.B) {
	var x e_nocarry_0247
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0247
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0247
		var xInv e_nocarry_0247
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0247
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0247
...
func testLinearComb(t *testing.T, x *e_nocarry_0247, xC int64, y *e_nocarry_0247, yC int64) {
	...
	var z e_nocarry_0247
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0247, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0247
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0247, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0247
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0247, xHi uint64) {
	var res e_nocarry_0247
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0247) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0247) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0247, c int64, result *e_nocarry_0247, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0247) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0247) uint64 {
