...
var benchRese_nocarry_0286 e_nocarry_0286

func BenchmarkE_nocarry_0286SetBytes(b *testing.B) {
	var x e_nocarry_0286
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0286MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0286.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0286)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0286)
		}
	})
}

func BenchmarkE_nocarry_0286Inverse(b *testing.B) {
	var x e_nocarry_0286
	x.SetRandom()
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0286Butterfly(b *testing.B) {
	var x e_nocarry_0286
	x.SetRandom()
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0286)
	}
}

func BenchmarkE_nocarry_0286Exp(b *testing.B) {
	var x e_nocarry_0286
	x.SetRandom()
	benchRese_nocarry_0286.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0286Double(b *testing.B) {
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Double(&benchRese_nocarry_0286)
	}
}

func BenchmarkE_nocarry_0286Add(b *testing.B) {
	var x e_nocarry_0286
	x.SetRandom()
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Add(&x, &benchRese_nocarry_0286)
	}
}

func BenchmarkE_nocarry_0286Sub(b *testing.B) {
	var x e_nocarry_0286
	x.SetRandom()
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Sub(&x, &benchRese_nocarry_0286)
	}
}

func BenchmarkE_nocarry_0286Neg(b *testing.B) {
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Neg(&benchRese_nocarry_0286)
	}
}

func BenchmarkE_nocarry_0286Div(b *testing.B) {
	var x e_nocarry_0286
	x.SetRandom()
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Div(&x, &benchRese_nocarry_0286)
	}
}

func BenchmarkE_nocarry_0286FromMont(b *testing.B) {
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.FromMont()
	}
}

func BenchmarkE_nocarry_0286ToMont(b *testing.B) {
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.ToMont()
	}
}
func BenchmarkE_nocarry_0286Square(b *testing.B) {
	benchRese_nocarry_0286.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Square(&benchRese_nocarry_0286)
	}
}

func BenchmarkE_nocarry_0286Sqrt(b *testing.B) {
	var a e_nocarry_0286
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0286Mul(b *testing.B) {
	x := e_nocarry_0286{
		9558719814708392712,
		3058727308161927458,
		7404685810660342884,
	...
	benchRese_nocarry_0286.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Mul(&benchRese_nocarry_0286, &x)
	}
}

func BenchmarkE_nocarry_0286Cmp(b *testing.B) {
	x := e_nocarry_0286{
		9558719814708392712,
		3058727308161927458,
		7404685810660342884,
	...
	benchRese_nocarry_0286 = x
	benchRese_nocarry_0286[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0286.Cmp(&x)
	}
}

func TestE_nocarry_0286Cmp(t *testing.T) {
	var x, y e_nocarry_0286
...
func TestE_nocarry_0286IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0286
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0286

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0286{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0286
	one.SetOne()
	e.Sub(&qe_nocarry_0286, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0286{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0286{0, uint64(i)})
	}
...
func TestE_nocarry_0286NegZero(t *testing.T) {
	var a, b e_nocarry_0286
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0286Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0286, len(staticTestValues))
...
func TestE_nocarry_0286Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0286) bool {
			var b e_nocarry_0286
...
func TestE_nocarry_0286InverseExp(t *testing.T) {
...
func TestE_nocarry_0286MulByConstants(t *testing.T) {
...
func TestE_nocarry_0286Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0286) bool {
...
func TestE_nocarry_0286LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0286Halve(t *testing.T) {
...
func TestE_nocarry_0286FromMont(t *testing.T) {
...
type testPaire_nocarry_0286 struct {
	element e_nocarry_0286
	bigint  big.Int
}

func (z *e_nocarry_0286) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0286[4] {
		return true
	}
	if z[4] < qe_nocarry_0286[4] {
		return false
	...
	return z[0] >= qe_nocarry_0286[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0286

		g.element = e_nocarry_0286{
		...
		if qe_nocarry_0286[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0286[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0286 {
			var g e_nocarry_0286
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0286[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0286[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0286[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0286[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0286[4], carry)
...
func Benchmarke_nocarry_0286InverseNew(b *testing.B) {
	var x e_nocarry_0286
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0286
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0286
		var xInv e_nocarry_0286
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0286
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0286
...
func testLinearComb(t *testing.T, x *e_nocarry_0286, xC int64, y *e_nocarry_0286, yC int64) {
	...
	var z e_nocarry_0286
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0286, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0286
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0286, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0286
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0286, xHi uint64) {
	var res e_nocarry_0286
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0286) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0286) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0286, c int64, result *e_nocarry_0286, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0286) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0286) uint64 {
