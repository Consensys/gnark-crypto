...
// modulus q
DATA q<>+0(SB)/8, $0x8d3a5d5c48efe445
DATA q<>+8(SB)/8, $0x6b7d79115e534db6
DATA q<>+16(SB)/8, $0x3a894ae77cbf70e1
DATA q<>+24(SB)/8, $0x9ca63fe1812ece17
DATA q<>+32(SB)/8, $0x0000000037ccfbd5
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x7ccfc0fb67327173
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x8d3a5d5c48efe445, R9
	MOVQ    $0x6b7d79115e534db6, R10
	MOVQ    $0x3a894ae77cbf70e1, R11
	MOVQ    $0x9ca63fe1812ece17, R12
	MOVQ    $0x0000000037ccfbd5, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x6b7d79115e534db6, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x3a894ae77cbf70e1, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x9ca63fe1812ece17, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000037ccfbd5, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x8d3a5d5c48efe445, CX
	MOVQ    $0x6b7d79115e534db6, BX
	MOVQ    $0x3a894ae77cbf70e1, SI
	MOVQ    $0x9ca63fe1812ece17, DI
	MOVQ    $0x0000000037ccfbd5, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
