...
var benchRese_nocarry_0394 e_nocarry_0394

func BenchmarkE_nocarry_0394SetBytes(b *testing.B) {
	var x e_nocarry_0394
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0394MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0394.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0394)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0394)
		}
	})
}

func BenchmarkE_nocarry_0394Inverse(b *testing.B) {
	var x e_nocarry_0394
	x.SetRandom()
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0394Butterfly(b *testing.B) {
	var x e_nocarry_0394
	x.SetRandom()
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0394)
	}
}

func BenchmarkE_nocarry_0394Exp(b *testing.B) {
	var x e_nocarry_0394
	x.SetRandom()
	benchRese_nocarry_0394.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0394Double(b *testing.B) {
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Double(&benchRese_nocarry_0394)
	}
}

func BenchmarkE_nocarry_0394Add(b *testing.B) {
	var x e_nocarry_0394
	x.SetRandom()
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Add(&x, &benchRese_nocarry_0394)
	}
}

func BenchmarkE_nocarry_0394Sub(b *testing.B) {
	var x e_nocarry_0394
	x.SetRandom()
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Sub(&x, &benchRese_nocarry_0394)
	}
}

func BenchmarkE_nocarry_0394Neg(b *testing.B) {
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Neg(&benchRese_nocarry_0394)
	}
}

func BenchmarkE_nocarry_0394Div(b *testing.B) {
	var x e_nocarry_0394
	x.SetRandom()
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Div(&x, &benchRese_nocarry_0394)
	}
}

func BenchmarkE_nocarry_0394FromMont(b *testing.B) {
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.FromMont()
	}
}

func BenchmarkE_nocarry_0394ToMont(b *testing.B) {
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.ToMont()
	}
}
func BenchmarkE_nocarry_0394Square(b *testing.B) {
	benchRese_nocarry_0394.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Square(&benchRese_nocarry_0394)
	}
}

func BenchmarkE_nocarry_0394Sqrt(b *testing.B) {
	var a e_nocarry_0394
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0394Mul(b *testing.B) {
	x := e_nocarry_0394{
		1006599056845902563,
		7863293535281891595,
	...
	benchRese_nocarry_0394.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Mul(&benchRese_nocarry_0394, &x)
	}
}

func BenchmarkE_nocarry_0394Cmp(b *testing.B) {
	x := e_nocarry_0394{
		1006599056845902563,
		7863293535281891595,
		17174316951264723884,
	...
	benchRese_nocarry_0394 = x
	benchRese_nocarry_0394[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0394.Cmp(&x)
	}
}

func TestE_nocarry_0394Cmp(t *testing.T) {
	var x, y e_nocarry_0394
...
func TestE_nocarry_0394IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0394
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0394

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0394{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0394
	one.SetOne()
	e.Sub(&qe_nocarry_0394, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0394{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0394{0, uint64(i)})
	}
...
func TestE_nocarry_0394NegZero(t *testing.T) {
	var a, b e_nocarry_0394
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0394Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0394, len(staticTestValues))
...
func TestE_nocarry_0394Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0394) bool {
			var b e_nocarry_0394
...
func TestE_nocarry_0394InverseExp(t *testing.T) {
...
func TestE_nocarry_0394MulByConstants(t *testing.T) {
...
func TestE_nocarry_0394Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0394) bool {
...
func TestE_nocarry_0394LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0394Halve(t *testing.T) {
...
func TestE_nocarry_0394FromMont(t *testing.T) {
...
type testPaire_nocarry_0394 struct {
	element e_nocarry_0394
	bigint  big.Int
}

func (z *e_nocarry_0394) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0394[6] {
		return true
	}
	if z[6] < qe_nocarry_0394[6] {
		return false
	...
	return z[0] >= qe_nocarry_0394[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0394

		g.element = e_nocarry_0394{
		...
		if qe_nocarry_0394[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0394[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0394 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0394[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0394[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0394[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0394[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0394[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0394[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0394[6], carry)
...
func Benchmarke_nocarry_0394InverseNew(b *testing.B) {
	var x e_nocarry_0394
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0394
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0394
		var xInv e_nocarry_0394
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0394
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0394
...
func testLinearComb(t *testing.T, x *e_nocarry_0394, xC int64, y *e_nocarry_0394, yC int64) {
	...
	var z e_nocarry_0394
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0394, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0394
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0394, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0394
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0394, xHi uint64) {
	var res e_nocarry_0394
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0394) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0394) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0394, c int64, result *e_nocarry_0394, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0394) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0394) uint64 {
