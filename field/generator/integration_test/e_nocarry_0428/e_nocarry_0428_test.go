...
var benchRese_nocarry_0428 e_nocarry_0428

func BenchmarkE_nocarry_0428SetBytes(b *testing.B) {
	var x e_nocarry_0428
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0428MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0428.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0428)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0428)
		}
	})
}

func BenchmarkE_nocarry_0428Inverse(b *testing.B) {
	var x e_nocarry_0428
	x.SetRandom()
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0428Butterfly(b *testing.B) {
	var x e_nocarry_0428
	x.SetRandom()
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0428)
	}
}

func BenchmarkE_nocarry_0428Exp(b *testing.B) {
	var x e_nocarry_0428
	x.SetRandom()
	benchRese_nocarry_0428.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0428Double(b *testing.B) {
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Double(&benchRese_nocarry_0428)
	}
}

func BenchmarkE_nocarry_0428Add(b *testing.B) {
	var x e_nocarry_0428
	x.SetRandom()
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Add(&x, &benchRese_nocarry_0428)
	}
}

func BenchmarkE_nocarry_0428Sub(b *testing.B) {
	var x e_nocarry_0428
	x.SetRandom()
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Sub(&x, &benchRese_nocarry_0428)
	}
}

func BenchmarkE_nocarry_0428Neg(b *testing.B) {
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Neg(&benchRese_nocarry_0428)
	}
}

func BenchmarkE_nocarry_0428Div(b *testing.B) {
	var x e_nocarry_0428
	x.SetRandom()
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Div(&x, &benchRese_nocarry_0428)
	}
}

func BenchmarkE_nocarry_0428FromMont(b *testing.B) {
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.FromMont()
	}
}

func BenchmarkE_nocarry_0428ToMont(b *testing.B) {
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.ToMont()
	}
}
func BenchmarkE_nocarry_0428Square(b *testing.B) {
	benchRese_nocarry_0428.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Square(&benchRese_nocarry_0428)
	}
}

func BenchmarkE_nocarry_0428Sqrt(b *testing.B) {
	var a e_nocarry_0428
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0428Mul(b *testing.B) {
	x := e_nocarry_0428{
		443168294859590828,
		1960366448605636696,
		3247638023316679079,
	...
	benchRese_nocarry_0428.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Mul(&benchRese_nocarry_0428, &x)
	}
}

func BenchmarkE_nocarry_0428Cmp(b *testing.B) {
	x := e_nocarry_0428{
		443168294859590828,
		1960366448605636696,
		3247638023316679079,
	...
	benchRese_nocarry_0428 = x
	benchRese_nocarry_0428[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0428.Cmp(&x)
	}
}

func TestE_nocarry_0428Cmp(t *testing.T) {
	var x, y e_nocarry_0428
...
func TestE_nocarry_0428IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0428
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0428

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0428{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0428
	one.SetOne()
	e.Sub(&qe_nocarry_0428, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0428{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0428{0, uint64(i)})
	}
...
func TestE_nocarry_0428NegZero(t *testing.T) {
	var a, b e_nocarry_0428
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0428Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0428, len(staticTestValues))
...
func TestE_nocarry_0428Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0428) bool {
			var b e_nocarry_0428
...
func TestE_nocarry_0428InverseExp(t *testing.T) {
...
func TestE_nocarry_0428MulByConstants(t *testing.T) {
...
func TestE_nocarry_0428Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0428) bool {
...
func TestE_nocarry_0428LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0428Halve(t *testing.T) {
...
func TestE_nocarry_0428FromMont(t *testing.T) {
...
type testPaire_nocarry_0428 struct {
	element e_nocarry_0428
	bigint  big.Int
}

func (z *e_nocarry_0428) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0428[6] {
		return true
	}
	if z[6] < qe_nocarry_0428[6] {
		return false
	...
	return z[0] >= qe_nocarry_0428[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0428

		g.element = e_nocarry_0428{
		...
		if qe_nocarry_0428[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0428[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0428 {
			var g e_nocarry_0428
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0428[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0428[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0428[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0428[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0428[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0428[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0428[6], carry)
...
func Benchmarke_nocarry_0428InverseNew(b *testing.B) {
	var x e_nocarry_0428
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0428
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0428
		var xInv e_nocarry_0428
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0428
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0428
...
func testLinearComb(t *testing.T, x *e_nocarry_0428, xC int64, y *e_nocarry_0428, yC int64) {
	...
	var z e_nocarry_0428
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0428, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0428
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0428, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0428
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0428, xHi uint64) {
	var res e_nocarry_0428
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0428) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0428) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0428, c int64, result *e_nocarry_0428, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0428) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0428) uint64 {
