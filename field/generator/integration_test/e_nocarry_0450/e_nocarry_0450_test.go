...
var benchRese_nocarry_0450 e_nocarry_0450

func BenchmarkE_nocarry_0450SetBytes(b *testing.B) {
	var x e_nocarry_0450
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0450MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0450.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0450)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0450)
		}
	})
}

func BenchmarkE_nocarry_0450Inverse(b *testing.B) {
	var x e_nocarry_0450
	x.SetRandom()
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0450Butterfly(b *testing.B) {
	var x e_nocarry_0450
	x.SetRandom()
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0450)
	}
}

func BenchmarkE_nocarry_0450Exp(b *testing.B) {
	var x e_nocarry_0450
	x.SetRandom()
	benchRese_nocarry_0450.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0450Double(b *testing.B) {
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Double(&benchRese_nocarry_0450)
	}
}

func BenchmarkE_nocarry_0450Add(b *testing.B) {
	var x e_nocarry_0450
	x.SetRandom()
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Add(&x, &benchRese_nocarry_0450)
	}
}

func BenchmarkE_nocarry_0450Sub(b *testing.B) {
	var x e_nocarry_0450
	x.SetRandom()
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Sub(&x, &benchRese_nocarry_0450)
	}
}

func BenchmarkE_nocarry_0450Neg(b *testing.B) {
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Neg(&benchRese_nocarry_0450)
	}
}

func BenchmarkE_nocarry_0450Div(b *testing.B) {
	var x e_nocarry_0450
	x.SetRandom()
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Div(&x, &benchRese_nocarry_0450)
	}
}

func BenchmarkE_nocarry_0450FromMont(b *testing.B) {
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.FromMont()
	}
}

func BenchmarkE_nocarry_0450ToMont(b *testing.B) {
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.ToMont()
	}
}
func BenchmarkE_nocarry_0450Square(b *testing.B) {
	benchRese_nocarry_0450.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Square(&benchRese_nocarry_0450)
	}
}

func BenchmarkE_nocarry_0450Sqrt(b *testing.B) {
	var a e_nocarry_0450
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0450Mul(b *testing.B) {
	x := e_nocarry_0450{
	...
	benchRese_nocarry_0450.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Mul(&benchRese_nocarry_0450, &x)
	}
}

func BenchmarkE_nocarry_0450Cmp(b *testing.B) {
	x := e_nocarry_0450{
		16667582734398894156,
		14507037428811206069,
		15339118861567760503,
	...
	benchRese_nocarry_0450 = x
	benchRese_nocarry_0450[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0450.Cmp(&x)
	}
}

func TestE_nocarry_0450Cmp(t *testing.T) {
	var x, y e_nocarry_0450
...
func TestE_nocarry_0450IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0450
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0450

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0450{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0450
	one.SetOne()
	e.Sub(&qe_nocarry_0450, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0450{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0450{0, uint64(i)})
	}
...
func TestE_nocarry_0450NegZero(t *testing.T) {
	var a, b e_nocarry_0450
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0450Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0450, len(staticTestValues))
...
func TestE_nocarry_0450Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0450) bool {
			var b e_nocarry_0450
...
func TestE_nocarry_0450InverseExp(t *testing.T) {
...
func TestE_nocarry_0450MulByConstants(t *testing.T) {
...
func TestE_nocarry_0450Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0450) bool {
...
func TestE_nocarry_0450LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0450Halve(t *testing.T) {
...
func TestE_nocarry_0450FromMont(t *testing.T) {
...
type testPaire_nocarry_0450 struct {
	element e_nocarry_0450
	bigint  big.Int
}

func (z *e_nocarry_0450) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0450[7] {
		return true
	}
	if z[7] < qe_nocarry_0450[7] {
		return false
	...
	return z[0] >= qe_nocarry_0450[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0450

		g.element = e_nocarry_0450{
		...
		if qe_nocarry_0450[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0450[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0450 {
			var g e_nocarry_0450
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0450[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0450[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0450[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0450[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0450[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0450[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0450[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0450[7], carry)
...
func Benchmarke_nocarry_0450InverseNew(b *testing.B) {
	var x e_nocarry_0450
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0450
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0450
		var xInv e_nocarry_0450
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0450
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0450
...
func testLinearComb(t *testing.T, x *e_nocarry_0450, xC int64, y *e_nocarry_0450, yC int64) {
	...
	var z e_nocarry_0450
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0450, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0450
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0450, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0450
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0450, xHi uint64) {
	var res e_nocarry_0450
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0450) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0450) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0450, c int64, result *e_nocarry_0450, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0450) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0450) uint64 {
