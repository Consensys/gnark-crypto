...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 56(R10), R9
	JCC  l1
	MOVQ $0x7a0b3291ef9f5433, R11
	ADDQ R11, AX
	MOVQ $0xb5cec4982b6f662f, R11
	ADCQ R11, DX
	MOVQ $0x6e16693bd9356b22, R11
	ADCQ R11, CX
	MOVQ $0xb5634d494fffdd5b, R11
	ADCQ R11, BX
	MOVQ $0xccdb7dd3a304125f, R11
	ADCQ R11, SI
	MOVQ $0x27a16ea116bcb512, R11
	ADCQ R11, DI
	MOVQ $0xa6e78baae13c1e6a, R11
	ADCQ R11, R8
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x7a0b3291ef9f5433, R12
	SUBQ  DX, R12
	MOVQ  R12, 0(R11)
	MOVQ  $0xb5cec4982b6f662f, R12
	SBBQ  CX, R12
	MOVQ  R12, 8(R11)
	MOVQ  $0x6e16693bd9356b22, R12
	SBBQ  BX, R12
	MOVQ  R12, 16(R11)
	MOVQ  $0xb5634d494fffdd5b, R12
	SBBQ  SI, R12
	MOVQ  R12, 24(R11)
	MOVQ  $0xccdb7dd3a304125f, R12
	SBBQ  DI, R12
	MOVQ  R12, 32(R11)
	MOVQ  $0x27a16ea116bcb512, R12
	SBBQ  R8, R12
	MOVQ  R12, 40(R11)
	MOVQ  $0xa6e78baae13c1e6a, R12
	SBBQ  R9, R12
	MOVQ  R12, 48(R11)
...
TEXT ·Butterfly(SB), $24-16
	...
	SBBQ 56(AX), R10
	JCC  l3
	MOVQ $0x7a0b3291ef9f5433, AX
	ADDQ AX, DX
	MOVQ $0xb5cec4982b6f662f, AX
	ADCQ AX, CX
	MOVQ $0x6e16693bd9356b22, AX
	ADCQ AX, BX
	MOVQ $0xb5634d494fffdd5b, AX
	ADCQ AX, SI
	MOVQ $0xccdb7dd3a304125f, AX
	ADCQ AX, DI
	MOVQ $0x27a16ea116bcb512, AX
	ADCQ AX, R8
	MOVQ $0xa6e78baae13c1e6a, AX
	ADCQ AX, R9
