...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xb0078a94d04e34db, R13
	ADDQ R13, AX
	MOVQ $0xd906e28bd5678d30, R13
	ADCQ R13, DX
	MOVQ $0x9af209eb3ee80225, R13
	ADCQ R13, CX
	MOVQ $0xde53549228c360b1, R13
	ADCQ R13, BX
	MOVQ $0x3400bbefaa72f658, R13
	ADCQ R13, SI
	MOVQ $0x811c231e44227e8a, R13
	ADCQ R13, DI
	MOVQ $0xa01ba614d280a6f1, R13
	ADCQ R13, R8
	MOVQ $0x657b539b88ebeaa8, R13
	ADCQ R13, R9
	MOVQ $0xba2e12876b9a801d, R13
	ADCQ R13, R10
	MOVQ $0x00003bdbd1af33fd, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xb0078a94d04e34db, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xd906e28bd5678d30, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x9af209eb3ee80225, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xde53549228c360b1, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x3400bbefaa72f658, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x811c231e44227e8a, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xa01ba614d280a6f1, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x657b539b88ebeaa8, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xba2e12876b9a801d, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00003bdbd1af33fd, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xb0078a94d04e34db, AX
	ADDQ AX, DX
	MOVQ $0xd906e28bd5678d30, AX
	ADCQ AX, CX
	MOVQ $0x9af209eb3ee80225, AX
	ADCQ AX, BX
	MOVQ $0xde53549228c360b1, AX
	ADCQ AX, SI
	MOVQ $0x3400bbefaa72f658, AX
	ADCQ AX, DI
	MOVQ $0x811c231e44227e8a, AX
	ADCQ AX, R8
	MOVQ $0xa01ba614d280a6f1, AX
	ADCQ AX, R9
	MOVQ $0x657b539b88ebeaa8, AX
	ADCQ AX, R10
	MOVQ $0xba2e12876b9a801d, AX
	ADCQ AX, R11
	MOVQ $0x00003bdbd1af33fd, AX
	ADCQ AX, R12
