...
var benchRese_nocarry_0622 e_nocarry_0622

func BenchmarkE_nocarry_0622SetBytes(b *testing.B) {
	var x e_nocarry_0622
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0622MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0622.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0622)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0622)
		}
	})
}

func BenchmarkE_nocarry_0622Inverse(b *testing.B) {
	var x e_nocarry_0622
	x.SetRandom()
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0622Butterfly(b *testing.B) {
	var x e_nocarry_0622
	x.SetRandom()
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0622)
	}
}

func BenchmarkE_nocarry_0622Exp(b *testing.B) {
	var x e_nocarry_0622
	x.SetRandom()
	benchRese_nocarry_0622.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0622Double(b *testing.B) {
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Double(&benchRese_nocarry_0622)
	}
}

func BenchmarkE_nocarry_0622Add(b *testing.B) {
	var x e_nocarry_0622
	x.SetRandom()
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Add(&x, &benchRese_nocarry_0622)
	}
}

func BenchmarkE_nocarry_0622Sub(b *testing.B) {
	var x e_nocarry_0622
	x.SetRandom()
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Sub(&x, &benchRese_nocarry_0622)
	}
}

func BenchmarkE_nocarry_0622Neg(b *testing.B) {
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Neg(&benchRese_nocarry_0622)
	}
}

func BenchmarkE_nocarry_0622Div(b *testing.B) {
	var x e_nocarry_0622
	x.SetRandom()
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Div(&x, &benchRese_nocarry_0622)
	}
}

func BenchmarkE_nocarry_0622FromMont(b *testing.B) {
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.FromMont()
	}
}

func BenchmarkE_nocarry_0622ToMont(b *testing.B) {
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.ToMont()
	}
}
func BenchmarkE_nocarry_0622Square(b *testing.B) {
	benchRese_nocarry_0622.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Square(&benchRese_nocarry_0622)
	}
}

func BenchmarkE_nocarry_0622Sqrt(b *testing.B) {
	var a e_nocarry_0622
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0622Mul(b *testing.B) {
	x := e_nocarry_0622{
		9900366349892250144,
	...
	benchRese_nocarry_0622.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Mul(&benchRese_nocarry_0622, &x)
	}
}

func BenchmarkE_nocarry_0622Cmp(b *testing.B) {
	x := e_nocarry_0622{
		9900366349892250144,
		10445544250025697371,
		9354754669700035381,
	...
	benchRese_nocarry_0622 = x
	benchRese_nocarry_0622[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0622.Cmp(&x)
	}
}

func TestE_nocarry_0622Cmp(t *testing.T) {
	var x, y e_nocarry_0622
...
func TestE_nocarry_0622IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0622
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0622

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0622{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0622
	one.SetOne()
	e.Sub(&qe_nocarry_0622, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0622{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0622{0, uint64(i)})
	}
...
func TestE_nocarry_0622NegZero(t *testing.T) {
	var a, b e_nocarry_0622
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0622Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0622, len(staticTestValues))
...
func TestE_nocarry_0622Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0622) bool {
			var b e_nocarry_0622
...
func TestE_nocarry_0622InverseExp(t *testing.T) {
...
func TestE_nocarry_0622MulByConstants(t *testing.T) {
...
func TestE_nocarry_0622Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0622) bool {
...
func TestE_nocarry_0622LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0622Halve(t *testing.T) {
...
func TestE_nocarry_0622FromMont(t *testing.T) {
...
type testPaire_nocarry_0622 struct {
	element e_nocarry_0622
	bigint  big.Int
}

func (z *e_nocarry_0622) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0622[9] {
		return true
	}
	if z[9] < qe_nocarry_0622[9] {
		return false
	...
	return z[0] >= qe_nocarry_0622[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0622

		g.element = e_nocarry_0622{
		...
		if qe_nocarry_0622[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0622[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0622 {
			var g e_nocarry_0622
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0622[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0622[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0622[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0622[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0622[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0622[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0622[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0622[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0622[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0622[9], carry)
...
func Benchmarke_nocarry_0622InverseNew(b *testing.B) {
	var x e_nocarry_0622
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0622
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0622
		var xInv e_nocarry_0622
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0622
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0622
...
func testLinearComb(t *testing.T, x *e_nocarry_0622, xC int64, y *e_nocarry_0622, yC int64) {
	...
	var z e_nocarry_0622
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0622, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0622
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0622, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0622
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0622, xHi uint64) {
	var res e_nocarry_0622
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0622) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0622) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0622, c int64, result *e_nocarry_0622, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0622) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0622) uint64 {
