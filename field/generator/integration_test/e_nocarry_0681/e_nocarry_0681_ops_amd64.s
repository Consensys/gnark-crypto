...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xf8d865ab08742ec7, R14
	ADDQ R14, AX
	MOVQ $0x62e5b3a429d9ee41, R14
	ADCQ R14, DX
	MOVQ $0x22443ddb085a9c4f, R14
	ADCQ R14, CX
	MOVQ $0x4db17a6622acbff7, R14
	ADCQ R14, BX
	MOVQ $0x9169702d6d546d77, R14
	ADCQ R14, SI
	MOVQ $0x260f490e81957e50, R14
	ADCQ R14, DI
	MOVQ $0xdfeb6f9069bb264b, R14
	ADCQ R14, R8
	MOVQ $0x61811f4228f45a36, R14
	ADCQ R14, R9
	MOVQ $0xe0d7c534348c3881, R14
	ADCQ R14, R10
	MOVQ $0x37498682accda115, R14
	ADCQ R14, R11
	MOVQ $0x000001f9fced2c26, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf8d865ab08742ec7, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x62e5b3a429d9ee41, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x22443ddb085a9c4f, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x4db17a6622acbff7, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x9169702d6d546d77, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x260f490e81957e50, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xdfeb6f9069bb264b, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x61811f4228f45a36, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xe0d7c534348c3881, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x37498682accda115, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000001f9fced2c26, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xf8d865ab08742ec7, AX
	ADDQ AX, DX
	MOVQ $0x62e5b3a429d9ee41, AX
	ADCQ AX, CX
	MOVQ $0x22443ddb085a9c4f, AX
	ADCQ AX, BX
	MOVQ $0x4db17a6622acbff7, AX
	ADCQ AX, SI
	MOVQ $0x9169702d6d546d77, AX
	ADCQ AX, DI
	MOVQ $0x260f490e81957e50, AX
	ADCQ AX, R8
	MOVQ $0xdfeb6f9069bb264b, AX
	ADCQ AX, R9
	MOVQ $0x61811f4228f45a36, AX
	ADCQ AX, R10
	MOVQ $0xe0d7c534348c3881, AX
	ADCQ AX, R11
	MOVQ $0x37498682accda115, AX
	ADCQ AX, R12
	MOVQ $0x000001f9fced2c26, AX
	ADCQ AX, R13
