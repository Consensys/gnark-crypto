...
var benchRese_nocarry_0681 e_nocarry_0681

func BenchmarkE_nocarry_0681SetBytes(b *testing.B) {
	var x e_nocarry_0681
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0681MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0681.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0681)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0681)
		}
	})
}

func BenchmarkE_nocarry_0681Inverse(b *testing.B) {
	var x e_nocarry_0681
	x.SetRandom()
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0681Butterfly(b *testing.B) {
	var x e_nocarry_0681
	x.SetRandom()
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0681)
	}
}

func BenchmarkE_nocarry_0681Exp(b *testing.B) {
	var x e_nocarry_0681
	x.SetRandom()
	benchRese_nocarry_0681.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0681Double(b *testing.B) {
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Double(&benchRese_nocarry_0681)
	}
}

func BenchmarkE_nocarry_0681Add(b *testing.B) {
	var x e_nocarry_0681
	x.SetRandom()
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Add(&x, &benchRese_nocarry_0681)
	}
}

func BenchmarkE_nocarry_0681Sub(b *testing.B) {
	var x e_nocarry_0681
	x.SetRandom()
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Sub(&x, &benchRese_nocarry_0681)
	}
}

func BenchmarkE_nocarry_0681Neg(b *testing.B) {
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Neg(&benchRese_nocarry_0681)
	}
}

func BenchmarkE_nocarry_0681Div(b *testing.B) {
	var x e_nocarry_0681
	x.SetRandom()
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Div(&x, &benchRese_nocarry_0681)
	}
}

func BenchmarkE_nocarry_0681FromMont(b *testing.B) {
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.FromMont()
	}
}

func BenchmarkE_nocarry_0681ToMont(b *testing.B) {
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.ToMont()
	}
}
func BenchmarkE_nocarry_0681Square(b *testing.B) {
	benchRese_nocarry_0681.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Square(&benchRese_nocarry_0681)
	}
}

func BenchmarkE_nocarry_0681Sqrt(b *testing.B) {
	var a e_nocarry_0681
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0681Mul(b *testing.B) {
	x := e_nocarry_0681{
	...
	benchRese_nocarry_0681.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Mul(&benchRese_nocarry_0681, &x)
	}
}

func BenchmarkE_nocarry_0681Cmp(b *testing.B) {
	x := e_nocarry_0681{
		18160023512380379849,
		13367128496227533720,
		3690859096059015214,
	...
	benchRese_nocarry_0681 = x
	benchRese_nocarry_0681[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0681.Cmp(&x)
	}
}

func TestE_nocarry_0681Cmp(t *testing.T) {
	var x, y e_nocarry_0681
...
func TestE_nocarry_0681IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0681
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0681

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0681{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0681
	one.SetOne()
	e.Sub(&qe_nocarry_0681, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0681{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0681{0, uint64(i)})
	}
...
func TestE_nocarry_0681NegZero(t *testing.T) {
	var a, b e_nocarry_0681
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0681Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0681, len(staticTestValues))
...
func TestE_nocarry_0681Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0681) bool {
			var b e_nocarry_0681
...
func TestE_nocarry_0681InverseExp(t *testing.T) {
...
func TestE_nocarry_0681MulByConstants(t *testing.T) {
...
func TestE_nocarry_0681Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0681) bool {
...
func TestE_nocarry_0681LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0681Halve(t *testing.T) {
...
func TestE_nocarry_0681FromMont(t *testing.T) {
...
type testPaire_nocarry_0681 struct {
	element e_nocarry_0681
	bigint  big.Int
}

func (z *e_nocarry_0681) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0681[10] {
		return true
	}
	if z[10] < qe_nocarry_0681[10] {
		return false
	...
	return z[0] >= qe_nocarry_0681[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0681

		g.element = e_nocarry_0681{
		...
		if qe_nocarry_0681[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0681[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0681 {
			var g e_nocarry_0681
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0681[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0681[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0681[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0681[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0681[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0681[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0681[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0681[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0681[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0681[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0681[10], carry)
...
func Benchmarke_nocarry_0681InverseNew(b *testing.B) {
	var x e_nocarry_0681
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0681
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0681
		var xInv e_nocarry_0681
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0681
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0681
...
func testLinearComb(t *testing.T, x *e_nocarry_0681, xC int64, y *e_nocarry_0681, yC int64) {
	...
	var z e_nocarry_0681
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0681, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0681
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0681, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0681
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0681, xHi uint64) {
	var res e_nocarry_0681
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0681) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0681) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0681, c int64, result *e_nocarry_0681, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0681) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0681) uint64 {
