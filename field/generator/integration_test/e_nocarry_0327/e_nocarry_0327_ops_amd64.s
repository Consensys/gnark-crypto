...
// modulus q
DATA q<>+0(SB)/8, $0x81a9cae97748c0ab
DATA q<>+8(SB)/8, $0xbe39787964bc02a5
DATA q<>+16(SB)/8, $0xa1153079c0f213d1
DATA q<>+24(SB)/8, $0x420b3fa15586d391
DATA q<>+32(SB)/8, $0xa8668ee1bcc9aa5a
DATA q<>+40(SB)/8, $0x0000000000000072
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xd10db55cde82c5fd
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x81a9cae97748c0ab, R10
	MOVQ    $0xbe39787964bc02a5, R11
	MOVQ    $0xa1153079c0f213d1, R12
	MOVQ    $0x420b3fa15586d391, R13
	MOVQ    $0xa8668ee1bcc9aa5a, R14
	MOVQ    $0x0000000000000072, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xbe39787964bc02a5, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xa1153079c0f213d1, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x420b3fa15586d391, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xa8668ee1bcc9aa5a, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000000000072, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x81a9cae97748c0ab, CX
	MOVQ    $0xbe39787964bc02a5, BX
	MOVQ    $0xa1153079c0f213d1, SI
	MOVQ    $0x420b3fa15586d391, DI
	MOVQ    $0xa8668ee1bcc9aa5a, R8
	MOVQ    $0x0000000000000072, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
