...
var benchRese_nocarry_0327 e_nocarry_0327

func BenchmarkE_nocarry_0327SetBytes(b *testing.B) {
	var x e_nocarry_0327
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0327MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0327.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0327)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0327)
		}
	})
}

func BenchmarkE_nocarry_0327Inverse(b *testing.B) {
	var x e_nocarry_0327
	x.SetRandom()
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0327Butterfly(b *testing.B) {
	var x e_nocarry_0327
	x.SetRandom()
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0327)
	}
}

func BenchmarkE_nocarry_0327Exp(b *testing.B) {
	var x e_nocarry_0327
	x.SetRandom()
	benchRese_nocarry_0327.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0327Double(b *testing.B) {
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Double(&benchRese_nocarry_0327)
	}
}

func BenchmarkE_nocarry_0327Add(b *testing.B) {
	var x e_nocarry_0327
	x.SetRandom()
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Add(&x, &benchRese_nocarry_0327)
	}
}

func BenchmarkE_nocarry_0327Sub(b *testing.B) {
	var x e_nocarry_0327
	x.SetRandom()
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Sub(&x, &benchRese_nocarry_0327)
	}
}

func BenchmarkE_nocarry_0327Neg(b *testing.B) {
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Neg(&benchRese_nocarry_0327)
	}
}

func BenchmarkE_nocarry_0327Div(b *testing.B) {
	var x e_nocarry_0327
	x.SetRandom()
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Div(&x, &benchRese_nocarry_0327)
	}
}

func BenchmarkE_nocarry_0327FromMont(b *testing.B) {
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.FromMont()
	}
}

func BenchmarkE_nocarry_0327ToMont(b *testing.B) {
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.ToMont()
	}
}
func BenchmarkE_nocarry_0327Square(b *testing.B) {
	benchRese_nocarry_0327.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Square(&benchRese_nocarry_0327)
	}
}

func BenchmarkE_nocarry_0327Sqrt(b *testing.B) {
	var a e_nocarry_0327
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0327Mul(b *testing.B) {
	x := e_nocarry_0327{
	...
	benchRese_nocarry_0327.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Mul(&benchRese_nocarry_0327, &x)
	}
}

func BenchmarkE_nocarry_0327Cmp(b *testing.B) {
	x := e_nocarry_0327{
		17303189029120539087,
		10178863053776529904,
		12453064022152543237,
	...
	benchRese_nocarry_0327 = x
	benchRese_nocarry_0327[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0327.Cmp(&x)
	}
}

func TestE_nocarry_0327Cmp(t *testing.T) {
	var x, y e_nocarry_0327
...
func TestE_nocarry_0327IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0327
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0327

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0327{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0327
	one.SetOne()
	e.Sub(&qe_nocarry_0327, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0327{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0327{0, uint64(i)})
	}
...
func TestE_nocarry_0327NegZero(t *testing.T) {
	var a, b e_nocarry_0327
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0327Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0327, len(staticTestValues))
...
func TestE_nocarry_0327Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0327) bool {
			var b e_nocarry_0327
...
func TestE_nocarry_0327InverseExp(t *testing.T) {
...
func TestE_nocarry_0327MulByConstants(t *testing.T) {
...
func TestE_nocarry_0327Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0327) bool {
...
func TestE_nocarry_0327LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0327Halve(t *testing.T) {
...
func TestE_nocarry_0327FromMont(t *testing.T) {
...
type testPaire_nocarry_0327 struct {
	element e_nocarry_0327
	bigint  big.Int
}

func (z *e_nocarry_0327) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0327[5] {
		return true
	}
	if z[5] < qe_nocarry_0327[5] {
		return false
	...
	return z[0] >= qe_nocarry_0327[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0327

		g.element = e_nocarry_0327{
		...
		if qe_nocarry_0327[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0327[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0327 {
			var g e_nocarry_0327
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0327[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0327[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0327[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0327[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0327[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0327[5], carry)
...
func Benchmarke_nocarry_0327InverseNew(b *testing.B) {
	var x e_nocarry_0327
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0327
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0327
		var xInv e_nocarry_0327
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0327
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0327
...
func testLinearComb(t *testing.T, x *e_nocarry_0327, xC int64, y *e_nocarry_0327, yC int64) {
	...
	var z e_nocarry_0327
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0327, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0327
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0327, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0327
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0327, xHi uint64) {
	var res e_nocarry_0327
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0327) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0327) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0327, c int64, result *e_nocarry_0327, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0327) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0327) uint64 {
