...
// modulus q
DATA q<>+0(SB)/8, $0xd3a35b3ee2e24d95
DATA q<>+8(SB)/8, $0x60fa64b9f8fd3a3f
DATA q<>+16(SB)/8, $0x01ce3962fdddaa2a
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x651cc6bdda8e6a43
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xd3a35b3ee2e24d95, DI
	MOVQ    $0x60fa64b9f8fd3a3f, R8
	MOVQ    $0x01ce3962fdddaa2a, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x60fa64b9f8fd3a3f, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x01ce3962fdddaa2a, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xd3a35b3ee2e24d95, R10
	MOVQ    $0x60fa64b9f8fd3a3f, R11
	MOVQ    $0x01ce3962fdddaa2a, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
