...
var benchRese_nocarry_0185 e_nocarry_0185

func BenchmarkE_nocarry_0185SetBytes(b *testing.B) {
	var x e_nocarry_0185
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0185MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0185.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0185)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0185)
		}
	})
}

func BenchmarkE_nocarry_0185Inverse(b *testing.B) {
	var x e_nocarry_0185
	x.SetRandom()
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0185Butterfly(b *testing.B) {
	var x e_nocarry_0185
	x.SetRandom()
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0185)
	}
}

func BenchmarkE_nocarry_0185Exp(b *testing.B) {
	var x e_nocarry_0185
	x.SetRandom()
	benchRese_nocarry_0185.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0185Double(b *testing.B) {
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Double(&benchRese_nocarry_0185)
	}
}

func BenchmarkE_nocarry_0185Add(b *testing.B) {
	var x e_nocarry_0185
	x.SetRandom()
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Add(&x, &benchRese_nocarry_0185)
	}
}

func BenchmarkE_nocarry_0185Sub(b *testing.B) {
	var x e_nocarry_0185
	x.SetRandom()
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Sub(&x, &benchRese_nocarry_0185)
	}
}

func BenchmarkE_nocarry_0185Neg(b *testing.B) {
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Neg(&benchRese_nocarry_0185)
	}
}

func BenchmarkE_nocarry_0185Div(b *testing.B) {
	var x e_nocarry_0185
	x.SetRandom()
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Div(&x, &benchRese_nocarry_0185)
	}
}

func BenchmarkE_nocarry_0185FromMont(b *testing.B) {
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.FromMont()
	}
}

func BenchmarkE_nocarry_0185ToMont(b *testing.B) {
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.ToMont()
	}
}
func BenchmarkE_nocarry_0185Square(b *testing.B) {
	benchRese_nocarry_0185.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Square(&benchRese_nocarry_0185)
	}
}

func BenchmarkE_nocarry_0185Sqrt(b *testing.B) {
	var a e_nocarry_0185
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0185Mul(b *testing.B) {
	x := e_nocarry_0185{
		13311822498026851637,
		17580126337554239013,
		113056170267127761,
	}
	benchRese_nocarry_0185.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Mul(&benchRese_nocarry_0185, &x)
	}
}

func BenchmarkE_nocarry_0185Cmp(b *testing.B) {
	x := e_nocarry_0185{
		13311822498026851637,
		17580126337554239013,
		113056170267127761,
	}
	benchRese_nocarry_0185 = x
	benchRese_nocarry_0185[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0185.Cmp(&x)
	}
}

func TestE_nocarry_0185Cmp(t *testing.T) {
	var x, y e_nocarry_0185
...
func TestE_nocarry_0185IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0185
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0185

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0185{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0185
	one.SetOne()
	e.Sub(&qe_nocarry_0185, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0185{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0185{0, uint64(i)})
	}
...
func TestE_nocarry_0185NegZero(t *testing.T) {
	var a, b e_nocarry_0185
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0185Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0185, len(staticTestValues))
...
func TestE_nocarry_0185Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0185) bool {
			var b e_nocarry_0185
...
func TestE_nocarry_0185InverseExp(t *testing.T) {
...
func TestE_nocarry_0185MulByConstants(t *testing.T) {
...
func TestE_nocarry_0185Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0185) bool {
...
func TestE_nocarry_0185LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0185Halve(t *testing.T) {
...
func TestE_nocarry_0185FromMont(t *testing.T) {
...
type testPaire_nocarry_0185 struct {
	element e_nocarry_0185
	bigint  big.Int
}

func (z *e_nocarry_0185) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0185[2] {
		return true
	}
	if z[2] < qe_nocarry_0185[2] {
		return false
	...
	return z[0] >= qe_nocarry_0185[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0185

		g.element = e_nocarry_0185{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0185[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0185[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0185 {
			var g e_nocarry_0185
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0185[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0185[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0185[2], carry)
...
func Benchmarke_nocarry_0185InverseNew(b *testing.B) {
	var x e_nocarry_0185
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0185
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0185
		var xInv e_nocarry_0185
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0185
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0185
...
func testLinearComb(t *testing.T, x *e_nocarry_0185, xC int64, y *e_nocarry_0185, yC int64) {
	...
	var z e_nocarry_0185
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0185, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0185
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0185, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0185
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0185, xHi uint64) {
	var res e_nocarry_0185
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0185) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0185) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0185, c int64, result *e_nocarry_0185, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0185) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0185) uint64 {
