...
var benchRese_nocarry_0566 e_nocarry_0566

func BenchmarkE_nocarry_0566SetBytes(b *testing.B) {
	var x e_nocarry_0566
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0566MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0566.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0566)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0566)
		}
	})
}

func BenchmarkE_nocarry_0566Inverse(b *testing.B) {
	var x e_nocarry_0566
	x.SetRandom()
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0566Butterfly(b *testing.B) {
	var x e_nocarry_0566
	x.SetRandom()
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0566)
	}
}

func BenchmarkE_nocarry_0566Exp(b *testing.B) {
	var x e_nocarry_0566
	x.SetRandom()
	benchRese_nocarry_0566.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0566Double(b *testing.B) {
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Double(&benchRese_nocarry_0566)
	}
}

func BenchmarkE_nocarry_0566Add(b *testing.B) {
	var x e_nocarry_0566
	x.SetRandom()
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Add(&x, &benchRese_nocarry_0566)
	}
}

func BenchmarkE_nocarry_0566Sub(b *testing.B) {
	var x e_nocarry_0566
	x.SetRandom()
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Sub(&x, &benchRese_nocarry_0566)
	}
}

func BenchmarkE_nocarry_0566Neg(b *testing.B) {
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Neg(&benchRese_nocarry_0566)
	}
}

func BenchmarkE_nocarry_0566Div(b *testing.B) {
	var x e_nocarry_0566
	x.SetRandom()
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Div(&x, &benchRese_nocarry_0566)
	}
}

func BenchmarkE_nocarry_0566FromMont(b *testing.B) {
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.FromMont()
	}
}

func BenchmarkE_nocarry_0566ToMont(b *testing.B) {
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.ToMont()
	}
}
func BenchmarkE_nocarry_0566Square(b *testing.B) {
	benchRese_nocarry_0566.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Square(&benchRese_nocarry_0566)
	}
}

func BenchmarkE_nocarry_0566Sqrt(b *testing.B) {
	var a e_nocarry_0566
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0566Mul(b *testing.B) {
	x := e_nocarry_0566{
	...
	benchRese_nocarry_0566.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Mul(&benchRese_nocarry_0566, &x)
	}
}

func BenchmarkE_nocarry_0566Cmp(b *testing.B) {
	x := e_nocarry_0566{
		16369130358067803951,
		9998103722928875072,
		15537093054109139387,
	...
	benchRese_nocarry_0566 = x
	benchRese_nocarry_0566[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0566.Cmp(&x)
	}
}

func TestE_nocarry_0566Cmp(t *testing.T) {
	var x, y e_nocarry_0566
...
func TestE_nocarry_0566IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0566
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0566

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0566{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0566
	one.SetOne()
	e.Sub(&qe_nocarry_0566, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0566{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0566{0, uint64(i)})
	}
...
func TestE_nocarry_0566NegZero(t *testing.T) {
	var a, b e_nocarry_0566
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0566Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0566, len(staticTestValues))
...
func TestE_nocarry_0566Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0566) bool {
			var b e_nocarry_0566
...
func TestE_nocarry_0566InverseExp(t *testing.T) {
...
func TestE_nocarry_0566MulByConstants(t *testing.T) {
...
func TestE_nocarry_0566Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0566) bool {
...
func TestE_nocarry_0566LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0566Halve(t *testing.T) {
...
func TestE_nocarry_0566FromMont(t *testing.T) {
...
type testPaire_nocarry_0566 struct {
	element e_nocarry_0566
	bigint  big.Int
}

func (z *e_nocarry_0566) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0566[8] {
		return true
	}
	if z[8] < qe_nocarry_0566[8] {
		return false
	...
	return z[0] >= qe_nocarry_0566[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0566

		g.element = e_nocarry_0566{
		...
		if qe_nocarry_0566[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0566[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0566 {
			var g e_nocarry_0566
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0566[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0566[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0566[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0566[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0566[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0566[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0566[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0566[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0566[8], carry)
...
func Benchmarke_nocarry_0566InverseNew(b *testing.B) {
	var x e_nocarry_0566
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0566
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0566
		var xInv e_nocarry_0566
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0566
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0566
...
func testLinearComb(t *testing.T, x *e_nocarry_0566, xC int64, y *e_nocarry_0566, yC int64) {
	...
	var z e_nocarry_0566
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0566, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0566
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0566, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0566
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0566, xHi uint64) {
	var res e_nocarry_0566
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0566) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0566) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0566, c int64, result *e_nocarry_0566, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0566) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0566) uint64 {
