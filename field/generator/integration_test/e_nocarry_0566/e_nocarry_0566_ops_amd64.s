...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x5d75546d83b4fc73, R12
	ADDQ R12, AX
	MOVQ $0xd18af1d95b9110ca, R12
	ADCQ R12, DX
	MOVQ $0xf37cb59aed8ada75, R12
	ADCQ R12, CX
	MOVQ $0x5439ce1c3cbd329b, R12
	ADCQ R12, BX
	MOVQ $0x186c8f69060ec5a3, R12
	ADCQ R12, SI
	MOVQ $0x90131630b1e1ef3b, R12
	ADCQ R12, DI
	MOVQ $0x0d4ca0915a632a68, R12
	ADCQ R12, R8
	MOVQ $0x846ddec891ad767d, R12
	ADCQ R12, R9
	MOVQ $0x00352e0881e60d41, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x5d75546d83b4fc73, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xd18af1d95b9110ca, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xf37cb59aed8ada75, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x5439ce1c3cbd329b, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x186c8f69060ec5a3, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x90131630b1e1ef3b, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x0d4ca0915a632a68, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x846ddec891ad767d, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00352e0881e60d41, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x5d75546d83b4fc73, AX
	ADDQ AX, DX
	MOVQ $0xd18af1d95b9110ca, AX
	ADCQ AX, CX
	MOVQ $0xf37cb59aed8ada75, AX
	ADCQ AX, BX
	MOVQ $0x5439ce1c3cbd329b, AX
	ADCQ AX, SI
	MOVQ $0x186c8f69060ec5a3, AX
	ADCQ AX, DI
	MOVQ $0x90131630b1e1ef3b, AX
	ADCQ AX, R8
	MOVQ $0x0d4ca0915a632a68, AX
	ADCQ AX, R9
	MOVQ $0x846ddec891ad767d, AX
	ADCQ AX, R10
	MOVQ $0x00352e0881e60d41, AX
	ADCQ AX, R11
