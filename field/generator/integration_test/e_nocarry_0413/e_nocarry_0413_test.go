...
var benchRese_nocarry_0413 e_nocarry_0413

func BenchmarkE_nocarry_0413SetBytes(b *testing.B) {
	var x e_nocarry_0413
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0413MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0413.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0413)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0413)
		}
	})
}

func BenchmarkE_nocarry_0413Inverse(b *testing.B) {
	var x e_nocarry_0413
	x.SetRandom()
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0413Butterfly(b *testing.B) {
	var x e_nocarry_0413
	x.SetRandom()
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0413)
	}
}

func BenchmarkE_nocarry_0413Exp(b *testing.B) {
	var x e_nocarry_0413
	x.SetRandom()
	benchRese_nocarry_0413.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0413Double(b *testing.B) {
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Double(&benchRese_nocarry_0413)
	}
}

func BenchmarkE_nocarry_0413Add(b *testing.B) {
	var x e_nocarry_0413
	x.SetRandom()
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Add(&x, &benchRese_nocarry_0413)
	}
}

func BenchmarkE_nocarry_0413Sub(b *testing.B) {
	var x e_nocarry_0413
	x.SetRandom()
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Sub(&x, &benchRese_nocarry_0413)
	}
}

func BenchmarkE_nocarry_0413Neg(b *testing.B) {
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Neg(&benchRese_nocarry_0413)
	}
}

func BenchmarkE_nocarry_0413Div(b *testing.B) {
	var x e_nocarry_0413
	x.SetRandom()
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Div(&x, &benchRese_nocarry_0413)
	}
}

func BenchmarkE_nocarry_0413FromMont(b *testing.B) {
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.FromMont()
	}
}

func BenchmarkE_nocarry_0413ToMont(b *testing.B) {
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.ToMont()
	}
}
func BenchmarkE_nocarry_0413Square(b *testing.B) {
	benchRese_nocarry_0413.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Square(&benchRese_nocarry_0413)
	}
}

func BenchmarkE_nocarry_0413Sqrt(b *testing.B) {
	var a e_nocarry_0413
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0413Mul(b *testing.B) {
	x := e_nocarry_0413{
		3507164947563470338,
		8724939752804885740,
		66493028460668191,
	...
	benchRese_nocarry_0413.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Mul(&benchRese_nocarry_0413, &x)
	}
}

func BenchmarkE_nocarry_0413Cmp(b *testing.B) {
	x := e_nocarry_0413{
		3507164947563470338,
		8724939752804885740,
		66493028460668191,
	...
	benchRese_nocarry_0413 = x
	benchRese_nocarry_0413[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0413.Cmp(&x)
	}
}

func TestE_nocarry_0413Cmp(t *testing.T) {
	var x, y e_nocarry_0413
...
func TestE_nocarry_0413IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0413
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0413

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0413{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0413
	one.SetOne()
	e.Sub(&qe_nocarry_0413, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0413{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0413{0, uint64(i)})
	}
...
func TestE_nocarry_0413NegZero(t *testing.T) {
	var a, b e_nocarry_0413
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0413Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0413, len(staticTestValues))
...
func TestE_nocarry_0413Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0413) bool {
			var b e_nocarry_0413
...
func TestE_nocarry_0413InverseExp(t *testing.T) {
...
func TestE_nocarry_0413MulByConstants(t *testing.T) {
...
func TestE_nocarry_0413Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0413) bool {
...
func TestE_nocarry_0413LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0413Halve(t *testing.T) {
...
func TestE_nocarry_0413FromMont(t *testing.T) {
...
type testPaire_nocarry_0413 struct {
	element e_nocarry_0413
	bigint  big.Int
}

func (z *e_nocarry_0413) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0413[6] {
		return true
	}
	if z[6] < qe_nocarry_0413[6] {
		return false
	...
	return z[0] >= qe_nocarry_0413[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0413

		g.element = e_nocarry_0413{
		...
		if qe_nocarry_0413[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0413[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0413 {
			var g e_nocarry_0413
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0413[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0413[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0413[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0413[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0413[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0413[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0413[6], carry)
...
func Benchmarke_nocarry_0413InverseNew(b *testing.B) {
	var x e_nocarry_0413
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0413
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0413
		var xInv e_nocarry_0413
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0413
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0413
...
func testLinearComb(t *testing.T, x *e_nocarry_0413, xC int64, y *e_nocarry_0413, yC int64) {
	...
	var z e_nocarry_0413
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0413, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0413
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0413, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0413
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0413, xHi uint64) {
	var res e_nocarry_0413
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0413) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0413) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0413, c int64, result *e_nocarry_0413, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0413) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0413) uint64 {
