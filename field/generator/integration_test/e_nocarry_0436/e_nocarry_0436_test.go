...
var benchRese_nocarry_0436 e_nocarry_0436

func BenchmarkE_nocarry_0436SetBytes(b *testing.B) {
	var x e_nocarry_0436
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0436MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0436.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0436)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0436)
		}
	})
}

func BenchmarkE_nocarry_0436Inverse(b *testing.B) {
	var x e_nocarry_0436
	x.SetRandom()
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0436Butterfly(b *testing.B) {
	var x e_nocarry_0436
	x.SetRandom()
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0436)
	}
}

func BenchmarkE_nocarry_0436Exp(b *testing.B) {
	var x e_nocarry_0436
	x.SetRandom()
	benchRese_nocarry_0436.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0436Double(b *testing.B) {
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Double(&benchRese_nocarry_0436)
	}
}

func BenchmarkE_nocarry_0436Add(b *testing.B) {
	var x e_nocarry_0436
	x.SetRandom()
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Add(&x, &benchRese_nocarry_0436)
	}
}

func BenchmarkE_nocarry_0436Sub(b *testing.B) {
	var x e_nocarry_0436
	x.SetRandom()
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Sub(&x, &benchRese_nocarry_0436)
	}
}

func BenchmarkE_nocarry_0436Neg(b *testing.B) {
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Neg(&benchRese_nocarry_0436)
	}
}

func BenchmarkE_nocarry_0436Div(b *testing.B) {
	var x e_nocarry_0436
	x.SetRandom()
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Div(&x, &benchRese_nocarry_0436)
	}
}

func BenchmarkE_nocarry_0436FromMont(b *testing.B) {
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.FromMont()
	}
}

func BenchmarkE_nocarry_0436ToMont(b *testing.B) {
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.ToMont()
	}
}
func BenchmarkE_nocarry_0436Square(b *testing.B) {
	benchRese_nocarry_0436.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Square(&benchRese_nocarry_0436)
	}
}

func BenchmarkE_nocarry_0436Sqrt(b *testing.B) {
	var a e_nocarry_0436
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0436Mul(b *testing.B) {
	x := e_nocarry_0436{
		877711008772628638,
		9553203588223113058,
	...
	benchRese_nocarry_0436.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Mul(&benchRese_nocarry_0436, &x)
	}
}

func BenchmarkE_nocarry_0436Cmp(b *testing.B) {
	x := e_nocarry_0436{
		877711008772628638,
		9553203588223113058,
		10634202433597839244,
	...
	benchRese_nocarry_0436 = x
	benchRese_nocarry_0436[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0436.Cmp(&x)
	}
}

func TestE_nocarry_0436Cmp(t *testing.T) {
	var x, y e_nocarry_0436
...
func TestE_nocarry_0436IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0436
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0436

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0436{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0436
	one.SetOne()
	e.Sub(&qe_nocarry_0436, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0436{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0436{0, uint64(i)})
	}
...
func TestE_nocarry_0436NegZero(t *testing.T) {
	var a, b e_nocarry_0436
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0436Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0436, len(staticTestValues))
...
func TestE_nocarry_0436Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0436) bool {
			var b e_nocarry_0436
...
func TestE_nocarry_0436InverseExp(t *testing.T) {
...
func TestE_nocarry_0436MulByConstants(t *testing.T) {
...
func TestE_nocarry_0436Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0436) bool {
...
func TestE_nocarry_0436LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0436Halve(t *testing.T) {
...
func TestE_nocarry_0436FromMont(t *testing.T) {
...
type testPaire_nocarry_0436 struct {
	element e_nocarry_0436
	bigint  big.Int
}

func (z *e_nocarry_0436) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0436[6] {
		return true
	}
	if z[6] < qe_nocarry_0436[6] {
		return false
	...
	return z[0] >= qe_nocarry_0436[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0436

		g.element = e_nocarry_0436{
		...
		if qe_nocarry_0436[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0436[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0436 {
			var g e_nocarry_0436
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0436[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0436[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0436[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0436[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0436[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0436[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0436[6], carry)
...
func Benchmarke_nocarry_0436InverseNew(b *testing.B) {
	var x e_nocarry_0436
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0436
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0436
		var xInv e_nocarry_0436
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0436
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0436
...
func testLinearComb(t *testing.T, x *e_nocarry_0436, xC int64, y *e_nocarry_0436, yC int64) {
	...
	var z e_nocarry_0436
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0436, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0436
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0436, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0436
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0436, xHi uint64) {
	var res e_nocarry_0436
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0436) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0436) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0436, c int64, result *e_nocarry_0436, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0436) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0436) uint64 {
