...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0445{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0445{0, uint64(i)})
	}
...
func (z *e_nocarry_0445) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0445[6] {
		return true
	}
	if z[6] < qe_nocarry_0445[6] {
		return false
...
func Benchmarke_nocarry_0445InverseNew(b *testing.B) {
	var x e_nocarry_0445
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0445, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0445, xHi uint64) {
