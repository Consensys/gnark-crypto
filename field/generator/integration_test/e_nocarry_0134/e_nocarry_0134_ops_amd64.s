...
// modulus q
DATA q<>+0(SB)/8, $0x9ceac0ea7c310a2b
DATA q<>+8(SB)/8, $0x118306bfd5194baa
DATA q<>+16(SB)/8, $0x0000000000000034
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xfb10e2b44bb29b7d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x9ceac0ea7c310a2b, DI
	MOVQ    $0x118306bfd5194baa, R8
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x118306bfd5194baa, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x0000000000000034, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x9ceac0ea7c310a2b, R10
	MOVQ    $0x118306bfd5194baa, R11
	MOVQ    $0x0000000000000034, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
