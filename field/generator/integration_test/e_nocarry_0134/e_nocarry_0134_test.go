...
var benchRese_nocarry_0134 e_nocarry_0134

func BenchmarkE_nocarry_0134SetBytes(b *testing.B) {
	var x e_nocarry_0134
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0134MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0134.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0134)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0134)
		}
	})
}

func BenchmarkE_nocarry_0134Inverse(b *testing.B) {
	var x e_nocarry_0134
	x.SetRandom()
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0134Butterfly(b *testing.B) {
	var x e_nocarry_0134
	x.SetRandom()
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0134)
	}
}

func BenchmarkE_nocarry_0134Exp(b *testing.B) {
	var x e_nocarry_0134
	x.SetRandom()
	benchRese_nocarry_0134.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0134Double(b *testing.B) {
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Double(&benchRese_nocarry_0134)
	}
}

func BenchmarkE_nocarry_0134Add(b *testing.B) {
	var x e_nocarry_0134
	x.SetRandom()
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Add(&x, &benchRese_nocarry_0134)
	}
}

func BenchmarkE_nocarry_0134Sub(b *testing.B) {
	var x e_nocarry_0134
	x.SetRandom()
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Sub(&x, &benchRese_nocarry_0134)
	}
}

func BenchmarkE_nocarry_0134Neg(b *testing.B) {
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Neg(&benchRese_nocarry_0134)
	}
}

func BenchmarkE_nocarry_0134Div(b *testing.B) {
	var x e_nocarry_0134
	x.SetRandom()
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Div(&x, &benchRese_nocarry_0134)
	}
}

func BenchmarkE_nocarry_0134FromMont(b *testing.B) {
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.FromMont()
	}
}

func BenchmarkE_nocarry_0134ToMont(b *testing.B) {
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.ToMont()
	}
}
func BenchmarkE_nocarry_0134Square(b *testing.B) {
	benchRese_nocarry_0134.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Square(&benchRese_nocarry_0134)
	}
}

func BenchmarkE_nocarry_0134Sqrt(b *testing.B) {
	var a e_nocarry_0134
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0134Mul(b *testing.B) {
	x := e_nocarry_0134{
		16230708278410668230,
		10285244059799213599,
		39,
	}
	benchRese_nocarry_0134.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Mul(&benchRese_nocarry_0134, &x)
	}
}

func BenchmarkE_nocarry_0134Cmp(b *testing.B) {
	x := e_nocarry_0134{
		16230708278410668230,
		10285244059799213599,
		39,
	}
	benchRese_nocarry_0134 = x
	benchRese_nocarry_0134[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0134.Cmp(&x)
	}
}

func TestE_nocarry_0134Cmp(t *testing.T) {
	var x, y e_nocarry_0134
...
func TestE_nocarry_0134IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0134
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0134

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0134{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0134
	one.SetOne()
	e.Sub(&qe_nocarry_0134, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0134{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0134{0, uint64(i)})
	}
...
func TestE_nocarry_0134NegZero(t *testing.T) {
	var a, b e_nocarry_0134
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0134Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0134, len(staticTestValues))
...
func TestE_nocarry_0134Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0134) bool {
			var b e_nocarry_0134
...
func TestE_nocarry_0134InverseExp(t *testing.T) {
...
func TestE_nocarry_0134MulByConstants(t *testing.T) {
...
func TestE_nocarry_0134Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0134) bool {
...
func TestE_nocarry_0134LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0134Halve(t *testing.T) {
...
func TestE_nocarry_0134FromMont(t *testing.T) {
...
type testPaire_nocarry_0134 struct {
	element e_nocarry_0134
	bigint  big.Int
}

func (z *e_nocarry_0134) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0134[2] {
		return true
	}
	if z[2] < qe_nocarry_0134[2] {
		return false
	...
	return z[0] >= qe_nocarry_0134[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0134

		g.element = e_nocarry_0134{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0134[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0134[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0134 {
			var g e_nocarry_0134
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0134[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0134[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0134[2], carry)
...
func Benchmarke_nocarry_0134InverseNew(b *testing.B) {
	var x e_nocarry_0134
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0134
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0134
		var xInv e_nocarry_0134
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0134
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0134
...
func testLinearComb(t *testing.T, x *e_nocarry_0134, xC int64, y *e_nocarry_0134, yC int64) {
	...
	var z e_nocarry_0134
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0134, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0134
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0134, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0134
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0134, xHi uint64) {
	var res e_nocarry_0134
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0134) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0134) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0134, c int64, result *e_nocarry_0134, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0134) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0134) uint64 {
