...
// modulus q
DATA q<>+0(SB)/8, $0xa2e2452fe896699f
DATA q<>+8(SB)/8, $0x0650695458453cc3
GLOBL q<>(SB), (RODATA+NOPTR), $16

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x3b2530fadae58da1
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SUBQ    0(CX), AX
	SBBQ    8(CX), DX
	MOVQ    $0xa2e2452fe896699f, SI
	MOVQ    $0x0650695458453cc3, DI
	CMOVQCC BX, SI
	CMOVQCC BX, DI
	ADDQ    SI, AX
	ADCQ    DI, DX
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SUBQ    0(DX), SI
	SBBQ    8(DX), DI
	MOVQ    $0xa2e2452fe896699f, R8
	MOVQ    $0x0650695458453cc3, R9
	CMOVQCC AX, R8
	CMOVQCC AX, R9
	ADDQ    R8, SI
	ADCQ    R9, DI
