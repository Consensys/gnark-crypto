...
var benchRese_nocarry_0123 e_nocarry_0123

func BenchmarkE_nocarry_0123SetBytes(b *testing.B) {
	var x e_nocarry_0123
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0123MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0123.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0123)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0123)
		}
	})
}

func BenchmarkE_nocarry_0123Inverse(b *testing.B) {
	var x e_nocarry_0123
	x.SetRandom()
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0123Butterfly(b *testing.B) {
	var x e_nocarry_0123
	x.SetRandom()
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0123)
	}
}

func BenchmarkE_nocarry_0123Exp(b *testing.B) {
	var x e_nocarry_0123
	x.SetRandom()
	benchRese_nocarry_0123.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0123Double(b *testing.B) {
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Double(&benchRese_nocarry_0123)
	}
}

func BenchmarkE_nocarry_0123Add(b *testing.B) {
	var x e_nocarry_0123
	x.SetRandom()
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Add(&x, &benchRese_nocarry_0123)
	}
}

func BenchmarkE_nocarry_0123Sub(b *testing.B) {
	var x e_nocarry_0123
	x.SetRandom()
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Sub(&x, &benchRese_nocarry_0123)
	}
}

func BenchmarkE_nocarry_0123Neg(b *testing.B) {
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Neg(&benchRese_nocarry_0123)
	}
}

func BenchmarkE_nocarry_0123Div(b *testing.B) {
	var x e_nocarry_0123
	x.SetRandom()
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Div(&x, &benchRese_nocarry_0123)
	}
}

func BenchmarkE_nocarry_0123FromMont(b *testing.B) {
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.FromMont()
	}
}

func BenchmarkE_nocarry_0123ToMont(b *testing.B) {
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.ToMont()
	}
}
func BenchmarkE_nocarry_0123Square(b *testing.B) {
	benchRese_nocarry_0123.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Square(&benchRese_nocarry_0123)
	}
}

func BenchmarkE_nocarry_0123Sqrt(b *testing.B) {
	var a e_nocarry_0123
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0123Mul(b *testing.B) {
	x := e_nocarry_0123{
		10602690499732182496,
		446194621939084846,
	}
	benchRese_nocarry_0123.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Mul(&benchRese_nocarry_0123, &x)
	}
}

func BenchmarkE_nocarry_0123Cmp(b *testing.B) {
	x := e_nocarry_0123{
		10602690499732182496,
		446194621939084846,
	}
	benchRese_nocarry_0123 = x
	benchRese_nocarry_0123[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0123.Cmp(&x)
	}
}

func TestE_nocarry_0123Cmp(t *testing.T) {
	var x, y e_nocarry_0123
...
func TestE_nocarry_0123IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0123
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0123

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0123{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0123
	one.SetOne()
	e.Sub(&qe_nocarry_0123, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0123{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0123{0, uint64(i)})
	}
...
func TestE_nocarry_0123NegZero(t *testing.T) {
	var a, b e_nocarry_0123
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0123Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0123, len(staticTestValues))
...
func TestE_nocarry_0123Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0123) bool {
			var b e_nocarry_0123
...
func TestE_nocarry_0123InverseExp(t *testing.T) {
...
func TestE_nocarry_0123MulByConstants(t *testing.T) {
...
func TestE_nocarry_0123Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0123) bool {
...
func TestE_nocarry_0123LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0123Halve(t *testing.T) {
...
func TestE_nocarry_0123FromMont(t *testing.T) {
...
type testPaire_nocarry_0123 struct {
	element e_nocarry_0123
	bigint  big.Int
}

func (z *e_nocarry_0123) biggerOrEqualModulus() bool {
...
func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0123

		g.element = e_nocarry_0123{
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0123[1] != ^uint64(0) {
			g.element[1] %= (qe_nocarry_0123[1] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0123 {
			var g e_nocarry_0123
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0123[0], carry)
		a[1], _ = bits.Add64(a[1], qe_nocarry_0123[1], carry)
...
func Benchmarke_nocarry_0123InverseNew(b *testing.B) {
	var x e_nocarry_0123
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0123
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0123
		var xInv e_nocarry_0123
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0123
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0123
...
func testLinearComb(t *testing.T, x *e_nocarry_0123, xC int64, y *e_nocarry_0123, yC int64) {
	...
	var z e_nocarry_0123
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0123, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0123
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0123, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0123
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0123, xHi uint64) {
	var res e_nocarry_0123
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0123) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0123) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0123, c int64, result *e_nocarry_0123, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0123) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0123) uint64 {
