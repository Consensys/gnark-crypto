...
var benchRese_nocarry_0451 e_nocarry_0451

func BenchmarkE_nocarry_0451SetBytes(b *testing.B) {
	var x e_nocarry_0451
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0451MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0451.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0451)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0451)
		}
	})
}

func BenchmarkE_nocarry_0451Inverse(b *testing.B) {
	var x e_nocarry_0451
	x.SetRandom()
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0451Butterfly(b *testing.B) {
	var x e_nocarry_0451
	x.SetRandom()
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0451)
	}
}

func BenchmarkE_nocarry_0451Exp(b *testing.B) {
	var x e_nocarry_0451
	x.SetRandom()
	benchRese_nocarry_0451.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0451Double(b *testing.B) {
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Double(&benchRese_nocarry_0451)
	}
}

func BenchmarkE_nocarry_0451Add(b *testing.B) {
	var x e_nocarry_0451
	x.SetRandom()
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Add(&x, &benchRese_nocarry_0451)
	}
}

func BenchmarkE_nocarry_0451Sub(b *testing.B) {
	var x e_nocarry_0451
	x.SetRandom()
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Sub(&x, &benchRese_nocarry_0451)
	}
}

func BenchmarkE_nocarry_0451Neg(b *testing.B) {
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Neg(&benchRese_nocarry_0451)
	}
}

func BenchmarkE_nocarry_0451Div(b *testing.B) {
	var x e_nocarry_0451
	x.SetRandom()
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Div(&x, &benchRese_nocarry_0451)
	}
}

func BenchmarkE_nocarry_0451FromMont(b *testing.B) {
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.FromMont()
	}
}

func BenchmarkE_nocarry_0451ToMont(b *testing.B) {
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.ToMont()
	}
}
func BenchmarkE_nocarry_0451Square(b *testing.B) {
	benchRese_nocarry_0451.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Square(&benchRese_nocarry_0451)
	}
}

func BenchmarkE_nocarry_0451Sqrt(b *testing.B) {
	var a e_nocarry_0451
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0451Mul(b *testing.B) {
	x := e_nocarry_0451{
		3027382468627721817,
		5932025852712805217,
		5271465903694599017,
	...
	benchRese_nocarry_0451.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Mul(&benchRese_nocarry_0451, &x)
	}
}

func BenchmarkE_nocarry_0451Cmp(b *testing.B) {
	x := e_nocarry_0451{
		3027382468627721817,
		5932025852712805217,
		5271465903694599017,
	...
	benchRese_nocarry_0451 = x
	benchRese_nocarry_0451[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0451.Cmp(&x)
	}
}

func TestE_nocarry_0451Cmp(t *testing.T) {
	var x, y e_nocarry_0451
...
func TestE_nocarry_0451IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0451
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0451

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0451{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0451
	one.SetOne()
	e.Sub(&qe_nocarry_0451, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0451{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0451{0, uint64(i)})
	}
...
func TestE_nocarry_0451NegZero(t *testing.T) {
	var a, b e_nocarry_0451
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0451Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0451, len(staticTestValues))
...
func TestE_nocarry_0451Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0451) bool {
			var b e_nocarry_0451
...
func TestE_nocarry_0451InverseExp(t *testing.T) {
...
func TestE_nocarry_0451MulByConstants(t *testing.T) {
...
func TestE_nocarry_0451Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0451) bool {
...
func TestE_nocarry_0451LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0451Halve(t *testing.T) {
...
func TestE_nocarry_0451FromMont(t *testing.T) {
...
type testPaire_nocarry_0451 struct {
	element e_nocarry_0451
	bigint  big.Int
}

func (z *e_nocarry_0451) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0451[7] {
		return true
	}
	if z[7] < qe_nocarry_0451[7] {
		return false
	...
	return z[0] >= qe_nocarry_0451[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0451

		g.element = e_nocarry_0451{
		...
		if qe_nocarry_0451[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0451[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0451 {
			var g e_nocarry_0451
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0451[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0451[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0451[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0451[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0451[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0451[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0451[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0451[7], carry)
...
func Benchmarke_nocarry_0451InverseNew(b *testing.B) {
	var x e_nocarry_0451
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0451
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0451
		var xInv e_nocarry_0451
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0451
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0451
...
func testLinearComb(t *testing.T, x *e_nocarry_0451, xC int64, y *e_nocarry_0451, yC int64) {
	...
	var z e_nocarry_0451
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0451, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0451
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0451, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0451
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0451, xHi uint64) {
	var res e_nocarry_0451
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0451) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0451) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0451, c int64, result *e_nocarry_0451, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0451) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0451) uint64 {
