...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 56(R10), R9
	JCC  l1
	MOVQ $0xe7a8adadaae6c6dd, R11
	ADDQ R11, AX
	MOVQ $0x775b67d4d0c40d3c, R11
	ADCQ R11, DX
	MOVQ $0x198f7b4632814613, R11
	ADCQ R11, CX
	MOVQ $0x193351c979fee82a, R11
	ADCQ R11, BX
	MOVQ $0xef57c47013ff7540, R11
	ADCQ R11, SI
	MOVQ $0x0c1e9e9ee955d1ad, R11
	ADCQ R11, DI
	MOVQ $0x2e8dec473bab20d0, R11
	ADCQ R11, R8
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xe7a8adadaae6c6dd, R12
	SUBQ  DX, R12
	MOVQ  R12, 0(R11)
	MOVQ  $0x775b67d4d0c40d3c, R12
	SBBQ  CX, R12
	MOVQ  R12, 8(R11)
	MOVQ  $0x198f7b4632814613, R12
	SBBQ  BX, R12
	MOVQ  R12, 16(R11)
	MOVQ  $0x193351c979fee82a, R12
	SBBQ  SI, R12
	MOVQ  R12, 24(R11)
	MOVQ  $0xef57c47013ff7540, R12
	SBBQ  DI, R12
	MOVQ  R12, 32(R11)
	MOVQ  $0x0c1e9e9ee955d1ad, R12
	SBBQ  R8, R12
	MOVQ  R12, 40(R11)
	MOVQ  $0x2e8dec473bab20d0, R12
	SBBQ  R9, R12
	MOVQ  R12, 48(R11)
...
TEXT ·Butterfly(SB), $24-16
	...
	SBBQ 56(AX), R10
	JCC  l3
	MOVQ $0xe7a8adadaae6c6dd, AX
	ADDQ AX, DX
	MOVQ $0x775b67d4d0c40d3c, AX
	ADCQ AX, CX
	MOVQ $0x198f7b4632814613, AX
	ADCQ AX, BX
	MOVQ $0x193351c979fee82a, AX
	ADCQ AX, SI
	MOVQ $0xef57c47013ff7540, AX
	ADCQ AX, DI
	MOVQ $0x0c1e9e9ee955d1ad, AX
	ADCQ AX, R8
	MOVQ $0x2e8dec473bab20d0, AX
	ADCQ AX, R9
