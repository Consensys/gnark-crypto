...
// modulus q
DATA q<>+0(SB)/8, $0xe7a8adadaae6c6dd
DATA q<>+8(SB)/8, $0x775b67d4d0c40d3c
DATA q<>+16(SB)/8, $0x198f7b4632814613
DATA q<>+24(SB)/8, $0x193351c979fee82a
DATA q<>+32(SB)/8, $0xef57c47013ff7540
DATA q<>+40(SB)/8, $0x0c1e9e9ee955d1ad
DATA q<>+48(SB)/8, $0x2e8dec473bab20d0
DATA q<>+56(SB)/8, $0x0000000000000006
GLOBL q<>(SB), (RODATA+NOPTR), $64

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xb55df41df6e2be8b
