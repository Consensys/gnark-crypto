...
// modulus q
DATA q<>+0(SB)/8, $0x9a7300a7b7d11407
DATA q<>+8(SB)/8, $0x406ea50e269d57e9
DATA q<>+16(SB)/8, $0x4ba11dcc4d3dd5b6
DATA q<>+24(SB)/8, $0x66c6e4e41d46894f
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xf5b225be0cc5e649
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x9a7300a7b7d11407, R8
	MOVQ    $0x406ea50e269d57e9, R9
	MOVQ    $0x4ba11dcc4d3dd5b6, R10
	MOVQ    $0x66c6e4e41d46894f, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x406ea50e269d57e9, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x4ba11dcc4d3dd5b6, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x66c6e4e41d46894f, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x9a7300a7b7d11407, R12
	MOVQ    $0x406ea50e269d57e9, R13
	MOVQ    $0x4ba11dcc4d3dd5b6, R14
	MOVQ    $0x66c6e4e41d46894f, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
