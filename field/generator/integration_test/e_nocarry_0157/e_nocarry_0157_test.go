...
var benchRese_nocarry_0157 e_nocarry_0157

func BenchmarkE_nocarry_0157SetBytes(b *testing.B) {
	var x e_nocarry_0157
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0157MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0157.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0157)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0157)
		}
	})
}

func BenchmarkE_nocarry_0157Inverse(b *testing.B) {
	var x e_nocarry_0157
	x.SetRandom()
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0157Butterfly(b *testing.B) {
	var x e_nocarry_0157
	x.SetRandom()
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0157)
	}
}

func BenchmarkE_nocarry_0157Exp(b *testing.B) {
	var x e_nocarry_0157
	x.SetRandom()
	benchRese_nocarry_0157.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0157Double(b *testing.B) {
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Double(&benchRese_nocarry_0157)
	}
}

func BenchmarkE_nocarry_0157Add(b *testing.B) {
	var x e_nocarry_0157
	x.SetRandom()
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Add(&x, &benchRese_nocarry_0157)
	}
}

func BenchmarkE_nocarry_0157Sub(b *testing.B) {
	var x e_nocarry_0157
	x.SetRandom()
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Sub(&x, &benchRese_nocarry_0157)
	}
}

func BenchmarkE_nocarry_0157Neg(b *testing.B) {
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Neg(&benchRese_nocarry_0157)
	}
}

func BenchmarkE_nocarry_0157Div(b *testing.B) {
	var x e_nocarry_0157
	x.SetRandom()
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Div(&x, &benchRese_nocarry_0157)
	}
}

func BenchmarkE_nocarry_0157FromMont(b *testing.B) {
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.FromMont()
	}
}

func BenchmarkE_nocarry_0157ToMont(b *testing.B) {
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.ToMont()
	}
}
func BenchmarkE_nocarry_0157Square(b *testing.B) {
	benchRese_nocarry_0157.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Square(&benchRese_nocarry_0157)
	}
}

func BenchmarkE_nocarry_0157Sqrt(b *testing.B) {
	var a e_nocarry_0157
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0157Mul(b *testing.B) {
	x := e_nocarry_0157{
		15381581995056661888,
		6581430568203845997,
		242758838,
	}
	benchRese_nocarry_0157.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Mul(&benchRese_nocarry_0157, &x)
	}
}

func BenchmarkE_nocarry_0157Cmp(b *testing.B) {
	x := e_nocarry_0157{
		15381581995056661888,
		6581430568203845997,
		242758838,
	}
	benchRese_nocarry_0157 = x
	benchRese_nocarry_0157[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0157.Cmp(&x)
	}
}

func TestE_nocarry_0157Cmp(t *testing.T) {
	var x, y e_nocarry_0157
...
func TestE_nocarry_0157IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0157
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0157

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0157{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0157
	one.SetOne()
	e.Sub(&qe_nocarry_0157, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0157{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0157{0, uint64(i)})
	}
...
func TestE_nocarry_0157NegZero(t *testing.T) {
	var a, b e_nocarry_0157
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0157Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0157, len(staticTestValues))
...
func TestE_nocarry_0157Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0157) bool {
			var b e_nocarry_0157
...
func TestE_nocarry_0157InverseExp(t *testing.T) {
...
func TestE_nocarry_0157MulByConstants(t *testing.T) {
...
func TestE_nocarry_0157Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0157) bool {
...
func TestE_nocarry_0157LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0157Halve(t *testing.T) {
...
func TestE_nocarry_0157FromMont(t *testing.T) {
...
type testPaire_nocarry_0157 struct {
	element e_nocarry_0157
	bigint  big.Int
}

func (z *e_nocarry_0157) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0157[2] {
		return true
	}
	if z[2] < qe_nocarry_0157[2] {
		return false
	...
	return z[0] >= qe_nocarry_0157[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0157

		g.element = e_nocarry_0157{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0157[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0157[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0157 {
			var g e_nocarry_0157
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0157[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0157[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0157[2], carry)
...
func Benchmarke_nocarry_0157InverseNew(b *testing.B) {
	var x e_nocarry_0157
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0157
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0157
		var xInv e_nocarry_0157
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0157
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0157
...
func testLinearComb(t *testing.T, x *e_nocarry_0157, xC int64, y *e_nocarry_0157, yC int64) {
	...
	var z e_nocarry_0157
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0157, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0157
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0157, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0157
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0157, xHi uint64) {
	var res e_nocarry_0157
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0157) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0157) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0157, c int64, result *e_nocarry_0157, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0157) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0157) uint64 {
