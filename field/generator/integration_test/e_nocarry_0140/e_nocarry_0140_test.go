...
var benchRese_nocarry_0140 e_nocarry_0140

func BenchmarkE_nocarry_0140SetBytes(b *testing.B) {
	var x e_nocarry_0140
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0140MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0140.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0140)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0140)
		}
	})
}

func BenchmarkE_nocarry_0140Inverse(b *testing.B) {
	var x e_nocarry_0140
	x.SetRandom()
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0140Butterfly(b *testing.B) {
	var x e_nocarry_0140
	x.SetRandom()
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0140)
	}
}

func BenchmarkE_nocarry_0140Exp(b *testing.B) {
	var x e_nocarry_0140
	x.SetRandom()
	benchRese_nocarry_0140.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0140Double(b *testing.B) {
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Double(&benchRese_nocarry_0140)
	}
}

func BenchmarkE_nocarry_0140Add(b *testing.B) {
	var x e_nocarry_0140
	x.SetRandom()
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Add(&x, &benchRese_nocarry_0140)
	}
}

func BenchmarkE_nocarry_0140Sub(b *testing.B) {
	var x e_nocarry_0140
	x.SetRandom()
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Sub(&x, &benchRese_nocarry_0140)
	}
}

func BenchmarkE_nocarry_0140Neg(b *testing.B) {
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Neg(&benchRese_nocarry_0140)
	}
}

func BenchmarkE_nocarry_0140Div(b *testing.B) {
	var x e_nocarry_0140
	x.SetRandom()
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Div(&x, &benchRese_nocarry_0140)
	}
}

func BenchmarkE_nocarry_0140FromMont(b *testing.B) {
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.FromMont()
	}
}

func BenchmarkE_nocarry_0140ToMont(b *testing.B) {
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.ToMont()
	}
}
func BenchmarkE_nocarry_0140Square(b *testing.B) {
	benchRese_nocarry_0140.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Square(&benchRese_nocarry_0140)
	}
}

func BenchmarkE_nocarry_0140Sqrt(b *testing.B) {
	var a e_nocarry_0140
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0140Mul(b *testing.B) {
	x := e_nocarry_0140{
		11919670659039079709,
		6518035727947176855,
		92,
	}
	benchRese_nocarry_0140.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Mul(&benchRese_nocarry_0140, &x)
	}
}

func BenchmarkE_nocarry_0140Cmp(b *testing.B) {
	x := e_nocarry_0140{
		11919670659039079709,
		6518035727947176855,
		92,
	}
	benchRese_nocarry_0140 = x
	benchRese_nocarry_0140[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0140.Cmp(&x)
	}
}

func TestE_nocarry_0140Cmp(t *testing.T) {
	var x, y e_nocarry_0140
...
func TestE_nocarry_0140IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0140
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0140

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0140{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0140
	one.SetOne()
	e.Sub(&qe_nocarry_0140, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0140{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0140{0, uint64(i)})
	}
...
func TestE_nocarry_0140NegZero(t *testing.T) {
	var a, b e_nocarry_0140
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0140Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0140, len(staticTestValues))
...
func TestE_nocarry_0140Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0140) bool {
			var b e_nocarry_0140
...
func TestE_nocarry_0140InverseExp(t *testing.T) {
...
func TestE_nocarry_0140MulByConstants(t *testing.T) {
...
func TestE_nocarry_0140Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0140) bool {
...
func TestE_nocarry_0140LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0140Halve(t *testing.T) {
...
func TestE_nocarry_0140FromMont(t *testing.T) {
...
type testPaire_nocarry_0140 struct {
	element e_nocarry_0140
	bigint  big.Int
}

func (z *e_nocarry_0140) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0140[2] {
		return true
	}
	if z[2] < qe_nocarry_0140[2] {
		return false
	...
	return z[0] >= qe_nocarry_0140[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0140

		g.element = e_nocarry_0140{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0140[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0140[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0140 {
			var g e_nocarry_0140
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0140[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0140[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0140[2], carry)
...
func Benchmarke_nocarry_0140InverseNew(b *testing.B) {
	var x e_nocarry_0140
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0140
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0140
		var xInv e_nocarry_0140
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0140
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0140
...
func testLinearComb(t *testing.T, x *e_nocarry_0140, xC int64, y *e_nocarry_0140, yC int64) {
	...
	var z e_nocarry_0140
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0140, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0140
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0140, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0140
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0140, xHi uint64) {
	var res e_nocarry_0140
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0140) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0140) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0140, c int64, result *e_nocarry_0140, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0140) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0140) uint64 {
