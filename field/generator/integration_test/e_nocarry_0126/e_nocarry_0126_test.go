...
func init() {
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0126{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0126{0, uint64(i)})
	}
...
func (z *e_nocarry_0126) biggerOrEqualModulus() bool {
	if z[1] > qe_nocarry_0126[1] {
		return true
	}
	if z[1] < qe_nocarry_0126[1] {
		return false
...
func Benchmarke_nocarry_0126InverseNew(b *testing.B) {
	var x e_nocarry_0126
	x.SetRandom()
...
func testBigNumWMulBr(t *testing.T, a *e_nocarry_0126, c int64) {
	var aHi uint64
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0126, xHi uint64) {
