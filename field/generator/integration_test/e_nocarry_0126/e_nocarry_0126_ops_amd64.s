...
// modulus q
DATA q<>+0(SB)/8, $0x9364d8f62f8aea8f
DATA q<>+8(SB)/8, $0x3a2a1763d25b793f
GLOBL q<>(SB), (RODATA+NOPTR), $16

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xed36c2a584730b91
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SUBQ    0(CX), AX
	SBBQ    8(CX), DX
	MOVQ    $0x9364d8f62f8aea8f, SI
	MOVQ    $0x3a2a1763d25b793f, DI
	CMOVQCC BX, SI
	CMOVQCC BX, DI
	ADDQ    SI, AX
	ADCQ    DI, DX
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SUBQ    0(DX), SI
	SBBQ    8(DX), DI
	MOVQ    $0x9364d8f62f8aea8f, R8
	MOVQ    $0x3a2a1763d25b793f, R9
	CMOVQCC AX, R8
	CMOVQCC AX, R9
	ADDQ    R8, SI
	ADCQ    R9, DI
