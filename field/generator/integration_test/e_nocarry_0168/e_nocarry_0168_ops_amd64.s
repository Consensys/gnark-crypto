...
// modulus q
DATA q<>+0(SB)/8, $0x152a05ccb0ed7737
DATA q<>+8(SB)/8, $0x97375be9fc343164
DATA q<>+16(SB)/8, $0x000000c93b5591f7
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x9e46232e77e81179
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0x152a05ccb0ed7737, DI
	MOVQ    $0x97375be9fc343164, R8
	MOVQ    $0x000000c93b5591f7, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x97375be9fc343164, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x000000c93b5591f7, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0x152a05ccb0ed7737, R10
	MOVQ    $0x97375be9fc343164, R11
	MOVQ    $0x000000c93b5591f7, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
