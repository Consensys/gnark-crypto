...
var benchRese_nocarry_0168 e_nocarry_0168

func BenchmarkE_nocarry_0168SetBytes(b *testing.B) {
	var x e_nocarry_0168
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0168MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0168.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0168)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0168)
		}
	})
}

func BenchmarkE_nocarry_0168Inverse(b *testing.B) {
	var x e_nocarry_0168
	x.SetRandom()
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0168Butterfly(b *testing.B) {
	var x e_nocarry_0168
	x.SetRandom()
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0168)
	}
}

func BenchmarkE_nocarry_0168Exp(b *testing.B) {
	var x e_nocarry_0168
	x.SetRandom()
	benchRese_nocarry_0168.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0168Double(b *testing.B) {
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Double(&benchRese_nocarry_0168)
	}
}

func BenchmarkE_nocarry_0168Add(b *testing.B) {
	var x e_nocarry_0168
	x.SetRandom()
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Add(&x, &benchRese_nocarry_0168)
	}
}

func BenchmarkE_nocarry_0168Sub(b *testing.B) {
	var x e_nocarry_0168
	x.SetRandom()
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Sub(&x, &benchRese_nocarry_0168)
	}
}

func BenchmarkE_nocarry_0168Neg(b *testing.B) {
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Neg(&benchRese_nocarry_0168)
	}
}

func BenchmarkE_nocarry_0168Div(b *testing.B) {
	var x e_nocarry_0168
	x.SetRandom()
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Div(&x, &benchRese_nocarry_0168)
	}
}

func BenchmarkE_nocarry_0168FromMont(b *testing.B) {
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.FromMont()
	}
}

func BenchmarkE_nocarry_0168ToMont(b *testing.B) {
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.ToMont()
	}
}
func BenchmarkE_nocarry_0168Square(b *testing.B) {
	benchRese_nocarry_0168.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Square(&benchRese_nocarry_0168)
	}
}

func BenchmarkE_nocarry_0168Sqrt(b *testing.B) {
	var a e_nocarry_0168
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0168Mul(b *testing.B) {
	x := e_nocarry_0168{
		3858972562507250652,
		9119990807642181329,
		535521370856,
	}
	benchRese_nocarry_0168.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Mul(&benchRese_nocarry_0168, &x)
	}
}

func BenchmarkE_nocarry_0168Cmp(b *testing.B) {
	x := e_nocarry_0168{
		3858972562507250652,
		9119990807642181329,
		535521370856,
	}
	benchRese_nocarry_0168 = x
	benchRese_nocarry_0168[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0168.Cmp(&x)
	}
}

func TestE_nocarry_0168Cmp(t *testing.T) {
	var x, y e_nocarry_0168
...
func TestE_nocarry_0168IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0168
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0168

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0168{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0168
	one.SetOne()
	e.Sub(&qe_nocarry_0168, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0168{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0168{0, uint64(i)})
	}
...
func TestE_nocarry_0168NegZero(t *testing.T) {
	var a, b e_nocarry_0168
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0168Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0168, len(staticTestValues))
...
func TestE_nocarry_0168Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0168) bool {
			var b e_nocarry_0168
...
func TestE_nocarry_0168InverseExp(t *testing.T) {
...
func TestE_nocarry_0168MulByConstants(t *testing.T) {
...
func TestE_nocarry_0168Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0168) bool {
...
func TestE_nocarry_0168LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0168Halve(t *testing.T) {
...
func TestE_nocarry_0168FromMont(t *testing.T) {
...
type testPaire_nocarry_0168 struct {
	element e_nocarry_0168
	bigint  big.Int
}

func (z *e_nocarry_0168) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0168[2] {
		return true
	}
	if z[2] < qe_nocarry_0168[2] {
		return false
	...
	return z[0] >= qe_nocarry_0168[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0168

		g.element = e_nocarry_0168{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0168[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0168[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0168 {
			var g e_nocarry_0168
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0168[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0168[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0168[2], carry)
...
func Benchmarke_nocarry_0168InverseNew(b *testing.B) {
	var x e_nocarry_0168
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0168
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0168
		var xInv e_nocarry_0168
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0168
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0168
...
func testLinearComb(t *testing.T, x *e_nocarry_0168, xC int64, y *e_nocarry_0168, yC int64) {
	...
	var z e_nocarry_0168
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0168, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0168
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0168, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0168
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0168, xHi uint64) {
	var res e_nocarry_0168
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0168) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0168) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0168, c int64, result *e_nocarry_0168, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0168) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0168) uint64 {
