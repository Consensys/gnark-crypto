...
// modulus q
DATA q<>+0(SB)/8, $0x6ccb43a17fc13fa7
DATA q<>+8(SB)/8, $0xcba23db97fa005bf
DATA q<>+16(SB)/8, $0x5ebcba531a0de480
DATA q<>+24(SB)/8, $0x000000000000001c
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xa79787fd5c9487e9
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x6ccb43a17fc13fa7, R8
	MOVQ    $0xcba23db97fa005bf, R9
	MOVQ    $0x5ebcba531a0de480, R10
	MOVQ    $0x000000000000001c, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xcba23db97fa005bf, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x5ebcba531a0de480, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x000000000000001c, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x6ccb43a17fc13fa7, R12
	MOVQ    $0xcba23db97fa005bf, R13
	MOVQ    $0x5ebcba531a0de480, R14
	MOVQ    $0x000000000000001c, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
