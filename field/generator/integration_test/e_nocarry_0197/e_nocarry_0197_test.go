...
var benchRese_nocarry_0197 e_nocarry_0197

func BenchmarkE_nocarry_0197SetBytes(b *testing.B) {
	var x e_nocarry_0197
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0197MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0197.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0197)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0197)
		}
	})
}

func BenchmarkE_nocarry_0197Inverse(b *testing.B) {
	var x e_nocarry_0197
	x.SetRandom()
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0197Butterfly(b *testing.B) {
	var x e_nocarry_0197
	x.SetRandom()
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0197)
	}
}

func BenchmarkE_nocarry_0197Exp(b *testing.B) {
	var x e_nocarry_0197
	x.SetRandom()
	benchRese_nocarry_0197.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0197Double(b *testing.B) {
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Double(&benchRese_nocarry_0197)
	}
}

func BenchmarkE_nocarry_0197Add(b *testing.B) {
	var x e_nocarry_0197
	x.SetRandom()
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Add(&x, &benchRese_nocarry_0197)
	}
}

func BenchmarkE_nocarry_0197Sub(b *testing.B) {
	var x e_nocarry_0197
	x.SetRandom()
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Sub(&x, &benchRese_nocarry_0197)
	}
}

func BenchmarkE_nocarry_0197Neg(b *testing.B) {
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Neg(&benchRese_nocarry_0197)
	}
}

func BenchmarkE_nocarry_0197Div(b *testing.B) {
	var x e_nocarry_0197
	x.SetRandom()
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Div(&x, &benchRese_nocarry_0197)
	}
}

func BenchmarkE_nocarry_0197FromMont(b *testing.B) {
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.FromMont()
	}
}

func BenchmarkE_nocarry_0197ToMont(b *testing.B) {
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.ToMont()
	}
}
func BenchmarkE_nocarry_0197Square(b *testing.B) {
	benchRese_nocarry_0197.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Square(&benchRese_nocarry_0197)
	}
}

func BenchmarkE_nocarry_0197Sqrt(b *testing.B) {
	var a e_nocarry_0197
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0197Mul(b *testing.B) {
	x := e_nocarry_0197{
	...
	benchRese_nocarry_0197.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Mul(&benchRese_nocarry_0197, &x)
	}
}

func BenchmarkE_nocarry_0197Cmp(b *testing.B) {
	x := e_nocarry_0197{
		13121127120130642760,
		9158597597046186183,
		15899558658316217441,
	...
	benchRese_nocarry_0197 = x
	benchRese_nocarry_0197[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0197.Cmp(&x)
	}
}

func TestE_nocarry_0197Cmp(t *testing.T) {
	var x, y e_nocarry_0197
...
func TestE_nocarry_0197IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0197
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0197

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0197{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0197
	one.SetOne()
	e.Sub(&qe_nocarry_0197, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0197{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0197{0, uint64(i)})
	}
...
func TestE_nocarry_0197NegZero(t *testing.T) {
	var a, b e_nocarry_0197
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0197Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0197, len(staticTestValues))
...
func TestE_nocarry_0197Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0197) bool {
			var b e_nocarry_0197
...
func TestE_nocarry_0197InverseExp(t *testing.T) {
...
func TestE_nocarry_0197MulByConstants(t *testing.T) {
...
func TestE_nocarry_0197Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0197) bool {
...
func TestE_nocarry_0197LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0197Halve(t *testing.T) {
...
func TestE_nocarry_0197FromMont(t *testing.T) {
...
type testPaire_nocarry_0197 struct {
	element e_nocarry_0197
	bigint  big.Int
}

func (z *e_nocarry_0197) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0197[3] {
		return true
	}
	if z[3] < qe_nocarry_0197[3] {
		return false
	...
	return z[0] >= qe_nocarry_0197[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0197

		g.element = e_nocarry_0197{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0197[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0197[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0197 {
			var g e_nocarry_0197
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0197[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0197[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0197[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0197[3], carry)
...
func Benchmarke_nocarry_0197InverseNew(b *testing.B) {
	var x e_nocarry_0197
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0197
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0197
		var xInv e_nocarry_0197
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0197
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0197
...
func testLinearComb(t *testing.T, x *e_nocarry_0197, xC int64, y *e_nocarry_0197, yC int64) {
	...
	var z e_nocarry_0197
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0197, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0197
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0197, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0197
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0197, xHi uint64) {
	var res e_nocarry_0197
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0197) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0197) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0197, c int64, result *e_nocarry_0197, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0197) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0197) uint64 {
