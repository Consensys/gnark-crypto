...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x0ddd735516d63ad9, R12
	ADDQ R12, AX
	MOVQ $0x08aaafd9e9eb2c85, R12
	ADCQ R12, DX
	MOVQ $0x3872941880a9e12c, R12
	ADCQ R12, CX
	MOVQ $0xd2c428c5046e6e81, R12
	ADCQ R12, BX
	MOVQ $0xf457a2c215c0a8e3, R12
	ADCQ R12, SI
	MOVQ $0xea90c09c53d855e5, R12
	ADCQ R12, DI
	MOVQ $0x7b2e81160ca96e17, R12
	ADCQ R12, R8
	MOVQ $0xaeabb8ad30688b2f, R12
	ADCQ R12, R9
	MOVQ $0x000e741b1998b875, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x0ddd735516d63ad9, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x08aaafd9e9eb2c85, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x3872941880a9e12c, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xd2c428c5046e6e81, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xf457a2c215c0a8e3, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xea90c09c53d855e5, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x7b2e81160ca96e17, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xaeabb8ad30688b2f, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000e741b1998b875, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x0ddd735516d63ad9, AX
	ADDQ AX, DX
	MOVQ $0x08aaafd9e9eb2c85, AX
	ADCQ AX, CX
	MOVQ $0x3872941880a9e12c, AX
	ADCQ AX, BX
	MOVQ $0xd2c428c5046e6e81, AX
	ADCQ AX, SI
	MOVQ $0xf457a2c215c0a8e3, AX
	ADCQ AX, DI
	MOVQ $0xea90c09c53d855e5, AX
	ADCQ AX, R8
	MOVQ $0x7b2e81160ca96e17, AX
	ADCQ AX, R9
	MOVQ $0xaeabb8ad30688b2f, AX
	ADCQ AX, R10
	MOVQ $0x000e741b1998b875, AX
	ADCQ AX, R11
