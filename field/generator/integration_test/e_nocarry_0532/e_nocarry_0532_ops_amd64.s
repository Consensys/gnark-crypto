...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x25c66319c80e07bd, R12
	ADDQ R12, AX
	MOVQ $0xe6c973e8fb765c96, R12
	ADCQ R12, DX
	MOVQ $0xd6dabe6280ea4293, R12
	ADCQ R12, CX
	MOVQ $0x736a26781bd13ff7, R12
	ADCQ R12, BX
	MOVQ $0xd1d20e56bc771166, R12
	ADCQ R12, SI
	MOVQ $0x4eba60ee22f55cd6, R12
	ADCQ R12, DI
	MOVQ $0x0314be2d23a3f19f, R12
	ADCQ R12, R8
	MOVQ $0x5d1d806917411b61, R12
	ADCQ R12, R9
	MOVQ $0x00000000000fbf24, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x25c66319c80e07bd, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xe6c973e8fb765c96, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xd6dabe6280ea4293, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x736a26781bd13ff7, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xd1d20e56bc771166, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x4eba60ee22f55cd6, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x0314be2d23a3f19f, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x5d1d806917411b61, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000000000fbf24, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x25c66319c80e07bd, AX
	ADDQ AX, DX
	MOVQ $0xe6c973e8fb765c96, AX
	ADCQ AX, CX
	MOVQ $0xd6dabe6280ea4293, AX
	ADCQ AX, BX
	MOVQ $0x736a26781bd13ff7, AX
	ADCQ AX, SI
	MOVQ $0xd1d20e56bc771166, AX
	ADCQ AX, DI
	MOVQ $0x4eba60ee22f55cd6, AX
	ADCQ AX, R8
	MOVQ $0x0314be2d23a3f19f, AX
	ADCQ AX, R9
	MOVQ $0x5d1d806917411b61, AX
	ADCQ AX, R10
	MOVQ $0x00000000000fbf24, AX
	ADCQ AX, R11
