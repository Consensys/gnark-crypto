...
var benchRese_nocarry_0532 e_nocarry_0532

func BenchmarkE_nocarry_0532SetBytes(b *testing.B) {
	var x e_nocarry_0532
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0532MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0532.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0532)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0532)
		}
	})
}

func BenchmarkE_nocarry_0532Inverse(b *testing.B) {
	var x e_nocarry_0532
	x.SetRandom()
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0532Butterfly(b *testing.B) {
	var x e_nocarry_0532
	x.SetRandom()
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0532)
	}
}

func BenchmarkE_nocarry_0532Exp(b *testing.B) {
	var x e_nocarry_0532
	x.SetRandom()
	benchRese_nocarry_0532.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0532Double(b *testing.B) {
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Double(&benchRese_nocarry_0532)
	}
}

func BenchmarkE_nocarry_0532Add(b *testing.B) {
	var x e_nocarry_0532
	x.SetRandom()
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Add(&x, &benchRese_nocarry_0532)
	}
}

func BenchmarkE_nocarry_0532Sub(b *testing.B) {
	var x e_nocarry_0532
	x.SetRandom()
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Sub(&x, &benchRese_nocarry_0532)
	}
}

func BenchmarkE_nocarry_0532Neg(b *testing.B) {
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Neg(&benchRese_nocarry_0532)
	}
}

func BenchmarkE_nocarry_0532Div(b *testing.B) {
	var x e_nocarry_0532
	x.SetRandom()
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Div(&x, &benchRese_nocarry_0532)
	}
}

func BenchmarkE_nocarry_0532FromMont(b *testing.B) {
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.FromMont()
	}
}

func BenchmarkE_nocarry_0532ToMont(b *testing.B) {
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.ToMont()
	}
}
func BenchmarkE_nocarry_0532Square(b *testing.B) {
	benchRese_nocarry_0532.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Square(&benchRese_nocarry_0532)
	}
}

func BenchmarkE_nocarry_0532Sqrt(b *testing.B) {
	var a e_nocarry_0532
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0532Mul(b *testing.B) {
	x := e_nocarry_0532{
	...
	benchRese_nocarry_0532.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Mul(&benchRese_nocarry_0532, &x)
	}
}

func BenchmarkE_nocarry_0532Cmp(b *testing.B) {
	x := e_nocarry_0532{
		17742008926808820157,
		12321013501101678932,
		14442535962461736177,
	...
	benchRese_nocarry_0532 = x
	benchRese_nocarry_0532[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0532.Cmp(&x)
	}
}

func TestE_nocarry_0532Cmp(t *testing.T) {
	var x, y e_nocarry_0532
...
func TestE_nocarry_0532IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0532
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0532

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0532{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0532
	one.SetOne()
	e.Sub(&qe_nocarry_0532, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0532{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0532{0, uint64(i)})
	}
...
func TestE_nocarry_0532NegZero(t *testing.T) {
	var a, b e_nocarry_0532
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0532Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0532, len(staticTestValues))
...
func TestE_nocarry_0532Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0532) bool {
			var b e_nocarry_0532
...
func TestE_nocarry_0532InverseExp(t *testing.T) {
...
func TestE_nocarry_0532MulByConstants(t *testing.T) {
...
func TestE_nocarry_0532Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0532) bool {
...
func TestE_nocarry_0532LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0532Halve(t *testing.T) {
...
func TestE_nocarry_0532FromMont(t *testing.T) {
...
type testPaire_nocarry_0532 struct {
	element e_nocarry_0532
	bigint  big.Int
}

func (z *e_nocarry_0532) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0532[8] {
		return true
	}
	if z[8] < qe_nocarry_0532[8] {
		return false
	...
	return z[0] >= qe_nocarry_0532[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0532

		g.element = e_nocarry_0532{
		...
		if qe_nocarry_0532[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0532[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0532 {
			var g e_nocarry_0532
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0532[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0532[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0532[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0532[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0532[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0532[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0532[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0532[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0532[8], carry)
...
func Benchmarke_nocarry_0532InverseNew(b *testing.B) {
	var x e_nocarry_0532
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0532
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0532
		var xInv e_nocarry_0532
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0532
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0532
...
func testLinearComb(t *testing.T, x *e_nocarry_0532, xC int64, y *e_nocarry_0532, yC int64) {
	...
	var z e_nocarry_0532
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0532, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0532
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0532, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0532
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0532, xHi uint64) {
	var res e_nocarry_0532
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0532) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0532) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0532, c int64, result *e_nocarry_0532, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0532) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0532) uint64 {
