...
var benchRese_nocarry_0158 e_nocarry_0158

func BenchmarkE_nocarry_0158SetBytes(b *testing.B) {
	var x e_nocarry_0158
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0158MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0158.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0158)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0158)
		}
	})
}

func BenchmarkE_nocarry_0158Inverse(b *testing.B) {
	var x e_nocarry_0158
	x.SetRandom()
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0158Butterfly(b *testing.B) {
	var x e_nocarry_0158
	x.SetRandom()
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0158)
	}
}

func BenchmarkE_nocarry_0158Exp(b *testing.B) {
	var x e_nocarry_0158
	x.SetRandom()
	benchRese_nocarry_0158.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0158Double(b *testing.B) {
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Double(&benchRese_nocarry_0158)
	}
}

func BenchmarkE_nocarry_0158Add(b *testing.B) {
	var x e_nocarry_0158
	x.SetRandom()
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Add(&x, &benchRese_nocarry_0158)
	}
}

func BenchmarkE_nocarry_0158Sub(b *testing.B) {
	var x e_nocarry_0158
	x.SetRandom()
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Sub(&x, &benchRese_nocarry_0158)
	}
}

func BenchmarkE_nocarry_0158Neg(b *testing.B) {
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Neg(&benchRese_nocarry_0158)
	}
}

func BenchmarkE_nocarry_0158Div(b *testing.B) {
	var x e_nocarry_0158
	x.SetRandom()
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Div(&x, &benchRese_nocarry_0158)
	}
}

func BenchmarkE_nocarry_0158FromMont(b *testing.B) {
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.FromMont()
	}
}

func BenchmarkE_nocarry_0158ToMont(b *testing.B) {
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.ToMont()
	}
}
func BenchmarkE_nocarry_0158Square(b *testing.B) {
	benchRese_nocarry_0158.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Square(&benchRese_nocarry_0158)
	}
}

func BenchmarkE_nocarry_0158Sqrt(b *testing.B) {
	var a e_nocarry_0158
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0158Mul(b *testing.B) {
	x := e_nocarry_0158{
		11359390039404926778,
		3416070245399880377,
		286405663,
	}
	benchRese_nocarry_0158.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Mul(&benchRese_nocarry_0158, &x)
	}
}

func BenchmarkE_nocarry_0158Cmp(b *testing.B) {
	x := e_nocarry_0158{
		11359390039404926778,
		3416070245399880377,
		286405663,
	}
	benchRese_nocarry_0158 = x
	benchRese_nocarry_0158[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0158.Cmp(&x)
	}
}

func TestE_nocarry_0158Cmp(t *testing.T) {
	var x, y e_nocarry_0158
...
func TestE_nocarry_0158IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0158
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0158

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0158{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0158
	one.SetOne()
	e.Sub(&qe_nocarry_0158, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0158{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0158{0, uint64(i)})
	}
...
func TestE_nocarry_0158NegZero(t *testing.T) {
	var a, b e_nocarry_0158
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0158Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0158, len(staticTestValues))
...
func TestE_nocarry_0158Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0158) bool {
			var b e_nocarry_0158
...
func TestE_nocarry_0158InverseExp(t *testing.T) {
...
func TestE_nocarry_0158MulByConstants(t *testing.T) {
...
func TestE_nocarry_0158Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0158) bool {
...
func TestE_nocarry_0158LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0158Halve(t *testing.T) {
...
func TestE_nocarry_0158FromMont(t *testing.T) {
...
type testPaire_nocarry_0158 struct {
	element e_nocarry_0158
	bigint  big.Int
}

func (z *e_nocarry_0158) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0158[2] {
		return true
	}
	if z[2] < qe_nocarry_0158[2] {
		return false
	...
	return z[0] >= qe_nocarry_0158[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0158

		g.element = e_nocarry_0158{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0158[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0158[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0158 {
			var g e_nocarry_0158
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0158[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0158[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0158[2], carry)
...
func Benchmarke_nocarry_0158InverseNew(b *testing.B) {
	var x e_nocarry_0158
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0158
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0158
		var xInv e_nocarry_0158
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0158
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0158
...
func testLinearComb(t *testing.T, x *e_nocarry_0158, xC int64, y *e_nocarry_0158, yC int64) {
	...
	var z e_nocarry_0158
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0158, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0158
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0158, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0158
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0158, xHi uint64) {
	var res e_nocarry_0158
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0158) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0158) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0158, c int64, result *e_nocarry_0158, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0158) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0158) uint64 {
