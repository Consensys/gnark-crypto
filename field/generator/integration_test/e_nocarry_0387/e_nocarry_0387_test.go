...
var benchRese_nocarry_0387 e_nocarry_0387

func BenchmarkE_nocarry_0387SetBytes(b *testing.B) {
	var x e_nocarry_0387
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0387MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0387.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0387)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0387)
		}
	})
}

func BenchmarkE_nocarry_0387Inverse(b *testing.B) {
	var x e_nocarry_0387
	x.SetRandom()
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0387Butterfly(b *testing.B) {
	var x e_nocarry_0387
	x.SetRandom()
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0387)
	}
}

func BenchmarkE_nocarry_0387Exp(b *testing.B) {
	var x e_nocarry_0387
	x.SetRandom()
	benchRese_nocarry_0387.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0387Double(b *testing.B) {
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Double(&benchRese_nocarry_0387)
	}
}

func BenchmarkE_nocarry_0387Add(b *testing.B) {
	var x e_nocarry_0387
	x.SetRandom()
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Add(&x, &benchRese_nocarry_0387)
	}
}

func BenchmarkE_nocarry_0387Sub(b *testing.B) {
	var x e_nocarry_0387
	x.SetRandom()
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Sub(&x, &benchRese_nocarry_0387)
	}
}

func BenchmarkE_nocarry_0387Neg(b *testing.B) {
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Neg(&benchRese_nocarry_0387)
	}
}

func BenchmarkE_nocarry_0387Div(b *testing.B) {
	var x e_nocarry_0387
	x.SetRandom()
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Div(&x, &benchRese_nocarry_0387)
	}
}

func BenchmarkE_nocarry_0387FromMont(b *testing.B) {
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.FromMont()
	}
}

func BenchmarkE_nocarry_0387ToMont(b *testing.B) {
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.ToMont()
	}
}
func BenchmarkE_nocarry_0387Square(b *testing.B) {
	benchRese_nocarry_0387.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Square(&benchRese_nocarry_0387)
	}
}

func BenchmarkE_nocarry_0387Sqrt(b *testing.B) {
	var a e_nocarry_0387
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0387Mul(b *testing.B) {
	x := e_nocarry_0387{
	...
	benchRese_nocarry_0387.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Mul(&benchRese_nocarry_0387, &x)
	}
}

func BenchmarkE_nocarry_0387Cmp(b *testing.B) {
	x := e_nocarry_0387{
		17510273441655931613,
		5410643115044409009,
		18228279050919605450,
	...
	benchRese_nocarry_0387 = x
	benchRese_nocarry_0387[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0387.Cmp(&x)
	}
}

func TestE_nocarry_0387Cmp(t *testing.T) {
	var x, y e_nocarry_0387
...
func TestE_nocarry_0387IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0387
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0387

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0387{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0387
	one.SetOne()
	e.Sub(&qe_nocarry_0387, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0387{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0387{0, uint64(i)})
	}
...
func TestE_nocarry_0387NegZero(t *testing.T) {
	var a, b e_nocarry_0387
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0387Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0387, len(staticTestValues))
...
func TestE_nocarry_0387Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0387) bool {
			var b e_nocarry_0387
...
func TestE_nocarry_0387InverseExp(t *testing.T) {
...
func TestE_nocarry_0387MulByConstants(t *testing.T) {
...
func TestE_nocarry_0387Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0387) bool {
...
func TestE_nocarry_0387LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0387Halve(t *testing.T) {
...
func TestE_nocarry_0387FromMont(t *testing.T) {
...
type testPaire_nocarry_0387 struct {
	element e_nocarry_0387
	bigint  big.Int
}

func (z *e_nocarry_0387) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0387[6] {
		return true
	}
	if z[6] < qe_nocarry_0387[6] {
		return false
	...
	return z[0] >= qe_nocarry_0387[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0387

		g.element = e_nocarry_0387{
		...
		if qe_nocarry_0387[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0387[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0387 {
			var g e_nocarry_0387
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0387[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0387[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0387[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0387[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0387[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0387[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0387[6], carry)
...
func Benchmarke_nocarry_0387InverseNew(b *testing.B) {
	var x e_nocarry_0387
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0387
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0387
		var xInv e_nocarry_0387
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0387
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0387
...
func testLinearComb(t *testing.T, x *e_nocarry_0387, xC int64, y *e_nocarry_0387, yC int64) {
	...
	var z e_nocarry_0387
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0387, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0387
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0387, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0387
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0387, xHi uint64) {
	var res e_nocarry_0387
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0387) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0387) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0387, c int64, result *e_nocarry_0387, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0387) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0387) uint64 {
