...
var benchRese_nocarry_0524 e_nocarry_0524

func BenchmarkE_nocarry_0524SetBytes(b *testing.B) {
	var x e_nocarry_0524
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0524MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0524.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0524)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0524)
		}
	})
}

func BenchmarkE_nocarry_0524Inverse(b *testing.B) {
	var x e_nocarry_0524
	x.SetRandom()
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0524Butterfly(b *testing.B) {
	var x e_nocarry_0524
	x.SetRandom()
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0524)
	}
}

func BenchmarkE_nocarry_0524Exp(b *testing.B) {
	var x e_nocarry_0524
	x.SetRandom()
	benchRese_nocarry_0524.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0524Double(b *testing.B) {
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Double(&benchRese_nocarry_0524)
	}
}

func BenchmarkE_nocarry_0524Add(b *testing.B) {
	var x e_nocarry_0524
	x.SetRandom()
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Add(&x, &benchRese_nocarry_0524)
	}
}

func BenchmarkE_nocarry_0524Sub(b *testing.B) {
	var x e_nocarry_0524
	x.SetRandom()
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Sub(&x, &benchRese_nocarry_0524)
	}
}

func BenchmarkE_nocarry_0524Neg(b *testing.B) {
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Neg(&benchRese_nocarry_0524)
	}
}

func BenchmarkE_nocarry_0524Div(b *testing.B) {
	var x e_nocarry_0524
	x.SetRandom()
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Div(&x, &benchRese_nocarry_0524)
	}
}

func BenchmarkE_nocarry_0524FromMont(b *testing.B) {
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.FromMont()
	}
}

func BenchmarkE_nocarry_0524ToMont(b *testing.B) {
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.ToMont()
	}
}
func BenchmarkE_nocarry_0524Square(b *testing.B) {
	benchRese_nocarry_0524.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Square(&benchRese_nocarry_0524)
	}
}

func BenchmarkE_nocarry_0524Sqrt(b *testing.B) {
	var a e_nocarry_0524
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0524Mul(b *testing.B) {
	x := e_nocarry_0524{
	...
	benchRese_nocarry_0524.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Mul(&benchRese_nocarry_0524, &x)
	}
}

func BenchmarkE_nocarry_0524Cmp(b *testing.B) {
	x := e_nocarry_0524{
		11551422899642142346,
		15038393132704990200,
		7535828561403165849,
	...
	benchRese_nocarry_0524 = x
	benchRese_nocarry_0524[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0524.Cmp(&x)
	}
}

func TestE_nocarry_0524Cmp(t *testing.T) {
	var x, y e_nocarry_0524
...
func TestE_nocarry_0524IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0524
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0524

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0524{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0524
	one.SetOne()
	e.Sub(&qe_nocarry_0524, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0524{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0524{0, uint64(i)})
	}
...
func TestE_nocarry_0524NegZero(t *testing.T) {
	var a, b e_nocarry_0524
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0524Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0524, len(staticTestValues))
...
func TestE_nocarry_0524Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0524) bool {
			var b e_nocarry_0524
...
func TestE_nocarry_0524InverseExp(t *testing.T) {
...
func TestE_nocarry_0524MulByConstants(t *testing.T) {
...
func TestE_nocarry_0524Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0524) bool {
...
func TestE_nocarry_0524LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0524Halve(t *testing.T) {
...
func TestE_nocarry_0524FromMont(t *testing.T) {
...
type testPaire_nocarry_0524 struct {
	element e_nocarry_0524
	bigint  big.Int
}

func (z *e_nocarry_0524) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0524[8] {
		return true
	}
	if z[8] < qe_nocarry_0524[8] {
		return false
	...
	return z[0] >= qe_nocarry_0524[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0524

		g.element = e_nocarry_0524{
		...
		if qe_nocarry_0524[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0524[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0524 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0524[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0524[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0524[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0524[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0524[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0524[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0524[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0524[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0524[8], carry)
...
func Benchmarke_nocarry_0524InverseNew(b *testing.B) {
	var x e_nocarry_0524
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0524
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0524
		var xInv e_nocarry_0524
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0524
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0524
...
func testLinearComb(t *testing.T, x *e_nocarry_0524, xC int64, y *e_nocarry_0524, yC int64) {
	...
	var z e_nocarry_0524
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0524, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0524
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0524, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0524
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0524, xHi uint64) {
	var res e_nocarry_0524
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0524) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0524) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0524, c int64, result *e_nocarry_0524, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0524) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0524) uint64 {
