...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x76e2064f80dfc999, R12
	ADDQ R12, AX
	MOVQ $0xc0284dc9165a5eb7, R12
	ADCQ R12, DX
	MOVQ $0xc86474ef1ea69862, R12
	ADCQ R12, CX
	MOVQ $0x4bcc1765f667be00, R12
	ADCQ R12, BX
	MOVQ $0x7653928bfd07a8c0, R12
	ADCQ R12, SI
	MOVQ $0x6d4cb2cfc244c530, R12
	ADCQ R12, DI
	MOVQ $0x851ca7727c1e3cb8, R12
	ADCQ R12, R8
	MOVQ $0x636df3d7a5254aaa, R12
	ADCQ R12, R9
	MOVQ $0x0000000000000edb, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x76e2064f80dfc999, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xc0284dc9165a5eb7, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xc86474ef1ea69862, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x4bcc1765f667be00, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x7653928bfd07a8c0, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x6d4cb2cfc244c530, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x851ca7727c1e3cb8, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x636df3d7a5254aaa, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000000000edb, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x76e2064f80dfc999, AX
	ADDQ AX, DX
	MOVQ $0xc0284dc9165a5eb7, AX
	ADCQ AX, CX
	MOVQ $0xc86474ef1ea69862, AX
	ADCQ AX, BX
	MOVQ $0x4bcc1765f667be00, AX
	ADCQ AX, SI
	MOVQ $0x7653928bfd07a8c0, AX
	ADCQ AX, DI
	MOVQ $0x6d4cb2cfc244c530, AX
	ADCQ AX, R8
	MOVQ $0x851ca7727c1e3cb8, AX
	ADCQ AX, R9
	MOVQ $0x636df3d7a5254aaa, AX
	ADCQ AX, R10
	MOVQ $0x0000000000000edb, AX
	ADCQ AX, R11
