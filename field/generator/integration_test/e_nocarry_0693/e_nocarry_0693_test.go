...
var benchRese_nocarry_0693 e_nocarry_0693

func BenchmarkE_nocarry_0693SetBytes(b *testing.B) {
	var x e_nocarry_0693
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0693MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0693.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0693)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0693)
		}
	})
}

func BenchmarkE_nocarry_0693Inverse(b *testing.B) {
	var x e_nocarry_0693
	x.SetRandom()
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0693Butterfly(b *testing.B) {
	var x e_nocarry_0693
	x.SetRandom()
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0693)
	}
}

func BenchmarkE_nocarry_0693Exp(b *testing.B) {
	var x e_nocarry_0693
	x.SetRandom()
	benchRese_nocarry_0693.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0693Double(b *testing.B) {
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Double(&benchRese_nocarry_0693)
	}
}

func BenchmarkE_nocarry_0693Add(b *testing.B) {
	var x e_nocarry_0693
	x.SetRandom()
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Add(&x, &benchRese_nocarry_0693)
	}
}

func BenchmarkE_nocarry_0693Sub(b *testing.B) {
	var x e_nocarry_0693
	x.SetRandom()
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Sub(&x, &benchRese_nocarry_0693)
	}
}

func BenchmarkE_nocarry_0693Neg(b *testing.B) {
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Neg(&benchRese_nocarry_0693)
	}
}

func BenchmarkE_nocarry_0693Div(b *testing.B) {
	var x e_nocarry_0693
	x.SetRandom()
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Div(&x, &benchRese_nocarry_0693)
	}
}

func BenchmarkE_nocarry_0693FromMont(b *testing.B) {
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.FromMont()
	}
}

func BenchmarkE_nocarry_0693ToMont(b *testing.B) {
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.ToMont()
	}
}
func BenchmarkE_nocarry_0693Square(b *testing.B) {
	benchRese_nocarry_0693.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Square(&benchRese_nocarry_0693)
	}
}

func BenchmarkE_nocarry_0693Sqrt(b *testing.B) {
	var a e_nocarry_0693
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0693Mul(b *testing.B) {
	x := e_nocarry_0693{
	...
	benchRese_nocarry_0693.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Mul(&benchRese_nocarry_0693, &x)
	}
}

func BenchmarkE_nocarry_0693Cmp(b *testing.B) {
	x := e_nocarry_0693{
		15622966300988001008,
		11149045649267349882,
		8219441944336283357,
	...
	benchRese_nocarry_0693 = x
	benchRese_nocarry_0693[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0693.Cmp(&x)
	}
}

func TestE_nocarry_0693Cmp(t *testing.T) {
	var x, y e_nocarry_0693
...
func TestE_nocarry_0693IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0693
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0693

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0693{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0693
	one.SetOne()
	e.Sub(&qe_nocarry_0693, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0693{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0693{0, uint64(i)})
	}
...
func TestE_nocarry_0693NegZero(t *testing.T) {
	var a, b e_nocarry_0693
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0693Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0693, len(staticTestValues))
...
func TestE_nocarry_0693Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0693) bool {
			var b e_nocarry_0693
...
func TestE_nocarry_0693InverseExp(t *testing.T) {
...
func TestE_nocarry_0693MulByConstants(t *testing.T) {
...
func TestE_nocarry_0693Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0693) bool {
...
func TestE_nocarry_0693LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0693Halve(t *testing.T) {
...
func TestE_nocarry_0693FromMont(t *testing.T) {
...
type testPaire_nocarry_0693 struct {
	element e_nocarry_0693
	bigint  big.Int
}

func (z *e_nocarry_0693) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0693[10] {
		return true
	}
	if z[10] < qe_nocarry_0693[10] {
		return false
	...
	return z[0] >= qe_nocarry_0693[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0693

		g.element = e_nocarry_0693{
		...
		if qe_nocarry_0693[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0693[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0693 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0693[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0693[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0693[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0693[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0693[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0693[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0693[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0693[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0693[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0693[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0693[10], carry)
...
func Benchmarke_nocarry_0693InverseNew(b *testing.B) {
	var x e_nocarry_0693
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0693
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0693
		var xInv e_nocarry_0693
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0693
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0693
...
func testLinearComb(t *testing.T, x *e_nocarry_0693, xC int64, y *e_nocarry_0693, yC int64) {
	...
	var z e_nocarry_0693
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0693, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0693
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0693, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0693
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0693, xHi uint64) {
	var res e_nocarry_0693
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0693) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0693) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0693, c int64, result *e_nocarry_0693, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0693) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0693) uint64 {
