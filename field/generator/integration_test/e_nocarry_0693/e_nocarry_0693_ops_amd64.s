...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xede12bea09243b51, R14
	ADDQ R14, AX
	MOVQ $0xcc035698eb949c6f, R14
	ADCQ R14, DX
	MOVQ $0x3b5757efdf972eec, R14
	ADCQ R14, CX
	MOVQ $0xf5f1fc6a645273e1, R14
	ADCQ R14, BX
	MOVQ $0x79ff416e59d0898f, R14
	ADCQ R14, SI
	MOVQ $0xe3ba9fbe0c5b1acc, R14
	ADCQ R14, DI
	MOVQ $0xbdfc777e24b7586a, R14
	ADCQ R14, R8
	MOVQ $0x4c67e8fb3fc1b25b, R14
	ADCQ R14, R9
	MOVQ $0xf008894414ea47b4, R14
	ADCQ R14, R10
	MOVQ $0xfa65e20eeb862f94, R14
	ADCQ R14, R11
	MOVQ $0x001f672e086978a6, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xede12bea09243b51, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xcc035698eb949c6f, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x3b5757efdf972eec, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xf5f1fc6a645273e1, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x79ff416e59d0898f, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xe3ba9fbe0c5b1acc, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xbdfc777e24b7586a, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x4c67e8fb3fc1b25b, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0xf008894414ea47b4, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xfa65e20eeb862f94, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x001f672e086978a6, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xede12bea09243b51, AX
	ADDQ AX, DX
	MOVQ $0xcc035698eb949c6f, AX
	ADCQ AX, CX
	MOVQ $0x3b5757efdf972eec, AX
	ADCQ AX, BX
	MOVQ $0xf5f1fc6a645273e1, AX
	ADCQ AX, SI
	MOVQ $0x79ff416e59d0898f, AX
	ADCQ AX, DI
	MOVQ $0xe3ba9fbe0c5b1acc, AX
	ADCQ AX, R8
	MOVQ $0xbdfc777e24b7586a, AX
	ADCQ AX, R9
	MOVQ $0x4c67e8fb3fc1b25b, AX
	ADCQ AX, R10
	MOVQ $0xf008894414ea47b4, AX
	ADCQ AX, R11
	MOVQ $0xfa65e20eeb862f94, AX
	ADCQ AX, R12
	MOVQ $0x001f672e086978a6, AX
	ADCQ AX, R13
