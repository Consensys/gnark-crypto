...
var benchRese_nocarry_0296 e_nocarry_0296

func BenchmarkE_nocarry_0296SetBytes(b *testing.B) {
	var x e_nocarry_0296
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0296MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0296.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0296)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0296)
		}
	})
}

func BenchmarkE_nocarry_0296Inverse(b *testing.B) {
	var x e_nocarry_0296
	x.SetRandom()
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0296Butterfly(b *testing.B) {
	var x e_nocarry_0296
	x.SetRandom()
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0296)
	}
}

func BenchmarkE_nocarry_0296Exp(b *testing.B) {
	var x e_nocarry_0296
	x.SetRandom()
	benchRese_nocarry_0296.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0296Double(b *testing.B) {
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Double(&benchRese_nocarry_0296)
	}
}

func BenchmarkE_nocarry_0296Add(b *testing.B) {
	var x e_nocarry_0296
	x.SetRandom()
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Add(&x, &benchRese_nocarry_0296)
	}
}

func BenchmarkE_nocarry_0296Sub(b *testing.B) {
	var x e_nocarry_0296
	x.SetRandom()
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Sub(&x, &benchRese_nocarry_0296)
	}
}

func BenchmarkE_nocarry_0296Neg(b *testing.B) {
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Neg(&benchRese_nocarry_0296)
	}
}

func BenchmarkE_nocarry_0296Div(b *testing.B) {
	var x e_nocarry_0296
	x.SetRandom()
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Div(&x, &benchRese_nocarry_0296)
	}
}

func BenchmarkE_nocarry_0296FromMont(b *testing.B) {
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.FromMont()
	}
}

func BenchmarkE_nocarry_0296ToMont(b *testing.B) {
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.ToMont()
	}
}
func BenchmarkE_nocarry_0296Square(b *testing.B) {
	benchRese_nocarry_0296.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Square(&benchRese_nocarry_0296)
	}
}

func BenchmarkE_nocarry_0296Sqrt(b *testing.B) {
	var a e_nocarry_0296
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0296Mul(b *testing.B) {
	x := e_nocarry_0296{
	...
	benchRese_nocarry_0296.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Mul(&benchRese_nocarry_0296, &x)
	}
}

func BenchmarkE_nocarry_0296Cmp(b *testing.B) {
	x := e_nocarry_0296{
		11622987399826282763,
		11232483668819117816,
		1696891705971192275,
	...
	benchRese_nocarry_0296 = x
	benchRese_nocarry_0296[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0296.Cmp(&x)
	}
}

func TestE_nocarry_0296Cmp(t *testing.T) {
	var x, y e_nocarry_0296
...
func TestE_nocarry_0296IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0296
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0296

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0296{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0296
	one.SetOne()
	e.Sub(&qe_nocarry_0296, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0296{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0296{0, uint64(i)})
	}
...
func TestE_nocarry_0296NegZero(t *testing.T) {
	var a, b e_nocarry_0296
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0296Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0296, len(staticTestValues))
...
func TestE_nocarry_0296Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0296) bool {
			var b e_nocarry_0296
...
func TestE_nocarry_0296InverseExp(t *testing.T) {
...
func TestE_nocarry_0296MulByConstants(t *testing.T) {
...
func TestE_nocarry_0296Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0296) bool {
...
func TestE_nocarry_0296LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0296Halve(t *testing.T) {
...
func TestE_nocarry_0296FromMont(t *testing.T) {
...
type testPaire_nocarry_0296 struct {
	element e_nocarry_0296
	bigint  big.Int
}

func (z *e_nocarry_0296) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0296[4] {
		return true
	}
	if z[4] < qe_nocarry_0296[4] {
		return false
	...
	return z[0] >= qe_nocarry_0296[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0296

		g.element = e_nocarry_0296{
		...
		if qe_nocarry_0296[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0296[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0296 {
			var g e_nocarry_0296
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0296[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0296[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0296[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0296[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0296[4], carry)
...
func Benchmarke_nocarry_0296InverseNew(b *testing.B) {
	var x e_nocarry_0296
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0296
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0296
		var xInv e_nocarry_0296
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0296
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0296
...
func testLinearComb(t *testing.T, x *e_nocarry_0296, xC int64, y *e_nocarry_0296, yC int64) {
	...
	var z e_nocarry_0296
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0296, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0296
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0296, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0296
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0296, xHi uint64) {
	var res e_nocarry_0296
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0296) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0296) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0296, c int64, result *e_nocarry_0296, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0296) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0296) uint64 {
