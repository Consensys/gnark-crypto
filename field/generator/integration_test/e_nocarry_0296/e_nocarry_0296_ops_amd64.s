...
// modulus q
DATA q<>+0(SB)/8, $0xc012ff712ddd7a43
DATA q<>+8(SB)/8, $0x521b268af59f2724
DATA q<>+16(SB)/8, $0xdf5d57e191063efc
DATA q<>+24(SB)/8, $0x2612148bae43277d
DATA q<>+32(SB)/8, $0x000000e6eda9b900
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x831642d01b84dd95
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xc012ff712ddd7a43, R9
	MOVQ    $0x521b268af59f2724, R10
	MOVQ    $0xdf5d57e191063efc, R11
	MOVQ    $0x2612148bae43277d, R12
	MOVQ    $0x000000e6eda9b900, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x521b268af59f2724, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xdf5d57e191063efc, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x2612148bae43277d, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000000e6eda9b900, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xc012ff712ddd7a43, CX
	MOVQ    $0x521b268af59f2724, BX
	MOVQ    $0xdf5d57e191063efc, SI
	MOVQ    $0x2612148bae43277d, DI
	MOVQ    $0x000000e6eda9b900, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
