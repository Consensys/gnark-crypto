...
// modulus q
DATA q<>+0(SB)/8, $0xfc0adbeea2b3d67d
DATA q<>+8(SB)/8, $0xa5bf7ae3749a1bd4
DATA q<>+16(SB)/8, $0x6ae22827b5f40b52
DATA q<>+24(SB)/8, $0x908276260edf812b
DATA q<>+32(SB)/8, $0x0000000000000006
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x26e83a966c232d2b
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xfc0adbeea2b3d67d, R9
	MOVQ    $0xa5bf7ae3749a1bd4, R10
	MOVQ    $0x6ae22827b5f40b52, R11
	MOVQ    $0x908276260edf812b, R12
	MOVQ    $0x0000000000000006, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xa5bf7ae3749a1bd4, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x6ae22827b5f40b52, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x908276260edf812b, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xfc0adbeea2b3d67d, CX
	MOVQ    $0xa5bf7ae3749a1bd4, BX
	MOVQ    $0x6ae22827b5f40b52, SI
	MOVQ    $0x908276260edf812b, DI
	MOVQ    $0x0000000000000006, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
