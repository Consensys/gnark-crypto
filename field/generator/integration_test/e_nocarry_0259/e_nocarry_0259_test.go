...
var benchRese_nocarry_0259 e_nocarry_0259

func BenchmarkE_nocarry_0259SetBytes(b *testing.B) {
	var x e_nocarry_0259
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0259MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0259.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0259)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0259)
		}
	})
}

func BenchmarkE_nocarry_0259Inverse(b *testing.B) {
	var x e_nocarry_0259
	x.SetRandom()
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0259Butterfly(b *testing.B) {
	var x e_nocarry_0259
	x.SetRandom()
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0259)
	}
}

func BenchmarkE_nocarry_0259Exp(b *testing.B) {
	var x e_nocarry_0259
	x.SetRandom()
	benchRese_nocarry_0259.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0259Double(b *testing.B) {
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Double(&benchRese_nocarry_0259)
	}
}

func BenchmarkE_nocarry_0259Add(b *testing.B) {
	var x e_nocarry_0259
	x.SetRandom()
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Add(&x, &benchRese_nocarry_0259)
	}
}

func BenchmarkE_nocarry_0259Sub(b *testing.B) {
	var x e_nocarry_0259
	x.SetRandom()
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Sub(&x, &benchRese_nocarry_0259)
	}
}

func BenchmarkE_nocarry_0259Neg(b *testing.B) {
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Neg(&benchRese_nocarry_0259)
	}
}

func BenchmarkE_nocarry_0259Div(b *testing.B) {
	var x e_nocarry_0259
	x.SetRandom()
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Div(&x, &benchRese_nocarry_0259)
	}
}

func BenchmarkE_nocarry_0259FromMont(b *testing.B) {
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.FromMont()
	}
}

func BenchmarkE_nocarry_0259ToMont(b *testing.B) {
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.ToMont()
	}
}
func BenchmarkE_nocarry_0259Square(b *testing.B) {
	benchRese_nocarry_0259.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Square(&benchRese_nocarry_0259)
	}
}

func BenchmarkE_nocarry_0259Sqrt(b *testing.B) {
	var a e_nocarry_0259
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0259Mul(b *testing.B) {
	x := e_nocarry_0259{
	...
	benchRese_nocarry_0259.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Mul(&benchRese_nocarry_0259, &x)
	}
}

func BenchmarkE_nocarry_0259Cmp(b *testing.B) {
	x := e_nocarry_0259{
		14299002688362694465,
		1026527667164781279,
		14103768923809208248,
	...
	benchRese_nocarry_0259 = x
	benchRese_nocarry_0259[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0259.Cmp(&x)
	}
}

func TestE_nocarry_0259Cmp(t *testing.T) {
	var x, y e_nocarry_0259
...
func TestE_nocarry_0259IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0259
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0259

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0259{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0259
	one.SetOne()
	e.Sub(&qe_nocarry_0259, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0259{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0259{0, uint64(i)})
	}
...
func TestE_nocarry_0259NegZero(t *testing.T) {
	var a, b e_nocarry_0259
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0259Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0259, len(staticTestValues))
...
func TestE_nocarry_0259Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0259) bool {
			var b e_nocarry_0259
...
func TestE_nocarry_0259InverseExp(t *testing.T) {
...
func TestE_nocarry_0259MulByConstants(t *testing.T) {
...
func TestE_nocarry_0259Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0259) bool {
...
func TestE_nocarry_0259LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0259Halve(t *testing.T) {
...
func TestE_nocarry_0259FromMont(t *testing.T) {
...
type testPaire_nocarry_0259 struct {
	element e_nocarry_0259
	bigint  big.Int
}

func (z *e_nocarry_0259) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0259[4] {
		return true
	}
	if z[4] < qe_nocarry_0259[4] {
		return false
	...
	return z[0] >= qe_nocarry_0259[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0259

		g.element = e_nocarry_0259{
		...
		if qe_nocarry_0259[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0259[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0259 {
			var g e_nocarry_0259
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0259[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0259[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0259[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0259[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0259[4], carry)
...
func Benchmarke_nocarry_0259InverseNew(b *testing.B) {
	var x e_nocarry_0259
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0259
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0259
		var xInv e_nocarry_0259
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0259
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0259
...
func testLinearComb(t *testing.T, x *e_nocarry_0259, xC int64, y *e_nocarry_0259, yC int64) {
	...
	var z e_nocarry_0259
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0259, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0259
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0259, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0259
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0259, xHi uint64) {
	var res e_nocarry_0259
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0259) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0259) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0259, c int64, result *e_nocarry_0259, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0259) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0259) uint64 {
