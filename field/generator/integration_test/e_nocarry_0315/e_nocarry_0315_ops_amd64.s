...
// modulus q
DATA q<>+0(SB)/8, $0x925d5805a8d79a89
DATA q<>+8(SB)/8, $0x1b542837df155341
DATA q<>+16(SB)/8, $0xa1dae7dfb596cb5a
DATA q<>+24(SB)/8, $0x5ef861f9809e287e
DATA q<>+32(SB)/8, $0x070669d37d5692f4
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x8aabc445c4fa0447
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x925d5805a8d79a89, R9
	MOVQ    $0x1b542837df155341, R10
	MOVQ    $0xa1dae7dfb596cb5a, R11
	MOVQ    $0x5ef861f9809e287e, R12
	MOVQ    $0x070669d37d5692f4, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x1b542837df155341, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xa1dae7dfb596cb5a, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x5ef861f9809e287e, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x070669d37d5692f4, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x925d5805a8d79a89, CX
	MOVQ    $0x1b542837df155341, BX
	MOVQ    $0xa1dae7dfb596cb5a, SI
	MOVQ    $0x5ef861f9809e287e, DI
	MOVQ    $0x070669d37d5692f4, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
