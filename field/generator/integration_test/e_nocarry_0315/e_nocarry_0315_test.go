...
var benchRese_nocarry_0315 e_nocarry_0315

func BenchmarkE_nocarry_0315SetBytes(b *testing.B) {
	var x e_nocarry_0315
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0315MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0315.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0315)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0315)
		}
	})
}

func BenchmarkE_nocarry_0315Inverse(b *testing.B) {
	var x e_nocarry_0315
	x.SetRandom()
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0315Butterfly(b *testing.B) {
	var x e_nocarry_0315
	x.SetRandom()
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0315)
	}
}

func BenchmarkE_nocarry_0315Exp(b *testing.B) {
	var x e_nocarry_0315
	x.SetRandom()
	benchRese_nocarry_0315.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0315Double(b *testing.B) {
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Double(&benchRese_nocarry_0315)
	}
}

func BenchmarkE_nocarry_0315Add(b *testing.B) {
	var x e_nocarry_0315
	x.SetRandom()
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Add(&x, &benchRese_nocarry_0315)
	}
}

func BenchmarkE_nocarry_0315Sub(b *testing.B) {
	var x e_nocarry_0315
	x.SetRandom()
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Sub(&x, &benchRese_nocarry_0315)
	}
}

func BenchmarkE_nocarry_0315Neg(b *testing.B) {
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Neg(&benchRese_nocarry_0315)
	}
}

func BenchmarkE_nocarry_0315Div(b *testing.B) {
	var x e_nocarry_0315
	x.SetRandom()
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Div(&x, &benchRese_nocarry_0315)
	}
}

func BenchmarkE_nocarry_0315FromMont(b *testing.B) {
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.FromMont()
	}
}

func BenchmarkE_nocarry_0315ToMont(b *testing.B) {
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.ToMont()
	}
}
func BenchmarkE_nocarry_0315Square(b *testing.B) {
	benchRese_nocarry_0315.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Square(&benchRese_nocarry_0315)
	}
}

func BenchmarkE_nocarry_0315Sqrt(b *testing.B) {
	var a e_nocarry_0315
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0315Mul(b *testing.B) {
	x := e_nocarry_0315{
	...
	benchRese_nocarry_0315.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Mul(&benchRese_nocarry_0315, &x)
	}
}

func BenchmarkE_nocarry_0315Cmp(b *testing.B) {
	x := e_nocarry_0315{
		10736424732277478869,
		12139068684560618154,
		17710181636499127920,
	...
	benchRese_nocarry_0315 = x
	benchRese_nocarry_0315[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0315.Cmp(&x)
	}
}

func TestE_nocarry_0315Cmp(t *testing.T) {
	var x, y e_nocarry_0315
...
func TestE_nocarry_0315IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0315
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0315

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0315{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0315
	one.SetOne()
	e.Sub(&qe_nocarry_0315, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0315{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0315{0, uint64(i)})
	}
...
func TestE_nocarry_0315NegZero(t *testing.T) {
	var a, b e_nocarry_0315
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0315Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0315, len(staticTestValues))
...
func TestE_nocarry_0315Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0315) bool {
			var b e_nocarry_0315
...
func TestE_nocarry_0315InverseExp(t *testing.T) {
...
func TestE_nocarry_0315MulByConstants(t *testing.T) {
...
func TestE_nocarry_0315Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0315) bool {
...
func TestE_nocarry_0315LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0315Halve(t *testing.T) {
...
func TestE_nocarry_0315FromMont(t *testing.T) {
...
type testPaire_nocarry_0315 struct {
	element e_nocarry_0315
	bigint  big.Int
}

func (z *e_nocarry_0315) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0315[4] {
		return true
	}
	if z[4] < qe_nocarry_0315[4] {
		return false
	...
	return z[0] >= qe_nocarry_0315[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0315

		g.element = e_nocarry_0315{
		...
		if qe_nocarry_0315[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0315[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0315 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0315[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0315[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0315[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0315[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0315[4], carry)
...
func Benchmarke_nocarry_0315InverseNew(b *testing.B) {
	var x e_nocarry_0315
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0315
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0315
		var xInv e_nocarry_0315
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0315
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0315
...
func testLinearComb(t *testing.T, x *e_nocarry_0315, xC int64, y *e_nocarry_0315, yC int64) {
	...
	var z e_nocarry_0315
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0315, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0315
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0315, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0315
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0315, xHi uint64) {
	var res e_nocarry_0315
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0315) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0315) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0315, c int64, result *e_nocarry_0315, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0315) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0315) uint64 {
