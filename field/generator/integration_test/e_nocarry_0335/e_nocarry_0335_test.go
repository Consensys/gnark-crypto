...
var benchRese_nocarry_0335 e_nocarry_0335

func BenchmarkE_nocarry_0335SetBytes(b *testing.B) {
	var x e_nocarry_0335
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0335MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0335.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0335)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0335)
		}
	})
}

func BenchmarkE_nocarry_0335Inverse(b *testing.B) {
	var x e_nocarry_0335
	x.SetRandom()
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0335Butterfly(b *testing.B) {
	var x e_nocarry_0335
	x.SetRandom()
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0335)
	}
}

func BenchmarkE_nocarry_0335Exp(b *testing.B) {
	var x e_nocarry_0335
	x.SetRandom()
	benchRese_nocarry_0335.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0335Double(b *testing.B) {
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Double(&benchRese_nocarry_0335)
	}
}

func BenchmarkE_nocarry_0335Add(b *testing.B) {
	var x e_nocarry_0335
	x.SetRandom()
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Add(&x, &benchRese_nocarry_0335)
	}
}

func BenchmarkE_nocarry_0335Sub(b *testing.B) {
	var x e_nocarry_0335
	x.SetRandom()
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Sub(&x, &benchRese_nocarry_0335)
	}
}

func BenchmarkE_nocarry_0335Neg(b *testing.B) {
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Neg(&benchRese_nocarry_0335)
	}
}

func BenchmarkE_nocarry_0335Div(b *testing.B) {
	var x e_nocarry_0335
	x.SetRandom()
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Div(&x, &benchRese_nocarry_0335)
	}
}

func BenchmarkE_nocarry_0335FromMont(b *testing.B) {
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.FromMont()
	}
}

func BenchmarkE_nocarry_0335ToMont(b *testing.B) {
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.ToMont()
	}
}
func BenchmarkE_nocarry_0335Square(b *testing.B) {
	benchRese_nocarry_0335.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Square(&benchRese_nocarry_0335)
	}
}

func BenchmarkE_nocarry_0335Sqrt(b *testing.B) {
	var a e_nocarry_0335
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0335Mul(b *testing.B) {
	x := e_nocarry_0335{
		9220104415357710471,
		4999429418764029133,
		8471538222796085887,
	...
	benchRese_nocarry_0335.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Mul(&benchRese_nocarry_0335, &x)
	}
}

func BenchmarkE_nocarry_0335Cmp(b *testing.B) {
	x := e_nocarry_0335{
		9220104415357710471,
		4999429418764029133,
		8471538222796085887,
	...
	benchRese_nocarry_0335 = x
	benchRese_nocarry_0335[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0335.Cmp(&x)
	}
}

func TestE_nocarry_0335Cmp(t *testing.T) {
	var x, y e_nocarry_0335
...
func TestE_nocarry_0335IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0335
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0335

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0335{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0335
	one.SetOne()
	e.Sub(&qe_nocarry_0335, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0335{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0335{0, uint64(i)})
	}
...
func TestE_nocarry_0335NegZero(t *testing.T) {
	var a, b e_nocarry_0335
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0335Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0335, len(staticTestValues))
...
func TestE_nocarry_0335Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0335) bool {
			var b e_nocarry_0335
...
func TestE_nocarry_0335InverseExp(t *testing.T) {
...
func TestE_nocarry_0335MulByConstants(t *testing.T) {
...
func TestE_nocarry_0335Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0335) bool {
...
func TestE_nocarry_0335LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0335Halve(t *testing.T) {
...
func TestE_nocarry_0335FromMont(t *testing.T) {
...
type testPaire_nocarry_0335 struct {
	element e_nocarry_0335
	bigint  big.Int
}

func (z *e_nocarry_0335) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0335[5] {
		return true
	}
	if z[5] < qe_nocarry_0335[5] {
		return false
	...
	return z[0] >= qe_nocarry_0335[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0335

		g.element = e_nocarry_0335{
		...
		if qe_nocarry_0335[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0335[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0335 {
			var g e_nocarry_0335
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0335[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0335[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0335[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0335[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0335[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0335[5], carry)
...
func Benchmarke_nocarry_0335InverseNew(b *testing.B) {
	var x e_nocarry_0335
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0335
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0335
		var xInv e_nocarry_0335
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0335
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0335
...
func testLinearComb(t *testing.T, x *e_nocarry_0335, xC int64, y *e_nocarry_0335, yC int64) {
	...
	var z e_nocarry_0335
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0335, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0335
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0335, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0335
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0335, xHi uint64) {
	var res e_nocarry_0335
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0335) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0335) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0335, c int64, result *e_nocarry_0335, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0335) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0335) uint64 {
