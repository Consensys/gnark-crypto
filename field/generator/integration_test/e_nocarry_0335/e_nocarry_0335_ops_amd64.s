...
// modulus q
DATA q<>+0(SB)/8, $0xbc853ed6db5387fd
DATA q<>+8(SB)/8, $0xbb403df8228d0f69
DATA q<>+16(SB)/8, $0xd09fdf237a5c0b93
DATA q<>+24(SB)/8, $0xb6f82320cbe3c579
DATA q<>+32(SB)/8, $0xa906c04d3bce9959
DATA q<>+40(SB)/8, $0x0000000000006da8
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x79c4e70fda73f2ab
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xbc853ed6db5387fd, R10
	MOVQ    $0xbb403df8228d0f69, R11
	MOVQ    $0xd09fdf237a5c0b93, R12
	MOVQ    $0xb6f82320cbe3c579, R13
	MOVQ    $0xa906c04d3bce9959, R14
	MOVQ    $0x0000000000006da8, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xbb403df8228d0f69, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xd09fdf237a5c0b93, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xb6f82320cbe3c579, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xa906c04d3bce9959, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000000000006da8, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xbc853ed6db5387fd, CX
	MOVQ    $0xbb403df8228d0f69, BX
	MOVQ    $0xd09fdf237a5c0b93, SI
	MOVQ    $0xb6f82320cbe3c579, DI
	MOVQ    $0xa906c04d3bce9959, R8
	MOVQ    $0x0000000000006da8, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
