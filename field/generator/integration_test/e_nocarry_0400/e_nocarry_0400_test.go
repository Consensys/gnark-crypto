...
var benchRese_nocarry_0400 e_nocarry_0400

func BenchmarkE_nocarry_0400SetBytes(b *testing.B) {
	var x e_nocarry_0400
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0400MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0400.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0400)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0400)
		}
	})
}

func BenchmarkE_nocarry_0400Inverse(b *testing.B) {
	var x e_nocarry_0400
	x.SetRandom()
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0400Butterfly(b *testing.B) {
	var x e_nocarry_0400
	x.SetRandom()
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0400)
	}
}

func BenchmarkE_nocarry_0400Exp(b *testing.B) {
	var x e_nocarry_0400
	x.SetRandom()
	benchRese_nocarry_0400.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0400Double(b *testing.B) {
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Double(&benchRese_nocarry_0400)
	}
}

func BenchmarkE_nocarry_0400Add(b *testing.B) {
	var x e_nocarry_0400
	x.SetRandom()
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Add(&x, &benchRese_nocarry_0400)
	}
}

func BenchmarkE_nocarry_0400Sub(b *testing.B) {
	var x e_nocarry_0400
	x.SetRandom()
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Sub(&x, &benchRese_nocarry_0400)
	}
}

func BenchmarkE_nocarry_0400Neg(b *testing.B) {
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Neg(&benchRese_nocarry_0400)
	}
}

func BenchmarkE_nocarry_0400Div(b *testing.B) {
	var x e_nocarry_0400
	x.SetRandom()
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Div(&x, &benchRese_nocarry_0400)
	}
}

func BenchmarkE_nocarry_0400FromMont(b *testing.B) {
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.FromMont()
	}
}

func BenchmarkE_nocarry_0400ToMont(b *testing.B) {
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.ToMont()
	}
}
func BenchmarkE_nocarry_0400Square(b *testing.B) {
	benchRese_nocarry_0400.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Square(&benchRese_nocarry_0400)
	}
}

func BenchmarkE_nocarry_0400Sqrt(b *testing.B) {
	var a e_nocarry_0400
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0400Mul(b *testing.B) {
	x := e_nocarry_0400{
	...
	benchRese_nocarry_0400.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Mul(&benchRese_nocarry_0400, &x)
	}
}

func BenchmarkE_nocarry_0400Cmp(b *testing.B) {
	x := e_nocarry_0400{
		13023886075094975426,
		554848444905049192,
		11010272312538904193,
	...
	benchRese_nocarry_0400 = x
	benchRese_nocarry_0400[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0400.Cmp(&x)
	}
}

func TestE_nocarry_0400Cmp(t *testing.T) {
	var x, y e_nocarry_0400
...
func TestE_nocarry_0400IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0400
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0400

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0400{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0400
	one.SetOne()
	e.Sub(&qe_nocarry_0400, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0400{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0400{0, uint64(i)})
	}
...
func TestE_nocarry_0400NegZero(t *testing.T) {
	var a, b e_nocarry_0400
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0400Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0400, len(staticTestValues))
...
func TestE_nocarry_0400Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0400) bool {
			var b e_nocarry_0400
...
func TestE_nocarry_0400InverseExp(t *testing.T) {
...
func TestE_nocarry_0400MulByConstants(t *testing.T) {
...
func TestE_nocarry_0400Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0400) bool {
...
func TestE_nocarry_0400LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0400Halve(t *testing.T) {
...
func TestE_nocarry_0400FromMont(t *testing.T) {
...
type testPaire_nocarry_0400 struct {
	element e_nocarry_0400
	bigint  big.Int
}

func (z *e_nocarry_0400) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0400[6] {
		return true
	}
	if z[6] < qe_nocarry_0400[6] {
		return false
	...
	return z[0] >= qe_nocarry_0400[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0400

		g.element = e_nocarry_0400{
		...
		if qe_nocarry_0400[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0400[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0400 {
			var g e_nocarry_0400
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0400[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0400[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0400[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0400[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0400[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0400[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0400[6], carry)
...
func Benchmarke_nocarry_0400InverseNew(b *testing.B) {
	var x e_nocarry_0400
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0400
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0400
		var xInv e_nocarry_0400
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0400
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0400
...
func testLinearComb(t *testing.T, x *e_nocarry_0400, xC int64, y *e_nocarry_0400, yC int64) {
	...
	var z e_nocarry_0400
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0400, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0400
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0400, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0400
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0400, xHi uint64) {
	var res e_nocarry_0400
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0400) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0400) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0400, c int64, result *e_nocarry_0400, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0400) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0400) uint64 {
