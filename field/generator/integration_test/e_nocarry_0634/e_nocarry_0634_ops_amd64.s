...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x2b98b45b9c93a2cf, R13
	ADDQ R13, AX
	MOVQ $0x35a1fd5ad531921e, R13
	ADCQ R13, DX
	MOVQ $0xc0621bcf057f82d8, R13
	ADCQ R13, CX
	MOVQ $0x199a9a291ebc0147, R13
	ADCQ R13, BX
	MOVQ $0xb53e2416ceccd63b, R13
	ADCQ R13, SI
	MOVQ $0xa3ea4746ef7236c9, R13
	ADCQ R13, DI
	MOVQ $0xc26a0d0491cababa, R13
	ADCQ R13, R8
	MOVQ $0xd61825e44e042685, R13
	ADCQ R13, R9
	MOVQ $0x54530aa4920f5ec4, R13
	ADCQ R13, R10
	MOVQ $0x037de9006c71d6f4, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x2b98b45b9c93a2cf, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x35a1fd5ad531921e, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xc0621bcf057f82d8, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x199a9a291ebc0147, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xb53e2416ceccd63b, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xa3ea4746ef7236c9, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xc26a0d0491cababa, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xd61825e44e042685, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x54530aa4920f5ec4, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x037de9006c71d6f4, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x2b98b45b9c93a2cf, AX
	ADDQ AX, DX
	MOVQ $0x35a1fd5ad531921e, AX
	ADCQ AX, CX
	MOVQ $0xc0621bcf057f82d8, AX
	ADCQ AX, BX
	MOVQ $0x199a9a291ebc0147, AX
	ADCQ AX, SI
	MOVQ $0xb53e2416ceccd63b, AX
	ADCQ AX, DI
	MOVQ $0xa3ea4746ef7236c9, AX
	ADCQ AX, R8
	MOVQ $0xc26a0d0491cababa, AX
	ADCQ AX, R9
	MOVQ $0xd61825e44e042685, AX
	ADCQ AX, R10
	MOVQ $0x54530aa4920f5ec4, AX
	ADCQ AX, R11
	MOVQ $0x037de9006c71d6f4, AX
	ADCQ AX, R12
