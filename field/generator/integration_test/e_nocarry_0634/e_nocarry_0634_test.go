...
var benchRese_nocarry_0634 e_nocarry_0634

func BenchmarkE_nocarry_0634SetBytes(b *testing.B) {
	var x e_nocarry_0634
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0634MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0634.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0634)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0634)
		}
	})
}

func BenchmarkE_nocarry_0634Inverse(b *testing.B) {
	var x e_nocarry_0634
	x.SetRandom()
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0634Butterfly(b *testing.B) {
	var x e_nocarry_0634
	x.SetRandom()
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0634)
	}
}

func BenchmarkE_nocarry_0634Exp(b *testing.B) {
	var x e_nocarry_0634
	x.SetRandom()
	benchRese_nocarry_0634.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0634Double(b *testing.B) {
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Double(&benchRese_nocarry_0634)
	}
}

func BenchmarkE_nocarry_0634Add(b *testing.B) {
	var x e_nocarry_0634
	x.SetRandom()
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Add(&x, &benchRese_nocarry_0634)
	}
}

func BenchmarkE_nocarry_0634Sub(b *testing.B) {
	var x e_nocarry_0634
	x.SetRandom()
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Sub(&x, &benchRese_nocarry_0634)
	}
}

func BenchmarkE_nocarry_0634Neg(b *testing.B) {
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Neg(&benchRese_nocarry_0634)
	}
}

func BenchmarkE_nocarry_0634Div(b *testing.B) {
	var x e_nocarry_0634
	x.SetRandom()
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Div(&x, &benchRese_nocarry_0634)
	}
}

func BenchmarkE_nocarry_0634FromMont(b *testing.B) {
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.FromMont()
	}
}

func BenchmarkE_nocarry_0634ToMont(b *testing.B) {
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.ToMont()
	}
}
func BenchmarkE_nocarry_0634Square(b *testing.B) {
	benchRese_nocarry_0634.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Square(&benchRese_nocarry_0634)
	}
}

func BenchmarkE_nocarry_0634Sqrt(b *testing.B) {
	var a e_nocarry_0634
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0634Mul(b *testing.B) {
	x := e_nocarry_0634{
	...
	benchRese_nocarry_0634.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Mul(&benchRese_nocarry_0634, &x)
	}
}

func BenchmarkE_nocarry_0634Cmp(b *testing.B) {
	x := e_nocarry_0634{
		13475258360905759419,
		2654352146616370038,
		11592053216008066351,
	...
	benchRese_nocarry_0634 = x
	benchRese_nocarry_0634[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0634.Cmp(&x)
	}
}

func TestE_nocarry_0634Cmp(t *testing.T) {
	var x, y e_nocarry_0634
...
func TestE_nocarry_0634IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0634
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0634

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0634{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0634
	one.SetOne()
	e.Sub(&qe_nocarry_0634, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0634{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0634{0, uint64(i)})
	}
...
func TestE_nocarry_0634NegZero(t *testing.T) {
	var a, b e_nocarry_0634
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0634Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0634, len(staticTestValues))
...
func TestE_nocarry_0634Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0634) bool {
			var b e_nocarry_0634
...
func TestE_nocarry_0634InverseExp(t *testing.T) {
...
func TestE_nocarry_0634MulByConstants(t *testing.T) {
...
func TestE_nocarry_0634Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0634) bool {
...
func TestE_nocarry_0634LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0634Halve(t *testing.T) {
...
func TestE_nocarry_0634FromMont(t *testing.T) {
...
type testPaire_nocarry_0634 struct {
	element e_nocarry_0634
	bigint  big.Int
}

func (z *e_nocarry_0634) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0634[9] {
		return true
	}
	if z[9] < qe_nocarry_0634[9] {
		return false
	...
	return z[0] >= qe_nocarry_0634[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0634

		g.element = e_nocarry_0634{
		...
		if qe_nocarry_0634[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0634[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0634 {
			var g e_nocarry_0634
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0634[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0634[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0634[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0634[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0634[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0634[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0634[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0634[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0634[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0634[9], carry)
...
func Benchmarke_nocarry_0634InverseNew(b *testing.B) {
	var x e_nocarry_0634
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0634
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0634
		var xInv e_nocarry_0634
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0634
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0634
...
func testLinearComb(t *testing.T, x *e_nocarry_0634, xC int64, y *e_nocarry_0634, yC int64) {
	...
	var z e_nocarry_0634
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0634, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0634
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0634, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0634
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0634, xHi uint64) {
	var res e_nocarry_0634
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0634) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0634) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0634, c int64, result *e_nocarry_0634, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0634) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0634) uint64 {
