...
// modulus q
DATA q<>+0(SB)/8, $0xf828b6e3c28fc52b
DATA q<>+8(SB)/8, $0x725ae76086f74e3c
DATA q<>+16(SB)/8, $0x44f8b6d28f8a3455
DATA q<>+24(SB)/8, $0x0000000000001cea
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x8606a8873d9d2e7d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xf828b6e3c28fc52b, R8
	MOVQ    $0x725ae76086f74e3c, R9
	MOVQ    $0x44f8b6d28f8a3455, R10
	MOVQ    $0x0000000000001cea, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x725ae76086f74e3c, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x44f8b6d28f8a3455, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x0000000000001cea, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xf828b6e3c28fc52b, R12
	MOVQ    $0x725ae76086f74e3c, R13
	MOVQ    $0x44f8b6d28f8a3455, R14
	MOVQ    $0x0000000000001cea, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
