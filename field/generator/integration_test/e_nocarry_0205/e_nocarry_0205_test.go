...
var benchRese_nocarry_0205 e_nocarry_0205

func BenchmarkE_nocarry_0205SetBytes(b *testing.B) {
	var x e_nocarry_0205
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0205MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0205.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0205)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0205)
		}
	})
}

func BenchmarkE_nocarry_0205Inverse(b *testing.B) {
	var x e_nocarry_0205
	x.SetRandom()
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0205Butterfly(b *testing.B) {
	var x e_nocarry_0205
	x.SetRandom()
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0205)
	}
}

func BenchmarkE_nocarry_0205Exp(b *testing.B) {
	var x e_nocarry_0205
	x.SetRandom()
	benchRese_nocarry_0205.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0205Double(b *testing.B) {
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Double(&benchRese_nocarry_0205)
	}
}

func BenchmarkE_nocarry_0205Add(b *testing.B) {
	var x e_nocarry_0205
	x.SetRandom()
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Add(&x, &benchRese_nocarry_0205)
	}
}

func BenchmarkE_nocarry_0205Sub(b *testing.B) {
	var x e_nocarry_0205
	x.SetRandom()
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Sub(&x, &benchRese_nocarry_0205)
	}
}

func BenchmarkE_nocarry_0205Neg(b *testing.B) {
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Neg(&benchRese_nocarry_0205)
	}
}

func BenchmarkE_nocarry_0205Div(b *testing.B) {
	var x e_nocarry_0205
	x.SetRandom()
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Div(&x, &benchRese_nocarry_0205)
	}
}

func BenchmarkE_nocarry_0205FromMont(b *testing.B) {
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.FromMont()
	}
}

func BenchmarkE_nocarry_0205ToMont(b *testing.B) {
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.ToMont()
	}
}
func BenchmarkE_nocarry_0205Square(b *testing.B) {
	benchRese_nocarry_0205.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Square(&benchRese_nocarry_0205)
	}
}

func BenchmarkE_nocarry_0205Sqrt(b *testing.B) {
	var a e_nocarry_0205
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0205Mul(b *testing.B) {
	x := e_nocarry_0205{
		5863592877230907292,
		2860688529238790041,
	...
	benchRese_nocarry_0205.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Mul(&benchRese_nocarry_0205, &x)
	}
}

func BenchmarkE_nocarry_0205Cmp(b *testing.B) {
	x := e_nocarry_0205{
		5863592877230907292,
		2860688529238790041,
		16954751653369084242,
	...
	benchRese_nocarry_0205 = x
	benchRese_nocarry_0205[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0205.Cmp(&x)
	}
}

func TestE_nocarry_0205Cmp(t *testing.T) {
	var x, y e_nocarry_0205
...
func TestE_nocarry_0205IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0205
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0205

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0205{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0205
	one.SetOne()
	e.Sub(&qe_nocarry_0205, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0205{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0205{0, uint64(i)})
	}
...
func TestE_nocarry_0205NegZero(t *testing.T) {
	var a, b e_nocarry_0205
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0205Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0205, len(staticTestValues))
...
func TestE_nocarry_0205Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0205) bool {
			var b e_nocarry_0205
...
func TestE_nocarry_0205InverseExp(t *testing.T) {
...
func TestE_nocarry_0205MulByConstants(t *testing.T) {
...
func TestE_nocarry_0205Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0205) bool {
...
func TestE_nocarry_0205LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0205Halve(t *testing.T) {
...
func TestE_nocarry_0205FromMont(t *testing.T) {
...
type testPaire_nocarry_0205 struct {
	element e_nocarry_0205
	bigint  big.Int
}

func (z *e_nocarry_0205) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0205[3] {
		return true
	}
	if z[3] < qe_nocarry_0205[3] {
		return false
	...
	return z[0] >= qe_nocarry_0205[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0205

		g.element = e_nocarry_0205{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0205[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0205[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0205 {
			var g e_nocarry_0205
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0205[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0205[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0205[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0205[3], carry)
...
func Benchmarke_nocarry_0205InverseNew(b *testing.B) {
	var x e_nocarry_0205
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0205
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0205
		var xInv e_nocarry_0205
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0205
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0205
...
func testLinearComb(t *testing.T, x *e_nocarry_0205, xC int64, y *e_nocarry_0205, yC int64) {
	...
	var z e_nocarry_0205
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0205, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0205
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0205, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0205
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0205, xHi uint64) {
	var res e_nocarry_0205
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0205) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0205) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0205, c int64, result *e_nocarry_0205, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0205) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0205) uint64 {
