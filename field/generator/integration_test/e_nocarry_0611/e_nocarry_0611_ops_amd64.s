...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xc3de7b09067914b5, R13
	ADDQ R13, AX
	MOVQ $0xfa167cda74f70527, R13
	ADCQ R13, DX
	MOVQ $0xc98ecfb6fe14b1eb, R13
	ADCQ R13, CX
	MOVQ $0xb02cdad1e26d368d, R13
	ADCQ R13, BX
	MOVQ $0x4ecb9c22fe478116, R13
	ADCQ R13, SI
	MOVQ $0x751215c31234a761, R13
	ADCQ R13, DI
	MOVQ $0x26b1858694d17da4, R13
	ADCQ R13, R8
	MOVQ $0x62e984dd5d0deca6, R13
	ADCQ R13, R9
	MOVQ $0x3fa1c045f70b569d, R13
	ADCQ R13, R10
	MOVQ $0x00000007e294ca86, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xc3de7b09067914b5, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xfa167cda74f70527, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xc98ecfb6fe14b1eb, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xb02cdad1e26d368d, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x4ecb9c22fe478116, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x751215c31234a761, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x26b1858694d17da4, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x62e984dd5d0deca6, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x3fa1c045f70b569d, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000007e294ca86, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xc3de7b09067914b5, AX
	ADDQ AX, DX
	MOVQ $0xfa167cda74f70527, AX
	ADCQ AX, CX
	MOVQ $0xc98ecfb6fe14b1eb, AX
	ADCQ AX, BX
	MOVQ $0xb02cdad1e26d368d, AX
	ADCQ AX, SI
	MOVQ $0x4ecb9c22fe478116, AX
	ADCQ AX, DI
	MOVQ $0x751215c31234a761, AX
	ADCQ AX, R8
	MOVQ $0x26b1858694d17da4, AX
	ADCQ AX, R9
	MOVQ $0x62e984dd5d0deca6, AX
	ADCQ AX, R10
	MOVQ $0x3fa1c045f70b569d, AX
	ADCQ AX, R11
	MOVQ $0x00000007e294ca86, AX
	ADCQ AX, R12
