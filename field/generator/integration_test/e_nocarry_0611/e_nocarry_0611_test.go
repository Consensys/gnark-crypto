...
var benchRese_nocarry_0611 e_nocarry_0611

func BenchmarkE_nocarry_0611SetBytes(b *testing.B) {
	var x e_nocarry_0611
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0611MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0611.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0611)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0611)
		}
	})
}

func BenchmarkE_nocarry_0611Inverse(b *testing.B) {
	var x e_nocarry_0611
	x.SetRandom()
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0611Butterfly(b *testing.B) {
	var x e_nocarry_0611
	x.SetRandom()
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0611)
	}
}

func BenchmarkE_nocarry_0611Exp(b *testing.B) {
	var x e_nocarry_0611
	x.SetRandom()
	benchRese_nocarry_0611.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0611Double(b *testing.B) {
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Double(&benchRese_nocarry_0611)
	}
}

func BenchmarkE_nocarry_0611Add(b *testing.B) {
	var x e_nocarry_0611
	x.SetRandom()
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Add(&x, &benchRese_nocarry_0611)
	}
}

func BenchmarkE_nocarry_0611Sub(b *testing.B) {
	var x e_nocarry_0611
	x.SetRandom()
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Sub(&x, &benchRese_nocarry_0611)
	}
}

func BenchmarkE_nocarry_0611Neg(b *testing.B) {
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Neg(&benchRese_nocarry_0611)
	}
}

func BenchmarkE_nocarry_0611Div(b *testing.B) {
	var x e_nocarry_0611
	x.SetRandom()
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Div(&x, &benchRese_nocarry_0611)
	}
}

func BenchmarkE_nocarry_0611FromMont(b *testing.B) {
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.FromMont()
	}
}

func BenchmarkE_nocarry_0611ToMont(b *testing.B) {
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.ToMont()
	}
}
func BenchmarkE_nocarry_0611Square(b *testing.B) {
	benchRese_nocarry_0611.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Square(&benchRese_nocarry_0611)
	}
}

func BenchmarkE_nocarry_0611Sqrt(b *testing.B) {
	var a e_nocarry_0611
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0611Mul(b *testing.B) {
	x := e_nocarry_0611{
		6367471286068831612,
	...
	benchRese_nocarry_0611.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Mul(&benchRese_nocarry_0611, &x)
	}
}

func BenchmarkE_nocarry_0611Cmp(b *testing.B) {
	x := e_nocarry_0611{
		6367471286068831612,
		14108338213042859699,
		13703817731515466962,
	...
	benchRese_nocarry_0611 = x
	benchRese_nocarry_0611[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0611.Cmp(&x)
	}
}

func TestE_nocarry_0611Cmp(t *testing.T) {
	var x, y e_nocarry_0611
...
func TestE_nocarry_0611IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0611
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0611

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0611{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0611
	one.SetOne()
	e.Sub(&qe_nocarry_0611, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0611{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0611{0, uint64(i)})
	}
...
func TestE_nocarry_0611NegZero(t *testing.T) {
	var a, b e_nocarry_0611
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0611Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0611, len(staticTestValues))
...
func TestE_nocarry_0611Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0611) bool {
			var b e_nocarry_0611
...
func TestE_nocarry_0611InverseExp(t *testing.T) {
...
func TestE_nocarry_0611MulByConstants(t *testing.T) {
...
func TestE_nocarry_0611Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0611) bool {
...
func TestE_nocarry_0611LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0611Halve(t *testing.T) {
...
func TestE_nocarry_0611FromMont(t *testing.T) {
...
type testPaire_nocarry_0611 struct {
	element e_nocarry_0611
	bigint  big.Int
}

func (z *e_nocarry_0611) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0611[9] {
		return true
	}
	if z[9] < qe_nocarry_0611[9] {
		return false
	...
	return z[0] >= qe_nocarry_0611[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0611

		g.element = e_nocarry_0611{
		...
		if qe_nocarry_0611[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0611[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0611 {
			var g e_nocarry_0611
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0611[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0611[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0611[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0611[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0611[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0611[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0611[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0611[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0611[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0611[9], carry)
...
func Benchmarke_nocarry_0611InverseNew(b *testing.B) {
	var x e_nocarry_0611
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0611
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0611
		var xInv e_nocarry_0611
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0611
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0611
...
func testLinearComb(t *testing.T, x *e_nocarry_0611, xC int64, y *e_nocarry_0611, yC int64) {
	...
	var z e_nocarry_0611
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0611, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0611
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0611, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0611
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0611, xHi uint64) {
	var res e_nocarry_0611
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0611) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0611) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0611, c int64, result *e_nocarry_0611, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0611) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0611) uint64 {
