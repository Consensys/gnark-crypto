...
var benchRese_nocarry_0288 e_nocarry_0288

func BenchmarkE_nocarry_0288SetBytes(b *testing.B) {
	var x e_nocarry_0288
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0288MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0288.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0288)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0288)
		}
	})
}

func BenchmarkE_nocarry_0288Inverse(b *testing.B) {
	var x e_nocarry_0288
	x.SetRandom()
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0288Butterfly(b *testing.B) {
	var x e_nocarry_0288
	x.SetRandom()
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0288)
	}
}

func BenchmarkE_nocarry_0288Exp(b *testing.B) {
	var x e_nocarry_0288
	x.SetRandom()
	benchRese_nocarry_0288.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0288Double(b *testing.B) {
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Double(&benchRese_nocarry_0288)
	}
}

func BenchmarkE_nocarry_0288Add(b *testing.B) {
	var x e_nocarry_0288
	x.SetRandom()
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Add(&x, &benchRese_nocarry_0288)
	}
}

func BenchmarkE_nocarry_0288Sub(b *testing.B) {
	var x e_nocarry_0288
	x.SetRandom()
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Sub(&x, &benchRese_nocarry_0288)
	}
}

func BenchmarkE_nocarry_0288Neg(b *testing.B) {
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Neg(&benchRese_nocarry_0288)
	}
}

func BenchmarkE_nocarry_0288Div(b *testing.B) {
	var x e_nocarry_0288
	x.SetRandom()
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Div(&x, &benchRese_nocarry_0288)
	}
}

func BenchmarkE_nocarry_0288FromMont(b *testing.B) {
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.FromMont()
	}
}

func BenchmarkE_nocarry_0288ToMont(b *testing.B) {
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.ToMont()
	}
}
func BenchmarkE_nocarry_0288Square(b *testing.B) {
	benchRese_nocarry_0288.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Square(&benchRese_nocarry_0288)
	}
}

func BenchmarkE_nocarry_0288Sqrt(b *testing.B) {
	var a e_nocarry_0288
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0288Mul(b *testing.B) {
	x := e_nocarry_0288{
		5432511408611423939,
		4686911994682998180,
		216717269419448469,
	...
	benchRese_nocarry_0288.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Mul(&benchRese_nocarry_0288, &x)
	}
}

func BenchmarkE_nocarry_0288Cmp(b *testing.B) {
	x := e_nocarry_0288{
		5432511408611423939,
		4686911994682998180,
		216717269419448469,
	...
	benchRese_nocarry_0288 = x
	benchRese_nocarry_0288[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0288.Cmp(&x)
	}
}

func TestE_nocarry_0288Cmp(t *testing.T) {
	var x, y e_nocarry_0288
...
func TestE_nocarry_0288IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0288
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0288

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0288{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0288
	one.SetOne()
	e.Sub(&qe_nocarry_0288, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0288{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0288{0, uint64(i)})
	}
...
func TestE_nocarry_0288NegZero(t *testing.T) {
	var a, b e_nocarry_0288
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0288Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0288, len(staticTestValues))
...
func TestE_nocarry_0288Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0288) bool {
			var b e_nocarry_0288
...
func TestE_nocarry_0288InverseExp(t *testing.T) {
...
func TestE_nocarry_0288MulByConstants(t *testing.T) {
...
func TestE_nocarry_0288Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0288) bool {
...
func TestE_nocarry_0288LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0288Halve(t *testing.T) {
...
func TestE_nocarry_0288FromMont(t *testing.T) {
...
type testPaire_nocarry_0288 struct {
	element e_nocarry_0288
	bigint  big.Int
}

func (z *e_nocarry_0288) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0288[4] {
		return true
	}
	if z[4] < qe_nocarry_0288[4] {
		return false
	...
	return z[0] >= qe_nocarry_0288[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0288

		g.element = e_nocarry_0288{
		...
		if qe_nocarry_0288[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0288[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0288 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0288[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0288[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0288[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0288[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0288[4], carry)
...
func Benchmarke_nocarry_0288InverseNew(b *testing.B) {
	var x e_nocarry_0288
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0288
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0288
		var xInv e_nocarry_0288
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0288
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0288
...
func testLinearComb(t *testing.T, x *e_nocarry_0288, xC int64, y *e_nocarry_0288, yC int64) {
	...
	var z e_nocarry_0288
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0288, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0288
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0288, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0288
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0288, xHi uint64) {
	var res e_nocarry_0288
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0288) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0288) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0288, c int64, result *e_nocarry_0288, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0288) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0288) uint64 {
