...
// modulus q
DATA q<>+0(SB)/8, $0x99afaa9a93252099
DATA q<>+8(SB)/8, $0x53e4f97214d0cf2a
DATA q<>+16(SB)/8, $0x82b457b91612faf4
DATA q<>+24(SB)/8, $0xb696b4668020227a
DATA q<>+32(SB)/8, $0x00000000ca9b75a0
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xad7d060fa4a8cc57
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x99afaa9a93252099, R9
	MOVQ    $0x53e4f97214d0cf2a, R10
	MOVQ    $0x82b457b91612faf4, R11
	MOVQ    $0xb696b4668020227a, R12
	MOVQ    $0x00000000ca9b75a0, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x53e4f97214d0cf2a, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x82b457b91612faf4, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xb696b4668020227a, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00000000ca9b75a0, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x99afaa9a93252099, CX
	MOVQ    $0x53e4f97214d0cf2a, BX
	MOVQ    $0x82b457b91612faf4, SI
	MOVQ    $0xb696b4668020227a, DI
	MOVQ    $0x00000000ca9b75a0, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
