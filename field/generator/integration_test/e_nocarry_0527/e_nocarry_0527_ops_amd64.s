...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xf143a3025cfbcfff, R12
	ADDQ R12, AX
	MOVQ $0x1a1238e4b7571809, R12
	ADCQ R12, DX
	MOVQ $0xf9aff6c3632e5309, R12
	ADCQ R12, CX
	MOVQ $0xce594f42e8bf663a, R12
	ADCQ R12, BX
	MOVQ $0x99a0c7fa86942b81, R12
	ADCQ R12, SI
	MOVQ $0xa92bf02a8394a06e, R12
	ADCQ R12, DI
	MOVQ $0xdce07ff73b427ad1, R12
	ADCQ R12, R8
	MOVQ $0x929e324e974e8d17, R12
	ADCQ R12, R9
	MOVQ $0x0000000000006682, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf143a3025cfbcfff, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x1a1238e4b7571809, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xf9aff6c3632e5309, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xce594f42e8bf663a, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x99a0c7fa86942b81, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xa92bf02a8394a06e, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xdce07ff73b427ad1, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x929e324e974e8d17, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x0000000000006682, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xf143a3025cfbcfff, AX
	ADDQ AX, DX
	MOVQ $0x1a1238e4b7571809, AX
	ADCQ AX, CX
	MOVQ $0xf9aff6c3632e5309, AX
	ADCQ AX, BX
	MOVQ $0xce594f42e8bf663a, AX
	ADCQ AX, SI
	MOVQ $0x99a0c7fa86942b81, AX
	ADCQ AX, DI
	MOVQ $0xa92bf02a8394a06e, AX
	ADCQ AX, R8
	MOVQ $0xdce07ff73b427ad1, AX
	ADCQ AX, R9
	MOVQ $0x929e324e974e8d17, AX
	ADCQ AX, R10
	MOVQ $0x0000000000006682, AX
	ADCQ AX, R11
