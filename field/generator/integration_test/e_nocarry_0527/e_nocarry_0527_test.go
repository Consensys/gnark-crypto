...
var benchRese_nocarry_0527 e_nocarry_0527

func BenchmarkE_nocarry_0527SetBytes(b *testing.B) {
	var x e_nocarry_0527
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0527MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0527.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0527)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0527)
		}
	})
}

func BenchmarkE_nocarry_0527Inverse(b *testing.B) {
	var x e_nocarry_0527
	x.SetRandom()
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0527Butterfly(b *testing.B) {
	var x e_nocarry_0527
	x.SetRandom()
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0527)
	}
}

func BenchmarkE_nocarry_0527Exp(b *testing.B) {
	var x e_nocarry_0527
	x.SetRandom()
	benchRese_nocarry_0527.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0527Double(b *testing.B) {
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Double(&benchRese_nocarry_0527)
	}
}

func BenchmarkE_nocarry_0527Add(b *testing.B) {
	var x e_nocarry_0527
	x.SetRandom()
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Add(&x, &benchRese_nocarry_0527)
	}
}

func BenchmarkE_nocarry_0527Sub(b *testing.B) {
	var x e_nocarry_0527
	x.SetRandom()
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Sub(&x, &benchRese_nocarry_0527)
	}
}

func BenchmarkE_nocarry_0527Neg(b *testing.B) {
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Neg(&benchRese_nocarry_0527)
	}
}

func BenchmarkE_nocarry_0527Div(b *testing.B) {
	var x e_nocarry_0527
	x.SetRandom()
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Div(&x, &benchRese_nocarry_0527)
	}
}

func BenchmarkE_nocarry_0527FromMont(b *testing.B) {
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.FromMont()
	}
}

func BenchmarkE_nocarry_0527ToMont(b *testing.B) {
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.ToMont()
	}
}
func BenchmarkE_nocarry_0527Square(b *testing.B) {
	benchRese_nocarry_0527.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Square(&benchRese_nocarry_0527)
	}
}

func BenchmarkE_nocarry_0527Sqrt(b *testing.B) {
	var a e_nocarry_0527
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0527Mul(b *testing.B) {
	x := e_nocarry_0527{
		3388575889906904465,
	...
	benchRese_nocarry_0527.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Mul(&benchRese_nocarry_0527, &x)
	}
}

func BenchmarkE_nocarry_0527Cmp(b *testing.B) {
	x := e_nocarry_0527{
		3388575889906904465,
		13038937600122382221,
		2142042999701714242,
	...
	benchRese_nocarry_0527 = x
	benchRese_nocarry_0527[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0527.Cmp(&x)
	}
}

func TestE_nocarry_0527Cmp(t *testing.T) {
	var x, y e_nocarry_0527
...
func TestE_nocarry_0527IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0527
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0527

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0527{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0527
	one.SetOne()
	e.Sub(&qe_nocarry_0527, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0527{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0527{0, uint64(i)})
	}
...
func TestE_nocarry_0527NegZero(t *testing.T) {
	var a, b e_nocarry_0527
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0527Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0527, len(staticTestValues))
...
func TestE_nocarry_0527Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0527) bool {
			var b e_nocarry_0527
...
func TestE_nocarry_0527InverseExp(t *testing.T) {
...
func TestE_nocarry_0527MulByConstants(t *testing.T) {
...
func TestE_nocarry_0527Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0527) bool {
...
func TestE_nocarry_0527LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0527Halve(t *testing.T) {
...
func TestE_nocarry_0527FromMont(t *testing.T) {
...
type testPaire_nocarry_0527 struct {
	element e_nocarry_0527
	bigint  big.Int
}

func (z *e_nocarry_0527) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0527[8] {
		return true
	}
	if z[8] < qe_nocarry_0527[8] {
		return false
	...
	return z[0] >= qe_nocarry_0527[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0527

		g.element = e_nocarry_0527{
		...
		if qe_nocarry_0527[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0527[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0527 {
			var g e_nocarry_0527
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0527[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0527[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0527[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0527[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0527[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0527[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0527[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0527[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0527[8], carry)
...
func Benchmarke_nocarry_0527InverseNew(b *testing.B) {
	var x e_nocarry_0527
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0527
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0527
		var xInv e_nocarry_0527
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0527
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0527
...
func testLinearComb(t *testing.T, x *e_nocarry_0527, xC int64, y *e_nocarry_0527, yC int64) {
	...
	var z e_nocarry_0527
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0527, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0527
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0527, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0527
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0527, xHi uint64) {
	var res e_nocarry_0527
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0527) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0527) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0527, c int64, result *e_nocarry_0527, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0527) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0527) uint64 {
