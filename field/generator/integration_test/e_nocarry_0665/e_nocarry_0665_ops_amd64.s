...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x44b786a536a7940f, R14
	ADDQ R14, AX
	MOVQ $0x7d96a8d48f955bbe, R14
	ADCQ R14, DX
	MOVQ $0x7d05367a85df9362, R14
	ADCQ R14, CX
	MOVQ $0x68fa1ede0a47d1e5, R14
	ADCQ R14, BX
	MOVQ $0xd2c88f6e631561b1, R14
	ADCQ R14, SI
	MOVQ $0xacad49de5fc73916, R14
	ADCQ R14, DI
	MOVQ $0xb737d361e31cf8f4, R14
	ADCQ R14, R8
	MOVQ $0xf484a8c8b1ef6f4f, R14
	ADCQ R14, R9
	MOVQ $0x1bd015cd5f8d2523, R14
	ADCQ R14, R10
	MOVQ $0x19fd62cde6e6e2a7, R14
	ADCQ R14, R11
	MOVQ $0x0000000001f7fa90, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x44b786a536a7940f, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x7d96a8d48f955bbe, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x7d05367a85df9362, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x68fa1ede0a47d1e5, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xd2c88f6e631561b1, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xacad49de5fc73916, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xb737d361e31cf8f4, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xf484a8c8b1ef6f4f, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x1bd015cd5f8d2523, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x19fd62cde6e6e2a7, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000001f7fa90, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x44b786a536a7940f, AX
	ADDQ AX, DX
	MOVQ $0x7d96a8d48f955bbe, AX
	ADCQ AX, CX
	MOVQ $0x7d05367a85df9362, AX
	ADCQ AX, BX
	MOVQ $0x68fa1ede0a47d1e5, AX
	ADCQ AX, SI
	MOVQ $0xd2c88f6e631561b1, AX
	ADCQ AX, DI
	MOVQ $0xacad49de5fc73916, AX
	ADCQ AX, R8
	MOVQ $0xb737d361e31cf8f4, AX
	ADCQ AX, R9
	MOVQ $0xf484a8c8b1ef6f4f, AX
	ADCQ AX, R10
	MOVQ $0x1bd015cd5f8d2523, AX
	ADCQ AX, R11
	MOVQ $0x19fd62cde6e6e2a7, AX
	ADCQ AX, R12
	MOVQ $0x0000000001f7fa90, AX
	ADCQ AX, R13
