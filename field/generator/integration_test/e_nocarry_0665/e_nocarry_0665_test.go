...
var benchRese_nocarry_0665 e_nocarry_0665

func BenchmarkE_nocarry_0665SetBytes(b *testing.B) {
	var x e_nocarry_0665
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0665MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0665.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0665)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0665)
		}
	})
}

func BenchmarkE_nocarry_0665Inverse(b *testing.B) {
	var x e_nocarry_0665
	x.SetRandom()
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0665Butterfly(b *testing.B) {
	var x e_nocarry_0665
	x.SetRandom()
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0665)
	}
}

func BenchmarkE_nocarry_0665Exp(b *testing.B) {
	var x e_nocarry_0665
	x.SetRandom()
	benchRese_nocarry_0665.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0665Double(b *testing.B) {
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Double(&benchRese_nocarry_0665)
	}
}

func BenchmarkE_nocarry_0665Add(b *testing.B) {
	var x e_nocarry_0665
	x.SetRandom()
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Add(&x, &benchRese_nocarry_0665)
	}
}

func BenchmarkE_nocarry_0665Sub(b *testing.B) {
	var x e_nocarry_0665
	x.SetRandom()
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Sub(&x, &benchRese_nocarry_0665)
	}
}

func BenchmarkE_nocarry_0665Neg(b *testing.B) {
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Neg(&benchRese_nocarry_0665)
	}
}

func BenchmarkE_nocarry_0665Div(b *testing.B) {
	var x e_nocarry_0665
	x.SetRandom()
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Div(&x, &benchRese_nocarry_0665)
	}
}

func BenchmarkE_nocarry_0665FromMont(b *testing.B) {
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.FromMont()
	}
}

func BenchmarkE_nocarry_0665ToMont(b *testing.B) {
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.ToMont()
	}
}
func BenchmarkE_nocarry_0665Square(b *testing.B) {
	benchRese_nocarry_0665.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Square(&benchRese_nocarry_0665)
	}
}

func BenchmarkE_nocarry_0665Sqrt(b *testing.B) {
	var a e_nocarry_0665
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0665Mul(b *testing.B) {
	x := e_nocarry_0665{
	...
	benchRese_nocarry_0665.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Mul(&benchRese_nocarry_0665, &x)
	}
}

func BenchmarkE_nocarry_0665Cmp(b *testing.B) {
	x := e_nocarry_0665{
		11847043684409759660,
		17803458801196065340,
		3516672607469144990,
	...
	benchRese_nocarry_0665 = x
	benchRese_nocarry_0665[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0665.Cmp(&x)
	}
}

func TestE_nocarry_0665Cmp(t *testing.T) {
	var x, y e_nocarry_0665
...
func TestE_nocarry_0665IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0665
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0665

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0665{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0665
	one.SetOne()
	e.Sub(&qe_nocarry_0665, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0665{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0665{0, uint64(i)})
	}
...
func TestE_nocarry_0665NegZero(t *testing.T) {
	var a, b e_nocarry_0665
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0665Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0665, len(staticTestValues))
...
func TestE_nocarry_0665Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0665) bool {
			var b e_nocarry_0665
...
func TestE_nocarry_0665InverseExp(t *testing.T) {
...
func TestE_nocarry_0665MulByConstants(t *testing.T) {
...
func TestE_nocarry_0665Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0665) bool {
...
func TestE_nocarry_0665LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0665Halve(t *testing.T) {
...
func TestE_nocarry_0665FromMont(t *testing.T) {
...
type testPaire_nocarry_0665 struct {
	element e_nocarry_0665
	bigint  big.Int
}

func (z *e_nocarry_0665) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0665[10] {
		return true
	}
	if z[10] < qe_nocarry_0665[10] {
		return false
	...
	return z[0] >= qe_nocarry_0665[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0665

		g.element = e_nocarry_0665{
		...
		if qe_nocarry_0665[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0665[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0665 {
			var g e_nocarry_0665
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0665[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0665[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0665[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0665[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0665[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0665[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0665[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0665[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0665[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0665[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0665[10], carry)
...
func Benchmarke_nocarry_0665InverseNew(b *testing.B) {
	var x e_nocarry_0665
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0665
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0665
		var xInv e_nocarry_0665
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0665
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0665
...
func testLinearComb(t *testing.T, x *e_nocarry_0665, xC int64, y *e_nocarry_0665, yC int64) {
	...
	var z e_nocarry_0665
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0665, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0665
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0665, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0665
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0665, xHi uint64) {
	var res e_nocarry_0665
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0665) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0665) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0665, c int64, result *e_nocarry_0665, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0665) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0665) uint64 {
