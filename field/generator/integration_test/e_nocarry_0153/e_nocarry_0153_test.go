...
var benchRese_nocarry_0153 e_nocarry_0153

func BenchmarkE_nocarry_0153SetBytes(b *testing.B) {
	var x e_nocarry_0153
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0153MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0153.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0153)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0153)
		}
	})
}

func BenchmarkE_nocarry_0153Inverse(b *testing.B) {
	var x e_nocarry_0153
	x.SetRandom()
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0153Butterfly(b *testing.B) {
	var x e_nocarry_0153
	x.SetRandom()
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0153)
	}
}

func BenchmarkE_nocarry_0153Exp(b *testing.B) {
	var x e_nocarry_0153
	x.SetRandom()
	benchRese_nocarry_0153.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0153Double(b *testing.B) {
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Double(&benchRese_nocarry_0153)
	}
}

func BenchmarkE_nocarry_0153Add(b *testing.B) {
	var x e_nocarry_0153
	x.SetRandom()
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Add(&x, &benchRese_nocarry_0153)
	}
}

func BenchmarkE_nocarry_0153Sub(b *testing.B) {
	var x e_nocarry_0153
	x.SetRandom()
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Sub(&x, &benchRese_nocarry_0153)
	}
}

func BenchmarkE_nocarry_0153Neg(b *testing.B) {
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Neg(&benchRese_nocarry_0153)
	}
}

func BenchmarkE_nocarry_0153Div(b *testing.B) {
	var x e_nocarry_0153
	x.SetRandom()
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Div(&x, &benchRese_nocarry_0153)
	}
}

func BenchmarkE_nocarry_0153FromMont(b *testing.B) {
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.FromMont()
	}
}

func BenchmarkE_nocarry_0153ToMont(b *testing.B) {
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.ToMont()
	}
}
func BenchmarkE_nocarry_0153Square(b *testing.B) {
	benchRese_nocarry_0153.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Square(&benchRese_nocarry_0153)
	}
}

func BenchmarkE_nocarry_0153Sqrt(b *testing.B) {
	var a e_nocarry_0153
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0153Mul(b *testing.B) {
	x := e_nocarry_0153{
		11750638485903625046,
		4111674197268423223,
		17838462,
	}
	benchRese_nocarry_0153.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Mul(&benchRese_nocarry_0153, &x)
	}
}

func BenchmarkE_nocarry_0153Cmp(b *testing.B) {
	x := e_nocarry_0153{
		11750638485903625046,
		4111674197268423223,
		17838462,
	}
	benchRese_nocarry_0153 = x
	benchRese_nocarry_0153[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0153.Cmp(&x)
	}
}

func TestE_nocarry_0153Cmp(t *testing.T) {
	var x, y e_nocarry_0153
...
func TestE_nocarry_0153IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0153
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0153

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0153{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0153
	one.SetOne()
	e.Sub(&qe_nocarry_0153, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0153{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0153{0, uint64(i)})
	}
...
func TestE_nocarry_0153NegZero(t *testing.T) {
	var a, b e_nocarry_0153
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0153Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0153, len(staticTestValues))
...
func TestE_nocarry_0153Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0153) bool {
			var b e_nocarry_0153
...
func TestE_nocarry_0153InverseExp(t *testing.T) {
...
func TestE_nocarry_0153MulByConstants(t *testing.T) {
...
func TestE_nocarry_0153Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0153) bool {
...
func TestE_nocarry_0153LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0153Halve(t *testing.T) {
...
func TestE_nocarry_0153FromMont(t *testing.T) {
...
type testPaire_nocarry_0153 struct {
	element e_nocarry_0153
	bigint  big.Int
}

func (z *e_nocarry_0153) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0153[2] {
		return true
	}
	if z[2] < qe_nocarry_0153[2] {
		return false
	...
	return z[0] >= qe_nocarry_0153[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0153

		g.element = e_nocarry_0153{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0153[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0153[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0153 {
			var g e_nocarry_0153
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0153[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0153[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0153[2], carry)
...
func Benchmarke_nocarry_0153InverseNew(b *testing.B) {
	var x e_nocarry_0153
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0153
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0153
		var xInv e_nocarry_0153
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0153
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0153
...
func testLinearComb(t *testing.T, x *e_nocarry_0153, xC int64, y *e_nocarry_0153, yC int64) {
	...
	var z e_nocarry_0153
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0153, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0153
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0153, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0153
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0153, xHi uint64) {
	var res e_nocarry_0153
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0153) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0153) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0153, c int64, result *e_nocarry_0153, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0153) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0153) uint64 {
