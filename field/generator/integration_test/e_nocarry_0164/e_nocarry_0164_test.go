...
var benchRese_nocarry_0164 e_nocarry_0164

func BenchmarkE_nocarry_0164SetBytes(b *testing.B) {
	var x e_nocarry_0164
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0164MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0164.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0164)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0164)
		}
	})
}

func BenchmarkE_nocarry_0164Inverse(b *testing.B) {
	var x e_nocarry_0164
	x.SetRandom()
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0164Butterfly(b *testing.B) {
	var x e_nocarry_0164
	x.SetRandom()
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0164)
	}
}

func BenchmarkE_nocarry_0164Exp(b *testing.B) {
	var x e_nocarry_0164
	x.SetRandom()
	benchRese_nocarry_0164.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0164Double(b *testing.B) {
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Double(&benchRese_nocarry_0164)
	}
}

func BenchmarkE_nocarry_0164Add(b *testing.B) {
	var x e_nocarry_0164
	x.SetRandom()
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Add(&x, &benchRese_nocarry_0164)
	}
}

func BenchmarkE_nocarry_0164Sub(b *testing.B) {
	var x e_nocarry_0164
	x.SetRandom()
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Sub(&x, &benchRese_nocarry_0164)
	}
}

func BenchmarkE_nocarry_0164Neg(b *testing.B) {
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Neg(&benchRese_nocarry_0164)
	}
}

func BenchmarkE_nocarry_0164Div(b *testing.B) {
	var x e_nocarry_0164
	x.SetRandom()
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Div(&x, &benchRese_nocarry_0164)
	}
}

func BenchmarkE_nocarry_0164FromMont(b *testing.B) {
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.FromMont()
	}
}

func BenchmarkE_nocarry_0164ToMont(b *testing.B) {
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.ToMont()
	}
}
func BenchmarkE_nocarry_0164Square(b *testing.B) {
	benchRese_nocarry_0164.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Square(&benchRese_nocarry_0164)
	}
}

func BenchmarkE_nocarry_0164Sqrt(b *testing.B) {
	var a e_nocarry_0164
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0164Mul(b *testing.B) {
	x := e_nocarry_0164{
		13938459692164858073,
		6806767712713749577,
		33064802682,
	}
	benchRese_nocarry_0164.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Mul(&benchRese_nocarry_0164, &x)
	}
}

func BenchmarkE_nocarry_0164Cmp(b *testing.B) {
	x := e_nocarry_0164{
		13938459692164858073,
		6806767712713749577,
		33064802682,
	}
	benchRese_nocarry_0164 = x
	benchRese_nocarry_0164[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0164.Cmp(&x)
	}
}

func TestE_nocarry_0164Cmp(t *testing.T) {
	var x, y e_nocarry_0164
...
func TestE_nocarry_0164IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0164
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0164

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0164{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0164
	one.SetOne()
	e.Sub(&qe_nocarry_0164, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0164{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0164{0, uint64(i)})
	}
...
func TestE_nocarry_0164NegZero(t *testing.T) {
	var a, b e_nocarry_0164
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0164Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0164, len(staticTestValues))
...
func TestE_nocarry_0164Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0164) bool {
			var b e_nocarry_0164
...
func TestE_nocarry_0164InverseExp(t *testing.T) {
...
func TestE_nocarry_0164MulByConstants(t *testing.T) {
...
func TestE_nocarry_0164Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0164) bool {
...
func TestE_nocarry_0164LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0164Halve(t *testing.T) {
...
func TestE_nocarry_0164FromMont(t *testing.T) {
...
type testPaire_nocarry_0164 struct {
	element e_nocarry_0164
	bigint  big.Int
}

func (z *e_nocarry_0164) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0164[2] {
		return true
	}
	if z[2] < qe_nocarry_0164[2] {
		return false
	...
	return z[0] >= qe_nocarry_0164[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0164

		g.element = e_nocarry_0164{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0164[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0164[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0164 {
			var g e_nocarry_0164
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0164[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0164[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0164[2], carry)
...
func Benchmarke_nocarry_0164InverseNew(b *testing.B) {
	var x e_nocarry_0164
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0164
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0164
		var xInv e_nocarry_0164
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0164
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0164
...
func testLinearComb(t *testing.T, x *e_nocarry_0164, xC int64, y *e_nocarry_0164, yC int64) {
	...
	var z e_nocarry_0164
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0164, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0164
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0164, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0164
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0164, xHi uint64) {
	var res e_nocarry_0164
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0164) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0164) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0164, c int64, result *e_nocarry_0164, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0164) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0164) uint64 {
