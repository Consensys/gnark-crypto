...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xc868619b8a707da7, R14
	ADDQ R14, AX
	MOVQ $0x2790c83552639a6a, R14
	ADCQ R14, DX
	MOVQ $0x1898de4fe429fb85, R14
	ADCQ R14, CX
	MOVQ $0xd84c46afb172d1cb, R14
	ADCQ R14, BX
	MOVQ $0xba659304da9a8f08, R14
	ADCQ R14, SI
	MOVQ $0x3c5f91f7e2a9a437, R14
	ADCQ R14, DI
	MOVQ $0xb17a38d5764e9b54, R14
	ADCQ R14, R8
	MOVQ $0xa00d8aad4a9d6ae1, R14
	ADCQ R14, R9
	MOVQ $0x06194d7af74b4fa6, R14
	ADCQ R14, R10
	MOVQ $0xd8c5a5e1b76dbfcb, R14
	ADCQ R14, R11
	MOVQ $0x0003c02101c59890, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xc868619b8a707da7, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x2790c83552639a6a, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x1898de4fe429fb85, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xd84c46afb172d1cb, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xba659304da9a8f08, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x3c5f91f7e2a9a437, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xb17a38d5764e9b54, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xa00d8aad4a9d6ae1, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x06194d7af74b4fa6, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xd8c5a5e1b76dbfcb, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0003c02101c59890, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xc868619b8a707da7, AX
	ADDQ AX, DX
	MOVQ $0x2790c83552639a6a, AX
	ADCQ AX, CX
	MOVQ $0x1898de4fe429fb85, AX
	ADCQ AX, BX
	MOVQ $0xd84c46afb172d1cb, AX
	ADCQ AX, SI
	MOVQ $0xba659304da9a8f08, AX
	ADCQ AX, DI
	MOVQ $0x3c5f91f7e2a9a437, AX
	ADCQ AX, R8
	MOVQ $0xb17a38d5764e9b54, AX
	ADCQ AX, R9
	MOVQ $0xa00d8aad4a9d6ae1, AX
	ADCQ AX, R10
	MOVQ $0x06194d7af74b4fa6, AX
	ADCQ AX, R11
	MOVQ $0xd8c5a5e1b76dbfcb, AX
	ADCQ AX, R12
	MOVQ $0x0003c02101c59890, AX
	ADCQ AX, R13
