...
var benchRese_nocarry_0690 e_nocarry_0690

func BenchmarkE_nocarry_0690SetBytes(b *testing.B) {
	var x e_nocarry_0690
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0690MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0690.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0690)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0690)
		}
	})
}

func BenchmarkE_nocarry_0690Inverse(b *testing.B) {
	var x e_nocarry_0690
	x.SetRandom()
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0690Butterfly(b *testing.B) {
	var x e_nocarry_0690
	x.SetRandom()
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0690)
	}
}

func BenchmarkE_nocarry_0690Exp(b *testing.B) {
	var x e_nocarry_0690
	x.SetRandom()
	benchRese_nocarry_0690.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0690Double(b *testing.B) {
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Double(&benchRese_nocarry_0690)
	}
}

func BenchmarkE_nocarry_0690Add(b *testing.B) {
	var x e_nocarry_0690
	x.SetRandom()
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Add(&x, &benchRese_nocarry_0690)
	}
}

func BenchmarkE_nocarry_0690Sub(b *testing.B) {
	var x e_nocarry_0690
	x.SetRandom()
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Sub(&x, &benchRese_nocarry_0690)
	}
}

func BenchmarkE_nocarry_0690Neg(b *testing.B) {
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Neg(&benchRese_nocarry_0690)
	}
}

func BenchmarkE_nocarry_0690Div(b *testing.B) {
	var x e_nocarry_0690
	x.SetRandom()
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Div(&x, &benchRese_nocarry_0690)
	}
}

func BenchmarkE_nocarry_0690FromMont(b *testing.B) {
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.FromMont()
	}
}

func BenchmarkE_nocarry_0690ToMont(b *testing.B) {
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.ToMont()
	}
}
func BenchmarkE_nocarry_0690Square(b *testing.B) {
	benchRese_nocarry_0690.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Square(&benchRese_nocarry_0690)
	}
}

func BenchmarkE_nocarry_0690Sqrt(b *testing.B) {
	var a e_nocarry_0690
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0690Mul(b *testing.B) {
	x := e_nocarry_0690{
		8803893213423713409,
	...
	benchRese_nocarry_0690.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Mul(&benchRese_nocarry_0690, &x)
	}
}

func BenchmarkE_nocarry_0690Cmp(b *testing.B) {
	x := e_nocarry_0690{
		8803893213423713409,
		12135428908369024917,
		11555590110978592846,
	...
	benchRese_nocarry_0690 = x
	benchRese_nocarry_0690[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0690.Cmp(&x)
	}
}

func TestE_nocarry_0690Cmp(t *testing.T) {
	var x, y e_nocarry_0690
...
func TestE_nocarry_0690IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0690
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0690

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0690{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0690
	one.SetOne()
	e.Sub(&qe_nocarry_0690, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0690{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0690{0, uint64(i)})
	}
...
func TestE_nocarry_0690NegZero(t *testing.T) {
	var a, b e_nocarry_0690
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0690Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0690, len(staticTestValues))
...
func TestE_nocarry_0690Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0690) bool {
			var b e_nocarry_0690
...
func TestE_nocarry_0690InverseExp(t *testing.T) {
...
func TestE_nocarry_0690MulByConstants(t *testing.T) {
...
func TestE_nocarry_0690Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0690) bool {
...
func TestE_nocarry_0690LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0690Halve(t *testing.T) {
...
func TestE_nocarry_0690FromMont(t *testing.T) {
...
type testPaire_nocarry_0690 struct {
	element e_nocarry_0690
	bigint  big.Int
}

func (z *e_nocarry_0690) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0690[10] {
		return true
	}
	if z[10] < qe_nocarry_0690[10] {
		return false
	...
	return z[0] >= qe_nocarry_0690[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0690

		g.element = e_nocarry_0690{
		...
		if qe_nocarry_0690[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0690[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0690 {
			var g e_nocarry_0690
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0690[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0690[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0690[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0690[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0690[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0690[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0690[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0690[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0690[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0690[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0690[10], carry)
...
func Benchmarke_nocarry_0690InverseNew(b *testing.B) {
	var x e_nocarry_0690
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0690
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0690
		var xInv e_nocarry_0690
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0690
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0690
...
func testLinearComb(t *testing.T, x *e_nocarry_0690, xC int64, y *e_nocarry_0690, yC int64) {
	...
	var z e_nocarry_0690
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0690, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0690
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0690, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0690
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0690, xHi uint64) {
	var res e_nocarry_0690
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0690) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0690) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0690, c int64, result *e_nocarry_0690, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0690) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0690) uint64 {
