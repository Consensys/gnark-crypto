...
var benchRese_nocarry_0269 e_nocarry_0269

func BenchmarkE_nocarry_0269SetBytes(b *testing.B) {
	var x e_nocarry_0269
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0269MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0269.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0269)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0269)
		}
	})
}

func BenchmarkE_nocarry_0269Inverse(b *testing.B) {
	var x e_nocarry_0269
	x.SetRandom()
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0269Butterfly(b *testing.B) {
	var x e_nocarry_0269
	x.SetRandom()
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0269)
	}
}

func BenchmarkE_nocarry_0269Exp(b *testing.B) {
	var x e_nocarry_0269
	x.SetRandom()
	benchRese_nocarry_0269.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0269Double(b *testing.B) {
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Double(&benchRese_nocarry_0269)
	}
}

func BenchmarkE_nocarry_0269Add(b *testing.B) {
	var x e_nocarry_0269
	x.SetRandom()
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Add(&x, &benchRese_nocarry_0269)
	}
}

func BenchmarkE_nocarry_0269Sub(b *testing.B) {
	var x e_nocarry_0269
	x.SetRandom()
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Sub(&x, &benchRese_nocarry_0269)
	}
}

func BenchmarkE_nocarry_0269Neg(b *testing.B) {
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Neg(&benchRese_nocarry_0269)
	}
}

func BenchmarkE_nocarry_0269Div(b *testing.B) {
	var x e_nocarry_0269
	x.SetRandom()
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Div(&x, &benchRese_nocarry_0269)
	}
}

func BenchmarkE_nocarry_0269FromMont(b *testing.B) {
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.FromMont()
	}
}

func BenchmarkE_nocarry_0269ToMont(b *testing.B) {
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.ToMont()
	}
}
func BenchmarkE_nocarry_0269Square(b *testing.B) {
	benchRese_nocarry_0269.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Square(&benchRese_nocarry_0269)
	}
}

func BenchmarkE_nocarry_0269Sqrt(b *testing.B) {
	var a e_nocarry_0269
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0269Mul(b *testing.B) {
	x := e_nocarry_0269{
		8456157853992994451,
	...
	benchRese_nocarry_0269.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Mul(&benchRese_nocarry_0269, &x)
	}
}

func BenchmarkE_nocarry_0269Cmp(b *testing.B) {
	x := e_nocarry_0269{
		8456157853992994451,
		16645705467481646482,
		7195368755275864778,
	...
	benchRese_nocarry_0269 = x
	benchRese_nocarry_0269[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0269.Cmp(&x)
	}
}

func TestE_nocarry_0269Cmp(t *testing.T) {
	var x, y e_nocarry_0269
...
func TestE_nocarry_0269IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0269
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0269

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0269{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0269
	one.SetOne()
	e.Sub(&qe_nocarry_0269, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0269{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0269{0, uint64(i)})
	}
...
func TestE_nocarry_0269NegZero(t *testing.T) {
	var a, b e_nocarry_0269
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0269Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0269, len(staticTestValues))
...
func TestE_nocarry_0269Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0269) bool {
			var b e_nocarry_0269
...
func TestE_nocarry_0269InverseExp(t *testing.T) {
...
func TestE_nocarry_0269MulByConstants(t *testing.T) {
...
func TestE_nocarry_0269Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0269) bool {
...
func TestE_nocarry_0269LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0269Halve(t *testing.T) {
...
func TestE_nocarry_0269FromMont(t *testing.T) {
...
type testPaire_nocarry_0269 struct {
	element e_nocarry_0269
	bigint  big.Int
}

func (z *e_nocarry_0269) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0269[4] {
		return true
	}
	if z[4] < qe_nocarry_0269[4] {
		return false
	...
	return z[0] >= qe_nocarry_0269[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0269

		g.element = e_nocarry_0269{
		...
		if qe_nocarry_0269[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0269[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0269 {
			var g e_nocarry_0269
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0269[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0269[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0269[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0269[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0269[4], carry)
...
func Benchmarke_nocarry_0269InverseNew(b *testing.B) {
	var x e_nocarry_0269
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0269
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0269
		var xInv e_nocarry_0269
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0269
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0269
...
func testLinearComb(t *testing.T, x *e_nocarry_0269, xC int64, y *e_nocarry_0269, yC int64) {
	...
	var z e_nocarry_0269
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0269, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0269
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0269, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0269
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0269, xHi uint64) {
	var res e_nocarry_0269
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0269) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0269) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0269, c int64, result *e_nocarry_0269, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0269) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0269) uint64 {
