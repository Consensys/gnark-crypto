...
// modulus q
DATA q<>+0(SB)/8, $0x3401cf4c9ce7f4d3
DATA q<>+8(SB)/8, $0xce687847d42ab83e
DATA q<>+16(SB)/8, $0x89f85847a06e0b41
DATA q<>+24(SB)/8, $0xd9b645e0bcd29793
DATA q<>+32(SB)/8, $0x0000000000001878
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x0bfc07e51ed37ca5
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x3401cf4c9ce7f4d3, R9
	MOVQ    $0xce687847d42ab83e, R10
	MOVQ    $0x89f85847a06e0b41, R11
	MOVQ    $0xd9b645e0bcd29793, R12
	MOVQ    $0x0000000000001878, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xce687847d42ab83e, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x89f85847a06e0b41, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xd9b645e0bcd29793, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000000001878, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x3401cf4c9ce7f4d3, CX
	MOVQ    $0xce687847d42ab83e, BX
	MOVQ    $0x89f85847a06e0b41, SI
	MOVQ    $0xd9b645e0bcd29793, DI
	MOVQ    $0x0000000000001878, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
