...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x984490745a6e5f5b, R13
	ADDQ R13, AX
	MOVQ $0xf17fd77bb8a2cbf7, R13
	ADCQ R13, DX
	MOVQ $0x126fbb39c201a5c6, R13
	ADCQ R13, CX
	MOVQ $0x23648557616fe48d, R13
	ADCQ R13, BX
	MOVQ $0x0f4cce4791484462, R13
	ADCQ R13, SI
	MOVQ $0x66932e20b0c08231, R13
	ADCQ R13, DI
	MOVQ $0xc50df9e5ab3f6441, R13
	ADCQ R13, R8
	MOVQ $0x0eca51d4c7199daf, R13
	ADCQ R13, R9
	MOVQ $0xcc20fbb667f02810, R13
	ADCQ R13, R10
	MOVQ $0x00000000fe338e6d, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x984490745a6e5f5b, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xf17fd77bb8a2cbf7, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x126fbb39c201a5c6, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x23648557616fe48d, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x0f4cce4791484462, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x66932e20b0c08231, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xc50df9e5ab3f6441, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x0eca51d4c7199daf, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xcc20fbb667f02810, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000000fe338e6d, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x984490745a6e5f5b, AX
	ADDQ AX, DX
	MOVQ $0xf17fd77bb8a2cbf7, AX
	ADCQ AX, CX
	MOVQ $0x126fbb39c201a5c6, AX
	ADCQ AX, BX
	MOVQ $0x23648557616fe48d, AX
	ADCQ AX, SI
	MOVQ $0x0f4cce4791484462, AX
	ADCQ AX, DI
	MOVQ $0x66932e20b0c08231, AX
	ADCQ AX, R8
	MOVQ $0xc50df9e5ab3f6441, AX
	ADCQ AX, R9
	MOVQ $0x0eca51d4c7199daf, AX
	ADCQ AX, R10
	MOVQ $0xcc20fbb667f02810, AX
	ADCQ AX, R11
	MOVQ $0x00000000fe338e6d, AX
	ADCQ AX, R12
