...
var benchRese_nocarry_0608 e_nocarry_0608

func BenchmarkE_nocarry_0608SetBytes(b *testing.B) {
	var x e_nocarry_0608
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0608MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0608.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0608)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0608)
		}
	})
}

func BenchmarkE_nocarry_0608Inverse(b *testing.B) {
	var x e_nocarry_0608
	x.SetRandom()
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0608Butterfly(b *testing.B) {
	var x e_nocarry_0608
	x.SetRandom()
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0608)
	}
}

func BenchmarkE_nocarry_0608Exp(b *testing.B) {
	var x e_nocarry_0608
	x.SetRandom()
	benchRese_nocarry_0608.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0608Double(b *testing.B) {
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Double(&benchRese_nocarry_0608)
	}
}

func BenchmarkE_nocarry_0608Add(b *testing.B) {
	var x e_nocarry_0608
	x.SetRandom()
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Add(&x, &benchRese_nocarry_0608)
	}
}

func BenchmarkE_nocarry_0608Sub(b *testing.B) {
	var x e_nocarry_0608
	x.SetRandom()
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Sub(&x, &benchRese_nocarry_0608)
	}
}

func BenchmarkE_nocarry_0608Neg(b *testing.B) {
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Neg(&benchRese_nocarry_0608)
	}
}

func BenchmarkE_nocarry_0608Div(b *testing.B) {
	var x e_nocarry_0608
	x.SetRandom()
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Div(&x, &benchRese_nocarry_0608)
	}
}

func BenchmarkE_nocarry_0608FromMont(b *testing.B) {
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.FromMont()
	}
}

func BenchmarkE_nocarry_0608ToMont(b *testing.B) {
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.ToMont()
	}
}
func BenchmarkE_nocarry_0608Square(b *testing.B) {
	benchRese_nocarry_0608.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Square(&benchRese_nocarry_0608)
	}
}

func BenchmarkE_nocarry_0608Sqrt(b *testing.B) {
	var a e_nocarry_0608
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0608Mul(b *testing.B) {
	x := e_nocarry_0608{
		3808132246219572680,
	...
	benchRese_nocarry_0608.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Mul(&benchRese_nocarry_0608, &x)
	}
}

func BenchmarkE_nocarry_0608Cmp(b *testing.B) {
	x := e_nocarry_0608{
		3808132246219572680,
		11289628479642015744,
		594590375609075813,
	...
	benchRese_nocarry_0608 = x
	benchRese_nocarry_0608[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0608.Cmp(&x)
	}
}

func TestE_nocarry_0608Cmp(t *testing.T) {
	var x, y e_nocarry_0608
...
func TestE_nocarry_0608IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0608
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0608

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0608{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0608
	one.SetOne()
	e.Sub(&qe_nocarry_0608, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0608{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0608{0, uint64(i)})
	}
...
func TestE_nocarry_0608NegZero(t *testing.T) {
	var a, b e_nocarry_0608
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0608Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0608, len(staticTestValues))
...
func TestE_nocarry_0608Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0608) bool {
			var b e_nocarry_0608
...
func TestE_nocarry_0608InverseExp(t *testing.T) {
...
func TestE_nocarry_0608MulByConstants(t *testing.T) {
...
func TestE_nocarry_0608Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0608) bool {
...
func TestE_nocarry_0608LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0608Halve(t *testing.T) {
...
func TestE_nocarry_0608FromMont(t *testing.T) {
...
type testPaire_nocarry_0608 struct {
	element e_nocarry_0608
	bigint  big.Int
}

func (z *e_nocarry_0608) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0608[9] {
		return true
	}
	if z[9] < qe_nocarry_0608[9] {
		return false
	...
	return z[0] >= qe_nocarry_0608[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0608

		g.element = e_nocarry_0608{
		...
		if qe_nocarry_0608[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0608[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0608 {
			var g e_nocarry_0608
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0608[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0608[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0608[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0608[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0608[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0608[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0608[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0608[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0608[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0608[9], carry)
...
func Benchmarke_nocarry_0608InverseNew(b *testing.B) {
	var x e_nocarry_0608
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0608
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0608
		var xInv e_nocarry_0608
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0608
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0608
...
func testLinearComb(t *testing.T, x *e_nocarry_0608, xC int64, y *e_nocarry_0608, yC int64) {
	...
	var z e_nocarry_0608
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0608, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0608
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0608, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0608
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0608, xHi uint64) {
	var res e_nocarry_0608
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0608) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0608) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0608, c int64, result *e_nocarry_0608, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0608) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0608) uint64 {
