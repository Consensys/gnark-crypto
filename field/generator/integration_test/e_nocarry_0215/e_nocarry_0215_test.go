...
var benchRese_nocarry_0215 e_nocarry_0215

func BenchmarkE_nocarry_0215SetBytes(b *testing.B) {
	var x e_nocarry_0215
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0215MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0215.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0215)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0215)
		}
	})
}

func BenchmarkE_nocarry_0215Inverse(b *testing.B) {
	var x e_nocarry_0215
	x.SetRandom()
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0215Butterfly(b *testing.B) {
	var x e_nocarry_0215
	x.SetRandom()
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0215)
	}
}

func BenchmarkE_nocarry_0215Exp(b *testing.B) {
	var x e_nocarry_0215
	x.SetRandom()
	benchRese_nocarry_0215.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0215Double(b *testing.B) {
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Double(&benchRese_nocarry_0215)
	}
}

func BenchmarkE_nocarry_0215Add(b *testing.B) {
	var x e_nocarry_0215
	x.SetRandom()
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Add(&x, &benchRese_nocarry_0215)
	}
}

func BenchmarkE_nocarry_0215Sub(b *testing.B) {
	var x e_nocarry_0215
	x.SetRandom()
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Sub(&x, &benchRese_nocarry_0215)
	}
}

func BenchmarkE_nocarry_0215Neg(b *testing.B) {
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Neg(&benchRese_nocarry_0215)
	}
}

func BenchmarkE_nocarry_0215Div(b *testing.B) {
	var x e_nocarry_0215
	x.SetRandom()
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Div(&x, &benchRese_nocarry_0215)
	}
}

func BenchmarkE_nocarry_0215FromMont(b *testing.B) {
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.FromMont()
	}
}

func BenchmarkE_nocarry_0215ToMont(b *testing.B) {
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.ToMont()
	}
}
func BenchmarkE_nocarry_0215Square(b *testing.B) {
	benchRese_nocarry_0215.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Square(&benchRese_nocarry_0215)
	}
}

func BenchmarkE_nocarry_0215Sqrt(b *testing.B) {
	var a e_nocarry_0215
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0215Mul(b *testing.B) {
	x := e_nocarry_0215{
	...
	benchRese_nocarry_0215.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Mul(&benchRese_nocarry_0215, &x)
	}
}

func BenchmarkE_nocarry_0215Cmp(b *testing.B) {
	x := e_nocarry_0215{
		10690149560199994263,
		14248180210156509471,
		9390017094290861942,
	...
	benchRese_nocarry_0215 = x
	benchRese_nocarry_0215[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0215.Cmp(&x)
	}
}

func TestE_nocarry_0215Cmp(t *testing.T) {
	var x, y e_nocarry_0215
...
func TestE_nocarry_0215IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0215
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0215

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0215{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0215
	one.SetOne()
	e.Sub(&qe_nocarry_0215, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0215{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0215{0, uint64(i)})
	}
...
func TestE_nocarry_0215NegZero(t *testing.T) {
	var a, b e_nocarry_0215
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0215Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0215, len(staticTestValues))
...
func TestE_nocarry_0215Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0215) bool {
			var b e_nocarry_0215
...
func TestE_nocarry_0215InverseExp(t *testing.T) {
...
func TestE_nocarry_0215MulByConstants(t *testing.T) {
...
func TestE_nocarry_0215Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0215) bool {
...
func TestE_nocarry_0215LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0215Halve(t *testing.T) {
...
func TestE_nocarry_0215FromMont(t *testing.T) {
...
type testPaire_nocarry_0215 struct {
	element e_nocarry_0215
	bigint  big.Int
}

func (z *e_nocarry_0215) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0215[3] {
		return true
	}
	if z[3] < qe_nocarry_0215[3] {
		return false
	...
	return z[0] >= qe_nocarry_0215[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0215

		g.element = e_nocarry_0215{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0215[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0215[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0215 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0215[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0215[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0215[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0215[3], carry)
...
func Benchmarke_nocarry_0215InverseNew(b *testing.B) {
	var x e_nocarry_0215
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0215
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0215
		var xInv e_nocarry_0215
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0215
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0215
...
func testLinearComb(t *testing.T, x *e_nocarry_0215, xC int64, y *e_nocarry_0215, yC int64) {
	...
	var z e_nocarry_0215
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0215, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0215
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0215, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0215
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0215, xHi uint64) {
	var res e_nocarry_0215
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0215) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0215) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0215, c int64, result *e_nocarry_0215, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0215) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0215) uint64 {
