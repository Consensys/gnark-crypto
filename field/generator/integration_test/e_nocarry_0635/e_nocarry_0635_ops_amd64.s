...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x9bdef1ad12626245, R13
	ADDQ R13, AX
	MOVQ $0x73d8384a841b74c1, R13
	ADCQ R13, DX
	MOVQ $0xf232730c4f3dcd65, R13
	ADCQ R13, CX
	MOVQ $0xa605781621997df2, R13
	ADCQ R13, BX
	MOVQ $0x83257147edbe43af, R13
	ADCQ R13, SI
	MOVQ $0x57b5446b5df73713, R13
	ADCQ R13, DI
	MOVQ $0x5b6dd4e421b4feb0, R13
	ADCQ R13, R8
	MOVQ $0xf4e0a51513a797bc, R13
	ADCQ R13, R9
	MOVQ $0xc2b25c9f254a1431, R13
	ADCQ R13, R10
	MOVQ $0x06fdce61c3b2a5de, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x9bdef1ad12626245, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x73d8384a841b74c1, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xf232730c4f3dcd65, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xa605781621997df2, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x83257147edbe43af, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x57b5446b5df73713, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x5b6dd4e421b4feb0, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xf4e0a51513a797bc, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xc2b25c9f254a1431, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x06fdce61c3b2a5de, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x9bdef1ad12626245, AX
	ADDQ AX, DX
	MOVQ $0x73d8384a841b74c1, AX
	ADCQ AX, CX
	MOVQ $0xf232730c4f3dcd65, AX
	ADCQ AX, BX
	MOVQ $0xa605781621997df2, AX
	ADCQ AX, SI
	MOVQ $0x83257147edbe43af, AX
	ADCQ AX, DI
	MOVQ $0x57b5446b5df73713, AX
	ADCQ AX, R8
	MOVQ $0x5b6dd4e421b4feb0, AX
	ADCQ AX, R9
	MOVQ $0xf4e0a51513a797bc, AX
	ADCQ AX, R10
	MOVQ $0xc2b25c9f254a1431, AX
	ADCQ AX, R11
	MOVQ $0x06fdce61c3b2a5de, AX
	ADCQ AX, R12
