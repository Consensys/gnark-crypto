...
var benchRese_nocarry_0635 e_nocarry_0635

func BenchmarkE_nocarry_0635SetBytes(b *testing.B) {
	var x e_nocarry_0635
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0635MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0635.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0635)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0635)
		}
	})
}

func BenchmarkE_nocarry_0635Inverse(b *testing.B) {
	var x e_nocarry_0635
	x.SetRandom()
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0635Butterfly(b *testing.B) {
	var x e_nocarry_0635
	x.SetRandom()
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0635)
	}
}

func BenchmarkE_nocarry_0635Exp(b *testing.B) {
	var x e_nocarry_0635
	x.SetRandom()
	benchRese_nocarry_0635.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0635Double(b *testing.B) {
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Double(&benchRese_nocarry_0635)
	}
}

func BenchmarkE_nocarry_0635Add(b *testing.B) {
	var x e_nocarry_0635
	x.SetRandom()
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Add(&x, &benchRese_nocarry_0635)
	}
}

func BenchmarkE_nocarry_0635Sub(b *testing.B) {
	var x e_nocarry_0635
	x.SetRandom()
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Sub(&x, &benchRese_nocarry_0635)
	}
}

func BenchmarkE_nocarry_0635Neg(b *testing.B) {
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Neg(&benchRese_nocarry_0635)
	}
}

func BenchmarkE_nocarry_0635Div(b *testing.B) {
	var x e_nocarry_0635
	x.SetRandom()
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Div(&x, &benchRese_nocarry_0635)
	}
}

func BenchmarkE_nocarry_0635FromMont(b *testing.B) {
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.FromMont()
	}
}

func BenchmarkE_nocarry_0635ToMont(b *testing.B) {
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.ToMont()
	}
}
func BenchmarkE_nocarry_0635Square(b *testing.B) {
	benchRese_nocarry_0635.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Square(&benchRese_nocarry_0635)
	}
}

func BenchmarkE_nocarry_0635Sqrt(b *testing.B) {
	var a e_nocarry_0635
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0635Mul(b *testing.B) {
	x := e_nocarry_0635{
		6259474210214556903,
	...
	benchRese_nocarry_0635.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Mul(&benchRese_nocarry_0635, &x)
	}
}

func BenchmarkE_nocarry_0635Cmp(b *testing.B) {
	x := e_nocarry_0635{
		6259474210214556903,
		11242909091405243168,
		4602922543197389740,
	...
	benchRese_nocarry_0635 = x
	benchRese_nocarry_0635[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0635.Cmp(&x)
	}
}

func TestE_nocarry_0635Cmp(t *testing.T) {
	var x, y e_nocarry_0635
...
func TestE_nocarry_0635IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0635
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0635

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0635{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0635
	one.SetOne()
	e.Sub(&qe_nocarry_0635, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0635{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0635{0, uint64(i)})
	}
...
func TestE_nocarry_0635NegZero(t *testing.T) {
	var a, b e_nocarry_0635
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0635Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0635, len(staticTestValues))
...
func TestE_nocarry_0635Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0635) bool {
			var b e_nocarry_0635
...
func TestE_nocarry_0635InverseExp(t *testing.T) {
...
func TestE_nocarry_0635MulByConstants(t *testing.T) {
...
func TestE_nocarry_0635Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0635) bool {
...
func TestE_nocarry_0635LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0635Halve(t *testing.T) {
...
func TestE_nocarry_0635FromMont(t *testing.T) {
...
type testPaire_nocarry_0635 struct {
	element e_nocarry_0635
	bigint  big.Int
}

func (z *e_nocarry_0635) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0635[9] {
		return true
	}
	if z[9] < qe_nocarry_0635[9] {
		return false
	...
	return z[0] >= qe_nocarry_0635[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0635

		g.element = e_nocarry_0635{
		...
		if qe_nocarry_0635[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0635[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0635 {
			var g e_nocarry_0635
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0635[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0635[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0635[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0635[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0635[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0635[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0635[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0635[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0635[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0635[9], carry)
...
func Benchmarke_nocarry_0635InverseNew(b *testing.B) {
	var x e_nocarry_0635
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0635
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0635
		var xInv e_nocarry_0635
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0635
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0635
...
func testLinearComb(t *testing.T, x *e_nocarry_0635, xC int64, y *e_nocarry_0635, yC int64) {
	...
	var z e_nocarry_0635
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0635, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0635
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0635, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0635
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0635, xHi uint64) {
	var res e_nocarry_0635
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0635) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0635) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0635, c int64, result *e_nocarry_0635, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0635) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0635) uint64 {
