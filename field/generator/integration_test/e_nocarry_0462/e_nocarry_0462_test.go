...
var benchRese_nocarry_0462 e_nocarry_0462

func BenchmarkE_nocarry_0462SetBytes(b *testing.B) {
	var x e_nocarry_0462
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0462MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0462.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0462)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0462)
		}
	})
}

func BenchmarkE_nocarry_0462Inverse(b *testing.B) {
	var x e_nocarry_0462
	x.SetRandom()
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0462Butterfly(b *testing.B) {
	var x e_nocarry_0462
	x.SetRandom()
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0462)
	}
}

func BenchmarkE_nocarry_0462Exp(b *testing.B) {
	var x e_nocarry_0462
	x.SetRandom()
	benchRese_nocarry_0462.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0462Double(b *testing.B) {
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Double(&benchRese_nocarry_0462)
	}
}

func BenchmarkE_nocarry_0462Add(b *testing.B) {
	var x e_nocarry_0462
	x.SetRandom()
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Add(&x, &benchRese_nocarry_0462)
	}
}

func BenchmarkE_nocarry_0462Sub(b *testing.B) {
	var x e_nocarry_0462
	x.SetRandom()
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Sub(&x, &benchRese_nocarry_0462)
	}
}

func BenchmarkE_nocarry_0462Neg(b *testing.B) {
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Neg(&benchRese_nocarry_0462)
	}
}

func BenchmarkE_nocarry_0462Div(b *testing.B) {
	var x e_nocarry_0462
	x.SetRandom()
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Div(&x, &benchRese_nocarry_0462)
	}
}

func BenchmarkE_nocarry_0462FromMont(b *testing.B) {
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.FromMont()
	}
}

func BenchmarkE_nocarry_0462ToMont(b *testing.B) {
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.ToMont()
	}
}
func BenchmarkE_nocarry_0462Square(b *testing.B) {
	benchRese_nocarry_0462.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Square(&benchRese_nocarry_0462)
	}
}

func BenchmarkE_nocarry_0462Sqrt(b *testing.B) {
	var a e_nocarry_0462
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0462Mul(b *testing.B) {
	x := e_nocarry_0462{
	...
	benchRese_nocarry_0462.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Mul(&benchRese_nocarry_0462, &x)
	}
}

func BenchmarkE_nocarry_0462Cmp(b *testing.B) {
	x := e_nocarry_0462{
		10775761340708005461,
		13079570208962987381,
		15871966752636285630,
	...
	benchRese_nocarry_0462 = x
	benchRese_nocarry_0462[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0462.Cmp(&x)
	}
}

func TestE_nocarry_0462Cmp(t *testing.T) {
	var x, y e_nocarry_0462
...
func TestE_nocarry_0462IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0462
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0462

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0462{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0462
	one.SetOne()
	e.Sub(&qe_nocarry_0462, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0462{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0462{0, uint64(i)})
	}
...
func TestE_nocarry_0462NegZero(t *testing.T) {
	var a, b e_nocarry_0462
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0462Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0462, len(staticTestValues))
...
func TestE_nocarry_0462Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0462) bool {
			var b e_nocarry_0462
...
func TestE_nocarry_0462InverseExp(t *testing.T) {
...
func TestE_nocarry_0462MulByConstants(t *testing.T) {
...
func TestE_nocarry_0462Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0462) bool {
...
func TestE_nocarry_0462LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0462Halve(t *testing.T) {
...
func TestE_nocarry_0462FromMont(t *testing.T) {
...
type testPaire_nocarry_0462 struct {
	element e_nocarry_0462
	bigint  big.Int
}

func (z *e_nocarry_0462) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0462[7] {
		return true
	}
	if z[7] < qe_nocarry_0462[7] {
		return false
	...
	return z[0] >= qe_nocarry_0462[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0462

		g.element = e_nocarry_0462{
		...
		if qe_nocarry_0462[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0462[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0462 {
			var g e_nocarry_0462
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0462[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0462[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0462[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0462[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0462[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0462[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0462[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0462[7], carry)
...
func Benchmarke_nocarry_0462InverseNew(b *testing.B) {
	var x e_nocarry_0462
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0462
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0462
		var xInv e_nocarry_0462
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0462
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0462
...
func testLinearComb(t *testing.T, x *e_nocarry_0462, xC int64, y *e_nocarry_0462, yC int64) {
	...
	var z e_nocarry_0462
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0462, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0462
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0462, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0462
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0462, xHi uint64) {
	var res e_nocarry_0462
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0462) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0462) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0462, c int64, result *e_nocarry_0462, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0462) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0462) uint64 {
