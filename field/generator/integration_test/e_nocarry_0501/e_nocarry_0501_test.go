...
var benchRese_nocarry_0501 e_nocarry_0501

func BenchmarkE_nocarry_0501SetBytes(b *testing.B) {
	var x e_nocarry_0501
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0501MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0501.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0501)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0501)
		}
	})
}

func BenchmarkE_nocarry_0501Inverse(b *testing.B) {
	var x e_nocarry_0501
	x.SetRandom()
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0501Butterfly(b *testing.B) {
	var x e_nocarry_0501
	x.SetRandom()
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0501)
	}
}

func BenchmarkE_nocarry_0501Exp(b *testing.B) {
	var x e_nocarry_0501
	x.SetRandom()
	benchRese_nocarry_0501.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0501Double(b *testing.B) {
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Double(&benchRese_nocarry_0501)
	}
}

func BenchmarkE_nocarry_0501Add(b *testing.B) {
	var x e_nocarry_0501
	x.SetRandom()
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Add(&x, &benchRese_nocarry_0501)
	}
}

func BenchmarkE_nocarry_0501Sub(b *testing.B) {
	var x e_nocarry_0501
	x.SetRandom()
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Sub(&x, &benchRese_nocarry_0501)
	}
}

func BenchmarkE_nocarry_0501Neg(b *testing.B) {
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Neg(&benchRese_nocarry_0501)
	}
}

func BenchmarkE_nocarry_0501Div(b *testing.B) {
	var x e_nocarry_0501
	x.SetRandom()
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Div(&x, &benchRese_nocarry_0501)
	}
}

func BenchmarkE_nocarry_0501FromMont(b *testing.B) {
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.FromMont()
	}
}

func BenchmarkE_nocarry_0501ToMont(b *testing.B) {
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.ToMont()
	}
}
func BenchmarkE_nocarry_0501Square(b *testing.B) {
	benchRese_nocarry_0501.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Square(&benchRese_nocarry_0501)
	}
}

func BenchmarkE_nocarry_0501Sqrt(b *testing.B) {
	var a e_nocarry_0501
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0501Mul(b *testing.B) {
	x := e_nocarry_0501{
		8363566861487891409,
		1305823622166072321,
	...
	benchRese_nocarry_0501.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Mul(&benchRese_nocarry_0501, &x)
	}
}

func BenchmarkE_nocarry_0501Cmp(b *testing.B) {
	x := e_nocarry_0501{
		8363566861487891409,
		1305823622166072321,
		14735046668519598145,
	...
	benchRese_nocarry_0501 = x
	benchRese_nocarry_0501[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0501.Cmp(&x)
	}
}

func TestE_nocarry_0501Cmp(t *testing.T) {
	var x, y e_nocarry_0501
...
func TestE_nocarry_0501IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0501
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0501

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0501{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0501
	one.SetOne()
	e.Sub(&qe_nocarry_0501, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0501{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0501{0, uint64(i)})
	}
...
func TestE_nocarry_0501NegZero(t *testing.T) {
	var a, b e_nocarry_0501
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0501Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0501, len(staticTestValues))
...
func TestE_nocarry_0501Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0501) bool {
			var b e_nocarry_0501
...
func TestE_nocarry_0501InverseExp(t *testing.T) {
...
func TestE_nocarry_0501MulByConstants(t *testing.T) {
...
func TestE_nocarry_0501Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0501) bool {
...
func TestE_nocarry_0501LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0501Halve(t *testing.T) {
...
func TestE_nocarry_0501FromMont(t *testing.T) {
...
type testPaire_nocarry_0501 struct {
	element e_nocarry_0501
	bigint  big.Int
}

func (z *e_nocarry_0501) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0501[7] {
		return true
	}
	if z[7] < qe_nocarry_0501[7] {
		return false
	...
	return z[0] >= qe_nocarry_0501[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0501

		g.element = e_nocarry_0501{
		...
		if qe_nocarry_0501[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0501[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0501 {
			var g e_nocarry_0501
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0501[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0501[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0501[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0501[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0501[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0501[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0501[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0501[7], carry)
...
func Benchmarke_nocarry_0501InverseNew(b *testing.B) {
	var x e_nocarry_0501
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0501
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0501
		var xInv e_nocarry_0501
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0501
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0501
...
func testLinearComb(t *testing.T, x *e_nocarry_0501, xC int64, y *e_nocarry_0501, yC int64) {
	...
	var z e_nocarry_0501
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0501, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0501
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0501, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0501
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0501, xHi uint64) {
	var res e_nocarry_0501
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0501) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0501) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0501, c int64, result *e_nocarry_0501, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0501) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0501) uint64 {
