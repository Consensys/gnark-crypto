...
var benchRese_nocarry_0488 e_nocarry_0488

func BenchmarkE_nocarry_0488SetBytes(b *testing.B) {
	var x e_nocarry_0488
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0488MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0488.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0488)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0488)
		}
	})
}

func BenchmarkE_nocarry_0488Inverse(b *testing.B) {
	var x e_nocarry_0488
	x.SetRandom()
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0488Butterfly(b *testing.B) {
	var x e_nocarry_0488
	x.SetRandom()
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0488)
	}
}

func BenchmarkE_nocarry_0488Exp(b *testing.B) {
	var x e_nocarry_0488
	x.SetRandom()
	benchRese_nocarry_0488.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0488Double(b *testing.B) {
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Double(&benchRese_nocarry_0488)
	}
}

func BenchmarkE_nocarry_0488Add(b *testing.B) {
	var x e_nocarry_0488
	x.SetRandom()
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Add(&x, &benchRese_nocarry_0488)
	}
}

func BenchmarkE_nocarry_0488Sub(b *testing.B) {
	var x e_nocarry_0488
	x.SetRandom()
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Sub(&x, &benchRese_nocarry_0488)
	}
}

func BenchmarkE_nocarry_0488Neg(b *testing.B) {
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Neg(&benchRese_nocarry_0488)
	}
}

func BenchmarkE_nocarry_0488Div(b *testing.B) {
	var x e_nocarry_0488
	x.SetRandom()
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Div(&x, &benchRese_nocarry_0488)
	}
}

func BenchmarkE_nocarry_0488FromMont(b *testing.B) {
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.FromMont()
	}
}

func BenchmarkE_nocarry_0488ToMont(b *testing.B) {
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.ToMont()
	}
}
func BenchmarkE_nocarry_0488Square(b *testing.B) {
	benchRese_nocarry_0488.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Square(&benchRese_nocarry_0488)
	}
}

func BenchmarkE_nocarry_0488Sqrt(b *testing.B) {
	var a e_nocarry_0488
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0488Mul(b *testing.B) {
	x := e_nocarry_0488{
	...
	benchRese_nocarry_0488.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Mul(&benchRese_nocarry_0488, &x)
	}
}

func BenchmarkE_nocarry_0488Cmp(b *testing.B) {
	x := e_nocarry_0488{
		15368017095822556749,
		905584522531819115,
		2457663654404074843,
	...
	benchRese_nocarry_0488 = x
	benchRese_nocarry_0488[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0488.Cmp(&x)
	}
}

func TestE_nocarry_0488Cmp(t *testing.T) {
	var x, y e_nocarry_0488
...
func TestE_nocarry_0488IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0488
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0488

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0488{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0488
	one.SetOne()
	e.Sub(&qe_nocarry_0488, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0488{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0488{0, uint64(i)})
	}
...
func TestE_nocarry_0488NegZero(t *testing.T) {
	var a, b e_nocarry_0488
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0488Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0488, len(staticTestValues))
...
func TestE_nocarry_0488Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0488) bool {
			var b e_nocarry_0488
...
func TestE_nocarry_0488InverseExp(t *testing.T) {
...
func TestE_nocarry_0488MulByConstants(t *testing.T) {
...
func TestE_nocarry_0488Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0488) bool {
...
func TestE_nocarry_0488LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0488Halve(t *testing.T) {
...
func TestE_nocarry_0488FromMont(t *testing.T) {
...
type testPaire_nocarry_0488 struct {
	element e_nocarry_0488
	bigint  big.Int
}

func (z *e_nocarry_0488) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0488[7] {
		return true
	}
	if z[7] < qe_nocarry_0488[7] {
		return false
	...
	return z[0] >= qe_nocarry_0488[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0488

		g.element = e_nocarry_0488{
		...
		if qe_nocarry_0488[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0488[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0488 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0488[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0488[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0488[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0488[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0488[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0488[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0488[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0488[7], carry)
...
func Benchmarke_nocarry_0488InverseNew(b *testing.B) {
	var x e_nocarry_0488
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0488
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0488
		var xInv e_nocarry_0488
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0488
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0488
...
func testLinearComb(t *testing.T, x *e_nocarry_0488, xC int64, y *e_nocarry_0488, yC int64) {
	...
	var z e_nocarry_0488
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0488, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0488
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0488, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0488
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0488, xHi uint64) {
	var res e_nocarry_0488
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0488) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0488) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0488, c int64, result *e_nocarry_0488, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0488) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0488) uint64 {
