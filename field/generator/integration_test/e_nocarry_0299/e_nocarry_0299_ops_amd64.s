...
// modulus q
DATA q<>+0(SB)/8, $0xf5520743d92e2df1
DATA q<>+8(SB)/8, $0x34833db737ad7547
DATA q<>+16(SB)/8, $0x47a3c49aeba827ca
DATA q<>+24(SB)/8, $0x0ed920f8d80e9f54
DATA q<>+32(SB)/8, $0x000006573a887251
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x9a3b9c1dace8dcef
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0xf5520743d92e2df1, R9
	MOVQ    $0x34833db737ad7547, R10
	MOVQ    $0x47a3c49aeba827ca, R11
	MOVQ    $0x0ed920f8d80e9f54, R12
	MOVQ    $0x000006573a887251, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x34833db737ad7547, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x47a3c49aeba827ca, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x0ed920f8d80e9f54, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x000006573a887251, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0xf5520743d92e2df1, CX
	MOVQ    $0x34833db737ad7547, BX
	MOVQ    $0x47a3c49aeba827ca, SI
	MOVQ    $0x0ed920f8d80e9f54, DI
	MOVQ    $0x000006573a887251, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
