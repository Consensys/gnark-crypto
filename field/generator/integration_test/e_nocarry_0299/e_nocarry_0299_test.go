...
var benchRese_nocarry_0299 e_nocarry_0299

func BenchmarkE_nocarry_0299SetBytes(b *testing.B) {
	var x e_nocarry_0299
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0299MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0299.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0299)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0299)
		}
	})
}

func BenchmarkE_nocarry_0299Inverse(b *testing.B) {
	var x e_nocarry_0299
	x.SetRandom()
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0299Butterfly(b *testing.B) {
	var x e_nocarry_0299
	x.SetRandom()
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0299)
	}
}

func BenchmarkE_nocarry_0299Exp(b *testing.B) {
	var x e_nocarry_0299
	x.SetRandom()
	benchRese_nocarry_0299.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0299Double(b *testing.B) {
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Double(&benchRese_nocarry_0299)
	}
}

func BenchmarkE_nocarry_0299Add(b *testing.B) {
	var x e_nocarry_0299
	x.SetRandom()
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Add(&x, &benchRese_nocarry_0299)
	}
}

func BenchmarkE_nocarry_0299Sub(b *testing.B) {
	var x e_nocarry_0299
	x.SetRandom()
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Sub(&x, &benchRese_nocarry_0299)
	}
}

func BenchmarkE_nocarry_0299Neg(b *testing.B) {
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Neg(&benchRese_nocarry_0299)
	}
}

func BenchmarkE_nocarry_0299Div(b *testing.B) {
	var x e_nocarry_0299
	x.SetRandom()
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Div(&x, &benchRese_nocarry_0299)
	}
}

func BenchmarkE_nocarry_0299FromMont(b *testing.B) {
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.FromMont()
	}
}

func BenchmarkE_nocarry_0299ToMont(b *testing.B) {
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.ToMont()
	}
}
func BenchmarkE_nocarry_0299Square(b *testing.B) {
	benchRese_nocarry_0299.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Square(&benchRese_nocarry_0299)
	}
}

func BenchmarkE_nocarry_0299Sqrt(b *testing.B) {
	var a e_nocarry_0299
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0299Mul(b *testing.B) {
	x := e_nocarry_0299{
	...
	benchRese_nocarry_0299.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Mul(&benchRese_nocarry_0299, &x)
	}
}

func BenchmarkE_nocarry_0299Cmp(b *testing.B) {
	x := e_nocarry_0299{
		17747933123228341285,
		8442722700766883202,
		6784314500470740279,
	...
	benchRese_nocarry_0299 = x
	benchRese_nocarry_0299[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0299.Cmp(&x)
	}
}

func TestE_nocarry_0299Cmp(t *testing.T) {
	var x, y e_nocarry_0299
...
func TestE_nocarry_0299IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0299
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0299

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0299{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0299
	one.SetOne()
	e.Sub(&qe_nocarry_0299, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0299{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0299{0, uint64(i)})
	}
...
func TestE_nocarry_0299NegZero(t *testing.T) {
	var a, b e_nocarry_0299
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0299Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0299, len(staticTestValues))
...
func TestE_nocarry_0299Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0299) bool {
			var b e_nocarry_0299
...
func TestE_nocarry_0299InverseExp(t *testing.T) {
...
func TestE_nocarry_0299MulByConstants(t *testing.T) {
...
func TestE_nocarry_0299Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0299) bool {
...
func TestE_nocarry_0299LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0299Halve(t *testing.T) {
...
func TestE_nocarry_0299FromMont(t *testing.T) {
...
type testPaire_nocarry_0299 struct {
	element e_nocarry_0299
	bigint  big.Int
}

func (z *e_nocarry_0299) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0299[4] {
		return true
	}
	if z[4] < qe_nocarry_0299[4] {
		return false
	...
	return z[0] >= qe_nocarry_0299[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0299

		g.element = e_nocarry_0299{
		...
		if qe_nocarry_0299[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0299[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0299 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0299[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0299[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0299[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0299[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0299[4], carry)
...
func Benchmarke_nocarry_0299InverseNew(b *testing.B) {
	var x e_nocarry_0299
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0299
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0299
		var xInv e_nocarry_0299
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0299
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0299
...
func testLinearComb(t *testing.T, x *e_nocarry_0299, xC int64, y *e_nocarry_0299, yC int64) {
	...
	var z e_nocarry_0299
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0299, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0299
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0299, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0299
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0299, xHi uint64) {
	var res e_nocarry_0299
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0299) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0299) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0299, c int64, result *e_nocarry_0299, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0299) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0299) uint64 {
