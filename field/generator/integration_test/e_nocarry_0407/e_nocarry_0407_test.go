...
var benchRese_nocarry_0407 e_nocarry_0407

func BenchmarkE_nocarry_0407SetBytes(b *testing.B) {
	var x e_nocarry_0407
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0407MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0407.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0407)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0407)
		}
	})
}

func BenchmarkE_nocarry_0407Inverse(b *testing.B) {
	var x e_nocarry_0407
	x.SetRandom()
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0407Butterfly(b *testing.B) {
	var x e_nocarry_0407
	x.SetRandom()
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0407)
	}
}

func BenchmarkE_nocarry_0407Exp(b *testing.B) {
	var x e_nocarry_0407
	x.SetRandom()
	benchRese_nocarry_0407.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0407Double(b *testing.B) {
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Double(&benchRese_nocarry_0407)
	}
}

func BenchmarkE_nocarry_0407Add(b *testing.B) {
	var x e_nocarry_0407
	x.SetRandom()
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Add(&x, &benchRese_nocarry_0407)
	}
}

func BenchmarkE_nocarry_0407Sub(b *testing.B) {
	var x e_nocarry_0407
	x.SetRandom()
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Sub(&x, &benchRese_nocarry_0407)
	}
}

func BenchmarkE_nocarry_0407Neg(b *testing.B) {
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Neg(&benchRese_nocarry_0407)
	}
}

func BenchmarkE_nocarry_0407Div(b *testing.B) {
	var x e_nocarry_0407
	x.SetRandom()
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Div(&x, &benchRese_nocarry_0407)
	}
}

func BenchmarkE_nocarry_0407FromMont(b *testing.B) {
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.FromMont()
	}
}

func BenchmarkE_nocarry_0407ToMont(b *testing.B) {
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.ToMont()
	}
}
func BenchmarkE_nocarry_0407Square(b *testing.B) {
	benchRese_nocarry_0407.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Square(&benchRese_nocarry_0407)
	}
}

func BenchmarkE_nocarry_0407Sqrt(b *testing.B) {
	var a e_nocarry_0407
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0407Mul(b *testing.B) {
	x := e_nocarry_0407{
		9001711774955774343,
		8037945033911372665,
		2709653013563216851,
	...
	benchRese_nocarry_0407.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Mul(&benchRese_nocarry_0407, &x)
	}
}

func BenchmarkE_nocarry_0407Cmp(b *testing.B) {
	x := e_nocarry_0407{
		9001711774955774343,
		8037945033911372665,
		2709653013563216851,
	...
	benchRese_nocarry_0407 = x
	benchRese_nocarry_0407[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0407.Cmp(&x)
	}
}

func TestE_nocarry_0407Cmp(t *testing.T) {
	var x, y e_nocarry_0407
...
func TestE_nocarry_0407IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0407
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0407

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0407{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0407
	one.SetOne()
	e.Sub(&qe_nocarry_0407, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0407{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0407{0, uint64(i)})
	}
...
func TestE_nocarry_0407NegZero(t *testing.T) {
	var a, b e_nocarry_0407
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0407Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0407, len(staticTestValues))
...
func TestE_nocarry_0407Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0407) bool {
			var b e_nocarry_0407
...
func TestE_nocarry_0407InverseExp(t *testing.T) {
...
func TestE_nocarry_0407MulByConstants(t *testing.T) {
...
func TestE_nocarry_0407Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0407) bool {
...
func TestE_nocarry_0407LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0407Halve(t *testing.T) {
...
func TestE_nocarry_0407FromMont(t *testing.T) {
...
type testPaire_nocarry_0407 struct {
	element e_nocarry_0407
	bigint  big.Int
}

func (z *e_nocarry_0407) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0407[6] {
		return true
	}
	if z[6] < qe_nocarry_0407[6] {
		return false
	...
	return z[0] >= qe_nocarry_0407[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0407

		g.element = e_nocarry_0407{
		...
		if qe_nocarry_0407[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0407[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0407 {
			var g e_nocarry_0407
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0407[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0407[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0407[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0407[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0407[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0407[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0407[6], carry)
...
func Benchmarke_nocarry_0407InverseNew(b *testing.B) {
	var x e_nocarry_0407
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0407
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0407
		var xInv e_nocarry_0407
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0407
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0407
...
func testLinearComb(t *testing.T, x *e_nocarry_0407, xC int64, y *e_nocarry_0407, yC int64) {
	...
	var z e_nocarry_0407
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0407, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0407
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0407, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0407
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0407, xHi uint64) {
	var res e_nocarry_0407
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0407) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0407) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0407, c int64, result *e_nocarry_0407, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0407) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0407) uint64 {
