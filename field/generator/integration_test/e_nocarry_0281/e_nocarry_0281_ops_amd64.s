...
// modulus q
DATA q<>+0(SB)/8, $0x7698999ad3095229
DATA q<>+8(SB)/8, $0x5911197823e97a14
DATA q<>+16(SB)/8, $0xd5dd3bde104741eb
DATA q<>+24(SB)/8, $0x4f7a9408abe5b71c
DATA q<>+32(SB)/8, $0x0000000001ab36ac
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xea167990423d95e7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x7698999ad3095229, R9
	MOVQ    $0x5911197823e97a14, R10
	MOVQ    $0xd5dd3bde104741eb, R11
	MOVQ    $0x4f7a9408abe5b71c, R12
	MOVQ    $0x0000000001ab36ac, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x5911197823e97a14, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xd5dd3bde104741eb, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x4f7a9408abe5b71c, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x0000000001ab36ac, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x7698999ad3095229, CX
	MOVQ    $0x5911197823e97a14, BX
	MOVQ    $0xd5dd3bde104741eb, SI
	MOVQ    $0x4f7a9408abe5b71c, DI
	MOVQ    $0x0000000001ab36ac, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
