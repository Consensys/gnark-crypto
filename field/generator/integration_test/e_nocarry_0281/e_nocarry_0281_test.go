...
var benchRese_nocarry_0281 e_nocarry_0281

func BenchmarkE_nocarry_0281SetBytes(b *testing.B) {
	var x e_nocarry_0281
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0281MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0281.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0281)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0281)
		}
	})
}

func BenchmarkE_nocarry_0281Inverse(b *testing.B) {
	var x e_nocarry_0281
	x.SetRandom()
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0281Butterfly(b *testing.B) {
	var x e_nocarry_0281
	x.SetRandom()
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0281)
	}
}

func BenchmarkE_nocarry_0281Exp(b *testing.B) {
	var x e_nocarry_0281
	x.SetRandom()
	benchRese_nocarry_0281.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0281Double(b *testing.B) {
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Double(&benchRese_nocarry_0281)
	}
}

func BenchmarkE_nocarry_0281Add(b *testing.B) {
	var x e_nocarry_0281
	x.SetRandom()
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Add(&x, &benchRese_nocarry_0281)
	}
}

func BenchmarkE_nocarry_0281Sub(b *testing.B) {
	var x e_nocarry_0281
	x.SetRandom()
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Sub(&x, &benchRese_nocarry_0281)
	}
}

func BenchmarkE_nocarry_0281Neg(b *testing.B) {
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Neg(&benchRese_nocarry_0281)
	}
}

func BenchmarkE_nocarry_0281Div(b *testing.B) {
	var x e_nocarry_0281
	x.SetRandom()
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Div(&x, &benchRese_nocarry_0281)
	}
}

func BenchmarkE_nocarry_0281FromMont(b *testing.B) {
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.FromMont()
	}
}

func BenchmarkE_nocarry_0281ToMont(b *testing.B) {
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.ToMont()
	}
}
func BenchmarkE_nocarry_0281Square(b *testing.B) {
	benchRese_nocarry_0281.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Square(&benchRese_nocarry_0281)
	}
}

func BenchmarkE_nocarry_0281Sqrt(b *testing.B) {
	var a e_nocarry_0281
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0281Mul(b *testing.B) {
	x := e_nocarry_0281{
	...
	benchRese_nocarry_0281.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Mul(&benchRese_nocarry_0281, &x)
	}
}

func BenchmarkE_nocarry_0281Cmp(b *testing.B) {
	x := e_nocarry_0281{
		14033186705063138509,
		1575524220656940559,
		7968290413019219269,
	...
	benchRese_nocarry_0281 = x
	benchRese_nocarry_0281[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0281.Cmp(&x)
	}
}

func TestE_nocarry_0281Cmp(t *testing.T) {
	var x, y e_nocarry_0281
...
func TestE_nocarry_0281IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0281
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0281

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0281{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0281
	one.SetOne()
	e.Sub(&qe_nocarry_0281, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0281{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0281{0, uint64(i)})
	}
...
func TestE_nocarry_0281NegZero(t *testing.T) {
	var a, b e_nocarry_0281
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0281Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0281, len(staticTestValues))
...
func TestE_nocarry_0281Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0281) bool {
			var b e_nocarry_0281
...
func TestE_nocarry_0281InverseExp(t *testing.T) {
...
func TestE_nocarry_0281MulByConstants(t *testing.T) {
...
func TestE_nocarry_0281Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0281) bool {
...
func TestE_nocarry_0281LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0281Halve(t *testing.T) {
...
func TestE_nocarry_0281FromMont(t *testing.T) {
...
type testPaire_nocarry_0281 struct {
	element e_nocarry_0281
	bigint  big.Int
}

func (z *e_nocarry_0281) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0281[4] {
		return true
	}
	if z[4] < qe_nocarry_0281[4] {
		return false
	...
	return z[0] >= qe_nocarry_0281[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0281

		g.element = e_nocarry_0281{
		...
		if qe_nocarry_0281[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0281[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0281 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0281[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0281[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0281[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0281[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0281[4], carry)
...
func Benchmarke_nocarry_0281InverseNew(b *testing.B) {
	var x e_nocarry_0281
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0281
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0281
		var xInv e_nocarry_0281
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0281
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0281
...
func testLinearComb(t *testing.T, x *e_nocarry_0281, xC int64, y *e_nocarry_0281, yC int64) {
	...
	var z e_nocarry_0281
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0281, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0281
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0281, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0281
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0281, xHi uint64) {
	var res e_nocarry_0281
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0281) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0281) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0281, c int64, result *e_nocarry_0281, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0281) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0281) uint64 {
