...
var benchRese_nocarry_0697 e_nocarry_0697

func BenchmarkE_nocarry_0697SetBytes(b *testing.B) {
	var x e_nocarry_0697
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0697MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0697.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0697)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0697)
		}
	})
}

func BenchmarkE_nocarry_0697Inverse(b *testing.B) {
	var x e_nocarry_0697
	x.SetRandom()
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0697Butterfly(b *testing.B) {
	var x e_nocarry_0697
	x.SetRandom()
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0697)
	}
}

func BenchmarkE_nocarry_0697Exp(b *testing.B) {
	var x e_nocarry_0697
	x.SetRandom()
	benchRese_nocarry_0697.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0697Double(b *testing.B) {
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Double(&benchRese_nocarry_0697)
	}
}

func BenchmarkE_nocarry_0697Add(b *testing.B) {
	var x e_nocarry_0697
	x.SetRandom()
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Add(&x, &benchRese_nocarry_0697)
	}
}

func BenchmarkE_nocarry_0697Sub(b *testing.B) {
	var x e_nocarry_0697
	x.SetRandom()
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Sub(&x, &benchRese_nocarry_0697)
	}
}

func BenchmarkE_nocarry_0697Neg(b *testing.B) {
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Neg(&benchRese_nocarry_0697)
	}
}

func BenchmarkE_nocarry_0697Div(b *testing.B) {
	var x e_nocarry_0697
	x.SetRandom()
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Div(&x, &benchRese_nocarry_0697)
	}
}

func BenchmarkE_nocarry_0697FromMont(b *testing.B) {
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.FromMont()
	}
}

func BenchmarkE_nocarry_0697ToMont(b *testing.B) {
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.ToMont()
	}
}
func BenchmarkE_nocarry_0697Square(b *testing.B) {
	benchRese_nocarry_0697.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Square(&benchRese_nocarry_0697)
	}
}

func BenchmarkE_nocarry_0697Sqrt(b *testing.B) {
	var a e_nocarry_0697
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0697Mul(b *testing.B) {
	x := e_nocarry_0697{
		9970838421742325912,
	...
	benchRese_nocarry_0697.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Mul(&benchRese_nocarry_0697, &x)
	}
}

func BenchmarkE_nocarry_0697Cmp(b *testing.B) {
	x := e_nocarry_0697{
		9970838421742325912,
		16560666922025619384,
		11980639519006949252,
	...
	benchRese_nocarry_0697 = x
	benchRese_nocarry_0697[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0697.Cmp(&x)
	}
}

func TestE_nocarry_0697Cmp(t *testing.T) {
	var x, y e_nocarry_0697
...
func TestE_nocarry_0697IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0697
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0697

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0697{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0697
	one.SetOne()
	e.Sub(&qe_nocarry_0697, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0697{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0697{0, uint64(i)})
	}
...
func TestE_nocarry_0697NegZero(t *testing.T) {
	var a, b e_nocarry_0697
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0697Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0697, len(staticTestValues))
...
func TestE_nocarry_0697Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0697) bool {
			var b e_nocarry_0697
...
func TestE_nocarry_0697InverseExp(t *testing.T) {
...
func TestE_nocarry_0697MulByConstants(t *testing.T) {
...
func TestE_nocarry_0697Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0697) bool {
...
func TestE_nocarry_0697LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0697Halve(t *testing.T) {
...
func TestE_nocarry_0697FromMont(t *testing.T) {
...
type testPaire_nocarry_0697 struct {
	element e_nocarry_0697
	bigint  big.Int
}

func (z *e_nocarry_0697) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0697[10] {
		return true
	}
	if z[10] < qe_nocarry_0697[10] {
		return false
	...
	return z[0] >= qe_nocarry_0697[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0697

		g.element = e_nocarry_0697{
		...
		if qe_nocarry_0697[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0697[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0697 {
			var g e_nocarry_0697
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0697[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0697[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0697[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0697[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0697[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0697[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0697[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0697[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0697[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0697[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0697[10], carry)
...
func Benchmarke_nocarry_0697InverseNew(b *testing.B) {
	var x e_nocarry_0697
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0697
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0697
		var xInv e_nocarry_0697
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0697
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0697
...
func testLinearComb(t *testing.T, x *e_nocarry_0697, xC int64, y *e_nocarry_0697, yC int64) {
	...
	var z e_nocarry_0697
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0697, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0697
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0697, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0697
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0697, xHi uint64) {
	var res e_nocarry_0697
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0697) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0697) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0697, c int64, result *e_nocarry_0697, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0697) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0697) uint64 {
