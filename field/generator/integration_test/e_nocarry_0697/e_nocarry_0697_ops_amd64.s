...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xe660fc2a3e0d1465, R14
	ADDQ R14, AX
	MOVQ $0x8e5094d4b774faa0, R14
	ADCQ R14, DX
	MOVQ $0xea9d3862041f85c8, R14
	ADCQ R14, CX
	MOVQ $0xb8558d094b438bb8, R14
	ADCQ R14, BX
	MOVQ $0x5253f97eb5c17592, R14
	ADCQ R14, SI
	MOVQ $0xd9886bbcd8c55620, R14
	ADCQ R14, DI
	MOVQ $0xc8c63b5d9ed8026a, R14
	ADCQ R14, R8
	MOVQ $0xe0965504bf844f8e, R14
	ADCQ R14, R9
	MOVQ $0x508bbe3596662b86, R14
	ADCQ R14, R10
	MOVQ $0x083adf9d70244057, R14
	ADCQ R14, R11
	MOVQ $0x01d570815e6c3272, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xe660fc2a3e0d1465, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x8e5094d4b774faa0, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xea9d3862041f85c8, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xb8558d094b438bb8, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x5253f97eb5c17592, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xd9886bbcd8c55620, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0xc8c63b5d9ed8026a, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xe0965504bf844f8e, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x508bbe3596662b86, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x083adf9d70244057, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x01d570815e6c3272, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xe660fc2a3e0d1465, AX
	ADDQ AX, DX
	MOVQ $0x8e5094d4b774faa0, AX
	ADCQ AX, CX
	MOVQ $0xea9d3862041f85c8, AX
	ADCQ AX, BX
	MOVQ $0xb8558d094b438bb8, AX
	ADCQ AX, SI
	MOVQ $0x5253f97eb5c17592, AX
	ADCQ AX, DI
	MOVQ $0xd9886bbcd8c55620, AX
	ADCQ AX, R8
	MOVQ $0xc8c63b5d9ed8026a, AX
	ADCQ AX, R9
	MOVQ $0xe0965504bf844f8e, AX
	ADCQ AX, R10
	MOVQ $0x508bbe3596662b86, AX
	ADCQ AX, R11
	MOVQ $0x083adf9d70244057, AX
	ADCQ AX, R12
	MOVQ $0x01d570815e6c3272, AX
	ADCQ AX, R13
