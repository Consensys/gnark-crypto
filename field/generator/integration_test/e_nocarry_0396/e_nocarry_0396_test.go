...
var benchRese_nocarry_0396 e_nocarry_0396

func BenchmarkE_nocarry_0396SetBytes(b *testing.B) {
	var x e_nocarry_0396
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0396MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0396.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0396)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0396)
		}
	})
}

func BenchmarkE_nocarry_0396Inverse(b *testing.B) {
	var x e_nocarry_0396
	x.SetRandom()
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0396Butterfly(b *testing.B) {
	var x e_nocarry_0396
	x.SetRandom()
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0396)
	}
}

func BenchmarkE_nocarry_0396Exp(b *testing.B) {
	var x e_nocarry_0396
	x.SetRandom()
	benchRese_nocarry_0396.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0396Double(b *testing.B) {
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Double(&benchRese_nocarry_0396)
	}
}

func BenchmarkE_nocarry_0396Add(b *testing.B) {
	var x e_nocarry_0396
	x.SetRandom()
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Add(&x, &benchRese_nocarry_0396)
	}
}

func BenchmarkE_nocarry_0396Sub(b *testing.B) {
	var x e_nocarry_0396
	x.SetRandom()
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Sub(&x, &benchRese_nocarry_0396)
	}
}

func BenchmarkE_nocarry_0396Neg(b *testing.B) {
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Neg(&benchRese_nocarry_0396)
	}
}

func BenchmarkE_nocarry_0396Div(b *testing.B) {
	var x e_nocarry_0396
	x.SetRandom()
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Div(&x, &benchRese_nocarry_0396)
	}
}

func BenchmarkE_nocarry_0396FromMont(b *testing.B) {
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.FromMont()
	}
}

func BenchmarkE_nocarry_0396ToMont(b *testing.B) {
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.ToMont()
	}
}
func BenchmarkE_nocarry_0396Square(b *testing.B) {
	benchRese_nocarry_0396.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Square(&benchRese_nocarry_0396)
	}
}

func BenchmarkE_nocarry_0396Sqrt(b *testing.B) {
	var a e_nocarry_0396
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0396Mul(b *testing.B) {
	x := e_nocarry_0396{
	...
	benchRese_nocarry_0396.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Mul(&benchRese_nocarry_0396, &x)
	}
}

func BenchmarkE_nocarry_0396Cmp(b *testing.B) {
	x := e_nocarry_0396{
		14471120860418268374,
		5282399995508875179,
		13095941626466059415,
	...
	benchRese_nocarry_0396 = x
	benchRese_nocarry_0396[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0396.Cmp(&x)
	}
}

func TestE_nocarry_0396Cmp(t *testing.T) {
	var x, y e_nocarry_0396
...
func TestE_nocarry_0396IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0396
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0396

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0396{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0396
	one.SetOne()
	e.Sub(&qe_nocarry_0396, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0396{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0396{0, uint64(i)})
	}
...
func TestE_nocarry_0396NegZero(t *testing.T) {
	var a, b e_nocarry_0396
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0396Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0396, len(staticTestValues))
...
func TestE_nocarry_0396Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0396) bool {
			var b e_nocarry_0396
...
func TestE_nocarry_0396InverseExp(t *testing.T) {
...
func TestE_nocarry_0396MulByConstants(t *testing.T) {
...
func TestE_nocarry_0396Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0396) bool {
...
func TestE_nocarry_0396LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0396Halve(t *testing.T) {
...
func TestE_nocarry_0396FromMont(t *testing.T) {
...
type testPaire_nocarry_0396 struct {
	element e_nocarry_0396
	bigint  big.Int
}

func (z *e_nocarry_0396) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0396[6] {
		return true
	}
	if z[6] < qe_nocarry_0396[6] {
		return false
	...
	return z[0] >= qe_nocarry_0396[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0396

		g.element = e_nocarry_0396{
		...
		if qe_nocarry_0396[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0396[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0396 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0396[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0396[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0396[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0396[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0396[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0396[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0396[6], carry)
...
func Benchmarke_nocarry_0396InverseNew(b *testing.B) {
	var x e_nocarry_0396
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0396
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0396
		var xInv e_nocarry_0396
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0396
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0396
...
func testLinearComb(t *testing.T, x *e_nocarry_0396, xC int64, y *e_nocarry_0396, yC int64) {
	...
	var z e_nocarry_0396
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0396, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0396
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0396, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0396
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0396, xHi uint64) {
	var res e_nocarry_0396
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0396) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0396) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0396, c int64, result *e_nocarry_0396, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0396) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0396) uint64 {
