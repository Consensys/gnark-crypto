...
var benchRese_nocarry_0481 e_nocarry_0481

func BenchmarkE_nocarry_0481SetBytes(b *testing.B) {
	var x e_nocarry_0481
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0481MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0481.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0481)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0481)
		}
	})
}

func BenchmarkE_nocarry_0481Inverse(b *testing.B) {
	var x e_nocarry_0481
	x.SetRandom()
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0481Butterfly(b *testing.B) {
	var x e_nocarry_0481
	x.SetRandom()
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0481)
	}
}

func BenchmarkE_nocarry_0481Exp(b *testing.B) {
	var x e_nocarry_0481
	x.SetRandom()
	benchRese_nocarry_0481.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0481Double(b *testing.B) {
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Double(&benchRese_nocarry_0481)
	}
}

func BenchmarkE_nocarry_0481Add(b *testing.B) {
	var x e_nocarry_0481
	x.SetRandom()
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Add(&x, &benchRese_nocarry_0481)
	}
}

func BenchmarkE_nocarry_0481Sub(b *testing.B) {
	var x e_nocarry_0481
	x.SetRandom()
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Sub(&x, &benchRese_nocarry_0481)
	}
}

func BenchmarkE_nocarry_0481Neg(b *testing.B) {
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Neg(&benchRese_nocarry_0481)
	}
}

func BenchmarkE_nocarry_0481Div(b *testing.B) {
	var x e_nocarry_0481
	x.SetRandom()
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Div(&x, &benchRese_nocarry_0481)
	}
}

func BenchmarkE_nocarry_0481FromMont(b *testing.B) {
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.FromMont()
	}
}

func BenchmarkE_nocarry_0481ToMont(b *testing.B) {
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.ToMont()
	}
}
func BenchmarkE_nocarry_0481Square(b *testing.B) {
	benchRese_nocarry_0481.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Square(&benchRese_nocarry_0481)
	}
}

func BenchmarkE_nocarry_0481Sqrt(b *testing.B) {
	var a e_nocarry_0481
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0481Mul(b *testing.B) {
	x := e_nocarry_0481{
		3249861530818714875,
		3692266792717862170,
	...
	benchRese_nocarry_0481.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Mul(&benchRese_nocarry_0481, &x)
	}
}

func BenchmarkE_nocarry_0481Cmp(b *testing.B) {
	x := e_nocarry_0481{
		3249861530818714875,
		3692266792717862170,
		16828778314014308149,
	...
	benchRese_nocarry_0481 = x
	benchRese_nocarry_0481[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0481.Cmp(&x)
	}
}

func TestE_nocarry_0481Cmp(t *testing.T) {
	var x, y e_nocarry_0481
...
func TestE_nocarry_0481IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0481
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0481

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0481{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0481
	one.SetOne()
	e.Sub(&qe_nocarry_0481, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0481{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0481{0, uint64(i)})
	}
...
func TestE_nocarry_0481NegZero(t *testing.T) {
	var a, b e_nocarry_0481
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0481Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0481, len(staticTestValues))
...
func TestE_nocarry_0481Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0481) bool {
			var b e_nocarry_0481
...
func TestE_nocarry_0481InverseExp(t *testing.T) {
...
func TestE_nocarry_0481MulByConstants(t *testing.T) {
...
func TestE_nocarry_0481Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0481) bool {
...
func TestE_nocarry_0481LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0481Halve(t *testing.T) {
...
func TestE_nocarry_0481FromMont(t *testing.T) {
...
type testPaire_nocarry_0481 struct {
	element e_nocarry_0481
	bigint  big.Int
}

func (z *e_nocarry_0481) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0481[7] {
		return true
	}
	if z[7] < qe_nocarry_0481[7] {
		return false
	...
	return z[0] >= qe_nocarry_0481[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0481

		g.element = e_nocarry_0481{
		...
		if qe_nocarry_0481[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0481[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0481 {
			var g e_nocarry_0481
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0481[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0481[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0481[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0481[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0481[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0481[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0481[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0481[7], carry)
...
func Benchmarke_nocarry_0481InverseNew(b *testing.B) {
	var x e_nocarry_0481
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0481
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0481
		var xInv e_nocarry_0481
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0481
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0481
...
func testLinearComb(t *testing.T, x *e_nocarry_0481, xC int64, y *e_nocarry_0481, yC int64) {
	...
	var z e_nocarry_0481
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0481, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0481
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0481, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0481
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0481, xHi uint64) {
	var res e_nocarry_0481
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0481) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0481) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0481, c int64, result *e_nocarry_0481, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0481) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0481) uint64 {
