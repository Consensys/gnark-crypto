...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x29a1feb2a70099c9, R13
	ADDQ R13, AX
	MOVQ $0x740001aedf4ad6f2, R13
	ADCQ R13, DX
	MOVQ $0x5312459df046c63b, R13
	ADCQ R13, CX
	MOVQ $0xfc1de16528406af2, R13
	ADCQ R13, BX
	MOVQ $0x879f4b30dd6f781a, R13
	ADCQ R13, SI
	MOVQ $0xd52e4e5ec4fbd33b, R13
	ADCQ R13, DI
	MOVQ $0x0de429cd32525c31, R13
	ADCQ R13, R8
	MOVQ $0x9699664d1f736c50, R13
	ADCQ R13, R9
	MOVQ $0x486c407d4ef759af, R13
	ADCQ R13, R10
	MOVQ $0x00000061a8bd9b27, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x29a1feb2a70099c9, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0x740001aedf4ad6f2, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x5312459df046c63b, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0xfc1de16528406af2, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x879f4b30dd6f781a, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xd52e4e5ec4fbd33b, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0x0de429cd32525c31, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x9699664d1f736c50, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x486c407d4ef759af, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x00000061a8bd9b27, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x29a1feb2a70099c9, AX
	ADDQ AX, DX
	MOVQ $0x740001aedf4ad6f2, AX
	ADCQ AX, CX
	MOVQ $0x5312459df046c63b, AX
	ADCQ AX, BX
	MOVQ $0xfc1de16528406af2, AX
	ADCQ AX, SI
	MOVQ $0x879f4b30dd6f781a, AX
	ADCQ AX, DI
	MOVQ $0xd52e4e5ec4fbd33b, AX
	ADCQ AX, R8
	MOVQ $0x0de429cd32525c31, AX
	ADCQ AX, R9
	MOVQ $0x9699664d1f736c50, AX
	ADCQ AX, R10
	MOVQ $0x486c407d4ef759af, AX
	ADCQ AX, R11
	MOVQ $0x00000061a8bd9b27, AX
	ADCQ AX, R12
