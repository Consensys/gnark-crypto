...
var benchRese_nocarry_0615 e_nocarry_0615

func BenchmarkE_nocarry_0615SetBytes(b *testing.B) {
	var x e_nocarry_0615
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0615MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0615.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0615)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0615)
		}
	})
}

func BenchmarkE_nocarry_0615Inverse(b *testing.B) {
	var x e_nocarry_0615
	x.SetRandom()
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0615Butterfly(b *testing.B) {
	var x e_nocarry_0615
	x.SetRandom()
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0615)
	}
}

func BenchmarkE_nocarry_0615Exp(b *testing.B) {
	var x e_nocarry_0615
	x.SetRandom()
	benchRese_nocarry_0615.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0615Double(b *testing.B) {
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Double(&benchRese_nocarry_0615)
	}
}

func BenchmarkE_nocarry_0615Add(b *testing.B) {
	var x e_nocarry_0615
	x.SetRandom()
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Add(&x, &benchRese_nocarry_0615)
	}
}

func BenchmarkE_nocarry_0615Sub(b *testing.B) {
	var x e_nocarry_0615
	x.SetRandom()
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Sub(&x, &benchRese_nocarry_0615)
	}
}

func BenchmarkE_nocarry_0615Neg(b *testing.B) {
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Neg(&benchRese_nocarry_0615)
	}
}

func BenchmarkE_nocarry_0615Div(b *testing.B) {
	var x e_nocarry_0615
	x.SetRandom()
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Div(&x, &benchRese_nocarry_0615)
	}
}

func BenchmarkE_nocarry_0615FromMont(b *testing.B) {
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.FromMont()
	}
}

func BenchmarkE_nocarry_0615ToMont(b *testing.B) {
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.ToMont()
	}
}
func BenchmarkE_nocarry_0615Square(b *testing.B) {
	benchRese_nocarry_0615.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Square(&benchRese_nocarry_0615)
	}
}

func BenchmarkE_nocarry_0615Sqrt(b *testing.B) {
	var a e_nocarry_0615
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0615Mul(b *testing.B) {
	x := e_nocarry_0615{
	...
	benchRese_nocarry_0615.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Mul(&benchRese_nocarry_0615, &x)
	}
}

func BenchmarkE_nocarry_0615Cmp(b *testing.B) {
	x := e_nocarry_0615{
		15969649469841155806,
		7207306087117004515,
		12799550529485141632,
	...
	benchRese_nocarry_0615 = x
	benchRese_nocarry_0615[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0615.Cmp(&x)
	}
}

func TestE_nocarry_0615Cmp(t *testing.T) {
	var x, y e_nocarry_0615
...
func TestE_nocarry_0615IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0615
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0615

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0615{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0615
	one.SetOne()
	e.Sub(&qe_nocarry_0615, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0615{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0615{0, uint64(i)})
	}
...
func TestE_nocarry_0615NegZero(t *testing.T) {
	var a, b e_nocarry_0615
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0615Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0615, len(staticTestValues))
...
func TestE_nocarry_0615Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0615) bool {
			var b e_nocarry_0615
...
func TestE_nocarry_0615InverseExp(t *testing.T) {
...
func TestE_nocarry_0615MulByConstants(t *testing.T) {
...
func TestE_nocarry_0615Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0615) bool {
...
func TestE_nocarry_0615LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0615Halve(t *testing.T) {
...
func TestE_nocarry_0615FromMont(t *testing.T) {
...
type testPaire_nocarry_0615 struct {
	element e_nocarry_0615
	bigint  big.Int
}

func (z *e_nocarry_0615) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0615[9] {
		return true
	}
	if z[9] < qe_nocarry_0615[9] {
		return false
	...
	return z[0] >= qe_nocarry_0615[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0615

		g.element = e_nocarry_0615{
		...
		if qe_nocarry_0615[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0615[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0615 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0615[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0615[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0615[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0615[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0615[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0615[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0615[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0615[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0615[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0615[9], carry)
...
func Benchmarke_nocarry_0615InverseNew(b *testing.B) {
	var x e_nocarry_0615
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0615
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0615
		var xInv e_nocarry_0615
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0615
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0615
...
func testLinearComb(t *testing.T, x *e_nocarry_0615, xC int64, y *e_nocarry_0615, yC int64) {
	...
	var z e_nocarry_0615
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0615, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0615
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0615, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0615
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0615, xHi uint64) {
	var res e_nocarry_0615
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0615) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0615) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0615, c int64, result *e_nocarry_0615, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0615) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0615) uint64 {
