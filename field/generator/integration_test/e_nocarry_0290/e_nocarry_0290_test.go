...
var benchRese_nocarry_0290 e_nocarry_0290

func BenchmarkE_nocarry_0290SetBytes(b *testing.B) {
	var x e_nocarry_0290
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0290MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0290.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0290)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0290)
		}
	})
}

func BenchmarkE_nocarry_0290Inverse(b *testing.B) {
	var x e_nocarry_0290
	x.SetRandom()
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0290Butterfly(b *testing.B) {
	var x e_nocarry_0290
	x.SetRandom()
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0290)
	}
}

func BenchmarkE_nocarry_0290Exp(b *testing.B) {
	var x e_nocarry_0290
	x.SetRandom()
	benchRese_nocarry_0290.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0290Double(b *testing.B) {
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Double(&benchRese_nocarry_0290)
	}
}

func BenchmarkE_nocarry_0290Add(b *testing.B) {
	var x e_nocarry_0290
	x.SetRandom()
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Add(&x, &benchRese_nocarry_0290)
	}
}

func BenchmarkE_nocarry_0290Sub(b *testing.B) {
	var x e_nocarry_0290
	x.SetRandom()
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Sub(&x, &benchRese_nocarry_0290)
	}
}

func BenchmarkE_nocarry_0290Neg(b *testing.B) {
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Neg(&benchRese_nocarry_0290)
	}
}

func BenchmarkE_nocarry_0290Div(b *testing.B) {
	var x e_nocarry_0290
	x.SetRandom()
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Div(&x, &benchRese_nocarry_0290)
	}
}

func BenchmarkE_nocarry_0290FromMont(b *testing.B) {
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.FromMont()
	}
}

func BenchmarkE_nocarry_0290ToMont(b *testing.B) {
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.ToMont()
	}
}
func BenchmarkE_nocarry_0290Square(b *testing.B) {
	benchRese_nocarry_0290.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Square(&benchRese_nocarry_0290)
	}
}

func BenchmarkE_nocarry_0290Sqrt(b *testing.B) {
	var a e_nocarry_0290
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0290Mul(b *testing.B) {
	x := e_nocarry_0290{
		5294197420184893513,
		3662439483647064963,
		5209938850927049621,
	...
	benchRese_nocarry_0290.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Mul(&benchRese_nocarry_0290, &x)
	}
}

func BenchmarkE_nocarry_0290Cmp(b *testing.B) {
	x := e_nocarry_0290{
		5294197420184893513,
		3662439483647064963,
		5209938850927049621,
	...
	benchRese_nocarry_0290 = x
	benchRese_nocarry_0290[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0290.Cmp(&x)
	}
}

func TestE_nocarry_0290Cmp(t *testing.T) {
	var x, y e_nocarry_0290
...
func TestE_nocarry_0290IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0290
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0290

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0290{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0290
	one.SetOne()
	e.Sub(&qe_nocarry_0290, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0290{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0290{0, uint64(i)})
	}
...
func TestE_nocarry_0290NegZero(t *testing.T) {
	var a, b e_nocarry_0290
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0290Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0290, len(staticTestValues))
...
func TestE_nocarry_0290Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0290) bool {
			var b e_nocarry_0290
...
func TestE_nocarry_0290InverseExp(t *testing.T) {
...
func TestE_nocarry_0290MulByConstants(t *testing.T) {
...
func TestE_nocarry_0290Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0290) bool {
...
func TestE_nocarry_0290LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0290Halve(t *testing.T) {
...
func TestE_nocarry_0290FromMont(t *testing.T) {
...
type testPaire_nocarry_0290 struct {
	element e_nocarry_0290
	bigint  big.Int
}

func (z *e_nocarry_0290) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0290[4] {
		return true
	}
	if z[4] < qe_nocarry_0290[4] {
		return false
	...
	return z[0] >= qe_nocarry_0290[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0290

		g.element = e_nocarry_0290{
		...
		if qe_nocarry_0290[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0290[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0290 {
			var g e_nocarry_0290
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0290[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0290[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0290[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0290[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0290[4], carry)
...
func Benchmarke_nocarry_0290InverseNew(b *testing.B) {
	var x e_nocarry_0290
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0290
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0290
		var xInv e_nocarry_0290
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0290
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0290
...
func testLinearComb(t *testing.T, x *e_nocarry_0290, xC int64, y *e_nocarry_0290, yC int64) {
	...
	var z e_nocarry_0290
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0290, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0290
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0290, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0290
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0290, xHi uint64) {
	var res e_nocarry_0290
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0290) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0290) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0290, c int64, result *e_nocarry_0290, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0290) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0290) uint64 {
