...
// modulus q
DATA q<>+0(SB)/8, $0x42e7d8a257b410b7
DATA q<>+8(SB)/8, $0xe64992bc88d9a893
DATA q<>+16(SB)/8, $0x51a1284fb186a029
DATA q<>+24(SB)/8, $0x62be50b7c48f3295
DATA q<>+32(SB)/8, $0x00000003352ff8d0
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x706b2b34662832f9
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x42e7d8a257b410b7, R9
	MOVQ    $0xe64992bc88d9a893, R10
	MOVQ    $0x51a1284fb186a029, R11
	MOVQ    $0x62be50b7c48f3295, R12
	MOVQ    $0x00000003352ff8d0, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0xe64992bc88d9a893, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x51a1284fb186a029, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0x62be50b7c48f3295, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00000003352ff8d0, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x42e7d8a257b410b7, CX
	MOVQ    $0xe64992bc88d9a893, BX
	MOVQ    $0x51a1284fb186a029, SI
	MOVQ    $0x62be50b7c48f3295, DI
	MOVQ    $0x00000003352ff8d0, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
