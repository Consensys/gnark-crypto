...
var benchRese_nocarry_0346 e_nocarry_0346

func BenchmarkE_nocarry_0346SetBytes(b *testing.B) {
	var x e_nocarry_0346
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0346MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0346.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0346)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0346)
		}
	})
}

func BenchmarkE_nocarry_0346Inverse(b *testing.B) {
	var x e_nocarry_0346
	x.SetRandom()
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0346Butterfly(b *testing.B) {
	var x e_nocarry_0346
	x.SetRandom()
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0346)
	}
}

func BenchmarkE_nocarry_0346Exp(b *testing.B) {
	var x e_nocarry_0346
	x.SetRandom()
	benchRese_nocarry_0346.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0346Double(b *testing.B) {
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Double(&benchRese_nocarry_0346)
	}
}

func BenchmarkE_nocarry_0346Add(b *testing.B) {
	var x e_nocarry_0346
	x.SetRandom()
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Add(&x, &benchRese_nocarry_0346)
	}
}

func BenchmarkE_nocarry_0346Sub(b *testing.B) {
	var x e_nocarry_0346
	x.SetRandom()
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Sub(&x, &benchRese_nocarry_0346)
	}
}

func BenchmarkE_nocarry_0346Neg(b *testing.B) {
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Neg(&benchRese_nocarry_0346)
	}
}

func BenchmarkE_nocarry_0346Div(b *testing.B) {
	var x e_nocarry_0346
	x.SetRandom()
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Div(&x, &benchRese_nocarry_0346)
	}
}

func BenchmarkE_nocarry_0346FromMont(b *testing.B) {
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.FromMont()
	}
}

func BenchmarkE_nocarry_0346ToMont(b *testing.B) {
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.ToMont()
	}
}
func BenchmarkE_nocarry_0346Square(b *testing.B) {
	benchRese_nocarry_0346.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Square(&benchRese_nocarry_0346)
	}
}

func BenchmarkE_nocarry_0346Sqrt(b *testing.B) {
	var a e_nocarry_0346
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0346Mul(b *testing.B) {
	x := e_nocarry_0346{
	...
	benchRese_nocarry_0346.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Mul(&benchRese_nocarry_0346, &x)
	}
}

func BenchmarkE_nocarry_0346Cmp(b *testing.B) {
	x := e_nocarry_0346{
		13099592158363587697,
		3430272145355622417,
		17842748343799541339,
	...
	benchRese_nocarry_0346 = x
	benchRese_nocarry_0346[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0346.Cmp(&x)
	}
}

func TestE_nocarry_0346Cmp(t *testing.T) {
	var x, y e_nocarry_0346
...
func TestE_nocarry_0346IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0346
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0346

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0346{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0346
	one.SetOne()
	e.Sub(&qe_nocarry_0346, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0346{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0346{0, uint64(i)})
	}
...
func TestE_nocarry_0346NegZero(t *testing.T) {
	var a, b e_nocarry_0346
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0346Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0346, len(staticTestValues))
...
func TestE_nocarry_0346Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0346) bool {
			var b e_nocarry_0346
...
func TestE_nocarry_0346InverseExp(t *testing.T) {
...
func TestE_nocarry_0346MulByConstants(t *testing.T) {
...
func TestE_nocarry_0346Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0346) bool {
...
func TestE_nocarry_0346LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0346Halve(t *testing.T) {
...
func TestE_nocarry_0346FromMont(t *testing.T) {
...
type testPaire_nocarry_0346 struct {
	element e_nocarry_0346
	bigint  big.Int
}

func (z *e_nocarry_0346) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0346[5] {
		return true
	}
	if z[5] < qe_nocarry_0346[5] {
		return false
	...
	return z[0] >= qe_nocarry_0346[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0346

		g.element = e_nocarry_0346{
		...
		if qe_nocarry_0346[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0346[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0346 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0346[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0346[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0346[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0346[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0346[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0346[5], carry)
...
func Benchmarke_nocarry_0346InverseNew(b *testing.B) {
	var x e_nocarry_0346
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0346
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0346
		var xInv e_nocarry_0346
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0346
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0346
...
func testLinearComb(t *testing.T, x *e_nocarry_0346, xC int64, y *e_nocarry_0346, yC int64) {
	...
	var z e_nocarry_0346
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0346, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0346
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0346, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0346
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0346, xHi uint64) {
	var res e_nocarry_0346
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0346) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0346) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0346, c int64, result *e_nocarry_0346, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0346) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0346) uint64 {
