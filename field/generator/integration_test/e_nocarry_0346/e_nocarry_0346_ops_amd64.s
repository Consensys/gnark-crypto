...
// modulus q
DATA q<>+0(SB)/8, $0x5aa957431c90b719
DATA q<>+8(SB)/8, $0x4896d0b5e2a30bc4
DATA q<>+16(SB)/8, $0xf04f0b45c3a5e30d
DATA q<>+24(SB)/8, $0xeb6ceea830c7c4b9
DATA q<>+32(SB)/8, $0x34c50fbdf7f75309
DATA q<>+40(SB)/8, $0x00000000033e51d2
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xb792aa4027f14ad7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x5aa957431c90b719, R10
	MOVQ    $0x4896d0b5e2a30bc4, R11
	MOVQ    $0xf04f0b45c3a5e30d, R12
	MOVQ    $0xeb6ceea830c7c4b9, R13
	MOVQ    $0x34c50fbdf7f75309, R14
	MOVQ    $0x00000000033e51d2, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x4896d0b5e2a30bc4, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xf04f0b45c3a5e30d, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xeb6ceea830c7c4b9, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x34c50fbdf7f75309, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000000033e51d2, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x5aa957431c90b719, CX
	MOVQ    $0x4896d0b5e2a30bc4, BX
	MOVQ    $0xf04f0b45c3a5e30d, SI
	MOVQ    $0xeb6ceea830c7c4b9, DI
	MOVQ    $0x34c50fbdf7f75309, R8
	MOVQ    $0x00000000033e51d2, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
