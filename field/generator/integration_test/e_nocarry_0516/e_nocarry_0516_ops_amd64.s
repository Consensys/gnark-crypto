...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xfc6e910117de7d19, R12
	ADDQ R12, AX
	MOVQ $0x344f57460af7ae6b, R12
	ADCQ R12, DX
	MOVQ $0xcb1a6313c92bea77, R12
	ADCQ R12, CX
	MOVQ $0x97ca42562fb1b831, R12
	ADCQ R12, BX
	MOVQ $0xfc635c17221a5048, R12
	ADCQ R12, SI
	MOVQ $0xa221ac7be0e768b5, R12
	ADCQ R12, DI
	MOVQ $0xe741a7af06f17781, R12
	ADCQ R12, R8
	MOVQ $0x315e421de9d10d05, R12
	ADCQ R12, R9
	MOVQ $0x000000000000000d, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xfc6e910117de7d19, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x344f57460af7ae6b, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0xcb1a6313c92bea77, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x97ca42562fb1b831, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xfc635c17221a5048, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xa221ac7be0e768b5, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xe741a7af06f17781, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x315e421de9d10d05, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xfc6e910117de7d19, AX
	ADDQ AX, DX
	MOVQ $0x344f57460af7ae6b, AX
	ADCQ AX, CX
	MOVQ $0xcb1a6313c92bea77, AX
	ADCQ AX, BX
	MOVQ $0x97ca42562fb1b831, AX
	ADCQ AX, SI
	MOVQ $0xfc635c17221a5048, AX
	ADCQ AX, DI
	MOVQ $0xa221ac7be0e768b5, AX
	ADCQ AX, R8
	MOVQ $0xe741a7af06f17781, AX
	ADCQ AX, R9
	MOVQ $0x315e421de9d10d05, AX
	ADCQ AX, R10
