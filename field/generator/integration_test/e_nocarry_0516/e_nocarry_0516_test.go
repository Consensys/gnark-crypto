...
var benchRese_nocarry_0516 e_nocarry_0516

func BenchmarkE_nocarry_0516SetBytes(b *testing.B) {
	var x e_nocarry_0516
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0516MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0516.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0516)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0516)
		}
	})
}

func BenchmarkE_nocarry_0516Inverse(b *testing.B) {
	var x e_nocarry_0516
	x.SetRandom()
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0516Butterfly(b *testing.B) {
	var x e_nocarry_0516
	x.SetRandom()
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0516)
	}
}

func BenchmarkE_nocarry_0516Exp(b *testing.B) {
	var x e_nocarry_0516
	x.SetRandom()
	benchRese_nocarry_0516.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0516Double(b *testing.B) {
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Double(&benchRese_nocarry_0516)
	}
}

func BenchmarkE_nocarry_0516Add(b *testing.B) {
	var x e_nocarry_0516
	x.SetRandom()
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Add(&x, &benchRese_nocarry_0516)
	}
}

func BenchmarkE_nocarry_0516Sub(b *testing.B) {
	var x e_nocarry_0516
	x.SetRandom()
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Sub(&x, &benchRese_nocarry_0516)
	}
}

func BenchmarkE_nocarry_0516Neg(b *testing.B) {
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Neg(&benchRese_nocarry_0516)
	}
}

func BenchmarkE_nocarry_0516Div(b *testing.B) {
	var x e_nocarry_0516
	x.SetRandom()
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Div(&x, &benchRese_nocarry_0516)
	}
}

func BenchmarkE_nocarry_0516FromMont(b *testing.B) {
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.FromMont()
	}
}

func BenchmarkE_nocarry_0516ToMont(b *testing.B) {
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.ToMont()
	}
}
func BenchmarkE_nocarry_0516Square(b *testing.B) {
	benchRese_nocarry_0516.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Square(&benchRese_nocarry_0516)
	}
}

func BenchmarkE_nocarry_0516Sqrt(b *testing.B) {
	var a e_nocarry_0516
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0516Mul(b *testing.B) {
	x := e_nocarry_0516{
		2899066734410582513,
	...
	benchRese_nocarry_0516.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Mul(&benchRese_nocarry_0516, &x)
	}
}

func BenchmarkE_nocarry_0516Cmp(b *testing.B) {
	x := e_nocarry_0516{
		2899066734410582513,
		15330176247950113335,
		1320797085807812905,
	...
	benchRese_nocarry_0516 = x
	benchRese_nocarry_0516[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0516.Cmp(&x)
	}
}

func TestE_nocarry_0516Cmp(t *testing.T) {
	var x, y e_nocarry_0516
...
func TestE_nocarry_0516IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0516
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0516

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0516{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0516
	one.SetOne()
	e.Sub(&qe_nocarry_0516, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0516{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0516{0, uint64(i)})
	}
...
func TestE_nocarry_0516NegZero(t *testing.T) {
	var a, b e_nocarry_0516
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0516Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0516, len(staticTestValues))
...
func TestE_nocarry_0516Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0516) bool {
			var b e_nocarry_0516
...
func TestE_nocarry_0516InverseExp(t *testing.T) {
...
func TestE_nocarry_0516MulByConstants(t *testing.T) {
...
func TestE_nocarry_0516Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0516) bool {
...
func TestE_nocarry_0516LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0516Halve(t *testing.T) {
...
func TestE_nocarry_0516FromMont(t *testing.T) {
...
type testPaire_nocarry_0516 struct {
	element e_nocarry_0516
	bigint  big.Int
}

func (z *e_nocarry_0516) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0516[8] {
		return true
	}
	if z[8] < qe_nocarry_0516[8] {
		return false
	...
	return z[0] >= qe_nocarry_0516[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0516

		g.element = e_nocarry_0516{
		...
		if qe_nocarry_0516[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0516[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0516 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0516[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0516[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0516[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0516[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0516[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0516[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0516[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0516[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0516[8], carry)
...
func Benchmarke_nocarry_0516InverseNew(b *testing.B) {
	var x e_nocarry_0516
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0516
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0516
		var xInv e_nocarry_0516
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0516
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0516
...
func testLinearComb(t *testing.T, x *e_nocarry_0516, xC int64, y *e_nocarry_0516, yC int64) {
	...
	var z e_nocarry_0516
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0516, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0516
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0516, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0516
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0516, xHi uint64) {
	var res e_nocarry_0516
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0516) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0516) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0516, c int64, result *e_nocarry_0516, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0516) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0516) uint64 {
