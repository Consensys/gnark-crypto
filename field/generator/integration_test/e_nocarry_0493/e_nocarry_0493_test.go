...
var benchRese_nocarry_0493 e_nocarry_0493

func BenchmarkE_nocarry_0493SetBytes(b *testing.B) {
	var x e_nocarry_0493
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0493MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0493.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0493)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0493)
		}
	})
}

func BenchmarkE_nocarry_0493Inverse(b *testing.B) {
	var x e_nocarry_0493
	x.SetRandom()
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0493Butterfly(b *testing.B) {
	var x e_nocarry_0493
	x.SetRandom()
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0493)
	}
}

func BenchmarkE_nocarry_0493Exp(b *testing.B) {
	var x e_nocarry_0493
	x.SetRandom()
	benchRese_nocarry_0493.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0493Double(b *testing.B) {
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Double(&benchRese_nocarry_0493)
	}
}

func BenchmarkE_nocarry_0493Add(b *testing.B) {
	var x e_nocarry_0493
	x.SetRandom()
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Add(&x, &benchRese_nocarry_0493)
	}
}

func BenchmarkE_nocarry_0493Sub(b *testing.B) {
	var x e_nocarry_0493
	x.SetRandom()
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Sub(&x, &benchRese_nocarry_0493)
	}
}

func BenchmarkE_nocarry_0493Neg(b *testing.B) {
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Neg(&benchRese_nocarry_0493)
	}
}

func BenchmarkE_nocarry_0493Div(b *testing.B) {
	var x e_nocarry_0493
	x.SetRandom()
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Div(&x, &benchRese_nocarry_0493)
	}
}

func BenchmarkE_nocarry_0493FromMont(b *testing.B) {
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.FromMont()
	}
}

func BenchmarkE_nocarry_0493ToMont(b *testing.B) {
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.ToMont()
	}
}
func BenchmarkE_nocarry_0493Square(b *testing.B) {
	benchRese_nocarry_0493.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Square(&benchRese_nocarry_0493)
	}
}

func BenchmarkE_nocarry_0493Sqrt(b *testing.B) {
	var a e_nocarry_0493
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0493Mul(b *testing.B) {
	x := e_nocarry_0493{
	...
	benchRese_nocarry_0493.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Mul(&benchRese_nocarry_0493, &x)
	}
}

func BenchmarkE_nocarry_0493Cmp(b *testing.B) {
	x := e_nocarry_0493{
		10003085902455800369,
		4667547867073978671,
		12305349200503093400,
	...
	benchRese_nocarry_0493 = x
	benchRese_nocarry_0493[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0493.Cmp(&x)
	}
}

func TestE_nocarry_0493Cmp(t *testing.T) {
	var x, y e_nocarry_0493
...
func TestE_nocarry_0493IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0493
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0493

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0493{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0493
	one.SetOne()
	e.Sub(&qe_nocarry_0493, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0493{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0493{0, uint64(i)})
	}
...
func TestE_nocarry_0493NegZero(t *testing.T) {
	var a, b e_nocarry_0493
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0493Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0493, len(staticTestValues))
...
func TestE_nocarry_0493Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0493) bool {
			var b e_nocarry_0493
...
func TestE_nocarry_0493InverseExp(t *testing.T) {
...
func TestE_nocarry_0493MulByConstants(t *testing.T) {
...
func TestE_nocarry_0493Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0493) bool {
...
func TestE_nocarry_0493LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0493Halve(t *testing.T) {
...
func TestE_nocarry_0493FromMont(t *testing.T) {
...
type testPaire_nocarry_0493 struct {
	element e_nocarry_0493
	bigint  big.Int
}

func (z *e_nocarry_0493) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0493[7] {
		return true
	}
	if z[7] < qe_nocarry_0493[7] {
		return false
	...
	return z[0] >= qe_nocarry_0493[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0493

		g.element = e_nocarry_0493{
		...
		if qe_nocarry_0493[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0493[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0493 {
			var g e_nocarry_0493
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0493[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0493[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0493[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0493[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0493[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0493[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0493[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0493[7], carry)
...
func Benchmarke_nocarry_0493InverseNew(b *testing.B) {
	var x e_nocarry_0493
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0493
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0493
		var xInv e_nocarry_0493
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0493
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0493
...
func testLinearComb(t *testing.T, x *e_nocarry_0493, xC int64, y *e_nocarry_0493, yC int64) {
	...
	var z e_nocarry_0493
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0493, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0493
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0493, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0493
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0493, xHi uint64) {
	var res e_nocarry_0493
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0493) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0493) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0493, c int64, result *e_nocarry_0493, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0493) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0493) uint64 {
