...
var benchRese_nocarry_0182 e_nocarry_0182

func BenchmarkE_nocarry_0182SetBytes(b *testing.B) {
	var x e_nocarry_0182
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0182MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0182.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0182)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0182)
		}
	})
}

func BenchmarkE_nocarry_0182Inverse(b *testing.B) {
	var x e_nocarry_0182
	x.SetRandom()
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0182Butterfly(b *testing.B) {
	var x e_nocarry_0182
	x.SetRandom()
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0182)
	}
}

func BenchmarkE_nocarry_0182Exp(b *testing.B) {
	var x e_nocarry_0182
	x.SetRandom()
	benchRese_nocarry_0182.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0182Double(b *testing.B) {
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Double(&benchRese_nocarry_0182)
	}
}

func BenchmarkE_nocarry_0182Add(b *testing.B) {
	var x e_nocarry_0182
	x.SetRandom()
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Add(&x, &benchRese_nocarry_0182)
	}
}

func BenchmarkE_nocarry_0182Sub(b *testing.B) {
	var x e_nocarry_0182
	x.SetRandom()
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Sub(&x, &benchRese_nocarry_0182)
	}
}

func BenchmarkE_nocarry_0182Neg(b *testing.B) {
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Neg(&benchRese_nocarry_0182)
	}
}

func BenchmarkE_nocarry_0182Div(b *testing.B) {
	var x e_nocarry_0182
	x.SetRandom()
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Div(&x, &benchRese_nocarry_0182)
	}
}

func BenchmarkE_nocarry_0182FromMont(b *testing.B) {
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.FromMont()
	}
}

func BenchmarkE_nocarry_0182ToMont(b *testing.B) {
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.ToMont()
	}
}
func BenchmarkE_nocarry_0182Square(b *testing.B) {
	benchRese_nocarry_0182.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Square(&benchRese_nocarry_0182)
	}
}

func BenchmarkE_nocarry_0182Sqrt(b *testing.B) {
	var a e_nocarry_0182
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0182Mul(b *testing.B) {
	x := e_nocarry_0182{
		13372478764990562020,
		13426974617208620389,
		5657142656074663,
	}
	benchRese_nocarry_0182.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Mul(&benchRese_nocarry_0182, &x)
	}
}

func BenchmarkE_nocarry_0182Cmp(b *testing.B) {
	x := e_nocarry_0182{
		13372478764990562020,
		13426974617208620389,
		5657142656074663,
	}
	benchRese_nocarry_0182 = x
	benchRese_nocarry_0182[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0182.Cmp(&x)
	}
}

func TestE_nocarry_0182Cmp(t *testing.T) {
	var x, y e_nocarry_0182
...
func TestE_nocarry_0182IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0182
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0182

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0182{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0182
	one.SetOne()
	e.Sub(&qe_nocarry_0182, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0182{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0182{0, uint64(i)})
	}
...
func TestE_nocarry_0182NegZero(t *testing.T) {
	var a, b e_nocarry_0182
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0182Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0182, len(staticTestValues))
...
func TestE_nocarry_0182Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0182) bool {
			var b e_nocarry_0182
...
func TestE_nocarry_0182InverseExp(t *testing.T) {
...
func TestE_nocarry_0182MulByConstants(t *testing.T) {
...
func TestE_nocarry_0182Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0182) bool {
...
func TestE_nocarry_0182LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0182Halve(t *testing.T) {
...
func TestE_nocarry_0182FromMont(t *testing.T) {
...
type testPaire_nocarry_0182 struct {
	element e_nocarry_0182
	bigint  big.Int
}

func (z *e_nocarry_0182) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0182[2] {
		return true
	}
	if z[2] < qe_nocarry_0182[2] {
		return false
	...
	return z[0] >= qe_nocarry_0182[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0182

		g.element = e_nocarry_0182{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0182[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0182[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0182 {
			var g e_nocarry_0182
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0182[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0182[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0182[2], carry)
...
func Benchmarke_nocarry_0182InverseNew(b *testing.B) {
	var x e_nocarry_0182
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0182
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0182
		var xInv e_nocarry_0182
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0182
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0182
...
func testLinearComb(t *testing.T, x *e_nocarry_0182, xC int64, y *e_nocarry_0182, yC int64) {
	...
	var z e_nocarry_0182
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0182, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0182
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0182, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0182
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0182, xHi uint64) {
	var res e_nocarry_0182
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0182) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0182) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0182, c int64, result *e_nocarry_0182, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0182) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0182) uint64 {
