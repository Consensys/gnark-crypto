...
var benchRese_nocarry_0133 e_nocarry_0133

func BenchmarkE_nocarry_0133SetBytes(b *testing.B) {
	var x e_nocarry_0133
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0133MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0133.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0133)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0133)
		}
	})
}

func BenchmarkE_nocarry_0133Inverse(b *testing.B) {
	var x e_nocarry_0133
	x.SetRandom()
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0133Butterfly(b *testing.B) {
	var x e_nocarry_0133
	x.SetRandom()
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0133)
	}
}

func BenchmarkE_nocarry_0133Exp(b *testing.B) {
	var x e_nocarry_0133
	x.SetRandom()
	benchRese_nocarry_0133.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0133Double(b *testing.B) {
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Double(&benchRese_nocarry_0133)
	}
}

func BenchmarkE_nocarry_0133Add(b *testing.B) {
	var x e_nocarry_0133
	x.SetRandom()
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Add(&x, &benchRese_nocarry_0133)
	}
}

func BenchmarkE_nocarry_0133Sub(b *testing.B) {
	var x e_nocarry_0133
	x.SetRandom()
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Sub(&x, &benchRese_nocarry_0133)
	}
}

func BenchmarkE_nocarry_0133Neg(b *testing.B) {
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Neg(&benchRese_nocarry_0133)
	}
}

func BenchmarkE_nocarry_0133Div(b *testing.B) {
	var x e_nocarry_0133
	x.SetRandom()
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Div(&x, &benchRese_nocarry_0133)
	}
}

func BenchmarkE_nocarry_0133FromMont(b *testing.B) {
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.FromMont()
	}
}

func BenchmarkE_nocarry_0133ToMont(b *testing.B) {
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.ToMont()
	}
}
func BenchmarkE_nocarry_0133Square(b *testing.B) {
	benchRese_nocarry_0133.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Square(&benchRese_nocarry_0133)
	}
}

func BenchmarkE_nocarry_0133Sqrt(b *testing.B) {
	var a e_nocarry_0133
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0133Mul(b *testing.B) {
	x := e_nocarry_0133{
		11747942375503238252,
		2265073719373895254,
		8,
	}
	benchRese_nocarry_0133.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Mul(&benchRese_nocarry_0133, &x)
	}
}

func BenchmarkE_nocarry_0133Cmp(b *testing.B) {
	x := e_nocarry_0133{
		11747942375503238252,
		2265073719373895254,
		8,
	}
	benchRese_nocarry_0133 = x
	benchRese_nocarry_0133[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0133.Cmp(&x)
	}
}

func TestE_nocarry_0133Cmp(t *testing.T) {
	var x, y e_nocarry_0133
...
func TestE_nocarry_0133IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0133
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0133

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0133{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0133
	one.SetOne()
	e.Sub(&qe_nocarry_0133, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0133{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0133{0, uint64(i)})
	}
...
func TestE_nocarry_0133NegZero(t *testing.T) {
	var a, b e_nocarry_0133
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0133Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0133, len(staticTestValues))
...
func TestE_nocarry_0133Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0133) bool {
			var b e_nocarry_0133
...
func TestE_nocarry_0133InverseExp(t *testing.T) {
...
func TestE_nocarry_0133MulByConstants(t *testing.T) {
...
func TestE_nocarry_0133Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0133) bool {
...
func TestE_nocarry_0133LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0133Halve(t *testing.T) {
...
func TestE_nocarry_0133FromMont(t *testing.T) {
...
type testPaire_nocarry_0133 struct {
	element e_nocarry_0133
	bigint  big.Int
}

func (z *e_nocarry_0133) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0133[2] {
		return true
	}
	if z[2] < qe_nocarry_0133[2] {
		return false
	...
	return z[0] >= qe_nocarry_0133[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0133

		g.element = e_nocarry_0133{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0133[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0133[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0133 {
			var g e_nocarry_0133
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0133[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0133[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0133[2], carry)
...
func Benchmarke_nocarry_0133InverseNew(b *testing.B) {
	var x e_nocarry_0133
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0133
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0133
		var xInv e_nocarry_0133
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0133
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0133
...
func testLinearComb(t *testing.T, x *e_nocarry_0133, xC int64, y *e_nocarry_0133, yC int64) {
	...
	var z e_nocarry_0133
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0133, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0133
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0133, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0133
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0133, xHi uint64) {
	var res e_nocarry_0133
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0133) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0133) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0133, c int64, result *e_nocarry_0133, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0133) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0133) uint64 {
