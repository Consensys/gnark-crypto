...
// modulus q
DATA q<>+0(SB)/8, $0xd6d1e6fc82e0cfd5
DATA q<>+8(SB)/8, $0xe416b1f6efb4f98d
DATA q<>+16(SB)/8, $0x000000000000001e
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xffae4b3db1380e83
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xd6d1e6fc82e0cfd5, DI
	MOVQ    $0xe416b1f6efb4f98d, R8
	MOVQ    $0x000000000000001e, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0xe416b1f6efb4f98d, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x000000000000001e, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xd6d1e6fc82e0cfd5, R10
	MOVQ    $0xe416b1f6efb4f98d, R11
	MOVQ    $0x000000000000001e, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
