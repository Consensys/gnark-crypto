...
var benchRese_nocarry_0422 e_nocarry_0422

func BenchmarkE_nocarry_0422SetBytes(b *testing.B) {
	var x e_nocarry_0422
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0422MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0422.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0422)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0422)
		}
	})
}

func BenchmarkE_nocarry_0422Inverse(b *testing.B) {
	var x e_nocarry_0422
	x.SetRandom()
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0422Butterfly(b *testing.B) {
	var x e_nocarry_0422
	x.SetRandom()
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0422)
	}
}

func BenchmarkE_nocarry_0422Exp(b *testing.B) {
	var x e_nocarry_0422
	x.SetRandom()
	benchRese_nocarry_0422.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0422Double(b *testing.B) {
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Double(&benchRese_nocarry_0422)
	}
}

func BenchmarkE_nocarry_0422Add(b *testing.B) {
	var x e_nocarry_0422
	x.SetRandom()
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Add(&x, &benchRese_nocarry_0422)
	}
}

func BenchmarkE_nocarry_0422Sub(b *testing.B) {
	var x e_nocarry_0422
	x.SetRandom()
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Sub(&x, &benchRese_nocarry_0422)
	}
}

func BenchmarkE_nocarry_0422Neg(b *testing.B) {
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Neg(&benchRese_nocarry_0422)
	}
}

func BenchmarkE_nocarry_0422Div(b *testing.B) {
	var x e_nocarry_0422
	x.SetRandom()
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Div(&x, &benchRese_nocarry_0422)
	}
}

func BenchmarkE_nocarry_0422FromMont(b *testing.B) {
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.FromMont()
	}
}

func BenchmarkE_nocarry_0422ToMont(b *testing.B) {
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.ToMont()
	}
}
func BenchmarkE_nocarry_0422Square(b *testing.B) {
	benchRese_nocarry_0422.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Square(&benchRese_nocarry_0422)
	}
}

func BenchmarkE_nocarry_0422Sqrt(b *testing.B) {
	var a e_nocarry_0422
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0422Mul(b *testing.B) {
	x := e_nocarry_0422{
		7674901209681811592,
	...
	benchRese_nocarry_0422.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Mul(&benchRese_nocarry_0422, &x)
	}
}

func BenchmarkE_nocarry_0422Cmp(b *testing.B) {
	x := e_nocarry_0422{
		7674901209681811592,
		11752462666432197538,
		16100372332967675320,
	...
	benchRese_nocarry_0422 = x
	benchRese_nocarry_0422[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0422.Cmp(&x)
	}
}

func TestE_nocarry_0422Cmp(t *testing.T) {
	var x, y e_nocarry_0422
...
func TestE_nocarry_0422IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0422
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0422

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0422{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0422
	one.SetOne()
	e.Sub(&qe_nocarry_0422, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0422{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0422{0, uint64(i)})
	}
...
func TestE_nocarry_0422NegZero(t *testing.T) {
	var a, b e_nocarry_0422
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0422Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0422, len(staticTestValues))
...
func TestE_nocarry_0422Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0422) bool {
			var b e_nocarry_0422
...
func TestE_nocarry_0422InverseExp(t *testing.T) {
...
func TestE_nocarry_0422MulByConstants(t *testing.T) {
...
func TestE_nocarry_0422Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0422) bool {
...
func TestE_nocarry_0422LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0422Halve(t *testing.T) {
...
func TestE_nocarry_0422FromMont(t *testing.T) {
...
type testPaire_nocarry_0422 struct {
	element e_nocarry_0422
	bigint  big.Int
}

func (z *e_nocarry_0422) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0422[6] {
		return true
	}
	if z[6] < qe_nocarry_0422[6] {
		return false
	...
	return z[0] >= qe_nocarry_0422[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0422

		g.element = e_nocarry_0422{
		...
		if qe_nocarry_0422[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0422[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0422 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0422[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0422[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0422[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0422[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0422[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0422[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0422[6], carry)
...
func Benchmarke_nocarry_0422InverseNew(b *testing.B) {
	var x e_nocarry_0422
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0422
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0422
		var xInv e_nocarry_0422
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0422
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0422
...
func testLinearComb(t *testing.T, x *e_nocarry_0422, xC int64, y *e_nocarry_0422, yC int64) {
	...
	var z e_nocarry_0422
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0422, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0422
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0422, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0422
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0422, xHi uint64) {
	var res e_nocarry_0422
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0422) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0422) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0422, c int64, result *e_nocarry_0422, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0422) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0422) uint64 {
