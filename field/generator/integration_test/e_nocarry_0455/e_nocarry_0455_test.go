...
var benchRese_nocarry_0455 e_nocarry_0455

func BenchmarkE_nocarry_0455SetBytes(b *testing.B) {
	var x e_nocarry_0455
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0455MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0455.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0455)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0455)
		}
	})
}

func BenchmarkE_nocarry_0455Inverse(b *testing.B) {
	var x e_nocarry_0455
	x.SetRandom()
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0455Butterfly(b *testing.B) {
	var x e_nocarry_0455
	x.SetRandom()
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0455)
	}
}

func BenchmarkE_nocarry_0455Exp(b *testing.B) {
	var x e_nocarry_0455
	x.SetRandom()
	benchRese_nocarry_0455.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0455Double(b *testing.B) {
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Double(&benchRese_nocarry_0455)
	}
}

func BenchmarkE_nocarry_0455Add(b *testing.B) {
	var x e_nocarry_0455
	x.SetRandom()
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Add(&x, &benchRese_nocarry_0455)
	}
}

func BenchmarkE_nocarry_0455Sub(b *testing.B) {
	var x e_nocarry_0455
	x.SetRandom()
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Sub(&x, &benchRese_nocarry_0455)
	}
}

func BenchmarkE_nocarry_0455Neg(b *testing.B) {
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Neg(&benchRese_nocarry_0455)
	}
}

func BenchmarkE_nocarry_0455Div(b *testing.B) {
	var x e_nocarry_0455
	x.SetRandom()
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Div(&x, &benchRese_nocarry_0455)
	}
}

func BenchmarkE_nocarry_0455FromMont(b *testing.B) {
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.FromMont()
	}
}

func BenchmarkE_nocarry_0455ToMont(b *testing.B) {
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.ToMont()
	}
}
func BenchmarkE_nocarry_0455Square(b *testing.B) {
	benchRese_nocarry_0455.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Square(&benchRese_nocarry_0455)
	}
}

func BenchmarkE_nocarry_0455Sqrt(b *testing.B) {
	var a e_nocarry_0455
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0455Mul(b *testing.B) {
	x := e_nocarry_0455{
	...
	benchRese_nocarry_0455.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Mul(&benchRese_nocarry_0455, &x)
	}
}

func BenchmarkE_nocarry_0455Cmp(b *testing.B) {
	x := e_nocarry_0455{
		14570155680621292453,
		3376407569350637314,
		6714711967739418249,
	...
	benchRese_nocarry_0455 = x
	benchRese_nocarry_0455[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0455.Cmp(&x)
	}
}

func TestE_nocarry_0455Cmp(t *testing.T) {
	var x, y e_nocarry_0455
...
func TestE_nocarry_0455IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0455
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0455

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0455{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0455
	one.SetOne()
	e.Sub(&qe_nocarry_0455, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0455{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0455{0, uint64(i)})
	}
...
func TestE_nocarry_0455NegZero(t *testing.T) {
	var a, b e_nocarry_0455
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0455Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0455, len(staticTestValues))
...
func TestE_nocarry_0455Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0455) bool {
			var b e_nocarry_0455
...
func TestE_nocarry_0455InverseExp(t *testing.T) {
...
func TestE_nocarry_0455MulByConstants(t *testing.T) {
...
func TestE_nocarry_0455Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0455) bool {
...
func TestE_nocarry_0455LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0455Halve(t *testing.T) {
...
func TestE_nocarry_0455FromMont(t *testing.T) {
...
type testPaire_nocarry_0455 struct {
	element e_nocarry_0455
	bigint  big.Int
}

func (z *e_nocarry_0455) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0455[7] {
		return true
	}
	if z[7] < qe_nocarry_0455[7] {
		return false
	...
	return z[0] >= qe_nocarry_0455[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0455

		g.element = e_nocarry_0455{
		...
		if qe_nocarry_0455[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0455[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0455 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0455[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0455[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0455[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0455[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0455[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0455[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0455[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0455[7], carry)
...
func Benchmarke_nocarry_0455InverseNew(b *testing.B) {
	var x e_nocarry_0455
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0455
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0455
		var xInv e_nocarry_0455
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0455
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0455
...
func testLinearComb(t *testing.T, x *e_nocarry_0455, xC int64, y *e_nocarry_0455, yC int64) {
	...
	var z e_nocarry_0455
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0455, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0455
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0455, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0455
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0455, xHi uint64) {
	var res e_nocarry_0455
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0455) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0455) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0455, c int64, result *e_nocarry_0455, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0455) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0455) uint64 {
