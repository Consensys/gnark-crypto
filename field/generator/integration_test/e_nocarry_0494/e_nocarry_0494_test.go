...
var benchRese_nocarry_0494 e_nocarry_0494

func BenchmarkE_nocarry_0494SetBytes(b *testing.B) {
	var x e_nocarry_0494
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0494MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0494.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0494)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0494)
		}
	})
}

func BenchmarkE_nocarry_0494Inverse(b *testing.B) {
	var x e_nocarry_0494
	x.SetRandom()
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0494Butterfly(b *testing.B) {
	var x e_nocarry_0494
	x.SetRandom()
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0494)
	}
}

func BenchmarkE_nocarry_0494Exp(b *testing.B) {
	var x e_nocarry_0494
	x.SetRandom()
	benchRese_nocarry_0494.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0494Double(b *testing.B) {
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Double(&benchRese_nocarry_0494)
	}
}

func BenchmarkE_nocarry_0494Add(b *testing.B) {
	var x e_nocarry_0494
	x.SetRandom()
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Add(&x, &benchRese_nocarry_0494)
	}
}

func BenchmarkE_nocarry_0494Sub(b *testing.B) {
	var x e_nocarry_0494
	x.SetRandom()
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Sub(&x, &benchRese_nocarry_0494)
	}
}

func BenchmarkE_nocarry_0494Neg(b *testing.B) {
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Neg(&benchRese_nocarry_0494)
	}
}

func BenchmarkE_nocarry_0494Div(b *testing.B) {
	var x e_nocarry_0494
	x.SetRandom()
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Div(&x, &benchRese_nocarry_0494)
	}
}

func BenchmarkE_nocarry_0494FromMont(b *testing.B) {
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.FromMont()
	}
}

func BenchmarkE_nocarry_0494ToMont(b *testing.B) {
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.ToMont()
	}
}
func BenchmarkE_nocarry_0494Square(b *testing.B) {
	benchRese_nocarry_0494.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Square(&benchRese_nocarry_0494)
	}
}

func BenchmarkE_nocarry_0494Sqrt(b *testing.B) {
	var a e_nocarry_0494
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0494Mul(b *testing.B) {
	x := e_nocarry_0494{
		7606849464755494948,
	...
	benchRese_nocarry_0494.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Mul(&benchRese_nocarry_0494, &x)
	}
}

func BenchmarkE_nocarry_0494Cmp(b *testing.B) {
	x := e_nocarry_0494{
		7606849464755494948,
		17265503286202010866,
		18161220837323269270,
	...
	benchRese_nocarry_0494 = x
	benchRese_nocarry_0494[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0494.Cmp(&x)
	}
}

func TestE_nocarry_0494Cmp(t *testing.T) {
	var x, y e_nocarry_0494
...
func TestE_nocarry_0494IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0494
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0494

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0494{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0494
	one.SetOne()
	e.Sub(&qe_nocarry_0494, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0494{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0494{0, uint64(i)})
	}
...
func TestE_nocarry_0494NegZero(t *testing.T) {
	var a, b e_nocarry_0494
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0494Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0494, len(staticTestValues))
...
func TestE_nocarry_0494Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0494) bool {
			var b e_nocarry_0494
...
func TestE_nocarry_0494InverseExp(t *testing.T) {
...
func TestE_nocarry_0494MulByConstants(t *testing.T) {
...
func TestE_nocarry_0494Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0494) bool {
...
func TestE_nocarry_0494LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0494Halve(t *testing.T) {
...
func TestE_nocarry_0494FromMont(t *testing.T) {
...
type testPaire_nocarry_0494 struct {
	element e_nocarry_0494
	bigint  big.Int
}

func (z *e_nocarry_0494) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0494[7] {
		return true
	}
	if z[7] < qe_nocarry_0494[7] {
		return false
	...
	return z[0] >= qe_nocarry_0494[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0494

		g.element = e_nocarry_0494{
		...
		if qe_nocarry_0494[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0494[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0494 {
			var g e_nocarry_0494
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0494[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0494[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0494[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0494[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0494[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0494[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0494[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0494[7], carry)
...
func Benchmarke_nocarry_0494InverseNew(b *testing.B) {
	var x e_nocarry_0494
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0494
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0494
		var xInv e_nocarry_0494
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0494
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0494
...
func testLinearComb(t *testing.T, x *e_nocarry_0494, xC int64, y *e_nocarry_0494, yC int64) {
	...
	var z e_nocarry_0494
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0494, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0494
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0494, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0494
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0494, xHi uint64) {
	var res e_nocarry_0494
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0494) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0494) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0494, c int64, result *e_nocarry_0494, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0494) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0494) uint64 {
