...
var benchRese_nocarry_0301 e_nocarry_0301

func BenchmarkE_nocarry_0301SetBytes(b *testing.B) {
	var x e_nocarry_0301
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0301MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0301.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0301)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0301)
		}
	})
}

func BenchmarkE_nocarry_0301Inverse(b *testing.B) {
	var x e_nocarry_0301
	x.SetRandom()
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0301Butterfly(b *testing.B) {
	var x e_nocarry_0301
	x.SetRandom()
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0301)
	}
}

func BenchmarkE_nocarry_0301Exp(b *testing.B) {
	var x e_nocarry_0301
	x.SetRandom()
	benchRese_nocarry_0301.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0301Double(b *testing.B) {
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Double(&benchRese_nocarry_0301)
	}
}

func BenchmarkE_nocarry_0301Add(b *testing.B) {
	var x e_nocarry_0301
	x.SetRandom()
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Add(&x, &benchRese_nocarry_0301)
	}
}

func BenchmarkE_nocarry_0301Sub(b *testing.B) {
	var x e_nocarry_0301
	x.SetRandom()
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Sub(&x, &benchRese_nocarry_0301)
	}
}

func BenchmarkE_nocarry_0301Neg(b *testing.B) {
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Neg(&benchRese_nocarry_0301)
	}
}

func BenchmarkE_nocarry_0301Div(b *testing.B) {
	var x e_nocarry_0301
	x.SetRandom()
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Div(&x, &benchRese_nocarry_0301)
	}
}

func BenchmarkE_nocarry_0301FromMont(b *testing.B) {
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.FromMont()
	}
}

func BenchmarkE_nocarry_0301ToMont(b *testing.B) {
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.ToMont()
	}
}
func BenchmarkE_nocarry_0301Square(b *testing.B) {
	benchRese_nocarry_0301.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Square(&benchRese_nocarry_0301)
	}
}

func BenchmarkE_nocarry_0301Sqrt(b *testing.B) {
	var a e_nocarry_0301
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0301Mul(b *testing.B) {
	x := e_nocarry_0301{
	...
	benchRese_nocarry_0301.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Mul(&benchRese_nocarry_0301, &x)
	}
}

func BenchmarkE_nocarry_0301Cmp(b *testing.B) {
	x := e_nocarry_0301{
		10934761061631968844,
		11509872716849667840,
		377952097864276244,
	...
	benchRese_nocarry_0301 = x
	benchRese_nocarry_0301[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0301.Cmp(&x)
	}
}

func TestE_nocarry_0301Cmp(t *testing.T) {
	var x, y e_nocarry_0301
...
func TestE_nocarry_0301IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0301
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0301

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0301{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0301
	one.SetOne()
	e.Sub(&qe_nocarry_0301, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0301{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0301{0, uint64(i)})
	}
...
func TestE_nocarry_0301NegZero(t *testing.T) {
	var a, b e_nocarry_0301
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0301Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0301, len(staticTestValues))
...
func TestE_nocarry_0301Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0301) bool {
			var b e_nocarry_0301
...
func TestE_nocarry_0301InverseExp(t *testing.T) {
...
func TestE_nocarry_0301MulByConstants(t *testing.T) {
...
func TestE_nocarry_0301Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0301) bool {
...
func TestE_nocarry_0301LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0301Halve(t *testing.T) {
...
func TestE_nocarry_0301FromMont(t *testing.T) {
...
type testPaire_nocarry_0301 struct {
	element e_nocarry_0301
	bigint  big.Int
}

func (z *e_nocarry_0301) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0301[4] {
		return true
	}
	if z[4] < qe_nocarry_0301[4] {
		return false
	...
	return z[0] >= qe_nocarry_0301[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0301

		g.element = e_nocarry_0301{
		...
		if qe_nocarry_0301[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0301[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0301 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0301[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0301[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0301[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0301[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0301[4], carry)
...
func Benchmarke_nocarry_0301InverseNew(b *testing.B) {
	var x e_nocarry_0301
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0301
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0301
		var xInv e_nocarry_0301
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0301
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0301
...
func testLinearComb(t *testing.T, x *e_nocarry_0301, xC int64, y *e_nocarry_0301, yC int64) {
	...
	var z e_nocarry_0301
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0301, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0301
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0301, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0301
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0301, xHi uint64) {
	var res e_nocarry_0301
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0301) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0301) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0301, c int64, result *e_nocarry_0301, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0301) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0301) uint64 {
