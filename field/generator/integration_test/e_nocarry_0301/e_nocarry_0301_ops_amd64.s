...
// modulus q
DATA q<>+0(SB)/8, $0x585222edeb00b5d9
DATA q<>+8(SB)/8, $0x08e1f465f136af6f
DATA q<>+16(SB)/8, $0xf302230f32ecad10
DATA q<>+24(SB)/8, $0xf7b0d26368e5bb35
DATA q<>+32(SB)/8, $0x00001ac4aa146684
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x9875f5258d138597
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x585222edeb00b5d9, R9
	MOVQ    $0x08e1f465f136af6f, R10
	MOVQ    $0xf302230f32ecad10, R11
	MOVQ    $0xf7b0d26368e5bb35, R12
	MOVQ    $0x00001ac4aa146684, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x08e1f465f136af6f, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0xf302230f32ecad10, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xf7b0d26368e5bb35, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00001ac4aa146684, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x585222edeb00b5d9, CX
	MOVQ    $0x08e1f465f136af6f, BX
	MOVQ    $0xf302230f32ecad10, SI
	MOVQ    $0xf7b0d26368e5bb35, DI
	MOVQ    $0x00001ac4aa146684, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
