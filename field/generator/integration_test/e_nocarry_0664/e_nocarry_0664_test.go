...
var benchRese_nocarry_0664 e_nocarry_0664

func BenchmarkE_nocarry_0664SetBytes(b *testing.B) {
	var x e_nocarry_0664
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0664MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0664.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0664)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0664)
		}
	})
}

func BenchmarkE_nocarry_0664Inverse(b *testing.B) {
	var x e_nocarry_0664
	x.SetRandom()
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0664Butterfly(b *testing.B) {
	var x e_nocarry_0664
	x.SetRandom()
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0664)
	}
}

func BenchmarkE_nocarry_0664Exp(b *testing.B) {
	var x e_nocarry_0664
	x.SetRandom()
	benchRese_nocarry_0664.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0664Double(b *testing.B) {
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Double(&benchRese_nocarry_0664)
	}
}

func BenchmarkE_nocarry_0664Add(b *testing.B) {
	var x e_nocarry_0664
	x.SetRandom()
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Add(&x, &benchRese_nocarry_0664)
	}
}

func BenchmarkE_nocarry_0664Sub(b *testing.B) {
	var x e_nocarry_0664
	x.SetRandom()
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Sub(&x, &benchRese_nocarry_0664)
	}
}

func BenchmarkE_nocarry_0664Neg(b *testing.B) {
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Neg(&benchRese_nocarry_0664)
	}
}

func BenchmarkE_nocarry_0664Div(b *testing.B) {
	var x e_nocarry_0664
	x.SetRandom()
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Div(&x, &benchRese_nocarry_0664)
	}
}

func BenchmarkE_nocarry_0664FromMont(b *testing.B) {
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.FromMont()
	}
}

func BenchmarkE_nocarry_0664ToMont(b *testing.B) {
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.ToMont()
	}
}
func BenchmarkE_nocarry_0664Square(b *testing.B) {
	benchRese_nocarry_0664.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Square(&benchRese_nocarry_0664)
	}
}

func BenchmarkE_nocarry_0664Sqrt(b *testing.B) {
	var a e_nocarry_0664
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0664Mul(b *testing.B) {
	x := e_nocarry_0664{
		2043225240222590119,
		3649443639297298457,
		4831295910398471276,
	...
	benchRese_nocarry_0664.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Mul(&benchRese_nocarry_0664, &x)
	}
}

func BenchmarkE_nocarry_0664Cmp(b *testing.B) {
	x := e_nocarry_0664{
		2043225240222590119,
		3649443639297298457,
		4831295910398471276,
	...
	benchRese_nocarry_0664 = x
	benchRese_nocarry_0664[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0664.Cmp(&x)
	}
}

func TestE_nocarry_0664Cmp(t *testing.T) {
	var x, y e_nocarry_0664
...
func TestE_nocarry_0664IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0664
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0664

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0664{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0664
	one.SetOne()
	e.Sub(&qe_nocarry_0664, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0664{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0664{0, uint64(i)})
	}
...
func TestE_nocarry_0664NegZero(t *testing.T) {
	var a, b e_nocarry_0664
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0664Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0664, len(staticTestValues))
...
func TestE_nocarry_0664Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0664) bool {
			var b e_nocarry_0664
...
func TestE_nocarry_0664InverseExp(t *testing.T) {
...
func TestE_nocarry_0664MulByConstants(t *testing.T) {
...
func TestE_nocarry_0664Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0664) bool {
...
func TestE_nocarry_0664LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0664Halve(t *testing.T) {
...
func TestE_nocarry_0664FromMont(t *testing.T) {
...
type testPaire_nocarry_0664 struct {
	element e_nocarry_0664
	bigint  big.Int
}

func (z *e_nocarry_0664) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0664[10] {
		return true
	}
	if z[10] < qe_nocarry_0664[10] {
		return false
	...
	return z[0] >= qe_nocarry_0664[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0664

		g.element = e_nocarry_0664{
		...
		if qe_nocarry_0664[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0664[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0664 {
			var g e_nocarry_0664
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0664[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0664[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0664[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0664[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0664[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0664[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0664[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0664[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0664[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0664[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0664[10], carry)
...
func Benchmarke_nocarry_0664InverseNew(b *testing.B) {
	var x e_nocarry_0664
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0664
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0664
		var xInv e_nocarry_0664
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0664
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0664
...
func testLinearComb(t *testing.T, x *e_nocarry_0664, xC int64, y *e_nocarry_0664, yC int64) {
	...
	var z e_nocarry_0664
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0664, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0664
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0664, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0664
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0664, xHi uint64) {
	var res e_nocarry_0664
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0664) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0664) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0664, c int64, result *e_nocarry_0664, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0664) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0664) uint64 {
