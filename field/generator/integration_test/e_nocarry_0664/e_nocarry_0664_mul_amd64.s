...
// modulus q
DATA q<>+0(SB)/8, $0x481a8103f8daaa7f
DATA q<>+8(SB)/8, $0x6a2ea4fcdf6a2a02
DATA q<>+16(SB)/8, $0x9382c5e5f18d0168
DATA q<>+24(SB)/8, $0x6cabb58a61a4cece
DATA q<>+32(SB)/8, $0xcfa7883d48ad7a63
DATA q<>+40(SB)/8, $0x8dfae41159dd710d
DATA q<>+48(SB)/8, $0x544aa01d2edc52d0
DATA q<>+56(SB)/8, $0x497cb4d61517a48f
DATA q<>+64(SB)/8, $0x8f889b789d1b35e7
DATA q<>+72(SB)/8, $0x58d46056ccc8be5a
DATA q<>+80(SB)/8, $0x0000000000da240a
GLOBL q<>(SB), (RODATA+NOPTR), $88

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x52c3d0de9a08ea81
