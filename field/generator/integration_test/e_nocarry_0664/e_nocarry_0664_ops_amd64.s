...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x481a8103f8daaa7f, R14
	ADDQ R14, AX
	MOVQ $0x6a2ea4fcdf6a2a02, R14
	ADCQ R14, DX
	MOVQ $0x9382c5e5f18d0168, R14
	ADCQ R14, CX
	MOVQ $0x6cabb58a61a4cece, R14
	ADCQ R14, BX
	MOVQ $0xcfa7883d48ad7a63, R14
	ADCQ R14, SI
	MOVQ $0x8dfae41159dd710d, R14
	ADCQ R14, DI
	MOVQ $0x544aa01d2edc52d0, R14
	ADCQ R14, R8
	MOVQ $0x497cb4d61517a48f, R14
	ADCQ R14, R9
	MOVQ $0x8f889b789d1b35e7, R14
	ADCQ R14, R10
	MOVQ $0x58d46056ccc8be5a, R14
	ADCQ R14, R11
	MOVQ $0x0000000000da240a, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x481a8103f8daaa7f, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x6a2ea4fcdf6a2a02, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x9382c5e5f18d0168, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x6cabb58a61a4cece, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xcfa7883d48ad7a63, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0x8dfae41159dd710d, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x544aa01d2edc52d0, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x497cb4d61517a48f, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x8f889b789d1b35e7, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x58d46056ccc8be5a, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x0000000000da240a, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x481a8103f8daaa7f, AX
	ADDQ AX, DX
	MOVQ $0x6a2ea4fcdf6a2a02, AX
	ADCQ AX, CX
	MOVQ $0x9382c5e5f18d0168, AX
	ADCQ AX, BX
	MOVQ $0x6cabb58a61a4cece, AX
	ADCQ AX, SI
	MOVQ $0xcfa7883d48ad7a63, AX
	ADCQ AX, DI
	MOVQ $0x8dfae41159dd710d, AX
	ADCQ AX, R8
	MOVQ $0x544aa01d2edc52d0, AX
	ADCQ AX, R9
	MOVQ $0x497cb4d61517a48f, AX
	ADCQ AX, R10
	MOVQ $0x8f889b789d1b35e7, AX
	ADCQ AX, R11
	MOVQ $0x58d46056ccc8be5a, AX
	ADCQ AX, R12
	MOVQ $0x0000000000da240a, AX
	ADCQ AX, R13
