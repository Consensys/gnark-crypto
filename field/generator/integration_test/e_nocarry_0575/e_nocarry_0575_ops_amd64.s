...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xd19cc3fc3633ece3, R12
	ADDQ R12, AX
	MOVQ $0x2b64fddc1d906525, R12
	ADCQ R12, DX
	MOVQ $0x56fa73b6689d12a8, R12
	ADCQ R12, CX
	MOVQ $0x0f4ad8f900fbf7c6, R12
	ADCQ R12, BX
	MOVQ $0x1f480b36dd31bdc5, R12
	ADCQ R12, SI
	MOVQ $0xda28fd91a007cb28, R12
	ADCQ R12, DI
	MOVQ $0x5f57b2a4bb92ccf6, R12
	ADCQ R12, R8
	MOVQ $0xef957fddfd5d86c0, R12
	ADCQ R12, R9
	MOVQ $0x73060121f461bc03, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xd19cc3fc3633ece3, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x2b64fddc1d906525, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x56fa73b6689d12a8, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x0f4ad8f900fbf7c6, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x1f480b36dd31bdc5, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xda28fd91a007cb28, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x5f57b2a4bb92ccf6, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0xef957fddfd5d86c0, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x73060121f461bc03, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xd19cc3fc3633ece3, AX
	ADDQ AX, DX
	MOVQ $0x2b64fddc1d906525, AX
	ADCQ AX, CX
	MOVQ $0x56fa73b6689d12a8, AX
	ADCQ AX, BX
	MOVQ $0x0f4ad8f900fbf7c6, AX
	ADCQ AX, SI
	MOVQ $0x1f480b36dd31bdc5, AX
	ADCQ AX, DI
	MOVQ $0xda28fd91a007cb28, AX
	ADCQ AX, R8
	MOVQ $0x5f57b2a4bb92ccf6, AX
	ADCQ AX, R9
	MOVQ $0xef957fddfd5d86c0, AX
	ADCQ AX, R10
	MOVQ $0x73060121f461bc03, AX
	ADCQ AX, R11
