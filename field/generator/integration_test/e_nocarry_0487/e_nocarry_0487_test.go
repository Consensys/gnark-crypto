...
var benchRese_nocarry_0487 e_nocarry_0487

func BenchmarkE_nocarry_0487SetBytes(b *testing.B) {
	var x e_nocarry_0487
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0487MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0487.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0487)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0487)
		}
	})
}

func BenchmarkE_nocarry_0487Inverse(b *testing.B) {
	var x e_nocarry_0487
	x.SetRandom()
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0487Butterfly(b *testing.B) {
	var x e_nocarry_0487
	x.SetRandom()
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0487)
	}
}

func BenchmarkE_nocarry_0487Exp(b *testing.B) {
	var x e_nocarry_0487
	x.SetRandom()
	benchRese_nocarry_0487.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0487Double(b *testing.B) {
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Double(&benchRese_nocarry_0487)
	}
}

func BenchmarkE_nocarry_0487Add(b *testing.B) {
	var x e_nocarry_0487
	x.SetRandom()
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Add(&x, &benchRese_nocarry_0487)
	}
}

func BenchmarkE_nocarry_0487Sub(b *testing.B) {
	var x e_nocarry_0487
	x.SetRandom()
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Sub(&x, &benchRese_nocarry_0487)
	}
}

func BenchmarkE_nocarry_0487Neg(b *testing.B) {
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Neg(&benchRese_nocarry_0487)
	}
}

func BenchmarkE_nocarry_0487Div(b *testing.B) {
	var x e_nocarry_0487
	x.SetRandom()
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Div(&x, &benchRese_nocarry_0487)
	}
}

func BenchmarkE_nocarry_0487FromMont(b *testing.B) {
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.FromMont()
	}
}

func BenchmarkE_nocarry_0487ToMont(b *testing.B) {
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.ToMont()
	}
}
func BenchmarkE_nocarry_0487Square(b *testing.B) {
	benchRese_nocarry_0487.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Square(&benchRese_nocarry_0487)
	}
}

func BenchmarkE_nocarry_0487Sqrt(b *testing.B) {
	var a e_nocarry_0487
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0487Mul(b *testing.B) {
	x := e_nocarry_0487{
		5478993580524122439,
	...
	benchRese_nocarry_0487.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Mul(&benchRese_nocarry_0487, &x)
	}
}

func BenchmarkE_nocarry_0487Cmp(b *testing.B) {
	x := e_nocarry_0487{
		5478993580524122439,
		14446028469924194970,
		6818608576084204729,
	...
	benchRese_nocarry_0487 = x
	benchRese_nocarry_0487[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0487.Cmp(&x)
	}
}

func TestE_nocarry_0487Cmp(t *testing.T) {
	var x, y e_nocarry_0487
...
func TestE_nocarry_0487IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0487
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0487

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0487{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0487
	one.SetOne()
	e.Sub(&qe_nocarry_0487, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0487{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0487{0, uint64(i)})
	}
...
func TestE_nocarry_0487NegZero(t *testing.T) {
	var a, b e_nocarry_0487
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0487Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0487, len(staticTestValues))
...
func TestE_nocarry_0487Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0487) bool {
			var b e_nocarry_0487
...
func TestE_nocarry_0487InverseExp(t *testing.T) {
...
func TestE_nocarry_0487MulByConstants(t *testing.T) {
...
func TestE_nocarry_0487Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0487) bool {
...
func TestE_nocarry_0487LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0487Halve(t *testing.T) {
...
func TestE_nocarry_0487FromMont(t *testing.T) {
...
type testPaire_nocarry_0487 struct {
	element e_nocarry_0487
	bigint  big.Int
}

func (z *e_nocarry_0487) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0487[7] {
		return true
	}
	if z[7] < qe_nocarry_0487[7] {
		return false
	...
	return z[0] >= qe_nocarry_0487[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0487

		g.element = e_nocarry_0487{
		...
		if qe_nocarry_0487[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0487[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0487 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0487[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0487[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0487[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0487[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0487[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0487[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0487[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0487[7], carry)
...
func Benchmarke_nocarry_0487InverseNew(b *testing.B) {
	var x e_nocarry_0487
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0487
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0487
		var xInv e_nocarry_0487
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0487
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0487
...
func testLinearComb(t *testing.T, x *e_nocarry_0487, xC int64, y *e_nocarry_0487, yC int64) {
	...
	var z e_nocarry_0487
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0487, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0487
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0487, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0487
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0487, xHi uint64) {
	var res e_nocarry_0487
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0487) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0487) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0487, c int64, result *e_nocarry_0487, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0487) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0487) uint64 {
