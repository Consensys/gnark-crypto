...
var benchRese_nocarry_0514 e_nocarry_0514

func BenchmarkE_nocarry_0514SetBytes(b *testing.B) {
	var x e_nocarry_0514
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0514MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0514.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0514)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0514)
		}
	})
}

func BenchmarkE_nocarry_0514Inverse(b *testing.B) {
	var x e_nocarry_0514
	x.SetRandom()
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0514Butterfly(b *testing.B) {
	var x e_nocarry_0514
	x.SetRandom()
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0514)
	}
}

func BenchmarkE_nocarry_0514Exp(b *testing.B) {
	var x e_nocarry_0514
	x.SetRandom()
	benchRese_nocarry_0514.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0514Double(b *testing.B) {
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Double(&benchRese_nocarry_0514)
	}
}

func BenchmarkE_nocarry_0514Add(b *testing.B) {
	var x e_nocarry_0514
	x.SetRandom()
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Add(&x, &benchRese_nocarry_0514)
	}
}

func BenchmarkE_nocarry_0514Sub(b *testing.B) {
	var x e_nocarry_0514
	x.SetRandom()
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Sub(&x, &benchRese_nocarry_0514)
	}
}

func BenchmarkE_nocarry_0514Neg(b *testing.B) {
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Neg(&benchRese_nocarry_0514)
	}
}

func BenchmarkE_nocarry_0514Div(b *testing.B) {
	var x e_nocarry_0514
	x.SetRandom()
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Div(&x, &benchRese_nocarry_0514)
	}
}

func BenchmarkE_nocarry_0514FromMont(b *testing.B) {
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.FromMont()
	}
}

func BenchmarkE_nocarry_0514ToMont(b *testing.B) {
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.ToMont()
	}
}
func BenchmarkE_nocarry_0514Square(b *testing.B) {
	benchRese_nocarry_0514.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Square(&benchRese_nocarry_0514)
	}
}

func BenchmarkE_nocarry_0514Sqrt(b *testing.B) {
	var a e_nocarry_0514
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0514Mul(b *testing.B) {
	x := e_nocarry_0514{
		1594711550166649410,
	...
	benchRese_nocarry_0514.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Mul(&benchRese_nocarry_0514, &x)
	}
}

func BenchmarkE_nocarry_0514Cmp(b *testing.B) {
	x := e_nocarry_0514{
		1594711550166649410,
		11815722793193345502,
		9057082629777086382,
	...
	benchRese_nocarry_0514 = x
	benchRese_nocarry_0514[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0514.Cmp(&x)
	}
}

func TestE_nocarry_0514Cmp(t *testing.T) {
	var x, y e_nocarry_0514
...
func TestE_nocarry_0514IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0514
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0514

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0514{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0514
	one.SetOne()
	e.Sub(&qe_nocarry_0514, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0514{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0514{0, uint64(i)})
	}
...
func TestE_nocarry_0514NegZero(t *testing.T) {
	var a, b e_nocarry_0514
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0514Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0514, len(staticTestValues))
...
func TestE_nocarry_0514Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0514) bool {
			var b e_nocarry_0514
...
func TestE_nocarry_0514InverseExp(t *testing.T) {
...
func TestE_nocarry_0514MulByConstants(t *testing.T) {
...
func TestE_nocarry_0514Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0514) bool {
...
func TestE_nocarry_0514LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0514Halve(t *testing.T) {
...
func TestE_nocarry_0514FromMont(t *testing.T) {
...
type testPaire_nocarry_0514 struct {
	element e_nocarry_0514
	bigint  big.Int
}

func (z *e_nocarry_0514) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0514[8] {
		return true
	}
	if z[8] < qe_nocarry_0514[8] {
		return false
	...
	return z[0] >= qe_nocarry_0514[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0514

		g.element = e_nocarry_0514{
		...
		if qe_nocarry_0514[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0514[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0514 {
			var g e_nocarry_0514
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0514[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0514[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0514[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0514[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0514[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0514[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0514[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0514[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0514[8], carry)
...
func Benchmarke_nocarry_0514InverseNew(b *testing.B) {
	var x e_nocarry_0514
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0514
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0514
		var xInv e_nocarry_0514
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0514
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0514
...
func testLinearComb(t *testing.T, x *e_nocarry_0514, xC int64, y *e_nocarry_0514, yC int64) {
	...
	var z e_nocarry_0514
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0514, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0514
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0514, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0514
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0514, xHi uint64) {
	var res e_nocarry_0514
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0514) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0514) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0514, c int64, result *e_nocarry_0514, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0514) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0514) uint64 {
