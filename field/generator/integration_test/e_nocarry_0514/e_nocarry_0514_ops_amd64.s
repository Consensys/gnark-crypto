...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x6b3d61fb6df0845d, R12
	ADDQ R12, AX
	MOVQ $0x76ea1d6383b8acaa, R12
	ADCQ R12, DX
	MOVQ $0x3e79455b3beca32b, R12
	ADCQ R12, CX
	MOVQ $0x347eca5d89b8ae54, R12
	ADCQ R12, BX
	MOVQ $0x8795eebff1e96366, R12
	ADCQ R12, SI
	MOVQ $0x8cee142d70f71857, R12
	ADCQ R12, DI
	MOVQ $0xe7479db9a4084f33, R12
	ADCQ R12, R8
	MOVQ $0x4ac5d0216c318607, R12
	ADCQ R12, R9
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x6b3d61fb6df0845d, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x76ea1d6383b8acaa, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x3e79455b3beca32b, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x347eca5d89b8ae54, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0x8795eebff1e96366, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0x8cee142d70f71857, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0xe7479db9a4084f33, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x4ac5d0216c318607, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x6b3d61fb6df0845d, AX
	ADDQ AX, DX
	MOVQ $0x76ea1d6383b8acaa, AX
	ADCQ AX, CX
	MOVQ $0x3e79455b3beca32b, AX
	ADCQ AX, BX
	MOVQ $0x347eca5d89b8ae54, AX
	ADCQ AX, SI
	MOVQ $0x8795eebff1e96366, AX
	ADCQ AX, DI
	MOVQ $0x8cee142d70f71857, AX
	ADCQ AX, R8
	MOVQ $0xe7479db9a4084f33, AX
	ADCQ AX, R9
	MOVQ $0x4ac5d0216c318607, AX
	ADCQ AX, R10
