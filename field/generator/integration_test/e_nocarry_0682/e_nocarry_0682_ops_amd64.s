...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xce3a05e26ff4e015, R14
	ADDQ R14, AX
	MOVQ $0x206c559ead982860, R14
	ADCQ R14, DX
	MOVQ $0x4f1edf18c137d04f, R14
	ADCQ R14, CX
	MOVQ $0x1a83544d0de9c98d, R14
	ADCQ R14, BX
	MOVQ $0xdb9fe84306cb6aba, R14
	ADCQ R14, SI
	MOVQ $0xf93cf7d5892a9304, R14
	ADCQ R14, DI
	MOVQ $0x209ba67816338139, R14
	ADCQ R14, R8
	MOVQ $0xbb481b2eae7fb0a5, R14
	ADCQ R14, R9
	MOVQ $0x35057e9dcc245b31, R14
	ADCQ R14, R10
	MOVQ $0x64280017e8e7d3a2, R14
	ADCQ R14, R11
	MOVQ $0x00000385ecc07c36, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xce3a05e26ff4e015, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0x206c559ead982860, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x4f1edf18c137d04f, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0x1a83544d0de9c98d, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0xdb9fe84306cb6aba, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xf93cf7d5892a9304, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x209ba67816338139, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0xbb481b2eae7fb0a5, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x35057e9dcc245b31, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0x64280017e8e7d3a2, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x00000385ecc07c36, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xce3a05e26ff4e015, AX
	ADDQ AX, DX
	MOVQ $0x206c559ead982860, AX
	ADCQ AX, CX
	MOVQ $0x4f1edf18c137d04f, AX
	ADCQ AX, BX
	MOVQ $0x1a83544d0de9c98d, AX
	ADCQ AX, SI
	MOVQ $0xdb9fe84306cb6aba, AX
	ADCQ AX, DI
	MOVQ $0xf93cf7d5892a9304, AX
	ADCQ AX, R8
	MOVQ $0x209ba67816338139, AX
	ADCQ AX, R9
	MOVQ $0xbb481b2eae7fb0a5, AX
	ADCQ AX, R10
	MOVQ $0x35057e9dcc245b31, AX
	ADCQ AX, R11
	MOVQ $0x64280017e8e7d3a2, AX
	ADCQ AX, R12
	MOVQ $0x00000385ecc07c36, AX
	ADCQ AX, R13
