...
var benchRese_nocarry_0682 e_nocarry_0682

func BenchmarkE_nocarry_0682SetBytes(b *testing.B) {
	var x e_nocarry_0682
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0682MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0682.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0682)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0682)
		}
	})
}

func BenchmarkE_nocarry_0682Inverse(b *testing.B) {
	var x e_nocarry_0682
	x.SetRandom()
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0682Butterfly(b *testing.B) {
	var x e_nocarry_0682
	x.SetRandom()
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0682)
	}
}

func BenchmarkE_nocarry_0682Exp(b *testing.B) {
	var x e_nocarry_0682
	x.SetRandom()
	benchRese_nocarry_0682.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0682Double(b *testing.B) {
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Double(&benchRese_nocarry_0682)
	}
}

func BenchmarkE_nocarry_0682Add(b *testing.B) {
	var x e_nocarry_0682
	x.SetRandom()
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Add(&x, &benchRese_nocarry_0682)
	}
}

func BenchmarkE_nocarry_0682Sub(b *testing.B) {
	var x e_nocarry_0682
	x.SetRandom()
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Sub(&x, &benchRese_nocarry_0682)
	}
}

func BenchmarkE_nocarry_0682Neg(b *testing.B) {
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Neg(&benchRese_nocarry_0682)
	}
}

func BenchmarkE_nocarry_0682Div(b *testing.B) {
	var x e_nocarry_0682
	x.SetRandom()
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Div(&x, &benchRese_nocarry_0682)
	}
}

func BenchmarkE_nocarry_0682FromMont(b *testing.B) {
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.FromMont()
	}
}

func BenchmarkE_nocarry_0682ToMont(b *testing.B) {
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.ToMont()
	}
}
func BenchmarkE_nocarry_0682Square(b *testing.B) {
	benchRese_nocarry_0682.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Square(&benchRese_nocarry_0682)
	}
}

func BenchmarkE_nocarry_0682Sqrt(b *testing.B) {
	var a e_nocarry_0682
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0682Mul(b *testing.B) {
	x := e_nocarry_0682{
	...
	benchRese_nocarry_0682.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Mul(&benchRese_nocarry_0682, &x)
	}
}

func BenchmarkE_nocarry_0682Cmp(b *testing.B) {
	x := e_nocarry_0682{
		16251902550002971557,
		11539863174550614855,
		9546605415707216208,
	...
	benchRese_nocarry_0682 = x
	benchRese_nocarry_0682[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0682.Cmp(&x)
	}
}

func TestE_nocarry_0682Cmp(t *testing.T) {
	var x, y e_nocarry_0682
...
func TestE_nocarry_0682IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0682
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0682

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0682{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0682
	one.SetOne()
	e.Sub(&qe_nocarry_0682, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0682{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0682{0, uint64(i)})
	}
...
func TestE_nocarry_0682NegZero(t *testing.T) {
	var a, b e_nocarry_0682
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0682Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0682, len(staticTestValues))
...
func TestE_nocarry_0682Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0682) bool {
			var b e_nocarry_0682
...
func TestE_nocarry_0682InverseExp(t *testing.T) {
...
func TestE_nocarry_0682MulByConstants(t *testing.T) {
...
func TestE_nocarry_0682Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0682) bool {
...
func TestE_nocarry_0682LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0682Halve(t *testing.T) {
...
func TestE_nocarry_0682FromMont(t *testing.T) {
...
type testPaire_nocarry_0682 struct {
	element e_nocarry_0682
	bigint  big.Int
}

func (z *e_nocarry_0682) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0682[10] {
		return true
	}
	if z[10] < qe_nocarry_0682[10] {
		return false
	...
	return z[0] >= qe_nocarry_0682[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0682

		g.element = e_nocarry_0682{
		...
		if qe_nocarry_0682[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0682[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0682 {
			var g e_nocarry_0682
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0682[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0682[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0682[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0682[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0682[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0682[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0682[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0682[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0682[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0682[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0682[10], carry)
...
func Benchmarke_nocarry_0682InverseNew(b *testing.B) {
	var x e_nocarry_0682
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0682
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0682
		var xInv e_nocarry_0682
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0682
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0682
...
func testLinearComb(t *testing.T, x *e_nocarry_0682, xC int64, y *e_nocarry_0682, yC int64) {
	...
	var z e_nocarry_0682
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0682, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0682
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0682, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0682
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0682, xHi uint64) {
	var res e_nocarry_0682
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0682) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0682) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0682, c int64, result *e_nocarry_0682, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0682) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0682) uint64 {
