...
// modulus q
DATA q<>+0(SB)/8, $0x153f39e8f53ab427
DATA q<>+8(SB)/8, $0x877f835441828258
DATA q<>+16(SB)/8, $0x45cdc5e6305a4433
DATA q<>+24(SB)/8, $0xb70f261c622dc5d8
DATA q<>+32(SB)/8, $0x6636fc4298dc7a2c
DATA q<>+40(SB)/8, $0x000000000001aa67
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x899f592b46b88469
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x153f39e8f53ab427, R10
	MOVQ    $0x877f835441828258, R11
	MOVQ    $0x45cdc5e6305a4433, R12
	MOVQ    $0xb70f261c622dc5d8, R13
	MOVQ    $0x6636fc4298dc7a2c, R14
	MOVQ    $0x000000000001aa67, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x877f835441828258, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x45cdc5e6305a4433, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xb70f261c622dc5d8, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x6636fc4298dc7a2c, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000000001aa67, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x153f39e8f53ab427, CX
	MOVQ    $0x877f835441828258, BX
	MOVQ    $0x45cdc5e6305a4433, SI
	MOVQ    $0xb70f261c622dc5d8, DI
	MOVQ    $0x6636fc4298dc7a2c, R8
	MOVQ    $0x000000000001aa67, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
