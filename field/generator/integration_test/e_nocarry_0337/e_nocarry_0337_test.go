...
var benchRese_nocarry_0337 e_nocarry_0337

func BenchmarkE_nocarry_0337SetBytes(b *testing.B) {
	var x e_nocarry_0337
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0337MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0337.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0337)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0337)
		}
	})
}

func BenchmarkE_nocarry_0337Inverse(b *testing.B) {
	var x e_nocarry_0337
	x.SetRandom()
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0337Butterfly(b *testing.B) {
	var x e_nocarry_0337
	x.SetRandom()
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0337)
	}
}

func BenchmarkE_nocarry_0337Exp(b *testing.B) {
	var x e_nocarry_0337
	x.SetRandom()
	benchRese_nocarry_0337.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0337Double(b *testing.B) {
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Double(&benchRese_nocarry_0337)
	}
}

func BenchmarkE_nocarry_0337Add(b *testing.B) {
	var x e_nocarry_0337
	x.SetRandom()
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Add(&x, &benchRese_nocarry_0337)
	}
}

func BenchmarkE_nocarry_0337Sub(b *testing.B) {
	var x e_nocarry_0337
	x.SetRandom()
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Sub(&x, &benchRese_nocarry_0337)
	}
}

func BenchmarkE_nocarry_0337Neg(b *testing.B) {
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Neg(&benchRese_nocarry_0337)
	}
}

func BenchmarkE_nocarry_0337Div(b *testing.B) {
	var x e_nocarry_0337
	x.SetRandom()
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Div(&x, &benchRese_nocarry_0337)
	}
}

func BenchmarkE_nocarry_0337FromMont(b *testing.B) {
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.FromMont()
	}
}

func BenchmarkE_nocarry_0337ToMont(b *testing.B) {
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.ToMont()
	}
}
func BenchmarkE_nocarry_0337Square(b *testing.B) {
	benchRese_nocarry_0337.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Square(&benchRese_nocarry_0337)
	}
}

func BenchmarkE_nocarry_0337Sqrt(b *testing.B) {
	var a e_nocarry_0337
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0337Mul(b *testing.B) {
	x := e_nocarry_0337{
	...
	benchRese_nocarry_0337.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Mul(&benchRese_nocarry_0337, &x)
	}
}

func BenchmarkE_nocarry_0337Cmp(b *testing.B) {
	x := e_nocarry_0337{
		15099757374060245894,
		6990407132607506658,
		6207734619179564599,
	...
	benchRese_nocarry_0337 = x
	benchRese_nocarry_0337[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0337.Cmp(&x)
	}
}

func TestE_nocarry_0337Cmp(t *testing.T) {
	var x, y e_nocarry_0337
...
func TestE_nocarry_0337IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0337
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0337

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0337{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0337
	one.SetOne()
	e.Sub(&qe_nocarry_0337, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0337{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0337{0, uint64(i)})
	}
...
func TestE_nocarry_0337NegZero(t *testing.T) {
	var a, b e_nocarry_0337
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0337Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0337, len(staticTestValues))
...
func TestE_nocarry_0337Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0337) bool {
			var b e_nocarry_0337
...
func TestE_nocarry_0337InverseExp(t *testing.T) {
...
func TestE_nocarry_0337MulByConstants(t *testing.T) {
...
func TestE_nocarry_0337Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0337) bool {
...
func TestE_nocarry_0337LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0337Halve(t *testing.T) {
...
func TestE_nocarry_0337FromMont(t *testing.T) {
...
type testPaire_nocarry_0337 struct {
	element e_nocarry_0337
	bigint  big.Int
}

func (z *e_nocarry_0337) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0337[5] {
		return true
	}
	if z[5] < qe_nocarry_0337[5] {
		return false
	...
	return z[0] >= qe_nocarry_0337[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0337

		g.element = e_nocarry_0337{
		...
		if qe_nocarry_0337[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0337[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0337 {
			var g e_nocarry_0337
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0337[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0337[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0337[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0337[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0337[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0337[5], carry)
...
func Benchmarke_nocarry_0337InverseNew(b *testing.B) {
	var x e_nocarry_0337
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0337
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0337
		var xInv e_nocarry_0337
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0337
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0337
...
func testLinearComb(t *testing.T, x *e_nocarry_0337, xC int64, y *e_nocarry_0337, yC int64) {
	...
	var z e_nocarry_0337
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0337, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0337
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0337, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0337
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0337, xHi uint64) {
	var res e_nocarry_0337
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0337) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0337) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0337, c int64, result *e_nocarry_0337, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0337) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0337) uint64 {
