...
var benchRese_nocarry_0342 e_nocarry_0342

func BenchmarkE_nocarry_0342SetBytes(b *testing.B) {
	var x e_nocarry_0342
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0342MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0342.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0342)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0342)
		}
	})
}

func BenchmarkE_nocarry_0342Inverse(b *testing.B) {
	var x e_nocarry_0342
	x.SetRandom()
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0342Butterfly(b *testing.B) {
	var x e_nocarry_0342
	x.SetRandom()
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0342)
	}
}

func BenchmarkE_nocarry_0342Exp(b *testing.B) {
	var x e_nocarry_0342
	x.SetRandom()
	benchRese_nocarry_0342.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0342Double(b *testing.B) {
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Double(&benchRese_nocarry_0342)
	}
}

func BenchmarkE_nocarry_0342Add(b *testing.B) {
	var x e_nocarry_0342
	x.SetRandom()
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Add(&x, &benchRese_nocarry_0342)
	}
}

func BenchmarkE_nocarry_0342Sub(b *testing.B) {
	var x e_nocarry_0342
	x.SetRandom()
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Sub(&x, &benchRese_nocarry_0342)
	}
}

func BenchmarkE_nocarry_0342Neg(b *testing.B) {
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Neg(&benchRese_nocarry_0342)
	}
}

func BenchmarkE_nocarry_0342Div(b *testing.B) {
	var x e_nocarry_0342
	x.SetRandom()
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Div(&x, &benchRese_nocarry_0342)
	}
}

func BenchmarkE_nocarry_0342FromMont(b *testing.B) {
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.FromMont()
	}
}

func BenchmarkE_nocarry_0342ToMont(b *testing.B) {
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.ToMont()
	}
}
func BenchmarkE_nocarry_0342Square(b *testing.B) {
	benchRese_nocarry_0342.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Square(&benchRese_nocarry_0342)
	}
}

func BenchmarkE_nocarry_0342Sqrt(b *testing.B) {
	var a e_nocarry_0342
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0342Mul(b *testing.B) {
	x := e_nocarry_0342{
	...
	benchRese_nocarry_0342.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Mul(&benchRese_nocarry_0342, &x)
	}
}

func BenchmarkE_nocarry_0342Cmp(b *testing.B) {
	x := e_nocarry_0342{
		18088684790325804880,
		17843479585783551492,
		7228613309410510559,
	...
	benchRese_nocarry_0342 = x
	benchRese_nocarry_0342[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0342.Cmp(&x)
	}
}

func TestE_nocarry_0342Cmp(t *testing.T) {
	var x, y e_nocarry_0342
...
func TestE_nocarry_0342IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0342
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0342

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0342{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0342
	one.SetOne()
	e.Sub(&qe_nocarry_0342, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0342{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0342{0, uint64(i)})
	}
...
func TestE_nocarry_0342NegZero(t *testing.T) {
	var a, b e_nocarry_0342
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0342Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0342, len(staticTestValues))
...
func TestE_nocarry_0342Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0342) bool {
			var b e_nocarry_0342
...
func TestE_nocarry_0342InverseExp(t *testing.T) {
...
func TestE_nocarry_0342MulByConstants(t *testing.T) {
...
func TestE_nocarry_0342Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0342) bool {
...
func TestE_nocarry_0342LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0342Halve(t *testing.T) {
...
func TestE_nocarry_0342FromMont(t *testing.T) {
...
type testPaire_nocarry_0342 struct {
	element e_nocarry_0342
	bigint  big.Int
}

func (z *e_nocarry_0342) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0342[5] {
		return true
	}
	if z[5] < qe_nocarry_0342[5] {
		return false
	...
	return z[0] >= qe_nocarry_0342[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0342

		g.element = e_nocarry_0342{
		...
		if qe_nocarry_0342[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0342[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0342 {
			var g e_nocarry_0342
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0342[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0342[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0342[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0342[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0342[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0342[5], carry)
...
func Benchmarke_nocarry_0342InverseNew(b *testing.B) {
	var x e_nocarry_0342
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0342
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0342
		var xInv e_nocarry_0342
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0342
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0342
...
func testLinearComb(t *testing.T, x *e_nocarry_0342, xC int64, y *e_nocarry_0342, yC int64) {
	...
	var z e_nocarry_0342
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0342, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0342
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0342, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0342
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0342, xHi uint64) {
	var res e_nocarry_0342
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0342) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0342) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0342, c int64, result *e_nocarry_0342, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0342) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0342) uint64 {
