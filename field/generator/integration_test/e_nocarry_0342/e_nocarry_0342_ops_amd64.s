...
// modulus q
DATA q<>+0(SB)/8, $0x73c9696755289253
DATA q<>+8(SB)/8, $0x9ebcaba3c516f166
DATA q<>+16(SB)/8, $0x06f6df5bfa15f646
DATA q<>+24(SB)/8, $0x1d74845bcff16405
DATA q<>+32(SB)/8, $0x4eff4db6af69dab7
DATA q<>+40(SB)/8, $0x000000000030780d
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x425e295e7aaa7e25
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x73c9696755289253, R10
	MOVQ    $0x9ebcaba3c516f166, R11
	MOVQ    $0x06f6df5bfa15f646, R12
	MOVQ    $0x1d74845bcff16405, R13
	MOVQ    $0x4eff4db6af69dab7, R14
	MOVQ    $0x000000000030780d, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x9ebcaba3c516f166, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x06f6df5bfa15f646, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x1d74845bcff16405, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x4eff4db6af69dab7, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x000000000030780d, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x73c9696755289253, CX
	MOVQ    $0x9ebcaba3c516f166, BX
	MOVQ    $0x06f6df5bfa15f646, SI
	MOVQ    $0x1d74845bcff16405, DI
	MOVQ    $0x4eff4db6af69dab7, R8
	MOVQ    $0x000000000030780d, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
