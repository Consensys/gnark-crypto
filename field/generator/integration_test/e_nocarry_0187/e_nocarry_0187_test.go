...
var benchRese_nocarry_0187 e_nocarry_0187

func BenchmarkE_nocarry_0187SetBytes(b *testing.B) {
	var x e_nocarry_0187
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0187MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0187.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0187)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0187)
		}
	})
}

func BenchmarkE_nocarry_0187Inverse(b *testing.B) {
	var x e_nocarry_0187
	x.SetRandom()
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0187Butterfly(b *testing.B) {
	var x e_nocarry_0187
	x.SetRandom()
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0187)
	}
}

func BenchmarkE_nocarry_0187Exp(b *testing.B) {
	var x e_nocarry_0187
	x.SetRandom()
	benchRese_nocarry_0187.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0187Double(b *testing.B) {
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Double(&benchRese_nocarry_0187)
	}
}

func BenchmarkE_nocarry_0187Add(b *testing.B) {
	var x e_nocarry_0187
	x.SetRandom()
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Add(&x, &benchRese_nocarry_0187)
	}
}

func BenchmarkE_nocarry_0187Sub(b *testing.B) {
	var x e_nocarry_0187
	x.SetRandom()
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Sub(&x, &benchRese_nocarry_0187)
	}
}

func BenchmarkE_nocarry_0187Neg(b *testing.B) {
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Neg(&benchRese_nocarry_0187)
	}
}

func BenchmarkE_nocarry_0187Div(b *testing.B) {
	var x e_nocarry_0187
	x.SetRandom()
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Div(&x, &benchRese_nocarry_0187)
	}
}

func BenchmarkE_nocarry_0187FromMont(b *testing.B) {
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.FromMont()
	}
}

func BenchmarkE_nocarry_0187ToMont(b *testing.B) {
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.ToMont()
	}
}
func BenchmarkE_nocarry_0187Square(b *testing.B) {
	benchRese_nocarry_0187.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Square(&benchRese_nocarry_0187)
	}
}

func BenchmarkE_nocarry_0187Sqrt(b *testing.B) {
	var a e_nocarry_0187
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0187Mul(b *testing.B) {
	x := e_nocarry_0187{
		12220111043817988803,
		11473494824949674563,
		469647079058942221,
	}
	benchRese_nocarry_0187.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Mul(&benchRese_nocarry_0187, &x)
	}
}

func BenchmarkE_nocarry_0187Cmp(b *testing.B) {
	x := e_nocarry_0187{
		12220111043817988803,
		11473494824949674563,
		469647079058942221,
	}
	benchRese_nocarry_0187 = x
	benchRese_nocarry_0187[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0187.Cmp(&x)
	}
}

func TestE_nocarry_0187Cmp(t *testing.T) {
	var x, y e_nocarry_0187
...
func TestE_nocarry_0187IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0187
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0187

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0187{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0187
	one.SetOne()
	e.Sub(&qe_nocarry_0187, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0187{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0187{0, uint64(i)})
	}
...
func TestE_nocarry_0187NegZero(t *testing.T) {
	var a, b e_nocarry_0187
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0187Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0187, len(staticTestValues))
...
func TestE_nocarry_0187Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0187) bool {
			var b e_nocarry_0187
...
func TestE_nocarry_0187InverseExp(t *testing.T) {
...
func TestE_nocarry_0187MulByConstants(t *testing.T) {
...
func TestE_nocarry_0187Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0187) bool {
...
func TestE_nocarry_0187LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0187Halve(t *testing.T) {
...
func TestE_nocarry_0187FromMont(t *testing.T) {
...
type testPaire_nocarry_0187 struct {
	element e_nocarry_0187
	bigint  big.Int
}

func (z *e_nocarry_0187) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0187[2] {
		return true
	}
	if z[2] < qe_nocarry_0187[2] {
		return false
	...
	return z[0] >= qe_nocarry_0187[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0187

		g.element = e_nocarry_0187{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0187[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0187[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0187 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0187[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0187[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0187[2], carry)
...
func Benchmarke_nocarry_0187InverseNew(b *testing.B) {
	var x e_nocarry_0187
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0187
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0187
		var xInv e_nocarry_0187
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0187
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0187
...
func testLinearComb(t *testing.T, x *e_nocarry_0187, xC int64, y *e_nocarry_0187, yC int64) {
	...
	var z e_nocarry_0187
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0187, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0187
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0187, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0187
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0187, xHi uint64) {
	var res e_nocarry_0187
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0187) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0187) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0187, c int64, result *e_nocarry_0187, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0187) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0187) uint64 {
