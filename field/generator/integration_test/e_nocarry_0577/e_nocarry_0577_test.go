...
var benchRese_nocarry_0577 e_nocarry_0577

func BenchmarkE_nocarry_0577SetBytes(b *testing.B) {
	var x e_nocarry_0577
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0577MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0577.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0577)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0577)
		}
	})
}

func BenchmarkE_nocarry_0577Inverse(b *testing.B) {
	var x e_nocarry_0577
	x.SetRandom()
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0577Butterfly(b *testing.B) {
	var x e_nocarry_0577
	x.SetRandom()
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0577)
	}
}

func BenchmarkE_nocarry_0577Exp(b *testing.B) {
	var x e_nocarry_0577
	x.SetRandom()
	benchRese_nocarry_0577.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0577Double(b *testing.B) {
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Double(&benchRese_nocarry_0577)
	}
}

func BenchmarkE_nocarry_0577Add(b *testing.B) {
	var x e_nocarry_0577
	x.SetRandom()
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Add(&x, &benchRese_nocarry_0577)
	}
}

func BenchmarkE_nocarry_0577Sub(b *testing.B) {
	var x e_nocarry_0577
	x.SetRandom()
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Sub(&x, &benchRese_nocarry_0577)
	}
}

func BenchmarkE_nocarry_0577Neg(b *testing.B) {
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Neg(&benchRese_nocarry_0577)
	}
}

func BenchmarkE_nocarry_0577Div(b *testing.B) {
	var x e_nocarry_0577
	x.SetRandom()
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Div(&x, &benchRese_nocarry_0577)
	}
}

func BenchmarkE_nocarry_0577FromMont(b *testing.B) {
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.FromMont()
	}
}

func BenchmarkE_nocarry_0577ToMont(b *testing.B) {
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.ToMont()
	}
}
func BenchmarkE_nocarry_0577Square(b *testing.B) {
	benchRese_nocarry_0577.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Square(&benchRese_nocarry_0577)
	}
}

func BenchmarkE_nocarry_0577Sqrt(b *testing.B) {
	var a e_nocarry_0577
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0577Mul(b *testing.B) {
	x := e_nocarry_0577{
	...
	benchRese_nocarry_0577.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Mul(&benchRese_nocarry_0577, &x)
	}
}

func BenchmarkE_nocarry_0577Cmp(b *testing.B) {
	x := e_nocarry_0577{
		16417964236172442879,
		13942262295018148089,
		15889990652550019972,
	...
	benchRese_nocarry_0577 = x
	benchRese_nocarry_0577[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0577.Cmp(&x)
	}
}

func TestE_nocarry_0577Cmp(t *testing.T) {
	var x, y e_nocarry_0577
...
func TestE_nocarry_0577IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0577
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0577

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0577{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0577
	one.SetOne()
	e.Sub(&qe_nocarry_0577, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0577{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0577{0, uint64(i)})
	}
...
func TestE_nocarry_0577NegZero(t *testing.T) {
	var a, b e_nocarry_0577
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0577Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0577, len(staticTestValues))
...
func TestE_nocarry_0577Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0577) bool {
			var b e_nocarry_0577
...
func TestE_nocarry_0577InverseExp(t *testing.T) {
...
func TestE_nocarry_0577MulByConstants(t *testing.T) {
...
func TestE_nocarry_0577Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0577) bool {
...
func TestE_nocarry_0577LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0577Halve(t *testing.T) {
...
func TestE_nocarry_0577FromMont(t *testing.T) {
...
type testPaire_nocarry_0577 struct {
	element e_nocarry_0577
	bigint  big.Int
}

func (z *e_nocarry_0577) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0577[9] {
		return true
	}
	if z[9] < qe_nocarry_0577[9] {
		return false
	...
	return z[0] >= qe_nocarry_0577[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0577

		g.element = e_nocarry_0577{
		...
		if qe_nocarry_0577[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0577[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0577 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0577[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0577[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0577[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0577[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0577[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0577[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0577[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0577[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0577[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0577[9], carry)
...
func Benchmarke_nocarry_0577InverseNew(b *testing.B) {
	var x e_nocarry_0577
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0577
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0577
		var xInv e_nocarry_0577
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0577
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0577
...
func testLinearComb(t *testing.T, x *e_nocarry_0577, xC int64, y *e_nocarry_0577, yC int64) {
	...
	var z e_nocarry_0577
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0577, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0577
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0577, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0577
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0577, xHi uint64) {
	var res e_nocarry_0577
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0577) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0577) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0577, c int64, result *e_nocarry_0577, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0577) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0577) uint64 {
