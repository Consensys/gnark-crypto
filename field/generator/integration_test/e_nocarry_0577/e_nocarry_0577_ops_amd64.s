...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x5d29857002f0f671, R13
	ADDQ R13, AX
	MOVQ $0xd88d630d979f1062, R13
	ADCQ R13, DX
	MOVQ $0x86098095ee2b2be1, R13
	ADCQ R13, CX
	MOVQ $0x69efa8f9dab436d2, R13
	ADCQ R13, BX
	MOVQ $0xfa0ad76770566478, R13
	ADCQ R13, SI
	MOVQ $0xab54a4f0d185dd8d, R13
	ADCQ R13, DI
	MOVQ $0xf99e0e4824be368c, R13
	ADCQ R13, R8
	MOVQ $0xe6e20f867c8c824e, R13
	ADCQ R13, R9
	MOVQ $0xafe9aa857f310451, R13
	ADCQ R13, R10
	MOVQ $1, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x5d29857002f0f671, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xd88d630d979f1062, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0x86098095ee2b2be1, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x69efa8f9dab436d2, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0xfa0ad76770566478, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xab54a4f0d185dd8d, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xf99e0e4824be368c, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xe6e20f867c8c824e, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xafe9aa857f310451, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $1, R14
	SBBQ  R12, R14
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x5d29857002f0f671, AX
	ADDQ AX, DX
	MOVQ $0xd88d630d979f1062, AX
	ADCQ AX, CX
	MOVQ $0x86098095ee2b2be1, AX
	ADCQ AX, BX
	MOVQ $0x69efa8f9dab436d2, AX
	ADCQ AX, SI
	MOVQ $0xfa0ad76770566478, AX
	ADCQ AX, DI
	MOVQ $0xab54a4f0d185dd8d, AX
	ADCQ AX, R8
	MOVQ $0xf99e0e4824be368c, AX
	ADCQ AX, R9
	MOVQ $0xe6e20f867c8c824e, AX
	ADCQ AX, R10
	MOVQ $0xafe9aa857f310451, AX
	ADCQ AX, R11
	MOVQ $1, AX
	ADCQ AX, R12
