...
// modulus q
DATA q<>+0(SB)/8, $0x934ecdb386bdecb7
DATA q<>+8(SB)/8, $0x1f58dbc0ba541d3d
DATA q<>+16(SB)/8, $0xf7d9e5e966f25c29
DATA q<>+24(SB)/8, $0x48d5f0377cc26a21
DATA q<>+32(SB)/8, $0x6afdb9dd9cf47af5
DATA q<>+40(SB)/8, $0x00000006a12e4976
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x70a17ef51b034ef9
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x934ecdb386bdecb7, R10
	MOVQ    $0x1f58dbc0ba541d3d, R11
	MOVQ    $0xf7d9e5e966f25c29, R12
	MOVQ    $0x48d5f0377cc26a21, R13
	MOVQ    $0x6afdb9dd9cf47af5, R14
	MOVQ    $0x00000006a12e4976, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x1f58dbc0ba541d3d, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xf7d9e5e966f25c29, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x48d5f0377cc26a21, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x6afdb9dd9cf47af5, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000006a12e4976, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x934ecdb386bdecb7, CX
	MOVQ    $0x1f58dbc0ba541d3d, BX
	MOVQ    $0xf7d9e5e966f25c29, SI
	MOVQ    $0x48d5f0377cc26a21, DI
	MOVQ    $0x6afdb9dd9cf47af5, R8
	MOVQ    $0x00000006a12e4976, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
