...
var benchRese_nocarry_0355 e_nocarry_0355

func BenchmarkE_nocarry_0355SetBytes(b *testing.B) {
	var x e_nocarry_0355
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0355MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0355.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0355)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0355)
		}
	})
}

func BenchmarkE_nocarry_0355Inverse(b *testing.B) {
	var x e_nocarry_0355
	x.SetRandom()
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0355Butterfly(b *testing.B) {
	var x e_nocarry_0355
	x.SetRandom()
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0355)
	}
}

func BenchmarkE_nocarry_0355Exp(b *testing.B) {
	var x e_nocarry_0355
	x.SetRandom()
	benchRese_nocarry_0355.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0355Double(b *testing.B) {
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Double(&benchRese_nocarry_0355)
	}
}

func BenchmarkE_nocarry_0355Add(b *testing.B) {
	var x e_nocarry_0355
	x.SetRandom()
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Add(&x, &benchRese_nocarry_0355)
	}
}

func BenchmarkE_nocarry_0355Sub(b *testing.B) {
	var x e_nocarry_0355
	x.SetRandom()
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Sub(&x, &benchRese_nocarry_0355)
	}
}

func BenchmarkE_nocarry_0355Neg(b *testing.B) {
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Neg(&benchRese_nocarry_0355)
	}
}

func BenchmarkE_nocarry_0355Div(b *testing.B) {
	var x e_nocarry_0355
	x.SetRandom()
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Div(&x, &benchRese_nocarry_0355)
	}
}

func BenchmarkE_nocarry_0355FromMont(b *testing.B) {
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.FromMont()
	}
}

func BenchmarkE_nocarry_0355ToMont(b *testing.B) {
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.ToMont()
	}
}
func BenchmarkE_nocarry_0355Square(b *testing.B) {
	benchRese_nocarry_0355.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Square(&benchRese_nocarry_0355)
	}
}

func BenchmarkE_nocarry_0355Sqrt(b *testing.B) {
	var a e_nocarry_0355
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0355Mul(b *testing.B) {
	x := e_nocarry_0355{
	...
	benchRese_nocarry_0355.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Mul(&benchRese_nocarry_0355, &x)
	}
}

func BenchmarkE_nocarry_0355Cmp(b *testing.B) {
	x := e_nocarry_0355{
		17024493663519244429,
		4571413424871854170,
		5268875198325667284,
	...
	benchRese_nocarry_0355 = x
	benchRese_nocarry_0355[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0355.Cmp(&x)
	}
}

func TestE_nocarry_0355Cmp(t *testing.T) {
	var x, y e_nocarry_0355
...
func TestE_nocarry_0355IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0355
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0355

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0355{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0355
	one.SetOne()
	e.Sub(&qe_nocarry_0355, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0355{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0355{0, uint64(i)})
	}
...
func TestE_nocarry_0355NegZero(t *testing.T) {
	var a, b e_nocarry_0355
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0355Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0355, len(staticTestValues))
...
func TestE_nocarry_0355Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0355) bool {
			var b e_nocarry_0355
...
func TestE_nocarry_0355InverseExp(t *testing.T) {
...
func TestE_nocarry_0355MulByConstants(t *testing.T) {
...
func TestE_nocarry_0355Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0355) bool {
...
func TestE_nocarry_0355LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0355Halve(t *testing.T) {
...
func TestE_nocarry_0355FromMont(t *testing.T) {
...
type testPaire_nocarry_0355 struct {
	element e_nocarry_0355
	bigint  big.Int
}

func (z *e_nocarry_0355) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0355[5] {
		return true
	}
	if z[5] < qe_nocarry_0355[5] {
		return false
	...
	return z[0] >= qe_nocarry_0355[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0355

		g.element = e_nocarry_0355{
		...
		if qe_nocarry_0355[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0355[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0355 {
			var g e_nocarry_0355
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0355[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0355[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0355[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0355[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0355[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0355[5], carry)
...
func Benchmarke_nocarry_0355InverseNew(b *testing.B) {
	var x e_nocarry_0355
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0355
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0355
		var xInv e_nocarry_0355
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0355
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0355
...
func testLinearComb(t *testing.T, x *e_nocarry_0355, xC int64, y *e_nocarry_0355, yC int64) {
	...
	var z e_nocarry_0355
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0355, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0355
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0355, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0355
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0355, xHi uint64) {
	var res e_nocarry_0355
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0355) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0355) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0355, c int64, result *e_nocarry_0355, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0355) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0355) uint64 {
