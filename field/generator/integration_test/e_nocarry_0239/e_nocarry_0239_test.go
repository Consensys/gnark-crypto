...
var benchRese_nocarry_0239 e_nocarry_0239

func BenchmarkE_nocarry_0239SetBytes(b *testing.B) {
	var x e_nocarry_0239
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0239MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0239.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0239)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0239)
		}
	})
}

func BenchmarkE_nocarry_0239Inverse(b *testing.B) {
	var x e_nocarry_0239
	x.SetRandom()
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0239Butterfly(b *testing.B) {
	var x e_nocarry_0239
	x.SetRandom()
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0239)
	}
}

func BenchmarkE_nocarry_0239Exp(b *testing.B) {
	var x e_nocarry_0239
	x.SetRandom()
	benchRese_nocarry_0239.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0239Double(b *testing.B) {
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Double(&benchRese_nocarry_0239)
	}
}

func BenchmarkE_nocarry_0239Add(b *testing.B) {
	var x e_nocarry_0239
	x.SetRandom()
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Add(&x, &benchRese_nocarry_0239)
	}
}

func BenchmarkE_nocarry_0239Sub(b *testing.B) {
	var x e_nocarry_0239
	x.SetRandom()
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Sub(&x, &benchRese_nocarry_0239)
	}
}

func BenchmarkE_nocarry_0239Neg(b *testing.B) {
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Neg(&benchRese_nocarry_0239)
	}
}

func BenchmarkE_nocarry_0239Div(b *testing.B) {
	var x e_nocarry_0239
	x.SetRandom()
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Div(&x, &benchRese_nocarry_0239)
	}
}

func BenchmarkE_nocarry_0239FromMont(b *testing.B) {
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.FromMont()
	}
}

func BenchmarkE_nocarry_0239ToMont(b *testing.B) {
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.ToMont()
	}
}
func BenchmarkE_nocarry_0239Square(b *testing.B) {
	benchRese_nocarry_0239.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Square(&benchRese_nocarry_0239)
	}
}

func BenchmarkE_nocarry_0239Sqrt(b *testing.B) {
	var a e_nocarry_0239
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0239Mul(b *testing.B) {
	x := e_nocarry_0239{
	...
	benchRese_nocarry_0239.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Mul(&benchRese_nocarry_0239, &x)
	}
}

func BenchmarkE_nocarry_0239Cmp(b *testing.B) {
	x := e_nocarry_0239{
		10316421979052316609,
		6000600401564469255,
		16088919773169045625,
	...
	benchRese_nocarry_0239 = x
	benchRese_nocarry_0239[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0239.Cmp(&x)
	}
}

func TestE_nocarry_0239Cmp(t *testing.T) {
	var x, y e_nocarry_0239
...
func TestE_nocarry_0239IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0239
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0239

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0239{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0239
	one.SetOne()
	e.Sub(&qe_nocarry_0239, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0239{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0239{0, uint64(i)})
	}
...
func TestE_nocarry_0239NegZero(t *testing.T) {
	var a, b e_nocarry_0239
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0239Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0239, len(staticTestValues))
...
func TestE_nocarry_0239Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0239) bool {
			var b e_nocarry_0239
...
func TestE_nocarry_0239InverseExp(t *testing.T) {
...
func TestE_nocarry_0239MulByConstants(t *testing.T) {
...
func TestE_nocarry_0239Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0239) bool {
...
func TestE_nocarry_0239LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0239Halve(t *testing.T) {
...
func TestE_nocarry_0239FromMont(t *testing.T) {
...
type testPaire_nocarry_0239 struct {
	element e_nocarry_0239
	bigint  big.Int
}

func (z *e_nocarry_0239) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0239[3] {
		return true
	}
	if z[3] < qe_nocarry_0239[3] {
		return false
	...
	return z[0] >= qe_nocarry_0239[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0239

		g.element = e_nocarry_0239{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0239[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0239[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0239 {
			var g e_nocarry_0239
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0239[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0239[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0239[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0239[3], carry)
...
func Benchmarke_nocarry_0239InverseNew(b *testing.B) {
	var x e_nocarry_0239
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0239
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0239
		var xInv e_nocarry_0239
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0239
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0239
...
func testLinearComb(t *testing.T, x *e_nocarry_0239, xC int64, y *e_nocarry_0239, yC int64) {
	...
	var z e_nocarry_0239
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0239, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0239
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0239, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0239
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0239, xHi uint64) {
	var res e_nocarry_0239
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0239) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0239) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0239, c int64, result *e_nocarry_0239, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0239) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0239) uint64 {
