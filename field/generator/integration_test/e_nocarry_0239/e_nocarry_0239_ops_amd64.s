...
// modulus q
DATA q<>+0(SB)/8, $0xb486885c120cea27
DATA q<>+8(SB)/8, $0x1b0c5bf63d084ab0
DATA q<>+16(SB)/8, $0x7a06bb73e72b731f
DATA q<>+24(SB)/8, $0x000079d69573bbf6
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x594e7c4b1f341a69
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xb486885c120cea27, R8
	MOVQ    $0x1b0c5bf63d084ab0, R9
	MOVQ    $0x7a06bb73e72b731f, R10
	MOVQ    $0x000079d69573bbf6, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x1b0c5bf63d084ab0, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x7a06bb73e72b731f, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x000079d69573bbf6, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0xb486885c120cea27, R12
	MOVQ    $0x1b0c5bf63d084ab0, R13
	MOVQ    $0x7a06bb73e72b731f, R14
	MOVQ    $0x000079d69573bbf6, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
