...
var benchRese_nocarry_0147 e_nocarry_0147

func BenchmarkE_nocarry_0147SetBytes(b *testing.B) {
	var x e_nocarry_0147
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0147MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0147.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0147)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0147)
		}
	})
}

func BenchmarkE_nocarry_0147Inverse(b *testing.B) {
	var x e_nocarry_0147
	x.SetRandom()
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0147Butterfly(b *testing.B) {
	var x e_nocarry_0147
	x.SetRandom()
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0147)
	}
}

func BenchmarkE_nocarry_0147Exp(b *testing.B) {
	var x e_nocarry_0147
	x.SetRandom()
	benchRese_nocarry_0147.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0147Double(b *testing.B) {
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Double(&benchRese_nocarry_0147)
	}
}

func BenchmarkE_nocarry_0147Add(b *testing.B) {
	var x e_nocarry_0147
	x.SetRandom()
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Add(&x, &benchRese_nocarry_0147)
	}
}

func BenchmarkE_nocarry_0147Sub(b *testing.B) {
	var x e_nocarry_0147
	x.SetRandom()
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Sub(&x, &benchRese_nocarry_0147)
	}
}

func BenchmarkE_nocarry_0147Neg(b *testing.B) {
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Neg(&benchRese_nocarry_0147)
	}
}

func BenchmarkE_nocarry_0147Div(b *testing.B) {
	var x e_nocarry_0147
	x.SetRandom()
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Div(&x, &benchRese_nocarry_0147)
	}
}

func BenchmarkE_nocarry_0147FromMont(b *testing.B) {
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.FromMont()
	}
}

func BenchmarkE_nocarry_0147ToMont(b *testing.B) {
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.ToMont()
	}
}
func BenchmarkE_nocarry_0147Square(b *testing.B) {
	benchRese_nocarry_0147.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Square(&benchRese_nocarry_0147)
	}
}

func BenchmarkE_nocarry_0147Sqrt(b *testing.B) {
	var a e_nocarry_0147
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0147Mul(b *testing.B) {
	x := e_nocarry_0147{
		13782087975307382064,
		15019731761383116073,
		105919,
	}
	benchRese_nocarry_0147.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Mul(&benchRese_nocarry_0147, &x)
	}
}

func BenchmarkE_nocarry_0147Cmp(b *testing.B) {
	x := e_nocarry_0147{
		13782087975307382064,
		15019731761383116073,
		105919,
	}
	benchRese_nocarry_0147 = x
	benchRese_nocarry_0147[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0147.Cmp(&x)
	}
}

func TestE_nocarry_0147Cmp(t *testing.T) {
	var x, y e_nocarry_0147
...
func TestE_nocarry_0147IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0147
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0147

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0147{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0147
	one.SetOne()
	e.Sub(&qe_nocarry_0147, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0147{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0147{0, uint64(i)})
	}
...
func TestE_nocarry_0147NegZero(t *testing.T) {
	var a, b e_nocarry_0147
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0147Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0147, len(staticTestValues))
...
func TestE_nocarry_0147Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0147) bool {
			var b e_nocarry_0147
...
func TestE_nocarry_0147InverseExp(t *testing.T) {
...
func TestE_nocarry_0147MulByConstants(t *testing.T) {
...
func TestE_nocarry_0147Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0147) bool {
...
func TestE_nocarry_0147LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0147Halve(t *testing.T) {
...
func TestE_nocarry_0147FromMont(t *testing.T) {
...
type testPaire_nocarry_0147 struct {
	element e_nocarry_0147
	bigint  big.Int
}

func (z *e_nocarry_0147) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0147[2] {
		return true
	}
	if z[2] < qe_nocarry_0147[2] {
		return false
	...
	return z[0] >= qe_nocarry_0147[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0147

		g.element = e_nocarry_0147{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0147[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0147[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0147 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0147[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0147[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0147[2], carry)
...
func Benchmarke_nocarry_0147InverseNew(b *testing.B) {
	var x e_nocarry_0147
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0147
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0147
		var xInv e_nocarry_0147
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0147
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0147
...
func testLinearComb(t *testing.T, x *e_nocarry_0147, xC int64, y *e_nocarry_0147, yC int64) {
	...
	var z e_nocarry_0147
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0147, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0147
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0147, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0147
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0147, xHi uint64) {
	var res e_nocarry_0147
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0147) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0147) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0147, c int64, result *e_nocarry_0147, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0147) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0147) uint64 {
