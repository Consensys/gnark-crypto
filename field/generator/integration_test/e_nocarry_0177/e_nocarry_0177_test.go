...
var benchRese_nocarry_0177 e_nocarry_0177

func BenchmarkE_nocarry_0177SetBytes(b *testing.B) {
	var x e_nocarry_0177
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0177MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0177.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0177)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0177)
		}
	})
}

func BenchmarkE_nocarry_0177Inverse(b *testing.B) {
	var x e_nocarry_0177
	x.SetRandom()
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0177Butterfly(b *testing.B) {
	var x e_nocarry_0177
	x.SetRandom()
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0177)
	}
}

func BenchmarkE_nocarry_0177Exp(b *testing.B) {
	var x e_nocarry_0177
	x.SetRandom()
	benchRese_nocarry_0177.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0177Double(b *testing.B) {
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Double(&benchRese_nocarry_0177)
	}
}

func BenchmarkE_nocarry_0177Add(b *testing.B) {
	var x e_nocarry_0177
	x.SetRandom()
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Add(&x, &benchRese_nocarry_0177)
	}
}

func BenchmarkE_nocarry_0177Sub(b *testing.B) {
	var x e_nocarry_0177
	x.SetRandom()
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Sub(&x, &benchRese_nocarry_0177)
	}
}

func BenchmarkE_nocarry_0177Neg(b *testing.B) {
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Neg(&benchRese_nocarry_0177)
	}
}

func BenchmarkE_nocarry_0177Div(b *testing.B) {
	var x e_nocarry_0177
	x.SetRandom()
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Div(&x, &benchRese_nocarry_0177)
	}
}

func BenchmarkE_nocarry_0177FromMont(b *testing.B) {
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.FromMont()
	}
}

func BenchmarkE_nocarry_0177ToMont(b *testing.B) {
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.ToMont()
	}
}
func BenchmarkE_nocarry_0177Square(b *testing.B) {
	benchRese_nocarry_0177.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Square(&benchRese_nocarry_0177)
	}
}

func BenchmarkE_nocarry_0177Sqrt(b *testing.B) {
	var a e_nocarry_0177
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0177Mul(b *testing.B) {
	x := e_nocarry_0177{
		10485394981403427056,
		5495068130206859895,
		232755373721202,
	}
	benchRese_nocarry_0177.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Mul(&benchRese_nocarry_0177, &x)
	}
}

func BenchmarkE_nocarry_0177Cmp(b *testing.B) {
	x := e_nocarry_0177{
		10485394981403427056,
		5495068130206859895,
		232755373721202,
	}
	benchRese_nocarry_0177 = x
	benchRese_nocarry_0177[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0177.Cmp(&x)
	}
}

func TestE_nocarry_0177Cmp(t *testing.T) {
	var x, y e_nocarry_0177
...
func TestE_nocarry_0177IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0177
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0177

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0177{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0177
	one.SetOne()
	e.Sub(&qe_nocarry_0177, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0177{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0177{0, uint64(i)})
	}
...
func TestE_nocarry_0177NegZero(t *testing.T) {
	var a, b e_nocarry_0177
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0177Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0177, len(staticTestValues))
...
func TestE_nocarry_0177Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0177) bool {
			var b e_nocarry_0177
...
func TestE_nocarry_0177InverseExp(t *testing.T) {
...
func TestE_nocarry_0177MulByConstants(t *testing.T) {
...
func TestE_nocarry_0177Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0177) bool {
...
func TestE_nocarry_0177LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0177Halve(t *testing.T) {
...
func TestE_nocarry_0177FromMont(t *testing.T) {
...
type testPaire_nocarry_0177 struct {
	element e_nocarry_0177
	bigint  big.Int
}

func (z *e_nocarry_0177) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0177[2] {
		return true
	}
	if z[2] < qe_nocarry_0177[2] {
		return false
	...
	return z[0] >= qe_nocarry_0177[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0177

		g.element = e_nocarry_0177{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0177[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0177[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0177 {
			var g e_nocarry_0177
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0177[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0177[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0177[2], carry)
...
func Benchmarke_nocarry_0177InverseNew(b *testing.B) {
	var x e_nocarry_0177
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0177
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0177
		var xInv e_nocarry_0177
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0177
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0177
...
func testLinearComb(t *testing.T, x *e_nocarry_0177, xC int64, y *e_nocarry_0177, yC int64) {
	...
	var z e_nocarry_0177
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0177, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0177
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0177, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0177
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0177, xHi uint64) {
	var res e_nocarry_0177
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0177) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0177) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0177, c int64, result *e_nocarry_0177, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0177) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0177) uint64 {
