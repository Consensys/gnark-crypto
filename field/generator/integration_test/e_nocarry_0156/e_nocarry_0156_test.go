...
var benchRese_nocarry_0156 e_nocarry_0156

func BenchmarkE_nocarry_0156SetBytes(b *testing.B) {
	var x e_nocarry_0156
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0156MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0156.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0156)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0156)
		}
	})
}

func BenchmarkE_nocarry_0156Inverse(b *testing.B) {
	var x e_nocarry_0156
	x.SetRandom()
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0156Butterfly(b *testing.B) {
	var x e_nocarry_0156
	x.SetRandom()
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0156)
	}
}

func BenchmarkE_nocarry_0156Exp(b *testing.B) {
	var x e_nocarry_0156
	x.SetRandom()
	benchRese_nocarry_0156.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0156Double(b *testing.B) {
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Double(&benchRese_nocarry_0156)
	}
}

func BenchmarkE_nocarry_0156Add(b *testing.B) {
	var x e_nocarry_0156
	x.SetRandom()
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Add(&x, &benchRese_nocarry_0156)
	}
}

func BenchmarkE_nocarry_0156Sub(b *testing.B) {
	var x e_nocarry_0156
	x.SetRandom()
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Sub(&x, &benchRese_nocarry_0156)
	}
}

func BenchmarkE_nocarry_0156Neg(b *testing.B) {
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Neg(&benchRese_nocarry_0156)
	}
}

func BenchmarkE_nocarry_0156Div(b *testing.B) {
	var x e_nocarry_0156
	x.SetRandom()
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Div(&x, &benchRese_nocarry_0156)
	}
}

func BenchmarkE_nocarry_0156FromMont(b *testing.B) {
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.FromMont()
	}
}

func BenchmarkE_nocarry_0156ToMont(b *testing.B) {
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.ToMont()
	}
}
func BenchmarkE_nocarry_0156Square(b *testing.B) {
	benchRese_nocarry_0156.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Square(&benchRese_nocarry_0156)
	}
}

func BenchmarkE_nocarry_0156Sqrt(b *testing.B) {
	var a e_nocarry_0156
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0156Mul(b *testing.B) {
	x := e_nocarry_0156{
		1768593067298311113,
		12527062767899123661,
		194611034,
	}
	benchRese_nocarry_0156.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Mul(&benchRese_nocarry_0156, &x)
	}
}

func BenchmarkE_nocarry_0156Cmp(b *testing.B) {
	x := e_nocarry_0156{
		1768593067298311113,
		12527062767899123661,
		194611034,
	}
	benchRese_nocarry_0156 = x
	benchRese_nocarry_0156[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0156.Cmp(&x)
	}
}

func TestE_nocarry_0156Cmp(t *testing.T) {
	var x, y e_nocarry_0156
...
func TestE_nocarry_0156IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0156
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0156

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0156{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0156
	one.SetOne()
	e.Sub(&qe_nocarry_0156, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0156{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0156{0, uint64(i)})
	}
...
func TestE_nocarry_0156NegZero(t *testing.T) {
	var a, b e_nocarry_0156
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0156Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0156, len(staticTestValues))
...
func TestE_nocarry_0156Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0156) bool {
			var b e_nocarry_0156
...
func TestE_nocarry_0156InverseExp(t *testing.T) {
...
func TestE_nocarry_0156MulByConstants(t *testing.T) {
...
func TestE_nocarry_0156Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0156) bool {
...
func TestE_nocarry_0156LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0156Halve(t *testing.T) {
...
func TestE_nocarry_0156FromMont(t *testing.T) {
...
type testPaire_nocarry_0156 struct {
	element e_nocarry_0156
	bigint  big.Int
}

func (z *e_nocarry_0156) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0156[2] {
		return true
	}
	if z[2] < qe_nocarry_0156[2] {
		return false
	...
	return z[0] >= qe_nocarry_0156[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0156

		g.element = e_nocarry_0156{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0156[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0156[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0156 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0156[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0156[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0156[2], carry)
...
func Benchmarke_nocarry_0156InverseNew(b *testing.B) {
	var x e_nocarry_0156
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0156
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0156
		var xInv e_nocarry_0156
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0156
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0156
...
func testLinearComb(t *testing.T, x *e_nocarry_0156, xC int64, y *e_nocarry_0156, yC int64) {
	...
	var z e_nocarry_0156
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0156, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0156
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0156, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0156
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0156, xHi uint64) {
	var res e_nocarry_0156
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0156) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0156) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0156, c int64, result *e_nocarry_0156, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0156) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0156) uint64 {
