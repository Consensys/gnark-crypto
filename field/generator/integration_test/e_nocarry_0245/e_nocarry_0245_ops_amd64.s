...
// modulus q
DATA q<>+0(SB)/8, $0x1cb57cb6c21ec35f
DATA q<>+8(SB)/8, $0xc708b5d97b91435c
DATA q<>+16(SB)/8, $0x90da8adbc4ee5b12
DATA q<>+24(SB)/8, $0x001a0076d2f512df
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xe0e14a80e63ba761
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x1cb57cb6c21ec35f, R8
	MOVQ    $0xc708b5d97b91435c, R9
	MOVQ    $0x90da8adbc4ee5b12, R10
	MOVQ    $0x001a0076d2f512df, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xc708b5d97b91435c, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x90da8adbc4ee5b12, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x001a0076d2f512df, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x1cb57cb6c21ec35f, R12
	MOVQ    $0xc708b5d97b91435c, R13
	MOVQ    $0x90da8adbc4ee5b12, R14
	MOVQ    $0x001a0076d2f512df, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
