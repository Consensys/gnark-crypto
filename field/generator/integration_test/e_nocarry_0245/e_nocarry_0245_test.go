...
var benchRese_nocarry_0245 e_nocarry_0245

func BenchmarkE_nocarry_0245SetBytes(b *testing.B) {
	var x e_nocarry_0245
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0245MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0245.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0245)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0245)
		}
	})
}

func BenchmarkE_nocarry_0245Inverse(b *testing.B) {
	var x e_nocarry_0245
	x.SetRandom()
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0245Butterfly(b *testing.B) {
	var x e_nocarry_0245
	x.SetRandom()
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0245)
	}
}

func BenchmarkE_nocarry_0245Exp(b *testing.B) {
	var x e_nocarry_0245
	x.SetRandom()
	benchRese_nocarry_0245.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0245Double(b *testing.B) {
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Double(&benchRese_nocarry_0245)
	}
}

func BenchmarkE_nocarry_0245Add(b *testing.B) {
	var x e_nocarry_0245
	x.SetRandom()
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Add(&x, &benchRese_nocarry_0245)
	}
}

func BenchmarkE_nocarry_0245Sub(b *testing.B) {
	var x e_nocarry_0245
	x.SetRandom()
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Sub(&x, &benchRese_nocarry_0245)
	}
}

func BenchmarkE_nocarry_0245Neg(b *testing.B) {
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Neg(&benchRese_nocarry_0245)
	}
}

func BenchmarkE_nocarry_0245Div(b *testing.B) {
	var x e_nocarry_0245
	x.SetRandom()
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Div(&x, &benchRese_nocarry_0245)
	}
}

func BenchmarkE_nocarry_0245FromMont(b *testing.B) {
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.FromMont()
	}
}

func BenchmarkE_nocarry_0245ToMont(b *testing.B) {
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.ToMont()
	}
}
func BenchmarkE_nocarry_0245Square(b *testing.B) {
	benchRese_nocarry_0245.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Square(&benchRese_nocarry_0245)
	}
}

func BenchmarkE_nocarry_0245Sqrt(b *testing.B) {
	var a e_nocarry_0245
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0245Mul(b *testing.B) {
	x := e_nocarry_0245{
	...
	benchRese_nocarry_0245.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Mul(&benchRese_nocarry_0245, &x)
	}
}

func BenchmarkE_nocarry_0245Cmp(b *testing.B) {
	x := e_nocarry_0245{
		16355060069473126539,
		4437103017794087721,
		14924196378846889173,
	...
	benchRese_nocarry_0245 = x
	benchRese_nocarry_0245[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0245.Cmp(&x)
	}
}

func TestE_nocarry_0245Cmp(t *testing.T) {
	var x, y e_nocarry_0245
...
func TestE_nocarry_0245IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0245
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0245

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0245{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0245
	one.SetOne()
	e.Sub(&qe_nocarry_0245, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0245{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0245{0, uint64(i)})
	}
...
func TestE_nocarry_0245NegZero(t *testing.T) {
	var a, b e_nocarry_0245
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0245Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0245, len(staticTestValues))
...
func TestE_nocarry_0245Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0245) bool {
			var b e_nocarry_0245
...
func TestE_nocarry_0245InverseExp(t *testing.T) {
...
func TestE_nocarry_0245MulByConstants(t *testing.T) {
...
func TestE_nocarry_0245Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0245) bool {
...
func TestE_nocarry_0245LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0245Halve(t *testing.T) {
...
func TestE_nocarry_0245FromMont(t *testing.T) {
...
type testPaire_nocarry_0245 struct {
	element e_nocarry_0245
	bigint  big.Int
}

func (z *e_nocarry_0245) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0245[3] {
		return true
	}
	if z[3] < qe_nocarry_0245[3] {
		return false
	...
	return z[0] >= qe_nocarry_0245[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0245

		g.element = e_nocarry_0245{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0245[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0245[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0245 {
			var g e_nocarry_0245
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0245[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0245[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0245[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0245[3], carry)
...
func Benchmarke_nocarry_0245InverseNew(b *testing.B) {
	var x e_nocarry_0245
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0245
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0245
		var xInv e_nocarry_0245
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0245
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0245
...
func testLinearComb(t *testing.T, x *e_nocarry_0245, xC int64, y *e_nocarry_0245, yC int64) {
	...
	var z e_nocarry_0245
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0245, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0245
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0245, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0245
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0245, xHi uint64) {
	var res e_nocarry_0245
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0245) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0245) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0245, c int64, result *e_nocarry_0245, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0245) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0245) uint64 {
