...
// modulus q
DATA q<>+0(SB)/8, $0xa986b93a80a4e9b1
DATA q<>+8(SB)/8, $0xcc412417071fdf3c
DATA q<>+16(SB)/8, $0xba8f0cd87f54de98
DATA q<>+24(SB)/8, $0xfcfa3480f860803c
DATA q<>+32(SB)/8, $0xc4c6524818f0a7cc
DATA q<>+40(SB)/8, $0x0000c6e13b3c9cdb
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xdce8cc50805840af
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xa986b93a80a4e9b1, R10
	MOVQ    $0xcc412417071fdf3c, R11
	MOVQ    $0xba8f0cd87f54de98, R12
	MOVQ    $0xfcfa3480f860803c, R13
	MOVQ    $0xc4c6524818f0a7cc, R14
	MOVQ    $0x0000c6e13b3c9cdb, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0xcc412417071fdf3c, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xba8f0cd87f54de98, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xfcfa3480f860803c, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xc4c6524818f0a7cc, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x0000c6e13b3c9cdb, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xa986b93a80a4e9b1, CX
	MOVQ    $0xcc412417071fdf3c, BX
	MOVQ    $0xba8f0cd87f54de98, SI
	MOVQ    $0xfcfa3480f860803c, DI
	MOVQ    $0xc4c6524818f0a7cc, R8
	MOVQ    $0x0000c6e13b3c9cdb, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
