...
var benchRese_nocarry_0368 e_nocarry_0368

func BenchmarkE_nocarry_0368SetBytes(b *testing.B) {
	var x e_nocarry_0368
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0368MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0368.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0368)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0368)
		}
	})
}

func BenchmarkE_nocarry_0368Inverse(b *testing.B) {
	var x e_nocarry_0368
	x.SetRandom()
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0368Butterfly(b *testing.B) {
	var x e_nocarry_0368
	x.SetRandom()
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0368)
	}
}

func BenchmarkE_nocarry_0368Exp(b *testing.B) {
	var x e_nocarry_0368
	x.SetRandom()
	benchRese_nocarry_0368.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0368Double(b *testing.B) {
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Double(&benchRese_nocarry_0368)
	}
}

func BenchmarkE_nocarry_0368Add(b *testing.B) {
	var x e_nocarry_0368
	x.SetRandom()
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Add(&x, &benchRese_nocarry_0368)
	}
}

func BenchmarkE_nocarry_0368Sub(b *testing.B) {
	var x e_nocarry_0368
	x.SetRandom()
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Sub(&x, &benchRese_nocarry_0368)
	}
}

func BenchmarkE_nocarry_0368Neg(b *testing.B) {
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Neg(&benchRese_nocarry_0368)
	}
}

func BenchmarkE_nocarry_0368Div(b *testing.B) {
	var x e_nocarry_0368
	x.SetRandom()
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Div(&x, &benchRese_nocarry_0368)
	}
}

func BenchmarkE_nocarry_0368FromMont(b *testing.B) {
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.FromMont()
	}
}

func BenchmarkE_nocarry_0368ToMont(b *testing.B) {
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.ToMont()
	}
}
func BenchmarkE_nocarry_0368Square(b *testing.B) {
	benchRese_nocarry_0368.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Square(&benchRese_nocarry_0368)
	}
}

func BenchmarkE_nocarry_0368Sqrt(b *testing.B) {
	var a e_nocarry_0368
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0368Mul(b *testing.B) {
	x := e_nocarry_0368{
		1513305523506364967,
		845955782516959369,
		4333591190662698919,
	...
	benchRese_nocarry_0368.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Mul(&benchRese_nocarry_0368, &x)
	}
}

func BenchmarkE_nocarry_0368Cmp(b *testing.B) {
	x := e_nocarry_0368{
		1513305523506364967,
		845955782516959369,
		4333591190662698919,
	...
	benchRese_nocarry_0368 = x
	benchRese_nocarry_0368[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0368.Cmp(&x)
	}
}

func TestE_nocarry_0368Cmp(t *testing.T) {
	var x, y e_nocarry_0368
...
func TestE_nocarry_0368IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0368
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0368

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0368{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0368
	one.SetOne()
	e.Sub(&qe_nocarry_0368, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0368{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0368{0, uint64(i)})
	}
...
func TestE_nocarry_0368NegZero(t *testing.T) {
	var a, b e_nocarry_0368
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0368Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0368, len(staticTestValues))
...
func TestE_nocarry_0368Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0368) bool {
			var b e_nocarry_0368
...
func TestE_nocarry_0368InverseExp(t *testing.T) {
...
func TestE_nocarry_0368MulByConstants(t *testing.T) {
...
func TestE_nocarry_0368Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0368) bool {
...
func TestE_nocarry_0368LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0368Halve(t *testing.T) {
...
func TestE_nocarry_0368FromMont(t *testing.T) {
...
type testPaire_nocarry_0368 struct {
	element e_nocarry_0368
	bigint  big.Int
}

func (z *e_nocarry_0368) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0368[5] {
		return true
	}
	if z[5] < qe_nocarry_0368[5] {
		return false
	...
	return z[0] >= qe_nocarry_0368[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0368

		g.element = e_nocarry_0368{
		...
		if qe_nocarry_0368[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0368[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0368 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0368[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0368[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0368[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0368[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0368[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0368[5], carry)
...
func Benchmarke_nocarry_0368InverseNew(b *testing.B) {
	var x e_nocarry_0368
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0368
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0368
		var xInv e_nocarry_0368
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0368
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0368
...
func testLinearComb(t *testing.T, x *e_nocarry_0368, xC int64, y *e_nocarry_0368, yC int64) {
	...
	var z e_nocarry_0368
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0368, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0368
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0368, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0368
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0368, xHi uint64) {
	var res e_nocarry_0368
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0368) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0368) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0368, c int64, result *e_nocarry_0368, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0368) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0368) uint64 {
