...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0x8226ae59d182e1d7, R14
	ADDQ R14, AX
	MOVQ $0xd6dd09b28392c4ea, R14
	ADCQ R14, DX
	MOVQ $0x34f9a6f8252ecf75, R14
	ADCQ R14, CX
	MOVQ $0xa3e261d8f38625e1, R14
	ADCQ R14, BX
	MOVQ $0x3cb9f75a36799ac9, R14
	ADCQ R14, SI
	MOVQ $0xbe19307768711b33, R14
	ADCQ R14, DI
	MOVQ $0x7a0c53e0a38a5508, R14
	ADCQ R14, R8
	MOVQ $0x06ea2cab9f973086, R14
	ADCQ R14, R9
	MOVQ $0x1ded674c7b6ce0fd, R14
	ADCQ R14, R10
	MOVQ $0xaf7c164cff43e157, R14
	ADCQ R14, R11
	MOVQ $0x000000001f18b5f1, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x8226ae59d182e1d7, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xd6dd09b28392c4ea, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0x34f9a6f8252ecf75, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xa3e261d8f38625e1, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x3cb9f75a36799ac9, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xbe19307768711b33, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x7a0c53e0a38a5508, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x06ea2cab9f973086, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x1ded674c7b6ce0fd, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xaf7c164cff43e157, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000000001f18b5f1, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0x8226ae59d182e1d7, AX
	ADDQ AX, DX
	MOVQ $0xd6dd09b28392c4ea, AX
	ADCQ AX, CX
	MOVQ $0x34f9a6f8252ecf75, AX
	ADCQ AX, BX
	MOVQ $0xa3e261d8f38625e1, AX
	ADCQ AX, SI
	MOVQ $0x3cb9f75a36799ac9, AX
	ADCQ AX, DI
	MOVQ $0xbe19307768711b33, AX
	ADCQ AX, R8
	MOVQ $0x7a0c53e0a38a5508, AX
	ADCQ AX, R9
	MOVQ $0x06ea2cab9f973086, AX
	ADCQ AX, R10
	MOVQ $0x1ded674c7b6ce0fd, AX
	ADCQ AX, R11
	MOVQ $0xaf7c164cff43e157, AX
	ADCQ AX, R12
	MOVQ $0x000000001f18b5f1, AX
	ADCQ AX, R13
