...
var benchRese_nocarry_0669 e_nocarry_0669

func BenchmarkE_nocarry_0669SetBytes(b *testing.B) {
	var x e_nocarry_0669
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0669MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0669.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0669)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0669)
		}
	})
}

func BenchmarkE_nocarry_0669Inverse(b *testing.B) {
	var x e_nocarry_0669
	x.SetRandom()
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0669Butterfly(b *testing.B) {
	var x e_nocarry_0669
	x.SetRandom()
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0669)
	}
}

func BenchmarkE_nocarry_0669Exp(b *testing.B) {
	var x e_nocarry_0669
	x.SetRandom()
	benchRese_nocarry_0669.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0669Double(b *testing.B) {
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Double(&benchRese_nocarry_0669)
	}
}

func BenchmarkE_nocarry_0669Add(b *testing.B) {
	var x e_nocarry_0669
	x.SetRandom()
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Add(&x, &benchRese_nocarry_0669)
	}
}

func BenchmarkE_nocarry_0669Sub(b *testing.B) {
	var x e_nocarry_0669
	x.SetRandom()
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Sub(&x, &benchRese_nocarry_0669)
	}
}

func BenchmarkE_nocarry_0669Neg(b *testing.B) {
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Neg(&benchRese_nocarry_0669)
	}
}

func BenchmarkE_nocarry_0669Div(b *testing.B) {
	var x e_nocarry_0669
	x.SetRandom()
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Div(&x, &benchRese_nocarry_0669)
	}
}

func BenchmarkE_nocarry_0669FromMont(b *testing.B) {
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.FromMont()
	}
}

func BenchmarkE_nocarry_0669ToMont(b *testing.B) {
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.ToMont()
	}
}
func BenchmarkE_nocarry_0669Square(b *testing.B) {
	benchRese_nocarry_0669.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Square(&benchRese_nocarry_0669)
	}
}

func BenchmarkE_nocarry_0669Sqrt(b *testing.B) {
	var a e_nocarry_0669
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0669Mul(b *testing.B) {
	x := e_nocarry_0669{
	...
	benchRese_nocarry_0669.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Mul(&benchRese_nocarry_0669, &x)
	}
}

func BenchmarkE_nocarry_0669Cmp(b *testing.B) {
	x := e_nocarry_0669{
		13651618446240331118,
		14318977831971782744,
		16821053905992579583,
	...
	benchRese_nocarry_0669 = x
	benchRese_nocarry_0669[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0669.Cmp(&x)
	}
}

func TestE_nocarry_0669Cmp(t *testing.T) {
	var x, y e_nocarry_0669
...
func TestE_nocarry_0669IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0669
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0669

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0669{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0669
	one.SetOne()
	e.Sub(&qe_nocarry_0669, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0669{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0669{0, uint64(i)})
	}
...
func TestE_nocarry_0669NegZero(t *testing.T) {
	var a, b e_nocarry_0669
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0669Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0669, len(staticTestValues))
...
func TestE_nocarry_0669Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0669) bool {
			var b e_nocarry_0669
...
func TestE_nocarry_0669InverseExp(t *testing.T) {
...
func TestE_nocarry_0669MulByConstants(t *testing.T) {
...
func TestE_nocarry_0669Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0669) bool {
...
func TestE_nocarry_0669LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0669Halve(t *testing.T) {
...
func TestE_nocarry_0669FromMont(t *testing.T) {
...
type testPaire_nocarry_0669 struct {
	element e_nocarry_0669
	bigint  big.Int
}

func (z *e_nocarry_0669) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0669[10] {
		return true
	}
	if z[10] < qe_nocarry_0669[10] {
		return false
	...
	return z[0] >= qe_nocarry_0669[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0669

		g.element = e_nocarry_0669{
		...
		if qe_nocarry_0669[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0669[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0669 {
			var g e_nocarry_0669
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0669[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0669[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0669[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0669[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0669[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0669[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0669[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0669[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0669[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0669[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0669[10], carry)
...
func Benchmarke_nocarry_0669InverseNew(b *testing.B) {
	var x e_nocarry_0669
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0669
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0669
		var xInv e_nocarry_0669
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0669
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0669
...
func testLinearComb(t *testing.T, x *e_nocarry_0669, xC int64, y *e_nocarry_0669, yC int64) {
	...
	var z e_nocarry_0669
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0669, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0669
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0669, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0669
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0669, xHi uint64) {
	var res e_nocarry_0669
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0669) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0669) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0669, c int64, result *e_nocarry_0669, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0669) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0669) uint64 {
