...
var benchRese_nocarry_0412 e_nocarry_0412

func BenchmarkE_nocarry_0412SetBytes(b *testing.B) {
	var x e_nocarry_0412
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0412MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0412.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0412)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0412)
		}
	})
}

func BenchmarkE_nocarry_0412Inverse(b *testing.B) {
	var x e_nocarry_0412
	x.SetRandom()
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0412Butterfly(b *testing.B) {
	var x e_nocarry_0412
	x.SetRandom()
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0412)
	}
}

func BenchmarkE_nocarry_0412Exp(b *testing.B) {
	var x e_nocarry_0412
	x.SetRandom()
	benchRese_nocarry_0412.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0412Double(b *testing.B) {
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Double(&benchRese_nocarry_0412)
	}
}

func BenchmarkE_nocarry_0412Add(b *testing.B) {
	var x e_nocarry_0412
	x.SetRandom()
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Add(&x, &benchRese_nocarry_0412)
	}
}

func BenchmarkE_nocarry_0412Sub(b *testing.B) {
	var x e_nocarry_0412
	x.SetRandom()
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Sub(&x, &benchRese_nocarry_0412)
	}
}

func BenchmarkE_nocarry_0412Neg(b *testing.B) {
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Neg(&benchRese_nocarry_0412)
	}
}

func BenchmarkE_nocarry_0412Div(b *testing.B) {
	var x e_nocarry_0412
	x.SetRandom()
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Div(&x, &benchRese_nocarry_0412)
	}
}

func BenchmarkE_nocarry_0412FromMont(b *testing.B) {
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.FromMont()
	}
}

func BenchmarkE_nocarry_0412ToMont(b *testing.B) {
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.ToMont()
	}
}
func BenchmarkE_nocarry_0412Square(b *testing.B) {
	benchRese_nocarry_0412.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Square(&benchRese_nocarry_0412)
	}
}

func BenchmarkE_nocarry_0412Sqrt(b *testing.B) {
	var a e_nocarry_0412
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0412Mul(b *testing.B) {
	x := e_nocarry_0412{
		5958276452290368567,
		7333513431238327847,
	...
	benchRese_nocarry_0412.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Mul(&benchRese_nocarry_0412, &x)
	}
}

func BenchmarkE_nocarry_0412Cmp(b *testing.B) {
	x := e_nocarry_0412{
		5958276452290368567,
		7333513431238327847,
		11293302489709205566,
	...
	benchRese_nocarry_0412 = x
	benchRese_nocarry_0412[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0412.Cmp(&x)
	}
}

func TestE_nocarry_0412Cmp(t *testing.T) {
	var x, y e_nocarry_0412
...
func TestE_nocarry_0412IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0412
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0412

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0412{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0412
	one.SetOne()
	e.Sub(&qe_nocarry_0412, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0412{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0412{0, uint64(i)})
	}
...
func TestE_nocarry_0412NegZero(t *testing.T) {
	var a, b e_nocarry_0412
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0412Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0412, len(staticTestValues))
...
func TestE_nocarry_0412Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0412) bool {
			var b e_nocarry_0412
...
func TestE_nocarry_0412InverseExp(t *testing.T) {
...
func TestE_nocarry_0412MulByConstants(t *testing.T) {
...
func TestE_nocarry_0412Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0412) bool {
...
func TestE_nocarry_0412LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0412Halve(t *testing.T) {
...
func TestE_nocarry_0412FromMont(t *testing.T) {
...
type testPaire_nocarry_0412 struct {
	element e_nocarry_0412
	bigint  big.Int
}

func (z *e_nocarry_0412) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0412[6] {
		return true
	}
	if z[6] < qe_nocarry_0412[6] {
		return false
	...
	return z[0] >= qe_nocarry_0412[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0412

		g.element = e_nocarry_0412{
		...
		if qe_nocarry_0412[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0412[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0412 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0412[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0412[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0412[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0412[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0412[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0412[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0412[6], carry)
...
func Benchmarke_nocarry_0412InverseNew(b *testing.B) {
	var x e_nocarry_0412
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0412
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0412
		var xInv e_nocarry_0412
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0412
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0412
...
func testLinearComb(t *testing.T, x *e_nocarry_0412, xC int64, y *e_nocarry_0412, yC int64) {
	...
	var z e_nocarry_0412
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0412, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0412
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0412, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0412
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0412, xHi uint64) {
	var res e_nocarry_0412
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0412) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0412) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0412, c int64, result *e_nocarry_0412, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0412) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0412) uint64 {
