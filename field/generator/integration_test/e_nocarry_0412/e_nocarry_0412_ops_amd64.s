...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 48(R9), R8
	JCC  l1
	MOVQ $0x849656216c2cf681, R10
	ADDQ R10, AX
	MOVQ $0x691cc81cc5d9ebea, R10
	ADCQ R10, DX
	MOVQ $0x711b4b5e2ef3e0b9, R10
	ADCQ R10, CX
	MOVQ $0xacafe20d548589a1, R10
	ADCQ R10, BX
	MOVQ $0x293f455fd8a28991, R10
	ADCQ R10, SI
	MOVQ $0xef8c0d8cacbdb898, R10
	ADCQ R10, DI
	MOVQ $0x000000000e45ed61, R10
	ADCQ R10, R8
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x849656216c2cf681, R11
	SUBQ  DX, R11
	MOVQ  R11, 0(R10)
	MOVQ  $0x691cc81cc5d9ebea, R11
	SBBQ  CX, R11
	MOVQ  R11, 8(R10)
	MOVQ  $0x711b4b5e2ef3e0b9, R11
	SBBQ  BX, R11
	MOVQ  R11, 16(R10)
	MOVQ  $0xacafe20d548589a1, R11
	SBBQ  SI, R11
	MOVQ  R11, 24(R10)
	MOVQ  $0x293f455fd8a28991, R11
	SBBQ  DI, R11
	MOVQ  R11, 32(R10)
	MOVQ  $0xef8c0d8cacbdb898, R11
	SBBQ  R8, R11
	MOVQ  R11, 40(R10)
	MOVQ  $0x000000000e45ed61, R11
	SBBQ  R9, R11
	MOVQ  R11, 48(R10)
	RET
...
TEXT ·Butterfly(SB), $8-16
	...
	SBBQ 48(AX), R9
	JCC  l3
	MOVQ $0x849656216c2cf681, AX
	ADDQ AX, DX
	MOVQ $0x691cc81cc5d9ebea, AX
	ADCQ AX, CX
	MOVQ $0x711b4b5e2ef3e0b9, AX
	ADCQ AX, BX
	MOVQ $0xacafe20d548589a1, AX
	ADCQ AX, SI
	MOVQ $0x293f455fd8a28991, AX
	ADCQ AX, DI
	MOVQ $0xef8c0d8cacbdb898, AX
	ADCQ AX, R8
	MOVQ $0x000000000e45ed61, AX
	ADCQ AX, R9
