...
var benchRese_nocarry_0435 e_nocarry_0435

func BenchmarkE_nocarry_0435SetBytes(b *testing.B) {
	var x e_nocarry_0435
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0435MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0435.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0435)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0435)
		}
	})
}

func BenchmarkE_nocarry_0435Inverse(b *testing.B) {
	var x e_nocarry_0435
	x.SetRandom()
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0435Butterfly(b *testing.B) {
	var x e_nocarry_0435
	x.SetRandom()
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0435)
	}
}

func BenchmarkE_nocarry_0435Exp(b *testing.B) {
	var x e_nocarry_0435
	x.SetRandom()
	benchRese_nocarry_0435.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0435Double(b *testing.B) {
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Double(&benchRese_nocarry_0435)
	}
}

func BenchmarkE_nocarry_0435Add(b *testing.B) {
	var x e_nocarry_0435
	x.SetRandom()
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Add(&x, &benchRese_nocarry_0435)
	}
}

func BenchmarkE_nocarry_0435Sub(b *testing.B) {
	var x e_nocarry_0435
	x.SetRandom()
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Sub(&x, &benchRese_nocarry_0435)
	}
}

func BenchmarkE_nocarry_0435Neg(b *testing.B) {
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Neg(&benchRese_nocarry_0435)
	}
}

func BenchmarkE_nocarry_0435Div(b *testing.B) {
	var x e_nocarry_0435
	x.SetRandom()
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Div(&x, &benchRese_nocarry_0435)
	}
}

func BenchmarkE_nocarry_0435FromMont(b *testing.B) {
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.FromMont()
	}
}

func BenchmarkE_nocarry_0435ToMont(b *testing.B) {
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.ToMont()
	}
}
func BenchmarkE_nocarry_0435Square(b *testing.B) {
	benchRese_nocarry_0435.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Square(&benchRese_nocarry_0435)
	}
}

func BenchmarkE_nocarry_0435Sqrt(b *testing.B) {
	var a e_nocarry_0435
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0435Mul(b *testing.B) {
	x := e_nocarry_0435{
		4636608583147207707,
		3161962382242586979,
		277795967612686090,
	...
	benchRese_nocarry_0435.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Mul(&benchRese_nocarry_0435, &x)
	}
}

func BenchmarkE_nocarry_0435Cmp(b *testing.B) {
	x := e_nocarry_0435{
		4636608583147207707,
		3161962382242586979,
		277795967612686090,
	...
	benchRese_nocarry_0435 = x
	benchRese_nocarry_0435[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0435.Cmp(&x)
	}
}

func TestE_nocarry_0435Cmp(t *testing.T) {
	var x, y e_nocarry_0435
...
func TestE_nocarry_0435IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0435
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0435

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0435{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0435
	one.SetOne()
	e.Sub(&qe_nocarry_0435, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0435{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0435{0, uint64(i)})
	}
...
func TestE_nocarry_0435NegZero(t *testing.T) {
	var a, b e_nocarry_0435
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0435Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0435, len(staticTestValues))
...
func TestE_nocarry_0435Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0435) bool {
			var b e_nocarry_0435
...
func TestE_nocarry_0435InverseExp(t *testing.T) {
...
func TestE_nocarry_0435MulByConstants(t *testing.T) {
...
func TestE_nocarry_0435Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0435) bool {
...
func TestE_nocarry_0435LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0435Halve(t *testing.T) {
...
func TestE_nocarry_0435FromMont(t *testing.T) {
...
type testPaire_nocarry_0435 struct {
	element e_nocarry_0435
	bigint  big.Int
}

func (z *e_nocarry_0435) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0435[6] {
		return true
	}
	if z[6] < qe_nocarry_0435[6] {
		return false
	...
	return z[0] >= qe_nocarry_0435[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0435

		g.element = e_nocarry_0435{
		...
		if qe_nocarry_0435[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0435[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0435 {
			var g e_nocarry_0435
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0435[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0435[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0435[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0435[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0435[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0435[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0435[6], carry)
...
func Benchmarke_nocarry_0435InverseNew(b *testing.B) {
	var x e_nocarry_0435
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0435
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0435
		var xInv e_nocarry_0435
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0435
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0435
...
func testLinearComb(t *testing.T, x *e_nocarry_0435, xC int64, y *e_nocarry_0435, yC int64) {
	...
	var z e_nocarry_0435
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0435, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0435
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0435, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0435
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0435, xHi uint64) {
	var res e_nocarry_0435
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0435) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0435) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0435, c int64, result *e_nocarry_0435, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0435) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0435) uint64 {
