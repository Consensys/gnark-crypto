...
// modulus q
DATA q<>+0(SB)/8, $0x759f1883d0a91b45
DATA q<>+8(SB)/8, $0xb087fab7f7c09857
DATA q<>+16(SB)/8, $0x19f69447d5e4668f
DATA q<>+24(SB)/8, $0x00000000069a8826
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xf31fa1fb2011c073
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0x759f1883d0a91b45, R8
	MOVQ    $0xb087fab7f7c09857, R9
	MOVQ    $0x19f69447d5e4668f, R10
	MOVQ    $0x00000000069a8826, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0xb087fab7f7c09857, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x19f69447d5e4668f, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x00000000069a8826, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x759f1883d0a91b45, R12
	MOVQ    $0xb087fab7f7c09857, R13
	MOVQ    $0x19f69447d5e4668f, R14
	MOVQ    $0x00000000069a8826, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
