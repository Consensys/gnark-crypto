...
var benchRese_nocarry_0219 e_nocarry_0219

func BenchmarkE_nocarry_0219SetBytes(b *testing.B) {
	var x e_nocarry_0219
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0219MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0219.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0219)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0219)
		}
	})
}

func BenchmarkE_nocarry_0219Inverse(b *testing.B) {
	var x e_nocarry_0219
	x.SetRandom()
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0219Butterfly(b *testing.B) {
	var x e_nocarry_0219
	x.SetRandom()
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0219)
	}
}

func BenchmarkE_nocarry_0219Exp(b *testing.B) {
	var x e_nocarry_0219
	x.SetRandom()
	benchRese_nocarry_0219.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0219Double(b *testing.B) {
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Double(&benchRese_nocarry_0219)
	}
}

func BenchmarkE_nocarry_0219Add(b *testing.B) {
	var x e_nocarry_0219
	x.SetRandom()
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Add(&x, &benchRese_nocarry_0219)
	}
}

func BenchmarkE_nocarry_0219Sub(b *testing.B) {
	var x e_nocarry_0219
	x.SetRandom()
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Sub(&x, &benchRese_nocarry_0219)
	}
}

func BenchmarkE_nocarry_0219Neg(b *testing.B) {
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Neg(&benchRese_nocarry_0219)
	}
}

func BenchmarkE_nocarry_0219Div(b *testing.B) {
	var x e_nocarry_0219
	x.SetRandom()
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Div(&x, &benchRese_nocarry_0219)
	}
}

func BenchmarkE_nocarry_0219FromMont(b *testing.B) {
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.FromMont()
	}
}

func BenchmarkE_nocarry_0219ToMont(b *testing.B) {
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.ToMont()
	}
}
func BenchmarkE_nocarry_0219Square(b *testing.B) {
	benchRese_nocarry_0219.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Square(&benchRese_nocarry_0219)
	}
}

func BenchmarkE_nocarry_0219Sqrt(b *testing.B) {
	var a e_nocarry_0219
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0219Mul(b *testing.B) {
	x := e_nocarry_0219{
	...
	benchRese_nocarry_0219.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Mul(&benchRese_nocarry_0219, &x)
	}
}

func BenchmarkE_nocarry_0219Cmp(b *testing.B) {
	x := e_nocarry_0219{
		14298518127447677468,
		3274824372371979914,
		12923667028840866112,
	...
	benchRese_nocarry_0219 = x
	benchRese_nocarry_0219[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0219.Cmp(&x)
	}
}

func TestE_nocarry_0219Cmp(t *testing.T) {
	var x, y e_nocarry_0219
...
func TestE_nocarry_0219IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0219
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0219

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0219{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0219
	one.SetOne()
	e.Sub(&qe_nocarry_0219, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0219{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0219{0, uint64(i)})
	}
...
func TestE_nocarry_0219NegZero(t *testing.T) {
	var a, b e_nocarry_0219
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0219Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0219, len(staticTestValues))
...
func TestE_nocarry_0219Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0219) bool {
			var b e_nocarry_0219
...
func TestE_nocarry_0219InverseExp(t *testing.T) {
...
func TestE_nocarry_0219MulByConstants(t *testing.T) {
...
func TestE_nocarry_0219Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0219) bool {
...
func TestE_nocarry_0219LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0219Halve(t *testing.T) {
...
func TestE_nocarry_0219FromMont(t *testing.T) {
...
type testPaire_nocarry_0219 struct {
	element e_nocarry_0219
	bigint  big.Int
}

func (z *e_nocarry_0219) biggerOrEqualModulus() bool {
	if z[3] > qe_nocarry_0219[3] {
		return true
	}
	if z[3] < qe_nocarry_0219[3] {
		return false
	...
	return z[0] >= qe_nocarry_0219[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0219

		g.element = e_nocarry_0219{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0219[3] != ^uint64(0) {
			g.element[3] %= (qe_nocarry_0219[3] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0219 {
			var g e_nocarry_0219
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0219[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0219[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0219[2], carry)
		a[3], _ = bits.Add64(a[3], qe_nocarry_0219[3], carry)
...
func Benchmarke_nocarry_0219InverseNew(b *testing.B) {
	var x e_nocarry_0219
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0219
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0219
		var xInv e_nocarry_0219
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0219
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0219
...
func testLinearComb(t *testing.T, x *e_nocarry_0219, xC int64, y *e_nocarry_0219, yC int64) {
	...
	var z e_nocarry_0219
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0219, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0219
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0219, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0219
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0219, xHi uint64) {
	var res e_nocarry_0219
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0219) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0219) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0219, c int64, result *e_nocarry_0219, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0219) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0219) uint64 {
