...
var benchRese_nocarry_0170 e_nocarry_0170

func BenchmarkE_nocarry_0170SetBytes(b *testing.B) {
	var x e_nocarry_0170
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0170MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0170.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0170)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0170)
		}
	})
}

func BenchmarkE_nocarry_0170Inverse(b *testing.B) {
	var x e_nocarry_0170
	x.SetRandom()
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0170Butterfly(b *testing.B) {
	var x e_nocarry_0170
	x.SetRandom()
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0170)
	}
}

func BenchmarkE_nocarry_0170Exp(b *testing.B) {
	var x e_nocarry_0170
	x.SetRandom()
	benchRese_nocarry_0170.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0170Double(b *testing.B) {
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Double(&benchRese_nocarry_0170)
	}
}

func BenchmarkE_nocarry_0170Add(b *testing.B) {
	var x e_nocarry_0170
	x.SetRandom()
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Add(&x, &benchRese_nocarry_0170)
	}
}

func BenchmarkE_nocarry_0170Sub(b *testing.B) {
	var x e_nocarry_0170
	x.SetRandom()
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Sub(&x, &benchRese_nocarry_0170)
	}
}

func BenchmarkE_nocarry_0170Neg(b *testing.B) {
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Neg(&benchRese_nocarry_0170)
	}
}

func BenchmarkE_nocarry_0170Div(b *testing.B) {
	var x e_nocarry_0170
	x.SetRandom()
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Div(&x, &benchRese_nocarry_0170)
	}
}

func BenchmarkE_nocarry_0170FromMont(b *testing.B) {
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.FromMont()
	}
}

func BenchmarkE_nocarry_0170ToMont(b *testing.B) {
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.ToMont()
	}
}
func BenchmarkE_nocarry_0170Square(b *testing.B) {
	benchRese_nocarry_0170.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Square(&benchRese_nocarry_0170)
	}
}

func BenchmarkE_nocarry_0170Sqrt(b *testing.B) {
	var a e_nocarry_0170
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0170Mul(b *testing.B) {
	x := e_nocarry_0170{
		4083327714585547266,
		13980445644635413012,
		851078944837,
	}
	benchRese_nocarry_0170.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Mul(&benchRese_nocarry_0170, &x)
	}
}

func BenchmarkE_nocarry_0170Cmp(b *testing.B) {
	x := e_nocarry_0170{
		4083327714585547266,
		13980445644635413012,
		851078944837,
	}
	benchRese_nocarry_0170 = x
	benchRese_nocarry_0170[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0170.Cmp(&x)
	}
}

func TestE_nocarry_0170Cmp(t *testing.T) {
	var x, y e_nocarry_0170
...
func TestE_nocarry_0170IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0170
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0170

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0170{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0170
	one.SetOne()
	e.Sub(&qe_nocarry_0170, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0170{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0170{0, uint64(i)})
	}
...
func TestE_nocarry_0170NegZero(t *testing.T) {
	var a, b e_nocarry_0170
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0170Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0170, len(staticTestValues))
...
func TestE_nocarry_0170Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0170) bool {
			var b e_nocarry_0170
...
func TestE_nocarry_0170InverseExp(t *testing.T) {
...
func TestE_nocarry_0170MulByConstants(t *testing.T) {
...
func TestE_nocarry_0170Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0170) bool {
...
func TestE_nocarry_0170LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0170Halve(t *testing.T) {
...
func TestE_nocarry_0170FromMont(t *testing.T) {
...
type testPaire_nocarry_0170 struct {
	element e_nocarry_0170
	bigint  big.Int
}

func (z *e_nocarry_0170) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0170[2] {
		return true
	}
	if z[2] < qe_nocarry_0170[2] {
		return false
	...
	return z[0] >= qe_nocarry_0170[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0170

		g.element = e_nocarry_0170{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0170[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0170[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0170 {
			var g e_nocarry_0170
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0170[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0170[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0170[2], carry)
...
func Benchmarke_nocarry_0170InverseNew(b *testing.B) {
	var x e_nocarry_0170
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0170
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0170
		var xInv e_nocarry_0170
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0170
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0170
...
func testLinearComb(t *testing.T, x *e_nocarry_0170, xC int64, y *e_nocarry_0170, yC int64) {
	...
	var z e_nocarry_0170
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0170, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0170
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0170, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0170
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0170, xHi uint64) {
	var res e_nocarry_0170
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0170) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0170) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0170, c int64, result *e_nocarry_0170, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0170) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0170) uint64 {
