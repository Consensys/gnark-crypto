...
var benchRese_nocarry_0151 e_nocarry_0151

func BenchmarkE_nocarry_0151SetBytes(b *testing.B) {
	var x e_nocarry_0151
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0151MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0151.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0151)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0151)
		}
	})
}

func BenchmarkE_nocarry_0151Inverse(b *testing.B) {
	var x e_nocarry_0151
	x.SetRandom()
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0151Butterfly(b *testing.B) {
	var x e_nocarry_0151
	x.SetRandom()
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0151)
	}
}

func BenchmarkE_nocarry_0151Exp(b *testing.B) {
	var x e_nocarry_0151
	x.SetRandom()
	benchRese_nocarry_0151.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0151Double(b *testing.B) {
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Double(&benchRese_nocarry_0151)
	}
}

func BenchmarkE_nocarry_0151Add(b *testing.B) {
	var x e_nocarry_0151
	x.SetRandom()
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Add(&x, &benchRese_nocarry_0151)
	}
}

func BenchmarkE_nocarry_0151Sub(b *testing.B) {
	var x e_nocarry_0151
	x.SetRandom()
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Sub(&x, &benchRese_nocarry_0151)
	}
}

func BenchmarkE_nocarry_0151Neg(b *testing.B) {
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Neg(&benchRese_nocarry_0151)
	}
}

func BenchmarkE_nocarry_0151Div(b *testing.B) {
	var x e_nocarry_0151
	x.SetRandom()
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Div(&x, &benchRese_nocarry_0151)
	}
}

func BenchmarkE_nocarry_0151FromMont(b *testing.B) {
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.FromMont()
	}
}

func BenchmarkE_nocarry_0151ToMont(b *testing.B) {
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.ToMont()
	}
}
func BenchmarkE_nocarry_0151Square(b *testing.B) {
	benchRese_nocarry_0151.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Square(&benchRese_nocarry_0151)
	}
}

func BenchmarkE_nocarry_0151Sqrt(b *testing.B) {
	var a e_nocarry_0151
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0151Mul(b *testing.B) {
	x := e_nocarry_0151{
		10791919526786867948,
		6933835125347039680,
		522239,
	}
	benchRese_nocarry_0151.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Mul(&benchRese_nocarry_0151, &x)
	}
}

func BenchmarkE_nocarry_0151Cmp(b *testing.B) {
	x := e_nocarry_0151{
		10791919526786867948,
		6933835125347039680,
		522239,
	}
	benchRese_nocarry_0151 = x
	benchRese_nocarry_0151[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0151.Cmp(&x)
	}
}

func TestE_nocarry_0151Cmp(t *testing.T) {
	var x, y e_nocarry_0151
...
func TestE_nocarry_0151IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0151
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0151

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0151{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0151
	one.SetOne()
	e.Sub(&qe_nocarry_0151, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0151{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0151{0, uint64(i)})
	}
...
func TestE_nocarry_0151NegZero(t *testing.T) {
	var a, b e_nocarry_0151
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0151Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0151, len(staticTestValues))
...
func TestE_nocarry_0151Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0151) bool {
			var b e_nocarry_0151
...
func TestE_nocarry_0151InverseExp(t *testing.T) {
...
func TestE_nocarry_0151MulByConstants(t *testing.T) {
...
func TestE_nocarry_0151Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0151) bool {
...
func TestE_nocarry_0151LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0151Halve(t *testing.T) {
...
func TestE_nocarry_0151FromMont(t *testing.T) {
...
type testPaire_nocarry_0151 struct {
	element e_nocarry_0151
	bigint  big.Int
}

func (z *e_nocarry_0151) biggerOrEqualModulus() bool {
	if z[2] > qe_nocarry_0151[2] {
		return true
	}
	if z[2] < qe_nocarry_0151[2] {
		return false
	...
	return z[0] >= qe_nocarry_0151[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0151

		g.element = e_nocarry_0151{
			genParams.NextUint64(),
			genParams.NextUint64(),
			genParams.NextUint64(),
		}
		if qe_nocarry_0151[2] != ^uint64(0) {
			g.element[2] %= (qe_nocarry_0151[2] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0151 {
			var g e_nocarry_0151
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0151[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0151[1], carry)
		a[2], _ = bits.Add64(a[2], qe_nocarry_0151[2], carry)
...
func Benchmarke_nocarry_0151InverseNew(b *testing.B) {
	var x e_nocarry_0151
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0151
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0151
		var xInv e_nocarry_0151
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0151
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0151
...
func testLinearComb(t *testing.T, x *e_nocarry_0151, xC int64, y *e_nocarry_0151, yC int64) {
	...
	var z e_nocarry_0151
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0151, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0151
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0151, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0151
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0151, xHi uint64) {
	var res e_nocarry_0151
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0151) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0151) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0151, c int64, result *e_nocarry_0151, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0151) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0151) uint64 {
