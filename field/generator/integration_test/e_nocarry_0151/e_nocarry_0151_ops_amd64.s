...
// modulus q
DATA q<>+0(SB)/8, $0xae3f7e4a2c105d4b
DATA q<>+8(SB)/8, $0x8b21a5d1df9c1a2e
DATA q<>+16(SB)/8, $0x000000000066fe72
GLOBL q<>(SB), (RODATA+NOPTR), $24

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x69de8392c3d3bb9d
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    8(BX), DX
	SBBQ    16(BX), CX
	MOVQ    $0xae3f7e4a2c105d4b, DI
	MOVQ    $0x8b21a5d1df9c1a2e, R8
	MOVQ    $0x000000000066fe72, R9
	CMOVQCC SI, DI
	CMOVQCC SI, R8
	CMOVQCC SI, R9
	ADDQ    DI, AX
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, DI
	MOVQ  DI, 0(SI)
	MOVQ  $0x8b21a5d1df9c1a2e, DI
	SBBQ  CX, DI
	MOVQ  DI, 8(SI)
	MOVQ  $0x000000000066fe72, DI
	SBBQ  BX, DI
	MOVQ  DI, 16(SI)
	RET
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    8(DX), R8
	SBBQ    16(DX), R9
	MOVQ    $0xae3f7e4a2c105d4b, R10
	MOVQ    $0x8b21a5d1df9c1a2e, R11
	MOVQ    $0x000000000066fe72, R12
	CMOVQCC AX, R10
	CMOVQCC AX, R11
	CMOVQCC AX, R12
	ADDQ    R10, DI
