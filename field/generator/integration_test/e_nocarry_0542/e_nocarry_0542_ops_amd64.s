...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0xdb5804477f082795, R12
	ADDQ R12, AX
	MOVQ $0xb72d6aa522333adf, R12
	ADCQ R12, DX
	MOVQ $0x083e2f2c89cdcd57, R12
	ADCQ R12, CX
	MOVQ $0x7f413c7b1a84768a, R12
	ADCQ R12, BX
	MOVQ $0xfe4a7efbe1bcf778, R12
	ADCQ R12, SI
	MOVQ $0xd26132c67fe4031f, R12
	ADCQ R12, DI
	MOVQ $0x4a609d6cb706d8d9, R12
	ADCQ R12, R8
	MOVQ $0x853f15fce79a88ca, R12
	ADCQ R12, R9
	MOVQ $0x000000003a74c812, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xdb5804477f082795, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0xb72d6aa522333adf, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x083e2f2c89cdcd57, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0x7f413c7b1a84768a, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xfe4a7efbe1bcf778, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xd26132c67fe4031f, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x4a609d6cb706d8d9, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x853f15fce79a88ca, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x000000003a74c812, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0xdb5804477f082795, AX
	ADDQ AX, DX
	MOVQ $0xb72d6aa522333adf, AX
	ADCQ AX, CX
	MOVQ $0x083e2f2c89cdcd57, AX
	ADCQ AX, BX
	MOVQ $0x7f413c7b1a84768a, AX
	ADCQ AX, SI
	MOVQ $0xfe4a7efbe1bcf778, AX
	ADCQ AX, DI
	MOVQ $0xd26132c67fe4031f, AX
	ADCQ AX, R8
	MOVQ $0x4a609d6cb706d8d9, AX
	ADCQ AX, R9
	MOVQ $0x853f15fce79a88ca, AX
	ADCQ AX, R10
	MOVQ $0x000000003a74c812, AX
	ADCQ AX, R11
