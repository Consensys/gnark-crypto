...
var benchRese_nocarry_0542 e_nocarry_0542

func BenchmarkE_nocarry_0542SetBytes(b *testing.B) {
	var x e_nocarry_0542
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0542MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0542.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0542)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0542)
		}
	})
}

func BenchmarkE_nocarry_0542Inverse(b *testing.B) {
	var x e_nocarry_0542
	x.SetRandom()
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0542Butterfly(b *testing.B) {
	var x e_nocarry_0542
	x.SetRandom()
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0542)
	}
}

func BenchmarkE_nocarry_0542Exp(b *testing.B) {
	var x e_nocarry_0542
	x.SetRandom()
	benchRese_nocarry_0542.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0542Double(b *testing.B) {
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Double(&benchRese_nocarry_0542)
	}
}

func BenchmarkE_nocarry_0542Add(b *testing.B) {
	var x e_nocarry_0542
	x.SetRandom()
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Add(&x, &benchRese_nocarry_0542)
	}
}

func BenchmarkE_nocarry_0542Sub(b *testing.B) {
	var x e_nocarry_0542
	x.SetRandom()
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Sub(&x, &benchRese_nocarry_0542)
	}
}

func BenchmarkE_nocarry_0542Neg(b *testing.B) {
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Neg(&benchRese_nocarry_0542)
	}
}

func BenchmarkE_nocarry_0542Div(b *testing.B) {
	var x e_nocarry_0542
	x.SetRandom()
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Div(&x, &benchRese_nocarry_0542)
	}
}

func BenchmarkE_nocarry_0542FromMont(b *testing.B) {
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.FromMont()
	}
}

func BenchmarkE_nocarry_0542ToMont(b *testing.B) {
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.ToMont()
	}
}
func BenchmarkE_nocarry_0542Square(b *testing.B) {
	benchRese_nocarry_0542.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Square(&benchRese_nocarry_0542)
	}
}

func BenchmarkE_nocarry_0542Sqrt(b *testing.B) {
	var a e_nocarry_0542
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0542Mul(b *testing.B) {
	x := e_nocarry_0542{
		7069279698306752355,
	...
	benchRese_nocarry_0542.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Mul(&benchRese_nocarry_0542, &x)
	}
}

func BenchmarkE_nocarry_0542Cmp(b *testing.B) {
	x := e_nocarry_0542{
		7069279698306752355,
		10127974852359036554,
		4645509004792454450,
	...
	benchRese_nocarry_0542 = x
	benchRese_nocarry_0542[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0542.Cmp(&x)
	}
}

func TestE_nocarry_0542Cmp(t *testing.T) {
	var x, y e_nocarry_0542
...
func TestE_nocarry_0542IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0542
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0542

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0542{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0542
	one.SetOne()
	e.Sub(&qe_nocarry_0542, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0542{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0542{0, uint64(i)})
	}
...
func TestE_nocarry_0542NegZero(t *testing.T) {
	var a, b e_nocarry_0542
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0542Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0542, len(staticTestValues))
...
func TestE_nocarry_0542Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0542) bool {
			var b e_nocarry_0542
...
func TestE_nocarry_0542InverseExp(t *testing.T) {
...
func TestE_nocarry_0542MulByConstants(t *testing.T) {
...
func TestE_nocarry_0542Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0542) bool {
...
func TestE_nocarry_0542LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0542Halve(t *testing.T) {
...
func TestE_nocarry_0542FromMont(t *testing.T) {
...
type testPaire_nocarry_0542 struct {
	element e_nocarry_0542
	bigint  big.Int
}

func (z *e_nocarry_0542) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0542[8] {
		return true
	}
	if z[8] < qe_nocarry_0542[8] {
		return false
	...
	return z[0] >= qe_nocarry_0542[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0542

		g.element = e_nocarry_0542{
		...
		if qe_nocarry_0542[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0542[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0542 {
			var g e_nocarry_0542
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0542[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0542[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0542[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0542[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0542[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0542[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0542[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0542[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0542[8], carry)
...
func Benchmarke_nocarry_0542InverseNew(b *testing.B) {
	var x e_nocarry_0542
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0542
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0542
		var xInv e_nocarry_0542
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0542
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0542
...
func testLinearComb(t *testing.T, x *e_nocarry_0542, xC int64, y *e_nocarry_0542, yC int64) {
	...
	var z e_nocarry_0542
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0542, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0542
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0542, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0542
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0542, xHi uint64) {
	var res e_nocarry_0542
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0542) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0542) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0542, c int64, result *e_nocarry_0542, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0542) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0542) uint64 {
