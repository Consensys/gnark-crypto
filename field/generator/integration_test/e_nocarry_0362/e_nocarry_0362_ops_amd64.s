...
// modulus q
DATA q<>+0(SB)/8, $0xe177a492b4bc5775
DATA q<>+8(SB)/8, $0x634b2c730686d196
DATA q<>+16(SB)/8, $0xf4adf4fb1defca4e
DATA q<>+24(SB)/8, $0xbaae60d0926cd138
DATA q<>+32(SB)/8, $0xac77227b7f254ef5
DATA q<>+40(SB)/8, $0x00000340e73dd62c
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x372ea11470c97f23
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xe177a492b4bc5775, R10
	MOVQ    $0x634b2c730686d196, R11
	MOVQ    $0xf4adf4fb1defca4e, R12
	MOVQ    $0xbaae60d0926cd138, R13
	MOVQ    $0xac77227b7f254ef5, R14
	MOVQ    $0x00000340e73dd62c, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x634b2c730686d196, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0xf4adf4fb1defca4e, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xbaae60d0926cd138, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xac77227b7f254ef5, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000340e73dd62c, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xe177a492b4bc5775, CX
	MOVQ    $0x634b2c730686d196, BX
	MOVQ    $0xf4adf4fb1defca4e, SI
	MOVQ    $0xbaae60d0926cd138, DI
	MOVQ    $0xac77227b7f254ef5, R8
	MOVQ    $0x00000340e73dd62c, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
