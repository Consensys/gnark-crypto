...
var benchRese_nocarry_0362 e_nocarry_0362

func BenchmarkE_nocarry_0362SetBytes(b *testing.B) {
	var x e_nocarry_0362
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0362MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0362.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0362)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0362)
		}
	})
}

func BenchmarkE_nocarry_0362Inverse(b *testing.B) {
	var x e_nocarry_0362
	x.SetRandom()
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0362Butterfly(b *testing.B) {
	var x e_nocarry_0362
	x.SetRandom()
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0362)
	}
}

func BenchmarkE_nocarry_0362Exp(b *testing.B) {
	var x e_nocarry_0362
	x.SetRandom()
	benchRese_nocarry_0362.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0362Double(b *testing.B) {
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Double(&benchRese_nocarry_0362)
	}
}

func BenchmarkE_nocarry_0362Add(b *testing.B) {
	var x e_nocarry_0362
	x.SetRandom()
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Add(&x, &benchRese_nocarry_0362)
	}
}

func BenchmarkE_nocarry_0362Sub(b *testing.B) {
	var x e_nocarry_0362
	x.SetRandom()
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Sub(&x, &benchRese_nocarry_0362)
	}
}

func BenchmarkE_nocarry_0362Neg(b *testing.B) {
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Neg(&benchRese_nocarry_0362)
	}
}

func BenchmarkE_nocarry_0362Div(b *testing.B) {
	var x e_nocarry_0362
	x.SetRandom()
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Div(&x, &benchRese_nocarry_0362)
	}
}

func BenchmarkE_nocarry_0362FromMont(b *testing.B) {
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.FromMont()
	}
}

func BenchmarkE_nocarry_0362ToMont(b *testing.B) {
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.ToMont()
	}
}
func BenchmarkE_nocarry_0362Square(b *testing.B) {
	benchRese_nocarry_0362.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Square(&benchRese_nocarry_0362)
	}
}

func BenchmarkE_nocarry_0362Sqrt(b *testing.B) {
	var a e_nocarry_0362
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0362Mul(b *testing.B) {
	x := e_nocarry_0362{
		796087963952922254,
		5571568137245557351,
		777493091276435628,
	...
	benchRese_nocarry_0362.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Mul(&benchRese_nocarry_0362, &x)
	}
}

func BenchmarkE_nocarry_0362Cmp(b *testing.B) {
	x := e_nocarry_0362{
		796087963952922254,
		5571568137245557351,
		777493091276435628,
	...
	benchRese_nocarry_0362 = x
	benchRese_nocarry_0362[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0362.Cmp(&x)
	}
}

func TestE_nocarry_0362Cmp(t *testing.T) {
	var x, y e_nocarry_0362
...
func TestE_nocarry_0362IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0362
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0362

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0362{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0362
	one.SetOne()
	e.Sub(&qe_nocarry_0362, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0362{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0362{0, uint64(i)})
	}
...
func TestE_nocarry_0362NegZero(t *testing.T) {
	var a, b e_nocarry_0362
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0362Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0362, len(staticTestValues))
...
func TestE_nocarry_0362Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0362) bool {
			var b e_nocarry_0362
...
func TestE_nocarry_0362InverseExp(t *testing.T) {
...
func TestE_nocarry_0362MulByConstants(t *testing.T) {
...
func TestE_nocarry_0362Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0362) bool {
...
func TestE_nocarry_0362LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0362Halve(t *testing.T) {
...
func TestE_nocarry_0362FromMont(t *testing.T) {
...
type testPaire_nocarry_0362 struct {
	element e_nocarry_0362
	bigint  big.Int
}

func (z *e_nocarry_0362) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0362[5] {
		return true
	}
	if z[5] < qe_nocarry_0362[5] {
		return false
	...
	return z[0] >= qe_nocarry_0362[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0362

		g.element = e_nocarry_0362{
		...
		if qe_nocarry_0362[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0362[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0362 {
			var g e_nocarry_0362
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0362[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0362[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0362[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0362[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0362[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0362[5], carry)
...
func Benchmarke_nocarry_0362InverseNew(b *testing.B) {
	var x e_nocarry_0362
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0362
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0362
		var xInv e_nocarry_0362
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0362
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0362
...
func testLinearComb(t *testing.T, x *e_nocarry_0362, xC int64, y *e_nocarry_0362, yC int64) {
	...
	var z e_nocarry_0362
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0362, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0362
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0362, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0362
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0362, xHi uint64) {
	var res e_nocarry_0362
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0362) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0362) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0362, c int64, result *e_nocarry_0362, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0362) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0362) uint64 {
