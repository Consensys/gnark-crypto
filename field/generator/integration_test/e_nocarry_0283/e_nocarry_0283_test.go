...
var benchRese_nocarry_0283 e_nocarry_0283

func BenchmarkE_nocarry_0283SetBytes(b *testing.B) {
	var x e_nocarry_0283
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0283MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0283.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0283)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0283)
		}
	})
}

func BenchmarkE_nocarry_0283Inverse(b *testing.B) {
	var x e_nocarry_0283
	x.SetRandom()
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0283Butterfly(b *testing.B) {
	var x e_nocarry_0283
	x.SetRandom()
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0283)
	}
}

func BenchmarkE_nocarry_0283Exp(b *testing.B) {
	var x e_nocarry_0283
	x.SetRandom()
	benchRese_nocarry_0283.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0283Double(b *testing.B) {
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Double(&benchRese_nocarry_0283)
	}
}

func BenchmarkE_nocarry_0283Add(b *testing.B) {
	var x e_nocarry_0283
	x.SetRandom()
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Add(&x, &benchRese_nocarry_0283)
	}
}

func BenchmarkE_nocarry_0283Sub(b *testing.B) {
	var x e_nocarry_0283
	x.SetRandom()
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Sub(&x, &benchRese_nocarry_0283)
	}
}

func BenchmarkE_nocarry_0283Neg(b *testing.B) {
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Neg(&benchRese_nocarry_0283)
	}
}

func BenchmarkE_nocarry_0283Div(b *testing.B) {
	var x e_nocarry_0283
	x.SetRandom()
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Div(&x, &benchRese_nocarry_0283)
	}
}

func BenchmarkE_nocarry_0283FromMont(b *testing.B) {
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.FromMont()
	}
}

func BenchmarkE_nocarry_0283ToMont(b *testing.B) {
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.ToMont()
	}
}
func BenchmarkE_nocarry_0283Square(b *testing.B) {
	benchRese_nocarry_0283.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Square(&benchRese_nocarry_0283)
	}
}

func BenchmarkE_nocarry_0283Sqrt(b *testing.B) {
	var a e_nocarry_0283
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0283Mul(b *testing.B) {
	x := e_nocarry_0283{
	...
	benchRese_nocarry_0283.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Mul(&benchRese_nocarry_0283, &x)
	}
}

func BenchmarkE_nocarry_0283Cmp(b *testing.B) {
	x := e_nocarry_0283{
		16355001442302365723,
		414732777866321647,
		8675783855667034968,
	...
	benchRese_nocarry_0283 = x
	benchRese_nocarry_0283[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0283.Cmp(&x)
	}
}

func TestE_nocarry_0283Cmp(t *testing.T) {
	var x, y e_nocarry_0283
...
func TestE_nocarry_0283IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0283
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0283

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0283{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0283
	one.SetOne()
	e.Sub(&qe_nocarry_0283, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0283{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0283{0, uint64(i)})
	}
...
func TestE_nocarry_0283NegZero(t *testing.T) {
	var a, b e_nocarry_0283
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0283Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0283, len(staticTestValues))
...
func TestE_nocarry_0283Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0283) bool {
			var b e_nocarry_0283
...
func TestE_nocarry_0283InverseExp(t *testing.T) {
...
func TestE_nocarry_0283MulByConstants(t *testing.T) {
...
func TestE_nocarry_0283Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0283) bool {
...
func TestE_nocarry_0283LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0283Halve(t *testing.T) {
...
func TestE_nocarry_0283FromMont(t *testing.T) {
...
type testPaire_nocarry_0283 struct {
	element e_nocarry_0283
	bigint  big.Int
}

func (z *e_nocarry_0283) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0283[4] {
		return true
	}
	if z[4] < qe_nocarry_0283[4] {
		return false
	...
	return z[0] >= qe_nocarry_0283[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0283

		g.element = e_nocarry_0283{
		...
		if qe_nocarry_0283[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0283[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0283 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0283[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0283[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0283[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0283[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0283[4], carry)
...
func Benchmarke_nocarry_0283InverseNew(b *testing.B) {
	var x e_nocarry_0283
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0283
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0283
		var xInv e_nocarry_0283
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0283
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0283
...
func testLinearComb(t *testing.T, x *e_nocarry_0283, xC int64, y *e_nocarry_0283, yC int64) {
	...
	var z e_nocarry_0283
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0283, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0283
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0283, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0283
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0283, xHi uint64) {
	var res e_nocarry_0283
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0283) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0283) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0283, c int64, result *e_nocarry_0283, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0283) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0283) uint64 {
