...
// modulus q
DATA q<>+0(SB)/8, $0x5ec3392e35f23e39
DATA q<>+8(SB)/8, $0x5a5aad5952dba466
DATA q<>+16(SB)/8, $0x98ac9ac874d8d5d5
DATA q<>+24(SB)/8, $0xb4147c5a77cd13cb
DATA q<>+32(SB)/8, $0x00000000070f3346
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x9b94ffa140a5aff7
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x5ec3392e35f23e39, R9
	MOVQ    $0x5a5aad5952dba466, R10
	MOVQ    $0x98ac9ac874d8d5d5, R11
	MOVQ    $0xb4147c5a77cd13cb, R12
	MOVQ    $0x00000000070f3346, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x5a5aad5952dba466, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x98ac9ac874d8d5d5, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xb4147c5a77cd13cb, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00000000070f3346, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x5ec3392e35f23e39, CX
	MOVQ    $0x5a5aad5952dba466, BX
	MOVQ    $0x98ac9ac874d8d5d5, SI
	MOVQ    $0xb4147c5a77cd13cb, DI
	MOVQ    $0x00000000070f3346, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
