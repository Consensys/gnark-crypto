...
var benchRese_nocarry_0500 e_nocarry_0500

func BenchmarkE_nocarry_0500SetBytes(b *testing.B) {
	var x e_nocarry_0500
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0500MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0500.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0500)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0500)
		}
	})
}

func BenchmarkE_nocarry_0500Inverse(b *testing.B) {
	var x e_nocarry_0500
	x.SetRandom()
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0500Butterfly(b *testing.B) {
	var x e_nocarry_0500
	x.SetRandom()
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0500)
	}
}

func BenchmarkE_nocarry_0500Exp(b *testing.B) {
	var x e_nocarry_0500
	x.SetRandom()
	benchRese_nocarry_0500.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0500Double(b *testing.B) {
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Double(&benchRese_nocarry_0500)
	}
}

func BenchmarkE_nocarry_0500Add(b *testing.B) {
	var x e_nocarry_0500
	x.SetRandom()
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Add(&x, &benchRese_nocarry_0500)
	}
}

func BenchmarkE_nocarry_0500Sub(b *testing.B) {
	var x e_nocarry_0500
	x.SetRandom()
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Sub(&x, &benchRese_nocarry_0500)
	}
}

func BenchmarkE_nocarry_0500Neg(b *testing.B) {
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Neg(&benchRese_nocarry_0500)
	}
}

func BenchmarkE_nocarry_0500Div(b *testing.B) {
	var x e_nocarry_0500
	x.SetRandom()
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Div(&x, &benchRese_nocarry_0500)
	}
}

func BenchmarkE_nocarry_0500FromMont(b *testing.B) {
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.FromMont()
	}
}

func BenchmarkE_nocarry_0500ToMont(b *testing.B) {
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.ToMont()
	}
}
func BenchmarkE_nocarry_0500Square(b *testing.B) {
	benchRese_nocarry_0500.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Square(&benchRese_nocarry_0500)
	}
}

func BenchmarkE_nocarry_0500Sqrt(b *testing.B) {
	var a e_nocarry_0500
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0500Mul(b *testing.B) {
	x := e_nocarry_0500{
		9606590211272221974,
		5161719264971786956,
		9678030029239669922,
	...
	benchRese_nocarry_0500.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Mul(&benchRese_nocarry_0500, &x)
	}
}

func BenchmarkE_nocarry_0500Cmp(b *testing.B) {
	x := e_nocarry_0500{
		9606590211272221974,
		5161719264971786956,
		9678030029239669922,
	...
	benchRese_nocarry_0500 = x
	benchRese_nocarry_0500[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0500.Cmp(&x)
	}
}

func TestE_nocarry_0500Cmp(t *testing.T) {
	var x, y e_nocarry_0500
...
func TestE_nocarry_0500IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0500
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0500

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0500{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0500
	one.SetOne()
	e.Sub(&qe_nocarry_0500, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0500{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0500{0, uint64(i)})
	}
...
func TestE_nocarry_0500NegZero(t *testing.T) {
	var a, b e_nocarry_0500
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0500Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0500, len(staticTestValues))
...
func TestE_nocarry_0500Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0500) bool {
			var b e_nocarry_0500
...
func TestE_nocarry_0500InverseExp(t *testing.T) {
...
func TestE_nocarry_0500MulByConstants(t *testing.T) {
...
func TestE_nocarry_0500Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0500) bool {
...
func TestE_nocarry_0500LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0500Halve(t *testing.T) {
...
func TestE_nocarry_0500FromMont(t *testing.T) {
...
type testPaire_nocarry_0500 struct {
	element e_nocarry_0500
	bigint  big.Int
}

func (z *e_nocarry_0500) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0500[7] {
		return true
	}
	if z[7] < qe_nocarry_0500[7] {
		return false
	...
	return z[0] >= qe_nocarry_0500[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0500

		g.element = e_nocarry_0500{
		...
		if qe_nocarry_0500[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0500[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0500 {
			var g e_nocarry_0500
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0500[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0500[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0500[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0500[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0500[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0500[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0500[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0500[7], carry)
...
func Benchmarke_nocarry_0500InverseNew(b *testing.B) {
	var x e_nocarry_0500
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0500
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0500
		var xInv e_nocarry_0500
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0500
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0500
...
func testLinearComb(t *testing.T, x *e_nocarry_0500, xC int64, y *e_nocarry_0500, yC int64) {
	...
	var z e_nocarry_0500
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0500, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0500
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0500, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0500
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0500, xHi uint64) {
	var res e_nocarry_0500
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0500) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0500) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0500, c int64, result *e_nocarry_0500, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0500) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0500) uint64 {
