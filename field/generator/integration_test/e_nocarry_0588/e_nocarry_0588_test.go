...
var benchRese_nocarry_0588 e_nocarry_0588

func BenchmarkE_nocarry_0588SetBytes(b *testing.B) {
	var x e_nocarry_0588
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0588MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0588.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0588)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0588)
		}
	})
}

func BenchmarkE_nocarry_0588Inverse(b *testing.B) {
	var x e_nocarry_0588
	x.SetRandom()
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0588Butterfly(b *testing.B) {
	var x e_nocarry_0588
	x.SetRandom()
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0588)
	}
}

func BenchmarkE_nocarry_0588Exp(b *testing.B) {
	var x e_nocarry_0588
	x.SetRandom()
	benchRese_nocarry_0588.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0588Double(b *testing.B) {
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Double(&benchRese_nocarry_0588)
	}
}

func BenchmarkE_nocarry_0588Add(b *testing.B) {
	var x e_nocarry_0588
	x.SetRandom()
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Add(&x, &benchRese_nocarry_0588)
	}
}

func BenchmarkE_nocarry_0588Sub(b *testing.B) {
	var x e_nocarry_0588
	x.SetRandom()
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Sub(&x, &benchRese_nocarry_0588)
	}
}

func BenchmarkE_nocarry_0588Neg(b *testing.B) {
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Neg(&benchRese_nocarry_0588)
	}
}

func BenchmarkE_nocarry_0588Div(b *testing.B) {
	var x e_nocarry_0588
	x.SetRandom()
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Div(&x, &benchRese_nocarry_0588)
	}
}

func BenchmarkE_nocarry_0588FromMont(b *testing.B) {
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.FromMont()
	}
}

func BenchmarkE_nocarry_0588ToMont(b *testing.B) {
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.ToMont()
	}
}
func BenchmarkE_nocarry_0588Square(b *testing.B) {
	benchRese_nocarry_0588.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Square(&benchRese_nocarry_0588)
	}
}

func BenchmarkE_nocarry_0588Sqrt(b *testing.B) {
	var a e_nocarry_0588
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0588Mul(b *testing.B) {
	x := e_nocarry_0588{
	...
	benchRese_nocarry_0588.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Mul(&benchRese_nocarry_0588, &x)
	}
}

func BenchmarkE_nocarry_0588Cmp(b *testing.B) {
	x := e_nocarry_0588{
		10329560823973367051,
		3846045993129973937,
		1041882238829668689,
	...
	benchRese_nocarry_0588 = x
	benchRese_nocarry_0588[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0588.Cmp(&x)
	}
}

func TestE_nocarry_0588Cmp(t *testing.T) {
	var x, y e_nocarry_0588
...
func TestE_nocarry_0588IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0588
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0588

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0588{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0588
	one.SetOne()
	e.Sub(&qe_nocarry_0588, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0588{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0588{0, uint64(i)})
	}
...
func TestE_nocarry_0588NegZero(t *testing.T) {
	var a, b e_nocarry_0588
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0588Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0588, len(staticTestValues))
...
func TestE_nocarry_0588Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0588) bool {
			var b e_nocarry_0588
...
func TestE_nocarry_0588InverseExp(t *testing.T) {
...
func TestE_nocarry_0588MulByConstants(t *testing.T) {
...
func TestE_nocarry_0588Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0588) bool {
...
func TestE_nocarry_0588LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0588Halve(t *testing.T) {
...
func TestE_nocarry_0588FromMont(t *testing.T) {
...
type testPaire_nocarry_0588 struct {
	element e_nocarry_0588
	bigint  big.Int
}

func (z *e_nocarry_0588) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0588[9] {
		return true
	}
	if z[9] < qe_nocarry_0588[9] {
		return false
	...
	return z[0] >= qe_nocarry_0588[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0588

		g.element = e_nocarry_0588{
		...
		if qe_nocarry_0588[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0588[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0588 {
			var g e_nocarry_0588
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0588[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0588[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0588[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0588[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0588[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0588[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0588[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0588[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0588[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0588[9], carry)
...
func Benchmarke_nocarry_0588InverseNew(b *testing.B) {
	var x e_nocarry_0588
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0588
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0588
		var xInv e_nocarry_0588
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0588
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0588
...
func testLinearComb(t *testing.T, x *e_nocarry_0588, xC int64, y *e_nocarry_0588, yC int64) {
	...
	var z e_nocarry_0588
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0588, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0588
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0588, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0588
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0588, xHi uint64) {
	var res e_nocarry_0588
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0588) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0588) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0588, c int64, result *e_nocarry_0588, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0588) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0588) uint64 {
