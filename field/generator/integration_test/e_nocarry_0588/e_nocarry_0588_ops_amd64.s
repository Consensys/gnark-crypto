...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0xf30822b1524507d3, R13
	ADDQ R13, AX
	MOVQ $0xfab0aa3ffa861f7e, R13
	ADCQ R13, DX
	MOVQ $0xe48621a2662bc8e1, R13
	ADCQ R13, CX
	MOVQ $0x39de34d62e8dc948, R13
	ADCQ R13, BX
	MOVQ $0x42c8d3392d9a1096, R13
	ADCQ R13, SI
	MOVQ $0x89ee823020406914, R13
	ADCQ R13, DI
	MOVQ $0xddcc013feb6d069b, R13
	ADCQ R13, R8
	MOVQ $0x950b97b59898bc10, R13
	ADCQ R13, R9
	MOVQ $0x781eab66e638027c, R13
	ADCQ R13, R10
	MOVQ $0x0000000000000fd6, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf30822b1524507d3, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xfab0aa3ffa861f7e, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xe48621a2662bc8e1, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x39de34d62e8dc948, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x42c8d3392d9a1096, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0x89ee823020406914, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xddcc013feb6d069b, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0x950b97b59898bc10, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0x781eab66e638027c, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x0000000000000fd6, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0xf30822b1524507d3, AX
	ADDQ AX, DX
	MOVQ $0xfab0aa3ffa861f7e, AX
	ADCQ AX, CX
	MOVQ $0xe48621a2662bc8e1, AX
	ADCQ AX, BX
	MOVQ $0x39de34d62e8dc948, AX
	ADCQ AX, SI
	MOVQ $0x42c8d3392d9a1096, AX
	ADCQ AX, DI
	MOVQ $0x89ee823020406914, AX
	ADCQ AX, R8
	MOVQ $0xddcc013feb6d069b, AX
	ADCQ AX, R9
	MOVQ $0x950b97b59898bc10, AX
	ADCQ AX, R10
	MOVQ $0x781eab66e638027c, AX
	ADCQ AX, R11
	MOVQ $0x0000000000000fd6, AX
	ADCQ AX, R12
