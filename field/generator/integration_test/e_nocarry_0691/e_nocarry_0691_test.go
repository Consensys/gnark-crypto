...
var benchRese_nocarry_0691 e_nocarry_0691

func BenchmarkE_nocarry_0691SetBytes(b *testing.B) {
	var x e_nocarry_0691
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0691MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0691.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0691)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0691)
		}
	})
}

func BenchmarkE_nocarry_0691Inverse(b *testing.B) {
	var x e_nocarry_0691
	x.SetRandom()
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0691Butterfly(b *testing.B) {
	var x e_nocarry_0691
	x.SetRandom()
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0691)
	}
}

func BenchmarkE_nocarry_0691Exp(b *testing.B) {
	var x e_nocarry_0691
	x.SetRandom()
	benchRese_nocarry_0691.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0691Double(b *testing.B) {
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Double(&benchRese_nocarry_0691)
	}
}

func BenchmarkE_nocarry_0691Add(b *testing.B) {
	var x e_nocarry_0691
	x.SetRandom()
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Add(&x, &benchRese_nocarry_0691)
	}
}

func BenchmarkE_nocarry_0691Sub(b *testing.B) {
	var x e_nocarry_0691
	x.SetRandom()
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Sub(&x, &benchRese_nocarry_0691)
	}
}

func BenchmarkE_nocarry_0691Neg(b *testing.B) {
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Neg(&benchRese_nocarry_0691)
	}
}

func BenchmarkE_nocarry_0691Div(b *testing.B) {
	var x e_nocarry_0691
	x.SetRandom()
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Div(&x, &benchRese_nocarry_0691)
	}
}

func BenchmarkE_nocarry_0691FromMont(b *testing.B) {
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.FromMont()
	}
}

func BenchmarkE_nocarry_0691ToMont(b *testing.B) {
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.ToMont()
	}
}
func BenchmarkE_nocarry_0691Square(b *testing.B) {
	benchRese_nocarry_0691.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Square(&benchRese_nocarry_0691)
	}
}

func BenchmarkE_nocarry_0691Sqrt(b *testing.B) {
	var a e_nocarry_0691
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0691Mul(b *testing.B) {
	x := e_nocarry_0691{
		345117921016128283,
		4694097679292915340,
	...
	benchRese_nocarry_0691.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Mul(&benchRese_nocarry_0691, &x)
	}
}

func BenchmarkE_nocarry_0691Cmp(b *testing.B) {
	x := e_nocarry_0691{
		345117921016128283,
		4694097679292915340,
		11656291343126176453,
	...
	benchRese_nocarry_0691 = x
	benchRese_nocarry_0691[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0691.Cmp(&x)
	}
}

func TestE_nocarry_0691Cmp(t *testing.T) {
	var x, y e_nocarry_0691
...
func TestE_nocarry_0691IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0691
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0691

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0691{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0691
	one.SetOne()
	e.Sub(&qe_nocarry_0691, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0691{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0691{0, uint64(i)})
	}
...
func TestE_nocarry_0691NegZero(t *testing.T) {
	var a, b e_nocarry_0691
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0691Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0691, len(staticTestValues))
...
func TestE_nocarry_0691Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0691) bool {
			var b e_nocarry_0691
...
func TestE_nocarry_0691InverseExp(t *testing.T) {
...
func TestE_nocarry_0691MulByConstants(t *testing.T) {
...
func TestE_nocarry_0691Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0691) bool {
...
func TestE_nocarry_0691LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0691Halve(t *testing.T) {
...
func TestE_nocarry_0691FromMont(t *testing.T) {
...
type testPaire_nocarry_0691 struct {
	element e_nocarry_0691
	bigint  big.Int
}

func (z *e_nocarry_0691) biggerOrEqualModulus() bool {
	if z[10] > qe_nocarry_0691[10] {
		return true
	}
	if z[10] < qe_nocarry_0691[10] {
		return false
	...
	return z[0] >= qe_nocarry_0691[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0691

		g.element = e_nocarry_0691{
		...
		if qe_nocarry_0691[10] != ^uint64(0) {
			g.element[10] %= (qe_nocarry_0691[10] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0691 {
			var g e_nocarry_0691
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0691[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0691[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0691[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0691[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0691[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0691[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0691[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0691[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0691[8], carry)
		a[9], carry = bits.Add64(a[9], qe_nocarry_0691[9], carry)
		a[10], _ = bits.Add64(a[10], qe_nocarry_0691[10], carry)
...
func Benchmarke_nocarry_0691InverseNew(b *testing.B) {
	var x e_nocarry_0691
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0691
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0691
		var xInv e_nocarry_0691
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0691
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0691
...
func testLinearComb(t *testing.T, x *e_nocarry_0691, xC int64, y *e_nocarry_0691, yC int64) {
	...
	var z e_nocarry_0691
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0691, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0691
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0691, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0691
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0691, xHi uint64) {
	var res e_nocarry_0691
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0691) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0691) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0691, c int64, result *e_nocarry_0691, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0691) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0691) uint64 {
