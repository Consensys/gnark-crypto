...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 80(R13), R12
	JCC  l1
	MOVQ $0xbdc461070407f0b7, R14
	ADDQ R14, AX
	MOVQ $0xd85672af00321d6a, R14
	ADCQ R14, DX
	MOVQ $0xe49208305a7b69b3, R14
	ADCQ R14, CX
	MOVQ $0xd364378e760a77e9, R14
	ADCQ R14, BX
	MOVQ $0x33764bc981a99485, R14
	ADCQ R14, SI
	MOVQ $0xb3a319fe533ad198, R14
	ADCQ R14, DI
	MOVQ $0x904ad907f96aa67c, R14
	ADCQ R14, R8
	MOVQ $0x602b73dbd998271d, R14
	ADCQ R14, R9
	MOVQ $0x31aa2ba04e290404, R14
	ADCQ R14, R10
	MOVQ $0xec9e6c13c37e11fe, R14
	ADCQ R14, R11
	MOVQ $0x000658019359552a, R14
	ADCQ R14, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xbdc461070407f0b7, R15
	SUBQ  DX, R15
	MOVQ  R15, 0(R14)
	MOVQ  $0xd85672af00321d6a, R15
	SBBQ  CX, R15
	MOVQ  R15, 8(R14)
	MOVQ  $0xe49208305a7b69b3, R15
	SBBQ  BX, R15
	MOVQ  R15, 16(R14)
	MOVQ  $0xd364378e760a77e9, R15
	SBBQ  SI, R15
	MOVQ  R15, 24(R14)
	MOVQ  $0x33764bc981a99485, R15
	SBBQ  DI, R15
	MOVQ  R15, 32(R14)
	MOVQ  $0xb3a319fe533ad198, R15
	SBBQ  R8, R15
	MOVQ  R15, 40(R14)
	MOVQ  $0x904ad907f96aa67c, R15
	SBBQ  R9, R15
	MOVQ  R15, 48(R14)
	MOVQ  $0x602b73dbd998271d, R15
	SBBQ  R10, R15
	MOVQ  R15, 56(R14)
	MOVQ  $0x31aa2ba04e290404, R15
	SBBQ  R11, R15
	MOVQ  R15, 64(R14)
	MOVQ  $0xec9e6c13c37e11fe, R15
	SBBQ  R12, R15
	MOVQ  R15, 72(R14)
	MOVQ  $0x000658019359552a, R15
	SBBQ  R13, R15
	MOVQ  R15, 80(R14)
	RET
...
TEXT ·Butterfly(SB), $72-16
	...
	SBBQ 80(AX), R13
	JCC  l3
	MOVQ $0xbdc461070407f0b7, AX
	ADDQ AX, DX
	MOVQ $0xd85672af00321d6a, AX
	ADCQ AX, CX
	MOVQ $0xe49208305a7b69b3, AX
	ADCQ AX, BX
	MOVQ $0xd364378e760a77e9, AX
	ADCQ AX, SI
	MOVQ $0x33764bc981a99485, AX
	ADCQ AX, DI
	MOVQ $0xb3a319fe533ad198, AX
	ADCQ AX, R8
	MOVQ $0x904ad907f96aa67c, AX
	ADCQ AX, R9
	MOVQ $0x602b73dbd998271d, AX
	ADCQ AX, R10
	MOVQ $0x31aa2ba04e290404, AX
	ADCQ AX, R11
	MOVQ $0xec9e6c13c37e11fe, AX
	ADCQ AX, R12
	MOVQ $0x000658019359552a, AX
	ADCQ AX, R13
