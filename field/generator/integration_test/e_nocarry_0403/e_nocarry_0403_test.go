...
var benchRese_nocarry_0403 e_nocarry_0403

func BenchmarkE_nocarry_0403SetBytes(b *testing.B) {
	var x e_nocarry_0403
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0403MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0403.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0403)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0403)
		}
	})
}

func BenchmarkE_nocarry_0403Inverse(b *testing.B) {
	var x e_nocarry_0403
	x.SetRandom()
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0403Butterfly(b *testing.B) {
	var x e_nocarry_0403
	x.SetRandom()
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0403)
	}
}

func BenchmarkE_nocarry_0403Exp(b *testing.B) {
	var x e_nocarry_0403
	x.SetRandom()
	benchRese_nocarry_0403.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0403Double(b *testing.B) {
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Double(&benchRese_nocarry_0403)
	}
}

func BenchmarkE_nocarry_0403Add(b *testing.B) {
	var x e_nocarry_0403
	x.SetRandom()
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Add(&x, &benchRese_nocarry_0403)
	}
}

func BenchmarkE_nocarry_0403Sub(b *testing.B) {
	var x e_nocarry_0403
	x.SetRandom()
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Sub(&x, &benchRese_nocarry_0403)
	}
}

func BenchmarkE_nocarry_0403Neg(b *testing.B) {
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Neg(&benchRese_nocarry_0403)
	}
}

func BenchmarkE_nocarry_0403Div(b *testing.B) {
	var x e_nocarry_0403
	x.SetRandom()
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Div(&x, &benchRese_nocarry_0403)
	}
}

func BenchmarkE_nocarry_0403FromMont(b *testing.B) {
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.FromMont()
	}
}

func BenchmarkE_nocarry_0403ToMont(b *testing.B) {
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.ToMont()
	}
}
func BenchmarkE_nocarry_0403Square(b *testing.B) {
	benchRese_nocarry_0403.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Square(&benchRese_nocarry_0403)
	}
}

func BenchmarkE_nocarry_0403Sqrt(b *testing.B) {
	var a e_nocarry_0403
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0403Mul(b *testing.B) {
	x := e_nocarry_0403{
		1014623900360846682,
		6669951690197360217,
	...
	benchRese_nocarry_0403.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Mul(&benchRese_nocarry_0403, &x)
	}
}

func BenchmarkE_nocarry_0403Cmp(b *testing.B) {
	x := e_nocarry_0403{
		1014623900360846682,
		6669951690197360217,
		10135816593865567093,
	...
	benchRese_nocarry_0403 = x
	benchRese_nocarry_0403[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0403.Cmp(&x)
	}
}

func TestE_nocarry_0403Cmp(t *testing.T) {
	var x, y e_nocarry_0403
...
func TestE_nocarry_0403IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0403
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0403

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0403{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0403
	one.SetOne()
	e.Sub(&qe_nocarry_0403, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0403{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0403{0, uint64(i)})
	}
...
func TestE_nocarry_0403NegZero(t *testing.T) {
	var a, b e_nocarry_0403
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0403Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0403, len(staticTestValues))
...
func TestE_nocarry_0403Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0403) bool {
			var b e_nocarry_0403
...
func TestE_nocarry_0403InverseExp(t *testing.T) {
...
func TestE_nocarry_0403MulByConstants(t *testing.T) {
...
func TestE_nocarry_0403Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0403) bool {
...
func TestE_nocarry_0403LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0403Halve(t *testing.T) {
...
func TestE_nocarry_0403FromMont(t *testing.T) {
...
type testPaire_nocarry_0403 struct {
	element e_nocarry_0403
	bigint  big.Int
}

func (z *e_nocarry_0403) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0403[6] {
		return true
	}
	if z[6] < qe_nocarry_0403[6] {
		return false
	...
	return z[0] >= qe_nocarry_0403[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0403

		g.element = e_nocarry_0403{
		...
		if qe_nocarry_0403[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0403[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0403 {
			var g e_nocarry_0403
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0403[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0403[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0403[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0403[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0403[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0403[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0403[6], carry)
...
func Benchmarke_nocarry_0403InverseNew(b *testing.B) {
	var x e_nocarry_0403
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0403
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0403
		var xInv e_nocarry_0403
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0403
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0403
...
func testLinearComb(t *testing.T, x *e_nocarry_0403, xC int64, y *e_nocarry_0403, yC int64) {
	...
	var z e_nocarry_0403
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0403, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0403
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0403, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0403
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0403, xHi uint64) {
	var res e_nocarry_0403
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0403) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0403) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0403, c int64, result *e_nocarry_0403, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0403) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0403) uint64 {
