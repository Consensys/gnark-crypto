...
// modulus q
DATA q<>+0(SB)/8, $0x3f4bf313a94f05c3
DATA q<>+8(SB)/8, $0x10af5abe718c8b67
DATA q<>+16(SB)/8, $0x385af214f798a66e
DATA q<>+24(SB)/8, $0x7a69a8444366d749
DATA q<>+32(SB)/8, $0xff2ff232d9b6e32d
DATA q<>+40(SB)/8, $0x00000000185d6679
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0x7bfb7f9d7525ed15
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0x3f4bf313a94f05c3, R10
	MOVQ    $0x10af5abe718c8b67, R11
	MOVQ    $0x385af214f798a66e, R12
	MOVQ    $0x7a69a8444366d749, R13
	MOVQ    $0xff2ff232d9b6e32d, R14
	MOVQ    $0x00000000185d6679, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x10af5abe718c8b67, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x385af214f798a66e, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0x7a69a8444366d749, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0xff2ff232d9b6e32d, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
	MOVQ  $0x00000000185d6679, R10
	SBBQ  R8, R10
	MOVQ  R10, 40(R9)
	RET
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0x3f4bf313a94f05c3, CX
	MOVQ    $0x10af5abe718c8b67, BX
	MOVQ    $0x385af214f798a66e, SI
	MOVQ    $0x7a69a8444366d749, DI
	MOVQ    $0xff2ff232d9b6e32d, R8
	MOVQ    $0x00000000185d6679, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
