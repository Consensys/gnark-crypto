...
var benchRese_nocarry_0349 e_nocarry_0349

func BenchmarkE_nocarry_0349SetBytes(b *testing.B) {
	var x e_nocarry_0349
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0349MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0349.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0349)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0349)
		}
	})
}

func BenchmarkE_nocarry_0349Inverse(b *testing.B) {
	var x e_nocarry_0349
	x.SetRandom()
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0349Butterfly(b *testing.B) {
	var x e_nocarry_0349
	x.SetRandom()
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0349)
	}
}

func BenchmarkE_nocarry_0349Exp(b *testing.B) {
	var x e_nocarry_0349
	x.SetRandom()
	benchRese_nocarry_0349.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0349Double(b *testing.B) {
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Double(&benchRese_nocarry_0349)
	}
}

func BenchmarkE_nocarry_0349Add(b *testing.B) {
	var x e_nocarry_0349
	x.SetRandom()
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Add(&x, &benchRese_nocarry_0349)
	}
}

func BenchmarkE_nocarry_0349Sub(b *testing.B) {
	var x e_nocarry_0349
	x.SetRandom()
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Sub(&x, &benchRese_nocarry_0349)
	}
}

func BenchmarkE_nocarry_0349Neg(b *testing.B) {
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Neg(&benchRese_nocarry_0349)
	}
}

func BenchmarkE_nocarry_0349Div(b *testing.B) {
	var x e_nocarry_0349
	x.SetRandom()
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Div(&x, &benchRese_nocarry_0349)
	}
}

func BenchmarkE_nocarry_0349FromMont(b *testing.B) {
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.FromMont()
	}
}

func BenchmarkE_nocarry_0349ToMont(b *testing.B) {
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.ToMont()
	}
}
func BenchmarkE_nocarry_0349Square(b *testing.B) {
	benchRese_nocarry_0349.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Square(&benchRese_nocarry_0349)
	}
}

func BenchmarkE_nocarry_0349Sqrt(b *testing.B) {
	var a e_nocarry_0349
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0349Mul(b *testing.B) {
	x := e_nocarry_0349{
	...
	benchRese_nocarry_0349.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Mul(&benchRese_nocarry_0349, &x)
	}
}

func BenchmarkE_nocarry_0349Cmp(b *testing.B) {
	x := e_nocarry_0349{
		14235400658310986213,
		17152081750190303641,
		16280023774384713231,
	...
	benchRese_nocarry_0349 = x
	benchRese_nocarry_0349[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0349.Cmp(&x)
	}
}

func TestE_nocarry_0349Cmp(t *testing.T) {
	var x, y e_nocarry_0349
...
func TestE_nocarry_0349IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0349
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0349

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0349{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0349
	one.SetOne()
	e.Sub(&qe_nocarry_0349, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0349{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0349{0, uint64(i)})
	}
...
func TestE_nocarry_0349NegZero(t *testing.T) {
	var a, b e_nocarry_0349
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0349Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0349, len(staticTestValues))
...
func TestE_nocarry_0349Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0349) bool {
			var b e_nocarry_0349
...
func TestE_nocarry_0349InverseExp(t *testing.T) {
...
func TestE_nocarry_0349MulByConstants(t *testing.T) {
...
func TestE_nocarry_0349Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0349) bool {
...
func TestE_nocarry_0349LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0349Halve(t *testing.T) {
...
func TestE_nocarry_0349FromMont(t *testing.T) {
...
type testPaire_nocarry_0349 struct {
	element e_nocarry_0349
	bigint  big.Int
}

func (z *e_nocarry_0349) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0349[5] {
		return true
	}
	if z[5] < qe_nocarry_0349[5] {
		return false
	...
	return z[0] >= qe_nocarry_0349[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0349

		g.element = e_nocarry_0349{
		...
		if qe_nocarry_0349[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0349[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0349 {
			var g e_nocarry_0349
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0349[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0349[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0349[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0349[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0349[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0349[5], carry)
...
func Benchmarke_nocarry_0349InverseNew(b *testing.B) {
	var x e_nocarry_0349
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0349
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0349
		var xInv e_nocarry_0349
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0349
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0349
...
func testLinearComb(t *testing.T, x *e_nocarry_0349, xC int64, y *e_nocarry_0349, yC int64) {
	...
	var z e_nocarry_0349
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0349, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0349
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0349, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0349
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0349, xHi uint64) {
	var res e_nocarry_0349
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0349) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0349) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0349, c int64, result *e_nocarry_0349, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0349) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0349) uint64 {
