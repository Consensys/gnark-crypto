...
var benchRese_nocarry_0278 e_nocarry_0278

func BenchmarkE_nocarry_0278SetBytes(b *testing.B) {
	var x e_nocarry_0278
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0278MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0278.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0278)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0278)
		}
	})
}

func BenchmarkE_nocarry_0278Inverse(b *testing.B) {
	var x e_nocarry_0278
	x.SetRandom()
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0278Butterfly(b *testing.B) {
	var x e_nocarry_0278
	x.SetRandom()
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0278)
	}
}

func BenchmarkE_nocarry_0278Exp(b *testing.B) {
	var x e_nocarry_0278
	x.SetRandom()
	benchRese_nocarry_0278.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0278Double(b *testing.B) {
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Double(&benchRese_nocarry_0278)
	}
}

func BenchmarkE_nocarry_0278Add(b *testing.B) {
	var x e_nocarry_0278
	x.SetRandom()
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Add(&x, &benchRese_nocarry_0278)
	}
}

func BenchmarkE_nocarry_0278Sub(b *testing.B) {
	var x e_nocarry_0278
	x.SetRandom()
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Sub(&x, &benchRese_nocarry_0278)
	}
}

func BenchmarkE_nocarry_0278Neg(b *testing.B) {
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Neg(&benchRese_nocarry_0278)
	}
}

func BenchmarkE_nocarry_0278Div(b *testing.B) {
	var x e_nocarry_0278
	x.SetRandom()
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Div(&x, &benchRese_nocarry_0278)
	}
}

func BenchmarkE_nocarry_0278FromMont(b *testing.B) {
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.FromMont()
	}
}

func BenchmarkE_nocarry_0278ToMont(b *testing.B) {
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.ToMont()
	}
}
func BenchmarkE_nocarry_0278Square(b *testing.B) {
	benchRese_nocarry_0278.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Square(&benchRese_nocarry_0278)
	}
}

func BenchmarkE_nocarry_0278Sqrt(b *testing.B) {
	var a e_nocarry_0278
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0278Mul(b *testing.B) {
	x := e_nocarry_0278{
	...
	benchRese_nocarry_0278.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Mul(&benchRese_nocarry_0278, &x)
	}
}

func BenchmarkE_nocarry_0278Cmp(b *testing.B) {
	x := e_nocarry_0278{
		13163113111713628182,
		912471976330953852,
		2257270174747545446,
	...
	benchRese_nocarry_0278 = x
	benchRese_nocarry_0278[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0278.Cmp(&x)
	}
}

func TestE_nocarry_0278Cmp(t *testing.T) {
	var x, y e_nocarry_0278
...
func TestE_nocarry_0278IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0278
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0278

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0278{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0278
	one.SetOne()
	e.Sub(&qe_nocarry_0278, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0278{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0278{0, uint64(i)})
	}
...
func TestE_nocarry_0278NegZero(t *testing.T) {
	var a, b e_nocarry_0278
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0278Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0278, len(staticTestValues))
...
func TestE_nocarry_0278Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0278) bool {
			var b e_nocarry_0278
...
func TestE_nocarry_0278InverseExp(t *testing.T) {
...
func TestE_nocarry_0278MulByConstants(t *testing.T) {
...
func TestE_nocarry_0278Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0278) bool {
...
func TestE_nocarry_0278LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0278Halve(t *testing.T) {
...
func TestE_nocarry_0278FromMont(t *testing.T) {
...
type testPaire_nocarry_0278 struct {
	element e_nocarry_0278
	bigint  big.Int
}

func (z *e_nocarry_0278) biggerOrEqualModulus() bool {
	if z[4] > qe_nocarry_0278[4] {
		return true
	}
	if z[4] < qe_nocarry_0278[4] {
		return false
	...
	return z[0] >= qe_nocarry_0278[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0278

		g.element = e_nocarry_0278{
		...
		if qe_nocarry_0278[4] != ^uint64(0) {
			g.element[4] %= (qe_nocarry_0278[4] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0278 {
			var g e_nocarry_0278
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0278[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0278[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0278[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0278[3], carry)
		a[4], _ = bits.Add64(a[4], qe_nocarry_0278[4], carry)
...
func Benchmarke_nocarry_0278InverseNew(b *testing.B) {
	var x e_nocarry_0278
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0278
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0278
		var xInv e_nocarry_0278
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0278
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0278
...
func testLinearComb(t *testing.T, x *e_nocarry_0278, xC int64, y *e_nocarry_0278, yC int64) {
	...
	var z e_nocarry_0278
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0278, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0278
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0278, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0278
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0278, xHi uint64) {
	var res e_nocarry_0278
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0278) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0278) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0278, c int64, result *e_nocarry_0278, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0278) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0278) uint64 {
