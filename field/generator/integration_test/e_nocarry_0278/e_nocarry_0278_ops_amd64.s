...
// modulus q
DATA q<>+0(SB)/8, $0x9f87087b2ddae143
DATA q<>+8(SB)/8, $0x3308505257effcd1
DATA q<>+16(SB)/8, $0x23ee65b5b71cc2a7
DATA q<>+24(SB)/8, $0xd87eddac71fd6cc9
DATA q<>+32(SB)/8, $0x00000000003b53db
GLOBL q<>(SB), (RODATA+NOPTR), $40

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xe183a2af2b294c95
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    24(DI), BX
	SBBQ    32(DI), SI
	MOVQ    $0x9f87087b2ddae143, R9
	MOVQ    $0x3308505257effcd1, R10
	MOVQ    $0x23ee65b5b71cc2a7, R11
	MOVQ    $0xd87eddac71fd6cc9, R12
	MOVQ    $0x00000000003b53db, R13
	CMOVQCC R8, R9
	CMOVQCC R8, R10
	CMOVQCC R8, R11
	CMOVQCC R8, R12
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R9
	MOVQ  R9, 0(R8)
	MOVQ  $0x3308505257effcd1, R9
	SBBQ  CX, R9
	MOVQ  R9, 8(R8)
	MOVQ  $0x23ee65b5b71cc2a7, R9
	SBBQ  BX, R9
	MOVQ  R9, 16(R8)
	MOVQ  $0xd87eddac71fd6cc9, R9
	SBBQ  SI, R9
	MOVQ  R9, 24(R8)
	MOVQ  $0x00000000003b53db, R9
	SBBQ  DI, R9
	MOVQ  R9, 32(R8)
	RET
...
TEXT ·Butterfly(SB), $24-16
	...
	MOVQ    DI, s1-16(SP)
	MOVQ    R8, s2-24(SP)
	MOVQ    $0x9f87087b2ddae143, CX
	MOVQ    $0x3308505257effcd1, BX
	MOVQ    $0x23ee65b5b71cc2a7, SI
	MOVQ    $0xd87eddac71fd6cc9, DI
	MOVQ    $0x00000000003b53db, R8
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
