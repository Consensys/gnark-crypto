...
var benchRese_nocarry_0323 e_nocarry_0323

func BenchmarkE_nocarry_0323SetBytes(b *testing.B) {
	var x e_nocarry_0323
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0323MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0323.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0323)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0323)
		}
	})
}

func BenchmarkE_nocarry_0323Inverse(b *testing.B) {
	var x e_nocarry_0323
	x.SetRandom()
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0323Butterfly(b *testing.B) {
	var x e_nocarry_0323
	x.SetRandom()
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0323)
	}
}

func BenchmarkE_nocarry_0323Exp(b *testing.B) {
	var x e_nocarry_0323
	x.SetRandom()
	benchRese_nocarry_0323.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0323Double(b *testing.B) {
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Double(&benchRese_nocarry_0323)
	}
}

func BenchmarkE_nocarry_0323Add(b *testing.B) {
	var x e_nocarry_0323
	x.SetRandom()
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Add(&x, &benchRese_nocarry_0323)
	}
}

func BenchmarkE_nocarry_0323Sub(b *testing.B) {
	var x e_nocarry_0323
	x.SetRandom()
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Sub(&x, &benchRese_nocarry_0323)
	}
}

func BenchmarkE_nocarry_0323Neg(b *testing.B) {
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Neg(&benchRese_nocarry_0323)
	}
}

func BenchmarkE_nocarry_0323Div(b *testing.B) {
	var x e_nocarry_0323
	x.SetRandom()
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Div(&x, &benchRese_nocarry_0323)
	}
}

func BenchmarkE_nocarry_0323FromMont(b *testing.B) {
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.FromMont()
	}
}

func BenchmarkE_nocarry_0323ToMont(b *testing.B) {
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.ToMont()
	}
}
func BenchmarkE_nocarry_0323Square(b *testing.B) {
	benchRese_nocarry_0323.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Square(&benchRese_nocarry_0323)
	}
}

func BenchmarkE_nocarry_0323Sqrt(b *testing.B) {
	var a e_nocarry_0323
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0323Mul(b *testing.B) {
	x := e_nocarry_0323{
	...
	benchRese_nocarry_0323.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Mul(&benchRese_nocarry_0323, &x)
	}
}

func BenchmarkE_nocarry_0323Cmp(b *testing.B) {
	x := e_nocarry_0323{
		10144856929011807913,
		2812047897412774510,
		1890283597530955007,
	...
	benchRese_nocarry_0323 = x
	benchRese_nocarry_0323[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0323.Cmp(&x)
	}
}

func TestE_nocarry_0323Cmp(t *testing.T) {
	var x, y e_nocarry_0323
...
func TestE_nocarry_0323IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0323
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0323

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0323{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0323
	one.SetOne()
	e.Sub(&qe_nocarry_0323, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0323{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0323{0, uint64(i)})
	}
...
func TestE_nocarry_0323NegZero(t *testing.T) {
	var a, b e_nocarry_0323
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0323Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0323, len(staticTestValues))
...
func TestE_nocarry_0323Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0323) bool {
			var b e_nocarry_0323
...
func TestE_nocarry_0323InverseExp(t *testing.T) {
...
func TestE_nocarry_0323MulByConstants(t *testing.T) {
...
func TestE_nocarry_0323Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0323) bool {
...
func TestE_nocarry_0323LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0323Halve(t *testing.T) {
...
func TestE_nocarry_0323FromMont(t *testing.T) {
...
type testPaire_nocarry_0323 struct {
	element e_nocarry_0323
	bigint  big.Int
}

func (z *e_nocarry_0323) biggerOrEqualModulus() bool {
	if z[5] > qe_nocarry_0323[5] {
		return true
	}
	if z[5] < qe_nocarry_0323[5] {
		return false
	...
	return z[0] >= qe_nocarry_0323[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0323

		g.element = e_nocarry_0323{
		...
		if qe_nocarry_0323[5] != ^uint64(0) {
			g.element[5] %= (qe_nocarry_0323[5] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0323 {
			var g e_nocarry_0323
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0323[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0323[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0323[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0323[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0323[4], carry)
		a[5], _ = bits.Add64(a[5], qe_nocarry_0323[5], carry)
...
func Benchmarke_nocarry_0323InverseNew(b *testing.B) {
	var x e_nocarry_0323
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0323
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0323
		var xInv e_nocarry_0323
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0323
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0323
...
func testLinearComb(t *testing.T, x *e_nocarry_0323, xC int64, y *e_nocarry_0323, yC int64) {
	...
	var z e_nocarry_0323
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0323, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0323
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0323, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0323
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0323, xHi uint64) {
	var res e_nocarry_0323
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0323) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0323) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0323, c int64, result *e_nocarry_0323, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0323) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0323) uint64 {
