...
// modulus q
DATA q<>+0(SB)/8, $0xa4f01c46ee74b37f
DATA q<>+8(SB)/8, $0x4626ca9853fe6ead
DATA q<>+16(SB)/8, $0x9931d78526b864f7
DATA q<>+24(SB)/8, $0xfb90f6d97ee3b398
DATA q<>+32(SB)/8, $0x0236fb8f0479c46d
DATA q<>+40(SB)/8, $0x0000000000000006
GLOBL q<>(SB), (RODATA+NOPTR), $48

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xe5ab8d991730f381
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    32(R8), SI
	SBBQ    40(R8), DI
	MOVQ    $0xa4f01c46ee74b37f, R10
	MOVQ    $0x4626ca9853fe6ead, R11
	MOVQ    $0x9931d78526b864f7, R12
	MOVQ    $0xfb90f6d97ee3b398, R13
	MOVQ    $0x0236fb8f0479c46d, R14
	MOVQ    $0x0000000000000006, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x4626ca9853fe6ead, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x9931d78526b864f7, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xfb90f6d97ee3b398, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x0236fb8f0479c46d, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    R8, s4-40(SP)
	MOVQ    R9, s5-48(SP)
	MOVQ    $0xa4f01c46ee74b37f, CX
	MOVQ    $0x4626ca9853fe6ead, BX
	MOVQ    $0x9931d78526b864f7, SI
	MOVQ    $0xfb90f6d97ee3b398, DI
	MOVQ    $0x0236fb8f0479c46d, R8
	MOVQ    $0x0000000000000006, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
