...
var benchRese_nocarry_0610 e_nocarry_0610

func BenchmarkE_nocarry_0610SetBytes(b *testing.B) {
	var x e_nocarry_0610
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0610MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0610.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0610)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0610)
		}
	})
}

func BenchmarkE_nocarry_0610Inverse(b *testing.B) {
	var x e_nocarry_0610
	x.SetRandom()
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0610Butterfly(b *testing.B) {
	var x e_nocarry_0610
	x.SetRandom()
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0610)
	}
}

func BenchmarkE_nocarry_0610Exp(b *testing.B) {
	var x e_nocarry_0610
	x.SetRandom()
	benchRese_nocarry_0610.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0610Double(b *testing.B) {
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Double(&benchRese_nocarry_0610)
	}
}

func BenchmarkE_nocarry_0610Add(b *testing.B) {
	var x e_nocarry_0610
	x.SetRandom()
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Add(&x, &benchRese_nocarry_0610)
	}
}

func BenchmarkE_nocarry_0610Sub(b *testing.B) {
	var x e_nocarry_0610
	x.SetRandom()
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Sub(&x, &benchRese_nocarry_0610)
	}
}

func BenchmarkE_nocarry_0610Neg(b *testing.B) {
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Neg(&benchRese_nocarry_0610)
	}
}

func BenchmarkE_nocarry_0610Div(b *testing.B) {
	var x e_nocarry_0610
	x.SetRandom()
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Div(&x, &benchRese_nocarry_0610)
	}
}

func BenchmarkE_nocarry_0610FromMont(b *testing.B) {
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.FromMont()
	}
}

func BenchmarkE_nocarry_0610ToMont(b *testing.B) {
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.ToMont()
	}
}
func BenchmarkE_nocarry_0610Square(b *testing.B) {
	benchRese_nocarry_0610.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Square(&benchRese_nocarry_0610)
	}
}

func BenchmarkE_nocarry_0610Sqrt(b *testing.B) {
	var a e_nocarry_0610
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0610Mul(b *testing.B) {
	x := e_nocarry_0610{
	...
	benchRese_nocarry_0610.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Mul(&benchRese_nocarry_0610, &x)
	}
}

func BenchmarkE_nocarry_0610Cmp(b *testing.B) {
	x := e_nocarry_0610{
		18227872652235980933,
		2417740997835654322,
		10917326307669424427,
	...
	benchRese_nocarry_0610 = x
	benchRese_nocarry_0610[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0610.Cmp(&x)
	}
}

func TestE_nocarry_0610Cmp(t *testing.T) {
	var x, y e_nocarry_0610
...
func TestE_nocarry_0610IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0610
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0610

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0610{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0610
	one.SetOne()
	e.Sub(&qe_nocarry_0610, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0610{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0610{0, uint64(i)})
	}
...
func TestE_nocarry_0610NegZero(t *testing.T) {
	var a, b e_nocarry_0610
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0610Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0610, len(staticTestValues))
...
func TestE_nocarry_0610Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0610) bool {
			var b e_nocarry_0610
...
func TestE_nocarry_0610InverseExp(t *testing.T) {
...
func TestE_nocarry_0610MulByConstants(t *testing.T) {
...
func TestE_nocarry_0610Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0610) bool {
...
func TestE_nocarry_0610LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0610Halve(t *testing.T) {
...
func TestE_nocarry_0610FromMont(t *testing.T) {
...
type testPaire_nocarry_0610 struct {
	element e_nocarry_0610
	bigint  big.Int
}

func (z *e_nocarry_0610) biggerOrEqualModulus() bool {
	if z[9] > qe_nocarry_0610[9] {
		return true
	}
	if z[9] < qe_nocarry_0610[9] {
		return false
	...
	return z[0] >= qe_nocarry_0610[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0610

		g.element = e_nocarry_0610{
		...
		if qe_nocarry_0610[9] != ^uint64(0) {
			g.element[9] %= (qe_nocarry_0610[9] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0610 {
			var g e_nocarry_0610
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0610[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0610[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0610[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0610[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0610[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0610[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0610[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0610[7], carry)
		a[8], carry = bits.Add64(a[8], qe_nocarry_0610[8], carry)
		a[9], _ = bits.Add64(a[9], qe_nocarry_0610[9], carry)
...
func Benchmarke_nocarry_0610InverseNew(b *testing.B) {
	var x e_nocarry_0610
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0610
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0610
		var xInv e_nocarry_0610
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0610
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0610
...
func testLinearComb(t *testing.T, x *e_nocarry_0610, xC int64, y *e_nocarry_0610, yC int64) {
	...
	var z e_nocarry_0610
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0610, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0610
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0610, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0610
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0610, xHi uint64) {
	var res e_nocarry_0610
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0610) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0610) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0610, c int64, result *e_nocarry_0610, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0610) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0610) uint64 {
