...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 72(R12), R11
	JCC  l1
	MOVQ $0x2b51adde6201db7d, R13
	ADDQ R13, AX
	MOVQ $0xd0c1e8eeaff0c40a, R13
	ADCQ R13, DX
	MOVQ $0xede6aa048bf2b69e, R13
	ADCQ R13, CX
	MOVQ $0x4b10ee55b3e4d0ec, R13
	ADCQ R13, BX
	MOVQ $0x901272c85248e60d, R13
	ADCQ R13, SI
	MOVQ $0xa8c119ff842bd58f, R13
	ADCQ R13, DI
	MOVQ $0xee7dea9b9d37e6a7, R13
	ADCQ R13, R8
	MOVQ $0xcc6bfa2048652118, R13
	ADCQ R13, R9
	MOVQ $0xcfc2297c85be7ec2, R13
	ADCQ R13, R10
	MOVQ $0x000000039633bfb9, R13
	ADCQ R13, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x2b51adde6201db7d, R14
	SUBQ  DX, R14
	MOVQ  R14, 0(R13)
	MOVQ  $0xd0c1e8eeaff0c40a, R14
	SBBQ  CX, R14
	MOVQ  R14, 8(R13)
	MOVQ  $0xede6aa048bf2b69e, R14
	SBBQ  BX, R14
	MOVQ  R14, 16(R13)
	MOVQ  $0x4b10ee55b3e4d0ec, R14
	SBBQ  SI, R14
	MOVQ  R14, 24(R13)
	MOVQ  $0x901272c85248e60d, R14
	SBBQ  DI, R14
	MOVQ  R14, 32(R13)
	MOVQ  $0xa8c119ff842bd58f, R14
	SBBQ  R8, R14
	MOVQ  R14, 40(R13)
	MOVQ  $0xee7dea9b9d37e6a7, R14
	SBBQ  R9, R14
	MOVQ  R14, 48(R13)
	MOVQ  $0xcc6bfa2048652118, R14
	SBBQ  R10, R14
	MOVQ  R14, 56(R13)
	MOVQ  $0xcfc2297c85be7ec2, R14
	SBBQ  R11, R14
	MOVQ  R14, 64(R13)
	MOVQ  $0x000000039633bfb9, R14
	SBBQ  R12, R14
	MOVQ  R14, 72(R13)
	RET
...
TEXT ·Butterfly(SB), $56-16
	...
	SBBQ 72(AX), R12
	JCC  l3
	MOVQ $0x2b51adde6201db7d, AX
	ADDQ AX, DX
	MOVQ $0xd0c1e8eeaff0c40a, AX
	ADCQ AX, CX
	MOVQ $0xede6aa048bf2b69e, AX
	ADCQ AX, BX
	MOVQ $0x4b10ee55b3e4d0ec, AX
	ADCQ AX, SI
	MOVQ $0x901272c85248e60d, AX
	ADCQ AX, DI
	MOVQ $0xa8c119ff842bd58f, AX
	ADCQ AX, R8
	MOVQ $0xee7dea9b9d37e6a7, AX
	ADCQ AX, R9
	MOVQ $0xcc6bfa2048652118, AX
	ADCQ AX, R10
	MOVQ $0xcfc2297c85be7ec2, AX
	ADCQ AX, R11
	MOVQ $0x000000039633bfb9, AX
	ADCQ AX, R12
