...
var benchRese_nocarry_0479 e_nocarry_0479

func BenchmarkE_nocarry_0479SetBytes(b *testing.B) {
	var x e_nocarry_0479
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0479MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0479.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0479)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0479)
		}
	})
}

func BenchmarkE_nocarry_0479Inverse(b *testing.B) {
	var x e_nocarry_0479
	x.SetRandom()
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0479Butterfly(b *testing.B) {
	var x e_nocarry_0479
	x.SetRandom()
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0479)
	}
}

func BenchmarkE_nocarry_0479Exp(b *testing.B) {
	var x e_nocarry_0479
	x.SetRandom()
	benchRese_nocarry_0479.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0479Double(b *testing.B) {
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Double(&benchRese_nocarry_0479)
	}
}

func BenchmarkE_nocarry_0479Add(b *testing.B) {
	var x e_nocarry_0479
	x.SetRandom()
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Add(&x, &benchRese_nocarry_0479)
	}
}

func BenchmarkE_nocarry_0479Sub(b *testing.B) {
	var x e_nocarry_0479
	x.SetRandom()
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Sub(&x, &benchRese_nocarry_0479)
	}
}

func BenchmarkE_nocarry_0479Neg(b *testing.B) {
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Neg(&benchRese_nocarry_0479)
	}
}

func BenchmarkE_nocarry_0479Div(b *testing.B) {
	var x e_nocarry_0479
	x.SetRandom()
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Div(&x, &benchRese_nocarry_0479)
	}
}

func BenchmarkE_nocarry_0479FromMont(b *testing.B) {
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.FromMont()
	}
}

func BenchmarkE_nocarry_0479ToMont(b *testing.B) {
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.ToMont()
	}
}
func BenchmarkE_nocarry_0479Square(b *testing.B) {
	benchRese_nocarry_0479.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Square(&benchRese_nocarry_0479)
	}
}

func BenchmarkE_nocarry_0479Sqrt(b *testing.B) {
	var a e_nocarry_0479
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0479Mul(b *testing.B) {
	x := e_nocarry_0479{
		2165402122670267361,
		7235362109963089252,
	...
	benchRese_nocarry_0479.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Mul(&benchRese_nocarry_0479, &x)
	}
}

func BenchmarkE_nocarry_0479Cmp(b *testing.B) {
	x := e_nocarry_0479{
		2165402122670267361,
		7235362109963089252,
		15905914999879247748,
	...
	benchRese_nocarry_0479 = x
	benchRese_nocarry_0479[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0479.Cmp(&x)
	}
}

func TestE_nocarry_0479Cmp(t *testing.T) {
	var x, y e_nocarry_0479
...
func TestE_nocarry_0479IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0479
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0479

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0479{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0479
	one.SetOne()
	e.Sub(&qe_nocarry_0479, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0479{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0479{0, uint64(i)})
	}
...
func TestE_nocarry_0479NegZero(t *testing.T) {
	var a, b e_nocarry_0479
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0479Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0479, len(staticTestValues))
...
func TestE_nocarry_0479Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0479) bool {
			var b e_nocarry_0479
...
func TestE_nocarry_0479InverseExp(t *testing.T) {
...
func TestE_nocarry_0479MulByConstants(t *testing.T) {
...
func TestE_nocarry_0479Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0479) bool {
...
func TestE_nocarry_0479LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0479Halve(t *testing.T) {
...
func TestE_nocarry_0479FromMont(t *testing.T) {
...
type testPaire_nocarry_0479 struct {
	element e_nocarry_0479
	bigint  big.Int
}

func (z *e_nocarry_0479) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0479[7] {
		return true
	}
	if z[7] < qe_nocarry_0479[7] {
		return false
	...
	return z[0] >= qe_nocarry_0479[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0479

		g.element = e_nocarry_0479{
		...
		if qe_nocarry_0479[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0479[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0479 {
			var g e_nocarry_0479
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0479[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0479[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0479[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0479[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0479[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0479[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0479[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0479[7], carry)
...
func Benchmarke_nocarry_0479InverseNew(b *testing.B) {
	var x e_nocarry_0479
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0479
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0479
		var xInv e_nocarry_0479
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0479
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0479
...
func testLinearComb(t *testing.T, x *e_nocarry_0479, xC int64, y *e_nocarry_0479, yC int64) {
	...
	var z e_nocarry_0479
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0479, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0479
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0479, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0479
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0479, xHi uint64) {
	var res e_nocarry_0479
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0479) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0479) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0479, c int64, result *e_nocarry_0479, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0479) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0479) uint64 {
