...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 64(R11), R10
	JCC  l1
	MOVQ $0x4b7ac53559d7385b, R12
	ADDQ R12, AX
	MOVQ $0x96042dfafd20d8a8, R12
	ADCQ R12, DX
	MOVQ $0x169df393276be93e, R12
	ADCQ R12, CX
	MOVQ $0xf5b011a6775399ae, R12
	ADCQ R12, BX
	MOVQ $0xf6f4eda3bb2f8c0c, R12
	ADCQ R12, SI
	MOVQ $0xfd260c3b51609abc, R12
	ADCQ R12, DI
	MOVQ $0x493216c0da37b13e, R12
	ADCQ R12, R8
	MOVQ $0x6ebc5f0a0c070e7d, R12
	ADCQ R12, R9
	MOVQ $0x00000000623bfaee, R12
	ADCQ R12, R10
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0x4b7ac53559d7385b, R13
	SUBQ  DX, R13
	MOVQ  R13, 0(R12)
	MOVQ  $0x96042dfafd20d8a8, R13
	SBBQ  CX, R13
	MOVQ  R13, 8(R12)
	MOVQ  $0x169df393276be93e, R13
	SBBQ  BX, R13
	MOVQ  R13, 16(R12)
	MOVQ  $0xf5b011a6775399ae, R13
	SBBQ  SI, R13
	MOVQ  R13, 24(R12)
	MOVQ  $0xf6f4eda3bb2f8c0c, R13
	SBBQ  DI, R13
	MOVQ  R13, 32(R12)
	MOVQ  $0xfd260c3b51609abc, R13
	SBBQ  R8, R13
	MOVQ  R13, 40(R12)
	MOVQ  $0x493216c0da37b13e, R13
	SBBQ  R9, R13
	MOVQ  R13, 48(R12)
	MOVQ  $0x6ebc5f0a0c070e7d, R13
	SBBQ  R10, R13
	MOVQ  R13, 56(R12)
	MOVQ  $0x00000000623bfaee, R13
	SBBQ  R11, R13
	MOVQ  R13, 64(R12)
	RET
...
TEXT ·Butterfly(SB), $40-16
	...
	SBBQ 64(AX), R11
	JCC  l3
	MOVQ $0x4b7ac53559d7385b, AX
	ADDQ AX, DX
	MOVQ $0x96042dfafd20d8a8, AX
	ADCQ AX, CX
	MOVQ $0x169df393276be93e, AX
	ADCQ AX, BX
	MOVQ $0xf5b011a6775399ae, AX
	ADCQ AX, SI
	MOVQ $0xf6f4eda3bb2f8c0c, AX
	ADCQ AX, DI
	MOVQ $0xfd260c3b51609abc, AX
	ADCQ AX, R8
	MOVQ $0x493216c0da37b13e, AX
	ADCQ AX, R9
	MOVQ $0x6ebc5f0a0c070e7d, AX
	ADCQ AX, R10
	MOVQ $0x00000000623bfaee, AX
	ADCQ AX, R11
