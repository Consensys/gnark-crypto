...
var benchRese_nocarry_0543 e_nocarry_0543

func BenchmarkE_nocarry_0543SetBytes(b *testing.B) {
	var x e_nocarry_0543
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0543MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0543.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0543)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0543)
		}
	})
}

func BenchmarkE_nocarry_0543Inverse(b *testing.B) {
	var x e_nocarry_0543
	x.SetRandom()
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0543Butterfly(b *testing.B) {
	var x e_nocarry_0543
	x.SetRandom()
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0543)
	}
}

func BenchmarkE_nocarry_0543Exp(b *testing.B) {
	var x e_nocarry_0543
	x.SetRandom()
	benchRese_nocarry_0543.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0543Double(b *testing.B) {
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Double(&benchRese_nocarry_0543)
	}
}

func BenchmarkE_nocarry_0543Add(b *testing.B) {
	var x e_nocarry_0543
	x.SetRandom()
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Add(&x, &benchRese_nocarry_0543)
	}
}

func BenchmarkE_nocarry_0543Sub(b *testing.B) {
	var x e_nocarry_0543
	x.SetRandom()
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Sub(&x, &benchRese_nocarry_0543)
	}
}

func BenchmarkE_nocarry_0543Neg(b *testing.B) {
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Neg(&benchRese_nocarry_0543)
	}
}

func BenchmarkE_nocarry_0543Div(b *testing.B) {
	var x e_nocarry_0543
	x.SetRandom()
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Div(&x, &benchRese_nocarry_0543)
	}
}

func BenchmarkE_nocarry_0543FromMont(b *testing.B) {
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.FromMont()
	}
}

func BenchmarkE_nocarry_0543ToMont(b *testing.B) {
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.ToMont()
	}
}
func BenchmarkE_nocarry_0543Square(b *testing.B) {
	benchRese_nocarry_0543.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Square(&benchRese_nocarry_0543)
	}
}

func BenchmarkE_nocarry_0543Sqrt(b *testing.B) {
	var a e_nocarry_0543
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0543Mul(b *testing.B) {
	x := e_nocarry_0543{
	...
	benchRese_nocarry_0543.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Mul(&benchRese_nocarry_0543, &x)
	}
}

func BenchmarkE_nocarry_0543Cmp(b *testing.B) {
	x := e_nocarry_0543{
		10046240064152574198,
		6969003448922680593,
		294954919825923894,
	...
	benchRese_nocarry_0543 = x
	benchRese_nocarry_0543[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0543.Cmp(&x)
	}
}

func TestE_nocarry_0543Cmp(t *testing.T) {
	var x, y e_nocarry_0543
...
func TestE_nocarry_0543IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0543
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0543

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0543{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0543
	one.SetOne()
	e.Sub(&qe_nocarry_0543, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0543{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0543{0, uint64(i)})
	}
...
func TestE_nocarry_0543NegZero(t *testing.T) {
	var a, b e_nocarry_0543
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0543Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0543, len(staticTestValues))
...
func TestE_nocarry_0543Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0543) bool {
			var b e_nocarry_0543
...
func TestE_nocarry_0543InverseExp(t *testing.T) {
...
func TestE_nocarry_0543MulByConstants(t *testing.T) {
...
func TestE_nocarry_0543Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0543) bool {
...
func TestE_nocarry_0543LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0543Halve(t *testing.T) {
...
func TestE_nocarry_0543FromMont(t *testing.T) {
...
type testPaire_nocarry_0543 struct {
	element e_nocarry_0543
	bigint  big.Int
}

func (z *e_nocarry_0543) biggerOrEqualModulus() bool {
	if z[8] > qe_nocarry_0543[8] {
		return true
	}
	if z[8] < qe_nocarry_0543[8] {
		return false
	...
	return z[0] >= qe_nocarry_0543[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0543

		g.element = e_nocarry_0543{
		...
		if qe_nocarry_0543[8] != ^uint64(0) {
			g.element[8] %= (qe_nocarry_0543[8] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0543 {
			var g e_nocarry_0543
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0543[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0543[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0543[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0543[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0543[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0543[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0543[6], carry)
		a[7], carry = bits.Add64(a[7], qe_nocarry_0543[7], carry)
		a[8], _ = bits.Add64(a[8], qe_nocarry_0543[8], carry)
...
func Benchmarke_nocarry_0543InverseNew(b *testing.B) {
	var x e_nocarry_0543
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0543
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0543
		var xInv e_nocarry_0543
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0543
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0543
...
func testLinearComb(t *testing.T, x *e_nocarry_0543, xC int64, y *e_nocarry_0543, yC int64) {
	...
	var z e_nocarry_0543
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0543, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0543
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0543, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0543
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0543, xHi uint64) {
	var res e_nocarry_0543
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0543) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0543) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0543, c int64, result *e_nocarry_0543, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0543) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0543) uint64 {
