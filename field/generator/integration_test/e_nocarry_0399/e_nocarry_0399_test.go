...
var benchRese_nocarry_0399 e_nocarry_0399

func BenchmarkE_nocarry_0399SetBytes(b *testing.B) {
	var x e_nocarry_0399
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0399MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0399.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0399)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0399)
		}
	})
}

func BenchmarkE_nocarry_0399Inverse(b *testing.B) {
	var x e_nocarry_0399
	x.SetRandom()
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0399Butterfly(b *testing.B) {
	var x e_nocarry_0399
	x.SetRandom()
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0399)
	}
}

func BenchmarkE_nocarry_0399Exp(b *testing.B) {
	var x e_nocarry_0399
	x.SetRandom()
	benchRese_nocarry_0399.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0399Double(b *testing.B) {
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Double(&benchRese_nocarry_0399)
	}
}

func BenchmarkE_nocarry_0399Add(b *testing.B) {
	var x e_nocarry_0399
	x.SetRandom()
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Add(&x, &benchRese_nocarry_0399)
	}
}

func BenchmarkE_nocarry_0399Sub(b *testing.B) {
	var x e_nocarry_0399
	x.SetRandom()
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Sub(&x, &benchRese_nocarry_0399)
	}
}

func BenchmarkE_nocarry_0399Neg(b *testing.B) {
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Neg(&benchRese_nocarry_0399)
	}
}

func BenchmarkE_nocarry_0399Div(b *testing.B) {
	var x e_nocarry_0399
	x.SetRandom()
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Div(&x, &benchRese_nocarry_0399)
	}
}

func BenchmarkE_nocarry_0399FromMont(b *testing.B) {
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.FromMont()
	}
}

func BenchmarkE_nocarry_0399ToMont(b *testing.B) {
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.ToMont()
	}
}
func BenchmarkE_nocarry_0399Square(b *testing.B) {
	benchRese_nocarry_0399.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Square(&benchRese_nocarry_0399)
	}
}

func BenchmarkE_nocarry_0399Sqrt(b *testing.B) {
	var a e_nocarry_0399
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0399Mul(b *testing.B) {
	x := e_nocarry_0399{
	...
	benchRese_nocarry_0399.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Mul(&benchRese_nocarry_0399, &x)
	}
}

func BenchmarkE_nocarry_0399Cmp(b *testing.B) {
	x := e_nocarry_0399{
		17850200429764506372,
		12368617674044551278,
		9911539004042386058,
	...
	benchRese_nocarry_0399 = x
	benchRese_nocarry_0399[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0399.Cmp(&x)
	}
}

func TestE_nocarry_0399Cmp(t *testing.T) {
	var x, y e_nocarry_0399
...
func TestE_nocarry_0399IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0399
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0399

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0399{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0399
	one.SetOne()
	e.Sub(&qe_nocarry_0399, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0399{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0399{0, uint64(i)})
	}
...
func TestE_nocarry_0399NegZero(t *testing.T) {
	var a, b e_nocarry_0399
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0399Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0399, len(staticTestValues))
...
func TestE_nocarry_0399Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0399) bool {
			var b e_nocarry_0399
...
func TestE_nocarry_0399InverseExp(t *testing.T) {
...
func TestE_nocarry_0399MulByConstants(t *testing.T) {
...
func TestE_nocarry_0399Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0399) bool {
...
func TestE_nocarry_0399LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0399Halve(t *testing.T) {
...
func TestE_nocarry_0399FromMont(t *testing.T) {
...
type testPaire_nocarry_0399 struct {
	element e_nocarry_0399
	bigint  big.Int
}

func (z *e_nocarry_0399) biggerOrEqualModulus() bool {
	if z[6] > qe_nocarry_0399[6] {
		return true
	}
	if z[6] < qe_nocarry_0399[6] {
		return false
	...
	return z[0] >= qe_nocarry_0399[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0399

		g.element = e_nocarry_0399{
		...
		if qe_nocarry_0399[6] != ^uint64(0) {
			g.element[6] %= (qe_nocarry_0399[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0399 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0399[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0399[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0399[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0399[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0399[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0399[5], carry)
		a[6], _ = bits.Add64(a[6], qe_nocarry_0399[6], carry)
...
func Benchmarke_nocarry_0399InverseNew(b *testing.B) {
	var x e_nocarry_0399
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0399
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0399
		var xInv e_nocarry_0399
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0399
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0399
...
func testLinearComb(t *testing.T, x *e_nocarry_0399, xC int64, y *e_nocarry_0399, yC int64) {
	...
	var z e_nocarry_0399
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0399, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0399
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0399, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0399
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0399, xHi uint64) {
	var res e_nocarry_0399
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0399) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0399) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0399, c int64, result *e_nocarry_0399, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0399) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0399) uint64 {
