...
var benchRese_nocarry_0453 e_nocarry_0453

func BenchmarkE_nocarry_0453SetBytes(b *testing.B) {
	var x e_nocarry_0453
	x.SetRandom()
	bb := x.Bytes()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.SetBytes(bb[:])
	}

}

func BenchmarkE_nocarry_0453MulByConstants(b *testing.B) {
	b.Run("mulBy3", func(b *testing.B) {
		benchRese_nocarry_0453.SetRandom()
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy3(&benchRese_nocarry_0453)
		}
	})
	...
	b.Run("mulBy13", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			MulBy13(&benchRese_nocarry_0453)
		}
	})
}

func BenchmarkE_nocarry_0453Inverse(b *testing.B) {
	var x e_nocarry_0453
	x.SetRandom()
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	...
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Inverse(&x)
	}

}

func BenchmarkE_nocarry_0453Butterfly(b *testing.B) {
	var x e_nocarry_0453
	x.SetRandom()
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Butterfly(&x, &benchRese_nocarry_0453)
	}
}

func BenchmarkE_nocarry_0453Exp(b *testing.B) {
	var x e_nocarry_0453
	x.SetRandom()
	benchRese_nocarry_0453.SetRandom()
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Exp(x, b1)
	}
}

func BenchmarkE_nocarry_0453Double(b *testing.B) {
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Double(&benchRese_nocarry_0453)
	}
}

func BenchmarkE_nocarry_0453Add(b *testing.B) {
	var x e_nocarry_0453
	x.SetRandom()
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Add(&x, &benchRese_nocarry_0453)
	}
}

func BenchmarkE_nocarry_0453Sub(b *testing.B) {
	var x e_nocarry_0453
	x.SetRandom()
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Sub(&x, &benchRese_nocarry_0453)
	}
}

func BenchmarkE_nocarry_0453Neg(b *testing.B) {
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Neg(&benchRese_nocarry_0453)
	}
}

func BenchmarkE_nocarry_0453Div(b *testing.B) {
	var x e_nocarry_0453
	x.SetRandom()
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Div(&x, &benchRese_nocarry_0453)
	}
}

func BenchmarkE_nocarry_0453FromMont(b *testing.B) {
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.FromMont()
	}
}

func BenchmarkE_nocarry_0453ToMont(b *testing.B) {
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.ToMont()
	}
}
func BenchmarkE_nocarry_0453Square(b *testing.B) {
	benchRese_nocarry_0453.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Square(&benchRese_nocarry_0453)
	}
}

func BenchmarkE_nocarry_0453Sqrt(b *testing.B) {
	var a e_nocarry_0453
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Sqrt(&a)
	}
}

func BenchmarkE_nocarry_0453Mul(b *testing.B) {
	x := e_nocarry_0453{
		4401622808275671730,
	...
	benchRese_nocarry_0453.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Mul(&benchRese_nocarry_0453, &x)
	}
}

func BenchmarkE_nocarry_0453Cmp(b *testing.B) {
	x := e_nocarry_0453{
		4401622808275671730,
		15235345347281083692,
		15079935997803665455,
	...
	benchRese_nocarry_0453 = x
	benchRese_nocarry_0453[0] = 0
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchRese_nocarry_0453.Cmp(&x)
	}
}

func TestE_nocarry_0453Cmp(t *testing.T) {
	var x, y e_nocarry_0453
...
func TestE_nocarry_0453IsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y e_nocarry_0453
		x.SetRandom()
		y.SetRandom()
...
var staticTestValues []e_nocarry_0453

func init() {
	staticTestValues = append(staticTestValues, e_nocarry_0453{}) // zero
	staticTestValues = append(staticTestValues, One())            // one
	staticTestValues = append(staticTestValues, rSquare)          // r^2
	var e, one e_nocarry_0453
	one.SetOne()
	e.Sub(&qe_nocarry_0453, &one)
	...
	for i := 0; i <= 3; i++ {
		staticTestValues = append(staticTestValues, e_nocarry_0453{uint64(i)})
		staticTestValues = append(staticTestValues, e_nocarry_0453{0, uint64(i)})
	}
...
func TestE_nocarry_0453NegZero(t *testing.T) {
	var a, b e_nocarry_0453
	b.SetZero()
	for a.IsZero() {
		a.SetRandom()
	}
...
func TestE_nocarry_0453Reduce(t *testing.T) {
	testValues := make([]e_nocarry_0453, len(staticTestValues))
...
func TestE_nocarry_0453Bytes(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
	...
	properties.Property("SetBytes(Bytes()) should stayt constant", prop.ForAll(
		func(a testPaire_nocarry_0453) bool {
			var b e_nocarry_0453
...
func TestE_nocarry_0453InverseExp(t *testing.T) {
...
func TestE_nocarry_0453MulByConstants(t *testing.T) {
...
func TestE_nocarry_0453Legendre(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Butterflies(t *testing.T) {
	...
	properties.Property("butterfly0 == a -b; a +b", prop.ForAll(
		func(a, b testPaire_nocarry_0453) bool {
...
func TestE_nocarry_0453LexicographicallyLargest(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Add(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Sub(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Mul(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Div(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Exp(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Square(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Inverse(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Sqrt(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Double(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Neg(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	if testing.Short() {
		parameters.MinSuccessfulTests = nbFuzzShort
	} else {
...
func TestE_nocarry_0453Halve(t *testing.T) {
...
func TestE_nocarry_0453FromMont(t *testing.T) {
...
type testPaire_nocarry_0453 struct {
	element e_nocarry_0453
	bigint  big.Int
}

func (z *e_nocarry_0453) biggerOrEqualModulus() bool {
	if z[7] > qe_nocarry_0453[7] {
		return true
	}
	if z[7] < qe_nocarry_0453[7] {
		return false
	...
	return z[0] >= qe_nocarry_0453[0]
}

func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		var g testPaire_nocarry_0453

		g.element = e_nocarry_0453{
		...
		if qe_nocarry_0453[7] != ^uint64(0) {
			g.element[7] %= (qe_nocarry_0453[7] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		genRandomFq := func() e_nocarry_0453 {
		...
		var carry uint64
		a[0], carry = bits.Add64(a[0], qe_nocarry_0453[0], carry)
		a[1], carry = bits.Add64(a[1], qe_nocarry_0453[1], carry)
		a[2], carry = bits.Add64(a[2], qe_nocarry_0453[2], carry)
		a[3], carry = bits.Add64(a[3], qe_nocarry_0453[3], carry)
		a[4], carry = bits.Add64(a[4], qe_nocarry_0453[4], carry)
		a[5], carry = bits.Add64(a[5], qe_nocarry_0453[5], carry)
		a[6], carry = bits.Add64(a[6], qe_nocarry_0453[6], carry)
		a[7], _ = bits.Add64(a[7], qe_nocarry_0453[7], carry)
...
func Benchmarke_nocarry_0453InverseNew(b *testing.B) {
	var x e_nocarry_0453
	x.SetRandom()
...
func TestP20InversionCorrectionFactor(t *testing.T) {
	...
	var oneInv e_nocarry_0453
	one.SetOne()
	oneInv.Inverse(&one)

	for i := 0; i < 100; i++ {
		var x e_nocarry_0453
		var xInv e_nocarry_0453
		x.SetRandom()
		xInv.Inverse(&x)
	...
	if !oneInv.Equal(&one) {
		...
		var fac e_nocarry_0453
		fac.setBigInt(&i) //back to montgomery

		var facTimesFac e_nocarry_0453
...
func testLinearComb(t *testing.T, x *e_nocarry_0453, xC int64, y *e_nocarry_0453, yC int64) {
	...
	var z e_nocarry_0453
	z.linearCombSosSigned(x, xC, y, yC)
	z.assertMatchVeryBigInt(t, 0, &p1)

}

func testBigNumWMulBr(t *testing.T, a *e_nocarry_0453, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0453
	aHi = aTimes.mulWRegularBr(a, c)

	assertMulProduct(t, a, c, &aTimes, aHi)
}

func testBigNumWMul(t *testing.T, a *e_nocarry_0453, c int64) {
	var aHi uint64
	var aTimes e_nocarry_0453
...
func testMontReduceSigned(t *testing.T, x *e_nocarry_0453, xHi uint64) {
	var res e_nocarry_0453
	var xInt big.Int
	var resInt big.Int
	x.toVeryBigIntSigned(&xInt, xHi)
...
func (z *e_nocarry_0453) toVeryBigIntUnsigned(i *big.Int, xHi uint64) {
	z.ToBigInt(i)
...
func (z *e_nocarry_0453) toVeryBigIntSigned(i *big.Int, xHi uint64) {
...
func assertMulProduct(t *testing.T, x *e_nocarry_0453, c int64, result *e_nocarry_0453, resultHi uint64) big.Int {
	var xInt big.Int
	x.ToBigInt(&xInt)
...
func (z *e_nocarry_0453) assertMatchVeryBigInt(t *testing.T, aHi uint64, aInt *big.Int) {
...
func approximateRef(x *e_nocarry_0453) uint64 {
