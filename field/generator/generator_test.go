...
func TestIntegration(t *testing.T) {
	...
	assert.NoError(GenerateCommonASM(2, asmDir, false, false))
	assert.NoError(GenerateCommonASM(3, asmDir, false, false))
	assert.NoError(GenerateCommonASM(7, asmDir, false, false))
	assert.NoError(GenerateCommonASM(8, asmDir, false, false))
