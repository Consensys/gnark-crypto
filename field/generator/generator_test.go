...
func TestIntegration(t *testing.T) {
	...
	assert.NoError(GenerateAMD64(2, 0, asmDir, false))
	assert.NoError(GenerateAMD64(3, 0, asmDir, false))
	assert.NoError(GenerateAMD64(7, 0, asmDir, false))
	assert.NoError(GenerateAMD64(8, 0, asmDir, false))

	assert.NoError(GenerateARM64(2, 0, asmDir, false))
	assert.NoError(GenerateARM64(8, 0, asmDir, false))
