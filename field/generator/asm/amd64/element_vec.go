...
func (f *FFAmd64) generateMulVec() {
	...
	const argSize = 5 * 8
	stackSize := f.StackSize(f.NbWords*3+5, 0, 0)
	...
	f.MOVQ(PX, r)
	f.VMOVDQU64("256+0*64("+r+")", "Z16")
	f.VMOVDQU64("256+1*64("+r+")", "Z17")
	f.VMOVDQU64("256+2*64("+r+")", "Z18")
	f.VMOVDQU64("256+3*64("+r+")", "Z19")
