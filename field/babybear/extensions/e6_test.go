...
func TestE6Ops(t *testing.T) {
	...
	properties.Property("[babybear] BatchInvertE6 should output the same result as Inverse", prop.ForAll(
		func(a, b, c E6) bool {
	...
	properties.Property("[babybear] Double and add twice should output the same result", prop.ForAll(
		func(a E6) bool {
			var b E6
			b.Add(&a, &a)
			a.Double(&a)
