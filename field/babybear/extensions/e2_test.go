...
func TestE2ReceiverIsOperand(t *testing.T) {
	...
	properties.Property("[babybear] Having the receiver as operand (mul by quadratic non-residue) should output the same result", prop.ForAll(
		func(a E2) bool {
			var b E2
	...
	properties.Property("[babybear] Having the receiver as operand (mul by cubic non-residue) should output the same result", prop.ForAll(
		func(a E2) bool {
			var b E2
