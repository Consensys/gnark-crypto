...
func (z *E6D) mulNaive(a, b *E6D) *E6D {
	...
	// degree 10
	d[10].Mul(&a.A5, &b.A5)
	// Reduce using w^6 = 2w^3 + 10.
	var t2, t10 fr.Element
	for k := 10; k >= 6; k-- {
		t2.Double(&d[k])
		d[k-3].Add(&d[k-3], &t2)
		t10.Add(&t2, &t2)
...
func (z *E6D) reconstruct(v *[17]fr.Element) *E6D {
	...
	t[0].Add(&v[13], &v[13]) // 2v14
	t[1].Add(&t[0], &v[13])  // 3v14

	t[2].Add(&v[15], &v[15]) // 2v16
	t[3].Add(&t[2], &v[15])  // 3v16
	t[4].Add(&t[3], &t[3])   // 6v16

	t[5].Add(&v[16], &v[16]) // 2v17
	...
	t[12].Add(&v[4], &v[4]) // 2v5
	z.A4.Sub(&z.A4, &t[12])

	t[13].Add(&v[6], &v[6])
	t[13].Add(&t[13], &v[6]) // 3v7
	z.A4.Sub(&z.A4, &t[13])
	...
	t[13].Add(&v[12], &v[12])
	t[13].Add(&t[13], &v[12]) // 3v13
	z.A4.Add(&z.A4, &t[13])

	z.A4.Add(&z.A4, &t[0])  // +2v14
	z.A4.Sub(&z.A4, &v[14]) // -v15
	...
	t[12].Add(&v[5], &v[5]) // 2v6
	z.A3.Add(&z.A3, &t[12])

	t[12].Add(&v[6], &v[6])   // 2v7
	t[13].Add(&t[12], &t[12]) // 4v7
	t[13].Add(&t[13], &v[6])  // 5v7
	z.A3.Add(&z.A3, &t[13])

	t[12].Add(&v[7], &v[7])   // 2v8
	t[13].Add(&t[12], &t[12]) // 4v8
	t[13].Add(&t[13], &v[7])  // 5v8
	z.A3.Sub(&z.A3, &t[13])

	t[12].Add(&v[9], &v[9])
	t[12].Add(&t[12], &v[9]) // 3v10
	z.A3.Sub(&z.A3, &t[12])

	t[12].Add(&v[10], &v[10]) // 2v11
	t[13].Add(&t[12], &t[12]) // 4v11
	t[13].Add(&t[13], &v[10]) // 5v11
	z.A3.Sub(&z.A3, &t[13])

	t[12].Add(&v[11], &v[11]) // 2v12
	z.A3.Sub(&z.A3, &t[12])

	t[12].Add(&v[12], &v[12]) // 2v13
	t[13].Add(&t[12], &t[12]) // 4v13
	t[12].Add(&t[12], &t[13]) // 6v13
	t[12].Add(&t[12], &v[12]) // 7v13
	z.A3.Add(&z.A3, &t[12])
	...
	t[12].Add(&v[14], &v[14])
	t[12].Add(&t[12], &v[14]) // 3v15
	z.A3.Add(&z.A3, &t[12])

	t[12].Add(&t[2], &t[2])   // 4v16
	t[12].Add(&t[12], &t[12]) // 8v16
	t[12].Sub(&t[12], &v[15]) // 7v16
	z.A3.Sub(&z.A3, &t[12])
	...
	t[12].Add(&t[12], &v[13]) // 19v14
	z.A1.Add(&z.A1, &t[12])

	// -11v15
	t[12].Add(&v[14], &v[14]) // 2
	t[13].Add(&t[12], &t[12]) // 4
	t[13].Add(&t[13], &t[13]) // 8
	t[13].Add(&t[13], &t[12]) // 10
	t[13].Add(&t[13], &v[14]) // 11
	z.A1.Sub(&z.A1, &t[13])
