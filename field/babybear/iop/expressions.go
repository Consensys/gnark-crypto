...
type Expression func(i int, x ...babybear.Element) babybear.Element
...
func Evaluate(f Expression, r []babybear.Element, form Form, x ...*Polynomial) (*Polynomial, error) {
	if len(x) == 0 {
