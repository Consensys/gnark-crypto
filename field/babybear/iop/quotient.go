...
func DivideByXMinusOne(a *Polynomial, domains [2]*fft.Domain) (*Polynomial, error) {
	...
	coeffs := make([]babybear.Element, a.coefficients.Len())
...
func evaluateXnMinusOneDomainBigCoset(domains [2]*fft.Domain) []babybear.Element {

	ratio := domains[1].Cardinality / domains[0].Cardinality

	res := make([]babybear.Element, ratio)
