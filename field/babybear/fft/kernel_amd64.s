...
TEXT ·SISToRefactor(SB), $2112-120
	...
	MOVQ         k256+0(FP), DX
	MOVQ         k512+24(FP), CX
	MOVQ         cosets+48(FP), R14
	MOVQ         DX, BX
	MOVQ         CX, SI
	MOVQ         R14, R8
	ADDQ         $0x0000000000000200, BX
	ADDQ         $0x0000000000000400, R8
	ADDQ         $0x0000000000000400, SI
	MOVQ         DI, R15
	ADDQ         $0x0000000000000400, R15

#define FROMMONTGOMERY(in0) \
	VPMULUDQ in0, Z18, Z20 \
	VPANDQ   Z19, Z20, Z20 \
	VPMULUDQ Z20, Z16, Z20 \
	VPADDQ   in0, Z20, in0 \
	VPSRLQ   $32, in0, in0 \
	VPSUBQ   Z16, in0, Z20 \
	VPMINUQ  in0, Z20, in0 \
...
#define LIMBSPLIT(in0) \
	...
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 192(DI)
	VMOVDQA32 Z21, 192(R15)
	VPMOVZXDQ 128(DX), Z0
	VPMOVZXDQ 128(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 256(DI)
	VMOVDQA32 Z21, 256(R15)
	VPMOVZXDQ 160(DX), Z0
	VPMOVZXDQ 160(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 320(DI)
	VMOVDQA32 Z21, 320(R15)
	VPMOVZXDQ 192(DX), Z0
	VPMOVZXDQ 192(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 384(DI)
	VMOVDQA32 Z21, 384(R15)
	VPMOVZXDQ 224(DX), Z0
	VPMOVZXDQ 224(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 448(DI)
	VMOVDQA32 Z21, 448(R15)
	VPMOVZXDQ 256(DX), Z0
	VPMOVZXDQ 256(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 512(DI)
	VMOVDQA32 Z21, 512(R15)
	VPMOVZXDQ 288(DX), Z0
	VPMOVZXDQ 288(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 576(DI)
	VMOVDQA32 Z21, 576(R15)
	VPMOVZXDQ 320(DX), Z0
	VPMOVZXDQ 320(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 640(DI)
	VMOVDQA32 Z21, 640(R15)
	VPMOVZXDQ 352(DX), Z0
	VPMOVZXDQ 352(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 704(DI)
	VMOVDQA32 Z21, 704(R15)
	VPMOVZXDQ 384(DX), Z0
	VPMOVZXDQ 384(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 768(DI)
	VMOVDQA32 Z21, 768(R15)
	VPMOVZXDQ 416(DX), Z0
	VPMOVZXDQ 416(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 832(DI)
	VMOVDQA32 Z21, 832(R15)
	VPMOVZXDQ 448(DX), Z0
	VPMOVZXDQ 448(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 896(DI)
	VMOVDQA32 Z21, 896(R15)
	VPMOVZXDQ 480(DX), Z0
	VPMOVZXDQ 480(BX), Z21
	FROMMONTGOMERY(Z0)
	LIMBSPLIT(Z0)
	FROMMONTGOMERY(Z21)
	LIMBSPLIT(Z21)
	VMOVDQA32 Z0, 960(DI)
	VMOVDQA32 Z21, 960(R15)
	VMOVDQA32 0(DI), Z0
	VMOVDQU32 Z0, 0(CX)
	VMOVDQA32 64(DI), Z0
	VMOVDQU32 Z0, 64(CX)
	...
	VMOVDQU32 Z0, 1024(CX)
	VMOVDQA32 1088(DI), Z0
	VMOVDQU32 Z0, 1088(CX)
	VMOVDQA32 1152(DI), Z0
	VMOVDQU32 Z0, 1152(CX)
	VMOVDQA32 1216(DI), Z0
	VMOVDQU32 Z0, 1216(CX)
	VMOVDQA32 1280(DI), Z0
	VMOVDQU32 Z0, 1280(CX)
	VMOVDQA32 1344(DI), Z0
	VMOVDQU32 Z0, 1344(CX)
	VMOVDQA32 1408(DI), Z0
	VMOVDQU32 Z0, 1408(CX)
	VMOVDQA32 1472(DI), Z0
	VMOVDQU32 Z0, 1472(CX)
	VMOVDQA32 1536(DI), Z0
	VMOVDQU32 Z0, 1536(CX)
	VMOVDQA32 1600(DI), Z0
	VMOVDQU32 Z0, 1600(CX)
	VMOVDQA32 1664(DI), Z0
	VMOVDQU32 Z0, 1664(CX)
	VMOVDQA32 1728(DI), Z0
	VMOVDQU32 Z0, 1728(CX)
	VMOVDQA32 1792(DI), Z0
	VMOVDQU32 Z0, 1792(CX)
	VMOVDQA32 1856(DI), Z0
	VMOVDQU32 Z0, 1856(CX)
	VMOVDQA32 1920(DI), Z0
	VMOVDQU32 Z0, 1920(CX)
	VMOVDQA32 1984(DI), Z0
	VMOVDQU32 Z0, 1984(CX)
	RET
