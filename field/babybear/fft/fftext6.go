...
func difFFTExt6(a []fext.E6, w babybear.Element, twiddles [][]babybear.Element, twiddlesStartStage, stage, maxSplits int, chDone chan struct{}, nbTasks int) {
	if chDone != nil {
		defer close(chDone)
	}
...
func ditFFTExt6(a []fext.E6, w babybear.Element, twiddles [][]babybear.Element, twiddlesStartStage, stage, maxSplits int, chDone chan struct{}, nbTasks int) {
	if chDone != nil {
		defer close(chDone)
	}
	n := len(a)
...
func kerDIFNP_512Ext6(a []fext.E6, twiddles [][]babybear.Element, stage int) {
...
func kerDITNP_512Ext6(a []fext.E6, twiddles [][]babybear.Element, stage int) {
	// code unrolled & generated by internal/generator/field/template/fft/fftext6.go.tmpl
