...
func kerDIFNP_128generic(a []babybear.Element, twiddles [][]babybear.Element, stage int) {
...
func kerDITNP_128generic(a []babybear.Element, twiddles [][]babybear.Element, stage int) {
	// code unrolled & generated by internal/generator/fft/template/fft.go.tmpl
