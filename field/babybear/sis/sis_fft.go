...
func fft64(a []babybear.Element, twiddlesCoset []babybear.Element) {
	...
	babybear.Butterfly(&a[0], &a[32])
	babybear.Butterfly(&a[1], &a[33])
	babybear.Butterfly(&a[2], &a[34])
	babybear.Butterfly(&a[3], &a[35])
	babybear.Butterfly(&a[4], &a[36])
	babybear.Butterfly(&a[5], &a[37])
	babybear.Butterfly(&a[6], &a[38])
	babybear.Butterfly(&a[7], &a[39])
	babybear.Butterfly(&a[8], &a[40])
	babybear.Butterfly(&a[9], &a[41])
	babybear.Butterfly(&a[10], &a[42])
	babybear.Butterfly(&a[11], &a[43])
	babybear.Butterfly(&a[12], &a[44])
	babybear.Butterfly(&a[13], &a[45])
	babybear.Butterfly(&a[14], &a[46])
	babybear.Butterfly(&a[15], &a[47])
	babybear.Butterfly(&a[16], &a[48])
	babybear.Butterfly(&a[17], &a[49])
	babybear.Butterfly(&a[18], &a[50])
	babybear.Butterfly(&a[19], &a[51])
	babybear.Butterfly(&a[20], &a[52])
	babybear.Butterfly(&a[21], &a[53])
	babybear.Butterfly(&a[22], &a[54])
	babybear.Butterfly(&a[23], &a[55])
	babybear.Butterfly(&a[24], &a[56])
	babybear.Butterfly(&a[25], &a[57])
	babybear.Butterfly(&a[26], &a[58])
	babybear.Butterfly(&a[27], &a[59])
	babybear.Butterfly(&a[28], &a[60])
	babybear.Butterfly(&a[29], &a[61])
	babybear.Butterfly(&a[30], &a[62])
	babybear.Butterfly(&a[31], &a[63])
	...
	babybear.Butterfly(&a[0], &a[16])
	babybear.Butterfly(&a[1], &a[17])
	babybear.Butterfly(&a[2], &a[18])
	babybear.Butterfly(&a[3], &a[19])
	babybear.Butterfly(&a[4], &a[20])
	babybear.Butterfly(&a[5], &a[21])
	babybear.Butterfly(&a[6], &a[22])
	babybear.Butterfly(&a[7], &a[23])
	babybear.Butterfly(&a[8], &a[24])
	babybear.Butterfly(&a[9], &a[25])
	babybear.Butterfly(&a[10], &a[26])
	babybear.Butterfly(&a[11], &a[27])
	babybear.Butterfly(&a[12], &a[28])
	babybear.Butterfly(&a[13], &a[29])
	babybear.Butterfly(&a[14], &a[30])
	babybear.Butterfly(&a[15], &a[31])
	babybear.Butterfly(&a[32], &a[48])
	babybear.Butterfly(&a[33], &a[49])
	babybear.Butterfly(&a[34], &a[50])
	babybear.Butterfly(&a[35], &a[51])
	babybear.Butterfly(&a[36], &a[52])
	babybear.Butterfly(&a[37], &a[53])
	babybear.Butterfly(&a[38], &a[54])
	babybear.Butterfly(&a[39], &a[55])
	babybear.Butterfly(&a[40], &a[56])
	babybear.Butterfly(&a[41], &a[57])
	babybear.Butterfly(&a[42], &a[58])
	babybear.Butterfly(&a[43], &a[59])
	babybear.Butterfly(&a[44], &a[60])
	babybear.Butterfly(&a[45], &a[61])
	babybear.Butterfly(&a[46], &a[62])
	babybear.Butterfly(&a[47], &a[63])
	...
	babybear.Butterfly(&a[0], &a[8])
	babybear.Butterfly(&a[1], &a[9])
	babybear.Butterfly(&a[2], &a[10])
	babybear.Butterfly(&a[3], &a[11])
	babybear.Butterfly(&a[4], &a[12])
	babybear.Butterfly(&a[5], &a[13])
	babybear.Butterfly(&a[6], &a[14])
	babybear.Butterfly(&a[7], &a[15])
	babybear.Butterfly(&a[16], &a[24])
	babybear.Butterfly(&a[17], &a[25])
	babybear.Butterfly(&a[18], &a[26])
	babybear.Butterfly(&a[19], &a[27])
	babybear.Butterfly(&a[20], &a[28])
	babybear.Butterfly(&a[21], &a[29])
	babybear.Butterfly(&a[22], &a[30])
	babybear.Butterfly(&a[23], &a[31])
	babybear.Butterfly(&a[32], &a[40])
	babybear.Butterfly(&a[33], &a[41])
	babybear.Butterfly(&a[34], &a[42])
	babybear.Butterfly(&a[35], &a[43])
	babybear.Butterfly(&a[36], &a[44])
	babybear.Butterfly(&a[37], &a[45])
	babybear.Butterfly(&a[38], &a[46])
	babybear.Butterfly(&a[39], &a[47])
	babybear.Butterfly(&a[48], &a[56])
	babybear.Butterfly(&a[49], &a[57])
	babybear.Butterfly(&a[50], &a[58])
	babybear.Butterfly(&a[51], &a[59])
	babybear.Butterfly(&a[52], &a[60])
	babybear.Butterfly(&a[53], &a[61])
	babybear.Butterfly(&a[54], &a[62])
	babybear.Butterfly(&a[55], &a[63])
	...
	babybear.Butterfly(&a[0], &a[4])
	babybear.Butterfly(&a[1], &a[5])
	babybear.Butterfly(&a[2], &a[6])
	babybear.Butterfly(&a[3], &a[7])
	babybear.Butterfly(&a[8], &a[12])
	babybear.Butterfly(&a[9], &a[13])
	babybear.Butterfly(&a[10], &a[14])
	babybear.Butterfly(&a[11], &a[15])
	babybear.Butterfly(&a[16], &a[20])
	babybear.Butterfly(&a[17], &a[21])
	babybear.Butterfly(&a[18], &a[22])
	babybear.Butterfly(&a[19], &a[23])
	babybear.Butterfly(&a[24], &a[28])
	babybear.Butterfly(&a[25], &a[29])
	babybear.Butterfly(&a[26], &a[30])
	babybear.Butterfly(&a[27], &a[31])
	babybear.Butterfly(&a[32], &a[36])
	babybear.Butterfly(&a[33], &a[37])
	babybear.Butterfly(&a[34], &a[38])
	babybear.Butterfly(&a[35], &a[39])
	babybear.Butterfly(&a[40], &a[44])
	babybear.Butterfly(&a[41], &a[45])
	babybear.Butterfly(&a[42], &a[46])
	babybear.Butterfly(&a[43], &a[47])
	babybear.Butterfly(&a[48], &a[52])
	babybear.Butterfly(&a[49], &a[53])
	babybear.Butterfly(&a[50], &a[54])
	babybear.Butterfly(&a[51], &a[55])
	babybear.Butterfly(&a[56], &a[60])
	babybear.Butterfly(&a[57], &a[61])
	babybear.Butterfly(&a[58], &a[62])
	babybear.Butterfly(&a[59], &a[63])
	...
	babybear.Butterfly(&a[0], &a[2])
	babybear.Butterfly(&a[1], &a[3])
	babybear.Butterfly(&a[4], &a[6])
	babybear.Butterfly(&a[5], &a[7])
	babybear.Butterfly(&a[8], &a[10])
	babybear.Butterfly(&a[9], &a[11])
	babybear.Butterfly(&a[12], &a[14])
	babybear.Butterfly(&a[13], &a[15])
	babybear.Butterfly(&a[16], &a[18])
	babybear.Butterfly(&a[17], &a[19])
	babybear.Butterfly(&a[20], &a[22])
	babybear.Butterfly(&a[21], &a[23])
	babybear.Butterfly(&a[24], &a[26])
	babybear.Butterfly(&a[25], &a[27])
	babybear.Butterfly(&a[28], &a[30])
	babybear.Butterfly(&a[29], &a[31])
	babybear.Butterfly(&a[32], &a[34])
	babybear.Butterfly(&a[33], &a[35])
	babybear.Butterfly(&a[36], &a[38])
	babybear.Butterfly(&a[37], &a[39])
	babybear.Butterfly(&a[40], &a[42])
	babybear.Butterfly(&a[41], &a[43])
	babybear.Butterfly(&a[44], &a[46])
	babybear.Butterfly(&a[45], &a[47])
	babybear.Butterfly(&a[48], &a[50])
	babybear.Butterfly(&a[49], &a[51])
	babybear.Butterfly(&a[52], &a[54])
	babybear.Butterfly(&a[53], &a[55])
	babybear.Butterfly(&a[56], &a[58])
	babybear.Butterfly(&a[57], &a[59])
	babybear.Butterfly(&a[60], &a[62])
	babybear.Butterfly(&a[61], &a[63])
	...
	babybear.Butterfly(&a[0], &a[1])
	babybear.Butterfly(&a[2], &a[3])
	babybear.Butterfly(&a[4], &a[5])
	babybear.Butterfly(&a[6], &a[7])
	babybear.Butterfly(&a[8], &a[9])
	babybear.Butterfly(&a[10], &a[11])
	babybear.Butterfly(&a[12], &a[13])
	babybear.Butterfly(&a[14], &a[15])
	babybear.Butterfly(&a[16], &a[17])
	babybear.Butterfly(&a[18], &a[19])
	babybear.Butterfly(&a[20], &a[21])
	babybear.Butterfly(&a[22], &a[23])
	babybear.Butterfly(&a[24], &a[25])
	babybear.Butterfly(&a[26], &a[27])
	babybear.Butterfly(&a[28], &a[29])
	babybear.Butterfly(&a[30], &a[31])
	babybear.Butterfly(&a[32], &a[33])
	babybear.Butterfly(&a[34], &a[35])
	babybear.Butterfly(&a[36], &a[37])
	babybear.Butterfly(&a[38], &a[39])
	babybear.Butterfly(&a[40], &a[41])
	babybear.Butterfly(&a[42], &a[43])
	babybear.Butterfly(&a[44], &a[45])
	babybear.Butterfly(&a[46], &a[47])
	babybear.Butterfly(&a[48], &a[49])
	babybear.Butterfly(&a[50], &a[51])
	babybear.Butterfly(&a[52], &a[53])
	babybear.Butterfly(&a[54], &a[55])
	babybear.Butterfly(&a[56], &a[57])
	babybear.Butterfly(&a[58], &a[59])
	babybear.Butterfly(&a[60], &a[61])
	babybear.Butterfly(&a[62], &a[63])
}
...
func precomputeTwiddlesCoset(generator, shifter babybear.Element) []babybear.Element {
	toReturn := make([]babybear.Element, 63)
	var r, s babybear.Element
	e := new(big.Int)
