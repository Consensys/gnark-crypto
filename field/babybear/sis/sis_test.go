...
func TestLimbDecomposition(t *testing.T) {
	...
	testcases := []babybear.Vector{
		{babybear.One()},
		{babybear.NewElement(2)},
		{babybear.NewElement(1 << 32), babybear.NewElement(2), babybear.NewElement(1)},
	}
	...
	for _, testcase := range testcases {
		...
		dummyBuffer := make(babybear.Vector, 192)
		...
		b := babybear.NewElement(1 << sis.LogTwoBound)
		numLimbsPerField := babybear.Bytes * 8 / sis.LogTwoBound
...
func TestDecomposition(t *testing.T) {
	...
	m := make(babybear.Vector, babybear.Bytes*8/logTwoBound)
