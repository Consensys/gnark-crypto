...
func TestLimbDecomposition(t *testing.T) {
	...
	testcases := []koalabear.Vector{
		{koalabear.One()},
		{koalabear.NewElement(2)},
		{koalabear.NewElement(1 << 32), koalabear.NewElement(2), koalabear.NewElement(1)},
	}
	...
	for _, testcase := range testcases {
		...
		dummyBuffer := make(koalabear.Vector, 192)
		...
		b := koalabear.NewElement(1 << sis.LogTwoBound)
		numLimbsPerField := koalabear.Bytes * 8 / sis.LogTwoBound
...
func TestDecomposition(t *testing.T) {
	...
	m := make(koalabear.Vector, koalabear.Bytes*8/logTwoBound)
