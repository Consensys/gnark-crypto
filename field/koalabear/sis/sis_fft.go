...
func fft64(a []koalabear.Element, twiddlesCoset []koalabear.Element) {
	...
	koalabear.Butterfly(&a[0], &a[32])
	koalabear.Butterfly(&a[1], &a[33])
	koalabear.Butterfly(&a[2], &a[34])
	koalabear.Butterfly(&a[3], &a[35])
	koalabear.Butterfly(&a[4], &a[36])
	koalabear.Butterfly(&a[5], &a[37])
	koalabear.Butterfly(&a[6], &a[38])
	koalabear.Butterfly(&a[7], &a[39])
	koalabear.Butterfly(&a[8], &a[40])
	koalabear.Butterfly(&a[9], &a[41])
	koalabear.Butterfly(&a[10], &a[42])
	koalabear.Butterfly(&a[11], &a[43])
	koalabear.Butterfly(&a[12], &a[44])
	koalabear.Butterfly(&a[13], &a[45])
	koalabear.Butterfly(&a[14], &a[46])
	koalabear.Butterfly(&a[15], &a[47])
	koalabear.Butterfly(&a[16], &a[48])
	koalabear.Butterfly(&a[17], &a[49])
	koalabear.Butterfly(&a[18], &a[50])
	koalabear.Butterfly(&a[19], &a[51])
	koalabear.Butterfly(&a[20], &a[52])
	koalabear.Butterfly(&a[21], &a[53])
	koalabear.Butterfly(&a[22], &a[54])
	koalabear.Butterfly(&a[23], &a[55])
	koalabear.Butterfly(&a[24], &a[56])
	koalabear.Butterfly(&a[25], &a[57])
	koalabear.Butterfly(&a[26], &a[58])
	koalabear.Butterfly(&a[27], &a[59])
	koalabear.Butterfly(&a[28], &a[60])
	koalabear.Butterfly(&a[29], &a[61])
	koalabear.Butterfly(&a[30], &a[62])
	koalabear.Butterfly(&a[31], &a[63])
	...
	koalabear.Butterfly(&a[0], &a[16])
	koalabear.Butterfly(&a[1], &a[17])
	koalabear.Butterfly(&a[2], &a[18])
	koalabear.Butterfly(&a[3], &a[19])
	koalabear.Butterfly(&a[4], &a[20])
	koalabear.Butterfly(&a[5], &a[21])
	koalabear.Butterfly(&a[6], &a[22])
	koalabear.Butterfly(&a[7], &a[23])
	koalabear.Butterfly(&a[8], &a[24])
	koalabear.Butterfly(&a[9], &a[25])
	koalabear.Butterfly(&a[10], &a[26])
	koalabear.Butterfly(&a[11], &a[27])
	koalabear.Butterfly(&a[12], &a[28])
	koalabear.Butterfly(&a[13], &a[29])
	koalabear.Butterfly(&a[14], &a[30])
	koalabear.Butterfly(&a[15], &a[31])
	koalabear.Butterfly(&a[32], &a[48])
	koalabear.Butterfly(&a[33], &a[49])
	koalabear.Butterfly(&a[34], &a[50])
	koalabear.Butterfly(&a[35], &a[51])
	koalabear.Butterfly(&a[36], &a[52])
	koalabear.Butterfly(&a[37], &a[53])
	koalabear.Butterfly(&a[38], &a[54])
	koalabear.Butterfly(&a[39], &a[55])
	koalabear.Butterfly(&a[40], &a[56])
	koalabear.Butterfly(&a[41], &a[57])
	koalabear.Butterfly(&a[42], &a[58])
	koalabear.Butterfly(&a[43], &a[59])
	koalabear.Butterfly(&a[44], &a[60])
	koalabear.Butterfly(&a[45], &a[61])
	koalabear.Butterfly(&a[46], &a[62])
	koalabear.Butterfly(&a[47], &a[63])
	...
	koalabear.Butterfly(&a[0], &a[8])
	koalabear.Butterfly(&a[1], &a[9])
	koalabear.Butterfly(&a[2], &a[10])
	koalabear.Butterfly(&a[3], &a[11])
	koalabear.Butterfly(&a[4], &a[12])
	koalabear.Butterfly(&a[5], &a[13])
	koalabear.Butterfly(&a[6], &a[14])
	koalabear.Butterfly(&a[7], &a[15])
	koalabear.Butterfly(&a[16], &a[24])
	koalabear.Butterfly(&a[17], &a[25])
	koalabear.Butterfly(&a[18], &a[26])
	koalabear.Butterfly(&a[19], &a[27])
	koalabear.Butterfly(&a[20], &a[28])
	koalabear.Butterfly(&a[21], &a[29])
	koalabear.Butterfly(&a[22], &a[30])
	koalabear.Butterfly(&a[23], &a[31])
	koalabear.Butterfly(&a[32], &a[40])
	koalabear.Butterfly(&a[33], &a[41])
	koalabear.Butterfly(&a[34], &a[42])
	koalabear.Butterfly(&a[35], &a[43])
	koalabear.Butterfly(&a[36], &a[44])
	koalabear.Butterfly(&a[37], &a[45])
	koalabear.Butterfly(&a[38], &a[46])
	koalabear.Butterfly(&a[39], &a[47])
	koalabear.Butterfly(&a[48], &a[56])
	koalabear.Butterfly(&a[49], &a[57])
	koalabear.Butterfly(&a[50], &a[58])
	koalabear.Butterfly(&a[51], &a[59])
	koalabear.Butterfly(&a[52], &a[60])
	koalabear.Butterfly(&a[53], &a[61])
	koalabear.Butterfly(&a[54], &a[62])
	koalabear.Butterfly(&a[55], &a[63])
	...
	koalabear.Butterfly(&a[0], &a[4])
	koalabear.Butterfly(&a[1], &a[5])
	koalabear.Butterfly(&a[2], &a[6])
	koalabear.Butterfly(&a[3], &a[7])
	koalabear.Butterfly(&a[8], &a[12])
	koalabear.Butterfly(&a[9], &a[13])
	koalabear.Butterfly(&a[10], &a[14])
	koalabear.Butterfly(&a[11], &a[15])
	koalabear.Butterfly(&a[16], &a[20])
	koalabear.Butterfly(&a[17], &a[21])
	koalabear.Butterfly(&a[18], &a[22])
	koalabear.Butterfly(&a[19], &a[23])
	koalabear.Butterfly(&a[24], &a[28])
	koalabear.Butterfly(&a[25], &a[29])
	koalabear.Butterfly(&a[26], &a[30])
	koalabear.Butterfly(&a[27], &a[31])
	koalabear.Butterfly(&a[32], &a[36])
	koalabear.Butterfly(&a[33], &a[37])
	koalabear.Butterfly(&a[34], &a[38])
	koalabear.Butterfly(&a[35], &a[39])
	koalabear.Butterfly(&a[40], &a[44])
	koalabear.Butterfly(&a[41], &a[45])
	koalabear.Butterfly(&a[42], &a[46])
	koalabear.Butterfly(&a[43], &a[47])
	koalabear.Butterfly(&a[48], &a[52])
	koalabear.Butterfly(&a[49], &a[53])
	koalabear.Butterfly(&a[50], &a[54])
	koalabear.Butterfly(&a[51], &a[55])
	koalabear.Butterfly(&a[56], &a[60])
	koalabear.Butterfly(&a[57], &a[61])
	koalabear.Butterfly(&a[58], &a[62])
	koalabear.Butterfly(&a[59], &a[63])
	...
	koalabear.Butterfly(&a[0], &a[2])
	koalabear.Butterfly(&a[1], &a[3])
	koalabear.Butterfly(&a[4], &a[6])
	koalabear.Butterfly(&a[5], &a[7])
	koalabear.Butterfly(&a[8], &a[10])
	koalabear.Butterfly(&a[9], &a[11])
	koalabear.Butterfly(&a[12], &a[14])
	koalabear.Butterfly(&a[13], &a[15])
	koalabear.Butterfly(&a[16], &a[18])
	koalabear.Butterfly(&a[17], &a[19])
	koalabear.Butterfly(&a[20], &a[22])
	koalabear.Butterfly(&a[21], &a[23])
	koalabear.Butterfly(&a[24], &a[26])
	koalabear.Butterfly(&a[25], &a[27])
	koalabear.Butterfly(&a[28], &a[30])
	koalabear.Butterfly(&a[29], &a[31])
	koalabear.Butterfly(&a[32], &a[34])
	koalabear.Butterfly(&a[33], &a[35])
	koalabear.Butterfly(&a[36], &a[38])
	koalabear.Butterfly(&a[37], &a[39])
	koalabear.Butterfly(&a[40], &a[42])
	koalabear.Butterfly(&a[41], &a[43])
	koalabear.Butterfly(&a[44], &a[46])
	koalabear.Butterfly(&a[45], &a[47])
	koalabear.Butterfly(&a[48], &a[50])
	koalabear.Butterfly(&a[49], &a[51])
	koalabear.Butterfly(&a[52], &a[54])
	koalabear.Butterfly(&a[53], &a[55])
	koalabear.Butterfly(&a[56], &a[58])
	koalabear.Butterfly(&a[57], &a[59])
	koalabear.Butterfly(&a[60], &a[62])
	koalabear.Butterfly(&a[61], &a[63])
	...
	koalabear.Butterfly(&a[0], &a[1])
	koalabear.Butterfly(&a[2], &a[3])
	koalabear.Butterfly(&a[4], &a[5])
	koalabear.Butterfly(&a[6], &a[7])
	koalabear.Butterfly(&a[8], &a[9])
	koalabear.Butterfly(&a[10], &a[11])
	koalabear.Butterfly(&a[12], &a[13])
	koalabear.Butterfly(&a[14], &a[15])
	koalabear.Butterfly(&a[16], &a[17])
	koalabear.Butterfly(&a[18], &a[19])
	koalabear.Butterfly(&a[20], &a[21])
	koalabear.Butterfly(&a[22], &a[23])
	koalabear.Butterfly(&a[24], &a[25])
	koalabear.Butterfly(&a[26], &a[27])
	koalabear.Butterfly(&a[28], &a[29])
	koalabear.Butterfly(&a[30], &a[31])
	koalabear.Butterfly(&a[32], &a[33])
	koalabear.Butterfly(&a[34], &a[35])
	koalabear.Butterfly(&a[36], &a[37])
	koalabear.Butterfly(&a[38], &a[39])
	koalabear.Butterfly(&a[40], &a[41])
	koalabear.Butterfly(&a[42], &a[43])
	koalabear.Butterfly(&a[44], &a[45])
	koalabear.Butterfly(&a[46], &a[47])
	koalabear.Butterfly(&a[48], &a[49])
	koalabear.Butterfly(&a[50], &a[51])
	koalabear.Butterfly(&a[52], &a[53])
	koalabear.Butterfly(&a[54], &a[55])
	koalabear.Butterfly(&a[56], &a[57])
	koalabear.Butterfly(&a[58], &a[59])
	koalabear.Butterfly(&a[60], &a[61])
	koalabear.Butterfly(&a[62], &a[63])
}
...
func precomputeTwiddlesCoset(generator, shifter koalabear.Element) []koalabear.Element {
	toReturn := make([]koalabear.Element, 63)
