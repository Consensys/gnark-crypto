...
func TestE6Exp(t *testing.T) {
	...
	properties.Property("[koalabear] Exp(x, -k) should equal Exp(x⁻¹, k)", prop.ForAll(
		func(a E6) bool {
	...
	properties.Property("[koalabear] Exp(x, k) for k > int64 should split as Exp(x, k_hi)*Exp(x, k_lo)", prop.ForAll(
		func(a E6) bool {
