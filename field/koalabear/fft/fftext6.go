...
func innerDITWithTwiddlesExt6M2(a []fext.E6, twiddles []koalabear.Element) {
	...
	koalabear.Butterfly(&a[0].B0.A0, &a[2].B0.A0)
	koalabear.Butterfly(&a[0].B0.A1, &a[2].B0.A1)
	koalabear.Butterfly(&a[0].B1.A0, &a[2].B1.A0)
	koalabear.Butterfly(&a[0].B1.A1, &a[2].B1.A1)
	koalabear.Butterfly(&a[0].B2.A0, &a[2].B2.A0)
	koalabear.Butterfly(&a[0].B2.A1, &a[2].B2.A1)
	...
	koalabear.Butterfly(&a[1].B0.A0, &a[3].B0.A0)
	koalabear.Butterfly(&a[1].B0.A1, &a[3].B0.A1)
	koalabear.Butterfly(&a[1].B1.A0, &a[3].B1.A0)
	koalabear.Butterfly(&a[1].B1.A1, &a[3].B1.A1)
	koalabear.Butterfly(&a[1].B2.A0, &a[3].B2.A0)
	koalabear.Butterfly(&a[1].B2.A1, &a[3].B2.A1)

}

func innerDITWithTwiddlesExt6M4(a []fext.E6, twiddles []koalabear.Element) {
	for i := 1; i < 4; i++ {
		t := &twiddles[i]
		y := &a[i+4]
	...
	for i := 0; i < 4; i++ {
		...
		koalabear.Butterfly(&x.B0.A0, &y.B0.A0)
		koalabear.Butterfly(&x.B0.A1, &y.B0.A1)
		koalabear.Butterfly(&x.B1.A0, &y.B1.A0)
		koalabear.Butterfly(&x.B1.A1, &y.B1.A1)
		koalabear.Butterfly(&x.B2.A0, &y.B2.A0)
		koalabear.Butterfly(&x.B2.A1, &y.B2.A1)
...
func innerDIFWithTwiddlesExt6M2(a []fext.E6, twiddles []koalabear.Element) {
...
func innerDIFWithTwiddlesExt6M4(a []fext.E6, twiddles []koalabear.Element) {
	for i := 0; i < 4; i++ {
		x, y := &a[i], &a[i+4]
...
func kerDIFNP_1024Ext6(a []fext.E6, twiddles [][]koalabear.Element, stage int) {
	// code unrolled & generated by internal/generator/field/template/fft/fftext6.go.tmpl
...
func kerDITNP_1024Ext6(a []fext.E6, twiddles [][]koalabear.Element, stage int) {
	// code unrolled & generated by internal/generator/field/template/fft/fftext6.go.tmpl
