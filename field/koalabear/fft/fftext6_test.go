...
func randElementExt6(rng *rand.Rand) fext.E6 {
	...
	v.B2.A0 = koalabear.Element{rng.Uint32N(2130706433)}
	v.B2.A1 = koalabear.Element{rng.Uint32N(2130706433)}
	return v
}
...
func evaluatePolynomialExt6(pol []fext.E6, val koalabear.Element) fext.E6 {
	var res, tmp fext.E6
