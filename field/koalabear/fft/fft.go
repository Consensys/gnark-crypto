...
func kerDIFNP_128generic(a []koalabear.Element, twiddles [][]koalabear.Element, stage int) {
...
func kerDITNP_128generic(a []koalabear.Element, twiddles [][]koalabear.Element, stage int) {
	// code unrolled & generated by internal/generator/fft/template/fft.go.tmpl
