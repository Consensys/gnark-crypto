...
// Partially derived from Dag Arne Osvik's work in github.com/a16z/vectorized-fields
...
accumulate_11:
	...
	// lo(hi(w2)) -> R15
	// lo(hi(w3)) -> R14
#define SPLIT_LO_HI_0(in0, in1) \
	MOVQ in1, in0         \
	ANDQ $0xffffffff, in0 \
	SHLQ $32, in0         \
	SHRQ $32, in1         \

	SPLIT_LO_HI_0(R13, SI)
	SPLIT_LO_HI_0(CX, R8)
	SPLIT_LO_HI_0(R15, R10)
	SPLIT_LO_HI_0(R14, R12)
...
#define MAC_1(in0, in1, in2) \
	...
	MAC_1(0*4(R14), Z16, Z24)
	MAC_1(1*4(R14), Z17, Z25)
	MAC_1(2*4(R14), Z18, Z26)
	MAC_1(3*4(R14), Z19, Z27)
	MAC_1(4*4(R14), Z20, Z28)
	MAC_1(5*4(R14), Z21, Z29)
	MAC_1(6*4(R14), Z22, Z30)
	MAC_1(7*4(R14), Z23, Z31)
	ADDQ $32, R14
	DECQ CX       // decrement n
	JMP  loop_13
...
#define ADDPP_2(in0, in1, in2, in3, in4) \
	VPSRLQ    $32, Z16, Z2              \
	VALIGND.Z $2, Z16, Z16, K1, Z16     \
	VPADDQ    Z2, Z16, Z16              \
	VPSRLQ    $32, in0, in0             \
	...
	ADDPP_2(Z24, Z17, Z25, Z18, 2)
	ADDPP_2(Z25, Z18, Z26, Z19, 3)
	ADDPP_2(Z26, Z19, Z27, Z20, 4)
	ADDPP_2(Z27, Z20, Z28, Z21, 5)
	ADDPP_2(Z28, Z21, Z29, Z22, 6)
	ADDPP_2(Z29, Z22, Z30, Z23, 7)
	VPSRLQ    $32, Z16, Z2
	VALIGND.Z $2, Z16, Z16, K1, Z16
	VPADDQ    Z2, Z16, Z16
	VPSRLQ    $32, Z30, Z30
...
#define MUL_XI_13() \
	MUL_WORD_TORENAME_11()  \
	DIV_SHIFT_TORENAME_12() \
