...
#define INNER_MUL_1(in0, in1, in2, in3) \
	MULXQ in0, R13, R14 \
	ADDQ  R13, R9       \
	ADCQ  R14, R10      \
	MULXQ in1, R13, R14 \
...
#define INNER_MUL_2() \
	MULXQ ·qElement+0(SB), R13, R14  \
	ADDQ  R13, R10                   \
	ADCQ  R14, R11                   \
	MULXQ ·qElement+16(SB), R13, R14 \
	ADCQ  R13, R12                   \
	ADCQ  R14, R8                    \
	ADCQ  $0, R9                     \
	MULXQ ·qElement+8(SB), R13, R14  \
	ADDQ  R13, R11                   \
	ADCQ  R14, R12                   \
	MULXQ ·qElement+24(SB), R13, R14 \
	ADCQ  R13, R8                    \
	ADCQ  R14, R9                    \
	ADCQ  $0, R10                    \

#define INNER_MUL_3(in0, in1, in2, in3) \
	MULXQ in0, R13, R14 \
	ADDQ  R13, R11      \
	ADCQ  R14, R12      \
	MULXQ in1, R13, R14 \
...
#define INNER_MUL_4(in0, in1, in2, in3) \
	MULXQ in0, R13, R14 \
	ADDQ  R13, R12      \
	ADCQ  R14, R8       \
	MULXQ in1, R13, R14 \
