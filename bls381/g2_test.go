...
func TestG2Serialization(t *testing.T) {
	...
	properties.Property("[BLS381] Affine SetBytes(Bytes(compressed = false)) should stay the same", prop.ForAll(
		func(a, b *e2) bool {
	...
	properties.Property("[BLS381] Affine SetBytes(Bytes(compressed = true)) should stay the same", prop.ForAll(
