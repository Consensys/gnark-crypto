...
func TestE12Serialization(t *testing.T) {
	...
	properties.Property("[BLS381] SetBytes(Bytes()) should stay constant", prop.ForAll(
		func(a *E12) bool {
			var b E12
			buf := a.Bytes()
...
func TestE12Ops(t *testing.T) {
	...
	properties.Property("[BLS381] pi**12=id", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.Frobenius(a).
				Frobenius(&b).
	...
	properties.Property("[BLS381] (pi**2)**6=id", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.FrobeniusSquare(a).
				FrobeniusSquare(&b).
	...
	properties.Property("[BLS381] (pi**3)**4=id", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.FrobeniusCube(a).
				FrobeniusCube(&b).
	...
	properties.Property("[BLS381] cyclotomic square and square should be the same in the cyclotomic subgroup", prop.ForAll(
		func(a *E12) bool {
			var b, c, d E12
			b.FrobeniusCube(a).
				FrobeniusCube(&b)
