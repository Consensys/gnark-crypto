...
func TestG1AffineOps(t *testing.T) {
	...
	properties.Property("[BLS381] [Jacobian Extended] addMixed (-G) should equal subMixed(G)", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG1Affine(&g1Gen, a)
	...
	properties.Property("[BLS381] [Jacobian Extended] doubleMixed (-G) should equal doubleNegMixed(G)", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG1Affine(&g1Gen, a)
			var p1, p1Neg G1Affine
			p1.FromJacobian(&fop1)
