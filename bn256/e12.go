...
func (z *E12) MulByVW(x *E12, y *E2) *E12 {
	...
	{ // begin: inline yNR.MulByNonResidue(y)
		...
		{ // begin inline: set the *E2 variable &(yNR).A0 to the E2-product of the *E2 variable &buf.A1 and (9,1)
			(&(yNR).A0).Neg(&buf.A1)
		} // end inline: set the *E2 variable &(yNR).A0 to the E2-product of the *E2 variable &buf.A1 and (9,1)
