...
func (p *G2Affine) Bytes(buf []byte, compressed bool) error {
	...
	if compressed {
		...
		binary.BigEndian.PutUint64(buf[96:104], p.Y.A1[3])

		binary.BigEndian.PutUint64(buf[88:96], p.Y.A0[0])
		binary.BigEndian.PutUint64(buf[80:88], p.Y.A0[1])
		binary.BigEndian.PutUint64(buf[72:80], p.Y.A0[2])
		binary.BigEndian.PutUint64(buf[64:72], p.Y.A0[3])
	...
	binary.BigEndian.PutUint64(buf[32:40], p.X.A1[3])

	binary.BigEndian.PutUint64(buf[24:32], p.X.A0[0])
	binary.BigEndian.PutUint64(buf[16:24], p.X.A0[1])
	binary.BigEndian.PutUint64(buf[8:16], p.X.A0[2])
	binary.BigEndian.PutUint64(buf[0:8], p.X.A0[3]|mswMask)
...
func (p *G2Affine) SetBytes(buf []byte) error {
	...
	p.X.A1[3] = binary.BigEndian.Uint64(buf[32:40])

	p.X.A0[0] = binary.BigEndian.Uint64(buf[24:32])
	p.X.A0[1] = binary.BigEndian.Uint64(buf[16:24])
	...
	if mData == mUncompressed {
		...
		p.Y.A1[3] = binary.BigEndian.Uint64(buf[96:104])

		p.Y.A0[0] = binary.BigEndian.Uint64(buf[88:96])
		p.Y.A0[1] = binary.BigEndian.Uint64(buf[80:88])
		p.Y.A0[2] = binary.BigEndian.Uint64(buf[72:80])
		p.Y.A0[3] = binary.BigEndian.Uint64(buf[64:72])
