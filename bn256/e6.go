...
func (z *E6) Mul(x, y *E6) *E6 {
	...
	rb0.Mul(&b3, &b4).
		SubAssign(&b1).
		SubAssign(&b2)
	{ // begin inline: set rb0 to (&rb0) * (9,1)
		var buf, buf9 E2
		buf.Set(&rb0)
		buf9.Double(&buf).
			Double(&buf9).
...
func (z *E6) Square(x *E6) *E6 {
	...
	// step 9
	{ // begin inline: set z.B0 to (&b4) * (9,1)
		var buf, buf9 E2
		buf.Set(&b4)
		buf9.Double(&buf).
			Double(&buf9).
...
func (z *E6) Inverse(x *E6) *E6 {
	...
	} // end inline: set c[0] to (&t[5]) * (9,1)
	c[0].Neg(&c[0]).AddAssign(&t[0])
	// step 8
	{ // begin inline: set c[1] to (&t[2]) * (9,1)
		var buf, buf9 E2
		buf.Set(&t[2])
		buf9.Double(&buf).
			Double(&buf9).
	...
	buf.Mul(&x.B1, &c[2])
	t[6].AddAssign(&buf)
	{ // begin inline: set t[6] to (&t[6]) * (9,1)
		var buf, buf9 E2
		buf.Set(&t[6])
		buf9.Double(&buf).
			Double(&buf9).
