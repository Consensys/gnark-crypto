...
// Modulus q =
//
//	q[base10] = 424804331891979973455971894938199991839487883914575852667663156896715214921
...
const (
	...
	Bits  = 248 // number of bits needed to represent a Element
	Bytes = 32  // number of bytes needed to represent a Element
)

// Field modulus q
const (
	q0 = 12468201750796144713
	q1 = 17012099061605194625
	q2 = 4680913926326678671
	q3 = 67675234495113892
)
...
const qInvNeg = 15380680873399721479

func init() {
	_modulus.SetString("f06e44682c2aa440f5f26a5ae1748fec171df66abbdb81ad07f36ed81b9049", 16)
}
...
func (z *Element) SetOne() *Element {
	z[0] = 2850033346006135408
	z[1] = 2841817744484517432
	z[2] = 18063497198812014357
	z[3] = 39080291038572922
	return z
}
...
func (z *Element) IsOne() bool {
	return ((z[3] ^ 39080291038572922) | (z[2] ^ 18063497198812014357) | (z[1] ^ 2841817744484517432) | (z[0] ^ 2850033346006135408)) == 0
}
...
func (z *Element) LexicographicallyLargest() bool {
	...
	var b uint64
	_, b = bits.Sub64(_z[0], 15457472912252848165, 0)
	_, b = bits.Sub64(_z[1], 17729421567657373120, b)
	_, b = bits.Sub64(_z[2], 2340456963163339335, b)
	_, b = bits.Sub64(_z[3], 33837617247556946, b)
...
var rSquare = Element{
	12503850779977665488,
	4231521375444390721,
	12923916254582618147,
	4786565839245165,
}
...
const (
	inversionCorrectionFactorWord0 = 8013490130535197113
	inversionCorrectionFactorWord1 = 341597987825497263
	inversionCorrectionFactorWord2 = 12045570510022576392
	inversionCorrectionFactorWord3 = 38390577882398742
	invIterationsN                 = 16
)
