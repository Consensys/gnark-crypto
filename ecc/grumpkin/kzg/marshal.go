...
func (pk *ProvingKey) WriteRawTo(w io.Writer) (int64, error) {
	return pk.writeTo(w, grumpkin.RawEncoding())
}

func (pk *ProvingKey) writeTo(w io.Writer, options ...func(*grumpkin.Encoder)) (int64, error) {
	// encode the ProvingKey
	enc := grumpkin.NewEncoder(w, options...)
...
func (vk *VerifyingKey) WriteRawTo(w io.Writer) (int64, error) {
	return vk.writeTo(w, grumpkin.RawEncoding())
}
...
func (vk *VerifyingKey) writeTo(w io.Writer, options ...func(*grumpkin.Encoder)) (int64, error) {
...
func (srs *SRS) WriteDump(w io.Writer, maxPkPoints ...int) error {
	...
	if _, err := srs.Vk.writeTo(w, grumpkin.RawEncoding()); err != nil {
		return err
	}
...
func (srs *SRS) ReadDump(r io.Reader, maxPkPoints ...int) error {
	...
	// read the slice
	srs.Pk.G1, _, err = unsafe.ReadSlice[[]grumpkin.G1Affine](r, maxPkPoints...)
	return err
}
...
func (pk *ProvingKey) UnsafeReadFrom(r io.Reader) (int64, error) {
	// decode the ProvingKey
	dec := grumpkin.NewDecoder(r, grumpkin.NoSubgroupChecks())
	if err := dec.Decode(&pk.G1); err != nil {
		return dec.BytesRead(), err
	}
	return dec.BytesRead(), nil
