...
func TestPairing(t *testing.T) {
	...
	properties.Property("[GRUMPKIN] Having the receiver as operand (final expo) should output the same result", prop.ForAll(
		func(a GT) bool {
	...
	properties.Property("[GRUMPKIN] Exponentiating FinalExpo(a) to r should output 1", prop.ForAll(
		func(a GT) bool {
			b := FinalExponentiation(&a)
	...
	properties.Property("[GRUMPKIN] Exp, CyclotomicExp and ExpGLV results must be the same in GT (small and big exponents)", prop.ForAll(
	...
	properties.Property("[GRUMPKIN] Expt(Expt) and Exp(t^2) should output the same result in the cyclotomic subgroup", prop.ForAll(
		func(a GT) bool {
			var b, c, d GT
			b.Conjugate(&a)
			a.Inverse(&a)
	...
	properties.Property("[GRUMPKIN] bilinearity", prop.ForAll(
	...
	properties.Property("[GRUMPKIN] PairingCheck", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[GRUMPKIN] Pair should output the same result with MillerLoop or MillerLoopFixedQ", prop.ForAll(
		func(a, b fr.Element) bool {
...
func TestMillerLoop(t *testing.T) {
	...
	properties.Property("[GRUMPKIN] MillerLoop of pairs should be equal to the product of MillerLoops", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[GRUMPKIN] MillerLoop and MillerLoopFixedQ should skip pairs with a point at infinity", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[GRUMPKIN] compressed pairing", prop.ForAll(
		func(a, b fr.Element) bool {
