...
func recoverP(v uint, r *big.Int) (*secp256r1.G1Affine, error) {
	...
	x.Add(x, kn)
	// y^2 = x^3+ax+b
	a, b := secp256r1.CurveCoefficients()
...
// SignForRecover performs the ECDSA signature according to [SEC 1] Section 4.1.3 and returns public key recovery information.
//
