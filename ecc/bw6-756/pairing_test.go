...
func TestPairing(t *testing.T) {
	...
	properties.Property("[BW6-756] Exp, CyclotomicExp and ExpGLV results must be the same in GT (small and big exponents)", prop.ForAll(
	...
	properties.Property("[BW6-756] Pair should output the same result with MillerLoop or MillerLoopFixedQ", prop.ForAll(
		func(a, b fr.Element) bool {
...
func TestMillerLoop(t *testing.T) {
	...
	properties.Property("[BW6-756] MillerLoop and MillerLoopFixedQ should skip pairs with a point at infinity", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[BW6-756] compressed pairing", prop.ForAll(
		func(a, b fr.Element) bool {
