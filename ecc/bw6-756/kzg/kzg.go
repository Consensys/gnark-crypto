...
type VerifyingKey struct {
	Lines [2][2][190]bw6756.LineEvaluationAff // precomputed pairing lines corresponding to G₂, [α]G₂
}
...
func NewSRS(size uint64, bAlpha *big.Int) (*SRS, error) {
	...
	var srs SRS
	srs.Pk.G1 = make([]bw6756.G1Affine, size)
...
func Verify(commitment *Digest, proof *OpeningProof, point fr.Element, vk VerifyingKey) error {
	...
	check, err := bw6756.PairingCheckFixedQ(
		...
		[][2][190]bw6756.LineEvaluationAff{vk.Lines[0], vk.Lines[1]},
	)
	if err != nil {
		return err
	}
