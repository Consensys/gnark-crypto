...
func randomPolynomial(size int) bw6633_pol.Polynomial {
	f := make(bw6633_pol.Polynomial, size)
	for i := 0; i < size; i++ {
		f[i].SetRandom()
	}
	return f
...
func TestDividePolyByXminusA(t *testing.T) {
	...
	pol := make(bw6633_pol.Polynomial, sizePol)
	for i := 0; i < sizePol; i++ {
		pol[i].SetRandom()
	}
...
func TestCommit(t *testing.T) {
	...
	// create a polynomial
	f := make(bw6633_pol.Polynomial, 60)
	for i := 0; i < 60; i++ {
		f[i].SetRandom()
	}
	...
	kzgCommit.Set(_kzgCommit.(*bw6633.G1Affine))
