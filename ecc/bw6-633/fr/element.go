...
// Field modulus q
const (
	q0 = 8063698428123676673
	q1 = 4764498181658371330
	q2 = 16051339359738796768
	q3 = 15273757526516850351
	q4 = 342900304943437392
)
...
const qInvNeg = 8083954730842193919
...
func (z *Element) Legendre() int {
	...
	for !a.IsZero() {
		...
		a[4] = (a[4] >> nbIterations) | (aHi << (2*k - nbIterations))
		...
		b[4] = (b[4] >> nbIterations) | (bHi << (2*k - nbIterations))
	}

	if b[0] == 1 && (b[1]|b[2]|b[3]|b[4]) == 0 {
		return l // (0|1) = 1
	} else {
