...
func NewDomain(m uint64, opts ...DomainOption) *Domain {
	...
	// twiddle factors
	domain.hasPrecomputedTwiddles = opt.hasPrecomputedTwiddles
...
func (d *Domain) WriteTo(w io.Writer) (int64, error) {
	...
	toEncode := []interface{}{d.Cardinality, &d.CardinalityInv, &d.Generator, &d.GeneratorInv, &d.FrMultiplicativeGen, &d.FrMultiplicativeGenInv, &d.hasPrecomputedTwiddles}
...
func (d *Domain) ReadFrom(r io.Reader) (int64, error) {
	...
	toDecode := []interface{}{&d.Cardinality, &d.CardinalityInv, &d.Generator, &d.GeneratorInv, &d.FrMultiplicativeGen, &d.FrMultiplicativeGenInv, &d.hasPrecomputedTwiddles}
