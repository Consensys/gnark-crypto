...
func TestElementFixedExp(t *testing.T) {
	...
	const sqrtExponentElement = "f06e44682c2aa440f5f26a5ae1748fec171df66abbdb81ad07f36ed81b904"
	...
	_bCbrtExponentElement, _ = new(big.Int).SetString("2f7e13d55e0ebe7849ddb6318e827b3e7005eb24e2bcbdf5ee9b8ad55ac73", 16)

	properties.Property("ExpByCbrts1o3 must match Exp", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
			c.ExpByCbrts1o3(c)
