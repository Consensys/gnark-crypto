...
const mu uint64 = 1170711311240

// AVX-512 IFMA constants for radix-52 Montgomery multiplication
// qInvNeg52 = qInvNeg & ((1<<52)-1) - low 52 bits of qInvNeg
const qInvNeg52 uint64 = 888145929477639

// muBarrett52 = floor(2^58 / (q >> 208)) for Barrett reduction
// Used to reduce from [0, 32q) to [0, q) in radix-52 Montgomery multiplication
const muBarrett52 uint64 = 279119

// q in radix-52 form (5 limbs), used by IFMA Montgomery multiplication
const qRadix52_0 uint64 = 2237982234611785
const qRadix52_1 uint64 = 4335012459059920
const qRadix52_2 uint64 = 3062640514176797
const qRadix52_3 uint64 = 750159245813413
const qRadix52_4 uint64 = 1032642127916
