...
// Evaluate evaluates p at x, throwing an error if the polynomial
// is not in canonical basis.
func (p *Polynomial) Evaluate(x fr.Element) (fr.Element, error) {

	var r fr.Element
	if p.Basis != Canonical {
		return r, ErrMustBeCanonical
	}
...
func (wp *WrappedPolynomial) Evaluate(x fr.Element) (fr.Element, error) {
