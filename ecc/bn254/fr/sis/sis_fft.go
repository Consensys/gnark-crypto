...
// Option 1; we put the FFT unrolled in SIS.
// Option 2; we keep the FFT in fft, but have more optimized kernels.
// with option 2 we likely add N multiplications unless we mutate the cosets
// or expose the kernels to supply the twiddleCosets as arguments.
