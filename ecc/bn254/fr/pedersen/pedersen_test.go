...
func TestMarshal(t *testing.T) {
	...
	t.Run("ProvingKey (raw) -> Bytes -> ProvingKey must remain identical.", utils.SerializationRoundTripRaw(&pk))
	t.Run("VerifyingKey -> Bytes -> VerifyingKey must remain identical.", utils.SerializationRoundTrip(&vk))
	t.Run("VerifyingKey (raw) -> Bytes -> ProvingKey must remain identical.", utils.SerializationRoundTripRaw(&vk))
}
