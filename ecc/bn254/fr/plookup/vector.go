...
func computeQuotientCanonical(alpha fr.Element, lh, lh0, lhn, lh1h2 []fr.Element, domainBig *fft.Domain) []fr.Element {
	...
	domainBig.FFTInverse(res, fft.DIT, fft.WithCoset())
...
func ProveLookupVector(srs *kzg.SRS, f, t fr.Vector) (ProofLookupVector, error) {
	...
	copy(_lt, ct)
	copy(_lf, cf)
	domainBig.FFT(_lz, fft.DIF, fft.WithCoset())
	domainBig.FFT(_lh1, fft.DIF, fft.WithCoset())
	domainBig.FFT(_lh2, fft.DIF, fft.WithCoset())
	domainBig.FFT(_lt, fft.DIF, fft.WithCoset())
	domainBig.FFT(_lf, fft.DIF, fft.WithCoset())
