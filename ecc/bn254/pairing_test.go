...
func TestPairing(t *testing.T) {
	...
	properties.Property("[BN254] Bilinearity: e(P,Q)^ab == e([a]P,Q)^b == e(P,[b]Q)^a", prop.ForAll(
	...
	properties.Property("[BN254] Non-degenerancy: e(P,Q) != 1", prop.ForAll(
		func() bool {
	...
	properties.Property("[BN254] PairingCheck: e(P,Q) * e(-P,Q) == 1", prop.ForAll(
		func(a, b fr.Element) bool {
...
func TestFixedPairing(t *testing.T) {
	...
	properties.Property("[BN254] doubleAndAddStep: optimized (Eisenträger-Lauter-Montgomery) matches reference implementation", prop.ForAll(
	...
	properties.Property("[BN254] PrecomputeLines and precomputeLinesRef should produce the same pairing result", prop.ForAll(
		func(a, b fr.Element) bool {
			var ag1 G1Affine
			var bg2 G2Affine
	...
	properties.Property("[BN254] manyDoubleSteps should match repeated doubleStep calls", prop.ForAll(
