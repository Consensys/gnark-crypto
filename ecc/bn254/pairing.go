...
func MillerLoop(P []G1Affine, Q []G2Affine) (GT, error) {
	...
	if n >= 2 {
		// k = 1
		qProj[1].doubleStep(&l)
		// line evaluation
		l.r0.MulByElement(&l.r0, &p[1].Y)
		l.r1.MulByElement(&l.r1, &p[1].X)
		result.Mul034by034(&l.r0, &l.r1, &l.r2, &result.C0.B0, &result.C1.B0, &result.C1.B1)
	}
