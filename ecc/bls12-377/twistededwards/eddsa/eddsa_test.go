...
func Example() {
	...
	hFunc := hash.MIMC_BLS12_377.New("seed")

	// create a eddsa key pair
	privateKey, _ := signature.EDDSA_BLS12_377.New(crand.Reader)
...
func TestSerialization(t *testing.T) {
	...
	privKey1, err := signature.EDDSA_BLS12_377.New(r)
	if err != nil {
		t.Fatal(err)
	}
	pubKey1 := privKey1.Public()

	privKey2, err := signature.EDDSA_BLS12_377.New(r)
	if err != nil {
		t.Fatal(err)
	}
...
func TestEddsaMIMC(t *testing.T) {
	...
	privKey, err := signature.EDDSA_BLS12_377.New(r)
	if err != nil {
		t.Fatal(nil)
	}
