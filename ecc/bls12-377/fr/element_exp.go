...
// ExpByCbrtHelperQMinus7Div9 is equivalent to z.Exp(x, 2130b436676bd0998f796ca7c0630002668461c500000001d902aaaaaaaaaaa).
...
func (z *Element) ExpByCbrtHelperQMinus7Div9(x Element) *Element {
	...
	//	i136      = ((i108 << 9 + _1010011) << 3 + _111) << 14
	//	i164      = ((_1100011 + i136) << 19 + _10011) << 6 + _1101
	//	i188      = (i164 << 10 + _100011) << 11 + _1101111 + _10
	//	i232      = ((i188 << 2 + 1) << 37 + _111011) << 3
	//	i256      = ((1 + i232) << 13 + _1010101) << 8 + _1010101
	//	i282      = ((i256 << 8 + _1010101) << 8 + _1010101) << 8
	//	return      2*((_1010101 + i282) << 6 + _10101)
	//
	// Operations: 243 squares 48 multiplies
	...
	// Step 187: t3 = x^0x84c2d0d99daf42663de5b29f018c00099a1186f
	t3.Mul(t3, t4)
	...
	// Step 290: z = x^0x10985a1b33b5e84cc7bcb653e0318001334230e280000000ec8155555555555
	z.Mul(z, t0)

	// Step 291: z = x^0x2130b436676bd0998f796ca7c0630002668461c500000001d902aaaaaaaaaaa
	z.Square(z)
