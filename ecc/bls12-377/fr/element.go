...
func (z *Element) montReduceSigned(x *Element, xHi uint64) {
	...
	if neg {
		...
		if b != 0 {
			...
			b = 0
			z[0], b = bits.Add64(z[0], 725501752471715841, b)
			z[1], b = bits.Add64(z[1], 6461107452199829505, b)
			z[2], b = bits.Add64(z[2], 6968279316240510977, b)
			z[3], _ = bits.Add64(neg1, 1345280370688173398, b)
		}
	}
}
