...
// Sarkar sqrt parameters for BLS12-377 Fr (p-1 = 2^47 * m).
const (
	sarkarN = 47
	sarkarK = 7
)

var sarkarL = [sarkarK]uint64{6, 6, 6, 7, 7, 7, 7}

// g = z^m where z is a quadratic non-residue in Fr (g has order 2^sarkarN).
var sarkarG = Element{
	4340692304772210610,
