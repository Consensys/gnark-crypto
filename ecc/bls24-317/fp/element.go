...
// field modulus q =
//
// 136393071104295911515099765908274057061945112121419593977210139303905973197232025618026156731051
...
// q (modulus)
const qElementWord0 uint64 = 10182971180934965931
const qElementWord1 uint64 = 15488787195747417982
const qElementWord2 uint64 = 1628721857945875526
const qElementWord3 uint64 = 17478405972920225849
const qElementWord4 uint64 = 1177913551803681068
...
const qInvNegLsw uint64 = 6176088765535387645
...
func init() {
	_modulus.SetString("136393071104295911515099765908274057061945112121419593977210139303905973197232025618026156731051", 10)
}
...
func (z *Element) SetRandom() (*Element, error) {
	...
	z[4] %= 1177913551803681068

	// if z > q → z -= q
	// note: this is NOT constant time
	if !(z[4] < 1177913551803681068 || (z[4] == 1177913551803681068 && (z[3] < 17478405972920225849 || (z[3] == 17478405972920225849 && (z[2] < 1628721857945875526 || (z[2] == 1628721857945875526 && (z[1] < 15488787195747417982 || (z[1] == 15488787195747417982 && (z[0] < 10182971180934965931))))))))) {
		var b uint64
		z[0], b = bits.Sub64(z[0], 10182971180934965931, 0)
		z[1], b = bits.Sub64(z[1], 15488787195747417982, b)
		z[2], b = bits.Sub64(z[2], 1628721857945875526, b)
		z[3], b = bits.Sub64(z[3], 17478405972920225849, b)
		z[4], _ = bits.Sub64(z[4], 1177913551803681068, b)
	}
...
func (z *Element) Halve() {
	if z[0]&1 == 1 {
		...
		// z = z + q
		var carry uint64
		z[0], carry = bits.Add64(z[0], 10182971180934965931, 0)
		z[1], carry = bits.Add64(z[1], 15488787195747417982, carry)
		z[2], carry = bits.Add64(z[2], 1628721857945875526, carry)
		z[3], carry = bits.Add64(z[3], 17478405972920225849, carry)
		z[4], _ = bits.Add64(z[4], 1177913551803681068, carry)
...
func _mulGeneric(z, x, y *Element) {
	...
	var c [3]uint64
	{
		...
		m := c[0] * 6176088765535387645
		c[2] = madd0(m, 10182971180934965931, c[0])
		c[1], c[0] = madd1(v, y[1], c[1])
		c[2], t[0] = madd2(m, 15488787195747417982, c[2], c[0])
		c[1], c[0] = madd1(v, y[2], c[1])
		c[2], t[1] = madd2(m, 1628721857945875526, c[2], c[0])
		c[1], c[0] = madd1(v, y[3], c[1])
		c[2], t[2] = madd2(m, 17478405972920225849, c[2], c[0])
		c[1], c[0] = madd1(v, y[4], c[1])
		t[4], t[3] = madd3(m, 1177913551803681068, c[0], c[2], c[1])
	}
	{
		// round 1
		v := x[1]
	...
	}
	{
		...
		c[2] = madd0(m, 10182971180934965931, c[0])
		c[1], c[0] = madd2(v, y[1], c[1], t[1])
		c[2], z[0] = madd2(m, 15488787195747417982, c[2], c[0])
		c[1], c[0] = madd2(v, y[2], c[1], t[2])
		c[2], z[1] = madd2(m, 1628721857945875526, c[2], c[0])
		c[1], c[0] = madd2(v, y[3], c[1], t[3])
		c[2], z[2] = madd2(m, 17478405972920225849, c[2], c[0])
		c[1], c[0] = madd2(v, y[4], c[1], t[4])
		z[4], z[3] = madd3(m, 1177913551803681068, c[0], c[2], c[1])
	}
...
func _mulWGeneric(z, x *Element, y uint64) {
	...
	var t [5]uint64
	{
		...
		m := c0 * 6176088765535387645
		c2 := madd0(m, 10182971180934965931, c0)
		c1, c0 = madd1(y, x[1], c1)
		c2, t[0] = madd2(m, 15488787195747417982, c2, c0)
		c1, c0 = madd1(y, x[2], c1)
		c2, t[1] = madd2(m, 1628721857945875526, c2, c0)
		c1, c0 = madd1(y, x[3], c1)
		c2, t[2] = madd2(m, 17478405972920225849, c2, c0)
		c1, c0 = madd1(y, x[4], c1)
		t[4], t[3] = madd3(m, 1177913551803681068, c0, c2, c1)
	}
	{
		// round 1
		m := t[0] * 6176088765535387645
		c2 := madd0(m, 10182971180934965931, t[0])
		c2, t[0] = madd2(m, 15488787195747417982, c2, t[1])
		c2, t[1] = madd2(m, 1628721857945875526, c2, t[2])
		c2, t[2] = madd2(m, 17478405972920225849, c2, t[3])
		t[4], t[3] = madd2(m, 1177913551803681068, t[4], c2)
	}
	{
		// round 2
		m := t[0] * 6176088765535387645
	...
	}
	{
		...
		m := t[0] * 6176088765535387645
		c2 := madd0(m, 10182971180934965931, t[0])
		c2, z[0] = madd2(m, 15488787195747417982, c2, t[1])
		c2, z[1] = madd2(m, 1628721857945875526, c2, t[2])
		c2, z[2] = madd2(m, 17478405972920225849, c2, t[3])
		z[4], z[3] = madd2(m, 1177913551803681068, t[4], c2)
	}
...
func _fromMontGeneric(z *Element) {
	...
	{
		// m = z[0]n'[0] mod W
		m := z[0] * 6176088765535387645
		C := madd0(m, 10182971180934965931, z[0])
		C, z[0] = madd2(m, 15488787195747417982, z[1], C)
		C, z[1] = madd2(m, 1628721857945875526, z[2], C)
		C, z[2] = madd2(m, 17478405972920225849, z[3], C)
		C, z[3] = madd2(m, 1177913551803681068, z[4], C)
		z[4] = C
	}
	{
		// m = z[0]n'[0] mod W
...
func _subGeneric(z, x, y *Element) {
	...
	if b != 0 {
		var c uint64
		z[0], c = bits.Add64(z[0], 10182971180934965931, 0)
		z[1], c = bits.Add64(z[1], 15488787195747417982, c)
		z[2], c = bits.Add64(z[2], 1628721857945875526, c)
		z[3], c = bits.Add64(z[3], 17478405972920225849, c)
		z[4], _ = bits.Add64(z[4], 1177913551803681068, c)
	}
}
...
func _negGeneric(z, x *Element) {
	...
	var borrow uint64
	z[0], borrow = bits.Sub64(10182971180934965931, x[0], 0)
	z[1], borrow = bits.Sub64(15488787195747417982, x[1], borrow)
	z[2], borrow = bits.Sub64(1628721857945875526, x[2], borrow)
	z[3], borrow = bits.Sub64(17478405972920225849, x[3], borrow)
	z[4], _ = bits.Sub64(1177913551803681068, x[4], borrow)
}
...
func (z *Element) Legendre() int {
	...
	// if l == 1
	if (l[4] == 778040796654335581) && (l[3] == 14525071511839886503) && (l[2] == 12462660278230970329) && (l[1] == 7475865022012901269) && (l[0] == 13276128949361475579) {
		return 1
	}
	return -1
}
...
const inversionCorrectionFactorWord0 = 13068848450370500644
const inversionCorrectionFactorWord1 = 8434285418056431308
const inversionCorrectionFactorWord2 = 8621508525510720840
const inversionCorrectionFactorWord3 = 10079858226894004022
const inversionCorrectionFactorWord4 = 237932516250676789
...
func (z *Element) montReduceSigned(x *Element, xHi uint64) {
	...
	if neg {
		...
		if b != 0 {
			...
			z[4], _ = bits.Add64(neg1, qElementWord4, b)
		}
	}
}
