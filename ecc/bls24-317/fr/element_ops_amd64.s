...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ    16(SI), CX
	SBBQ    24(SI), BX
	MOVQ    $0xf000000000000001, R8
	MOVQ    $0x1cd1e79196bf0e7a, R9
	MOVQ    $0xd0b097f28d83cd49, R10
	MOVQ    $0x443f917ea68dafc2, R11
	CMOVQCC DI, R8
	CMOVQCC DI, R9
	CMOVQCC DI, R10
	CMOVQCC DI, R11
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R8
	MOVQ  R8, 0(DI)
	MOVQ  $0x1cd1e79196bf0e7a, R8
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0xd0b097f28d83cd49, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x443f917ea68dafc2, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
