...
// q (modulus)
const qElementWord0 uint64 = 17293822569102704641
const qElementWord1 uint64 = 2076695515679886970
const qElementWord2 uint64 = 15037686223802191177
const qElementWord3 uint64 = 4917809291258081218
...
const qInvNegLsw uint64 = 17293822569102704639
...
func init() {
	_modulus.SetString("30869589236456844204538189757527902584594726589286811523515204428962673459201", 10)
}
...
func (z *Element) SetRandom() (*Element, error) {
	...
	z[3] %= 4917809291258081218

	// if z > q → z -= q
	// note: this is NOT constant time
	if !(z[3] < 4917809291258081218 || (z[3] == 4917809291258081218 && (z[2] < 15037686223802191177 || (z[2] == 15037686223802191177 && (z[1] < 2076695515679886970 || (z[1] == 2076695515679886970 && (z[0] < 17293822569102704641))))))) {
		var b uint64
		z[0], b = bits.Sub64(z[0], 17293822569102704641, 0)
		z[1], b = bits.Sub64(z[1], 2076695515679886970, b)
		z[2], b = bits.Sub64(z[2], 15037686223802191177, b)
		z[3], _ = bits.Sub64(z[3], 4917809291258081218, b)
	}
...
func (z *Element) Halve() {
	if z[0]&1 == 1 {
		...
		// z = z + q
		var carry uint64
		z[0], carry = bits.Add64(z[0], 17293822569102704641, 0)
		z[1], carry = bits.Add64(z[1], 2076695515679886970, carry)
		z[2], carry = bits.Add64(z[2], 15037686223802191177, carry)
		z[3], _ = bits.Add64(z[3], 4917809291258081218, carry)
...
func _mulGeneric(z, x, y *Element) {
	...
	var c [3]uint64
	{
		...
		m := c[0] * 17293822569102704639
		c[2] = madd0(m, 17293822569102704641, c[0])
		c[1], c[0] = madd1(v, y[1], c[1])
		c[2], t[0] = madd2(m, 2076695515679886970, c[2], c[0])
		c[1], c[0] = madd1(v, y[2], c[1])
		c[2], t[1] = madd2(m, 15037686223802191177, c[2], c[0])
		c[1], c[0] = madd1(v, y[3], c[1])
		t[3], t[2] = madd3(m, 4917809291258081218, c[0], c[2], c[1])
	}
	{
		// round 1
		v := x[1]
	...
	}
	{
		...
		c[2] = madd0(m, 17293822569102704641, c[0])
		c[1], c[0] = madd2(v, y[1], c[1], t[1])
		c[2], z[0] = madd2(m, 2076695515679886970, c[2], c[0])
		c[1], c[0] = madd2(v, y[2], c[1], t[2])
		c[2], z[1] = madd2(m, 15037686223802191177, c[2], c[0])
		c[1], c[0] = madd2(v, y[3], c[1], t[3])
		z[3], z[2] = madd3(m, 4917809291258081218, c[0], c[2], c[1])
	}
...
func _mulWGeneric(z, x *Element, y uint64) {
	...
	var t [4]uint64
	{
		...
		m := c0 * 17293822569102704639
		c2 := madd0(m, 17293822569102704641, c0)
		c1, c0 = madd1(y, x[1], c1)
		c2, t[0] = madd2(m, 2076695515679886970, c2, c0)
		c1, c0 = madd1(y, x[2], c1)
		c2, t[1] = madd2(m, 15037686223802191177, c2, c0)
		c1, c0 = madd1(y, x[3], c1)
		t[3], t[2] = madd3(m, 4917809291258081218, c0, c2, c1)
	}
	{
		// round 1
		m := t[0] * 17293822569102704639
		c2 := madd0(m, 17293822569102704641, t[0])
		c2, t[0] = madd2(m, 2076695515679886970, c2, t[1])
		c2, t[1] = madd2(m, 15037686223802191177, c2, t[2])
		t[3], t[2] = madd2(m, 4917809291258081218, t[3], c2)
	}
	{
		// round 2
		m := t[0] * 17293822569102704639
	...
	}
	{
		...
		m := t[0] * 17293822569102704639
		c2 := madd0(m, 17293822569102704641, t[0])
		c2, z[0] = madd2(m, 2076695515679886970, c2, t[1])
		c2, z[1] = madd2(m, 15037686223802191177, c2, t[2])
		z[3], z[2] = madd2(m, 4917809291258081218, t[3], c2)
	}
...
func _fromMontGeneric(z *Element) {
	...
	{
		// m = z[0]n'[0] mod W
		m := z[0] * 17293822569102704639
		C := madd0(m, 17293822569102704641, z[0])
		C, z[0] = madd2(m, 2076695515679886970, z[1], C)
		C, z[1] = madd2(m, 15037686223802191177, z[2], C)
		C, z[2] = madd2(m, 4917809291258081218, z[3], C)
		z[3] = C
	}
	{
		// m = z[0]n'[0] mod W
...
func _subGeneric(z, x, y *Element) {
	...
	if b != 0 {
		var c uint64
		z[0], c = bits.Add64(z[0], 17293822569102704641, 0)
		z[1], c = bits.Add64(z[1], 2076695515679886970, c)
		z[2], c = bits.Add64(z[2], 15037686223802191177, c)
		z[3], _ = bits.Add64(z[3], 4917809291258081218, c)
	}
}
...
func _negGeneric(z, x *Element) {
	...
	var borrow uint64
	z[0], borrow = bits.Sub64(17293822569102704641, x[0], 0)
	z[1], borrow = bits.Sub64(2076695515679886970, x[1], borrow)
	z[2], borrow = bits.Sub64(15037686223802191177, x[2], borrow)
	z[3], _ = bits.Sub64(4917809291258081218, x[3], borrow)
}
...
func (z *Element) Legendre() int {
	...
	// if l == 1
	if (l[3] == 3693316199935307959) && (l[2] == 10227173549722081316) && (l[1] == 12216657526669890703) && (l[0] == 3458764513820540925) {
		return 1
	}
	return -1
}
...
func (z *Element) Sqrt(x *Element) *Element {
	...
	if !((t[3] == 3693316199935307959) && (t[2] == 10227173549722081316) && (t[1] == 12216657526669890703) && (t[0] == 3458764513820540925)) {
	...
	for {
		...
		// for t != 1
		for !((t[3] == 3693316199935307959) && (t[2] == 10227173549722081316) && (t[1] == 12216657526669890703) && (t[0] == 3458764513820540925)) {
			t.Square(&t)
			m++
		}
...
const inversionCorrectionFactorWord0 = 3172493609395595892
const inversionCorrectionFactorWord1 = 3002871457799105677
const inversionCorrectionFactorWord2 = 10638039630978838198
const inversionCorrectionFactorWord3 = 2588158319459600671
