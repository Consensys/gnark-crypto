...
type VerifyingKey struct {
	Lines [2][2][len(bls24317.LoopCounter)]bls24317.LineEvaluationAff // precomputed pairing lines corresponding to G₂, [α]G₂
}
...
func Verify(commitment *Digest, proof *OpeningProof, point fr.Element, vk VerifyingKey) error {
	...
	check, err := bls24317.PairingCheckFixedQ(
		...
		[][2][len(bls24317.LoopCounter)]bls24317.LineEvaluationAff{vk.Lines[0], vk.Lines[1]},
	)
	if err != nil {
		return err
	}
