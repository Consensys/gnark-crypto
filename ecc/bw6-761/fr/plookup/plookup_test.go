...
func TestLookupVector(t *testing.T) {
	...
	{
		proof, err := ProveLookupVector(pk, fvector, lookupVector)
		if err != nil {
			t.Fatal(err)
		}

		err = VerifyLookupVector(vk, proof)
		if err != nil {
			t.Fatal(err)
		}
	}
...
func TestLookupTable(t *testing.T) {
	...
	// correct proof
	{
		proof, err := ProveLookupTables(pk, fTable, lookupTable)
		if err != nil {
			t.Fatal(err)
		}

		err = VerifyLookupTables(vk, proof)
		if err != nil {
			t.Fatal(err)
		}
	}
