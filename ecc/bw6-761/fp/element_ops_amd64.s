...
TEXT ·inverse(SB), $376-16
	...
	// s[10] -> s45-368(SP)
	// s[11] -> s46-376(SP)
	MOVQ $0xc686392d2d1fa659, R14
	MOVQ R14, s35-288(SP)
	MOVQ $0x7b14c9b2f79484ab, R14
	MOVQ R14, s36-296(SP)
	MOVQ $0x7fa1e825c1d2b459, R14
	MOVQ R14, s37-304(SP)
	MOVQ $0xd6ec28f848329d88, R14
	MOVQ R14, s38-312(SP)
	MOVQ $0x4afb427b73a1ed40, R14
	MOVQ R14, s39-320(SP)
	MOVQ $0x972c69400d5930ae, R14
	MOVQ R14, s40-328(SP)
	MOVQ $0x2c7a26bf8c995976, R14
	MOVQ R14, s41-336(SP)
	MOVQ $0xac52e458c6e57af9, R14
	MOVQ R14, s42-344(SP)
	MOVQ $0xac731bfa0c536dfe, R14
	MOVQ R14, s43-352(SP)
	MOVQ $0x121e5c630b103f50, R14
	MOVQ R14, s44-360(SP)
	MOVQ $0x8f1b0953b886cda4, R14
	MOVQ R14, s45-368(SP)
	MOVQ $0x00ad253c2da8d807, R14
	MOVQ R14, s46-376(SP)
