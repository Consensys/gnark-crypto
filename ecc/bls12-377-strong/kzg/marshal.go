...
func (pk *ProvingKey) WriteRawTo(w io.Writer) (int64, error) {
	return pk.writeTo(w, bls12377strong.RawEncoding())
}

func (pk *ProvingKey) writeTo(w io.Writer, options ...func(*bls12377strong.Encoder)) (int64, error) {
	// encode the ProvingKey
	enc := bls12377strong.NewEncoder(w, options...)
...
func (vk *VerifyingKey) WriteRawTo(w io.Writer) (int64, error) {
	return vk.writeTo(w, bls12377strong.RawEncoding())
}
...
func (vk *VerifyingKey) writeTo(w io.Writer, options ...func(*bls12377strong.Encoder)) (int64, error) {
...
func (srs *SRS) WriteDump(w io.Writer, maxPkPoints ...int) error {
	...
	if _, err := srs.Vk.writeTo(w, bls12377strong.RawEncoding()); err != nil {
		return err
	}
...
func (srs *SRS) ReadDump(r io.Reader, maxPkPoints ...int) error {
	...
	// read the slice
	srs.Pk.G1, _, err = unsafe.ReadSlice[[]bls12377strong.G1Affine](r, maxPkPoints...)
	return err
}
...
func (pk *ProvingKey) ReadFrom(r io.Reader) (int64, error) {
	...
	dec := bls12377strong.NewDecoder(r)
...
func (pk *ProvingKey) UnsafeReadFrom(r io.Reader) (int64, error) {
	// decode the ProvingKey
	dec := bls12377strong.NewDecoder(r, bls12377strong.NoSubgroupChecks())
	if err := dec.Decode(&pk.G1); err != nil {
		return dec.BytesRead(), err
	}
	return dec.BytesRead(), nil
...
func (proof *OpeningProof) WriteTo(w io.Writer) (int64, error) {
	enc := bls12377strong.NewEncoder(w)
