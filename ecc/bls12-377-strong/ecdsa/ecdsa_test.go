...
func TestECDSA(t *testing.T) {
	...
	properties.Property("[BLS12-377-STRONG] test the signing and verification", prop.ForAll(
		func() bool {
	...
	properties.Property("[BLS12-377-STRONG] test the signing and verification (pre-hashed)", prop.ForAll(
		func() bool {
