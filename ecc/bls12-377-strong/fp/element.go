...
// Field modulus q
const (
	q0 = 11301855842337137647
	q1 = 9432469365635867297
	q2 = 13835548522826568020
	q3 = 9607679278524336841
	q4 = 9223372036860965943
	q5 = 96076792050570859
)
...
const qInvNeg = 5973402686788605169

func init() {
	_modulus.SetString("15555555555566b80000000005e74378555556670530ac9c001be13dfc2115482e6dce9a57ae2a19cd84202412da3ef", 16)
}
...
func (z *Element) SetOne() *Element {
	z[0] = 18061334811333800111
	z[1] = 6179270387085404523
	z[2] = 13741378754300940786
	z[3] = 9607665172806824825
	z[4] = 9223372035672459923
	z[5] = 96076792050517451
	return z
}
...
func (z *Element) IsOne() bool {
	return ((z[5] ^ 96076792050517451) | (z[4] ^ 9223372035672459923) | (z[3] ^ 9607665172806824825) | (z[2] ^ 13741378754300940786) | (z[1] ^ 6179270387085404523) | (z[0] ^ 18061334811333800111)) == 0
}
...
func (z *Element) LexicographicallyLargest() bool {
	...
	var b uint64
	_, b = bits.Sub64(_z[0], 14874299958023344632, 0)
	_, b = bits.Sub64(_z[1], 4716234682817933648, b)
	_, b = bits.Sub64(_z[2], 16141146298268059818, b)
	_, b = bits.Sub64(_z[3], 14027211676116944228, b)
	_, b = bits.Sub64(_z[4], 13835058055285258779, b)
	_, b = bits.Sub64(_z[5], 48038396025285429, b)
...
const (
	inversionCorrectionFactorWord0 = 13104817355788801997
	inversionCorrectionFactorWord1 = 12769509705369952637
	inversionCorrectionFactorWord2 = 4530290123182189213
	inversionCorrectionFactorWord3 = 9665877282675278186
	inversionCorrectionFactorWord4 = 16459382072665584379
	inversionCorrectionFactorWord5 = 81659206630392038
	invIterationsN                 = 26
)
