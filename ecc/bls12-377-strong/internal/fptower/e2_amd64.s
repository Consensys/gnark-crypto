...
TEXT ·subE2(SB), NOSPLIT, $0-24
	...
	SBBQ    40(R8), DI
	MOVQ    x+8(FP), R8
	MOVQ    $0x9cd84202412da3ef, R10
	MOVQ    $0x82e6dce9a57ae2a1, R11
	MOVQ    $0xc001be13dfc21154, R12
	MOVQ    $0x8555556670530ac9, R13
	MOVQ    $0x80000000005e7437, R14
	MOVQ    $0x015555555555566b, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
	...
	SBBQ    80(R8), SI
	SBBQ    88(R8), DI
	MOVQ    $0x9cd84202412da3ef, R11
	MOVQ    $0x82e6dce9a57ae2a1, R12
	MOVQ    $0xc001be13dfc21154, R13
	MOVQ    $0x8555556670530ac9, R14
	MOVQ    $0x80000000005e7437, R15
	MOVQ    $0x015555555555566b, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
	CMOVQCC R9, R14
...
l1:
	MOVQ $0x9cd84202412da3ef, CX
	SUBQ BX, CX
	MOVQ CX, 0(DX)
	MOVQ $0x82e6dce9a57ae2a1, CX
	SBBQ SI, CX
	MOVQ CX, 8(DX)
	MOVQ $0xc001be13dfc21154, CX
	SBBQ DI, CX
	MOVQ CX, 16(DX)
	MOVQ $0x8555556670530ac9, CX
	SBBQ R8, CX
	MOVQ CX, 24(DX)
	MOVQ $0x80000000005e7437, CX
	SBBQ R9, CX
	MOVQ CX, 32(DX)
	MOVQ $0x015555555555566b, CX
	SBBQ R10, CX
	MOVQ CX, 40(DX)
