...
TEXT ·subE2(SB), NOSPLIT, $0-24
	...
	SBBQ    40(R8), DI
	MOVQ    x+8(FP), R8
	MOVQ    $0x366dd48007aaaaab, R10
	MOVQ    $0x5e6f3b3fd8f94772, R11
	MOVQ    $0x86858d90a5426e59, R12
	MOVQ    $0x484e34c52377be48, R13
	MOVQ    $0xb00fdb45ba6a5ba3, R14
	MOVQ    $0x016c06316cabdde5, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
	...
	SBBQ    80(R8), SI
	SBBQ    88(R8), DI
	MOVQ    $0x366dd48007aaaaab, R11
	MOVQ    $0x5e6f3b3fd8f94772, R12
	MOVQ    $0x86858d90a5426e59, R13
	MOVQ    $0x484e34c52377be48, R14
	MOVQ    $0xb00fdb45ba6a5ba3, R15
	MOVQ    $0x016c06316cabdde5, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
	CMOVQCC R9, R14
...
l1:
	MOVQ $0x366dd48007aaaaab, CX
	SUBQ BX, CX
	MOVQ CX, 0(DX)
	MOVQ $0x5e6f3b3fd8f94772, CX
	SBBQ SI, CX
	MOVQ CX, 8(DX)
	MOVQ $0x86858d90a5426e59, CX
	SBBQ DI, CX
	MOVQ CX, 16(DX)
	MOVQ $0x484e34c52377be48, CX
	SBBQ R8, CX
	MOVQ CX, 24(DX)
	MOVQ $0xb00fdb45ba6a5ba3, CX
	SBBQ R9, CX
	MOVQ CX, 32(DX)
	MOVQ $0x016c06316cabdde5, CX
	SBBQ R10, CX
	MOVQ CX, 40(DX)
