...
// NewDecoder returns a binary decoder supporting curve bls377 objects in both
...
func (dec *Decoder) Decode(v interface{}) (err error) {
	...
	if rv.Kind() != reflect.Ptr || rv.IsNil() || !rv.Elem().CanSet() {
		return errors.New("bls377 decoder: unsupported type, need pointer")
	}
	...
	case *[]G2Affine:
		...
		return nil
	default:
		return errors.New("bls377 encoder: unsupported type")
	}
}
