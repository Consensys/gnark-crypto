...
// Field modulus q
const (
	q0 = 2190616671734353199
	q1 = 13222870243701404210
	q2 = 18446744073709551615
	q3 = 576460752303423504
)
...
const qInvNeg = 13504954208620504625
...
func init() {
	...
	const sqrtExponent2Element = "2000000000000043fffffffffffffffede0449b72b9ec8c8799a8906b71934b"
...
func init() {
	_bCbrtExponentElement, _ = new(big.Int).SetString("1c71c71c71c71cae38e38e38e38e38e28c7596dbb4feeb5cdddeb2b0a2c1127", 16)
}
...
func init() {
	_bSxrtExponentElement, _ = new(big.Int).SetString("38e38e38e38e395c71c71c71c71c71c518eb2db769fdd6b9bbbd6561458225", 16)
}
