...
func (pp params) Verify(hash []byte, signature Signature, publicKey starkcurve.G1Affine) bool {
	...
	var U2 starkcurve.G1Jac
	U2.JointScalarMultiplicationAffine(&pp.Base, &publicKey, u1, u2)
