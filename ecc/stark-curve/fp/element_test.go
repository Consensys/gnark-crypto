...
func TestElementFixedExp(t *testing.T) {
	...
	_bCbrtExponentElement, _ = new(big.Int).SetString("555555555555560aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab", 16)

	properties.Property("ExpByCbrt2q1o3 must match Exp(555555555555560aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab)", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
			c.ExpByCbrt2q1o3(c)
