...
func TestPairing(t *testing.T) {
	...
	properties.Property("[BLS12-381] Bilinearity: e(P,Q)^ab == e([a]P,Q)^b == e(P,[b]Q)^a", prop.ForAll(
	...
	properties.Property("[BLS12-381] Non-degenerancy: e(P,Q) != 1", prop.ForAll(
		func() bool {
	...
	properties.Property("[BLS12-381] PairingCheck: e(P,Q) * e(-P,Q) == 1", prop.ForAll(
		func(a, b fr.Element) bool {
...
func TestFixedPairing(t *testing.T) {
	...
	properties.Property("[BLS12-381] doubleAndAddStep: optimized (Eisenträger-Lauter-Montgomery) matches reference implementation", prop.ForAll(
	...
	properties.Property("[BLS12-381] PrecomputeLines and precomputeLinesRef should produce the same pairing result", prop.ForAll(
		func(a, b fr.Element) bool {
			var ag1 G1Affine
			var bg2 G2Affine
	...
	properties.Property("[BLS12-381] manyDoubleSteps should match repeated doubleStep calls", prop.ForAll(
