...
func g2SqrtRatio(z *fptower.E2, u *fptower.E2, v *fptower.E2) uint64 {
	...
	tv2.Mul(&tv3, &fptower.E2{
		fp.Element{2496753913728403308, 5565778131840425442, 9551898259750726707, 1612762524095231405, 15826190741478736057, 958526743845453870},
		fp.Element{0},
	})
	tv5.Mul(&tv4, &tv1)
...
// g2MulByZ multiplies x by [-2 -2] and stores the result in z
