...
func (z *Element) montReduceSigned(x *Element, xHi uint64) {
	...
	if neg {
		...
		if b != 0 {
			...
			b = 0
			z[0], b = bits.Add64(z[0], 13402431016077863595, b)
			z[1], b = bits.Add64(z[1], 2210141511517208575, b)
			z[2], b = bits.Add64(z[2], 7435674573564081700, b)
			z[3], b = bits.Add64(z[3], 7239337960414712511, b)
