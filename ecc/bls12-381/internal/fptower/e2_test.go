...
func TestE2Ops(t *testing.T) {
	...
	properties.Property("[BLS12-381] squareGeneric & square should be equal", prop.ForAll(
		func(a *E2) bool {
			var c, d E2
			squareGenericE2(&c, a)
			d.Square(a)
	...
	properties.Property("[BLS12-381] cbrt torus should produce a valid cube root", prop.ForAll(
		func(a *E2) bool {
			var b E2
			b.Square(a).Mul(&b, a) // b = a³
