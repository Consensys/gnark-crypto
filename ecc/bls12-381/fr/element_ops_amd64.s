...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SBBQ  CX, R8
	MOVQ  R8, 8(DI)
	MOVQ  $0x3339d80809a1d805, R8
	SBBQ  BX, R8
	MOVQ  R8, 16(DI)
	MOVQ  $0x73eda753299d7d48, R8
	SBBQ  SI, R8
	MOVQ  R8, 24(DI)
	RET
...
TEXT ·inverse(SB), $56-16
	...
	// s[2] -> s5-48(SP)
	// s[3] -> s6-56(SP)
	MOVQ $0xc999e990f3f29c6d, SI
	MOVQ SI, s3-32(SP)
	MOVQ $0x2b6cedcb87925c23, SI
	MOVQ SI, s4-40(SP)
	MOVQ $0x05d314967254398f, SI
	MOVQ SI, s5-48(SP)
	MOVQ $0x0748d9d99f59ff11, SI
	MOVQ SI, s6-56(SP)
