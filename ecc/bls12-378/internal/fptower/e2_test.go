...
func TestE2Ops(t *testing.T) {
	...
	properties.Property("[BLS12-378] BatchInvertE2 should output the same result as Inverse", prop.ForAll(
		func(a, b, c *E2) bool {
	...
	properties.Property("[BLS12-378] Cmp and LexicographicallyLargest should be consistent", prop.ForAll(
		func(a *E2) bool {
			var negA E2
			negA.Neg(a)
