...
func TestPairing(t *testing.T) {
	...
	properties.Property("[BLS12-39] Having the receiver as operand (final expo) should output the same result", prop.ForAll(
		func(a GT) bool {
			b := a
	...
	properties.Property("[BLS12-39] Exponentiating FinalExpo(a) to r should output 1", prop.ForAll(
		func(a GT) bool {
			b := FinalExponentiation(&a)
	...
	properties.Property("[BLS12-39] Expt(Expt) and Exp(t^2) should output the same result in the cyclotomic subgroup", prop.ForAll(
		func(a GT) bool {
			var b, c, d GT
			b.Conjugate(&a)
			a.Inverse(&a)
	...
	properties.Property("[BLS12-39] bilinearity", prop.ForAll(
	...
	properties.Property("[BLS12-39] PairingCheck", prop.ForAll(
		func(a, b fr.Element) bool {
...
func TestMillerLoop(t *testing.T) {
	...
	properties.Property("[BLS12-39] MillerLoop of pairs should be equal to the product of MillerLoops", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[BLS12-39] MillerLoop should skip pairs with a point at infinity", prop.ForAll(
		func(a, b fr.Element) bool {
