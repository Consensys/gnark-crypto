...
func svdwMapG1(u fp.Element) G1Affine {
	...
	z.SetOne().Neg(&z)
	c1.SetOne()
	c2.SetString("163333666684")
	c3.SetString("19405999803")
	c4.SetString("108889111121")
...
func svdwMapG2(u fptower.E2) G2Affine {
	...
	z.A0.SetZero()
	z.A1.SetOne()
	c1.A0.SetString("326667333366")
	c1.A1.SetString("4")
	c2.A0.SetZero()
	c2.A1.SetString("163333666683")
	c3.A0.SetString("260978509113")
	c3.A1.SetString("249832021055")
	c4.A0.SetString("181481851871")
	c4.A1.SetString("254074592617")
