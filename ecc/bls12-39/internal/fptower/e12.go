...
func (z *E12) Bytes() (r [SizeOfGT]byte) {
	_z := *z
	_z.FromMont()
	binary.BigEndian.PutUint64(r[88:96], _z.C0.B0.A0[0])

	binary.BigEndian.PutUint64(r[80:88], _z.C0.B0.A1[0])

	binary.BigEndian.PutUint64(r[72:80], _z.C0.B1.A0[0])

	binary.BigEndian.PutUint64(r[64:72], _z.C0.B1.A1[0])

	binary.BigEndian.PutUint64(r[56:64], _z.C0.B2.A0[0])

	binary.BigEndian.PutUint64(r[48:56], _z.C0.B2.A1[0])

	binary.BigEndian.PutUint64(r[40:48], _z.C1.B0.A0[0])

	binary.BigEndian.PutUint64(r[32:40], _z.C1.B0.A1[0])

	binary.BigEndian.PutUint64(r[24:32], _z.C1.B1.A0[0])

	binary.BigEndian.PutUint64(r[16:24], _z.C1.B1.A1[0])

	binary.BigEndian.PutUint64(r[8:16], _z.C1.B2.A0[0])

	binary.BigEndian.PutUint64(r[0:8], _z.C1.B2.A1[0])
...
func (z *E12) SetBytes(e []byte) error {
	...
	z.C0.B0.A0.SetBytes(e[88 : 88+fp.Bytes])

	z.C0.B0.A1.SetBytes(e[80 : 80+fp.Bytes])

	z.C0.B1.A0.SetBytes(e[72 : 72+fp.Bytes])

	z.C0.B1.A1.SetBytes(e[64 : 64+fp.Bytes])

	z.C0.B2.A0.SetBytes(e[56 : 56+fp.Bytes])

	z.C0.B2.A1.SetBytes(e[48 : 48+fp.Bytes])

	z.C1.B0.A0.SetBytes(e[40 : 40+fp.Bytes])

	z.C1.B0.A1.SetBytes(e[32 : 32+fp.Bytes])

	z.C1.B1.A0.SetBytes(e[24 : 24+fp.Bytes])

	z.C1.B1.A1.SetBytes(e[16 : 16+fp.Bytes])

	z.C1.B2.A0.SetBytes(e[8 : 8+fp.Bytes])
