...
import (
	...
	bls1239 "github.com/consensys/gnark-crypto/ecc/bls12-39"
	"github.com/consensys/gnark-crypto/ecc/bls12-39/fr"
	"github.com/consensys/gnark-crypto/ecc/bls12-39/fr/fft"
	"github.com/consensys/gnark-crypto/ecc/bls12-39/fr/kzg"
	"github.com/consensys/gnark-crypto/ecc/bls12-39/fr/permutation"
...
func deriveRandomness(fs *fiatshamir.Transcript, challenge string, points ...*bls1239.G1Affine) (fr.Element, error) {

	var buf [bls1239.SizeOfG1AffineUncompressed]byte
	var r fr.Element
