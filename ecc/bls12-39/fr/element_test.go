...
func TestElementFixedExp(t *testing.T) {
	...
	_bLegendreExponentElement, _ = new(big.Int).SetString("2fadcf8", 16)
	const sqrtExponentElement = "2fadcf"
	...
	properties.Property("expByLegendreExp must match Exp(2fadcf8)", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
