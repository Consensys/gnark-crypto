...
func TestG1AffineIsOnCurve(t *testing.T) {
	...
	properties.Property("[BLS12-39] g1Gen (affine) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
	...
	properties.Property("[BLS12-39] g1Gen (Jacobian) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
