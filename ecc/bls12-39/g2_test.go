...
func TestG2AffineEndomorphism(t *testing.T) {
	...
	properties.Property("[BLS12-39] check that phi(P) = lambdaGLV * P", prop.ForAll(
	...
	properties.Property("[BLS12-39] check that phi^2(P) + phi(P) + P = 0", prop.ForAll(
		func(a fptower.E2) bool {
			var p, res, tmp G2Jac
			g := MapToCurveG2Svdw(a)
			p.FromAffine(&g)
	...
	properties.Property("[BLS12-39] check that psi^2(P) = -phi(P)", prop.ForAll(
		func(a fptower.E2) bool {
			var p, res1, res2 G2Jac
			g := MapToCurveG2Svdw(a)
			p.FromAffine(&g)
...
func TestG2AffineIsOnCurve(t *testing.T) {
	...
	properties.Property("[BLS12-39] g2Gen (affine) should be on the curve", prop.ForAll(
		func(a fptower.E2) bool {
	...
	properties.Property("[BLS12-39] g2Gen (Jacobian) should be on the curve", prop.ForAll(
		func(a fptower.E2) bool {
	...
	properties.Property("[BLS12-39] IsInSubGroup and MulBy subgroup order should be the same", prop.ForAll(
		func(a fptower.E2) bool {
			var op1, op2 G2Jac
...
func TestG2AffineConversions(t *testing.T) {
	...
	properties.Property("[BLS12-39] Affine representation should be independent of the Jacobian representative", prop.ForAll(
		func(a fptower.E2) bool {
	...
	properties.Property("[BLS12-39] Affine representation should be independent of a Extended Jacobian representative", prop.ForAll(
		func(a fptower.E2) bool {
			var g g2JacExtended
			g.X.Set(&g2Gen.X)
			g.Y.Set(&g2Gen.Y)
	...
	properties.Property("[BLS12-39] Jacobian representation should be the same as the affine representative", prop.ForAll(
		func(a fptower.E2) bool {
			var g G2Jac
			var op1 G2Affine
			op1.X.Set(&g2Gen.X)
	...
	properties.Property("[BLS12-39] Converting affine symbol for infinity to Jacobian should output correct infinity in Jacobian", prop.ForAll(
		func() bool {
			var g G2Affine
			g.X.SetZero()
			g.Y.SetZero()
	...
	properties.Property("[BLS12-39] Converting infinity in extended Jacobian to affine should output infinity symbol in Affine", prop.ForAll(
		func() bool {
			var g G2Affine
	...
	properties.Property("[BLS12-39] Converting infinity in extended Jacobian to Jacobian should output infinity in Jacobian", prop.ForAll(
		func() bool {
			var g G2Jac
			var op1 g2JacExtended
	...
	properties.Property("[BLS12-39] [Jacobian] Two representatives of the same class should be equal", prop.ForAll(
...
func TestG2AffineOps(t *testing.T) {
	...
	properties.Property("[BLS12-39] [Jacobian] Add should call double when having adding the same point", prop.ForAll(
		func(a, b fptower.E2) bool {
	...
	properties.Property("[BLS12-39] [Jacobian] Adding the opposite of a point to itself should output inf", prop.ForAll(
		func(a, b fptower.E2) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
			fop2 := fuzzJacobianG2Affine(&g2Gen, b)
			fop2.Neg(&fop2)
	...
	properties.Property("[BLS12-39] [Jacobian] Adding the inf to a point should not modify the point", prop.ForAll(
		func(a fptower.E2) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
	...
	properties.Property("[BLS12-39] [Jacobian Extended] addMixed (-G) should equal subMixed(G)", prop.ForAll(
		func(a fptower.E2) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
	...
	properties.Property("[BLS12-39] [Jacobian Extended] doubleMixed (-G) should equal doubleNegMixed(G)", prop.ForAll(
		func(a fptower.E2) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
			var p1, p1Neg G2Affine
			p1.FromJacobian(&fop1)
	...
	properties.Property("[BLS12-39] [Jacobian] Addmix the negation to itself should output 0", prop.ForAll(
		func(a fptower.E2) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
			fop1.Neg(&fop1)
			var op2 G2Affine
	...
	properties.Property("[BLS12-39] scalar multiplication (double and add) should depend only on the scalar mod r", prop.ForAll(
	...
	properties.Property("[BLS12-39] psi should map points from E' to itself", prop.ForAll(
		func() bool {
			var a G2Jac
			a.psi(&g2Gen)
	...
	properties.Property("[BLS12-39] scalar multiplication (GLV) should depend only on the scalar mod r", prop.ForAll(
		func(s fr.Element) bool {
	...
	properties.Property("[BLS12-39] GLV and Double and Add should output the same result", prop.ForAll(
		func(s fr.Element) bool {
...
func TestG2AffineCofactorCleaning(t *testing.T) {
	...
	properties.Property("[BLS12-39] Clearing the cofactor of a random point should set it in the r-torsion", prop.ForAll(
		func() bool {
...
func TestG2AffineBatchScalarMultiplication(t *testing.T) {
	...
	properties.Property("[BLS12-39] BatchScalarMultiplication should be consistant with individual scalar multiplications", prop.ForAll(
