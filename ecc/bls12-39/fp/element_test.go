...
func TestElementFixedExp(t *testing.T) {
	...
	_bLegendreExponentElement, _ = new(big.Int).SetString("260771f77b", 16)
	const sqrtExponentElement = "1303b8fbbe"
	...
	properties.Property("expByLegendreExp must match Exp(260771f77b)", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
