...
func init() {
	_modulus.SetString("326667333367", 10)
}
...
func (z *Element) SetRandom() (*Element, error) {
	...
	if !(z[0] < 326667333367) {
		z[0], _ = bits.Sub64(z[0], 326667333367, 0)
	}
...
func _mulGeneric(z, x, y *Element) {
	...
	var c [3]uint64
	{
		...
		m := c[0] * 14763286405836492089
		c[2] = madd0(m, 326667333367, c[0])
		z[0], _ = madd3(m, 326667333367, c[0], c[2], c[1])
	}
...
func _mulWGeneric(z, x *Element, y uint64) {
	...
	{
		// round 0
		m := t[0] * 14763286405836492089
		c2 := madd0(m, 326667333367, t[0])
		_, z[0] = madd2(m, 326667333367, t[0], c2)
	}
...
func _negGeneric(z, x *Element) {
	...
	z[0], _ = bits.Sub64(326667333367, x[0], 0)
}
