...
func (z *Element) montReduceSigned(x *Element, xHi uint64) {
	...
	if neg {
		...
		if b != 0 {
			...
			b = 0
			z[0], b = bits.Add64(z[0], 1860204336533995521, b)
			z[1], b = bits.Add64(z[1], 14466829657984787300, b)
			z[2], b = bits.Add64(z[2], 2737202078770428568, b)
			z[3], _ = bits.Add64(neg1, 1832378743606059307, b)
		}
	}
}
