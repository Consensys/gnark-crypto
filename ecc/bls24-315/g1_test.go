...
func TestG1AffineOps(t *testing.T) {
	...
	properties.Property("[BLS24-315] JointScalarMultiplication and [a]P+[b]Q should output the same result", prop.ForAll(
		func(s1, s2 fr.Element) bool {
			...
			var p1, p2 G1Jac
			p1.ScalarMultiplication(&g1Gen, &_s1)
			p2.ScalarMultiplication(&g1Gen, &_s2).
				AddAssign(&p1)

			p1.JointScalarMultiplicationAffine(&g1, &g2, &_s1, &_s2)
